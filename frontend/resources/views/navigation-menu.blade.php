        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('scans') }}" :active="request()->routeIs('scans')">
                        {{ __('Scans') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('vulnerabilities') }}" :active="request()->routeIs('vulnerabilities')">
                        {{ __('Vulnerabilities') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('risks') }}" :active="request()->routeIs('risks')">
                        {{ __('Risks') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('assets') }}" :active="request()->routeIs('assets')">
                        {{ __('Assets') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('plugins') }}" :active="request()->routeIs('plugins')">
                        {{ __('Plugins') }}
                    </x-jet-nav-link>

                    <p wire:model="flexItems"></p>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ route('scans') }}">
                                    {{ __('All Users') }}
                                </x-jet-dropdown-link>
                                <div class="block px-4 py-2 text-xs text-gray-400">
                                    {{ __('Users') }}
