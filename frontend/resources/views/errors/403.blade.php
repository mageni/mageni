...
<head>
    ...
    <meta name="description" content="Mageni provides a free, open-source and enterprise-ready cybersecurity vulnerability management solution.">
    <link rel="canonical" href="https://www.mageni.net/" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="robots" content="index, follow">
    <meta name="keywords" content="cybersecurity, microsoft, enterprise, tech, infosec, cyber, web, ransomware, bitcoin, linux, windows, ubuntu, macosx, cisco, fortinet, vulnerability, management" />
    <meta name="msvalidate.01" content="2601FEB5F1DE0E687C104F2DDA7548A8" />
    <meta name="yandex-verification" content="920cde63b8787164" />
    ...
    <link rel="icon" href="{{ url('assets/favicon/favicon.png') }}" type="image/png">
    ...
    <main class="flex flex-col justify-center flex-grow w-full px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-center flex-shrink-0">
            <a href="/" class="inline-flex">
                <span class="sr-only">Mageni Security Platform</span>
                <svg viewBox="616.924 390.839 534.093 294.996" class="w-24 h-12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="py-16">
            <div class="text-center">
                <p class="text-sm font-semibold tracking-wide text-indigo-600 uppercase">Error 403</p>
                <h1 class="mt-2 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">Unauthorized</h1>
                <p class="mt-2 text-base text-gray-500">If you believe this is an error, please contact your administrator.</p>
            </div>
        </div>
    </main>
</div>
