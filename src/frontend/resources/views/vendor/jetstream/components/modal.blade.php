...
$maxWidth = [
    ...
    '4xl' => 'sm:max-w-4xl',
    '5xl' => 'sm:max-w-5xl',
    'sms' => 'md:max-w-screen-sm',
    'mds' => 'md:max-w-screen-md',
    'lgs' => 'md:max-w-screen-lg',
][$maxWidth ?? '2xl'];
@endphp
...
<div
    ...
    style="display: none;"
>
    <div x-show="show" class="fixed inset-0 transition-all transform" x-on:click="show = true" x-transition:enter="ease-out duration-300"
