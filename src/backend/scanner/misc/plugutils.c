 ...
 * SPDX-FileCopyrightText: Based on work Copyright (C) 1998 - 2003 Renaud Deraison
 * SPDX-FileComment: Plugin-specific stuff.
...
#include "../../libraries/util/nvticache.h" /* for nvticache_get_by_oid() */
#include <signal.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
