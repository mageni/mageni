...
# $Id: gb_hpe_sap_sizing_tool_detect.nasl 10906 2018-08-10 14:50:26Z cfischer $
#
# HPE SAP Sizing Tool Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("HPE SAP Sizing Tool Version Detection (Windows)");
