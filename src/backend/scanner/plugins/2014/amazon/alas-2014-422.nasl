...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-422)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"nss-util-devel", rpm:"nss-util-devel~3.16.2~2.4.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.16.2~2.4.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-util-debuginfo", rpm:"nss-util-debuginfo~3.16.2~2.4.amzn1", rls:"AMAZON"))) {
    report += res;
  }
