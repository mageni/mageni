...
# $Id: gb_ubuntu_USN_2172_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.5.3-0ubuntu8.2", rls:"UBUNTU12.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.4.3-1ubuntu1.11", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU13.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.7.0~rc1-0ubuntu5.3", rls:"UBUNTU13.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.6.1-0ubuntu11.6", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
