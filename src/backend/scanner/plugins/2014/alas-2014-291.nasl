...
# $Id: alas-2014-291.nasl 6724 2017-07-14 09:57:17Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-291");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"libyaml-devel", rpm:"libyaml-devel~0.1.4~6.5.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libyaml-debuginfo", rpm:"libyaml-debuginfo~0.1.4~6.5.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libyaml", rpm:"libyaml~0.1.4~6.5.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
