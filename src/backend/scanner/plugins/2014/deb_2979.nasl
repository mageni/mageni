...
# $Id: deb_2979.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
We recommend that you upgrade your fail2ban packages.");
  script_tag(name:"summary", value:"Two vulnerabilities were discovered in Fail2ban, a solution to ban hosts
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"fail2ban", ver:"0.8.6-3wheezy3", rls:"DEB7")) != NULL) {
  report += res;
}
