...
# $Id: gb_owncloud_db_password_generator_vuln.nasl 11867 2018-10-12 10:48:11Z cfischer $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with ownCloud and is prone to weak database password
generation vulnerability.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"The flaw exists due to the program using the 'time' function as a random source
for PostgreSQL database user password generation.");
  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to easily guess a user's
password.");
  script_tag(name:"affected", value:"ownCloud Server 4.0.x before 4.0.14, 4.5.x before 4.5.9, and 5.0.x before
5.0.4");
