...
# $Id: gb_ubuntu_USN_2225_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for linux-lts-saucy USN-2225-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-06-02 15:06:29 +0530 (Mon, 02 Jun 2014)");
  ...
  script_name("Ubuntu Update for linux-lts-saucy USN-2225-1");
...
IEEE 802.11 Networking Stack (mac80211). Remote attackers could exploi ...

  Description truncated, please see the referenced URL(s) for more information.");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2225-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.11.0-22-generic", ver:"3.11.0-22.38~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.11.0-22-generic-lpae", ver:"3.11.0-22.38~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
