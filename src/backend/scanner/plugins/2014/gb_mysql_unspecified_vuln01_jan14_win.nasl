...
# $Id: gb_mysql_unspecified_vuln01_jan14_win.nasl 34604 2014-01-21 13:41:33Z Jan$
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.804072");
  ...
  script_tag(name:"creation_date", value:"2014-01-21 13:41:33 +0530 (Tue, 21 Jan 2014)");
  script_name("Oracle MySQL Multiple Unspecified vulnerabilities - 01 Jan14 (Windows)");
...
and cause a DoS (Denial of Service).");
  script_tag(name:"affected", value:"Oracle MySQL version 5.6.14 and earlier on Windows.");
