...
# $Id: gb_wordpress_fbpromotions_plugin_xss_vuln.nasl 11402 2018-09-15 09:13:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with WordPress Facebook Promotion Generator Plugin and
