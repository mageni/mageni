...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868583");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-12-14 05:56:20 +0100 (Sun, 14 Dec 2014)");
  script_cve_id("CVE-2014-9090", "CVE-2014-7843", "CVE-2014-7842", "CVE-2014-7841",
  ...
  script_name("Fedora Update for kernel FEDORA-2014-16632");
  script_tag(name:"summary", value:"Check the version of kernel");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"kernel on Fedora 20");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146138.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.17.6~200.fc20", rls:"FC20")) != NULL)
  {
