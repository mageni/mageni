...
# $Id: gb_mozilla_firefox_esr_mult_vuln01_may14_macosx.nasl 37404 2014-05-06 15:47:12Z may$
#
...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Multiple Vulnerabilities-01 May14 (Mac OS X)");
