...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.881919");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-04-08 11:31:20 +0530 (Tue, 08 Apr 2014)");
  script_cve_id("CVE-2013-6438", "CVE-2014-0098");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_name("CentOS Update for httpd CESA-2014:0369 centos5");
...
updated packages, the httpd daemon will be restarted automatically.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2014-April/020246.html");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.2.3~85.el5.centos", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"httpd-devel", rpm:"httpd-devel~2.2.3~85.el5.centos", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"httpd-manual", rpm:"httpd-manual~2.2.3~85.el5.centos", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"mod_ssl", rpm:"mod_ssl~2.2.3~85.el5.centos", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
