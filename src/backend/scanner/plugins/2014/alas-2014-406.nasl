...
# $Id: alas-2014-406.nasl 6759 2017-07-19 09:56:33Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-406");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"libXtst-debuginfo", rpm:"libXtst-debuginfo~1.2.1~2.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libXtst", rpm:"libXtst~1.2.1~2.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libXtst-devel", rpm:"libXtst-devel~1.2.1~2.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
