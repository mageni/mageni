...
tag_insight = "Multiple vulnerabilities in scponly allow authenticated users to bypass
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200802-06
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303449");
