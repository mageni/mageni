#
#VID f4af098d-d921-11da-ad4a-00123ffe8333
...
CVE-2006-1329
The SASL negotiation in Jabber Studio jabberd before 2.0s11 allows
remote attackers to cause a denial of service ('c2s segfault') by
sending a 'response stanza before an auth stanza'.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303391");
