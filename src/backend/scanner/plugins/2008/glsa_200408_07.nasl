...
tag_insight = "An input validation vulnerability has been discovered in Horde-IMP. This
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200408-07
http://bugs.gentoo.org/show_bug.cgi?id=59336
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300222");
