...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-23
http://bugs.gentoo.org/show_bug.cgi?id=68271
http://gaim.sourceforge.net/security/";
tag_summary = "The remote host is missing updates announced in
advisory GLSA 200410-23.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301400");
 ...
 script_name("Gentoo Security Advisory GLSA 200410-23 (gaim)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-im/gaim", unaffected: make_list("ge 1.0.2"), vulnerable: make_list("lt 1.0.2"))) != NULL) {
    report += res;
}
