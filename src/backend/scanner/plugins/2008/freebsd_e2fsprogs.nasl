...
tag_insight = "The following package is affected: e2fsprogs

CVE-2007-5497
Multiple integer overflows in libext2fs in e2fsprogs before 1.40.3
allow user-assisted remote attackers to execute arbitrary code via a
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300574");
 ...
 script_name("FreeBSD Ports: e2fsprogs");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.40.3")<0) {
    txt += 'Package e2fsprogs version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
