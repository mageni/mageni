#
#VID 2fbe16c2-cab6-11d9-9aed-000e0c2e438a
...
http://www.vuxml.org/freebsd/2fbe16c2-cab6-11d9-9aed-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300387");
...
if(!isnull(bver) && revcomp(a:bver, b:"0")>0) {
    txt += 'Package freeradius-devel version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
