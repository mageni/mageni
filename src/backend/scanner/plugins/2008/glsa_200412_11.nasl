...
tag_insight = "Cscope is vulnerable to symlink attacks, potentially allowing a local user
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300182");
 ...
 script_name("Gentoo Security Advisory GLSA 200412-11 (cscope)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-util/cscope", unaffected: make_list("ge 15.5-r2"), vulnerable: make_list("lt 15.5-r2"))) != NULL) {
    report += res;
}
