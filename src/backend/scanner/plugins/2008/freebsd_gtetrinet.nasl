#
#VID 0b79743b-3ab7-11db-81e1-000e0c2e438a
...
tag_insight = "The following package is affected: gtetrinet";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303468");
 ...
 script_name("FreeBSD Ports: gtetrinet");
...
if(!isnull(bver) && revcomp(a:bver, b:"0")>=0) {
    txt += 'Package gtetrinet version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
