...
# $Id: deb_1096_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1096-1
#
# Authors:
...
We recommend that you upgrade your webcalendar package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201096-1";
tag_summary = "The remote host is missing an update to webcalendar
announced via advisory DSA 1096-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300842");
 ...
 script_name("Debian Security Advisory DSA 1096-1 (webcalendar)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"webcalendar", ver:"0.9.45-4sarge5", rls:"DEB3.1")) != NULL) {
    report += res;
}
