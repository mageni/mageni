#
#VID ba005226-fb5b-11d8-9837-000c41e2cdad
...
CVE-2004-0802
Buffer overflow in the BMP loader in imlib2 before 1.1.2 allows remote
attackers to execute arbitrary code via a specially-crafted BMP image,
a different vulnerability than CVE-2004-0817.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301534");
