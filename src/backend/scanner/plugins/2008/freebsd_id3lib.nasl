...
tag_insight = "The following package is affected: id3lib
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301548");
 ...
 script_name("FreeBSD Ports: id3lib");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.8.3_4")<0) {
    txt += 'Package id3lib version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
