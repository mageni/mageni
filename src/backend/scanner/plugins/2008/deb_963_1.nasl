...
# $Id: deb_963_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 963-1
#
# Authors:
...
announced via advisory DSA 963-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301171");
 ...
 script_name("Debian Security Advisory DSA 963-1 (mydns)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mydns-common", ver:"1.0.0-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mydns-mysql", ver:"1.0.0-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mydns-pgsql", ver:"1.0.0-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
