...
# $Id: deb_1125_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301967");
 ...
 script_name("Debian Security Advisory DSA 1125-2 (drupal)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal", ver:"4.5.3-6.1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
