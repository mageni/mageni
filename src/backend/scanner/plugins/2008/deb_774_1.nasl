...
# $Id: deb_774_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302199");
 ...
 script_name("Debian Security Advisory DSA 774-1 (fetchmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"fetchmail-ssl", ver:"6.2.5-12sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"fetchmailconf", ver:"6.2.5-12sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"fetchmail", ver:"6.2.5-12sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
