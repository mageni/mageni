#
#VID 1f5b711b-3d0e-11dc-b3d3-0016179b2dd5
...
http://www.vuxml.org/freebsd/1f5b711b-3d0e-11dc-b3d3-0016179b2dd5.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303813");
 script_version("$Revision: 4078 $");
 script_cve_id("CVE-2007-4063", "CVE-2007-4064");
