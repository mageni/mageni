#
#VID 523fad14-eb9d-11d9-a8bd-000cf18bbe54
...
tag_insight = "The following package is affected: pear-XML_RPC

CVE-2005-1921
PEAR XML_RPC 1.3.0 and earlier, as used in products such as WordPress,
Serendipity, and others, allows remote attackers to execute arbitrary
PHP code via an XML file, which is not properly sanitized before being
used in an eval statement.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302299");
