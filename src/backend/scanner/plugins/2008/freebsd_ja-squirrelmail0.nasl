#
#VID 21b7c550-2a22-11db-a6e2-000e0c2e438a
...
http://www.vuxml.org/freebsd/21b7c550-2a22-11db-a6e2-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301920");
 ...
 script_name("FreeBSD Ports: ja-squirrelmail");
