...
# $Id: deb_382_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "This advisory is an addition to the earlier DSA-382-1 advisory: two more
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20382-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301884");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ssh-askpass-gnome", ver:"3.4p1-1.woody.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ssh", ver:"3.4p1-1.woody.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
