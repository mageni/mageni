...
# $Id: deb_978_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 978-1
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300846");
 ...
 script_name("Debian Security Advisory DSA 978-1 (gnupg)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gnupg", ver:"1.0.6-4woody4", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gnupg", ver:"1.4.1-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
