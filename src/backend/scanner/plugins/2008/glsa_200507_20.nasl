...
tag_insight = "A vulnerability in Shorewall allows clients authenticated by MAC address
filtering to bypass all other security rules.";
tag_solution = "All Shorewall users should upgrade to the latest available version:

    # emerge --sync
    # emerge --ask --oneshot --verbose net-firewall/shorewall

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200507-20
http://bugs.gentoo.org/show_bug.cgi?id=99398
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301654");
