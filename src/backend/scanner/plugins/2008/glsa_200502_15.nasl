...
tag_insight = "A vulnerability in PowerDNS could lead to a temporary Denial of Service.";
...
advisory GLSA 200502-15.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300078");
 ...
 script_name("Gentoo Security Advisory GLSA 200502-15 (PowerDNS)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-dns/pdns", unaffected: make_list("ge 2.9.17"), vulnerable: make_list("lt 2.9.17"))) != NULL) {
    report += res;
}
