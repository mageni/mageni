...
# $Id: deb_768_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 768-1
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303682");
 ...
 script_name("Debian Security Advisory DSA 768-1 (phpbb2)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpbb2-conf-mysql", ver:"2.0.13-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpbb2-languages", ver:"2.0.13-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpbb2", ver:"2.0.13-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
