...
tag_insight = "Quagga's RIP daemon allows the injection of routes and the disclosure of
...
advisory GLSA 200605-15.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302935");
 ...
 script_name("Gentoo Security Advisory GLSA 200605-15 (quagga)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-misc/quagga", unaffected: make_list("ge 0.98.6-r1"), vulnerable: make_list("lt 0.98.6-r1"))) != NULL) {
    report += res;
}
