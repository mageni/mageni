...
# $Id: deb_990_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 990-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to bluez-hcidump
announced via advisory DSA 990-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300854");
 ...
 script_name("Debian Security Advisory DSA 990-1 (bluez-hcidump)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bluez-hcidump", ver:"1.17-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
