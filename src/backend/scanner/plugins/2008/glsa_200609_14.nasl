...
tag_insight = "Multiple buffer overflows have been discovered in ImageMagick, which could
...
advisory GLSA 200609-14.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304074");
 ...
 script_name("Gentoo Security Advisory GLSA 200609-14 (Imagemagick)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-gfx/imagemagick", unaffected: make_list("ge 6.2.9.5"), vulnerable: make_list("lt 6.2.9.5"))) != NULL) {
    report += res;
}
