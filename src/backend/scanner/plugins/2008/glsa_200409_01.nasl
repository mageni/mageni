...
tag_insight = "vpopmail contains several bugs making it vulnerable to several SQL
...
code.";
tag_solution = "All vpopmail users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303663");
