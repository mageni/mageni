#
#VID f4ff7434-9505-11db-9ddc-0011098b2f36
...
http://www.vuxml.org/freebsd/f4ff7434-9505-11db-9ddc-0011098b2f36.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302773");
 ...
 script_cve_id("CVE-2006-4249");
 script_bugtraq_id(21460);
...
if(!isnull(bver) && revcomp(a:bver, b:"2.5")>0 && revcomp(a:bver, b:"2.5.1_1")<0) {
