...
tag_insight = "The Cyrus IMAP Server contains multiple vulnerabilities which could lead to
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-34
http://bugs.gentoo.org/show_bug.cgi?id=72194
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301873");
