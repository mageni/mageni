#
#VID 00644f03-fb58-11d8-9837-000c41e2cdad
...
tag_insight = "The following package is affected: imlib

CVE-2004-0817
Multiple heap-based buffer overflows in the imlib BMP image handler
allow remote attackers to execute arbitrary code via a crafted BMP
file.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugzilla.gnome.org/show_bug.cgi?id=151034
http://www.vuxml.org/freebsd/00644f03-fb58-11d8-9837-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302736");
