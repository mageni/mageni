...
# $Id: deb_1569_3.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Since the previous security update, the cacti package could no longer
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201569-3";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300675");
 ...
 script_name("Debian Security Advisory DSA 1569-3 (cacti)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.6i-3.5", rls:"DEB4.0")) != NULL) {
    report += res;
}
