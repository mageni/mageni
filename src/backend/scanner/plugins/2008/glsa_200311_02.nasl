...
tag_insight = "Buffer overflows exist in Opera 7.11 and 7.20 that can cause Opera to
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302821");
 ...
 script_name("Gentoo Security Advisory GLSA 200311-02 (Opera)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-www/opera", unaffected: make_list("ge 7.21"), vulnerable: make_list("eq 7.20", "eq 7.11"))) != NULL) {
    report += res;
}
