#
#VID 00263aa3-67a8-11d8-80e3-0020ed76ef5a
...
tag_insight = "The following package is affected: mailman
...
http://mail.python.org/pipermail/mailman-announce/2003-February/000056.html
http://www.vuxml.org/freebsd/00263aa3-67a8-11d8-80e3-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301309");
 ...
 script_bugtraq_id(6678, 6677);
 script_cve_id("CVE-2003-0038");
