#
#VID f6bff909-4a26-11db-a4cc-000a48049292
...
http://www.vuxml.org/freebsd/f6bff909-4a26-11db-a4cc-000a48049292.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300473");
 ...
 script_name("FreeBSD Ports: libmms");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.3")<0) {
    txt += 'Package libmms version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
