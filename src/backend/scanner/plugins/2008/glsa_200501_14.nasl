...
tag_insight = "An attacker may be able to execute arbitrary code by way of specially
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304174");
 ...
 script_name("Gentoo Security Advisory GLSA 200501-14 (media-sound/mpg123)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-sound/mpg123", unaffected: make_list("ge 0.59s-r9"), vulnerable: make_list("lt 0.59s-r9"))) != NULL) {
    report += res;
}
