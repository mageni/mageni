...
# $Id: deb_951_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 951-1
#
# Authors:
...
We recommend that you upgrade your trac package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20951-1";
tag_summary = "The remote host is missing an update to trac
announced via advisory DSA 951-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303773");
 ...
 script_name("Debian Security Advisory DSA 951-1 (trac)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"trac", ver:"0.8.1-3sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
