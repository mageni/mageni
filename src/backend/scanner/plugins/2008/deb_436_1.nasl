...
# $Id: deb_436_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 436-1
#
# Authors:
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20436-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303182");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mailman", ver:"2.0.11-1woody7", rls:"DEB3.0")) != NULL) {
    report += res;
}
