...
tag_insight = "Multiple vulnerabilities, including remotely exploitable buffer overflows,
have been found in code common to MPlayer and the xine library.";
tag_solution = "All users should upgrade to non-vulnerable versions of MPlayer and
xine-lib:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200405-24
http://bugs.gentoo.org/show_bug.cgi?id=49387
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304102");
