...
# $Id: deb_909_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 909-1
#
# Authors:
...
We recommend that you upgrade your horde3 package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20909-1";
tag_summary = "The remote host is missing an update to horde3
announced via advisory DSA 909-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300924");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 23:07:13 +0100 (Thu, 17 Jan 2008)");
 script_bugtraq_id(15535);
 script_cve_id("CVE-2005-3759");
 script_tag(name:"cvss_base", value:"5.8");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
 script_name("Debian Security Advisory DSA 909-1 (horde3)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"horde3", ver:"3.0.4-4sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
