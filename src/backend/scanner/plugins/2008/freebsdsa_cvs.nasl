...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:07.cvs.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302456");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-04:07.cvs.asc)";
 script_name(name);
