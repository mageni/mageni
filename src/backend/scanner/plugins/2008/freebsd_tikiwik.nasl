...
tag_insight = "The following package is affected: tikiwik
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302631");
 ...
 script_name("FreeBSD Ports: tikiwik");
...
txt = "";
vuln = 0;
bver = portver(pkg:"tikiwik");
if(!isnull(bver) && revcomp(a:bver, b:"1.9.8.2")<0) {
    txt += 'Package tikiwik version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
