...
# $Id: deb_556_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 556-1
#
# Authors:
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20556-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302226");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"telnet", ver:"0.17-18woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"telnetd", ver:"0.17-18woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
