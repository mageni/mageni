...
# $Id: deb_1045_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1045-1
#
# Authors:
...
announced via advisory DSA 1045-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300493");
 ...
 script_name("Debian Security Advisory DSA 1045-1 (openvpn)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"openvpn", ver:"2.0-1sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
