...
# $Id: deb_058_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Megyer Laszlo found a printf format bug in the exim mail transfer
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20058-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300136");
 ...
 script_name("Debian Security Advisory DSA 058-1 (exim)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"exim", ver:"3.12-10.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"eximon", ver:"3.12-10.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
