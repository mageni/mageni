...
# $Id: deb_322_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "typespeed is a game which challenges the player to type words
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20322-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301609");
 ...
 script_name("Debian Security Advisory DSA 322-1 (typespeed)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"typespeed", ver:"0.4.0-5.2", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"typespeed", ver:"0.4.1-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
