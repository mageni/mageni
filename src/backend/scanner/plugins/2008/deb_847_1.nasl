...
# $Id: deb_847_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300061");
 ...
 script_name("Debian Security Advisory DSA 847-1 (dia)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"dia-common", ver:"0.94.0-7sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dia", ver:"0.94.0-7sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dia-gnome", ver:"0.94.0-7sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dia-libs", ver:"0.94.0-7sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
