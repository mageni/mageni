...
# $Id: deb_1634_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Rob Holland discovered several programming errors in WordNet, an
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201634-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300414");
 ...
 script_name("Debian Security Advisory DSA 1634-1 (wordnet)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wordnet-sense-index", ver:"2.1-4+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordnet-base", ver:"2.1-4+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordnet-dev", ver:"2.1-4+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wordnet", ver:"2.1-4+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
