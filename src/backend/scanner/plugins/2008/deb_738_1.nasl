...
# $Id: deb_738_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 738-1
#
# Authors:
...
We recommend that you upgrade your razor package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20738-1";
tag_summary = "The remote host is missing an update to razor
announced via advisory DSA 738-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301528");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 23:00:53 +0100 (Thu, 17 Jan 2008)");
 script_bugtraq_id(13984);
 script_cve_id("CVE-2005-2024");
 script_tag(name:"cvss_base", value:"5.0");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
 script_name("Debian Security Advisory DSA 738-1 (razor)");
