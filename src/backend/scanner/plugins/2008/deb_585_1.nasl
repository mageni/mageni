...
# $Id: deb_585_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "A vulnerability has been discovered in the shadow suite which provides
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20585-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302133");
 ...
 script_name("Debian Security Advisory DSA 585-1 (shadow)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"login", ver:"20000902-12woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"passwd", ver:"20000902-12woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
