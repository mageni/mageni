...
tag_insight = "The following package is affected: globus";
...
http://www.vuxml.org/freebsd/5039ae61-2c9f-11db-8401-000ae42e9b93.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303966");
 ...
 script_name("FreeBSD Ports: globus");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.0.2_20060706")<0) {
    txt += 'Package globus version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
