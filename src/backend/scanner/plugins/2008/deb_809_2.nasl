...
# $Id: deb_809_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 809-2
#
# Authors:
...
We recommend that you upgrade your squid package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20809-2";
tag_summary = "The remote host is missing an update to squid
announced via advisory DSA 809-2.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300108");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squid", ver:"2.4.6-2woody10", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squid-cgi", ver:"2.4.6-2woody10", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squidclient", ver:"2.4.6-2woody10", rls:"DEB3.0")) != NULL) {
    report += res;
}
