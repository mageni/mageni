...
# $Id: deb_1319_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several remote vulnerabilities have been discovered in MaraDNS, a simple
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201319-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303114");
 ...
 script_name("Debian Security Advisory DSA 1319-1 (maradns)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"maradns", ver:"1.2.12.04-1etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
