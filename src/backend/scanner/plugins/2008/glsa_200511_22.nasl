...
tag_insight = "A vulnerability has been identified that allows a specially crafted SVG
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200511-22
http://bugs.gentoo.org/show_bug.cgi?id=109993";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303395");
 script_version("$Revision: 6596 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 11:21:37 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-09-24 21:14:03 +0200 (Wed, 24 Sep 2008)");
 script_bugtraq_id(15507);
