...
# $Id: deb_429_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
announced via advisory DSA 429-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20429-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304077");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gnupg", ver:"1.0.6-4woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
