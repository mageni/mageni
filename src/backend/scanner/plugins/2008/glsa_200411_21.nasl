...
tag_insight = "Samba is vulnerable to a buffer overflow that could lead to execution of
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-21
http://bugs.gentoo.org/show_bug.cgi?id=70429
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304325");
