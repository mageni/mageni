...
http://www.vuxml.org/freebsd/97d45e95-3ffc-11da-a263-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301088");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.4.0")>=0 && revcomp(a:bver, b:"2.4.3")<0) {
