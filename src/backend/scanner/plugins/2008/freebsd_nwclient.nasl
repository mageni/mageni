...
tag_insight = "The following package is affected: nwclient
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300932");
 ...
 script_name("FreeBSD Ports: nwclient");
...
if(!isnull(bver) && revcomp(a:bver, b:"0")>0) {
    txt += 'Package nwclient version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
