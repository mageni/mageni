...
# $Id: deb_1642_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Will Drewry discovered that the Horde, allows remote attackers to send
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201642-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302561");
 ...
 script_name("Debian Security Advisory DSA 1642-1 (horde3)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"horde3", ver:"3.1.3-4etch4", rls:"DEB4.0")) != NULL) {
    report += res;
}
