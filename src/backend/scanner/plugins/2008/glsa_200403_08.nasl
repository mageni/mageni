...
tag_insight = "A remotely-exploitable overflow exists in oftpd, allowing an attacker to
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200403-08
http://bugs.gentoo.org/show_bug.cgi?id=45738
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303853");
