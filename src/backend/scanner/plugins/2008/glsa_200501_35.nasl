...
tag_insight = "An overflow in the camel-lock-helper application can be exploited by an
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-35
http://bugs.gentoo.org/show_bug.cgi?id=79183";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303073");
