...
tag_insight = "A bug in Zebedee allows a remote attacker to perform a Denial of Service
attack.";
tag_solution = "All Zebedee users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301557");
