...
# $Id: deb_674_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 674-2
#
# Authors:
...
tag_insight = "Due to an error the last mailman update was slightly broken and had to
...
announced via advisory DSA 674-2.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20674-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302305");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mailman", ver:"2.0.11-1woody10", rls:"DEB3.0")) != NULL) {
    report += res;
}
