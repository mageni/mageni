...
tag_insight = "OpenOffice.org is affected by three security vulnerabilities which can be
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301704");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-office/openoffice", unaffected: make_list("ge 2.0.3"), vulnerable: make_list("lt 2.0.3"))) != NULL) {
    report += res;
}
if ((res = ispkgvuln(pkg:"app-office/openoffice-bin", unaffected: make_list("ge 2.0.3"), vulnerable: make_list("lt 2.0.3"))) != NULL) {
    report += res;
}
