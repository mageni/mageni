...
# $Id: deb_1493_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several local/remote vulnerabilities have been discovered in the image
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201493-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303683");
...
if ((res = isdpkgvuln(pkg:"libsdl-image1.2-dev", ver:"1.2.5-2etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsdl-image1.2", ver:"1.2.5-2etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
