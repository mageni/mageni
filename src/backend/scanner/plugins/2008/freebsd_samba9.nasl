#
#VID 57ae52f7-b9cc-11db-bf0f-0013720b182d
...
http://www.vuxml.org/freebsd/57ae52f7-b9cc-11db-bf0f-0013720b182d.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303055");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.0.6,1")>=0 && revcomp(a:bver, b:"3.0.24,1")<0) {
