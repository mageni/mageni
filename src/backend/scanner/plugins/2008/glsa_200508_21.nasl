...
tag_insight = "phpWebSite is vulnerable to multiple issues which result in the execution
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200508-21
http://bugs.gentoo.org/show_bug.cgi?id=102785
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301314");
