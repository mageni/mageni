...
tag_insight = "The network sub-system commonly utilizes the ioctl(2) mechanism to pass
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:06.kmem.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302341");
 script_version("$Revision: 8023 $");
 script_tag(name:"last_modification", value:"$Date: 2017-12-07 09:36:26 +0100 (Thu, 07 Dec 2017) $");
 script_tag(name:"creation_date", value:"2008-09-04 20:41:11 +0200 (Thu, 04 Sep 2008)");
 script_bugtraq_id(16373);
 script_cve_id("CVE-2006-0379");
 script_tag(name:"cvss_base", value:"2.1");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:N");
 name = "FreeBSD Security Advisory (FreeBSD-SA-06:06.kmem.asc)";
 script_name(name);
