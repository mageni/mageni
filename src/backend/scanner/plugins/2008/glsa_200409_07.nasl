...
tag_insight = "xv contains multiple exploitable buffer overflows in the image handling
code.";
tag_solution = "All xv users should upgrade to the latest stable version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302182");
