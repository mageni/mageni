...
# $Id: deb_384_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Two vulnerabilities were reported in sendmail.
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20384-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300042");
 ...
 script_name("Debian Security Advisory DSA 384-1 (sendmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sendmail-doc", ver:"8.12.3-6.6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmilter-dev", ver:"8.12.3-6.6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sendmail", ver:"8.12.3-6.6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sendmail-wide", ver:"8.12.3+3.5Wbeta-5.5", rls:"DEB3.0")) != NULL) {
    report += res;
}
