#
#VID 96fdbf5b-2cfd-11d8-9355-0020ed76ef5a
...
tag_insight = "The following package is affected: mathopd

The remote server suffers from a buffer overflow
...
http://www.vuxml.org/freebsd/96fdbf5b-2cfd-11d8-9355-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301036");
 ...
 script_cve_id("CVE-2003-1228");
 script_bugtraq_id(9871);
