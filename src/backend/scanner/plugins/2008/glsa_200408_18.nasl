...
tag_insight = "xine-lib contains an exploitable buffer overflow in the VCD handling code";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200408-18
http://bugs.gentoo.org/show_bug.cgi?id=59948
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304258");
