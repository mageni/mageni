...
# $Id: deb_006_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Last week a Zope (security advisory was released which indicated
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20006-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303995");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 14:24:38 +0100 (Thu, 17 Jan 2008)");
 script_tag(name:"cvss_base", value:"6.8");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
 script_name("Debian Security Advisory DSA 006-1 (zope)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"zope", ver:"2.1.6-5.3", rls:"DEB2.2")) != NULL) {
    report += res;
}
