...
# $Id: deb_198_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "A problem has been discovered in nullmailer, a simple relay-only mail
...
tag_summary = "The remote host is missing an update to nullmailer
announced via advisory DSA 198-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20198-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300867");
 ...
 script_name("Debian Security Advisory DSA 198-1 (nullmailer)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"nullmailer", ver:"1.00RC5-16.1woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
