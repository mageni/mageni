...
tag_solution = "All uim users should upgrade to the latest available version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-i18n/uim-0.4.5.1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200502-31
http://bugs.gentoo.org/show_bug.cgi?id=82678
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302774");
