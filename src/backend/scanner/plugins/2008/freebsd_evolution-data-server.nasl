#
#VID b1b5c125-2308-11dc-b91a-001921ab2fa4
...
tag_insight = "The following package is affected: evolution-data-server
...
http://www.vuxml.org/freebsd/b1b5c125-2308-11dc-b91a-001921ab2fa4.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300813");
 ...
 script_name("FreeBSD Ports: evolution-data-server");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.10.2_1")<0) {
    txt += 'Package evolution-data-server version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
