...
tag_insight = "A SQL injection vulnerability has been discovered in phpMyAdmin.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301154");
 ...
 script_name("Gentoo Security Advisory GLSA 200803-15 (phpmyadmin)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-db/phpmyadmin", unaffected: make_list("ge 2.11.5"), vulnerable: make_list("lt 2.11.5"))) != NULL) {
    report += res;
}
