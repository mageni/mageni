...
# $Id: deb_300_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to balsa
announced via advisory DSA 300-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20300-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303866");
 ...
 script_name("Debian Security Advisory DSA 300-1 (balsa)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"balsa", ver:"1.2.4-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
