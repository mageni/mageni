...
# $Id: deb_891_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 891-1
#
# Authors:
...
We recommend that you upgrade your gpsdrive package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20891-1";
tag_summary = "The remote host is missing an update to gpsdrive
announced via advisory DSA 891-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300631");
 ...
 script_name("Debian Security Advisory DSA 891-1 (gpsdrive)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gpsdrive", ver:"2.09-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
