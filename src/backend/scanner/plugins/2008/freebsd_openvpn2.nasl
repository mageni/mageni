...
http://www.vuxml.org/freebsd/a51ad838-2077-48b2-a136-e888a7db5f8d.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301726");
 ...
 script_bugtraq_id(14605);
 script_cve_id("CVE-2005-2531");
