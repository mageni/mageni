...
tag_insight = "CUPS leaks information about user names and passwords when using remote
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-06
http://bugs.gentoo.org/show_bug.cgi?id=66501";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300224");
