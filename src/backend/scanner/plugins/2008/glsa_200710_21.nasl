...
tag_insight = "Tikiwiki contains a command injection vulnerability which may allow remote
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-21
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301019");
