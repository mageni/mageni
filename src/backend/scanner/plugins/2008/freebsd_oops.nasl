#
#VID 1033750f-cab4-11d9-9aed-000e0c2e438a
...
tag_insight = "The following package is affected: oops
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302817");
 ...
 script_name("FreeBSD Ports: oops");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.5.24")<=0) {
    txt += 'Package oops version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
