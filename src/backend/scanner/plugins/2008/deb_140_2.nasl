...
# $Id: deb_140_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "In addition to the advisory DSA 140-1 the packages below fix another
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20140-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304293");
