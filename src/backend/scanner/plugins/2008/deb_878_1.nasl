...
# $Id: deb_878_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 878-1
#
# Authors:
...
announced via advisory DSA 878-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302056");
 ...
 script_name("Debian Security Advisory DSA 878-1 (netpbm-free)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libnetpbm10", ver:"10.0-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libnetpbm10-dev", ver:"10.0-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libnetpbm9", ver:"10.0-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libnetpbm9-dev", ver:"10.0-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"netpbm", ver:"10.0-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
