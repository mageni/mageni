...
# $Id: deb_1099_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1099-1
#
# Authors:
...
We recommend that you upgrade your horde2 package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201099-1";
tag_summary = "The remote host is missing an update to horde2
announced via advisory DSA 1099-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301785");
 ...
 script_name("Debian Security Advisory DSA 1099-1 (horde2)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"horde2", ver:"2.2.8-1sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
