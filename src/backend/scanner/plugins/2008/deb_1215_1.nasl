...
# $Id: deb_1215_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1215-1
#
# Authors:
...
announced via advisory DSA 1215-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300909");
 ...
 script_name("Debian Security Advisory DSA 1215-1 (xine-lib)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libxine-dev", ver:"1.0.1-1sarge4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libxine1", ver:"1.0.1-1sarge4", rls:"DEB3.1")) != NULL) {
    report += res;
}
