...
# $Id: deb_1372_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1372-2
#
# Authors:
...
tag_insight = "It was discovered that ktorrent, a BitTorrent client for KDE, was vulnerable
...
announced via advisory DSA 1372-2.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201372-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300123");
 ...
 script_name("Debian Security Advisory DSA 1372-2 (ktorrent)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ktorrent", ver:"2.0.3+dfsg1-2.2etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
