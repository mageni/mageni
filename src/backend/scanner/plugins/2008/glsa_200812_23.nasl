...
tag_insight = "A buffer overflow vulnerability has been discovered in Imlib2.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302038");
 ...
 script_name("Gentoo Security Advisory GLSA 200812-23 (imlib2)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-libs/imlib2", unaffected: make_list("ge 1.4.2-r1"), vulnerable: make_list("lt 1.4.2-r1"))) != NULL) {
    report += res;
}
