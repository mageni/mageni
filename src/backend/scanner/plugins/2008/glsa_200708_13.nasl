...
tag_insight = "The ISC BIND random number generator uses a weak algorithm, making it
easier to guess the next query ID and perform a DNS cache poisoning
attack.";
tag_solution = "All ISC BIND users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=net-dns/bind-9.4.1_p1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200708-13
http://bugs.gentoo.org/show_bug.cgi?id=186556";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300209");
