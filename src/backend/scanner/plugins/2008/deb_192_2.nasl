...
# $Id: deb_192_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 192-2
#
# Authors:
...
tag_insight = "The security update from DSA 192-1 contained a syntax error which is
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20192-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300442");
