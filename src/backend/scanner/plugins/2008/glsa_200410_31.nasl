...
tag_insight = "Email virus scanning software relying on Archive::Zip can be fooled into
thinking a ZIP attachment is empty while it contains a virus, allowing
detection evasion.";
tag_solution = "All Archive::Zip users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=dev-perl/Archive-Zip-1.14'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-31
http://bugs.gentoo.org/show_bug.cgi?id=68616
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300214");
