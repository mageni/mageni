...
# $Id: deb_1000_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1000-2
#
# Authors:
...
We recommend that you upgrade your libapreq2, libapache2-mod-apreq2
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201000-2";
tag_summary = "The remote host is missing an update to libapreq2-perl
announced via advisory DSA 1000-2.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300733");
 ...
 script_name("Debian Security Advisory DSA 1000-2 (libapreq2-perl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libapache2-request-perl", ver:"2.04-dev-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
