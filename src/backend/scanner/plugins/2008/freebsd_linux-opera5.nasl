#
#VID d6b092bd-61e1-11da-b64c-0001020eed82
...
CVE-2005-3699
Opera Web Browser 8.50 and 8.0 through 8.0.2 allows remote attackers
to spoof the URL in the status bar via the title in an image in a link
to a trusted site within a form to the malicious site.";
...
http://www.vuxml.org/freebsd/d6b092bd-61e1-11da-b64c-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303454");
