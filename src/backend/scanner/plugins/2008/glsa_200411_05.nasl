...
tag_insight = "libxml2 contains multiple buffer overflows which could lead to the
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303933");
 ...
 script_name("Gentoo Security Advisory GLSA 200411-05 (libxml2)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-libs/libxml2", unaffected: make_list("ge 2.6.15"), vulnerable: make_list("lt 2.6.15"))) != NULL) {
    report += res;
}
