...
tag_insight = "BNC contains an input validation flaw which might allow a remote attacker
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-13
http://bugs.gentoo.org/show_bug.cgi?id=66912
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302433");
