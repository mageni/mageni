...
tag_insight = "PHP Toolkit does not quote parameters, allowing for PHP source code
disclosure on Apache, and a Denial of Service.";
tag_solution = "All PHP Toolkit users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-admin/php-toolkit-1.0.1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-19
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301912");
