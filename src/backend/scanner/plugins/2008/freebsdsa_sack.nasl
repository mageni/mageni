...
tag_insight = "SACK (Selective Acknowledgement) is an extension to the TCP/IP protocol
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303071");
 script_version("$Revision: 8023 $");
 script_tag(name:"last_modification", value:"$Date: 2017-12-07 09:36:26 +0100 (Thu, 07 Dec 2017) $");
 script_tag(name:"creation_date", value:"2008-09-04 20:41:11 +0200 (Thu, 04 Sep 2008)");
 script_bugtraq_id(16466);
 script_cve_id("CVE-2006-0433");
 script_tag(name:"cvss_base", value:"5.0");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
 name = "FreeBSD Security Advisory (FreeBSD-SA-06:08.sack.asc)";
 script_name(name);
