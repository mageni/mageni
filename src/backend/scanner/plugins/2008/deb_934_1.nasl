...
# $Id: deb_934_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to pound
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301947");
 ...
 script_name("Debian Security Advisory DSA 934-1 (pound)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"pound", ver:"1.8.2-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
