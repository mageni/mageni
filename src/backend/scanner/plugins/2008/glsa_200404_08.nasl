...
tag_insight = "Automake may be vulnerable to a symbolic link attack which may allow an
attacker to modify data or elevate their privileges.";
tag_solution = "Automake users should upgrade to the latest versions:

    # emerge --sync
    # emerge --ask --oneshot --verbose sys-devel/automake

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200404-08
http://bugs.gentoo.org/show_bug.cgi?id=45646";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302799");
