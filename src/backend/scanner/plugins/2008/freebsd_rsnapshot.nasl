#
#VID 8c5ad0cf-ba37-11d9-837d-000e0c2e438a
...
tag_insight = "The following package is affected: rsnapshot
...
http://www.vuxml.org/freebsd/8c5ad0cf-ba37-11d9-837d-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303686");
 ...
 script_bugtraq_id(13095);
 script_tag(name:"cvss_base", value:"4.6");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
 script_name("FreeBSD Ports: rsnapshot");
...
txt = "";
vuln = 0;
bver = portver(pkg:"rsnapshot");
if(!isnull(bver) && revcomp(a:bver, b:"1.1.7")<0) {
    txt += 'Package rsnapshot version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
