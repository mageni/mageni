...
# $Id: deb_325_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "eldav, a WebDAV client for Emacs, creates temporary files without
...
tag_summary = "The remote host is missing an update to eldav
announced via advisory DSA 325-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20325-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301488");
 ...
 script_name("Debian Security Advisory DSA 325-1 (eldav)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"eldav", ver:"0.0.20020411-1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
