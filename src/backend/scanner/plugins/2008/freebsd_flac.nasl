#
#VID ff65eecb-91e4-11dc-bd6c-0016179b2dd5
...
tag_insight = "The following package is affected: flac
...
http://www.vuxml.org/freebsd/ff65eecb-91e4-11dc-bd6c-0016179b2dd5.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302997");
 ...
 script_name("FreeBSD Ports: flac");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.1.2_2")<0) {
    txt += 'Package flac version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
