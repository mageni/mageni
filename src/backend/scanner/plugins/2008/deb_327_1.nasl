...
# $Id: deb_327_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Steve Kemp discovered several buffer overflows in xbl, a game, which
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20327-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300485");
