...
# $Id: deb_191_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several cross site scripting vulnerabilities have been found in
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20191-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303947");
 ...
 script_name("Debian Security Advisory DSA 191-1 (squirrelmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squirrelmail", ver:"1.2.6-1.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
