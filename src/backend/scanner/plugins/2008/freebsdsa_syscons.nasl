#
#ADV FreeBSD-SA-04:15.syscons.asc
...
tag_insight = "syscons(4) is the default console driver for FreeBSD.  Using the
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300028");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-04:15.syscons.asc)";
 script_name(name);
