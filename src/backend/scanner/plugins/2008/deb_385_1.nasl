...
# $Id: deb_385_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Jens Steube reported a pair of buffer overflow vulnerabilities in
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20385-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301308");
 ...
 script_name("Debian Security Advisory DSA 385-1 (hztty)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hztty", ver:"2.0-5.2woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
