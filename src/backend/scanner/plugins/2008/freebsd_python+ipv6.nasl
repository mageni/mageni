...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300173");
 ...
 script_name("FreeBSD Ports: python+ipv6");
...
if(!isnull(bver) && revcomp(a:bver, b:"0")>=0) {
    txt += 'Package python+ipv6 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
