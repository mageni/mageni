#
#VID da9e6438-bfc0-11d8-b00e-000347a4fa7d
...
by creating a user with the same name as an existing group that has
higher privileges.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300576");
 ...
 script_xref(name : "URL" , value : "http://secunia.com/advisories/11807");
 script_xref(name : "URL" , value : "http://www.vuxml.org/freebsd/da9e6438-bfc0-11d8-b00e-000347a4fa7d.html");
 exit(0);
}
