...
#
# Fedora Update for ImageMagick FEDORA-2015-3605
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for ImageMagick FEDORA-2015-3605");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ImageMagick'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"ImageMagick on Fedora 22");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~6.8.8.10~9.fc22", rls:"FC22")) != NULL)
  {
