...
if(description)
{
  ...
  script_name("RedHat Update for firefox RHSA-2015:2657-01");
...
if(release == "RHENT_7")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.5.0~3.el7_2", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"firefox-debuginfo", rpm:"firefox-debuginfo~38.5.0~3.el7_2", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "RHENT_6")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.5.0~2.el6_7", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"firefox-debuginfo", rpm:"firefox-debuginfo~38.5.0~2.el6_7", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.5.0~2.el5_11", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"firefox-debuginfo", rpm:"firefox-debuginfo~38.5.0~2.el5_11", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
