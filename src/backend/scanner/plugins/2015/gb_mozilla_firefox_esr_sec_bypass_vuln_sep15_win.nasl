...
# $Id: gb_mozilla_firefox_esr_sec_bypass_vuln_sep15_win.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
# Mozilla Firefox ESR Security Bypass Vulnerability - Sep15 (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.805748");
  ...
  script_name("Mozilla Firefox ESR Security Bypass Vulnerability - Sep15 (Windows)");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 38.2.1 on Windows");
