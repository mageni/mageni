...
#
# Ubuntu Update for tiff USN-2553-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-04-02 07:12:38 +0200 (Thu, 02 Apr 2015)");
  ...
  script_name("Ubuntu Update for tiff USN-2553-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"USN-2553-1 fixed vulnerabilities in LibTIFF.
One of the security fixes caused a regression when saving certain TIFF files with
a Predictor tag. The problematic patch has been temporarily backed out until a
more complete fix is available.
...
user privileges. (CVE-2014-9655)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2553-2/");
...
if(release == "UBUNTU14.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libtiff5:amd64", ver:"4.0.3-10ubuntu0.2", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libtiff5:i386", ver:"4.0.3-10ubuntu0.2", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libtiff5:amd64", ver:"4.0.3-7ubuntu0.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libtiff5:i386", ver:"4.0.3-7ubuntu0.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libtiff4", ver:"3.9.5-2ubuntu1.8", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libtiff4", ver:"3.9.2-2ubuntu0.16", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
