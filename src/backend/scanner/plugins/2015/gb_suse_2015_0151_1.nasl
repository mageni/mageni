...
# $Id: gb_suse_2015_0151_1.nasl 14110 2019-03-12 09:28:23Z cfischer $
#
# SuSE Update for flash-player SUSE-SU-2015:0151-1 (flash-player)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for flash-player SUSE-SU-2015:0151-1 (flash-player)");
...
if(release == "SLED12.0SP0")
{
  ...
  if ((res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.440~31.1", rls:"SLED12.0SP0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.440~31.1", rls:"SLED12.0SP0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
