...
#
# Ubuntu Update for linux-ti-omap4 USN-2641-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-06-24 06:17:54 +0200 (Wed, 24 Jun 2015)");
  script_cve_id("CVE-2015-1328");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-ti-omap4 USN-2641-2");
...
gain administrative privileges on the system.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2641-2/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-1466-omap4", ver:"3.2.0-1466.87", rls:"UBUNTU12.04 LTS")) != NULL)
  {
