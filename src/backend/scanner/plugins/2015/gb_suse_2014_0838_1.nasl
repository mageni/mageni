...
# $Id: gb_suse_2014_0838_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"rxvt-unicode was updated to ensure that window property values can not be
