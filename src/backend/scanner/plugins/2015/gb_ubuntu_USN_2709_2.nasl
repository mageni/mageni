...
#
# Ubuntu Update for pollinate USN-2709-2
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for pollinate USN-2709-2");
...
server.");
  script_tag(name:"affected", value:"pollinate on Ubuntu 15.04,
  Ubuntu 14.04 LTS");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2709-2/");
...
if(release == "UBUNTU15.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"pollinate", ver:"4.11-0ubuntu2.2", rls:"UBUNTU15.04")) != NULL)
  {
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"pollinate", ver:"4.7-0ubuntu1.4", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
