...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-266)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"nspr-debuginfo", rpm:"nspr-debuginfo~4.10.2~1.19.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nspr-devel", rpm:"nspr-devel~4.10.2~1.19.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nspr", rpm:"nspr~4.10.2~1.19.amzn1", rls:"AMAZON"))) {
    report += res;
  }
