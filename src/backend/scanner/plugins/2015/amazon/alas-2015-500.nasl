...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2015-500)");
  ...
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-500.html");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"gpgme-devel", rpm:"gpgme-devel~1.4.3~5.15.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gpgme", rpm:"gpgme~1.4.3~5.15.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gpgme-debuginfo", rpm:"gpgme-debuginfo~1.4.3~5.15.amzn1", rls:"AMAZON"))) {
    report += res;
  }
