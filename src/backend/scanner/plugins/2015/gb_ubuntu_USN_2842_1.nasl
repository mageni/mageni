...
#
# Ubuntu Update for linux USN-2842-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-12-18 05:44:22 +0100 (Fri, 18 Dec 2015)");
  script_cve_id("CVE-2015-8104", "CVE-2015-7799", "CVE-2015-7884", "CVE-2015-7885");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:N/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux USN-2842-1");
...
obtain sensitive information from the kernel. (CVE-2015-7885)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2842-1/");
...
if(release == "UBUNTU15.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-generic", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-generic-lpae", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-lowlatency", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-powerpc-e500mc", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-powerpc-smp", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-powerpc64-emb", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.19.0-41-powerpc64-smp", ver:"3.19.0-41.46", rls:"UBUNTU15.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
