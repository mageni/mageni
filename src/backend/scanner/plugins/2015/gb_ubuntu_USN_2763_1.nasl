...
#
# Ubuntu Update for linux-lts-trusty USN-2763-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for linux-lts-trusty USN-2763-1");
...
information, or cause a denial of service (system crash).");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2763-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-65-generic", ver:"3.13.0-65.106~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-65-generic-lpae", ver:"3.13.0-65.106~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
