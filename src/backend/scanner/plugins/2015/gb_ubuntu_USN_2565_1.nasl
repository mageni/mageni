...
#
# Ubuntu Update for linux USN-2565-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for linux USN-2565-1");
...
this flaw to read data from other sysctl settings. (CVE-2015-2042)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2565-1/");
...
if(release == "UBUNTU14.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-generic", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-generic-lpae", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-lowlatency", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-powerpc-e500mc", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-powerpc-smp", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-powerpc64-emb", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-34-powerpc64-smp", ver:"3.16.0-34.45", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
