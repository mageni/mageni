...
if (description)
{
  ...
  script_name("F5 BIG-IP - Linux kernel vulnerability CVE-2015-7613");

  script_xref(name:"URL", value:"https://support.f5.com/csp/article/K90230486");

  script_tag(name:"impact", value:"Exploitation of this issue requires shell access, and a non-standard and unsupported configuration (such as modifications to Linux configuration files) may expose this issue further. F5 does not recommend manually editing Linux configuration files. There is no remote access vector or data plane exposure.");
...
check_f5["LTM"] = make_array("affected",   "12.0.0;11.1.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;11.0.0;10.1.0-10.2.4;");

check_f5["AAM"] = make_array("affected",   "12.0.0;11.4.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;");

check_f5["AFM"] = make_array("affected",   "12.0.0;11.3.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;");

check_f5["AVR"] = make_array("affected",   "12.0.0;11.1.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;11.0.0;");

check_f5["APM"] = make_array("affected",   "12.0.0;11.1.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;11.0.0;10.1.0-10.2.4;");

check_f5["ASM"] = make_array("affected",   "12.0.0;11.1.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;11.0.0;10.1.0-10.2.4;");

check_f5["GTM"] = make_array("affected",   "11.1.0-11.6.1;",
                             "unaffected", "11.5.5;11.0.0;10.1.0-10.2.4;");

check_f5["LC"]  = make_array("affected",   "12.0.0;11.1.0-11.6.1;",
                             "unaffected", "13.0.0;12.1.0-12.1.2;12.0.0_HF3;11.5.5;11.0.0;10.1.0-10.2.4;");
