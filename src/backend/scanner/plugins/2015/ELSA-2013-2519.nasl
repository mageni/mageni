...
# $Id: ELSA-2013-2519.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2013-2519 - Unbreakable Enterprise kernel Security update. Please see the references for more insight.");
