...
# $Id: gb_suse_2015_1519_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"qemu was updated to fix two security issues and augments one non-security
  bug fix.
