...
if(description)
{
  ...
  script_name("Fedora Update for rubygem-actionpack FEDORA-2014-15342");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-actionpack'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"rubygem-actionpack on Fedora 21");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~4.1.5~2.fc21", rls:"FC21")) != NULL)
  {
