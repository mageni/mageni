...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882266");
  script_version("$Revision: 14058 $");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-09-02 06:59:27 +0200 (Wed, 02 Sep 2015)");
  script_cve_id("CVE-2015-4491");
  script_tag(name:"qod_type", value:"package");
  script_name("CentOS Update for gdk-pixbuf2 CESA-2015:1694 centos7");
...
which contain a backported patch to correct this issue.");
  script_tag(name:"affected", value:"gdk-pixbuf2 on CentOS 7");
  script_tag(name:"solution", value:"Please install the updated packages.");
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-September/021360.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"gdk-pixbuf2", rpm:"gdk-pixbuf2~2.28.2~5.el7_1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gdk-pixbuf2-devel", rpm:"gdk-pixbuf2-devel~2.28.2~5.el7_1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
