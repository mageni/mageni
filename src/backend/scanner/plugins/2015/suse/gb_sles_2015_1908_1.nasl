...
if(description)
{
  ...
  script_cve_id("CVE-2014-0222","CVE-2015-4037","CVE-2015-5239");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:1908-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-November/001668.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2015:1908-1 advisory.");
