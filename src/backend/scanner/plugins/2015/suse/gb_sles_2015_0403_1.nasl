...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2015.0403.1");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0403-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-February/001261.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xorg-x11-server'
  package(s) announced via the SUSE-SU-2015:0403-1 advisory.");
