...
if(description)
{
  ...
  script_cve_id("CVE-2014-8964","CVE-2015-0433","CVE-2015-0441");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:1273-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-July/001504.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mariadb'
  package(s) announced via the SUSE-SU-2015:1273-1 advisory.");
