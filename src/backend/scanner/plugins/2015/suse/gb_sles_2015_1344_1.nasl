...
if(description)
{
  ...
  script_cve_id("CVE-2013-1752","CVE-2013-1753","CVE-2014-4650");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:1344-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-August/001525.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'python'
  package(s) announced via the SUSE-SU-2015:1344-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Server 12 (ppc64le s390x x86_64), SUSE Linux Enterprise Server 12 (s390x x86_64), SUSE Linux Enterprise Server 12 (noarch)");
