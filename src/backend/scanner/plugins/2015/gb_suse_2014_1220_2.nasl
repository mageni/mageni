...
# $Id: gb_suse_2014_1220_2.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Mozilla NSS was updated to 3.16.5 to fix a RSA certificate forgery issue.
