...
# $Id: mgasa-2015-0265.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_name("Mageia Linux Local Check: mgasa-2015-0265");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0265");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"chromium-browser-stable", rpm:"chromium-browser-stable~43.0.2357.130~1.mga5", rls:"MAGEIA5")) != NULL) {
