...
# $Id: ELSA-2014-3081.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2014-3081 - Unbreakable Enterprise kernel security update. Please see the references for more insight.");
