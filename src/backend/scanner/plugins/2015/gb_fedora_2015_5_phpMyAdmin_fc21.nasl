...
#
# Fedora Update for phpMyAdmin FEDORA-2015-5
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for phpMyAdmin FEDORA-2015-5");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~4.5.1~1.fc21", rls:"FC21")) != NULL)
  {
