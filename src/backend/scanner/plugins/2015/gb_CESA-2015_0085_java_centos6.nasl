...
#
# CentOS Update for java CESA-2015:0085 centos6
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882105");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-01-27 05:50:04 +0100 (Tue, 27 Jan 2015)");
  ...
  script_name("CentOS Update for java CESA-2015:0085 centos6");
...
component in OpenJDK. A specially crafted font file could allo ...
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-January/020900.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.34~1.13.6.1.el6_6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-demo", rpm:"java-1.6.0-openjdk-demo~1.6.0.34~1.13.6.1.el6_6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-devel", rpm:"java-1.6.0-openjdk-devel~1.6.0.34~1.13.6.1.el6_6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-javadoc", rpm:"java-1.6.0-openjdk-javadoc~1.6.0.34~1.13.6.1.el6_6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-src", rpm:"java-1.6.0-openjdk-src~1.6.0.34~1.13.6.1.el6_6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
