...
# $Id: mgasa-2015-0280.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple flaws were discovered in the 2D, CORBA, JMX, Libraries and RMI components in OpenJDK.");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"java-1.8.0-openjdk", rpm:"java-1.8.0-openjdk~1.8.0.51~1.b16.1.mga5", rls:"MAGEIA5")) != NULL) {
