...
# $Id: mgasa-2015-0350.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_name("Mageia Linux Local Check: mgasa-2015-0350");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0350");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"xmltooling", rpm:"xmltooling~1.5.3~5.1.mga5", rls:"MAGEIA5")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"opensaml", rpm:"opensaml~2.5.2~6.1.mga5", rls:"MAGEIA5")) != NULL) {
  security_message(data:res);
  exit(0);
}
