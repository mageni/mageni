...
# $Id: ELSA-2010-0768.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2010-0768 - java-1.6.0-openjdk security and bug fix update. Please see the references for more insight.");
