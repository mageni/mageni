...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"python26-pygments", rpm:"python26-pygments~1.4~4.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python27-pygments", rpm:"python27-pygments~1.4~4.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python-pygments", rpm:"python-pygments~1.4~4.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
