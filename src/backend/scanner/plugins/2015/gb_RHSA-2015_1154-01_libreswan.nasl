...
if(release == "RHENT_7")
{
  ...
  if ((res = isrpmvuln(pkg:"libreswan", rpm:"libreswan~3.12~10.1.el7_1", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libreswan-debuginfo", rpm:"libreswan-debuginfo~3.12~10.1.el7_1", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
