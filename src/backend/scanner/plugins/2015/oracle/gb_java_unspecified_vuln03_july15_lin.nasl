...
# $Id: gb_java_unspecified_vuln03_july15_lin.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
# Oracle Java SE JRE Unspecified Vulnerability-03 July 2015 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108406");
  ...
  script_name("Oracle Java SE JRE Unspecified Vulnerability-03 July 2015 (Linux)");
  ...
  script_tag(name:"affected", value:"Oracle Java SE 7 update 80 on Linux.");
