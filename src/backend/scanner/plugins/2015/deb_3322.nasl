...
# $Id: deb_3322.nasl 14278 2019-03-18 14:47:26Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"librack-ruby", ver:"1.4.1-2.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"librack-ruby1.8", ver:"1.4.1-2.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"librack-ruby1.9.1", ver:"1.4.1-2.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ruby-rack", ver:"1.4.1-2.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
