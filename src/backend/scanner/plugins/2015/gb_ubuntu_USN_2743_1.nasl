...
#
# Ubuntu Update for firefox USN-2743-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-24 07:26:56 +0200 (Thu, 24 Sep 2015)");
  ...
  script_name("Ubuntu Update for firefox USN-2743-1");
...
with the pr ...
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2743-1/");
...
if(release == "UBUNTU15.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"41.0+build3-0ubuntu0.15.04.1", rls:"UBUNTU15.04")) != NULL)
  {
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"41.0+build3-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"41.0+build3-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
