...
# $Id: ELSA-2012-1416.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2012-1416 - kdelibs security update. Please see the references for more insight.");
