...
#
# Ubuntu Update for linux USN-2792-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-11-06 06:02:50 +0100 (Fri, 06 Nov 2015)");
  script_cve_id("CVE-2015-7613", "CVE-2015-0272", "CVE-2015-2925", "CVE-2015-5257");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux USN-2792-1");
...
(system crash). (CVE-2015-5257)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2792-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-generic", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-generic-pae", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-highbank", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-omap", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-powerpc-smp", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-powerpc64-smp", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-93-virtual", ver:"3.2.0-93.133", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
