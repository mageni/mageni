...
#
# Fedora Update for dovecot FEDORA-2015-7089
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158236.html");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"dovecot", rpm:"dovecot~2.2.16~2.fc21", rls:"FC21")) != NULL)
  {
