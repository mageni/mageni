...
#
# Ubuntu Update for linux-lts-trusty USN-2841-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-12-18 05:44:34 +0100 (Fri, 18 Dec 2015)");
  script_cve_id("CVE-2015-8104", "CVE-2015-7799", "CVE-2015-7885");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:N/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-lts-trusty USN-2841-2");
...
obtain sensitive information from the kernel. (CVE-2015-7885)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2841-2/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-73-generic", ver:"3.13.0-73.116~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-73-generic-lpae", ver:"3.13.0-73.116~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
