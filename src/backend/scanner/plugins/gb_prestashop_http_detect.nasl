...
if(description)
{
  ...
  script_version("2022-07-18T09:35:35+0000");
  script_tag(name:"last_modification", value:"2022-07-18 09:35:35 +0000 (Mon, 18 Jul 2022)");
...
foreach dir (make_list_unique("/", "/prestashop", http_cgi_dirs(port: port))) {
  ...
  res = http_get_cache(port: port, item: dir + "/error500.html");
