...
#
# Microsoft Office 2013 Service Pack 1 Defense in Depth Vulnerability (KB3172524)
#
# Authors:
...
if(msPath)
{
  ...
  if(msdllVer =~ "^15\.0" && version_is_less(version:msdllVer, test_version:"15.0.4971.1000"))
  {
