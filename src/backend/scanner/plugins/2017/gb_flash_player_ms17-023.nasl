...
#
# Microsoft IE And Microsoft Edge Multiple Flash Player Vulnerabilities (4014329)
#
# Authors:
...
if(version_is_less(version:flashVer, test_version:"25.0.0.127"))
{
  report = 'File checked:     ' + flashPath + '\n' +
           'File version:     ' + flashVer  + '\n' +
           'Vulnerable range: ' + "Less than 25.0.0.127" + '\n' ;
