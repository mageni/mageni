...
# $Id: gb_suse_2017_3016_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_name("SuSE Update for snack openSUSE-SU-2017:3016-1 (snack)");
...
if(release == "openSUSELeap42.2")
{
  ...
  if ((res = isrpmvuln(pkg:"snack", rpm:"snack~2.2.10~217.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"snack-debuginfo", rpm:"snack-debuginfo~2.2.10~217.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"snack-debugsource", rpm:"snack-debugsource~2.2.10~217.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"snack", rpm:"snack~2.2.10~220.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"snack-debuginfo", rpm:"snack-debuginfo~2.2.10~220.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"snack-debugsource", rpm:"snack-debugsource~2.2.10~220.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
