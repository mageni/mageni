...
# $Id: gb_suse_2017_3427_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  * Specially crafted content may cause denial of service");
  script_tag(name:"affected", value:"enigmail on openSUSE Leap 42.3, openSUSE Leap 42.2");
  script_tag(name:"solution", value:"Please install the updated packages.");

  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2017-12/msg00088.html");
...
if(release == "openSUSELeap42.2")
{
  ...
  if ((res = isrpmvuln(pkg:"enigmail", rpm:"enigmail~1.9.9~2.13.1", rls:"openSUSELeap42.2")) != NULL)
  {
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"enigmail", rpm:"enigmail~1.9.9~9.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
