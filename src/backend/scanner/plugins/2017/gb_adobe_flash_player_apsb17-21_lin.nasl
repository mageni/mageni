...
# $Id: gb_adobe_flash_player_apsb17-21_lin.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
# Adobe Flash Player Security Updates( apsb17-21 )-Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811467");
  script_version("$Revision: 11863 $");
  script_cve_id("CVE-2017-3080", "CVE-2017-3099", "CVE-2017-3100");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2018-10-12 11:42:02 +0200 (Fri, 12 Oct 2018) $");
  script_tag(name:"creation_date", value:"2017-07-12 15:27:27 +0530 (Wed, 12 Jul 2017)");
  script_name("Adobe Flash Player Security Updates( apsb17-21 )-Linux");
