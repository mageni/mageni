...
# $Id: gb_adobe_flash_within_chrome_apsb17-21_macosx.nasl 11874 2018-10-12 11:28:04Z mmartin $
#
# Adobe Flash Player Within Google Chrome Security Update (apsb17-21)-Mac OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811473");
  script_version("$Revision: 11874 $");
  script_cve_id("CVE-2017-3080", "CVE-2017-3099", "CVE-2017-3100");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2018-10-12 13:28:04 +0200 (Fri, 12 Oct 2018) $");
  script_tag(name:"creation_date", value:"2017-07-12 15:25:26 +0530 (Wed, 12 Jul 2017)");
  script_name("Adobe Flash Player Within Google Chrome Security Update (apsb17-21)-Mac OS X");
  ...
  26.0.0.137 within Google Chrome on Mac OS X.");
