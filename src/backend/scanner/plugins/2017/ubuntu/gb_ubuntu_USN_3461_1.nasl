...
# $Id: gb_ubuntu_USN_3461_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3461-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"nvidia-384", ver:"384.90-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU17.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"nvidia-384", ver:"384.90-0ubuntu0.17.04.1", rls:"UBUNTU17.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"nvidia-384", ver:"384.90-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
