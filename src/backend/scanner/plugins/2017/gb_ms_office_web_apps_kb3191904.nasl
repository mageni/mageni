...
#
# Microsoft Office Web Apps Multiple Remote Code Execution Vulnerabilities (KB3191904)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Microsoft Office Web Apps Server 2010
