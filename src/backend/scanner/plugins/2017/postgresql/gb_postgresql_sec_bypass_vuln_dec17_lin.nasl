...
# $Id: gb_postgresql_sec_bypass_vuln_dec17_lin.nasl 12142 2018-10-29 08:28:54Z cfischer $
#
# PostgreSQL Security Bypass Vulnerability-Dec17 (Linux)
#
# Authors:
...
if(description)
{
  ...
  before 9.6.6 and 10.x before 10.1 on Linux.");
