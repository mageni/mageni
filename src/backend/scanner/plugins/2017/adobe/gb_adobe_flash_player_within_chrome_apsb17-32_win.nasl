...
# $Id: gb_adobe_flash_player_within_chrome_apsb17-32_win.nasl 11983 2018-10-19 10:04:45Z mmartin $
#
# Adobe Flash Player Within Google Chrome Security Update( apsb17-32 )- Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811970");
  ...
  script_tag(name:"creation_date", value:"2017-10-17 11:14:32 +0530 (Tue, 17 Oct 2017)");
  script_name("Adobe Flash Player Within Google Chrome Security Update( apsb17-32 )- Windows");
  ...
  Google Chrome 27.0.0.159, or later.");
