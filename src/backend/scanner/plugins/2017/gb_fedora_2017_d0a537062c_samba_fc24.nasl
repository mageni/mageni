...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.872234");
  ...
  script_name("Fedora Update for samba FEDORA-2017-d0a537062c");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"samba on Fedora 24");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HOOF5AU3KIEFF673YP52D4HB33OADIWH");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~4.4.9~0.fc24", rls:"FC24")) != NULL)
  {
