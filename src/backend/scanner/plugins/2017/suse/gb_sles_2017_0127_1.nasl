...
if(description)
{
  ...
  script_cve_id("CVE-2016-9102","CVE-2016-9103","CVE-2016-9381");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0127-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-January/002561.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2017:0127-1 advisory.");
