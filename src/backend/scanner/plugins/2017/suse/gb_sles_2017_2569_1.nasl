...
if(description)
{
  ...
  script_cve_id("CVE-2016-10371","CVE-2017-7592","CVE-2017-7593");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2569-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-September/003259.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tiff'
  package(s) announced via the SUSE-SU-2017:2569-1 advisory.");
