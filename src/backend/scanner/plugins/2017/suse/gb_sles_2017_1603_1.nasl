...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1603-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-June/002953.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'netpbm'
  package(s) announced via the SUSE-SU-2017:1603-1 advisory.");
