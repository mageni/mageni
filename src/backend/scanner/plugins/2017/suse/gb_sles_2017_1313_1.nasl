...
if(description)
{
  ...
  script_cve_id("CVE-2015-7995","CVE-2015-9019","CVE-2016-4738");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1313-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-May/002887.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libxslt'
  package(s) announced via the SUSE-SU-2017:1313-1 advisory.");
