...
if(description)
{
  ...
  script_cve_id("CVE-2017-10664","CVE-2017-11434","CVE-2017-12135");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2327-2)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-November/003397.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2017:2327-2 advisory.");
