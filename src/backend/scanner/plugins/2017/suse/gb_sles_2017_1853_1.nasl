...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000365","CVE-2017-1000380","CVE-2017-7346");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1853-1)");
  ...
  package(s) announced via the SUSE-SU-2017:1853-1 advisory.");
