...
if(description)
{
  ...
  script_cve_id("CVE-2016-7444","CVE-2016-8610","CVE-2017-5335");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0348-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-February/002614.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'gnutls'
  package(s) announced via the SUSE-SU-2017:0348-1 advisory.");
