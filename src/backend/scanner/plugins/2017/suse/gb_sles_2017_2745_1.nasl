...
if(description)
{
  ...
  script_cve_id("CVE-2017-13078","CVE-2017-13079","CVE-2017-13080");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2745-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-October/003300.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wpa_supplicant'
  package(s) announced via the SUSE-SU-2017:2745-1 advisory.");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~2.2~15.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant-debuginfo", rpm:"wpa_supplicant-debuginfo~2.2~15.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant-debugsource", rpm:"wpa_supplicant-debugsource~2.2~15.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
