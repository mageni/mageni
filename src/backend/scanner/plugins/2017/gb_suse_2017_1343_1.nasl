...
# $Id: gb_suse_2017_1343_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for smb4k openSUSE-SU-2017:1343-1 (smb4k)
#
# Authors:
...
if(release == "openSUSELeap42.2")
{
  ...
  if ((res = isrpmvuln(pkg:"smb4k", rpm:"smb4k~1.2.1~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"smb4k-debuginfo", rpm:"smb4k-debuginfo~1.2.1~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"smb4k-debugsource", rpm:"smb4k-debugsource~1.2.1~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"smb4k-doc", rpm:"smb4k-doc~1.2.1~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"smb4k-lang", rpm:"smb4k-lang~1.2.1~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
