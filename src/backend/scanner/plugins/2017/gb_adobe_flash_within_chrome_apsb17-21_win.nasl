...
# $Id: gb_adobe_flash_within_chrome_apsb17-21_win.nasl 11977 2018-10-19 07:28:56Z mmartin $
#
# Adobe Flash Player Within Google Chrome Security Update (apsb17-21)-Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811470");
  script_version("$Revision: 11977 $");
  script_cve_id("CVE-2017-3080", "CVE-2017-3099", "CVE-2017-3100");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2018-10-19 09:28:56 +0200 (Fri, 19 Oct 2018) $");
  script_tag(name:"creation_date", value:"2017-07-12 15:23:26 +0530 (Wed, 12 Jul 2017)");
  script_name("Adobe Flash Player Within Google Chrome Security Update (apsb17-21)-Windows");
  ...
  26.0.0.137 within Google Chrome on Windows.");
