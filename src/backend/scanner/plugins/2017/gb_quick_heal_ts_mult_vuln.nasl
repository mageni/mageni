...
# $Id: gb_quick_heal_ts_mult_vuln.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
...
if(description)
{
  ...
  Total Security and is prone to multiple vulnerabilities.");
  ...
  script_mandatory_keys("QuickHeal/TotalSecurity6432/Installed");
  exit(0);
}
