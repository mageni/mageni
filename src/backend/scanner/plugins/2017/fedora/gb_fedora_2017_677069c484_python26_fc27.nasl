...
# $Id: gb_fedora_2017_677069c484_python26_fc27.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4JOH22BAPYPMNUQOSJFFIXZVBH5HAGQ3");
...
if(release == "FC27")
{
  ...
  if ((res = isrpmvuln(pkg:"python26", rpm:"python26~2.6.9~10.fc27", rls:"FC27")) != NULL)
  {
