...
# $Id: gb_isc_bind_rtype_any_query_dos_vuln_win.nasl 11900 2018-10-15 07:44:31Z mmartin $
#
...
if(description)
{
  ...
  9.10.4-P4  and 9.11.0 through 9.11.0-P1 on Windows.");

  script_tag(name:"solution", value:"Upgrade to ISC BIND version 9.9.9-P5 or
  9.10.4-P5 or 9.11.0-P2 or 9.9.9-S7 or later on Windows.");

  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"https://kb.isc.org/article/AA-01439/0");
...
if(bindVer =~ "^9")
{
  ...
  else if(version_in_range(version:bindVer, test_version:"9.8.5", test_version2:"9.8.8"))
  {
    fix = "9.9.9-P5";
    VULN = TRUE;
  }
