...
# $Id: gb_mantisbt_xss_vuln_win7.nasl 12818 2018-12-18 09:55:03Z ckuersteiner $
#
# MantisBT Multiple XSS Vulnerabilities (Windows)
#
# Authors:
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.140266");
  ...
  script_name("MantisBT Multiple XSS Vulnerabilities (Windows)");
