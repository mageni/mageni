...
#
# Fedora Update for java-1.8.0-openjdk-aarch32 FEDORA-2017-c1252ccd41
#
# Authors:
...
if(release == "FC25")
{
  ...
  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~aarch32~1.8.0.112~3.161109.fc25", rls:"FC25")) != NULL)
  {
