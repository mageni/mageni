...
# $Id: deb_4009.nasl 14284 2019-03-18 15:02:15Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libshadowsocks-libev-dev", ver:"2.6.3+ds-3+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libshadowsocks-libev2", ver:"2.6.3+ds-3+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"shadowsocks-libev", ver:"2.6.3+ds-3+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
