...
# $Id: deb_4042.nasl 14284 2019-03-18 15:02:15Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxml-libxml-perl", ver:"2.0128+dfsg-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxml-libxml-perl", ver:"2.0116+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
