...
# $Id: deb_4068.nasl 14284 2019-03-18 15:02:15Z cfischer $
#
# Auto-generated from advisory DSA 4068-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 4068-1 (rsync - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-4068.html");
...
its security tracker page linked in the references.");
  ...
  script_tag(name:"summary", value:"Several vulnerabilities were discovered in rsync, a fast, versatile,
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"rsync", ver:"3.1.2-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"rsync", ver:"3.1.1-3+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
