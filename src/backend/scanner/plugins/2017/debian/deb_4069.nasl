...
# $Id: deb_4069.nasl 14284 2019-03-18 15:02:15Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"otrs", ver:"3.3.18-1+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"otrs2", ver:"3.3.18-1+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"otrs", ver:"5.0.16-1+deb9u5", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"otrs2", ver:"5.0.16-1+deb9u5", rls:"DEB9")) != NULL) {
  report += res;
}
