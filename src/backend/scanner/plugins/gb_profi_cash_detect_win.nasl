...
# $Id: gb_profi_cash_detect_win.nasl 13048 2019-01-12 15:36:05Z mmartin $
#
# Fiducia & GAD IT AG Profi cash Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("Fiducia & GAD IT AG Profi cash Version Detection (Windows)");
  ...
  of Fiducia & GAD IT AG Profi Cash for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "Profi cash") continue;
