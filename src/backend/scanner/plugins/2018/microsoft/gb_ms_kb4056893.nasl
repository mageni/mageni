...
if(description)
{
  ...
  update according to Microsoft KB4056893");
...
if(version_in_range(version:edgeVer, test_version:"11.0.10240.0", test_version2:"11.0.10240.17737"))
{
  report = report_fixed_ver(file_checked:"\\Edgehtml.dll",
                            file_version:edgeVer, vulnerable_range:"11.0.10240.0 - 11.0.10240.17737");
