...
# $Id: gb_suse_2018_2590_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  script_name("SuSE Update for cobbler openSUSE-SU-2018:2590-1 (cobbler)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-09/msg00001.html");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~2.6.6~17.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cobbler-tests", rpm:"cobbler-tests~2.6.6~17.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cobbler-web", rpm:"cobbler-web~2.6.6~17.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"koan", rpm:"koan~2.6.6~17.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
