...
# $Id: gb_suse_2018_3825_1.nasl 12799 2018-12-14 07:38:54Z ckuersteiner $
#
# SuSE Update for squid openSUSE-SU-2018:3825-1 (squid)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for squid openSUSE-SU-2018:3825-1 (squid)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-11/msg00032.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid'
  package(s) announced via the openSUSE-SU-2018:3825_1 advisory.");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.5.21~18.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"squid-debuginfo", rpm:"squid-debuginfo~3.5.21~18.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"squid-debugsource", rpm:"squid-debugsource~3.5.21~18.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
