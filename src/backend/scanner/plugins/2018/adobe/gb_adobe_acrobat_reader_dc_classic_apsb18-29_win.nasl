...
#
# Adobe Acrobat Reader DC (Classic Track) Multiple Arbitrary Code Execution Vulnerabilities-apsb18-29 (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813858");
  ...
  script_name("Adobe Acrobat Reader DC (Classic Track) Multiple Arbitrary Code Execution Vulnerabilities-apsb18-29 (Windows)");
  ...
  2015.006.30434 and earlier versions on Windows.");
