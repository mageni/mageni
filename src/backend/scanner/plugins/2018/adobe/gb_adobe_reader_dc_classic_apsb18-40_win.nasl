...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814194");
  ...
  script_name("Adobe Reader DC 2015 Information Disclosure Vulnerability(apsb18-40)-Windows");
  ...
  script_tag(name:"affected", value:"Adobe Reader DC 2015 version 2015.x before 2015.006.30457 on Windows.");
