...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814028");
  ...
  script_name("Adobe Acrobat DC (Continuous Track) Security Updates(apsb18-34)-Mac OS X");
  ...
  2018.011.20058 and earlier on Mac OS X.");
