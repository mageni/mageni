...
if(version_is_less(version:flashVer, test_version:"31.0.0.108")) {
  report = report_fixed_ver(file_checked:flashPath, file_version:flashVer, vulnerable_range:"Less than 31.0.0.108");
