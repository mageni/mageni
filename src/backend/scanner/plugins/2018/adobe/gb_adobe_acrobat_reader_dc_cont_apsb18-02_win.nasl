...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812921");
  ...
  script_tag(name:"creation_date", value:"2018-02-15 12:24:40 +0530 (Thu, 15 Feb 2018)");
  script_name("Adobe Acrobat Reader DC (Continuous Track) Multiple Vulnerabilities-apsb18-02 (Windows)");
  ...
  2018.009.20050 and earlier versions on Windows.");
