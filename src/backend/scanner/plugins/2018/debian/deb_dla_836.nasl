...
# $Id: deb_dla_836.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"munin", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-async", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-common", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-doc", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-node", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-plugins-core", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-plugins-extra", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"munin-plugins-java", ver:"2.0.6-4+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
