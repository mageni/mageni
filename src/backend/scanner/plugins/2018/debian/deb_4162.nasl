...
# $Id: deb_4162.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DSA 4162-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"irssi", ver:"1.0.7-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"irssi-dev", ver:"1.0.7-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
