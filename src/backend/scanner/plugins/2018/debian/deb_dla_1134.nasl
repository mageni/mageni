...
# $Id: deb_dla_1134.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsdl-image1.2", ver:"1.2.12-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsdl-image1.2-dev", ver:"1.2.12-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
