...
# $Id: deb_dla_1047.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1047-1] supervisor security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"supervisor", ver:"3.0a8-1.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
