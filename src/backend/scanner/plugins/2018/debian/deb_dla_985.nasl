...
# $Id: deb_dla_985.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 985-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 985-1] libsndfile security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsndfile1", ver:"1.0.25-9.1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsndfile1-dev", ver:"1.0.25-9.1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sndfile-programs", ver:"1.0.25-9.1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
