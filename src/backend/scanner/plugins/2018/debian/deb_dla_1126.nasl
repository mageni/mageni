...
# $Id: deb_dla_1126.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1126-1] libxfont security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxfont-dev", ver:"1:1.4.5-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxfont1", ver:"1:1.4.5-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxfont1-dbg", ver:"1:1.4.5-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
