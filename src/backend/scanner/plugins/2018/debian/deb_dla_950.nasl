...
# $Id: deb_dla_950.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libtasn1-3", ver:"2.13-2+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtasn1-3-bin", ver:"2.13-2+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtasn1-3-dbg", ver:"2.13-2+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtasn1-3-dev", ver:"2.13-2+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
