...
# $Id: deb_dla_1094.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1094-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1094-1] tiff3 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libtiff4", ver:"3.9.6-11+deb7u8", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtiff4-dev", ver:"3.9.6-11+deb7u8", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtiffxx0c2", ver:"3.9.6-11+deb7u8", rls:"DEB7")) != NULL) {
  report += res;
}
