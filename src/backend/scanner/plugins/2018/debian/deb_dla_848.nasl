...
# $Id: deb_dla_848.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 848-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 848-1] freetype security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"freetype2-demos", ver:"2.4.9-1.1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfreetype6", ver:"2.4.9-1.1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfreetype6-dev", ver:"2.4.9-1.1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
