...
# $Id: deb_dla_933.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 933-1] roundcube security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"roundcube", ver:"0.7.2-9+deb7u7", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"roundcube-core", ver:"0.7.2-9+deb7u7", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"roundcube-mysql", ver:"0.7.2-9+deb7u7", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"roundcube-pgsql", ver:"0.7.2-9+deb7u7", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"roundcube-plugins", ver:"0.7.2-9+deb7u7", rls:"DEB7")) != NULL) {
  report += res;
}
