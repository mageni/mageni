...
# $Id: deb_dla_1486.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
We recommend that you upgrade your spice packages.");
  script_tag(name:"summary", value:"vulnerability was discovered in SPICE before version 0.14.1 where the
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libspice-server-dev", ver:"0.12.5-1+deb8u6", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.5-1+deb8u6", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-server1-dbg", ver:"0.12.5-1+deb8u6", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"spice-client", ver:"0.12.5-1+deb8u6", rls:"DEB8")) != NULL) {
  report += res;
}
