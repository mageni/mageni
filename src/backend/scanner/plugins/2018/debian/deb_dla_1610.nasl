...
# $Id: deb_dla_1610.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libtsk-dev", ver:"4.1.3-4+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtsk10", ver:"4.1.3-4+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sleuthkit", ver:"4.1.3-4+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
