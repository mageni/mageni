...
# $Id: deb_dla_1104.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1104-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1104-1] newsbeuter security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2017/09/msg00021.html");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"newsbeuter", ver:"2.5-2+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
