...
# $Id: deb_dla_1329.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1329-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"memcached", ver:"1.4.13-0.2+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
