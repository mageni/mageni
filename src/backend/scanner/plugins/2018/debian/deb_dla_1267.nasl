...
# $Id: deb_dla_1267.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1267-1] squid security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"squid", ver:"2.7.STABLE9-4.1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"squid-common", ver:"2.7.STABLE9-4.1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
