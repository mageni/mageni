...
# $Id: deb_dla_1336.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1336-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1336-1] rubygems security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"rubygems", ver:"1.8.24-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"rubygems-doc", ver:"1.8.24-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"rubygems1.8", ver:"1.8.24-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
