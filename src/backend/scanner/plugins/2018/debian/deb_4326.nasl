...
# $Id: deb_4326.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"openjdk-8-dbg", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-demo", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-doc", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-jdk", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-jdk-headless", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-jre", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-jre-headless", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-jre-zero", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjdk-8-source", ver:"8u181-b13-2~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
