...
# $Id: deb_dla_934.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 934-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 934-1] radicale security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-radicale", ver:"0.7-1.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"radicale", ver:"0.7-1.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
