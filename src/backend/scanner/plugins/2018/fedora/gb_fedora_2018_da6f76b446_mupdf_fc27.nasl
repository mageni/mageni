...
# $Id: gb_fedora_2018_da6f76b446_mupdf_fc27.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2CZGGVJMS2GEVUGZVLWXKPKKX256KEJU");
...
if(release == "FC27")
{
  ...
  if ((res = isrpmvuln(pkg:"mupdf", rpm:"mupdf~1.12.0~5.fc27", rls:"FC27")) != NULL)
  {
