...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4HSXYNZIAVW43BM2RI2PRUDWRYMPGC4L");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"poppler", rpm:"poppler~0.52.0~11.fc26", rls:"FC26")) != NULL)
  {
