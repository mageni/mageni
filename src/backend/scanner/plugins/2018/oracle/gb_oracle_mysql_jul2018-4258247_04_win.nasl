...
#
# Oracle MySQL Security Updates-04 (jul2018-4258247) Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813710");
  ...
  script_name("Oracle MySQL Security Updates-04 (jul2018-4258247) Windows");
  ...
  script_tag(name:"insight", value:"Multiple flaws exists due to an error in the
