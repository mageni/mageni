...
if(description)
{
  ...
  unspecified errors in components 'Event Management', 'Instance Management',
  'Enterprise Config Management' and 'Security Management'.");
...
affected = make_list('10.1.0.5', '10.2.0.3', '10.2.0.4');
