...
# $Id: gb_ubuntu_USN_3838_1.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3838-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libraw'
  package(s) announced via the USN-3838-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that LibRaw incorrectly handled photo files. If
a user or
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libraw9", ver:"0.15.4-1ubuntu0.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libraw16", ver:"0.18.8-1ubuntu0.2", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libraw15", ver:"0.17.1-1ubuntu0.4", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
