...
if(description)
{
  ...
  script_name("Ubuntu Update for unbound USN-3673-1");
...
Unbound into accepting a NODATA proof.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3673-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libunbound2", ver:"1.4.22-1ubuntu4.14.04.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"unbound", ver:"1.4.22-1ubuntu4.14.04.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libunbound2", ver:"1.6.5-1ubuntu0.2", rls:"UBUNTU17.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"unbound", ver:"1.6.5-1ubuntu0.2", rls:"UBUNTU17.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libunbound2", ver:"1.6.7-1ubuntu2.1", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"unbound", ver:"1.6.7-1ubuntu2.1", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libunbound2", ver:"1.5.8-1ubuntu1.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"unbound", ver:"1.5.8-1ubuntu1.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
