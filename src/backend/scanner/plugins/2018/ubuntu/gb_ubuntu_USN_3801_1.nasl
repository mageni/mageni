...
# $Id: gb_ubuntu_USN_3801_1.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3801-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the USN-3801-1 advisory.");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"63.0+build2-0ubuntu0.14.04.2", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"63.0+build2-0ubuntu0.18.04.2", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"63.0+build2-0ubuntu0.18.10.2", rls:"UBUNTU18.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"63.0+build2-0ubuntu0.16.04.2", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
