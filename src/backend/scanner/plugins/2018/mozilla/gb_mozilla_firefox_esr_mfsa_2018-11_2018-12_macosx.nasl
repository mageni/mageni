...
#
# Mozilla Firefox ESR Security Updates(mfsa_2018-11_2018-12)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813360");
  ...
  script_tag(name:"creation_date", value:"2018-05-11 12:35:20 +0530 (Fri, 11 May 2018)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2018-11_2018-12)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 52.8 on MAC OS X.");
