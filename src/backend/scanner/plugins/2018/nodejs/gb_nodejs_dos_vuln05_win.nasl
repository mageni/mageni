...
#
# Node.js Denial-of-Service Vulnerability-05 (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813470");
  ...
  script_name("Node.js Denial-of-Service Vulnerability-05 (Windows)");
  ...
  or 9.11.2 or later. Please see the references for more information.");
