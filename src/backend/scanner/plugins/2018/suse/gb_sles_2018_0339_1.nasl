...
if(description)
{
  ...
  script_cve_id("CVE-2016-9262","CVE-2016-9388","CVE-2016-9389");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0339-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003697.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'jasper'
  package(s) announced via the SUSE-SU-2018:0339-1 advisory.");
