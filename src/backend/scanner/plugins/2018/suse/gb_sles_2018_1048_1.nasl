...
if(description)
{
  ...
  script_cve_id("CVE-2017-18257","CVE-2018-1091","CVE-2018-7740");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1048-1)");
  ...
  package(s) announced via the SUSE-SU-2018:1048-1 advisory.");
