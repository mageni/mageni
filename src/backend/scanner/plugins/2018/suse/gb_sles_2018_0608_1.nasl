...
if(description)
{
  ...
  script_cve_id("CVE-2016-10169","CVE-2016-10170","CVE-2016-10171");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0608-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-March/003788.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wavpack'
  package(s) announced via the SUSE-SU-2018:0608-1 advisory.");
