...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:4210-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-December/004992.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libqt5-qtbase'
  package(s) announced via the SUSE-SU-2018:4210-1 advisory.");
