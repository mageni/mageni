...
if(description)
{
  ...
  script_cve_id("CVE-2017-15119","CVE-2017-15124","CVE-2017-16845");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0831-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-March/003848.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2018:0831-1 advisory.");
