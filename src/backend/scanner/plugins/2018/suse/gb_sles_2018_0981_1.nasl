...
if(description)
{
  ...
  script_cve_id("CVE-2018-9256","CVE-2018-9259","CVE-2018-9260");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0981-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-April/003900.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2018:0981-1 advisory.");
