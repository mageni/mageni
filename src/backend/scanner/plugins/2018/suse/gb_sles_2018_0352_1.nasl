...
if(description)
{
  ...
  script_cve_id("CVE-2017-14245","CVE-2017-14246","CVE-2017-14634");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0352-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003705.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libsndfile'
  package(s) announced via the SUSE-SU-2018:0352-1 advisory.");
