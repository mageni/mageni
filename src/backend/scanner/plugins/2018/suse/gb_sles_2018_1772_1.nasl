...
if(description)
{
  ...
  script_cve_id("CVE-2017-17741","CVE-2017-18241","CVE-2017-18249");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1772-1)");
  ...
  package(s) announced via the SUSE-SU-2018:1772-1 advisory.");
