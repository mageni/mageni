...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3640-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-November/004833.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libarchive'
  package(s) announced via the SUSE-SU-2018:3640-1 advisory.");
