...
if(description)
{
  ...
  script_cve_id("CVE-2016-3632","CVE-2016-8331","CVE-2017-11613");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1826-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004224.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tiff'
  package(s) announced via the SUSE-SU-2018:1826-1 advisory.");
