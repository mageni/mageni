...
#
# IT-Grundschutz, 13. EL, Maßnahme 5.066
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.95041");
  script_version("$Revision: 10646 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-27 09:00:22 +0200 (Fri, 27 Jul 2018) $");
  script_tag(name:"creation_date", value:"2013-11-20 16:13:39 +0100 (Wed, 20 Nov 2013)");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M5.066: Verwendung von TLS/SSL.

  ACHTUNG: Dieser Test wird nicht mehr unterstützt. Er wurde ersetzt durch
  den entsprechenden Test der nun permanent and die aktuelle EL angepasst
  wird: OID 1.3.6.1.4.1.25623.1.0.95067
