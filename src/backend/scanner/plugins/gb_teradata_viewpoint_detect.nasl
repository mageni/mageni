...
# $Id: gb_teradata_viewpoint_detect.nasl 13208 2019-01-22 07:11:16Z ckuersteiner $
#
...
if(description)
{
  ...
  script_version("$Revision: 13208 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-22 08:11:16 +0100 (Tue, 22 Jan 2019) $");
