...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832804");
  ...
  script_tag(name:"creation_date", value:"2024-01-24 17:20:03 +0530 (Wed, 24 Jan 2024)");
  script_name("Mozilla Firefox ESR Security Update (mfsa_2024-01_2024-04) - MAC OS X");
  ...
  attackers to run arbitrary code, bypass security restrictions, gain elevated
