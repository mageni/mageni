...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6587.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6587-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6587-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6587-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server, xwayland' package(s) announced via the USN-6587-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:1.20.13-1ubuntu1~20.04.14", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xwayland", ver:"2:1.20.13-1ubuntu1~20.04.14", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:21.1.4-2ubuntu1.7~22.04.7", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xwayland", ver:"2:22.1.1-1ubuntu0.10", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:21.1.7-1ubuntu3.6", rls:"UBUNTU23.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xwayland", ver:"2:22.1.8-1ubuntu1.4", rls:"UBUNTU23.04"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:21.1.7-3ubuntu2.6", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xwayland", ver:"2:23.2.0-1ubuntu0.4", rls:"UBUNTU23.10"))) {
    report += res;
  }
