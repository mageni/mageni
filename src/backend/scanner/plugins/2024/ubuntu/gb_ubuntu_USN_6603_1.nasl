...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6603.1");
  script_cve_id("CVE-2023-6606", "CVE-2023-6931", "CVE-2023-6932");
  ...
  script_name("Ubuntu: Security Advisory (USN-6603-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6603-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6603-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-6603-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.4.0-1165-aws", ver:"4.4.0-1165.180", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"4.4.0.1165.169", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
