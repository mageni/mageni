...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6591.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6591-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6591-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6591-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'postfix' package(s) announced via the USN-6591-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Timo Longin discovered that Postfix incorrectly handled certain email line
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postfix", ver:"2.11.0-1ubuntu1.2+esm2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postfix", ver:"3.1.0-3ubuntu0.4+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postfix", ver:"3.3.0-1ubuntu0.4+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postfix", ver:"3.4.13-0ubuntu1.3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postfix", ver:"3.6.4-1ubuntu1.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postfix", ver:"3.8.1-2ubuntu0.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
