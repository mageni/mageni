...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6606.1");
  script_cve_id("CVE-2023-51779", "CVE-2023-6606", "CVE-2023-6817", "CVE-2023-6931", "CVE-2024-0193");
  ...
  script_name("Ubuntu: Security Advisory (USN-6606-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6606-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6606-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.1' package(s) announced via the USN-6606-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.1.0-1029-oem", ver:"6.1.0-1029.29", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04", ver:"6.1.0.1029.30", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04a", ver:"6.1.0.1029.30", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04b", ver:"6.1.0.1029.30", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04c", ver:"6.1.0.1029.30", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
