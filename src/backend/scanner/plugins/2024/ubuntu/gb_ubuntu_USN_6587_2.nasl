...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6587.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6587-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6587-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6587-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server' package(s) announced via the USN-6587-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6587-1 fixed several vulnerabilities in X.Org. This update provides
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:1.18.4-0ubuntu0.12+esm9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xwayland", ver:"2:1.18.4-0ubuntu0.12+esm9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:1.19.6-1ubuntu4.15+esm4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xwayland", ver:"2:1.19.6-1ubuntu4.15+esm4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
