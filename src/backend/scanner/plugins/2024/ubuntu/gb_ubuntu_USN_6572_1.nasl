...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6572.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6572-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6572-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6572-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-6572-1 advisory.");
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1009-azure", ver:"6.5.0-1009.9", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1009-azure-fde", ver:"6.5.0-1009.9", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.5.0.1009.11", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.5.0.1009.11", rls:"UBUNTU23.10"))) {
    report += res;
  }
