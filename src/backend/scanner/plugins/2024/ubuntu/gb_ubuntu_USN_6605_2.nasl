...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6605.2");
  script_cve_id("CVE-2023-6040", "CVE-2023-6606", "CVE-2023-6931", "CVE-2023-6932");
  ...
  script_name("Ubuntu: Security Advisory (USN-6605-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6605-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6605-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm' package(s) announced via the USN-6605-2 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1105-kvm", ver:"5.4.0-1105.112", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.4.0.1105.101", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
