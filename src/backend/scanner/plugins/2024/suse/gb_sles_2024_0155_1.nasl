...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0155.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0155-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0155-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240155-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'suse-module-tools' package(s) announced via the SUSE-SU-2024:0155-1 advisory.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"suse-module-tools", rpm:"suse-module-tools~15.2.19~150200.4.18.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
