...
if(description)
{
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-23-38)");
  ...
  - CVE-2023-41273: Heap-based buffer overflow could allow authenticated administrators to execute
  code via a network

  - CVE-2023-41274: NULL pointer dereference could allow authenticated administrators to launch a
  ...
  script_tag(name:"solution", value:"Update to version 5.1.2.2533 build 20230926 or later.");
...
if (version =~ "^5\.1") {
  ...
  if (version_is_equal(version: version, test_version: "5.1.2.2533") &&
     (!build || version_is_less(version: build, test_version: "20230926"))) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.1.2.2533", fixed_build: "20230926");
    security_message(port: 0, data: report);
    exit(0);
