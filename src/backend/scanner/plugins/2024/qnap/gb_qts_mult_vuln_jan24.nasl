...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151478");
  script_version("2024-01-10T05:05:17+0000");
  script_tag(name:"last_modification", value:"2024-01-10 05:05:17 +0000 (Wed, 10 Jan 2024)");
  script_tag(name:"creation_date", value:"2024-01-09 02:58:18 +0000 (Tue, 09 Jan 2024)");
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-23-22, QSA-23-54, QSA-23-64)");
...
if (version =~ "^5\.1") {
  if (version_is_less(version: version, test_version:"5.1.3.2578")) {
    report = report_fixed_ver(installed_version: version, installed_build: build, fixed_version: "5.1.3.2578", fixed_build: "20231110");
