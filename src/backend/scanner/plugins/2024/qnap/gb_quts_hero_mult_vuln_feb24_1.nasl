...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151643");
  script_version("2024-02-09T05:06:25+0000");
  script_tag(name:"last_modification", value:"2024-02-09 05:06:25 +0000 (Fri, 09 Feb 2024)");
  script_tag(name:"creation_date", value:"2024-02-05 05:08:51 +0000 (Mon, 05 Feb 2024)");
  ...
  script_name("QNAP QuTS hero Multiple Vulnerabilities (QSA-23-30, QSA-23-47)");
  ...
  - CVE-2023-39297: An OS command injection has been reported to affect certain QNAP operating
  system versions. If exploited, the vulnerability could allow authenticated users to execute
  commands via a network.

  - CVE-2023-45025: An OS command injection has been reported to affect certain QNAP operating
  system versions. If exploited, the vulnerability could allow users to execute commands via a
  network when the system is in a certain configuration.");
  ...
  h5.1.4.2596 build 20231128 or later.");
