...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114305");
  ...
  script_name("Synology DiskStation Manager < 7.2.1-69057-2 Open Redirect Vulnerability (Synology-SA-24:02) - Unreliable Remote Version Check");
...
if (revcomp(a: version, b: "7.2.1-69057-2") < 0) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2.1-69057-2");
  security_message(port: 0, data: report);
  exit(0);
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.114304
