...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-12-21 20:58:00 +0000 (Thu, 21 Dec 2023)");

  script_cve_id("CVE-2023-6295");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress SiteOrigin Widgets Bundle Plugin < 1.51.0 LFI Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not validate user input before using it to
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/adc9ed9f-55b4-43a9-a79d-c7120764f47c/");
...
if( version_is_less( version: version, test_version: "1.51.0" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "1.51.0", install_path: location );
