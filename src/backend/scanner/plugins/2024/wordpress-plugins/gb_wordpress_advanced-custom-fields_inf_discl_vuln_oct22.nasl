...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2024-01-11 20:05:00 +0000 (Thu, 11 Jan 2024)");
  ...
  script_name("WordPress Advanced Custom Fields Plugin 3.1.1 < 6.0.3 Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Advanced Custom Fields' is prone to an
  ...
  script_xref(name:"URL", value:"https://patchstack.com/database/vulnerability/advanced-custom-fields/wordpress-advanced-custom-fields-plugin-3-1-1-6-0-2-custom-field-value-exposure");
...
if( version_in_range_exclusive( version: version, test_version_lo: "3.1.1", test_version_up: "6.0.3" ) ) {
