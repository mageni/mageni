...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885546");
  ...
  script_name("Fedora: Security Advisory for python-wled (FEDORA-2023-a04cc349e1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/S3H2YIKCALQYS72O5AQ3HML5NO72Y6VP");
...
programs to automate the behavior of WLED.");
  ...
  script_tag(name:"affected", value:"'python-wled' package(s) on Fedora 39.");
