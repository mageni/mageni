...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885527");
  ...
  script_tag(name:"creation_date", value:"2024-01-18 09:13:28 +0000 (Thu, 18 Jan 2024)");
  script_name("Fedora: Security Advisory for zabbix (FEDORA-2024-a7bec8b0bd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a7bec8b0bd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BYSYLA7VTHR25CBLYO5ZLEJFGU7HTHQB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zabbix'
  package(s) announced via the FEDORA-2024-a7bec8b0bd advisory.");
...
multitude of servers.");
  ...
  script_tag(name:"affected", value:"'zabbix' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~6.0.25~1.fc38", rls:"FC38"))) {
    report += res;
  }
