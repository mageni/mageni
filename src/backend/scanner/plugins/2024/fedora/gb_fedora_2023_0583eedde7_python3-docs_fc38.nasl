...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885557");
  ...
  script_tag(name:"creation_date", value:"2024-01-18 09:15:20 +0000 (Thu, 18 Jan 2024)");
  script_name("Fedora: Security Advisory for python3-docs (FEDORA-2023-0583eedde7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SOX7BCN6YL7B3RFPEEXPIU5CMTEHJOKR");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-docs", rpm:"python3-docs~3.11.7~1.fc38", rls:"FC38"))) {
    report += res;
  }
