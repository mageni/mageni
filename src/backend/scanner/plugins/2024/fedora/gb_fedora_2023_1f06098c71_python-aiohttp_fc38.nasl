...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885554");
  ...
  script_tag(name:"creation_date", value:"2024-01-18 09:14:13 +0000 (Thu, 18 Jan 2024)");
  script_name("Fedora: Security Advisory for python-aiohttp (FEDORA-2023-1f06098c71)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TUPUKOKUCAW3K652552LRVMHEOLQOWOF");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-aiohttp", rpm:"python-aiohttp~3.9.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
