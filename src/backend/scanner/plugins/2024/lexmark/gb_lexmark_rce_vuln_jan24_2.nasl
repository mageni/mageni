...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151622");
  script_version("2024-01-30T14:37:03+0000");
  script_tag(name:"last_modification", value:"2024-01-30 14:37:03 +0000 (Tue, 30 Jan 2024)");
  script_tag(name:"creation_date", value:"2024-01-30 05:05:24 +0000 (Tue, 30 Jan 2024)");
  script_tag(name:"cvss_base", value:"7.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:C/I:C/A:C");

  script_cve_id("CVE-2023-50735");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Lexmark Printer RCE Vulnerability (CVE-2023-50735)");
  ...
  script_tag(name:"insight", value:"A heap corruption vulnerability has been identified in
  ...
  script_xref(name:"URL", value:"https://publications.lexmark.com/publications/security-alerts/CVE-2023-50735.pdf");
