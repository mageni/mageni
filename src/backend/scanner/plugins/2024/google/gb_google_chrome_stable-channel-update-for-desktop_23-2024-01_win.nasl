...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832800");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_23-2024-01) - Windows");
  ...
  121.0.6167.85 on Windows");

  script_tag(name:"solution", value:"Upgrade to version 121.0.6167.85/.86 or
...
if(version_is_less(version:vers, test_version:"121.0.6167.85")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"121.0.6167.85/.86", install_path:path);
