...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832785");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_16-2024-01) - Linux");
  ...
  120.0.6099.224 on Linux");

  script_tag(name:"solution", value:"Upgrade to version 120.0.6099.224 or
...
if(version_is_less(version:vers, test_version:"120.0.6099.224")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"120.0.6099.224", install_path:path);
