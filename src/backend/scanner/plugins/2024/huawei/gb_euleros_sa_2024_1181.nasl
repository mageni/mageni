...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1181");
  ...
  script_name("Huawei EulerOS: Security Advisory for mozjs60 (EulerOS-SA-2024-1181)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1181");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1181");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mozjs60' package(s) announced via the EulerOS-SA-2024-1181 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozjs60", rpm:"mozjs60~60.2.2~4.h2.r9.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
