...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1005");
  ...
  script_name("Huawei EulerOS: Security Advisory for curl (EulerOS-SA-2024-1005)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1005");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1005");
  script_xref(name:"URL", value:"https://curl.se/libcurl/c/curl_easy_duphandle.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'curl' package(s) announced via the EulerOS-SA-2024-1005 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.69.1~2.h24.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.69.1~2.h24.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
