...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1116");
  script_cve_id("CVE-2023-38469", "CVE-2023-38471", "CVE-2023-38472", "CVE-2023-38473");
  ...
  script_name("Huawei EulerOS: Security Advisory for avahi (EulerOS-SA-2024-1116)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1116");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1116");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'avahi' package(s) announced via the EulerOS-SA-2024-1116 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A vulnerability, which was classified as problematic, has been found in avahi (version now known). Affected by this issue is the function avahi_dns_packet_append_record. There is no information about possible countermeasures known. It may be suggested to replace the affected object with an alternative product.(CVE-2023-38469)
...
A vulnerability was found in avahi (the affected version unknown). It has been classified as problematic. Affected is the function avahi_alternative_host_name. There is no information about possible countermeasures known. It may be suggested to replace the affected object with an alternative product.(CVE-2023-38473)");
  ...
  script_tag(name:"affected", value:"'avahi' package(s) on Huawei EulerOS V2.0SP11(x86_64).");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-libs", rpm:"avahi-libs~0.8~12.h5.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
