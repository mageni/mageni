...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1137");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdb (EulerOS-SA-2024-1137)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1137");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1137");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdb' package(s) announced via the EulerOS-SA-2024-1137 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~7.6.1~110.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-gdbserver", rpm:"gdb-gdbserver~7.6.1~110.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
