...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1150");
  ...
  script_name("Huawei EulerOS: Security Advisory for libX11 (EulerOS-SA-2024-1150)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1150");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1150");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libX11' package(s) announced via the EulerOS-SA-2024-1150 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libX11", rpm:"libX11~1.6.5~1.h8.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libX11-common", rpm:"libX11-common~1.6.5~1.h8.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libX11-devel", rpm:"libX11-devel~1.6.5~1.h8.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
