...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1077");
  ...
  script_name("Huawei EulerOS: Security Advisory for avahi (EulerOS-SA-2024-1077)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1077");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1077");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'avahi' package(s) announced via the EulerOS-SA-2024-1077 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-libs", rpm:"avahi-libs~0.8~1.h13.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
