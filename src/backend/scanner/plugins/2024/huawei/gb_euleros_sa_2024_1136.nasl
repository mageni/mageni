...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1136");
  ...
  script_name("Huawei EulerOS: Security Advisory for curl (EulerOS-SA-2024-1136)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1136");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1136");
  script_xref(name:"URL", value:"https://curl.se/libcurl/c/curl_easy_duphandle.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'curl' package(s) announced via the EulerOS-SA-2024-1136 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.29.0~46.h29.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.29.0~46.h29.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl-devel", rpm:"libcurl-devel~7.29.0~46.h29.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
