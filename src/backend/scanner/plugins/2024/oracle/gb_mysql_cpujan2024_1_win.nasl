...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151555");
  script_version("2024-01-19T05:06:18+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:18 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"creation_date", value:"2024-01-17 04:55:22 +0000 (Wed, 17 Jan 2024)");
  ...
  script_cve_id("CVE-2024-20983");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.x <= 8.0.34 Security Update (cpujan2024) - Windows");
