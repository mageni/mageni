...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832765");
  ...
  script_cve_id("CVE-2024-21320", "CVE-2024-21307", "CVE-2024-21306", "CVE-2024-21305",
                ...
                "CVE-2024-21311", "CVE-2024-21310", "CVE-2024-21309", "CVE-2024-20700",
  ...
  script_tag(name:"creation_date", value:"2024-01-10 10:28:50 +0530 (Wed, 10 Jan 2024)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5034121)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5034121");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5034121");
...
if(version_is_less(version:fileVer, test_version:"10.0.22000.2713")) {
  report = report_fixed_ver(file_checked:dllPath + "\system32\user32.dll", file_version:fileVer, vulnerable_range:"Less than 10.0.22000.2713");
