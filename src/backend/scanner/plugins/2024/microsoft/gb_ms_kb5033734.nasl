...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832782");
  ...
  script_name(".NET Core Multiple Vulnerabilities (KB5033734)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5033734.");
  ...
  script_tag(name:"affected", value:".NET Core runtime 7.0 before 7.0.15 and
  .NET Core SDK before 7.0.405.");

  script_tag(name:"solution", value:"Upgrade .NET Core runtime to version 7.0.15
  or later or upgrade .NET Core SDK to version 7.0.405 or later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://github.com/dotnet/core/blob/main/release-notes/7.0/7.0.15/7.0.15.md");
...
if(corerunVer) {
  if(corerunVer =~ "^7\.0" && version_is_less(version:corerunVer, test_version:"7.0.15")) {
    fix = "7.0.15 or later";
  }
}

else if(codesdkVer) {
  if(version_in_range(version:codesdkVer, test_version:"7.0", test_version2:"7.0.404")) {
    fix1 = "7.0.405 or later";
  }
}
