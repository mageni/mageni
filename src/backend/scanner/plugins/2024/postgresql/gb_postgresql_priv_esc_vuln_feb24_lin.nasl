...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114331");
  ...
  script_name("PostgreSQL 12.x < 12.18, 13.x < 13.14, 14.x < 14.11, 15.x < 15.6, 16.x < 16.1 Privilege Escalation Vulnerability - Linux");
