...
# $Id: win_uac_apps_install_prompt.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for User Account Control: Detect application installations and prompt for elevation
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312533");
...
The policy setting controls the behavior of application installation detection
for the entire system. Some software might attempt to install itself after being
