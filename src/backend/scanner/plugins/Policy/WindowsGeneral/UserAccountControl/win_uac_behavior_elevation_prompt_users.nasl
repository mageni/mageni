...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312527");
  ...
  script_name('Microsoft Windows: User Account Control: Behavior of the elevation prompt for standard users');
...
The policy setting controls the behavior of the elevation prompt for standard
users.");
  exit(0);
}
