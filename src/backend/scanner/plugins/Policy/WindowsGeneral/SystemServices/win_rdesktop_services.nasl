...
# $Id: win_rdesktop_services.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Remote Desktop Services (TermService)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312684");
...
'Remote Desktop Services (TermService)' on Windows hosts (at least
Windows 7).

The service allows users to connect interactively to a remote computer. Remote
Desktop and Remote Desktop Session Host Server depend on this service.");
  exit(0);
}
