...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312690");
  ...
  script_name('Microsoft Windows: MSS: IP source routing protection level');
...
title = 'MSS: (DisableIPSourceRouting) IP source routing protection level (protects against packet spoofing)';
