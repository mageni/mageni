...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109932");
  ...
  script_name("Windows Defender Firewall: Private Profile: Apply local connection security rules");
...
win_min_ver = "6.1";
title = "Private Profile: Settings: Apply local connection security rules";
