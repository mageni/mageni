...
# $Id: win_domain_sign_secure_channel.nasl 10661 2018-07-27 13:27:42Z emoss $
#
# Check value for Domain member: Digitally sign secure channel data (when possible)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312586");
  ...
  script_name('Microsoft Windows: Digitally sign secure channel data (when possible)');
...
'Domain member: Digitally sign secure channel data (when possible)' on Windows
...
member must be signed. Logon information that is transmitted over the secure
