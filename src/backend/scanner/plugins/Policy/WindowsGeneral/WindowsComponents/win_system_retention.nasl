...
# $Id: win_system_retention.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for System: Control Event Log behavior when the log file reaches
# its maximum size
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312465");
  script_version("$Revision: 10989 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-15 16:57:51 +0200 (Wed, 15 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-26 15:32:50 +0200 (Tue, 26 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: Event Log behavior when log file reaches its max size (System)');
...
The setting controls Event Log behavior when the log file reaches its maximum
size.
...
Event Log Service/System/' + title;
type = 'HKLM';
