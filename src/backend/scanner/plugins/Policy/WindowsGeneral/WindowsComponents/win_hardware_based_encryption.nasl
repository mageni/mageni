...
# $Id: win_hardware_based_encryption.nasl 10893 2018-08-10 13:07:24Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312415");
...
'Configure use of hardware-based encryption for fixed data drives' on Windows
