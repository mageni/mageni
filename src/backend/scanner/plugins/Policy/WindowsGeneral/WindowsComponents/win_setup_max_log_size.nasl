...
# $Id: win_setup_max_log_size.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Specify the maximum log file size (Setup)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312482");
  ...
  script_name('Microsoft Windows: Specify the maximum log file size (Setup)');
...
'Setup: Specify the maximum log file size' on Windows hosts (at least Windows 7).
