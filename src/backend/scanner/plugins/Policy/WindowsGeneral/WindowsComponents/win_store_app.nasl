...
# $Id: win_store_app.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Turn off the Store application
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312466");
  ...
  script_name('Microsoft Windows: Store application');
...
'Turn off the Store application' on Windows hosts (at least Windows 8.1).

The setting controls the access to the Store application.");
  exit(0);
}
