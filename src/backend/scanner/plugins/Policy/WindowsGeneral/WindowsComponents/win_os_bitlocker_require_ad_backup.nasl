...
# $Id: win_os_bitlocker_require_ad_backup.nasl 10893 2018-08-10 13:07:24Z emoss $
#
# Check value for Choose how BitLocker-protected operating system drives can be
# recovered: Do not enable BitLocker until recovery information is stored to AD
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312429");
...
operating system drives' on Windows hosts (at least Windows 7).
...
The option controls prevents users from enabling BitLocker unless the computer
