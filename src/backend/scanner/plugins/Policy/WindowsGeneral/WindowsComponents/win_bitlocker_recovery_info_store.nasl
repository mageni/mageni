...
# $Id: win_bitlocker_recovery_info_store.nasl 10842 2018-08-08 14:01:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312442");
  script_version("$Revision: 10842 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-08 16:01:21 +0200 (Wed, 08 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-25 15:15:54 +0200 (Mon, 25 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: Recovering of BitLocker-protected fixed drives (infos to store)');
...
'Choose how BitLocker-protected fixed drives can be recovered: Configure storage
of BitLocker recovery information to AD DS' on Windows hosts (at least Windows 7).
...
title = 'Choose how BitLocker-protected fixed drives can be recovered: Configure storage of BitLocker recovery information to AD DS';
fixtext = 'Set following UI path accordingly:
Computer Configuration/Administrative Templates/Windows Components/
BitLocker Drive Encryption/Fixed Data Drives/' + title;
type = 'HKLM';
key = 'Software\\Policies\\Microsoft\\FVE';
item = 'FDVActiveDirectoryInfoToStore';
