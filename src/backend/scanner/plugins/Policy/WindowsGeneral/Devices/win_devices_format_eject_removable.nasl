...
# $Id: win_devices_format_eject_removable.nasl 10649 2018-07-27 07:16:55Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312365");
  ...
  script_name('Microsoft Windows: Devices: Allowed to format and eject removable media');
...
'Devices: Allowed to format and eject removable media' on Windows hosts (at 
least Windows 7).
...
themselves full control, and view or modify any file. 
The policy setting determines who is allowed to format and eject removable media.");
  exit(0);
}
