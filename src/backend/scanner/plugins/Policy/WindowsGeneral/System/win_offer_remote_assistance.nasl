...
# $Id: win_offer_remote_assistance.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Configure Offer Remote Assistance
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312642");
...
'Configure Offer Remote Assistance' on Windows hosts (at least Windows 8.1).

The setting turns on or off Offer (Unsolicited) Remote Assistance on this computer.");
  exit(0);
}
