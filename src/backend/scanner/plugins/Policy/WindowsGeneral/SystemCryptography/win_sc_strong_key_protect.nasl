...
# $Id: win_sc_strong_key_protect.nasl 10740 2018-08-02 14:13:50Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312511");
  ...
  script_add_preference(name:"Minimum", type:"radio", value:"1;0;2");
