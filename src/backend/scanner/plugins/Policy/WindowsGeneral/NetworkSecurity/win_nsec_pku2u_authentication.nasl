...
# $Id: win_nsec_pku2u_authentication.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for Network security: Allow PKU2U authentication requests to this computer to use online identities
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312369");
  ...
  script_name('Microsoft Windows: Network security: Allow PKU2U authentication requests');
...
online identities' on Windows hosts (at least Windows 7).

The policy setting controls if online identities can be used by PKU2U, which is
a peer-to-peer authentication protocol. Authentication will be centrally managed
