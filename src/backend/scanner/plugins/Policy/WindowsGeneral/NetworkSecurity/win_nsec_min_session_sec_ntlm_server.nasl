...
# $Id: win_nsec_min_session_sec_ntlm_server.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for Network security: Minimum session security for NTLM SSP based (including secure RPC) servers
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312373");
  script_version("$Revision: 10740 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-02 16:13:50 +0200 (Thu, 02 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-12 12:33:08 +0200 (Tue, 12 Jun 2018)");
  ...
  script_add_preference(name:"Value", type:"radio", value:"0;16;32;524288;536870912");
  script_mandatory_keys("Compliance/Launch");
  script_tag(name: "summary", value: "This test checks the setting for policy
'Network security: Minimum session security for NTLM SSP based (including secure
RPC) servers' on Windows hosts (at least Windows 7).

The policy setting allows a client device to require the negotiation of 128-bit
encryption or NTLMv2 session security. These values are dependent on the Network
security: LAN Manager authentication level policy setting value.");
  exit(0);
}
