...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312562");
  ...
  script_name('Microsoft Windows: Network access: Restrict anonymous access to Named Pipes and Shares');
...
The policy setting controls the restriction of anonymous access to only those
shared folders and pipes that are named in the Network access: Named pipes that
