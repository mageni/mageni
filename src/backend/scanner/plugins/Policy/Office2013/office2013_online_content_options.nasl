...
# $Id: office2013_online_content_options.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Online content options
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312337");
  ...
  script_name('Microsoft Office 2013: Online content options');
  ...
  script_tag(name: "summary", value: 'Check Setting "Online content options" (Microsoft Office 2013).');
  exit(0);
}
