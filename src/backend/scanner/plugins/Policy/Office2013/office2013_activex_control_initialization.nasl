...
# $Id: office2013_activex_control_initialization.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for ActiveX Control Initialization
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312315");
  ...
  script_name('Microsoft Office 2013: ActiveX Control Initialization');
  ...
  script_tag(name: "summary", value: 'Check Setting "ActiveX Control Initialization" (Microsoft Office 2013).');
  exit(0);
}
