...
# $Id: office2013_block_signing_into_office.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Block signing into Office
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312308");
  ...
  script_name('Microsoft Office 2013: Block signing into Office');
  ...
  script_tag(name: "summary", value: 'Check Setting "Block signing into Office" (Microsoft Office 2013).');
  exit(0);
}
...
type = 'HKCU';
key = 'Software\\Policies\\Microsoft\\Office\\15.0\\common\\signin';
item = 'signinoptions';
