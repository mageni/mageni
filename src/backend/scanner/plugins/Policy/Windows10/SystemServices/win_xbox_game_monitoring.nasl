...
# $Id: win_xbox_game_monitoring.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Xbox Game Monitoring (xbgm)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312296");
  ...
  script_name('Microsoft Windows 10: Service: Xbox Game Monitoring');
...
'Xbox Game Monitoring (xbgm)' on Windows hosts (Windows 10).

The service monitors games.");
  exit(0);
}
