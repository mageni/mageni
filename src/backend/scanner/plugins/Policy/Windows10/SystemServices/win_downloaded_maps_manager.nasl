...
# $Id: win_downloaded_maps_manager.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Downloaded Maps Manager (MapsBroker)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312292");
  ...
  script_name('Microsoft Windows 10: Service: Downloaded Maps Manager');
...
'Downloaded Maps Manager (MapsBroker)' on Windows hosts (Windows 10).

The service is for application access to downloaded maps. The service is
started by application accessing downloaded maps.");
  exit(0);
}
