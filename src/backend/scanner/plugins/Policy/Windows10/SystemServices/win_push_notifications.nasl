...
# $Id: win_push_notifications.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Windows Push Notifications System Service (WpnService)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312294");
  ...
  script_name('Microsoft Windows 10: Service: Windows Push Notifications System Service');
...
'Windows Push Notifications System Service (WpnService)' on Windows hosts (Windows 10).

The service runs in session 0 and hosts the notification platform and connection
...
title = 'Windows Push Notifications System Service';
