...
# $Id: win_kms_client_online_avs.nasl 10989 2018-08-15 14:57:51Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312233");
  ...
  script_name('Microsoft Windows 10: KMS Client Online AVS Validation');
...
title = 'Turn off KMS Client Online AVS Validation';
fixtext = 'Set following UI path accordingly:
Computer Configuration/Administrative Templates/Windows Components/
Software Protection Platform/' + title;
type = 'HKLM';
