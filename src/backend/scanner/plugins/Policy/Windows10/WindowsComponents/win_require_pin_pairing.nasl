...
# $Id: win_require_pin_pairing.nasl 10961 2018-08-14 14:21:06Z emoss $
#
# Check value for Require pin for pairing
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312209");
  ...
  script_name('Microsoft Windows 10: Require pin for pairing');
...
'Require pin for pairing' on Windows hosts (at least Windows 10).

The policy setting controls whether a pin is required for pairing.");
  exit(0);
}
