...
# $Id: win_edge_bypass_sites.nasl 10989 2018-08-15 14:57:51Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312203");
...
'Prevent bypassing Windows Defender SmartScreen prompts for sites' on Windows
hosts (at least Windows 10).

The setting configures whether users can override the Windows Defender
SmartScreen warnings about potentially malicious websites.");
  exit(0);
}
