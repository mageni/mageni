...
# $Id: win10_enable_computer_user_accounts_trusted_for_delegation.nasl 10649 2018-07-27 07:16:55Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312258");
  ...
  script_name('Microsoft Windows 10: Enable computer and user accounts to be trusted for delegation');
