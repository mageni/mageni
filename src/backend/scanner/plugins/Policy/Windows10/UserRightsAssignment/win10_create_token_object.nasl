...
# $Id: win10_create_token_object.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Create a token object (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312262");
  ...
  script_name('Microsoft Windows 10: Create a token object');
...
accounts a process can use to create a token, and which accounts it can then use 
to gain access to local resources when the process uses NtCreateToken() 
...
select = 'AccountList';
keyname = 'SeCreateTokenPrivilege';
