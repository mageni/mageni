...
# $Id: win10_logon_as_service.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Log on as a service (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312246");
  ...
  script_name('Microsoft Windows 10: Log on as a service');
...
service accounts can register a process as a service. Running a process under a 
