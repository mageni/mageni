...
# $Id: win_spotlight_lockscreen.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Configure Windows spotlight on lock screen
# (users listed in HKU)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312239");
...
'Configure Windows spotlight on lock screen' on Windows hosts (at least Windows 10).

The setting configures Windows spotlight on the lock screen.");
  exit(0);
}
