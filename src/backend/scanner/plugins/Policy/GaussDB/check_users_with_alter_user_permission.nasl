...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.115008");
  script_version("2020-07-29T09:51:47+0000");
  script_tag(name:"last_modification", value:"2020-07-30 10:23:02 +0000 (Thu, 30 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-04-07 13:53:55 +0000 (Tue, 07 Apr 2020)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");

  script_name("ZSQL: Check for users with ALTER USER permission");
  ...
  script_tag(name:"summary", value:"Searches for users and roles with ALTER USER permission and
checks whether they are authorized to have it.A user with the ALTER USER permission can modify other
...
cmd = "SELECT USERNAME, PRIVILEGE FROM DB_USER_SYS_PRIVS WHERE USERNAME = 'user_name' AND PRIVILEGE = 'ALTER USER'";
title = "Check for users with ALTER USER permission";
solution = "1)REVOKE ALTER USER FROM user_name
2)REVOKE ALTER USER FROM role_name";
test_type = "SQL_Query";
