...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150069");
  ...
  script_name("Linux: SSH MaxAuthTries");
  ...
  script_add_preference(name:"Value", type:"entry", value:"4", id:1);
...
if(get_kb_item("Policy/linux/sshd_config/ERROR")){
  ...
  value = get_kb_item("Policy/linux/sshd_config/maxauthtries");
