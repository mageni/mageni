...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.880714");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'imap'
  ...
  script_tag(name:"affected", value:"imap on CentOS 3");
  script_tag(name:"insight", value:"The imap package provides server daemons for both the IMAP (Internet
