...
if(description)
{
  script_xref(name:"URL", value:"http://lists.mandriva.com/security-announce/2011-04/msg00007.php");
  script_oid("1.3.6.1.4.1.25623.1.0.831363");
  ...
  script_name("Mandriva Update for logrotate MDVSA-2011:065 (logrotate)");
  ...
  script_tag(name:"affected", value:"logrotate on Mandriva Linux 2009.0,
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered and corrected in logrotate:
  ...
  Program. The updated packages have been upgraded to the 3.7.9 version and
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"logrotate", rpm:"logrotate~3.7.9~0.1mdvmes5.2", rls:"MNDK_mes5")) != NULL)
  {
...
if(release == "MNDK_2010.1")
{
  ...
  if ((res = isrpmvuln(pkg:"logrotate", rpm:"logrotate~3.7.9~0.1mdv2010.2", rls:"MNDK_2010.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"logrotate", rpm:"logrotate~3.7.9~0.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2009.0")
{
  ...
  if ((res = isrpmvuln(pkg:"logrotate", rpm:"logrotate~3.7.9~0.1mdv2009.0", rls:"MNDK_2009.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
