...
#
# Fedora Update for postfix FEDORA-2011-3355
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/056560.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862938");
  ...
  script_name("Fedora Update for postfix FEDORA-2011-3355");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"postfix", rpm:"postfix~2.7.3~1.fc13", rls:"FC13")) != NULL)
  {
