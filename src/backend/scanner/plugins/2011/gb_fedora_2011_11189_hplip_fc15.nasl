...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065817.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863512");
  ...
  script_tag(name:"affected", value:"hplip on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"hplip", rpm:"hplip~3.11.7~2.fc15", rls:"FC15")) != NULL)
  {
