...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015930.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880756");
  ...
  script_name("CentOS Update for thunderbird CESA-2009:0258 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~1.5.0.12~19.el4.centos", rls:"CentOS4")) != NULL)
  {
