...
# $Id: gb_oracle_database_mult_unspecified_vuln_jan08.nasl 12047 2018-10-24 07:38:41Z cfischer $
#
...
if(description)
{
  ...
  script_cve_id("CVE-2008-0339", "CVE-2008-0340", "CVE-2008-0341", "CVE-2008-0342",
                "CVE-2008-0343", "CVE-2008-0344", "CVE-2008-0345");
...
if( version_in_range( version:vers, test_version:"10.2.0.0", test_version2:"10.2.0.2" ) ||
    ...
    version_in_range( version:vers, test_version:"11.1.0", test_version2:"11.1.0.5" ) ||
    ...
    version_is_equal( version:vers, test_version:"11.1.0.6" ) ) {
