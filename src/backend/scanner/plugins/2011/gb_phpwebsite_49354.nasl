...
# $Id: gb_phpwebsite_49354.nasl 11997 2018-10-20 11:59:41Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"phpWebSite is prone to an SQL-injection vulnerability because it
...
foreach dir( make_list_unique( "/", cgi_dirs( port:port ) ) ) {
  ...
  if( dir == "/" ) dir = "";
  url = string(dir,"/mod.php?mod=publisher&op=allmedia&artid=-1%20union%20select%200x53514c2d496e6a656374696f6e2d54657374");
