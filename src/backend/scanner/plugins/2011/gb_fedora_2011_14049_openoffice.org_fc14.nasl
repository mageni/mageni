...
#
# Fedora Update for openoffice.org FEDORA-2011-14049
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"openoffice.org on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"openoffice.org", rpm:"openoffice.org~3.3.0~20.8.fc14", rls:"FC14")) != NULL)
  {
