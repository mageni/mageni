...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066209.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863543");
  ...
  script_tag(name:"affected", value:"qt on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"qt", rpm:"qt~4.7.4~2.fc14", rls:"FC14")) != NULL)
  {
