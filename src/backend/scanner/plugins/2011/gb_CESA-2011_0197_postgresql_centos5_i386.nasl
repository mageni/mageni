...
#
# CentOS Update for postgresql CESA-2011:0197 centos5 i386
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.880527");
  ...
  script_name("CentOS Update for postgresql CESA-2011:0197 centos5 i386");

  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-April/017381.html");
