...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2010-July/016765.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880583");
  ...
  script_name("CentOS Update for libtiff CESA-2010:0519 centos5 i386");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.8.2~7.el5_5.5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.8.2~7.el5_5.5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
