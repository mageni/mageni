...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066250.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863539");
  ...
  script_tag(name:"affected", value:"quassel on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"quassel", rpm:"quassel~0.7.3~1.fc14", rls:"FC14")) != NULL)
  {
