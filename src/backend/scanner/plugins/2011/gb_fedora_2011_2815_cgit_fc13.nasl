...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/055898.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862923");
  ...
  script_tag(name:"affected", value:"cgit on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"cgit", rpm:"cgit~0.9~1.fc13", rls:"FC13")) != NULL)
  {
