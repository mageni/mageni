...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/056363.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862912");
  ...
  script_tag(name:"affected", value:"mailman on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"mailman", rpm:"mailman~2.1.12~17.fc13", rls:"FC13")) != NULL)
  {
