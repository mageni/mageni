...
if(description)
{
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1038-1");
  script_tag(name:"affected", value:"dpkg vulnerability on Ubuntu 9.10,
  Ubuntu 10.04 LTS,
  Ubuntu 10.10");
