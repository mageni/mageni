...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.862966");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-doctrine-Doctrine'
  ...
  script_tag(name:"affected", value:"php-doctrine-Doctrine on Fedora 14");
