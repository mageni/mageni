...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-February/015610.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880675");
  ...
  script_name("CentOS Update for seamonkey CESA-2009:0257 centos4 i386");
