...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/056229.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862911");
  ...
  script_tag(name:"affected", value:"samba on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~3.5.8~74.fc13", rls:"FC13")) != NULL)
  {
