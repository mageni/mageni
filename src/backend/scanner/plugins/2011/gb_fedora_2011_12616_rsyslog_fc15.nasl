...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066271.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863537");
  ...
  script_tag(name:"affected", value:"rsyslog on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"rsyslog", rpm:"rsyslog~5.8.5~1.fc15", rls:"FC15")) != NULL)
  {
