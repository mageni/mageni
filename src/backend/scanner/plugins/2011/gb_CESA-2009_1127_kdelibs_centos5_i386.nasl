...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-June/016007.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880747");
  ...
  script_name("CentOS Update for kdelibs CESA-2009:1127 centos5 i386");
