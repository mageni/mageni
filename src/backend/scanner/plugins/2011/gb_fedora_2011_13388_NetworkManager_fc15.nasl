...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066425.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863548");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"NetworkManager", rpm:"NetworkManager~0.9.1.90~1.git20110927.fc15", rls:"FC15")) != NULL)
  {
