...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-January/052879.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862772");
  ...
  script_name("Fedora Update for wordpress FEDORA-2010-19296");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.8.6~3.fc14", rls:"FC14")) != NULL)
  {
