...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-November/069325.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863623");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~1.4.10~1.fc14", rls:"FC14")) != NULL)
  {
