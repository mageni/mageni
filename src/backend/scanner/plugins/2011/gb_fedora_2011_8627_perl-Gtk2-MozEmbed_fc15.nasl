...
#
# Fedora Update for perl-Gtk2-MozEmbed FEDORA-2011-8627
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-June/061973.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863304");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-Gtk2-MozEmbed", rpm:"perl-Gtk2-MozEmbed~0.09~1.fc15.1", rls:"FC15")) != NULL)
  {
