...
if(description)
{
  ...
  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers execute arbitrary code
  ...
  script_tag(name:"insight", value:"The flaw is caused by a stack overflow error in the OpenType Compact Font
