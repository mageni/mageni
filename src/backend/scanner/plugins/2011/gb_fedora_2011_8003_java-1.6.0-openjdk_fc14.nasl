...
#
# Fedora Update for java-1.6.0-openjdk FEDORA-2011-8003
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-June/061352.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863277");
  ...
  script_name("Fedora Update for java-1.6.0-openjdk FEDORA-2011-8003");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.0~53.1.9.8.fc14", rls:"FC14")) != NULL)
  {
