...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the installed cP Creator version and saves
  the result in KB.");
...
foreach dir( make_list_unique( "/", "/cPcreator", "/cp", cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "HTTP/1.. 200" && "cP Creator" >< rcvRes ) {
