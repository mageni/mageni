...
# $Id: gb_pnozmulti_configurator_detect_win.nasl 13159 2019-01-19 07:39:41Z mmartin $
#
...
if(description)
{
  ...
  script_version("$Revision: 13159 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-19 08:39:41 +0100 (Sat, 19 Jan 2019) $");
  script_tag(name:"creation_date", value:"2019-01-19 08:40:31 +0100 (Sat, 19 Jan 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("Pilz PNOZmulti Configurator Version Detection (Windows)");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "PNOZmulti Configurator") continue;
