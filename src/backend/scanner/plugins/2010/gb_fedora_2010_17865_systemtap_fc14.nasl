...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/051115.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314898");
  script_version("$Revision: 8274 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-03 08:28:17 +0100 (Wed, 03 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2010-17865");
  script_cve_id("CVE-2010-4171", "CVE-2010-4170");
  script_name("Fedora Update for systemtap FEDORA-2010-17865");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"systemtap", rpm:"systemtap~1.3~3.fc14", rls:"FC14")) != NULL)
  {
