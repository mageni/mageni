...
#
# Fedora Update for kdemultimedia FEDORA-2010-6077
#
# Authors:
...
tag_affected = "kdemultimedia on Fedora 11";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039579.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314364");
  ...
  script_name("Fedora Update for kdemultimedia FEDORA-2010-6077");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"kdemultimedia", rpm:"kdemultimedia~4.4.2~2.fc11", rls:"FC11")) != NULL)
  {
