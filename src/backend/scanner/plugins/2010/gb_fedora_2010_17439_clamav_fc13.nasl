...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/051278.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314855");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"clamav", rpm:"clamav~0.96.4~1300.fc13", rls:"FC13")) != NULL)
  {
