...
tag_affected = "ImageMagick on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052599.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314197");
  ...
  script_name("Fedora Update for ImageMagick FEDORA-2010-19056");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~6.5.8.10~7.fc13", rls:"FC13")) != NULL)
  {
