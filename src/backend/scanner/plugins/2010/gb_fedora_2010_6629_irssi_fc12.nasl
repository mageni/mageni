...
tag_affected = "irssi on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041054.html");
  script_oid("1.3.6.1.4.1.25623.1.0.315043");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"irssi", rpm:"irssi~0.8.15~1.fc12", rls:"FC12")) != NULL)
  {
