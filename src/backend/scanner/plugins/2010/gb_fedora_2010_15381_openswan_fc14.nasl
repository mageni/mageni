...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/048999.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313201");
  script_version("$Revision: 8469 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-19 08:58:21 +0100 (Fri, 19 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-15381");
  script_cve_id("CVE-2010-3308", "CVE-2010-3302");
  script_name("Fedora Update for openswan FEDORA-2010-15381");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"openswan", rpm:"openswan~2.6.29~1.fc14", rls:"FC14")) != NULL)
  {
