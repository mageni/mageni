...
tag_insight = "Roundcube 0.3.1 and earlier does not request that the web browser
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-02/msg00055.php");
  script_oid("1.3.6.1.4.1.25623.1.0.313095");
  script_version("$Revision: 8187 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-20 08:30:09 +0100 (Wed, 20 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-02 08:46:47 +0100 (Tue, 02 Mar 2010)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_xref(name: "MDVSA", value: "2010:048");
  script_cve_id("CVE-2010-0464");
  script_name("Mandriva Update for roundcubemail MDVSA-2010:048 (roundcubemail)");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.2.2~0.2mdvmes5", rls:"MNDK_mes5")) != NULL)
  {
