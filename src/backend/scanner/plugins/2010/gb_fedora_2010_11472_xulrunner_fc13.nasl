...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044584.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314181");
  ...
  script_name("Fedora Update for xulrunner FEDORA-2010-11472");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~1.9.2.7~2.fc13", rls:"FC13")) != NULL)
  {
