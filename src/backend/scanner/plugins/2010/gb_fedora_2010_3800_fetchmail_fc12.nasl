...
tag_affected = "fetchmail on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/036632.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314074");
  ...
  script_name("Fedora Update for fetchmail FEDORA-2010-3800");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"fetchmail", rpm:"fetchmail~6.3.11~4.fc12", rls:"FC12")) != NULL)
  {
