...
# $
# Description: Auto generated from VID 09910d76-4c82-11df-83fb-0015587e2cc1
#
# Authors:
...
http://www.vuxml.org/freebsd/09910d76-4c82-11df-83fb-0015587e2cc1.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.313627");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.6.3")>=0 && revcomp(a:bver, b:"6.3.16")<=0) {
