...
#
# Fedora Update for galeon FEDORA-2010-5506
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038313.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314213");
  ...
  script_name("Fedora Update for galeon FEDORA-2010-5506");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.7~22.fc12", rls:"FC12")) != NULL)
  {
