...
#
# Fedora Update for pcmanx-gtk2 FEDORA-2010-5515
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038350.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314777");
  ...
  script_name("Fedora Update for pcmanx-gtk2 FEDORA-2010-5515");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"pcmanx-gtk2", rpm:"pcmanx-gtk2~0.3.9~4.20100222svn.fc11", rls:"FC11")) != NULL)
  {
