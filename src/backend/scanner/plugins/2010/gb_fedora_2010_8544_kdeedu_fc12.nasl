...
#
# Fedora Update for kdeedu FEDORA-2010-8544
#
# Authors:
...
tag_affected = "kdeedu on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041918.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312943");
  ...
  script_name("Fedora Update for kdeedu FEDORA-2010-8544");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdeedu", rpm:"kdeedu~4.4.3~1.fc12.1", rls:"FC12")) != NULL)
  {
