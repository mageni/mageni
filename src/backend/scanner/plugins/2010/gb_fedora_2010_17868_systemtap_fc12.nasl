...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/051122.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313725");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"systemtap", rpm:"systemtap~1.3~3.fc12", rls:"FC12")) != NULL)
  {
