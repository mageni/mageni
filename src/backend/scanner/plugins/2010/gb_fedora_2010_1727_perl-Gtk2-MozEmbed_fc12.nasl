...
#
# Fedora Update for perl-Gtk2-MozEmbed FEDORA-2010-1727
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035421.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314787");
  ...
  script_name("Fedora Update for perl-Gtk2-MozEmbed FEDORA-2010-1727");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-Gtk2-MozEmbed", rpm:"perl-Gtk2-MozEmbed~0.08~6.fc12.11", rls:"FC12")) != NULL)
  {
