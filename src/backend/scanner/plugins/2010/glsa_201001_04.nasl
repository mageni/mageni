...
tag_insight = "Multiple vulnerabilities in VirtualBox were found, the worst of which
    allowing for privilege escalation.";
tag_solution = "All users of the binary version of VirtualBox should upgrade to the
    latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201001-04
http://bugs.gentoo.org/show_bug.cgi?id=288836
http://bugs.gentoo.org/show_bug.cgi?id=294678";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.313995");
