...
tag_affected = "nss-softokn on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049761.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314422");
  ...
  script_name("Fedora Update for nss-softokn FEDORA-2010-15520");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"nss-softokn", rpm:"nss-softokn~3.12.8~1.fc13", rls:"FC13")) != NULL)
  {
