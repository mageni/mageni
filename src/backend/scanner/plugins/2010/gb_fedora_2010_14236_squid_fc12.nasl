...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047820.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313972");
  ...
  script_name("Fedora Update for squid FEDORA-2010-14236");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.1.8~1.fc12", rls:"FC12")) != NULL)
  {
