...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043379.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313974");
  ...
  script_name("Fedora Update for gnome-python2-extras FEDORA-2010-10344");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.25.3~18.fc12", rls:"FC12")) != NULL)
  {
