...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052550.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313474");
  script_version("$Revision: 8274 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-03 08:28:17 +0100 (Wed, 03 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-28 07:11:56 +0100 (Tue, 28 Dec 2010)");
  script_xref(name: "FEDORA", value: "2010-19166");
  script_tag(name:"cvss_base", value:"2.1");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:N/A:P");
  script_cve_id("CVE-2010-4352");
  script_name("Fedora Update for dbus FEDORA-2010-19166");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"dbus", rpm:"dbus~1.4.0~2.fc14", rls:"FC14")) != NULL)
  {
