...
tag_affected = "drupal-cck on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049300.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313159");
  script_version("$Revision: 8296 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-05 08:28:01 +0100 (Fri, 05 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-10-19 15:54:15 +0200 (Tue, 19 Oct 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-15707");
  script_name("Fedora Update for drupal-cck FEDORA-2010-15707");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-cck", rpm:"drupal-cck~6.x.2.8~1.fc13", rls:"FC13")) != NULL)
  {
