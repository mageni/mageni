...
#
# Fedora Update for phpMyAdmin FEDORA-2010-14411
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047378.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313335");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.3.7~1.fc12", rls:"FC12")) != NULL)
  {
