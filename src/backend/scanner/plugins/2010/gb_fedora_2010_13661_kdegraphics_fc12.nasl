...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046542.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314889");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdegraphics", rpm:"kdegraphics~4.4.5~3.fc12", rls:"FC12")) != NULL)
  {
