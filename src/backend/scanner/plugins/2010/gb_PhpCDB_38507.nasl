...
# $Id: gb_PhpCDB_38507.nasl 14326 2019-03-19 13:40:32Z jschulte $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"PhpCDB is prone to multiple local file-include vulnerabilities because
