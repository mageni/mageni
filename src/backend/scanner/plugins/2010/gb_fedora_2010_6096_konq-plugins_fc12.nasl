...
tag_affected = "konq-plugins on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039477.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313773");
  ...
  script_name("Fedora Update for konq-plugins FEDORA-2010-6096");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"konq-plugins", rpm:"konq-plugins~4.4.0~3.fc12", rls:"FC12")) != NULL)
  {
