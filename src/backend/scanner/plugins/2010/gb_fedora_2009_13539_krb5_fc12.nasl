...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2010-January/msg00200.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312892");
  script_version("$Revision: 8495 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-23 08:57:49 +0100 (Tue, 23 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-01-15 10:29:41 +0100 (Fri, 15 Jan 2010)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_xref(name: "FEDORA", value: "2009-13539");
  script_cve_id("CVE-2009-3295");
  script_name("Fedora Update for krb5 FEDORA-2009-13539");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.7~15.fc12", rls:"FC12")) != NULL)
  {
