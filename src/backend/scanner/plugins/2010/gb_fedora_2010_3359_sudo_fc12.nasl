...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/036635.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313012");
  script_version("$Revision: 8510 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-24 08:57:42 +0100 (Wed, 24 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-03-12 17:02:32 +0100 (Fri, 12 Mar 2010)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2010-3359");
  script_cve_id("CVE-2010-0426");
  script_name("Fedora Update for sudo FEDORA-2010-3359");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.7.2p5~1.fc12", rls:"FC12")) != NULL)
  {
