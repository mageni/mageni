...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-April/016629.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314661");
  ...
  script_name("CentOS Update for wireshark CESA-2010:0360 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~1.0.11~1.el4_8.5", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wireshark-gnome", rpm:"wireshark-gnome~1.0.11~1.el4_8.5", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
