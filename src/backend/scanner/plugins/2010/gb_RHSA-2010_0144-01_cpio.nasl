...
#
# RedHat Update for cpio RHSA-2010:0144-01
#
# Authors:
...
tag_affected = "cpio on Red Hat Enterprise Linux (v. 5 server)";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2010-March/msg00009.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313111");
  script_version("$Revision: 8258 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-29 08:28:57 +0100 (Fri, 29 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-22 11:34:53 +0100 (Mon, 22 Mar 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "RHSA", value: "2010:0144-01");
  script_cve_id("CVE-2007-4476", "CVE-2010-0624");
  script_name("RedHat Update for cpio RHSA-2010:0144-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"cpio", rpm:"cpio~2.6~23.el5_4.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cpio-debuginfo", rpm:"cpio-debuginfo~2.6~23.el5_4.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
