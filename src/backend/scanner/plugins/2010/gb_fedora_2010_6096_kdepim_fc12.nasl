...
#
# Fedora Update for kdepim FEDORA-2010-6096
#
# Authors:
...
tag_affected = "kdepim on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039475.html");
  script_oid("1.3.6.1.4.1.25623.1.0.315142");
  ...
  script_name("Fedora Update for kdepim FEDORA-2010-6096");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdepim", rpm:"kdepim~4.4.2~1.fc12", rls:"FC12")) != NULL)
  {
