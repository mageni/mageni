...
#
# Fedora Update for maniadrive FEDORA-2010-4114
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/038277.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312741");
  script_version("$Revision: 8338 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-09 09:00:38 +0100 (Tue, 09 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-04-06 08:56:44 +0200 (Tue, 06 Apr 2010)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_xref(name: "FEDORA", value: "2010-4114");
  script_name("Fedora Update for maniadrive FEDORA-2010-4114");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"maniadrive", rpm:"maniadrive~1.2~18.fc11", rls:"FC11")) != NULL)
  {
