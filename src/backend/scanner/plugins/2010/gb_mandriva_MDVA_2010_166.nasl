...
tag_affected = "php-eaccelerator on Mandriva Linux 2010.0,
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.314087");
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"php-eaccelerator", rpm:"php-eaccelerator~0.9.6.1~0.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"php-eaccelerator-admin", rpm:"php-eaccelerator-admin~0.9.6.1~0.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
