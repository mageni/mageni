...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/045926.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314542");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"sunbird", rpm:"sunbird~1.0~0.27.b2pre.fc13", rls:"FC13")) != NULL)
  {
