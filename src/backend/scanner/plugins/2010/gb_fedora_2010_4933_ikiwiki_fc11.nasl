...
tag_affected = "ikiwiki on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038360.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313167");
  script_version("$Revision: 8469 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-19 08:58:21 +0100 (Fri, 19 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-04-06 08:56:44 +0200 (Tue, 06 Apr 2010)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_xref(name: "FEDORA", value: "2010-4933");
  script_cve_id("CVE-2009-2944");
  script_name("Fedora Update for ikiwiki FEDORA-2010-4933");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"ikiwiki", rpm:"ikiwiki~3.20100312~1.fc11", rls:"FC11")) != NULL)
  {
