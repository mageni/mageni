...
# $Id: gb_logpoint_detect.nasl 10899 2018-08-10 13:49:35Z cfischer $
#
# LogPoint Detection
#
# Authors:
...
if ("<title>LogPoint</title>" >< res && "App.constants.DEFAULT_AUTH" >< res) {
  version = "unknown";
  ...
  log_message(data: build_detection_report(app: "LogPoint", version: version, install: "/", cpe: cpe,
                                           concluded: vers[0]),
              port: port);
  exit(0);
}
