...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118267");
  ...
  script_name("Python < 2.6.8, 2.7.x < 2.7.3, 3.1.x < 3.1.5, 3.2.x < 3.2.3 XML-RPC DoS (bpo-14001) - Linux");
  ...
  script_tag(name:"insight", value:"SimpleXMLRPCServer.py in SimpleXMLRPCServer allows remote
  attackers to cause a DoS (infinite loop and CPU consumption) via an XML-RPC POST request that
  contains a smaller amount of data than specified by the Content-Length header.");

  script_tag(name:"affected", value:"Python prior to version 2.6.8, versions 2.7.x prior to 2.7.3,
  3.1.x < 3.1.5 and 3.2.x prior to 3.2.3.");

  script_tag(name:"solution", value:"Update to version 2.6.8, 2.7.3, 3.1.5, 3.2.3 or later.");

  script_xref(name:"URL", value:"https://python-security.readthedocs.io/vuln/xmlrpc-dos.html");
  script_xref(name:"Advisory-ID", value:"bpo-14001");
...
if( version_in_range( version:version, test_version:"2.7.0", test_version2:"2.7.2" ) ) {
