...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libwebp (USN-4971-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006049.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libwebp'
  package(s) announced via the USN-4971-1 advisory.");
...
code.");
  ...
  script_tag(name:"affected", value:"'libwebp' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
