...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-azure (USN-5092-3)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006239.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure'
  package(s) announced via the USN-5092-3 advisory.");
