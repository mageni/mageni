...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for mongodb (USN-5101-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006224.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mongodb'
  package(s) announced via the USN-5101-1 advisory.");
