...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dovecot (USN-4674-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-January/005815.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot'
  package(s) announced via the USN-4674-1 advisory.");
...
to crash, resulting in a denial of service. (CVE-2020-25275)");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.3.7.2-1ubuntu3.3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.33.2-1ubuntu4.7", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.22-1ubuntu2.14", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.3.11.3+dfsg1-2ubuntu0.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
