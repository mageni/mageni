...
if(description)
{
  ...
  script_cve_id("CVE-2020-12108", "CVE-2020-15011", "CVE-2020-12137", "CVE-2021-42097", "CVE-2021-42096");
  ...
  script_name("Ubuntu: Security Advisory for mailman (USN-5121-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-November/006261.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman'
  package(s) announced via the USN-5121-2 advisory.");
...
Andre Protas, Richard Cloke, and Andy Nuttall discovered that Mailmans
...
password. (CVE-2021-42096)");
  ...
  script_tag(name:"affected", value:"'mailman' package(s) on Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"1:2.1.29-1ubuntu3.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
