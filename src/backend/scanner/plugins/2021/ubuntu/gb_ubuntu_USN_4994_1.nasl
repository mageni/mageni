...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for apache2 (USN-4994-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006079.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2'
  package(s) announced via the USN-4994-1 advisory.");
...
(CVE-2021-30641)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
