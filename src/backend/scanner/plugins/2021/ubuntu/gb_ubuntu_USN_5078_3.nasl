...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for squashfs-tools (USN-5078-3)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006235.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools'
  package(s) announced via the USN-5078-3 advisory.");
...
write arbitrary files to the filesystem.");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squashfs-tools", ver:"1:4.4-1ubuntu0.3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
