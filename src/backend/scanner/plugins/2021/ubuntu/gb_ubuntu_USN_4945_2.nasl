...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-raspi (USN-4945-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006032.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi'
  package(s) announced via the USN-4945-2 advisory.");
