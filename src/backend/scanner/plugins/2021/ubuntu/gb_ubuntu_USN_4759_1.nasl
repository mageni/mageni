...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for glib2.0 (USN-4759-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-March/005924.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2.0'
  package(s) announced via the USN-4759-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libglib2.0-0", ver:"2.64.6-1~ubuntu20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libglib2.0-0", ver:"2.56.4-0ubuntu0.18.04.7", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libglib2.0-0", ver:"2.48.2-0ubuntu4.7", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libglib2.0-0", ver:"2.66.1-2ubuntu0.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
