...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853993");
  ...
  script_tag(name:"creation_date", value:"2021-07-20 03:02:27 +0000 (Tue, 20 Jul 2021)");
  script_name("openSUSE: Security Advisory for go1.15 (openSUSE-SU-2021:2398-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:2398-1");
  ...
  package(s) announced via the openSUSE-SU-2021:2398-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.15", rpm:"go1.15~1.15.14~1.36.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.15-doc", rpm:"go1.15-doc~1.15.14~1.36.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.15-race", rpm:"go1.15-race~1.15.14~1.36.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
