...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818528");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5005566)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5005566");
  ...
  - An elevation of privilege vulnerability in Windows Bind Filter Driver.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5005566");
...
if(version_in_range(version:fileVer, test_version:"10.0.18362.0", test_version2:"10.0.18362.1765"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Pcadm.dll",
                            file_version:fileVer, vulnerable_range:"10.0.18362.0 - 10.0.18362.1765");
