...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817880");
  script_version("2021-01-13T16:01:57+0000");
  script_cve_id("CVE-2021-1711");
  ...
  script_name("Microsoft Office Remote Code Execution Vulnerability (KB4486762)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4486762");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an error in Microsoft
  Office while opening a specially crafted Office file.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4486762");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    {
      if(version_is_less(version:msdllVer, test_version:"15.0.5311.1000"))
      {
        report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                   file_version:msdllVer, vulnerable_range:"15.0 - 15.0.5311.0999");
