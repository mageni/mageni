...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817575");
  ...
  script_cve_id("CVE-2021-1637", "CVE-2021-1648", "CVE-2021-1649", "CVE-2021-1650",
                ...
                "CVE-2021-1666", "CVE-2021-1667", "CVE-2021-1668", "CVE-2021-1671",
                "CVE-2021-1673", "CVE-2021-1674", "CVE-2021-1676", "CVE-2021-1678",
                "CVE-2021-1679", "CVE-2021-1683", "CVE-2021-1684", "CVE-2021-1688",
  ...
  script_tag(name:"creation_date", value:"2021-01-13 12:09:52 +0530 (Wed, 13 Jan 2021)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4598285)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4598285");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4598285");
...
if(version_is_less(version:fileVer, test_version:"6.3.9600.19920"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Localspl.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.3.9600.19920");
