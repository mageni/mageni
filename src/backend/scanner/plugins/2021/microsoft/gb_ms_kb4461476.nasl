...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818915");
  script_version("2021-10-14T03:43:45+0000");
  script_cve_id("CVE-2021-40454");
  ...
  script_name("Microsoft Office 2016 Information Disclosure Vulnerability (KB4461476)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4461476");
  ...
  to gain access to sensitive data on the affected system.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4461476");
