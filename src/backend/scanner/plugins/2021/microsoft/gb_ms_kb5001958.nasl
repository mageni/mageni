...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818350");
  ...
  script_name("Microsoft Office 2013 Service Pack 1 RCE Vulnerability (KB5001958)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5001958");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001958");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    {
      if(version_is_less(version:msdllVer, test_version:"15.0.5349.1000"))
      {
        report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                   file_version:msdllVer, vulnerable_range:"15.0 - 15.0.5349.0999");
