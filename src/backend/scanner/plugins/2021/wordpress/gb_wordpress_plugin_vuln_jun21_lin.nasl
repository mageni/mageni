...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147224");
  script_version("2021-11-26T01:55:13+0000");
  script_tag(name:"last_modification", value:"2021-11-26 11:17:40 +0000 (Fri, 26 Nov 2021)");
  script_tag(name:"creation_date", value:"2021-11-26 01:45:48 +0000 (Fri, 26 Nov 2021)");
  ...
  script_name("WordPress < 5.8 Missing 'Update URI' Plugin Header Vulnerability - Linux");
