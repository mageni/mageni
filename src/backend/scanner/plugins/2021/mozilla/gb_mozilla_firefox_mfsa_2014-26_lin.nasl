...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2014.26");
  script_cve_id("CVE-2014-1508");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2014-26) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2014-26");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2014-26/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=963198");
  ...
  script_tag(name:"insight", value:"Information disclosure through polygon rendering in MathML
