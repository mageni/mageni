...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2021.33");
  script_cve_id("CVE-2021-29980", "CVE-2021-29981", "CVE-2021-29982", "CVE-2021-29983", "CVE-2021-29984", "CVE-2021-29985", "CVE-2021-29986", "CVE-2021-29987", "CVE-2021-29988", "CVE-2021-29989", "CVE-2021-29990");
  ...
  script_tag(name:"severity_date", value:"2021-08-25 00:08:00 +0000 (Wed, 25 Aug 2021)");

  script_name("Mozilla Firefox Security Advisory (MFSA2021-33) - Linux");
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1719088");
  ...
  script_tag(name:"insight", value:"CVE-2021-29986: Race condition when resolving DNS names could have led to memory corruption
