...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2015.60");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2015-60) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2015-60");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2015-60/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1163422");
...
Security researcher Jann Horn reported that when Mozilla
Foundation Security Advisory 2015-25 was fixed in Firefox 37, an error was
...
Armin Razmdjou reported for that issue, opening hyperlinks on a
