...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2015.29");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2015-29) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2015-29");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2015-29/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1145255");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Code execution through incorrect JavaScript bounds checking elimination
...
and writing of memory allowing for arbitrary code execution on the local system.");
  ...
  script_tag(name:"affected", value:"Firefox version(s) below 36.0.3.");
...
if (version_is_less(version: version, test_version: "36.0.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "36.0.3", install_path: location);
