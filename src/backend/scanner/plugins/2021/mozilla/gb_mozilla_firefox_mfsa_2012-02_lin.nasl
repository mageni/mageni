...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2012.02");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2012-02) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2012-02");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2012-02/");
  script_xref(name:"URL", value:"http://www.ietf.org/rfc/rfc3986.txt");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=504014");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Overly permissive IPv6 literal syntax
...
previously accepted.");
  ...
  script_tag(name:"affected", value:"Firefox version(s) below 3.6.26 and below 7.");
