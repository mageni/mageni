...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2017-04) - Linux");
...
if (version_is_less(version: version, test_version: "51.0.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "51.0.3", install_path: location);
