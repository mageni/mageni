...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2015.137");
  script_cve_id("CVE-2015-7208");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2015-137) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2015-137");
  ...
  script_tag(name:"insight", value:"Firefox allows for control characters to be set in cookies
Security researcher musicDespiteEverything reported an issue when ASCII code 11 for vertical tab is stored in a cookie in violation of RFC6265. This may result in
