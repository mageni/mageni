...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2021.38");
  script_cve_id("CVE-2021-29993", "CVE-2021-38491", "CVE-2021-38492", "CVE-2021-38493", "CVE-2021-38494");
  ...
  script_tag(name:"severity_date", value:"2021-11-04 19:50:00 +0000 (Thu, 04 Nov 2021)");

  script_name("Mozilla Firefox Security Advisory (MFSA2021-38) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2021-38");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2021-38/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1712242%2C1708767%2C1712240%2C1708544%2C1729259");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1723391%2C1724101%2C1724107");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1723920%2C1725638");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1551886");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1721107");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2021-29993: Handling custom intents could lead to crashes and UI spoofs
...
Mozilla developers Christian Holler and Lars T Hansen reported memory safety bugs present in Firefox 91. Some of these bugs showed evidence of memory corruption and we presume that with enough effort some of these could have been exploited to run arbitrary code.");
  ...
  script_tag(name:"affected", value:"Firefox version(s) below 92.");
...
if (version_is_less(version: version, test_version: "92")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "92", install_path: location);
