...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.0062.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:0062-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:0062-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210062-1/");
  script_xref(name:"URL", value:"https://cwe.mitre.org/data/definitions/444.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs12' package(s) announced via the SUSE-SU-2021:0062-1 advisory.");
 ...
 * zlib: switch to lazy init for zlib streams");
  ...
  script_tag(name:"affected", value:"'nodejs12' package(s) on SUSE Linux Enterprise Module for Web Scripting 15-SP2");
...
if(release == "SLES15.0SP2") {
  if(!isnull(res = isrpmvuln(pkg:"nodejs12", rpm:"nodejs12~12.20.1~4.10.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-debuginfo", rpm:"nodejs12-debuginfo~12.20.1~4.10.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-debugsource", rpm:"nodejs12-debugsource~12.20.1~4.10.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-devel", rpm:"nodejs12-devel~12.20.1~4.10.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm12", rpm:"npm12~12.20.1~4.10.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-docs", rpm:"nodejs12-docs~12.20.1~4.10.1", rls:"SLES15.0SP2"))){
    report += res;
  }
