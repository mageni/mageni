...
CVE-2020-18032: Fixed possible remote code execution via buffer overflow
 (bsc#1185833).");
  ...
  script_tag(name:"affected", value:"'graphviz' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 9, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise High Availability 12-SP5, SUSE Linux Enterprise High Availability 12-SP4, SUSE Linux Enterprise High Availability 12-SP3, HPE Helion Openstack 8");
