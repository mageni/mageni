...
Fixed CVE-2021-3605 [bsc#1187395]: Heap buffer overflow in the
 rleUncompress function");
  ...
  script_tag(name:"affected", value:"'OpenEXR' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Point of Sale 11-SP3, SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP3");
