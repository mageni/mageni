...
Fixed a bug where it was no longer possible to mount CIFS filesystem
 after the last maintenance update. (bsc#1184815)");
  ...
  script_tag(name:"affected", value:"'cifs-utils' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15");
