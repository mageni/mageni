...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211845-1/");
...
Add sudo to requires: used to drop privileges.");
  ...
  script_tag(name:"affected", value:"'avahi' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-autoipd-debuginfo", rpm:"avahi-autoipd-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-debuginfo", rpm:"avahi-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"avahi-debugsource", rpm:"avahi-debugsource~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"avahi-glib2-debugsource", rpm:"avahi-glib2-debugsource~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-utils-debuginfo", rpm:"avahi-utils-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-utils-gtk-debuginfo", rpm:"avahi-utils-gtk-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-client3-debuginfo", rpm:"libavahi-client3-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-common3-debuginfo", rpm:"libavahi-common3-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-core7-debuginfo", rpm:"libavahi-core7-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-glib1-debuginfo", rpm:"libavahi-glib1-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-gobject0-debuginfo", rpm:"libavahi-gobject0-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-ui-gtk3-0-debuginfo", rpm:"libavahi-ui-gtk3-0-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libavahi-ui0-debuginfo", rpm:"libavahi-ui0-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libdns_sd-debuginfo", rpm:"libdns_sd-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libhowl0-debuginfo", rpm:"libhowl0-debuginfo~0.6.32~5.13.1", rls:"SLES15.0"))){
    report += res;
  }
