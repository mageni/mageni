...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.1807.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1807-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1807-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211807-1/");
  ...
  script_xref(name:"URL", value:"https://github.com/httplib2/httplib2/pul");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-httplib2' package(s) announced via the SUSE-SU-2021:1807-1 advisory.");
 ...
 * Add DigiCert Global Root G2 serial 033af1e6a711a9a0bb2864b11d09fae5
 [link moved to references]... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'python-httplib2' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Module for Public Cloud 12");
...
if(release == "SLES12.0") {
  if(!isnull(res = isrpmvuln(pkg:"python-httplib2", rpm:"python-httplib2~0.19.0~7.7.1", rls:"SLES12.0"))){
    report += res;
  }
