...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117666");
  script_version("2021-09-15T05:15:07+0000");
  script_cve_id("CVE-2013-1965", "CVE-2013-2134", "CVE-2013-2135");
  ...
  script_name("Apache Struts Security Update (S2-012, S2-015)");
  ...
  script_xref(name:"URL", value:"https://cwiki.apache.org/confluence/display/WW/S2-015");
  script_xref(name:"Advisory-ID", value:"S2-015");
  ...
  script_tag(name:"affected", value:"Apache Struts 2.0.0 through 2.3.14.2.");
...
if (version_in_range(version: version, test_version: "2.0.0", test_version2: "2.3.14.2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.3.14.3", install_path: location);
