...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117668");
  script_version("2021-09-15T05:15:07+0000");
  script_cve_id("CVE-2013-2251", "CVE-2013-2248");
  ...
  script_name("Apache Struts Security Update (S2-016, S2-017)");
...
if (version_in_range(version: version, test_version: "2.0.0", test_version2: "2.3.15")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.3.15.1", install_path: location);
