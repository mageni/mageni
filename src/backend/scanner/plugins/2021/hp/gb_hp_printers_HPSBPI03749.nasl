...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147247");
  script_version("2021-12-03T14:03:38+0000");
  script_tag(name:"last_modification", value:"2021-12-06 11:03:13 +0000 (Mon, 06 Dec 2021)");
  script_tag(name:"creation_date", value:"2021-12-03 06:24:27 +0000 (Fri, 03 Dec 2021)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2021-11-04 21:06:00 +0000 (Thu, 04 Nov 2021)");

  script_cve_id("CVE-2021-39238");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("HP Printer Buffer Overflow Vulnerability (HPSBPI03749, Printing-Shellz)");
  ...
  script_tag(name:"summary", value:"Multiple HP printers are prone to a buffer overflow
  vulnerability dubbed 'Printing-Shellz'.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Certain HP LaserJet, HP LaserJet Managed, HP PageWide, and HP
  PageWide Managed products may be vulnerable to potential buffer overflow.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"https://support.hp.com/us-en/document/ish_5000383-5000409-16");
  script_xref(name:"URL", value:"https://labs.f-secure.com/assets/BlogFiles/Printing-Shellz.pdf");
...
cpe_list = make_list("cpe:/h:hp:color_laserjet_cm4540_mfp",
                     ...
                     "cpe:/h:hp:color_laserjet_mfp_m577",
                     "cpe:/h:hp:color_laserjet_flow_mfp_m577",
                     "cpe:/h:hp:laserjet_m154nw",
                     "cpe:/h:hp:laserjet_m253nw",
                     "cpe:/h:hp:laserjet_m253dw",
                     "cpe:/h:hp:laserjet_m254nw",
                     "cpe:/h:hp:laserjet_m254dw",
                     "cpe:/h:hp:laserjet_mfp_m180",
                     "cpe:/h:hp:laserjet_mfp_m181",
                     "cpe:/h:hp:laserjet_mfp_m280",
                     "cpe:/h:hp:laserjet_mfp_m281",
                     ...
                     "cpe:/h:hp:pagewide_452dn",
                     "cpe:/h:hp:pagewide_452dw",
                     "cpe:/h:hp:pagewide_477dw",
                     "cpe:/h:hp:pagewide_477dn",
                     "cpe:/h:hp:pagewide_552");
...
else if (cpe == "cpe:/h:hp:laserjet_mfp_m180" ||
         cpe == "cpe:/h:hp:laserjet_mfp_m181" ||
         cpe == "cpe:/h:hp:laserjet_mfp_m280" ||
         cpe == "cpe:/h:hp:laserjet_mfp_m281") {
  if (version_is_less(version: version, test_version: "20211109")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "20211109");
    security_message(port: 0, data: report);
    exit(0);
  }
}

else if (cpe == "cpe:/h:hp:pagewide_452dn" ||
         cpe == "cpe:/h:hp:pagewide_452dw" ||
         cpe == "cpe:/h:hp:pagewide_477dw" ||
         cpe == "cpe:/h:hp:pagewide_477dn" ||
         cpe == "cpe:/h:hp:pagewide_552") {
  if (version_is_less(version: version, test_version: "2142A")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "2142A");
    security_message(port: 0, data: report);
    exit(0);
  }
}
