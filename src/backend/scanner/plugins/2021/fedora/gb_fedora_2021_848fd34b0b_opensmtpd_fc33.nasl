...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878866");
  ...
  script_tag(name:"creation_date", value:"2021-02-01 04:01:33 +0000 (Mon, 01 Feb 2021)");
  script_name("Fedora: Security Advisory for opensmtpd (FEDORA-2021-848fd34b0b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-848fd34b0b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5LKTFBQCHGMVPR4IZWHQIYAPM5J3LN3J");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensmtpd'
  package(s) announced via the FEDORA-2021-848fd34b0b advisory.");
...
back to Sendmail as a default mail daemon.");
  ...
  script_tag(name:"affected", value:"'opensmtpd' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opensmtpd", rpm:"opensmtpd~6.8.0p2~1.fc33", rls:"FC33"))) {
    report += res;
  }
