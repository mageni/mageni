...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818576");
  ...
  script_tag(name:"creation_date", value:"2021-10-02 01:23:08 +0000 (Sat, 02 Oct 2021)");
  script_name("Fedora: Security Advisory for matrix-synapse (FEDORA-2021-f12fdca1bf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-f12fdca1bf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2VHDEPCZ22GJFMZCWA2XZAGPOEV72POF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'matrix-synapse'
  package(s) announced via the FEDORA-2021-f12fdca1bf advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"matrix-synapse", rpm:"matrix-synapse~1.41.1~1.fc35", rls:"FC35"))) {
    report += res;
  }
