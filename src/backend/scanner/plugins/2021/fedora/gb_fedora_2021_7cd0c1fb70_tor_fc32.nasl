...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879273");
  ...
  script_name("Fedora: Security Advisory for tor (FEDORA-2021-7cd0c1fb70)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-7cd0c1fb70");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QXL34GCZBHAIF3PASVE7LWYG4BIKHIDP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2021-7cd0c1fb70 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.5.7~1.fc32", rls:"FC32"))) {
    report += res;
  }
