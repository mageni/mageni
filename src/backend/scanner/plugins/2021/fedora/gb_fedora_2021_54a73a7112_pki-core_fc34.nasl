...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879768");
  ...
  script_tag(name:"creation_date", value:"2021-06-20 03:17:00 +0000 (Sun, 20 Jun 2021)");
  script_name("Fedora: Security Advisory for pki-core (FEDORA-2021-54a73a7112)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M4OIKXB2E4FOCY5YLGWEKI6Q4SO2FMXX");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pki-core", rpm:"pki-core~10.10.6~1.fc34", rls:"FC34"))) {
    report += res;
  }
