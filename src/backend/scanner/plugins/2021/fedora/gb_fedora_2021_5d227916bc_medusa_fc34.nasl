...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819423");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:23:12 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for medusa (FEDORA-2021-5d227916bc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Y3UP2IHGOMTJRBOEHJLWCUS6CK5LYCKT");
...
Some of the key features of Medusa are:
  ...
  * Modular design. Each service module exists
  ...
  script_tag(name:"affected", value:"'medusa' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"medusa", rpm:"medusa~2.2~17.20181216git292193b.fc34", rls:"FC34"))) {
    report += res;
  }
