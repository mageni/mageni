...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879041");
  ...
  script_tag(name:"creation_date", value:"2021-03-09 04:02:42 +0000 (Tue, 09 Mar 2021)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2021-a2d3ad5dda)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SUCBCKRHWP3UD2AVVYQJE7BIJEMCMXW5");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.10.20~200.fc33", rls:"FC33"))) {
    report += res;
  }
