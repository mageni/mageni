...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879791");
  ...
  script_tag(name:"creation_date", value:"2021-06-28 03:20:12 +0000 (Mon, 28 Jun 2021)");
  script_name("Fedora: Security Advisory for php-phpmailer6 (FEDORA-2021-bfc34b3d5c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-bfc34b3d5c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FJYSOFCUBS67J3TKR74SD3C454N7VTYM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-phpmailer6'
  package(s) announced via the FEDORA-2021-bfc34b3d5c advisory.");
...
Autoloader: /usr/share/php/PHPMailer/PHPMailer6/autoload.php");
  ...
  script_tag(name:"affected", value:"'php-phpmailer6' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-phpmailer6", rpm:"php-phpmailer6~6.5.0~1.fc34", rls:"FC34"))) {
    report += res;
  }
