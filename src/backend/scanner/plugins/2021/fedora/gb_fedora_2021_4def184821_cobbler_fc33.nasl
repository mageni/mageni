...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818619");
  ...
  script_tag(name:"creation_date", value:"2021-10-03 01:22:55 +0000 (Sun, 03 Oct 2021)");
  script_name("Fedora: Security Advisory for cobbler (FEDORA-2021-4def184821)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-4def184821");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5EFZNDVIG46XXBBBA7MBQS4JVHRDRIUK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2021-4def184821 advisory.");
...
other applications.");
  ...
  script_tag(name:"affected", value:"'cobbler' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~3.2.2~2.fc33", rls:"FC33"))) {
    report += res;
  }
