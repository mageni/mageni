...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819396");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:14 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for rss-glx (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SMMWXVVXVCE4UWCQR33KJTH6KHJWF5JV");
...
order to use them as screensavers.");
  ...
  script_tag(name:"affected", value:"'rss-glx' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rss-glx", rpm:"rss-glx~0.9.1.p~50.fc34", rls:"FC34"))) {
    report += res;
  }
