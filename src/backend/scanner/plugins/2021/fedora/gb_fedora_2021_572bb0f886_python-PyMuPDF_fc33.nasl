...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879031");
  ...
  script_tag(name:"creation_date", value:"2021-03-06 04:08:38 +0000 (Sat, 06 Mar 2021)");
  script_name("Fedora: Security Advisory for python-PyMuPDF (FEDORA-2021-572bb0f886)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HU2INAD3ZINKVHFGDA3AMSW3VRD5VO6H");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-PyMuPDF", rpm:"python-PyMuPDF~1.18.8~2.fc33", rls:"FC33"))) {
    report += res;
  }
