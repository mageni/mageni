...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879099");
  ...
  script_tag(name:"creation_date", value:"2021-03-20 04:06:29 +0000 (Sat, 20 Mar 2021)");
  script_name("Fedora: Security Advisory for gnome-shell-extensions (FEDORA-2021-303f6623fa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6D7MIWLLK74HH65G6VEDM3AW2DKZ6FMT");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-shell-extensions-40.0", rpm:"gnome-shell-extensions-40.0~rc~1.fc34", rls:"FC34"))) {
    report += res;
  }
