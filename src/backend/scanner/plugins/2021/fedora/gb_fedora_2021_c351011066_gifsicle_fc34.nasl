...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818566");
  ...
  script_tag(name:"creation_date", value:"2021-09-24 01:43:09 +0000 (Fri, 24 Sep 2021)");
  script_name("Fedora: Security Advisory for gifsicle (FEDORA-2021-c351011066)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-c351011066");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7H3ASG2BD4D4SAUUI6TOLUZYP2QYYHXY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gifsicle'
  package(s) announced via the FEDORA-2021-c351011066 advisory.");
...
and gifdiff compares two GIFs for identical visual appearance.");
  ...
  script_tag(name:"affected", value:"'gifsicle' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gifsicle", rpm:"gifsicle~1.93~1.fc34", rls:"FC34"))) {
    report += res;
  }
