...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879432");
  ...
  script_name("Fedora: Security Advisory for mosquitto (FEDORA-2021-b845743e48)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-b845743e48");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DUICPZTPJPHDRXRY6FYQ2JIHYMXPOOZU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mosquitto'
  package(s) announced via the FEDORA-2021-b845743e48 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mosquitto", rpm:"mosquitto~2.0.10~1.fc34", rls:"FC34"))) {
    report += res;
  }
