...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879821");
  ...
  script_name("Fedora: Security Advisory for djvulibre (FEDORA-2021-fd6f2727c8)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-fd6f2727c8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XVKYWV4P5XGA3FXKGFB443MKC32L7YQB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the FEDORA-2021-fd6f2727c8 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"djvulibre", rpm:"djvulibre~3.5.27~28.fc33", rls:"FC33"))) {
    report += res;
  }
