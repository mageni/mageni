...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818446");
  ...
  script_name("Fedora: Security Advisory for testdisk (FEDORA-2021-38d1b07839)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HJ2CFPRTXXI3BAYNYASC7DNATH5UC26D");
...
440 file formats including JPG, MSOffice, OpenOffice documents.");
  ...
  script_tag(name:"affected", value:"'testdisk' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"testdisk", rpm:"testdisk~7.1~7.fc33", rls:"FC33"))) {
    report += res;
  }
