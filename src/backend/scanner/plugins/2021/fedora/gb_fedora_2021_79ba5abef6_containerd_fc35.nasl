...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819373");
  ...
  script_name("Fedora: Security Advisory for containerd (FEDORA-2021-79ba5abef6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JSYNCFGKFF5ZWN6JJMD22XLXCJSTKXOA");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.5.8~1.fc35", rls:"FC35"))) {
    report += res;
  }
