...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819082");
  ...
  script_name("Fedora: Security Advisory for watchdog (FEDORA-2021-4cf4b682e8)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-4cf4b682e8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OWDUJEWPBMNSHDJL6S6SAKLSKUZHA2H7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'watchdog'
  package(s) announced via the FEDORA-2021-4cf4b682e8 advisory.");
...
expiration) initiated by the BMC.");
  ...
  script_tag(name:"affected", value:"'watchdog' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"watchdog", rpm:"watchdog~5.16~2.fc35", rls:"FC35"))) {
    report += res;
  }
