...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818578");
  ...
  script_name("Fedora: Security Advisory for iaito (FEDORA-2021-c1a0dc39b4)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/56WBK2J64RZXGY7RMFM3XFEPIAITFRQ2");
...
Closer integration between r2 and the UI.");
  ...
  script_tag(name:"affected", value:"'iaito' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"iaito", rpm:"iaito~5.3.1~3.fc35", rls:"FC35"))) {
    report += res;
  }
