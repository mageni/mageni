...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819383");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:06 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for synfigstudio (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/F7F4C7WIWCPTZNOBPPLBSC4J7D23V3CT");
  ...
  script_tag(name:"insight", value:"Synfig Animation Studio is a powerful, industrial-strength vector-based
...
This package contains the GUI-based animation studio.");
  ...
  script_tag(name:"affected", value:"'synfigstudio' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"synfigstudio", rpm:"synfigstudio~1.4.0~3.fc34", rls:"FC34"))) {
    report += res;
  }
