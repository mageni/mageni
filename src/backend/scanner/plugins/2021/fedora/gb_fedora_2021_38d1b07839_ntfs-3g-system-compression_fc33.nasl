...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818459");
  ...
  script_name("Fedora: Security Advisory for ntfs-3g-system-compression (FEDORA-2021-38d1b07839)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/I4M6YI2RNMOKJOWXV6JDDLIONUWSRAQO");
...
utility on Windows.");
  ...
  script_tag(name:"affected", value:"'ntfs-3g-system-compression' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntfs-3g-system-compression", rpm:"ntfs-3g-system-compression~1.0~7.fc33", rls:"FC33"))) {
    report += res;
  }
