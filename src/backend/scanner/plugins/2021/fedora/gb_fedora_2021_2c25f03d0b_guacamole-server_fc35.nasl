...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819143");
  ...
  script_tag(name:"creation_date", value:"2021-11-18 07:50:42 +0000 (Thu, 18 Nov 2021)");
  script_name("Fedora: Security Advisory for guacamole-server (FEDORA-2021-2c25f03d0b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-2c25f03d0b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4U4NIJUKNM6NVTXJUCLEWOXSC6MSDRWQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'guacamole-server'
  package(s) announced via the FEDORA-2021-2c25f03d0b advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"guacamole-server", rpm:"guacamole-server~1.3.0~9.fc35", rls:"FC35"))) {
    report += res;
  }
