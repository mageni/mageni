...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819179");
  ...
  script_name("Fedora: Security Advisory for rubygem-rmagick (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KAXKJUQ2LG5PWOWQLNFNOZ3WOSKMMK7X");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-rmagick", rpm:"rubygem-rmagick~4.2.3~3.fc35", rls:"FC35"))) {
    report += res;
  }
