...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879460");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2021-d1fdd76443)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d1fdd76443");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MQI7RCR37FAWAGNNDRNWSDCK5HYSV45J");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2021-d1fdd76443 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.7~3.fc34", rls:"FC34"))) {
    report += res;
  }
