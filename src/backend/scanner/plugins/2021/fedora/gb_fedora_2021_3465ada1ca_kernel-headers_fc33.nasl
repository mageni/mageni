...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878800");
  ...
  script_tag(name:"creation_date", value:"2021-01-14 09:51:01 +0000 (Thu, 14 Jan 2021)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-3465ada1ca)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2UNVLDW2IS4N3JNM2CEZMF3M7J3DHSFX");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.10.6~200.fc33", rls:"FC33"))) {
    report += res;
  }
