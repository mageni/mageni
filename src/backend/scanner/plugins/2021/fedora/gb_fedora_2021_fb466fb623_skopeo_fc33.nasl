...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878988");
  ...
  script_name("Fedora: Security Advisory for skopeo (FEDORA-2021-fb466fb623)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7WIB77IOGIKRTRPQ7WKXNZ4FAJEI34QK");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"skopeo", rpm:"skopeo~1.2.2~1.fc33", rls:"FC33"))) {
    report += res;
  }
