...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879216");
  ...
  script_name("Fedora: Security Advisory for gnome-boxes (FEDORA-2021-303f6623fa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AUD64A4HUIAEA6DF6E7INOKW2IIHGNMK");
  ...
  * When technology permits, set up access for applications on
  ...
  script_tag(name:"affected", value:"'gnome-boxes' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-boxes-40", rpm:"gnome-boxes-40~rc~1.fc34", rls:"FC34"))) {
    report += res;
  }
