...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818408");
  ...
  script_name("Fedora: Security Advisory for ntfs-3g (FEDORA-2021-c0235d9d79)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J6ACAL2OSY4MFKIQMETQG4T7ZJS2BVPE");
...
file access right and ownership support.");
  ...
  script_tag(name:"affected", value:"'ntfs-3g' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntfs-3g", rpm:"ntfs-3g~2021.8.22~1.fc34", rls:"FC34"))) {
    report += res;
  }
