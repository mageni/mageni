...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819334");
  ...
  script_name("Fedora: Security Advisory for containerd (FEDORA-2021-eb2742b148)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FLBBZYA3OFWVHHKTB5WOIIX6O7UI3YQS");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.5.8~1.fc34", rls:"FC34"))) {
    report += res;
  }
