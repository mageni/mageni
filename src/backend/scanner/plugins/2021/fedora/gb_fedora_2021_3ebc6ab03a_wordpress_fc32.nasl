...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879422");
  ...
  script_name("Fedora: Security Advisory for wordpress (FEDORA-2021-3ebc6ab03a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-3ebc6ab03a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YRHTZI542SQBYTF4XZE7QJMXJYQUEAMU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2021-3ebc6ab03a advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.7.1~1.fc32", rls:"FC32"))) {
    report += res;
  }
