...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879874");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-07dc0b3eb1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XJ64D4CHN3ZN5E3HT2PGZOTP52JGOQN4");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.13.3~200.fc34", rls:"FC34"))) {
    report += res;
  }
