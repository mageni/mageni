...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818416");
  ...
  script_tag(name:"creation_date", value:"2021-09-11 01:09:36 +0000 (Sat, 11 Sep 2021)");
  script_name("Fedora: Security Advisory for mosquitto (FEDORA-2021-aee8f32946)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-aee8f32946");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/K4WWGVF5BUFPYPCFUPPP4KRIYI5OTJN2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mosquitto'
  package(s) announced via the FEDORA-2021-aee8f32946 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mosquitto", rpm:"mosquitto~2.0.12~1.fc34", rls:"FC34"))) {
    report += res;
  }
