...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819134");
  ...
  script_name("Fedora: Security Advisory for dmtx-utils (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DFEWZHUDIWAJQNJMD6YXGIA5QQUV5CTY");
...
libdmtx.");
  ...
  script_tag(name:"affected", value:"'dmtx-utils' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dmtx-utils", rpm:"dmtx-utils~0.7.6~9.fc35.1", rls:"FC35"))) {
    report += res;
  }
