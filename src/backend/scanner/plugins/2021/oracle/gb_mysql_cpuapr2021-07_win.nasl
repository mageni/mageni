...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.145806");
  script_version("2021-04-21T06:41:13+0000");
  script_tag(name:"last_modification", value:"2021-04-22 10:14:47 +0000 (Thu, 22 Apr 2021)");
  script_tag(name:"creation_date", value:"2021-04-21 06:40:34 +0000 (Wed, 21 Apr 2021)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:M/C:N/I:N/A:C");

  script_cve_id("CVE-2021-2213");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0 <= 8.0.22 Security Update (cpuapr2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version and 8.0 through 8.0.22.");
