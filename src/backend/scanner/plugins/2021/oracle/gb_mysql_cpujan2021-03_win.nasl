...
if (description)
{
  ...
  script_name("Oracle MySQL 5.7 <= 5.7.32 Security Update (cpujan2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 5.7 through 5.7.32.");
