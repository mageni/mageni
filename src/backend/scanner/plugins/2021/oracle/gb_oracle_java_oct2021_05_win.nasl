...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818831");
  ...
  script_name("Oracle Java SE Security Update (oct2021) 05 - Windows");
  ...
  and earlier, 7u311 (1.7.0.311) and earlier on Windows.");
