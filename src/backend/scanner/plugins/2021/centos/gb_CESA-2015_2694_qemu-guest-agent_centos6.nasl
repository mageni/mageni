...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882351");
  ...
  script_name("CentOS: Security Advisory for qemu-guest-agent (CESA-2015:2694)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2015:2694");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2015-December/021581.html");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-guest-agent", rpm:"qemu-guest-agent~0.12.1.2~2.479.el6_7.3", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~0.12.1.2~2.479.el6_7.3", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm", rpm:"qemu-kvm~0.12.1.2~2.479.el6_7.3", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm-tools", rpm:"qemu-kvm-tools~0.12.1.2~2.479.el6_7.3", rls:"CentOS6"))) {
    report += res;
  }
