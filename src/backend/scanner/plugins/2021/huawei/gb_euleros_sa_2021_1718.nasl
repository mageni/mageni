...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1718");
  script_version("2021-04-13T06:14:49+0000");
  ...
  script_tag(name:"creation_date", value:"2021-04-13 06:14:49 +0000 (Tue, 13 Apr 2021)");
  script_name("Huawei EulerOS: Security Advisory for open-iscsi (EulerOS-SA-2021-1718)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1718");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1718");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'open-iscsi' package(s) announced via the EulerOS-SA-2021-1718 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"open-iscsi", rpm:"open-iscsi~2.0.876~21.h15.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
