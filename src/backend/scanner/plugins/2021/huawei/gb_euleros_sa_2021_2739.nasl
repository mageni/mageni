...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2739");
  ...
  script_name("Huawei EulerOS: Security Advisory for sssd (EulerOS-SA-2021-2739)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2739");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2739");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sssd' package(s) announced via the EulerOS-SA-2021-2739 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-sssd", rpm:"python3-sssd~2.2.2~3.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"sssd", rpm:"sssd~2.2.2~3.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
