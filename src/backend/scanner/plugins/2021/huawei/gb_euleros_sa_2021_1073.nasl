...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1073");
  script_version("2021-01-19T10:09:33+0000");
  script_cve_id("CVE-2019-9512", "CVE-2019-9514", "CVE-2020-16845", "CVE-2020-24553");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_tag(name:"last_modification", value:"2021-01-20 11:07:43 +0000 (Wed, 20 Jan 2021)");
  script_tag(name:"creation_date", value:"2021-01-19 10:09:33 +0000 (Tue, 19 Jan 2021)");
  script_name("Huawei EulerOS: Security Advisory for golang (EulerOS-SA-2021-1073)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1073");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1073");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'golang' package(s) announced via the EulerOS-SA-2021-1073 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang", rpm:"golang~1.13.3~9", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-bin", rpm:"golang-bin~1.13.3~9", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-src", rpm:"golang-src~1.13.3~9", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
