...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1254");
  ...
  script_tag(name:"creation_date", value:"2021-02-05 15:06:01 +0000 (Fri, 05 Feb 2021)");
  script_name("Huawei EulerOS: Security Advisory for python-pillow (EulerOS-SA-2021-1254)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1254");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1254");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'python-pillow' package(s) announced via the EulerOS-SA-2021-1254 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-pillow", rpm:"python-pillow~5.3.0~4.h7.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-pillow", rpm:"python3-pillow~5.3.0~4.h7.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
