...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1552");
  script_version("2021-03-05T07:10:30+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-05 07:10:30 +0000 (Fri, 05 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for perl-DBI (EulerOS-SA-2021-1552)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1552");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1552");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'perl-DBI' package(s) announced via the EulerOS-SA-2021-1552 advisory.");
...
An issue was discovered in the DBI module through 1.643 for Perl. DBD::File drivers can open files from folders other than those specifically passed via the f_dir attribute in the data source name (DSN). NOTE: this issue exists because of an incomplete fix for CVE-2014-10401.(CVE-2014-10402)");
  ...
  script_tag(name:"affected", value:"'perl-DBI' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.6.0.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-DBI", rpm:"perl-DBI~1.641~5.h2.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
