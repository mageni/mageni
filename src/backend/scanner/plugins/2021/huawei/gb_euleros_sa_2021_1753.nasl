...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1753");
  script_version("2021-04-13T06:16:17+0000");
  ...
  script_name("Huawei EulerOS: Security Advisory for openldap (EulerOS-SA-2021-1753)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1753");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1753");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openldap' package(s) announced via the EulerOS-SA-2021-1753 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.4.49~3.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-clients", rpm:"openldap-clients~2.4.49~3.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
