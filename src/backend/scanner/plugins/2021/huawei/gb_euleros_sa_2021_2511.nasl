...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2511");
  ...
  script_name("Huawei EulerOS: Security Advisory for mod_auth_mellon (EulerOS-SA-2021-2511)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2511");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2511");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mod_auth_mellon' package(s) announced via the EulerOS-SA-2021-2511 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mod_auth_mellon", rpm:"mod_auth_mellon~0.13.1~3.h5.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
