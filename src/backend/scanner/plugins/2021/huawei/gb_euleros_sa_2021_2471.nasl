...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2471");
  ...
  script_name("Huawei EulerOS: Security Advisory for libsolv (EulerOS-SA-2021-2471)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2471");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2471");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsolv' package(s) announced via the EulerOS-SA-2021-2471 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsolv", rpm:"libsolv~0.6.35~3.h5.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
