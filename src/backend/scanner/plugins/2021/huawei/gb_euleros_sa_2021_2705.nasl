...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2705");
  ...
  script_name("Huawei EulerOS: Security Advisory for cloud-init (EulerOS-SA-2021-2705)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2705");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2705");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cloud-init' package(s) announced via the EulerOS-SA-2021-2705 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cloud-init", rpm:"cloud-init~17.1~16.h7.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
