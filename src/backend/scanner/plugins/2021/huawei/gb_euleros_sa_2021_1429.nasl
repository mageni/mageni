...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1429");
  script_version("2021-03-05T07:06:02+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-05 07:06:02 +0000 (Fri, 05 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for chrony (EulerOS-SA-2021-1429)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1429");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1429");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'chrony' package(s) announced via the EulerOS-SA-2021-1429 advisory.");
  ...
  script_tag(name:"affected", value:"'chrony' package(s) on Huawei EulerOS Virtualization 3.0.2.6.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chrony", rpm:"chrony~3.2~2.h1.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
