...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2128");
  script_version("2021-07-07T09:11:54+0000");
  script_cve_id("CVE-2019-17450", "CVE-2020-16592", "CVE-2020-35493", "CVE-2020-35494", "CVE-2020-35495", "CVE-2020-35496", "CVE-2020-35507");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2021-07-07 09:11:54 +0000 (Wed, 07 Jul 2021)");
  script_tag(name:"creation_date", value:"2021-07-07 08:42:33 +0000 (Wed, 07 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for bindutils (EulerOS-SA-2021-2128)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2128");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2128");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'bindutils' package(s) announced via the EulerOS-SA-2021-2128 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.27~28.base.1.h49.eulerosv2r7.x86_64", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
