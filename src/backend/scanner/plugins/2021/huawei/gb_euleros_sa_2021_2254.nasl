...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2254");
  script_cve_id("CVE-2021-20266", "CVE-2021-20271", "CVE-2021-3421");
  script_tag(name:"creation_date", value:"2021-08-09 10:10:44 +0000 (Mon, 09 Aug 2021)");
  ...
  script_name("Huawei EulerOS: Security Advisory for rpm (EulerOS-SA-2021-2254)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2254");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2254");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'rpm' package(s) announced via the EulerOS-SA-2021-2254 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-rpm", rpm:"python3-rpm~4.15.1~12.h18.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpm", rpm:"rpm~4.15.1~12.h18.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpm-libs", rpm:"rpm-libs~4.15.1~12.h18.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
