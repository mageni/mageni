...
if(description)
{
  ...
  script_version("2021-01-19T10:12:42+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1132");
  ...
  'xorg-x11-server' package(s) announced via the EulerOS-SA-2021-1132 advisory.");
