...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1322");
  script_version("2021-02-22T08:38:41+0000");
  script_cve_id("CVE-2017-0393", "CVE-2019-9433");
  script_tag(name:"cvss_base", value:"7.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:C");
  script_tag(name:"last_modification", value:"2021-02-23 12:20:55 +0000 (Tue, 23 Feb 2021)");
  script_tag(name:"creation_date", value:"2021-02-22 08:38:41 +0000 (Mon, 22 Feb 2021)");
  script_name("Huawei EulerOS: Security Advisory for libvpx (EulerOS-SA-2021-1322)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1322");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1322");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libvpx' package(s) announced via the EulerOS-SA-2021-1322 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvpx", rpm:"libvpx~1.3.0~5.h2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
