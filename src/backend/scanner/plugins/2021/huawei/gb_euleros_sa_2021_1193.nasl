...
if(description)
{
  ...
  'ghostscript' package(s) announced via the EulerOS-SA-2021-1193 advisory.");
...
The gx_ttfReader__Read function in base/gxttfb.c in Artifex Ghostscript GhostXPS 9.21 allows remote attackers to cause a denial of service (heap-based buffer over-read and application crash ...
