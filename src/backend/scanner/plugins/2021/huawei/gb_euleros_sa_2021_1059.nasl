...
if(description)
{
  ...
  script_version("2021-01-19T10:08:53+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1059");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1059");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'bind' package(s) announced via the EulerOS-SA-2021-1059 advisory.");
