...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1447");
  script_version("2021-03-05T07:06:37+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-05 07:06:37 +0000 (Fri, 05 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for perl-DBD-MySQL (EulerOS-SA-2021-1447)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1447");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1447");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'perl-DBD-MySQL' package(s) announced via the EulerOS-SA-2021-1447 advisory.");
...
The DBD::mysql module through 4.043 for Perl uses the mysql_ssl=1 setting to mean that SSL is optional (even though this setting's documentation has a 'your communication with the server will be encrypted' statement), which allows man-in-the-middle attackers to spoof servers via a cleartext-downgrade attack, a related issue to CVE-2015-3152.(CVE-2017-10789)");
  ...
  script_tag(name:"affected", value:"'perl-DBD-MySQL' package(s) on Huawei EulerOS Virtualization 3.0.2.6.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-DBD-MySQL", rpm:"perl-DBD-MySQL~4.023~6.h2.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
