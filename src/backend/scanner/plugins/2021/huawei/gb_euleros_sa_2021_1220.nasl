...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1220");
  ...
  script_tag(name:"creation_date", value:"2021-02-05 15:04:03 +0000 (Fri, 05 Feb 2021)");
  script_name("Huawei EulerOS: Security Advisory for openjpeg (EulerOS-SA-2021-1220)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1220");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1220");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openjpeg' package(s) announced via the EulerOS-SA-2021-1220 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg-libs", rpm:"openjpeg-libs~1.5.1~17.h4.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
