...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818022");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_12-2021-03)-Linux");
  ...
  prior to 89.0.4389.90 on Linux");
