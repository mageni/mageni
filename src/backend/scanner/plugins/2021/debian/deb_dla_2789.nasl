...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for squashfs-tools (DLA-2789-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/10/msg00017.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2789-1");
  script_xref(name:"Advisory-ID", value:"DLA-2789-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools'
  package(s) announced via the DLA-2789-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"squashfs-tools", ver:"1:4.3-3+deb9u3", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"squashfs-tools-dbg", ver:"1:4.3-3+deb9u3", rls:"DEB9"))) {
  report += res;
}
