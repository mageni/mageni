...
if(description)
{
  ...
  script_version("2021-07-01T03:00:10+0000");
  ...
  script_name("Debian LTS: Security Advisory for ipmitool (DLA-2699-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/06/msg00029.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2699-1");
  ...
  package(s) announced via the DLA-2699-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue has been found in ipmitool, an utility for IPMI control with
