...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for openjdk-8 (DLA-2814-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/11/msg00008.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2814-1");
  script_xref(name:"Advisory-ID", value:"DLA-2814-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-8'
  package(s) announced via the DLA-2814-1 advisory.");
