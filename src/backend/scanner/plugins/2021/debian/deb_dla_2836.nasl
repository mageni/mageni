...
if(description)
{
  ...
  script_version("2021-12-03T02:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for nss (DLA-2836-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/12/msg00000.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2836-1");
  script_xref(name:"Advisory-ID", value:"DLA-2836-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss'
  package(s) announced via the DLA-2836-1 advisory.");
