...
if(description)
{
  ...
  script_version("2021-01-13T04:00:31+0000");
  ...
  script_name("Debian LTS: Security Advisory for coturn (DLA-2522-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/01/msg00011.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2522-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'coturn'
  package(s) announced via the DLA-2522-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"coturn", ver:"4.5.0.5-1+deb9u3", rls:"DEB9"))) {
  report += res;
}
