...
if(description)
{
  ...
  script_version("2021-04-28T03:00:07+0000");
  ...
  script_name("Debian LTS: Security Advisory for gst-plugins-bad1.0 (DLA-2642-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00029.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2642-1");
  script_xref(name:"Advisory-ID", value:"DLA-2642-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gst-plugins-bad1.0'
  package(s) announced via the DLA-2642-1 advisory.");
