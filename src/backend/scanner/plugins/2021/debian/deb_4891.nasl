...
if(description)
{
  ...
  script_version("2021-04-15T03:00:10+0000");
  ...
  script_name("Debian: Security Advisory for tomcat9 (DSA-4891-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4891.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4891-1");
  script_xref(name:"Advisory-ID", value:"DSA-4891-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat9'
  package(s) announced via the DSA-4891-1 advisory.");
