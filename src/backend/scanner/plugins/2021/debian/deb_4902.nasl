...
if(description)
{
  ...
  script_name("Debian: Security Advisory for gst-plugins-bad1.0 (DSA-4902-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4902.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4902-1");
  script_xref(name:"Advisory-ID", value:"DSA-4902-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gst-plugins-bad1.0'
  package(s) announced via the DSA-4902-1 advisory.");
