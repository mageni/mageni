...
if( description )
{
  ...
  script_version("2021-01-12T09:12:14+0000");
  ...
  script_dependencies("gb_jquery_detect.nasl", "os_detection.nasl");
  script_mandatory_keys("jquery/detected", "Host/runs_windows");

  script_tag(name:"summary", value:"The installed version of jQuery on the remote host has reached the End of Life (EOL) and
  should not be used anymore.");

  script_tag(name:"impact", value:"An EOL version of jQuery is not receiving any security updates from the vendor. Unfixed
