...
if (description)
{
  ...
  script_version("2021-12-13T10:04:26+0000");
  ...
  script_name("Elastic Logstash Log4j RCE Vulnerability (Log4Shell)");
  ...
  script_tag(name:"summary", value:"Logstash is prone to a remote code execution (RCE)
  ...
  script_tag(name:"affected", value:"Logstash prior to version 6.8.21 and 7.x prior to 7.16.1.");
...
if (version_is_less(version: version, test_version: "6.8.21")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "6.8.21", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "7.0.0", test_version2: "7.16.0")) {
