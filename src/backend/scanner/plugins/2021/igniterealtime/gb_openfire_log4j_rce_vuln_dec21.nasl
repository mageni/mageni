...
if(description)
{
  ...
  script_name("Openfire < 4.6.5 Log4j RCE Vulnerability (Log4Shell)");
  ...
  script_tag(name:"summary", value:"Openfire is prone to a remote code execution (RCE) vulnerability
  ...
  script_tag(name:"affected", value:"Openfire version 4.6.4 and prior.");

  script_tag(name:"solution", value:"Update to version 4.6.5 or later.");

  script_xref(name:"URL", value:"https://discourse.igniterealtime.org/t/openfire-4-6-5-released/91108");
