...
if(description)
{
  ...
  script_name("OpenLDAP < 2.4.55 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"A NULL pointer dereference was found in OpenLDAP server during
  a request for renaming RDNs. An unauthenticated attacker could remotely crash the slapd process
  by sending a specially crafted request, causing a denial of service.");

  script_tag(name:"affected", value:"OpenLDAP prior to version 2.4.55.");

  script_tag(name:"solution", value:"Update to version 2.4.55 or later.");

  script_xref(name:"URL", value:"https://lists.openldap.org/hyperkitty/list/openldap-announce@openldap.org/thread/2LNDHYYOU5VCK2DSRLEQYRCTWVWXZ2AJ/");
