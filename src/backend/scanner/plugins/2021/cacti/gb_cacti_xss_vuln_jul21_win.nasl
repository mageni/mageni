...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147152");
  script_version("2021-11-15T03:52:06+0000");
  script_tag(name:"last_modification", value:"2021-11-15 10:55:03 +0000 (Mon, 15 Nov 2021)");
  script_tag(name:"creation_date", value:"2021-11-15 03:51:27 +0000 (Mon, 15 Nov 2021)");
  ...
  script_name("Cacti < 1.2.18 XSS Vulnerability - Windows");
  ...
  script_tag(name:"affected", value:"Cacti prior to version 1.2.18.");

  script_tag(name:"solution", value:"Update to version 1.2.18 or later.");

  script_xref(name:"URL", value:"https://github.com/Cacti/cacti/pull/4261");
