...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146879");
  script_version("2021-10-11T11:32:40+0000");
  script_tag(name:"last_modification", value:"2021-10-12 10:34:41 +0000 (Tue, 12 Oct 2021)");
  script_tag(name:"creation_date", value:"2021-10-11 11:25:43 +0000 (Mon, 11 Oct 2021)");
  ...
  script_name("PostgreSQL 11.x < 11.12, 12.x < 12.7, 13.x < 13.3 Information Disclosure Vulnerability - Linux");
