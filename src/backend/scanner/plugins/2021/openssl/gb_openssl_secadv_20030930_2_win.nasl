...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112918");
  ...
  script_name("OpenSSL: Double Free Vulnerability (CVE-2003-0545) (Windows)");
  ...
  script_tag(name:"solution", value:"Update OpenSSL to version 0.9.7c or later. See the references for
  more details.");
