...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112925");
  ...
  script_name("OpenSSL: DoS Vulnerability (CVE-2004-0112) (Linux)");
  ...
  script_tag(name:"solution", value:"Update OpenSSL to version 0.9.7d or later. See the references for
  more details.");
