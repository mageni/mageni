...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112941");
  ...
  script_name("OpenSSL: Multiple Vulnerabilities (20090325) (Windows)");
  ...
  script_tag(name:"affected", value:"OpenSSL 0.9.8 through 0.9.8j.");
...
if (version_in_range(version: version, test_version: "0.9.8", test_version2: "0.9.8j")) {
