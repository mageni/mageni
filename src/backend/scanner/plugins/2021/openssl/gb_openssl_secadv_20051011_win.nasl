...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112930");
  script_version("2021-08-13T09:47:16+0000");
  ...
  script_name("OpenSSL: Man in the Middle Attack (CVE-2005-2969) (Windows)");
  ...
  script_tag(name:"solution", value:"Update OpenSSL to version 0.9.7h, 0.9.8a or later.");
