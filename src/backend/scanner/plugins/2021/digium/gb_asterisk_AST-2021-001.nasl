...
if (description)
{
  ...
  script_cve_id("CVE-2020-35776");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Asterisk DoS Vulnerability (AST-2021-001)");
  ...
  script_xref(name:"URL", value:"https://downloads.asterisk.org/pub/security/AST-2021-001.html");
...
if (version_in_range(version: version, test_version: "16.15.1", test_version2: "16.16.0")) {
...
if (version_in_range(version: version, test_version: "18.1.1", test_version2: "18.2.0")) {
