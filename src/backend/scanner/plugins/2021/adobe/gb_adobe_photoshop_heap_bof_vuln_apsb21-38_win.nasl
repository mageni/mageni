...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818143");
  script_version("2021-06-15T03:25:17+0000");
  script_cve_id("CVE-2021-28624");
  ...
  script_name("Adobe Photoshop Heap-based Buffer Overflow Vulnerability (APSB21-38) - Windows");
  ...
  script_tag(name:"affected", value:"Adobe Photoshop 2020 21.2.8 and earlier
  and Adobe Photoshop 2021 22.4.1 and earlier versions on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Photoshop 2020 21.2.9
  or Adobe Photoshop 2021 22.4.2 or later. Please see the references for more
  information.");
...
if(vers =~ "^21\.") {
  if(version_is_less(version:vers, test_version:"21.2.9")) {
    fix = "21.2.9";
  ...
  if(version_is_less(version:vers, test_version:"22.4.2")) {
    fix = "22.4.2";
