...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818502");
  ...
  script_name("Adobe Reader DC Continuous Security Update (APSB21-51) - Mac OS X");
  ...
  2021.005.20054andearlierversions on Mac OS X.");
