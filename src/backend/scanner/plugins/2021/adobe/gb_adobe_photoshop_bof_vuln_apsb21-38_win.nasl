...
if(description)
{
  ...
  and Adobe Photoshop 2021 prior to 22.4.0 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Photoshop 2020 21.2.8
  or Adobe Photoshop 2021 22.4.0 or later. Please see the references for more
  information.");
