...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814856");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2019-7815");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2019-02-25 12:04:54 +0530 (Mon, 25 Feb 2019)");
  script_name("Adobe Acrobat DC (Continuous Track) Security Updates (apsb19-13)-Windows");
