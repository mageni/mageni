...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815689");
  ...
  script_name("Adobe Acrobat DC (Continuous) Security Updates(apsb19-55)-Windows");
  ...
  prior to version 2019.021.20058 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Acrobat DC 2019 (Continuous)
