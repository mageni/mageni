...
if(description)
{
  ...
  script_version("2019-10-27T03:00:09+0000");
  script_cve_id("CVE-2019-18408");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-10-27 03:00:09 +0000 (Sun, 27 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-27 03:00:09 +0000 (Sun, 27 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1971-1] libarchive security update)");
  ...
  package(s) announced via the DSA-1971-1 advisory.");
