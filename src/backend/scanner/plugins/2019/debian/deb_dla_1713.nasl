...
if(description)
{
  ...
  script_cve_id("CVE-2019-7572", "CVE-2019-7573", "CVE-2019-7574", "CVE-2019-7575", "CVE-2019-7576",
                ...
                "CVE-2019-7638");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1713-1] libsdl1.2 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsdl1.2-dbg", ver:"1.2.15-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsdl1.2-dev", ver:"1.2.15-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsdl1.2debian", ver:"1.2.15-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
