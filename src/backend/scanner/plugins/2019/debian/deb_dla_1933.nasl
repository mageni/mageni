...
if(description)
{
  ...
  script_version("2019-09-27T02:00:13+0000");
  script_cve_id("CVE-2019-5477");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-09-27 02:00:13 +0000 (Fri, 27 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-27 02:00:13 +0000 (Fri, 27 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1933-1] ruby-nokogiri security update)");
  ...
  package(s) announced via the DSA-1933-1 advisory.");
