...
if(description)
{
  ...
  script_version("2019-05-26T02:00:33+0000");
  script_cve_id("CVE-2019-10894", "CVE-2019-10895", "CVE-2019-10899", "CVE-2019-10901", "CVE-2019-10903");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-26 02:00:33 +0000 (Sun, 26 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-26 02:00:33 +0000 (Sun, 26 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1802-1] wireshark security update)");
  ...
  package(s) announced via the DSA-1802-1 advisory.");
