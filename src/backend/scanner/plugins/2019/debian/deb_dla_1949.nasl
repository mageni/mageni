...
if(description)
{
  ...
  script_version("2019-10-09T02:00:09+0000");
  script_cve_id("CVE-2018-19961", "CVE-2018-19962", "CVE-2018-19966");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-10-09 02:00:09 +0000 (Wed, 09 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-09 02:00:09 +0000 (Wed, 09 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1949-1] xen security update)");
  ...
  package(s) announced via the DSA-1949-1 advisory.");
