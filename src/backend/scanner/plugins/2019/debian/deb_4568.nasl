...
if(description)
{
  ...
  script_version("2019-11-17T03:00:04+0000");
  script_cve_id("CVE-2019-3466");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-17 03:00:04 +0000 (Sun, 17 Nov 2019)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"postgresql", ver:"200+deb10u3", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-all", ver:"200+deb10u3", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-client", ver:"200+deb10u3", rls:"DEB10"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"postgresql-contrib", ver:"200+deb10u3", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-doc", ver:"200+deb10u3", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-server-dev-all", ver:"200+deb10u3", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql", ver:"181+deb9u3", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-all", ver:"181+deb9u3", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-client", ver:"181+deb9u3", rls:"DEB9"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"postgresql-contrib", ver:"181+deb9u3", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"postgresql-doc", ver:"181+deb9u3", rls:"DEB9"))) {
  report += res;
}
