...
if(description)
{
  ...
  script_version("2019-10-12T02:00:06+0000");
  script_cve_id("CVE-2019-11027");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-10-12 02:00:06 +0000 (Sat, 12 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-12 02:00:06 +0000 (Sat, 12 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1956-1] ruby-openid security update)");
  ...
  package(s) announced via the DSA-1956-1 advisory.");
