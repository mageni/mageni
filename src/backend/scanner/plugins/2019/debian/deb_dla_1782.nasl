...
if(description)
{
  ...
  script_version("2019-05-11T02:00:08+0000");
  script_cve_id("CVE-2019-2602", "CVE-2019-2684", "CVE-2019-2698");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-11 02:00:08 +0000 (Sat, 11 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-11 02:00:08 +0000 (Sat, 11 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1782-1] openjdk-7 security update)");
  ...
  package(s) announced via the DSA-1782-1 advisory.");
