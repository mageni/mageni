...
if(description)
{
  ...
  script_version("2019-05-28T02:00:16+0000");
  ...
  script_tag(name:"last_modification", value:"2019-05-28 02:00:16 +0000 (Tue, 28 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-28 02:00:16 +0000 (Tue, 28 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1806-1] thunderbird security update)");
  ...
  package(s) announced via the DSA-1806-1 advisory.");
