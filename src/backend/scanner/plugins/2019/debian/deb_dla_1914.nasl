...
if(description)
{
  ...
  script_version("2019-09-10T02:00:20+0000");
  script_cve_id("CVE-2019-10181", "CVE-2019-10182", "CVE-2019-10185");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-09-10 02:00:20 +0000 (Tue, 10 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-10 02:00:20 +0000 (Tue, 10 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1914-1] icedtea-web security update)");
  ...
  package(s) announced via the DSA-1914-1 advisory.");
