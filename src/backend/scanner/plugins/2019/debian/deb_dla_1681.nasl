...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1681-1] gsoap security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"gsoap", ver:"2.8.17-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gsoap-dbg", ver:"2.8.17-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gsoap-doc", ver:"2.8.17-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgsoap-dbg", ver:"2.8.17-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgsoap-dev", ver:"2.8.17-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgsoap5", ver:"2.8.17-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
