...
if(description)
{
  ...
  script_version("2019-12-31T03:00:12+0000");
  script_cve_id("CVE-2016-2090");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-12-31 03:00:12 +0000 (Tue, 31 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-31 03:00:12 +0000 (Tue, 31 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2052-1] libbsd security update)");
  ...
  package(s) announced via the DSA-2052-1 advisory.");
