...
if(description)
{
  ...
  script_version("2019-10-20T02:00:07+0000");
  script_cve_id("CVE-2019-3689");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-10-20 02:00:07 +0000 (Sun, 20 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-20 02:00:07 +0000 (Sun, 20 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1965-1] nfs-utils security update)");
  ...
  package(s) announced via the DSA-1965-1 advisory.");
