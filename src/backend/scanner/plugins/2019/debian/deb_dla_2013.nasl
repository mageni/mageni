...
if(description)
{
  ...
  script_version("2019-11-28T03:00:10+0000");
  script_cve_id("CVE-2017-14160", "CVE-2018-10392", "CVE-2018-10393");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-28 03:00:10 +0000 (Thu, 28 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-28 03:00:10 +0000 (Thu, 28 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2013-1] libvorbis security update)");
  ...
  package(s) announced via the DSA-2013-1 advisory.");
