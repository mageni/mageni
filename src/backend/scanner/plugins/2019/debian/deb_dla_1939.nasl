...
if(description)
{
  ...
  script_version("2019-10-01T02:00:10+0000");
  script_cve_id("CVE-2018-20650", "CVE-2018-21009", "CVE-2019-12493");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-10-01 02:00:10 +0000 (Tue, 01 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-01 02:00:10 +0000 (Tue, 01 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1939-1] poppler security update)");
  ...
  package(s) announced via the DSA-1939-1 advisory.");
