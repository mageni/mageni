...
if(description)
{
  ...
  script_version("2019-09-29T02:00:17+0000");
  script_cve_id("CVE-2019-5094");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-09-29 02:00:17 +0000 (Sun, 29 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-29 02:00:17 +0000 (Sun, 29 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1935-1] e2fsprogs security update)");
  ...
  package(s) announced via the DSA-1935-1 advisory.");
