...
if(description)
{
  ...
  script_version("2019-10-07T02:00:24+0000");
  ...
  script_tag(name:"last_modification", value:"2019-10-07 02:00:24 +0000 (Mon, 07 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-07 02:00:24 +0000 (Mon, 07 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1947-1] libreoffice security update)");
  ...
  package(s) announced via the DSA-1947-1 advisory.");
