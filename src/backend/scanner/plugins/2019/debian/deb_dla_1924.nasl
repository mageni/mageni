...
if(description)
{
  ...
  script_version("2019-09-17T02:00:23+0000");
  script_cve_id("CVE-2019-16056");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-09-17 02:00:23 +0000 (Tue, 17 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-17 02:00:23 +0000 (Tue, 17 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1924-1] python3.4 security update)");
  ...
  package(s) announced via the DSA-1924-1 advisory.");
