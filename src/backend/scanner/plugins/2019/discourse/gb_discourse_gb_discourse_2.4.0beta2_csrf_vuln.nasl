...
if(description)
{
  ...
  script_version("2019-08-27T11:05:23+0000");
  script_tag(name:"last_modification", value:"2019-08-27 11:05:23 +0000 (Tue, 27 Aug 2019)");
  ...
  script_name("Discourse <= 2.4.0.beta2 CSRF Token Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw exists because Discourse is sending the CSRF token in query
  strings.");

  script_tag(name:"affected", value:"Discourse up to and including version 2.4.0.beta2.");

  script_tag(name:"solution", value:"No known solution is available as of 27th August, 2019. Information
...
if( version_is_less_equal( version:vers, test_version:"2.4.0.beta2" ) ) {
