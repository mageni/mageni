...
if(description)
{
  ...
  script_version("2019-11-22T10:17:06+0000");
  script_tag(name:"last_modification", value:"2019-11-22 10:17:06 +0000 (Fri, 22 Nov 2019)");
  ...
  script_name("FreePBX < 15.0.16.27, 14.0.13.12 or 13.0.197.14 Auth Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"FreePBX is prone to a remote admin authentication bypass vulnerability.");
  ...
  script_tag(name:"affected", value:"FreePBX versions 15.0.16.26 and below, 14.0.13.11 and below, 13.0.197.13 and below.");

  script_tag(name:"solution", value:"Update to version 13.0.197.14, 14.0.13.12 or 15.6.16.27 respectively.");
