...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877025");
  ...
  script_name("Fedora Update for freetds FEDORA-2019-db2d7b1c80");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/G6OTALFMF7VGLQOC6XPEZT6OLUDJTHMD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freetds'
  package(s) announced via the FEDORA-2019-db2d7b1c80 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freetds", rpm:"freetds~1.1.20~1.fc30", rls:"FC30"))) {
    report += res;
  }
