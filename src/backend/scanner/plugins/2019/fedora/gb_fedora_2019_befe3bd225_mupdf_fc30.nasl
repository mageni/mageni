...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876394");
  script_version("2019-05-31T13:18:49+0000");
  script_cve_id("CVE-2018-19881", "CVE-2018-19882", "CVE-2019-6131", "CVE-2019-6130");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-31 13:18:49 +0000 (Fri, 31 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-22 02:14:19 +0000 (Wed, 22 May 2019)");
  script_name("Fedora Update for mupdf FEDORA-2019-befe3bd225");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SEK2EHVNREJ7XZMFF2MXRWKIF4IBHPNE");

  script_tag(name:"summary", value:"The remote host is missing an update for the
  'mupdf' package(s) announced via the FEDORA-2019-befe3bd225 advisory.");
  ...
  accessing the internal structures of the PDF document.  Example code for navigating
  interactive links and bookmarks, encrypting PDF files, extracting fonts, images, and
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mupdf", rpm:"mupdf~1.15.0~1.fc30", rls:"FC30"))) {
    report += res;
  }
