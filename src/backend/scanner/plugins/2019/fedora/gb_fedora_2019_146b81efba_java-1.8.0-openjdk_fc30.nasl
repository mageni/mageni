...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876650");
  ...
  script_name("Fedora Update for java-1.8.0-openjdk FEDORA-2019-146b81efba");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Z6KNXCZYB7I4ZE6PD2IRFMIPFSHFQUEF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk'
  package(s) announced via the FEDORA-2019-146b81efba advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~1.8.0.222.b10~0.fc30", rls:"FC30"))) {
    report += res;
  }
