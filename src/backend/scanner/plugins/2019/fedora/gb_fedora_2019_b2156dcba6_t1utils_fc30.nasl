...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876965");
  ...
  script_tag(name:"creation_date", value:"2019-11-04 03:21:19 +0000 (Mon, 04 Nov 2019)");
  script_name("Fedora Update for t1utils FEDORA-2019-b2156dcba6");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2VE4VFK364FITBQIGYRLPPA66RZT5HIN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 't1utils'
  package(s) announced via the FEDORA-2019-b2156dcba6 advisory.");
...
format, and Macintosh resource forks.");
  ...
  script_tag(name:"affected", value:"'t1utils' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"t1utils", rpm:"t1utils~1.41~1.fc30", rls:"FC30"))) {
    report += res;
  }
