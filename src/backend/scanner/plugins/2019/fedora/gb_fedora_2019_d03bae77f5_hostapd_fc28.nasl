...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875569");
  script_version("2019-04-25T10:19:44+0000");
  script_cve_id("CVE-2019-9494", "CVE-2019-9495", "CVE-2019-9496", "CVE-2019-9497",
  ...
  script_tag(name:"creation_date", value:"2019-04-24 02:09:51 +0000 (Wed, 24 Apr 2019)");
  script_name("Fedora Update for hostapd FEDORA-2019-d03bae77f5");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/56OBBOJJSKRTDGEXZOVFSTP4HDSDBLAE");

  script_tag(name:"summary", value:"The remote host is missing an update for the
  'hostapd' package(s) announced via the FEDORA-2019-d03bae77f5 advisory.");
...
included with hostapd.");
  ...
  script_tag(name:"affected", value:"'hostapd' package(s) on Fedora 28.");
...
if(release == "FC28") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"hostapd", rpm:"hostapd~2.7~2.fc28", rls:"FC28"))) {
    report += res;
  }
