...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876501");
  ...
  script_name("Fedora Update for js-jquery-jstree FEDORA-2019-a171291a47");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XS2LBCCI42XXZLTYCTIDCM2ZE6H6VC6O");

  script_tag(name:"summary", value:"The remote host is missing an update for the
  'js-jquery-jstree' package(s) announced via the FEDORA-2019-a171291a47 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is
  present on the target host.");

  script_tag(name:"insight", value:"jsTree is jquery plugin, that provides
  interactive trees. It is absolutely free, open source and distributed under
  the MIT license.
...
tree is familiar and easy.");
  ...
  script_tag(name:"affected", value:"'js-jquery-jstree' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"js-jquery-jstree", rpm:"js-jquery-jstree~3.3.8~1.fc29", rls:"FC29"))) {
    report += res;
  }
