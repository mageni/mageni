...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876348");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2016-8612", "CVE-2016-3110");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-10 02:11:51 +0000 (Fri, 10 May 2019)");
  script_name("Fedora Update for mod_cluster FEDORA-2019-7813edd5a2");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6JMA2YLPK6SEUVF5Q3QEANHYEPRZA2RI");

  script_tag(name:"summary", value:"The remote host is missing an update for the
  'mod_cluster' package(s) announced via the FEDORA-2019-7813edd5a2 advisory.");
  ...
  script_tag(name:"affected", value:"'mod_cluster' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mod_cluster", rpm:"mod_cluster~1.3.11~1.fc30", rls:"FC30"))) {
    report += res;
  }
