...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876558");
  ...
  script_name("Fedora Update for filezilla FEDORA-2019-6e77507660");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VXXYFJVJYWYC5XNX6QFT2UBFPJGEZVII");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"filezilla", rpm:"filezilla~3.43.0~1.fc29", rls:"FC29"))) {
    report += res;
  }
