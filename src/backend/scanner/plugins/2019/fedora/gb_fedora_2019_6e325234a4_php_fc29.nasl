...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876354");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2019-11036", "CVE-2018-19935");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-12 02:18:39 +0000 (Sun, 12 May 2019)");
  script_name("Fedora Update for php FEDORA-2019-6e325234a4");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2NFXYNCXZCPYT7ZN4ZLI5EPQQW44FRRO");

  script_tag(name:"summary", value:"The remote host is missing an update for
  the 'php' package(s) announced via the FEDORA-2019-6e325234a4 advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php", rpm:"php~7.2.18~1.fc29", rls:"FC29"))) {
    report += res;
  }
