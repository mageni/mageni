...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883003");
  script_version("$Revision: 14058 $");
  script_cve_id("CVE-2016-5824", "CVE-2018-18500", "CVE-2018-18501", "CVE-2018-18505");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2019-02-09 04:03:25 +0100 (Sat, 09 Feb 2019)");
  script_name("CentOS Update for thunderbird CESA-2019:0269 centos6");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-February/023190.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the CESA-2019:0269 advisory.");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~60.5.0~1.el6.centos", rls:"CentOS6")) != NULL)
  {
