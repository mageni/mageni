...
if(description)
{
  ...
  script_version("2019-05-06T14:21:55+0000");
  script_tag(name:"last_modification", value:"2019-05-06 14:21:55 +0000 (Mon, 06 May 2019)");
  ...
  script_tag(name:"insight", value:"Moodle allows remote authenticated administrators to execute arbitrary PHP code
  via a ZIP archive, containing a theme_*.php file, to
