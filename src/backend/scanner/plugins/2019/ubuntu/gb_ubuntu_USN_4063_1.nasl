...
if(description)
{
  ...
  script_name("Ubuntu Update for libreoffice USN-4063-1");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-4063-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice'
  package(s) announced via the USN-4063-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:6.0.7-0ubuntu0.18.04.8", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU19.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:6.2.5-0ubuntu0.19.04.1", rls:"UBUNTU19.04"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:5.1.6~rc2-0ubuntu1~xenial8", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
