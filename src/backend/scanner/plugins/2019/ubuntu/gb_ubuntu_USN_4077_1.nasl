...
to privilege escalation.");
  ...
  script_tag(name:"affected", value:"'tmpreaper' package(s) on Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tmpreaper", ver:"1.6.13+nmu1+deb9u1build0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tmpreaper", ver:"1.6.13+nmu1+deb9u1build0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
