...
if(description)
{
  ...
  script_name("Ubuntu Update for intel-microcode USN-4182-3");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-December/005234.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'intel-microcode'
  package(s) announced via the USN-4182-3 advisory.");
...
(CVE-2019-11139)");
  ...
  script_tag(name:"affected", value:"'intel-microcode' package(s) on Ubuntu 19.04, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20191115.1ubuntu0.18.04.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU19.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20191115.1ubuntu0.19.04.2", rls:"UBUNTU19.04"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20191115.1ubuntu0.16.04.2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
