...
if (description)
{
  ...
  script_version("2019-09-03T09:05:36+0000");
  script_tag(name:"last_modification", value:"2019-09-03 09:05:36 +0000 (Tue, 03 Sep 2019)");
  ...
  script_tag(name:"insight", value:"memcached 1.5.16 has a stack-based buffer over-read in conn_to_str in
  memcached.c when UNIX sockets are used.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Memcached version prior to 1.5.17.");
