...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815275");
  ...
  script_tag(name:"creation_date", value:"2019-08-16 10:34:24 +0530 (Fri, 16 Aug 2019)");
  script_name("Mozilla Firefox Security Update (mfsa_2019-24_2019-24)-MAC OS X");

  script_tag(name:"summary", value:"This host is installed with
  Mozilla Firefox and is prone to an information disclosure vulnerability.");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 68.0.2 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 68.0.2
