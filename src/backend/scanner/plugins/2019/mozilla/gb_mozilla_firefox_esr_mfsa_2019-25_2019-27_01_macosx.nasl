...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815452");
  script_version("2019-09-05T09:53:24+0000");
  script_cve_id("CVE-2019-11746", "CVE-2019-11744", "CVE-2019-11742", "CVE-2019-11740",
                "CVE-2019-11752", "CVE-2019-9812", "CVE-2019-11743");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-09-05 09:53:24 +0000 (Thu, 05 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-05 13:37:19 +0530 (Thu, 05 Sep 2019)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2019-25_2019-27_01)-Mac OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 60.9
...
if(version_is_less(version:ffVer, test_version:"60.9"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"60.9", install_path:ffPath);
