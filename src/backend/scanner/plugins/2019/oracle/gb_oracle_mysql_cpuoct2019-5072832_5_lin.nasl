...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143033");
  ...
  script_name("Oracle MySQL 5.6.x < 5.6.46, 5.7.x < 5.7.28 Security Update (2019-5072832) - Linux");
  ...
  script_tag(name:"affected", value:"MySQL 5.6.0 - 5.6.45 and 5.7.0 - 5.7.27.");
