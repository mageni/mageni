...
if(description)
{
  ...
  script_version("2019-08-12T11:57:49+0000");
  script_tag(name:"last_modification", value:"2019-08-12 11:57:49 +0000 (Mon, 12 Aug 2019)");
  ...
  script_name("Elastic Kibana < 6.8.2, 7.x.x < 7.2.1 Multiple Vulnerabilities (Linux)");
