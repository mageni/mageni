...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815852");
  ...
  script_tag(name:"creation_date", value:"2019-11-20 10:10:15 +0530 (Wed, 20 Nov 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_18-2019-11)-Linux");
