...
if(version_is_less(version:chr_ver, test_version:"74.0.3729.131"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"74.0.3729.131", install_path:chr_path);
