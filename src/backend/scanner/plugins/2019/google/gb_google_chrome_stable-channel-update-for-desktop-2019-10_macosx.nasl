...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815800");
  ...
  script_tag(name:"creation_date", value:"2019-10-11 15:51:16 +0530 (Fri, 11 Oct 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2019-10)-Mac OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 77.0.3865.120 on Mac OS X");
...
if(version_is_less(version:chr_ver, test_version:"77.0.3865.120"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"77.0.3865.120", install_path:chr_path);
