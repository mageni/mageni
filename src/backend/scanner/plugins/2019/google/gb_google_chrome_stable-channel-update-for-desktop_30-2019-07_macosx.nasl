...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815267");
  ...
  script_tag(name:"creation_date", value:"2019-07-31 10:42:55 +0530 (Wed, 31 Jul 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_30-2019-07)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 76.0.3809.87 on MAC OS X");
...
if(version_is_less(version:chr_ver, test_version:"76.0.3809.87"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"76.0.3809.87", install_path:chr_path);
