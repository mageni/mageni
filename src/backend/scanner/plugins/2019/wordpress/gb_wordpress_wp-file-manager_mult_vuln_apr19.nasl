...
if (description)
{
  ...
  script_version("2019-04-24T09:09:40+0000");
  script_tag(name:"last_modification", value:"2019-04-24 09:09:40 +0000 (Wed, 24 Apr 2019)");
...
url = dir + "/wp-content/plugins/wp-file-manager/readme.txt";
res = http_get_cache(port: port, item: url);

if("=== File Manager ===" >< res && "Changelog" >< res) {

  vers = eregmatch( pattern: "Stable tag: ([0-9.]+)", string: res);

  if(vers[1] && version_is_less(version: vers[1], test_version: "3.1")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "3.1", file_checked: url);
