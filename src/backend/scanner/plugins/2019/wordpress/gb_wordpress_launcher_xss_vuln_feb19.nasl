...
if (description)
{
  ...
  script_version("2019-05-16T11:42:19+0000");
  script_tag(name:"last_modification", value:"2019-05-16 11:42:19 +0000 (Thu, 16 May 2019)");
...
if("=== Launcher" >< res && "Changelog" >< res) {
  ...
  if(vers[1] && version_is_less(version: vers[1], test_version: "1.0.11")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "1.0.11", file_checked: url);
