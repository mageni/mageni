...
if (description)
{
  ...
  script_version("2019-07-29T10:07:13+0000");
  script_tag(name:"last_modification", value:"2019-07-29 10:07:13 +0000 (Mon, 29 Jul 2019)");
...
url = dir + "/wp-content/plugins/simple-membership/readme.txt";
res = http_get_cache(port: port, item: url);

if("=== Simple Membership ===" >< res && "Changelog" >< res) {

  vers = eregmatch(pattern: "Stable tag: ([0-9.]+)", string: res);

  if(vers[1] && version_is_less(version: vers[1], test_version: "3.8.5")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "3.8.5", file_checked: url);
