...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113471");
  ...
  script_cve_id("CVE-2015-9311");

  script_name("WordPress NewStatPress Plugin < 1.0.6 XSS Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress NewStatPress plugin through version 1.0.5.");
...
if( "NewStatPress is a new version of StatPress" >< res && "Changelog" >< res) {
  ...
  if( version_is_less( version: vers[1], test_version: "1.0.6" ) ) {
    report = report_fixed_ver( installed_version: vers[1], fixed_version: "1.0.6", file_checked: url );
