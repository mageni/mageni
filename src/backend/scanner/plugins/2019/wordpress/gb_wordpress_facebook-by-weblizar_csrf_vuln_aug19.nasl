...
if(description)
{
  ...
  script_version("2019-09-11T11:04:23+0000");
  script_tag(name:"last_modification", value:"2019-09-11 11:04:23 +0000 (Wed, 11 Sep 2019)");
...
url = dir + "/wp-content/plugins/facebook-by-weblizar/readme.txt";
res = http_get_cache( port: port, item: url );

if( ( "=== Facebook" >< res || "=== Social LikeBox" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.8.5" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.8.5", file_checked: url );
