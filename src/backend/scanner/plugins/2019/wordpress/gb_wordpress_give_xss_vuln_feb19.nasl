...
if("=== Give - Donation Plugin and Fundraising Platform ===" >< res && "Changelog" >< res) {

  vers = eregmatch( pattern: "Stable tag: ([0-9.]+)", string: res);

  if(vers[1] && version_is_less(version: vers[1], test_version: "2.3.1")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "2.3.1", file_checked: url);
