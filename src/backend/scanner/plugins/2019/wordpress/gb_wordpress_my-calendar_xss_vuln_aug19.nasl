...
if(description)
{
  ...
  script_version("2019-09-11T09:35:36+0000");
  script_tag(name:"last_modification", value:"2019-09-11 09:35:36 +0000 (Wed, 11 Sep 2019)");
  ...
  script_tag(name:"summary", value:"The WordPress plugin My Calendar is prone to a cross-site scripting (XSS) vulnerability.");
...
url = dir + "/wp-content/plugins/my-calendar/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== My Calendar" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "3.1.10" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "3.1.10", file_checked: url );
