...
if(description)
{
  ...
  script_version("2019-06-11T13:42:19+0000");
  script_tag(name:"last_modification", value:"2019-06-11 13:42:19 +0000 (Tue, 11 Jun 2019)");
  ...
  script_name("Rancher <= 2.2.4 Privilege Escalation Vulnerability");
  ...
  script_tag(name:"summary", value:"Rancher is prone to a privilege escalation vulnerability.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"Unprivileged users (if allows to deploy nodes) can gain admin access to the
