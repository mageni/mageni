...
if(description)
{
  ...
  script_name("openSUSE Update for tomcat openSUSE-SU-2019:1723-1 (tomcat)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00013.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat'
  package(s) announced via the openSUSE-SU-2019:1723_1 advisory.");
