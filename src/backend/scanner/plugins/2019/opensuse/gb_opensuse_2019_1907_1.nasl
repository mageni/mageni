...
if(description)
{
  ...
  script_name("openSUSE Update for nodejs8 openSUSE-SU-2019:1907-1 (nodejs8)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00052.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs8'
  package(s) announced via the openSUSE-SU-2019:1907_1 advisory.");
