...
if(description)
{
  ...
  script_name("openSUSE Update for java-11-openjdk openSUSE-SU-2019:1327-1 (java-11-openjdk)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openjdk'
  package(s) announced via the openSUSE-SU-2019:1327_1 advisory.");
