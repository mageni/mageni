...
if(description)
{
  ...
  script_name("openSUSE Update for clamav openSUSE-SU-2019:1208-1 (clamav)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00064.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav'
  package(s) announced via the openSUSE-SU-2019:1208_1 advisory.");
