...
if(description)
{
  ...
  script_name("openSUSE Update for bash openSUSE-SU-2019:1178-1 (bash)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00049.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bash'
  package(s) announced via the openSUSE-SU-2019:1178_1 advisory.");
