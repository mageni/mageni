...
if(description)
{
  ...
  script_name("openSUSE Update for file openSUSE-SU-2019:1197-1 (file)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00053.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'file'
  package(s) announced via the openSUSE-SU-2019:1197_1 advisory.");
