...
if(description)
{
  ...
  script_name("openSUSE Update for signing-party openSUSE-SU-2019:1388-1 (signing-party)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00029.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'signing-party'
  package(s) announced via the openSUSE-SU-2019:1388_1 advisory.");
