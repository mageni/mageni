...
if(description)
{
  ...
  script_name("SuSE Update for python-urllib3 openSUSE-SU-2019:0159-1 (python-urllib3)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-02/msg00014.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-urllib3'
  package(s) announced via the openSUSE-SU-2019:0159_1 advisory.");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"python-urllib3", rpm:"python-urllib3~1.22~4.4.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"python3-urllib3", rpm:"python3-urllib3~1.22~4.4.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
