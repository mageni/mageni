...
if(description)
{
  ...
  script_name("openSUSE Update for rmt-server openSUSE-SU-2019:1527-1 (rmt-server)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00025.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rmt-server'
  package(s) announced via the openSUSE-SU-2019:1527_1 advisory.");
