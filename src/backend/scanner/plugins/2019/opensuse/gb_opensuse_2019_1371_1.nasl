...
if(description)
{
  ...
  script_name("openSUSE Update for python3 openSUSE-SU-2019:1371-1 (python3)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00024.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3'
  package(s) announced via the openSUSE-SU-2019:1371_1 advisory.");
