...
if(description)
{
  ...
  script_name("openSUSE Update for bluez openSUSE-SU-2019:1198-1 (bluez)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00054.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bluez'
  package(s) announced via the openSUSE-SU-2019:1198_1 advisory.");
