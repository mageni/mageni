...
if(description)
{
  ...
  script_name("openSUSE Update for neovim openSUSE-SU-2019:1551-1 (neovim)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00031.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'neovim'
  package(s) announced via the openSUSE-SU-2019:1551_1 advisory.");
