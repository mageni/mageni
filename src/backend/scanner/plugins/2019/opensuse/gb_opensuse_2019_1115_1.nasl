...
if(description)
{
  ...
  script_version("2019-04-03T06:41:35+0000");
  script_cve_id("CVE-2018-19871");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-04-03 06:41:35 +0000 (Wed, 03 Apr 2019)");
  script_tag(name:"creation_date", value:"2019-04-03 06:41:35 +0000 (Wed, 03 Apr 2019)");
  script_name("openSUSE Update for libqt5-qtimageformats openSUSE-SU-2019:1115-1 (libqt5-qtimageformats)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00002.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libqt5-qtimageformats'
  package(s) announced via the openSUSE-SU-2019:1115_1 advisory.");
