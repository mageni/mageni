...
if(description)
{
  ...
  update according to Microsoft KB4475547");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475547");
...
if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5163.1000"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"15.0 - 15.0.5163.0999");
