...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815628");
  ...
  script_name("Microsoft Windows Scripting Engine Memory Corruption Vulnerability (KB4522010)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4522010");
  ...
  script_tag(name:"affected", value:"Internet Explorer 11 on
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4522010");
...
if(version_in_range(version:fileVer, test_version:"11.0.14393.0", test_version2:"11.0.14393.3204"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Mshtml.dll",
                            file_version:fileVer, vulnerable_range:"11.0.14393.0 - 11.0.14393.3204");
