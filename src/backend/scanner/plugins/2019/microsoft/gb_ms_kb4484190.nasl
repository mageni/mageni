...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815675");
  ...
  script_name("Microsoft Excel 2013 Information Disclosure Vulnerability (KB4484190)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484190");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exist due to an error when Microsoft Excel
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484190");
...
if(excelVer =~ "^15\." && version_is_less(version:excelVer, test_version:"15.0.5197.1000"))
{
  report = report_fixed_ver(file_checked:excelPath + "Excel.exe",
                            file_version:excelVer, vulnerable_range:"15.0 - 15.0.5197.0999");
