...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814677");
  ...
  script_name("Microsoft Office 2016 Multiple RCE Vulnerabilities (KB4018294)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4018294");
  ...
  - Microsoft Office Access Connectivity Engine improperly handles
    objects in memory.

  - Windows Jet Database Engine improperly handles objects in memory.");

  script_tag(name:"impact", value:"Successful exploitation will allow an
  attacker to execute arbitrary code on a victim system.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4018294");
...
foreach key(key_list)
{
  ...
  if(propath)
  {
    ...
    if(version_is_less(version:offdllVer, test_version:"16.0.4810.1000"))
    {
