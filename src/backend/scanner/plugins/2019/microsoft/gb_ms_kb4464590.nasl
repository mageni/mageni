...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815089");
  ...
  script_tag(name:"creation_date", value:"2019-06-12 10:16:57 +0530 (Wed, 12 Jun 2019)");
  script_name("Microsoft Word 2013 Service Pack 1 Remote Code Execution Vulnerability (KB4464590)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4464590");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4464590");
...
if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5145.1000"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"15.0 - 15.0.5145.0999");
