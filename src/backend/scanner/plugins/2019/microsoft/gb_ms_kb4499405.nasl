...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815109");
  ...
  script_tag(name:"creation_date", value:"2019-05-15 10:50:50 +0530 (Wed, 15 May 2019)");
  script_name("Microsoft .NET Framework Multiple DoS Vulnerabilities (KB4499405)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4499405");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.7.2 and 4.8 on
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4499405");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4495590");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4495618");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ## https://support.microsoft.com/en-us/help/4495590
              ## https://support.microsoft.com/en-us/help/4495618
              if(version_in_range(version:dllVer, test_version:"2.0.50727.5700", test_version2:"2.0.50727.9039"))
              {
                vulnerable_range = "2.0.50727.5700 - 2.0.50727.9039" ;
                break;
              }
              ## https://support.microsoft.com/en-us/help/4495590
              else if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.3415"))
              {
                vulnerable_range = "4.7 - 4.7.3415" ;
                break;
              }
              ## https://support.microsoft.com/en-us/help/4495618
