...
if(description)
{
  ...
  script_cve_id("CVE-2019-15142","CVE-2019-15143","CVE-2019-15144");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2444-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-September/005957.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'djvulibre'
  package(s) announced via the SUSE-SU-2019:2444-1 advisory.");
