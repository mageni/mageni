...
if(description)
{
  ...
  script_cve_id("CVE-2018-20836","CVE-2018-5390","CVE-2018-7191");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1870-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005724.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2019:1870-1 advisory.");
