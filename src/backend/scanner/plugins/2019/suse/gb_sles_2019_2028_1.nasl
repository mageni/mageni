...
if(description)
{
  ...
  script_cve_id("CVE-2018-3639","CVE-2019-2426","CVE-2019-2745");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2028-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005762.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_0-openjdk'
  package(s) announced via the SUSE-SU-2019:2028-1 advisory.");
