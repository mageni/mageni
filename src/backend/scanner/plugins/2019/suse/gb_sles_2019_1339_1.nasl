...
if(description)
{
  ...
  script_cve_id("CVE-2016-9797","CVE-2016-9798","CVE-2016-9802");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1339-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-May/005494.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'bluez'
  package(s) announced via the SUSE-SU-2019:1339-1 advisory.");
