...
if(description)
{
  ...
  script_cve_id("CVE-2013-4343","CVE-2018-17972","CVE-2018-7191");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1527-1)");
  ...
  package(s) announced via the SUSE-SU-2019:1527-1 advisory.");
