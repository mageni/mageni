...
if(description)
{
  ...
  script_cve_id("CVE-2019-11070","CVE-2019-6201","CVE-2019-6251");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1155-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-May/005426.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2019:1155-1 advisory.");
