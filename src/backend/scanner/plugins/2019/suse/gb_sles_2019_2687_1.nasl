...
if(description)
{
  ...
  script_cve_id("CVE-2019-2614","CVE-2019-2627","CVE-2019-2737");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2687-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-October/006023.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mariadb-100'
  package(s) announced via the SUSE-SU-2019:2687-1 advisory.");
