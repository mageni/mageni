...
if(description)
{
  ...
  script_cve_id("CVE-2018-15126","CVE-2018-15127","CVE-2018-20019");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0060-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-January/005025.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'LibVNCServer'
  package(s) announced via the SUSE-SU-2019:0060-1 advisory.");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"LibVNCServer-debugsource", rpm:"LibVNCServer-debugsource~0.9.9~17.8.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncclient0", rpm:"libvncclient0~0.9.9~17.8.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncclient0-debuginfo", rpm:"libvncclient0-debuginfo~0.9.9~17.8.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncserver0", rpm:"libvncserver0~0.9.9~17.8.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncserver0-debuginfo", rpm:"libvncserver0-debuginfo~0.9.9~17.8.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
