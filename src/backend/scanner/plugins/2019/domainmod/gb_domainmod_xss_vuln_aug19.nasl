...
if(description)
{
  ...
  script_version("2019-09-03T11:38:53+0000");
  script_tag(name:"last_modification", value:"2019-09-03 11:38:53 +0000 (Tue, 03 Sep 2019)");
  ...
  script_cve_id("CVE-2019-15811");

  script_name("DomainMOD <= 4.13.0 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"DomainMOD is prone to a cross-site scripting (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability exists in the file reporting/domains/cost-by-month.php
  via the parameter daterange.");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 03rd September, 2019.
