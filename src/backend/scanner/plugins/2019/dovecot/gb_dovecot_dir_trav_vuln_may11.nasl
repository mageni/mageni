...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114171");
  script_version("2020-01-07T12:10:22+0000");
  script_tag(name:"last_modification", value:"2020-01-07 12:10:22 +0000 (Tue, 07 Jan 2020)");
  script_tag(name:"creation_date", value:"2019-12-30 13:25:16 +0100 (Mon, 30 Dec 2019)");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");

  script_cve_id("CVE-2011-2167");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Dovecot 2.0.x < 2.0.13 Directory Traversal Vulnerability");
  ...
  script_tag(name:"summary", value:"Dovecot is prone to a directory traversal vulnerability.");

  script_tag(name:"insight", value:"Script-login does not follow the chroot configuration setting,
  which might allow remote authenticated users to conduct directory traversal attacks by leveraging
  a script.");
