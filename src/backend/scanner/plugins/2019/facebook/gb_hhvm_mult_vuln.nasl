...
if (description)
{
  ...
  script_version("2019-07-29T05:09:36+0000");
  script_tag(name:"last_modification", value:"2019-07-29 05:09:36 +0000 (Mon, 29 Jul 2019)");
  ...
  script_name("HHVM Multiple Vulnerabilities - June19");
...
if (version_is_less(version: version, test_version: "3.30.6")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.30.6");
