...
if(description)
{
  ...
  script_name("Corel PDF Fusion Detection (Windows SMB Login)");
  ...
  script_tag(name:"summary", value:"SMB login-based detection of Corel PDF Fusion.");

  script_xref(name:"URL", value:"https://www.wordperfect.com/en/product/pdf-creator/");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    # Corel PDF Fusion
    if( ! app_name || app_name !~ "^Corel PDF Fusion$" )
      continue;
    ...
    set_kb_item( name:"corel/pdf_fusion/detected", value:TRUE );
    set_kb_item( name:"corel/pdf_fusion/smb-login/detected", value:TRUE );

    register_and_report_cpe( app:app_name, ver:version, concluded:concluded,
                             base:"cpe:/a:corel:pdf_fusion:", expr:"^([0-9.]+)",
