...
# $Id: gb_ubuntu_USN_1933_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-ti-omap4 USN-1933-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-08-27 10:01:39 +0530 (Tue, 27 Aug 2013)");
  script_cve_id("CVE-2013-1059", "CVE-2013-2148", "CVE-2013-2164", "CVE-2013-2851");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-1933-1");
...
this flaw to gain kernel privileges. (CVE-2013-2851)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1933-1/");
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-231-omap4", ver:"3.5.0-231.47", rls:"UBUNTU12.10")) != NULL)
  {
