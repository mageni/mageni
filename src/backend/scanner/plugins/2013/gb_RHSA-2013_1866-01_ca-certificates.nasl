...
restarted for the changes to take effect.");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2013-December/msg00042.html");
...
if(release == "RHENT_6")
{
  ...
  if ((res = isrpmvuln(pkg:"ca-certificates", rpm:"ca-certificates~2013.1.95~65.1.el6_5", rls:"RHENT_6")) != NULL)
  {
