...
#
# Fedora Update for kernel FEDORA-2013-22695
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867119");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-12-17 11:38:56 +0530 (Tue, 17 Dec 2013)");
  script_cve_id("CVE-2013-6405", "CVE-2013-6382", "CVE-2013-6380", "CVE-2013-6378",
  ...
  script_name("Fedora Update for kernel FEDORA-2013-22695");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123338.html");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.11.10~100.fc18", rls:"FC18")) != NULL)
  {
