...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866917");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-09-24 11:42:48 +0530 (Tue, 24 Sep 2013)");
  script_cve_id("CVE-2013-4623");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_name("Fedora Update for polarssl FEDORA-2013-16317");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"polarssl", rpm:"polarssl~1.2.8~1.fc19", rls:"FC19")) != NULL)
  {
