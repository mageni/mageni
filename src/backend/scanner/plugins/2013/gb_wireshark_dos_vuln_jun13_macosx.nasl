...
# $Id: gb_wireshark_dos_vuln_jun13_macosx.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Wireshark 1.6.x before 1.6.16, 1.8.x before 1.8.8 and 1.10.0 on Mac OS X");
