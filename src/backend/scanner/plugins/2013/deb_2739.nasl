...
# $Id: deb_2739.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
We recommend that you upgrade your cacti packages.");
  script_tag(name:"summary", value:"Two security issues (SQL injection and command line injection via SNMP
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.7g-1+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
