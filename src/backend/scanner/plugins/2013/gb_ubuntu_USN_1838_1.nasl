...
# $Id: gb_ubuntu_USN_1838_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-05-31 09:57:41 +0530 (Fri, 31 May 2013)");
  script_cve_id("CVE-2013-2094", "CVE-2013-1929");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-1838-1");

  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1838-1/");
...
if(release == "UBUNTU13.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-225-omap4", ver:"3.5.0-225.36", rls:"UBUNTU13.04")) != NULL)
  {
