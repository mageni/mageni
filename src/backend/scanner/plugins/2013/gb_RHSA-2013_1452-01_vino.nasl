...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871055");
  ...
  script_name("RedHat Update for vino RHSA-2013:1452-01");


  script_tag(name:"affected", value:"vino on Red Hat Enterprise Linux (v. 5 server),
...
if(release == "RHENT_6")
{
  ...
  if ((res = isrpmvuln(pkg:"vino", rpm:"vino~2.28.1~9.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"vino-debuginfo", rpm:"vino-debuginfo~2.28.1~9.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"vino", rpm:"vino~2.13.5~10.el5_10", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"vino-debuginfo", rpm:"vino-debuginfo~2.13.5~10.el5_10", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
