...
# $Id: gb_mozilla_firefox_esr_mult_vuln01_oct12_macosx.nasl 12072 2018-10-25 08:12:00Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803642");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR versions 10.x before 10.0.8 on Mac OS X");
