...
# $Id: gb_activeperl_repeatcpy_bof_vuln_win.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Active Perl 5.12.x before 5.12.5, 5.14.x before 5.14.3 and
  ...
  script_tag(name:"solution", value:"Upgrade to Active Perl 5.12.5, 5.14.3, 15.15.5 or later.");
  script_tag(name:"summary", value:"The host is installed with Active Perl and is prone to heap based
