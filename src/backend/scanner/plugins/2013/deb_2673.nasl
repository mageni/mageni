...
# $Id: deb_2673.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"libdmx on Debian Linux");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libdmx-dev", ver:"1:1.1.0-2+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libdmx1", ver:"1:1.1.0-2+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libdmx1-dbg", ver:"1:1.1.0-2+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libdmx-dev", ver:"1:1.1.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libdmx1", ver:"1:1.1.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libdmx1-dbg", ver:"1:1.1.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
