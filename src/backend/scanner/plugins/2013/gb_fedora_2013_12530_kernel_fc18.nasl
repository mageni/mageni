...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866067");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-07-16 10:15:15 +0530 (Tue, 16 Jul 2013)");
  ...
  script_name("Fedora Update for kernel FEDORA-2013-12530");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111241.html");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.9.9~201.fc18", rls:"FC18")) != NULL)
  {
