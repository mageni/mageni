...
#
# Fedora Update for sleuthkit FEDORA-2013-0336
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.865239");
  ...
  script_tag(name:"affected", value:"sleuthkit on Fedora 17");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"sleuthkit", rpm:"sleuthkit~4.0.1~1.fc17", rls:"FC17")) != NULL)
  {
