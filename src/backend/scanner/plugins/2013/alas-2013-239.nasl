...
# $Id: alas-2013-239.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-239");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"mod24_fcgid-debuginfo", rpm:"mod24_fcgid-debuginfo~2.3.9~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mod24_fcgid", rpm:"mod24_fcgid~2.3.9~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
