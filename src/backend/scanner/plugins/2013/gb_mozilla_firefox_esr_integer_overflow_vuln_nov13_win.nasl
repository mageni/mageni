...
# $Id: gb_mozilla_firefox_esr_integer_overflow_vuln_nov13_win.nasl 31965 2013-11-07 13:47:17Z nov$
#
...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Integer Overflow Vulnerability-01 Nov13 (Windows)");
