...
# $Id: deb_2688.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"libxres on Debian Linux");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxres-dev", ver:"2:1.0.4-1+squeeze", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxres1", ver:"2:1.0.4-1+squeeze", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxres1-dbg", ver:"2:1.0.4-1+squeeze", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxres-dev", ver:"2:1.0.6-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxres1", ver:"2:1.0.6-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxres1-dbg", ver:"2:1.0.6-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
