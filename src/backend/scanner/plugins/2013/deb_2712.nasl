...
# $Id: deb_2712.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
We recommend that you upgrade your otrs2 packages.");
  script_tag(name:"summary", value:"It was discovered that users with a valid agent login could use
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"otrs", ver:"3.1.7+dfsg1-8+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"otrs2", ver:"3.1.7+dfsg1-8+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
