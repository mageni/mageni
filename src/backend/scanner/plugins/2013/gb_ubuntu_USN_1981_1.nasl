...
# $Id: gb_ubuntu_USN_1981_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"hplip", ver:"3.12.2-1ubuntu3.3", rls:"UBUNTU12.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"hplip", ver:"3.10.2-2ubuntu2.4", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"hplip", ver:"3.12.6-3ubuntu4.2", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
