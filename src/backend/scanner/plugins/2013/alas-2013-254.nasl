...
# $Id: alas-2013-254.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.120549");
  script_version("$Revision: 11703 $");
  script_tag(name:"creation_date", value:"2015-09-08 13:29:22 +0200 (Tue, 08 Sep 2015)");
  script_tag(name:"last_modification", value:"$Date: 2018-10-01 10:05:31 +0200 (Mon, 01 Oct 2018) $");
  script_name("Amazon Linux Local Check: ALAS-2013-254");
  ...
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-254.html");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"mod24_nss-debuginfo", rpm:"mod24_nss-debuginfo~1.0.8~24.17.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mod24_nss", rpm:"mod24_nss~1.0.8~24.17.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
