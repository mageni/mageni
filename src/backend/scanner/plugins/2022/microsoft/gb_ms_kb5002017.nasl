...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826453");
  ...
  script_name("Microsoft Visio 2013 SP1 Security Feature Bypass Vulnerability (KB5002017");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002017");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002017");
