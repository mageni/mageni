...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826572");
  ...
  script_cve_id("CVE-2022-22035", "CVE-2022-24504", "CVE-2022-30198", "CVE-2022-33634",
                ...
                "CVE-2022-37981", "CVE-2022-37982", "CVE-2022-37984", "CVE-2022-37985",
                "CVE-2022-37986", "CVE-2022-37987", "CVE-2022-37988", "CVE-2022-37989",
                "CVE-2022-37990", "CVE-2022-37991", "CVE-2022-37993", "CVE-2022-37994",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5018457)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5018457");
  ...
  - A Remote Code Execution Vulnerability in Windows GDI+.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5018457");
...
if(version_is_less(version:fileVer, test_version:"6.2.9200.23919"))
{
  report = report_fixed_ver(file_checked:dllPath + "\advapi32.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.2.9200.23919");
