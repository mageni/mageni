...
if(description)
{
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to version 107.0.1418.24.");
...
if(version_is_less(version:vers, test_version:"107.0.1418.24"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"107.0.1418.24", install_path:path);
