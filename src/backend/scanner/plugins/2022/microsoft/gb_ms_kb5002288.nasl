...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826559");
  ...
  script_name("Microsoft Office 2016 Remote Code Execution Vulnerability (KB5002288)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002288");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002288");
...
if(officeVer =~ "^16\.")
{
  ...
  foreach key(key_list)
  {
    ...
    if(propath)
    {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5365.1000"))
      {
        report = report_fixed_ver(file_checked:offPath + "\mso.dll",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5365.0999");
