...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821300");
  ...
  script_tag(name:"severity_date", value:"2022-03-16 00:15:00 +0000 (Wed, 16 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-05-11 11:02:34 +0530 (Wed, 11 May 2022)");
  script_name("Microsoft Word 2013 Service Pack 1 Security Feature Bypass Vulnerability (KB5002187)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5002187");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002187");
...
if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5449.0999"))
{
