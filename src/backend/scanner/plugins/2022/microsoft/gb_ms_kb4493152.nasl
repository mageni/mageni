...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821308");
  ...
  script_tag(name:"severity_date", value:"2022-05-11 13:53:39 +0530 (Wed, 11 May 2022)");
  script_tag(name:"creation_date", value:"2022-05-11 13:53:39 +0530 (Wed, 11 May 2022)");
  script_name("Microsoft Publisher 2016 Security Feature Bypass Vulnerability (KB4493152)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4493152");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4493152");
...
if(exeVer && exeVer =~ "^16.*")
{
  if(version_in_range(version:exeVer, test_version:"16.0", test_version2:"16.0.5317.0999"))
  {
