...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821288");
  ...
  script_name("Microsoft Outlook 2013 Service Pack 1 RCE Vulnerability (KB5001990)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5001990");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an insufficient
  validation of user-supplied input in Microsoft Outlook.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001990");
...
if(version_in_range(version:outlookVer, test_version:"15.0", test_version2:"15.0.5399.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"15.0 - 15.0.5399.0999");
