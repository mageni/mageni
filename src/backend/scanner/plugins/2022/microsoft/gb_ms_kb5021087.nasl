...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826731");
  ...
  script_name("Microsoft .NET Framework Remote Code Execution Vulnerability (KB5021087)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5021087");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.8 and 4.8.1 on Microsoft Windows 10, version 21H1.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5021087");
