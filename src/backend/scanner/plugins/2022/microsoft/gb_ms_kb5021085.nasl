...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826736");
  ...
  script_name("Microsoft .NET Framework Remote Code Execution Vulnerability (KB5021085)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5021085");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.7.2 and 4.8 on Microsoft Windows 10 version 1809 32-bit/x64-based Systems and Microsoft Windows Server 2019.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5021085");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer1 || dllVer2)
            {
              if(dllVer2 && version_in_range(version:dllVer2, test_version:"3.0.6920.8600", test_version2:"3.0.6920.9053"))
              {
                VULN1 = TRUE ;
                vulnerable_range1 = "3.0.6920.8600 - 3.0.6920.9053";
                break;
              }
    ...
    if((!vulnerable_range1 || !vulnerable_range2) && "NET Framework Setup" >< key)
    {
      ...
      if(dotPath && "\Microsoft.NET\Framework" >< dotPath)
      {
        ...
        if(dllVer1 || dllVer2)
        {
          ...
          {
            VULN2 = TRUE ;
            vulnerable_range2 = "4.8 - 4.8.4493" ;
            break;
          }
        }
      }
