...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826615");
  script_version("2022-11-09T13:25:33+0000");
  script_cve_id("CVE-2022-23824", "CVE-2022-37992", "CVE-2022-38015", "CVE-2022-41039",
                ...
                "CVE-2022-41073", "CVE-2022-41086", "CVE-2022-41088", "CVE-2022-41090",
                "CVE-2022-41091", "CVE-2022-41092", "CVE-2022-41093", "CVE-2022-41095",
                "CVE-2022-41096", "CVE-2022-41097", "CVE-2022-41098", "CVE-2022-41099",
                "CVE-2022-41100", "CVE-2022-41101", "CVE-2022-41102", "CVE-2022-41109",
                "CVE-2022-41113", "CVE-2022-41114", "CVE-2022-41118", "CVE-2022-41125",
                "CVE-2022-41128");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5019959)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5019959");
  ...
  - An elevation of privilege vulnerability in Windows Advanced Local
  Procedure Call.
  ...
  bypass security restrictions, conduct DoS attacks on an affected system.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5019959");
...
if(!("19042" >< build || "19043" >< build || "19044" >< build || "19045" >< build)){
  exit(0);
}
...
{
  if(version_in_range(version:fileVer, test_version:"10.0.19041.0", test_version2:"10.0.19041.2251"))
  {
    report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                              file_version:fileVer, vulnerable_range:"10.0.19041.0 - 10.0.19041.2251");
