...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826808");
  ...
  script_cve_id("CVE-2022-41074", "CVE-2022-41077", "CVE-2022-41121", "CVE-2022-44666",
                ...
                "CVE-2022-44675", "CVE-2022-44676", "CVE-2022-44678", "CVE-2022-44679",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5021235)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5021235");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple flaws exist due to:

  - An elevation of privilege vulnerability in Windows Client Server Run-Time Subsystem.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5021235");
...
if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.5581"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.5581");
