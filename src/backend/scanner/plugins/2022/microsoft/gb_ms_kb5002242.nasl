...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821287");
  ...
  script_name("Microsoft Excel 2013 Service Pack 1 Security Feature Bypass Vulnerability (KB5002242)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002242");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to security feature bypass
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002242");
...
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.0.5475.0999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"15.0 - 15.0.5475.0999");
