...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826810");
  ...
  script_cve_id("CVE-2022-41074", "CVE-2022-41077", "CVE-2022-41121", "CVE-2022-44666",
                ...
                "CVE-2022-44697", "CVE-2022-44707", "CVE-2022-41076", "CVE-2022-41094");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5021294)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5021294");
  ...
  - An elevation of privilege vulnerability in Windows Fax Compose.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5021294");
...
if(version_is_less(version:fileVer, test_version:"6.3.9600.20718"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"Less than 6.3.9600.20718");
