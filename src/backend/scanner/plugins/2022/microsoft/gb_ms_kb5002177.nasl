...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820070");
  script_version("2022-04-20T08:12:51+0000");
  script_cve_id("CVE-2022-26901");
  ...
  script_name("Microsoft Excel 2016 RCE Vulnerability (KB5002177)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5002177");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002177");
...
if(version_in_range(version:vers, test_version:"16.0", test_version2:"16.0.5305.0999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"16.0 - 16.0.5305.0999");
