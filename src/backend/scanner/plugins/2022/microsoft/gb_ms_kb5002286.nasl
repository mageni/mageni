...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826814");
  ...
  script_name("Microsoft Visio 2016 Security Feature Bypass Vulnerability (KB5002286");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002286");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002286");
...
if(version_in_range(version:excelVer, test_version:"16.0", test_version2:"16.0.5366.0999"))
{
  report = report_fixed_ver(file_checked:"visio.exe",
           file_version:excelVer, vulnerable_range:"16.0 - 16.0.5366.0999");
