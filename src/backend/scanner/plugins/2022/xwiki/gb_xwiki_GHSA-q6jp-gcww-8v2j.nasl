...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170245");
  ...
  script_cve_id("CVE-2022-41937");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki < 13.10.8, 14.x < 14.4.3, 14.5.x < 14.6-rc-1 Missing Authorization Vulnerability (GHSA-q6jp-gcww-8v2j)");
  ...
  script_tag(name:"insight", value:"The application allow anyone with view access to modify any page
  of the wiki by importing a crafted XAR package.");

  script_tag(name:"affected", value:"XWiki prior to version 13.10.8, 14.x prior to 14.4.3
  and 14.5.x prior to 14.6-rc-1.");

  script_tag(name:"solution", value:"Update to version 13.10.8, 14.4.3, 14.6-rc-1 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-q6jp-gcww-8v2j");
