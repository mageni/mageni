...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170256");
  ...
  script_cve_id("CVE-2022-41932");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki < 13.10.8, 14.x < 14.4.2, 14.5.x < 14.6-rc-1 Uncontrolled Resource Consumption Vulnerability (GHSA-4x5r-6v26-7j4v)");
  ...
  script_tag(name:"insight", value:"It is possible to make XWiki create many new schemas and fill them
  with tables just by using a crafted user identifier in the login form.");

  script_tag(name:"affected", value:"XWiki prior to version 13.10.8, 14.x prior to 14.4.2
  and 14.5.x prior to 14.6-rc-1.");

  script_tag(name:"solution", value:"Update to version 13.10.8, 14.4.2, 14.6-rc-1 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-4x5r-6v26-7j4v");
...
if( version_is_less( version:version, test_version:"13.10.8" ) ) {
