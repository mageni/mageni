...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170253");
  ...
  script_cve_id("CVE-2022-41930");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 12.4 < 13.10.7, 14.x < 14.4.2, 14.5.x < 14.5RC1 Missing Authorization Vulnerability (GHSA-p5v9-g8w8-5q4v)");
  ...
  script_tag(name:"insight", value:"Any user (logged in or not) with access to the page
  XWiki.XWikiUserProfileSheet can enable or disable any user profile. This might allow to a disabled
  user to re-enable themselves, or to an attacker to disable any user of the wiki.");

  script_tag(name:"affected", value:"XWiki version 12.4 prior to 13.10.7, 14.x prior to 14.4.2
  and 14.5.x prior to 14.5RC1.");

  script_tag(name:"solution", value:"Update to version 13.10.7, 14.4.2, 14.5RC1 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-p5v9-g8w8-5q4v");
...
if( version_in_range_exclusive( version:version, test_version_lo:"12.4", test_version_up:"13.10.7" ) ) {
