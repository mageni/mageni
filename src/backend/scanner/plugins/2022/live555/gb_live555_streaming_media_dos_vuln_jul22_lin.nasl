...
if(description)
{
  ...
  script_name("Live555 Streaming Media <= 2021.08.23 DoS Vulnerability - Linux");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 06th March, 2023.
