...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2826");
  ...
  script_name("Huawei EulerOS: Security Advisory for linux-firmware (EulerOS-SA-2022-2826)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2826");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2826");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'linux-firmware' package(s) announced via the EulerOS-SA-2022-2826 advisory.");
...
Improper buffer restriction in some Intel(R) Wireless Bluetooth(R) products before version 21.110 may allow an unauthenticated user to potentially enable escalation of privilege via adjacent access.(CVE-2020-12321)");
  ...
  script_tag(name:"affected", value:"'linux-firmware' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"linux-firmware", rpm:"linux-firmware~20200817~2.h5.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
