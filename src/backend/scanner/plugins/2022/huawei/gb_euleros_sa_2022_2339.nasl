...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2339");
  ...
  script_name("Huawei EulerOS: Security Advisory for cryptsetup (EulerOS-SA-2022-2339)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2339");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2339");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cryptsetup' package(s) announced via the EulerOS-SA-2022-2339 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cryptsetup", rpm:"cryptsetup~2.3.1~1.h4.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cryptsetup-reencrypt", rpm:"cryptsetup-reencrypt~2.3.1~1.h4.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
