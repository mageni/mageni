...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2479");
  ...
  script_name("Huawei EulerOS: Security Advisory for rsync (EulerOS-SA-2022-2479)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2479");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2479");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'rsync' package(s) announced via the EulerOS-SA-2022-2479 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.1.3~4.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rsync-daemon", rpm:"rsync-daemon~3.1.3~4.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
