...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2713");
  ...
  script_name("Huawei EulerOS: Security Advisory for libtar (EulerOS-SA-2022-2713)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2713");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2713");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libtar' package(s) announced via the EulerOS-SA-2022-2713 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The th_read() function doesn't free a variable t->th_buf.gnu_longlink after allocating memory, which may cause a memory leak.(CVE-2021-33645)
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtar", rpm:"libtar~1.2.11~29.h3.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
