...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2323");
  ...
  script_name("Huawei EulerOS: Security Advisory for libdb (EulerOS-SA-2022-2323)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2323");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2323");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libdb' package(s) announced via the EulerOS-SA-2022-2323 advisory.");
  ...
  script_tag(name:"affected", value:"'libdb' package(s) on Huawei EulerOS V2.0SP9.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libdb", rpm:"libdb~5.3.28~35.h6.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
