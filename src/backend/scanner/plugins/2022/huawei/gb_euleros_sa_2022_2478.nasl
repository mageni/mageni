...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2478");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-lxml (EulerOS-SA-2022-2478)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2478");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2478");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-lxml' package(s) announced via the EulerOS-SA-2022-2478 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-lxml", rpm:"python2-lxml~4.2.3~2.h7.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-lxml", rpm:"python3-lxml~4.2.3~2.h7.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
