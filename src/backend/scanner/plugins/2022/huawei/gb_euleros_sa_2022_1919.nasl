...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1919");
  ...
  script_name("Huawei EulerOS: Security Advisory for yajl (EulerOS-SA-2022-1919)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1919");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1919");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'yajl' package(s) announced via the EulerOS-SA-2022-1919 advisory.");
  ...
  script_tag(name:"affected", value:"'yajl' package(s) on Huawei EulerOS V2.0SP5.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yajl", rpm:"yajl~2.0.4~4.h2.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
