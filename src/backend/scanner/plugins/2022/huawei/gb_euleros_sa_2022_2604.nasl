...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2604");
  ...
  script_name("Huawei EulerOS: Security Advisory for compat-openldap (EulerOS-SA-2022-2604)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2604");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2604");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'compat-openldap' package(s) announced via the EulerOS-SA-2022-2604 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"compat-openldap", rpm:"compat-openldap~2.3.43~5.h4", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
