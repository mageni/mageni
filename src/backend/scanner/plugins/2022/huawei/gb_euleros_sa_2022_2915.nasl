...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2915");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-lxml (EulerOS-SA-2022-2915)");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-lxml-help", rpm:"python-lxml-help~4.5.2~2.h8.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
