...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1084");
  ...
  script_name("Huawei EulerOS: Security Advisory for nettle (EulerOS-SA-2022-1084)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1084");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1084");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'nettle' package(s) announced via the EulerOS-SA-2022-1084 advisory.");
...
A flaw was found in the way nettle's RSA decryption functions handled specially crafted ciphertext. An attacker could use this flaw to provide a manipulated ciphertext leading to application crash and denial of service.(CVE-2021-3580)");
  ...
  script_tag(name:"affected", value:"'nettle' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.6.0.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nettle", rpm:"nettle~3.4.1rc1~1.h2.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nettle-devel", rpm:"nettle-devel~3.4.1rc1~1.h2.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
