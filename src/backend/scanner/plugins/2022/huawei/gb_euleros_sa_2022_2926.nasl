...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2926");
  ...
  script_name("Huawei EulerOS: Security Advisory for cups (EulerOS-SA-2022-2926)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2926");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2926");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cups' package(s) announced via the EulerOS-SA-2022-2926 advisory.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~2.2.13~4.h6.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
