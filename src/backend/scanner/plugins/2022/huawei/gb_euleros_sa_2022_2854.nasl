...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2854");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-pip (EulerOS-SA-2022-2854)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2854");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2854");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-pip' package(s) announced via the EulerOS-SA-2022-2854 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-pip-wheel", rpm:"python-pip-wheel~20.2.2~1.h7.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-pip", rpm:"python3-pip~20.2.2~1.h7.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
