...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1318");
  ...
  script_name("Huawei EulerOS: Security Advisory for cloud-init (EulerOS-SA-2022-1318)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1318");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1318");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cloud-init' package(s) announced via the EulerOS-SA-2022-1318 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cloud-init", rpm:"cloud-init~0.7.9~24.1.h8.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
