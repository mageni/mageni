...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2765");
  ...
  script_name("Huawei EulerOS: Security Advisory for gnutls (EulerOS-SA-2022-2765)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2765");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2765");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gnutls' package(s) announced via the EulerOS-SA-2022-2765 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~3.6.9~6.h11.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnutls-devel", rpm:"gnutls-devel~3.6.9~6.h11.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnutls-help", rpm:"gnutls-help~3.6.9~6.h11.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
