...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1034");
  ...
  script_name("Huawei EulerOS: Security Advisory for qemu (EulerOS-SA-2022-1034)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1034");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1034");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'qemu' package(s) announced via the EulerOS-SA-2022-1034 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~4.1.0~16.h10.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
