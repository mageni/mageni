...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2420");
  ...
  script_name("Huawei EulerOS: Security Advisory for perl-Encode (EulerOS-SA-2022-2420)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2420");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2420");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'perl-Encode' package(s) announced via the EulerOS-SA-2022-2420 advisory.");
  ...
  script_tag(name:"affected", value:"'perl-Encode' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Encode", rpm:"perl-Encode~3.06~1.h4.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
