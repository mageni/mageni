...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2313");
  ...
  script_name("Huawei EulerOS: Security Advisory for dpdk (EulerOS-SA-2022-2313)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2313");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2313");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dpdk' package(s) announced via the EulerOS-SA-2022-2313 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dpdk", rpm:"dpdk~19.11~0.h27.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dpdk-tools", rpm:"dpdk-tools~19.11~0.h27.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
