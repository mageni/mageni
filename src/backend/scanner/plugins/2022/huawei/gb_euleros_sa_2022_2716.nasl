...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2716");
  script_cve_id("CVE-2022-20141");
  ...
  script_tag(name:"severity_date", value:"2022-09-01 18:58:00 +0000 (Thu, 01 Sep 2022)");

  script_name("Huawei EulerOS: Security Advisory for kernel (EulerOS-SA-2022-2716)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2716");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2716");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2022-2716 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In ip_check_mc_rcu of igmp.c, there is a possible use after free due to improper locking. This could lead to local escalation of privilege when opening and closing inet sockets with no additional execution privileges needed. User interaction is not needed for exploitation.(CVE-2022-20141)");
