...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2820");
  ...
  script_name("Huawei EulerOS: Security Advisory for fribidi (EulerOS-SA-2022-2820)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2820");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2820");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'fribidi' package(s) announced via the EulerOS-SA-2022-2820 advisory.");
...
A segmentation fault (SEGV) flaw was found in the Fribidi package and affects the fribidi_remove_bidi_marks() function of the lib/fribidi.c file. This flaw allows an attacker to pass a specially crafted file to Fribidi, leading to a crash and causing a denial of service.(CVE-2022-25310)");
  ...
  script_tag(name:"affected", value:"'fribidi' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fribidi", rpm:"fribidi~1.0.10~1.h2.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fribidi-devel", rpm:"fribidi-devel~1.0.10~1.h2.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
