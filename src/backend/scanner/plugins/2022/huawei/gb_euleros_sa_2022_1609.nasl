...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1609");
  ...
  script_name("Huawei EulerOS: Security Advisory for mozjs60 (EulerOS-SA-2022-1609)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1609");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1609");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mozjs60' package(s) announced via the EulerOS-SA-2022-1609 advisory.");
...
Due to a missing case handling object types, a type confusion vulnerability could occur, resulting in a crash. We presume that with enough effort that it could be exploited to run arbitrary code. This vulnerability affects Firefox ESR < 68.4 and Firefox < 72.(CVE-2019-17017)");
  ...
  script_tag(name:"affected", value:"'mozjs60' package(s) on Huawei EulerOS Virtualization release 2.9.1.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozjs60", rpm:"mozjs60~60.2.2~4.h2.r1.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
