...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2122");
  ...
  script_name("Huawei EulerOS: Security Advisory for selinux-policy (EulerOS-SA-2022-2122)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2122");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2122");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'selinux-policy' package(s) announced via the EulerOS-SA-2022-2122 advisory.");
  ...
  script_tag(name:"affected", value:"'selinux-policy' package(s) on Huawei EulerOS Virtualization release 2.10.1.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"selinux-policy", rpm:"selinux-policy~3.14.2~65.h21.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"selinux-policy-help", rpm:"selinux-policy-help~3.14.2~65.h21.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
