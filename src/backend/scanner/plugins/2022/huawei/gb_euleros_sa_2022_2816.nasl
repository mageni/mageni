...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2816");
  ...
  script_name("Huawei EulerOS: Security Advisory for deltarpm (EulerOS-SA-2022-2816)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2816");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2816");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'deltarpm' package(s) announced via the EulerOS-SA-2022-2816 advisory.");
...
zlib before 1.2.12 allows memory corruption when deflating (i.e., when compressing) if the input has many distant matches.(CVE-2018-25032)");
  ...
  script_tag(name:"affected", value:"'deltarpm' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"deltarpm", rpm:"deltarpm~3.6.2~4.h3.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deltarpm-help", rpm:"deltarpm-help~3.6.2~4.h3.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
