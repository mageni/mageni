...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2439");
  script_cve_id("CVE-2022-1962", "CVE-2022-28131", "CVE-2022-30629");
  ...
  script_tag(name:"severity_date", value:"2022-08-15 19:24:00 +0000 (Mon, 15 Aug 2022)");

  script_name("Huawei EulerOS: Security Advisory for golang (EulerOS-SA-2022-2439)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2439");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2439");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'golang' package(s) announced via the EulerOS-SA-2022-2439 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Uncontrolled recursion in Decoder.Skip in encoding/xml before Go 1.17.12 and Go 1.18.4 allows an attacker to cause a panic due to stack exhaustion via a deeply nested XML document.(CVE-2022-28131)
