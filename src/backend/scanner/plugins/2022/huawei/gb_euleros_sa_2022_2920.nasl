...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2920");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2022-2920)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2920");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2920");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2022-2920 advisory.");
...
SQLite 1.0.12 through 3.39.x before 3.39.2 sometimes allows an array-bounds overflow if billions of bytes are used in a string argument to a C API.(CVE-2022-35737)");
  ...
  script_tag(name:"affected", value:"'sqlite' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.32.3~2.h7.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
