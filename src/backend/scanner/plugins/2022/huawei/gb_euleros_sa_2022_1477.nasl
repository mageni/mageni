...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1477");
  ...
  script_name("Huawei EulerOS: Security Advisory for nss (EulerOS-SA-2022-1477)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1477");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1477");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'nss' package(s) announced via the EulerOS-SA-2022-1477 advisory.");
  ...
  script_tag(name:"affected", value:"'nss' package(s) on Huawei EulerOS V2.0SP10(x86_64).");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss", rpm:"nss~3.54.0~4.h5.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-softokn", rpm:"nss-softokn~3.54.0~4.h5.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.54.0~4.h5.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
