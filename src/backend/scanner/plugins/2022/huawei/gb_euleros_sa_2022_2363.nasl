...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2363");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-lxml (EulerOS-SA-2022-2363)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2363");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2363");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-lxml' package(s) announced via the EulerOS-SA-2022-2363 advisory.");
  ...
  script_tag(name:"affected", value:"'python-lxml' package(s) on Huawei EulerOS Virtualization release 2.9.1.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-lxml-help", rpm:"python-lxml-help~4.2.3~4.h7.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
