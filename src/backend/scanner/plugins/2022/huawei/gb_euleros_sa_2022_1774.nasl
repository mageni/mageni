...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1774");
  ...
  script_name("Huawei EulerOS: Security Advisory for xulrunner (EulerOS-SA-2022-1774)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1774");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1774");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'xulrunner' package(s) announced via the EulerOS-SA-2022-1774 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"storeAtts in xmlparse.c in Expat (aka libexpat) before 2.4.3 has an integer overflow.(CVE-2022-22827)
...
Expat (aka libexpat) before 2.4.4 has an integer overflow in the doProlog function.(CVE-2022-23990)");
  ...
  script_tag(name:"affected", value:"'xulrunner' package(s) on Huawei EulerOS V2.0SP3.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~31.6.0~3.h2", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
