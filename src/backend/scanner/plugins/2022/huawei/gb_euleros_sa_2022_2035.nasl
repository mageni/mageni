...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2035");
  ...
  script_name("Huawei EulerOS: Security Advisory for python3 (EulerOS-SA-2022-2035)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2035");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2035");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python3' package(s) announced via the EulerOS-SA-2022-2035 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3", rpm:"python3~3.7.9~9.h20.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-unversioned-command", rpm:"python3-unversioned-command~3.7.9~9.h20.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
