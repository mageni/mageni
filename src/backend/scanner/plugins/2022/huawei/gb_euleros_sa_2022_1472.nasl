...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1472");
  ...
  script_name("Huawei EulerOS: Security Advisory for busybox (EulerOS-SA-2022-1472)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1472");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1472");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'busybox' package(s) announced via the EulerOS-SA-2022-1472 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox-help", rpm:"busybox-help~1.31.1~6.h6.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
