...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2868");
  ...
  script_name("Huawei EulerOS: Security Advisory for pcre2 (EulerOS-SA-2022-2868)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2868");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2868");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pcre2' package(s) announced via the EulerOS-SA-2022-2868 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pcre2", rpm:"pcre2~10.35~1.h2.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
