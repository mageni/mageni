...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2219");
  ...
  script_name("Huawei EulerOS: Security Advisory for dpkg (EulerOS-SA-2022-2219)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2219");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2219");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dpkg' package(s) announced via the EulerOS-SA-2022-2219 advisory.");
  ...
  script_tag(name:"affected", value:"'dpkg' package(s) on Huawei EulerOS V2.0SP8.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dpkg", rpm:"dpkg~1.18.25~9.h1.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
