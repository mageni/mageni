...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1273");
  ...
  script_tag(name:"severity_date", value:"2021-07-26 18:03:00 +0000 (Mon, 26 Jul 2021)");

  script_name("Huawei EulerOS: Security Advisory for libsepol (EulerOS-SA-2022-1273)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1273");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1273");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsepol' package(s) announced via the EulerOS-SA-2022-1273 advisory.");
...
The CIL compiler in SELinux 3.2 has a use-after-free in cil_reset_classpermission (called from cil_reset_classperms_set and cil_reset_classperms_list).(CVE-2021-36086)");
  ...
  script_tag(name:"affected", value:"'libsepol' package(s) on Huawei EulerOS V2.0SP5.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsepol", rpm:"libsepol~2.5~8.1.h1.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsepol-devel", rpm:"libsepol-devel~2.5~8.1.h1.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
