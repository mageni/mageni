...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2758");
  ...
  script_name("Huawei EulerOS: Security Advisory for deltarpm (EulerOS-SA-2022-2758)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2758");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2758");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'deltarpm' package(s) announced via the EulerOS-SA-2022-2758 advisory.");
...
inffast.c in zlib 1.2.8 might allow context-dependent attackers to have unspecified impact by leveraging improper pointer arithmetic.(CVE-2016-9841)");
  ...
  script_tag(name:"affected", value:"'deltarpm' package(s) on Huawei EulerOS V2.0SP9(x86_64).");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"deltarpm", rpm:"deltarpm~3.6.2~2.h3.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
