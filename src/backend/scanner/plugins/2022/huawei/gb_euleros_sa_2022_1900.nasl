...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1900");
  script_cve_id("CVE-2022-0891", "CVE-2022-0908", "CVE-2022-0924", "CVE-2022-1355");
  ...
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2022-1900)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1900");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1900");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libtiff' package(s) announced via the EulerOS-SA-2022-1900 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"stack-buffer-overflow in tiffcp.c in main().(CVE-2022-1355)
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.0.3~27.h35.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~4.0.3~27.h35.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
