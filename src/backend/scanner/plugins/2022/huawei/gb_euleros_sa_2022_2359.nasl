...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2359");
  ...
  script_name("Huawei EulerOS: Security Advisory for openssh (EulerOS-SA-2022-2359)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2359");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2359");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openssh' package(s) announced via the EulerOS-SA-2022-2359 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssh", rpm:"openssh~8.2p1~2.h38.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-clients", rpm:"openssh-clients~8.2p1~2.h38.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-server", rpm:"openssh-server~8.2p1~2.h38.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
