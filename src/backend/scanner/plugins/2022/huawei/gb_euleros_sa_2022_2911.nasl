...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2911");
  ...
  script_name("Huawei EulerOS: Security Advisory for mariadb-connector-c (EulerOS-SA-2022-2911)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2911");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2911");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mariadb-connector-c' package(s) announced via the EulerOS-SA-2022-2911 advisory.");
...
zlib before 1.2.12 allows memory corruption when deflating (i.e., when compressing) if the input has many distant matches.(CVE-2018-25032)");
  ...
  script_tag(name:"affected", value:"'mariadb-connector-c' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb-connector-c", rpm:"mariadb-connector-c~3.0.6~7.h5.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
