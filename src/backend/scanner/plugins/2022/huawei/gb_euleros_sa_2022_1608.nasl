...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1608");
  ...
  script_name("Huawei EulerOS: Security Advisory for libarchive (EulerOS-SA-2022-1608)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1608");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1608");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libarchive' package(s) announced via the EulerOS-SA-2022-1608 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libarchive", rpm:"libarchive~3.4.1~4.h3.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
