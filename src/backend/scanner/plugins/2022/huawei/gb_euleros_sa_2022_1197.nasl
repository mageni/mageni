...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1197");
  ...
  script_name("Huawei EulerOS: Security Advisory for postgresql (EulerOS-SA-2022-1197)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1197");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1197");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'postgresql' package(s) announced via the EulerOS-SA-2022-1197 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"libpq processes unencrypted bytes from man-in-the-middle(CVE-2021-23222 )");
