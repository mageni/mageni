...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2497");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdisk (EulerOS-SA-2022-2497)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2497");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2497");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdisk' package(s) announced via the EulerOS-SA-2022-2497 advisory.");
...
In LoadPartitionTable of gpt.cc, there is a possible out of bounds write due to a missing bounds check. This could lead to local escalation of privilege when inserting a malicious USB device, with no additional execution privileges needed. User interaction is not needed for exploitation.(CVE-2020-0256)");
  ...
  script_tag(name:"affected", value:"'gdisk' package(s) on Huawei EulerOS Virtualization 3.0.6.6.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdisk", rpm:"gdisk~0.8.6~5.h1.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
