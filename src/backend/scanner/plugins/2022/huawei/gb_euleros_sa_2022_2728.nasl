...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2728");
  ...
  script_name("Huawei EulerOS: Security Advisory for fribidi (EulerOS-SA-2022-2728)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2728");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2728");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'fribidi' package(s) announced via the EulerOS-SA-2022-2728 advisory.");
...
A heap-based buffer overflow flaw was found in the Fribidi package and affects the fribidi_cap_rtl_to_unicode() function of the fribidi-char-sets-cap-rtl.c file. This flaw allows an attacker to pass a specially crafted file to the Fribidi application with the '--caprtl' option, leading to a crash and causing a denial of service.(CVE-2022-25309)");
  ...
  script_tag(name:"affected", value:"'fribidi' package(s) on Huawei EulerOS V2.0SP9.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fribidi", rpm:"fribidi~1.0.5~4.h2.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fribidi-devel", rpm:"fribidi-devel~1.0.5~4.h2.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
