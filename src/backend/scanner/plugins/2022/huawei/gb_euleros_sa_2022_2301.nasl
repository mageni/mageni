...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2301");
  ...
  script_name("Huawei EulerOS: Security Advisory for pcre2 (EulerOS-SA-2022-2301)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2301");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2301");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pcre2' package(s) announced via the EulerOS-SA-2022-2301 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pcre2", rpm:"pcre2~10.33~2.h3.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
