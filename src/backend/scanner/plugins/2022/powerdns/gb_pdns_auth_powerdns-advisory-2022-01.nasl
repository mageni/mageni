...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server DoS Vulnerability (2022-01)");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative version 4.4.2, 4.5.3 and 4.6.0.");

  script_tag(name:"solution", value:"Update to version 4.4.3, 4.5.4, 4.6.1 or later.");

  script_xref(name:"URL", value:"https://doc.powerdns.com/authoritative/security-advisories/powerdns-advisory-2022-01.html");
...
if (version_is_equal(version: version, test_version: "4.4.2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.4.3");
  security_message(data: report, port: port, proto: proto);
  exit(0);
}

if (version_is_equal(version: version, test_version: "4.5.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.5.4");
  security_message(data: report, port: port, proto: proto);
  exit(0);
}
