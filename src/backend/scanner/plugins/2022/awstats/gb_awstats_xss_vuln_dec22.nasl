...
if(description)
{
  ...
  script_name("AWStats 7.x <= 7.8 XSS Vulnerability");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 07th December, 2022.
...
if (version_is_less_equal(version: version, test_version: "7.8")) {
