...
if(description)
{
  ...
  script_name("Synology DiskStation Manager 6.2.x < 6.2.4-25556-5, 7.x < 7.0.1-42218-3 OS Command Injection Vulnerability (Synology-SA-22:03) - Remote Known Vulnerable Versions Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170290
