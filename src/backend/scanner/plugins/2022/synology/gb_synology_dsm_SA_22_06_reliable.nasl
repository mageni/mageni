...
if(description)
{
  ...
  script_name("Synology DiskStation Manager 6.2.x < 6.2.4-25556-6, 7.0.x < 7.0.1-42218-4, 7.1.x < 7.1-42661-1 Multiple Vulnerabilities (Synology-SA-22:06) - Remote Known Vulnerable Versions Check");
...
if ( ( version =~ "^7\.1" ) && ( revcomp( a:version, b:"7.1-42661" ) < 0 ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"7.1-42661-1" );
  security_message( port:0, data:report );
  exit( 0 );
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170291
if ( ( version =~ "^6\.2\.4-25556" ) || ( version =~ "^7\.0\.1-42218" ) || (version =~ "^7\.1-42661") )
  exit( 0 );
