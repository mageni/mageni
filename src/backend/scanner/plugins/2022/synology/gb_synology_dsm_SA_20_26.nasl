...
if(description)
{
  ...
  script_version("2022-11-18T08:40:34+0000");
  script_tag(name:"last_modification", value:"2022-11-18 08:40:34 +0000 (Fri, 18 Nov 2022)");
  ...
  script_name("Synology DiskStation Manager < 6.2.3-25426-3 Multiple Vulnerabilities (Synology-SA-20:26)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager prior to version 6.2.3-25426-3.");
...
if ( revcomp( a:version, b:"6.2.3-25426-3" ) < 0 ) {
