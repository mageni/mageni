...
if(description)
{
  ...
  script_name("Synology DiskStation Manager 7.0.x < 7.0.1-42218-6, 7.1.x < 7.1.1-42962-3 Multiple Vulnerabilities (Synology-SA-22:23) - Remote Known Vulnerable Versions Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170293
if ( ( version =~ "^7\.0\.1-42218" ) || (version =~ "^7\.1\.1-42962") )
  exit( 0 );
