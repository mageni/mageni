...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170233");
  ...
  script_name("Synology DiskStation Manager < 6.2.4-25556-5, 7.x < 7.0.1-42218-3 OS Command Injection Vulnerability (Synology-SA-22:03)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager prior to version 6.2.4-25556-5 and
  7.x prior to 7.0.1-42218-3.");
...
if ( revcomp( a:version, b:"6.2.4-25556-5" ) < 0 ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"6.2.4-25556-5" );
  security_message( port:0, data:report );
  exit( 0 );
}

if ( revcomp( a:version, b:"7.0" ) >= 0 && revcomp( a:version, b:"7.0.1-42218-3" ) < 0 ) {
