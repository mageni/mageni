...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170273");
  ...
  script_name("Synology DiskStation Manager 7.1.x < 7.1.1-42962-3 Multiple Vulnerabilities (Synology-SA-22:23)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager versions 7.1.x prior to
  7.1.1-42962-3.");

  script_tag(name:"solution", value:"Update to firmware version 7.1.1-42962-3 or later.");
...
if ( ( version =~ "^7\.1" )  && ( revcomp( a:version, b:"7.1.1-42962-3" ) < 0 ) ) {
