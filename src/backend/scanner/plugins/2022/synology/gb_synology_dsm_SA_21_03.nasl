...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-26 13:45:00 +0000 (Tue, 26 Apr 2022)");
  ...
  script_name("Synology DiskStation Manager < 6.2.4-25553 Multiple Vulnerabilities (Synology-SA-21:03)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager prior to version 6.2.4-25553.");
...
if ( revcomp( a:version, b:"6.2.4-25553" ) < 0 ) {
