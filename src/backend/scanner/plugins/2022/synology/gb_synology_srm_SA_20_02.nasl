...
if(description)
{
  ...
  script_name("Synology Router Manager < 1.2.4-8081 Arbitrary Code Execution Vulnerability (Synology-SA-20:02)");
  ...
  script_tag(name:"affected", value:"Synology Router Manager prior to version 1.2.4-8081.");
...
if ( revcomp( a:version, b:"1.2.4-8081" ) < 0 ) {
