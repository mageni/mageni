...
if(description)
{
  ...
  script_name("Synology DiskStation Manager 6.2.x, 7.0.x Multiple Vulnerabilities (Synology-SA-22:23)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager versions 6.2.x and 7.0.x.");
