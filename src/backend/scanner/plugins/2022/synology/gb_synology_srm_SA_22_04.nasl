...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170261");
  ...
  script_name("Synology Router Manager < 1.3.1-9346 OpenSSL Vulnerability (Synology-SA-22:04)");
  ...
  This might result in a denial of service condition.");
