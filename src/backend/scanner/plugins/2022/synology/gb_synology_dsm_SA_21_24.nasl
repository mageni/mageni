...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170237");
  ...
  script_name("Synology DiskStation Manager < 7.0.1-42218 OpenSSL Vulnerabilities (Synology-SA-21:24)");
  ...
  script_tag(name:"insight", value:"Updated OpenSSL to version 1.1.1l to resolve remote code
  execution (CVE-2021-3711) and denial of service (CVE-2021-3712) vulnerabilities.");

  script_tag(name:"affected", value:"Synology DiskStation Manager prior to version 7.0.1-42218.");

  script_tag(name:"solution", value:"Update to firmware version 7.0.1-42218 or later.");
...
if ( revcomp( a:version, b:"7.0.1-42218" ) < 0 ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"7.0.1-42218" );
