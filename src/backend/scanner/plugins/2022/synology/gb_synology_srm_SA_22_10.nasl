...
if(description)
{
  ...
  script_name("Synology Router Manager Multiple Samba Vulnerabilities (Synology-SA-22:10)");
  ...
  script_tag(name:"affected", value:"Synology Router Manager version 1.3.1-9346-2 and prior.");

  script_tag(name:"solution", value:"No known solution is available as of 05th December, 2022.
...
if ( revcomp( a:version, b:"1.3.1-9346-2" ) <= 0 ) {
