...
if(description)
{
  ...
  script_name("Synology DiskStation Manager < 6.2.3-25426-2 Multiple Vulnerabilities (Synology-SA-20:18)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager prior to version 6.2.3-25426-2.");
...
if ( revcomp( a:version, b:"6.2.3-25426-2" ) < 0 ) {
