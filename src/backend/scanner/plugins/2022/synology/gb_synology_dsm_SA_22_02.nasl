...
if(description)
{
  ...
  script_name("Synology DiskStation Manager < 6.2.4-25556-4 Samba Vulnerability (Synology-SA-22:02)");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager prior to version 6.2.4-25556-4.");
...
if ( revcomp( a:version, b:"6.2.4-25556-4" ) < 0 ) {
