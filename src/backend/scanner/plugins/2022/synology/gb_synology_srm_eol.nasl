...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170275");
  ...
  script_name("Synology Router Manager (SRM) End of Life (EOL) Detection");
  ...
  script_tag(name:"summary", value:"The Synology Router Manager version on the remote
  host has reached the End of Life (EOL) and should not be used anymore.");

  script_tag(name:"impact", value:"An EOL version of Synology Router Manager is not
  ...
  script_tag(name:"solution", value:"Update the Synology Router Manager version on the
...
if( ret = product_reached_eol( cpe:CPE, version:ver ) ) {
  report = build_eol_message( name:"Synology Router Manager",
                              cpe:CPE,
                              version:ver,
