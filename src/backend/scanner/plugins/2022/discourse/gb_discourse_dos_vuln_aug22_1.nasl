...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127141");
  script_version("2022-08-16T09:56:41+0000");
  script_tag(name:"last_modification", value:"2022-08-16 09:56:41 +0000 (Tue, 16 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-16 08:22:15 +0000 (Tue, 16 Aug 2022)");
  ...
  script_name("Discourse < 2.8.7 DoS Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse prior to version 2.8.7.");
