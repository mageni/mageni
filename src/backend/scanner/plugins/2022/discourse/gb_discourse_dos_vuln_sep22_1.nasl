...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124188");
  ...
  script_cve_id("CVE-2022-39226");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Discourse < 2.8.9, 2.9.x - 2.9.0.beta9 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"A malicious actor can add large payloads of text into the Location
