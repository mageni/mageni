...
if(description)
{
  ...
  script_version("2022-06-08T03:56:50+0000");
  ...
  script_cve_id("CVE-2022-31025");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Discourse 2.9.x < 2.9.0.beta5 User Approval Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"Discourse is prone to a user approval bypass vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Inviting users on sites that use SSO could bypass the
  must_approve_users check and invites by staff are always approved automatically.");
