...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826582");
  ...
  script_tag(name:"creation_date", value:"2022-10-13 15:19:49 +0530 (Thu, 13 Oct 2022)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB22-46) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat Classic 2020 20.005.30381
  and earlier versions on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Acrobat Classic 2020 to
  version 20.005.30407 or later.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30381"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.005.30407(2020.005.30407)", install_path:path);
