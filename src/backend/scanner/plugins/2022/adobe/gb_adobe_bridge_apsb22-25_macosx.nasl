...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821130");
  ...
  script_name("Adobe Bridge Multiple Vulnerabilities (APSB22-25) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Bridge 12.0.1 and earlier versions
  on Mac OS X.");
