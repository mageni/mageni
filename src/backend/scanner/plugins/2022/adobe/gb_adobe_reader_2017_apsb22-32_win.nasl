...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821184");
  ...
  script_name("Adobe Reader 2017 Security Update (APSB22-32) - Windows");
  ...
  script_tag(name:"affected", value:"Adobe Reader 2017 versions 17.012.30229
  ...
  script_xref(name:"URL", value:"https://helpx.adobe.com/in/security/products/acrobat/apsb22-32.html");
...
if(version_in_range(version:vers, test_version:"17.0", test_version2:"17.012.30229"))
{
