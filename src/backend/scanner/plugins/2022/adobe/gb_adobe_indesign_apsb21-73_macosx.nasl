...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822473");
  ...
  script_tag(name:"affected", value:"Adobe InDesign 16.3.2 and earlier versions
  on Mac OS X.");
...
if(version_is_less_equal(version:vers, test_version:"16.3.2"))
{
