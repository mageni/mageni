...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826529");
  ...
  script_tag(name:"creation_date", value:"2022-09-15 18:17:02 +0530 (Thu, 15 Sep 2022)");
  script_name("Adobe Photoshop Information Disclosure Vulnerability (APSB22-14) - Mac OS X");
