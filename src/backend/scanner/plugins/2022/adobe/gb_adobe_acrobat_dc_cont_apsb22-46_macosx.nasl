...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826579");
  ...
  script_tag(name:"creation_date", value:"2022-10-13 15:19:11 +0530 (Thu, 13 Oct 2022)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB22-46) - Mac OS X");
  ...
  22.002.20212 and earlier on Mac OS X.");
...
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2022.003.20258", install_path:path);
