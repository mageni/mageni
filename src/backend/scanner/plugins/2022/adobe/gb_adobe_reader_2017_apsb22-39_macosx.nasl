...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826410");
  ...
  script_name("Adobe Reader 2017 Security Update (APSB22-39) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Reader 2017 versions 17.012.30249
  and earlier on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Reader 2017 to version
  17.012.30262 or later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://helpx.adobe.com/in/security/products/acrobat/apsb22-39.html");
...
if(version_in_range(version:vers, test_version:"17.0", test_version2:"17.012.30249"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"17.012.30262 or later.", install_path:path);
