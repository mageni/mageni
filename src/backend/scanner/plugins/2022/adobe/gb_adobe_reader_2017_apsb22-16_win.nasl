...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821206");
  ...
  script_name("Adobe Reader 2017 Security Update (APSB22-16) - Windows");
  ...
  script_xref(name:"URL", value:"https://helpx.adobe.com/in/security/products/acrobat/apsb22-16.html");
