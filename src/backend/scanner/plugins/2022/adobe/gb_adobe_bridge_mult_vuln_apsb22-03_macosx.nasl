...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819944");
  ...
  script_tag(name:"creation_date", value:"2022-01-13 18:55:50 +0530 (Thu, 13 Jan 2022)");
  script_name("Adobe Bridge Security Update (APSB22-03) - Mac OS X");
  ...
  12.x prior to 12.0.1 on Mac OS X.");
