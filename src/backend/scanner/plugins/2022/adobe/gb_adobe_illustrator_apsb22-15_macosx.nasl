...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826404");
  ...
  script_name("Adobe Illustrator buffer overflow Vulnerability (APSB22-15) - Mac OS X");
  ...
  25.4.4 and earlier versions on Mac OS X.");
