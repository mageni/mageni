...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826580");
  ...
  script_tag(name:"creation_date", value:"2022-10-13 15:19:27 +0530 (Thu, 13 Oct 2022)");
  script_name("Adobe Reader DC Continuous Security Update (APSB22-46) - Mac OS X");
