...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826412");
  ...
  script_name("Adobe Acrobat 2017 Security Update (APSB22-39) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat 2017 17.012.30249 and earlier
  versions on MacOSX.");
