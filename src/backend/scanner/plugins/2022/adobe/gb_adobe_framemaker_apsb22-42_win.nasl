...
if (description)
{
  ...
  script_tag(name:"affected", value:"Adobe Framemaker 15.0.8 and earlier, 16.0.4
  and earlier versions on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Framemaker 15.0.8 or 16.0.4
...
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.0.7"))
{
  fix = "15.0.8 or later.";
}
else if(version_in_range(version:vers, test_version:"16.0", test_version2:"16.0.3"))
{
  fix = "16.0.4 or later.";
}
