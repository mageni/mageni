...
if (description)
{
  ...
  attackers to execute arbitrary on the system.");

  script_tag(name:"affected", value:"Adobe Framemaker 2019.0.5 and below version
  on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Framemaker 2019.0.6 or
...
if(version_is_less_equal(version:vers, test_version:"2019.0.5"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2019.0.6 or later.", install_path:path);
