...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147445");
  script_version("2022-01-14T02:47:28+0000");
  script_tag(name:"last_modification", value:"2022-01-14 11:23:55 +0000 (Fri, 14 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-14 02:46:34 +0000 (Fri, 14 Jan 2022)");
  ...
  script_name("Jenkins < 2.319.2, < 2.330 CSRF Vulnerability - Windows");
