...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2012-10-08 04:00:00 +0000 (Mon, 08 Oct 2012)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Proc-ProcessTable, perl-Proc-ProcessTable' package(s) announced via the MGASA-2013-0254 advisory.");
...
files via a symlink attack on /tmp/TTYDEVS (CVE-2011-4363).");
  ...
  script_tag(name:"affected", value:"'perl-Proc-ProcessTable, perl-Proc-ProcessTable' package(s) on Mageia 2, Mageia 3.");
