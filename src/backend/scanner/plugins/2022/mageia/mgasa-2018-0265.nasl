...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2018.0265");
  script_cve_id("CVE-2018-1000004", "CVE-2018-1000200", "CVE-2018-1065", "CVE-2018-1068", "CVE-2018-1087", "CVE-2018-1092", "CVE-2018-1093", "CVE-2018-1094", "CVE-2018-1095", "CVE-2018-1108", "CVE-2018-1120", "CVE-2018-1130", "CVE-2018-3639", "CVE-2018-8897");
  ...
  script_name("Mageia: Security Advisory (MGASA-2018-0265)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2018-0265");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2018-0265.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=23077");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-linus' package(s) announced via the MGASA-2018-0265 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This kernel-linus update is based on the upstream 4.14.44 and fixes at least
...
from psutils or procps (such as ps, w) or any other program which makes ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-4.14.44-1.mga6", rpm:"kernel-linus-4.14.44-1.mga6~1~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus", rpm:"kernel-linus~4.14.44~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-4.14.44-1.mga6", rpm:"kernel-linus-devel-4.14.44-1.mga6~1~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-latest", rpm:"kernel-linus-devel-latest~4.14.44~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-doc", rpm:"kernel-linus-doc~4.14.44~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-latest", rpm:"kernel-linus-latest~4.14.44~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-4.14.44-1.mga6", rpm:"kernel-linus-source-4.14.44-1.mga6~1~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-latest", rpm:"kernel-linus-source-latest~4.14.44~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
