...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'x11vnc, x11vnc' package(s) announced via the MGASA-2014-0361 advisory.");
...
The updated packages should have been shipped along with MGASA-2014-0356");
  ...
  script_tag(name:"affected", value:"'x11vnc, x11vnc' package(s) on Mageia 3, Mageia 4.");
