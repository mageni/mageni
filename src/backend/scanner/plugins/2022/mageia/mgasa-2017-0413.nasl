...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libextractor, libextractor' package(s) announced via the MGASA-2017-0413 advisory.");
