...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2013-10-15 16:05:00 +0000 (Tue, 15 Oct 2013)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'torque, torque' package(s) announced via the MGASA-2013-0308 advisory.");
...
and run the job, which would run as root (CVE-2013-4319).");
  ...
  script_tag(name:"affected", value:"'torque, torque' package(s) on Mageia 2, Mageia 3.");
