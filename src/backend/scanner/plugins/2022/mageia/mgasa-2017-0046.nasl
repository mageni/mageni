...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'audacious-plugins, audacious-plugins' package(s) announced via the MGASA-2017-0046 advisory.");
...
with a bundled copy, which has been patched to fix the issues.");
  ...
  script_tag(name:"affected", value:"'audacious-plugins, audacious-plugins' package(s) on Mageia 5.");
