...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0405");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0405)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0405");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0405.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl' package(s) announced via the MGASA-2014-0405 advisory.");
...
issues.");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on Mageia 3.");
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl", rpm:"perl~5.16.3~1.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-base", rpm:"perl-base~5.16.3~1.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-devel", rpm:"perl-devel~5.16.3~1.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-doc", rpm:"perl-doc~5.16.3~1.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
