...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox, busybox' package(s) announced via the MGASA-2021-0310 advisory.");
...
fault, via malformed gzip data (CVE-2021-28831).");
  ...
  script_tag(name:"affected", value:"'busybox, busybox' package(s) on Mageia 7, Mageia 8.");
