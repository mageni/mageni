...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-03-26 04:54:00 +0000 (Wed, 26 Mar 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail, roundcubemail' package(s) announced via the MGASA-2013-0325 advisory.");
...
manipulated SQL queries and even code execution (CVE-2013-6172).");
  ...
  script_tag(name:"affected", value:"'roundcubemail, roundcubemail' package(s) on Mageia 2, Mageia 3.");
