...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Image-ExifTool, perl-Image-ExifTool' package(s) announced via the MGASA-2021-0259 advisory.");
...
malicious image (CVE-2021-22204).");
  ...
  script_tag(name:"affected", value:"'perl-Image-ExifTool, perl-Image-ExifTool' package(s) on Mageia 7, Mageia 8.");
