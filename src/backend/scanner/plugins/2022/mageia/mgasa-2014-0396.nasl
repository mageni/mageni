...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0396");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0396)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0396");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0396.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=14150");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid, squid' package(s) announced via the MGASA-2014-0396 advisory.");
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~3.2.10~1.8.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~3.2.10~1.8.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~3.3.13~1.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~3.3.13~1.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
