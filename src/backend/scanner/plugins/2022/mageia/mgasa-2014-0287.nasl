...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'freerdp, freerdp' package(s) announced via the MGASA-2014-0287 advisory.");
...
Request packet (CVE-2014-0791).");
  ...
  script_tag(name:"affected", value:"'freerdp, freerdp' package(s) on Mageia 3, Mageia 4.");
