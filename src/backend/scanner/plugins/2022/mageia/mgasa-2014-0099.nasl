...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2015-08-05 16:28:00 +0000 (Wed, 05 Aug 2015)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpmyadmin, phpmyadmin, phpseclib, phpseclib' package(s) announced via the MGASA-2014-0099 advisory.");
...
Mageia 4, due to new dependencies.");
  ...
  script_tag(name:"affected", value:"'phpmyadmin, phpmyadmin, phpseclib, phpseclib' package(s) on Mageia 3, Mageia 4.");
