...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird, thunderbird, thunderbird-l10n, thunderbird-l10n' package(s) announced via the MGASA-2017-0370 advisory.");
