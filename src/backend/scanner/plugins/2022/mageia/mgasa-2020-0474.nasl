...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2020.0474");
  ...
  script_name("Mageia: Security Advisory (MGASA-2020-0474)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2020-0474");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2020-0474.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=27568");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4617-1");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2020/11/04/1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spice-vdagent' package(s) announced via the MGASA-2020-0474 advisory.");
...
the active session (CVE-2020-25653).");
  ...
  script_tag(name:"affected", value:"'spice-vdagent' package(s) on Mageia 7.");
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"spice-vdagent", rpm:"spice-vdagent~0.19.0~1.1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }
