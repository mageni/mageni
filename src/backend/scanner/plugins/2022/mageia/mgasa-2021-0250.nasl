...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnuchess, gnuchess' package(s) announced via the MGASA-2021-0250 advisory.");
...
functions in frontend/cmd.cc. (CVE-2021-30184).");
  ...
  script_tag(name:"affected", value:"'gnuchess, gnuchess' package(s) on Mageia 7, Mageia 8.");
