...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0207");
  script_cve_id("CVE-2014-0049", "CVE-2014-0055", "CVE-2014-0069", "CVE-2014-0077");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0207)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0207");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0207.html");
  ...
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=13265");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-linus' package(s) announced via the MGASA-2014-0207 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Updated kernel-linus provides upstream 3.12.18 kernel and fixes the following
security issues:
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-3.12.18-1.mga4", rpm:"kernel-linus-3.12.18-1.mga4~1~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus", rpm:"kernel-linus~3.12.18~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-3.12.18-1.mga4", rpm:"kernel-linus-devel-3.12.18-1.mga4~1~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-latest", rpm:"kernel-linus-devel-latest~3.12.18~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-doc", rpm:"kernel-linus-doc~3.12.18~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-latest", rpm:"kernel-linus-latest~3.12.18~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-3.12.18-1.mga4", rpm:"kernel-linus-source-3.12.18-1.mga4~1~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-latest", rpm:"kernel-linus-source-latest~3.12.18~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
