...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'htmldoc, htmldoc' package(s) announced via the MGASA-2021-0332 advisory.");
...
SEGV on unknown address 0x000000000000 (CVE-2021-26948).");
  ...
  script_tag(name:"affected", value:"'htmldoc, htmldoc' package(s) on Mageia 7, Mageia 8.");
