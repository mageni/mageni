...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpano13, libpano13, libpano13, libpano13' package(s) announced via the MGASA-2021-0230 advisory.");
  ...
  script_tag(name:"affected", value:"'libpano13, libpano13, libpano13, libpano13' package(s) on Mageia 7, Mageia 8.");
