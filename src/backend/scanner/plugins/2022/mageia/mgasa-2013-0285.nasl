...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2013-10-02 04:29:00 +0000 (Wed, 02 Oct 2013)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-phpmailer, php-phpmailer, wordpress, wordpress' package(s) announced via the MGASA-2013-0285 advisory.");
...
by the updated wordpress.");
  ...
  script_tag(name:"affected", value:"'php-phpmailer, php-phpmailer, wordpress, wordpress' package(s) on Mageia 2, Mageia 3.");
