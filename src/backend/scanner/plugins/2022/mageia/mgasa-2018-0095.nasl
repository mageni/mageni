...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid, squid' package(s) announced via the MGASA-2018-0095 advisory.");
...
(SQUID-2018:2).");
  ...
  script_tag(name:"affected", value:"'squid, squid' package(s) on Mageia 5, Mageia 6.");
