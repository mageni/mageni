...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2011-10-21 02:56:00 +0000 (Fri, 21 Oct 2011)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Crypt-DSA, perl-Crypt-DSA' package(s) announced via the MGASA-2013-0289 advisory.");
...
This update removes the fallback to Data::Random.");
  ...
  script_tag(name:"affected", value:"'perl-Crypt-DSA, perl-Crypt-DSA' package(s) on Mageia 2, Mageia 3.");
