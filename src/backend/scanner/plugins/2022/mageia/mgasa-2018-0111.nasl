...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gcab, gcab' package(s) announced via the MGASA-2018-0111 advisory.");
...
specially crafted .cab file is processed (CVE-2018-5345).");
  ...
  script_tag(name:"affected", value:"'gcab, gcab' package(s) on Mageia 5, Mageia 6.");
