...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2020.0332");
  script_cve_id("CVE-2020-14058", "CVE-2020-14059");
  ...
  script_name("Mageia: Security Advisory (MGASA-2020-0332)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2020-0332");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2020-0332.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=26884");
  script_xref(name:"URL", value:"http://www.squid-cache.org/Advisories/SQUID-2020_6.txt");
  script_xref(name:"URL", value:"https://github.com/squid-cache/squid/security/advisories/GHSA-qf3v-rc95-96j5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the MGASA-2020-0332 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Due to use of a potentially dangerous function Squid and the default
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~4.12~2.mga7", rls:"MAGEIA7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~4.12~2.mga7", rls:"MAGEIA7"))) {
    report += res;
  }
