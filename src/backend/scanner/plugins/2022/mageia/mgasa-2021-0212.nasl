...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'avahi, avahi' package(s) announced via the MGASA-2021-0212 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Avoid infinite loop by handling HUP event in client_work. (CVE-2021-3468)");

  script_tag(name:"affected", value:"'avahi, avahi' package(s) on Mageia 7, Mageia 8.");
