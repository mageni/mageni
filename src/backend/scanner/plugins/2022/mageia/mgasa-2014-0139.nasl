...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python, python' package(s) announced via the MGASA-2014-0139 advisory.");
...
(CVE-2013-1753).");
  ...
  script_tag(name:"affected", value:"'python, python' package(s) on Mageia 3, Mageia 4.");
