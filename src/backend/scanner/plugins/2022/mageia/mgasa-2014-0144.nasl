...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-26 20:00:00 +0000 (Thu, 26 Jan 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'stunnel, stunnel' package(s) announced via the MGASA-2014-0144 advisory.");
...
(mga#13124). This can be worked around by adding fips = no into the config.");
  ...
  script_tag(name:"affected", value:"'stunnel, stunnel' package(s) on Mageia 3, Mageia 4.");
