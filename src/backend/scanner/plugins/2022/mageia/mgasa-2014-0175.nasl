...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'json-c, json-c' package(s) announced via the MGASA-2014-0175 advisory.");
...
(CVE-2013-6371).");
  ...
  script_tag(name:"affected", value:"'json-c, json-c' package(s) on Mageia 3, Mageia 4.");
