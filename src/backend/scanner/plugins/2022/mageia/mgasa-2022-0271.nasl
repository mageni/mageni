...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox-l10n' package(s) announced via the MGASA-2022-0271 advisory.");
...
could interact with different coordinates than displayed (CVE-2022-36319).");
  ...
  script_tag(name:"affected", value:"'firefox, firefox-l10n' package(s) on Mageia 8.");
