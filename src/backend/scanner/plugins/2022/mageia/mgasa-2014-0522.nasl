...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-09-06 14:30:00 +0000 (Tue, 06 Sep 2016)");

  script_name("Mageia: Security Advisory (MGASA-2014-0522)");
...
and several other bugs, as well as providing additional features.");
  ...
  script_tag(name:"affected", value:"'pdns-recursor' package(s) on Mageia 4.");
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pdns-recursor", rpm:"pdns-recursor~3.6.2~1.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
