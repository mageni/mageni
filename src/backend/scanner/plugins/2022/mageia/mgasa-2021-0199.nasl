...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox, firefox-l10n, firefox-l10n, nss, nss' package(s) announced via the MGASA-2021-0199 advisory.");
...
Alt-Svc header (CVE-2021-29946).");
  ...
  script_tag(name:"affected", value:"'firefox, firefox, firefox-l10n, firefox-l10n, nss, nss' package(s) on Mageia 7, Mageia 8.");
