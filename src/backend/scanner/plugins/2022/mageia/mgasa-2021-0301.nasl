...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nginx, nginx' package(s) announced via the MGASA-2021-0301 advisory.");
...
confidentiality and integrity as well as system availability (CVE-2021-23017).");
  ...
  script_tag(name:"affected", value:"'nginx, nginx' package(s) on Mageia 7, Mageia 8.");
