...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'imagemagick, imagemagick' package(s) announced via the MGASA-2014-0482 advisory.");
