...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-04-20 14:56:00 +0000 (Fri, 20 Apr 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'zarafa, zarafa' package(s) announced via the MGASA-2014-0380 advisory.");
...
CVE-2014-5450).");
  ...
  script_tag(name:"affected", value:"'zarafa, zarafa' package(s) on Mageia 3, Mageia 4.");
