...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126171");
  script_version("2022-10-18T10:13:37+0000");
  script_tag(name:"last_modification", value:"2022-10-18 10:13:37 +0000 (Tue, 18 Oct 2022)");
  script_tag(name:"creation_date", value:"2022-10-17 11:45:30 +0000 (Mon, 17 Oct 2022)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_cve_id("CVE-2022-25278");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Drupal 8.0 < 9.3.19, 9.4.0 < 9.4.3 Access Bypass (SA-CORE-2022-013) - Windows");
  ...
  script_tag(name:"insight", value:"Under certain circumstances, the Drupal core form API evaluates
  form element access incorrectly. This may lead to a user being able to alter data they should not
  have access to.");

  script_tag(name:"affected", value:"Drupal versions starting from 8.0.0 prior to 9.3.19 and 9.4.0
  prior to 9.4.3.");

  script_tag(name:"solution", value:"Update to version 9.3.19, 9.4.3 or later.");

  script_xref(name:"URL", value:"https://www.drupal.org/sa-core-2022-013");
