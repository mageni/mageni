...
if(description)
{
  ...
  script_version("2022-12-19T11:36:50+0000");
  script_tag(name:"last_modification", value:"2022-12-19 11:36:50 +0000 (Mon, 19 Dec 2022)");
  script_tag(name:"creation_date", value:"2022-12-19 11:00:29 +0000 (Mon, 19 Dec 2022)");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");

  script_cve_id("CVE-2022-4605", "CVE-2022-4606");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("FlatPress < 1.3  Multiple Vulnerabilities (CVE-2022-4605, CVE-2022-4606)");
