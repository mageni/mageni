...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822590");
  ...
  script_tag(name:"creation_date", value:"2022-10-03 01:13:23 +0000 (Mon, 03 Oct 2022)");
  script_name("Fedora: Security Advisory for kitty (FEDORA-2022-d718af66d1)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-d718af66d1");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6RRNAPU33PHEH64P77YL3AJO6CTZGHTX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kitty'
  package(s) announced via the FEDORA-2022-d718af66d1 advisory.");
  ...
  script_tag(name:"affected", value:"'kitty' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kitty", rpm:"kitty~0.26.3~2.fc36", rls:"FC36"))) {
    report += res;
  }
