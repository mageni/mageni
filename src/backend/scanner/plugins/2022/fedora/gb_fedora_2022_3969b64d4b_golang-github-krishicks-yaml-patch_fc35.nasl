...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821541");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:16:20 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-krishicks-yaml-patch (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FO5TYQ3IITVAYXYYMQNGHIPZ4Q4Y57UM");
...
of JavaScript Object Notation (JSON) Patch, directly transposed to YAML.");
  ...
  script_tag(name:"affected", value:"'golang-github-krishicks-yaml-patch' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-krishicks-yaml-patch", rpm:"golang-github-krishicks-yaml-patch~0.0.10~8.20200307git05b3177.fc35", rls:"FC35"))) {
    report += res;
  }
