...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822489");
  ...
  script_tag(name:"creation_date", value:"2022-09-20 01:14:01 +0000 (Tue, 20 Sep 2022)");
  script_name("Fedora: Security Advisory for rizin (FEDORA-2022-0c34c7d5e1)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-0c34c7d5e1");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WZQG6Z6IHDAOJRCA5QV4FG532FZ6DSLG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rizin'
  package(s) announced via the FEDORA-2022-0c34c7d5e1 advisory.");
...
cleanliness.");
  ...
  script_tag(name:"affected", value:"'rizin' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rizin", rpm:"rizin~0.4.1~1.fc37", rls:"FC37"))) {
    report += res;
  }
