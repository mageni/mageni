...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820873");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:35:28 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-containerd-stargz-snapshotter (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2H575ROTFYHUILFKCSM5A353O6FZHSZ2");
  ...
  script_tag(name:"affected", value:"'golang-github-containerd-stargz-snapshotter' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-containerd-stargz-snapshotter", rpm:"golang-github-containerd-stargz-snapshotter~0.10.1~2.fc36", rls:"FC36"))) {
    report += res;
  }
