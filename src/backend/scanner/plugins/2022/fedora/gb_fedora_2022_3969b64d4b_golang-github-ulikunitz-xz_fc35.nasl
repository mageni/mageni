...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821751");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:29:21 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-ulikunitz-xz (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VGC7BRXO3QTSBSDICWHOGOQHXDVG262O");
...
code.");
  ...
  script_tag(name:"affected", value:"'golang-github-ulikunitz-xz' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-ulikunitz-xz", rpm:"golang-github-ulikunitz-xz~0.5.10~4.fc35", rls:"FC35"))) {
    report += res;
  }
