...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822993");
  ...
  script_tag(name:"creation_date", value:"2022-12-09 02:12:14 +0000 (Fri, 09 Dec 2022)");
  script_name("Fedora: Security Advisory for sfnt2woff-zopfli (FEDORA-2022-458378be7a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-458378be7a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QU5X3IIE5HK5VLPQOQYO4P2OJLDUDANM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sfnt2woff-zopfli'
  package(s) announced via the FEDORA-2022-458378be7a advisory.");
...
A corresponding version of the woff2sfnt utility is also provided.");
  ...
  script_tag(name:"affected", value:"'sfnt2woff-zopfli' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sfnt2woff-zopfli", rpm:"sfnt2woff-zopfli~1.3.1~3.fc35", rls:"FC35"))) {
    report += res;
  }
