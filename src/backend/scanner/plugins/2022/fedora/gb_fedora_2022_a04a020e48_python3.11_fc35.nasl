...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822739");
  ...
  script_name("Fedora: Security Advisory for python3.11 (FEDORA-2022-a04a020e48)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-a04a020e48");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RLN7UAR3R4RPP2X5ROCUZKEAXSKRX7LE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.11'
  package(s) announced via the FEDORA-2022-a04a020e48 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.11", rpm:"python3.11~3.11.0~1.fc35", rls:"FC35"))) {
    report += res;
  }
