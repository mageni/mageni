...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823052");
  ...
  script_tag(name:"creation_date", value:"2022-12-26 02:14:47 +0000 (Mon, 26 Dec 2022)");
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-7e327a20be)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J2URKEEXLEABIVVVLSCXEXL6GIXX3GYN");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.6.14~2.fc37", rls:"FC37"))) {
    report += res;
  }
