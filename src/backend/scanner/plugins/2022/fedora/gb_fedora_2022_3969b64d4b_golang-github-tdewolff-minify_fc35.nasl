...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821709");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:28:47 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-tdewolff-minify (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OXI5UXGKMO6QPSIVQF44MWXECGABWZL3");
...
UglifyCSS, ...).");
  ...
  script_tag(name:"affected", value:"'golang-github-tdewolff-minify' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-tdewolff-minify", rpm:"golang-github-tdewolff-minify~2.11.10~3.fc35", rls:"FC35"))) {
    report += res;
  }
