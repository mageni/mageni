...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820546");
  ...
  script_name("Fedora: Security Advisory for golang-x-exp (FEDORA-2022-08ae2dd481)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CSK2WSATFKWMIL25LDCZSLZODLXQ47H4");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-x-exp-0", rpm:"golang-x-exp-0~0.42.20220330git053ad81.fc36", rls:"FC36"))) {
    report += res;
  }
