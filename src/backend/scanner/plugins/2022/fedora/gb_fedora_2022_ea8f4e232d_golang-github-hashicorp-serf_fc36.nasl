...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822081");
  ...
  script_name("Fedora: Security Advisory for golang-github-hashicorp-serf (FEDORA-2022-ea8f4e232d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZTP2LDS4IFXO3FLQVDBLI35S7YKGH26Q");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-hashicorp-serf", rpm:"golang-github-hashicorp-serf~0.9.5~6.fc36", rls:"FC36"))) {
    report += res;
  }
