...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819620");
  ...
  script_tag(name:"creation_date", value:"2022-01-30 02:02:43 +0000 (Sun, 30 Jan 2022)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2021-22594d9eb0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-22594d9eb0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6DYRBUWTP7BHWIWYZCVTN437SG6GUZDC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2021-22594d9eb0 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~96.0.4664.110~3.fc35", rls:"FC35"))) {
    report += res;
  }
