...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822646");
  ...
  script_tag(name:"creation_date", value:"2022-10-05 07:35:58 +0000 (Wed, 05 Oct 2022)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2022-3ca063941b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-3ca063941b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LVOHGEQF56ZD3C5BZHVIWAXFM2Z3A2HV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2022-3ca063941b advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~105.0.5195.125~2.fc35", rls:"FC35"))) {
    report += res;
  }
