...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822265");
  ...
  script_name("Fedora: Security Advisory for golang-github-burntsushi-toml-test (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5SUEAV2J7ZZFFSLS5YMGZQNAMMDQ5UUZ");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-burntsushi-toml-test", rpm:"golang-github-burntsushi-toml-test~0.2.0~12.20210108git9767d20.fc36", rls:"FC36"))) {
    report += res;
  }
