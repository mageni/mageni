...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820985");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:32:00 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-gorhill-cronexpr (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CRXCES5DQQ6O6KTPKWEAQDDEZU3Q2DZH");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-gorhill-cronexpr", rpm:"golang-github-gorhill-cronexpr~1.0.0~4.fc36", rls:"FC36"))) {
    report += res;
  }
