...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822396");
  ...
  script_tag(name:"creation_date", value:"2022-09-05 01:12:40 +0000 (Mon, 05 Sep 2022)");
  script_name("Fedora: Security Advisory for tcpreplay (FEDORA-2022-680ea95f71)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-680ea95f71");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ECRCFJ6X3IVB7BT4KS6AHQMSL532YXYD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay'
  package(s) announced via the FEDORA-2022-680ea95f71 advisory.");
...
capture files.");
  ...
  script_tag(name:"affected", value:"'tcpreplay' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.4.2~1.fc35", rls:"FC35"))) {
    report += res;
  }
