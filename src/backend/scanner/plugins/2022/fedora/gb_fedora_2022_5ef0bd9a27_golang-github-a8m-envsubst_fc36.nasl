...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821921");
  ...
  script_name("Fedora: Security Advisory for golang-github-a8m-envsubst (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OIGM62DE6MJNWCQWOKHKATGUVLPWKS3D");
  ...
  script_tag(name:"affected", value:"'golang-github-a8m-envsubst' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-a8m-envsubst", rpm:"golang-github-a8m-envsubst~1.3.0~3.fc36", rls:"FC36"))) {
    report += res;
  }
