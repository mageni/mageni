...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820820");
  script_version("2022-07-07T10:16:06+0000");
  script_cve_id("CVE-2022-33903");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-07-07 10:16:06 +0000 (Thu, 07 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-02 01:10:23 +0000 (Sat, 02 Jul 2022)");
  script_name("Fedora: Security Advisory for tor (FEDORA-2022-456b252727)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-456b252727");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4WGRQFAQP5UYYI7UHAL622OWZGHZ5JUQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2022-456b252727 advisory.");
...
Tor network, or as a client to connect to the Tor network.");
  ...
  script_tag(name:"affected", value:"'tor' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.7.8~1.fc36", rls:"FC36"))) {
    report += res;
  }
