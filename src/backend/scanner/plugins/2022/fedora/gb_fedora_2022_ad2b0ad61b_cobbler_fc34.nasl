...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820111");
  ...
  script_name("Fedora: Security Advisory for cobbler (FEDORA-2022-ad2b0ad61b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-ad2b0ad61b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IYSHMF6MEIITFAG7EJ3IQKVUN7MDV2XM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2022-ad2b0ad61b advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~3.2.2~11.fc34", rls:"FC34"))) {
    report += res;
  }
