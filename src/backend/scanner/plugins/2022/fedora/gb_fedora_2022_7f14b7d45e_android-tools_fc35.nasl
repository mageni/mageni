...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822783");
  script_version("2022-11-17T05:30:14+0000");
  script_cve_id("CVE-2022-20128", "CVE-2022-3168");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-11-17 05:30:14 +0000 (Thu, 17 Nov 2022)");
  script_tag(name:"creation_date", value:"2022-11-14 02:13:12 +0000 (Mon, 14 Nov 2022)");
  script_name("Fedora: Security Advisory for android-tools (FEDORA-2022-7f14b7d45e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-7f14b7d45e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UF4QLKGMPPKAHLPYVIUTH7RFAPHX5H3M");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'android-tools'
  package(s) announced via the FEDORA-2022-7f14b7d45e advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"android-tools", rpm:"android-tools~33.0.3p1~2.fc35", rls:"FC35"))) {
    report += res;
  }
