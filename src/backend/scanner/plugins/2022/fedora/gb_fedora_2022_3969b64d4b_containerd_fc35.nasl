...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821459");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:16:42 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FIUSVIXEHH5MOG4D4LQT7CO2NJG2IXWM");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.6.6~4.fc35", rls:"FC35"))) {
    report += res;
  }
