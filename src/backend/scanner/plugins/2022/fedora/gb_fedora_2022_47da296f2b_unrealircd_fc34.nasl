...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820162");
  ...
  script_tag(name:"creation_date", value:"2022-03-31 01:04:47 +0000 (Thu, 31 Mar 2022)");
  script_name("Fedora: Security Advisory for unrealircd (FEDORA-2022-47da296f2b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-47da296f2b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GHIYDGSO76TZ77HCEYU4QF6FK6OOQ3C5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'unrealircd'
  package(s) announced via the FEDORA-2022-47da296f2b advisory.");
...
flood and anti-spam systems, swear filtering and module support.");
  ...
  script_tag(name:"affected", value:"'unrealircd' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"unrealircd", rpm:"unrealircd~5.2.4~1.fc34", rls:"FC34"))) {
    report += res;
  }
