...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821576");
  ...
  script_tag(name:"creation_date", value:"2022-07-14 01:14:44 +0000 (Thu, 14 Jul 2022)");
  script_name("Fedora: Security Advisory for reposurgeon (FEDORA-2022-ba365d3703)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GKEFB6UCOFKUMABCV6F4UEW6T4YMD2X7");
...
DVCS.");
  ...
  script_tag(name:"affected", value:"'reposurgeon' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"reposurgeon", rpm:"reposurgeon~4.32~2.fc36", rls:"FC36"))) {
    report += res;
  }
