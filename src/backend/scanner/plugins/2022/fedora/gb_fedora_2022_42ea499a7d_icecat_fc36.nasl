...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819852");
  ...
  script_name("Fedora: Security Advisory for icecat (FEDORA-2022-42ea499a7d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2CBGFBUBXR6HFMC6OA5R3DHSEWLYQT35");
 ...
 * A series of configuration changes and tweaks were applied to ensure that
  ...
  script_tag(name:"affected", value:"'icecat' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"icecat", rpm:"icecat~91.7.0~1.rh1.fc36", rls:"FC36"))) {
    report += res;
  }
