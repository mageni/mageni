...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823016");
  ...
  script_tag(name:"creation_date", value:"2022-12-17 02:12:49 +0000 (Sat, 17 Dec 2022)");
  script_name("Fedora: Security Advisory for python3.10 (FEDORA-2022-b2f06fbb62)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-b2f06fbb62");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YPNWZKXPKTNHS5FVMN7UQZ2UPCSEFJUK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.10'
  package(s) announced via the FEDORA-2022-b2f06fbb62 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.10", rpm:"python3.10~3.10.9~1.fc37", rls:"FC37"))) {
    report += res;
  }
