...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821866");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:18:17 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-k8s-pod-security-admission (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MX5CUBTABVWV4EKSHUT56OMFZZFIIT5Q");
  ...
  script_tag(name:"affected", value:"'golang-k8s-pod-security-admission' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-k8s-pod-security-admission", rpm:"golang-k8s-pod-security-admission~1.22.0~3.fc35", rls:"FC35"))) {
    report += res;
  }
