...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822582");
  ...
  script_tag(name:"creation_date", value:"2022-10-04 01:19:39 +0000 (Tue, 04 Oct 2022)");
  script_name("Fedora: Security Advisory for python-oauthlib (FEDORA-2022-5a74a5eea7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-5a74a5eea7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QRYLYHE5HWF6R2CRLJFUK4PILR47WXOE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-oauthlib'
  package(s) announced via the FEDORA-2022-5a74a5eea7 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-oauthlib", rpm:"python-oauthlib~3.2.1~1.fc37", rls:"FC37"))) {
    report += res;
  }
