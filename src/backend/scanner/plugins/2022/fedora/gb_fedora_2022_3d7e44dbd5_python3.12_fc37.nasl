...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823024");
  ...
  script_tag(name:"creation_date", value:"2022-12-17 02:12:48 +0000 (Sat, 17 Dec 2022)");
  script_name("Fedora: Security Advisory for python3.12 (FEDORA-2022-3d7e44dbd5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-3d7e44dbd5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/35YDIWCUMWTMDBWFRAVENFH6BLB65D6S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.12'
  package(s) announced via the FEDORA-2022-3d7e44dbd5 advisory.");
...
the 'python3.12-' prefix.");
  ...
  script_tag(name:"affected", value:"'python3.12' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.12", rpm:"python3.12~a3~1.fc37", rls:"FC37"))) {
    report += res;
  }
