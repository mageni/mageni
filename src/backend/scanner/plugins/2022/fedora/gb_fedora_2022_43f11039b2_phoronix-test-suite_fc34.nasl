...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819769");
  ...
  script_tag(name:"creation_date", value:"2022-02-10 02:02:12 +0000 (Thu, 10 Feb 2022)");
  script_name("Fedora: Security Advisory for phoronix-test-suite (FEDORA-2022-43f11039b2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-43f11039b2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BU7E6OOZCXS3ZWHOQ2AR7MKM56IN2R6R");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phoronix-test-suite'
  package(s) announced via the FEDORA-2022-43f11039b2 advisory.");
...
users only for confirmation of actions.");
  ...
  script_tag(name:"affected", value:"'phoronix-test-suite' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phoronix-test-suite", rpm:"phoronix-test-suite~10.8.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
