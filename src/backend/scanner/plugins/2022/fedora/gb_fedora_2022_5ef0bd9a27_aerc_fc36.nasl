...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822102");
  ...
  script_name("Fedora: Security Advisory for aerc (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4AQB6NBU26JSMRASGYXFMJDXRNPBUJMU");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aerc", rpm:"aerc~0.10.0~5.fc36", rls:"FC36"))) {
    report += res;
  }
