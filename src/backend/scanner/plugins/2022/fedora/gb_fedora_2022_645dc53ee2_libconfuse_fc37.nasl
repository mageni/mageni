...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822446");
  ...
  script_tag(name:"creation_date", value:"2022-09-16 01:19:00 +0000 (Fri, 16 Sep 2022)");
  script_name("Fedora: Security Advisory for libconfuse (FEDORA-2022-645dc53ee2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-645dc53ee2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EDUT2V62V2XF2IT5TJFPB6P3EQ6X5VLL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libconfuse'
  package(s) announced via the FEDORA-2022-645dc53ee2 advisory.");
...
easy to use and quick to integrate with your code.");
  ...
  script_tag(name:"affected", value:"'libconfuse' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libconfuse", rpm:"libconfuse~3.3~7.fc37", rls:"FC37"))) {
    report += res;
  }
