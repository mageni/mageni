...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822727");
  ...
  script_tag(name:"creation_date", value:"2022-11-04 02:18:40 +0000 (Fri, 04 Nov 2022)");
  script_name("Fedora: Security Advisory for drupal7 (FEDORA-2022-bf18450366)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-bf18450366");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SGSY236PYSFYIEBRGDERLA7OSY6D7XL4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7'
  package(s) announced via the FEDORA-2022-bf18450366 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7", rpm:"drupal7~7.92~1.fc35", rls:"FC35"))) {
    report += res;
  }
