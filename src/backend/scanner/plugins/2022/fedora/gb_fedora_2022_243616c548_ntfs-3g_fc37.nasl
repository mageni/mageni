...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823044");
  ...
  script_tag(name:"creation_date", value:"2022-12-23 02:19:10 +0000 (Fri, 23 Dec 2022)");
  script_name("Fedora: Security Advisory for ntfs-3g (FEDORA-2022-243616c548)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-243616c548");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UGDKGXA4R2ZVUQ3CT4D4YGTFMNZQA7HW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g'
  package(s) announced via the FEDORA-2022-243616c548 advisory.");
...
file access right and ownership support.");
  ...
  script_tag(name:"affected", value:"'ntfs-3g' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntfs-3g", rpm:"ntfs-3g~2022.10.3~1.fc37", rls:"FC37"))) {
    report += res;
  }
