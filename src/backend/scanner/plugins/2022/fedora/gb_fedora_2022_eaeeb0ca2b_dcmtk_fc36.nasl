...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822385");
  ...
  script_name("Fedora: Security Advisory for dcmtk (FEDORA-2022-eaeeb0ca2b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2Z7WVDK43MKWOS23BIN4VCQRQRXHGSDB");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dcmtk", rpm:"dcmtk~3.6.7~1.fc36", rls:"FC36"))) {
    report += res;
  }
