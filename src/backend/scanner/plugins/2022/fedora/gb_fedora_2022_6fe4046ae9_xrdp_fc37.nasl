...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823017");
  ...
  script_tag(name:"creation_date", value:"2022-12-21 02:18:19 +0000 (Wed, 21 Dec 2022)");
  script_name("Fedora: Security Advisory for xrdp (FEDORA-2022-6fe4046ae9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-6fe4046ae9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/67CHZVOMSTH2Q7P3TYFUNZUA6J7ZYEBQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xrdp'
  package(s) announced via the FEDORA-2022-6fe4046ae9 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xrdp", rpm:"xrdp~0.9.21~1.fc37", rls:"FC37"))) {
    report += res;
  }
