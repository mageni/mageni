...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821702");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:31:28 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-spf13-cobra (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VJYAI3J7IF6FNF7ZM6HT7EUAQHGJ2H7B");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-spf13-cobra", rpm:"golang-github-spf13-cobra~1.4.0~3.fc35", rls:"FC35"))) {
    report += res;
  }
