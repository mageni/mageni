...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822879");
  ...
  script_tag(name:"creation_date", value:"2022-11-24 02:16:38 +0000 (Thu, 24 Nov 2022)");
  script_name("Fedora: Security Advisory for drupal7-link (FEDORA-2022-e795e17c38)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-e795e17c38");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BGQXNOGDXZ3LNM5K6IXQOUP3AYBY46ST");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-link'
  package(s) announced via the FEDORA-2022-e795e17c38 advisory.");
...
This package provides the following Drupal module:
  ...
  * link");
  ...
  script_tag(name:"affected", value:"'drupal7-link' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-link", rpm:"drupal7-link~1.11~1.fc37", rls:"FC37"))) {
    report += res;
  }
