...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822529");
  ...
  script_name("Fedora: Security Advisory for python3.11 (FEDORA-2022-141f632a6f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-141f632a6f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/76YE7AM37MRU76XJV4M27CWDAMUGNRYK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.11'
  package(s) announced via the FEDORA-2022-141f632a6f advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.11-3.11.0", rpm:"python3.11-3.11.0~rc2~1.fc35", rls:"FC35"))) {
    report += res;
  }
