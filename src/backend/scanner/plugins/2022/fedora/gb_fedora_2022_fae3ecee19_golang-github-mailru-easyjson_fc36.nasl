...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820901");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:31:27 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-mailru-easyjson (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2YG6PKLPC4427ODH7L23EKLHTAI5TPET");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-mailru-easyjson", rpm:"golang-github-mailru-easyjson~0.7.6~5.fc36", rls:"FC36"))) {
    report += res;
  }
