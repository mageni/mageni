...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821510");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:37:08 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-etcd-bbolt (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IQKIZSNDNVOGFWZDLWTLLZJ4HJU3TMUK");
...
The design of Bolt is based on Howard Chu&#39, s LMDB database project.");
  ...
  script_tag(name:"affected", value:"'golang-etcd-bbolt' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-etcd-bbolt", rpm:"golang-etcd-bbolt~1.3.6~4.fc35", rls:"FC35"))) {
    report += res;
  }
