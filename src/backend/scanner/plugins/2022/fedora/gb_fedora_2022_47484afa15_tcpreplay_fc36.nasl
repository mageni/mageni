...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822391");
  ...
  script_tag(name:"creation_date", value:"2022-09-05 01:12:27 +0000 (Mon, 05 Sep 2022)");
  script_name("Fedora: Security Advisory for tcpreplay (FEDORA-2022-47484afa15)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-47484afa15");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5B75AFRJUGOYHCFG2ZV2JKSUPA6MSCT5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay'
  package(s) announced via the FEDORA-2022-47484afa15 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.4.2~1.fc36", rls:"FC36"))) {
    report += res;
  }
