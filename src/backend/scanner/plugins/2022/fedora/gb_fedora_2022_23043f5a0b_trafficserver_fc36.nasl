...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822372");
  ...
  script_tag(name:"creation_date", value:"2022-08-24 01:12:14 +0000 (Wed, 24 Aug 2022)");
  script_name("Fedora: Security Advisory for trafficserver (FEDORA-2022-23043f5a0b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-23043f5a0b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZCSBQBYPOZSWS5LCOAQ6LJLRLXFIAW5A");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trafficserver'
  package(s) announced via the FEDORA-2022-23043f5a0b advisory.");
...
reverse proxies, Apache Traffic Server is battle hardened.");
  ...
  script_tag(name:"affected", value:"'trafficserver' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trafficserver", rpm:"trafficserver~9.1.3~1.fc36", rls:"FC36"))) {
    report += res;
  }
