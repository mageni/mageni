...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821775");
  ...
  script_name("Fedora: Security Advisory for golang-starlark (FEDORA-2022-3e1ade35db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SXIMWJMDD5CCHJ4JFWUC3P77CDL2DJYY");
...
application.");
  ...
  script_tag(name:"affected", value:"'golang-starlark' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-starlark-0", rpm:"golang-starlark-0~0.7.20210113gite81fc95.fc35", rls:"FC35"))) {
    report += res;
  }
