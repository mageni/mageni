...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822917");
  ...
  script_tag(name:"creation_date", value:"2022-11-30 02:13:29 +0000 (Wed, 30 Nov 2022)");
  script_name("Fedora: Security Advisory for heimdal (FEDORA-2022-cbbd105d08)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-cbbd105d08");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JO4RWDGQFTRM7IO2BEJXD7EGLGXJC6LQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'heimdal'
  package(s) announced via the FEDORA-2022-cbbd105d08 advisory.");
...
by default since it is deemed too big a security risk by the packager.");
  ...
  script_tag(name:"affected", value:"'heimdal' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"heimdal", rpm:"heimdal~7.7.1~3.fc35", rls:"FC35"))) {
    report += res;
  }
