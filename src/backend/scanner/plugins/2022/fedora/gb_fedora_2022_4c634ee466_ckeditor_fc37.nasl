...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822843");
  script_version("2022-11-17T05:30:14+0000");
  script_cve_id("CVE-2021-41164", "CVE-2022-24728", "CVE-2022-24729");
  ...
  script_name("Fedora: Security Advisory for ckeditor (FEDORA-2022-4c634ee466)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-4c634ee466");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VR76VBN5GW5QUBJFHVXRX36UZ6YTCMW6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ckeditor'
  package(s) announced via the FEDORA-2022-4c634ee466 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ckeditor", rpm:"ckeditor~4.20.0~1.fc37", rls:"FC37"))) {
    report += res;
  }
