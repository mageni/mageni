...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821778");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:40:23 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for yubihsm-connector (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QTFXBQEOTONDFO7EYRTYX7IILQXKNCOJ");
  ...
  script_tag(name:"affected", value:"'yubihsm-connector' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yubihsm-connector", rpm:"yubihsm-connector~3.0.2~2.fc35", rls:"FC35"))) {
    report += res;
  }
