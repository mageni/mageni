...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822196");
  ...
  script_name("Fedora: Security Advisory for osmo (FEDORA-2022-e31de9e141)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-e31de9e141");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LTWR4QVCBA3OCDWSLZBEHJLEDAGIUFRX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'osmo'
  package(s) announced via the FEDORA-2022-e31de9e141 advisory.");
...
meet user preferences.");
  ...
  script_tag(name:"affected", value:"'osmo' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"osmo", rpm:"osmo~0.4.4~2.fc36", rls:"FC36"))) {
    report += res;
  }
