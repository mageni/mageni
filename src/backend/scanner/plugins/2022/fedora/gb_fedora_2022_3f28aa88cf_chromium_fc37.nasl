...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-3f28aa88cf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T4NMJURTG5RO3TGD7ZMIQ6Z4ZZ3SAVYE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2022-3f28aa88cf advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~105.0.5195.125~2.fc37", rls:"FC37"))) {
    report += res;
  }
