...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822357");
  ...
  script_name("Fedora: Security Advisory for yara (FEDORA-2022-21cf5402fc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WTAPOXSEVWTUPIXWVNJL2BJ4OY4SI4Z4");
...
and a Boolean expression which determine its logic.");
  ...
  script_tag(name:"affected", value:"'yara' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yara", rpm:"yara~4.2.3~1.fc36", rls:"FC36"))) {
    report += res;
  }
