...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819847");
  ...
  script_tag(name:"creation_date", value:"2022-03-23 08:34:55 +0000 (Wed, 23 Mar 2022)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2022-49b52819a4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-49b52819a4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KQJB6ZPRLKV6WCMX2PRRRQBFAOXFBK6B");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2022-49b52819a4 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~99.0.4844.51~1.fc34", rls:"FC34"))) {
    report += res;
  }
