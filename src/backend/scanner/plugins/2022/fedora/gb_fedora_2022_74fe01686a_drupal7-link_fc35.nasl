...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822885");
  ...
  script_name("Fedora: Security Advisory for drupal7-link (FEDORA-2022-74fe01686a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-74fe01686a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CYANFVPAVII5XYHNQ65YQFPISMQBOMYM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-link'
  package(s) announced via the FEDORA-2022-74fe01686a advisory.");
...
This package provides the following Drupal module:
  ...
  * link");
  ...
  script_tag(name:"affected", value:"'drupal7-link' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-link", rpm:"drupal7-link~1.11~1.fc35", rls:"FC35"))) {
    report += res;
  }
