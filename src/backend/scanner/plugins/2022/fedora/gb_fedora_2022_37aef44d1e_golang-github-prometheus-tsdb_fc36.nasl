...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822111");
  ...
  script_name("Fedora: Security Advisory for golang-github-prometheus-tsdb (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GBW2YWPCTR3QTU7MONYCLLUVNUDIMK5E");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-tsdb", rpm:"golang-github-prometheus-tsdb~0.10.0~9.fc36", rls:"FC36"))) {
    report += res;
  }
