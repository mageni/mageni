...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821613");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:19:04 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-x-text (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XC6WQMCLBCP7SEQKCLBEYZL64M7SFA3U");
...
transformations, and locale-specific text handling.");
  ...
  script_tag(name:"affected", value:"'golang-x-text' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-x-text-0.3.7", rpm:"golang-x-text-0.3.7~3.fc35~bootstrap", rls:"FC35"))) {
    report += res;
  }
