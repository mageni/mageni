...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822507");
  ...
  script_name("Fedora: Security Advisory for libconfuse (FEDORA-2022-9b67d67195)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-9b67d67195");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BSAZK4KAWRWNAFUBBXOYU3PVNH3X7226");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libconfuse'
  package(s) announced via the FEDORA-2022-9b67d67195 advisory.");
...
easy to use and quick to integrate with your code.");
  ...
  script_tag(name:"affected", value:"'libconfuse' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libconfuse", rpm:"libconfuse~3.3~7.fc35", rls:"FC35"))) {
    report += res;
  }
