...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821768");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:31:34 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-nats-io-nkeys (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZBB5ZG4TQJQAUTS6E2GTAQISSB5S2EZE");
  ...
  script_tag(name:"affected", value:"'golang-github-nats-io-nkeys' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nats-io-nkeys", rpm:"golang-github-nats-io-nkeys~0.2.0~5.fc35", rls:"FC35"))) {
    report += res;
  }
