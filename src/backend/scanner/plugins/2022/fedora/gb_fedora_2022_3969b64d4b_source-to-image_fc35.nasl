...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821467");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:28:26 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for source-to-image (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/35TZLSITDLUSMJD3VMMEXPJ62CFAOIUU");
...
container images to version your runtime environments.");
  ...
  script_tag(name:"affected", value:"'source-to-image' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"source-to-image", rpm:"source-to-image~1.3.1~4.fc35", rls:"FC35"))) {
    report += res;
  }
