...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820501");
  ...
  script_name("Fedora: Security Advisory for java-1.8.0-openjdk (FEDORA-2022-5a2e1ad72b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LV4SVJOIS4LQ5H3ISREGGFJIGDC2ECII");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.8.0-openjdk", rpm:"java-1.8.0-openjdk~1.8.0.332.b09~1.fc35", rls:"FC35"))) {
    report += res;
  }
