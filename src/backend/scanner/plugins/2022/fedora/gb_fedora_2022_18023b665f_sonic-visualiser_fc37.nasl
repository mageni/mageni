...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822935");
  ...
  script_tag(name:"creation_date", value:"2022-12-04 02:16:53 +0000 (Sun, 04 Dec 2022)");
  script_name("Fedora: Security Advisory for sonic-visualiser (FEDORA-2022-18023b665f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7K6QR6LK5XYRVCRTXB6BIFU2KCPGG77P");
...
analysis plugin format  as well as applying standard audio effects.");
  ...
  script_tag(name:"affected", value:"'sonic-visualiser' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sonic-visualiser", rpm:"sonic-visualiser~4.5~3.fc37", rls:"FC37"))) {
    report += res;
  }
