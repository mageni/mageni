...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822946");
  ...
  script_name("Fedora: Security Advisory for ntfs-3g (FEDORA-2022-14f11bfc73)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-14f11bfc73");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2BOQ7YLFT43KLXEN3EB6CS4DP635RJWP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g'
  package(s) announced via the FEDORA-2022-14f11bfc73 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntfs-3g", rpm:"ntfs-3g~2022.10.3~1.fc35", rls:"FC35"))) {
    report += res;
  }
