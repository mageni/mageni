...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822822");
  ...
  script_tag(name:"creation_date", value:"2022-11-14 02:13:15 +0000 (Mon, 14 Nov 2022)");
  script_name("Fedora: Security Advisory for android-tools (FEDORA-2022-6716cd0da2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-6716cd0da2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M323FGLTHUKLZTBSMG34DOHO3KN5RIHV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'android-tools'
  package(s) announced via the FEDORA-2022-6716cd0da2 advisory.");
...
setup between the host and the target phone as adb.");
  ...
  script_tag(name:"affected", value:"'android-tools' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"android-tools", rpm:"android-tools~33.0.3p1~1.fc37", rls:"FC37"))) {
    report += res;
  }
