...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820311");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 01:09:55 +0000 (Fri, 29 Apr 2022)");
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-5cbd6de569)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/B2ONRYIVXR44YKZVOZUYY66WDQYME7GA");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.6.2~3.fc34", rls:"FC34"))) {
    report += res;
  }
