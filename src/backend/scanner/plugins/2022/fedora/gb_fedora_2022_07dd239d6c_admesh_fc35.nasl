...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822913");
  ...
  script_name("Fedora: Security Advisory for admesh (FEDORA-2022-07dd239d6c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-07dd239d6c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NQZU3OJRXHLVJD2S6SLBNRRAQUMJZYVL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'admesh'
  package(s) announced via the FEDORA-2022-07dd239d6c advisory.");
...
AutoCAD DXF, Geomview OFF, STL, or VRML format.");
  ...
  script_tag(name:"affected", value:"'admesh' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"admesh", rpm:"admesh~0.98.5~1.fc35", rls:"FC35"))) {
    report += res;
  }
