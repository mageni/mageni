...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821517");
  ...
  script_tag(name:"creation_date", value:"2022-07-14 01:14:49 +0000 (Thu, 14 Jul 2022)");
  script_name("Fedora: Security Advisory for osbuild-composer (FEDORA-2022-ba365d3703)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6RYUSRA6JT2T7XJAXBT57SGOQ4HS6O6I");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"osbuild-composer", rpm:"osbuild-composer~55~2.fc36", rls:"FC36"))) {
    report += res;
  }
