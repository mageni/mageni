...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821442");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:36:36 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-mailru-easyjson (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FXIN7H4RTN2FTTQ4OMY4CRLJRZMWW3FJ");
...
enabling omitempty behavior by default.");
  ...
  script_tag(name:"affected", value:"'golang-github-mailru-easyjson' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-mailru-easyjson", rpm:"golang-github-mailru-easyjson~0.7.6~5.fc35", rls:"FC35"))) {
    report += res;
  }
