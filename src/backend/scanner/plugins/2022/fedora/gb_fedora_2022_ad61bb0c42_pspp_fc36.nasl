...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822458");
  ...
  script_tag(name:"creation_date", value:"2022-09-16 01:18:58 +0000 (Fri, 16 Sep 2022)");
  script_name("Fedora: Security Advisory for pspp (FEDORA-2022-ad61bb0c42)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-ad61bb0c42");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OECANCPD4WSSBJLSC3EE472M5DXRTIS4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pspp'
  package(s) announced via the FEDORA-2022-ad61bb0c42 advisory.");
...
support is currently limited, but growing.");
  ...
  script_tag(name:"affected", value:"'pspp' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pspp", rpm:"pspp~1.6.2~4.fc36", rls:"FC36"))) {
    report += res;
  }
