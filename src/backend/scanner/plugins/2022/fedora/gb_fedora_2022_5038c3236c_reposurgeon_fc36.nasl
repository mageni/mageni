...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822271");
  ...
  script_name("Fedora: Security Advisory for reposurgeon (FEDORA-2022-5038c3236c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EJQBZP2EB42UY3MIQVTGSGP4H2YTJEOQ");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"reposurgeon", rpm:"reposurgeon~4.32~3.fc36", rls:"FC36"))) {
    report += res;
  }
