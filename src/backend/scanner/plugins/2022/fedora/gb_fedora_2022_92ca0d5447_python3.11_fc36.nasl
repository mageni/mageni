...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822726");
  ...
  script_tag(name:"creation_date", value:"2022-11-04 02:18:39 +0000 (Fri, 04 Nov 2022)");
  script_name("Fedora: Security Advisory for python3.11 (FEDORA-2022-92ca0d5447)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-92ca0d5447");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4NNGUQPLF3WELGZWJKDYHHJBPGZZLNXO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.11'
  package(s) announced via the FEDORA-2022-92ca0d5447 advisory.");
...
the 'python3.11-' prefix.");
  ...
  script_tag(name:"affected", value:"'python3.11' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.11", rpm:"python3.11~3.11.0~1.fc36", rls:"FC36"))) {
    report += res;
  }
