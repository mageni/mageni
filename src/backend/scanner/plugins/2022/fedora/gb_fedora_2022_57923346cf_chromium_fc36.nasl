...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820191");
  ...
  script_name("Fedora: Security Advisory for chromium (FEDORA-2022-57923346cf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-57923346cf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MRWRAXAFR3JR7XCFWTHC2KALSZKWACCE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2022-57923346cf advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~99.0.4844.51~1.fc36", rls:"FC36"))) {
    report += res;
  }
