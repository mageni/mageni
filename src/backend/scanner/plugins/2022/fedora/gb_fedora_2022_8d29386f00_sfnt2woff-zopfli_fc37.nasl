...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822973");
  ...
  script_tag(name:"creation_date", value:"2022-12-09 02:12:15 +0000 (Fri, 09 Dec 2022)");
  script_name("Fedora: Security Advisory for sfnt2woff-zopfli (FEDORA-2022-8d29386f00)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-8d29386f00");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MSYSRRVSZTIIZUZHYRZUDRH4KFENWYIY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sfnt2woff-zopfli'
  package(s) announced via the FEDORA-2022-8d29386f00 advisory.");
...
A corresponding version of the woff2sfnt utility is also provided.");
  ...
  script_tag(name:"affected", value:"'sfnt2woff-zopfli' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sfnt2woff-zopfli", rpm:"sfnt2woff-zopfli~1.3.1~3.fc37", rls:"FC37"))) {
    report += res;
  }
