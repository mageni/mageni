...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821798");
  ...
  script_tag(name:"creation_date", value:"2022-07-14 01:15:30 +0000 (Thu, 14 Jul 2022)");
  script_name("Fedora: Security Advisory for buildah (FEDORA-2022-ba365d3703)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VFVK34BIRQO4QCWMRG7EEWEDD6VFNOXX");
...
or
  ...
  * delete a working container or an image");
  ...
  script_tag(name:"affected", value:"'buildah' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.26.1~4.fc36", rls:"FC36"))) {
    report += res;
  }
