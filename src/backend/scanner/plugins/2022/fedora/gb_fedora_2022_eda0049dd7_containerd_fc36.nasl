...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820644");
  ...
  script_tag(name:"creation_date", value:"2022-05-08 01:10:48 +0000 (Sun, 08 May 2022)");
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-eda0049dd7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-eda0049dd7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HIMAHZ6AUIKN7AX26KHZYBXVECIOVWBH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd'
  package(s) announced via the FEDORA-2022-eda0049dd7 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.6.2~1.fc36", rls:"FC36"))) {
    report += res;
  }
