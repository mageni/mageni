...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-37c2d26f59");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RUA2JM6YT3ZXSZLBJVRA32AXYM3GJMO3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-pear-CAS'
  package(s) announced via the FEDORA-2022-37c2d26f59 advisory.");
...
Autoloader: %{pear_phpdir}/CAS/Autoload.php");
  ...
  script_tag(name:"affected", value:"'php-pear-CAS' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-pear-CAS", rpm:"php-pear-CAS~1.6.0~1.fc36", rls:"FC36"))) {
    report += res;
  }
