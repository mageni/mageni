...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821057");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:45:07 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-theupdateframework-notary (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AWI5LOYYGY2HABKUWSBK6Z3CMQTKT5PW");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-theupdateframework-notary", rpm:"golang-github-theupdateframework-notary~0.7.0~6.fc36", rls:"FC36"))) {
    report += res;
  }
