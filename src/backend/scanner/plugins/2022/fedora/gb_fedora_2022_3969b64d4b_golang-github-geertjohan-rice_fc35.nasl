...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821644");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:26:58 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-geertjohan-rice (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JIRUUO7PSD5EHW44HM6OBWBYFWQNTSHR");
...
html, js, css, images, templates, etc very easy.");
  ...
  script_tag(name:"affected", value:"'golang-github-geertjohan-rice' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-geertjohan-rice", rpm:"golang-github-geertjohan-rice~1.0.2~5.fc35", rls:"FC35"))) {
    report += res;
  }
