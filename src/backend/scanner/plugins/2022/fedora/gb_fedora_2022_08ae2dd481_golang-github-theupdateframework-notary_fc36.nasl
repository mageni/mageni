...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820637");
  ...
  script_tag(name:"creation_date", value:"2022-05-08 01:10:42 +0000 (Sun, 08 May 2022)");
  script_name("Fedora: Security Advisory for golang-github-theupdateframework-notary (FEDORA-2022-08ae2dd481)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UR7NO4VK7X2WPV7ANLEW5NPAOGRAVY3G");
...
content.");
  ...
  script_tag(name:"affected", value:"'golang-github-theupdateframework-notary' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-theupdateframework-notary", rpm:"golang-github-theupdateframework-notary~0.7.0~4.fc36", rls:"FC36"))) {
    report += res;
  }
