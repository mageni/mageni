...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822068");
  ...
  script_name("Fedora: Security Advisory for golang-starlark (FEDORA-2022-5038c3236c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J6AQ6KQAG3IFNCHCWGCV6OVJR5KDERNM");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-starlark-0", rpm:"golang-starlark-0~0.8.20210113gite81fc95.fc36", rls:"FC36"))) {
    report += res;
  }
