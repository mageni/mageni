...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821736");
  ...
  script_name("Fedora: Security Advisory for grafana-pcp (FEDORA-2022-3e1ade35db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XOYHJLZNOX3SN7SO577SWFDQ5Y5YP3T4");
...
bpftrace scripts from pmdabpftrace(1), as well as several dashboards.");
  ...
  script_tag(name:"affected", value:"'grafana-pcp' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grafana-pcp", rpm:"grafana-pcp~3.2.0~2.fc35", rls:"FC35"))) {
    report += res;
  }
