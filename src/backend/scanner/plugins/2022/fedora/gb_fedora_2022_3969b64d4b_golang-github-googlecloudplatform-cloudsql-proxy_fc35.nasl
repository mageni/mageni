...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821606");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:37:03 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-googlecloudplatform-cloudsql-proxy (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P2RYTZMPKW3J4J3W27VX2OXRWGCL5BEQ");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-googlecloudplatform-cloudsql-proxy", rpm:"golang-github-googlecloudplatform-cloudsql-proxy~1.19.1~6.fc35", rls:"FC35"))) {
    report += res;
  }
