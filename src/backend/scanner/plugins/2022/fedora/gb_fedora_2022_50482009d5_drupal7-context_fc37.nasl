...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822898");
  ...
  script_name("Fedora: Security Advisory for drupal7-context (FEDORA-2022-50482009d5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-50482009d5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/I2HZOOBNIWQDCT4X52HC3GYUVBZU2H3X");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-context'
  package(s) announced via the FEDORA-2022-50482009d5 advisory.");
...
This package provides the following Drupal modules:
  ...
  * context_ui");
  ...
  script_tag(name:"affected", value:"'drupal7-context' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-context", rpm:"drupal7-context~3.11~1.fc37", rls:"FC37"))) {
    report += res;
  }
