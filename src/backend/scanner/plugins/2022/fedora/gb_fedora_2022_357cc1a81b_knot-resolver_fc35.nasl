...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822603");
  ...
  script_tag(name:"creation_date", value:"2022-10-02 01:13:15 +0000 (Sun, 02 Oct 2022)");
  script_name("Fedora: Security Advisory for knot-resolver (FEDORA-2022-357cc1a81b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-357cc1a81b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HIMDNIUI7GTUEKIBBYYW7OCTJQFPDNXL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'knot-resolver'
  package(s) announced via the FEDORA-2022-357cc1a81b advisory.");
...
$ systemctl start kresd(a)1.service");
  ...
  script_tag(name:"affected", value:"'knot-resolver' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"knot-resolver", rpm:"knot-resolver~5.5.3~1.fc35", rls:"FC35"))) {
    report += res;
  }
