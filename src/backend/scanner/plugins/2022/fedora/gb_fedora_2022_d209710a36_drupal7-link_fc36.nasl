...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822896");
  ...
  script_name("Fedora: Security Advisory for drupal7-link (FEDORA-2022-d209710a36)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-d209710a36");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4M76GD3OJICLWHTRSC4U5HLBFG6KJO7T");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-link'
  package(s) announced via the FEDORA-2022-d209710a36 advisory.");
...
This package provides the following Drupal module:
  ...
  * link");
  ...
  script_tag(name:"affected", value:"'drupal7-link' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-link", rpm:"drupal7-link~1.11~1.fc36", rls:"FC36"))) {
    report += res;
  }
