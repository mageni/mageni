...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-6807c29d58");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OVSX2UDQTJOXOTK6OI6PSV2XYKWDIWPM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-x11-server'
  package(s) announced via the FEDORA-2022-6807c29d58 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server", rpm:"xorg-x11-server~1.20.14~7.fc36", rls:"FC36"))) {
    report += res;
  }
