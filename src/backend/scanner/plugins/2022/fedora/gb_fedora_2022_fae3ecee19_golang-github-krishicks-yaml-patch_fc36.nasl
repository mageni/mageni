...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820941");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:27:19 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-krishicks-yaml-patch (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/APW7SDXJNC7OG4FDTYDVECQEMHR6JIAP");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-krishicks-yaml-patch", rpm:"golang-github-krishicks-yaml-patch~0.0.10~8.20200307git05b3177.fc36", rls:"FC36"))) {
    report += res;
  }
