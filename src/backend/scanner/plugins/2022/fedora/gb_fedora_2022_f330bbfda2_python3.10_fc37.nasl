...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822455");
  ...
  script_name("Fedora: Security Advisory for python3.10 (FEDORA-2022-f330bbfda2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-f330bbfda2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6XL6E5A3I36TRR73VNBOXNIQP4AMZDFZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.10'
  package(s) announced via the FEDORA-2022-f330bbfda2 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.10", rpm:"python3.10~3.10.7~1.fc37", rls:"FC37"))) {
    report += res;
  }
