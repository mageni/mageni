...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821566");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:35:47 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for aerc (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YLFJLMNVYWV7PFCFRSWGCJ5KAI4A5BIJ");
...
efficient and extensible, perfect for the discerning hacker.");
  ...
  script_tag(name:"affected", value:"'aerc' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aerc", rpm:"aerc~0.10.0~4.fc35", rls:"FC35"))) {
    report += res;
  }
