...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-cb92b4ea21");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VCTYD5EQRS73QZTWPOC2ZO2FL7MMYXMS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the FEDORA-2022-cb92b4ea21 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"samba", rpm:"samba~4.17.4~0.fc37", rls:"FC37"))) {
    report += res;
  }
