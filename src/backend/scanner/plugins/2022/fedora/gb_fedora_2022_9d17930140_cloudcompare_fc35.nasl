...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822435");
  ...
  script_tag(name:"creation_date", value:"2022-09-11 01:11:36 +0000 (Sun, 11 Sep 2022)");
  script_name("Fedora: Security Advisory for cloudcompare (FEDORA-2022-9d17930140)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-9d17930140");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5BUOTYU3KKIYE4BEBUFA4MRS462P3OWM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cloudcompare'
  package(s) announced via the FEDORA-2022-9d17930140 advisory.");
...
management, interactive or automatic segmentation, display enhancement...).");
  ...
  script_tag(name:"affected", value:"'cloudcompare' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cloudcompare", rpm:"cloudcompare~2.9.1~16.fc35", rls:"FC35"))) {
    report += res;
  }
