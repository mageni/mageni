...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819566");
  ...
  script_tag(name:"creation_date", value:"2022-01-24 02:05:50 +0000 (Mon, 24 Jan 2022)");
  script_name("Fedora: Security Advisory for guacamole-server (FEDORA-2022-cc680f9f82)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-cc680f9f82");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P3X6KYVDMURCDFATPNFFLFQ4TBMRSXU5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'guacamole-server'
  package(s) announced via the FEDORA-2022-cc680f9f82 advisory.");
...
The main web application is provided by the 'guacamole-client' package.");
  ...
  script_tag(name:"affected", value:"'guacamole-server' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"guacamole-server", rpm:"guacamole-server~1.4.0~1.fc35", rls:"FC35"))) {
    report += res;
  }
