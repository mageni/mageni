...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821623");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:21:31 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for exercism (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4J6IQ3PYDLZITA6RZP44A7FDU2VMKIXB");
...
Python or Ruby environment simply to fetch and submit exercises.");
  ...
  script_tag(name:"affected", value:"'exercism' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"exercism", rpm:"exercism~3.0.13~8.fc35", rls:"FC35"))) {
    report += res;
  }
