...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821823");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:39:03 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-gohugoio-testmodbuilder (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YL7UAHOZPLRPUDDX5HSWKXKHOH4J4GR5");
  ...
  script_tag(name:"affected", value:"'golang-github-gohugoio-testmodbuilder' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-gohugoio-testmodbuilder-0", rpm:"golang-github-gohugoio-testmodbuilder-0~0.10.20201030git72e1e0c.fc35", rls:"FC35"))) {
    report += res;
  }
