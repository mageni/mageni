...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822089");
  ...
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VTTX5TXGXQS7CMIIIHKRREQX4I567SVG");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.6.6~5.fc36", rls:"FC36"))) {
    report += res;
  }
