...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823032");
  ...
  script_tag(name:"creation_date", value:"2022-12-18 02:11:44 +0000 (Sun, 18 Dec 2022)");
  script_name("Fedora: Security Advisory for python3.11 (FEDORA-2022-6ba889e0e3)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-6ba889e0e3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/B3YI6JYARWU6GULWOHNUROSACT54XFFS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.11'
  package(s) announced via the FEDORA-2022-6ba889e0e3 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.11", rpm:"python3.11~3.11.1~1.fc36", rls:"FC36"))) {
    report += res;
  }
