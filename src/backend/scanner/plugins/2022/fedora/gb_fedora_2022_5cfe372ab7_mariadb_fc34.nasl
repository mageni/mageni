...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820491");
  ...
  script_tag(name:"creation_date", value:"2022-05-09 01:05:56 +0000 (Mon, 09 May 2022)");
  script_name("Fedora: Security Advisory for mariadb (FEDORA-2022-5cfe372ab7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-5cfe372ab7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EZFZVMJL5UDTOZMARLXQIMG3BTG6UNYW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb'
  package(s) announced via the FEDORA-2022-5cfe372ab7 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb", rpm:"mariadb~10.5.15~1.fc34", rls:"FC34"))) {
    report += res;
  }
