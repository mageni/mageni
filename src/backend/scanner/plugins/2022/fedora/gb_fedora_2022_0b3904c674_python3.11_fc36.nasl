...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822537");
  ...
  script_name("Fedora: Security Advisory for python3.11 (FEDORA-2022-0b3904c674)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-0b3904c674");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PD7FTLJOIGMUSCDR3JAN6WRFHJEE4PH5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.11'
  package(s) announced via the FEDORA-2022-0b3904c674 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.11-3.11.0", rpm:"python3.11-3.11.0~rc2~1.fc36", rls:"FC36"))) {
    report += res;
  }
