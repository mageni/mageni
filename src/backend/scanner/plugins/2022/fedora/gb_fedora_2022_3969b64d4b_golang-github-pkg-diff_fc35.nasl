...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821681");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:35:35 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-pkg-diff (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QJ6T3Y3UVUONZNGFE7AWZ3C2ZHEYIJY4");
...
The subpackages provide very fine-grained control over every aspect:
  ...
  script_tag(name:"affected", value:"'golang-github-pkg-diff' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-pkg-diff-0", rpm:"golang-github-pkg-diff-0~0.4.20210406git20ebb0f.fc35", rls:"FC35"))) {
    report += res;
  }
