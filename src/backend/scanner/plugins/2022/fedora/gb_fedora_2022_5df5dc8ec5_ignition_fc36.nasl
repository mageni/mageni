...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820672");
  ...
  script_tag(name:"creation_date", value:"2022-05-27 01:07:55 +0000 (Fri, 27 May 2022)");
  script_name("Fedora: Security Advisory for ignition (FEDORA-2022-5df5dc8ec5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-5df5dc8ec5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T5QQXRGQKTN4YX2ZF3GQNEBDEOKJGCN3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ignition'
  package(s) announced via the FEDORA-2022-5df5dc8ec5 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ignition", rpm:"ignition~2.14.0~1.fc36", rls:"FC36"))) {
    report += res;
  }
