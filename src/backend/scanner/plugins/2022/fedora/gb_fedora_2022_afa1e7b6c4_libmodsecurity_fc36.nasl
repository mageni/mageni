...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822696");
  ...
  script_tag(name:"creation_date", value:"2022-10-25 01:23:45 +0000 (Tue, 25 Oct 2022)");
  script_name("Fedora: Security Advisory for libmodsecurity (FEDORA-2022-afa1e7b6c4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-afa1e7b6c4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6MS5GMNYHFFIBWLJW7N3XAD24SLF3PFZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmodsecurity'
  package(s) announced via the FEDORA-2022-afa1e7b6c4 advisory.");
...
by your application via Connectors.");
  ...
  script_tag(name:"affected", value:"'libmodsecurity' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmodsecurity", rpm:"libmodsecurity~3.0.8~1.fc36", rls:"FC36"))) {
    report += res;
  }
