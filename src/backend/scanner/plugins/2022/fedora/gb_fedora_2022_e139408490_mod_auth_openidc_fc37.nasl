...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-e139408490");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MOA67H3SS5ZRPS5SX4RJN6XE5CLFBWHB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mod_auth_openidc'
  package(s) announced via the FEDORA-2022-e139408490 advisory.");
...
an OpenID Connect Relying Party and/or OAuth 2.0 Resource Server.");
  ...
  script_tag(name:"affected", value:"'mod_auth_openidc' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mod_auth_openidc", rpm:"mod_auth_openidc~2.4.12.2~1.fc37", rls:"FC37"))) {
    report += res;
  }
