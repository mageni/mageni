...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822024");
  ...
  script_name("Fedora: Security Advisory for golang-github-geertjohan-rice (FEDORA-2022-ea8f4e232d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/E5TOS3KFVS72ZBR2R2QHQPMEGYBIGWX5");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-geertjohan-rice", rpm:"golang-github-geertjohan-rice~1.0.2~6.fc36", rls:"FC36"))) {
    report += res;
  }
