...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820954");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:29:24 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-geertjohan-rice (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZU2SEWSBUGTEY54OJGIHDECFR2KRLLRW");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-geertjohan-rice", rpm:"golang-github-geertjohan-rice~1.0.2~5.fc36", rls:"FC36"))) {
    report += res;
  }
