...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821693");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:40:27 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FILVVF46DRP2LLLDTHGZHMUKOZWHNAQP");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~20.10.17~4.fc35", rls:"FC35"))) {
    report += res;
  }
