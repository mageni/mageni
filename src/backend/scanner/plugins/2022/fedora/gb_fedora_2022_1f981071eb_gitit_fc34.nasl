...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820206");
  ...
  script_tag(name:"creation_date", value:"2022-04-03 01:05:05 +0000 (Sun, 03 Apr 2022)");
  script_name("Fedora: Security Advisory for gitit (FEDORA-2022-1f981071eb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/K3DIQQTOUTS5FGTGCSTHU4ZVI6A2O27J");
...
any happstack application");
  ...
  script_tag(name:"affected", value:"'gitit' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gitit", rpm:"gitit~0.13.0.0~5.1.fc34", rls:"FC34"))) {
    report += res;
  }
