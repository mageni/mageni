...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822775");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2022-3094c02073)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-3094c02073");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PMVY6ASUTNAHCJRPXPYKHYJ3IO3EOQGP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2022-3094c02073 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.14~3.fc37", rls:"FC37"))) {
    report += res;
  }
