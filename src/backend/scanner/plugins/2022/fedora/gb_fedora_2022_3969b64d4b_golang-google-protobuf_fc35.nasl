...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821809");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:31:14 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-google-protobuf (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VX3BHOPWFHPSRWIRVTEIIV76RIB3D4Q6");
  ...
  script_tag(name:"affected", value:"'golang-google-protobuf' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-google-protobuf", rpm:"golang-google-protobuf~1.27.1~3.fc35", rls:"FC35"))) {
    report += res;
  }
