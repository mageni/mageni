...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820300");
  ...
  script_tag(name:"creation_date", value:"2022-04-25 01:04:42 +0000 (Mon, 25 Apr 2022)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2022-0816754490)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QIOQN7JJNN6ABIDGRSTVZA65MHRLMH2Q");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.17.4~100.fc34", rls:"FC34"))) {
    report += res;
  }
