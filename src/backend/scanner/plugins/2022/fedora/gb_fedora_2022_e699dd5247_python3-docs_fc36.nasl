...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823079");
  ...
  script_name("Fedora: Security Advisory for python3-docs (FEDORA-2022-e699dd5247)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J5KVMWNQ4JVGE574WWT46C2YKTB7ZJLE");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-docs", rpm:"python3-docs~3.10.9~1.fc36", rls:"FC36"))) {
    report += res;
  }
