...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821534");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:20:30 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-nicksnyder-i18n-2 (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LSXJ6IE5PAENBBXPRJ5JST7JNAV5FFGT");
...
multiple languages.
  ...
  script_tag(name:"affected", value:"'golang-github-nicksnyder-i18n-2' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nicksnyder-i18n-2", rpm:"golang-github-nicksnyder-i18n-2~2.1.2~5.fc35", rls:"FC35"))) {
    report += res;
  }
