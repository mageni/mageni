...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820884");
  ...
  script_tag(name:"creation_date", value:"2022-07-02 01:10:25 +0000 (Sat, 02 Jul 2022)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2022-bcb096166f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-bcb096166f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/X4N3DFVRD7RJIYUG7QMEERMFP5Z2CCYG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2022-bcb096166f advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~102.0.5005.115~1.fc35", rls:"FC35"))) {
    report += res;
  }
