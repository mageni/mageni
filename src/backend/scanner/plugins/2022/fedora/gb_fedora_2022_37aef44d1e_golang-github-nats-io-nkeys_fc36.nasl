...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822017");
  ...
  script_name("Fedora: Security Advisory for golang-github-nats-io-nkeys (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XUUGKFLAGVOBCWG6AZMWLOVGNMY7NBB7");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nats-io-nkeys", rpm:"golang-github-nats-io-nkeys~0.2.0~6.fc36", rls:"FC36"))) {
    report += res;
  }
