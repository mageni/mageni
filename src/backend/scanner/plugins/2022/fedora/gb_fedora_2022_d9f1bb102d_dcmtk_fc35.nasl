...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822388");
  ...
  script_name("Fedora: Security Advisory for dcmtk (FEDORA-2022-d9f1bb102d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2D7J3X4S474DU75J37M6W4KJ446FGAUS");
...
Install DCMTK if you are working with DICOM format medical image files.");
  ...
  script_tag(name:"affected", value:"'dcmtk' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dcmtk", rpm:"dcmtk~3.6.7~1.fc35", rls:"FC35"))) {
    report += res;
  }
