...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821827");
  ...
  script_tag(name:"creation_date", value:"2022-07-14 01:13:51 +0000 (Thu, 14 Jul 2022)");
  script_name("Fedora: Security Advisory for ignition (FEDORA-2022-ba365d3703)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7OFBEEZSF2H6JMZCEMESZLNEZWUFXS4V");
...
the configuration.");
  ...
  script_tag(name:"affected", value:"'ignition' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ignition", rpm:"ignition~2.14.0~2.fc36", rls:"FC36"))) {
    report += res;
  }
