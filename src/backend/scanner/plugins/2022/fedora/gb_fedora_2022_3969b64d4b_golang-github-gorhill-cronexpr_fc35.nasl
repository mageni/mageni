...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821815");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:22:19 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-gorhill-cronexpr (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/C57PLTP4BAMFNBOS6FN4LZKGGTPTAC2X");
...
in a number of implementations out there.");
  ...
  script_tag(name:"affected", value:"'golang-github-gorhill-cronexpr' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-gorhill-cronexpr", rpm:"golang-github-gorhill-cronexpr~1.0.0~4.fc35", rls:"FC35"))) {
    report += res;
  }
