...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821549");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:37:30 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for caddy (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LS36YGQNU52VMQ455JHLKYMOM7XEYT3N");
  ...
  script_tag(name:"affected", value:"'caddy' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"caddy", rpm:"caddy~2.3.0~3.fc35", rls:"FC35"))) {
    report += res;
  }
