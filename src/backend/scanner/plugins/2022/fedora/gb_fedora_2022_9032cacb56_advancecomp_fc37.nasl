...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822940");
  ...
  script_tag(name:"creation_date", value:"2022-12-04 02:17:04 +0000 (Sun, 04 Dec 2022)");
  script_name("Fedora: Security Advisory for advancecomp (FEDORA-2022-9032cacb56)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-9032cacb56");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KQHLMLFHPV5C7PTBZML6U72QT6VNEOEF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'advancecomp'
  package(s) announced via the FEDORA-2022-9032cacb56 advisory.");
...
This package contains:
  ...
  script_tag(name:"affected", value:"'advancecomp' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"advancecomp", rpm:"advancecomp~2.4~1.fc37", rls:"FC37"))) {
    report += res;
  }
