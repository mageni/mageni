...
if(description)
{
  ...
  script_name("Zoom Client 5.7.3 < 5.11.5 Privilege Escalation Vulnerability (ZSB-22018) - Mac OS X");
  ...
  script_tag(name:"solution", value:"Update to version 5.11.5 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.7.3", test_version_up: "5.11.5")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.11.5", install_path: location);
