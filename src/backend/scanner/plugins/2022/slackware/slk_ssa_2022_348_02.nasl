...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2022.348.02");
  ...
  script_name("Slackware: Security Advisory (SSA:2022-348-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2022-348-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2022&m=slackware-security.389963");
  ...
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/thunderbird/102.6.0/releasenotes/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-thunderbird' package(s) announced via the SSA:2022-348-02 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.6.0-i686-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.6.0-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.6.0-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.6.0-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
