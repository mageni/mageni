...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2022.264.01");
  script_cve_id("CVE-2022-2795", "CVE-2022-3080", "CVE-2022-38177", "CVE-2022-38178");
  script_tag(name:"creation_date", value:"2022-09-22 04:45:43 +0000 (Thu, 22 Sep 2022)");
  ...
  script_name("Slackware: Security Advisory (SSA:2022-264-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2022-264-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2022&m=slackware-security.395002");
  script_xref(name:"URL", value:"https://kb.isc.org/docs/cve-2022-2795");
  script_xref(name:"URL", value:"https://kb.isc.org/docs/cve-2022-3080");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the SSA:2022-264-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.16.33-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.16.33-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.18.7-i586-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.18.7-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
