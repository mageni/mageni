...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2021.362.01");
  script_cve_id("CVE-2019-16275", "CVE-2020-12695", "CVE-2021-0326", "CVE-2021-0535", "CVE-2021-27803", "CVE-2021-30004");
  ...
  script_name("Slackware: Security Advisory (SSA:2021-362-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2021-362-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2021&m=slackware-security.501086");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wpa_supplicant' package(s) announced via the SSA:2021-362-01 advisory.");
...
if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.9-i486-1_slack14.0", rls:"SLK14.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.9-x86_64-1_slack14.0", rls:"SLK14.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.9-i486-1_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.9-x86_64-1_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.9-i586-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.9-x86_64-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
