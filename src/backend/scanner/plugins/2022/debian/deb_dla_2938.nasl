...
if(description)
{
  ...
  script_version("2022-03-09T02:00:04+0000");
  ...
  script_name("Debian LTS: Security Advisory for twisted (DLA-2938-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/03/msg00009.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2938-1");
  ...
  package(s) announced via the DLA-2938-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an issue in the Twisted Python
...
if(!isnull(res = isdpkgvuln(pkg:"python-twisted-conch", ver:"16.6.0-2+deb9u2", rls:"DEB9"))) {
  report += res;
}
