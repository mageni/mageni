...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for isc-dhcp (DLA-3146-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00015.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3146-1");
  script_xref(name:"Advisory-ID", value:"DLA-3146-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1021320");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'isc-dhcp'
  package(s) announced via the DLA-3146-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities have been discovered in the ISC DHCP client,
relay and server.

CVE-2022-2928

It was discovered that the DHCP server does not correctly perform
option reference counting when configured with 'allow leasequery<semicolon>'.
