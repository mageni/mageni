...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for flac (DLA-3094-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00003.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3094-1");
  ...
  package(s) announced via the DLA-3094-1 advisory.");
