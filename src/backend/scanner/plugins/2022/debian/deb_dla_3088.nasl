...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for net-snmp (DLA-3088-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/08/msg00020.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3088-1");
  ...
  package(s) announced via the DLA-3088-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Yu Zhang and Nanyu Zhong discovered several vulnerabilities in net-snmp, a
