...
if(description)
{
  ...
  script_version("2022-08-18T01:00:05+0000");
  script_cve_id("CVE-2022-32792", "CVE-2022-32816");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-08-18 01:00:05 +0000 (Thu, 18 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-18 01:00:05 +0000 (Thu, 18 Aug 2022)");
  script_name("Debian: Security Advisory for wpewebkit (DSA-5211-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5211.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5211-1");
  script_xref(name:"Advisory-ID", value:"DSA-5211-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wpewebkit'
  package(s) announced via the DSA-5211-1 advisory.");
