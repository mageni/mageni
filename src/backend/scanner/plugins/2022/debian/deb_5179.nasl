...
if(description)
{
  ...
  script_version("2022-07-12T01:00:07+0000");
  script_cve_id("CVE-2022-31625", "CVE-2022-31626");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2022-07-12 01:00:07 +0000 (Tue, 12 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-12 01:00:07 +0000 (Tue, 12 Jul 2022)");
  script_name("Debian: Security Advisory for php7.4 (DSA-5179-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5179.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5179-1");
  ...
  package(s) announced via the DSA-5179-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Charles Fol discovered two security issues in PHP, a widely-used open
