...
if(description)
{
  ...
  script_version("2022-02-22T02:00:06+0000");
  ...
  script_name("Debian: Security Advisory for wpewebkit (DSA-5084-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5084.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5084-1");
  ...
  package(s) announced via the DSA-5084-1 advisory.");
