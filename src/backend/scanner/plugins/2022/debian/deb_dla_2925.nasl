...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for drupal7 (DLA-2925-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/02/msg00019.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2925-1");
  script_xref(name:"Advisory-ID", value:"DLA-2925-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7'
  package(s) announced via the DLA-2925-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This security updates includes two fixes, backported respectively from
...
'undefined' value in options

- Fix improper input validation in Drupal's form API");

  script_tag(name:"affected", value:"'drupal7' package(s) on Debian Linux.");

  script_tag(name:"solution", value:"For Debian 9 stretch, this problem has been fixed in version 7.52-2+deb9u18.
