...
if(description)
{
  ...
  script_version("2022-11-15T08:41:51+0000");
  script_cve_id("CVE-2019-16167", "CVE-2019-19725", "CVE-2022-39377");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2022-11-15 08:41:51 +0000 (Tue, 15 Nov 2022)");
  ...
  script_name("Debian LTS: Security Advisory for sysstat (DLA-3188-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3188-1");
  script_xref(name:"Advisory-ID", value:"DLA-3188-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/939914");
  script_xref(name:"URL", value:"https://bugs.debian.org/946657");
  script_xref(name:"URL", value:"https://bugs.debian.org/1023832");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sysstat'
  package(s) announced via the DLA-3188-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"There were a couple of security issues found in sysstat, system
...
activities. This issue may lead to Remote Code Execution (RCE).");
  ...
  script_tag(name:"affected", value:"'sysstat' package(s) on Debian Linux.");
