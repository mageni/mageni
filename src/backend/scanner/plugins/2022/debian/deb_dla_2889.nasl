...
if(description)
{
  ...
  script_version("2022-01-21T08:08:59+0000");
  ...
  script_name("Debian LTS: Security Advisory for drupal7 (DLA-2889-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2889-1");
  ...
  package(s) announced via the DLA-2889-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The Drupal project includes a very old version of jQuery. Security
