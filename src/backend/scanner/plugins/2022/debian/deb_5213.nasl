...
if(description)
{
  ...
  script_name("Debian: Security Advisory for schroot (DSA-5213-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5213.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5213-1");
  ...
  package(s) announced via the DSA-5213-1 advisory.");
