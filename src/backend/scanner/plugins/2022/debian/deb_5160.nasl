...
if(description)
{
  ...
  script_name("Debian: Security Advisory for ntfs-3g (DSA-5160-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5160.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5160-1");
  script_xref(name:"Advisory-ID", value:"DSA-5160-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g'
  package(s) announced via the DSA-5160-1 advisory.");
