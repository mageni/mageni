...
if(description)
{
  ...
  script_name("Debian: Security Advisory for poppler (DSA-5224-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5224.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5224-1");
  script_xref(name:"Advisory-ID", value:"DSA-5224-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'poppler'
  package(s) announced via the DSA-5224-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities were discovered in poppler, a PDF rendering library,
