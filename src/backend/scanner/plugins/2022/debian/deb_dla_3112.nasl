...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for bzip2 (DLA-3112-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3112-1");
  script_xref(name:"Advisory-ID", value:"DLA-3112-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/944557");
  script_xref(name:"URL", value:"https://bugs.debian.org/965309");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bzip2'
  package(s) announced via the DLA-3112-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update fixes bzdiff when using it with two compressed files. It also
includes a fix to support large files on 32 bit systems.");
