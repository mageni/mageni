...
if(description)
{
  ...
  script_version("2022-05-14T01:00:09+0000");
  ...
  script_name("Debian LTS: Security Advisory for ruby-nokogiri (DLA-3003-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00013.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3003-1");
  script_xref(name:"Advisory-ID", value:"DLA-3003-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1009787");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-nokogiri'
  package(s) announced via the DLA-3003-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a potential denial of service attack
