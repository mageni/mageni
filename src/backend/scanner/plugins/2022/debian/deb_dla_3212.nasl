...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for twisted (DLA-3212-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00038.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3212-1");
  ...
  package(s) announced via the DLA-3212-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that twisted, a framework for internet applications
...
if(!isnull(res = isdpkgvuln(pkg:"python-twisted-conch", ver:"18.9.0-3+deb10u2", rls:"DEB10"))) {
  report += res;
}
