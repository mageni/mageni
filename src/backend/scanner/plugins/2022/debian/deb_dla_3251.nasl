...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libcommons-net-java (DLA-3251-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/12/msg00038.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3251-1");
  script_xref(name:"Advisory-ID", value:"DLA-3251-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1025910");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libcommons-net-java'
  package(s) announced via the DLA-3251-1 advisory.");
