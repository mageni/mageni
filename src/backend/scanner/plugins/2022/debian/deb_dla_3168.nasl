...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for openvswitch (DLA-3168-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00036.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3168-1");
  ...
  package(s) announced via the DLA-3168-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue has been found in openvswitch, a software-based, Ethernet
virtual switch.
