...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for ruby-tzinfo (DLA-3077-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/08/msg00009.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3077-1");
  script_xref(name:"Advisory-ID", value:"DLA-3077-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-tzinfo'
  package(s) announced via the DLA-3077-1 advisory.");
...
programming language.");
  ...
  script_tag(name:"affected", value:"'ruby-tzinfo' package(s) on Debian Linux.");
