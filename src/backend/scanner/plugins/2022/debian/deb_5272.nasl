...
if(description)
{
  ...
  script_name("Debian: Security Advisory for xen (DSA-5272-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5272.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5272-1");
  script_xref(name:"Advisory-ID", value:"DSA-5272-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen'
  package(s) announced via the DSA-5272-1 advisory.");
