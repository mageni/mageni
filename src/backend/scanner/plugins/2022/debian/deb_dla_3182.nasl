...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for vim (DLA-3182-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00009.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3182-1");
  ...
  package(s) announced via the DLA-3182-1 advisory.");
