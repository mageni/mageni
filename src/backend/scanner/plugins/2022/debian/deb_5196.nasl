...
if(description)
{
  ...
  script_version("2022-08-01T08:41:22+0000");
  script_cve_id("CVE-2020-13692", "CVE-2022-21724", "CVE-2022-26520");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2022-08-01 08:41:22 +0000 (Mon, 01 Aug 2022)");
  ...
  script_name("Debian: Security Advisory for libpgjava (DSA-5196-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5196.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5196-1");
  script_xref(name:"Advisory-ID", value:"DSA-5196-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpgjava'
  package(s) announced via the DSA-5196-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities have been found in libpgjava, the official
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libpostgresql-jdbc-java", ver:"42.2.15-1+deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libpostgresql-jdbc-java-doc", ver:"42.2.15-1+deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libpostgresql-jdbc-java", ver:"42.2.5-2+deb10u1", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libpostgresql-jdbc-java-doc", ver:"42.2.5-2+deb10u1", rls:"DEB10"))) {
  report += res;
}
