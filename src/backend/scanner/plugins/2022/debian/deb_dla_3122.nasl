...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for dovecot (DLA-3122-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00032.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3122-1");
  ...
  package(s) announced via the DLA-3122-1 advisory.");
