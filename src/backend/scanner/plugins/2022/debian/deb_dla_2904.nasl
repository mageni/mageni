...
if(description)
{
  ...
  script_version("2022-01-31T02:00:15+0000");
  ...
  script_name("Debian LTS: Security Advisory for expat (DLA-2904-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00032.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2904-1");
  script_xref(name:"Advisory-ID", value:"DLA-2904-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1002994");
  script_xref(name:"URL", value:"https://bugs.debian.org/1003474");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the DLA-2904-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple security vulnerabilities have been discovered in Expat, the XML
