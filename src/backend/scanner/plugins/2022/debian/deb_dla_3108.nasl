...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for pcs (DLA-3108-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00017.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3108-1");
  ...
  package(s) announced via the DLA-3108-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A security issue was discovered in pcs, a corosync and pacemaker
configuration tool:
