...
if(description)
{
  ...
  script_version("2022-09-04T01:00:13+0000");
  script_cve_id("CVE-2020-27792");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-09-04 01:00:13 +0000 (Sun, 04 Sep 2022)");
  script_tag(name:"creation_date", value:"2022-09-04 01:00:13 +0000 (Sun, 04 Sep 2022)");
  script_name("Debian LTS: Security Advisory for ghostscript (DLA-3096-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00005.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3096-1");
  script_xref(name:"Advisory-ID", value:"DLA-3096-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript'
  package(s) announced via the DLA-3096-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A heap-based buffer over write vulnerability was found in GhostScript, the GPL
