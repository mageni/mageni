...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for python-treq (DLA-2954-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/03/msg00025.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2954-1");
  script_xref(name:"Advisory-ID", value:"DLA-2954-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1005041");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-treq'
  package(s) announced via the DLA-2954-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an information disclosure issue in
...
to a single domain and were instead sent to every domain.");
  ...
  script_tag(name:"affected", value:"'python-treq' package(s) on Debian Linux.");
