...
if(description)
{
  ...
  script_name("Debian: Security Advisory for commons-configuration2 (DSA-5290-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5290.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5290-1");
  script_xref(name:"Advisory-ID", value:"DSA-5290-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'commons-configuration2'
  package(s) announced via the DSA-5290-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Apache Commons Configuration, a Java library providing a generic configuration
...
engine (javax.script) - dns - resolve dns records - url
- load values from
...
used.");
  ...
  script_tag(name:"affected", value:"'commons-configuration2' package(s) on Debian Linux.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libcommons-configuration2-java", ver:"2.8.0-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libcommons-configuration2-java-doc", ver:"2.8.0-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
