...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libpgjava (DLA-3140-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00009.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3140-1");
  script_xref(name:"Advisory-ID", value:"DLA-3140-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1016662");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpgjava'
  package(s) announced via the DLA-3140-1 advisory.");
