...
if(description)
{
  ...
  script_name("Debian: Security Advisory for fish (DSA-5234-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5234.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5234-1");
  ...
  package(s) announced via the DSA-5234-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An arbitrary code execution vulnerability was discovered in fish, a
command line shell. When using the default configuration of fish,
...
behavior of git, including running arbitrary commands.");
  ...
  script_tag(name:"affected", value:"'fish' package(s) on Debian Linux.");
