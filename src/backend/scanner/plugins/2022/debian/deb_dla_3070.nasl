...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for gnutls28 (DLA-3070-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/08/msg00002.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3070-1");
  ...
  package(s) announced via the DLA-3070-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two issues were found in GnuTLS, a library implementing the TLS and SSL
