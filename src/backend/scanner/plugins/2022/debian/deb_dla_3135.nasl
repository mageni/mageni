...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libdatetime-timezone-perl (DLA-3135-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00004.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3135-1");
  script_xref(name:"Advisory-ID", value:"DLA-3135-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libdatetime-timezone-perl'
  package(s) announced via the DLA-3135-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update includes the changes in tzdata 2022d for the
