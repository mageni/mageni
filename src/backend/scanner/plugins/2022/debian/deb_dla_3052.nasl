...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for cyrus-imapd (DLA-3052-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/06/msg00013.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3052-1");
  script_xref(name:"Advisory-ID", value:"DLA-3052-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/993433");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cyrus-imapd'
  package(s) announced via the DLA-3052-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Cyrus IMAP server was prone to a denial of service
