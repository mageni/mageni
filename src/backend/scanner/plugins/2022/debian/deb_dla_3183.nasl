...
if(description)
{
  ...
  script_version("2022-11-10T11:05:02+0000");
  script_cve_id("CVE-2022-42799", "CVE-2022-42823", "CVE-2022-42824");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-11-10 11:05:02 +0000 (Thu, 10 Nov 2022)");
  script_tag(name:"creation_date", value:"2022-11-10 02:00:09 +0000 (Thu, 10 Nov 2022)");
  script_name("Debian LTS: Security Advisory for webkit2gtk (DLA-3183-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00010.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3183-1");
  script_xref(name:"Advisory-ID", value:"DLA-3183-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk'
  package(s) announced via the DLA-3183-1 advisory.");
...
if(!isnull(res = isdpkgvuln(pkg:"libwebkit2gtk-4.0-37-gtk2", ver:"2.38.2-1~deb10u1", rls:"DEB10"))) {
  report += res;
}
