...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libxml2 (DLA-3172-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00040.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3172-1");
  script_xref(name:"Advisory-ID", value:"DLA-3172-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1022224");
  script_xref(name:"URL", value:"https://bugs.debian.org/1022225");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2'
  package(s) announced via the DLA-3172-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that libxml2, the GNOME XML library, was vulnerable to
