...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for twig (DLA-3147-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00016.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3147-1");
  script_xref(name:"Advisory-ID", value:"DLA-3147-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1020991");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'twig'
  package(s) announced via the DLA-3147-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a potential arbitrary file read
