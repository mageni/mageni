...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for asterisk (DLA-3194-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00021.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3194-1");
  script_xref(name:"Advisory-ID", value:"DLA-3194-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1014998");
  script_xref(name:"URL", value:"https://bugs.debian.org/1018073");
  script_xref(name:"URL", value:"https://bugs.debian.org/1014976");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'asterisk'
  package(s) announced via the DLA-3194-1 advisory.");
