...
if(description)
{
  ...
  script_name("Debian: Security Advisory for firefox-esr (DSA-5237-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5237.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5237-1");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/firefox/102.0esr/releasenotes/");
  script_xref(name:"Advisory-ID", value:"DSA-5237-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox-esr'
  package(s) announced via the DSA-5237-1 advisory.");
