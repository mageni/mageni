...
if(description)
{
  ...
  script_version("2022-08-27T01:00:06+0000");
  script_cve_id("CVE-2022-37434");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-08-27 01:00:06 +0000 (Sat, 27 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-27 01:00:06 +0000 (Sat, 27 Aug 2022)");
  script_name("Debian: Security Advisory for zlib (DSA-5218-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5218.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5218-1");
  ...
  package(s) announced via the DSA-5218-1 advisory.");
