...
if(description)
{
  ...
  script_version("2022-05-17T14:03:58+0000");
  ...
  script_name("Debian LTS: Security Advisory for cifs-utils (DLA-3009-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00020.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3009-1");
  script_xref(name:"Advisory-ID", value:"DLA-3009-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1010818");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cifs-utils'
  package(s) announced via the DLA-3009-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A couple of vulnerabilities were found in src:cifs-utils, a Common
...
credentials file.");
  ...
  script_tag(name:"affected", value:"'cifs-utils' package(s) on Debian Linux.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"cifs-utils", ver:"2:6.7-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
