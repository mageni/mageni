...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libgoogle-gson-java (DLA-3100-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00009.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3100-1");
  script_xref(name:"Advisory-ID", value:"DLA-3100-1");
  ...
  package(s) announced via the DLA-3100-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libgoogle-gson-java", ver:"2.8.5-3+deb10u1", rls:"DEB10"))) {
  report += res;
}
