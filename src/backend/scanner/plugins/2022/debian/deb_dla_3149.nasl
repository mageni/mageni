...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for ruby-nokogiri (DLA-3149-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00018.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3149-1");
  script_xref(name:"Advisory-ID", value:"DLA-3149-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/934802");
  ...
  package(s) announced via the DLA-3149-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in Nokogiri, an
