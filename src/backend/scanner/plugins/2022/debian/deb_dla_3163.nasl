...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for wordpress (DLA-3163-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/10/msg00032.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3163-1");
  ...
  package(s) announced via the DLA-3163-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities have been discovered in Wordpress, a
...
or facilitate the injection of client-side scripts.");
