...
if(description)
{
  ...
  script_version("2022-01-22T02:00:12+0000");
  ...
  script_name("Debian: Security Advisory for usbview (DSA-5052-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5052.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5052-1");
  script_xref(name:"Advisory-ID", value:"DSA-5052-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'usbview'
  package(s) announced via the DSA-5052-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Matthias Gerstner reported that usbview, a USB device viewer, does not
properly handle authorization in the PolicyKit policy configuration,
which could result in root privilege escalation.");

  script_tag(name:"affected", value:"'usbview' package(s) on Debian Linux.");
