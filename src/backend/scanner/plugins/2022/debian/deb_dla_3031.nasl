...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for modsecurity-apache (DLA-3031-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00042.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3031-1");
  ...
  package(s) announced via the DLA-3031-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a potential resource exhaustion
attack in modsecurity-apache, an Apache module which inspects HTTP
requests with the aim of preventing typical web application attacks
such as XSS and SQL.");
