...
if(description)
{
  ...
  script_version("2022-09-16T01:00:08+0000");
  script_cve_id("CVE-2021-3800");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-09-16 01:00:08 +0000 (Fri, 16 Sep 2022)");
  script_tag(name:"creation_date", value:"2022-09-16 01:00:08 +0000 (Fri, 16 Sep 2022)");
  script_name("Debian LTS: Security Advisory for glib2.0 (DLA-3110-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/09/msg00020.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3110-1");
  ...
  package(s) announced via the DLA-3110-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was found that GLib, a general-purpose portable utility library,
