...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for frr (DLA-3211-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00039.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3211-1");
  script_xref(name:"Advisory-ID", value:"DLA-3211-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1021016");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'frr'
  package(s) announced via the DLA-3211-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a potential out-of-bounds read in
the BGP daemon of frr, a set of tools to route internet traffic.");

  script_tag(name:"affected", value:"'frr' package(s) on Debian Linux.");
