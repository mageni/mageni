...
if(description)
{
  ...
  script_version("2022-11-15T02:00:08+0000");
  script_cve_id("CVE-2022-31628", "CVE-2022-31629", "CVE-2022-31630", "CVE-2022-37454");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-11-15 02:00:08 +0000 (Tue, 15 Nov 2022)");
  script_tag(name:"creation_date", value:"2022-11-15 02:00:08 +0000 (Tue, 15 Nov 2022)");
  script_name("Debian: Security Advisory for php7.4 (DSA-5277-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5277.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5277-1");
  ...
  package(s) announced via the DSA-5277-1 advisory.");
