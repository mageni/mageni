...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for varnish (DLA-3208-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00036.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3208-1");
  script_xref(name:"Advisory-ID", value:"DLA-3208-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/956307");
  script_xref(name:"URL", value:"https://bugs.debian.org/1023751");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'varnish'
  package(s) announced via the DLA-3208-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Martin van Kervel Smedshammer discovered a request forgery attack can be
