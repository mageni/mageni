...
if(description)
{
  ...
  script_version("2022-02-22T02:00:15+0000");
  ...
  script_name("Debian: Security Advisory for redis (DSA-5081-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5081.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5081-1");
  ...
  package(s) announced via the DSA-5081-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Reginaldo Silva discovered a (Debian-specific) Lua sandbox escape in
