...
if(description)
{
  ...
  script_version("2022-08-11T01:00:09+0000");
  ...
  script_tag(name:"last_modification", value:"2022-08-11 01:00:09 +0000 (Thu, 11 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-11 01:00:09 +0000 (Thu, 11 Aug 2022)");
  script_name("Debian: Security Advisory for gst-plugins-good1.0 (DSA-5204-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5204.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5204-1");
  script_xref(name:"Advisory-ID", value:"DSA-5204-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gst-plugins-good1.0'
  package(s) announced via the DSA-5204-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Adam Doupe discovered multiple vulnerabilities in the Gstreamer plugins
