...
if(description)
{
  ...
  script_name("Debian: Security Advisory for nbd (DSA-5100-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5100.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5100-1");
  ...
  package(s) announced via the DSA-5100-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities were discovered in the server for the Network Block
