...
if(description)
{
  ...
  script_version("2022-08-07T01:00:05+0000");
  script_cve_id("CVE-2022-2319", "CVE-2022-2320");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-08-07 01:00:05 +0000 (Sun, 07 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-07 01:00:05 +0000 (Sun, 07 Aug 2022)");
  script_name("Debian: Security Advisory for xorg-server (DSA-5199-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5199.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5199-1");
  ...
  package(s) announced via the DSA-5199-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jan-Niklas Sohn discovered that multiple input validation failures in
