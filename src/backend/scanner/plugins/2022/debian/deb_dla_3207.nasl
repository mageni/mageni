...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for jackson-databind (DLA-3207-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/11/msg00035.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3207-1");
  script_xref(name:"Advisory-ID", value:"DLA-3207-1");
  ...
  package(s) announced via the DLA-3207-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libjackson2-databind-java", ver:"2.9.8-3+deb10u4", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjackson2-databind-java-doc", ver:"2.9.8-3+deb10u4", rls:"DEB10"))) {
  report += res;
}
