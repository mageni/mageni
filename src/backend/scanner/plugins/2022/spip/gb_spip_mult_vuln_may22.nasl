...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124074");
  ...
  script_cve_id("CVE-2022-28959", "CVE-2022-28961");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("SPIP < 3.1.14 Multiple Vulnerabilities");
  ...
  - CVE-2022-28959: Cross-site scripting (XSS)

  - CVE-2022-28961: SQL injection");

  script_tag(name:"affected", value:"SPIP prior to version 3.1.14.");
