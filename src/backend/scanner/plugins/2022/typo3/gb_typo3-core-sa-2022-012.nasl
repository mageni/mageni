...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126254");
  script_version("2022-12-15T10:11:09+0000");
  script_tag(name:"last_modification", value:"2022-12-15 10:11:09 +0000 (Thu, 15 Dec 2022)");
  script_tag(name:"creation_date", value:"2022-12-14 11:00:09 +0000 (Wed, 14 Dec 2022)");
  script_tag(name:"cvss_base", value:"5.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:N/I:N/A:C");

  script_cve_id("CVE-2022-23500");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("TYPO3 DoS Vulnerability (TYPO3-CORE-SA-2022-012)");
  ...
  10.4.32 and 11.0.0 through 11.5.19.");

  script_tag(name:"solution", value:"Update to version 9.5.38 ELTS, 10.4.33, 11.5.20 or later.");

  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-012");
