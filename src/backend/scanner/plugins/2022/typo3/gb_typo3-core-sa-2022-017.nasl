...
if (description)
{
  ...
  script_name("TYPO3 XSS Vulnerability (TYPO3-CORE-SA-2022-017)");
  ...
  script_tag(name:"insight", value:"Due to a parsing issue in the upstream package
  masterminds/html5, malicious markup used in a sequence with special HTML CDATA sections cannot be
  ...
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-017");
