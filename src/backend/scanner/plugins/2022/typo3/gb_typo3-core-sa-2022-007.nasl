...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124158");
  ...
  script_cve_id("CVE-2022-36105");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("TYPO3 Information Disclosure Vulnerability (TYPO3-CORE-SA-2022-007)");
  ...
  script_tag(name:"insight", value:"By observing response time during user authentication (backend
  and frontend) it is possible to distinguish between existing and non-existing user accounts.");
  ...
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-007");
