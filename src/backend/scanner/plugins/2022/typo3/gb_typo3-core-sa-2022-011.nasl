...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126258");
  script_version("2022-12-15T10:11:09+0000");
  script_tag(name:"last_modification", value:"2022-12-15 10:11:09 +0000 (Thu, 15 Dec 2022)");
  script_tag(name:"creation_date", value:"2022-12-15 08:26:09 +0000 (Thu, 15 Dec 2022)");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:N");

  script_cve_id("CVE-2022-36020");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("TYPO3 XSS Vulnerability (TYPO3-CORE-SA-2022-011)");
  ...
  script_tag(name:"insight", value:"Due to a parsing issue in upstream package masterminds/html5,
  malicious markup used in a sequence with special HTML comments cannot be filtered and sanitized.");

  script_tag(name:"affected", value:"TYPO3 version 7.0.0 through 7.6.57 ELTS, 8.0.0 through 8.7.47
  ELTS, 9.0.0 through 9.5.36 ELTS, 10.0.0 through 10.4.31 and 11.0.0 through 11.5.15.");

  script_tag(name:"solution", value:"Update to version 7.6.58 ELTS, 8.7.48 ELTS, 9.5.37 ELTS,
  10.4.32, 11.5.16 or later.");

  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-011");
