...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.2858.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:2858-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:2858-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222858-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the SUSE-SU-2022:2858-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.1.3~3.9.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rsync-debuginfo", rpm:"rsync-debuginfo~3.1.3~3.9.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rsync-debugsource", rpm:"rsync-debugsource~3.1.3~3.9.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
