...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.4635.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:4635-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:4635-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224635-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'conmon' package(s) announced via the SUSE-SU-2022:4635-1 advisory.");
...
conmon: Fix: free userdata files before exec cleanup");
  ...
  script_tag(name:"affected", value:"'conmon' package(s) on SUSE Linux Enterprise Micro 5.3, SUSE Linux Enterprise Module for Containers 15-SP4.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"conmon", rpm:"conmon~2.1.5~150400.3.3.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"conmon-debuginfo", rpm:"conmon-debuginfo~2.1.5~150400.3.3.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
