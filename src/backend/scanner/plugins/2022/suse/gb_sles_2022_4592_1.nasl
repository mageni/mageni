...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.4592.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:4592-1)");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cni", rpm:"cni~0.7.1~150100.3.8.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cni", rpm:"cni~0.7.1~150100.3.8.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cni", rpm:"cni~0.7.1~150100.3.8.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cni", rpm:"cni~0.7.1~150100.3.8.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
