...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.4278.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:4278-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:4278-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224278-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'supportutils' package(s) announced via the SUSE-SU-2022:4278-1 advisory.");
...
Added includedir directories from /etc/sudoers (bsc#1188086)");
  ...
  script_tag(name:"affected", value:"'supportutils' package(s) on SUSE Linux Enterprise Micro 5.1, SUSE Linux Enterprise Micro 5.2, SUSE Linux Enterprise Micro 5.3, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP4.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"supportutils", rpm:"supportutils~3.1.21~150300.7.35.15.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"supportutils", rpm:"supportutils~3.1.21~150300.7.35.15.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
