...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.3486.1");
  ...
  script_tag(name:"severity_date", value:"2022-09-19 18:11:00 +0000 (Mon, 19 Sep 2022)");

  script_name("SUSE: Security Advisory (SUSE-SU-2022:3486-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223486-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cosign' package(s) announced via the SUSE-SU-2022:3486-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cosign", rpm:"cosign~1.12.0~150400.3.6.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
