...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.1437.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:1437-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:1437-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221437-1/");
  script_xref(name:"URL", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1183043");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah' package(s) announced via the SUSE-SU-2022:1437-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.25.1~150300.8.6.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
