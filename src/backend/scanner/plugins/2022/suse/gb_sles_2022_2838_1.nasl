...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.2838.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:2838-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:2838-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222838-1/");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2022:2838-1 advisory.");
...
C0 <pipe> 06-bf-05/03 <pipe> 0000001f <pipe> 00000022 <pipe> Core Gen12
 ------------------------------------------------------------------");
  ...
  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE OpenStack Cloud 9, SUSE OpenStack Cloud Crowbar 9.");
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20220809~13.101.1", rls:"SLES12.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debuginfo", rpm:"ucode-intel-debuginfo~20220809~13.101.1", rls:"SLES12.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debugsource", rpm:"ucode-intel-debugsource~20220809~13.101.1", rls:"SLES12.0SP2"))) {
    report += res;
  }
...
if(release == "SLES12.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20220809~13.101.1", rls:"SLES12.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debuginfo", rpm:"ucode-intel-debuginfo~20220809~13.101.1", rls:"SLES12.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debugsource", rpm:"ucode-intel-debugsource~20220809~13.101.1", rls:"SLES12.0SP3"))) {
    report += res;
  }
...
if(release == "SLES12.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20220809~13.101.1", rls:"SLES12.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debuginfo", rpm:"ucode-intel-debuginfo~20220809~13.101.1", rls:"SLES12.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debugsource", rpm:"ucode-intel-debugsource~20220809~13.101.1", rls:"SLES12.0SP4"))) {
    report += res;
  }
