...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.3537.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:3537-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223537-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-jdbc' package(s) announced via the SUSE-SU-2022:3537-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"postgresql-jdbc", rpm:"postgresql-jdbc~42.2.25~150400.3.6.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
