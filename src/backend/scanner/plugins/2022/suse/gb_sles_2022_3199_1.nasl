...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.3199.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:3199-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223199-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'yast2-samba-provision' package(s) announced via the SUSE-SU-2022:3199-1 advisory.");
...
Add metainfo (fate#319035)");
  ...
  script_tag(name:"affected", value:"'yast2-samba-provision' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP4.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yast2-samba-provision", rpm:"yast2-samba-provision~1.0.5~150400.9.3.3", rls:"SLES15.0SP4"))) {
    report += res;
  }
