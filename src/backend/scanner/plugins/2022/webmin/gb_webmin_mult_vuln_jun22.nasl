...
if(description)
{
  ...
  script_version("2022-06-17T08:17:31+0000");
  ...
  - CVE-2021-32158: A Cross-Site Scripting (XSS) vulnerability exists via the Upload and Download
  feature.
  ...
  - CVE-2021-32162: A Cross-site request forgery (CSRF) vulnerability exists through
  the File Manager feature.");
