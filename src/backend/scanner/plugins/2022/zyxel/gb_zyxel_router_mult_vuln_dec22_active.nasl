...
if (description)
{
  ...
  script_version("2022-12-19T09:33:17+0000");
  script_tag(name:"last_modification", value:"2022-12-19 09:33:17 +0000 (Mon, 19 Dec 2022)");
  ...
  script_name("Zyxel Router / Gateway Multiple Vulnerabilities (Dec 2022) - Active Check");
  ...
  script_mandatory_keys("zyxel/router/http/detected");
  script_require_ports("Services/www", 80);

  script_tag(name:"summary", value:"Multiple Zyxel Router / Gateway devices are prone to multiple
  vulnerabilities.");
