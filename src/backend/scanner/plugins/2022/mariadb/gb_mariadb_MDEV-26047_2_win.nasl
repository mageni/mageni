...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104562");
  script_version("2023-02-28T10:08:51+0000");
  script_tag(name:"last_modification", value:"2023-02-28 10:08:51 +0000 (Tue, 28 Feb 2023)");
  script_tag(name:"creation_date", value:"2022-07-04 06:47:47 +0000 (Mon, 04 Jul 2022)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-07-11 17:09:00 +0000 (Mon, 11 Jul 2022)");

  script_cve_id("CVE-2022-32083");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-26047 - 2) - Windows");
  ...
  script_tag(name:"insight", value:"MariaDB contains a segmentation fault via the component
  Item_subselect::init_expr_cache_tracker.");

  script_tag(name:"affected", value:"MariaDB versions prior to 10.2.44, 10.3.x prior to 10.3.35,
  10.4.x prior to 10.4.25, 10.5.x prior to 10.5.16, 10.6.x prior to 10.6.8 and 10.7.x prior to
  10.7.4.");

  script_tag(name:"solution", value:"Update to version 10.2.44, 10.3.35, 10.4.25, 10.5.16, 10.6.8,
  10.7.4 or later.");

  # nb: MDEV-26047 has two CVEs attached
...
if (version_is_less(version: version, test_version: "10.2.44")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "10.2.44");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "10.3.0", test_version_up: "10.3.35")) {
