...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104553");
  ...
  script_cve_id("CVE-2022-31624");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-26556) - Windows");
  ...
  script_tag(name:"insight", value:"While executing the plugin/server_audit/server_audit.c method
  log_statement_ex, the held lock lock_bigbuffer is not released correctly, which allows local users
  ...
  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-26556");
