...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104619");
  ...
  script_cve_id("CVE-2022-27452");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-28090) - Windows");
  ...
  script_tag(name:"insight", value:"DoS due segmentation fault via component sql/item_cmpfunc.cc.");
