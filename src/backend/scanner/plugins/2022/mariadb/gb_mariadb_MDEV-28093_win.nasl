...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104621");
  ...
  script_cve_id("CVE-2022-27456");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB Use-After-Free Vulnerability (MDEV-28093) - Windows");
  ...
  script_tag(name:"insight", value:"Use-after-free in the component VDec::VDec at /sql/sql_type.cc.");

  script_tag(name:"affected", value:"MariaDB versions prior to 10.3.35, 10.4.x prior to 10.4.25,
  10.5.x prior to 10.5.16, 10.6.x prior to 10.6.8 and 10.7.x prior to 10.7.4.");

  script_tag(name:"solution", value:"Update to version 10.3.35, 10.4.25, 10.5.16, 10.6.8, 10.7.4 or
  later.");
