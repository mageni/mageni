...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104566");
  ...
  script_cve_id("CVE-2022-27377");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB Use-After-Free Vulnerability (MDEV-26281) - Windows");
  ...
  script_tag(name:"summary", value:"MariaDB is prone to a use-after-free vulnerability.");
