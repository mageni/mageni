...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104627");
  ...
  script_cve_id("CVE-2022-27457");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB Use-After-Free Vulnerability (MDEV-28098) - Windows");
  ...
  script_tag(name:"insight", value:"Use-after-free in the component my_mb_wc_latin1 at /strings/ctype-latin1.c.");
  ...
  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-28098");
