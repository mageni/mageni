...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104625");
  ...
  script_cve_id("CVE-2022-27455");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB Use-After-Free Vulnerability (MDEV-28097) - Windows");
  ...
  script_tag(name:"insight", value:"Use-after-free in the component my_wildcmp_8bit_impl at /strings/ctype-simple.c.");
