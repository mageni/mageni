...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126001");
  ...
  script_cve_id("CVE-2022-27447", "CVE-2022-27458");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB Multiple Use-After-Free Vulnerabilities (MDEV-28099) - Linux");
  ...
  script_tag(name:"summary", value:"MariaDB is prone to multiple use-after-free vulnerabilities.");
