...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104580");
  ...
  script_cve_id("CVE-2022-27387");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB Buffer Overflow Vulnerability (MDEV-26422) - Windows");
  ...
  script_tag(name:"summary", value:"MariaDB is prone to a buffer overflow vulnerability.");
