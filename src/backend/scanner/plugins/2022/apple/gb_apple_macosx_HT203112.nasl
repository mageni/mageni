...
if(description)
{
  ...
  script_name("Apple MacOSX Security Update (HT203112)");

  script_tag(name:"summary", value:"Apple Mac OS X is prone to a buffer overflow
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to a heap buffer overflow
  existed in IOHIDFamily's handling of key-mapping properties.");
