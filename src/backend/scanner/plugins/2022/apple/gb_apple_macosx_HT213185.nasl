...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819820");
  script_version("2022-03-18T09:01:15+0000");
  script_cve_id("CVE-2022-22631", "CVE-2022-22648", "CVE-2022-22627", "CVE-2022-22626",
                "CVE-2022-22625", "CVE-2022-22597", "CVE-2022-22616", "CVE-2022-22661",
                "CVE-2022-22613", "CVE-2022-22614", "CVE-2022-22615", "CVE-2022-22638",
                "CVE-2022-22647", "CVE-2022-22656", "CVE-2022-22617", "CVE-2022-22650",
                "CVE-2022-22662", "CVE-2022-22582");
  ...
  script_name("Apple MacOSX Security Update (HT213185)");
  ...
  script_tag(name:"solution", value:"Apply Security Update 2022-003 Catalina for
  10.15.x, Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/HT213185");
...
if(osVer =~ "^10\.15")
{
  ...
  {
    if(version_is_less(version:buildVer, test_version:"19H1824"))
    {
