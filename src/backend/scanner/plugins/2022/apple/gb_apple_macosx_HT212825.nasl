...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826501");
  ...
  script_name("Apple MacOSX Security Update (HT212825)");

  script_tag(name:"summary", value:"Apple Mac OS X is prone to a type confusion vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw is due to a type confusion issue
  related to improper state handling.");
  ...
  script_tag(name:"solution", value:"Apply Security Update 2021-006 Catalina for
  10.15.x, Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/HT212825");
...
if(osVer =~ "^10\.15")
{
  ...
  {
    if(version_is_less(version:buildVer, test_version:"19H1419"))
    {
