...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826508");
  script_version("2022-09-14T10:57:19+0000");
  script_cve_id("CVE-2022-32854", "CVE-2022-32902", "CVE-2022-32896", "CVE-2022-32911",
  ...
  script_name("Apple MacOSX Security Update (HT213443)");
  ...
  11.7 or later. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/HT213443");
...
if(version_is_less(version:osVer, test_version:"11.7"))
{
  report = report_fixed_ver(installed_version:osVer, fixed_version:"11.7");
