...
if (version_in_range(version: version, test_version: "7.0", test_version2: "7.0.31")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.0.32", install_path: location);
