...
if (description)
{
  ...
  Template toolkit, by having the admin installing an unverified 3th party package.");
...
if (version_in_range(version: version, test_version: "7.0", test_version2: "7.0.36")) {
