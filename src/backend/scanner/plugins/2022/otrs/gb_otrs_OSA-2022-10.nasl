...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150762");
  ...
  script_cve_id("CVE-2022-39049");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("OTRS XSS Vulnerability (OSA-2022-10)");
  ...
  script_xref(name:"URL", value:"https://otrs.com/release-notes/otrs-security-advisory-2022-10/");
