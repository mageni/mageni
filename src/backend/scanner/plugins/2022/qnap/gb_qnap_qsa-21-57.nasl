...
if(description)
{
  ...
  script_version("2022-02-17T11:12:52+0000");
  ...
  script_tag(name:"solution", value:"Update to version 4.5.4.1892 build 20211223 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "4.5.3", test_version_up:"4.5.4_20211223")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.5.4_20211223");
