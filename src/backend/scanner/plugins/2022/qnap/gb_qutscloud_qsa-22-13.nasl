...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170125");
  ...
  script_name("QNAP QuTScloud Path Traversal Vulnerability (QSA-22-13)");
  ...
  script_tag(name:"summary", value:"QNAP QuTScloud is prone to a path traversal vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"A path traversal vulnerability in thttpd has been reported to
  affect QNAP devices running QuTScloud.");

  script_tag(name:"impact", value:"If exploited, this vulnerability allows attackers to access and
  read sensitive data.");

  script_tag(name:"solution", value:"Update to version 5.0.1.1949 build 20220218 or later.");
...
if ( version_is_less( version:version, test_version:"c5.0.1_20220218" ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"c5.0.1_20220218" );
