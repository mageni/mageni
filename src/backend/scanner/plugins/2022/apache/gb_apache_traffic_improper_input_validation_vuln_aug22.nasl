...
if (description)
{
  ...
  script_tag(name:"summary", value:"Apache Traffic Server (ATS) is prone to improper input validation
  vulnerability.");
...
if (version_in_range(version: version, test_version: "8.0.0", test_version2: "8.1.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.1.5");
