...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826709");
  script_version("2022-11-19T00:27:41+0000");
  script_cve_id("CVE-2022-3885", "CVE-2022-3886", "CVE-2022-3887", "CVE-2022-3888",
                "CVE-2022-3889", "CVE-2022-3890");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2022-11-19 00:27:41 +0000 (Sat, 19 Nov 2022)");
  script_tag(name:"creation_date", value:"2022-11-18 15:33:31 +0530 (Fri, 18 Nov 2022)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2022-11) - MAC OS X");
  ...
  107.0.5304.110 on MAC OS X");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  107.0.5304.110 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"107.0.5304.110"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"107.0.5304.110", install_path:path);
