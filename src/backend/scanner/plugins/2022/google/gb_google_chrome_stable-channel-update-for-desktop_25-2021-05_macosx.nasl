...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826824");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_25-2021-05)-MAC OS X");
