...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821333");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_13-2022-12)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 108.0.5359.12 on Linux");
