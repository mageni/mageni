...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826608");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_25-2022-10) - Linux");
  ...
  107.0.5304.68 on Linux");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  107.0.5304.68 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"107.0.5304.68"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"107.0.5304.68", install_path:path);
