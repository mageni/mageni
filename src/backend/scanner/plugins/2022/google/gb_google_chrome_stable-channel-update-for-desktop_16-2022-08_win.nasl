...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826414");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_16-2022-08) - Windows");
  ...
  104.0.5112.102 on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  104.0.5112.102 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"104.0.5112.102"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"104.0.5112.102", install_path:path);
