...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826801");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_24-2022-11) - Linux");

  script_tag(name:"summary", value:"Google Chrome is prone to a heap overflow
  vulnerability.");
