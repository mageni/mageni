...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826416");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_16-2022-08) - MAC OS X");
