...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170210");
  ...
  script_tag(name:"severity_date", value:"2022-06-30 13:56:00 +0000 (Thu, 30 Jun 2022)");

  script_cve_id("CVE-2021-25104");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Ocean Extra Plugin < 1.9.5 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not escape generated links which are then used
  when the OceanWP theme is active.");

  script_tag(name:"affected", value:"WordPress Ocean Extra plugin prior to version 1.9.5.");

  script_tag(name:"solution", value:"Update to version 1.9.5 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/2ee6f1d8-3803-42f6-9193-3dd8f416b558");
