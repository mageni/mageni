...
if(description)
{
  ...
  script_tag(name:"affected", value:"WordPress Autoptimize plugin prior to version 3.1.1.");

  script_tag(name:"solution", value:"Update to version 3.1.1 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/219767a8-2427-42d5-8734-bd197d9ab46b");
