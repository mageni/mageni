...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170184");
  ...
  script_cve_id("CVE-2022-2267");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Mailchimp for WooCommerce Plugin < 2.7.1 SSRF Vulnerability");
  ...
  script_tag(name:"insight", value:"The Mailchimp for WooCommerce WordPress plugin before 2.7.1 has an
  AJAX action that allows any logged in users (such as subscriber) to perform a POST request on behalf
  of the server to the internal network/LAN, the body of the request is also appended to the response
  so it can be used to scan private network for example.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/e3bd9f8c-919a-40af-9e80-607573e71870");
