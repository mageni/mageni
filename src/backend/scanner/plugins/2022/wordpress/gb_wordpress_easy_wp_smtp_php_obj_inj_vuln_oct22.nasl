...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Easy WP SMTP' is prone to a
  ...
  could lead to PHP object injection issue when an admin import (intentionally or not) a malicious
  file and a suitable gadget chain is present on the blog.");

  script_tag(name:"affected", value:"WordPress Easy WP SMTP plugin prior to version 1.5.0.");

  script_tag(name:"solution", value:"Update to version 1.5.0 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/0e735502-eaa2-4047-949e-bc8eb6b39fc9");
