...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127245");
  script_version("2022-11-08T12:34:13+0000");
  script_tag(name:"last_modification", value:"2022-11-08 12:34:13 +0000 (Tue, 08 Nov 2022)");
  script_tag(name:"creation_date", value:"2022-11-08 10:16:40 +0000 (Tue, 08 Nov 2022)");
  script_tag(name:"cvss_base", value:"8.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:M/C:C/I:C/A:C");

  script_cve_id("CVE-2022-36386");
  ...
  script_tag(name:"impact", value:"A malicious authenticated user is able to execute code.");
  ...
  script_xref(name:"URL", value:"https://patchstack.com/database/vulnerability/wp-all-import/wordpress-import-any-xml-or-csv-file-to-wordpress-plugin-3-6-7-authenticated-arbitrary-code-execution-vulnerability");
