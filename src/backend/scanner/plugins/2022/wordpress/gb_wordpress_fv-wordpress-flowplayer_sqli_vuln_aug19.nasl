...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127110");
  script_version("2022-07-30T07:26:17+0000");
  script_tag(name:"last_modification", value:"2022-07-30 07:26:17 +0000 (Sat, 30 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-29 13:58:08 +0000 (Fri, 29 Jul 2022)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_cve_id("CVE-2019-14801");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress FV Flowplayer Video Player Plugin < 7.3.15.727 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'FV Flowplayer' is prone to an SQL injection
  (SQLi) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The plugin allows to inject SQL in email subscription.");

  script_tag(name:"affected", value:"WordPress 'FV Flowplayer' plugin prior to version 7.3.15.727.");
