...
if(description)
{
  ...
  script_version("2022-12-19T14:25:05+0000");
  script_tag(name:"last_modification", value:"2022-12-19 14:25:05 +0000 (Mon, 19 Dec 2022)");
  ...
  script_name("WordPress <= 6.1.1 SSRF Vulnerability");
...
if (version_is_less_equal(version: version, test_version: "6.1.1")) {
