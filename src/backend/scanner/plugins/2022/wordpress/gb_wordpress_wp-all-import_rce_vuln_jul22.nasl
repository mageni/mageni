...
if(description)
{
  ...
  script_tag(name:"insight", value:"The plugin accepts all zip files and automatically extracts the
  zip file without validating the extracted file type. Allowing high privilege users such as admin
  to upload an arbitrary file like PHP, leading to RCE.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/578093db-a025-4148-8c4b-ec2df31743f7");
