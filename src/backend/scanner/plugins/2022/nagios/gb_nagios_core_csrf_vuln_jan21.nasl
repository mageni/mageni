...
if(description)
{
  ...
  script_name("Nagios Core <= 4.2.4 Cross-Site Request Forgery (CSRF) Vulnerability");
  ...
  script_tag(name:"affected", value:"Nagios Core version 4.2.4 and probably prior.");

  script_tag(name:"solution", value:"No known solution is available as of 14th December, 2022.
  Information regarding this issue will be updated once solution details are available.

  Note: To mitigate the issue the vendor suggests to change the apache configuration on the server
  to include SSL protection for both /nagios and /nagios/cgi-bin.");
