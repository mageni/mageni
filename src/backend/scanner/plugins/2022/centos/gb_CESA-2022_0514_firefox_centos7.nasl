...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884202");
  ...
  script_tag(name:"creation_date", value:"2022-02-16 02:00:52 +0000 (Wed, 16 Feb 2022)");
  script_name("CentOS: Security Advisory for firefox (CESA-2022:0514)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2022:0514");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2022-February/073557.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2022:0514 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~91.6.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
