...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884210");
  script_version("2022-03-31T07:10:52+0000");
  script_cve_id("CVE-2021-45960", "CVE-2021-46143", "CVE-2022-22822", "CVE-2022-22823", "CVE-2022-22824", "CVE-2022-22825", "CVE-2022-22826", "CVE-2022-22827", "CVE-2022-23852", "CVE-2022-25235", "CVE-2022-25236", "CVE-2022-25315");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2022-03-31 10:53:41 +0000 (Thu, 31 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-30 01:00:55 +0000 (Wed, 30 Mar 2022)");
  script_name("CentOS: Security Advisory for expat (CESA-2022:1069)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2022:1069");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2022-March/073580.html");
...
page(s) listed in the References section.");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on CentOS 7.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.1.0~14.el7_9", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"expat-devel", rpm:"expat-devel~2.1.0~14.el7_9", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"expat-static", rpm:"expat-static~2.1.0~14.el7_9", rls:"CentOS7"))) {
    report += res;
  }
