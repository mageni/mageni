...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884230");
  ...
  script_tag(name:"creation_date", value:"2022-08-03 01:01:34 +0000 (Wed, 03 Aug 2022)");
  script_name("CentOS: Security Advisory for firefox (CESA-2022:5479)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2022:5479");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2022-August/073622.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2022:5479 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~91.11.0~2.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
