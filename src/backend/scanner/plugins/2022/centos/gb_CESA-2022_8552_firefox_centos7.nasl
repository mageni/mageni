...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884254");
  ...
  script_tag(name:"creation_date", value:"2022-12-01 02:00:48 +0000 (Thu, 01 Dec 2022)");
  script_name("CentOS: Security Advisory for firefox (CESA-2022:8552)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2022:8552");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2022-November/073659.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2022:8552 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~102.5.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
