...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884237");
  script_version("2022-08-10T10:11:40+0000");
  script_cve_id("CVE-2022-2505", "CVE-2022-36318", "CVE-2022-36319");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-08-10 10:11:40 +0000 (Wed, 10 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-05 01:01:00 +0000 (Fri, 05 Aug 2022)");
  script_name("CentOS: Security Advisory for firefox (CESA-2022:5776)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2022:5776");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2022-August/073625.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2022:5776 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~91.12.0~2.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
