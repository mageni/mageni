...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884229");
  ...
  script_tag(name:"creation_date", value:"2022-08-03 01:01:33 +0000 (Wed, 03 Aug 2022)");
  script_name("CentOS: Security Advisory for python-virtualenv (CESA-2022:5234)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2022:5234");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2022-August/073616.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-virtualenv'
  package(s) announced via the CESA-2022:5234 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-virtualenv", rpm:"python-virtualenv~15.1.0~7.el7_9", rls:"CentOS7"))) {
    report += res;
  }
