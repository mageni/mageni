...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104478");
  script_version("2022-12-19T09:18:42+0000");
  script_tag(name:"last_modification", value:"2022-12-19 09:18:42 +0000 (Mon, 19 Dec 2022)");
  ...
  script_name("Python DoS Vulnerability (Oct 2022) - Mac OS X");
