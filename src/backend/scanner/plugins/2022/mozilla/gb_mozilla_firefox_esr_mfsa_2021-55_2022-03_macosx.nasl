...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819954");
  ...
  script_tag(name:"creation_date", value:"2022-01-14 15:23:48 +0530 (Fri, 14 Jan 2022)");
  script_name("Mozilla Firefox ESR Security Update(mfsa_2021-55_2022-03)-MAC OS X");
