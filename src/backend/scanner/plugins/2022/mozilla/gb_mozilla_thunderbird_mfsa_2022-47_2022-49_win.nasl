...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826705");
  ...
  script_tag(name:"creation_date", value:"2022-11-16 13:11:35 +0530 (Wed, 16 Nov 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa_2022-47_2022-49)-Windows");
  ...
  script_tag(name:"solution", value:"Upgrade Mozilla Thunderbird to version 102.5
