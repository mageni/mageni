...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826438");
  script_version("2022-09-08T10:11:29+0000");
  script_cve_id("CVE-2022-36319", "CVE-2022-36318", "CVE-2022-36314", "CVE-2022-2505");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2022-09-08 10:11:29 +0000 (Thu, 08 Sep 2022)");
  script_tag(name:"creation_date", value:"2022-09-06 11:23:16 +0530 (Tue, 06 Sep 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa2022-32) - Windows");
  ...
  attackers to leak memory, disclose information, conduct spoofing and cause
  ...
  102.1 or later, Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2022-32");
