...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826445");
  ...
  script_tag(name:"creation_date", value:"2022-09-09 17:18:20 +0530 (Fri, 09 Sep 2022)");
  script_name("Mozilla Firefox ESR Security Update(mfsa2021-49) - Windows");
