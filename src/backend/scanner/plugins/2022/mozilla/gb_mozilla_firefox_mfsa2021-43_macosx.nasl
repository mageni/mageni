...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826480");
  ...
  script_tag(name:"creation_date", value:"2022-09-22 16:11:37 +0530 (Thu, 22 Sep 2022)");
  script_name("Mozilla Firefox Security Update(mfsa2021-43) - MAC OS X");
