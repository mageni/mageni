...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826436");
  ...
  script_tag(name:"creation_date", value:"2022-09-06 11:23:00 +0530 (Tue, 06 Sep 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa2022-31) - Windows");
  ...
  attackers to disclose information and conduct spoofing on affected system.");

  script_tag(name:"affected", value:"Mozilla Thunderbird version before
  91.12 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Thunderbird version
  91.12 or later, Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2022-31");
