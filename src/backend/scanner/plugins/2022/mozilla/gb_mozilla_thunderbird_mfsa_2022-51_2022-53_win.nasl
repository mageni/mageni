...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826820");
  ...
  script_tag(name:"creation_date", value:"2022-12-16 17:25:22 +0530 (Fri, 16 Dec 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa_2022-51_2022-53)-Windows");
