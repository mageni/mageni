...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826472");
  ...
  script_tag(name:"creation_date", value:"2022-09-21 13:42:39 +0530 (Wed, 21 Sep 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa2022-39) - MAC OS X");
