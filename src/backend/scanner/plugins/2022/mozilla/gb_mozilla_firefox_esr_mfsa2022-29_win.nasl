...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826417");
  ...
  script_tag(name:"creation_date", value:"2022-07-28 15:39:16 +0530 (Thu, 28 Jul 2022)");
  script_name("Mozilla Firefox ESR Security Update(mfsa2022-29) - Windows");
