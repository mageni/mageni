...
if(description)
{
  ...
  script_cve_id("CVE-2022-46880", "CVE-2022-46881", "CVE-2022-46874", "CVE-2022-46875",
  ...
  script_name("Mozilla Thunderbird Security Update(mfsa_2022-51_2022-53)-MAC OS X");
