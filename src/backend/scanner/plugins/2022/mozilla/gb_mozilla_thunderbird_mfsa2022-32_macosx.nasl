...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826439");
  ...
  script_tag(name:"creation_date", value:"2022-09-06 11:23:26 +0530 (Tue, 06 Sep 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa2022-32) - MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Thunderbird version 102.1
