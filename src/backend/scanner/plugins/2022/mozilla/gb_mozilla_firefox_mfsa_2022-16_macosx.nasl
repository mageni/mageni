...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821164");
  ...
  script_tag(name:"creation_date", value:"2022-07-07 23:24:17 +0530 (Thu, 07 Jul 2022)");
  script_name("Mozilla Firefox Security Updates(mfsa2022-16) - MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 100
...
if(version_is_less(version:vers, test_version:"100"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"100", install_path:path);
