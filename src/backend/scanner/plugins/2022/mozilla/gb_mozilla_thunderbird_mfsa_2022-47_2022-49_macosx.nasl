...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826706");
  script_version("2022-11-16T13:46:43+0000");
  ...
  script_tag(name:"last_modification", value:"2022-11-16 13:46:43 +0000 (Wed, 16 Nov 2022)");
  script_tag(name:"creation_date", value:"2022-11-16 13:12:06 +0530 (Wed, 16 Nov 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa_2022-47_2022-49)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Thunderbird version prior to
  102.5 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade Mozilla Thunderbird version to 102.5
