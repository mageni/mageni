...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826818");
  ...
  script_tag(name:"creation_date", value:"2022-12-16 16:07:12 +0530 (Fri, 16 Dec 2022)");
  script_name("Mozilla Firefox ESR Security Update(mfsa_2022-51_2022-53)-Windows");
