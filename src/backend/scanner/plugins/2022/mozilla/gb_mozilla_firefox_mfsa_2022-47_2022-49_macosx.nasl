...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Update(mfsa_2022-47_2022-49)-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade Mozilla Firefox to version 107
