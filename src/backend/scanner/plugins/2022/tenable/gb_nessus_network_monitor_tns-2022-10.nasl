...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118431");
  ...
  script_cve_id("CVE-2021-3711", "CVE-2021-3712", "CVE-2021-4160", "CVE-2022-0778",
  ...
  script_name("Tenable Nessus Network Monitor < 6.0.1 Multiple Vulnerabilities (TNS-2022-10)");
  ...
  script_tag(name:"insight", value:"Several third-party components (OpenSSL and jQuery UI) were found
  to contain vulnerabilities, and updated versions have been made available by the providers.

  Nessus Network Monitor 6.0.1 updates OpenSSL to version 1.1.1n and jQueryUI to 1.13.0 to
  address the identified vulnerabilities.");

  script_tag(name:"affected", value:"Tenable Nessus Network Monitor prior to version 6.0.1.");

  script_tag(name:"solution", value:"Update to version 6.0.1 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2022-10");
