...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118412");
  ...
  script_name("Tenable Nessus < 8.15.6 Multiple Vulnerabilities (TNS-2022-16)");
  ...
  script_tag(name:"insight", value:"Two separate vulnerabilities that utilize the Audit
  functionality in Nessus were discovered, reported and fixed. Nessus version 8.15.6 fixes the
  reported Audit function vulnerabilities.
  ...
  script_tag(name:"affected", value:"Tenable Nessus prior to version 8.15.6.");

  script_tag(name:"solution", value:"Update to version 8.15.6 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2022-16");
...
if (version_is_less(version: version, test_version: "8.15.6")) {
