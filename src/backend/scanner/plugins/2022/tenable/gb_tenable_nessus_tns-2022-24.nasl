...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118418");
  script_version("2022-11-11T15:28:34+0000");
  script_tag(name:"last_modification", value:"2022-11-11 15:28:34 +0000 (Fri, 11 Nov 2022)");
  ...
  script_name("Tenable Nessus < 10.4.1 Multiple Vulnerabilities (TNS-2022-24)");
  ...
  Nessus 10.4.1 updates expat to version 2.5.0 and OpenSSL to 3.0.7 to address the identified
  vulnerabilities.");

  script_tag(name:"affected", value:"Tenable Nessus prior to version 10.4.1.");

  script_tag(name:"solution", value:"Update to version 10.4.1 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2022-24");
