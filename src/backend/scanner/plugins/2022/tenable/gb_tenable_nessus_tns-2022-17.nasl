...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118413");
  script_version("2022-11-10T15:40:37+0000");
  script_tag(name:"last_modification", value:"2022-11-10 15:40:37 +0000 (Thu, 10 Nov 2022)");
  ...
  script_name("Tenable Nessus Agent < 8.3.4 Multiple Vulnerabilities (TNS-2022-17)");
  ...
  functionality were identified, reported and fixed. With the release of Nessus Agent 8.3.4,
  ...
  script_tag(name:"affected", value:"Tenable Nessus Agent prior to version 8.3.4.");

  script_tag(name:"solution", value:"Update to version 8.3.4 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2022-17");
