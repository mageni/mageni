...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170059");
  ...
  script_cve_id("CVE-2018-18641");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 8.10.x - 11.2.6, 11.3.x - 11.3.7, 11.4.x - 11.4.2 Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a cleartext storage of sensitive information
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Personal access tokens are stored unencrypted as plain text in
  the database.");

  script_tag(name:"affected", value:"GitLab version 8.10.x through 11.2.6, 11.3.x through 11.3.7 and
  11.4.x through 11.4.2.");

  script_tag(name:"solution", value:"Update to version 11.2.7, 11.3.8, 11.4.3 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/51113");
...
if ( version_in_range( version:version, test_version:"8.10.0", test_version2:"11.2.6" ) ) {
