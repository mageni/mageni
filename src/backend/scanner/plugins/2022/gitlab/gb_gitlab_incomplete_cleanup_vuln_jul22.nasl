...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170146");
  ...
  script_cve_id("CVE-2022-2307");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 13.x - 15.0.4, 15.1.x - 15.1.3, 15.2 Incomplete Cleanup Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to an incomplete cleanup vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"A lack of cascading deletes allows a malicious Group Owner to
  retain a usable Group Access Token even after the Group is deleted, though the APIs usable by that
  token are limited.");

  script_tag(name:"affected", value:"GitLab version 13.x through 15.0.4, 15.1.x through 15.1.3
  and 15.2.");
...
if ( version_in_range( version:version, test_version:"13.0.0", test_version2:"15.0.4" ) ) {
