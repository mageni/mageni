...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170150");
  script_version("2022-08-08T20:20:02+0000");
  script_tag(name:"last_modification", value:"2022-08-08 20:20:02 +0000 (Mon, 08 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-08 12:51:53 +0000 (Mon, 08 Aug 2022)");
  script_tag(name:"cvss_base", value:"5.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:N");

  script_cve_id("CVE-2022-2497");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 12.6.x - 15.0.4, 15.1.x - 15.1.3, 15.2 Information Exposure Vulnerability");
  ...
  script_tag(name:"insight", value:"A malicious maintainer could exfiltrate an integration's access
  token by modifying the integration URL such that authenticated requests are sent to an attacker
  controlled server.");

  script_tag(name:"affected", value:"GitLab version 12.6.x through 15.0.4, 15.1.x through 15.1.3
  and 15.2.");
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2497.json");
...
if ( version_in_range( version:version, test_version:"12.6.0", test_version2:"15.0.4" ) ) {
