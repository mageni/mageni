...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170148");
  script_version("2022-08-08T20:20:02+0000");
  script_tag(name:"last_modification", value:"2022-08-08 20:20:02 +0000 (Mon, 08 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-08 10:20:34 +0000 (Mon, 08 Aug 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:C/A:N");

  script_cve_id("CVE-2022-2417");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 12.10.x - 15.0.4, 15.1.x - 15.1.3, 15.2 Improper Input Validation Vulnerability");
  ...
  script_tag(name:"insight", value:"Insufficient validation in GitLab CE/EE allows an authenticated
  and authorized user to import a project that includes branch names which are 40 hexadecimal
  characters, which could be abused in supply chain attacks where a victim pinned to a specific Git
  commit of the project.");

  script_tag(name:"affected", value:"GitLab version 12.10.x through 15.0.4, 15.1.x through 15.1.3
  and 15.2.");
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2417.json");
...
if ( version_in_range( version:version, test_version:"12.10.0", test_version2:"15.0.4" ) ) {
