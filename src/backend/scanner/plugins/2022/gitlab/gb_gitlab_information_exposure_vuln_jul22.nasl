...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170147");
  ...
  script_cve_id("CVE-2022-2534");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 9.3.x - 15.0.4, 15.1.x - 15.1.3, 15.2 Information Exposure Vulnerability");
  ...
  script_tag(name:"insight", value:"GitLab is returning contributor emails due to improper data
  handling in the Datadog integration.");

  script_tag(name:"affected", value:"GitLab version 9.3.x through 15.0.4, 15.1.x through 15.1.3
  and 15.2.");
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2534.json");
  exit(0);
}
...
if ( version_in_range( version:version, test_version:"9.3.0", test_version2:"15.0.4" ) ) {
