...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170214");
  ...
  script_name("GitLab 7.14 < 15.3.5, 15.4 < 15.4.4, 15.5 < 15.5.2 Improper Authorization Vulnerability");
  ...
  script_tag(name:"insight", value:"Improper authorization in GitLab allows a user retrying a job in
  a downstream pipeline to take ownership of the retried jobs in the upstream pipeline even if the
  user doesn't have access to that project.");

  script_tag(name:"affected", value:"GitLab version 7.14.x and above prior to 15.3.5, 15.4.x prior to
  15.4.4 and 15.5.x prior to 15.5.2.");

  script_tag(name:"solution", value:"Update to version 15.3.5, 15.4.4, 15.5.2 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-3706.json");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"7.4", test_version_up:"15.3.5" ) ) {
