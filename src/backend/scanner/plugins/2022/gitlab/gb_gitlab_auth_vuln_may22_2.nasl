...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126008");
  ...
  script_tag(name:"severity_date", value:"2022-05-18 20:21:00 +0000 (Wed, 18 May 2022)");

  script_cve_id("CVE-2022-1426");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 12.6.0 < 14.8.6, 14.9.x < 14.9.4, 14.10.x < 14.10.1 Authentication Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to an authentication vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"GitLab is not correctly authenticating a user that has some
  certain amount of information which allows a user to authenticate without a personal access
  token.");

  script_tag(name:"affected", value:"GitLab version 12.6.0 through 14.8.5, 14.9.x through 14.9.3
  and version 14.10.0.");
...
if ( version_in_range( version:version, test_version:"12.6.0", test_version2:"14.8.5" ) ) {
