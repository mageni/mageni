...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170153");
  ...
  script_cve_id("CVE-2022-2512");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 15.x - 15.0.4, 15.1.x - 15.1.3, 15.2 Improper Access Control Vulnerability");
  ...
  script_tag(name:"insight", value:"Membership changes are not reflected in TODO for confidential
  notes, allowing former project members to read updates via TODOs.");

  script_tag(name:"affected", value:"GitLab version 15.x through 15.0.4, 15.1.x through 15.1.3
  and 15.2.");
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2512.json");
  exit(0);
}
...
if ( version_in_range( version:version, test_version:"15.0.0", test_version2:"15.0.4" ) ) {
