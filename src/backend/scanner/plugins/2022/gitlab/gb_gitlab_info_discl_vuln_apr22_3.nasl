...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147970");
  ...
  script_tag(name:"severity_date", value:"2022-04-04 19:14:00 +0000 (Mon, 04 Apr 2022)");

  script_cve_id("CVE-2022-0371");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab < 14.5.4, 14.6.x < 14.6.4, 14.7.x < 14.7.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"GitLab search may allow authenticated users to search other
  users by their respective private emails even if a user set their email to private.");

  script_tag(name:"affected", value:"GitLab prior to version 14.5.4, version 14.6.x through 14.6.3
  and 14.7.0.");
...
if (version_is_less(version: version, test_version: "14.5.4")) {
