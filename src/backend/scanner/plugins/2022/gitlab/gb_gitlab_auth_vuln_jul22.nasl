...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170154");
  ...
  script_cve_id("CVE-2022-2539");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 14.6.x - 15.0.4, 15.1.x - 15.1.3, 15.2 Improper Authorization Vulnerability");
  ...
  script_tag(name:"insight", value:"Unauthorized users can filter issues by contact and organization.");

  script_tag(name:"affected", value:"GitLab version 14.6.x through 15.0.4, 15.1.x through 15.1.3
  and 15.2.");
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2539.json");
...
if ( version_in_range( version:version, test_version:"14.6.0", test_version2:"15.0.4" ) ) {
