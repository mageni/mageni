...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170215");
  ...
  script_cve_id("CVE-2022-3483");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 12.1 < 15.3.5, 15.4 < 15.4.4, 15.5 < 15.5.2 Information Exposure Vulnerability");
  ...
  script_tag(name:"impact", value:"A malicious maintainer could exfiltrate a Datadog integration's
  access token by modifying the integration URL such that authenticated requests are sent to an
  attacker controlled server.");

  script_tag(name:"affected", value:"GitLab version 12.1.x and above prior to 15.3.5, 15.4.x prior to
  15.4.4 and 15.5.x prior to 15.5.2.");

  script_tag(name:"solution", value:"Update to version 15.3.5, 15.4.4, 15.5.2 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-3483.json");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"12.1", test_version_up:"15.3.5" ) ) {
