...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170220");
  ...
  script_cve_id("CVE-2022-3819");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 15.0 < 15.3.5, 15.4 < 15.4.4, 15.5 < 15.5.2 Improper Authorization Vulnerability");
  ...
  script_tag(name:"impact", value:"An improper authorization issue in GitLab CE/EE allows a malicious
  users to set emojis on internal notes they don't have access to.");

  script_tag(name:"affected", value:"GitLab version 15.x and above prior to 15.3.5, 15.4.x prior to
  15.4.4 and 15.5.x prior to 15.5.2.");

  script_tag(name:"solution", value:"Update to version 15.3.5, 15.4.4, 15.5.2 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-3819.json");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"15.0", test_version_up:"15.3.5" ) ) {
