...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118393");
  ...
  script_cve_id("CVE-2022-21635", "CVE-2022-21638", "CVE-2022-21641");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0 <= 8.0.29 Security Update (cpuoct2022) - Linux");
