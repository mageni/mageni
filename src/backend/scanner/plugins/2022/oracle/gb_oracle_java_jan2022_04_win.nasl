...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819967");
  ...
  script_name("Oracle Java SE Security Update (jan2022) 04 - Windows");
  ...
  and earlier, 7u321 (1.7.0.321) and earlier and 11.x through 11.0.13 on Windows.");
