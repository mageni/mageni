...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118384");
  ...
  script_cve_id("CVE-2022-21589");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server <= 5.7.39 / 8.0 <= 8.0.16 Security Update (cpuoct2022) - Linux");
  ...
  script_tag(name:"solution", value:"Update to version 5.7.40, 8.0.17 or later.");
...
else if (version_in_range(version: version, test_version: "8.0", test_version2: "8.0.16")) {
