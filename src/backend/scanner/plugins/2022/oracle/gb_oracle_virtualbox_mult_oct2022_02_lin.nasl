...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826587");
  ...
  script_tag(name:"creation_date", value:"2022-10-19 17:17:45 +0530 (Wed, 19 Oct 2022)");
  script_name("Oracle VirtualBox Security Update(oct2022) - Linux");
