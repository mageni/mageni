...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118386");
  ...
  script_cve_id("CVE-2022-21592");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server <= 5.7.39 / 8.0 <= 8.0.29 Security Update (cpuoct2022) - Linux");
  ...
  script_tag(name:"solution", value:"Update to version 5.7.40, 8.0.30 or later.");
