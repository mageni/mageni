...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148045");
  script_version("2022-05-04T03:48:45+0000");
  script_tag(name:"last_modification", value:"2022-05-04 10:05:48 +0000 (Wed, 04 May 2022)");
  script_tag(name:"creation_date", value:"2022-05-04 03:18:54 +0000 (Wed, 04 May 2022)");
  ...
  script_name("OpenSSL: c_rehash script allows command injection (CVE-2022-1292) - Linux");
