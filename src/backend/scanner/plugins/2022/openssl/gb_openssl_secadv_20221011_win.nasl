...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104354");
  script_version("2022-10-12T10:25:02+0000");
  script_tag(name:"last_modification", value:"2022-10-12 10:25:02 +0000 (Wed, 12 Oct 2022)");
  ...
  script_name("OpenSSL: Using a Custom Cipher with NID_undef may lead to NULL encryption (CVE-2022-3358) - Windows");
