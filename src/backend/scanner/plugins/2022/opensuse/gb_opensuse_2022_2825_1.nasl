...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854903");
  ...
  script_tag(name:"creation_date", value:"2022-08-17 01:04:16 +0000 (Wed, 17 Aug 2022)");
  script_name("openSUSE: Security Advisory for rsync (SUSE-SU-2022:2825-1)");
  ...
  package(s) announced via the SUSE-SU-2022:2825-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.2.3~150400.3.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rsync-debuginfo", rpm:"rsync-debuginfo~3.2.3~150400.3.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rsync-debugsource", rpm:"rsync-debugsource~3.2.3~150400.3.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
