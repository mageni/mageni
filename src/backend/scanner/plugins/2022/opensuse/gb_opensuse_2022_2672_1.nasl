...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854878");
  ...
  script_tag(name:"creation_date", value:"2022-08-05 01:01:47 +0000 (Fri, 05 Aug 2022)");
  script_name("openSUSE: Security Advisory for go1.18 (SUSE-SU-2022:2672-1)");
  ...
  package(s) announced via the SUSE-SU-2022:2672-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.18", rpm:"go1.18~1.18.5~150000.1.25.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.18-doc", rpm:"go1.18-doc~1.18.5~150000.1.25.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.18-race", rpm:"go1.18-race~1.18.5~150000.1.25.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.18", rpm:"go1.18~1.18.5~150000.1.25.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.18-doc", rpm:"go1.18-doc~1.18.5~150000.1.25.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.18-race", rpm:"go1.18-race~1.18.5~150000.1.25.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
