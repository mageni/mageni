...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822551");
  ...
  script_tag(name:"creation_date", value:"2022-09-27 01:03:51 +0000 (Tue, 27 Sep 2022)");
  script_name("openSUSE: Security Advisory for snakeyaml (SUSE-SU-2022:3397-1)");
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/4KYA7O77MLOZCR6FG5WEY5TZRITBLP2Y");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snakeyaml'
  package(s) announced via the SUSE-SU-2022:3397-1 advisory.");
  ...
  script_tag(name:"affected", value:"'snakeyaml' package(s) on openSUSE Leap 15.3, openSUSE Leap 15.4.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"snakeyaml", rpm:"snakeyaml~1.31~150200.3.8.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"snakeyaml-javadoc", rpm:"snakeyaml-javadoc~1.31~150200.3.8.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"snakeyaml", rpm:"snakeyaml~1.31~150200.3.8.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"snakeyaml-javadoc", rpm:"snakeyaml-javadoc~1.31~150200.3.8.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
