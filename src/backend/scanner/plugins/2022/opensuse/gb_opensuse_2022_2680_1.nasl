...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854885");
  ...
  script_name("openSUSE: Security Advisory for buildah (SUSE-SU-2022:2680-1)");
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/HKBDV4HGT6Y5PW5WOWYJF4JH6RFLLR4D");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah'
  package(s) announced via the SUSE-SU-2022:2680-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.25.1~150400.3.3.28", rls:"openSUSELeap15.4"))) {
    report += res;
  }
