...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854917");
  ...
  script_tag(name:"creation_date", value:"2022-08-24 01:01:57 +0000 (Wed, 24 Aug 2022)");
  script_name("openSUSE: Security Advisory for podman (SUSE-SU-2022:2839-1)");
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CZOW7SOZROZ5MNDL7JBPKQ2TGAMD3NXB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman'
  package(s) announced via the SUSE-SU-2022:2839-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~3.4.7~150300.9.9.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman-cni-config", rpm:"podman-cni-config~3.4.7~150300.9.9.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }
