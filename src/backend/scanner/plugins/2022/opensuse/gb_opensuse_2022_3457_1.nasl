...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822558");
  ...
  script_tag(name:"creation_date", value:"2022-09-29 01:02:12 +0000 (Thu, 29 Sep 2022)");
  script_name("openSUSE: Security Advisory for vsftpd (SUSE-SU-2022:3457-1)");
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/B6ADEQCQBS3OXDQC5YTUK7YW4Q2P6VR5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vsftpd'
  package(s) announced via the SUSE-SU-2022:3457-1 advisory.");
  ...
  script_tag(name:"affected", value:"'vsftpd' package(s) on openSUSE Leap 15.3.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vsftpd", rpm:"vsftpd~3.0.5~150200.12.9.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vsftpd-debuginfo", rpm:"vsftpd-debuginfo~3.0.5~150200.12.9.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vsftpd-debugsource", rpm:"vsftpd-debugsource~3.0.5~150200.12.9.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
