...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854370");
  ...
  script_tag(name:"creation_date", value:"2022-02-01 06:32:12 +0000 (Tue, 01 Feb 2022)");
  script_name("openSUSE: Security Advisory for MozillaThunderbird (openSUSE-SU-2021:4150-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:4150-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/OQOGFW6JISWI3PQR7AHD3OEX3SPELMFB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaThunderbird'
  package(s) announced via the openSUSE-SU-2021:4150-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird", rpm:"MozillaThunderbird~91.4.0~8.45.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-debuginfo", rpm:"MozillaThunderbird-debuginfo~91.4.0~8.45.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-debugsource", rpm:"MozillaThunderbird-debugsource~91.4.0~8.45.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-common", rpm:"MozillaThunderbird-translations-common~91.4.0~8.45.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-other", rpm:"MozillaThunderbird-translations-other~91.4.0~8.45.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }
