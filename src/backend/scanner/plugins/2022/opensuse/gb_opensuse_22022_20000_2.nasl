...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854541");
  script_version("2022-05-19T12:23:28+0000");
  script_cve_id("CVE-2017-8923", "CVE-2021-23343", "CVE-2021-32803", "CVE-2021-32804", "CVE-2021-3807", "CVE-2021-3918");
  ...
  script_tag(name:"creation_date", value:"2022-03-05 02:02:12 +0000 (Sat, 05 Mar 2022)");
  script_name("openSUSE: Security Advisory for nodejs8 (openSUSE-SU-22022:20000-2)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-22022:20000-2");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/T7SRHEBFFCU5FEJ7Y56VZHSCQ2L3DDKG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs8'
  package(s) announced via the openSUSE-SU-22022:20000-2 advisory.");
