...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for gst-plugins-good1.0 (USN-5555-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-August/006717.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gst-plugins-good1.0'
  package(s) announced via the USN-5555-1 advisory.");
...
CVE-2022-1925, CVE-2022-2122)");
  ...
  script_tag(name:"affected", value:"'gst-plugins-good1.0' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
