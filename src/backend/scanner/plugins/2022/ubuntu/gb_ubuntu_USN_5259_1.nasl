...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5259.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5259-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5259-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5259-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cron' package(s) announced via the USN-5259-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the postinst maintainer script in Cron unsafely
...
to cause a denial of service. (CVE-2019-9706)");
  ...
  script_tag(name:"affected", value:"'cron' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cron", ver:"3.0pl1-128ubuntu2+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
