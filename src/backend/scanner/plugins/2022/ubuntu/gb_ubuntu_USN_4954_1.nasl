...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4954.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-4954-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4954-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4954-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc' package(s) announced via the USN-4954-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jason Royes and Samuel Dytrych discovered that the memcpy()
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc6", ver:"2.23-0ubuntu11.3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
