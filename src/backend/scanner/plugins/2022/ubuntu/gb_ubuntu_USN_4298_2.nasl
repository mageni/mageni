...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2020.4298.2");
  script_cve_id("CVE-2019-13734", "CVE-2019-13750", "CVE-2019-13751", "CVE-2019-13752", "CVE-2019-13753", "CVE-2019-19926");
  ...
  script_name("Ubuntu: Security Advisory (USN-4298-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4298-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4298-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sqlite3' package(s) announced via the USN-4298-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4298-1 fixed several vulnerabilities in SQLite. This update provides
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsqlite3-0", ver:"3.8.2-1ubuntu2.2+esm2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"sqlite3", ver:"3.8.2-1ubuntu2.2+esm2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
