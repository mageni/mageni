...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2006.297.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-297-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-297-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-297-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'enigmail, mozilla-thunderbird' package(s) announced via the USN-297-1 advisory.");
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mozilla-thunderbird-enigmail", ver:"2:0.94-0ubuntu4.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-thunderbird", ver:"1.5.0.4-0ubuntu6.06", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
