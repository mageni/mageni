...
if(description)
{
  ...
  script_cve_id("CVE-2021-4002", "CVE-2021-4001", "CVE-2021-42739", "CVE-2021-43267");
  ...
  script_name("Ubuntu: Security Advisory for linux-oem-5.10 (USN-5207-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-January/006330.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.10'
  package(s) announced via the USN-5207-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.10.0-1053-oem", ver:"5.10.0-1053.55", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04", ver:"5.10.0.1053.55", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04b", ver:"5.10.0.1053.55", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
