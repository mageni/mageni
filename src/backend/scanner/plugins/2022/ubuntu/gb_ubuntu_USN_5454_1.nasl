...
if(description)
{
  ...
  script_cve_id("CVE-2022-26691", "CVE-2019-8842", "CVE-2020-10001");
  ...
  script_name("Ubuntu: Security Advisory for cups (USN-5454-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006597.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups'
  package(s) announced via the USN-5454-1 advisory.");
...
LTS.  (CVE-2019-8842, CVE-2020-10001)");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
