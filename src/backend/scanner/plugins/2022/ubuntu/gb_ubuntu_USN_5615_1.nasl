...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5615.1");
  ...
  script_tag(name:"severity_date", value:"2022-08-29 16:35:00 +0000 (Mon, 29 Aug 2022)");

  script_name("Ubuntu: Security Advisory (USN-5615-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5615-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5615-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sqlite3' package(s) announced via the USN-5615-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that SQLite incorrectly handled INTERSEC query
...
(CVE-2021-20223)");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sqlite3", ver:"3.22.0-1ubuntu0.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sqlite3", ver:"3.31.1-4ubuntu0.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
