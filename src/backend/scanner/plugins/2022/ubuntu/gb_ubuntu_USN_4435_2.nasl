...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2020.4435.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-4435-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4435-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4435-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the USN-4435-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4435-1 fixed several vulnerabilities in ClamAV. This update provides
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"clamav", ver:"0.102.4+dfsg-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"clamav", ver:"0.102.4+dfsg-0ubuntu0.14.04.1+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
