...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for php8.0 (USN-5303-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006421.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php8.0'
  package(s) announced via the USN-5303-1 advisory.");
...
or possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'php8.0' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS.");
