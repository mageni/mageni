...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5580.1");
  script_cve_id("CVE-2021-33655", "CVE-2021-33656", "CVE-2022-20368", "CVE-2022-36946");
  ...
  script_name("Ubuntu: Security Advisory (USN-5580-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5580-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5580-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-5580-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.4.0-1150-aws", ver:"4.4.0-1150.165", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"4.4.0.1150.154", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
