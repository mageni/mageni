...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for python2.7 (USN-5519-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-July/006678.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7'
  package(s) announced via the USN-5519-1 advisory.");
...
An attacker could possibly use this issue to execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'python2.7' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
