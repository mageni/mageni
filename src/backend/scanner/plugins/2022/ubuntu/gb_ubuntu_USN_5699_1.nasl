...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5699.1");
  script_cve_id("CVE-2021-3326", "CVE-2021-35942");
  script_tag(name:"creation_date", value:"2022-10-26 11:04:25 +0000 (Wed, 26 Oct 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5699-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5699-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5699-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc' package(s) announced via the USN-5699-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc6", ver:"2.23-0ubuntu11.3+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
