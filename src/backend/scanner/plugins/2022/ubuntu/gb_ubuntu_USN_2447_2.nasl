...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2014.2447.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-2447-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-2447-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2447-2");
  script_xref(name:"URL", value:"http://bugs.launchpad.net/bugs/1390604");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-utopic' package(s) announced via the USN-2447-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-2447-1 fixed vulnerabilities in the Linux kernel. Due to an unrelated
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-generic-lpae", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-generic", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-lowlatency", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc-e500mc", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc-smp", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc64-emb", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc64-smp", ver:"3.16.0-28.38~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
