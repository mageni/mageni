...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for qemu (USN-5489-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006638.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu'
  package(s) announced via the USN-5489-1 advisory.");
...
code. (CVE-2022-26354)");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
