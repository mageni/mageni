...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for bash (USN-5380-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006510.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bash'
  package(s) announced via the USN-5380-1 advisory.");
...
possibly use this issue to escalate privileges.");
  ...
  script_tag(name:"affected", value:"'bash' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
