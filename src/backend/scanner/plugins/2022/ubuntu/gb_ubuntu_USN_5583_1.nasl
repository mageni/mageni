...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for systemd (USN-5583-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-August/006753.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the USN-5583-1 advisory.");
...
this issue to cause a crash or execute arbitrary code. (CVE-2022-2526)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on Ubuntu 18.04 LTS.");
