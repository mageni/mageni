...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3658.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-3658-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3658-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3658-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'procps' package(s) announced via the USN-3658-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3658-1 fixed a vulnerability in procps-ng. This update provides
...
Original advisory details:
 ...
 of service. (CVE-2018-1125)");
  ...
  script_tag(name:"affected", value:"'procps' package(s) on Ubuntu 12.04.");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"procps", ver:"1:3.2.8-11ubuntu6.6", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
