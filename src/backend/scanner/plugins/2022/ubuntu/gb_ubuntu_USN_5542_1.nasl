...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for samba (USN-5542-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-August/006702.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the USN-5542-1 advisory.");
...
(CVE-2022-32746)");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on Ubuntu 22.04 LTS, Ubuntu 20.04 LTS.");
