...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5487.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5487-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5487-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5487-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1979577");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-5487-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5487-1 fixed several vulnerabilities in Apache. Unfortunately, that update introduced
...
Original advisory details:
 ...
 (CVE-2022-31813)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 14.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2-bin", ver:"2.4.7-1ubuntu4.22+esm6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.7-1ubuntu4.22+esm6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
