...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dosbox (USN-5356-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006484.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dosbox'
  package(s) announced via the USN-5356-1 advisory.");
...
(CVE-2019-12594)");
  ...
  script_tag(name:"affected", value:"'dosbox' package(s) on Ubuntu 18.04 LTS.");
