...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5635.1");
  ...
  script_tag(name:"creation_date", value:"2022-09-26 04:46:01 +0000 (Mon, 26 Sep 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5635-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5635-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5635-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gkeop' package(s) announced via the USN-5635-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1003-gkeop", ver:"5.15.0-1003.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gkeop-5.15", ver:"5.15.0.1003.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gkeop", ver:"5.15.0.1003.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
