...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2019.3937.2");
  script_cve_id("CVE-2017-15710", "CVE-2018-1301", "CVE-2018-1312", "CVE-2019-0217");
  ...
  script_name("Ubuntu: Security Advisory (USN-3937-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3937-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3937-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-3937-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3937-1 and USN-3627-1 fixed several vulnerabilities in Apache.
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2.2-bin", ver:"2.2.22-1ubuntu1.15", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
