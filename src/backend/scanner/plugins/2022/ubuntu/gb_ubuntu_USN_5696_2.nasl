...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5696.2");
  script_cve_id("CVE-2022-21589", "CVE-2022-21592", "CVE-2022-21608", "CVE-2022-21617");
  ...
  script_name("Ubuntu: Security Advisory (USN-5696-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5696-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5696-2");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-5.7' package(s) announced via the USN-5696-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5696-1 fixed several vulnerabilities in MySQL. This update provides
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.40-0ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
