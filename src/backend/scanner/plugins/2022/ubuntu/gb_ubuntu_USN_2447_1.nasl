...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2014.2447.1");
  script_cve_id("CVE-2014-3673", "CVE-2014-3687", "CVE-2014-3688", "CVE-2014-7825", "CVE-2014-7826", "CVE-2014-7970", "CVE-2014-8086", "CVE-2014-8134", "CVE-2014-8369", "CVE-2014-9090", "CVE-2014-9322");
  ...
  script_name("Ubuntu: Security Advisory (USN-2447-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-2447-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2447-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-utopic' package(s) announced via the USN-2447-1 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-generic-lpae", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-generic", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-lowlatency", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc-e500mc", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc-smp", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc64-emb", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc64-smp", ver:"3.16.0-28.37~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
