...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3817.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3817-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3817-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3817-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7' package(s) announced via the USN-3817-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3817-1 fixed a vulnerability in Python. This update provides
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python2.7-minimal", ver:"2.7.3-0ubuntu3.11", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.7", ver:"2.7.3-0ubuntu3.11", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
