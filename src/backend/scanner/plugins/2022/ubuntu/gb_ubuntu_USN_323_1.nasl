...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2006.323.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-323-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-323-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-323-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla' package(s) announced via the USN-323-1 advisory.");
...
malicious web site can exploit this to send back two ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU5.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mozilla-browser", ver:"2:1.7.13-0ubuntu05.04.1", rls:"UBUNTU5.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-mailnews", ver:"2:1.7.13-0ubuntu05.04.1", rls:"UBUNTU5.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-psm", ver:"2:1.7.13-0ubuntu05.04.1", rls:"UBUNTU5.04"))) {
    report += res;
  }
...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mozilla-browser", ver:"2:1.7.13-0ubuntu5.10.1", rls:"UBUNTU5.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-mailnews", ver:"2:1.7.13-0ubuntu5.10.1", rls:"UBUNTU5.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-psm", ver:"2:1.7.13-0ubuntu5.10.1", rls:"UBUNTU5.10"))) {
    report += res;
  }
