...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3430.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-3430-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3430-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3430-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1741262");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq' package(s) announced via the USN-3430-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3430-2 fixed several vulnerabilities. The update introduced a new
...
Original advisory details:
 ...
 service. (CVE-2017-14496)");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on Ubuntu 12.04.");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.59-4ubuntu0.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-utils", ver:"2.59-4ubuntu0.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq", ver:"2.59-4ubuntu0.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
