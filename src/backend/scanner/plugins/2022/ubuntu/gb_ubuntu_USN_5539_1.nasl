...
if(description)
{
  ...
  script_version("2022-08-03T08:43:00+0000");
  ...
  script_tag(name:"last_modification", value:"2022-08-03 08:43:00 +0000 (Wed, 03 Aug 2022)");
  ...
  script_name("Ubuntu: Security Advisory for linux-bluefield (USN-5539-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-July/006699.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-bluefield'
  package(s) announced via the USN-5539-1 advisory.");
