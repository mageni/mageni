...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for ldns (USN-5257-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-January/006378.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ldns'
  package(s) announced via the USN-5257-1 advisory.");
...
(CVE-2020-19860, CVE-2020-19861)");
  ...
  script_tag(name:"affected", value:"'ldns' package(s) on Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libldns2", ver:"1.7.0-3ubuntu4.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
