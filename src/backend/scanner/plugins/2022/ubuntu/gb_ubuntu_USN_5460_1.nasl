...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5460.1");
  script_cve_id("CVE-2022-0554", "CVE-2022-0572", "CVE-2022-0685", "CVE-2022-0714", "CVE-2022-0729", "CVE-2022-0943", "CVE-2022-1616", "CVE-2022-1619", "CVE-2022-1620", "CVE-2022-1621");
  ...
  script_name("Ubuntu: Security Advisory (USN-5460-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5460-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5460-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim' package(s) announced via the USN-5460-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Vim was incorrectly processing Vim buffers.
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:7.4.1689-3ubuntu1.5+esm6", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
