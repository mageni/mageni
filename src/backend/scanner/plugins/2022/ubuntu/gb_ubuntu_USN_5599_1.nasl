...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5599.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5599-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5599-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5599-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle' package(s) announced via the USN-5599-1 advisory.");
...
privileges. (CVE-2022-2959)");
  ...
  script_tag(name:"affected", value:"'linux-oracle' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1017-oracle", ver:"5.15.0-1017.22", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.15.0.1017.15", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
