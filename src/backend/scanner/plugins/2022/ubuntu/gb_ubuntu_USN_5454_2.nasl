...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5454.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5454-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5454-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5454-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups' package(s) announced via the USN-5454-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5454-1 fixed several vulnerabilities in CUPS. This update provides
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.1.3-4ubuntu0.11+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
