...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for php8.0 (USN-5300-3)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006432.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php8.0'
  package(s) announced via the USN-5300-3 advisory.");
