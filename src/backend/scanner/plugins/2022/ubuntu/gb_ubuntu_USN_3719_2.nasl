...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3719.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3719-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3719-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3719-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mutt' package(s) announced via the USN-3719-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3719-1 fixed a vulnerability in Mutt. This update provides
...
Original advisory details:
 ...
 CVE-2018-14362, CVE-2018-14349)");
  ...
  script_tag(name:"affected", value:"'mutt' package(s) on Ubuntu 12.04.");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mutt-patched", ver:"1.5.21-5ubuntu2.3", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mutt", ver:"1.5.21-5ubuntu2.3", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
