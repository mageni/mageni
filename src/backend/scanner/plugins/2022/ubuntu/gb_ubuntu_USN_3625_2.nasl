...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3625.2");
  script_cve_id("CVE-2015-8853", "CVE-2016-6185", "CVE-2017-6512", "CVE-2018-6913");
  ...
  script_name("Ubuntu: Security Advisory (USN-3625-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3625-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3625-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl' package(s) announced via the USN-3625-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3625-1 fixed a vulnerability in Perl. This update provides
...
Original advisory details:
 ...
 code. (CVE-2018-6913)");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on Ubuntu 12.04.");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"perl", ver:"5.14.2-6ubuntu2.7", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
