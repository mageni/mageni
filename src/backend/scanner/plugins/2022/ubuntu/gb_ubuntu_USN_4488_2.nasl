...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2020.4488.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-4488-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4488-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4488-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server' package(s) announced via the USN-4488-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4488-1 fixed several vulnerabilities in X.Org. This update provides
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:1.15.1-0ubuntu2.11+esm2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
