...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5777.1");
  script_cve_id("CVE-2022-24303", "CVE-2022-45198");
  ...
  script_name("Ubuntu: Security Advisory (USN-5777-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5777-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5777-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pillow' package(s) announced via the USN-5777-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Pillow incorrectly handled the deletion of temporary
...
to crash, resulting in a denial of service. (CVE-2022-45198)");
  ...
  script_tag(name:"affected", value:"'pillow' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-pil", ver:"7.0.0-4ubuntu0.7", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-pil", ver:"9.0.1-1ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
