...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"USN-35-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-35-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'imagemagick' package(s) announced via the USN-35-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Markus Meissner discovered several potential buffer overflows in some
...
if(release == "UBUNTU4.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"imagemagick", ver:"6.0.2.5-1ubuntu1.2", rls:"UBUNTU4.10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"perlmagick", ver:"6.0.2.5-1ubuntu1.2", rls:"UBUNTU4.10"))) {
    report += res;
  }
