...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5616.1");
  script_cve_id("CVE-2021-33061", "CVE-2022-1012", "CVE-2022-1729", "CVE-2022-1852", "CVE-2022-1943", "CVE-2022-1973", "CVE-2022-2503", "CVE-2022-2873", "CVE-2022-2959", "CVE-2022-32296");
  script_tag(name:"creation_date", value:"2022-09-19 05:23:03 +0000 (Mon, 19 Sep 2022)");
  ...
  script_tag(name:"severity_date", value:"2022-08-25 16:35:00 +0000 (Thu, 25 Aug 2022)");

  script_name("Ubuntu: Security Advisory (USN-5616-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5616-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5616-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg' package(s) announced via the USN-5616-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1015-intel-iotg", ver:"5.15.0-1015.20", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1015.16", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
