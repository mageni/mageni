...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2019.3985.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3985-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3985-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3985-2");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/MDS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the USN-3985-2 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libvirt-bin", ver:"1.2.2-0ubuntu13.1.28", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt0", ver:"1.2.2-0ubuntu13.1.28", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
