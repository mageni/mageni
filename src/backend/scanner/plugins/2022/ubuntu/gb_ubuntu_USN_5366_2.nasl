...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for fribidi (USN-5366-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006524.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fribidi'
  package(s) announced via the USN-5366-2 advisory.");
...
arbitrary code. (CVE-2022-25310)");
  ...
  script_tag(name:"affected", value:"'fribidi' package(s) on Ubuntu 22.04 LTS.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfribidi-bin", ver:"1.0.8-2ubuntu3.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfribidi-dev", ver:"1.0.8-2ubuntu3.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfribidi0", ver:"1.0.8-2ubuntu3.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
