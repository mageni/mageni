...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5705.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5705-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5705-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5705-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the USN-5705-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Chintan Shah discovered that LibTIFF incorrectly handled memory in
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.0.6-1ubuntu0.8+esm6", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
