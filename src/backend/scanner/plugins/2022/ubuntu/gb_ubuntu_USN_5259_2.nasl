...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for cron (USN-5259-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006544.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cron'
  package(s) announced via the USN-5259-2 advisory.");
