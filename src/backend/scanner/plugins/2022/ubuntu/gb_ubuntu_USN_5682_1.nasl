...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5682.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5682-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5682-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5682-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.4' package(s) announced via the USN-5682-1 advisory.");
...
use this to cause a denial of service (system crash). (CVE-2022-36879)");
  ...
  script_tag(name:"affected", value:"'linux-aws-5.4' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1086-aws", ver:"5.4.0-1086.93~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.4.0.1086.66", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
