...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2014.2449.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-2449-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-2449-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2449-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the USN-2449-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Neel Mehta discovered that NTP generated weak authentication keys. A remote
...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntp", ver:"1:4.2.4p8+dfsg-1ubuntu2.2", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntp", ver:"1:4.2.6.p3+dfsg-1ubuntu3.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntp", ver:"1:4.2.6.p5+dfsg-3ubuntu2.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntp", ver:"1:4.2.6.p5+dfsg-3ubuntu2.14.10.1", rls:"UBUNTU14.10"))) {
    report += res;
  }
