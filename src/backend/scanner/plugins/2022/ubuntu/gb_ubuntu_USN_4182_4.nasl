...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2019.4182.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-4182-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4182-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4182-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1854764");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'intel-microcode' package(s) announced via the USN-4182-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4182-2 provided updated Intel Processor Microcode. A regression
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20191115.1ubuntu0.14.04.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
