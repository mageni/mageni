...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for snapd (USN-5292-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006407.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snapd'
  package(s) announced via the USN-5292-2 advisory.");
...
snap did not properly manage the
...
privileges and execute arbitrary code. (CVE-2021-44731)");
  ...
  script_tag(name:"affected", value:"'snapd' package(s) on Ubuntu 20.04 LTS.");
