...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5694.1");
  script_cve_id("CVE-2020-12801", "CVE-2020-12803", "CVE-2022-26305", "CVE-2022-26306", "CVE-2022-26307", "CVE-2022-3140");
  script_tag(name:"creation_date", value:"2022-10-21 04:34:40 +0000 (Fri, 21 Oct 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5694-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5694-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5694-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice' package(s) announced via the USN-5694-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that LibreOffice incorrectly handled links using the
...
Ubuntu 18.04 LTS. (CVE-2022-26306, CVE-2022-26307)");
  ...
  script_tag(name:"affected", value:"'libreoffice' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice", ver:"1:6.0.7-0ubuntu0.18.04.12", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice", ver:"1:6.4.7-0ubuntu0.20.04.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice", ver:"1:7.3.6-0ubuntu0.22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
