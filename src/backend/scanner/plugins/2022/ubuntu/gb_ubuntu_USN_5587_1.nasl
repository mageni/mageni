...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for curl (USN-5587-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-September/006763.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl'
  package(s) announced via the USN-5587-1 advisory.");
...
host could possibly use this to cause denial-of-service.");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on Ubuntu 22.04 LTS, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
