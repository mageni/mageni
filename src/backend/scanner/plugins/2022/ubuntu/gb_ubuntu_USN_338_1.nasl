...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2006.338.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-338-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-338-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-338-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-dfsg-5.0' package(s) announced via the USN-338-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Dmitri Lenev discovered that arguments of setuid SQL functions were
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.0", ver:"5.0.22-0ubuntu6.06.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
