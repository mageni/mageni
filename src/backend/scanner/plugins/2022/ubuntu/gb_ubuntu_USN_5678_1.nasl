...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5678.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5678-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5678-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5678-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-gcp-4.15' package(s) announced via the USN-5678-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1137-gcp", ver:"4.15.0-1137.153", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1142-aws", ver:"4.15.0-1142.154", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-18.04", ver:"4.15.0.1142.142", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-lts-18.04", ver:"4.15.0.1137.153", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
