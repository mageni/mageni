...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for protobuf-c (USN-5531-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-July/006693.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'protobuf-c'
  package(s) announced via the USN-5531-1 advisory.");
...
cause a denial of service (system crash) via unspecified vectors.");
  ...
  script_tag(name:"affected", value:"'protobuf-c' package(s) on Ubuntu 22.04 LTS, Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"protobuf-c-compiler", ver:"1.3.3-1ubuntu2.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"protobuf-c-compiler", ver:"1.3.3-1ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
