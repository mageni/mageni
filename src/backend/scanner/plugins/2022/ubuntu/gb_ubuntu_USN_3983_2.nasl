...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2019.3983.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3983-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3983-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3983-2");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/MDS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-trusty' package(s) announced via the USN-3983-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3983-1 fixed vulnerabilities in the Linux kernel for Ubuntu 14.04
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.13.0-170-generic-lpae", ver:"3.13.0-170.220~12.04.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.13.0-170-generic", ver:"3.13.0-170.220~12.04.2+signed1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.13.0-170-lowlatency", ver:"3.13.0-170.220~12.04.2+signed1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-lpae-lts-trusty", ver:"3.13.0.170.158", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-lts-trusty", ver:"3.13.0.170.158", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
