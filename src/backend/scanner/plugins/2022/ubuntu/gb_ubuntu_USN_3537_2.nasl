...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3537.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3537-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3537-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3537-2");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-5.5' package(s) announced via the USN-3537-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3537-1 fixed vulnerabilities in MySQL. This update
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.5", ver:"5.5.59-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
