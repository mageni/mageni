...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2006.362.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-362-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-362-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-362-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php4, php5' package(s) announced via the USN-362-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The stripos() function did not check for invalidly long or empty
...
if(release == "UBUNTU5.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-php4", ver:"4:4.3.10-10ubuntu4.8", rls:"UBUNTU5.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php4-cgi", ver:"4:4.3.10-10ubuntu4.8", rls:"UBUNTU5.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php4-cli", ver:"4:4.3.10-10ubuntu4.8", rls:"UBUNTU5.04"))) {
    report += res;
  }
...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-php5", ver:"5.0.5-2ubuntu1.5", rls:"UBUNTU5.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php5-cgi", ver:"5.0.5-2ubuntu1.5", rls:"UBUNTU5.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php5-cli", ver:"5.0.5-2ubuntu1.5", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-php5", ver:"5.1.2-1ubuntu3.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php5-cgi", ver:"5.1.2-1ubuntu3.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php5-cli", ver:"5.1.2-1ubuntu3.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
