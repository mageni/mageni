...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2019.4202.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-4202-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4202-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4202-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-4202-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that a specially crafted S/MIME message with an inner
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:68.2.1+build1-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:68.2.1+build1-0ubuntu0.19.10.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
