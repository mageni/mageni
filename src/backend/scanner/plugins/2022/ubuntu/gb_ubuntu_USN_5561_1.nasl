...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2022-08-11 01:01:09 +0000 (Thu, 11 Aug 2022)");
  script_name("Ubuntu: Security Advisory for epiphany-browser (USN-5561-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-August/006722.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'epiphany-browser'
  package(s) announced via the USN-5561-1 advisory.");
...
(CVE-2022-29536)");
  ...
  script_tag(name:"affected", value:"'epiphany-browser' package(s) on Ubuntu 22.04 LTS, Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"epiphany-browser", ver:"42.1-1ubuntu1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"epiphany-browser", ver:"3.36.4-0ubuntu2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
