...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5731.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5731-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5731-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5731-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'multipath-tools' package(s) announced via the USN-5731-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that multipath-tools incorrectly handled symlinks. A
...
issues, to escalate privileges. (CVE-2022-41974)");
  ...
  script_tag(name:"affected", value:"'multipath-tools' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 22.10.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"multipath-tools", ver:"0.7.4-2ubuntu3.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"multipath-tools", ver:"0.8.3-1ubuntu2.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"multipath-tools", ver:"0.8.8-1ubuntu1.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"multipath-tools", ver:"0.8.8-1ubuntu1.22.10.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
