...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2017.3346.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-3346-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3346-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3346-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-3346-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3346-1 and USN-3346-2 fixed two vulnerabilities in Bind and a regression,
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.8.1.dfsg.P1-4ubuntu0.23", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
