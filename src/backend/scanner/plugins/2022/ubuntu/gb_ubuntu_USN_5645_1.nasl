...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5645.1");
  script_cve_id("CVE-2021-23214", "CVE-2021-32027");
  ...
  script_name("Ubuntu: Security Advisory (USN-5645-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5645-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5645-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-9.5' package(s) announced via the USN-5645-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.5", ver:"9.5.25-0ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
