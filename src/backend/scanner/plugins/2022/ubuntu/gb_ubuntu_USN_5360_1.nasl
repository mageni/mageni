...
if(description)
{
  ...
  script_cve_id("CVE-2020-13943", "CVE-2020-17527", "CVE-2021-25122", "CVE-2021-30640", "CVE-2020-9484", "CVE-2021-33037", "CVE-2020-9494", "CVE-2021-25329", "CVE-2021-41079");
  ...
  script_name("Ubuntu: Security Advisory for tomcat9 (USN-5360-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006486.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat9'
  package(s) announced via the USN-5360-1 advisory.");
...
denial of service. (CVE-2020-9494, CVE-2021-25329, CVE-2021-41079)");
  ...
  script_tag(name:"affected", value:"'tomcat9' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
