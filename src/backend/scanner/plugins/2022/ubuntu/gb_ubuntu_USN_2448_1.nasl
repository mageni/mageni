...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2014.2448.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-2448-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-2448-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2448-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2448-1 advisory.");
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-generic-lpae", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-generic", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-lowlatency", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc-e500mc", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc-smp", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc64-emb", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-28-powerpc64-smp", ver:"3.16.0-28.37", rls:"UBUNTU14.10"))) {
    report += res;
  }
