...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2018.3587.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3587-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3587-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3587-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot' package(s) announced via the USN-3587-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3587-1 fixed a vulnerability in Dovecot. This update provides
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.0.19-0ubuntu2.5", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
