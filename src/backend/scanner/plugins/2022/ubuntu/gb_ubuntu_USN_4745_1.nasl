...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4745.1");
  script_cve_id("CVE-2020-1971", "CVE-2021-23841");
  ...
  script_name("Ubuntu: Security Advisory (USN-4745-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4745-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4745-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the USN-4745-1 advisory.");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.0.0", ver:"1.0.1-4ubuntu5.45", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.0.0", ver:"1.0.1f-1ubuntu2.27+esm2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
