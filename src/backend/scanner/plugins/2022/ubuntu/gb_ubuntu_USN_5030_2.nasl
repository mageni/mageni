...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5030.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5030-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5030-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5030-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libdbi-perl' package(s) announced via the USN-5030-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5030-1 addressed vulnerabilities in Perl DBI module. This
...
Original advisory details:
 ...
 module to crash, resulting in a denial of service. (CVE-2020-14393)");
  ...
  script_tag(name:"affected", value:"'libdbi-perl' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdbi-perl", ver:"1.634-1ubuntu0.2+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
