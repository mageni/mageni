...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2017.3424.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-3424-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-3424-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3424-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2' package(s) announced via the USN-3424-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3424-1 fixed several vulnerabilities in libxml2. This update
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml2", ver:"2.7.8.dfsg-5.1ubuntu4.18", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
