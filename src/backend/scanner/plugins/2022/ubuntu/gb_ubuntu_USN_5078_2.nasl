...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.5078.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5078-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5078-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5078-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools' package(s) announced via the USN-5078-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5078-1 fixed several vulnerabilities in Squashfs-Tools.
...
Original advisory details:
 ...
 write arbitrary files to the filesystem. (CVE-2021-41072)");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squashfs-tools", ver:"1:4.3-3ubuntu2.16.04.3+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
