...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2006.289.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-289-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-289-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-289-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the USN-289-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A buffer overflow has been found in the tiff2pdf utility. By tricking
...
remote arbitrary code execution with the privileges of that system. (In
...
if(release == "UBUNTU5.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"3.6.1-5ubuntu0.5", rls:"UBUNTU5.04"))) {
    report += res;
  }
...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"3.7.3-1ubuntu1.4", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"3.7.4-1ubuntu3.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
