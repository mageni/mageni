...
if(description)
{
  ...
  script_cve_id("CVE-2022-2588", "CVE-2022-2586", "CVE-2022-2585", "CVE-2022-1652", "CVE-2022-1679", "CVE-2022-28893", "CVE-2022-29900", "CVE-2022-29901", "CVE-2022-34918");
  ...
  script_tag(name:"creation_date", value:"2022-08-11 01:01:13 +0000 (Thu, 11 Aug 2022)");
  script_name("Ubuntu: Security Advisory for linux-aws (USN-5566-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-August/006728.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws'
  package(s) announced via the USN-5566-1 advisory.");
...
to escalate privileges in certain situations. (CVE-2022-34918)");
  ...
  script_tag(name:"affected", value:"'linux-aws' package(s) on Ubuntu 22.04 LTS, Ubuntu 20.04 LTS.");
