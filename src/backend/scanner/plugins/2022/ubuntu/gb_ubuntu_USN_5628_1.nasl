...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5628.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5628-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5628-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5628-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'etcd' package(s) announced via the USN-5628-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that etcd incorrectly handled certain specially crafted
...
service. (CVE-2020-15114)");
  ...
  script_tag(name:"affected", value:"'etcd' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"etcd-client", ver:"3.2.26+dfsg-6ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"etcd-server", ver:"3.2.26+dfsg-6ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"etcd", ver:"3.2.26+dfsg-6ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
