...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5714.1");
  script_cve_id("CVE-2022-2519", "CVE-2022-2520", "CVE-2022-2521", "CVE-2022-2867", "CVE-2022-2868", "CVE-2022-2869", "CVE-2022-2953", "CVE-2022-34526", "CVE-2022-3570", "CVE-2022-3598", "CVE-2022-3599", "CVE-2022-3626", "CVE-2022-3627");
  script_tag(name:"creation_date", value:"2022-11-09 04:27:23 +0000 (Wed, 09 Nov 2022)");
  script_version("2022-11-09T04:27:23+0000");
  script_tag(name:"last_modification", value:"2022-11-09 04:27:23 +0000 (Wed, 09 Nov 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5714-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5714-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5714-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the USN-5714-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that LibTIFF incorrectly handled certain memory operations
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.0.3-7ubuntu0.11+esm5", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.0.6-1ubuntu0.8+esm7", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.0.9-5ubuntu0.8", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.1.0+git191117-2ubuntu0.20.04.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.3.0-6ubuntu0.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.4.0-4ubuntu3.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
