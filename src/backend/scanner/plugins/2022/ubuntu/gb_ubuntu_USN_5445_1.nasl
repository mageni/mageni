...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for subversion (USN-5445-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006585.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'subversion'
  package(s) announced via the USN-5445-1 advisory.");
...
service. (CVE-2020-17525)");
  ...
  script_tag(name:"affected", value:"'subversion' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-svn", ver:"1.9.7-4ubuntu1.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsvn1", ver:"1.9.7-4ubuntu1.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"subversion", ver:"1.9.7-4ubuntu1.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-svn", ver:"1.13.0-3ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsvn1", ver:"1.13.0-3ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"subversion", ver:"1.13.0-3ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
