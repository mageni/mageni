...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2006.345.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-345-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-345-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-345-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman' package(s) announced via the USN-345-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Steve Alexander discovered that mailman did not properly handle
...
messages into the log.");
  ...
  script_tag(name:"affected", value:"'mailman' package(s) on Ubuntu 5.04, Ubuntu 5.10, Ubuntu 6.06.");
...
if(release == "UBUNTU5.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-7ubuntu0.3", rls:"UBUNTU5.04"))) {
    report += res;
  }
...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-8ubuntu2.3", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-9ubuntu4.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
