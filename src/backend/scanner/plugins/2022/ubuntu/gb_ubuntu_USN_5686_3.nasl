...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5686.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-5686-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5686-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5686-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'git' package(s) announced via the USN-5686-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5686-1 fixed vulnerabilities in Git. This update provides the corresponding
...
Original advisory details:
 ...
 (CVE-2022-39260)");
  ...
  script_tag(name:"affected", value:"'git' package(s) on Ubuntu 22.10.");
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.37.2-1ubuntu1.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
