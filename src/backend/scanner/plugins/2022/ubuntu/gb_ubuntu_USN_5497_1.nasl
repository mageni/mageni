...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5497.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5497-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5497-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5497-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libjpeg6b' package(s) announced via the USN-5497-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Libjpeg6b was not properly performing bounds
...
cause a denial of service. (CVE-2020-14152)");
  ...
  script_tag(name:"affected", value:"'libjpeg6b' package(s) on Ubuntu 14.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libjpeg62", ver:"6b1-4ubuntu1+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
