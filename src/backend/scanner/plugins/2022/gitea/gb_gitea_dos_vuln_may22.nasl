...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170095");
  script_version("2022-05-05T13:17:27+0000");
  script_tag(name:"last_modification", value:"2022-05-06 10:15:46 +0000 (Fri, 06 May 2022)");
  script_tag(name:"creation_date", value:"2022-05-04 14:10:49 +0000 (Wed, 04 May 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-05-03 15:40:00 +0000 (Tue, 03 May 2022)");

  script_cve_id("CVE-2022-27313");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Gitea < 1.16.4 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"An arbitrary file deletion vulnerability allows attackers to
  cause a denial of service (DoS) via deleting the configuration file.");
  ...
  script_xref(name:"URL", value:"https://github.com/go-gitea/gitea/pull/19072");
