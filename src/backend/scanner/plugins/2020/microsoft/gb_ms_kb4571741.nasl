...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817261");
  ...
  script_cve_id("CVE-2020-1046", "CVE-2020-1337", "CVE-2020-1339", "CVE-2020-1377",
                ...
                "CVE-2020-1522", "CVE-2020-1525", "CVE-2020-1526", "CVE-2020-1527",
                "CVE-2020-1528", "CVE-2020-1529", "CVE-2020-1530", "CVE-2020-1531",
                ...
                "CVE-2020-1554", "CVE-2020-1555", "CVE-2020-1556", "CVE-2020-1557",
                "CVE-2020-1558", "CVE-2020-1561", "CVE-2020-1562", "CVE-2020-1564",
                "CVE-2020-1565", "CVE-2020-1566", "CVE-2020-1567", "CVE-2020-1568",
                "CVE-2020-1570", "CVE-2020-1577", "CVE-2020-1579", "CVE-2020-1584",
                "CVE-2020-1587");
  ...
  script_tag(name:"creation_date", value:"2020-08-12 09:52:14 +0530 (Wed, 12 Aug 2020)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4571741)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4571741");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4571741");
...
if(version_in_range(version:fileVer, test_version:"10.0.16299.0", test_version2:"10.0.16299.2044"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Updateagent.dll",
                            file_version:fileVer, vulnerable_range:"10.0.16299.0 - 10.0.16299.2044");
