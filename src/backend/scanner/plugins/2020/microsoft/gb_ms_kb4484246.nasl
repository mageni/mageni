...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815590");
  ...
  script_tag(name:"creation_date", value:"2020-04-15 10:23:15 +0530 (Wed, 15 Apr 2020)");
  script_name("Microsoft PowerPoint 2016 RCE Vulnerability (KB4484246)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484246");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484246");
...
foreach key(key_list)
{
  ...
  if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.4993.1001"))
  {
