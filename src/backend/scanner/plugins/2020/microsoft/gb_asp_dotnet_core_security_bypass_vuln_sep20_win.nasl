...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817387");
  ...
  script_name(".NET Core Security Feature Bypass Vulnerability (Sep 2020)");
...
if (coreVers =~ "^2\.1" && version_is_less(version:coreVers, test_version:"2.1.22")){
  fix = "2.1.22";
}

else if (coreVers =~ "^3\.1" && version_is_less(version:coreVers, test_version:"3.1.8")){
  fix = "3.1.8" ;
}
