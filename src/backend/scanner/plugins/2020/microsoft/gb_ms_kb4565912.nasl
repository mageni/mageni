...
fileVer = fetch_file_version(sysPath:dllPath, file_name:"Netsetupapi.dll");
if(!fileVer){
  exit(0);
}

if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.3800"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Netsetupapi.dll",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.3800");
