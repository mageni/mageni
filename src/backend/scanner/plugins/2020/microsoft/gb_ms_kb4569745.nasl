...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817324");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB4569745)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4569745");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5 and 4.8 for Microsoft Windows 10 Version 2004.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4569745");
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ...
              else if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9153"))
              {
                vulnerable_range = "2.0.50727 - 2.0.50727.9153" ;
                break;
              }
            }
          }
