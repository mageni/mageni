...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818318");
  ...
  script_tag(name:"creation_date", value:"2021-06-10 07:49:18 +0530 (Thu, 10 Jun 2021)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5003646)");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/topic/june-8-2021-kb5003646-os-build-17763-1999-81e2ff5a-0769-4e56-8762-059dd6e0d6bb");
...
if(version_in_range(version:fileVer, test_version:"10.0.17763.0", test_version2:"10.0.17763.1998"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.17763.0 - 10.0.17763.1998");
