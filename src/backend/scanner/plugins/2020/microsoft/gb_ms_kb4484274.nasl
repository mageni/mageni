...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816878");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 10:18:54 +0530 (Thu, 16 Apr 2020)");
  script_name("Microsoft Outlook 2016 Remote Code Execution Vulnerability (KB4484274)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484274");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484274");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.4993.1000")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.4993.1000");
