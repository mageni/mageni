...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817054");
  ...
  script_tag(name:"creation_date", value:"2020-06-10 11:21:20 +0530 (Wed, 10 Jun 2020)");
  script_name("Microsoft Project 2013 Information Disclosure Vulnerability (KB4484369)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484369");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484369");
...
if(version_in_range(version:proVer, test_version:"15.0.5172.0", test_version2:"15.0.5249.0999"))
{
  report = report_fixed_ver(file_checked:path + "\winproj.exe",
                            file_version:proVer, vulnerable_range:"15.0.5172.0 - 15.0.5249.0999");
