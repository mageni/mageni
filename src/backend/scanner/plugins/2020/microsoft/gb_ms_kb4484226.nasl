...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815589");
  ...
  script_tag(name:"creation_date", value:"2020-04-15 10:08:35 +0530 (Wed, 15 Apr 2020)");
  script_name("Microsoft PowerPoint 2013 Service Pack 1 RCE Vulnerability (KB4484226)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484226");
...
foreach key(key_list)
{
  ...
  if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5233.1000"))
  {
