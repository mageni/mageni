...
if(description)
{
  ...
  outlook and powerpoint software fails to properly handle specially crafted
  Office file.");

  script_tag(name:"impact", value:"Successful exploitation will allow an attacker
  to execute arbitrary code in the context of the current user and disclose
  sensitive information.");

  script_tag(name:"affected", value:"Microsoft Office 2019 on Mac OS X.");

  script_tag(name:"solution", value:"The security update for Microsoft Office 2019
  for Mac is not immediately available. Please see the references for more information.");
...
if(offVer =~ "^16\.")
{
  if(version_in_range(version:offVer, test_version:"16.17.0", test_version2:"16.43"))
  {
