...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817361");
  ...
  script_cve_id("CVE-2020-0648", "CVE-2020-0664", "CVE-2020-0718", "CVE-2020-0761",
                ...
                "CVE-2020-1097", "CVE-2020-1115", "CVE-2020-1119", "CVE-2020-1122",
                "CVE-2020-1129", "CVE-2020-1130", "CVE-2020-1133", "CVE-2020-1146",
                "CVE-2020-1152", "CVE-2020-1159", "CVE-2020-1162", "CVE-2020-1169",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4574727)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4574727");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4574727");
...
if(version_in_range(version:fileVer, test_version:"10.0.18362.0", test_version2:"10.0.18362.1081"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Gdiplus.dll",
                            file_version:fileVer, vulnerable_range:"10.0.18362.0 - 10.0.18362.1081");
