...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816889");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 14:13:19 +0530 (Thu, 16 Apr 2020)");
  script_name("Microsoft Project 2016 Remote Code Execution Vulnerability (KB4484269)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484269");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484269");
...
if(version_in_range(version:proVer, test_version:"16.0.4900.0", test_version2:"16.0.4993.1000"))
{
  report = report_fixed_ver(file_checked:proPath + "\Root\Office16\winproj.exe",
                            file_version:proVer, vulnerable_range:"16.0.4900.0 - 16.0.4993.1000");
