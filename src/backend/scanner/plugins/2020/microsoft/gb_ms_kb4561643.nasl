...
fileVer = fetch_file_version(sysPath:dllPath, file_name:"Atl.dll");
if(!fileVer){
  exit(0);
}

if(version_is_less(version:fileVer, test_version:"3.5.2284.0"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Atl.dll",
                            file_version:fileVer, vulnerable_range:"Less than 3.5.2284.0");
