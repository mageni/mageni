...
if(description)
{
  ...
  script_version("2020-01-06T11:34:20+0000");
  script_tag(name:"last_modification", value:"2020-01-06 11:34:20 +0000 (Mon, 06 Jan 2020)");
  ...
  able to inject arbitrary code into the site or even
