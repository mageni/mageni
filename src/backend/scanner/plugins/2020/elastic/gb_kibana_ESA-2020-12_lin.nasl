...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144430");
  script_version("2020-08-20T02:59:01+0000");
  script_tag(name:"last_modification", value:"2020-08-20 10:11:27 +0000 (Thu, 20 Aug 2020)");
  script_tag(name:"creation_date", value:"2020-08-20 02:47:17 +0000 (Thu, 20 Aug 2020)");
  ...
  script_name("Elastic Kibana < 6.8.12, 7.x < 7.9.0 Information Disclosure Vulnerability (Linux)");
  ...
  script_tag(name:"summary", value:"Kibana is prone to a field disclosure vulnerability.");
  ...
  script_tag(name:"affected", value:"Kibana prior to version 6.8.12 and 7.9.0.");
