...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817558");
  ...
  script_tag(name:"creation_date", value:"2020-12-16 11:20:33 +0530 (Wed, 16 Dec 2020)");
  script_name("Mozilla Thunderbird Security Updates(mfsa_2020-54_2020-56)-Windows");
