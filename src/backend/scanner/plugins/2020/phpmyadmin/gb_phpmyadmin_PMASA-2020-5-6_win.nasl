...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144897");
  script_version("2020-11-06T03:38:34+0000");
  script_tag(name:"last_modification", value:"2020-11-06 11:47:26 +0000 (Fri, 06 Nov 2020)");
  script_tag(name:"creation_date", value:"2020-11-06 03:22:55 +0000 (Fri, 06 Nov 2020)");
  ...
  script_name("phpMyAdmin < 4.9.6, 5.x < 5.0.3 Multiple Vulnerabilities - PMASA-2020-5, PMASA-2020-6 (Windows)");
