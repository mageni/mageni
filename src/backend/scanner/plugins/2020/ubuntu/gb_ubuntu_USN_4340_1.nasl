...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for cups (USN-4340-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-April/005403.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups'
  package(s) announced via the USN-4340-1 advisory.");
...
arbitrary code. (CVE-2020-3898)");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.2.12-2ubuntu1.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.2.7-1ubuntu2.8", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.1.3-4ubuntu0.11", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
