...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libiberty (USN-4326-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-April/005388.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libiberty'
  package(s) announced via the USN-4326-1 advisory.");
...
arbitrary code");
  ...
  script_tag(name:"affected", value:"'libiberty' package(s) on Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
