...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for apport (USN-4449-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-August/005545.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apport'
  package(s) announced via the USN-4449-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Ryota Shiga discovered that Apport incorrectly dropped privileges when
...
arbitrary code. (CVE-2020-15702)");
  ...
  script_tag(name:"affected", value:"'apport' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
