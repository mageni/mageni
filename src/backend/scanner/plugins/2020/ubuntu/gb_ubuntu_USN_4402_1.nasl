...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for curl (USN-4402-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-June/005488.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl'
  package(s) announced via the USN-4402-1 advisory.");
...
(CVE-2020-8177)");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on Ubuntu 20.04 LTS, Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
