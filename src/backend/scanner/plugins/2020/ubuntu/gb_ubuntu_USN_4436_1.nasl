...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for librsvg (USN-4436-1)");
  ...
  script_xref(name:"USN", value:"4436-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-July/005530.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'librsvg'
  package(s) announced via the USN-4436-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"librsvg2-2", ver:"2.40.20-2ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"librsvg2-2", ver:"2.40.13-3ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
