...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for pacemaker (USN-4623-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-November/005748.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pacemaker'
  package(s) announced via the USN-4623-1 advisory.");
...
to bypass ACL restrictions and execute arbitrary code as root.");
  ...
  script_tag(name:"affected", value:"'pacemaker' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pacemaker", ver:"2.0.3-3ubuntu4.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pacemaker", ver:"1.1.18-0ubuntu1.3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pacemaker", ver:"1.1.14-2ubuntu1.9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pacemaker", ver:"2.0.4-2ubuntu3.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
