...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878529");
  ...
  script_tag(name:"creation_date", value:"2020-10-27 04:14:42 +0000 (Tue, 27 Oct 2020)");
  script_name("Fedora: Security Advisory for dnf-plugins-core (FEDORA-2020-b40fc174b5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XDMHVY7OMIJNSPVZ2GJWHT77Z5V3YJ55");
...
provides generate_completion_cache passive plugin.");
  ...
  script_tag(name:"affected", value:"'dnf-plugins-core' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnf-plugins-core", rpm:"dnf-plugins-core~4.0.18~1.fc33", rls:"FC33"))) {
    report += res;
  }
