...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878290");
  ...
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2020-d5b2e71a17)");
  ...
  script_xref(name:"FEDORA", value:"2020-d5b2e71a17");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HYQPCHGCVKFS3H226QQKZFQP56JYOQ3T");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'community-mysql'
  package(s) announced via the FEDORA-2020-d5b2e71a17 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.21~11.fc31", rls:"FC31"))) {
    report += res;
  }
