...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877833");
  ...
  script_tag(name:"creation_date", value:"2020-05-15 03:23:44 +0000 (Fri, 15 May 2020)");
  script_name("Fedora: Security Advisory for pure-ftpd (FEDORA-2020-5ac8d4c11a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/22P44PECZWNDP7CMBL7NRBMNFS73C5Z2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pure-ftpd'
  package(s) announced via the FEDORA-2020-5ac8d4c11a advisory.");
...
Rebuild switches:
  ...
  script_tag(name:"affected", value:"'pure-ftpd' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pure-ftpd", rpm:"pure-ftpd~1.0.49~5.fc32", rls:"FC32"))) {
    report += res;
  }
