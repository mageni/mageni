...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877433");
  ...
  script_name("Fedora: Security Advisory for pure-ftpd (FEDORA-2020-74b71e5873)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PICL3U2J4EPGBLOE555Y5RAZTQL3WBBV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pure-ftpd'
  package(s) announced via the FEDORA-2020-74b71e5873 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pure-ftpd", rpm:"pure-ftpd~1.0.49~3.fc31", rls:"FC31"))) {
    report += res;
  }
