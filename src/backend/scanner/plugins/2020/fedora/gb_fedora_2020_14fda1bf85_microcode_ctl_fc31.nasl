...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878637");
  ...
  script_name("Fedora: Security Advisory for microcode_ctl (FEDORA-2020-14fda1bf85)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MAAGIK5CXKBPGY3R4UR5VO56M7MKLZ43");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl'
  package(s) announced via the FEDORA-2020-14fda1bf85 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~39.2.fc31", rls:"FC31"))) {
    report += res;
  }
