...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877599");
  ...
  script_name("Fedora: Security Advisory for nethack (FEDORA-2020-4c3d74204a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J3ZNHCZOGHXFXXQ2RKI3C76Y3MUOSDMW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nethack'
  package(s) announced via the FEDORA-2020-4c3d74204a advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nethack", rpm:"nethack~3.6.6~1.fc30", rls:"FC30"))) {
    report += res;
  }
