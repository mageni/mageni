...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878137");
  ...
  script_name("Fedora: Security Advisory for tor (FEDORA-2020-e30a990f5a)");
  ...
  script_xref(name:"FEDORA", value:"2020-e30a990f5a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/B2I2WEGDWMEPBJJE3YGSA7677W25WSBA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2020-e30a990f5a advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.3.6~1.fc31", rls:"FC31"))) {
    report += res;
  }
