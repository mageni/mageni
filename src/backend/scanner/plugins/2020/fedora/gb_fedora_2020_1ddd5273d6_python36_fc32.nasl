...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878172");
  ...
  script_tag(name:"creation_date", value:"2020-08-08 03:14:55 +0000 (Sat, 08 Aug 2020)");
  script_name("Fedora: Security Advisory for python36 (FEDORA-2020-1ddd5273d6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YILCHHTNLH4GG4GSQBX2MZRKZBXOLCKE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python36'
  package(s) announced via the FEDORA-2020-1ddd5273d6 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python36", rpm:"python36~3.6.11~3.fc32", rls:"FC32"))) {
    report += res;
  }
