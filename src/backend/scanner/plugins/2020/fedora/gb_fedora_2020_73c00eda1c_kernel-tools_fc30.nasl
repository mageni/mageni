...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877711");
  ...
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2020-73c00eda1c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TF4PQZBEPNXDSK5DOBMW54OCLP25FTCD");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.5.16~100.fc30", rls:"FC30"))) {
    report += res;
  }
