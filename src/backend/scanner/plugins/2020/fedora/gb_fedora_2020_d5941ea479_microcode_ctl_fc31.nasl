...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878653");
  ...
  script_tag(name:"creation_date", value:"2020-11-26 04:17:02 +0000 (Thu, 26 Nov 2020)");
  script_name("Fedora: Security Advisory for microcode_ctl (FEDORA-2020-d5941ea479)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NEM2FZWVE4FNGYNQU3WCBAWTZRBWDYUR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl'
  package(s) announced via the FEDORA-2020-d5941ea479 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~39.3.fc31", rls:"FC31"))) {
    report += res;
  }
