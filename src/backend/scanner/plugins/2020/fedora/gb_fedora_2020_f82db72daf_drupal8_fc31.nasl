...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877652");
  ...
  script_name("Fedora: Security Advisory for drupal8 (FEDORA-2020-f82db72daf)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A5DEUWFBH2HJ34OIJQMP64C3FKH73M46");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal8'
  package(s) announced via the FEDORA-2020-f82db72daf advisory.");
...
diverse community of people around the world.");
  ...
  script_tag(name:"affected", value:"'drupal8' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal8", rpm:"drupal8~8.8.4~1.fc31", rls:"FC31"))) {
    report += res;
  }
