...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877899");
  ...
  script_name("Fedora: Security Advisory for perl-Mojolicious (FEDORA-2020-cc7deffbf1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JBUG5I5NYLNO4I44N7J26C6RCVHX7M5Y");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Mojolicious'
  package(s) announced via the FEDORA-2020-cc7deffbf1 advisory.");
...
a new attempt at implementing this idea using state of the art technology.");
  ...
  script_tag(name:"affected", value:"'perl-Mojolicious' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Mojolicious", rpm:"perl-Mojolicious~8.42~1.fc32", rls:"FC32"))) {
    report += res;
  }
