...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878128");
  ...
  script_name("Fedora: Security Advisory for tor (FEDORA-2020-48653597f1)");
  ...
  script_xref(name:"FEDORA", value:"2020-48653597f1");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LYMATIV7PRGCHWGSIS2G4DGLZKQIY2CU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2020-48653597f1 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.3.6~1.fc32", rls:"FC32"))) {
    report += res;
  }
