...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877756");
  ...
  script_name("Fedora: Security Advisory for gnuchess (FEDORA-2020-8083181df6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TB4FURVE4C35UDXGAAHJL5NIHJQ3WDZT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnuchess'
  package(s) announced via the FEDORA-2020-8083181df6 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnuchess", rpm:"gnuchess~6.2.6~1.fc32", rls:"FC32"))) {
    report += res;
  }
