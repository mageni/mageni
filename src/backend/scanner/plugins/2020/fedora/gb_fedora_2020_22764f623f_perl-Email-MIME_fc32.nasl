...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877924");
  ...
  script_name("Fedora: Security Advisory for perl-Email-MIME (FEDORA-2020-22764f623f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VJFUIVJOQGZOYF4Q4RXPBJTBBZD5LXVK");
...
parts of the message. Headers are decoded from MIME encoding.");
  ...
  script_tag(name:"affected", value:"'perl-Email-MIME' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Email-MIME", rpm:"perl-Email-MIME~1.949~1.fc32", rls:"FC32"))) {
    report += res;
  }
