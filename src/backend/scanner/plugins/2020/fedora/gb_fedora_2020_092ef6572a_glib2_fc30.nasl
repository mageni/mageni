...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877506");
  ...
  script_name("Fedora: Security Advisory for glib2 (FEDORA-2020-092ef6572a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KJMLGW55HOQXHMTIPH2PWXFRBNBWVO4W");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2'
  package(s) announced via the FEDORA-2020-092ef6572a advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.60.7~3.fc30", rls:"FC30"))) {
    report += res;
  }
