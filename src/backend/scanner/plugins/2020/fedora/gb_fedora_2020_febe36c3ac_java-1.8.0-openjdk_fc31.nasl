...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878542");
  ...
  script_tag(name:"creation_date", value:"2020-10-31 04:14:04 +0000 (Sat, 31 Oct 2020)");
  script_name("Fedora: Security Advisory for java-1.8.0-openjdk (FEDORA-2020-febe36c3ac)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XKRGVMZT3EUUWKUA6DBT56FT3UOKPHQ2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk'
  package(s) announced via the FEDORA-2020-febe36c3ac advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.8.0-openjdk", rpm:"java-1.8.0-openjdk~1.8.0.272.b10~0.fc31", rls:"FC31"))) {
    report += res;
  }
