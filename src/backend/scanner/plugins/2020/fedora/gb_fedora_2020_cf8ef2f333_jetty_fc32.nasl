...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878242");
  ...
  script_tag(name:"creation_date", value:"2020-09-02 11:52:19 +0530 (Wed, 02 Sep 2020)");
  script_name("Fedora: Security Advisory for jetty (FEDORA-2020-cf8ef2f333)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LYCAMDYHCQXK5C2737VBXFCPEIVTHIT3");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jetty", rpm:"jetty~9.4.31~2.fc32", rls:"FC32"))) {
    report += res;
  }
