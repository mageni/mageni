...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878425");
  ...
  script_name("Fedora: Security Advisory for mumble (FEDORA-2020-8372f6bae4)");
  ...
  script_xref(name:"FEDORA", value:"2020-8372f6bae4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UQJDBZUYMMF4R5QQKD2HTIKQU2NSKO63");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mumble'
  package(s) announced via the FEDORA-2020-8372f6bae4 advisory.");
...
won&#39, t be audible to other players.");
  ...
  script_tag(name:"affected", value:"'mumble' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mumble", rpm:"mumble~1.3.2~1.fc32", rls:"FC32"))) {
    report += res;
  }
