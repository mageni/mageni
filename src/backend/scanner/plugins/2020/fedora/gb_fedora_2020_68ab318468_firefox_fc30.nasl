...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877704");
  ...
  script_name("Fedora: Security Advisory for firefox (FEDORA-2020-68ab318468)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4E7TMIVYPYW4Q5M7FE5EPBSRWJQRU34G");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~75.0~1.fc30", rls:"FC30"))) {
    report += res;
  }
