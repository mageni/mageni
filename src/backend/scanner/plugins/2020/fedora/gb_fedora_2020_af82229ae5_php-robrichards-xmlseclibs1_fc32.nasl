...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877729");
  ...
  script_name("Fedora: Security Advisory for php-robrichards-xmlseclibs1 (FEDORA-2020-af82229ae5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OCSR3V6LNWJAD37VQB6M2K7P4RQSCVFG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-robrichards-xmlseclibs1'
  package(s) announced via the FEDORA-2020-af82229ae5 advisory.");
...
Autoloader: /usr/share/php/robrichards-xmlseclibs/autoload.php");
  ...
  script_tag(name:"affected", value:"'php-robrichards-xmlseclibs1' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-robrichards-xmlseclibs1", rpm:"php-robrichards-xmlseclibs1~1.4.3~1.fc32", rls:"FC32"))) {
    report += res;
  }
