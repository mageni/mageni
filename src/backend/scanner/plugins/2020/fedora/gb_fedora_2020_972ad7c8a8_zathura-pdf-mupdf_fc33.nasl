...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878508");
  ...
  script_name("Fedora: Security Advisory for zathura-pdf-mupdf (FEDORA-2020-972ad7c8a8)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Q3PSKNWAZVAW5HNBWLABGUNPEYAXBVNN");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zathura-pdf-mupdf", rpm:"zathura-pdf-mupdf~0.3.6~4.fc33", rls:"FC33"))) {
    report += res;
  }
