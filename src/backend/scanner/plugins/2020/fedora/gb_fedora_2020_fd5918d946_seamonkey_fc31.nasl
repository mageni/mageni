...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878655");
  ...
  script_tag(name:"creation_date", value:"2020-11-26 04:17:04 +0000 (Thu, 26 Nov 2020)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2020-fd5918d946)");
  ...
  script_xref(name:"FEDORA", value:"2020-fd5918d946");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LZZOKMR7UHT47ZGFZYA4BXUR6EP3GCXF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2020-fd5918d946 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.5~2.fc31", rls:"FC31"))) {
    report += res;
  }
