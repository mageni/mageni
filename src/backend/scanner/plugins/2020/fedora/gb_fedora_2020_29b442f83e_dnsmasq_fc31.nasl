...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877894");
  ...
  script_name("Fedora: Security Advisory for dnsmasq (FEDORA-2020-29b442f83e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JU474LT66BHNVFG5C4GEV3VTZNAEJ3BS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq'
  package(s) announced via the FEDORA-2020-29b442f83e advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.80~15.fc31", rls:"FC31"))) {
    report += res;
  }
