...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817613");
  ...
  script_name("Oracle Java SE Security Update(oct2020) 02-Linux");

  script_tag(name:"summary", value:"The host is installed with Oracle Java SE
  and is prone to remote security vulnerability.");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 11.0.8 and earlier, 15 on Linux.");
