...
if (description)
{
  ...
  script_cve_id("CVE-2019-5482", "CVE-2020-2814", "CVE-2020-2770", "CVE-2020-2761", "CVE-2020-2774",
                "CVE-2020-2853", "CVE-2020-2779", "CVE-2019-1547", "CVE-2019-1549", "CVE-2019-1552",
                "CVE-2019-1563", "CVE-2019-5481");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL 8.0 <= 8.0.18 Security Update (cpuapr2020) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 8.0 through 8.0.18.");
