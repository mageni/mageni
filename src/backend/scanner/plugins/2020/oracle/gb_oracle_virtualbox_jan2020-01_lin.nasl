...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816609");
  ...
  script_tag(name:"creation_date", value:"2020-01-16 15:48:17 +0530 (Thu, 16 Jan 2020)");
  script_name("Oracle VirtualBox Security Updates(jan2020) 01 - Linux");
  ...
  prior to 6.1.2 and 6.0.x prior to 6.0.16 on Linux.");

  script_tag(name:"solution", value:"Upgrade to Oracle VirtualBox version 5.2.36
  or 6.0.16 or 6.1.2 or later. Please see the references for more information.");
...
else if(virtualVer =~ "^6\.1\." && version_is_less(version:virtualVer, test_version:"6.1.2")){
  fix = "6.1.2";
}
