...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816848");
  ...
  script_name("Oracle VirtualBox Security Updates(apr2020) 03 - Windows");
  ...
  6.0.x prior to 6.0.20 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Oracle VirtualBox version 6.0.20 or
  6.1.6 or later. Please see the references for more information.");
