...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143360");
  ...
  script_name("Oracle MySQL 5.7.x < 5.7.29 Security Update (cpujan2020) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.0 - 5.7.28.");
