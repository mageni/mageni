...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817819");
  ...
  script_tag(name:"creation_date", value:"2020-11-04 18:00:15 +0530 (Wed, 04 Nov 2020)");
  script_name("Adobe Reader DC Continuous Security Updates(apsb20-67)-Mac OS X");
  ...
  versions before 2020.013.20064 on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC (Continuous)
  to version 2020.013.20064 or later. Please see the references for more information.");
...
if(version_in_range(version:readerVer, test_version:"20.0", test_version2:"20.012.20048"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"20.013.20064(2020.013.20064)", install_path:InstallPath);
