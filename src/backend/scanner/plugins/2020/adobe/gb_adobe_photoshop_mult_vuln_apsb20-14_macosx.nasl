...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816820");
  ...
  script_name("Adobe Photoshop CC Multiple Vulnerabilities-APSB20-14 (Mac OS X)");
  ...
  and Adobe Photoshop 2020 21.1 and earlier versions on Mac OS X.");
