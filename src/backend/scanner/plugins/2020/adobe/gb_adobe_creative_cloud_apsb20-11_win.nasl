...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816727");
  ...
  script_tag(name:"creation_date", value:"2020-03-27 18:46:51 +0530 (Fri, 27 Mar 2020)");
  script_tag(name:"qod_type", value:"registry");
  script_name("Adobe Creative Cloud Security Update APSB20-11 (Windows)");
  ...
  script_tag(name:"affected", value:"Adobe Creative Cloud 5.0 and earlier versions on Windows.");
...
if(version_is_less_equal(version:cloudVer, test_version:"5.0"))
{
