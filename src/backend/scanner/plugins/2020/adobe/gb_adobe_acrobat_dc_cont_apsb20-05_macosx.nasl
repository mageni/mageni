...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816572");
  ...
  script_name("Adobe Acrobat DC (Continuous) Security Updates(apsb20-05)-MAC OS X");
  ...
  to version 2020.006.20034 on MAC OS X.");
...
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"20.006.20034(2020.006.20034)", install_path:InstallPath);
