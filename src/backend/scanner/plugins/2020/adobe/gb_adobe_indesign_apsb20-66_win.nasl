...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817604");
  ...
  script_name("Adobe InDesign RCE Vulnerability-APSB20-66 (Windows)");
  ...
  script_tag(name:"affected", value:"Adobe InDesign 15.1.2 and earlier versions on Windows.");
