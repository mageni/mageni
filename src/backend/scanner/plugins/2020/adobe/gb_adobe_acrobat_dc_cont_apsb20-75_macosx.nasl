...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817860");
  ...
  script_tag(name:"creation_date", value:"2020-12-10 11:51:10 +0530 (Thu, 10 Dec 2020)");
  script_name("Adobe Acrobat DC (Continuous) Security Update(apsb20-75) - Mac OS X");
  ...
  to version 2020.013.20074 on Mac OS X.");
