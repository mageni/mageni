...
if(description)
{
  ...
  script_name("Adobe Premiere Pro Multiple Code Execution Vulnerabilities-Windows (apsb20-38)");

  script_tag(name:"summary", value:"The host is installed with Adobe Premiere
  Pro and is prone to multiple code execution vulnerabilities.");
  ...
  script_tag(name:"affected", value:"Adobe Premiere Pro versions 14.2andprior on Windows.");

  script_tag(name:"solution", value:"Upgrade Adobe Premiere Pro to version 14.3
...
if(version_is_less(version:adobeVer, test_version:"14.3"))
{
  report = report_fixed_ver(installed_version:adobeVer, fixed_version:'14.3', install_path:adobePath);
