...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817862");
  ...
  script_tag(name:"creation_date", value:"2020-12-10 11:51:20 +0530 (Thu, 10 Dec 2020)");
  script_name("Adobe Reader Classic 2020 Security Update(apsb20-75) - Mac OS X");
  ...
  2020.001.30018 on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Reader Classic 2020 to
  version 2020.001.30018 or later. Please see the references for more information.");
