...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817276");
  ...
  script_tag(name:"creation_date", value:"2020-09-02 11:51:12 +0530 (Wed, 02 Sep 2020)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_25-2020-08)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 85.0.4183.83 on Linux");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  85.0.4183.83 or later. Please see the references for more information.");
...
if(version_is_less(version:chr_ver, test_version:"85.0.4183.83"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"85.0.4183.83", install_path:chr_path);
