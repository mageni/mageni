...
if(description)
{
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-08)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 84.0.4147.125 on MAC OS X");
