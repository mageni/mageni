...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817039");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-06)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 83.0.4103.97 on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  83.0.4103.97 or later. Please see the references for more information.");
...
if(version_is_less(version:chr_ver, test_version:"83.0.4103.97"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"83.0.4103.97", install_path:chr_path);
