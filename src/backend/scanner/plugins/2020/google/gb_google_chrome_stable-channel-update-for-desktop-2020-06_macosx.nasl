...
if(description)
{
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-06)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 83.0.4103.97 on MAC OS X");
