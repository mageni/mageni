...
if(description)
{
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-10)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version  prior to 86.0.4240.75 on Windows");
