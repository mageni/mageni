...
if(description)
{
  ...
  script_version("2020-01-01T03:00:20+0000");
  script_cve_id("CVE-2018-20349");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-01 03:00:20 +0000 (Wed, 01 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-01 03:00:20 +0000 (Wed, 01 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2055-1] igraph security update)");
  ...
  package(s) announced via the DSA-2055-1 advisory.");
