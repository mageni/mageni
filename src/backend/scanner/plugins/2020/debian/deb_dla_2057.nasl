...
if(description)
{
  ...
  script_version("2020-01-07T03:00:10+0000");
  script_cve_id("CVE-2019-19911", "CVE-2020-5312", "CVE-2020-5313");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-07 03:00:10 +0000 (Tue, 07 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-07 03:00:10 +0000 (Tue, 07 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2057-1] pillow security update)");
  ...
  package(s) announced via the DSA-2057-1 advisory.");
