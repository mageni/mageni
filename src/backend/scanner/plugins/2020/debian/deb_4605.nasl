...
if(description)
{
  ...
  script_version("2020-01-21T04:00:46+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-21 04:00:46 +0000 (Tue, 21 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-21 04:00:46 +0000 (Tue, 21 Jan 2020)");
  script_name("Debian Security Advisory DSA 4605-1 (openjdk-11 - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4605.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4605-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-11'
  package(s) announced via the DSA-4605-1 advisory.");
