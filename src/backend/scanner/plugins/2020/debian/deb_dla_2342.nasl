...
if(description)
{
  ...
  script_version("2020-08-25T03:00:11+0000");
  ...
  script_name("Debian LTS: Security Advisory for libjackson-json-java (DLA-2342-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00039.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2342-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libjackson-json-java'
  package(s) announced via the DLA-2342-1 advisory.");
