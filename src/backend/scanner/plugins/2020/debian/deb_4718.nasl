...
if(description)
{
  ...
  script_version("2020-07-07T03:00:10+0000");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"calendar-google-provider", ver:"1:68.10.0-1~deb10u1", rls:"DEB10"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"calendar-google-provider", ver:"1:68.10.0-1~deb9u1", rls:"DEB9"))) {
  report += res;
}
