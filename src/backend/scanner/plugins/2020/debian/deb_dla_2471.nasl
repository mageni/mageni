...
if(description)
{
  ...
  script_version("2020-12-02T04:00:18+0000");
  ...
  script_name("Debian LTS: Security Advisory for libxstream-java (DLA-2471-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/12/msg00001.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2471-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxstream-java'
  package(s) announced via the DLA-2471-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was found that XStream is vulnerable to Remote Code Execution. The
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libxstream-java", ver:"1.4.9-2+deb9u1", rls:"DEB9"))) {
  report += res;
}
