...
if(description)
{
  ...
  script_version("2020-11-07T04:00:18+0000");
  ...
  script_name("Debian: Security Advisory for wordpress (DSA-4784-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4784.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4784-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the DSA-4784-1 advisory.");
