...
if(description)
{
  ...
  script_version("2020-11-26T04:00:07+0000");
  ...
  script_name("Debian: Security Advisory for spip (DSA-4798-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4798.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4798-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spip'
  package(s) announced via the DSA-4798-1 advisory.");
