...
if(description)
{
  ...
  script_version("2020-01-10T03:00:06+0000");
  script_cve_id("CVE-2019-19920");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-10 03:00:06 +0000 (Fri, 10 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-10 03:00:06 +0000 (Fri, 10 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2062-1] sa-exim security update)");
  ...
  package(s) announced via the DSA-2062-1 advisory.");
