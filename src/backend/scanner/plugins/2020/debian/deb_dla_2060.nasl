...
if(description)
{
  ...
  script_version("2020-01-16T04:00:05+0000");
  script_cve_id("CVE-2020-5504");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-16 04:00:05 +0000 (Thu, 16 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-16 04:00:05 +0000 (Thu, 16 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2060-1] phpmyadmin security update)");
  ...
  package(s) announced via the DSA-2060-1 advisory.");
