...
if(description)
{
  ...
  script_version("2020-11-24T04:00:19+0000");
  ...
  script_name("Debian LTS: Security Advisory for php-pear (DLA-2465-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00043.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2465-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-pear'
  package(s) announced via the DLA-2465-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a filename sanitisation issue in
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"php-pear", ver:"1:1.10.1+submodules+notgz-9+deb9u2", rls:"DEB9"))) {
  report += res;
}
