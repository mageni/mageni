...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for yaws (DLA-2384-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/09/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2384-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'yaws'
  package(s) announced via the DLA-2384-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two issues have been found in yaws, a high performance HTTP 1.1 webserver
written in Erlang.
