...
if(description)
{
  ...
  script_version("2020-12-16T04:00:14+0000");
  ...
  script_name("Debian: Security Advisory for libxstream-java (DSA-4811-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4811.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4811-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxstream-java'
  package(s) announced via the DSA-4811-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the default blacklist of XStream, a Java library
