...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817214");
  ...
  script_tag(name:"creation_date", value:"2020-07-09 11:00:44 +0530 (Thu, 09 Jul 2020)");
  script_name("Wireshark Security Update(wnpa-sec-2020-09)-Windows");
  ...
  script_tag(name:"affected", value:"Wireshark versions 3.2.0 to 3.2.4 on Windows.");
