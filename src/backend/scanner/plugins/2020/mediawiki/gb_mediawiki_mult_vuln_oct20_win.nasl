...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113770");
  script_version("2020-10-26T11:41:37+0000");
  script_tag(name:"last_modification", value:"2020-10-26 11:41:37 +0000 (Mon, 26 Oct 2020)");
  ...
  script_name("MediaWiki <= 1.35.0 Multiple Vulnerabilities (Windows)");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 26th October, 2020.
