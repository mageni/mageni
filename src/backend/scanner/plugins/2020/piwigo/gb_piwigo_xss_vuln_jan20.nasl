...
if (description)
{
  ...
  script_version("2020-02-13T08:35:20+0000");
  script_tag(name:"last_modification", value:"2020-02-13 08:35:20 +0000 (Thu, 13 Feb 2020)");
  script_tag(name:"creation_date", value:"2020-02-13 03:31:28 +0000 (Thu, 13 Feb 2020)");
  script_tag(name:"cvss_base", value:"5.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:N");

  script_cve_id("CVE-2020-8089");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Piwigo < 2.10.2 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"Piwigo is affected by stored XSS via the Group Name Field to the group_list page.");
...
if (version_is_less(version: version, fixed_version: "2.10.2")) {
