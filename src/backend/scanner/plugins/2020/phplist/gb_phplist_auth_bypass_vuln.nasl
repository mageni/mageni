...
if (description)
{
  ...
  script_version("2020-02-10T07:01:22+0000");
  script_tag(name:"last_modification", value:"2020-02-10 07:01:22 +0000 (Mon, 10 Feb 2020)");
  ...
  script_name("phpList <= 3.5.0 Authentication Bypass Vulnerability");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 10th February, 2020.
