...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816723");
  script_version("2020-03-29T02:34:12+0000");
  script_cve_id("CVE-2019-8853", "CVE-2020-3851");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-03-30 09:58:56 +0000 (Mon, 30 Mar 2020)");
  script_tag(name:"creation_date", value:"2020-03-26 12:25:15 +0530 (Thu, 26 Mar 2020)");
  script_name("Apple MacOSX Security Updates(HT211100)-02");
  ...
  remote attackers to read restricted memory and gain elevated privileges.");

  script_tag(name:"affected", value:"Apple Mac OS X versions,
  10.14.x through 10.14.6, 10.13.x through 10.13.6");

  script_tag(name:"solution", value:"Apply Security Update 2020-002 for 10.13.x,
  and 10.14.x. Please see the references for more information.");
