...
if(description)
{
  ...
  script_name("openSUSE Update for djvulibre openSUSE-SU-2019:2219-1 (djvulibre)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00087.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the openSUSE-SU-2019:2219_1 advisory.");
