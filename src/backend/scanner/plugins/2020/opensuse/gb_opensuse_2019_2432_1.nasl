...
if(description)
{
  ...
  script_name("openSUSE Update for binutils openSUSE-SU-2019:2432-1 (binutils)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00008.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'binutils'
  package(s) announced via the openSUSE-SU-2019:2432_1 advisory.");
