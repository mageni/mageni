...
if(description)
{
  ...
  script_name("openSUSE Update for graphviz openSUSE-SU-2019:1434-1 (graphviz)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00054.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphviz'
  package(s) announced via the openSUSE-SU-2019:1434_1 advisory.");
