...
if(description)
{
  ...
  script_name("openSUSE Update for ucode-intel openSUSE-SU-2019:1806-1 (ucode-intel)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00052.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2019:1806_1 advisory.");
