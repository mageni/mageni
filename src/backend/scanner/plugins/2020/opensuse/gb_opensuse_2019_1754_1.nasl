...
if(description)
{
  ...
  script_name("openSUSE Update for python-requests openSUSE-SU-2019:1754-1 (python-requests)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00024.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-requests'
  package(s) announced via the openSUSE-SU-2019:1754_1 advisory.");
