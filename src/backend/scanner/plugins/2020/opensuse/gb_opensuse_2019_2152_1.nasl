...
if(description)
{
  ...
  script_name("openSUSE Update for chromium openSUSE-SU-2019:2152-1 (chromium)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00050.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the openSUSE-SU-2019:2152_1 advisory.");
