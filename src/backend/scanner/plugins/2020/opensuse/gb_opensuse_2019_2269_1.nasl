...
if(description)
{
  ...
  script_name("openSUSE Update for openssl-1_0_0 openSUSE-SU-2019:2269-1 (openssl-1_0_0)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00016.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl-1_0_0'
  package(s) announced via the openSUSE-SU-2019:2269_1 advisory.");
