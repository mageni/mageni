...
if(description)
{
  ...
  script_name("openSUSE Update for python-SQLAlchemy openSUSE-SU-2019:2064-1 (python-SQLAlchemy)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00010.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-SQLAlchemy'
  package(s) announced via the openSUSE-SU-2019:2064_1 advisory.");
