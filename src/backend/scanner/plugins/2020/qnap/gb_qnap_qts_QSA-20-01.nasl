...
if (description)
{
  ...
  script_version("2020-06-26T08:53:36+0000");
  ...
  - Multiple XSS vulnerability (CVE-2018-19943, CVE-2018-19953)
...
if (version_in_range(version: version, test_version: "4.3.4", test_version2: "4.3.20200407")) {
