...
if (description)
{
  ...
  script_version("2020-09-14T07:15:57+0000");
  ...
  script_tag(name:"summary", value:"The WordPress plugin Email Subscribers & Newsletters is prone to an email
  forgery/spoofing vulnerability.");

  script_tag(name:"insight", value:"Missing Authentication for Critical Function in Icegram Email Subscribers &
  Newsletters Plugin for WordPress allows a remote, unauthenticated attacker to conduct unauthenticated email
  forgery/spoofing.");

  script_tag(name:"affected", value:"WordPress Email Subscribers & Newsletters plugin before version 4.5.6.");
