...
if (description)
{
  ...
  script_version("2020-06-02T10:29:37+0000");
  ...
  script_mandatory_keys("siteorigin-panels/detected");

  script_tag(name:"summary", value:"The Page Builder by SiteOrigin plugin for WordPress is prone to multiple vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The action_builder_content function and live editor feature did not do
  any nonce verification, allowing for requests to be forged on behalf of an administrator.
  The panels_data $_POST variable allows for malicious JavaScript to be executed in the victim's browser");

  script_tag(name:"impact", value:"Successful exploitation of this issue may allow an attacker to execute malicious JavaScript in the victim's browser.");

  script_tag(name:"affected", value:"WordPress Page Builder by SiteOrigin plugin before version 2.10.16.");
