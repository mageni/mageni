...
if(description)
{
  ...
  script_cve_id("CVE-2020-0429","CVE-2020-0431","CVE-2020-14381");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3225-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007720.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel (Live Patch 29 for SLE 12 SP3)'
  package(s) announced via the SUSE-SU-2020:3225-1 advisory.");
