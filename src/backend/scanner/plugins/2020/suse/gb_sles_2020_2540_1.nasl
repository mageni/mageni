...
if(description)
{
  ...
  script_cve_id("CVE-2018-3639","CVE-2020-14314","CVE-2020-14331");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2540-1)");
  ...
  package(s) announced via the SUSE-SU-2020:2540-1 advisory.");
