...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0079-2)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-September/007437.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libzypp'
  package(s) announced via the SUSE-SU-2020:0079-2 advisory.");
