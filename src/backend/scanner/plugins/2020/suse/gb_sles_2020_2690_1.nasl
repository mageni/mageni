...
if(description)
{
  ...
  script_cve_id("CVE-2016-9397","CVE-2016-9398","CVE-2016-9399");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2690-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-September/007443.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'jasper'
  package(s) announced via the SUSE-SU-2020:2690-1 advisory.");
