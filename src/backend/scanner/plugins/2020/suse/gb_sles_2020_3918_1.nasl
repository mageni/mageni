...
if(description)
{
  ...
  script_cve_id("CVE-2019-12900","CVE-2019-15961","CVE-2020-3123");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3918-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-December/008110.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'clamav'
  package(s) announced via the SUSE-SU-2020:3918-1 advisory.");
