...
if(description)
{
  ...
  script_cve_id("CVE-2020-15436","CVE-2020-15437","CVE-2020-25668");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3717-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-December/007942.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2020:3717-1 advisory.");
