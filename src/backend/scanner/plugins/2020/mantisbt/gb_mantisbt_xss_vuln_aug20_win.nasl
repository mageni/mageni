...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144391");
  script_version("2020-08-13T09:15:19+0000");
  script_tag(name:"last_modification", value:"2020-08-13 10:32:48 +0000 (Thu, 13 Aug 2020)");
  script_tag(name:"creation_date", value:"2020-08-13 09:14:44 +0000 (Thu, 13 Aug 2020)");
  ...
  script_name("MantisBT < 2.24.2 XSS Vulnerability - Windows");
