...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144329");
  script_version("2020-07-29T07:07:42+0000");
  script_tag(name:"last_modification", value:"2020-07-30 10:23:02 +0000 (Thu, 30 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-07-29 07:01:17 +0000 (Wed, 29 Jul 2020)");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");

  script_cve_id("CVE-2020-15712", "CVE-2020-15713", "CVE-2020-15714", "CVE-2020-15715");
  ...
  - Directory traversal vulnerability (CVE-2020-15712)

  - Multiple SQL injection vulnerabilities (CVE-2020-15713, CVE-2020-15714)

  - RCE vulnerability (CVE-2020-15715)");
