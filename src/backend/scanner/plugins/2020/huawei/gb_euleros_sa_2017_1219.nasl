...
if(description)
{
  ...
  script_version("2020-01-23T10:59:42+0000");
  script_cve_id("CVE-2017-9461");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 10:59:42 +0000 (Thu, 23 Jan 2020)");
  ...
  'samba' package(s) announced via the EulerOS-SA-2017-1219 advisory.");
