...
if(description)
{
  ...
  script_version("2020-11-04T08:54:27+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2362");
  ...
  'libvncserver' package(s) announced via the EulerOS-SA-2020-2362 advisory.");
