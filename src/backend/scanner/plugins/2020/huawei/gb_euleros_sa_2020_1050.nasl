...
if(description)
{
  ...
  script_version("2020-01-23T13:18:13+0000");
  script_cve_id("CVE-2019-13118", "CVE-2019-18197");
  script_tag(name:"cvss_base", value:"5.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:18:13 +0000 (Thu, 23 Jan 2020)");
  ...
  'libxslt' package(s) announced via the EulerOS-SA-2020-1050 advisory.");
