...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2233");
  script_version("2020-01-23T15:42:05+0000");
  script_cve_id("CVE-2017-16808", "CVE-2018-19519", "CVE-2019-1010220");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 15:42:05 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:42:16 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for tcpdump (EulerOS-SA-2019-2233)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2233");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'tcpdump' package(s) announced via the EulerOS-SA-2019-2233 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpdump", rpm:"tcpdump~4.9.2~3.h1.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
