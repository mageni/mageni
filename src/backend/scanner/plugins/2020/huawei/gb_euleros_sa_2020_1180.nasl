...
if(description)
{
  ...
  script_version("2020-02-25T13:58:08+0000");
  ...
  script_tag(name:"last_modification", value:"2020-02-25 13:58:08 +0000 (Tue, 25 Feb 2020)");
  ...
  'sqlite' package(s) announced via the EulerOS-SA-2020-1180 advisory.");
