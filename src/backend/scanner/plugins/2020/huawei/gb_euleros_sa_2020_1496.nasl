...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1496");
  script_version("2020-04-16T05:58:35+0000");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 05:58:35 +0000 (Thu, 16 Apr 2020)");
  script_name("Huawei EulerOS: Security Advisory for libpng (EulerOS-SA-2020-1496)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1496");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libpng' package(s) announced via the EulerOS-SA-2020-1496 advisory.");
...
Integer overflow in the png_set_unknown_chunks function in libpng/pngset.c in libpng before 1.5.14beta08 allows context-dependent attackers to cause a denial of service (segmentation fault and crash) via a crafted image, which triggers a heap-based buffer overflow.(CVE-2013-7353)");
  ...
  script_tag(name:"affected", value:"'libpng' package(s) on Huawei EulerOS Virtualization 3.0.2.2.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.5.13~7.1.h5.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
