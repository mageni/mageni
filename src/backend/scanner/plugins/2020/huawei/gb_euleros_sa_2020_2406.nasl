...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2406");
  script_version("2020-11-04T08:56:06+0000");
  ...
  script_tag(name:"creation_date", value:"2020-11-04 08:56:06 +0000 (Wed, 04 Nov 2020)");
  script_name("Huawei EulerOS: Security Advisory for xorg-x11-server (EulerOS-SA-2020-2406)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2406");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2406");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'xorg-x11-server' package(s) announced via the EulerOS-SA-2020-2406 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-Xephyr", rpm:"xorg-x11-server-Xephyr~1.17.2~10.h5", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-Xorg", rpm:"xorg-x11-server-Xorg~1.17.2~10.h5", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-common", rpm:"xorg-x11-server-common~1.17.2~10.h5", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
