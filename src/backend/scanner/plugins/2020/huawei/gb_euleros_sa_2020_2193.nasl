...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2193");
  script_version("2020-10-21T05:18:06+0000");
  ...
  script_tag(name:"creation_date", value:"2020-10-21 05:18:06 +0000 (Wed, 21 Oct 2020)");
  script_name("Huawei EulerOS: Security Advisory for yum-utils (EulerOS-SA-2020-2193)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2193");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2193");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'yum-utils' package(s) announced via the EulerOS-SA-2020-2193 advisory.");
  ...
  script_tag(name:"affected", value:"'yum-utils' package(s) on Huawei EulerOS Virtualization 3.0.2.2.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yum-utils", rpm:"yum-utils~1.1.31~46.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
