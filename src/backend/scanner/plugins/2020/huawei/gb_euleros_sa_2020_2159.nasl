...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2159");
  ...
  script_tag(name:"creation_date", value:"2020-09-29 13:49:54 +0000 (Tue, 29 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for squid (EulerOS-SA-2020-2159)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2159");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2159");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'squid' package(s) announced via the EulerOS-SA-2020-2159 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~4.2~2.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
