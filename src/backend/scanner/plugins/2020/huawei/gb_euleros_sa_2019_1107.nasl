...
if(description)
{
  ...
  script_version("2020-01-23T11:31:29+0000");
  script_cve_id("CVE-2018-15688", "CVE-2018-16864", "CVE-2018-16865", "CVE-2019-6454");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:31:29 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgudev1-219", rpm:"libgudev1-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libgudev1-devel-219", rpm:"libgudev1-devel-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-219", rpm:"systemd-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-devel-219", rpm:"systemd-devel-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-libs-219", rpm:"systemd-libs-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-python-219", rpm:"systemd-python-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-sysv-219", rpm:"systemd-sysv-219~30.6.h53", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
