...
if(description)
{
  ...
  script_version("2020-08-31T07:03:37+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1856");
  ...
  'icedtea-web' package(s) announced via the EulerOS-SA-2020-1856 advisory.");
