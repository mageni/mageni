...
if(description)
{
  ...
  script_version("2020-12-15T07:18:36+0000");
  script_cve_id("CVE-2020-10737");
  script_tag(name:"cvss_base", value:"3.7");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-12-15 07:18:36 +0000 (Tue, 15 Dec 2020)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2524");
  ...
  'oddjob' package(s) announced via the EulerOS-SA-2020-2524 advisory.");
