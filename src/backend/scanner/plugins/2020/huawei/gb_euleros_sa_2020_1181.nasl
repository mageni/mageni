...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1181");
  script_version("2020-02-25T13:58:15+0000");
  script_cve_id("CVE-2019-18634", "CVE-2019-19232", "CVE-2019-19234");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-02-25 13:58:15 +0000 (Tue, 25 Feb 2020)");
  script_tag(name:"creation_date", value:"2020-02-25 13:58:15 +0000 (Tue, 25 Feb 2020)");
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2020-1181)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1181");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'sudo' package(s) announced via the EulerOS-SA-2020-1181 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.8.23~3.h13.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
