...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1374");
  script_version("2020-04-16T05:45:48+0000");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 05:45:48 +0000 (Thu, 16 Apr 2020)");
  script_name("Huawei EulerOS: Security Advisory for coreutils (EulerOS-SA-2020-1374)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1374");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'coreutils' package(s) announced via the EulerOS-SA-2020-1374 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"coreutils", rpm:"coreutils~8.22~12.1.h6", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
