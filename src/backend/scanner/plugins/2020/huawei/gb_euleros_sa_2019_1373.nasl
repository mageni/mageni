...
if(description)
{
  ...
  script_version("2020-01-23T11:40:42+0000");
  script_cve_id("CVE-2018-10839");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:40:42 +0000 (Thu, 23 Jan 2020)");
  ...
  'qemu-kvm' package(s) announced via the EulerOS-SA-2019-1373 advisory.");
