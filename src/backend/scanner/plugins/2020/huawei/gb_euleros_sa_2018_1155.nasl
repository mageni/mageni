...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2018.1155");
  ...
  script_name("Huawei EulerOS: Security Advisory for libvorbis (EulerOS-SA-2018-1155)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1155");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libvorbis' package(s) announced via the EulerOS-SA-2018-1155 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvorbis", rpm:"libvorbis~1.3.3~8.h2", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
