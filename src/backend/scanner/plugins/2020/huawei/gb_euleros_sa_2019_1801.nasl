...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1801");
  script_version("2020-01-23T12:23:21+0000");
  script_cve_id("CVE-2015-1395", "CVE-2018-6952");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:C/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 12:23:21 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:23:21 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for patch (EulerOS-SA-2019-1801)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1801");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'patch' package(s) announced via the EulerOS-SA-2019-1801 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"patch", rpm:"patch~2.7.1~10.h1.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
