...
if(description)
{
  ...
  script_version("2020-01-23T10:44:46+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 10:44:46 +0000 (Thu, 23 Jan 2020)");
  ...
  'java-1.7.0-openjdk' package(s) announced via the EulerOS-SA-2017-1028 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~1.7.0.131~2.6.9.0", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~devel~1.7.0.131~2.6.9.0", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~headless~1.7.0.131~2.6.9.0", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
