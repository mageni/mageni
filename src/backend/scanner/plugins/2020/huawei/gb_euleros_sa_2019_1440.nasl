...
if(description)
{
  ...
  script_version("2020-01-23T11:47:05+0000");
  script_cve_id("CVE-2013-4397");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:47:05 +0000 (Thu, 23 Jan 2020)");
  ...
  'libtar' package(s) announced via the EulerOS-SA-2019-1440 advisory.");
