...
if(description)
{
  ...
  script_version("2020-07-31T05:41:02+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1812");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1812");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'mysql-connector-java' package(s) announced via the EulerOS-SA-2020-1812 advisory.");
