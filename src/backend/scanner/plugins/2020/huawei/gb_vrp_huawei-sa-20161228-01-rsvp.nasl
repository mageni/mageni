...
if(description)
{
  ...
  script_name("Huawei VRP Data Communication: DoS Vulnerability (huawei-sa-20161228-01-rsvp)");
  ...
  script_tag(name:"insight", value:"There is a denial of service (DoS) vulnerability in multiple Huawei devices.
  Due to the lack of input validation, a remote attacker may craft a malformed Resource Reservation Protocol
  (RSVP) packet and send it to the device, causing a few buffer overflows and occasional device restart.");

  script_tag(name:"impact", value:"An attacker may exploit this vulnerability to cause the device to restart
  occasionally.");
