...
if(description)
{
  ...
  script_version("2020-01-23T12:42:34+0000");
  script_cve_id("CVE-2018-20060", "CVE-2019-11236", "CVE-2019-9740");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 12:42:34 +0000 (Thu, 23 Jan 2020)");
  ...
  'python-urllib3' package(s) announced via the EulerOS-SA-2019-2239 advisory.");
