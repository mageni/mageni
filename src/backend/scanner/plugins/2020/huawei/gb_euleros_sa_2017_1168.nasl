...
if(description)
{
  ...
  script_version("2020-01-23T10:54:46+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 10:54:46 +0000 (Thu, 23 Jan 2020)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1168");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'freeradius' package(s) announced via the EulerOS-SA-2017-1168 advisory.");
