...
if(description)
{
  ...
  script_version("2020-06-16T05:47:52+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1645");
  ...
  'tomcat' package(s) announced via the EulerOS-SA-2020-1645 advisory.");
...
When using Apache Tomcat versions 10.0.0-M1 to 10.0.0-M4, 9.0.0.M1 to 9.0.34, 8.5.0 to 8.5.54 and 7.0.0 to 7.0.103 if a) an a ...
