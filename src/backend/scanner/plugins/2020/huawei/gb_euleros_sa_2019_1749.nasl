...
if(description)
{
  ...
  script_version("2020-01-23T12:21:37+0000");
  script_cve_id("CVE-2019-12795");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:21:37 +0000 (Thu, 23 Jan 2020)");
  ...
  'gvfs' package(s) announced via the EulerOS-SA-2019-1749 advisory.");
