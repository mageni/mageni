...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2521");
  script_version("2020-12-15T07:18:29+0000");
  script_cve_id("CVE-2018-1000667", "CVE-2018-10016", "CVE-2018-10316", "CVE-2018-19215", "CVE-2018-19755", "CVE-2018-8882");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-12-15 07:18:29 +0000 (Tue, 15 Dec 2020)");
  script_tag(name:"creation_date", value:"2020-12-15 07:18:29 +0000 (Tue, 15 Dec 2020)");
  script_name("Huawei EulerOS: Security Advisory for nasm (EulerOS-SA-2020-2521)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2521");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2521");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'nasm' package(s) announced via the EulerOS-SA-2020-2521 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nasm", rpm:"nasm~2.13.03~2.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
