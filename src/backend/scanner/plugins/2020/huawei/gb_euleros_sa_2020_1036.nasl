...
if(description)
{
  ...
  script_version("2020-01-23T13:17:01+0000");
  script_cve_id("CVE-2019-11555", "CVE-2019-9497", "CVE-2019-9498", "CVE-2019-9499");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:17:01 +0000 (Thu, 23 Jan 2020)");
  ...
  'wpa_supplicant' package(s) announced via the EulerOS-SA-2020-1036 advisory.");
