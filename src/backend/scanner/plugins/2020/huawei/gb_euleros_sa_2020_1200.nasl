...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1200");
  script_version("2020-03-13T07:13:54+0000");
  ...
  script_tag(name:"creation_date", value:"2020-03-13 07:13:54 +0000 (Fri, 13 Mar 2020)");
  script_name("Huawei EulerOS: Security Advisory for openldap (EulerOS-SA-2020-1200)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1200");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openldap' package(s) announced via the EulerOS-SA-2020-1200 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.4.44~15.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-clients", rpm:"openldap-clients~2.4.44~15.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
