...
if(description)
{
  ...
  script_version("2020-01-23T11:34:12+0000");
  script_cve_id("CVE-2012-6703", "CVE-2013-3076", "CVE-2013-3231", "CVE-2013-3237", "CVE-2018-13406", "CVE-2018-18386");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 11:34:12 +0000 (Thu, 23 Jan 2020)");
  ...
  'kernel' package(s) announced via the EulerOS-SA-2019-1197 advisory.");
