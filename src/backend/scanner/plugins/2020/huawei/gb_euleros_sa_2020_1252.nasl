...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1252");
  script_version("2020-03-13T07:18:25+0000");
  ...
  script_tag(name:"creation_date", value:"2020-03-13 07:18:25 +0000 (Fri, 13 Mar 2020)");
  script_name("Huawei EulerOS: Security Advisory for nss-softokn (EulerOS-SA-2020-1252)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1252");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'nss-softokn' package(s) announced via the EulerOS-SA-2020-1252 advisory.");
...
Libgcrypt before 1.7.10 and 1.8.x before 1.8.3 allows a memory-cache side-channel attack on ECDSA signatures that can be mitigated through the use of blinding during the signing process in the _gcry_ecc_ecdsa_sign function in cipher/ecc-ecdsa.c, aka the Return Of the Hidden Number Problem or ROHNP. To discover an ECDSA key, the attacker needs access to either the local machine or a different virtual machine on the same physical host.(CVE-2018-0495)");
  ...
  script_tag(name:"affected", value:"'nss-softokn' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss-softokn", rpm:"nss-softokn~3.36.0~5.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-softokn-freebl", rpm:"nss-softokn-freebl~3.36.0~5.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
