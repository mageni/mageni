...
if(description)
{
  ...
  script_version("2020-01-23T11:42:16+0000");
  script_cve_id("CVE-2016-2183", "CVE-2018-1060", "CVE-2018-1061", "CVE-2019-9636");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 11:42:16 +0000 (Thu, 23 Jan 2020)");
  ...
  'python' package(s) announced via the EulerOS-SA-2019-1403 advisory.");
