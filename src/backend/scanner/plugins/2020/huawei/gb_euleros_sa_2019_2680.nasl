...
if(description)
{
  ...
  script_version("2020-01-23T13:13:36+0000");
  script_cve_id("CVE-2016-10169", "CVE-2018-19840");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:13:36 +0000 (Thu, 23 Jan 2020)");
  ...
  'wavpack' package(s) announced via the EulerOS-SA-2019-2680 advisory.");
