...
if(description)
{
  ...
  script_version("2020-01-23T11:42:07+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:42:07 +0000 (Thu, 23 Jan 2020)");
  ...
  'php' package(s) announced via the EulerOS-SA-2019-1402 advisory.");
