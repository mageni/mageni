...
if(description)
{
  ...
  script_version("2020-01-23T12:45:56+0000");
  script_cve_id("CVE-2019-14833", "CVE-2019-14847");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 12:45:56 +0000 (Thu, 23 Jan 2020)");
  ...
  'samba' package(s) announced via the EulerOS-SA-2019-2303 advisory.");
