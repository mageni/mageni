...
if(description)
{
  ...
  script_version("2020-01-23T11:02:34+0000");
  script_cve_id("CVE-2017-14867");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 11:02:34 +0000 (Thu, 23 Jan 2020)");
  ...
  'git' package(s) announced via the EulerOS-SA-2017-1266 advisory.");
