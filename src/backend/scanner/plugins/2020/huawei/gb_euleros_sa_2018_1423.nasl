...
if(description)
{
  ...
  script_version("2020-01-23T11:25:53+0000");
  script_cve_id("CVE-2018-7725", "CVE-2018-7726", "CVE-2018-7727");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:25:53 +0000 (Thu, 23 Jan 2020)");
  ...
  'zziplib' package(s) announced via the EulerOS-SA-2018-1423 advisory.");
