...
if(description)
{
  ...
  script_name("Huawei VRP Data Communication: Memory Leak Vulnerability (huawei-sa-20171213-02-firewall)");
  ...
  memory don't be released when an local authenticated attacker execute special commands many times. An
