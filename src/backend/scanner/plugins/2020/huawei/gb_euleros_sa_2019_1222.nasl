...
if(description)
{
  ...
  script_version("2020-01-23T11:35:31+0000");
  script_cve_id("CVE-2015-7705", "CVE-2015-7853", "CVE-2015-7871", "CVE-2018-7185");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:35:31 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROSVIRT-2.5.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp- 4.2.6p5", rpm:"ntp- 4.2.6p5~25.0.1.h18", rls:"EULEROSVIRT-2.5.3"))) {
    report += res;
  }
