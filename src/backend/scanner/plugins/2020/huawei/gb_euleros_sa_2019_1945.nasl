...
if(description)
{
  ...
  script_version("2020-01-23T12:28:13+0000");
  script_cve_id("CVE-2019-9494", "CVE-2019-9496");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:28:13 +0000 (Thu, 23 Jan 2020)");
  ...
  'wpa_supplicant' package(s) announced via the EulerOS-SA-2019-1945 advisory.");
