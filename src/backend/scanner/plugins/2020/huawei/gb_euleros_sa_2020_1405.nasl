...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1405");
  script_version("2020-04-16T05:50:43+0000");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 05:50:43 +0000 (Thu, 16 Apr 2020)");
  script_name("Huawei EulerOS: Security Advisory for libssh2 (EulerOS-SA-2020-1405)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1405");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libssh2' package(s) announced via the EulerOS-SA-2020-1405 advisory.");
