...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2488");
  script_version("2020-12-01T06:58:21+0000");
  ...
  script_tag(name:"creation_date", value:"2020-12-01 06:58:21 +0000 (Tue, 01 Dec 2020)");
  script_name("Huawei EulerOS: Security Advisory for perl-DBI (EulerOS-SA-2020-2488)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2488");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2488");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'perl-DBI' package(s) announced via the EulerOS-SA-2020-2488 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-DBI", rpm:"perl-DBI~1.642~2.h4.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
