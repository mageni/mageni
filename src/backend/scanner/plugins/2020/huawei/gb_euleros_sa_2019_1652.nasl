...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1652");
  script_version("2020-01-23T12:19:03+0000");
  script_cve_id("CVE-2018-20532", "CVE-2018-20533", "CVE-2018-20534");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:19:03 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:19:03 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for libsolv (EulerOS-SA-2019-1652)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1652");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libsolv' package(s) announced via the EulerOS-SA-2019-1652 advisory.");
...
There is a NULL pointer dereference at ext/testcase.c (function testcase_read) in libsolvext.a in libsolv through 0.7.2 that will cause a denial of service.(CVE-2018-20532)");
  ...
  script_tag(name:"affected", value:"'libsolv' package(s) on Huawei EulerOS V2.0SP8.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsolv", rpm:"libsolv~0.6.35~3.h1.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
