...
if(description)
{
  ...
  script_version("2020-02-21T09:35:39+0000");
  ...
  script_cve_id("CVE-2020-8841");

  script_name("TestLink <= 1.9.19 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"Testlink is prone to an SQL injection (SQLi) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is exploitable via the relation_type parameter
  of the lib/requirements/reqSearch.php endpoint.");

  script_tag(name:"impact", value:"Successful exploitation would allow an authenticated attacker to
  read or modify sensitive information or even execute arbitrary
  commands on the target system.");

  script_tag(name:"affected", value:"TestLink through version 1.9.19.");

  script_tag(name:"solution", value:"Update to version 1.9.20.");
