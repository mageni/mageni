...
if (description)
{
  ...
  script_name("Nextcloud Server < 14.0.13, < 15.0.9, < 16.0.2 XSS Vulnerability (NC-SA-2019-004)");
  ...
  script_xref(name:"URL", value:"https://nextcloud.com/security/advisory/?id=NC-SA-2019-004");
