...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143460");
  script_version("2020-02-06T02:06:10+0000");
  script_tag(name:"last_modification", value:"2020-02-06 02:06:10 +0000 (Thu, 06 Feb 2020)");
  script_tag(name:"creation_date", value:"2020-02-05 08:05:53 +0000 (Wed, 05 Feb 2020)");
  script_tag(name:"cvss_base", value:"6.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:S/C:N/I:C/A:C");

  script_cve_id("CVE-2019-15621");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Nextcloud Server < 14.0.13, < 15.0.9, < 16.0.2 Share Vulnerability (NC-SA-2020-012)");
  ...
  script_tag(name:"summary", value:"Nextcloud Server is prone to an improper permission preservation vulnerability
  on reshares.");

  script_tag(name:"insight", value:"Improper permissions preservation causes sharees to be able to reshare with
  write permissions when sharing the mount point of a share they received, as a public link.");
  ...
  script_xref(name:"URL", value:"https://nextcloud.com/security/advisory/?id=NC-SA-2020-012");
