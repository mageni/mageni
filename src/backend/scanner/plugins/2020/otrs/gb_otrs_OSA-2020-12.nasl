...
if (description)
{
  ...
  script_version("2020-06-15T08:27:38+0000");
  ...
  script_tag(name:"insight", value:"BCC recipients in mails sent from OTRS are visible in article detail on
  an external interface.");

  script_tag(name:"affected", value:"OTRS 7.0.x through 7.0.17 and 8.0.x through 8.0.3.");
