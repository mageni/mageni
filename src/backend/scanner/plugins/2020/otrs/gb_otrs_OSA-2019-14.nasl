...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143315");
  script_version("2020-01-07T04:00:27+0000");
  script_tag(name:"last_modification", value:"2020-01-07 04:00:27 +0000 (Tue, 07 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-07 03:48:05 +0000 (Tue, 07 Jan 2020)");
  ...
  script_name("OTRS 5.0.x < 5.0.39, 6.0.x < 6.0.24, 7.0.x < 7.0.13 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"An attacker who is logged into OTRS as an agent is able to list tickets
  assigned to other agents, which are in the queue where attacker doesn't have permissions.");
  ...
  script_xref(name:"URL", value:"https://community.otrs.com/security-advisory-2019-14-security-update-for-otrs-framework/");
...
if (version_in_range(version: version, test_version: "6.0.0", test_version2: "7.0.12")) {
