...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883312");
  ...
  script_tag(name:"creation_date", value:"2020-12-22 04:00:41 +0000 (Tue, 22 Dec 2020)");
  script_name("CentOS: Security Advisory for thunderbird (CESA-2020:5618)");
  ...
  script_xref(name:"CESA", value:"2020:5618");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-December/048242.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the CESA-2020:5618 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~78.6.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
