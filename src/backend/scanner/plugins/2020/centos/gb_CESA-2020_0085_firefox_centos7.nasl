...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883162");
  ...
  script_tag(name:"creation_date", value:"2020-01-16 04:00:33 +0000 (Thu, 16 Jan 2020)");
  script_name("CentOS Update for firefox CESA-2020:0085 centos7");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-January/035600.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2020:0085 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.4.1~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
