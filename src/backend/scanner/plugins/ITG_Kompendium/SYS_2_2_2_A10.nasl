...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109996");
...
"gsf/Policy/Windows10/UserRightsAssignment/win10_allow_logon_locally.nasl");
...
Die Standard-Anforderung 'A10: Integration von Online-Konten in das Betriebssystem' beschreibt, dass Login
nur mit einem Konto eines selbst betriebenen Verzeichnisdienstes moeglich sein sollte. Eine lokale
Anmeldung sollte lediglich Administratoren moeglich sein.");
...
"1.3.6.1.4.1.25623.1.0.109116");

if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A10");
  exit(0);
}
