...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.150583");
  ...
  script_tag(name:"summary", value:"Wechseldatentraeger wie z. B. USB-Sticks oder CDs/DVDs DUERFEN
NICHT automatisch eingebunden werden.");
...
if (host_runs("linux") != "yes"){
  ...
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.1.3.A3");
  exit(0);
}
