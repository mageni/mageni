...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150599");
  script_version("2021-03-15T14:01:58+0000");
  script_tag(name:"last_modification", value:"2021-03-15 14:01:58 +0000 (Mon, 15 Mar 2021)");
  ...
  script_tag(name:"summary", value:"Passwoerter SOLLTEN NICHT als Parameter an Programme uebergeben
werden.");
...
title = "Sichere Verwendung von Passwoertern auf der Kommandozeile";

if (host_runs("linux") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.3.A9");
  exit(0);
}
