...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150010");
...
Die Basis-Anforderung 'A3: Sichere Administration von Windows Server 2012' beschreibt, wie administrative
Konten benutzt werden muessen.");
...
title = "Sichere Administration von Windows Server 2012";

if (host_runs("windows_server_2012") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.1.2.2.A3");
  exit(0);
}
