...
# $Id: gb_nmap6_citrix_enum_apps.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803505");
  ...
  script_tag(name:"creation_date", value:"2013-02-28 18:59:54 +0530 (Thu, 28 Feb 2013)");
  script_name("Nmap NSE 6.01: citrix-enum-apps");
...
argv = make_list("nmap", "--script=citrix-enum-apps.nse","-sU", "--script=citrix-enum-apps.nse", "-p", port, get_host_ip());
