...
# $Id: gb_nmap_daytime.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  ...
  This is a wrapper on the Nmap Security Scanner's daytime.nse.");
...
argv = make_list("nmap", "--script=daytime.nse", get_host_ip());
