...
# $Id: gb_nmap6_http_auth.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803502");
  ...
  script_tag(name:"creation_date", value:"2013-02-28 18:59:51 +0530 (Thu, 28 Feb 2013)");
  script_name("Nmap NSE 6.01: http-auth");
  ...
  script_add_preference(name:"http-auth.path", value:"", type:"entry");
  script_add_preference(name:"http-max-cache-size", value:"", type:"entry");

  script_tag(name:"summary", value:"Retrieves the authentication scheme and realm of a web service that requires authentication.
...
http-auth.path:   Define the request path
...
pref = script_get_preference("http-auth.path");
if (!isnull(pref) && pref != "") {
  args[i++] = string('"', 'http-auth.path', '=', pref, '"');
}
