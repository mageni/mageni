...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2023.075.01");
  script_cve_id("CVE-2023-25751", "CVE-2023-25752", "CVE-2023-28162", "CVE-2023-28163", "CVE-2023-28164", "CVE-2023-28176");
  script_tag(name:"creation_date", value:"2023-03-17 04:19:13 +0000 (Fri, 17 Mar 2023)");
  ...
  script_name("Slackware: Security Advisory (SSA:2023-075-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2023-075-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2023&m=slackware-security.385932");
  ...
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/thunderbird/102.9.0/releasenotes/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-thunderbird' package(s) announced via the SSA:2023-075-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.9.0-i686-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.9.0-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.9.0-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"102.9.0-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
