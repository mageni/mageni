...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2023.356.01");
  script_tag(name:"creation_date", value:"2023-12-25 04:19:27 +0000 (Mon, 25 Dec 2023)");
  ...
  script_name("Slackware: Security Advisory (SSA:2023-356-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2023-356-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2023&m=slackware-security.405376");
  script_xref(name:"URL", value:"https://www.postfix.org/smtp-smuggling.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postfix' package(s) announced via the SSA:2023-356-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"postfix", ver:"3.6.13-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"postfix", ver:"3.6.13-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"postfix", ver:"3.8.4-i586-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"postfix", ver:"3.8.4-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
