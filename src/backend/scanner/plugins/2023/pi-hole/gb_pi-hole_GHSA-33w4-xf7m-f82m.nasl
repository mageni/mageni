...
if(description)
{
  ...
  script_name("Pi-hole Web 4.x < 5.8.13 Insufficient Session Expiration Vulnerability");
  ...
  script_tag(name:"summary", value:"The Pi-hole Web is prone to an insufficient session expiration
  vulnerability.");
  ...
  script_tag(name:"affected", value:"Pi-hole Web version 4.x prior to 5.8.13.");
