...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832345");
  script_version("2023-08-04T16:09:15+0000");
  script_cve_id("CVE-2023-3600", "CVE-2023-3417");
  ...
  script_name("Mozilla Thunderbird Security Updates (mfsa_2023-29_2023-33) - MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to version 115.0.1
...
if(version_is_less(version:vers, test_version:"115.0.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"115.0.1", install_path:path);
