...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832532");
  ...
  script_tag(name:"creation_date", value:"2023-09-27 16:30:13 +0530 (Wed, 27 Sep 2023)");
  script_name("Mozilla Thunderbird Security Update (mfsa_2023-41_2023-43)- MAC OS X");
