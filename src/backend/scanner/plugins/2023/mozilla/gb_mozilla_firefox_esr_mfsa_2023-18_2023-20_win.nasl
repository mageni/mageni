...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832205");
  ...
  script_tag(name:"creation_date", value:"2023-06-08 12:13:35 +0530 (Thu, 08 Jun 2023)");
  script_name("Mozilla Firefox ESR Security Update(mfsa_2023-18_2023-20)-Windows");
