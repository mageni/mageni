...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832754");
  script_version("2023-12-26T05:05:23+0000");
  script_cve_id("CVE-2023-50762", "CVE-2023-50761", "CVE-2023-6856", "CVE-2023-6857",
  ...
  script_tag(name:"creation_date", value:"2023-12-21 15:54:23 +0530 (Thu, 21 Dec 2023)");
  script_name("Mozilla Thunderbird Security Update (mfsa_2023-53_2023-56) - MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to version 115.6
