...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826759");
  ...
  script_tag(name:"creation_date", value:"2023-01-10 17:51:55 +0530 (Tue, 10 Jan 2023)");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2021-33) - Mac OS X");
