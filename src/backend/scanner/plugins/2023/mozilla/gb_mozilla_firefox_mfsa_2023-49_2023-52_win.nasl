...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832712");
  ...
  script_tag(name:"creation_date", value:"2023-11-23 11:10:46 +0530 (Thu, 23 Nov 2023)");
  script_name("Mozilla Firefox Security Update (mfsa_2023-49_2023-52) - Windows");
