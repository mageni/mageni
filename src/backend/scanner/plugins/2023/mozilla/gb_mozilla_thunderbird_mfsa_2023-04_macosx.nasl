...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826905");
  ...
  script_tag(name:"creation_date", value:"2023-02-02 15:46:33 +0530 (Thu, 02 Feb 2023)");
  script_name("Mozilla Thunderbird Security Update(mfsa_2023-04)-Mac OS X");
