...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832075");
  ...
  script_tag(name:"creation_date", value:"2023-05-11 13:35:35 +0530 (Thu, 11 May 2023)");
  script_name("Mozilla Firefox Security Updates(mfsa_2023-07_2023-11)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 111 on MAC OS X.");
