...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832099");
  ...
  script_tag(name:"creation_date", value:"2023-07-05 15:21:12 +0530 (Wed, 05 Jul 2023)");
  script_name("Mozilla Thunderbird Security Updates (mfsa_2023-22_2023-24) - MAC OS X");
