...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127586");
  script_version("2023-10-19T05:05:21+0000");
  script_tag(name:"last_modification", value:"2023-10-19 05:05:21 +0000 (Thu, 19 Oct 2023)");
  script_tag(name:"creation_date", value:"2023-10-13 13:40:11 +0000 (Fri, 13 Oct 2023)");
  ...
  script_cve_id("CVE-2023-0081");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress MonsterInsights - Google Analytics Dashboard Plugin < 8.12.1 XSS Vulnerability");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/76d2963c-ebff-498f-9484-3c3008750c14/");
...
if( version_is_less( version: version, test_version: "8.12.1" ) ) {
