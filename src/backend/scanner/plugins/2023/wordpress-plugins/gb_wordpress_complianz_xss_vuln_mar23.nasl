...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127375");
  ...
  script_tag(name:"severity_date", value:"2023-03-31 15:47:00 +0000 (Fri, 31 Mar 2023)");
  ...
  script_name("WordPress Complianz - GDPR/CCPA Cookie Consent Plugin < 6.4.2 XSS Vulnerability");
