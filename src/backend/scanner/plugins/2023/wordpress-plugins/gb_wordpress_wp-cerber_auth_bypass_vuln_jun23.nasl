...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124453");
  ...
  script_tag(name:"severity_date", value:"2022-09-13 15:59:00 +0000 (Tue, 13 Sep 2022)");

  script_cve_id("CVE-2022-2939");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress WP Cerber Security, Anti-spam & Malware Scan Plugin < 9.1 Authorization Bypass Vulnerability");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/b69b1620-96ac-464f-928a-11f0c8694e8c/");
