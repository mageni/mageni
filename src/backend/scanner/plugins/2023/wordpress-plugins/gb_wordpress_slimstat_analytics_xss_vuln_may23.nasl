...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-05-31 14:00:00 +0000 (Wed, 31 May 2023)");

  script_cve_id("CVE-2022-45366");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Slimstat Analytics Plugin < 5.0.5 XSS Vulnerability");
  ...
  script_xref(name:"URL", value:"https://patchstack.com/database/vulnerability/wp-slimstat/wordpress-slimstat-analytics-plugin-5-0-4-reflected-cross-site-scripting-xss-vulnerability?_s_id=cve");
