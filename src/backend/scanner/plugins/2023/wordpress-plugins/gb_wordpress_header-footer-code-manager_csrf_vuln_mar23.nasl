...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-10-05 16:22:00 +0000 (Thu, 05 Oct 2023)");

  script_cve_id("CVE-2023-39989");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Header Footer Code Manager Plugin < 1.1.35 CSRF Vulnerability");
  ...
  script_xref(name:"URL", value:"https://patchstack.com/database/vulnerability/header-footer-code-manager/wordpress-header-footer-code-manager-plugin-1-1-34-cross-site-request-forgery-csrf-vulnerability");
...
if (version_is_less(version: version, test_version: "1.1.35")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.1.35", install_path: location);
