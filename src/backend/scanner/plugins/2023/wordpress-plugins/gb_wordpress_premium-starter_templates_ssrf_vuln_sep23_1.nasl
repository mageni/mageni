...
CPE = "cpe:/a:brainstormforce:starter_templates_pro";

if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127656");
  script_version("2023-12-15T16:10:08+0000");
  script_tag(name:"last_modification", value:"2023-12-15 16:10:08 +0000 (Fri, 15 Dec 2023)");
  script_tag(name:"creation_date", value:"2023-12-13 08:00:45 +0000 (Wed, 13 Dec 2023)");
  ...
  script_mandatory_keys("wordpress/plugin/astra-pro-sites/detected");
