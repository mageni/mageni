...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-06-27 14:24:00 +0000 (Mon, 27 Jun 2022)");

  script_cve_id("CVE-2022-30533");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Modern Events Calendar Lite Plugin < 6.3.0 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not sanitise and escape some parameters, which
  could allow low privilege users to perform stored cross-site scripting (XSS) attacks.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/a614adad-6b3c-4566-b615-9dfcbdbed514/");
