...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126575");
  ...
  script_tag(name:"severity_date", value:"2023-12-05 19:22:00 +0000 (Tue, 05 Dec 2023)");

  script_cve_id("CVE-2023-48326");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Events Manager Plugin < 6.4.6 XSS Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress Events Manager plugin prior to version 6.4.6.");

  script_tag(name:"solution", value:"Update to version 6.4.6 or later.");

  script_xref(name:"URL", value:"https://patchstack.com/database/vulnerability/events-manager/wordpress-events-manager-plugin-6-4-5-reflected-cross-site-scripting-xss-vulnerability");
