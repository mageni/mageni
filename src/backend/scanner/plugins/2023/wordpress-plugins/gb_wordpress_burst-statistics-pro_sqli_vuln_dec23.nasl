...
if (description)
{
  ...
  script_name("WordPress Burst Statistics Pro Plugin 1.4.x < 1.5.1 SQLi Vulnerability");
  ...
  script_mandatory_keys("wordpress/plugin/burst-pro/detected");

  script_tag(name:"summary", value:"The WordPress plugin 'Burst Statistics Pro' is prone to an SQL
  ...
  script_tag(name:"affected", value:"WordPress Burst Statistics Pro plugin version 1.4.x prior to
  1.5.1.");
...
if( version_in_range_exclusive( version: version, test_version_lo: "1.4.0", test_version_up: "1.5.1" ) ) {
