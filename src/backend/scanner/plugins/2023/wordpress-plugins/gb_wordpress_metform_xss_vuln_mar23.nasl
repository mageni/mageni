...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126004");
  ...
  script_cve_id("CVE-2023-0084");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Metform Elementor Contact Form Builder Plugin < 3.2.0 XSS Vulnerability");
  ...
  script_tag(name:"impact", value:"Stored XSS via text areas on forms.");
  ...
  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/id/05f7d9fe-e95f-4ddf-9bce-2aeac3c2e946");
