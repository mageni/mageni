...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127526");
  script_version("2023-10-13T16:09:03+0000");
  script_tag(name:"last_modification", value:"2023-10-13 16:09:03 +0000 (Fri, 13 Oct 2023)");
  script_tag(name:"creation_date", value:"2023-08-18 10:12:12 +0000 (Fri, 18 Aug 2023)");
  ...
  script_tag(name:"insight", value:"The plugin has several widgets that are vulnerable to stored
  cross-site scripting (XSS) by lower-privileged users such as contributors.");
