...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127516");
  script_version("2023-10-13T16:09:03+0000");
  script_tag(name:"last_modification", value:"2023-10-13 16:09:03 +0000 (Fri, 13 Oct 2023)");
  script_tag(name:"creation_date", value:"2023-08-11 11:03:12 +0000 (Fri, 11 Aug 2023)");
  ...
  script_cve_id("CVE-2022-1710");

  script_name("WordPress Appointment Hour Booking Plugin < 1.3.56 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not sanitise and escape a settings of its
  Calendar fields.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/ed162ccc-88e6-41e8-b24d-1b9f77a038b6");
