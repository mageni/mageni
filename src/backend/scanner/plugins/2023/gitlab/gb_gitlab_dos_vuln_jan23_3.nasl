...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124270");
  ...
  script_cve_id("CVE-2023-0518");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 14.x < 15.6.7, 15.7.x < 15.7.6, 15.8.x < 15.8.1 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"An attacker is able to trigger a DoS attack by uploading a
  malicious Helm chart.");

  script_tag(name:"affected", value:"GitLab version 14.x prior to 15.6.7, 15.7.x prior to 15.7.6
...
if (version_in_range_exclusive(version: version, test_version_lo: "14.0", test_version_up: "15.6.7")) {
