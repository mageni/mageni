...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104536");
  ...
  script_name("OpenSSL 1.1.1 < 1.1.1t, 3.0 < 3.0.8 DoS Vulnerability - Windows");
  ...
  script_tag(name:"insight", value:"The flaw exists due to a double free after calling
  PEM_read_bio_ex.");

  script_tag(name:"affected", value:"OpenSSL version 1.1.1 and 3.0.");

  script_tag(name:"solution", value:"Update to version 1.1.1t, 3.0.8 or later.");
