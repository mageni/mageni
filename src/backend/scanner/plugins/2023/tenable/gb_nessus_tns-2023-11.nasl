...
if(description)
{
  ...
  script_name("Tenable Nessus 10.2.1 <= 10.4.2 Multiple Vulnerabilities (TNS-2023-11)");
  ...
  Nessus 10.4.3 updates OpenSSL to version 3.0.8 to address the identified vulnerabilities.");

  script_tag(name:"affected", value:"Tenable Nessus version 10.2.1 through 10.4.2.");

  script_tag(name:"solution", value:"Update to version 10.4.3 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2023-11");
...
if (version_in_range(version: version, test_version: "10.2.1", test_version2: "10.4.2")) {
