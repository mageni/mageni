...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170472");
  ...
  script_name("Tenable Nessus < 10.5.2 Multiple Vulnerabilities (TNS-2023-20)");
  ...
  functionality. Several of the third-party components (libxml2, libxslt) were found to contain
  vulnerabilities, and updated versions have been made available by the provider.

  Nessus 10.5.2 updates libxml2 to version 2.11.1 and libxslt to version 1.1.37 to address the
  identified vulnerabilities.");

  script_tag(name:"affected", value:"Tenable Nessus prior to version 10.5.2.");

  script_tag(name:"solution", value:"Update to version 10.5.2 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2023-20");
...
if (version_is_less(version: version, test_version: "10.5.2")) {
