...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118550");
  ...
  script_name("Tenable Nessus Agent < 10.4.1 Multiple Vulnerabilities (TNS-2023-24)");
  ...
  to address the potential impact of the issues. Nessus Agent 10.4.1 updates OpenSSL to version
  3.0.9 to address the identified vulnerabilities.");

  script_tag(name:"affected", value:"Tenable Nessus Agent prior to version 10.4.1.");

  script_tag(name:"solution", value:"Update to version 10.4.1 or later.");

  script_xref(name:"URL", value:"https://www.tenable.com/security/tns-2023-24");
