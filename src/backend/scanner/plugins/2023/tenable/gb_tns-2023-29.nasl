...
if(description)
{
  ...
  script_name("Tenable Nessus < 10.6.0 Multiple Vulnerabilities (TNS-2023-09)");
  ...
  script_tag(name:"affected", value:"Tenable Nessus prior to version 10.6.0.");

  script_tag(name:"solution", value:"Update to version 10.6.0 or later.");
...
if (version_is_less(version: version, test_version: "10.6.0")) {
