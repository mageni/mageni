...
if(description)
{
  ...
  script_cve_id("CVE-2023-27932", "CVE-2023-27954");
...
if(version_is_less(version:safVer, test_version:"16.4"))
{
  report = report_fixed_ver(installed_version:safVer, fixed_version:"16.4", install_path:safPath);
