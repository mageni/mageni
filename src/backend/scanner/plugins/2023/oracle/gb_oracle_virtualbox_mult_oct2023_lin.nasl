...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832553");
  ...
  script_tag(name:"creation_date", value:"2023-10-19 11:40:11 +0530 (Thu, 19 Oct 2023)");
  script_name("Oracle VirtualBox Security Update (oct2023) - Linux");
