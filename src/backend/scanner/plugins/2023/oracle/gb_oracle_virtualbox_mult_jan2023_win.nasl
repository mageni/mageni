...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826780");
  ...
  script_tag(name:"creation_date", value:"2023-01-18 12:04:27 +0530 (Wed, 18 Jan 2023)");
  script_name("Oracle VirtualBox Security Update(jan2023) - Windows");
  ...
  7.0.x prior to 7.0.6 on Windows.");
