...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832312");
  ...
  script_name("Oracle VirtualBox Security Update (jul2023) - Mac OS X");
  ...
  7.0.x prior to 7.0.10 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 6.1.46 or 7.0.10 or later. Please see the references for more information.");
