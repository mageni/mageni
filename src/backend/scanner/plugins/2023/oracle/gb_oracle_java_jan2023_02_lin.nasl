...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826786");
  ...
  script_tag(name:"creation_date", value:"2023-01-18 12:49:55 +0530 (Wed, 18 Jan 2023)");
  script_name("Oracle Java SE Security Update (jan2023) 02 - Linux");
