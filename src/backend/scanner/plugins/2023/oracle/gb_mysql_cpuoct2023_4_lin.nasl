...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151217");
  script_version("2023-10-19T05:05:21+0000");
  script_tag(name:"last_modification", value:"2023-10-19 05:05:21 +0000 (Thu, 19 Oct 2023)");
  script_tag(name:"creation_date", value:"2023-10-18 05:02:45 +0000 (Wed, 18 Oct 2023)");
  ...
  script_name("Oracle MySQL Server <= 5.7.43, 8.x <= 8.0.34, 8.1.0 Security Update (cpuoct2023) - Linux");
