...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832316");
  ...
  script_name("Oracle Java SE Security Update (jul2023) 02 - Linux");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 8u371 and earlier on Linux.");
