...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.149542");
  script_version("2023-04-19T10:08:55+0000");
  script_tag(name:"last_modification", value:"2023-04-19 10:08:55 +0000 (Wed, 19 Apr 2023)");
  script_tag(name:"creation_date", value:"2023-04-19 06:01:04 +0000 (Wed, 19 Apr 2023)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:M/C:N/I:N/A:C");

  script_cve_id("CVE-2023-21913");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.x <= 8.0.31 Security Update (cpuapr2023) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.x through 8.0.31.");
