...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832322");
  ...
  script_name("Oracle Java SE Security Update (jul2023) 05 - Windows");
  ...
  and libraries within the Java SE engine component in Oracle Java SE.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote
  attacker to manipulate data and execute arbitrary code.");

  script_tag(name:"affected", value:"Oracle Java SE version 8u371 and earlier, 11.0.19, 17.0.7, 20.0.1 and
  earlier on Windows.");
