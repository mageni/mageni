...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.149980");
  script_version("2023-07-20T05:05:18+0000");
  script_tag(name:"last_modification", value:"2023-07-20 05:05:18 +0000 (Thu, 20 Jul 2023)");
  script_tag(name:"creation_date", value:"2023-07-19 06:37:31 +0000 (Wed, 19 Jul 2023)");
  ...
  script_name("Oracle MySQL Server <= 5.7.42, 8.x <= 8.0.33 Security Update (cpujul2023) - Linux");
