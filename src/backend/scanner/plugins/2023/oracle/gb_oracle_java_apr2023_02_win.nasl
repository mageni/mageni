...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832048");
  ...
  script_name("Oracle Java SE Security Update (apr2023) 02 - Windows");

  script_tag(name:"summary", value:"Oracle Java SE is prone to a remote code execution
  vulnerability.");
  ...
  11.0.18, 17.0.6 and earlier on Windows.");
