...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826788");
  ...
  script_tag(name:"creation_date", value:"2023-01-18 12:49:07 +0530 (Wed, 18 Jan 2023)");
  script_name("Oracle Java SE Security Update (jan2023) 01 - Linux");
  ...
  within the JSSE component in Oracle Java SE.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote
  attacker to cause service disruption.");

  script_tag(name:"affected", value:"Oracle Java SE version 11.0.17, 17.0.5, 19.0.1
...
if(version_in_range(version:vers, test_version:"11.0", test_version2:"11.0.17") ||
