...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151214");
  script_version("2023-10-19T05:05:21+0000");
  script_tag(name:"last_modification", value:"2023-10-19 05:05:21 +0000 (Thu, 19 Oct 2023)");
  script_tag(name:"creation_date", value:"2023-10-18 04:46:54 +0000 (Wed, 18 Oct 2023)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:M/C:N/I:N/A:C");

  script_cve_id("CVE-2023-2650", "CVE-2023-0464", "CVE-2023-0465", "CVE-2023-0466",
                "CVE-2023-1255");
  ...
  script_name("Oracle MySQL Server <= 5.7.42, 8.x <= 8.0.33 Security Update (cpuoct2023) - Windows");
