...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832160");
  script_version("2023-07-25T05:05:58+0000");
  script_cve_id("CVE-2023-22043");
  script_tag(name:"cvss_base", value:"5.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:N/I:C/A:N");
  script_tag(name:"last_modification", value:"2023-07-25 05:05:58 +0000 (Tue, 25 Jul 2023)");
  script_tag(name:"creation_date", value:"2023-07-19 19:35:02 +0530 (Wed, 19 Jul 2023)");
  script_name("Oracle Java SE Security Update (jul2023) 02 - Windows");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 8u371 and earlier on Windows.");
