...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832603");
  ...
  script_tag(name:"creation_date", value:"2023-10-19 13:46:08 +0530 (Thu, 19 Oct 2023)");
  script_name("Oracle Java SE Security Update (oct2023) 02 - Linux");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 17.0.8, 20.0.2 on Linux.");
