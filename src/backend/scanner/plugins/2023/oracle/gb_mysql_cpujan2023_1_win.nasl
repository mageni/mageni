...
if (description)
{
  ...
  script_name("Oracle MySQL Server <= 5.7.40 Security Update (cpujan2023) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 5.7.40 and prior.");

  script_tag(name:"solution", value:"Update to version 5.7.41 or later.");
