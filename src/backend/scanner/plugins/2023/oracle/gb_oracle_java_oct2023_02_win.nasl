...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832601");
  ...
  script_name("Oracle Java SE Security Update (oct2023) 02 - Windows");
  ...
  in Oracle Java SE which can be exploited by using APIs in the specified Component.");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 17.0.8, 20.0.2 on Windows.");
...
if(version_in_range(version:vers, test_version:"17.0", test_version2:"17.0.8") ||
