...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1429");
  ...
  script_name("Huawei EulerOS: Security Advisory for python3 (EulerOS-SA-2023-1429)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1429");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1429");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python3' package(s) announced via the EulerOS-SA-2023-1429 advisory.");
