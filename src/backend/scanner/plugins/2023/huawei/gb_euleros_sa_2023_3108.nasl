...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3108");
  ...
  script_name("Huawei EulerOS: Security Advisory for scipy (EulerOS-SA-2023-3108)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3108");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3108");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'scipy' package(s) announced via the EulerOS-SA-2023-3108 advisory.");
...
A use-after-free issue was discovered in Py_FindObjects() function in SciPy versions prior to 1.8.0. NOTE: the vendor and discoverer indicate that this is not a security issue.(CVE-2023-29824)");
  ...
  script_tag(name:"affected", value:"'scipy' package(s) on Huawei EulerOS Virtualization release 2.9.0.");
