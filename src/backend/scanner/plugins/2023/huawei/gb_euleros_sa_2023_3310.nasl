...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3310");
  ...
  script_name("Huawei EulerOS: Security Advisory for libX11 (EulerOS-SA-2023-3310)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3310");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3310");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libX11' package(s) announced via the EulerOS-SA-2023-3310 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libX11", rpm:"libX11~1.6.9~4.h5.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
