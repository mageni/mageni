...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1171");
  ...
  script_name("Huawei EulerOS: Security Advisory for linux-firmware (EulerOS-SA-2023-1171)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1171");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1171");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'linux-firmware' package(s) announced via the EulerOS-SA-2023-1171 advisory.");
...
Improper buffer restriction in some Intel(R) Wireless Bluetooth(R) products before version 21.110 may allow an unauthenticated user to potentially enable escalation of privilege via adjacent access.(CVE-2020-12321)");
  ...
  script_tag(name:"affected", value:"'linux-firmware' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"linux-firmware", rpm:"linux-firmware~20200817~2.h5.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
