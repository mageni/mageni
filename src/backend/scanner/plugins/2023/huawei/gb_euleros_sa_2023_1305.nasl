...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1305");
  ...
  script_name("Huawei EulerOS: Security Advisory for zlib (EulerOS-SA-2023-1305)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1305");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1305");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'zlib' package(s) announced via the EulerOS-SA-2023-1305 advisory.");
...
zlib through 1.2.12 has a heap-based buffer over-read or buffer overflow in inflate in inflate.c via a large gzip header extra field. NOTE: only applications that call inflateGetHeader are affected. Some common applications bundle the affected zlib source code but may be unable to call inflateGetHeader (e.g., see the nodejs/node reference).(CVE-2022-37434)");
  ...
  script_tag(name:"affected", value:"'zlib' package(s) on Huawei EulerOS Virtualization 3.0.2.2.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zlib", rpm:"zlib~1.2.7~17.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zlib-devel", rpm:"zlib-devel~1.2.7~17.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
