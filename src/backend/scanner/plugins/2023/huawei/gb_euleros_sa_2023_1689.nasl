...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1689");
  script_cve_id("CVE-2021-28210", "CVE-2021-38575", "CVE-2021-38578");
  ...
  script_name("Huawei EulerOS: Security Advisory for edk2 (EulerOS-SA-2023-1689)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1689");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1689");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'edk2' package(s) announced via the EulerOS-SA-2023-1689 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2-aarch64", rpm:"edk2-aarch64~2.8.0~7", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
