...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1227");
  ...
  script_name("Huawei EulerOS: Security Advisory for mariadb-connector-c (EulerOS-SA-2023-1227)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1227");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1227");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mariadb-connector-c' package(s) announced via the EulerOS-SA-2023-1227 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb-connector-c", rpm:"mariadb-connector-c~3.0.6~6.h3.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
