...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1723");
  ...
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2023-1723)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1723");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1723");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sudo' package(s) announced via the EulerOS-SA-2023-1723 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.8.19p2~14.h10", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
