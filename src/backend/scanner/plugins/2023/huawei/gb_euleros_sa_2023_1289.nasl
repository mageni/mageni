...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1289");
  script_cve_id("CVE-2021-20181", "CVE-2021-3527", "CVE-2021-3682");
  ...
  script_name("Huawei EulerOS: Security Advisory for qemu-kvm (EulerOS-SA-2023-1289)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1289");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1289");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'qemu-kvm' package(s) announced via the EulerOS-SA-2023-1289 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm", rpm:"qemu-kvm~2.8.1~30.089", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm-common", rpm:"qemu-kvm-common~2.8.1~30.089", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm-tools", rpm:"qemu-kvm-tools~2.8.1~30.089", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
