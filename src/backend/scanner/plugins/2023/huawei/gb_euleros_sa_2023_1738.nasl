...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1738");
  ...
  script_name("Huawei EulerOS: Security Advisory for pcre2 (EulerOS-SA-2023-1738)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1738");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1738");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pcre2' package(s) announced via the EulerOS-SA-2023-1738 advisory.");
  ...
  script_tag(name:"affected", value:"'pcre2' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pcre2", rpm:"pcre2~10.23~2.h2", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
