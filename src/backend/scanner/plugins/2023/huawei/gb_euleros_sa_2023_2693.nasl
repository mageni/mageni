...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2693");
  ...
  script_name("Huawei EulerOS: Security Advisory for libssh (EulerOS-SA-2023-2693)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2693");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2693");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libssh' package(s) announced via the EulerOS-SA-2023-2693 advisory.");
...
A NULL pointer dereference was found In libssh during re-keying with algorithm guessing. This issue may allow an authenticated client to cause a denial of service.(CVE-2023-1667)");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on Huawei EulerOS V2.0SP11(x86_64).");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh", rpm:"libssh~0.9.6~2.h10.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
