...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1713");
  script_cve_id("CVE-2018-18508", "CVE-2019-17007", "CVE-2020-25648", "CVE-2021-43527");
  ...
  script_name("Huawei EulerOS: Security Advisory for nss (EulerOS-SA-2023-1713)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1713");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1713");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'nss' package(s) announced via the EulerOS-SA-2023-1713 advisory.");
...
A remote code execution flaw was found in the way NSS verifies certificates. This flaw allows an attacker posing as an SSL/TLS server to trigger this issue in a client application compiled with NSS when it tries to initiate an SSL/TLS connection. Similarly, a server application compiled with NSS, which processes client certificates, can receive a malicious certificate via a client, triggering the flaw. The highest threat to this vulnerability is confidentiality, integrity, as well as system availability.(CVE-2021-43527)");
  ...
  script_tag(name:"affected", value:"'nss' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss", rpm:"nss~3.36.0~8.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-sysinit", rpm:"nss-sysinit~3.36.0~8.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-tools", rpm:"nss-tools~3.36.0~8.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
