...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1763");
  ...
  script_name("Huawei EulerOS: Security Advisory for lxc (EulerOS-SA-2023-1763)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1763");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1763");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'lxc' package(s) announced via the EulerOS-SA-2023-1763 advisory.");
  ...
  script_tag(name:"affected", value:"'lxc' package(s) on Huawei EulerOS V2.0SP11.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lxc", rpm:"lxc~4.0.3~2022031701.h12.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lxc-libs", rpm:"lxc-libs~4.0.3~2022031701.h12.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
