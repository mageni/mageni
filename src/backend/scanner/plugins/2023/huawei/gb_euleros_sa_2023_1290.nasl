...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1290");
  ...
  script_name("Huawei EulerOS: Security Advisory for rsync (EulerOS-SA-2023-1290)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1290");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1290");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'rsync' package(s) announced via the EulerOS-SA-2023-1290 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.1.2~4.h6.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
