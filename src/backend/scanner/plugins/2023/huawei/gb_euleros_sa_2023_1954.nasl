...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1954");
  ...
  script_name("Huawei EulerOS: Security Advisory for haproxy (EulerOS-SA-2023-1954)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1954");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1954");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'haproxy' package(s) announced via the EulerOS-SA-2023-1954 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"haproxy", rpm:"haproxy~2.0.14~2.h8.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
