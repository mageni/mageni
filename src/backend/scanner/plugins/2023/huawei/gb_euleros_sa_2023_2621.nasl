...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2621");
  ...
  script_name("Huawei EulerOS: Security Advisory for ntp (EulerOS-SA-2023-2621)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2621");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2621");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ntp' package(s) announced via the EulerOS-SA-2023-2621 advisory.");
...
praecis_parse in ntpd/refclock_palisade.c in NTP 4.2.8p15 has an out-of-bounds write. Any attack method would be complex, e.g., with a manipulated GPS receiver.(CVE-2023-26555)");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on Huawei EulerOS V2.0SP9.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.8p14~3.h6.r2.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
