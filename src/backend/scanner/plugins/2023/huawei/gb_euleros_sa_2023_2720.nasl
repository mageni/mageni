...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2720");
  ...
  script_name("Huawei EulerOS: Security Advisory for dmidecode (EulerOS-SA-2023-2720)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2720");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2720");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dmidecode' package(s) announced via the EulerOS-SA-2023-2720 advisory.");
  ...
  script_tag(name:"affected", value:"'dmidecode' package(s) on Huawei EulerOS Virtualization release 2.11.1.");
...
if(release == "EULEROSVIRT-2.11.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dmidecode", rpm:"dmidecode~3.3~3.h1.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }
