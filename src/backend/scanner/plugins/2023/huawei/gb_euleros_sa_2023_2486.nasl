...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2486");
  ...
  script_name("Huawei EulerOS: Security Advisory for emacs (EulerOS-SA-2023-2486)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2486");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2486");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'emacs' package(s) announced via the EulerOS-SA-2023-2486 advisory.");
...
org-babel-execute:latex in ob-latex.el in Org Mode through 9.6.1 for GNU Emacs allows attackers to execute arbitrary commands via a file name or directory name that contains shell metacharacters.(CVE-2023-28617)");
  ...
  script_tag(name:"affected", value:"'emacs' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"emacs-filesystem", rpm:"emacs-filesystem~27.1~4.h7.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
