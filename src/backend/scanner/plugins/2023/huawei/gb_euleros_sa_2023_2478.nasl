...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2478");
  ...
  script_name("Huawei EulerOS: Security Advisory for open-iscsi (EulerOS-SA-2023-2478)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2478");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2478");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'open-iscsi' package(s) announced via the EulerOS-SA-2023-2478 advisory.");
  ...
  script_tag(name:"affected", value:"'open-iscsi' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"open-iscsi", rpm:"open-iscsi~2.1.1~3.h19.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
