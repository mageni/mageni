...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1947");
  ...
  script_name("Huawei EulerOS: Security Advisory for apr-util (EulerOS-SA-2023-1947)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1947");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1947");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'apr-util' package(s) announced via the EulerOS-SA-2023-1947 advisory.");
  ...
  script_tag(name:"affected", value:"'apr-util' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apr-util", rpm:"apr-util~1.6.1~12.h2.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
