...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2087");
  ...
  script_name("Huawei EulerOS: Security Advisory for dhcp (EulerOS-SA-2023-2087)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2087");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2087");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dhcp' package(s) announced via the EulerOS-SA-2023-2087 advisory.");
...
In ISC DHCP 4.4.0 -> 4.4.3, ISC DHCP 4.1-ESV-R1 -> 4.1-ESV-R16-P1, when ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'dhcp' package(s) on Huawei EulerOS Virtualization release 2.11.0.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.4.2~13.h7.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
