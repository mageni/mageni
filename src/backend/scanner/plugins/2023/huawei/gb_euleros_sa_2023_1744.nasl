...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1744");
  ...
  script_name("Huawei EulerOS: Security Advisory for dpkg (EulerOS-SA-2023-1744)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1744");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1744");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dpkg' package(s) announced via the EulerOS-SA-2023-1744 advisory.");
  ...
  script_tag(name:"affected", value:"'dpkg' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dpkg", rpm:"dpkg~1.18.25~9.h1", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
