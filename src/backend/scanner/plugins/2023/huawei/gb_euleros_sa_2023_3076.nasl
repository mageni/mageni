...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3076");
  ...
  script_name("Huawei EulerOS: Security Advisory for pcre2 (EulerOS-SA-2023-3076)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3076");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3076");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pcre2' package(s) announced via the EulerOS-SA-2023-3076 advisory.");
  ...
  script_tag(name:"affected", value:"'pcre2' package(s) on Huawei EulerOS Virtualization release 2.11.0.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pcre2", rpm:"pcre2~10.39~1.h6.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
