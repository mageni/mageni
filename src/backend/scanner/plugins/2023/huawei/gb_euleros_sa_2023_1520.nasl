...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1520");
  ...
  script_name("Huawei EulerOS: Security Advisory for byacc (EulerOS-SA-2023-1520)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1520");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1520");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'byacc' package(s) announced via the EulerOS-SA-2023-1520 advisory.");
...
Berkeley Yacc is an LALR(1) parser generator. Berkeley Yacc has been made as compatible as possible with AT&T Yacc. Berkeley Yacc can accept any input specification that conforms to the AT&T Yacc documentation. Specifications that take advantage of undocumented features of AT&T Yacc will probably be rejected.(CVE-2021-33642)");
  ...
  script_tag(name:"affected", value:"'byacc' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"byacc", rpm:"byacc~1.9.20200330~1.h3.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"byacc-help", rpm:"byacc-help~1.9.20200330~1.h3.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
