...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2282");
  ...
  script_name("Huawei EulerOS: Security Advisory for apr (EulerOS-SA-2023-2282)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2282");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2282");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'apr' package(s) announced via the EulerOS-SA-2023-2282 advisory.");
  ...
  script_tag(name:"affected", value:"'apr' package(s) on Huawei EulerOS V2.0SP11(x86_64).");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apr", rpm:"apr~1.7.0~4.h2.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
