...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1087");
  ...
  script_name("Huawei EulerOS: Security Advisory for grilo (EulerOS-SA-2023-1087)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1087");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1087");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'grilo' package(s) announced via the EulerOS-SA-2023-1087 advisory.");
  ...
  script_tag(name:"affected", value:"'grilo' package(s) on Huawei EulerOS Virtualization 3.0.2.6.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grilo", rpm:"grilo~0.3.3~1.h1.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
