...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2871");
  ...
  script_name("Huawei EulerOS: Security Advisory for syslinux (EulerOS-SA-2023-2871)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2871");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2871");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'syslinux' package(s) announced via the EulerOS-SA-2023-2871 advisory.");
...
inffast.c in zlib 1.2.8 might allow context-dependent attackers to have unspecified impact by leveraging improper pointer arithmetic.(CVE-2016-9841)");
  ...
  script_tag(name:"affected", value:"'syslinux' package(s) on Huawei EulerOS V2.0SP11(x86_64).");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"syslinux", rpm:"syslinux~6.04~9.h2.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"syslinux-nonlinux", rpm:"syslinux-nonlinux~6.04~9.h2.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
