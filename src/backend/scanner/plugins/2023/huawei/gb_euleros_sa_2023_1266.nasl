...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1266");
  ...
  script_name("Huawei EulerOS: Security Advisory for libgcrypt (EulerOS-SA-2023-1266)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1266");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1266");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libgcrypt' package(s) announced via the EulerOS-SA-2023-1266 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgcrypt", rpm:"libgcrypt~1.5.3~14.h6.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
