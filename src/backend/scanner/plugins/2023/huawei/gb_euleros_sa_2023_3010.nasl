...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3010");
  ...
  script_name("Huawei EulerOS: Security Advisory for kernel (EulerOS-SA-2023-3010)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3010");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3010");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2023-3010 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"procps-ng", rpm:"procps-ng~3.3.16~15.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"procps-ng-i18n", rpm:"procps-ng-i18n~3.3.16~15.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
