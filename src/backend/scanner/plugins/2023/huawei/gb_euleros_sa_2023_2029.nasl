...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2029");
  ...
  script_name("Huawei EulerOS: Security Advisory for tpm2-tss (EulerOS-SA-2023-2029)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2029");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2029");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'tpm2-tss' package(s) announced via the EulerOS-SA-2023-2029 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tpm2-tss", rpm:"tpm2-tss~2.4.0~1.h3.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
