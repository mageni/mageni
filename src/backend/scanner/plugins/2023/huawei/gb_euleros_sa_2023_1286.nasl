...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1286");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-lxml (EulerOS-SA-2023-1286)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1286");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1286");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-lxml' package(s) announced via the EulerOS-SA-2023-1286 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-lxml", rpm:"python-lxml~3.2.1~4.h7.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
