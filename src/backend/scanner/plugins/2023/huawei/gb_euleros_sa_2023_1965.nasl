...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1965");
  ...
  script_name("Huawei EulerOS: Security Advisory for tpm2-tss (EulerOS-SA-2023-1965)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1965");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1965");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'tpm2-tss' package(s) announced via the EulerOS-SA-2023-1965 advisory.");
  ...
  script_tag(name:"affected", value:"'tpm2-tss' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tpm2-tss", rpm:"tpm2-tss~3.0.3~1.h2.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
