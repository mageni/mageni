...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2973");
  ...
  script_name("Huawei EulerOS: Security Advisory for qemu (EulerOS-SA-2023-2973)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2973");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2973");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'qemu' package(s) announced via the EulerOS-SA-2023-2973 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu", rpm:"qemu~4.1.0~2.9.1.2.397", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
