...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1605");
  ...
  script_name("Huawei EulerOS: Security Advisory for ppp (EulerOS-SA-2023-1605)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1605");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1605");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ppp' package(s) announced via the EulerOS-SA-2023-1605 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"network-scripts-ppp", rpm:"network-scripts-ppp~2.4.7~26.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ppp", rpm:"ppp~2.4.7~26.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
