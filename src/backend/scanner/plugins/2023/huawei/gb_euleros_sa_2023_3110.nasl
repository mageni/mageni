...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3110");
  ...
  script_name("Huawei EulerOS: Security Advisory for syslinux (EulerOS-SA-2023-3110)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3110");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3110");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'syslinux' package(s) announced via the EulerOS-SA-2023-3110 advisory.");
...
inffast.c in zlib 1.2.8 might allow context-dependent attackers to have unspecified impact by leveraging improper pointer arithmetic.(CVE-2016-9841)");
  ...
  script_tag(name:"affected", value:"'syslinux' package(s) on Huawei EulerOS Virtualization release 2.9.0.");
