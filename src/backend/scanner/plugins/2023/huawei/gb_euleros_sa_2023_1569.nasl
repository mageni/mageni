...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1569");
  ...
  script_name("Huawei EulerOS: Security Advisory for xorg-x11-server (EulerOS-SA-2023-1569)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1569");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1569");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'xorg-x11-server' package(s) announced via the EulerOS-SA-2023-1569 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-help", rpm:"xorg-x11-server-help~1.20.8~4.h8.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
