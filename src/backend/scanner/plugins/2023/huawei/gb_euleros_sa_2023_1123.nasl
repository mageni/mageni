...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1123");
  ...
  script_name("Huawei EulerOS: Security Advisory for git (EulerOS-SA-2023-1123)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1123");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1123");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'git' package(s) announced via the EulerOS-SA-2023-1123 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"git", rpm:"git~2.23.0~12.h9.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"git-help", rpm:"git-help~2.23.0~12.h9.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
