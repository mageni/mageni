...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2114");
  ...
  script_name("Huawei EulerOS: Security Advisory for tpm2-tss (EulerOS-SA-2023-2114)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2114");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2114");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'tpm2-tss' package(s) announced via the EulerOS-SA-2023-2114 advisory.");
  ...
  script_tag(name:"affected", value:"'tpm2-tss' package(s) on Huawei EulerOS Virtualization release 2.11.0.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tpm2-tss", rpm:"tpm2-tss~3.1.0~1.h1.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
