...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2131");
  ...
  script_name("Huawei EulerOS: Security Advisory for tar (EulerOS-SA-2023-2131)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2131");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2131");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'tar' package(s) announced via the EulerOS-SA-2023-2131 advisory.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tar", rpm:"tar~1.34~1.h5.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
