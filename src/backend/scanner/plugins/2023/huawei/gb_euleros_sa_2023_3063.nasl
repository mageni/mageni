...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3063");
  ...
  script_name("Huawei EulerOS: Security Advisory for scipy (EulerOS-SA-2023-3063)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3063");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3063");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'scipy' package(s) announced via the EulerOS-SA-2023-3063 advisory.");
...
A refcounting issue which leads to potential memory leak was discovered in scipy commit 8627df31ab in Py_FindObjects() function.(CVE-2023-25399)");
  ...
  script_tag(name:"affected", value:"'scipy' package(s) on Huawei EulerOS Virtualization release 2.11.1.");
...
if(release == "EULEROSVIRT-2.11.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-scipy", rpm:"python3-scipy~1.6.2~1.h7.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }
