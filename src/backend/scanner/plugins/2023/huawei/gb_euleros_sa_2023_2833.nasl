...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2833");
  ...
  script_name("Huawei EulerOS: Security Advisory for c-ares (EulerOS-SA-2023-2833)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2833");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2833");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'c-ares' package(s) announced via the EulerOS-SA-2023-2833 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"c-ares", rpm:"c-ares~1.18.1~1.h4.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
