...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3312");
  ...
  script_name("Huawei EulerOS: Security Advisory for libXpm (EulerOS-SA-2023-3312)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3312");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3312");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libXpm' package(s) announced via the EulerOS-SA-2023-3312 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libXpm", rpm:"libXpm~3.5.12~11.h3.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
