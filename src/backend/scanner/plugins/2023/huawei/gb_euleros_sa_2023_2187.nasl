...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2187");
  ...
  script_name("Huawei EulerOS: Security Advisory for compat-openssl10 (EulerOS-SA-2023-2187)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2187");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2187");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'compat-openssl10' package(s) announced via the EulerOS-SA-2023-2187 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"compat-openssl10", rpm:"compat-openssl10~1.0.2o~3.h18.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
