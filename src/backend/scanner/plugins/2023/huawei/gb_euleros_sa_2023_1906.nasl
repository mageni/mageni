...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1906");
  ...
  script_name("Huawei EulerOS: Security Advisory for libXpm (EulerOS-SA-2023-1906)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1906");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1906");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libXpm' package(s) announced via the EulerOS-SA-2023-1906 advisory.");
...
A flaw was found in libXpm. When processing a file with width of 0 and a very large height, some parser functions will be called repeatedly and can lead to an infinite loop, resulting in a Denial of Service in the application linked to the library.(CVE-2022-44617)");
  ...
  script_tag(name:"affected", value:"'libXpm' package(s) on Huawei EulerOS Virtualization release 2.10.1.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libXpm", rpm:"libXpm~3.5.13~1.h1.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
