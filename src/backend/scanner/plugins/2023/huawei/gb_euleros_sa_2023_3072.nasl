...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3072");
  ...
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2023-3072)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3072");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3072");
  script_xref(name:"URL", value:"https://gitlab.com/libtiff/libtiff/-/merge_requests/475");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libtiff' package(s) announced via the EulerOS-SA-2023-3072 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shadow", rpm:"shadow~4.9~4.h11.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.3.0~9.h19.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
