...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1192");
  ...
  script_name("Huawei EulerOS: Security Advisory for gnutls (EulerOS-SA-2023-1192)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1192");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1192");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gnutls' package(s) announced via the EulerOS-SA-2023-1192 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~3.6.9~6.h11.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnutls-utils", rpm:"gnutls-utils~3.6.9~6.h11.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
