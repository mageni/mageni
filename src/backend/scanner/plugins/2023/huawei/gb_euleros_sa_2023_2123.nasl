...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2123");
  script_cve_id("CVE-2006-20001", "CVE-2022-23943", "CVE-2022-36760", "CVE-2022-37436", "CVE-2023-25690", "CVE-2023-27522");
  ...
  script_name("Huawei EulerOS: Security Advisory for httpd (EulerOS-SA-2023-2123)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2123");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2123");
  script_xref(name:"URL", value:"http://example.com:8080/");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'httpd' package(s) announced via the EulerOS-SA-2023-2123 advisory.");
...
HTTP Response Smuggling vulnerability in Apache HTTP Server via mod_proxy_uwsgi. This issue affects Apache HTTP Server: from 2.4.30 through 2.4.55. Special characters in the origin response header can truncate/split the response forwarded to the client.(CVE-2023-27522)");
  ...
  script_tag(name:"affected", value:"'httpd' package(s) on Huawei EulerOS Virtualization release 2.11.0.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.4.51~5.h15.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"httpd-filesystem", rpm:"httpd-filesystem~2.4.51~5.h15.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"httpd-tools", rpm:"httpd-tools~2.4.51~5.h15.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mod_ssl", rpm:"mod_ssl~2.4.51~5.h15.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
