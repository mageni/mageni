...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2740");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-cryptography (EulerOS-SA-2023-2740)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2740");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2740");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-cryptography' package(s) announced via the EulerOS-SA-2023-2740 advisory.");
  ...
  script_tag(name:"affected", value:"'python-cryptography' package(s) on Huawei EulerOS Virtualization release 2.11.1.");
...
if(release == "EULEROSVIRT-2.11.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-cryptography-help", rpm:"python-cryptography-help~3.3.1~2.h6.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }
