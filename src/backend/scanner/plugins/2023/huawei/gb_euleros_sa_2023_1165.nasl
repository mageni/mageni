...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1165");
  script_cve_id("CVE-2021-25214", "CVE-2021-25215", "CVE-2021-25219", "CVE-2021-25220", "CVE-2022-2928", "CVE-2022-2929");
  ...
  script_name("Huawei EulerOS: Security Advisory for dhcp (EulerOS-SA-2023-1165)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1165");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1165");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dhcp' package(s) announced via the EulerOS-SA-2023-1165 advisory.");
...
In BIND 9.3.0 -> 9.11.35, 9.12.0 -> 9.16.21, and versions 9.9.3-S1 -> 9.11.35-S1 and 9.16.8-S1 -> 9.16.21-S1 of BIND Supported Preview Edition, as well as release versions 9.17.0 -> 9.17.18 of the BIND 9.17 development branch, exploitation of broken authoritative servers using a flaw in response processing can cause degradation in BIND resolver performance. The way the lame cache is currently designed makes it possible for its internal data structures to grow almost infinitely, which may cause significant delays in client query processing.(CVE-2021-25219)");
  ...
  script_tag(name:"affected", value:"'dhcp' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.4.2~3.h16.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
