...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151442");
  script_version("2023-12-26T05:05:23+0000");
  script_tag(name:"last_modification", value:"2023-12-26 05:05:23 +0000 (Tue, 26 Dec 2023)");
  script_tag(name:"creation_date", value:"2023-12-21 06:40:11 +0000 (Thu, 21 Dec 2023)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2020-12-31 15:19:00 +0000 (Thu, 31 Dec 2020)");

  script_cve_id("CVE-2020-9094");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Out of Bound Read Vulnerability in Huawei Product (huawei-sa-20201216-01-obr)");
  ...
  script_tag(name:"summary", value:"There is an out of bound read vulnerability in some products.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"A module does not deal with specific message properly.
  Attackers can exploit this vulnerability by sending malicious packet.");

  script_tag(name:"impact", value:"This can lead to denial of service.");
  ...
  script_xref(name:"URL", value:"https://www.huawei.com/en/psirt/security-advisories/huawei-sa-20201216-01-obr-en");
