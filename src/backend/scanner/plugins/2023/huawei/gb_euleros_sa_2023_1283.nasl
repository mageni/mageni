...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1283");
  ...
  script_name("Huawei EulerOS: Security Advisory for pyOpenSSL (EulerOS-SA-2023-1283)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1283");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1283");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pyOpenSSL' package(s) announced via the EulerOS-SA-2023-1283 advisory.");
...
Python Cryptographic Authority pyopenssl version Before 17.5.0 contains a CWE - 401 : Failure to Release Memory Before Removing Last Reference vulnerability in PKCS #12 Store that can result in Denial of service if memory runs low or is exhausted. This attack appear to be exploitable via Depends upon calling application, however it could be as simple as initiating a TLS connection. Anything that would cause the calling application to reload certificates from a PKCS #12 store.. This vulnerability appears to have been fixed in 17.5.0.(CVE-2018-1000808)");
  ...
  script_tag(name:"affected", value:"'pyOpenSSL' package(s) on Huawei EulerOS Virtualization 3.0.2.2.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-pyOpenSSL", rpm:"python2-pyOpenSSL~16.2.0~4.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
