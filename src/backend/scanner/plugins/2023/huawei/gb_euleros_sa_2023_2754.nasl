...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2754");
  ...
  script_name("Huawei EulerOS: Security Advisory for glib2 (EulerOS-SA-2023-2754)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2754");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2754");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'glib2' package(s) announced via the EulerOS-SA-2023-2754 advisory.");
...
A vulnerability was found in GLib2.0, where DoS caused by handling a malicious text-form variant which is structured to cause looping superlinear to its text size. Applications are at risk if they parse untrusted text-form variants.(CVE-2023-24593)");
  ...
  script_tag(name:"affected", value:"'glib2' package(s) on Huawei EulerOS Virtualization release 2.11.0.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.68.1~10.h12.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
