...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1692");
  ...
  script_name("Huawei EulerOS: Security Advisory for rsyslog (EulerOS-SA-2023-1692)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1692");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1692");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'rsyslog' package(s) announced via the EulerOS-SA-2023-1692 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsyslog", rpm:"rsyslog~8.24.0~17.h26", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rsyslog-mmjsonparse", rpm:"rsyslog-mmjsonparse~8.24.0~17.h26", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
