...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2012");
  ...
  script_name("Huawei EulerOS: Security Advisory for apr-util (EulerOS-SA-2023-2012)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2012");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2012");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'apr-util' package(s) announced via the EulerOS-SA-2023-2012 advisory.");
  ...
  script_tag(name:"affected", value:"'apr-util' package(s) on Huawei EulerOS Virtualization release 2.9.0.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apr-util", rpm:"apr-util~1.6.1~11.h1.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
