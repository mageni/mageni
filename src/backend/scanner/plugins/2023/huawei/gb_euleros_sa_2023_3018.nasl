...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.3018");
  ...
  script_name("Huawei EulerOS: Security Advisory for procps-ng (EulerOS-SA-2023-3018)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-3018");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3018");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'procps-ng' package(s) announced via the EulerOS-SA-2023-3018 advisory.");
  ...
  script_tag(name:"affected", value:"'procps-ng' package(s) on Huawei EulerOS V2.0SP11.");
