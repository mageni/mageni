...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1902");
  script_cve_id("CVE-2022-1184", "CVE-2022-20572", "CVE-2022-2602", "CVE-2022-3108", "CVE-2022-3111", "CVE-2022-3524", "CVE-2022-3542", "CVE-2022-3545", "CVE-2022-3566", "CVE-2022-3567", "CVE-2022-3586", "CVE-2022-3629", "CVE-2022-41218", "CVE-2022-4129", "CVE-2022-43750", "CVE-2022-4662", "CVE-2022-47929", "CVE-2023-0394", "CVE-2023-23454");
  ...
  script_name("Huawei EulerOS: Security Advisory for kernel (EulerOS-SA-2023-1902)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1902");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1902");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2023-1902 advisory.");
...
A vulnerability was found in Linux Kernel. It has been declared as problematic. Affected by this vulnerability is the function ipv6_renew_options of the component IPv6 Handler. The manipulation leads to memory leak. The attack can be launched remotely. It is recommended to apply a patch to fix this issue. The identifier VDB-211021 was assigned to this ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel", rpm:"kernel~4.19.90~vhulk2211.3.0.h1373.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-abi-stablelists", rpm:"kernel-abi-stablelists~4.19.90~vhulk2211.3.0.h1373.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~4.19.90~vhulk2211.3.0.h1373.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-tools-libs", rpm:"kernel-tools-libs~4.19.90~vhulk2211.3.0.h1373.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-perf", rpm:"python3-perf~4.19.90~vhulk2211.3.0.h1373.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
