...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.2090");
  ...
  script_name("Huawei EulerOS: Security Advisory for libX11 (EulerOS-SA-2023-2090)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-2090");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2090");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libX11' package(s) announced via the EulerOS-SA-2023-2090 advisory.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libX11", rpm:"libX11~1.7.2~2.h3.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
