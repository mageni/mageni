...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1060");
  ...
  script_name("Huawei EulerOS: Security Advisory for expat (EulerOS-SA-2023-1060)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1060");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1060");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2023-1060 advisory.");
...
xmltok_impl.c in Expat (aka libexpat) before 2.4.5 lacks certain validation of encoding, such as checks for whether a UTF-8 character is valid in a certain context.(CVE-2022-25235)");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on Huawei EulerOS Virtualization 3.0.2.6.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.1.0~10.h11.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"expat-devel", rpm:"expat-devel~2.1.0~10.h11.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"expat-static", rpm:"expat-static~2.1.0~10.h11.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
