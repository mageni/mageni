...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1058");
  ...
  script_name("Huawei EulerOS: Security Advisory for ceph-common (EulerOS-SA-2023-1058)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1058");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1058");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ceph-common' package(s) announced via the EulerOS-SA-2023-1058 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"librados2", rpm:"librados2~0.94.5~2.h2.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"librbd1", rpm:"librbd1~0.94.5~2.h2.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
