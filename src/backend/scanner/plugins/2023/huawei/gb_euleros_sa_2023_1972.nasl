...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1972");
  ...
  script_name("Huawei EulerOS: Security Advisory for emacs (EulerOS-SA-2023-1972)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1972");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1972");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'emacs' package(s) announced via the EulerOS-SA-2023-1972 advisory.");
...
GNU Emacs through 28.2 allows attackers to execute commands via shell metacharacters in the name of a source-code file, because lib-src/etags.c uses the system C library function in its implementation of the etags program. For example, a victim may use the 'etags -u *' command (suggested in the etags documentation) in a situation where the current working directory has contents that depend on untrusted input.(CVE-2022-48337)");
  ...
  script_tag(name:"affected", value:"'emacs' package(s) on Huawei EulerOS V2.0SP10(x86_64).");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"emacs-filesystem", rpm:"emacs-filesystem~27.1~4.h6.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
