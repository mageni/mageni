...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2023.1047");
  ...
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2023-1047)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2023-1047");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1047");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sudo' package(s) announced via the EulerOS-SA-2023-1047 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.9.8p2~2.h6.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
