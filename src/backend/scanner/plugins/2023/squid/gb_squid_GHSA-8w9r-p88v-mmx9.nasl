...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114206");
  ...
  script_cve_id("CVE-2023-49285");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Squid DoS Vulnerability (GHSA-8w9r-p88v-mmx9, SQUID-2023:7)");
  ...
  script_tag(name:"insight", value:"Due to a Buffer Overread bug Squid is vulnerable to a Denial of
  ...
  script_tag(name:"affected", value:"Squid versions 2.2 through 5.9 and 6.0 through 6.4.");

  script_tag(name:"solution", value:"Update to version 6.5 or later.");

  script_xref(name:"URL", value:"https://github.com/squid-cache/squid/security/advisories/GHSA-8w9r-p88v-mmx9");
...
if (version_in_range(version: version, test_version: "2.2", test_version2: "5.9") ||
    version_in_range(version: version, test_version: "6.0", test_version2: "6.4")) {
