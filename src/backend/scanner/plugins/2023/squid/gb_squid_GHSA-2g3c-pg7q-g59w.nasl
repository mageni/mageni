...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.100664");
  ...
  script_cve_id("CVE-2023-46848");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Squid Multiple DoS Vulnerabilities (GHSA-2g3c-pg7q-g59w, SQUID-2023:5)");
  ...
  - Due to an Incorrect Conversion between Numeric Types bug Squid is vulnerable to a Denial of
  Service attack against FTP Native Relay input validation.

  - Due to an Incorrect Conversion between Numeric Types bug Squid is vulnerable to a Denial of
  Service attack against ftp:// URL validation and access control.
  ...
  script_tag(name:"affected", value:"Squid versions 5.0.3 through 5.9 and 6.0 through 6.3.");
...
if (version_in_range(version: version, test_version: "5.0.3", test_version2: "5.9") ||
