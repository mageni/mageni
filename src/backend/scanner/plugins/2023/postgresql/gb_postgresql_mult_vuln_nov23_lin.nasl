...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.100980");
  ...
  script_name("PostgreSQL 11.x < 11.22, 12.x < 12.17, 13.x < 13.13, 14.x < 14.10, 15.x < 15.5, 16.x < 16.1 Multiple Vulnerabilities - Linux");
