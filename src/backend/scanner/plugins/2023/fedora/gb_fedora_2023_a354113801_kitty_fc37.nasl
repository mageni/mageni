...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827722");
  ...
  script_tag(name:"creation_date", value:"2023-05-20 01:05:52 +0000 (Sat, 20 May 2023)");
  script_name("Fedora: Security Advisory for kitty (FEDORA-2023-a354113801)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-a354113801");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3KWER72STTBDQI2ALXFBG3CBPO4J4PGR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kitty'
  package(s) announced via the FEDORA-2023-a354113801 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kitty", rpm:"kitty~0.26.5~5.fc37", rls:"FC37"))) {
    report += res;
  }
