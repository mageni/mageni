...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827768");
  ...
  script_tag(name:"creation_date", value:"2023-05-30 01:06:34 +0000 (Tue, 30 May 2023)");
  script_name("Fedora: Security Advisory for python-vkbasalt-cli (FEDORA-2023-cc571303eb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/N24KI3O3FWGKJSLATY35ZM3CHSABJ6WE");
...
write a configuration file.");
  ...
  script_tag(name:"affected", value:"'python-vkbasalt-cli' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-vkbasalt-cli", rpm:"python-vkbasalt-cli~3.1.1.post1~1.fc38", rls:"FC38"))) {
    report += res;
  }
