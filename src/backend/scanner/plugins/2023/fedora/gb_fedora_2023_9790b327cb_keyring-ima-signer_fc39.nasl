...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885381");
  ...
  script_name("Fedora: Security Advisory for keyring-ima-signer (FEDORA-2023-9790b327cb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CDENGDFMEGPFXZ6PRLC2HURC5GJHPA6Y");
...
stored in the kernel keyring to ensure they&#39, re not recoverable.");
  ...
  script_tag(name:"affected", value:"'keyring-ima-signer' package(s) on Fedora 39.");
