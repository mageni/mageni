...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827291");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:05:06 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for indi-3rdparty-libraries (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SRMVI6R3KSPITKDWM2V4PTGWYXUB43EU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'indi-3rdparty-libraries'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This is a metapackage for installing all INDI 3rdparty libraries
...
We currently ship the following libraries:
  ...
  script_tag(name:"affected", value:"'indi-3rdparty-libraries' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"indi-3rdparty-libraries", rpm:"indi-3rdparty-libraries~2.0.0~1.fc38", rls:"FC38"))) {
    report += res;
  }
