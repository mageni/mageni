...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884801");
  ...
  script_name("Fedora: Security Advisory for rubygem-actionpack (FEDORA-2023-4f0bb4ff5e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZZWGVNFQMSFZCJ4UDMEE33E4DOGNB5FY");
...
unit/integration testing that doesn&#39, t require a browser.");
  ...
  script_tag(name:"affected", value:"'rubygem-actionpack' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~7.0.7.2~1.fc39", rls:"FC39"))) {
    report += res;
  }
