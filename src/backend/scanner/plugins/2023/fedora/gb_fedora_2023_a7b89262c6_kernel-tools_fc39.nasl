...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885372");
  ...
  script_tag(name:"creation_date", value:"2023-12-05 02:19:49 +0000 (Tue, 05 Dec 2023)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2023-a7b89262c6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IG6IF3FUY7LVZJMFRPANAU4L4PSJ3ESQ");
...
and the supporting documentation.");
  ...
  script_tag(name:"affected", value:"'kernel-tools' package(s) on Fedora 39.");
