...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827316");
  ...
  script_tag(name:"creation_date", value:"2023-03-12 02:03:41 +0000 (Sun, 12 Mar 2023)");
  script_name("Fedora: Security Advisory for dcmtk (FEDORA-2023-fe6fa5696e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-fe6fa5696e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/R3QG7MSHORLYAHDXMYG6FQKU4GOCRBCR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dcmtk'
  package(s) announced via the FEDORA-2023-fe6fa5696e advisory.");
...
Install DCMTK if you are working with DICOM format medical image files.");
  ...
  script_tag(name:"affected", value:"'dcmtk' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dcmtk", rpm:"dcmtk~3.6.7~3.fc37", rls:"FC37"))) {
    report += res;
  }
