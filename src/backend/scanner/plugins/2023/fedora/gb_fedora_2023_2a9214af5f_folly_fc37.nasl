...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885073");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:22 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for folly (FEDORA-2023-2a9214af5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZLU6U2R2IC2K64NDPNMV55AUAO65MAF4");
...
Folly.");
  ...
  script_tag(name:"affected", value:"'folly' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"folly", rpm:"folly~2023.10.16.00~1.fc37", rls:"FC37"))) {
    report += res;
  }
