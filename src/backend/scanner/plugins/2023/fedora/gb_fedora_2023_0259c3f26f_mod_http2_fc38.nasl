...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885055");
  ...
  script_name("Fedora: Security Advisory for mod_http2 (FEDORA-2023-0259c3f26f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-0259c3f26f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BFQD3KUEMFBHPAPBGLWQC34L4OWL5HAZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mod_http2'
  package(s) announced via the FEDORA-2023-0259c3f26f advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mod_http2", rpm:"mod_http2~2.0.25~1.fc38", rls:"FC38"))) {
    report += res;
  }
