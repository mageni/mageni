...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827598");
  ...
  script_name("Fedora: Security Advisory for mingw-freeimage (FEDORA-2023-bace76409a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XXJ4QSLSK4HLH5ZDMDC42F7XLWLFADRD");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-freeimage", rpm:"mingw-freeimage~3.19.0~0.14.svn1889.fc38", rls:"FC38"))) {
    report += res;
  }
