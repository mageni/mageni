...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884942");
  ...
  script_name("Fedora: Security Advisory for prrte (FEDORA-2023-d6dbdf62ad)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/457YSC7V4GJQOTTJQDCEAISMC4QKEKUR");
...
abbreviated 'prte' (one 'r', not two) for convenience.");
  ...
  script_tag(name:"affected", value:"'prrte' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"prrte", rpm:"prrte~2.0.2~5.fc38", rls:"FC38"))) {
    report += res;
  }
