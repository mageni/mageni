...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884752");
  ...
  script_tag(name:"creation_date", value:"2023-09-09 01:17:29 +0000 (Sat, 09 Sep 2023)");
  script_name("Fedora: Security Advisory for php-phpmailer6 (FEDORA-2023-e51479556c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-e51479556c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RHTP33T5MLPIOHL3MOSKPP5TADPLQNUL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-phpmailer6'
  package(s) announced via the FEDORA-2023-e51479556c advisory.");
...
Autoloader: /usr/share/php/PHPMailer/PHPMailer6/autoload.php");
  ...
  script_tag(name:"affected", value:"'php-phpmailer6' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-phpmailer6", rpm:"php-phpmailer6~6.8.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
