...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-c1741c9724");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4AOSGAOPXLBK4A5ZRTVZ4M6QKVLSWMWG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2023-c1741c9724 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~112.0.5615.121~2.fc36", rls:"FC36"))) {
    report += res;
  }
