...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827788");
  ...
  script_tag(name:"creation_date", value:"2023-06-01 01:09:09 +0000 (Thu, 01 Jun 2023)");
  script_name("Fedora: Security Advisory for python3.10 (FEDORA-2023-994ecd7dbc)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-994ecd7dbc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/F2NY75GFDZ5T6YPN44D3VMFT5SUVTOTG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.10'
  package(s) announced via the FEDORA-2023-994ecd7dbc advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.10", rpm:"python3.10~3.10.11~2.fc38", rls:"FC38"))) {
    report += res;
  }
