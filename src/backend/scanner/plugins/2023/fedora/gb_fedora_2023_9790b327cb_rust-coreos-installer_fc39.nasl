...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885419");
  ...
  script_name("Fedora: Security Advisory for rust-coreos-installer (FEDORA-2023-9790b327cb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IMWF76A3XKMEC7LR4CE2X4YNNXRVHWX2");
...
machines (or, occasionally, to virtual machines).");
  ...
  script_tag(name:"affected", value:"'rust-coreos-installer' package(s) on Fedora 39.");
