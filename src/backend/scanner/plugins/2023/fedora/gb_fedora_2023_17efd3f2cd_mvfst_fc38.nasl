...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885066");
  ...
  script_name("Fedora: Security Advisory for mvfst (FEDORA-2023-17efd3f2cd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2FMDA7RC3EE26UG4R5XSYGL572J3ZREX");
...
features to support large scale deployments.");
  ...
  script_tag(name:"affected", value:"'mvfst' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mvfst", rpm:"mvfst~2023.10.16.00~1.fc38", rls:"FC38"))) {
    report += res;
  }
