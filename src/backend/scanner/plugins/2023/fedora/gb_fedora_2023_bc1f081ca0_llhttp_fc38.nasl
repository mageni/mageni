...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885424");
  ...
  script_tag(name:"creation_date", value:"2023-12-07 02:23:20 +0000 (Thu, 07 Dec 2023)");
  script_name("Fedora: Security Advisory for llhttp (FEDORA-2023-bc1f081ca0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VDKQ6HM3KNDU4OQI476ZWT4O7DMSIT35");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"llhttp", rpm:"llhttp~9.1.3~1.fc38", rls:"FC38"))) {
    report += res;
  }
