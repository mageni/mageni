...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827519");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2023-2212bff784)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-2212bff784");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IIE2ITEX2Q7TAFZP4N6K2PCC3SQHO54N");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2023-2212bff784 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.16~1.fc38", rls:"FC38"))) {
    report += res;
  }
