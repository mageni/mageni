...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885128");
  ...
  script_name("Fedora: Security Advisory for cachelib (FEDORA-2023-7934802344)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/44KZW7T3ZHILEBPMME47ZVIFJXPXVXXY");
...
caching transparently.");
  ...
  script_tag(name:"affected", value:"'cachelib' package(s) on Fedora 39.");
