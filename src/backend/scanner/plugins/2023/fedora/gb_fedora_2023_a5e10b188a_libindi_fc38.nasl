...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827266");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:04:11 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for libindi (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MT4LGRSWPKOQ4XDBLGXTTCR6GJPHS3F4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libindi'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"INDI is a distributed control protocol designed to operate
...
data acquisition, monitoring, and a lot more.");
  ...
  script_tag(name:"affected", value:"'libindi' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libindi", rpm:"libindi~2.0.0~3.fc38", rls:"FC38"))) {
    report += res;
  }
