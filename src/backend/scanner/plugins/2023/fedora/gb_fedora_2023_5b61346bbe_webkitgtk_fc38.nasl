...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827594");
  ...
  script_tag(name:"creation_date", value:"2023-04-23 01:14:18 +0000 (Sun, 23 Apr 2023)");
  script_name("Fedora: Security Advisory for webkitgtk (FEDORA-2023-5b61346bbe)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-5b61346bbe");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6QL5OGMSHRQ26FTYWZUXVNWB2VHOSVXK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkitgtk'
  package(s) announced via the FEDORA-2023-5b61346bbe advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"webkitgtk", rpm:"webkitgtk~2.40.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
