...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827293");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:06:40 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for loudgain (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XCKB3WKZS5JAAFOCZARPEVZOZOJRBCWP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'loudgain'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"loudgain is a versatile ReplayGain 2.0 loudness normalizer, based on the
...
modify the actual audio data.");
  ...
  script_tag(name:"affected", value:"'loudgain' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"loudgain", rpm:"loudgain~0.6.8~13.fc38", rls:"FC38"))) {
    report += res;
  }
