...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884973");
  ...
  script_tag(name:"creation_date", value:"2023-10-09 01:18:50 +0000 (Mon, 09 Oct 2023)");
  script_name("Fedora: Security Advisory for mingw-freeimage (FEDORA-2023-604a7d56b0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7DAXL4YEDPIRNORMG7LDHO3H4M66YFTY");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-freeimage", rpm:"mingw-freeimage~3.19.0~0.17.svn1909.fc38", rls:"FC38"))) {
    report += res;
  }
