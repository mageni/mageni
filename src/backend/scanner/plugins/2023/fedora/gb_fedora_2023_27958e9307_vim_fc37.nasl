...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-27958e9307");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PDVN5HSWPNVP4QXBPCEGZDLZKURLJWTE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the FEDORA-2023-27958e9307 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vim", rpm:"vim~9.0.1367~1.fc37", rls:"FC37"))) {
    report += res;
  }
