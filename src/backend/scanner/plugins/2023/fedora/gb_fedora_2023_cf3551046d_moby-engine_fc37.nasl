...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884733");
  ...
  script_tag(name:"creation_date", value:"2023-09-05 01:15:45 +0000 (Tue, 05 Sep 2023)");
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2023-cf3551046d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-cf3551046d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LYZOKMMVX4SIEHPJW3SJUQGMO5YZCPHC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'moby-engine'
  package(s) announced via the FEDORA-2023-cf3551046d advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~24.0.5~1.fc37", rls:"FC37"))) {
    report += res;
  }
