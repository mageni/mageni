...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827247");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:04:39 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for qmmp-plugin-pack (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XQ3ZTI5FM3YNAKFBYN56S434NJAUJUZC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qmmp-plugin-pack'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Plugin pack is a set of extra plugins for Qmmp.

  * FFap - enhanced Monkey&#39, s Audio (APE) decoder
  ...
  * Ytb - audio playback from YouTube (uses yt-dlp or youtube-dl)");
  ...
  script_tag(name:"affected", value:"'qmmp-plugin-pack' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qmmp-plugin-pack", rpm:"qmmp-plugin-pack~2.1.0~5.fc38", rls:"FC38"))) {
    report += res;
  }
