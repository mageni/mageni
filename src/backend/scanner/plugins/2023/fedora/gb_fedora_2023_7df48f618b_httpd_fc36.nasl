...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-7df48f618b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JG5FYKVB57P35KV2GPAG5K7QP7BH7DYG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'httpd'
  package(s) announced via the FEDORA-2023-7df48f618b advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.4.56~1.fc36", rls:"FC36"))) {
    report += res;
  }
