...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884660");
  ...
  script_tag(name:"creation_date", value:"2023-08-17 01:14:18 +0000 (Thu, 17 Aug 2023)");
  script_name("Fedora: Security Advisory for python-aiohttp (FEDORA-2023-105880e618)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IV326O2X4BE3SINX5FJHMAKVHUAA4ZYF");
...
with middlewares and pluggable routing.");
  ...
  script_tag(name:"affected", value:"'python-aiohttp' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-aiohttp", rpm:"python-aiohttp~3.8.5~1.fc37", rls:"FC37"))) {
    report += res;
  }
