...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-d69c7f95a4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GOXIH2FDEQJEAARE52C3GHTLGQFBYPIB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'emacs'
  package(s) announced via the FEDORA-2022-d69c7f95a4 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"emacs", rpm:"emacs~28.2~1.fc37", rls:"FC37"))) {
    report += res;
  }
