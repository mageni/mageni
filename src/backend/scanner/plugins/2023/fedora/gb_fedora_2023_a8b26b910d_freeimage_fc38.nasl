...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884743");
  ...
  script_name("Fedora: Security Advisory for freeimage (FEDORA-2023-a8b26b910d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RUEK2JOVJBQZVNQIIZZO3JFMTVB4R5KS");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freeimage", rpm:"freeimage~3.19.0~0.19.svn1909.fc38", rls:"FC38"))) {
    report += res;
  }
