...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885331");
  ...
  script_name("Fedora: Security Advisory for kubernetes (FEDORA-2023-39ecb65aaf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-39ecb65aaf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7MPGMITSZXUCAVO7Q75675SOLXC2XXU4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes'
  package(s) announced via the FEDORA-2023-39ecb65aaf advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes", rpm:"kubernetes~1.26.11~1.fc38", rls:"FC38"))) {
    report += res;
  }
