...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885327");
  ...
  script_name("Fedora: Security Advisory for galera (FEDORA-2023-bff42b29eb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5LWEA37QIYXWYCX7KTOSNYCEZNE2XHEX");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"galera", rpm:"galera~26.4.16~1.fc37", rls:"FC37"))) {
    report += res;
  }
