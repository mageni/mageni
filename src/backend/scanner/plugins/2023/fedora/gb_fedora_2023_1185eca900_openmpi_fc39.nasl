...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884929");
  ...
  script_name("Fedora: Security Advisory for openmpi (FEDORA-2023-1185eca900)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GBNIACYJ3URQ3WAXXQXH5Z3R6UCJTRRR");
...
researchers.");
  ...
  script_tag(name:"affected", value:"'openmpi' package(s) on Fedora 39.");
