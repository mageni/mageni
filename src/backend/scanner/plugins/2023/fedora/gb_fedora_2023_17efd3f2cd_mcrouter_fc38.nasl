...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885061");
  ...
  script_name("Fedora: Security Advisory for mcrouter (FEDORA-2023-17efd3f2cd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WLPRQ5TWUQQXYWBJM7ECYDAIL2YVKIUH");
...
memcached hosts.");
  ...
  script_tag(name:"affected", value:"'mcrouter' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mcrouter", rpm:"mcrouter~0.41.0.20231016~1.fc38", rls:"FC38"))) {
    report += res;
  }
