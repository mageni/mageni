...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823110");
  ...
  script_tag(name:"creation_date", value:"2023-01-09 08:48:37 +0000 (Mon, 09 Jan 2023)");
  script_name("Fedora: Security Advisory for GitPython (FEDORA-2022-8146a727a8)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-8146a727a8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IKMVYKLWX62UEYKAN64RUZMOIAMZM5JN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'GitPython'
  package(s) announced via the FEDORA-2022-8146a727a8 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"GitPython", rpm:"GitPython~3.1.30~1.fc37", rls:"FC37"))) {
    report += res;
  }
