...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827246");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:08:25 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for chromaprint (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NA6SMRAM37FQM6DOAFDXXSTCS2T2DGID");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromaprint'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Chromaprint library is the core component of the AcoustID project. It&#39, s a
...
License for binaries is GPLv2+ but source code is MIT + LGPLv2+");
  ...
  script_tag(name:"affected", value:"'chromaprint' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromaprint", rpm:"chromaprint~1.5.1~8.fc38", rls:"FC38"))) {
    report += res;
  }
