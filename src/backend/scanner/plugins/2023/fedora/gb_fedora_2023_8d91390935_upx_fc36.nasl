...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823168");
  ...
  script_name("Fedora: Security Advisory for upx (FEDORA-2023-8d91390935)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-8d91390935");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EL3BVKIGG3SH6I3KPOYQAWCBD4UMPOPI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'upx'
  package(s) announced via the FEDORA-2023-8d91390935 advisory.");
...
executables suffer no memory overhead or other drawbacks.");
  ...
  script_tag(name:"affected", value:"'upx' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"upx", rpm:"upx~4.0.1~2.fc36", rls:"FC36"))) {
    report += res;
  }
