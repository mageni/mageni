...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885308");
  ...
  script_tag(name:"creation_date", value:"2023-11-22 02:16:34 +0000 (Wed, 22 Nov 2023)");
  script_name("Fedora: Security Advisory for audiofile (FEDORA-2023-07669abb35)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-07669abb35");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/N4JXZ6QAMA3TSRY6GUZRY3WTHR7P5TPH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'audiofile'
  package(s) announced via the FEDORA-2023-07669abb35 advisory.");
...
any of the sound file formats it can handle.");
  ...
  script_tag(name:"affected", value:"'audiofile' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"audiofile", rpm:"audiofile~0.3.6~36.fc38", rls:"FC38"))) {
    report += res;
  }
