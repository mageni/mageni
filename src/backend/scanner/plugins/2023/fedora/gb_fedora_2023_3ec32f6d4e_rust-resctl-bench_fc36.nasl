...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827035");
  ...
  script_tag(name:"creation_date", value:"2023-01-31 02:03:47 +0000 (Tue, 31 Jan 2023)");
  script_name("Fedora: Security Advisory for rust-resctl-bench (FEDORA-2023-3ec32f6d4e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YVNXTZVZW2XSOCEBDPLNS3UY6GSRBRHV");
...
understandable reports.");
  ...
  script_tag(name:"affected", value:"'rust-resctl-bench' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-resctl-bench", rpm:"rust-resctl-bench~2.1.2~8.fc36", rls:"FC36"))) {
    report += res;
  }
