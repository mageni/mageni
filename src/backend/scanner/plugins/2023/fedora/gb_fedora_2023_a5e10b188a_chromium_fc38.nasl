...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827256");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:05:59 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BDFRV5JSGI45APKJS5WE7USEG3D5E2FE");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~111.0.5563.64~2.fc38", rls:"FC38"))) {
    report += res;
  }
