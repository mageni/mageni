...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827309");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:07:33 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for xine-lib (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FH77LIZOTVVJREGBRY453MVXXLX2QXMM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xine-lib'
...
common multimedia formats available - and some uncommon formats, too.");
  ...
  script_tag(name:"affected", value:"'xine-lib' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xine-lib", rpm:"xine-lib~1.2.13~1.fc38", rls:"FC38"))) {
    report += res;
  }
