...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885069");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:19 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for watchman (FEDORA-2023-17efd3f2cd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/U3ZKWWUUD7UUMNRIRVC4ZQQGKU5DKU27");
...
trigger actions (such as rebuilding assets) when matching files change.");
  ...
  script_tag(name:"affected", value:"'watchman' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"watchman", rpm:"watchman~2021.05.10.00~24.fc38", rls:"FC38"))) {
    report += res;
  }
