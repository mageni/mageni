...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827837");
  ...
  script_tag(name:"creation_date", value:"2023-06-17 01:09:17 +0000 (Sat, 17 Jun 2023)");
  script_name("Fedora: Security Advisory for syncthing (FEDORA-2023-39eb10ec3c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-39eb10ec3c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XEBWSQVGHSTR4ZO7LVVEMPEGMV2DS5XR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'syncthing'
  package(s) announced via the FEDORA-2023-39eb10ec3c advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"syncthing", rpm:"syncthing~1.23.5~1.fc38", rls:"FC38"))) {
    report += res;
  }
