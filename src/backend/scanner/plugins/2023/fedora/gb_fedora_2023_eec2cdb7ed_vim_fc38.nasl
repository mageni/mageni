...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885319");
  ...
  script_tag(name:"creation_date", value:"2023-11-27 02:16:19 +0000 (Mon, 27 Nov 2023)");
  script_name("Fedora: Security Advisory for vim (FEDORA-2023-eec2cdb7ed)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-eec2cdb7ed");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VNRNYLWXZOGTYWE5HMFNQ5FVE3HBUHF6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the FEDORA-2023-eec2cdb7ed advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vim", rpm:"vim~9.0.2120~1.fc38", rls:"FC38"))) {
    report += res;
  }
