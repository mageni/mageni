...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884944");
  ...
  script_tag(name:"creation_date", value:"2023-10-05 01:26:58 +0000 (Thu, 05 Oct 2023)");
  script_name("Fedora: Security Advisory for slurm (FEDORA-2023-155d2f22f1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YDLWSMQYXF2ZGOQKCG26H6ZZA5FEH7HX");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"slurm", rpm:"slurm~22.05.9~5.fc37", rls:"FC37"))) {
    report += res;
  }
