...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884751");
  ...
  script_name("Fedora: Security Advisory for netconsd (FEDORA-2023-84b7db808d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-84b7db808d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XYQD77QSJ6ZTGA6AHORG3M3XIVBDL33J");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netconsd'
  package(s) announced via the FEDORA-2023-84b7db808d advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netconsd", rpm:"netconsd~0.3~1.fc37", rls:"FC37"))) {
    report += res;
  }
