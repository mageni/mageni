...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884723");
  ...
  script_tag(name:"creation_date", value:"2023-09-02 01:13:28 +0000 (Sat, 02 Sep 2023)");
  script_name("Fedora: Security Advisory for mosquitto (FEDORA-2023-e7ed15ab9e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-e7ed15ab9e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DFD6IJDNRD5XUEBATC2JN4SNFTYZHO5P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mosquitto'
  package(s) announced via the FEDORA-2023-e7ed15ab9e advisory.");
...
like the Arduino.");
  ...
  script_tag(name:"affected", value:"'mosquitto' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mosquitto", rpm:"mosquitto~2.0.17~1.fc37", rls:"FC37"))) {
    report += res;
  }
