...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885089");
  ...
  script_tag(name:"creation_date", value:"2023-10-28 01:17:15 +0000 (Sat, 28 Oct 2023)");
  script_name("Fedora: Security Advisory for redis (FEDORA-2023-8a9087f089)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-8a9087f089");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BNEK2K4IE7MPKRD6H36JXZMJKYS6I5GQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis'
  package(s) announced via the FEDORA-2023-8a9087f089 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~7.0.14~1.fc37", rls:"FC37"))) {
    report += res;
  }
