...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885075");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:24 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for mcrouter (FEDORA-2023-2a9214af5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/I5YWFDWT5C7HRGLQW5NQESIAXYKVDGSH");
...
memcached hosts.");
  ...
  script_tag(name:"affected", value:"'mcrouter' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mcrouter", rpm:"mcrouter~0.41.0.20231016~1.fc37", rls:"FC37"))) {
    report += res;
  }
