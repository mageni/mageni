...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884661");
  ...
  script_name("Fedora: Security Advisory for nodejs18 (FEDORA-2023-d12a917ab4)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2WPAR5Y3NCBOB4YQJBGGRIU3SZMBRWTW");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs18", rpm:"nodejs18~18.17.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
