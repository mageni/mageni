...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827513");
  script_version("2023-04-19T10:08:55+0000");
  script_cve_id("CVE-2023-26253", "CVE-2022-48340");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2023-04-19 10:08:55 +0000 (Wed, 19 Apr 2023)");
  script_tag(name:"creation_date", value:"2023-04-13 01:08:06 +0000 (Thu, 13 Apr 2023)");
  script_name("Fedora: Security Advisory for glusterfs (FEDORA-2023-5a54eea360)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-5a54eea360");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UE6K2DXP4QZVKP32Z7BSYDSRBL4H7JSE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glusterfs'
  package(s) announced via the FEDORA-2023-5a54eea360 advisory.");
...
and client framework.");
  ...
  script_tag(name:"affected", value:"'glusterfs' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glusterfs", rpm:"glusterfs~10.4~1.fc37", rls:"FC37"))) {
    report += res;
  }
