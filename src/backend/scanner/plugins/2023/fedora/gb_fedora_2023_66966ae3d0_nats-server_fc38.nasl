...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885337");
  ...
  script_tag(name:"creation_date", value:"2023-11-29 02:14:33 +0000 (Wed, 29 Nov 2023)");
  script_name("Fedora: Security Advisory for nats-server (FEDORA-2023-66966ae3d0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NSDBM4KUCTTZG23IFBFP2VXAK5T7M5LB");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nats-server", rpm:"nats-server~2.10.5~1.fc38", rls:"FC38"))) {
    report += res;
  }
