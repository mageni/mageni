...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827034");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2023-dfeb282345)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-dfeb282345");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M2ZHRPV52MY7OE6O7KFJDX32B3MNP3GQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2023-dfeb282345 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.15~1.fc37", rls:"FC37"))) {
    report += res;
  }
