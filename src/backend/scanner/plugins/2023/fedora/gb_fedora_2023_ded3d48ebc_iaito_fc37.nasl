...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827850");
  ...
  script_name("Fedora: Security Advisory for iaito (FEDORA-2023-ded3d48ebc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ERV755NGHFOCWGDHWZH5D3VZWEDF7NHP");
...
Closer integration between r2 and the UI.");
  ...
  script_tag(name:"affected", value:"'iaito' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"iaito", rpm:"iaito~5.8.6~1.fc37", rls:"FC37"))) {
    report += res;
  }
