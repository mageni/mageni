...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827474");
  ...
  script_tag(name:"creation_date", value:"2023-04-05 01:06:34 +0000 (Wed, 05 Apr 2023)");
  script_name("Fedora: Security Advisory for nodejs20 (FEDORA-2023-973319d5b7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VPOJRV5BEXFABHXM6TMDDG3IK4TK2HT7");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs20", rpm:"nodejs20~19.8.1~7.fc38", rls:"FC38"))) {
    report += res;
  }
