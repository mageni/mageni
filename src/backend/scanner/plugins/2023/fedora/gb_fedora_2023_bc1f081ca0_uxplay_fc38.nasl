...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885421");
  ...
  script_tag(name:"creation_date", value:"2023-12-07 02:23:15 +0000 (Thu, 07 Dec 2023)");
  script_name("Fedora: Security Advisory for uxplay (FEDORA-2023-bc1f081ca0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4GLO6KZDCAGC6MJ3PWHP5FTI4Q53MSVM");
...
server in non-mirror mode.");
  ...
  script_tag(name:"affected", value:"'uxplay' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"uxplay", rpm:"uxplay~1.66~2.fc38", rls:"FC38"))) {
    report += res;
  }
