...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827444");
  ...
  script_tag(name:"creation_date", value:"2023-04-05 01:06:27 +0000 (Wed, 05 Apr 2023)");
  script_name("Fedora: Security Advisory for nodejs16 (FEDORA-2023-973319d5b7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HGAP3HF35PBVVAEUHUFTLYYO2HGNWJLO");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs16", rpm:"nodejs16~16.20.0~2.fc38", rls:"FC38"))) {
    report += res;
  }
