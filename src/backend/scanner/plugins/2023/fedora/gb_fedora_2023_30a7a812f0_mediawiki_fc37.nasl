...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-30a7a812f0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AP65YEN762IBNQPOYGUVLTQIDLM5XD2A");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mediawiki'
  package(s) announced via the FEDORA-2023-30a7a812f0 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mediawiki", rpm:"mediawiki~1.38.5~1.fc37", rls:"FC37"))) {
    report += res;
  }
