...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885342");
  ...
  script_tag(name:"creation_date", value:"2023-11-29 02:14:39 +0000 (Wed, 29 Nov 2023)");
  script_name("Fedora: Security Advisory for nats-server (FEDORA-2023-3a895ff65c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JLNJCLQMUXU55JWMONQFOJL54PGJ5G2N");
...
Computing Foundation (CNCF).");
  ...
  script_tag(name:"affected", value:"'nats-server' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nats-server", rpm:"nats-server~2.10.5~1.fc39", rls:"FC39"))) {
    report += res;
  }
