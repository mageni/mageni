...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827580");
  ...
  script_name("Fedora: Security Advisory for frr (FEDORA-2023-77d00facd0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-77d00facd0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BBXEXL2ZQBWCBLNUP6P67FHECXQWSK3L");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'frr'
  package(s) announced via the FEDORA-2023-77d00facd0 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"frr", rpm:"frr~8.5~1.fc38", rls:"FC38"))) {
    report += res;
  }
