...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885269");
  ...
  script_name("Fedora: Security Advisory for microcode_ctl (FEDORA-2023-3dfc0123b0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-3dfc0123b0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IYITCRYXBMTUREOMDJRIHZNBZANNMCDP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl'
  package(s) announced via the FEDORA-2023-3dfc0123b0 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~55.2.fc38", rls:"FC38"))) {
    report += res;
  }
