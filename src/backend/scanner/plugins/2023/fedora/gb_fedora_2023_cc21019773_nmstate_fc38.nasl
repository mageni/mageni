...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827658");
  ...
  script_name("Fedora: Security Advisory for nmstate (FEDORA-2023-cc21019773)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A7FZDW3S2474MNG2RJLTMFTHAKFD6BPZ");
...
provider support on the southbound.");
  ...
  script_tag(name:"affected", value:"'nmstate' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nmstate", rpm:"nmstate~2.2.10~4.fc38", rls:"FC38"))) {
    report += res;
  }
