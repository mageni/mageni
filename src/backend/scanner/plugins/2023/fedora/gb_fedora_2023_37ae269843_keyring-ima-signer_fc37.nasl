...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827744");
  ...
  script_tag(name:"creation_date", value:"2023-05-19 01:07:17 +0000 (Fri, 19 May 2023)");
  script_name("Fedora: Security Advisory for keyring-ima-signer (FEDORA-2023-37ae269843)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PE65BSWWMOBQKHSJZJ77ASXZHQYFJV6O");
...
stored in the kernel keyring to ensure they&#39, re not recoverable.");
  ...
  script_tag(name:"affected", value:"'keyring-ima-signer' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"keyring-ima-signer", rpm:"keyring-ima-signer~0.1.0~9.fc37", rls:"FC37"))) {
    report += res;
  }
