...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827775");
  ...
  script_tag(name:"creation_date", value:"2023-05-30 01:06:33 +0000 (Tue, 30 May 2023)");
  script_name("Fedora: Security Advisory for bottles (FEDORA-2023-328397d034)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VO32NWST44KUXQAVG4GGSZAF4TO5D43P");
...
Features:
  ...
  * .. and much more that you can find by installing Bottles!");
  ...
  script_tag(name:"affected", value:"'bottles' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bottles", rpm:"bottles~51.6~1.fc37", rls:"FC37"))) {
    report += res;
  }
