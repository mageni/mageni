...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827254");
  ...
  script_name("Fedora: Security Advisory for audacious-plugins (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RSWWFVOCZRMMOAPFQVY53GZLL3FBMMOT");
  ...
  script_tag(name:"affected", value:"'audacious-plugins' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"audacious-plugins", rpm:"audacious-plugins~4.3~2.fc38", rls:"FC38"))) {
    report += res;
  }
