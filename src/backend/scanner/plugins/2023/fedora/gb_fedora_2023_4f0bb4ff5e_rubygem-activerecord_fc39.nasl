...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884794");
  ...
  script_name("Fedora: Security Advisory for rubygem-activerecord (FEDORA-2023-4f0bb4ff5e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PRCIZQCU2DVAYJCI3ONWDIPSRUJSHDYK");
...
manual SQL.");
  ...
  script_tag(name:"affected", value:"'rubygem-activerecord' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-activerecord", rpm:"rubygem-activerecord~7.0.7.2~1.fc39", rls:"FC39"))) {
    report += res;
  }
