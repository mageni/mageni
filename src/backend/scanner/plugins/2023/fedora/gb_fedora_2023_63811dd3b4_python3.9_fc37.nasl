...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884710");
  ...
  script_name("Fedora: Security Advisory for python3.9 (FEDORA-2023-63811dd3b4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-63811dd3b4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SOLROHPCZJQQ65N2HUTBYXMOFWZH7SZL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.9'
  package(s) announced via the FEDORA-2023-63811dd3b4 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.9", rpm:"python3.9~3.9.18~1.fc37", rls:"FC37"))) {
    report += res;
  }
