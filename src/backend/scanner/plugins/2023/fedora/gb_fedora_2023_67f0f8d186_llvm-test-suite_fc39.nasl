...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885166");
  ...
  script_name("Fedora: Security Advisory for llvm-test-suite (FEDORA-2023-67f0f8d186)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZD22UMCUS3I7JVTQDZ3VP5TUF5Q4A2OV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'llvm-test-suite'
  package(s) announced via the FEDORA-2023-67f0f8d186 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"C/C++ Compiler Test Suite that is maintained as an LLVM sub-project.  This test
suite can be run with any compiler, not just clang.");

  script_tag(name:"affected", value:"'llvm-test-suite' package(s) on Fedora 39.");
