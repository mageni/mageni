...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827659");
  ...
  script_tag(name:"creation_date", value:"2023-05-08 01:06:33 +0000 (Mon, 08 May 2023)");
  script_name("Fedora: Security Advisory for rust-below (FEDORA-2023-cc21019773)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RWSM4MFSO3YN42C25A7GHNFECY2M4S3O");
...
atop&#39, s design and style decisions.");
  ...
  script_tag(name:"affected", value:"'rust-below' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-below", rpm:"rust-below~0.6.3~4.fc38", rls:"FC38"))) {
    report += res;
  }
