...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827402");
  ...
  script_tag(name:"creation_date", value:"2023-04-02 01:05:03 +0000 (Sun, 02 Apr 2023)");
  script_name("Fedora: Security Advisory for amanda (FEDORA-2023-3d0619d767)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-3d0619d767");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ATMGMVS3QDN6OMKMHGUTUTU7NS7HR3BZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'amanda'
  package(s) announced via the FEDORA-2023-3d0619d767 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"amanda", rpm:"amanda~3.5.3~1.fc38", rls:"FC38"))) {
    report += res;
  }
