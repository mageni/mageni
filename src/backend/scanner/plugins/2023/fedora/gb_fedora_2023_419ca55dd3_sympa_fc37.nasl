...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827818");
  ...
  script_tag(name:"creation_date", value:"2023-06-12 01:07:04 +0000 (Mon, 12 Jun 2023)");
  script_name("Fedora: Security Advisory for sympa (FEDORA-2023-419ca55dd3)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-419ca55dd3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MC5HV4ESLV2E23YGHNJ542QEZBH6YE2F");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sympa'
  package(s) announced via the FEDORA-2023-419ca55dd3 advisory.");
...
and encryption.");
  ...
  script_tag(name:"affected", value:"'sympa' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sympa", rpm:"sympa~6.2.72~2.fc37", rls:"FC37"))) {
    report += res;
  }
