...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827776");
  ...
  script_name("Fedora: Security Advisory for python-fastapi (FEDORA-2023-9329cee69d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EIO5EL6WHF7I3ZI5BROWSOS73A2MOF6J");
...
The key features are:
  ...
  * estimation based on tests on an internal development team, building production
  ...
  script_tag(name:"affected", value:"'python-fastapi' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-fastapi", rpm:"python-fastapi~0.95.2~1.fc38", rls:"FC38"))) {
    report += res;
  }
