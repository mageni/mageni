...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885386");
  ...
  script_name("Fedora: Security Advisory for keyring-ima-signer (FEDORA-2023-6215ea423b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MMI74PXJV7IFPSY3NX2ZQMT72UHXWHUZ");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"keyring-ima-signer", rpm:"keyring-ima-signer~0.1.0~11.fc38", rls:"FC38"))) {
    report += res;
  }
