...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884883");
  ...
  script_name("Fedora: Security Advisory for firecracker (FEDORA-2023-c19aaa2283)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CYKI4PDNZGOFPPRRXUFEGFSITSCTQBTO");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firecracker", rpm:"firecracker~1.4.1~2.fc38", rls:"FC38"))) {
    report += res;
  }
