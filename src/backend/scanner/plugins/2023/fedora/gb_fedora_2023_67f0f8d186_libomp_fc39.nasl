...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885202");
  ...
  script_name("Fedora: Security Advisory for libomp (FEDORA-2023-67f0f8d186)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FXRZPV44LT7CKFVQDZ6Z5D2YGPEO2UP2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libomp'
  package(s) announced via the FEDORA-2023-67f0f8d186 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"OpenMP runtime for clang.");

  script_tag(name:"affected", value:"'libomp' package(s) on Fedora 39.");
