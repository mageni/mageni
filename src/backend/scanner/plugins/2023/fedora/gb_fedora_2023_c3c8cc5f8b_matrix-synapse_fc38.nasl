...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885036");
  ...
  script_tag(name:"creation_date", value:"2023-10-20 01:19:40 +0000 (Fri, 20 Oct 2023)");
  script_name("Fedora: Security Advisory for matrix-synapse (FEDORA-2023-c3c8cc5f8b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-c3c8cc5f8b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WRO4MPQ6HOXIUZM6RJP6VTCTMV7RD2T3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'matrix-synapse'
  package(s) announced via the FEDORA-2023-c3c8cc5f8b advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"matrix-synapse", rpm:"matrix-synapse~1.94.0~2.fc38", rls:"FC38"))) {
    report += res;
  }
