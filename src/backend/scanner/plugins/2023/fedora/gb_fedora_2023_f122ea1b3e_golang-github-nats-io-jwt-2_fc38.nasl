...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884948");
  ...
  script_name("Fedora: Security Advisory for golang-github-nats-io-jwt-2 (FEDORA-2023-f122ea1b3e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RLG2SHPNAMU23DJSYJMTCUWLCJEEPDSE");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nats-io-jwt-2", rpm:"golang-github-nats-io-jwt-2~2.5.2~1.fc38", rls:"FC38"))) {
    report += res;
  }
