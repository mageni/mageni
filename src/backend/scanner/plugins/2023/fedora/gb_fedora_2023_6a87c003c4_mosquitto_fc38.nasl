...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884715");
  ...
  script_tag(name:"creation_date", value:"2023-09-02 01:13:21 +0000 (Sat, 02 Sep 2023)");
  script_name("Fedora: Security Advisory for mosquitto (FEDORA-2023-6a87c003c4)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DRTMAZJQJDCNP2H4QY5TNXTU4RWGWXHI");
...
like the Arduino.");
  ...
  script_tag(name:"affected", value:"'mosquitto' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mosquitto", rpm:"mosquitto~2.0.17~1.fc38", rls:"FC38"))) {
    report += res;
  }
