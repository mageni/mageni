...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-2e38c3756f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VNV2GNZXOTEDAJRFH3ZYWRUBGIVL7BSU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'yarnpkg'
  package(s) announced via the FEDORA-2023-2e38c3756f advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yarnpkg", rpm:"yarnpkg~1.22.19~5.fc38", rls:"FC38"))) {
    report += res;
  }
