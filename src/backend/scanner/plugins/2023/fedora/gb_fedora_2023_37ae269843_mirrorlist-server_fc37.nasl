...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827746");
  ...
  script_name("Fedora: Security Advisory for mirrorlist-server (FEDORA-2023-37ae269843)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NCL3VDTDRKFB5WNCLHB4KUDEMS2HT2XH");
  ...
  script_tag(name:"insight", value:"The mirrorlist-server uses the data created by MirrorManager2
to answer client request for the 'best' mirror.
...
than the Python version.");
  ...
  script_tag(name:"affected", value:"'mirrorlist-server' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mirrorlist-server", rpm:"mirrorlist-server~3.0.6~6.fc37", rls:"FC37"))) {
    report += res;
  }
