...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2023-05-31 01:07:20 +0000 (Wed, 31 May 2023)");
  script_name("Fedora: Security Advisory for microcode_ctl (FEDORA-2023-b28dc472b0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-b28dc472b0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NRFJFIKOCATKQ32CZ4GG3D5XDIMF6L6P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl'
  package(s) announced via the FEDORA-2023-b28dc472b0 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~53.1.fc37", rls:"FC37"))) {
    report += res;
  }
