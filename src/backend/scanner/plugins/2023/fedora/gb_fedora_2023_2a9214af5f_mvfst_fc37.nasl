...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885068");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:18 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for mvfst (FEDORA-2023-2a9214af5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/F44KR6XPT7JECUY5Y7RK4NDJWFNAK5AC");
...
features to support large scale deployments.");
  ...
  script_tag(name:"affected", value:"'mvfst' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mvfst", rpm:"mvfst~2023.10.16.00~1.fc37", rls:"FC37"))) {
    report += res;
  }
