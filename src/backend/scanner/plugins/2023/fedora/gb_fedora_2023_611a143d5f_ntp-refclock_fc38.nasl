...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827856");
  ...
  script_name("Fedora: Security Advisory for ntp-refclock (FEDORA-2023-611a143d5f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-611a143d5f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IY2SVYH4MKPAXEYHCCXD3Z6VGINLSVHK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp-refclock'
  package(s) announced via the FEDORA-2023-611a143d5f advisory.");
...
the system clock.");
  ...
  script_tag(name:"affected", value:"'ntp-refclock' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp-refclock", rpm:"ntp-refclock~0.6~1.fc38", rls:"FC38"))) {
    report += res;
  }
