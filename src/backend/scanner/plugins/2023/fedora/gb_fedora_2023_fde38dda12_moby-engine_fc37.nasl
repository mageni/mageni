...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823127");
  ...
  script_tag(name:"creation_date", value:"2023-01-11 02:01:31 +0000 (Wed, 11 Jan 2023)");
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2023-fde38dda12)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-fde38dda12");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5QXXO3TDARAQVD6XOZMJMXGOUH63RFFO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'moby-engine'
  package(s) announced via the FEDORA-2023-fde38dda12 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~20.10.22~1.fc37", rls:"FC37"))) {
    report += res;
  }
