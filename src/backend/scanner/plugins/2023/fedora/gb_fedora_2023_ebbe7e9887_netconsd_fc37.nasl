...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885116");
  ...
  script_tag(name:"creation_date", value:"2023-11-03 02:22:10 +0000 (Fri, 03 Nov 2023)");
  script_name("Fedora: Security Advisory for netconsd (FEDORA-2023-ebbe7e9887)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-ebbe7e9887");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JSZ24POKYNJRCVUYN6XY2QHOEMV3YQQM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netconsd'
  package(s) announced via the FEDORA-2023-ebbe7e9887 advisory.");
...
netconsd with the content and metadata for netconsole messages it receives.");
  ...
  script_tag(name:"affected", value:"'netconsd' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netconsd", rpm:"netconsd~0.4~1.fc37", rls:"FC37"))) {
    report += res;
  }
