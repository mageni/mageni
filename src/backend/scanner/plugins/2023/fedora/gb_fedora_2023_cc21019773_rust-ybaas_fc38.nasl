...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827665");
  ...
  script_name("Fedora: Security Advisory for rust-ybaas (FEDORA-2023-cc21019773)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VBXB3VHKNEXRZDQ7LTXGTYKJPXI6Z6Z3");
...
you can use yubibomb as a service!");
  ...
  script_tag(name:"affected", value:"'rust-ybaas' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-ybaas", rpm:"rust-ybaas~0.0.10~7.fc38", rls:"FC38"))) {
    report += res;
  }
