...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827021");
  ...
  script_tag(name:"creation_date", value:"2023-01-29 02:02:30 +0000 (Sun, 29 Jan 2023)");
  script_name("Fedora: Security Advisory for rust-bat (FEDORA-2023-e3c8abd37e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IPUXRBKZ754LG5HBL6DYC2UQK5V4B2UC");
  ...
  script_tag(name:"affected", value:"'rust-bat' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-bat", rpm:"rust-bat~0.21.0~6.fc37", rls:"FC37"))) {
    report += res;
  }
