...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827081");
  ...
  script_tag(name:"creation_date", value:"2023-02-10 02:01:57 +0000 (Fri, 10 Feb 2023)");
  script_name("Fedora: Security Advisory for opusfile (FEDORA-2023-6d18f920d2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-6d18f920d2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2ODIA6QRIRBNF2HRXOE5VCZ2AFP4ZB4R");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opusfile'
  package(s) announced via the FEDORA-2023-6d18f920d2 advisory.");
...
(including seeking).
  ...
  * Support for both random access and streaming data sources.");
  ...
  script_tag(name:"affected", value:"'opusfile' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opusfile", rpm:"opusfile~0.12~9.fc37", rls:"FC37"))) {
    report += res;
  }
