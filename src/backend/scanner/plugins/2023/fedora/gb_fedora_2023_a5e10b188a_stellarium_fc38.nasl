...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827280");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:05:19 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for stellarium (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NDWRSRMF4CFLLXXYVOCS5FQXTWZNVK5Y");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"stellarium", rpm:"stellarium~1.2~8.fc38", rls:"FC38"))) {
    report += res;
  }
