...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885071");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:20 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for proxygen (FEDORA-2023-2a9214af5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PFIVAFYJ72LJM5RA5CYDKKTLR3MFYTYH");
...
library.");
  ...
  script_tag(name:"affected", value:"'proxygen' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"proxygen", rpm:"proxygen~2023.10.16.00~1.fc37", rls:"FC37"))) {
    report += res;
  }
