...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827865");
  ...
  script_tag(name:"creation_date", value:"2023-06-24 01:07:22 +0000 (Sat, 24 Jun 2023)");
  script_name("Fedora: Security Advisory for trafficserver (FEDORA-2023-92686b3e8b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-92686b3e8b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6GDCBNFDDW6ULW7CACJCPENI7BVDHM5O");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trafficserver'
  package(s) announced via the FEDORA-2023-92686b3e8b advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trafficserver", rpm:"trafficserver~9.2.1~1.fc37", rls:"FC37"))) {
    report += res;
  }
