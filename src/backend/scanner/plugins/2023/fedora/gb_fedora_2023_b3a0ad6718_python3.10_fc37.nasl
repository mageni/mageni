...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884713");
  ...
  script_tag(name:"creation_date", value:"2023-09-01 01:16:50 +0000 (Fri, 01 Sep 2023)");
  script_name("Fedora: Security Advisory for python3.10 (FEDORA-2023-b3a0ad6718)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-b3a0ad6718");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QGFWUVGWV6JF35HI33B5ZD2OLWCDAC6N");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.10'
  package(s) announced via the FEDORA-2023-b3a0ad6718 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.10", rpm:"python3.10~3.10.13~1.fc37", rls:"FC37"))) {
    report += res;
  }
