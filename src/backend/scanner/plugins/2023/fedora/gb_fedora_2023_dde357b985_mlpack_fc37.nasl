...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885236");
  ...
  script_name("Fedora: Security Advisory for mlpack (FEDORA-2023-dde357b985)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-dde357b985");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/S5NJKY5AEW4NJM2KJ466XVYM5HPFZSUI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mlpack'
  package(s) announced via the FEDORA-2023-dde357b985 advisory.");
...
margins.");
  ...
  script_tag(name:"affected", value:"'mlpack' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mlpack", rpm:"mlpack~4.2.1~5.fc37", rls:"FC37"))) {
    report += res;
  }
