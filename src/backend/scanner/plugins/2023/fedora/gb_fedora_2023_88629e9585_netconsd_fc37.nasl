...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827408");
  ...
  script_tag(name:"creation_date", value:"2023-04-03 01:06:29 +0000 (Mon, 03 Apr 2023)");
  script_name("Fedora: Security Advisory for netconsd (FEDORA-2023-88629e9585)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-88629e9585");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7DM7QBQBBYRJZ2ZGF7UCXNG5CKAL3HFM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netconsd'
  package(s) announced via the FEDORA-2023-88629e9585 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netconsd", rpm:"netconsd~0.2~1.fc37", rls:"FC37"))) {
    report += res;
  }
