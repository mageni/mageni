...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884878");
  ...
  script_tag(name:"creation_date", value:"2023-09-28 01:13:54 +0000 (Thu, 28 Sep 2023)");
  script_name("Fedora: Security Advisory for firecracker (FEDORA-2023-1db67725f2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-1db67725f2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IPXRXD5VXBZHBGMUM77B52CJJMG7EJGI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firecracker'
  package(s) announced via the FEDORA-2023-1db67725f2 advisory.");
...
release.  It is not production ready without additional sandboxing.");
  ...
  script_tag(name:"affected", value:"'firecracker' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firecracker", rpm:"firecracker~1.4.1~2.fc37", rls:"FC37"))) {
    report += res;
  }
