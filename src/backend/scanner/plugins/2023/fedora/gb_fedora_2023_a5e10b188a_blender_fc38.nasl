...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827313");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:10:35 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for blender (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CELCEZDO3ERUV3JC5ZYJROUQP5PWBANI");
...
secure, multi-platform content to the web, CD-ROMs, and other media.");
  ...
  script_tag(name:"affected", value:"'blender' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"blender", rpm:"blender~3.4.1~16.fc38", rls:"FC38"))) {
    report += res;
  }
