...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885390");
  ...
  script_name("Fedora: Security Advisory for perl-PAR-Packer (FEDORA-2023-c67f4dbf13)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UEYBXYHCEYU5SZYCY7EKKGBWNY63S2R2");
...
stand-alone executables, perl scripts and PAR files.");
  ...
  script_tag(name:"affected", value:"'perl-PAR-Packer' package(s) on Fedora 39.");
