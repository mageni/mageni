...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884934");
  ...
  script_name("Fedora: Security Advisory for nats-server (FEDORA-2023-f122ea1b3e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YZYFOBLWBXEJHPTHTLW7AOO4E7KNZQMB");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nats-server", rpm:"nats-server~2.10.1~4.fc38", rls:"FC38"))) {
    report += res;
  }
