...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884943");
  ...
  script_tag(name:"creation_date", value:"2023-10-05 01:26:57 +0000 (Thu, 05 Oct 2023)");
  script_name("Fedora: Security Advisory for pmix (FEDORA-2023-155d2f22f1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DRGBNM5IZ4RKCK23AL2UGWBPJL2HFIDH");
...
scalability.");
  ...
  script_tag(name:"affected", value:"'pmix' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pmix", rpm:"pmix~4.1.3~1.fc37", rls:"FC37"))) {
    report += res;
  }
