...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823150");
  ...
  script_tag(name:"creation_date", value:"2023-01-13 02:06:21 +0000 (Fri, 13 Jan 2023)");
  script_name("Fedora: Security Advisory for phoronix-test-suite (FEDORA-2023-e363201a4c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-e363201a4c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QPCTVMSEML2YHIUKIQHE3ZVBSAAZOJZD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phoronix-test-suite'
  package(s) announced via the FEDORA-2023-e363201a4c advisory.");
...
users only for confirmation of actions.");
  ...
  script_tag(name:"affected", value:"'phoronix-test-suite' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phoronix-test-suite", rpm:"phoronix-test-suite~10.8.4~2.fc37", rls:"FC37"))) {
    report += res;
  }
