...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827728");
  ...
  script_name("Fedora: Security Advisory for rust-ybaas (FEDORA-2023-80ab942675)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TIBOYRRSBET5MAQ6EFSAHVWTE7HLRPT2");
...
laptop&#39, s USB port? Don&#39, t want the complexity of installing and using the
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-ybaas", rpm:"rust-ybaas~0.0.16~1.fc37", rls:"FC37"))) {
    report += res;
  }
