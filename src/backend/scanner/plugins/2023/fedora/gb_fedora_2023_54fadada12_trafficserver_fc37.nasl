...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885043");
  ...
  script_tag(name:"creation_date", value:"2023-10-22 01:18:28 +0000 (Sun, 22 Oct 2023)");
  script_name("Fedora: Security Advisory for trafficserver (FEDORA-2023-54fadada12)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-54fadada12");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZKQSIKIAT5TJ3WSLU3RDBQ35YX4GY4V3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trafficserver'
  package(s) announced via the FEDORA-2023-54fadada12 advisory.");
...
reverse proxies, Apache Traffic Server is battle hardened.");
  ...
  script_tag(name:"affected", value:"'trafficserver' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trafficserver", rpm:"trafficserver~9.2.3~1.fc37", rls:"FC37"))) {
    report += res;
  }
