...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821378");
  ...
  script_tag(name:"creation_date", value:"2023-02-16 02:02:08 +0000 (Thu, 16 Feb 2023)");
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2023-e449235964)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-e449235964");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NGZ4B5IQJEZQFSXGCZKSJ6GO3HLQ6URQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'community-mysql'
  package(s) announced via the FEDORA-2023-e449235964 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.32~1.fc36", rls:"FC36"))) {
    report += res;
  }
