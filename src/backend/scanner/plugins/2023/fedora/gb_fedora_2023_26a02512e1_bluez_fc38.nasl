...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885439");
  ...
  script_name("Fedora: Security Advisory for bluez (FEDORA-2023-26a02512e1)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-26a02512e1");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/77YQQS5FXPYE6WBBZO3REFIRAUJHERFA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bluez'
  package(s) announced via the FEDORA-2023-26a02512e1 advisory.");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bluez", rpm:"bluez~5.70~5.fc38", rls:"FC38"))) {
    report += res;
  }
