...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827179");
  ...
  script_name("Fedora: Security Advisory for sddm-kcm (FEDORA-2023-e31c3e4b6c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QGMCH35PYM6VIOZQHPQYFG766JRFBX4Y");
...
SDDM Display Manager");
  ...
  script_tag(name:"affected", value:"'sddm-kcm' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sddm-kcm", rpm:"sddm-kcm~5.27.1~1.fc37", rls:"FC37"))) {
    report += res;
  }
