...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885022");
  ...
  script_tag(name:"creation_date", value:"2023-10-16 01:17:18 +0000 (Mon, 16 Oct 2023)");
  script_name("Fedora: Security Advisory for cacti (FEDORA-2023-6335ea9c0c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6A2URG5GMA3GZENU6UBZRRJZUYC4JUNJ");
...
driven.");
  ...
  script_tag(name:"affected", value:"'cacti' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cacti", rpm:"cacti~1.2.25~1.fc38", rls:"FC38"))) {
    report += res;
  }
