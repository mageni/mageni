...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827500");
  ...
  script_tag(name:"creation_date", value:"2023-04-15 01:06:54 +0000 (Sat, 15 Apr 2023)");
  script_name("Fedora: Security Advisory for bzip3 (FEDORA-2023-c08f9dfc16)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-c08f9dfc16");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4JLSE25SV7K2NB6FTFT4UHJOJUHBHYHY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bzip3'
  package(s) announced via the FEDORA-2023-c08f9dfc16 advisory.");
...
and PPM-style context modeling.");
  ...
  script_tag(name:"affected", value:"'bzip3' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bzip3", rpm:"bzip3~1.3.0~1.fc37", rls:"FC37"))) {
    report += res;
  }
