...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827310");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:06:12 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for siril (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/R2DD7BKLCGGHPVHKYUJ7MEVTWXBZ3FA7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'siril'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Siril is an image processing tool specially tailored for noise reduction and
...
enhance pictures from various file formats, even images sequences");

  script_tag(name:"affected", value:"'siril' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"siril", rpm:"siril~1.0.6~6.fc38", rls:"FC38"))) {
    report += res;
  }
