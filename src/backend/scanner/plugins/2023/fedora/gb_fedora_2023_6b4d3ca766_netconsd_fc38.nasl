...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885209");
  ...
  script_name("Fedora: Security Advisory for netconsd (FEDORA-2023-6b4d3ca766)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-6b4d3ca766");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZU56IBE2GRXAKBNYUTNGF6E3SZEDKXBD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netconsd'
  package(s) announced via the FEDORA-2023-6b4d3ca766 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netconsd", rpm:"netconsd~0.4~1.fc38", rls:"FC38"))) {
    report += res;
  }
