...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884779");
  ...
  script_name("Fedora: Security Advisory for python3-docs (FEDORA-2023-aeb32a843f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NY6ULJJLJJ5I4Q6ANX3N7PWJD2UARGWT");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-docs", rpm:"python3-docs~3.11.5~1.fc37", rls:"FC37"))) {
    report += res;
  }
