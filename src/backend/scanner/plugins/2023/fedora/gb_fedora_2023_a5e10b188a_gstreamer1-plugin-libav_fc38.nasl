...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827283");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:10:08 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for gstreamer1-plugin-libav (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BABP3VYE4WJKUDAAPYIPQKEVVHLLTQHU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer1-plugin-libav'
...
This package provides FFmpeg/LibAV GStreamer plugin.");
  ...
  script_tag(name:"affected", value:"'gstreamer1-plugin-libav' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gstreamer1-plugin-libav", rpm:"gstreamer1-plugin-libav~1.22.0~2.fc38", rls:"FC38"))) {
    report += res;
  }
