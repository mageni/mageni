...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827300");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:11:00 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for mlt (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6KAFXTJ6DI3CIQB7XQTZXEG7DCKGNIXE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mlt'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"MLT is an open source multimedia framework, designed and developed for
...
tools, xml authoring components, and an extendible plug-in based API.");
  ...
  script_tag(name:"affected", value:"'mlt' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mlt", rpm:"mlt~7.14.0~2.fc38", rls:"FC38"))) {
    report += res;
  }
