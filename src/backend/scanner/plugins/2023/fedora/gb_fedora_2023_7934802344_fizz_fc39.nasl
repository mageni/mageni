...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885139");
  ...
  script_tag(name:"creation_date", value:"2023-11-05 02:19:02 +0000 (Sun, 05 Nov 2023)");
  script_name("Fedora: Security Advisory for fizz (FEDORA-2023-7934802344)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FVQANWK7TFP7C4PO5K2XJHH2MMO64TVW");
...
PSK resumption, early data, client authentication, and HelloRetryRequest.");
  ...
  script_tag(name:"affected", value:"'fizz' package(s) on Fedora 39.");
