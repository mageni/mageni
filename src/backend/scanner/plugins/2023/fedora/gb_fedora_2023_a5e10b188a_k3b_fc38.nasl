...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827307");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:11:25 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for k3b (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DQWHG3YKYF6IYU4SGEPXALXKXMZ3IKMV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'k3b'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"K3b provides a comfortable user interface to perform most CD/DVD
burning tasks. While the experienced user can take influence in all
steps of the burning process the beginner may find comfort in the
automatic settings and the reasonable k3b defaults which allow a quick
start.");

  script_tag(name:"affected", value:"'k3b' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"k3b", rpm:"k3b~22.12.3~2.fc38", rls:"FC38"))) {
    report += res;
  }
