...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884987");
  ...
  script_tag(name:"creation_date", value:"2023-10-12 01:15:43 +0000 (Thu, 12 Oct 2023)");
  script_name("Fedora: Security Advisory for oneVPL (FEDORA-2023-b6aab4f954)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J7RNFPWOSFII2JE2KDRHPLJANZC3YATW");
...
implementations:
  ...
  script_tag(name:"affected", value:"'oneVPL' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"oneVPL", rpm:"oneVPL~2023.3.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
