...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884922");
  ...
  script_tag(name:"creation_date", value:"2023-10-04 01:16:43 +0000 (Wed, 04 Oct 2023)");
  script_name("Fedora: Security Advisory for firecracker (FEDORA-2023-98f44d1c4c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CIBZVJHNQOFIANMNQ3VL74W45H6F7UJE");
...
release.  It is not production ready without additional sandboxing.");
  ...
  script_tag(name:"affected", value:"'firecracker' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firecracker", rpm:"firecracker~1.4.1~3.fc38", rls:"FC38"))) {
    report += res;
  }
