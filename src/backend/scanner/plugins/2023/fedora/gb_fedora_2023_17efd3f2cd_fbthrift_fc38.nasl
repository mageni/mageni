...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885074");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:23 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for fbthrift (FEDORA-2023-17efd3f2cd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GPSG52LH2JGTMWRVHJSLXAUEKBI6A45D");
...
Thrift server.");
  ...
  script_tag(name:"affected", value:"'fbthrift' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fbthrift", rpm:"fbthrift~2023.10.16.00~1.fc38", rls:"FC38"))) {
    report += res;
  }
