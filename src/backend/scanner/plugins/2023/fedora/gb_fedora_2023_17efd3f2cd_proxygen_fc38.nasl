...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885077");
  ...
  script_tag(name:"creation_date", value:"2023-10-25 01:17:25 +0000 (Wed, 25 Oct 2023)");
  script_name("Fedora: Security Advisory for proxygen (FEDORA-2023-17efd3f2cd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VCI7RLQOLZ7EWC6C4ZHJJWPQMLMBDGPI");
...
library.");
  ...
  script_tag(name:"affected", value:"'proxygen' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"proxygen", rpm:"proxygen~2023.10.16.00~1.fc38", rls:"FC38"))) {
    report += res;
  }
