...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827421");
  ...
  script_name("Fedora: Security Advisory for rubygem-actionpack (FEDORA-2023-d6157bb1e2)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7DGWDU3CRVTYFC7BYPIQHZTUYFAIWWQY");
...
unit/integration testing that doesn&#39, t require a browser.");
  ...
  script_tag(name:"affected", value:"'rubygem-actionpack' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~7.0.4.3~1.fc38", rls:"FC38"))) {
    report += res;
  }
