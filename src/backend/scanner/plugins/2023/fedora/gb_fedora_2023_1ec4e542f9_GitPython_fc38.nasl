...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884695");
  ...
  script_tag(name:"creation_date", value:"2023-08-23 01:10:41 +0000 (Wed, 23 Aug 2023)");
  script_name("Fedora: Security Advisory for GitPython (FEDORA-2023-1ec4e542f9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-1ec4e542f9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PF6AXUTC5BO7L2SBJMCVKJSPKWY52I5R");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'GitPython'
  package(s) announced via the FEDORA-2023-1ec4e542f9 advisory.");
...
and data streaming.");
  ...
  script_tag(name:"affected", value:"'GitPython' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"GitPython", rpm:"GitPython~3.1.32~1.fc38", rls:"FC38"))) {
    report += res;
  }
