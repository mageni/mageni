...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827301");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:08:51 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for attract-mode (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BCEFB3ELUBRF2K2FMSIE5D6QN5KQ37CY");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"attract-mode", rpm:"attract-mode~2.6.2~6.fc38", rls:"FC38"))) {
    report += res;
  }
