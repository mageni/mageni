...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885340");
  ...
  script_tag(name:"creation_date", value:"2023-11-29 02:14:37 +0000 (Wed, 29 Nov 2023)");
  script_name("Fedora: Security Advisory for python-geopandas (FEDORA-2023-8857bdcd95)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-8857bdcd95");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MWFYXLVBTBHNKYRXI572RFX7IJDDQGBL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-geopandas'
  package(s) announced via the FEDORA-2023-8857bdcd95 advisory.");
...
otherwise require a spatial database such as PostGIS.");
  ...
  script_tag(name:"affected", value:"'python-geopandas' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-geopandas", rpm:"python-geopandas~0.14.1~1.fc37", rls:"FC37"))) {
    report += res;
  }
