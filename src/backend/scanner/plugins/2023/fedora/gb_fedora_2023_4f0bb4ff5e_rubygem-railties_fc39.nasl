...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884802");
  ...
  script_name("Fedora: Security Advisory for rubygem-railties (FEDORA-2023-4f0bb4ff5e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HL35O4P5L3PVSVPLB7AG7BZ5SWSWQU2A");
...
Railties is responsible to glue all frameworks together. Overall, it:
  ...
  * provides Rails generators core.");
  ...
  script_tag(name:"affected", value:"'rubygem-railties' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-railties", rpm:"rubygem-railties~7.0.7.2~1.fc39", rls:"FC39"))) {
    report += res;
  }
