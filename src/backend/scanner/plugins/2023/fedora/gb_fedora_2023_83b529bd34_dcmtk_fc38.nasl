...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827287");
  ...
  script_tag(name:"creation_date", value:"2023-03-12 02:04:12 +0000 (Sun, 12 Mar 2023)");
  script_name("Fedora: Security Advisory for dcmtk (FEDORA-2023-83b529bd34)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-83b529bd34");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UMQ2USESKF6OAZAH64OFHNK2HJIJVGPP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dcmtk'
  package(s) announced via the FEDORA-2023-83b529bd34 advisory.");
...
Install DCMTK if you are working with DICOM format medical image files.");
  ...
  script_tag(name:"affected", value:"'dcmtk' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dcmtk", rpm:"dcmtk~3.6.7~3.fc38", rls:"FC38"))) {
    report += res;
  }
