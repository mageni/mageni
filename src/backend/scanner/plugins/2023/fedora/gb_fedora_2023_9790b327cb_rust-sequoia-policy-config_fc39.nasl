...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885409");
  ...
  script_name("Fedora: Security Advisory for rust-sequoia-policy-config (FEDORA-2023-9790b327cb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P5CT6ZG2OUNZ2JOKDJQJYPS7CXP74I7M");
  ...
  script_tag(name:"affected", value:"'rust-sequoia-policy-config' package(s) on Fedora 39.");
