...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827570");
  ...
  script_tag(name:"creation_date", value:"2023-04-23 01:14:10 +0000 (Sun, 23 Apr 2023)");
  script_name("Fedora: Security Advisory for freeimage (FEDORA-2023-748f1d5710)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2J6SP66VE4MVGY777VNSDMOTMQCRWITP");
...
today&#39, s multimedia applications.");
  ...
  script_tag(name:"affected", value:"'freeimage' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freeimage", rpm:"freeimage~3.19.0~0.16.svn1889.fc37", rls:"FC37"))) {
    report += res;
  }
