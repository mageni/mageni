...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885129");
  ...
  script_tag(name:"creation_date", value:"2023-11-05 02:18:44 +0000 (Sun, 05 Nov 2023)");
  script_name("Fedora: Security Advisory for folly (FEDORA-2023-7934802344)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BYVIYKG67GS47F5EVK2YE7VDOWMHKZB6");
...
Folly.");
  ...
  script_tag(name:"affected", value:"'folly' package(s) on Fedora 39.");
