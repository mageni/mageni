...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885266");
  ...
  script_tag(name:"creation_date", value:"2023-11-16 02:16:29 +0000 (Thu, 16 Nov 2023)");
  script_name("Fedora: Security Advisory for frr (FEDORA-2023-ce436d56f8)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-ce436d56f8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JLG64IF3FU7V76K4TKCCXVNEE6P2VUDO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'frr'
  package(s) announced via the FEDORA-2023-ce436d56f8 advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"frr", rpm:"frr~8.5.3~1.fc37", rls:"FC37"))) {
    report += res;
  }
