...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821355");
  ...
  script_tag(name:"creation_date", value:"2023-01-26 02:02:01 +0000 (Thu, 26 Jan 2023)");
  script_name("Fedora: Security Advisory for tor (FEDORA-2023-1254a1fc28)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-1254a1fc28");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IYOLTP6HQO2HPXUYKOR7P5YYYN7CINQQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2023-1254a1fc28 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.7.13~1.fc36", rls:"FC36"))) {
    report += res;
  }
