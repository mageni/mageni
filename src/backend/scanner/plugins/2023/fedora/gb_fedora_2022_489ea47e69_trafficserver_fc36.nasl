...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823090");
  ...
  script_tag(name:"creation_date", value:"2022-12-30 02:14:04 +0000 (Fri, 30 Dec 2022)");
  script_name("Fedora: Security Advisory for trafficserver (FEDORA-2022-489ea47e69)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-489ea47e69");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7ZGWILQKAF2RVM6BPCVU3L4PY3BPJMEH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trafficserver'
  package(s) announced via the FEDORA-2022-489ea47e69 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trafficserver", rpm:"trafficserver~9.1.4~1.fc36", rls:"FC36"))) {
    report += res;
  }
