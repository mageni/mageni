...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827105");
  ...
  script_name("Fedora: Security Advisory for edk2 (FEDORA-2023-e1ffb79ddf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-e1ffb79ddf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VO363SLUAI4JBSF2WZ7XHBERODKZP47B");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'edk2'
  package(s) announced via the FEDORA-2023-e1ffb79ddf advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2", rpm:"edk2~20221117gitfff6d81270b5~13.fc37", rls:"FC37"))) {
    report += res;
  }
