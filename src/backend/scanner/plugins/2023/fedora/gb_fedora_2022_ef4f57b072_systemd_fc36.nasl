...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823089");
  ...
  script_tag(name:"creation_date", value:"2022-12-31 02:13:36 +0000 (Sat, 31 Dec 2022)");
  script_name("Fedora: Security Advisory for systemd (FEDORA-2022-ef4f57b072)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-ef4f57b072");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MS5N5SLYAHKENLAJWYBDKU55ICU3SVZF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the FEDORA-2022-ef4f57b072 advisory.");
...
This package was built from the 250.9-stable branch of systemd.");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"systemd", rpm:"systemd~250.9~1.fc36", rls:"FC36"))) {
    report += res;
  }
