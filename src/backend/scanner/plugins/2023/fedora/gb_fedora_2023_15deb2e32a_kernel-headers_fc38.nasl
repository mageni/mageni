...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885373");
  ...
  script_tag(name:"creation_date", value:"2023-12-05 02:19:50 +0000 (Tue, 05 Dec 2023)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2023-15deb2e32a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YQ7JVDEDZV5SNHG5EW7RHKK2ZN56HSGB");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~6.6.3~100.fc38", rls:"FC38"))) {
    report += res;
  }
