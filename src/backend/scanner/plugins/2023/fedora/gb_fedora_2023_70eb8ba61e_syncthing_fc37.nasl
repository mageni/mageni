...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-70eb8ba61e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BQXTSAL36O7S2OK3ZDPABJUGJMQOC4Q5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'syncthing'
  package(s) announced via the FEDORA-2023-70eb8ba61e advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"syncthing", rpm:"syncthing~1.23.0~2.fc37", rls:"FC37"))) {
    report += res;
  }
