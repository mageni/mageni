...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885045");
  ...
  script_tag(name:"creation_date", value:"2023-10-22 01:18:32 +0000 (Sun, 22 Oct 2023)");
  script_name("Fedora: Security Advisory for python2.7 (FEDORA-2023-e47078af3e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-e47078af3e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KZRZRJHWLZ7MOJNPQBWGJVXMVYDC5BRA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7'
  package(s) announced via the FEDORA-2023-e47078af3e advisory.");
...
This package also provides the 'python2' executable.");
  ...
  script_tag(name:"affected", value:"'python2.7' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2.7", rpm:"python2.7~2.7.18~35.fc37", rls:"FC37"))) {
    report += res;
  }
