...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885510");
  ...
  script_name("Fedora: Security Advisory for python3.12 (FEDORA-2023-c0bf8c0c4e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-c0bf8c0c4e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NEUNZSZ3CVSM2QWVYH3N2XGOCDWNYUA3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.12'
  package(s) announced via the FEDORA-2023-c0bf8c0c4e advisory.");
...
the 'python3.12-' prefix.");
  ...
  script_tag(name:"affected", value:"'python3.12' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.12", rpm:"python3.12~3.12.1~2.fc38", rls:"FC38"))) {
    report += res;
  }
