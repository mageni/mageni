...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884761");
  ...
  script_tag(name:"creation_date", value:"2023-09-13 01:18:52 +0000 (Wed, 13 Sep 2023)");
  script_name("Fedora: Security Advisory for freerdp (FEDORA-2023-10e43bcebb)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-10e43bcebb");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OH2ATH2BKDNKCJAU4WPPXK4SHLE3UJUV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freerdp'
  package(s) announced via the FEDORA-2023-10e43bcebb advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freerdp", rpm:"freerdp~2.11.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
