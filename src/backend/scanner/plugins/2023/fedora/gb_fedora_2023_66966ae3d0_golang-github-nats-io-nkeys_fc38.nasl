...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885347");
  ...
  script_tag(name:"creation_date", value:"2023-11-29 02:14:47 +0000 (Wed, 29 Nov 2023)");
  script_name("Fedora: Security Advisory for golang-github-nats-io-nkeys (FEDORA-2023-66966ae3d0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ULQQONMSCQSH5Z5OWFFQHCGEZ3NL4DRJ");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nats-io-nkeys", rpm:"golang-github-nats-io-nkeys~0.4.6~1.fc38", rls:"FC38"))) {
    report += res;
  }
