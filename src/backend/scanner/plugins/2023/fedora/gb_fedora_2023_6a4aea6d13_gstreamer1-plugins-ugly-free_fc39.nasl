...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885291");
  ...
  script_tag(name:"creation_date", value:"2023-11-19 02:16:45 +0000 (Sun, 19 Nov 2023)");
  script_name("Fedora: Security Advisory for gstreamer1-plugins-ugly-free (FEDORA-2023-6a4aea6d13)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EMYAA63T67CMLKQ2KFQGZE72LSWZSDWK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer1-plugins-ugly-free'
...
This package contains plug-ins whose license is not fully compatible with LGPL.");
  ...
  script_tag(name:"affected", value:"'gstreamer1-plugins-ugly-free' package(s) on Fedora 39.");
