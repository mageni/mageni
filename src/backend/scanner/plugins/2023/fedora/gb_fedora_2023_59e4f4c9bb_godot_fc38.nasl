...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885118");
  ...
  script_name("Fedora: Security Advisory for godot (FEDORA-2023-59e4f4c9bb)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-59e4f4c9bb");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JFCXR2EJGIE24DV45AWX6JJM7RQAT5CY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'godot'
  package(s) announced via the FEDORA-2023-59e4f4c9bb advisory.");
...
export games from the source code), use the --headless flag.");
  ...
  script_tag(name:"affected", value:"'godot' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"godot", rpm:"godot~4.1.2~1.fc38", rls:"FC38"))) {
    report += res;
  }
