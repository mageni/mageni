...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884741");
  ...
  script_name("Fedora: Security Advisory for erofs-utils (FEDORA-2023-f838326992)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-f838326992");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FHOIRL6XH5NYR3LYI3KP5DE4SDSQWR7W");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'erofs-utils'
  package(s) announced via the FEDORA-2023-f838326992 advisory.");
...
This package includes tools to create, check, and extract EROFS images.");
  ...
  script_tag(name:"affected", value:"'erofs-utils' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"erofs-utils", rpm:"erofs-utils~1.6~3.fc38", rls:"FC38"))) {
    report += res;
  }
