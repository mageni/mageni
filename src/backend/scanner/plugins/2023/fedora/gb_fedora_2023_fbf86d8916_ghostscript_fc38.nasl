...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827489");
  ...
  script_name("Fedora: Security Advisory for ghostscript (FEDORA-2023-fbf86d8916)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-fbf86d8916");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DHJX62KSRIOBZA6FKONMJP7MEFY7LTH2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript'
  package(s) announced via the FEDORA-2023-fbf86d8916 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~10.01.0~3.fc38", rls:"FC38"))) {
    report += res;
  }
