...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885382");
  ...
  script_name("Fedora: Security Advisory for rust-tealdeer (FEDORA-2023-6215ea423b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SA4JU2LRKWUSWU3BBLQ6SVARFCUVXZ3H");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-tealdeer", rpm:"rust-tealdeer~1.6.1~5.fc38", rls:"FC38"))) {
    report += res;
  }
