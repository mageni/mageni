...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884814");
  ...
  script_name("Fedora: Security Advisory for rubygem-activestorage (FEDORA-2023-4f0bb4ff5e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5WN2756EUPB5FDATN7DBE5UVVFSY2UYR");
  ...
  script_tag(name:"affected", value:"'rubygem-activestorage' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-activestorage", rpm:"rubygem-activestorage~7.0.7.2~1.fc39", rls:"FC39"))) {
    report += res;
  }
