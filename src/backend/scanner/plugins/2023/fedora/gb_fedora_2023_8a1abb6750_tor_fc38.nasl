...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885514");
  ...
  script_tag(name:"creation_date", value:"2023-12-28 02:18:27 +0000 (Thu, 28 Dec 2023)");
  script_name("Fedora: Security Advisory for tor (FEDORA-2023-8a1abb6750)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-8a1abb6750");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MN7ABZ5GZV3QUCJAEGETQV2DGUVW7KQK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2023-8a1abb6750 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.8.10~1.fc38", rls:"FC38"))) {
    report += res;
  }
