...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884998");
  ...
  script_tag(name:"creation_date", value:"2023-10-13 01:20:00 +0000 (Fri, 13 Oct 2023)");
  script_name("Fedora: Security Advisory for oneVPL-intel-gpu (FEDORA-2023-760e5eb2c6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TULYSWHC3X76AIGGMUSLBTWOXNND6IEV");
...
filtering.");
  ...
  script_tag(name:"affected", value:"'oneVPL-intel-gpu' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"oneVPL-intel-gpu", rpm:"oneVPL-intel-gpu~23.3.4~2.fc37", rls:"FC37"))) {
    report += res;
  }
