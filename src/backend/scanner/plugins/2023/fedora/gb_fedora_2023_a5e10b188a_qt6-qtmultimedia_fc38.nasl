...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827257");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:11:13 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for qt6-qtmultimedia (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OCG2BI3VPS6OBZAKBI75CUZMU3RU4CEJ");
...
the use of available devices like cameras and radios.");
  ...
  script_tag(name:"affected", value:"'qt6-qtmultimedia' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qt6-qtmultimedia", rpm:"qt6-qtmultimedia~6.4.2~4.fc38", rls:"FC38"))) {
    report += res;
  }
