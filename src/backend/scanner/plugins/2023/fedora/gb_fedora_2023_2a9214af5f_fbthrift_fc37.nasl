...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885070");
  ...
  script_name("Fedora: Security Advisory for fbthrift (FEDORA-2023-2a9214af5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MXZXSYEGKJ76O5A6CDF7CTXAKJNE3O3Z");
...
Thrift server.");
  ...
  script_tag(name:"affected", value:"'fbthrift' package(s) on Fedora 37.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fbthrift", rpm:"fbthrift~2023.10.16.00~1.fc37", rls:"FC37"))) {
    report += res;
  }
