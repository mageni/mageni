...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827245");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:09:56 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for kstars (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7CPNNFR7D4YPAC44I2BZ5NSYRFXF64X3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kstars'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"KStars is a Desktop Planetarium.  It provides an accurate graphical
...
all 8 planets, the Sun and Moon, and thousands of comets and asteroids.");
  ...
  script_tag(name:"affected", value:"'kstars' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kstars", rpm:"kstars~3.6.3~1.fc38", rls:"FC38"))) {
    report += res;
  }
