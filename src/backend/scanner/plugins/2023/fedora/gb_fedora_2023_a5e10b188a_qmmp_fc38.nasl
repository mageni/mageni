...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.827284");
  ...
  script_tag(name:"creation_date", value:"2023-03-14 02:08:13 +0000 (Tue, 14 Mar 2023)");
  script_name("Fedora: Security Advisory for qmmp (FEDORA-2023-a5e10b188a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5LMR7KIRJHXVZ4N4AHRY3V27O647UPDI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qmmp'
  package(s) announced via the FEDORA-2023-a5e10b188a advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This program is an audio-player, written with help of Qt library.
...
Main opportunities:
  ...
  * lyrics support");
  ...
  script_tag(name:"affected", value:"'qmmp' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qmmp", rpm:"qmmp~2.1.2~4.fc38", rls:"FC38"))) {
    report += res;
  }
