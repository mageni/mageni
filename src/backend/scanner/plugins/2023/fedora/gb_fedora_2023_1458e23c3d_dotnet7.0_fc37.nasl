...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885287");
  ...
  script_name("Fedora: Security Advisory for dotnet7.0 (FEDORA-2023-1458e23c3d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-1458e23c3d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5YYKFCBKAA7MO5ACSZWLUQGI2JKHVPYI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dotnet7.0'
  package(s) announced via the FEDORA-2023-1458e23c3d advisory.");
...
if(release == "FC37") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dotnet7.0", rpm:"dotnet7.0~7.0.113~1.fc37", rls:"FC37"))) {
    report += res;
  }
