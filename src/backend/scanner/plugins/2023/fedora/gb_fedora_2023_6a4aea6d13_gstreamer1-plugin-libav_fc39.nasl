...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885284");
  ...
  script_name("Fedora: Security Advisory for gstreamer1-plugin-libav (FEDORA-2023-6a4aea6d13)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VU5SFCYBIB6CC2TTJVLOC5FNF4XIAZ7R");
...
This package provides FFmpeg/LibAV GStreamer plugin.");
  ...
  script_tag(name:"affected", value:"'gstreamer1-plugin-libav' package(s) on Fedora 39.");
