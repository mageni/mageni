...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885378");
  ...
  script_name("Fedora: Security Advisory for samba (FEDORA-2023-9adeb354af)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-9adeb354af");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ACVMYEP5KJRL3FWSCZW2MQZ26IVPXY62");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the FEDORA-2023-9adeb354af advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"samba", rpm:"samba~4.18.9~1.fc38", rls:"FC38"))) {
    report += res;
  }
