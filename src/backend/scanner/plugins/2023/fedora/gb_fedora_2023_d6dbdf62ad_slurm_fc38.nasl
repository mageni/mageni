...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884957");
  ...
  script_tag(name:"creation_date", value:"2023-10-05 01:27:12 +0000 (Thu, 05 Oct 2023)");
  script_name("Fedora: Security Advisory for slurm (FEDORA-2023-d6dbdf62ad)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JPJNUOC2M7CLAZ2GQ5Q56CY5L7OQA6F5");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"slurm", rpm:"slurm~22.05.9~5.fc38", rls:"FC38"))) {
    report += res;
  }
