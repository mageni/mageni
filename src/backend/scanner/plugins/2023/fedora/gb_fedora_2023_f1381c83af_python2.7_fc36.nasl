...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.823143");
  ...
  script_tag(name:"creation_date", value:"2023-01-14 02:01:35 +0000 (Sat, 14 Jan 2023)");
  script_name("Fedora: Security Advisory for python2.7 (FEDORA-2023-f1381c83af)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-f1381c83af");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7WQPHKGNXUJC3TC3BDW5RKGROWRJVSFR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7'
  package(s) announced via the FEDORA-2023-f1381c83af advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2.7", rpm:"python2.7~2.7.18~23.fc36", rls:"FC36"))) {
    report += res;
  }
