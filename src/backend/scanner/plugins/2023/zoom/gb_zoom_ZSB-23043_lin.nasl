...
if(description)
{
  ...
  script_cve_id("CVE-2023-39208");

  script_tag(name:"qod_type", value:"executable_version");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Zoom Client < 5.15.10 DoS Vulnerability (ZSB-23043) - Linux");
  ...
  script_tag(name:"insight", value:"Improper input validation in Zoom Desktop Client for Linux may
