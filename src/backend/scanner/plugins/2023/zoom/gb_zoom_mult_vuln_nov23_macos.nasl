...
if(description)
{
  ...
  script_cve_id("CVE-2023-39199", "CVE-2023-39205", "CVE-2023-39206", "CVE-2023-43582",
                "CVE-2023-43588");
  ...
  script_name("Zoom Client < 5.16.0 Multiple Vulnerabilities (ZSB-23049, ZSB-23050, ZSB-23051, ZSB-23052, ZSB-23055) - Mac OS X");
