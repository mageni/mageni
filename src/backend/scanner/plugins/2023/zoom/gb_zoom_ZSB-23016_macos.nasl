...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.149876");
  script_version("2023-07-06T05:05:36+0000");
  script_tag(name:"last_modification", value:"2023-07-06 05:05:36 +0000 (Thu, 06 Jul 2023)");
  script_tag(name:"creation_date", value:"2023-07-05 04:07:34 +0000 (Wed, 05 Jul 2023)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:N/A:N");

  script_cve_id("CVE-2023-34114");

  script_tag(name:"qod_type", value:"executable_version");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Zoom Client < 5.14.10 Information Disclosure Vulnerability (ZSB-23016) - Mac OS X");
  ...
  script_tag(name:"insight", value:"Exposure of resource to wrong sphere may allow an authenticated
