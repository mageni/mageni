...
if(description)
{
  ...
  script_name("Zoom Client 5.15.0 - 5.15.1 Information Disclosure Vulnerability (ZSB-23025) - Windows");
  ...
  script_tag(name:"affected", value:"Zoom Client version 5.15.0 and 5.15.1.");
...
if (version_in_range(version: version, test_version: "5.15.0", test_version2: "5.15.1")) {
