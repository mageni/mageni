...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118527");
  ...
  script_cve_id("CVE-2023-39211", "CVE-2023-39209");

  script_tag(name:"qod_type", value:"executable_version");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Zoom Client < 5.15.5 Multiple Vulnerabilities (ZSB-23036, ZSB-23041) - Windows");
  ...
  - CVE-2023-39211: Improper privilege management may allow an authenticated user to enable an
  information disclosure via local access. (ZSB-23036).

  - CVE-2023-39209: Improper input validation may allow an authenticated user to enable an
  information disclosure via network access. (ZSB-23041).");
