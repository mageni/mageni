...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118525");
  ...
  script_cve_id("CVE-2023-36535", "CVE-2023-39218");

  script_tag(name:"qod_type", value:"executable_version");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Zoom Client < 5.14.10 Multiple Information Disclosure Vulnerabilities (ZSB-23031, ZSB-23034) - Mac OS X");
  ...
  script_tag(name:"summary", value:"Zoom Client is prone to multiple information
  ...
  - CVE-2023-36535, CVE-2023-39218: Client-side enforcement of server-side security may allow an
  authenticated user to enable information disclosure via network access (ZSB-23031, ZSB-23034).");
