...
if (description)
{
  ...
  script_name("ILIAS < 7.20 Multiple Vulnerabilities");
  ...
  - 36999: [Test & Assessment] Test: Broken Access Control in tests with feedback

  - 37025: [Bibliographic List Item] Bibliography: Stored XSS via RIS/BibTeX import

  - 37068: [Exercise] Exercise Object: Stored XSS");

  script_tag(name:"affected", value:"The ILIAS prior to version 7.20.");

  script_tag(name:"solution", value:"Update to version 7.20 or later.");
...
if (version_is_less(version: version, test_version: "7.20")) {
