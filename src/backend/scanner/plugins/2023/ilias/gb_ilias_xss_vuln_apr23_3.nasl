...
if (description)
{
  ...
  script_name("ILIAS < 7.20 XSS Vulnerability");
  ...
  - 37068: [Bibliographic List Item] Bibliography: Stored XSS via RIS/BibTeX import");

  script_tag(name:"affected", value:"ILIAS prior to version 7.20.");
