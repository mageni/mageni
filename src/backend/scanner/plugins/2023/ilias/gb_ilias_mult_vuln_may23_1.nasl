...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170690");
  ...
  script_cve_id("CVE-2023-32778");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("ILIAS < 7.22, 8.x < 8.2 Multiple Vulnerabilities");
  ...
  - CVE-2023-32778 / 37243: [File System] Remote code execution through ZIP upload

  - 20149: [General] Adding WAC coverage for T&A paths

  - 35147: [General] Session Parameter in Weblinks");

  script_tag(name:"affected", value:"ILIAS prior to version 7.22 and 8.x prior to 8.2.");

  script_tag(name:"solution", value:"Update to version 7.22, 8.2 or later.");

  script_xref(name:"URL", value:"https://docu.ilias.de/goto_docu_pg_141704_35.html");
