...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832004");
  script_version("2023-02-16T10:08:32+0000");
  script_cve_id("CVE-2023-21722", "CVE-2023-21808", "CVE-2023-21823", "CVE-2023-23376",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5022838)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5022838");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5022838");
...
if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.5716"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.5716");
