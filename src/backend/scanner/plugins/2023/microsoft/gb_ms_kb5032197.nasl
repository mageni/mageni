...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832595");
  ...
  script_tag(name:"creation_date", value:"2023-11-16 18:34:24 +0530 (Thu, 16 Nov 2023)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5032197)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5032197");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5032197");
...
if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.6450")) {
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.6450");
