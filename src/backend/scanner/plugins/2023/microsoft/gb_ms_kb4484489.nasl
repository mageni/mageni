...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832391");
  ...
  script_name("Microsoft Project 2013 Remote Code Execution Vulnerability (KB4484489)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4484489");
  ...
  script_tag(name:"affected", value:"Microsoft Project 2013 Service Pack 1.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484489");
...
if(version_in_range(version:proVer, test_version:"15.0.5085.0", test_version2:"15.0.5579.1000")) {
  report = report_fixed_ver(file_checked:path + "\winproj.exe", file_version:proVer, vulnerable_range:"15.0.5085.0 - 15.0.5579.1000");
