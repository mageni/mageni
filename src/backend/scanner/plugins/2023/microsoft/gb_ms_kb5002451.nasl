...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832166");
  ...
  script_tag(name:"creation_date", value:"2023-08-09 14:48:48 +0530 (Wed, 09 Aug 2023)");
  script_name("Microsoft Excel 2013 Service Pack 1 Defense in Depth Security Update (KB5002451)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002451");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002451");
...
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.0.5579.1000")) {
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"15.0 - 15.0.5579.1000");
