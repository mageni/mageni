...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832022");
  script_version("2023-03-24T10:09:03+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2023-24876", "CVE-2023-24910", "CVE-2023-24908", "CVE-2023-24872",
                "CVE-2023-23403", "CVE-2023-24909", "CVE-2023-24911", "CVE-2023-24870",
                "CVE-2023-24868", "CVE-2023-24880", "CVE-2023-1018", "CVE-2023-1017",
                "CVE-2023-24913", "CVE-2023-24869", "CVE-2023-24907", "CVE-2023-24867",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5023702)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5023702");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5023702");
...
if(version_in_range(version:fileVer, test_version:"10.0.17763.0", test_version2:"10.0.17763.4130"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.17763.0 - 10.0.17763.4130");
