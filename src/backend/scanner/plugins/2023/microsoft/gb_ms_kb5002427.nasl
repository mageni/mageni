...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832158");
  ...
  script_tag(name:"creation_date", value:"2023-07-12 15:22:48 +0530 (Wed, 12 Jul 2023)");
  script_name("Microsoft Outlook 2016 Multiple Vulnerabilities (KB5002427)");

  script_tag(name:"summary", value:"This host is missing an critical security
  update according to Microsoft KB5002427");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002427/");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.5404.1000")) {
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.5404.0999");
