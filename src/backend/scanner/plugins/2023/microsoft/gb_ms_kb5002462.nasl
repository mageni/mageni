...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832368");
  ...
  script_name("Microsoft Publisher 2016 Remote Code Execution Vulnerability (KB5002462)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002462");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002462");
...
if(exeVer && exeVer =~ "^16.*")
{
  if(version_in_range(version:exeVer, test_version:"16.0", test_version2:"16.0.5408.1000")) {
    report = report_fixed_ver(file_checked: exePath + "\mspub.exe", file_version:exeVer, vulnerable_range:"16.0 - 16.0.5408.1000");
