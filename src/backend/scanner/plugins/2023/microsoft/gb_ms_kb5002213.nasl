...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826964");
  ...
  script_name("Microsoft Publisher 2013 Multiple Vulnerabilities (KB5002213)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002213");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002213");
...
if(exeVer && exeVer =~ "^15.*")
{
  if(version_in_range(version:exeVer, test_version:"15.0", test_version2:"15.0.5545.0999"))
  {
    report = report_fixed_ver(file_checked: exePath + "\mspub.exe",
                                file_version:exeVer, vulnerable_range:"15.0 - 15.0.5545.0999");
