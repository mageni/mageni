...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832248");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB5028948)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5028948");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5 and 4.8.1 on Microsoft Windows 11, version 22H2.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5028948");
      ...
      foreach item (registry_enum_keys(key:key)) {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath) {
          foreach item (registry_enum_keys(key:key)) {
            ...
            if(dllVer) {
              if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9173")) {
                VULN = TRUE ;
                vulnerable_range = "2.0.50727 - 2.0.50727.9173";
                break;
              }
              else if(version_in_range(version:dllVer, test_version:"4.8.9000", test_version2:"4.8.9166.0")) {
                VULN = TRUE ;
                vulnerable_range = "4.8.9000 - 4.8.9166.0" ;
                break;
              }
            }
          }
