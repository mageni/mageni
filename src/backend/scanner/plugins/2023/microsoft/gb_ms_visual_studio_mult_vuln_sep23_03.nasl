...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832281");
  script_version("2023-09-22T16:08:59+0000");
  script_cve_id("CVE-2023-36796", "CVE-2023-36759", "CVE-2023-36792", "CVE-2023-36793",
                "CVE-2023-36794");
  ...
  script_name("Microsoft Visual Studio Multiple Vulnerabilities-03 - September23");
  ...
  script_tag(name:"affected", value:"Microsoft Visual Studio 2019 version 16.11 prior to 16.11.30.");
  ...
  script_xref(name:"URL", value:"https://learn.microsoft.com/en-us/visualstudio/releases/2019/release-notes");
...
foreach key (key_list)
{
  foreach item (registry_enum_keys(key:key))
  {
    ...
    if(vsname =~ "^Visual Studio.*2019$")
    {
      ...
      if(version_in_range(version:vsversion, test_version:"16.11", test_version2:"16.11.34031.80")) {
        fix = "Visual Studio 2019 version 16.11.30";
