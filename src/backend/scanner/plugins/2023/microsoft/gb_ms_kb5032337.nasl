...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832619");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB5032337)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5032337");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5032337");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            if(version_in_range(version:dllVer, test_version:"2.0.50727.5700", test_version2:"2.0.50727.9061"))
            {
              VULN = TRUE ;
              vulnerable_range = "2.0.50727.5700 - 2.0.50727.9061";
              break;
            }
            else if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.4075.0"))
            {
              VULN = TRUE ;
              vulnerable_range = "4.7 - 4.7.4075.0" ;
              break;
            }
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(dotPath && "\Microsoft.NET\Framework" >< dotPath)
      {
        ...
        if(dllVer)
        {
          ...
          else if(version_in_range(version:dllVer, test_version:"4.8", test_version2:"4.8.4681"))
          {
            VULN = TRUE ;
            vulnerable_range = "4.8 - 4.8.4681" ;
            break;
          }
        }
      }
