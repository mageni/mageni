...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832239");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB5029652)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5029652");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.6.2, 4.7, 4.7.1, 4.7.2, 4.8 for Microsoft Windows Server 2012.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5029652");
    ...
    foreach item (registry_enum_keys(key:key)) {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath) {
        foreach item (registry_enum_keys(key:key)) {
          ...
          dllVer1 = fetch_file_version(sysPath:dotPath, file_name:"System.web.extensions.dll");
          dllVer2 = fetch_file_version(sysPath:dotPath, file_name:"Mscorlib.dll");

          if(dllVer1 || dllVer2)
          {
            if(dllVer2 && version_in_range(version:dllVer2, test_version:"2.0.50727.5700", test_version2:"2.0.50727.8973"))
            {
              VULN1 = TRUE ;
              vulnerable_range1 = "2.0.50727.5700 - 2.0.50727.8973";
              break;
            }
            else if(dllVer1 && version_in_range(version:dllVer1, test_version:"4.7", test_version2:"4.7.4056.0"))
            {
              VULN2 = TRUE ;
              vulnerable_range2 = "4.7 - 4.7.4056.0" ;
              break;
            }

            else if(version_in_range(version:dllVer1, test_version:"4.8", test_version2:"4.8.4653.0"))
            {
              VULN2 = TRUE ;
              vulnerable_range2 = "4.8 - 4.8.4653.0" ;
              break;
            }
          }
        }
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(dotPath && "\Microsoft.NET\Framework" >< dotPath)
      {
        ...
        if(dllVer1 || dllVer2)
        {
          ...
          else if(version_in_range(version:dllVer1, test_version:"4.8", test_version2:"4.8.4653"))
          {
            VULN2 = TRUE ;
            vulnerable_range2 = "4.8 - 4.8.4653" ;
            break;
          }
        }
      }
