...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832379");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5029253)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5029253");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5029253");
...
if(version_is_less(version:fileVer, test_version:"10.0.22000.2245")) {
  report = report_fixed_ver(file_checked:dllPath + "\system32\user32.dll", file_version:fileVer, vulnerable_range:"Less than 10.0.22000.2245");
