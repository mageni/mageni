...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826907");
  ...
  script_name("Microsoft .NET Framework Information Disclosure Vulnerability (KB5020690)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5020690");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.6.2, 4.7, 4.7.1, 4.7.2, 4.8 for Microsoft Windows 8.1 and Microsoft Windows Server 2012 R2.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5020690");
