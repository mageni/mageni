...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832128");
  ...
  script_tag(name:"creation_date", value:"2023-06-14 12:54:25 +0530 (Wed, 14 Jun 2023)");
  script_name("Microsoft Excel 2013 Service Pack 1 Mulptiple Vulnerabilities (KBKB5002414)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002414");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002414");
...
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.0.5563.0999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"15.0 - 15.0.5563.0999");
