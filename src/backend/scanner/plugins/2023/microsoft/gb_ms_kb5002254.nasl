...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832026");
  ...
  script_name("Microsoft Outlook 2016 Elevation of Privilege Vulnerability (KB5002254)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002254");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an improper implementation
  of NTLM Authentication in Microsoft Outlook software.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002254");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.5387.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.5387.0999");
