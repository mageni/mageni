...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826929");
  ...
  script_tag(name:"creation_date", value:"2023-03-15 11:26:54 +0530 (Wed, 15 Mar 2023)");
  script_name("Microsoft Excel 2016 Multiple Vulnerabilities (KB5002351)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002351");
  ...
  to conduct arbitrary code execution and spoofing on an affected system.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/help/5002351");
...
if(version_in_range(version:vers, test_version:"16.0", test_version2:"16.0.5387.0999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"16.0 - 16.0.5387.0999");
