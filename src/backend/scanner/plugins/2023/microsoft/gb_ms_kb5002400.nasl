...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832230");
  ...
  script_name("Microsoft Office 2013 Service Pack 1 Remote Code Execution Vulnerability (KB5002400)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002400");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw is due to an unspecified remote code
  execution vulnerability in Microsoft Office Graphics.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002400");
