...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826910");
  ...
  script_name("Microsoft .NET Framework DoS And RCE Vulnerabilities (KB5022782)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5022782");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5022782");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9054"))
              {
                vulnerable_range = "2.0.50727 - 2.0.50727.9054";
                break;
              }
              else if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.4037"))
              {
                vulnerable_range = "4.7 - 4.7.4037" ;
                break;
              }
