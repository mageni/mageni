...
if(description)
{
  ...
  script_tag(name:"affected", value:"Microsoft Visual Studio 2022 version 17.6 prior to 17.6.7, 17.4 prior to 17.4.11, 17.2 prior to 17.2.19.");
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/visualstudio/releases/2022/release-notes-v17.6");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/visualstudio/releases/2022/release-notes-v17.4");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/visualstudio/releases/2022/release-notes-v17.2");
...
foreach key (key_list)
{
  foreach item (registry_enum_keys(key:key))
  {
    ...
    if(vsname =~ "^Visual Studio.*2022$")
    {
      ...
      if(version_in_range(version:vsversion, test_version:"17.6", test_version2:"17.6.34031.177")) {
        fix = "Visual Studio 2022 version 17.6.7";
      }
      else if (version_in_range(version:vsversion, test_version:"17.4", test_version2:"17.4.34031.108")) {
        fix = "Visual Studio 2017 version 17.4.11";
      }
      else if (version_in_range(version:vsversion, test_version:"17.2", test_version2:"17.2.34031.103")) {
        fix = "Visual Studio 2017 version 17.2.19";
      }
