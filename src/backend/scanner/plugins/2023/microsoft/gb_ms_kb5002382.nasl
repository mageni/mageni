...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832088");
  ...
  script_name("Microsoft Outlook 2013 Service Pack 1 RCE Vulnerability (KB5002382)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002382");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002382/");
