...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124373");
  script_version("2023-08-23T05:05:12+0000");
  script_tag(name:"last_modification", value:"2023-08-23 05:05:12 +0000 (Wed, 23 Aug 2023)");
  script_tag(name:"creation_date", value:"2023-07-24 08:13:39 +0000 (Mon, 24 Jul 2023)");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");

  script_cve_id("CVE-2023-29523");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 3.3-milestone-1 < 13.10.11, 14.0-rc-1 < 14.4.8, 14.5 < 14.10.2 Code Injection Vulnerability (GHSA-x764-ff8r-9hpx)");
  ...
  script_tag(name:"affected", value:"XWiki version 3.3-milestone-1 prior to 13.10.11, 14.0-rc-1
  prior to 14.4.8, 14.5 prior to 14.10.2.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.8, 14.10.2 or later.");

  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-x764-ff8r-9hpx");
...
if( version_in_range_exclusive( version:version, test_version_lo:"3.3-milestone-1", test_version_up:"13.10.11" ) ) {
