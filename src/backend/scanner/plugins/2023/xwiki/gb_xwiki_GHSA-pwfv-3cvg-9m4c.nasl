...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124312");
  ...
  script_cve_id("CVE-2023-29507");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 14.0-rc-1 < 14.4.7, 14.5.x < 14.10 Incorrect Use of Privileged APIs Vulnerability (GHSA-pwfv-3cvg-9m4c)");
  ...
  script_tag(name:"summary", value:"Xwiki is prone to an incorrect use of privileged APIs vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The Document script API returns directly a DocumentAuthors
  allowing to set any authors to the document, which in consequence can allow subsequent executions
  of scripts since this author is used for checking rights.");
  ...
  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-pwfv-3cvg-9m4c");
