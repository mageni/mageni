...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124376");
  ...
  script_cve_id("CVE-2023-29520");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 4.3-milestone-2 < 13.10.11, 14.0-rc-1 < 14.4.8, 14.5 < 14.10.1 Uncaught Exception Vulnerability (GHSA-9jq5-xwqw-q8j3)");
  ...
  script_tag(name:"summary", value:"Xwiki is prone to an uncaught exception vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"It's possible to break many translations coming from wiki pages
  by creating a corrupted document containing a translation object.");

  script_tag(name:"affected", value:"XWiki version 4.3-milestone-2 prior to 13.10.11, 14.0-rc-1
  prior to 14.4.8, 14.5 prior to 14.10.1.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.8, 14.10.1 or later.");

  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-9jq5-xwqw-q8j3");
...
if( version_in_range_exclusive( version:version, test_version_lo:"4.3-milestone-2", test_version_up:"13.10.11" ) ) {
