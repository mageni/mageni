...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170337");
  ...
  script_cve_id("CVE-2023-26473");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 1.3-rc-1 < 13.10.11, 14.x < 14.4.7, 14.5.x < 14.10 Improper Access Control Vulnerability (GHSA-vpx4-7rfp-h545)");
  ...
  script_tag(name:"insight", value:"Unprivileged users can make arbitrary select queries using
  DatabaseListProperty and suggest.vm.");

  script_tag(name:"affected", value:"XWiki version 1.3-rc-1 prior to 13.10.11, 14.x prior to 14.4.7
  and 14.5.x prior to 14.10.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.7, 14.10 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-vpx4-7rfp-h545");
  script_xref(name:"URL", value:"https://jira.xwiki.org/browse/XWIKI-19523");
...
if( version_in_range_exclusive( version:version, test_version_lo:"1.3-rc-1", test_version_up:"13.10.11" ) ) {
