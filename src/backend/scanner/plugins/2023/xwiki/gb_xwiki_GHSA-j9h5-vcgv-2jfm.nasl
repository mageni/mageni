...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124410");
  ...
  script_cve_id("CVE-2023-32071");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 2.2-milestone-1 < 14.4.8, 14.5 < 14.10.4 XSS Vulnerability (GHSA-j9h5-vcgv-2jfm)");
  ...
  script_tag(name:"insight", value:"It's possible to execute javascript with the right of any user
  by leading him to a special URL on the wiki targeting a page which contains an attachment.");

  script_tag(name:"affected", value:"XWiki version 2.2-milestone-1 prior to 14.4.8 and 14.5 prior
  to 14.10.4.");

  script_tag(name:"solution", value:"Update to version 14.4.8, 14.10.4 or later.");

  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-j9h5-vcgv-2jfm");
...
if( version_in_range_exclusive( version:version, test_version_lo:"2.2-milestone-1", test_version_up:"14.4.8" ) ) {
