...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170338");
  ...
  script_cve_id("CVE-2023-26474");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 13.x < 13.10.11, 14.x < 14.4.7, 14.5.x < 14.10 Privilege Escalation Vulnerability (GHSA-3738-p9x3-mv9r)");
  ...
  script_tag(name:"insight", value:"It's possible to use the right of an existing document content
  author to execute a text area property.");

  script_tag(name:"affected", value:"XWiki version 13.x prior to 13.10.11, 14.x prior to 14.4.7
  and 14.5.x prior to 14.10.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.7, 14.10 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-3738-p9x3-mv9r");
  script_xref(name:"URL", value:"https://jira.xwiki.org/browse/XWIKI-20373");
...
if( version_in_range_exclusive( version:version, test_version_lo:"13.0", test_version_up:"13.10.11" ) ) {
