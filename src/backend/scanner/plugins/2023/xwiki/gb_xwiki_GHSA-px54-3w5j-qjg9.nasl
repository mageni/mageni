...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124378");
  script_version("2023-08-23T05:05:12+0000");
  script_tag(name:"last_modification", value:"2023-08-23 05:05:12 +0000 (Wed, 23 Aug 2023)");
  script_tag(name:"creation_date", value:"2023-07-26 10:15:22 +0000 (Wed, 26 Jul 2023)");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");

  script_cve_id("CVE-2023-29518");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 2.5-m-1 < 13.10.11, 14.0-rc-1 < 14.4.8, 14.5 < 14.10.1 Privilege Escalation Vulnerability (GHSA-px54-3w5j-qjg9)");
  ...
  script_tag(name:"affected", value:"XWiki version 2.5-m-1 prior to 13.10.11, 14.0-rc-1 prior to
  14.4.8 and 14.5 prior to 14.10.1.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.8, 14.10.1 or later.");

  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-px54-3w5j-qjg9");
...
if( version_in_range_exclusive( version:version, test_version_lo:"2.5-m-1", test_version_up:"13.10.11" ) ) {
