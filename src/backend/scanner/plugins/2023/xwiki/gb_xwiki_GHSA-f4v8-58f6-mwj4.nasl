...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124310");
  ...
  script_cve_id("CVE-2023-29509");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 7.2-rc-1 < 13.10.11, 14.x < 14.4.7, 14.5.x < 14.10 Code Injection Vulnerability (GHSA-f4v8-58f6-mwj4)");
  ...
  script_tag(name:"insight", value:"Any user with view rights on commonly accessible documents can
  execute arbitrary Groovy, Python or Velocity code in XWiki leading to full access to the XWiki
  installation. The root cause is improper escaping of the documentTree macro parameters in This
  macro is installed by default in FlamingoThemesCode.WebHome.");

  script_tag(name:"affected", value:"XWiki version 7.2-rc-1 prior to 13.10.11, 14.x prior to
  14.4.7 and 14.5.x prior to 14.10.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.7, 14.10 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-f4v8-58f6-mwj4");
...
if( version_in_range_exclusive( version:version, test_version_lo:"7.2-rc-1", test_version_up:"13.10.11" ) ) {
