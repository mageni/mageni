...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124409");
  ...
  script_cve_id("CVE-2023-31126");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 14.6-rc-1 < 14.10.4 XSS Vulnerability (GHSA-pv7v-ph6g-3gxv)");
  ...
  script_tag(name:"insight", value:"The HTML sanitizer allowed the injection of arbitrary HTML code
  and thus cross-site scripting via invalid data attributes.");
  ...
  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-pv7v-ph6g-3gxv");
