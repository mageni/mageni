...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124317");
  ...
  script_cve_id("CVE-2023-29210");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 13.2-rc-1 < 13.10.11, 14.x < 14.4.7, 14.5.x < 14.10 Code Injection Vulnerability (GHSA-p9mj-v5mf-m82x)");
  ...
  including the notification preferences macros can execute arbitrary Groovy, Python or Velocity
  code in XWiki leading to full access to the XWiki installation. The root cause is improper
  escaping of the user parameter of the macro that provide the notification filters. These macros
  are used in the user profiles and thus installed by default in XWiki.");

  script_tag(name:"affected", value:"XWiki version 13.2-rc-1 prior to 13.10.11, 14.x prior
  to 14.4.7 and 14.5.x prior to 14.10.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.7, 14.10 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-p9mj-v5mf-m82x");
...
if( version_in_range_exclusive( version:version, test_version_lo:"13.2-rc-1", test_version_up:"13.10.11" ) ) {
