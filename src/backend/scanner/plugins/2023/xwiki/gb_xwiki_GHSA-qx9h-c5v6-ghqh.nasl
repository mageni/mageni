...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124314");
  ...
  script_cve_id("CVE-2023-29214");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 1.1-m2 < 13.10.11, 14.x < 14.4.7, 14.5.x < 14.10 Code Injection Vulnerability (GHSA-qx9h-c5v6-ghqh)");
  ...
  script_tag(name:"summary", value:"Xwiki is prone to an code injection vulnerability.");
  ...
  improper escaping of the included pages in the IncludedDocuments panel.");

  script_tag(name:"affected", value:"XWiki version 1.1-m2 prior to 13.10.11, 14.x prior to 14.4.7 and 14.5.x prior to
  14.10.");

  script_tag(name:"solution", value:"Update to version 13.10.11, 14.4.7, 14.10 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-qx9h-c5v6-ghqh");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"1.1-m2", test_version_up:"13.10.11" ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"13.10.11", install_path:location );
  security_message( port:port, data:report );
  exit( 0 );
}

if( version_in_range_exclusive( version:version, test_version_lo:"14.4", test_version_up:"14.4.7" ) ) {
