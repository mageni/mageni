...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Foxit PhantomPDF 11.2.2 or later. Please
...
if(version_is_less(version:pdfVer, test_version:"10.1.7.37777") ||
   version_in_range(version:pdfVer, test_version:"11.0", test_version2:"11.2.1.53537"))
{
