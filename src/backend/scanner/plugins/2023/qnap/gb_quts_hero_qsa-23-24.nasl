...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170695");
  ...
  script_name("QNAP QuTS hero OS Command Injection Vulnerability (QSA-23-24)");
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h5.0.x");

  script_tag(name:"solution", value:"Update to version QuTS hero h5.0.1.2376 build 20230421 or
  later.");
