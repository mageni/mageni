...
if(description)
{
  ...
  script_name("QNAP QuTS hero OS Command Injection Vulnerability (QSA-23-31)");
  ...
  script_tag(name:"summary", value:"QNAP QuTS hero is prone to an OS command injection
  vulnerability.");
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h4.5.x and h5.0.x.");

  script_tag(name:"solution", value:"Update to version QuTS hero h4.5.4.2374 build 20230417,
  h5.0.1.2376 build 20230421 or later.");
...
if (version =~ "^h5\.0") {
  if (version_is_less(version: version, test_version: "h5.0.1.2376")) {
    report = report_fixed_ver(installed_version: version, installed_build: build, fixed_version: "h5.0.1.2376", fixed_build: "20230421");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "h5.0.1.2376") &&
