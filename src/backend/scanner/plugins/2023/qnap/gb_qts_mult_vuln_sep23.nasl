...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170561");
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-23-19, QSA-23-21)");
  ...
  script_tag(name:"affected", value:"QNAP QTS version 4.5.4 and 5.0.1.");

  script_tag(name:"solution", value:"Update to version 4.5.4.2374 build 20230416, 5.0.1.2346 build
  20230322 or later.");
...
if (version =~ "^4\.5\.4") {
  if (version_is_less(version: version, test_version: "4.5.4.2374")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "4.5.4.2374", fixed_build: "20230416");
...
if (version =~ "^5") {
  if (version_is_less(version: version, test_version: "5.0.1.2346")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "5.0.1.2346", fixed_build: "20230322");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "5.0.1.2346") &&
