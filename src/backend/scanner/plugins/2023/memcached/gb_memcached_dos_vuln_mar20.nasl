...
if (description)
{
  ...
  script_tag(name:"impact", value:"Remote attacker is able to cause a denial of service
  (daemon crash) via a crafted meta command.");

  script_tag(name:"affected", value:"Memcached version 1.6.x prior to 1.6.3.");

  script_tag(name:"solution", value:"Update to version 1.6.3 or later.");

  script_xref(name:"URL", value:"https://github.com/memcached/memcached/issues/636");
...
if( version_in_range_exclusive( version: version, test_version_lo: "1.6.0", test_version_up: "1.6.3" ) ) {
