...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170494");
  ...
  script_name("Synology Router Manager 1.1.x Multiple Vulnerabilities (Synology-SA-18:34) - Unreliable Remote Version Check");
...
if ( ( version =~ "^1\.1\.7-6941" ) && ( revcomp( a:version, b:"1.1.7-6941-1" ) < 0 ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"1.1.7-6941-1" );
  security_message( port:0, data:report );
  exit( 0 );
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170493
