...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170289");
  ...
  script_name("Synology DiskStation Manager 6.2.x < 6.2.4-25556-4 Samba Vulnerability (Synology-SA-22:02) - Unreliable Remote Version Check");
...
if ( ( version =~ "^6\.2\.4-25556" ) && ( revcomp( a:version, b:"6.2.4-25556-4" ) < 0 ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"6.2.4-25556-4" );
  security_message( port:0, data:report );
  exit( 0 );
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170234
