...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170489");
  ...
  script_name("Synology Router Manager 1.1.x Path Traversal Vulnerability (Synology-SA-17:71) - Unreliable Remote Version Check");
...
if ( ( version =~ "^1\.1\.5-6542" ) && ( revcomp( a:version, b:"1.1.5-6542-4" ) < 0 ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"1.1.5-6542-4" );
  security_message( port:0, data:report );
  exit( 0 );
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170488
