...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2023.0086");
  ...
  script_name("Mageia: Security Advisory (MGASA-2023-0086)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2023-0086");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2023-0086.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=31616");
  script_xref(name:"URL", value:"https://github.com/redis/redis/releases/tag/6.0.18");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the MGASA-2023-0086 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Specially crafted SRANDMEMBER, ZRANDMEMBER, and HRANDFIELD commands can
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.0.18~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
