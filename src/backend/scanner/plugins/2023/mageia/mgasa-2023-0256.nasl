...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2023.0256");
  script_cve_id("CVE-2023-4427", "CVE-2023-4428", "CVE-2023-4429", "CVE-2023-4430", "CVE-2023-4431", "CVE-2023-4572");
  ...
  script_name("Mageia: Security Advisory (MGASA-2023-0256)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2023-0256");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2023-0256.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=32193");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium-browser-stable' package(s) announced via the MGASA-2023-0256 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The chromium-browser-stable package has been updated to the 116.0.5845.140
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium-browser", rpm:"chromium-browser~116.0.5845.140~1.mga9.tainted", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-browser-stable", rpm:"chromium-browser-stable~116.0.5845.140~1.mga9.tainted", rls:"MAGEIA9"))) {
    report += res;
  }
