...
if(description)
{
  ...
  script_tag(name:"insight", value:"Dmidecode allows -dump-bin to overwrite a local file. This has security
relevance because, for example, execution of Dmidecode via Sudo is
plausible. (CVE-2023-30630)");

  script_tag(name:"affected", value:"'dmidecode' package(s) on Mageia 8.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dmidecode", rpm:"dmidecode~3.5~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
