...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2023.0016");
  ...
  script_name("Mageia: Security Advisory (MGASA-2023-0016)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2023-0016");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2023-0016.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=31389");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium-browser-stable' package(s) announced via the MGASA-2023-0016 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The chromium-browser-stable package has been updated to the 109.0.5414.74
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium-browser", rpm:"chromium-browser~109.0.5414.74~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-browser-stable", rpm:"chromium-browser-stable~109.0.5414.74~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
