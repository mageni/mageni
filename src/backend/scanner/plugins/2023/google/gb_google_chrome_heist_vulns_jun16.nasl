...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104817");
  ...
  script_name("Google Chrome 'HEIST' Vulnerabilities");

  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone Networks GmbH");
  script_family("General");
  script_dependencies("gb_google_chrome_detect_lin.nasl", "gb_google_chrome_detect_win.nasl",
                      "gb_google_chrome_detect_macosx.nasl");
  script_mandatory_keys("google/chrome/detected");
  ...
  script_xref(name:"URL", value:"https://support.google.com/chrome/answer/95647");

  script_tag(name:"summary", value:"Google Chrome might be prone to multiple vulnerabilities
  dubbed 'HEIST'.");

  script_tag(name:"vuldetect", value:"Reports if Google Chrome is installed on the target.");
  ...
  script_tag(name:"affected", value:"Google Chrome when using a web-browser configuration in which
