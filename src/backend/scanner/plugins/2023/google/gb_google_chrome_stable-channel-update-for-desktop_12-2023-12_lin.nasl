...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832744");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_12-2023-12) - Linux");
  ...
  spoofing and cause a denial of service on an affected system.");

  script_tag(name:"affected", value:"Google Chrome version prior to
  120.0.6099.109 on Linux");

  script_tag(name:"solution", value:"Upgrade to version 120.0.6099.109 or
...
if(version_is_less(version:vers, test_version:"120.0.6099.109")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"120.0.6099.109", install_path:path);
