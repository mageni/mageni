...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832756");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_20-2023-12) - Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome versions prior to 120.0.6099.129
  on Linux.");
