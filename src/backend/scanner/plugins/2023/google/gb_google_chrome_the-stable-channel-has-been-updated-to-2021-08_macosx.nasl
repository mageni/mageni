...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826751");
  ...
  script_name("Google Chrome Security Update(the-stable-channel-has-been-updated-to-2021-08) - MAC OS X");
