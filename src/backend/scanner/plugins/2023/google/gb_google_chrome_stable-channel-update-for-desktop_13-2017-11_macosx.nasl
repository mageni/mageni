...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832575");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_13-2017-11) - MAC OS X");
