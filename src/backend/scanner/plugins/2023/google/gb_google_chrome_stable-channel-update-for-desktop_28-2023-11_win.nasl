...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832718");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_28-2023-11) - Windows");
  ...
  run arbitrary code and cause a denial of service on an affected system.");

  script_tag(name:"affected", value:"Google Chrome version prior to
  119.0.6045.199 on Windows");
...
if(version_is_less(version:vers, test_version:"119.0.6045.199")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"119.0.6045.199/.200", install_path:path);
