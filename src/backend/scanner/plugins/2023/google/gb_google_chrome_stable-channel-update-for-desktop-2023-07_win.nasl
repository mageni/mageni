...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832323");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2023-07) - Windows");
  ...
  115.0.5790.98/99 on Windows");

  script_tag(name:"solution", value:"Upgrade to version 115.0.5790.98/99 or later.
