...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832551");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_10-2023-10) - MAC OS X");
...
if(version_is_less(version:vers, test_version:"118.0.5993.70")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"118.0.5993.70", install_path:path);
