...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826750");
  ...
  script_tag(name:"creation_date", value:"2023-01-06 11:24:04 +0530 (Fri, 06 Jan 2023)");
  script_name("Google Chrome Security Update(the-stable-channel-has-been-updated-to-2021-08) - Windows");
