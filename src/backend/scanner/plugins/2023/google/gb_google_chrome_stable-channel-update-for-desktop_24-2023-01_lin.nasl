...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821353");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_24-2023-01)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 109.0.5414.119 on Linux");
