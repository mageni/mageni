...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832570");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_31-2023-10) - Windows");
  ...
  119.0.6045.105 on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  119.0.6045.105/.106 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"119.0.6045.105")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"119.0.6045.105/.106", install_path:path);
