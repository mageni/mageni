...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832104");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2023-04)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 112.0.5615.49 on Linux");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  112.0.5615.49 or later. Please see the references for more information.");
