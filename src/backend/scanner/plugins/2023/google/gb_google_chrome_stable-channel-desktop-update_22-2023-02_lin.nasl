...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832014");
  ...
  script_name("Google Chrome Security Update(stable-channel-desktop-update_22-2023-02)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 110.0.5481.177 on Linux");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  110.0.5481.177 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"110.0.5481.177"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"110.0.5481.177", install_path:path);
