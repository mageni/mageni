...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821391");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2023-03)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 111.0.5563.64 on MAC OS X");
