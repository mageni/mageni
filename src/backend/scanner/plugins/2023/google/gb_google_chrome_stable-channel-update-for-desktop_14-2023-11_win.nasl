...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832586");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_14-2023-11) - Windows");
  ...
  119.0.6045.159 on Windows");

  script_tag(name:"solution", value:"Upgrade to version 119.0.6045.159/.160
...
if(version_is_less(version:vers, test_version:"119.0.6045.159")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"119.0.6045.159/.160", install_path:path);
