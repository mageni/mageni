...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832745");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_12-2023-12) - MAC OS X");
