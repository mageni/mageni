...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832421");
  ...
  script_name("Google Chrome Security Update (chrome-desktop-stable-update-2023-08) - MAC OS X");
  ...
  116.0.5845.110 on MAC OS X");

  script_tag(name:"solution", value:"Upgrade to version
  116.0.5845.110 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"Add_manually")) {
