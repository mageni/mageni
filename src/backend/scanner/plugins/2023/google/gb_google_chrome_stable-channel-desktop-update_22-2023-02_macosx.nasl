...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832015");
  ...
  script_name("Google Chrome Security Update(stable-channel-desktop-update_22-2023-02)-MAC OS X");
