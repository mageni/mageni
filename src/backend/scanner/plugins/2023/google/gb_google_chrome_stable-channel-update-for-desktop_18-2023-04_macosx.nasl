...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832119");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_18-2023-04)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 112.0.5615.137 on MAC OS X");
