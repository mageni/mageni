...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832235");
  ...
  script_name("Google Chrome Security Updates (stable-channel-update-for-desktop-2023-08) - MAC OS X");
