...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832419");
  ...
  script_name("Google Chrome Security Update (chrome-desktop-stable-update-2023-08) - Windows");
