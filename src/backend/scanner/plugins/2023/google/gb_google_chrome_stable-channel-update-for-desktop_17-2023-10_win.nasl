...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832567");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_17-2023-10) - Windows");
  ...
  118.0.5993.88 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  118.0.5993.88/.89 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"118.0.5993.88")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"118.0.5993.88/.89", install_path:path);
