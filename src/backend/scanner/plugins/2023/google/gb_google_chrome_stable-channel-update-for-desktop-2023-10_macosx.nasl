...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832188");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2023-10) - Mac OS X");
  ...
  117.0.5938.149 on Mac OS X");

  script_tag(name:"solution", value:"Upgrade to version 117.0.5938.149 or later.
...
if(version_is_less(version:vers, test_version:"117.0.5938.149")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"117.0.5938.149", install_path:path);
