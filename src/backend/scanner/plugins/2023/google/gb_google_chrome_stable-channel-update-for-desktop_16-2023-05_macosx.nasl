...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832127");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_16-2023-05)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 113.0.5672.126 on MAC OS X");
