...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832143");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_26-2023-06)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 114.0.5735.198 on Linux");
