...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832202");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2023-06) - MAC OS X");
  ...
  114.0.5735.106 on MAC OS X");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  114.0.5735.106 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"114.0.5735.106"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"114.0.5735.106", install_path:path);
