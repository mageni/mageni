...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832558");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_29-2023-08) - Windows");
  ...
  116.0.5845.140 on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  116.0.5845.140/.141 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"116.0.5845.140")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"116.0.5845.140/.141", install_path:path);
