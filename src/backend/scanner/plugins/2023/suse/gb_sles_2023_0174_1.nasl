...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230174-1/");
  script_xref(name:"URL", value:"https://gcc.gnu.org/gcc-12/changes.html");
...
For a full changelog with all new GCC12 features, check out [link moved to references]");

  script_tag(name:"affected", value:"'glib2' package(s) on SUSE Linux Enterprise Desktop 15-SP4, SUSE Linux Enterprise High Performance Computing 15-SP4, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Manager Proxy 4.3, SUSE Manager Retail Branch Server 4.3, SUSE Manager Server 4.3.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libstdc++6", rpm:"libstdc++6~12.2.1+git416~150000.1.5.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
