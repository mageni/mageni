...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.3952.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:3952-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3952-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233952-1/");
  script_xref(name:"URL", value:"https://github.com/opencontainers/runc/releases/tag/v1.1.8");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc' package(s) announced via the SUSE-SU-2023:3952-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update of runc fixes the following issues:
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.1.8~150000.49.1", rls:"SLES15.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"runc-debuginfo", rpm:"runc-debuginfo~1.1.8~150000.49.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.1.8~150000.49.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"runc-debuginfo", rpm:"runc-debuginfo~1.1.8~150000.49.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.1.8~150000.49.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"runc-debuginfo", rpm:"runc-debuginfo~1.1.8~150000.49.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
