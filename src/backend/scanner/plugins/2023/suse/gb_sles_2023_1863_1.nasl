...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.1863.1");
  script_cve_id("CVE-2022-28737");
  script_tag(name:"creation_date", value:"2023-04-17 09:29:50 +0000 (Mon, 17 Apr 2023)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:1863-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:1863-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231863-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'shim' package(s) announced via the SUSE-SU-2023:1863-1 advisory.");
...
if(release == "SLES12.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.7~25.24.1", rls:"SLES12.0SP4"))) {
    report += res;
  }
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.7~25.24.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
