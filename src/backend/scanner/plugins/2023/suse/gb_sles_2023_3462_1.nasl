...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.3462.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:3462-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3462-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233462-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ca-certificates-mozilla' package(s) announced via the SUSE-SU-2023:3462-1 advisory.");
...
Chambers of Commerce Root E-Tugra Certification Authority E-Tugra Global Root CA ECC v3 E-Tugra Global Root CA RSA v3 Hongkong Post Root CA 1");
  ...
  script_tag(name:"affected", value:"'ca-certificates-mozilla' package(s) on SUSE CaaS Platform 4.0, SUSE Linux Enterprise High Performance Computing 15-SP1, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~2.62~150000.4.41.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
