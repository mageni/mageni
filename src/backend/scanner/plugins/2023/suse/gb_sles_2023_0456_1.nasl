...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.0456.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:0456-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:0456-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230456-1/");
  script_xref(name:"URL", value:"https://www.intel.com/content/www/us/en/security-center/ad");
  script_xref(name:"URL", value:"https://www.intel.com/content/www/us/en/security-center/ad");
  script_xref(name:"URL", value:"https://www.intel.com/content/www/us/en/security-center/ad");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2023:0456-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20230214~3.49.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debuginfo", rpm:"ucode-intel-debuginfo~20230214~3.49.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debugsource", rpm:"ucode-intel-debugsource~20230214~3.49.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
