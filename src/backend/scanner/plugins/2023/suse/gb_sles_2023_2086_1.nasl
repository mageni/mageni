...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.2086.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:2086-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:2086-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232086-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'shim' package(s) announced via the SUSE-SU-2023:2086-1 advisory.");
...
arm/aa64: fix the size of .rela* sections mok: fix potential buffer overrun in import_mok_state mok: relax the maximum variable size check Don't unhook ExitBootServices when EBS protection is disabled ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE CaaS Platform 4.0, SUSE Enterprise Storage 7, SUSE Linux Enterprise High Performance Computing 15-SP1, SUSE Linux Enterprise High Performance Computing 15-SP2, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.7~150100.3.35.1", rls:"SLES15.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.7~150100.3.35.1", rls:"SLES15.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.7~150100.3.35.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.7~150100.3.35.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.7~150100.3.35.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.7~150100.3.35.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
