...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.0408.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:0408-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:0408-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230408-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs18' package(s) announced via the SUSE-SU-2023:0408-1 advisory.");
...
Update to Nodejs ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'nodejs18' package(s) on SUSE Linux Enterprise Module for Web Scripting 12.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs18", rpm:"nodejs18~18.13.0~8.3.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18-debuginfo", rpm:"nodejs18-debuginfo~18.13.0~8.3.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18-debugsource", rpm:"nodejs18-debugsource~18.13.0~8.3.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18-devel", rpm:"nodejs18-devel~18.13.0~8.3.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18-docs", rpm:"nodejs18-docs~18.13.0~8.3.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm18", rpm:"npm18~18.13.0~8.3.1", rls:"SLES12.0"))) {
    report += res;
  }
