...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.0293.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:0293-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:0293-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230293-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nginx' package(s) announced via the SUSE-SU-2023:0293-1 advisory.");
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nginx", rpm:"nginx~1.16.1~150100.6.19.1", rls:"SLES15.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nginx-debuginfo", rpm:"nginx-debuginfo~1.16.1~150100.6.19.1", rls:"SLES15.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nginx-debugsource", rpm:"nginx-debugsource~1.16.1~150100.6.19.1", rls:"SLES15.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nginx-source", rpm:"nginx-source~1.16.1~150100.6.19.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
