...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.4654.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:4654-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:4654-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234654-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-firmware' package(s) announced via the SUSE-SU-2023:4654-1 advisory.");
...
CVE-2023-20592: Issue with INVD instruction aka CacheWarpAttack (bsc#1215823).");
  ...
  script_tag(name:"affected", value:"'kernel-firmware' package(s) on SUSE Enterprise Storage 7.1, SUSE Linux Enterprise High Performance Computing 15-SP3, SUSE Linux Enterprise Micro 5.1, SUSE Linux Enterprise Micro 5.2, SUSE Linux Enterprise Micro for Rancher 5.2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware", rpm:"kernel-firmware~20210208~150300.4.19.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware-brcm", rpm:"kernel-firmware-brcm~20210208~150300.4.19.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-amd", rpm:"ucode-amd~20210208~150300.4.19.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
