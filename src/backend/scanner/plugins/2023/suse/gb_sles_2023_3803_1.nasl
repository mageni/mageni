...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.3803.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:3803-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3803-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233803-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'supportutils' package(s) announced via the SUSE-SU-2023:3803-1 advisory.");
...
The location of chkbin was updated earlier. This documents that
 change (bsc#1205533, bsc#1204942)");
  ...
  script_tag(name:"affected", value:"'supportutils' package(s) on SUSE CaaS Platform 4.0, SUSE Enterprise Storage 7, SUSE Linux Enterprise High Performance Computing 15-SP1, SUSE Linux Enterprise High Performance Computing 15-SP2, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"supportutils", rpm:"supportutils~3.1.26~150000.5.50.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"supportutils", rpm:"supportutils~3.1.26~150000.5.50.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
