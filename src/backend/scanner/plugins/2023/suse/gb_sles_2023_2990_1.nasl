...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.2990.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:2990-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:2990-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232990-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openjdk' package(s) announced via the SUSE-SU-2023:2990-1 advisory.");
...
- JDK-8209167: Use CLDR&#x27,s time zone mappings for Windows
...
- JDK-8215575: C2 crash: assert(get_instanceKlass()-&gt,is_loaded()) failed: must be at least loaded
...
- JDK-8269746: C2: ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk", rpm:"java-11-openjdk~11.0.20.0~3.61.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk-demo", rpm:"java-11-openjdk-demo~11.0.20.0~3.61.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk-devel", rpm:"java-11-openjdk-devel~11.0.20.0~3.61.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk-headless", rpm:"java-11-openjdk-headless~11.0.20.0~3.61.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
