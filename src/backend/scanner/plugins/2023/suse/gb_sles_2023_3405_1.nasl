...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.3405.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:3405-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3405-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233405-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ca-certificates-mozilla' package(s) announced via the SUSE-SU-2023:3405-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~2.62~12.43.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
