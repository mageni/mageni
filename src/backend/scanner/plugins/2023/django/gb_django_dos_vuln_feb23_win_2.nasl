...
if (description)
{
  ...
  script_name("Django 3.2.x < 3.2.18, 4.x < 4.0.10, 4.1.x < 4.1.7 DoS Vulnerability - Windows");
  ...
  script_tag(name:"insight", value:"Passing certain inputs to multipart forms could result in too
  many open files or memory exhaustion, and provided a potential vector for a denial of service
  (DoS) attack.");

  script_tag(name:"affected", value:"Django versions 3.2.x prior to 3.2.18, 4.x prior to 4.0.10,
  4.1.x prior to 4.1.7.");

  script_tag(name:"solution", value:"Update to version 3.2.18, 4.0.10, 4.1.7 or later.");
