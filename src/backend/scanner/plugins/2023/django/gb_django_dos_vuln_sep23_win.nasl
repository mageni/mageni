...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127610");
  script_version("2024-01-10T05:05:17+0000");
  script_tag(name:"last_modification", value:"2024-01-10 05:05:17 +0000 (Wed, 10 Jan 2024)");
  script_tag(name:"creation_date", value:"2023-11-06 10:50:40 +0000 (Mon, 06 Nov 2023)");
  ...
  script_name("Django < 3.2.21, 4.1.x < 4.1.11, 4.2.x < 4.2.5 DoS Vulnerability - Windows");
  ...
  script_tag(name:"affected", value:"Django versions prior to 3.2.21, 4.1.x prior to 4.1.11 and
  4.2.x through 4.2.5.");
