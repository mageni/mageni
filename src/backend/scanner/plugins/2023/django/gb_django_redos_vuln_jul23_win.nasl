...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127491");
  script_version("2023-07-10T08:07:43+0000");
  script_tag(name:"last_modification", value:"2023-07-10 08:07:43 +0000 (Mon, 10 Jul 2023)");
  script_tag(name:"creation_date", value:"2023-07-05 12:32:07 +0000 (Wed, 05 Jul 2023)");
  ...
  script_name("Django 3.2.x < 3.2.20, 4.1.x < 4.1.10, 4.2.x < 4.2.3 ReDoS Vulnerability - Windows");
