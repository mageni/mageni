...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170518");
  ...
  script_name("Discourse 3.1.x < 3.1.0.beta6 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse version 3.1.x prior to 3.1.0.beta6.");

  script_tag(name:"solution", value:"Update to version 3.1.0.beta6 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "3.1.0.beta", test_version_up: "3.1.0.beta6")) {
