...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170698");
  ...
  script_tag(name:"severity_date", value:"2023-11-17 20:29:00 +0000 (Fri, 17 Nov 2023)");

  script_cve_id("CVE-2023-47120");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Discourse 3.1.x < 3.1.3, 3.2.x < 3.2.0.beta3 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"Redis memory can be depleted by crafting a site with an
  abnormally long favicon URL and drafting multiple posts which Onebox it.");

  script_tag(name:"affected", value:"Discourse version 3.1.x prior to 3.1.3 and 3.2.x prior to 3.2.0.beta3.");

  script_tag(name:"solution", value:"Update to version 3.1.3, 3.2.0.beta3 or later.");

  script_xref(name:"URL", value:"https://github.com/discourse/discourse/security/advisories/GHSA-77cw-xhj8-hfp3");
