...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170441");
  ...
  script_cve_id("CVE-2022-36067");

  script_name("vm2 < 3.9.11 Sandbox Escape Vulnerability");
  ...
  script_tag(name:"affected", value:"vm2 prior to version 3.9.11.");

  script_tag(name:"solution", value:"Update to version 3.9.11 or later.");

  script_xref(name:"URL", value:"https://github.com/patriksimek/vm2/security/advisories/GHSA-mrgp-mrhc-5jrq");
  script_xref(name:"URL", value:"https://github.com/patriksimek/vm2/issues/467");
  script_xref(name:"URL", value:"https://www.oxeye.io/resources/vm2-sandbreak-vulnerability-cve-2022-36067");
