...
if(description)
{
  ...
  script_cve_id("CVE-2023-23668");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress GiveWP Plugin < 2.25.2 XSS Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress GiveWP plugin version prior to version 2.25.2.");
