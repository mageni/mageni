...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3497)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3497");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pypdf2' package(s) announced via the DLA-3497 advisory.");
