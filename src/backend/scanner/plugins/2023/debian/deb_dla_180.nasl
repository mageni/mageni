...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2015.180");
  ...
  script_name("Debian: Security Advisory (DLA-180)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-180");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-180");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnutls26' package(s) announced via the DLA-180 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnutls-bin", ver:"2.8.6-1+squeeze5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnutls-doc", ver:"2.8.6-1+squeeze5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"guile-gnutls", ver:"2.8.6-1+squeeze5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnutls-dev", ver:"2.8.6-1+squeeze5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnutls26-dbg", ver:"2.8.6-1+squeeze5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnutls26", ver:"2.8.6-1+squeeze5", rls:"DEB6"))) {
    report += res;
  }
