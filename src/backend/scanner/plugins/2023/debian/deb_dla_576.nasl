...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.576");
  ...
  script_name("Debian: Security Advisory (DLA-576)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-576");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-576");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libdbd-mysql-perl' package(s) announced via the DLA-576 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 4.021-1+deb7u1.
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdbd-mysql-perl", ver:"4.021-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
