...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3463)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3463");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'opensc' package(s) announced via the DLA-3463 advisory.");
