...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for sudo (DLA-3272-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/01/msg00012.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3272-1");
  script_xref(name:"URL", value:"https://www.sudo.ws/security/advisories/sudoedit_any/");
  script_xref(name:"Advisory-ID", value:"DLA-3272-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sudo'
  package(s) announced via the DLA-3272-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.8.27-1+deb10u5", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"sudo-ldap", ver:"1.8.27-1+deb10u5", rls:"DEB10"))) {
  report += res;
}
