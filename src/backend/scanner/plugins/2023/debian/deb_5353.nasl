...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss3-dev", ver:"2:3.61-1+deb11u3", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libnss3-tools", ver:"2:3.61-1+deb11u3", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libnss3", ver:"2:3.61-1+deb11u3", rls:"DEB11"))) {
    report += res;
  }
