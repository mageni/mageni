...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2015.186");
  ...
  script_name("Debian: Security Advisory (DLA-186)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-186");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-186");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mailman' package(s) announced via the DLA-186 advisory.");
...
For Debian 6 Squeeze, these issues have been fixed in mailman version 1:2.1.13-6");
  ...
  script_tag(name:"affected", value:"'mailman' package(s) on Debian 6.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"1:2.1.13-6", rls:"DEB6"))) {
    report += res;
  }
