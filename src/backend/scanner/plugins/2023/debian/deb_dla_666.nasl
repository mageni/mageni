...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.666");
  ...
  script_name("Debian: Security Advisory (DLA-666)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-666");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-666");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'guile-2.0' package(s) announced via the DLA-666 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in GNU Guile, an implementation of the Scheme programming language. The Common Vulnerabilities and Exposures project identifies the following issues.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'guile-2.0' package(s) on Debian 7.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"guile-2.0-dev", ver:"2.0.5+1-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"guile-2.0-doc", ver:"2.0.5+1-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"guile-2.0-libs", ver:"2.0.5+1-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"guile-2.0", ver:"2.0.5+1-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }
