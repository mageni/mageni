...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.382");
  ...
  script_name("Debian: Security Advisory (DLA-382)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-382");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-382");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DLA-382 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sudo-ldap", ver:"1.7.4p4-2.squeeze.6", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.7.4p4-2.squeeze.6", rls:"DEB6"))) {
    report += res;
  }
