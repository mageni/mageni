...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2017.809");
  ...
  script_name("Debian: Security Advisory (DLA-809)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-809");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-809");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tcpdump' package(s) announced via the DLA-809 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpdump", ver:"4.9.0-1~deb7u1", rls:"DEB7"))) {
    report += res;
  }
