...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-929)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-929");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-929");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'petris' package(s) announced via the DSA-929 advisory.");
