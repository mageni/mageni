...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2008.1645");
  ...
  script_name("Debian: Security Advisory (DSA-1645)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1645");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/dsa-1645");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lighttpd' package(s) announced via the DSA-1645 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lighttpd-doc", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lighttpd-mod-cml", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lighttpd-mod-magnet", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lighttpd-mod-mysql-vhost", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lighttpd-mod-trigger-b4-dl", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lighttpd-mod-webdav", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lighttpd", ver:"1.4.13-4etch11", rls:"DEB4"))) {
    report += res;
  }
