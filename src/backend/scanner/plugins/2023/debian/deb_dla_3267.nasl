...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libxstream-java (DLA-3267-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/01/msg00007.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3267-1");
  script_xref(name:"Advisory-ID", value:"DLA-3267-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1027754");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxstream-java'
  package(s) announced via the DLA-3267-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"XStream serializes Java objects to XML and back again. Versions prior to
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libxstream-java", ver:"1.4.11.1-1+deb10u4", rls:"DEB10"))) {
  report += res;
}
