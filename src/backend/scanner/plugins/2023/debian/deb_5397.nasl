...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2023.5397");
  ...
  script_name("Debian: Security Advisory (DSA-5397)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5397");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5397");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5397");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wpewebkit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpewebkit' package(s) announced via the DSA-5397 advisory.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libwpewebkit-1.0-3", ver:"2.38.6-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libwpewebkit-1.0-dev", ver:"2.38.6-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libwpewebkit-1.0-doc", ver:"2.38.6-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"wpewebkit-driver", ver:"2.38.6-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
