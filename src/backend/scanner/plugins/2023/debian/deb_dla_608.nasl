...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.608");
  ...
  script_name("Debian: Security Advisory (DLA-608)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-608");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-608");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mailman' package(s) announced via the DLA-608 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"1:2.1.15-1+deb7u2", rls:"DEB7"))) {
    report += res;
  }
