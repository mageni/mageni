...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1979)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1979");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/dsa-1979");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lintian' package(s) announced via the DSA-1979 advisory.");
