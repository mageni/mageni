...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2023.3607");
  ...
  script_name("Debian: Security Advisory (DLA-3607)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3607");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3607");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gnome-boxes");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnome-boxes' package(s) announced via the DLA-3607 advisory.");
  ...
  script_tag(name:"affected", value:"'gnome-boxes' package(s) on Debian 10.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnome-boxes", ver:"3.30.3-2+deb10u1", rls:"DEB10"))) {
    report += res;
  }
