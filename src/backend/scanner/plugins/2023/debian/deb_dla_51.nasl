...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.51");
  ...
  script_name("Debian: Security Advisory (DLA-51)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-51");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-51");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg2' package(s) announced via the DLA-51 advisory.");
...
For Debian 6 Squeeze, these issues have been fixed in gnupg2 version 2.0.14-2+squeeze3");
  ...
  script_tag(name:"affected", value:"'gnupg2' package(s) on Debian 6.");
