...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libde265-0", ver:"1.0.11-0+deb11u1", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libde265-dev", ver:"1.0.11-0+deb11u1", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libde265-examples", ver:"1.0.11-0+deb11u1", rls:"DEB11"))) {
    report += res;
  }
