...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.442");
  ...
  script_name("Debian: Security Advisory (DLA-442)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-442");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-442");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lxc' package(s) announced via the DLA-442 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2013-6441
...
This update implements a safe_mount() function that prevents lxc from doing mounts onto symbolic links.");
  ...
  script_tag(name:"affected", value:"'lxc' package(s) on Debian 6.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lxc", ver:"0.7.2-1+deb6u1", rls:"DEB6"))) {
    report += res;
  }
