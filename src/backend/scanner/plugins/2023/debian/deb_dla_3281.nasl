...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for swift (DLA-3281-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/01/msg00021.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3281-1");
  script_xref(name:"Advisory-ID", value:"DLA-3281-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1029200");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'swift'
  package(s) announced via the DLA-3281-1 advisory.");
