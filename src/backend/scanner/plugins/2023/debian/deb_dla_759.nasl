...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-759)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-759");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-759");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2016-90/#CVE-2016-9074");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DLA-759 advisory.");
