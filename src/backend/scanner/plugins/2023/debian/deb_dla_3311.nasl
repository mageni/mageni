...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for heimdal (DLA-3311-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/02/msg00005.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3311-1");
  script_xref(name:"Advisory-ID", value:"DLA-3311-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1030849");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'heimdal'
  package(s) announced via the DLA-3311-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"I discovered a flaw in Heimdal, an implementation of Kerberos 5 that
