...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2007.1285");
  script_cve_id("CVE-2007-1622", "CVE-2007-1893", "CVE-2007-1894", "CVE-2007-1897", "CVE-2007-4483");
  ...
  script_name("Debian: Security Advisory (DSA-1285)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1285");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1285");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DSA-1285 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2007-1622
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wordpress", ver:"2.0.10-1", rls:"DEB4"))) {
    report += res;
  }
