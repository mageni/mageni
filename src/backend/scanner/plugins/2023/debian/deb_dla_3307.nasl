...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for openjdk-11 (DLA-3307-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/02/msg00001.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3307-1");
  ...
  package(s) announced via the DLA-3307-1 advisory.");
