...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-601)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-601");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-601");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'quagga' package(s) announced via the DLA-601 advisory.");
