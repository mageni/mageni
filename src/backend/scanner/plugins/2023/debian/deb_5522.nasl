...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5522)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5522");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5522-3");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat9' package(s) announced via the DSA-5522 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A regression was discovered in the Http2UpgradeHandler class of Tomcat 9 introduced by the patch to fix CVE-2023-44487 (Rapid Reset Attack). A wrong value for the overheadcount variable forced HTTP2 connections to close early.
