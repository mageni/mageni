...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.536");
  ...
  script_name("Debian: Security Advisory (DLA-536)");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wget", ver:"1.13.4-3+deb7u3", rls:"DEB7"))) {
    report += res;
  }
