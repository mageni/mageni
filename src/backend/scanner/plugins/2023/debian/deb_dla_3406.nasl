...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2023.3406");
  ...
  script_name("Debian: Security Advisory (DLA-3406)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3406");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sniproxy' package(s) announced via the DLA-3406 advisory.");
...
For Debian 10 buster, this problem has been fixed in version 0.6.0-1+deb10u1.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'sniproxy' package(s) on Debian 10.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sniproxy", ver:"0.6.0-1+deb10u1", rls:"DEB10"))) {
    report += res;
  }
