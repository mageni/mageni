...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2102)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2102");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/dsa-2102");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'barnowl' package(s) announced via the DSA-2102 advisory.");
