...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2014.2826");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"denyhosts", ver:"2.6-7+deb6u3", rls:"DEB6"))) {
    report += res;
  }
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"denyhosts", ver:"2.6-10+deb7u3", rls:"DEB7"))) {
    report += res;
  }
