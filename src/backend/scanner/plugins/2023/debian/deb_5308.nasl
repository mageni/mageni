...
if(description)
{
  ...
  script_name("Debian: Security Advisory for webkit2gtk (DSA-5308-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5308.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5308-1");
  ...
  package(s) announced via the DSA-5308-1 advisory.");
