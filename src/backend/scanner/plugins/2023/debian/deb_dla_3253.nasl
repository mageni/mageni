...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for openvswitch (DLA-3253-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/12/msg00043.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3253-1");
  script_xref(name:"Advisory-ID", value:"DLA-3253-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1027273");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openvswitch'
  package(s) announced via the DLA-3253-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an out-of-bounds read and integer
