...
if(description)
{
  ...
  script_name("Debian: Security Advisory for libxstream-java (DSA-5315-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5315.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5315-1");
  script_xref(name:"Advisory-ID", value:"DSA-5315-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxstream-java'
  package(s) announced via the DSA-5315-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libxstream-java", ver:"1.4.15-3+deb11u2", rls:"DEB11"))) {
  report += res;
}
