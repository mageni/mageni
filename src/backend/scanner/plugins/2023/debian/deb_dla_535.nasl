...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.535");
  ...
  script_name("Debian: Security Advisory (DLA-535)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-535");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-535");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xerces-c' package(s) announced via the DLA-535 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxerces-c-dev", ver:"3.1.1-3+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxerces-c-doc", ver:"3.1.1-3+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxerces-c-samples", ver:"3.1.1-3+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxerces-c3.1", ver:"3.1.1-3+deb7u4", rls:"DEB7"))) {
    report += res;
  }
