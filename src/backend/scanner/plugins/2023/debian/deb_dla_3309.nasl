...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for graphite-web (DLA-3309-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/02/msg00003.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3309-1");
  script_xref(name:"Advisory-ID", value:"DLA-3309-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1026992");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphite-web'
  package(s) announced via the DLA-3309-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there were a number of issues in graphite-web,
a tool provide realtime graphing of system statistics etc.

A series of cross-site scripting (XSS) vulnerabilities existed that
