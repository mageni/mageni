...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-751)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-751");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-751");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nagios3' package(s) announced via the DLA-751 advisory.");
