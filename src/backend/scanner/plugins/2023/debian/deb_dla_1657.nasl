...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2019.1657");
  ...
  script_name("Debian: Security Advisory (DLA-1657)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1657");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1657");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'debian-security-support' package(s) announced via the DLA-1657 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"debian-security-support, the Debian security support coverage checker, has been updated in jessie.
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"debian-security-support", ver:"2019.02.01~deb8u1", rls:"DEB8"))) {
    report += res;
  }
