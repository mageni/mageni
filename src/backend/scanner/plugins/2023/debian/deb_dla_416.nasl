...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-416)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-416");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-416");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'eglibc' package(s) announced via the DLA-416 advisory.");
