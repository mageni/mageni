...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2017.1155");
  ...
  script_name("Debian: Security Advisory (DLA-1155)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1155");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1155");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tzdata' package(s) announced via the DLA-1155 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tzdata-java", ver:"2017c-0+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tzdata", ver:"2017c-0+deb7u1", rls:"DEB7"))) {
    report += res;
  }
