...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libsdl2 (DLA-3314-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/02/msg00008.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3314-1");
  script_xref(name:"Advisory-ID", value:"DLA-3314-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/924610");
  script_xref(name:"URL", value:"https://bugs.debian.org/1014577");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsdl2'
  package(s) announced via the DLA-3314-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities have been discovered in SDL2, the Simple
