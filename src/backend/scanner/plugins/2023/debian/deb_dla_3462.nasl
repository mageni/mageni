...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-06-21 01:15:00 +0000 (Wed, 21 Jun 2023)");

  script_name("Debian: Security Advisory (DLA-3462)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3462");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3462");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wordpress");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DLA-3462 advisory.");
