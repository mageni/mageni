...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2015.3156");
  script_cve_id("CVE-2013-6933");
  ...
  script_name("Debian: Security Advisory (DSA-3156)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3156");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3156");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/liblivemedia");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'liblivemedia, mplayer, vlc' package(s) announced via the DSA-3156 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"For the stable distribution (wheezy), this problem has been fixed in version 2012.05.17-1+wheezy1.
...
For the detailed security status of liblivemedia please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'liblivemedia, mplayer, vlc' package(s) on Debian 7.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblivemedia-dev", ver:"2012.05.17-1+wheezy1", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"livemedia-utils", ver:"2012.05.17-1+wheezy1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mencoder", ver:"2:1.0~rc4.dfsg1+svn34540-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mplayer-dbg", ver:"2:1.0~rc4.dfsg1+svn34540-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mplayer-doc", ver:"2:1.0~rc4.dfsg1+svn34540-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mplayer-gui", ver:"2:1.0~rc4.dfsg1+svn34540-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mplayer", ver:"2:1.0~rc4.dfsg1+svn34540-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
