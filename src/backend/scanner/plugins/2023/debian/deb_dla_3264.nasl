...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for ruby-sinatra (DLA-3264-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/01/msg00005.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3264-1");
  script_xref(name:"Advisory-ID", value:"DLA-3264-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1025125");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-sinatra'
  package(s) announced via the DLA-3264-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a potential reflected file download
