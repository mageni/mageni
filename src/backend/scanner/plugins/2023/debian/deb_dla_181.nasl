...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-181)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-181");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-181");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xerces-c' package(s) announced via the DLA-181 advisory.");
