...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2008.1644");
  ...
  script_name("Debian: Security Advisory (DSA-1644)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1644");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/dsa-1644");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mplayer' package(s) announced via the DSA-1644 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Felipe Andres Manzano discovered that mplayer, a multimedia player, is vulnerable to several integer overflows in the Real video stream demuxing code. These flaws could allow an attacker to cause a denial of service (a crash) or potentially execution of arbitrary code by supplying a maliciously crafted video file.
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mplayer-doc", ver:"1.0~rc1-12etch5", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mplayer", ver:"1.0~rc1-12etch5", rls:"DEB4"))) {
    report += res;
  }
