...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-350)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-350");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-350");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'eglibc' package(s) announced via the DLA-350 advisory.");
