...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3434)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3434");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sysstat' package(s) announced via the DLA-3434 advisory.");
