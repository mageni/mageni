...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-130)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-130");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-130");
  script_xref(name:"URL", value:"http://tracker.firebirdsql.org/browse/CORE-4630");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firebird2.1' package(s) announced via the DLA-130 advisory.");
