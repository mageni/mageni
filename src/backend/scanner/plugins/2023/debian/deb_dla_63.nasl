...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.63");
  ...
  script_name("Debian: Security Advisory (DLA-63)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-63");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-63");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bash' package(s) announced via the DLA-63 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bash-builtins", ver:"4.1-3+deb6u2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bash-doc", ver:"4.1-3+deb6u2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bash-static", ver:"4.1-3+deb6u2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bash", ver:"4.1-3+deb6u2", rls:"DEB6"))) {
    report += res;
  }
