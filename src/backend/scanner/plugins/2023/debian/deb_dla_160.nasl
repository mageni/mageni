...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-160)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-160");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-160");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DLA-160 advisory.");
