...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2015.175");
  ...
  script_name("Debian: Security Advisory (DLA-175)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-175");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-175");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg' package(s) announced via the DLA-175 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnupg-curl", ver:"1.4.10-4+squeeze7", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnupg-udeb", ver:"1.4.10-4+squeeze7", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnupg", ver:"1.4.10-4+squeeze7", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gpgv-udeb", ver:"1.4.10-4+squeeze7", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gpgv", ver:"1.4.10-4+squeeze7", rls:"DEB6"))) {
    report += res;
  }
