...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for netty (DLA-3268-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2023/01/msg00008.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3268-1");
  script_xref(name:"Advisory-ID", value:"DLA-3268-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1027180");
  script_xref(name:"URL", value:"https://bugs.debian.org/1014769");
  script_xref(name:"URL", value:"https://bugs.debian.org/1001437");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netty'
  package(s) announced via the DLA-3268-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libnetty-java", ver:"1:4.1.33-1+deb10u3", rls:"DEB10"))) {
  report += res;
}
