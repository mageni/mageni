...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2007.1416");
  ...
  script_name("Debian: Security Advisory (DSA-1416)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1416");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1416");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tk8.3' package(s) announced via the DSA-1416 advisory.");
...
We recommend that you upgrade your tk8.3 packages.");
  ...
  script_tag(name:"affected", value:"'tk8.3' package(s) on Debian 4.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tk8.3-dev", ver:"8.3.5-6etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tk8.3-doc", ver:"8.3.5-6etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tk8.3", ver:"8.3.5-6etch1", rls:"DEB4"))) {
    report += res;
  }
