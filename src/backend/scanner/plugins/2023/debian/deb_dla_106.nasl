...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.106");
  ...
  script_name("Debian: Security Advisory (DLA-106)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-106");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-106");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'getmail4' package(s) announced via the DLA-106 advisory.");
...
For the squeeze distribution, those problems have been fixed by importing a new upstream version: 4.46.0-1~deb6u1. The updated package has been prepared by Osamu Aoki.");

  script_tag(name:"affected", value:"'getmail4' package(s) on Debian 6.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"getmail4", ver:"4.46.0-1~deb6u1", rls:"DEB6"))) {
    report += res;
  }
