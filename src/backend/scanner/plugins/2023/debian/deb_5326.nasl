...
if(description)
{
  ...
  script_name("Debian: Security Advisory for nodejs (DSA-5326-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5326.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5326-1");
  ...
  package(s) announced via the DSA-5326-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in Node.js, which could result
