...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2015.272");
  ...
  script_name("Debian: Security Advisory (DLA-272)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-272");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-272");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DLA-272 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django-doc", ver:"1.2.3-3+squeeze13", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-django", ver:"1.2.3-3+squeeze13", rls:"DEB6"))) {
    report += res;
  }
