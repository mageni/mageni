...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2010.2067");
  ...
  script_name("Debian: Security Advisory (DSA-2067)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2067");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/dsa-2067");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mahara' package(s) announced via the DSA-2067 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in mahara, an electronic portfolio, weblog, and resume builder. The following Common Vulnerabilities and Exposures project ids identify them:
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mahara-apache2", ver:"1.0.4-4+lenny6", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mahara", ver:"1.0.4-4+lenny6", rls:"DEB5"))) {
    report += res;
  }
