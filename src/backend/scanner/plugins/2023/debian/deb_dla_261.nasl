...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"aptdaemon", ver:"0.31+bzr413-1.1+deb6u2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-aptdaemon-gtk", ver:"0.31+bzr413-1.1+deb6u2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-aptdaemon", ver:"0.31+bzr413-1.1+deb6u2", rls:"DEB6"))) {
    report += res;
  }
