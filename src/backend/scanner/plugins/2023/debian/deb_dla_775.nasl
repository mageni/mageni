...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-775)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-775");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-775");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hplip' package(s) announced via the DLA-775 advisory.");
