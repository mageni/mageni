...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.551");
  ...
  script_name("Debian: Security Advisory (DLA-551)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-551");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-551");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpmyadmin' package(s) announced via the DLA-551 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Phpmyadmin, a web administration tool for MySQL, had several Cross Site Scripting (XSS) vulnerabilities were reported.
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:3.4.11.1-2+deb7u5", rls:"DEB7"))) {
    report += res;
  }
