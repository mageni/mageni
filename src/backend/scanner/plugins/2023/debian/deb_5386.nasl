...
if(description)
{
  ...
  script_cve_id("CVE-2023-1810", "CVE-2023-1811", "CVE-2023-1812", "CVE-2023-1813", "CVE-2023-1814", "CVE-2023-1815", "CVE-2023-1816", "CVE-2023-1817", "CVE-2023-1818", "CVE-2023-1819", "CVE-2023-1820", "CVE-2023-1821", "CVE-2023-1822", "CVE-2023-1823");
  ...
  script_name("Debian: Security Advisory (DSA-5386)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5386");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5386");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5386 advisory.");
