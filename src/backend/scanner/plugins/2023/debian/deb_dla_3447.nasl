...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3447)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3447");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3447");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby2.5' package(s) announced via the DLA-3447 advisory.");
