...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.488");
  ...
  script_name("Debian: Security Advisory (DLA-488)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-488");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-488");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xymon' package(s) announced via the DLA-488 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Markus Krell discovered that Xymon (formerly known as Hobbit), a network- and applications-monitoring system, was vulnerable to the following security issues:
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'xymon' package(s) on Debian 7.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xymon-client", ver:"4.3.0~beta2.dfsg-9.1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xymon", ver:"4.3.0~beta2.dfsg-9.1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
