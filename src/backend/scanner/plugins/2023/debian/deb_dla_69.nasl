...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-69)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-69");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-69");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'exuberant-ctags' package(s) announced via the DLA-69 advisory.");
