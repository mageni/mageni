...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-371)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-371");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-371");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'foomatic-filters' package(s) announced via the DLA-371 advisory.");
