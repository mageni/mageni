...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-05-29 03:56:00 +0000 (Mon, 29 May 2023)");

  script_name("Debian: Security Advisory (DLA-3443)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3443");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3443");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wireshark");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wireshark' package(s) announced via the DLA-3443 advisory.");
