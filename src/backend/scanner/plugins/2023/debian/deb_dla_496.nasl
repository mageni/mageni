...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.496");
  ...
  script_name("Debian: Security Advisory (DLA-496)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-496");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-496");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-activerecord-3.2' package(s) announced via the DLA-496 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2015-7577
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-activerecord-3.2", ver:"3.2.6-5+deb7u2", rls:"DEB7"))) {
    report += res;
  }
