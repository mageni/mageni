...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-123)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-123");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-123");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firebird2.5' package(s) announced via the DLA-123 advisory.");
