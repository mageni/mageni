...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-740)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-740");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-740");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libgsf' package(s) announced via the DLA-740 advisory.");
