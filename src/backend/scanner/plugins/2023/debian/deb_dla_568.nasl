...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.568");
  script_cve_id("CVE-2016-5832", "CVE-2016-5834", "CVE-2016-5835", "CVE-2016-5837", "CVE-2016-5838", "CVE-2016-5839");
  ...
  script_name("Debian: Security Advisory (DLA-568)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-568");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-568");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DLA-568 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wordpress-l10n", ver:"3.6.1+dfsg-1~deb7u11", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"wordpress", ver:"3.6.1+dfsg-1~deb7u11", rls:"DEB7"))) {
    report += res;
  }
