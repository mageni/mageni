...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-04-19 15:06:00 +0000 (Mon, 19 Apr 2021)");

  script_name("Debian: Security Advisory (DLA-454)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-454");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-454");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'minissdpd' package(s) announced via the DLA-454 advisory.");
