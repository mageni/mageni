...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.23");
  ...
  script_name("Debian: Security Advisory (DLA-23)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-23");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-23");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DLA-23 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2013-1741
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss3-1d-dbg", ver:"3.12.8-1+squeeze8", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libnss3-1d", ver:"3.12.8-1+squeeze8", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libnss3-dev", ver:"3.12.8-1+squeeze8", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libnss3-tools", ver:"3.12.8-1+squeeze8", rls:"DEB6"))) {
    report += res;
  }
