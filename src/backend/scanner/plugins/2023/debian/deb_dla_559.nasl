...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.559");
  ...
  script_name("Debian: Security Advisory (DLA-559)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-559");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-559");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ntp' package(s) announced via the DLA-559 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntp-doc", ver:"1:4.2.6.p5+dfsg-2+deb7u7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ntp", ver:"1:4.2.6.p5+dfsg-2+deb7u7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ntpdate", ver:"1:4.2.6.p5+dfsg-2+deb7u7", rls:"DEB7"))) {
    report += res;
  }
