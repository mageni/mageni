...
if(description)
{
  ...
  script_name("Debian: Security Advisory for openvswitch (DSA-5319-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5319.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5319-1");
  script_xref(name:"Advisory-ID", value:"DSA-5319-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openvswitch'
  package(s) announced via the DSA-5319-1 advisory.");
