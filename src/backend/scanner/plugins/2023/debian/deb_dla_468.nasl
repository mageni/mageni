...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-468)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-468");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-468");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libuser' package(s) announced via the DLA-468 advisory.");
