...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-04-20 21:08:00 +0000 (Wed, 20 Apr 2016)");

  script_name("Debian: Security Advisory (DLA-351)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-351");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-351");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'redmine' package(s) announced via the DLA-351 advisory.");
