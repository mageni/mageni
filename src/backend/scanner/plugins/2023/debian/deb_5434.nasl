...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2023.5434");
  ...
  script_name("Debian: Security Advisory (DSA-5434)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5434");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5434");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5434");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/minidlna");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'minidlna' package(s) announced via the DSA-5434 advisory.");
...
For the detailed security status of minidlna please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'minidlna' package(s) on Debian 11, Debian 12.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"minidlna", ver:"1.3.0+dfsg-2+deb11u2", rls:"DEB11"))) {
    report += res;
  }
...
if(release == "DEB12") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"minidlna", ver:"1.3.0+dfsg-2.2+deb12u1", rls:"DEB12"))) {
    report += res;
  }
