...
if(description)
{
  ...
  script_cve_id("CVE-2023-3727", "CVE-2023-3728", "CVE-2023-3730", "CVE-2023-3732", "CVE-2023-3733", "CVE-2023-3734", "CVE-2023-3735", "CVE-2023-3736", "CVE-2023-3737", "CVE-2023-3738", "CVE-2023-3739", "CVE-2023-3740");
  ...
  script_name("Debian: Security Advisory (DSA-5456)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5456");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5456");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5456 advisory.");
