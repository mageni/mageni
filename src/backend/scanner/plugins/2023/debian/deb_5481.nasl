...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-08-21 18:17:00 +0000 (Mon, 21 Aug 2023)");

  script_name("Debian: Security Advisory (DSA-5481)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5481");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5481");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'fastdds' package(s) announced via the DSA-5481 advisory.");
