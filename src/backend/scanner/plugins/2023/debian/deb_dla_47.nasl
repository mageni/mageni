...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-47)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-47");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-47");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lua5.1' package(s) announced via the DLA-47 advisory.");
