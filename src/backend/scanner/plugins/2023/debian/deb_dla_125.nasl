...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.125");
  ...
  script_name("Debian: Security Advisory (DLA-125)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-125");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-125");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mime-support' package(s) announced via the DLA-125 advisory.");
...
We recommend that you upgrade your mime-support packages.");
  ...
  script_tag(name:"affected", value:"'mime-support' package(s) on Debian 6.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mime-support", ver:"3.48-1+deb6u1", rls:"DEB6"))) {
    report += res;
  }
