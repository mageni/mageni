...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-92)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-92");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-92");
  script_xref(name:"URL", value:"http://tomcat.apache.org/native-doc/miscellaneous/changelog.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat-native' package(s) announced via the DLA-92 advisory.");
