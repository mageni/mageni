...
if(description)
{
  ...
  script_name("Debian: Security Advisory for spip (DSA-5325-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5325.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5325-1");
  script_xref(name:"Advisory-ID", value:"DSA-5325-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spip'
  package(s) announced via the DSA-5325-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"3.2.11-3+deb11u6", rls:"DEB11"))) {
  report += res;
}
