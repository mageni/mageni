...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for xorg-server (DLA-3256-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/12/msg00041.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3256-1");
  script_xref(name:"Advisory-ID", value:"DLA-3256-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server'
  package(s) announced via the DLA-3256-1 advisory.");
