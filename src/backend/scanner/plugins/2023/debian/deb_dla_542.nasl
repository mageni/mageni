...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.542");
  ...
  script_name("Debian: Security Advisory (DLA-542)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-542");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-542");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pidgin' package(s) announced via the DLA-542 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Numerous security issues have been identified and fixed in Pidgin in Debian/Wheezy.
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"finch-dev", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"finch", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpurple-bin", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpurple-dev", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpurple0", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pidgin-data", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pidgin-dbg", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pidgin-dev", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pidgin", ver:"2.10.10-1~deb7u2", rls:"DEB7"))) {
    report += res;
  }
