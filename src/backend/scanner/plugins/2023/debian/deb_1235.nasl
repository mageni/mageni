...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1235)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1235");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1235");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby1.8' package(s) announced via the DSA-1235 advisory.");
