...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2011.2335");
  ...
  script_name("Debian: Security Advisory (DSA-2335)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2335");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/dsa-2335");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'man2html' package(s) announced via the DSA-2335 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tim Starling discovered that the Debian-native CGI wrapper for man2html, a program to convert UNIX man pages to HTML, is not properly escaping user-supplied input when displaying various error messages. A remote attacker can exploit this flaw to conduct cross-site scripting (XSS) attacks.
...
We recommend that you upgrade your man2html packages.");
  ...
  script_tag(name:"affected", value:"'man2html' package(s) on Debian 5, Debian 6.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"man2html", ver:"1.6f-3+lenny1", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"man2html", ver:"1.6f+repack-1+squeeze1", rls:"DEB6"))) {
    report += res;
  }
