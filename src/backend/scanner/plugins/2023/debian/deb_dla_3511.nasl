...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3511)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3511");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3511");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'amd64-microcode' package(s) announced via the DLA-3511 advisory.");
