...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.0011");
  ...
  script_name("Debian: Security Advisory (DLA-0011)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-0011");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-0011");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libemail-address-perl' package(s) announced via the DLA-0011 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libemail-address-perl", ver:"1.889-2+deb6u1", rls:"DEB6"))) {
    report += res;
  }
