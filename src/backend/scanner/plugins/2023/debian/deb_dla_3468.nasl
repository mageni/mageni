...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2023.3468");
  ...
  script_name("Debian: Security Advisory (DLA-3468)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3468");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3468");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/hsqldb1.8.0");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hsqldb1.8.0' package(s) announced via the DLA-3468 advisory.");
...
For Debian 10 buster, this problem has been fixed in version 1.8.0.10+dfsg-10+deb10u1.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'hsqldb1.8.0' package(s) on Debian 10.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libhsqldb1.8.0-java", ver:"1.8.0.10+dfsg-10+deb10u1", rls:"DEB10"))) {
    report += res;
  }
