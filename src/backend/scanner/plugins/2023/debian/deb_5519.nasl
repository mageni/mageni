...
if(description)
{
  ...
  script_tag(name:"insight", value:"Maxim Suhanov discovered multiple vulnerabilities in GURB2's code to handle NTFS filesystems, which may result in a Secure Boot bypass.
