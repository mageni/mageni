...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.462");
  ...
  script_name("Debian: Security Advisory (DLA-462)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-462");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-462");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'websvn' package(s) announced via the DLA-462 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"websvn", ver:"2.3.3-1.1+deb7u3", rls:"DEB7"))) {
    report += res;
  }
