...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2023.3537");
  script_cve_id("CVE-2022-40982", "CVE-2022-41804", "CVE-2023-23908");
  script_tag(name:"creation_date", value:"2023-08-22 04:19:29 +0000 (Tue, 22 Aug 2023)");
  ...
  script_name("Debian: Security Advisory (DLA-3537)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3537");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3537");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'intel-microcode' package(s) announced via the DLA-3537 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20230808.1~deb10u1", rls:"DEB10"))) {
    report += res;
  }
