...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-02-08 18:46:00 +0000 (Wed, 08 Feb 2017)");

  script_name("Debian: Security Advisory (DLA-733)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-733");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-733");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openafs' package(s) announced via the DLA-733 advisory.");
