...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-467)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-467");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-467");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xerces-c' package(s) announced via the DLA-467 advisory.");
