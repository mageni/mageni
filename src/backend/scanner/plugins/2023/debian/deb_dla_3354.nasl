...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-09 00:36:00 +0000 (Sat, 09 Apr 2022)");

  script_name("Debian: Security Advisory (DLA-3354)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3354");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3354");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/kopanocore");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kopanocore' package(s) announced via the DLA-3354 advisory.");
