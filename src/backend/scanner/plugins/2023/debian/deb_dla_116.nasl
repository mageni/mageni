...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2014.116");
  ...
  script_name("Debian: Security Advisory (DLA-116)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-116");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-116");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ntp' package(s) announced via the DLA-116 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntp-doc", ver:"1:4.2.6.p2+dfsg-1+deb6u1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ntp", ver:"1:4.2.6.p2+dfsg-1+deb6u1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ntpdate", ver:"1:4.2.6.p2+dfsg-1+deb6u1", rls:"DEB6"))) {
    report += res;
  }
