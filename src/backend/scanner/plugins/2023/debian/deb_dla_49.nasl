...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-49)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-49");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-49");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'acpi-support' package(s) announced via the DLA-49 advisory.");
