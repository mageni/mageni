...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for emacs (DLA-3257-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/12/msg00046.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3257-1");
  script_xref(name:"Advisory-ID", value:"DLA-3257-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1025009");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'emacs'
  package(s) announced via the DLA-3257-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an issue in Emacs where where
...
when calling the (external) ctags(1) binary.");
  ...
  script_tag(name:"affected", value:"'emacs' package(s) on Debian Linux.");
