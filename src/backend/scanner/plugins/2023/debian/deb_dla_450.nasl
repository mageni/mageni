...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-450)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-450");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-450");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gdk-pixbuf' package(s) announced via the DLA-450 advisory.");
