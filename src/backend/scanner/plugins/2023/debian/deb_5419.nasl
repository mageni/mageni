...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2023.5419");
  script_cve_id("CVE-2023-31130", "CVE-2023-32067");
  script_tag(name:"creation_date", value:"2023-06-07 11:34:43 +0000 (Wed, 07 Jun 2023)");
  ...
  script_name("Debian: Security Advisory (DSA-5419)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5419");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5419");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5419");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/c-ares");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'c-ares' package(s) announced via the DSA-5419 advisory.");
...
Target resolver may erroneously interprets a malformed UDP packet with a lenght of 0 as a graceful shutdown of the connection, which could cause a denial of service.
...
For the detailed security status of c-ares please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'c-ares' package(s) on Debian 11.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc-ares-dev", ver:"1.17.1-1+deb11u3", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libc-ares2", ver:"1.17.1-1+deb11u3", rls:"DEB11"))) {
    report += res;
  }
