...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2006.1181");
  ...
  script_name("Debian: Security Advisory (DSA-1181)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1181");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1181");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gzip' package(s) announced via the DSA-1181 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tavis Ormandy from the Google Security Team discovered several vulnerabilities in gzip, the GNU compression utility. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your gzip package.");
  ...
  script_tag(name:"affected", value:"'gzip' package(s) on Debian 3.1.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gzip", ver:"1.3.5-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }
