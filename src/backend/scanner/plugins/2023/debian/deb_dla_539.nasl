...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2016.539");
  ...
  script_name("Debian: Security Advisory (DLA-539)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-539");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/dla-539");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu-kvm' package(s) announced via the DLA-539 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 1.1.2+dfsg-6+deb7u13.
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kvm", ver:"1:1.1.2+dfsg-6+deb7u13", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-kvm-dbg", ver:"1.1.2+dfsg-6+deb7u13", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-kvm", ver:"1.1.2+dfsg-6+deb7u13", rls:"DEB7"))) {
    report += res;
  }
