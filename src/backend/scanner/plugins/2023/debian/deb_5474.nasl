...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20230808.1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
...
if(release == "DEB12") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20230808.1~deb12u1", rls:"DEB12"))) {
    report += res;
  }
