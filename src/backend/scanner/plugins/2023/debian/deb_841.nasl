...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-841)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-841");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-841");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mailutils' package(s) announced via the DSA-841 advisory.");
