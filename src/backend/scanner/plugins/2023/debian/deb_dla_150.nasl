...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2015.150");
  ...
  script_name("Debian: Security Advisory (DLA-150)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-150");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/dla-150");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unzip' package(s) announced via the DLA-150 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"6.0-4+deb6u2", rls:"DEB6"))) {
    report += res;
  }
