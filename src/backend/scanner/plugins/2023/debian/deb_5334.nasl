...
if(description)
{
  ...
  script_name("Debian: Security Advisory for varnish (DSA-5334-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5334.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5334-1");
  script_xref(name:"Advisory-ID", value:"DSA-5334-1");
  ...
  package(s) announced via the DSA-5334-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Martin van Kervel Smedshammer discovered that varnish, a state of the
