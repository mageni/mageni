...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-108)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-108");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/dla-108");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nfs-utils' package(s) announced via the DLA-108 advisory.");
