...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.832526");
  ...
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB23-34) - Windows");

  script_tag(name:"summary", value:"Adobe Acrobat Classic is prone to an
  ...
  20.005.30514 and earlier on Windows.");
