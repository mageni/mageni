...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832525");
  ...
  script_name("Adobe Reader DC Continuous Security Update (APSB23-34) - Mac OS X");

  script_tag(name:"summary", value:"Adobe Acrobat Reader is prone to
  ...
  23.003.20284 and earlier on Mac OS X.");
