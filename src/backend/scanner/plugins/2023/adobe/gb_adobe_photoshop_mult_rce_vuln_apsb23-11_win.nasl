...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821395");
  ...
  script_tag(name:"creation_date", value:"2023-03-15 13:30:07 +0530 (Wed, 15 Mar 2023)");
  script_name("Adobe Photoshop Multiple RCE Vulnerabilities (APSB23-11)-Windows");

  script_tag(name:"summary", value:"Adobe Photoshop is prone to remote code
