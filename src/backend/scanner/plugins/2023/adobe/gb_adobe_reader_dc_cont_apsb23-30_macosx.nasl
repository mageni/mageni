...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832257");
  ...
  script_tag(name:"creation_date", value:"2023-08-22 15:31:57 +0530 (Tue, 22 Aug 2023)");
  script_name("Adobe Reader DC Continuous Security Update (APSB23-30) - Mac OS X");
  ...
  23.003.20244 and earlier on Mac OS X.");
