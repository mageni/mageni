...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821397");
  ...
  script_tag(name:"creation_date", value:"2023-03-15 14:40:42 +0530 (Wed, 15 Mar 2023)");
  script_name("Adobe Illustrator Multiple Vulnerabilities (APSB23-19)-Windows");
  ...
  script_tag(name:"affected", value:"Adobe Illustrator 27.2.0 and earlier on Windows.");
