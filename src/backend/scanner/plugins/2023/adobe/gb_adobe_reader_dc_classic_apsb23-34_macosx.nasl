...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832523");
  ...
  script_tag(name:"creation_date", value:"2023-10-11 15:20:42 +0530 (Wed, 11 Oct 2023)");
  script_name("Adobe Acrobat Reader Classic 2020 Security Update (APSB23-34) - Mac OS X");
  ...
  20.005.30516 and earlier versions on Mac OS X.");
