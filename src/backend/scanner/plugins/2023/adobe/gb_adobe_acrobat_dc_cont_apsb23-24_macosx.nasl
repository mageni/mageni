...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826976");
  ...
  script_tag(name:"creation_date", value:"2023-04-14 17:10:12 +0530 (Fri, 14 Apr 2023)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB23-24) - Mac OS X");
  ...
  prior to 23.001.20143 on Mac OS X.");
