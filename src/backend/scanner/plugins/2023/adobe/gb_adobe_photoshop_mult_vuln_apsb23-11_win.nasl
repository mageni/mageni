...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826926");
  ...
  script_name("Adobe Photoshop Multiple Vulnerabilities (APSB23-11) - Windows");
  ...
  script_tag(name:"solution", value:"Upgrade Adobe Photoshop 2022 to 23.5.4,
  Adobe Photoshop 2023 to 24.1.1 or later.");
