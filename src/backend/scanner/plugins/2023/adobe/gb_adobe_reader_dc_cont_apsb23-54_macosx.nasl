...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832706");
  ...
  script_name("Adobe Acrobat Reader DC Continuous Security Update (APSB23-54) - Mac OS X");
  ...
  23.006.20360 and earlier on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 23.006.20380 or later.");
