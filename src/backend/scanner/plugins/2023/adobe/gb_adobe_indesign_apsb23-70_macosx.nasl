...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832742");
  ...
  script_tag(name:"creation_date", value:"2023-12-14 12:04:13 +0530 (Thu, 14 Dec 2023)");
  script_name("Adobe InDesign Multiple Vulnerabilities (APSB23-70) - Mac OS X");
