...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826773");
  ...
  script_tag(name:"creation_date", value:"2023-01-11 15:27:22 +0530 (Wed, 11 Jan 2023)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB23-01) - Mac OS X");
  ...
  22.003.20281 and earlier on Mac OS X.");
...
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2022.003.20310", install_path:path);
