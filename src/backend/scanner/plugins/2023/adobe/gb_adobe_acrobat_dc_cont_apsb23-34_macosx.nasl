...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832521");
  ...
  script_tag(name:"creation_date", value:"2023-10-11 15:19:01 +0530 (Wed, 11 Oct 2023)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB23-34) - Mac OS X");
  ...
  23.003.20284 and earlier versions on Mac OS X.");
