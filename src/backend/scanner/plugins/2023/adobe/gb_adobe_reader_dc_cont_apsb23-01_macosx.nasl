...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826774");
  ...
  script_tag(name:"creation_date", value:"2023-01-11 15:27:58 +0530 (Wed, 11 Jan 2023)");
  script_name("Adobe Reader DC Continuous Security Update (APSB23-01) - Mac OS X");
