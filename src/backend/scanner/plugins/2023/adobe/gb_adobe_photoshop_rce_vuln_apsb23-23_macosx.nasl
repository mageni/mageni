...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821394");
  ...
  script_tag(name:"creation_date", value:"2023-03-15 13:22:02 +0530 (Wed, 15 Mar 2023)");
  script_name("Adobe Photoshop RCE Vulnerability (APSB23-23)- Mac OS X");

  script_tag(name:"summary", value:"Adobe Photoshop is prone to a high-risk vulnerability
