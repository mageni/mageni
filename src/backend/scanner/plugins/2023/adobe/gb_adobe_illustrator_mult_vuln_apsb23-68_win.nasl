...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832739");
  ...
  script_name("Adobe Illustrator Multiple Vulnerabilities (APSB23-68) - Windows");
  ...
  Adobe Illustrator 2024 prior to 28.1 on Windows.");
