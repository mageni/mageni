...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826977");
  ...
  script_tag(name:"creation_date", value:"2023-04-14 17:10:47 +0530 (Fri, 14 Apr 2023)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB23-24) - Mac OS X");
