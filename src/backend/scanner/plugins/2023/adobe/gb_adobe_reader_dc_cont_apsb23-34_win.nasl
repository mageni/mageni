...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832524");
  ...
  script_name("Adobe Reader DC Continuous Security Update (APSB23-34) - Windows");

  script_tag(name:"summary", value:"Adobe Acrobat Reader is prone to an
  ...
  23.003.20284 and earlier on Windows.");

  script_tag(name:"solution", value:"Update to version 23.006.20320 or later.");
...
if(version_is_less(version:vers, test_version:"23.006.20320")) {
