...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832255");
  ...
  script_tag(name:"creation_date", value:"2023-08-22 15:31:34 +0530 (Tue, 22 Aug 2023)");
  script_name("Adobe Reader Classic 2020 Security Update (APSB23-30) - Mac OS X");
  ...
  prior to 20.005.30516.10516 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 20.005.30516.10516 or later.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30467")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.005.30516.10516(2020.005.30516.10516)", install_path:path);
