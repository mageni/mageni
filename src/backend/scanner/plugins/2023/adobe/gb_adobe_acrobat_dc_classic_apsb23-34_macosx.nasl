...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832527");
  ...
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB23-30) - Mac OS X");

  script_tag(name:"summary", value:"Adobe Acrobat is prone to
  ...
  script_tag(name:"affected", value:"Adobe Acrobat Classic 2020 version
  20.005.30516 and earlier on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 20.005.30524 or later.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30516")) {
