...
if (description)
{
  ...
  script_cve_id("CVE-2023-42117", "CVE-2023-42118", "CVE-2023-42119");
  ...
  - CVE-2023-42118: libspf2 integer underflow remote code execution (RCE)
  ...
  script_tag(name:"solution", value:"No known solution is available as of 04th October, 2023.
...
if (version_is_less_equal(version: version, test_version: "4.96.1")) {
