...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884282");
  ...
  script_tag(name:"creation_date", value:"2023-03-23 02:00:36 +0000 (Thu, 23 Mar 2023)");
  script_name("CentOS: Security Advisory for firefox (CESA-2023:1333)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2023:1333");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2023-March/086391.html");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~102.9.0~3.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
