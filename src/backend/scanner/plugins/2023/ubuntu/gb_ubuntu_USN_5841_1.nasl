...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5841.1");
  script_cve_id("CVE-2019-14973", "CVE-2019-17546", "CVE-2020-35523", "CVE-2020-35524", "CVE-2022-3970", "CVE-2022-48281");
  ...
  script_name("Ubuntu: Security Advisory (USN-5841-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5841-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5841-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the USN-5841-1 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.0.3-7ubuntu0.11+esm6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtiff5", ver:"4.0.3-7ubuntu0.11+esm6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.0.6-1ubuntu0.8+esm9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtiff5", ver:"4.0.6-1ubuntu0.8+esm9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
