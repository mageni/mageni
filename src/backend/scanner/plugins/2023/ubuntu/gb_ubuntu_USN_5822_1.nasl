...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5822.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5822-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5822-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5822-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the USN-5822-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Samba incorrectly handled the bad password count
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.13.17~dfsg-0ubuntu1.20.04.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.15.13+dfsg-0ubuntu1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.16.8+dfsg-0ubuntu1", rls:"UBUNTU22.10"))) {
    report += res;
  }
