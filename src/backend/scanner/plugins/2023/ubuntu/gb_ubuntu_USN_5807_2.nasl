...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5807.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5807-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5807-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5807-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxpm' package(s) announced via the USN-5807-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5807-1 fixed vulnerabilities in libXpm. This update provides the
...
Original advisory details:
 ...
 (CVE-2022-4883)");
  ...
  script_tag(name:"affected", value:"'libxpm' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxpm4", ver:"1:3.5.11-1ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xpmutils", ver:"1:3.5.11-1ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
