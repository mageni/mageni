...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5205.1");
  script_cve_id("CVE-2018-13112", "CVE-2018-17580", "CVE-2018-17582", "CVE-2018-17974", "CVE-2018-18407", "CVE-2018-18408", "CVE-2018-20552", "CVE-2018-20553", "CVE-2020-12740", "CVE-2020-24265", "CVE-2020-24266", "CVE-2022-27416", "CVE-2022-28487");
  ...
  script_name("Ubuntu: Security Advisory (USN-5205-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5205-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5205-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay' package(s) announced via the USN-5205-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Tcpreplay incorrectly handled certain specially crafted
...
22.04 ESM. (CVE-2022-28487)");
  ...
  script_tag(name:"affected", value:"'tcpreplay' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpreplay", ver:"3.4.4-2+deb8u1ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpreplay", ver:"4.2.6-1ubuntu0.1~esm4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpreplay", ver:"4.3.2-1ubuntu0.1~esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpreplay", ver:"4.3.4-1ubuntu0.1~esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
