...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5913.1");
  script_cve_id("CVE-2022-20566", "CVE-2022-3565", "CVE-2022-36879", "CVE-2022-43750", "CVE-2022-4379", "CVE-2022-47520", "CVE-2023-0045", "CVE-2023-0461");
  ...
  script_name("Ubuntu: Security Advisory (USN-5913-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5913-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5913-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.14, linux-oem-5.17' package(s) announced via the USN-5913-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.14.0-1058-oem", ver:"5.14.0-1058.66", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04", ver:"5.14.0.1058.56", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04b", ver:"5.14.0.1058.56", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04c", ver:"5.14.0.1058.56", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04d", ver:"5.14.0.1058.56", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.17.0-1028-oem", ver:"5.17.0-1028.29", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04", ver:"5.17.0.1028.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04a", ver:"5.17.0.1028.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
