...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6134.1");
  script_cve_id("CVE-2022-27672", "CVE-2022-3707", "CVE-2022-4129", "CVE-2022-47929", "CVE-2022-4842", "CVE-2023-0386", "CVE-2023-0394", "CVE-2023-0458", "CVE-2023-0459", "CVE-2023-1073", "CVE-2023-1074", "CVE-2023-1075", "CVE-2023-1078", "CVE-2023-1118", "CVE-2023-1281", "CVE-2023-1513", "CVE-2023-1652", "CVE-2023-1829", "CVE-2023-1872", "CVE-2023-20938", "CVE-2023-21102", "CVE-2023-2162", "CVE-2023-26545", "CVE-2023-32269");
  ...
  script_tag(name:"severity_date", value:"2023-05-24 00:15:00 +0000 (Wed, 24 May 2023)");

  script_name("Ubuntu: Security Advisory (USN-6134-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6134-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6134-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg-5.15' package(s) announced via the USN-6134-1 advisory.");
...
the Linux kernel contained ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1030-intel-iotg", ver:"5.15.0-1030.35~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1030.35~20.04.22", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1030.35~20.04.22", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
