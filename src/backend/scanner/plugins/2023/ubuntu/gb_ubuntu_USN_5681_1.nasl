...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5681.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5681-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5681-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5681-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gthumb' package(s) announced via the USN-5681-1 advisory.");
...
in a denial of service. (CVE-2020-36427)");
  ...
  script_tag(name:"affected", value:"'gthumb' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gthumb-data", ver:"3:3.4.3-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gthumb", ver:"3:3.4.3-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gthumb-data", ver:"3:3.6.1-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gthumb", ver:"3:3.6.1-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
