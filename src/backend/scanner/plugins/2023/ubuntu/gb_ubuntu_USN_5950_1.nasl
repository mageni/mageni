...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5950.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5950-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5950-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5950-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm' package(s) announced via the USN-5950-1 advisory.");
...
service (system crash) or possibly execute arbitrary ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-kvm' package(s) on Ubuntu 22.10.");
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.19.0-1019-kvm", ver:"5.19.0-1019.20", rls:"UBUNTU22.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.19.0.1019.16", rls:"UBUNTU22.10"))) {
    report += res;
  }
