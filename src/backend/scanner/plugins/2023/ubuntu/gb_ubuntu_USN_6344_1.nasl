...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6344.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6344-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6344-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6344-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-6344-1 advisory.");
...
arbitrary code. (CVE-2023-38429)");
  ...
  script_tag(name:"affected", value:"'linux-azure' package(s) on Ubuntu 23.04.");
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.2.0-1011-azure", ver:"6.2.0-1011.11", rls:"UBUNTU23.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.2.0.1011.11", rls:"UBUNTU23.04"))) {
    report += res;
  }
