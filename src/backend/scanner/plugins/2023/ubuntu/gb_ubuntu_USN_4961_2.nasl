...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.4961.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-4961-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4961-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4961-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-pip' package(s) announced via the USN-4961-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4961-1 fixed a vulnerability in pip. This update provides the
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-pip", ver:"1.5.4-1ubuntu4+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-pip", ver:"8.1.1-2ubuntu0.6+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-pip", ver:"9.0.1-2.3~ubuntu1.18.04.5+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
