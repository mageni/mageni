...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5793.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-5793-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5793-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5793-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp, linux-oracle' package(s) announced via the USN-5793-3 advisory.");
...
driver in the Linux ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gcp, linux-oracle' package(s) on Ubuntu 22.10.");
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.19.0-1014-gcp", ver:"5.19.0-1014.15", rls:"UBUNTU22.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.19.0-1014-oracle", ver:"5.19.0-1014.16", rls:"UBUNTU22.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"5.19.0.1014.11", rls:"UBUNTU22.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.19.0.1014.11", rls:"UBUNTU22.10"))) {
    report += res;
  }
