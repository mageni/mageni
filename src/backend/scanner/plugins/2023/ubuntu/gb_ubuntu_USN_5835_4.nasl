...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5835.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-5835-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5835-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5835-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cinder' package(s) announced via the USN-5835-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5835-1 fixed vulnerabilities in Cinder. This update provides the
...
Original advisory details:
 ...
 information.");
  ...
  script_tag(name:"affected", value:"'cinder' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-cinder", ver:"2:12.0.10-0ubuntu2.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-cinder", ver:"2:16.4.2-0ubuntu2.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
