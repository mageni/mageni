...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5856.1");
  script_cve_id("CVE-2022-1048", "CVE-2022-3424", "CVE-2023-0179");
  ...
  script_name("Ubuntu: Security Advisory (USN-5856-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5856-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5856-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.1' package(s) announced via the USN-5856-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.1.0-1006-oem", ver:"6.1.0-1006.6", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04c", ver:"6.1.0.1006.6", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
