...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6261.1");
  script_cve_id("CVE-2023-3090", "CVE-2023-32629", "CVE-2023-3390", "CVE-2023-35001");
  script_tag(name:"creation_date", value:"2023-07-31 04:09:50 +0000 (Mon, 31 Jul 2023)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6261-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6261-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6261-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-iot' package(s) announced via the USN-6261-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1018-iot", ver:"5.4.0-1018.19", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
