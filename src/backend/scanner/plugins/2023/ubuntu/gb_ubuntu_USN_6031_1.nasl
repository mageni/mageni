...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6031.1");
  script_cve_id("CVE-2022-21505", "CVE-2022-3903", "CVE-2022-41849", "CVE-2022-4382", "CVE-2023-1074", "CVE-2023-1095", "CVE-2023-1118", "CVE-2023-1281", "CVE-2023-23559", "CVE-2023-26607");
  ...
  script_name("Ubuntu: Security Advisory (USN-6031-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6031-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6031-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.17' package(s) announced via the USN-6031-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.17.0-1030-oem", ver:"5.17.0-1030.31", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04", ver:"5.17.0.1030.28", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04a", ver:"5.17.0.1030.28", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
