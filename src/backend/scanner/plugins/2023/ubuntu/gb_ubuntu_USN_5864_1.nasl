...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5864.1");
  script_cve_id("CVE-2019-14275", "CVE-2019-19555", "CVE-2019-19797", "CVE-2020-21529", "CVE-2020-21530", "CVE-2020-21531", "CVE-2020-21532", "CVE-2020-21533", "CVE-2020-21534", "CVE-2020-21535", "CVE-2020-21675", "CVE-2020-21676", "CVE-2021-32280", "CVE-2021-3561");
  ...
  script_name("Ubuntu: Security Advisory (USN-5864-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5864-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5864-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fig2dev' package(s) announced via the USN-5864-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Frederic Cambus discovered that Fig2dev incorrectly handled certain image
...
a denial of service. (CVE-2021-32280)");
  ...
  script_tag(name:"affected", value:"'fig2dev' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fig2dev", ver:"1:3.2.6a-6ubuntu1.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"transfig", ver:"1:3.2.6a-6ubuntu1.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fig2dev", ver:"1:3.2.7a-7ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
