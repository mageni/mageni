...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6285.1");
  script_cve_id("CVE-2022-48502", "CVE-2023-2640", "CVE-2023-2898", "CVE-2023-31248", "CVE-2023-32629", "CVE-2023-3390", "CVE-2023-35001", "CVE-2023-3609", "CVE-2023-3610", "CVE-2023-3611", "CVE-2023-3776", "CVE-2023-38430", "CVE-2023-38432", "CVE-2023-3863");
  ...
  script_name("Ubuntu: Security Advisory (USN-6285-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6285-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6285-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.1' package(s) announced via the USN-6285-1 advisory.");
...
vulnerability. A local attacker could use this to cause a denial of service
(system crash) or possibly execute ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.1.0-1019-oem", ver:"6.1.0-1019.19", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04c", ver:"6.1.0.1019.19", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
