...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5880.1");
  script_cve_id("CVE-2023-0767", "CVE-2023-25728", "CVE-2023-25729", "CVE-2023-25730", "CVE-2023-25731", "CVE-2023-25732", "CVE-2023-25733", "CVE-2023-25735", "CVE-2023-25736", "CVE-2023-25737", "CVE-2023-25739", "CVE-2023-25741", "CVE-2023-25742", "CVE-2023-25744", "CVE-2023-25745");
  script_tag(name:"creation_date", value:"2023-02-20 11:10:13 +0000 (Mon, 20 Feb 2023)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5880-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5880-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5880-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-5880-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Christian Holler discovered that Firefox did not properly manage memory
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"110.0+build3-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"110.0+build3-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
