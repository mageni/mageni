...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6520.1");
  script_cve_id("CVE-2023-25775", "CVE-2023-31083", "CVE-2023-31085", "CVE-2023-3772", "CVE-2023-38430", "CVE-2023-38432", "CVE-2023-3863", "CVE-2023-3865", "CVE-2023-3866", "CVE-2023-3867", "CVE-2023-4132", "CVE-2023-4134", "CVE-2023-44466", "CVE-2023-45871", "CVE-2023-5090", "CVE-2023-5345");
  ...
  script_name("Ubuntu: Security Advisory (USN-6520-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6520-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6520-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-starfive-6.2' package(s) announced via the USN-6520-1 advisory.");
...
certain ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-starfive-6.2' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.2.0-1009-starfive", ver:"6.2.0-1009.10~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-starfive", ver:"6.2.0.1009.10~22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
