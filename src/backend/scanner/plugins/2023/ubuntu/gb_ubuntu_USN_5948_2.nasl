...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5948.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5948-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5948-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5948-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-werkzeug' package(s) announced via the USN-5948-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5948-1 fixed vulnerabilities in Werkzeug. This update provides the
...
Original advisory details:
 ...
 service. (CVE-2023-25577)");
  ...
  script_tag(name:"affected", value:"'python-werkzeug' package(s) on Ubuntu 23.04.");
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-werkzeug", ver:"2.2.2-2ubuntu0.1", rls:"UBUNTU23.04"))) {
    report += res;
  }
