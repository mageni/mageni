...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4794.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-4794-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4794-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4794-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libupnp' package(s) announced via the USN-4794-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Matthew Garrett discovered that libupnp mishandled POST requests by
...
possibly execute arbitrary code. (CVE-2016-8863)");
  ...
  script_tag(name:"affected", value:"'libupnp' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libupnp6", ver:"1:1.6.19+git20160116-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
