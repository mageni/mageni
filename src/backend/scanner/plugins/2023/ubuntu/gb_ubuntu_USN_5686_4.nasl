...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5686.4");
  ...
  script_tag(name:"severity_date", value:"2022-10-21 17:44:00 +0000 (Fri, 21 Oct 2022)");

  script_name("Ubuntu: Security Advisory (USN-5686-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5686-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5686-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'git' package(s) announced via the USN-5686-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5686-1 fixed several vulnerabilities in Git. This update
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.7.4-0ubuntu1.10+esm6", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
