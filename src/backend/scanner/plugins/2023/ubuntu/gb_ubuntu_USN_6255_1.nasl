...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6255.1");
  script_cve_id("CVE-2023-3090", "CVE-2023-31248", "CVE-2023-3389", "CVE-2023-3390", "CVE-2023-3439", "CVE-2023-35001");
  ...
  script_name("Ubuntu: Security Advisory (USN-6255-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6255-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6255-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg-5.15' package(s) announced via the USN-6255-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the IP-VLAN network driver for the Linux kernel did
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1036-intel-iotg", ver:"5.15.0-1036.41~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1036.41~20.04.26", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1036.41~20.04.26", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
