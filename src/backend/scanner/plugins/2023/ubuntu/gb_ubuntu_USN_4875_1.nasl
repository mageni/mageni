...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4875.1");
  script_cve_id("CVE-2020-7247", "CVE-2020-8793", "CVE-2020-8794");
  ...
  script_name("Ubuntu: Security Advisory (USN-4875-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4875-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4875-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensmtpd' package(s) announced via the USN-4875-1 advisory.");
...
Ubuntu 16.04 ESM. (CVE-2020-8794)");
  ...
  script_tag(name:"affected", value:"'opensmtpd' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"opensmtpd", ver:"5.4.1p1-1ubuntu0.1~esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"opensmtpd", ver:"5.7.3p2-1ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
