...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6233.2");
  ...
  script_tag(name:"severity_date", value:"2022-04-18 10:05:33 +0000 (Mon, 18 Apr 2022)");

  script_name("Ubuntu: Security Advisory (USN-6233-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6233-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6233-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'yajl' package(s) announced via the USN-6233-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6233-1 fixed vulnerabilities in YAJL. This update provides the
...
Original advisory details:
 ...
 service (memory exhaustion). (CVE-2023-33460)");
  ...
  script_tag(name:"affected", value:"'yajl' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyajl2", ver:"2.1.0-3ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyajl2", ver:"2.1.0-3ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyajl2", ver:"2.1.0-3ubuntu0.23.04.1", rls:"UBUNTU23.04"))) {
    report += res;
  }
