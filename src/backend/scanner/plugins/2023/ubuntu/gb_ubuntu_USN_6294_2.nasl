...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6294.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6294-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6294-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6294-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'haproxy' package(s) announced via the USN-6294-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6294-1 fixed vulnerabilities in HAProxy. This update provides the
...
Original advisory details:
 ...
 payload and bypass certain restrictions.");
  ...
  script_tag(name:"affected", value:"'haproxy' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"haproxy", ver:"2.0.31-0ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
