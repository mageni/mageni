...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5777.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5777-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5777-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5777-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pillow-python2' package(s) announced via the USN-5777-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5777-1 fixed vulnerabilities in Pillow (Python 3). This update provides the
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-pil", ver:"6.2.1-3ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
