...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5949-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5949-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5949-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium-browser' package(s) announced via the USN-5949-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Chromium could be made to write out of bounds in
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"chromium-browser", ver:"111.0.5563.64-0ubuntu0.18.04.5", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
