...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5811.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5811-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5811-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5811-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sudo' package(s) announced via the USN-5811-2 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sudo-ldap", ver:"1.8.16-0ubuntu1.10+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.8.16-0ubuntu1.10+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
