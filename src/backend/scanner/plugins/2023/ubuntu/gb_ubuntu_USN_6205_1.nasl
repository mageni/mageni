...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6205.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6205-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6205-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6205-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2023577");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2023220");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke' package(s) announced via the USN-6205-1 advisory.");
...
(kernel memory) or possibly cause undesired behaviors. (LP: #2023220)");
  ...
  script_tag(name:"affected", value:"'linux-gke' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1103-gke", ver:"5.4.0-1103.110", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"5.4.0.1103.108", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-5.4", ver:"5.4.0.1103.108", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
