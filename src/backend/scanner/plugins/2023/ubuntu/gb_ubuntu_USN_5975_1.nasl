...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp' package(s) announced via the USN-5975-1 advisory.");
...
kernel did not properly perform bounds checking in some situations. ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-gcp' package(s) on Ubuntu 16.04.");
