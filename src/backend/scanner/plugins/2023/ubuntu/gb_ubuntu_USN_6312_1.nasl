...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6312.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6312-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6312-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6312-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke, linux-ibm-5.4' package(s) announced via the USN-6312-1 advisory.");
...
to cause a denial of service ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gke, linux-ibm-5.4' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1054-ibm", ver:"5.4.0-1054.59~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"5.4.0.1054.65", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1105-gke", ver:"5.4.0-1105.112", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"5.4.0.1105.110", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-5.4", ver:"5.4.0.1105.110", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
