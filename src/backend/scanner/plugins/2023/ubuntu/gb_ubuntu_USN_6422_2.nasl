...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6422.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6422-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6422-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6422-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ring' package(s) announced via the USN-6422-2 advisory.");
...
Original advisory details:
 ...
 (CVE-2023-27585)");
  ...
  script_tag(name:"affected", value:"'ring' package(s) on Ubuntu 23.10.");
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"jami", ver:"20230206.0~ds2-1.3ubuntu0.1", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"jami-daemon", ver:"20230206.0~ds2-1.3ubuntu0.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
