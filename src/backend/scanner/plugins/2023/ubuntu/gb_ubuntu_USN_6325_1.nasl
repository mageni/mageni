...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6325.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6325-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6325-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6325-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gkeop-5.15, linux-intel-iotg' package(s) announced via the USN-6325-1 advisory.");
...
Kevin Rich discovered that the netfilter subsystem in the Linux ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gkeop-5.15, linux-intel-iotg' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1026-gkeop", ver:"5.15.0-1026.31~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gkeop-5.15", ver:"5.15.0.1026.31~20.04.22", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1038-intel-iotg", ver:"5.15.0-1038.43", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1038.37", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
