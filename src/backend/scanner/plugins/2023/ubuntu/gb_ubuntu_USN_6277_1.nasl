...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6277.1");
  script_cve_id("CVE-2014-5011", "CVE-2014-5012", "CVE-2014-5013", "CVE-2021-3838", "CVE-2022-2400");
  ...
  script_tag(name:"severity_date", value:"2020-01-13 21:00:00 +0000 (Mon, 13 Jan 2020)");

  script_name("Ubuntu: Security Advisory (USN-6277-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6277-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6277-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-dompdf' package(s) announced via the USN-6277-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Dompdf was not properly validating untrusted input when
...
issue to expose sensitive information. (CVE-2022-2400)");
  ...
  script_tag(name:"affected", value:"'php-dompdf' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-dompdf", ver:"0.6.1+dfsg-2ubuntu1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-dompdf", ver:"0.6.2+dfsg-3ubuntu0.18.04.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-dompdf", ver:"0.6.2+dfsg-3ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
