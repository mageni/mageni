...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5847.1");
  script_cve_id("CVE-2020-7729", "CVE-2022-0436", "CVE-2022-1537");
  ...
  script_name("Ubuntu: Security Advisory (USN-5847-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5847-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5847-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'grunt' package(s) announced via the USN-5847-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Grunt was not properly loading YAML files before
...
to execute arbitrary code. (CVE-2022-1537)");
  ...
  script_tag(name:"affected", value:"'grunt' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grunt", ver:"1.0.1-8ubuntu0.1+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grunt", ver:"1.0.4-2ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grunt", ver:"1.4.1-2ubuntu0.1~esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
