...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4442.2");
  script_cve_id("CVE-2018-1000550", "CVE-2018-1000671", "CVE-2020-10936");
  ...
  script_name("Ubuntu: Security Advisory (USN-4442-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4442-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4442-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sympa' package(s) announced via the USN-4442-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4442-1 fixed vulnerabilities in Sympa. This update provides the
...
affected Ubuntu 16.04 ESM and Ubuntu 18.04 ESM. (CVE-2018-1000671)");
  ...
  script_tag(name:"affected", value:"'sympa' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sympa", ver:"6.1.24~dfsg-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sympa", ver:"6.2.24~dfsg-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sympa", ver:"6.2.40~dfsg-4ubuntu0.20.04.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
