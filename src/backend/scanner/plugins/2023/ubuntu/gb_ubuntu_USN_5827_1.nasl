...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5827.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5827-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5827-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5827-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-5827-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Rob Schulhof discovered that Bind incorrectly handled a large number of
...
Ubuntu 22.04 LTS and Ubuntu 22.10. (CVE-2022-3924)");
  ...
  script_tag(name:"affected", value:"'bind9' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 22.10.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.16.1-0ubuntu2.12", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.1-1ubuntu1.3", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.4-2ubuntu2.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
