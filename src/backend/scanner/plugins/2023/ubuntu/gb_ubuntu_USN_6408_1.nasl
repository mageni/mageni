...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6408.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6408-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6408-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6408-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxpm' package(s) announced via the USN-6408-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Yair Mizrahi discovered that libXpm incorrectly handled certain malformed
...
CVE-2023-43789)");
  ...
  script_tag(name:"affected", value:"'libxpm' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxpm4", ver:"1:3.5.12-1ubuntu0.20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxpm4", ver:"1:3.5.12-1ubuntu0.22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxpm4", ver:"1:3.5.12-1.1ubuntu0.1", rls:"UBUNTU23.04"))) {
    report += res;
  }
