...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5834.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5834-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5834-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5834-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-5834-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Apache HTTP Server mod_dav module did not
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2-bin", ver:"2.4.18-2ubuntu3.17+esm8", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.18-2ubuntu3.17+esm8", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
