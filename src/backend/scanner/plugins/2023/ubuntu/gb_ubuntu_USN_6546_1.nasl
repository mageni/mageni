...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6546.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6546-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6546-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6546-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice' package(s) announced via the USN-6546-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Reginaldo Silva discovered that LibreOffice incorrectly handled filenames
...
arbitrary scripts. (CVE-2023-6186)");
  ...
  script_tag(name:"affected", value:"'libreoffice' package(s) on Ubuntu 23.04, Ubuntu 23.10.");
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice", ver:"4:7.5.9-0ubuntu0.23.04.1", rls:"UBUNTU23.04"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice", ver:"4:7.6.4-0ubuntu0.23.10.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
