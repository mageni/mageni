...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5880.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5880-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5880-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5880-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2008861");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-5880-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5880-1 fixed vulnerabilities in Firefox. The update introduced
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"110.0.1+build2-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"110.0.1+build2-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
