...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6022.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6022-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6022-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6022-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kamailio' package(s) announced via the USN-6022-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Kamailio did not properly sanitize SIP messages under
...
cause a denial of service or possibly execute arbitrary code. (CVE-2020-27507)");
  ...
  script_tag(name:"affected", value:"'kamailio' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kamailio", ver:"4.3.4-1.1ubuntu2.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kamailio", ver:"5.1.2-1ubuntu2+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kamailio", ver:"5.3.2-1ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
