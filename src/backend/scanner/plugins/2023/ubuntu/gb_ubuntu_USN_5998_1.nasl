...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5998.1");
  script_cve_id("CVE-2019-17571", "CVE-2022-23302", "CVE-2022-23305", "CVE-2022-23307");
  ...
  script_name("Ubuntu: Security Advisory (USN-5998-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5998-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5998-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-log4j1.2' package(s) announced via the USN-5998-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the SocketServer component of Apache Log4j 1.2
...
LTS. (CVE-2022-23307)");
  ...
  script_tag(name:"affected", value:"'apache-log4j1.2' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblog4j1.2-java", ver:"1.2.17-7ubuntu1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblog4j1.2-java", ver:"1.2.17-8+deb10u1ubuntu0.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblog4j1.2-java", ver:"1.2.17-9ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
