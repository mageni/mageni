...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6328.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6328-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6328-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6328-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle' package(s) announced via the USN-6328-1 advisory.");
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.2.0-1010-oracle", ver:"6.2.0-1010.10", rls:"UBUNTU23.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.2.0.1010.10", rls:"UBUNTU23.04"))) {
    report += res;
  }
