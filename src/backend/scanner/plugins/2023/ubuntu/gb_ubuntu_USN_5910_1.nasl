...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5910.1");
  ...
  script_tag(name:"severity_date", value:"2023-02-17 18:55:00 +0000 (Fri, 17 Feb 2023)");

  script_name("Ubuntu: Security Advisory (USN-5910-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5910-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5910-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-rack' package(s) announced via the USN-5910-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Rack did not properly structure regular expressions
...
Ubuntu 20.04 ESM and Ubuntu 22.04 ESM. (CVE-2022-44572)");
  ...
  script_tag(name:"affected", value:"'ruby-rack' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.5.2-3+deb8u3ubuntu1~esm6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.6.4-3ubuntu0.2+esm4", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.6.4-4ubuntu0.2+esm4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.0.7-2ubuntu0.1+esm3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.1.4-5ubuntu1+esm3", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
