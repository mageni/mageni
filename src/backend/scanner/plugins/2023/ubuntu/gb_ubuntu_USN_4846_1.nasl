...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4846.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-4846-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4846-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4846-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'yubico-piv-tool' package(s) announced via the USN-4846-1 advisory.");
...
Manager.");
  ...
  script_tag(name:"affected", value:"'yubico-piv-tool' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libykpiv1", ver:"1.0.3-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
