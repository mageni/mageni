...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6123.1");
  script_cve_id("CVE-2023-1670", "CVE-2023-2612", "CVE-2023-26606", "CVE-2023-30456", "CVE-2023-32233");
  ...
  script_name("Ubuntu: Security Advisory (USN-6123-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6123-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6123-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.0' package(s) announced via the USN-6123-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.0.0-1017-oem", ver:"6.0.0-1017.17", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04b", ver:"6.0.0.1017.17", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
