...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6502.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6502-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6502-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6502-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle' package(s) announced via the USN-6502-2 advisory.");
...
code. (CVE-2023-5345)");
  ...
  script_tag(name:"affected", value:"'linux-oracle' package(s) on Ubuntu 23.04.");
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.2.0-1016-oracle", ver:"6.2.0-1016.17", rls:"UBUNTU23.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.2.0.1016.16", rls:"UBUNTU23.04"))) {
    report += res;
  }
