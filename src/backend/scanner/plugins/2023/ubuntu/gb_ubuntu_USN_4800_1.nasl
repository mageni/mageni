...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4800.1");
  script_cve_id("CVE-2016-9179", "CVE-2017-1000211", "CVE-2021-38165");
  ...
  script_name("Ubuntu: Security Advisory (USN-4800-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4800-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4800-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lynx' package(s) announced via the USN-4800-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Lynx incorrectly handled certain URLs. A remote attacker
...
credentials because they may appear in SNI data. (CVE-2021-38165)");
  ...
  script_tag(name:"affected", value:"'lynx' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx", ver:"2.8.9dev8-4ubuntu1+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx", ver:"2.8.9dev16-3ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx", ver:"2.9.0dev.5-1ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
