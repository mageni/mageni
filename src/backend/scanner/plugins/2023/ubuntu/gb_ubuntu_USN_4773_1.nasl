...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4773.1");
  script_cve_id("CVE-2015-2559", "CVE-2015-2749", "CVE-2015-2750", "CVE-2018-7600", "CVE-2018-7602");
  ...
  script_name("Ubuntu: Security Advisory (USN-4773-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4773-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4773-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7' package(s) announced via the USN-4773-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Drupal did not properly process certain input. An
...
This issue affected only Ubuntu 14.04 ESM. (CVE-2015-2749, CVE-2015-2750)");
  ...
  script_tag(name:"affected", value:"'drupal7' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"drupal7", ver:"7.26-1ubuntu0.1+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"drupal7", ver:"7.44-1ubuntu1~16.04.0+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
