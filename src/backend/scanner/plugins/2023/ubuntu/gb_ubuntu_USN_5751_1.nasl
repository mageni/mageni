...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5751.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5751-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5751-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5751-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmaxminddb' package(s) announced via the USN-5751-1 advisory.");
...
applications using libmaxminddb to crash, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'libmaxminddb' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmaxminddb0", ver:"1.0.4-2.1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
