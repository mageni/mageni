...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5835.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-5835-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5835-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5835-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nova' package(s) announced via the USN-5835-5 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5835-3 fixed vulnerabilities in Nova. This update provides the
...
Original advisory details:
 ...
 information.");
  ...
  script_tag(name:"affected", value:"'nova' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nova-common", ver:"2:17.0.13-0ubuntu5.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-nova", ver:"2:17.0.13-0ubuntu5.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
