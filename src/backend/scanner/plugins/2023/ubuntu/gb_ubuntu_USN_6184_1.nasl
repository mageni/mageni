...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6184.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6184-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6184-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6184-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups' package(s) announced via the USN-6184-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that CUPS incorrectly handled certain memory operations.
...
in a denial of service, or possibly obtain sensitive information.");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 22.10, Ubuntu 23.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.3.1-9ubuntu1.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.4.1op1-1ubuntu4.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.4.2-1ubuntu2.2", rls:"UBUNTU22.10"))) {
    report += res;
  }
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.4.2-3ubuntu2.2", rls:"UBUNTU23.04"))) {
    report += res;
  }
