...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5922.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5922-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5922-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5922-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fribidi' package(s) announced via the USN-5922-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that FriBidi incorrectly handled the processing of input
...
arbitrary code. (CVE-2022-25310)");
  ...
  script_tag(name:"affected", value:"'fribidi' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfribidi-bin", ver:"0.19.7-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfribidi0", ver:"0.19.7-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
