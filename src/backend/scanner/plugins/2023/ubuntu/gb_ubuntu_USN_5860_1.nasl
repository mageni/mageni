...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5860.1");
  script_cve_id("CVE-2022-3543", "CVE-2022-3619", "CVE-2022-3623", "CVE-2022-3628", "CVE-2022-3640", "CVE-2022-3643", "CVE-2022-41849", "CVE-2022-41850", "CVE-2022-42895", "CVE-2022-42896", "CVE-2022-4378", "CVE-2022-45934", "CVE-2022-47940", "CVE-2023-0590");
  ...
  script_name("Ubuntu: Security Advisory (USN-5860-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5860-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5860-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke' package(s) announced via the USN-5860-1 advisory.");
...
It was discovered that an integer overflow ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1027-gke", ver:"5.15.0-1027.32", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-5.15", ver:"5.15.0.1027.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"5.15.0.1027.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
