...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6327.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6327-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6327-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6327-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm' package(s) announced via the USN-6327-1 advisory.");
...
(system crash) or possibly execute arbitrary code. (CVE-2023-3776)");
  ...
  script_tag(name:"affected", value:"'linux-kvm' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.4.0-1123-kvm", ver:"4.4.0-1123.133", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"4.4.0.1123.120", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
