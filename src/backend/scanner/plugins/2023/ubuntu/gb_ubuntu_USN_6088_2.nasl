...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6088.2");
  script_cve_id("CVE-2019-19921", "CVE-2021-43784", "CVE-2022-29162", "CVE-2023-25809", "CVE-2023-27561", "CVE-2023-28642");
  ...
  script_name("Ubuntu: Security Advisory (USN-6088-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6088-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6088-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc' package(s) announced via the USN-6088-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6088-1 fixed vulnerabilities in runC. This update provides
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"runc", ver:"1.0.0~rc7+git20190403.029124da-0ubuntu1~16.04.4+esm4", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
