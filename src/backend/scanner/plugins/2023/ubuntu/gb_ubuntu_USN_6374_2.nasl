...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6374.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6374-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6374-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6374-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mutt' package(s) announced via the USN-6374-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6374-1 fixed vulnerabilities in Mutt. This update provides the
...
Original advisory details:
 ...
 service. (CVE-2023-4874, CVE-2023-4875)");
  ...
  script_tag(name:"affected", value:"'mutt' package(s) on Ubuntu 23.10.");
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mutt", ver:"2.2.9-1ubuntu0.23.10.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
