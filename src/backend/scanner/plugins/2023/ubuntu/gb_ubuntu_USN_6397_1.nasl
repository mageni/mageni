...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6397.1");
  ...
  script_tag(name:"creation_date", value:"2023-09-27 04:08:14 +0000 (Wed, 27 Sep 2023)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6397-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6397-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6397-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-bluefield' package(s) announced via the USN-6397-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1070-bluefield", ver:"5.4.0-1070.76", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-bluefield", ver:"5.4.0.1070.65", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
