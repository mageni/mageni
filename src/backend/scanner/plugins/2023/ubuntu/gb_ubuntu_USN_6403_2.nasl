...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6403.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6403-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6403-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6403-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvpx' package(s) announced via the USN-6403-2 advisory.");
...
Original advisory details:
 ...
 execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'libvpx' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libvpx5", ver:"1.7.0-3ubuntu0.18.04.1+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
