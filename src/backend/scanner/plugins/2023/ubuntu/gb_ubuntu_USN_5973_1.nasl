...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5973.1");
  script_cve_id("CVE-2018-3774", "CVE-2020-8124", "CVE-2021-27515", "CVE-2021-3664", "CVE-2022-0512", "CVE-2022-0639", "CVE-2022-0686", "CVE-2022-0691");
  ...
  script_name("Ubuntu: Security Advisory (USN-5973-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5973-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5973-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'node-url-parse' package(s) announced via the USN-5973-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that url-parse incorrectly handled certain inputs. If a
...
Ubuntu 20.04 LTS. (CVE-2022-0686)");
  ...
  script_tag(name:"affected", value:"'node-url-parse' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"node-url-parse", ver:"1.0.5-2ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"node-url-parse", ver:"1.2.0-1ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"node-url-parse", ver:"1.4.7-3ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
