...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6561.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6561-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6561-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6561-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh' package(s) announced via the USN-6561-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.9.3-2ubuntu2.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.9.6-2ubuntu0.22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.10.4-2ubuntu0.2", rls:"UBUNTU23.04"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.10.5-3ubuntu1.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
