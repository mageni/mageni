...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6407.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6407-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6407-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6407-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libx11' package(s) announced via the USN-6407-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6407-1 fixed several vulnerabilities in libx11. This update provides
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx11-6", ver:"2:1.6.2-1ubuntu2.1+esm5", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx11-6", ver:"2:1.6.3-1ubuntu2.2+esm4", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx11-6", ver:"2:1.6.4-3ubuntu0.4+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
