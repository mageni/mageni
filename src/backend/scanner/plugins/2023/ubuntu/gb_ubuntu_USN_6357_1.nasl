...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6357.1");
  script_cve_id("CVE-2022-40982", "CVE-2023-2002", "CVE-2023-20593", "CVE-2023-21255", "CVE-2023-2163", "CVE-2023-2269", "CVE-2023-31084", "CVE-2023-3268", "CVE-2023-35823", "CVE-2023-35824", "CVE-2023-35828", "CVE-2023-3609", "CVE-2023-3611", "CVE-2023-3776");
  ...
  script_name("Ubuntu: Security Advisory (USN-6357-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6357-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6357-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm, linux-ibm-5.4' package(s) announced via the USN-6357-1 advisory.");
...
kernel contained a race condition during ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-ibm, linux-ibm-5.4' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1056-ibm", ver:"5.4.0-1056.61~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"5.4.0.1056.67", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1056-ibm", ver:"5.4.0-1056.61", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-lts-20.04", ver:"5.4.0.1056.85", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
