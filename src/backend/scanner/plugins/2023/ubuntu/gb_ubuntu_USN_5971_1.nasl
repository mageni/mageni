...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5971.1");
  script_cve_id("CVE-2018-10196", "CVE-2019-11023", "CVE-2020-18032");
  script_tag(name:"creation_date", value:"2023-03-27 04:11:00 +0000 (Mon, 27 Mar 2023)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5971-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5971-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5971-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphviz' package(s) announced via the USN-5971-1 advisory.");
...
(CVE-2020-18032)");
  ...
  script_tag(name:"affected", value:"'graphviz' package(s) on Ubuntu 14.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"graphviz", ver:"2.36.0-0ubuntu3.2+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"graphviz", ver:"2.40.1-2ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"graphviz", ver:"2.42.2-3ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
