...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5896.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5896-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5896-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5896-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-rack' package(s) announced via the USN-5896-1 advisory.");
...
the machine running the application. (CVE-2022-30123)");
  ...
  script_tag(name:"affected", value:"'ruby-rack' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.6.4-4ubuntu0.2+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.0.7-2ubuntu0.1+esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.1.4-5ubuntu1+esm2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
