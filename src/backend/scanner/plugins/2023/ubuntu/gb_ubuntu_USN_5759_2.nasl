...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5759.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5759-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5759-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5759-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libbpf' package(s) announced via the USN-5759-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5759-1 fixed vulnerabilities in LibBPF. This update provides the
...
Original advisory details:
 ...
 execute arbitrary code. (CVE-2022-3534, CVE-2022-3606)");
  ...
  script_tag(name:"affected", value:"'libbpf' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libbpf0", ver:"1:0.5.0-1~ubuntu20.04.1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
