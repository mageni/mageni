...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5839.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5839-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5839-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5839-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-5839-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Apache HTTP Server mod_dav module incorrectly
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.29-1ubuntu4.26", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.41-4ubuntu3.13", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.52-1ubuntu4.3", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.54-2ubuntu1.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
