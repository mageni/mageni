...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5888.1");
  script_cve_id("CVE-2015-20107", "CVE-2021-28861", "CVE-2022-37454", "CVE-2022-42919", "CVE-2022-45061", "CVE-2023-24329");
  ...
  script_name("Ubuntu: Security Advisory (USN-5888-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5888-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5888-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.9' package(s) announced via the USN-5888-1 advisory.");
...
denial of service. (CVE-2022-45061, CVE-2023-24329)");
  ...
  script_tag(name:"affected", value:"'python3.9' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3.9-minimal", ver:"3.9.5-3ubuntu0~20.04.1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.9", ver:"3.9.5-3ubuntu0~20.04.1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
