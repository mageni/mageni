...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5344.1");
  script_cve_id("CVE-2016-1249", "CVE-2016-1251", "CVE-2017-10788", "CVE-2017-10789");
  ...
  script_name("Ubuntu: Security Advisory (USN-5344-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5344-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5344-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libdbd-mysql-perl' package(s) announced via the USN-5344-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the DBD::mysql module, when configured with server-side
...
attack. (CVE-2017-10789)");
  ...
  script_tag(name:"affected", value:"'libdbd-mysql-perl' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdbd-mysql-perl", ver:"4.033-1ubuntu0.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
