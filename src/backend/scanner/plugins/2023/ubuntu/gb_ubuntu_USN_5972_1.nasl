...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5972.1");
  script_cve_id("CVE-2023-25152", "CVE-2023-25751", "CVE-2023-25752", "CVE-2023-28162", "CVE-2023-28164", "CVE-2023-28176");
  ...
  script_tag(name:"severity_date", value:"2023-02-24 06:20:00 +0000 (Fri, 24 Feb 2023)");

  script_name("Ubuntu: Security Advisory (USN-5972-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5972-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5972-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-5972-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:102.9.0+build1-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:102.9.0+build1-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:102.9.0+build1-0ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:102.9.0+build1-0ubuntu0.22.10.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
