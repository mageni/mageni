...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5282.1");
  script_cve_id("CVE-2019-14267", "CVE-2019-14934", "CVE-2020-20740", "CVE-2020-9549", "CVE-2021-3508");
  ...
  script_name("Ubuntu: Security Advisory (USN-5282-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5282-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5282-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pdfresurrect' package(s) announced via the USN-5282-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that PDFResurrect was incorrectly handling corrupted PDF
...
to cause an infinite loop, resulting in a denial of service. (CVE-2021-3508)");
  ...
  script_tag(name:"affected", value:"'pdfresurrect' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdfresurrect", ver:"0.12-6ubuntu0.2+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdfresurrect", ver:"0.14-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdfresurrect", ver:"0.19-1ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdfresurrect", ver:"0.22-2ubuntu0.1~esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
