...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6233.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6233-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6233-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6233-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'yajl' package(s) announced via the USN-6233-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that YAJL was not properly performing bounds checks when
...
service (memory exhaustion). (CVE-2023-33460)");
  ...
  script_tag(name:"affected", value:"'yajl' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyajl2", ver:"2.0.4-4ubuntu0.1~esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyajl2", ver:"2.1.0-2ubuntu0.16.04.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyajl2", ver:"2.1.0-2ubuntu0.18.04.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
