...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5223.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5223-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5223-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5223-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-log4j1.2' package(s) announced via the USN-5223-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5223-1 fixed a vulnerability in Apache Log4j 1.2. This update
...
Original advisory details:
 ...
 this vulnerability to cause a DoS or possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'apache-log4j1.2' package(s) on Ubuntu 16.04.");
