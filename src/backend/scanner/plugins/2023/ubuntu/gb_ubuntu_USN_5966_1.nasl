...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5966.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-5966-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5966-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5966-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'amanda' package(s) announced via the USN-5966-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Maher Azzouzi discovered an information disclosure vulnerability in the
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"amanda-client", ver:"1:3.3.3-2ubuntu1.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"amanda-client", ver:"1:3.3.6-4.1ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"amanda-client", ver:"1:3.5.1-1ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"amanda-client", ver:"1:3.5.1-2ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"amanda-client", ver:"1:3.5.1-8ubuntu1.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"amanda-client", ver:"1:3.5.1-9ubuntu0.1", rls:"UBUNTU22.10"))) {
    report += res;
  }
