...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5785.1");
  script_cve_id("CVE-2019-17185", "CVE-2022-41860", "CVE-2022-41861");
  script_tag(name:"creation_date", value:"2023-01-05 04:10:47 +0000 (Thu, 05 Jan 2023)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5785-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5785-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5785-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freeradius' package(s) announced via the USN-5785-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that FreeRADIUS incorrectly handled multiple EAP-pwd
...
issue to cause a denial of service on the server. (CVE-2022-41861)");
  ...
  script_tag(name:"affected", value:"'freeradius' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freeradius", ver:"2.2.8+dfsg-0.1ubuntu0.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freeradius", ver:"3.0.16+dfsg-1ubuntu3.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freeradius", ver:"3.0.20+dfsg-3ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freeradius", ver:"3.0.26~dfsg~git20220223.1.00ed0241fa-0ubuntu3.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
