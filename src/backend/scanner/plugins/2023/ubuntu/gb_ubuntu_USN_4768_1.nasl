...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4768.1");
  script_cve_id("CVE-2014-3484", "CVE-2015-1817", "CVE-2016-8859", "CVE-2017-15650", "CVE-2018-1000001");
  ...
  script_name("Ubuntu: Security Advisory (USN-4768-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4768-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4768-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'musl' package(s) announced via the USN-4768-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that musl did not properly handle kernel syscalls. An
...
service (crash). (CVE-2016-8859)");
  ...
  script_tag(name:"affected", value:"'musl' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"musl", ver:"0.9.15-1ubuntu0.1~esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"musl", ver:"1.1.9-1ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
