...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6173.1");
  script_cve_id("CVE-2023-1380", "CVE-2023-2002", "CVE-2023-2156", "CVE-2023-2269", "CVE-2023-31436", "CVE-2023-32250", "CVE-2023-32254");
  ...
  script_name("Ubuntu: Security Advisory (USN-6173-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6173-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6173-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.1' package(s) announced via the USN-6173-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Gwangun Jung discovered that the Quick Fair Queueing scheduler
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.1.0-1014-oem", ver:"6.1.0-1014.14", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04c", ver:"6.1.0.1014.14", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
