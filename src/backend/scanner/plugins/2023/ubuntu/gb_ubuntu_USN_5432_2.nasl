...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5432.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-5432-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5432-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5432-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpng1.6' package(s) announced via the USN-5432-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5432-1 fixed vulnerabilities in libpng.
...
Original advisory details:
 ...
 arbitrary code. (CVE-2018-14048)");
  ...
  script_tag(name:"affected", value:"'libpng1.6' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.20-2ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpng16-dev", ver:"1.6.20-2ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
