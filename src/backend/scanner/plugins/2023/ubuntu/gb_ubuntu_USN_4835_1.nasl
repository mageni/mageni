...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2021.4835.1");
  script_cve_id("CVE-2018-11099", "CVE-2018-11129", "CVE-2018-11130", "CVE-2019-1010127");
  ...
  script_tag(name:"severity_date", value:"2019-07-30 14:15:00 +0000 (Tue, 30 Jul 2019)");

  script_name("Ubuntu: Security Advisory (USN-4835-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4835-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4835-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vcftools' package(s) announced via the USN-4835-1 advisory.");
...
execute arbitrary code. (CVE-2019-1010127)");
  ...
  script_tag(name:"affected", value:"'vcftools' package(s) on Ubuntu 14.04, Ubuntu 18.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vcftools", ver:"0.1.11+dfsg-1ubuntu0.1~esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vcftools", ver:"0.1.15-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
