...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.6348.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6348-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6348-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6348-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg-5.15, linux-raspi' package(s) announced via the USN-6348-1 advisory.");
...
Kevin Rich discovered that the netfilter subsystem in the Linux ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-intel-iotg-5.15, linux-raspi' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1038-intel-iotg", ver:"5.15.0-1038.43~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1038.43~20.04.28", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1038.43~20.04.28", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1036-raspi", ver:"5.15.0-1036.39", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.15.0.1036.34", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-nolpae", ver:"5.15.0.1036.34", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
