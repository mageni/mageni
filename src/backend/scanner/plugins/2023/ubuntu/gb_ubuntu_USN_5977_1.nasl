...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2023.5977.1");
  script_cve_id("CVE-2022-2196", "CVE-2023-1032", "CVE-2023-1281");
  ...
  script_name("Ubuntu: Security Advisory (USN-5977-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5977-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5977-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.0' package(s) announced via the USN-5977-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.0.0-1013-oem", ver:"6.0.0-1013.13", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-22.04b", ver:"6.0.0.1013.13", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
