...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2022.5271.1");
  script_cve_id("CVE-2020-35572", "CVE-2021-21311", "CVE-2021-29625");
  ...
  script_name("Ubuntu: Security Advisory (USN-5271-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-5271-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5271-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'adminer' package(s) announced via the USN-5271-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Adminer did not escape data in the history parameter
...
Ubuntu 20.04 ESM. (CVE-2021-29625)");
  ...
  script_tag(name:"affected", value:"'adminer' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"adminer", ver:"4.2.1-1ubuntu1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"adminer", ver:"4.6.2-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"adminer", ver:"4.7.6-1ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
