...
tag_affected = "libtiff on CentOS 2";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-August/015219.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304438");
  ...
  script_name( "CentOS Update for libtiff CESA-2008:0863-01 centos2 i386");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.5.7~31.el2", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.5.7~31.el2", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
