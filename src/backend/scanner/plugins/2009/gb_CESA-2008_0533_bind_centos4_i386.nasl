...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015080.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311692");
  ...
  script_name( "CentOS Update for bind CESA-2008:0533 centos4 i386");
