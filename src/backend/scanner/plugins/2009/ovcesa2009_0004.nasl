#CESA-2009:0004 63179 12
# $Id: ovcesa2009_0004.nasl 6650 2017-07-10 11:43:12Z cfischer $
# Description: Auto-generated from advisory CESA-2009:0004 (openssl)
#
# Authors:
...
http://www.securityspace.com/smysecure/catid.html?in=CESA-2009:0004
...
advisory CESA-2009:0004.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305344");
 ...
 script_name("CentOS Security Advisory CESA-2009:0004 (openssl)");
...
if ((res = isrpmvuln(pkg:"openssl", rpm:"openssl~0.9.7a~43.17.c4.2", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"openssl-devel", rpm:"openssl-devel~0.9.7a~43.17.c4.2", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"openssl-perl", rpm:"openssl-perl~0.9.7a~43.17.c4.2", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"openssl096b", rpm:"openssl096b~0.9.6b~22.46.c4", rls:"CentOS4")) != NULL) {
    report += res;
}
