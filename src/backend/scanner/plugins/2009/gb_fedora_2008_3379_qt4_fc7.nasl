...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00589.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305704");
  ...
  script_name( "Fedora Update for qt4 FEDORA-2008-3379");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"qt4", rpm:"qt4~4.3.4~11.fc7", rls:"FC7")) != NULL)
  {
