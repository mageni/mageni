...
tag_affected = "libexif on Red Hat Enterprise Linux (v. 5 server)";
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.307685");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"libexif", rpm:"libexif~0.6.13~4.0.2.el5_1.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libexif-debuginfo", rpm:"libexif-debuginfo~0.6.13~4.0.2.el5_1.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libexif-devel", rpm:"libexif-devel~0.6.13~4.0.2.el5_1.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
