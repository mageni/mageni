...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00031.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308524");
  ...
  script_cve_id("CVE-2008-1567", "CVE-2007-0095");
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-2825");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.5.1~1.fc8", rls:"FC8")) != NULL)
  {
