...
# $Id: ovcesa2009_1642.nasl 6650 2017-07-10 11:43:12Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309545");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"acpid", rpm:"acpid~1.0.4~9.el5_4.1", rls:"CentOS5")) != NULL) {
    report += res;
}
