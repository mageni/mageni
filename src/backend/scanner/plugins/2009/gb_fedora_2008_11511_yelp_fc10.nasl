...
#
# Fedora Update for yelp FEDORA-2008-11511
#
# Authors:
...
tag_affected = "yelp on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01014.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309414");
  ...
  script_name( "Fedora Update for yelp FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"yelp", rpm:"yelp~2.24.0~4.fc10", rls:"FC10")) != NULL)
  {
