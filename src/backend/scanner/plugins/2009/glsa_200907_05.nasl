...
tag_insight = "An error in git-daemon might lead to a Denial of Service via resource
consumption.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200907-05
http://bugs.gentoo.org/show_bug.cgi?id=273905";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306763");
