...
# $Id: fcore_2009_0550.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307790");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"amarok", rpm:"amarok~2.0.1.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"amarok-debuginfo", rpm:"amarok-debuginfo~2.0.1.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
