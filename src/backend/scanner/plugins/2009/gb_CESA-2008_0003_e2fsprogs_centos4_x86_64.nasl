...
#
# CentOS Update for e2fsprogs CESA-2008:0003 centos4 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-January/014598.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306006");
  ...
  script_name( "CentOS Update for e2fsprogs CESA-2008:0003 centos4 x86_64");
