...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00358.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306159");
  ...
  script_name( "Fedora Update for dovecot FEDORA-2008-2464");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"dovecot", rpm:"dovecot~1.0.13~6.fc8", rls:"FC8")) != NULL)
  {
