...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00513.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308757");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:07:33 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2008-9773");
  script_cve_id("CVE-2008-4225", "CVE-2008-4226");
  script_name( "Fedora Update for libxml2 FEDORA-2008-9773");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.7.2~2.fc9", rls:"FC9")) != NULL)
  {
