#CESA-2009:1549 66220 6
# $Id: ovcesa2009_1549.nasl 6650 2017-07-10 11:43:12Z cfischer $
...
tag_summary = "The remote host is missing updates to wget announced in
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308137");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wget", rpm:"wget~1.10.2~0.30E.1", rls:"CentOS3")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"wget", rpm:"wget~1.10.2~1.el4_8.1", rls:"CentOS4")) != NULL) {
    report += res;
}
