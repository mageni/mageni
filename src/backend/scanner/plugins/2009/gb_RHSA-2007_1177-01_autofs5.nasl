...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2007-December/msg00020.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307360");
  ...
  script_name( "RedHat Update for autofs5 RHSA-2007:1177-01");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"autofs5", rpm:"autofs5~5.0.1~0.rc2.55.el4_6.2", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"autofs5-debuginfo", rpm:"autofs5-debuginfo~5.0.1~0.rc2.55.el4_6.2", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
