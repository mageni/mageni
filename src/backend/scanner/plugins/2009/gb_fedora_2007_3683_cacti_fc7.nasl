...
#
# Fedora Update for cacti FEDORA-2007-3683
#
# Authors:
...
tag_affected = "cacti on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-November/msg00794.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307996");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-27 16:23:18 +0100 (Fri, 27 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_xref(name: "FEDORA", value: "2007-3683");
  script_cve_id("CVE-2007-6035", "CVE-2007-3112");
  script_name( "Fedora Update for cacti FEDORA-2007-3683");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.7a~1.fc7", rls:"FC7")) != NULL)
  {
