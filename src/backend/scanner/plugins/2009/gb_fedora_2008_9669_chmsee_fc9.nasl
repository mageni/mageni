...
#
# Fedora Update for chmsee FEDORA-2008-9669
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00388.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305739");
  ...
  script_name( "Fedora Update for chmsee FEDORA-2008-9669");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.1~6.fc9", rls:"FC9")) != NULL)
  {
