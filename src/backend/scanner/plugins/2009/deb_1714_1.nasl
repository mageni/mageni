...
# $Id: deb_1714_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_summary = "The remote host is missing an update to rt2570
announced via advisory DSA 1714-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201714-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309670");
 ...
 script_name("Debian Security Advisory DSA 1714-1 (rt2570)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rt2570-source", ver:"1.1.0+cvs20060620-3+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
