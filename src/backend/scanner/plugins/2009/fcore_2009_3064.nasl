...
# $Id: fcore_2009_3064.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-3064 (netatalk)
#
# Authors:
...
announced via advisory FEDORA-2009-3064.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310176");
 ...
 script_name("Fedora Core 9 FEDORA-2009-3064 (netatalk)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"netatalk", rpm:"netatalk~2.0.3~21.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"netatalk-devel", rpm:"netatalk-devel~2.0.3~21.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"netatalk-debuginfo", rpm:"netatalk-debuginfo~2.0.3~21.fc9", rls:"FC9")) != NULL) {
    report += res;
}
