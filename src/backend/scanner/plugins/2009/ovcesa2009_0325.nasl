#CESA-2009:0325 63516 8
# $Id: ovcesa2009_0325.nasl 6650 2017-07-10 11:43:12Z cfischer $
# Description: Auto-generated from advisory CESA-2009:0325 (seamonkey)
#
# Authors:
...
http://www.securityspace.com/smysecure/catid.html?in=CESA-2009:0325
...
advisory CESA-2009:0325.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305875");
 ...
 script_name("CentOS Security Advisory CESA-2009:0325 (seamonkey)");
...
if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.0.9~38.el4.centos", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"seamonkey-chat", rpm:"seamonkey-chat~1.0.9~38.el4.centos", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"seamonkey-devel", rpm:"seamonkey-devel~1.0.9~38.el4.centos", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"seamonkey-dom-inspector", rpm:"seamonkey-dom-inspector~1.0.9~38.el4.centos", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"seamonkey-js-debugger", rpm:"seamonkey-js-debugger~1.0.9~38.el4.centos", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"seamonkey-mail", rpm:"seamonkey-mail~1.0.9~38.el4.centos", rls:"CentOS4")) != NULL) {
    report += res;
}
