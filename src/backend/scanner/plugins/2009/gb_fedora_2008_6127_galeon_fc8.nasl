...
#
# Fedora Update for galeon FEDORA-2008-6127
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00204.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306661");
  ...
  script_name( "Fedora Update for galeon FEDORA-2008-6127");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.4~3.fc8.3", rls:"FC8")) != NULL)
  {
