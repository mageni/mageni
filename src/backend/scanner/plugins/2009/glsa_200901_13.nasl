...
tag_insight = "Multiple vulnerabilities have been discovered in Pidgin, allowing for
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-13
http://bugs.gentoo.org/show_bug.cgi?id=230045
http://bugs.gentoo.org/show_bug.cgi?id=234135";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304993");
