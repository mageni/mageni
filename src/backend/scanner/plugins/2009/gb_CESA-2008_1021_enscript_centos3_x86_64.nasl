...
#
# CentOS Update for enscript CESA-2008:1021 centos3 x86_64
#
# Authors:
...
tag_affected = "enscript on CentOS 3";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-December/015483.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312191");
  ...
  script_name( "CentOS Update for enscript CESA-2008:1021 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"enscript", rpm:"enscript~1.6.1~24.7", rls:"CentOS3")) != NULL)
  {
