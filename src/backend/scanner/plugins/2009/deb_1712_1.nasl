...
# $Id: deb_1712_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "It was discovered that an integer overflow in the Probe Request packet
...
tag_summary = "The remote host is missing an update to rt2400
announced via advisory DSA 1712-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201712-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307647");
 ...
 script_name("Debian Security Advisory DSA 1712-1 (rt2400)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rt2400-source", ver:"1.2.2+cvs20060620-4+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rt2400", ver:"1.2.2+cvs20060620-4+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
