...
# $Id: fcore_2009_2970.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-2970 (lcms)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2970";
tag_summary = "The remote host is missing an update to lcms
announced via advisory FEDORA-2009-2970.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309127");
 ...
 script_name("Fedora Core 10 FEDORA-2009-2970 (lcms)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"<td>lcms", rpm:"<td>lcms~1.18~0.1.beta2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"lcms", rpm:"lcms~1.18~0.1.beta2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"lcms-devel", rpm:"lcms-devel~1.18~0.1.beta2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"lcms-libs", rpm:"lcms-libs~1.18~0.1.beta2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"python-lcms", rpm:"python-lcms~1.18~0.1.beta2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"lcms-debuginfo", rpm:"lcms-debuginfo~1.18~0.1.beta2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
