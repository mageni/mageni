...
# $Id: fcore_2009_3435.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-3435 (argyllcms)
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308866");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"argyllcms", rpm:"argyllcms~1.0.3~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"argyllcms-doc", rpm:"argyllcms-doc~1.0.3~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"argyllcms-debuginfo", rpm:"argyllcms-debuginfo~1.0.3~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
