...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015145.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309429");
  ...
  script_name( "CentOS Update for firefox CESA-2008:0598 centos3 i386");
