...
#
# CentOS Update for cups CESA-2008:0498 centos4 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/014965.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307888");
  ...
  script_name( "CentOS Update for cups CESA-2008:0498 centos4 x86_64");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"cups", rpm:"cups~1.1.22~0.rc1.9.20.2.el4_6.8", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-devel", rpm:"cups-devel~1.1.22~0.rc1.9.20.2.el4_6.8", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.1.22~0.rc1.9.20.2.el4_6.8", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
