...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01065.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304531");
  ...
  script_name( "Fedora Update for mugshot FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"mugshot", rpm:"mugshot~1.2.2~4.fc9", rls:"FC9")) != NULL)
  {
