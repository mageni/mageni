...
#
# CentOS Update for samba CESA-2007:1114-01 centos2 i386
#
# Authors:
...
tag_affected = "samba on CentOS 2";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2007-December/014501.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304422");
  ...
  script_name( "CentOS Update for samba CESA-2007:1114-01 centos2 i386");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~2.2.12~1.21as.8.2", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"samba-client", rpm:"samba-client~2.2.12~1.21as.8.2", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"samba-common", rpm:"samba-common~2.2.12~1.21as.8.2", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"samba-swat", rpm:"samba-swat~2.2.12~1.21as.8.2", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
