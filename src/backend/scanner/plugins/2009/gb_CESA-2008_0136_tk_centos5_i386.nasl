...
#
# CentOS Update for tk CESA-2008:0136 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-February/014701.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307760");
  ...
  script_name( "CentOS Update for tk CESA-2008:0136 centos5 i386");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"tk", rpm:"tk~8.4.13~5.el5_1.1", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tk-devel", rpm:"tk-devel~8.4.13~5.el5_1.1", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
