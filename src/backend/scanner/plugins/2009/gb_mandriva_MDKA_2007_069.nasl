...
tag_affected = "x11-driver-video-vesa on Mandriva Linux 2007.0,
  Mandriva Linux 2007.0/X86_64";
tag_insight = "X.org was crashing and/or corrupting the screen when the screen
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-06/msg00043.php");
  script_oid("1.3.6.1.4.1.25623.1.0.310681");
  ...
  script_tag(name:"summary", value:"Check for the Version of x11-driver-video-vesa");
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"x11-driver-video-vesa", rpm:"x11-driver-video-vesa~1.2.1~2.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
