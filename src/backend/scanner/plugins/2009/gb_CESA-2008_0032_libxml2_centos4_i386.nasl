...
#
# CentOS Update for libxml2 CESA-2008:0032 centos4 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-January/014602.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307196");
  ...
  script_name( "CentOS Update for libxml2 CESA-2008:0032 centos4 i386");
