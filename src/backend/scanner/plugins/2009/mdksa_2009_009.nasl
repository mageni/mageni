...
# $Id: mdksa_2009_009.nasl 6573 2017-07-06 13:10:50Z cfischer $
# Description: Auto-generated from advisory MDVSA-2009:009 (kvm)
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311538");
 ...
 script_name("Mandrake Security Advisory MDVSA-2009:009 (kvm)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"kvm", rpm:"kvm~74~3.1mdv2009.0", rls:"MNDK_2009.0")) != NULL) {
    report += res;
}
