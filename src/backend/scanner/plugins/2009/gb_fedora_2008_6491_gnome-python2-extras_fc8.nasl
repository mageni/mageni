...
#
# Fedora Update for gnome-python2-extras FEDORA-2008-6491
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00677.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304615");
  ...
  script_name( "Fedora Update for gnome-python2-extras FEDORA-2008-6491");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.19.1~16.fc8", rls:"FC8")) != NULL)
  {
