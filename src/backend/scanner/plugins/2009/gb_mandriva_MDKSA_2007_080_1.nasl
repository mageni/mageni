...
tag_affected = "tightvnc on Mandriva Linux 2007.1,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-04/msg00014.php");
  script_oid("1.3.6.1.4.1.25623.1.0.305579");
  ...
  script_name( "Mandriva Update for tightvnc MDKSA-2007:080-1 (tightvnc)");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"tightvnc", rpm:"tightvnc~1.2.9~16.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tightvnc-doc", rpm:"tightvnc-doc~1.2.9~16.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tightvnc-server", rpm:"tightvnc-server~1.2.9~16.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
