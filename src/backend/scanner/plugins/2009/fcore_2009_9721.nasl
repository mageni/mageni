...
# $Id: fcore_2009_9721.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-9721 (drupal)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-9721";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307313");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.14~1.fc11", rls:"FC11")) != NULL) {
    report += res;
}
