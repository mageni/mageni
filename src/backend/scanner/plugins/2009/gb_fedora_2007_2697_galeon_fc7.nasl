...
#
# Fedora Update for galeon FEDORA-2007-2697
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-October/msg00418.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307045");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.3~12.fc7", rls:"FC7")) != NULL)
  {
  ...
  if ((res = isrpmvuln(pkg:"galeon-debuginfo", rpm:"galeon-debuginfo~2.0.3~12.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
