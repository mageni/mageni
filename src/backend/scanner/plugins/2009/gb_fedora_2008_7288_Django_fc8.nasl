...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00091.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306523");
 ...
 script_version("$Revision: 6623 $");
  ...
  script_xref(name: "FEDORA", value: "2008-7288");
  script_name( "Fedora Update for Django FEDORA-2008-7288");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"Django", rpm:"Django~0.96.3~1.fc8", rls:"FC8")) != NULL)
  {
