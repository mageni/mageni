...
tag_insight = "A buffer overflow vulnerability in libsndfile might allow remote attackers
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310169");
 ...
 script_name("Gentoo Security Advisory GLSA 200904-16 (libsndfile)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-libs/libsndfile", unaffected: make_list("ge 1.0.19"), vulnerable: make_list("lt 1.0.19"))) != NULL) {
    report += res;
}
