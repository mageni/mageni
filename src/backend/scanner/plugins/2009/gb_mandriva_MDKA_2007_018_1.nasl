...
#
# Mandriva Update for timezone MDKA-2007:018-1 (timezone)
#
# Authors:
...
tag_affected = "timezone on Mandriva Linux 2006.0,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-03/msg00012.php");
  script_oid("1.3.6.1.4.1.25623.1.0.308905");
  ...
  script_xref(name: "MDKA", value: "2007:018-1");
  script_name( "Mandriva Update for timezone MDKA-2007:018-1 (timezone)");
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"timezone-2007c", rpm:"timezone-2007c~1.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
...
if(release == "MNDK_2006.0")
{
  ...
  if ((res = isrpmvuln(pkg:"timezone-2007c", rpm:"timezone-2007c~0.1.20060mdk", rls:"MNDK_2006.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
