...
#
# Fedora Update for phpMyAdmin FEDORA-2008-2229
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00100.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311314");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-2229");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.5~1.fc7", rls:"FC7")) != NULL)
  {
