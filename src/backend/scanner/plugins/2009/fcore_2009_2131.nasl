...
# $Id: fcore_2009_2131.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305919");
 ...
 script_name("Fedora Core 10 FEDORA-2009-2131 (mingw32-libpng)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mingw32-libpng", rpm:"mingw32-libpng~1.2.35~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
