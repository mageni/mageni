...
# $Id: deb_1949_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "It was discovered that php-net-ping, a PHP PEAR module to execute ping
...
tag_summary = "The remote host is missing an update to php-net-ping
announced via advisory DSA 1949-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201949-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306221");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"php-net-ping", ver:"2.4.2-1+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"php-net-ping", ver:"2.4.2-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
