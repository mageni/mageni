...
tag_insight = "The following package is affected: fuser";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311029");
...
if(!isnull(bver) && revcomp(a:bver, b:"1142334561_2")<0) {
    txt += 'Package fuser version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
