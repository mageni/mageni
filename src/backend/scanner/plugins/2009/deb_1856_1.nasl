...
# $Id: deb_1856_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "It was discovered that the Debian Mantis package, a web based bug
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201856-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305254");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mantis", ver:"1.1.6+dfsg-2lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
