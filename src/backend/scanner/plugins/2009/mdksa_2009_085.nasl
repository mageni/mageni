...
# $Id: mdksa_2009_085.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
tag_insight = "Integer overflows in gstreamer0.10-plugins-base Base64 encoding and
...
tag_summary = "The remote host is missing an update to gstreamer0.10-plugins-base
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310078");
