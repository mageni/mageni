...
tag_affected = "blender on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg00225.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308709");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"blender", rpm:"blender~2.45~14.fc7", rls:"FC7")) != NULL)
  {
