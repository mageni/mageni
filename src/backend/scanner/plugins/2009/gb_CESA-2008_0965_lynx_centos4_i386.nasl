...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-October/015359.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306190");
  ...
  script_name( "CentOS Update for lynx CESA-2008:0965 centos4 i386");
