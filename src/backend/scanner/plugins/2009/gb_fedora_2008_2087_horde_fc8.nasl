...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00925.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312183");
  ...
  script_name( "Fedora Update for horde FEDORA-2008-2087");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"horde", rpm:"horde~3.1.6~1.fc8", rls:"FC8")) != NULL)
  {
