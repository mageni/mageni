...
# $Id: RHSA_2009_1619.nasl 6683 2017-07-12 09:41:57Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307524");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-1619.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"dstat", rpm:"dstat~0.6.6~3.el5_4.1", rls:"RHENT_5")) != NULL) {
    report += res;
}
