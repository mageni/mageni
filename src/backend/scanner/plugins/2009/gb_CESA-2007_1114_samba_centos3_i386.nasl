...
#
# CentOS Update for samba CESA-2007:1114 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2007-December/014494.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307206");
  ...
  script_name( "CentOS Update for samba CESA-2007:1114 centos3 i386");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~3.0.9~1.3E.14.3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"samba-client", rpm:"samba-client~3.0.9~1.3E.14.3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"samba-common", rpm:"samba-common~3.0.9~1.3E.14.3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"samba-swat", rpm:"samba-swat~3.0.9~1.3E.14.3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
