...
tag_insight = "Multiple vulnerabilities in Adobe Reader and Adobe Flash Player allow for
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200908-04
http://bugs.gentoo.org/show_bug.cgi?id=278813
http://bugs.gentoo.org/show_bug.cgi?id=278819";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309695");
