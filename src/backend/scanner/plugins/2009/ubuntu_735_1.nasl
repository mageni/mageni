...
tag_insight = "It was discovered that the Base64 decoding functions in GStreamer Base
...
tag_summary = "The remote host is missing an update to gst-plugins-base0.10
announced via advisory USN-735-1.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306647");
 ...
 script_name("Ubuntu USN-735-1 (gst-plugins-base0.10)");
