...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00794.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309503");
  ...
  script_cve_id("CVE-2008-4129", "CVE-2008-3662", "CVE-2008-4130");
  script_name( "Fedora Update for gallery2 FEDORA-2008-11230");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gallery2", rpm:"gallery2~2.3~1.fc8", rls:"FC8")) != NULL)
  {
