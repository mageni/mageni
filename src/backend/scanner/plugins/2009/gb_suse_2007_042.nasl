...
# $Id: gb_suse_2007_042.nasl 8050 2017-12-08 09:34:29Z santu $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.310965");
  ...
  script_tag(name:"summary", value:"Check for the Version of evolution,evolution-data-server");
