...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-April/014841.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310785");
  ...
  script_name( "CentOS Update for ImageMagick CESA-2008:0145 centos4 i386");
