...
#
# Fedora Update for seamonkey FEDORA-2008-3231
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00407.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311449");
  ...
  script_name( "Fedora Update for seamonkey FEDORA-2008-3231");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.1.9~2.fc7", rls:"FC7")) != NULL)
  {
