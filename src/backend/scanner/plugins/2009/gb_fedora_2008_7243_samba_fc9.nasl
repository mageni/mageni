...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00271.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305798");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~3.2.3~0.20.fc9", rls:"FC9")) != NULL)
  {
