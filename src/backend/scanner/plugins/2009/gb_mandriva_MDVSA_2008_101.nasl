...
tag_insight = "Several vulnerabilities were discovered in rdesktop, a Remote Desktop
  Protocol client.
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-05/msg00019.php");
  script_oid("1.3.6.1.4.1.25623.1.0.312078");
  ...
  script_name( "Mandriva Update for rdesktop MDVSA-2008:101 (rdesktop)");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"rdesktop", rpm:"rdesktop~1.5.0~1.2mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"rdesktop", rpm:"rdesktop~1.5.0~3.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"rdesktop", rpm:"rdesktop~1.5.0~4.1mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
