...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00486.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305015");
  ...
  script_name( "Fedora Update for gtkmozembedmm FEDORA-2008-3283");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gtkmozembedmm", rpm:"gtkmozembedmm~1.4.2.cvs20060817~20.fc8", rls:"FC8")) != NULL)
  {
