...
# $Id: fcore_2009_8491.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-8491 (libxml2)
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310800");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.7.3~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libxml2-devel", rpm:"libxml2-devel~2.7.3~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libxml2-python", rpm:"libxml2-python~2.7.3~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libxml2-static", rpm:"libxml2-static~2.7.3~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libxml2-debuginfo", rpm:"libxml2-debuginfo~2.7.3~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
