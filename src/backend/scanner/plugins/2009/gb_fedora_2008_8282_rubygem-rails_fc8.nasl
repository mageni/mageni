...
tag_affected = "rubygem-rails on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00406.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304829");
  ...
  script_name( "Fedora Update for rubygem-rails FEDORA-2008-8282");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-rails", rpm:"rubygem-rails~2.1.1~2.fc8", rls:"FC8")) != NULL)
  {
