...
#
# Fedora Update for seamonkey FEDORA-2008-6196
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00295.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308784");
  ...
  script_name( "Fedora Update for seamonkey FEDORA-2008-6196");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.1.10~1.fc8", rls:"FC8")) != NULL)
  {
