...
tag_affected = "sword on Fedora 7";
tag_insight = "The SWORD Project is the CrossWire Bible Society's free Bible software
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00769.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311025");
  ...
  script_tag(name:"summary", value:"Check for the Version of sword");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"sword", rpm:"sword~1.5.10~2.fc7", rls:"FC7")) != NULL)
  {
