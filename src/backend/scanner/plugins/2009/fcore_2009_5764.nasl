...
# $Id: fcore_2009_5764.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-5764 (ocsinventory)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-5764";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308591");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ocsinventory", rpm:"ocsinventory~1.02.1~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ocsinventory-reports", rpm:"ocsinventory-reports~1.02.1~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ocsinventory-server", rpm:"ocsinventory-server~1.02.1~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
