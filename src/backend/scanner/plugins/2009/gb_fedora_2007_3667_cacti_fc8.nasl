...
#
# Fedora Update for cacti FEDORA-2007-3667
#
# Authors:
...
tag_affected = "cacti on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-November/msg00778.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310002");
  ...
  script_name( "Fedora Update for cacti FEDORA-2007-3667");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.7a~1.fc8", rls:"FC8")) != NULL)
  {
