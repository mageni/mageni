...
# $Id: fcore_2009_13216.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309384");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"coreutils", rpm:"coreutils~7.2~5.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"coreutils-debuginfo", rpm:"coreutils-debuginfo~7.2~5.fc11", rls:"FC11")) != NULL) {
    report += res;
}
