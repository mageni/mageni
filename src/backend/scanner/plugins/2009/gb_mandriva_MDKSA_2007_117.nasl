...
tag_insight = "lharc.c in lha does not securely create temporary files, which might
  allow local users to read or write files by creating a file before
  LHA is invoked.

  Updated packages have been patched to prevent this issue.";

tag_affected = "lha on Mandriva Linux 2007.0,
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"lha", rpm:"lha~1.14i~12.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"lha", rpm:"lha~1.14i~12.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
