...
if(description)
{
  ...
  script_name("TestLink < 1.8.5 Multiple Vulnerabilities");
  ...
  script_tag(name:"summary", value:"TestLink is prone to multiple SQL injection (SQLi) and
  cross-site scripting (XSS) vulnerabilities because it fails to sufficiently sanitize
  user-supplied data.");
  ...
  script_tag(name:"affected", value:"TestLink prior to version 1.8.5.");
