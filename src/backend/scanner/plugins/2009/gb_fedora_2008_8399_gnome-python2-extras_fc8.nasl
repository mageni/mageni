...
#
# Fedora Update for gnome-python2-extras FEDORA-2008-8399
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01371.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307945");
  ...
  script_name( "Fedora Update for gnome-python2-extras FEDORA-2008-8399");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.19.1~17.fc8", rls:"FC8")) != NULL)
  {
