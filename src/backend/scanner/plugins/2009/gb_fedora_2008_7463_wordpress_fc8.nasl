...
#
# Fedora Update for wordpress FEDORA-2008-7463
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00502.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310409");
  ...
  script_name( "Fedora Update for wordpress FEDORA-2008-7463");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.6.1~1.fc8", rls:"FC8")) != NULL)
  {
