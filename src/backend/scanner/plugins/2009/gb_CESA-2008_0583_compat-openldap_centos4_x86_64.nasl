...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015109.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310810");
  ...
  script_name( "CentOS Update for compat-openldap CESA-2008:0583 centos4 x86_64");
