...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-February/014705.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306683");
  ...
  script_name( "CentOS Update for cups CESA-2008:0157 centos5 x86_64");
