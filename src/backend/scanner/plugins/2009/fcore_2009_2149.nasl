...
# $Id: fcore_2009_2149.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306020");
 ...
 script_name("Fedora Core 10 FEDORA-2009-2149 (rubygem-actionpack)");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=472510");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~2.1.1~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
