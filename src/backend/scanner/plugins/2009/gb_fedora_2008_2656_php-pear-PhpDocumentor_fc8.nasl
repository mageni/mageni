...
tag_insight = "phpDocumentor is the current standard auto-documentation tool for the
...
tag_affected = "php-pear-PhpDocumentor on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00551.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311726");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-16 16:22:52 +0100 (Mon, 16 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-2656");
  script_cve_id("CVE-2008-1066");
  script_name( "Fedora Update for php-pear-PhpDocumentor FEDORA-2008-2656");

  script_tag(name:"summary", value:"Check for the Version of php-pear-PhpDocumentor");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"php-pear-PhpDocumentor", rpm:"php-pear-PhpDocumentor~1.4.1~2.fc8", rls:"FC8")) != NULL)
  {
