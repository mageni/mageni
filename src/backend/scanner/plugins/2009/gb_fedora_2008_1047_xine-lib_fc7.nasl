...
#
# Fedora Update for xine-lib FEDORA-2008-1047
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-January/msg00976.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309865");
  ...
  script_xref(name: "FEDORA", value: "2008-1047");
  script_name( "Fedora Update for xine-lib FEDORA-2008-1047");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"xine-lib", rpm:"xine-lib~1.1.10~1.fc7", rls:"FC7")) != NULL)
  {
