...
#
# Mandriva Update for draksnapshot MDVA-2008:120 (draksnapshot)
#
# Authors:
...
tag_insight = "This update fixes several minor issues with draksnapshot, such as
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-09/msg00010.php");
  script_oid("1.3.6.1.4.1.25623.1.0.311596");
  script_version("$Revision: 6568 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-06 15:04:21 +0200 (Thu, 06 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-04-09 14:09:08 +0200 (Thu, 09 Apr 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "MDVA", value: "2008:120");
  script_name( "Mandriva Update for draksnapshot MDVA-2008:120 (draksnapshot)");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"draksnapshot", rpm:"draksnapshot~0.11~1.1mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
