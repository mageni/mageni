...
tag_insight = "The following package is affected: rt
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304909");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.8.6")<0) {
    txt += 'Package rt version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
