...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.305085");
  ...
  script_name( "Solaris Update for CDE 1.5 114219-11");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-114219-11-1");
...
if(solaris_check_patch(release:"5.9", arch:"sparc", patch:"114219-11", package:"SUNWolrte SUNWdtim") < 0)
{
  security_message(0);
  exit(0);
}
