...
# $Id: fcore_2009_1147.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to glpi
...
if(description)
{
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=481558");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"glpi", rpm:"glpi~0.71.5~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
