...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-January/msg00676.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308887");
  script_version("$Revision: 6623 $");
  script_cve_id("CVE-2008-0404");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:12:43 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2008-0796");
  script_name( "Fedora Update for mantis FEDORA-2008-0796");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"mantis", rpm:"mantis~1.1.1~1.fc7", rls:"FC7")) != NULL)
  {
  ...
  if ((res = isrpmvuln(pkg:"mantis-config-httpd", rpm:"mantis-config-httpd~1.1.1~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
