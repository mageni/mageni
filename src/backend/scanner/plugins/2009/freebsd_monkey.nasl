...
tag_insight = "The following package is affected: monkey";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309282");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.9.3")<0) {
    txt += 'Package monkey version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
