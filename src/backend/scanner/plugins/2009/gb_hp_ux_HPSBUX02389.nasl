...
#
# HP-UX Update for HP-UX Pkg HPSBUX02389
#
# Authors:
...
tag_affected = "HP-UX Pkg on
  HP-UX B.11.31";
tag_insight = "A potential security vulnerability has been identified in HP-UX. The 
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.305575");
  script_version("$Revision: 6584 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-06 16:13:23 +0200 (Thu, 06 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-05-05 12:14:23 +0200 (Tue, 05 May 2009)");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:S/C:N/I:N/A:C");
  script_xref(name: "HPSBUX", value: "02389");
...
if(release == "HPUX11.31")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"ProgSupport.C-INC", patch_list:['PHKL_38987'], rls:"HPUX11.31")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = ishpuxpkgvuln(pkg:"OS-Core.CORE2-KRN", patch_list:['PHKL_38987'], rls:"HPUX11.31")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
