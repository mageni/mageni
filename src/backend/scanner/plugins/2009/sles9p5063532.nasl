...
# $Id: sles9p5063532.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306613");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mutt", rpm:"mutt~1.5.6i~64.14", rls:"SLES9.0")) != NULL) {
    report += res;
}
