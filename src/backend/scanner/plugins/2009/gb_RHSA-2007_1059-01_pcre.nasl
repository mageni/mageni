...
tag_affected = "pcre on Red Hat Enterprise Linux (v. 5 server)";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2007-November/msg00002.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305963");
  ...
  script_name( "RedHat Update for pcre RHSA-2007:1059-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"pcre", rpm:"pcre~6.6~2.el5_1.7", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcre-debuginfo", rpm:"pcre-debuginfo~6.6~2.el5_1.7", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcre-devel", rpm:"pcre-devel~6.6~2.el5_1.7", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
