...
# $Id: fcore_2009_8477.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311891");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"puppet", rpm:"puppet~0.24.8~4.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"puppet-server", rpm:"puppet-server~0.24.8~4.fc11", rls:"FC11")) != NULL) {
    report += res;
}
