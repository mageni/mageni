...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311101");
 ...
 script_name("Fedora Core 10 FEDORA-2009-1526 (squid)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.0.STABLE13~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"squid-debuginfo", rpm:"squid-debuginfo~3.0.STABLE13~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
