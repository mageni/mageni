...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c01328657-2");
  script_oid("1.3.6.1.4.1.25623.1.0.307426");
  ...
  script_name( "HP-UX Update for ARPA Transport HPSBUX02306");
...
if(release == "HPUX11.31")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"Networking.NET2-KRN", patch_list:['PHNE_36281'], rls:"HPUX11.31")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = ishpuxpkgvuln(pkg:"OS-Core.CORE2-KRN", patch_list:['PHNE_36281'], rls:"HPUX11.31")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
