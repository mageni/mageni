...
tag_insight = "The package for the drawing application Skencil contained a bug
...
tag_affected = "skencil on Mandriva Linux 2007.0,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-01/msg00032.php");
  script_oid("1.3.6.1.4.1.25623.1.0.309962");
  ...
  script_tag(name:"summary", value:"Check for the Version of skencil");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"skencil", rpm:"skencil~0.6.18~0.695.4.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"skencil", rpm:"skencil~0.6.18~0.695.4.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
