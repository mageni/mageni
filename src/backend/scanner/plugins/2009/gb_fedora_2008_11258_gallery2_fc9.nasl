...
tag_affected = "gallery2 on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00832.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304954");
  ...
  script_cve_id("CVE-2008-4130", "CVE-2008-3662", "CVE-2008-4129");
  script_name( "Fedora Update for gallery2 FEDORA-2008-11258");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"gallery2", rpm:"gallery2~2.3~1.fc9", rls:"FC9")) != NULL)
  {
