...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg01261.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304741");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"trac", rpm:"trac~0.10.5~1.fc8", rls:"FC8")) != NULL)
  {
