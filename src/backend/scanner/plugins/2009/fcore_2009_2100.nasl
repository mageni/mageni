...
# $Id: fcore_2009_2100.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to optipng
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307553");
 ...
 script_name("Fedora Core 10 FEDORA-2009-2100 (optipng)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"optipng", rpm:"optipng~0.6.2.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"optipng-debuginfo", rpm:"optipng-debuginfo~0.6.2.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
