...
#
# CentOS Update for pcre CESA-2007:1063 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2007-November/014468.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307329");
  ...
  script_name( "CentOS Update for pcre CESA-2007:1063 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"pcre", rpm:"pcre~3.9~10.4", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcre-devel", rpm:"pcre-devel~3.9~10.4", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
