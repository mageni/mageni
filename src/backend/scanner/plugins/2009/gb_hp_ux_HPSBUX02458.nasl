...
#
# HP-UX Update for bootpd HPSBUX02458
#
# Authors:
...
tag_affected = "bootpd on
  HP-UX B.11.11, B.11.23 and HP-UX B.11.31 running";
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.312167");
...
if(release == "HPUX11.31")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"DHCPv4.DHCPV4-RUN", patch_list:['PHNE_39443'], rls:"HPUX11.31")) != NULL)
  {
...
if(release == "HPUX11.23")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"InternetSrvcs.INETSVCS2-BOOT", patch_list:['PHNE_39668'], rls:"HPUX11.23")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"InternetSrvcs.INETSVCS2-BOOT", patch_list:['PHNE_39700'], rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
