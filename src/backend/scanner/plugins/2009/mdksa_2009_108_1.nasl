...
# $Id: mdksa_2009_108_1.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306210");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"zsh", rpm:"zsh~4.3.4~4.1mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"zsh-doc", rpm:"zsh-doc~4.3.4~4.1mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
