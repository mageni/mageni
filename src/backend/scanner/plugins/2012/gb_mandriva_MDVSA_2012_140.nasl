...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831723");
  ...
  script_tag(name:"affected", value:"mono on Mandriva Linux 2011.0");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"insight", value:"A vulnerability has been discovered and corrected in mono:
