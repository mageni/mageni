...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831681");
  ...
  script_tag(name:"affected", value:"expat on Mandriva Linux 2011.0,
  Mandriva Enterprise Server 5.2,
  Mandriva Linux 2010.1");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"insight", value:"A memory leak and a hash table collision flaw in expat could cause
