...
#
# Fedora Update for openjpeg FEDORA-2012-14707
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864813");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"openjpeg", rpm:"openjpeg~1.4~14.fc16", rls:"FC16")) != NULL)
  {
