...
# $Id: esoft_slk_ssa_2005_251_04.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-251-04 php5 in Slackware 10.1");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-251-04");
...
if((res = isslkpkgvuln(pkg:"php", ver:"5.0.5-i486-1", rls:"SLK10.1")) != NULL) {
  report += res;
}
