...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831546");
  ...
  script_tag(name:"affected", value:"apr on Mandriva Linux 2011.0,
  Mandriva Enterprise Server 5.2,
  Mandriva Linux 2010.1");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"insight", value:"A vulnerability has been found and corrected in ASF APR:
  ...
  many improvements over the previous versions and is not vulnerable to
  this issue.");
