...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065213.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863918");
  ...
  script_name("Fedora Update for rubygem-activerecord FEDORA-2011-11386");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-activerecord", rpm:"rubygem-activerecord~3.0.10~1.fc16", rls:"FC16")) != NULL)
  {
