...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-June/082811.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864497");
  ...
  script_name("Fedora Update for openstack-nova FEDORA-2012-9550");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"openstack-nova", rpm:"openstack-nova~2012.1~10.fc17", rls:"FC17")) != NULL)
  {
