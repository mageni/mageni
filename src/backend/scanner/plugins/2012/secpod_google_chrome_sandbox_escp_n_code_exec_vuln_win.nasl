...
# $Id: secpod_google_chrome_sandbox_escp_n_code_exec_vuln_win.nasl 11549 2018-09-22 12:11:10Z cfischer $
#
...
if(description)
{
  ...
  script_name("Google Chrome Full Sandbox Escape and Code Execution Vulnerability (Windows)");
