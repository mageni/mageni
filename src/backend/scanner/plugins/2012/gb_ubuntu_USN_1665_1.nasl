...
# $Id: gb_ubuntu_USN_1665_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1665-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841252");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-12-14 09:51:58 +0530 (Fri, 14 Dec 2012)");
  script_cve_id("CVE-2012-0958");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_name("Ubuntu Update for unity-firefox-extension USN-1665-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1665-1");
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"xul-ext-unity", ver:"2.4.1-0ubuntu1.2", rls:"UBUNTU12.10")) != NULL)
  {
