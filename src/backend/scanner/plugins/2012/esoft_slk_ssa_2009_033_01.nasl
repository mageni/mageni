...
# $Id: esoft_slk_ssa_2009_033_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2009-033-01 xdg-utils");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2009-033-01");
...
if((res = isslkpkgvuln(pkg:"xdg-utils", ver:"1.0.2-noarch-3_slack12.2", rls:"SLK12.2")) != NULL) {
  report += res;
}
