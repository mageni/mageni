...
# $Id: gb_ubuntu_USN_1330_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.0.0-1206-omap4", ver:"3.0.0-1206.15", rls:"UBUNTU11.10")) != NULL)
  {
