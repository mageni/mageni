...
#
# Fedora Update for php-pear-CAS FEDORA-2012-4119
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for php-pear-CAS FEDORA-2012-4119");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"php-pear-CAS", rpm:"php-pear-CAS~1.3.0~2.fc16", rls:"FC16")) != NULL)
  {
