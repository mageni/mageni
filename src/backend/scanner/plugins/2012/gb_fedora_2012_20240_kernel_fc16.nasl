...
#
# Fedora Update for kernel FEDORA-2012-20240
#
# Authors:
...
if(description)
{
  ...
  script_cve_id("CVE-2012-4530", "CVE-2012-4461", "CVE-2012-4565", "CVE-2012-4508",
                ...
                "CVE-2012-2372", "CVE-2011-4131", "CVE-2012-2123", "CVE-2012-2119",
                "CVE-2012-1601", "CVE-2012-1568", "CVE-2012-1179", "CVE-2012-1146",
                "CVE-2012-1097", "CVE-2012-1090", "CVE-2011-4086", "CVE-2012-0056",
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.6.10~2.fc16", rls:"FC16")) != NULL)
  {
