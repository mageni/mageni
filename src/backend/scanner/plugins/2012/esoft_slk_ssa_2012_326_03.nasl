...
# $Id: esoft_slk_ssa_2012_326_03.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.72592");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2012-326-03");
...
if((res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"17.0-i486-1_slack13.37", rls:"SLK13.37")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"17.0-i486-1_slack14.0", rls:"SLK14.0")) != NULL) {
  report += res;
}
