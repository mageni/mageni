...
# $Id: esoft_slk_ssa_2007_200_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59011");
  script_tag(name:"creation_date", value:"2012-09-11 01:34:21 +0200 (Tue, 11 Sep 2012)");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 10:16:15 +0100 (Fri, 15 Mar 2019) $");
  script_version("$Revision: 14202 $");
  script_tag(name:"cvss_base", value:"4.4");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:P/I:P/A:P");
  script_name("Slackware Advisory SSA:2007-200-01 firefox");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-200-01");
...
if((res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.5-i686-1", rls:"SLK11.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.5-i686-1", rls:"SLK12.0")) != NULL) {
  report += res;
}
