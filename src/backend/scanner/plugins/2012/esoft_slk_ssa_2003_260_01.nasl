...
# $Id: esoft_slk_ssa_2003_260_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2003-260-01 OpenSSH updated again");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2003-260-01");
...
if((res = isslkpkgvuln(pkg:"openssh", ver:"3.7.1p1-i386-1", rls:"SLK8.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"openssh", ver:"3.7.1p1-i386-1", rls:"SLK9.0")) != NULL) {
  report += res;
}
