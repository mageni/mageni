...
# $Id: esoft_slk_ssa_2005_201_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-201-01 dnsmasq");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-201-01");
...
if((res = isslkpkgvuln(pkg:"dnsmasq", ver:"2.22-i486-1", rls:"SLK10.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"dnsmasq", ver:"2.22-i486-1", rls:"SLK10.1")) != NULL) {
  report += res;
}
