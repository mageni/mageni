...
# $Id: gb_ubuntu_USN_1326_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1326-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.840932");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-03-16 10:50:08 +0530 (Fri, 16 Mar 2012)");
  script_cve_id("CVE-2012-0030");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:P");
  script_name("Ubuntu Update for nova USN-1326-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1326-1");
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"nova-api", ver:"2011.3-0ubuntu6.4", rls:"UBUNTU11.10")) != NULL)
  {
