...
# $Id: gb_suse_2012_0610_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850225");
  ...
  script_tag(name:"insight", value:"The Opera web browser was updated to 11.62 fixing various
