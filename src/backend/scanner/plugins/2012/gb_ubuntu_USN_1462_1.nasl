...
# $Id: gb_ubuntu_USN_1462_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1462-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841026");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-06-08 10:13:50 +0530 (Fri, 08 Jun 2012)");
  script_cve_id("CVE-2012-1667", "CVE-2012-1033");
  script_tag(name:"cvss_base", value:"8.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:C");
  script_name("Ubuntu Update for bind9 USN-1462-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1462-1");
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libdns64", ver:"9.7.0.dfsg.P1-1ubuntu0.5", rls:"UBUNTU10.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libdns81", ver:"9.8.1.dfsg.P1-4ubuntu0.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libdns69", ver:"9.7.3.dfsg-1ubuntu4.2", rls:"UBUNTU11.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU11.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"libdns69", ver:"9.7.3.dfsg-1ubuntu2.4", rls:"UBUNTU11.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU8.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libdns36", ver:"9.4.2.dfsg.P2-2ubuntu0.10", rls:"UBUNTU8.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
