...
if(description)
{
  ...
  script_cve_id("CVE-2014-8127","CVE-2016-3622","CVE-2016-3658");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:3301-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002537.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tiff'
  package(s) announced via the SUSE-SU-2016:3301-1 advisory.");
