...
if(description)
{
  ...
  script_cve_id("CVE-2015-1819","CVE-2015-5312","CVE-2015-7497");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0049-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-January/001788.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libxml2'
  package(s) announced via the SUSE-SU-2016:0049-1 advisory.");
