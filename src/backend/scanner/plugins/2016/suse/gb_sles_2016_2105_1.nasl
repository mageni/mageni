...
if(description)
{
  ...
  script_cve_id("CVE-2014-9904","CVE-2015-7833","CVE-2015-8551");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2105-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-August/002218.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2016:2105-1 advisory.");
