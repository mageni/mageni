...
if(description)
{
  ...
  script_cve_id("CVE-2015-8853","CVE-2016-1238","CVE-2016-2381");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2263-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-September/002262.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'perl'
  package(s) announced via the SUSE-SU-2016:2263-1 advisory.");
