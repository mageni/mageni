...
if(description)
{
  ...
  script_cve_id("CVE-2016-7445","CVE-2016-8332","CVE-2016-9112");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:3270-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002525.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openjpeg2'
  package(s) announced via the SUSE-SU-2016:3270-1 advisory.");
