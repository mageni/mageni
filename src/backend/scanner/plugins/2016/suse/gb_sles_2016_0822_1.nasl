...
if(description)
{
  ...
  script_cve_id("CVE-2015-5174","CVE-2015-5345","CVE-2015-5346");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0822-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-March/001957.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tomcat'
  package(s) announced via the SUSE-SU-2016:0822-1 advisory.");
