...
if (description)
{
  ...
  script_name("F5 BIG-IP - BIG-IP virtual server TCP sequence numbers vulnerability");

  script_xref(name:"URL", value:"https://support.f5.com/csp/article/K68401558");
...
check_f5["LTM"] = make_array("affected",   "12.0.0;11.5.0-11.6.1;11.2.1;10.2.1-10.2.4;",
                             "unaffected", "12.1.0-12.1.1;12.0.0_HF1;");
...
check_f5["AVR"] = make_array("affected",   "12.0.0;11.5.0-11.6.1;11.2.1;",
                             "unaffected", "12.1.0-12.1.1;12.0.0_HF1;");

check_f5["APM"] = make_array("affected",   "12.0.0;11.5.0-11.6.1;11.2.1;10.2.1-10.2.4;",
                             "unaffected", "12.1.0-12.1.1;12.0.0_HF1;");

check_f5["ASM"] = make_array("affected",   "12.0.0;11.5.0-11.6.1;11.2.1;10.2.1-10.2.4;",
                             "unaffected", "12.1.0-12.1.1;12.0.0_HF1;");

check_f5["LC"]  = make_array("affected",   "12.0.0;11.5.0-11.6.1;11.2.1;10.2.1-10.2.4;",
                             "unaffected", "12.1.0-12.1.1;12.0.0_HF1;");
