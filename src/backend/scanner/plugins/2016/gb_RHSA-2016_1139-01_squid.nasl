...
#
# RedHat Update for squid RHSA-2016:1139-01
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871623");
  script_version("$Revision: 12497 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-23 09:28:21 +0100 (Fri, 23 Nov 2018) $");
  script_tag(name:"creation_date", value:"2016-06-03 16:25:13 +0530 (Fri, 03 Jun 2016)");
  ...
  script_name("RedHat Update for squid RHSA-2016:1139-01");
...
crash the squid worker, causing a Denial of Service attack. (CVE-2016-4556)");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2016-May/msg00053.html");
...
if(release == "RHENT_7")
{
  ...
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.3.8~26.el7_2.3", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"squid-debuginfo", rpm:"squid-debuginfo~3.3.8~26.el7_2.3", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
