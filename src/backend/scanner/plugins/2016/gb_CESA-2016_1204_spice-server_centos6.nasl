...
if(description)
{
  ...
  script_name("CentOS Update for spice-server CESA-2016:1204 centos6");
...
CVE-2016-2150 issue was discovered by Frediano Ziglio (Red Hat).");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-June/021903.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"spice-server", rpm:"spice-server~0.12.4~13.el6.1", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"spice-server-devel", rpm:"spice-server-devel~0.12.4~13.el6.1", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
