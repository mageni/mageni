...
#
# Fedora Update for zathura-pdf-mupdf FEDORA-2016-1b9d24c2b6
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for zathura-pdf-mupdf FEDORA-2016-1b9d24c2b6");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"zathura-pdf-mupdf", rpm:"zathura-pdf-mupdf~0.3.0~2.fc23", rls:"FC23")) != NULL)
  {
