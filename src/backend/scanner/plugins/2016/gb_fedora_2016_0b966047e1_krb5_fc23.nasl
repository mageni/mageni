...
#
# Fedora Update for krb5 FEDORA-2016-0b966047e1
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for krb5 FEDORA-2016-0b966047e1");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.14.1~7.fc23", rls:"FC23")) != NULL)
  {
