...
# $Id: gb_adobe_indesign_server_memory_corruption_vuln_win.nasl 12431 2018-11-20 09:21:00Z asteins $
#
# Adobe InDesign Server Unspecified Memory Corruption Vulnerability (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810241");
  ...
  script_name("Adobe InDesign Server Unspecified Memory Corruption Vulnerability (Windows)");
  ...
  script_dependencies("gb_adobe_indesign_server_detect_win.nasl");
  script_mandatory_keys("AdobeIndesignServer/Win/Ver");
