...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.6.30 / 5.7 <= 5.7.12 Security Update (cpujul2016) - Windows");
  ...
  script_tag(name:"impact", value:"Successful exploitation will allow remote attacker to affect
  availability via unknown vectors.");

  script_tag(name:"affected", value:"Oracle MySQL 5.6.30 and earlier, 5.7.12 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.6.30") ||
