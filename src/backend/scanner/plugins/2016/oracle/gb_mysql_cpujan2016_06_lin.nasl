...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812173");
  ...
  script_tag(name:"creation_date", value:"2017-11-22 13:58:08 +0530 (Wed, 22 Nov 2017)");
  script_tag(name:"qod_type", value:"remote_banner_unreliable");
  script_name("Oracle MySQL <= 5.6.27 / 5.7.9 Security Update (cpujan2016) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.6.27 and earlier and 5.7.9.");
...
if(version_is_less_equal(version:vers, test_version:"5.6.27") ||
