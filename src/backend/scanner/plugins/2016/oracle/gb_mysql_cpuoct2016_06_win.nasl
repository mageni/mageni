...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.6.31 / 5.7 <= 5.7.13 Security Update (cpuoct2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.6.31 and earlier, 5.7.13 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.6.31") ||
