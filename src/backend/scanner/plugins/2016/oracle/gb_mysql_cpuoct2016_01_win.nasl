...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809370");
  ...
  script_name("Oracle MySQL <= 5.6.32 / 5.7 <= 5.7.14 Security Update (cpuoct2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.6.32 and earlier, and 5.7.14 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.6.32") ||
