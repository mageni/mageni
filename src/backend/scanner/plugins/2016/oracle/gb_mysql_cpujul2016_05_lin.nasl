...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.808700");
  ...
  script_tag(name:"creation_date", value:"2016-07-21 12:53:20 +0530 (Thu, 21 Jul 2016)");
  script_tag(name:"qod_type", value:"remote_banner_unreliable");
  script_name("Oracle MySQL <= 5.5.48 / 5.6 <= 5.6.29 / 5.7 <= 5.7.11 Security Update (cpujul2016) - Linux");
  ...
  unknown vectors related to 'Connection' sub-component.");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.48 and earlier, 5.6.29 and earlier, 5.7.11 and earlier.");
