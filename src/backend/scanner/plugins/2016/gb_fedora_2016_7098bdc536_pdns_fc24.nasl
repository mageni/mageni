...
#
# Fedora Update for pdns FEDORA-2016-7098bdc536
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for pdns FEDORA-2016-7098bdc536");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"pdns", rpm:"pdns~4.0.1~1.fc24", rls:"FC24")) != NULL)
  {
