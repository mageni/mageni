...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882461");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-04-14 05:19:24 +0200 (Thu, 14 Apr 2016)");
  ...
  script_name("CentOS Update for ipa-admintools CESA-2016:0612 centos7");
...
protection for LDAP connections. A man-in-the-middle attacker co ...
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-April/021830.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"ipa-admintools", rpm:"ipa-admintools~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ipa-client", rpm:"ipa-client~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ipa-python", rpm:"ipa-python~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ipa-server", rpm:"ipa-server~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ipa-server-dns", rpm:"ipa-server-dns~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ipa-server-trust-ad", rpm:"ipa-server-trust-ad~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ipa", rpm:"ipa~4.2.0~15.0.1.el7.centos.6.1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
