...
# $Id: deb_3549.nasl 14275 2019-03-18 14:39:45Z cfischer $
# Auto-generated from advisory DSA 3549-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 3549-1 (chromium-browser - security update)");
  ...
  script_xref(name:"URL", value:"http://www.debian.org/security/2016/dsa-3549.html");
...
these problems have been fixed in version 50.0.2661.75-1~deb8u1.
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"chromedriver", ver:"50.0.2661.75-1~deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"chromium", ver:"50.0.2661.75-1~deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"chromium-dbg", ver:"50.0.2661.75-1~deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"chromium-inspector", ver:"50.0.2661.75-1~deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"chromium-l10n", ver:"50.0.2661.75-1~deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
