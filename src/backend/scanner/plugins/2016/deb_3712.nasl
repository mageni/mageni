...
# $Id: deb_3712.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"terminology", ver:"0.7.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"terminology-data", ver:"0.7.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
