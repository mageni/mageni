...
# $Id: deb_3702.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"tar", ver:"1.27.1-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tar-scripts", ver:"1.27.1-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
