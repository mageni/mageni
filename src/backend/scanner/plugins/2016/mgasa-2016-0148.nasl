...
# $Id: mgasa-2016-0148.nasl 14180 2019-03-14 12:29:16Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2016-0148.html");
  script_cve_id("CVE-2016-4051");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.5.17~1.mga5", rls:"MAGEIA5")) != NULL) {
