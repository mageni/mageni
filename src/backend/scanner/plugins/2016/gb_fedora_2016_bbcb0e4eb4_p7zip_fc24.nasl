...
#
# Fedora Update for p7zip FEDORA-2016-bbcb0e4eb4
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for p7zip FEDORA-2016-bbcb0e4eb4");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"p7zip", rpm:"p7zip~16.02~1.fc24", rls:"FC24")) != NULL)
  {
