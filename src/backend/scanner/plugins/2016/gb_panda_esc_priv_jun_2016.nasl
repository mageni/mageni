...
if(description)
{
  ...
  script_tag(name:"affected", value:"Panda Small Business Protection (16.1.2)");
  ...
  script_tag(name:"summary", value:"This host is running Panda Small Business Protection and is prone to a Privilege
