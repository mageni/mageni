...
# $Id: gb_f5_big_ip_sol00265182.nasl 12338 2018-11-13 14:51:17Z asteins $
#
# F5 BIG-IP - SOL00265182 - Custom monitor privilege escalation vulnerability CVE-2016-5020
#
# Authors:
...
if (description)
{
  ...
  script_name("F5 BIG-IP - SOL00265182 - Custom monitor privilege escalation vulnerability CVE-2016-5020");

  script_xref(name:"URL", value:"https://support.f5.com/kb/en-us/solutions/public/k/00/sol00265182.html");
