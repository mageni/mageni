...
#
# Ubuntu Update for thunderbird USN-3023-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-08-02 10:58:42 +0530 (Tue, 02 Aug 2016)");
  script_cve_id("CVE-2016-1951", "CVE-2016-2818");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for thunderbird USN-3023-1");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3023-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"thunderbird", ver:"1:45.2.0+build1-0ubuntu0.14.04.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"thunderbird", ver:"1:45.2.0+build1-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"thunderbird", ver:"1:45.2.0+build1-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU15.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"thunderbird", ver:"1:45.2.0+build1-0ubuntu0.15.10.1", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
