...
#
# Fedora Update for python-jwcrypto FEDORA-2016-7b4a60ae66
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for python-jwcrypto FEDORA-2016-7b4a60ae66");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-jwcrypto'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"python-jwcrypto on Fedora 23");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"python-jwcrypto", rpm:"python-jwcrypto~0.3.2~1.fc23", rls:"FC23")) != NULL)
  {
