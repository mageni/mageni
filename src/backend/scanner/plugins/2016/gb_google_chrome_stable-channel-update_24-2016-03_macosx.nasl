...
# $Id: gb_google_chrome_stable-channel-update_24-2016-03_macosx.nasl 11969 2018-10-18 14:53:42Z asteins $
#
# Google Chrome Security Updates(stable-channel-update_24-2016-03)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.807644");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update_24-2016-03)-MAC OS X");
  ...
  prior to 49.0.2623.108 on MAC OS X.");
