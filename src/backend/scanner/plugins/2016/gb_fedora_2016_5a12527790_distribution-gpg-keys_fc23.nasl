...
#
# Fedora Update for distribution-gpg-keys FEDORA-2016-5a12527790
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"distribution-gpg-keys on Fedora 23");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"distribution-gpg-keys", rpm:"distribution-gpg-keys~1.7~1.fc23", rls:"FC23")) != NULL)
  {
