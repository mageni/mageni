...
# $Id: gb_nmap_nbstat_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104112");
  ...
  script_name("Nmap NSE net: nbstat");
...
if (phase == 1) {
  argv = make_array();
  nmap_nse_register(script:"nbstat", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"nbstat");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (nbstat.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
