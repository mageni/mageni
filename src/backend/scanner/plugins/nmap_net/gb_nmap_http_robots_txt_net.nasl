...
# $Id: gb_nmap_http_robots_txt_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if(description)
{
  ...
  script_name("Nmap NSE net: http-robots.txt");
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"http-robots.txt", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"http-robots.txt");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (http-robots.txt.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
