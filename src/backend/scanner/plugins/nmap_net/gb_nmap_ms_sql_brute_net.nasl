...
# $Id: gb_nmap_ms_sql_brute_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104171");
  ...
  script_name("Nmap NSE net: ms-sql-brute");
  ...
  script_tag(name:"summary", value:"Performs password guessing against Microsoft SQL Server (ms-sql).
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"ms-sql-brute", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"ms-sql-brute");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (ms-sql-brute.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
