 ...
 * SPDX-FileComment: The viper - plugin class. Loads or launches viper- plugins.
...
nasl_thread (struct script_infos *args)
{
  ...
  proctitle_set ("mageni-vscand: testing %s (%s)", ip_str, args->name);
