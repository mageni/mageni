 ...
 * SPDX-FileCopyrightText: Copyright (C) Igor Vergeichik <iverg@mail.ru> 2001
 * SPDX-FileCopyrightText: Copyright (C) Andrew Tridgell 2001
 * SPDX-FileCopyrightText: Copyright (C) Simo Sorce 2001
 * SPDX-FileCopyrightText: Copyright (C) Martin Pool 2003
