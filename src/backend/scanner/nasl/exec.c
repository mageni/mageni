 ...
 * SPDX-FileCopyrightText: Based on work Copyright (C) 2002 - 2004 Tenable Network Security
...
#include "../../libraries/util/nvticache.h" /* for nvticache_get_kb */
#include <regex.h>
#include <stdlib.h> /* for srand48 */
#include <string.h> /* for strlen */
#include </usr/include/strings.h> /* for memmem */
