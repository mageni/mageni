 ...
 * SPDX-FileCopyrightText: Copyright (C) Andrew Tridgell              1992-2000
 * SPDX-FileCopyrightText: Copyright (C) John H Terpstra              1996-2002
 * SPDX-FileCopyrightText: Copyright (C) Luke Kenneth Casson Leighton 1996-2000
 * SPDX-FileCopyrightText: Copyright (C) Paul Ashton                  1998-2000
 * SPDX-FileCopyrightText: Copyright (C) Simo Sorce                   2001-2002
 * SPDX-FileCopyrightText: Copyright (C) Martin Pool                  2002
...
/* Copy into a smb_ucs2_tt from a possibly unaligned buffer. Return the copied
 * smb_ucs2_tt */
