...
#include "../../libraries/base/hosts.h"      /* for gvm_hosts_* and gvm_host_* */
#include "../../libraries/base/networking.h" /* for gvm_source_iface_init */
#include "../../libraries/base/nvti.h"
#include "../../libraries/base/prefs.h" /* for prefs_get */
#include "../../libraries/util/kb.h"    /* for kb_new */
  ...
  if (display_version)
    {
      ...
      else
      {
        ...
        printf ("======================================================================\n");
        printf ("From the manual (man) of openvas-nasl:\n");
        printf ("Most of the engine is (C) 2003 Michel Arboi,\n");
        printf ("most of the built-in functions are (C) 2003 Renaud Deraison.\n");
        printf ("Most new code since 2005 developed by Greenbone Networks GmbH.\n");
        printf ("======================================================================\n");
