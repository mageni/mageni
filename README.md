...
Mageni (From the Hebrew word for "My Defender" and from the Japanese word for "Infinity") is passionate about solving the world's toughest and most complex problems using open source. Mageni provides the modern and open source vulnerability and attack surface management platform that helps you outpace adversaries and catch vulnerabilities that others miss.
