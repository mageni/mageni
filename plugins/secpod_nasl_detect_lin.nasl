...
# $Id: secpod_nasl_detect_lin.nasl 11015 2018-08-17 06:31:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detect the installed version of NASL and set the
  result in KB.");
  exit(0);
}
