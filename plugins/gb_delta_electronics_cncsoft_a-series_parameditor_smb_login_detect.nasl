...
if(description)
{
  ...
  script_name("Delta Electronics CNCSoft A-Series ParamEditor Detection (Windows SMB Login)");
...
set_kb_item( name:"delta_electronics/cncsoft/a-series/parameditor/detected", value:TRUE );

register_and_report_cpe( app:"Delta Electronics CNCSoft A-Series ParamEditor", ver:version, concluded:concluded,
                         base:"cpe:/a:deltaww:cncsoft_parameditor:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0 );
