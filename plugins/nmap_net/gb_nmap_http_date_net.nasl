...
# $Id: gb_nmap_http_date_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104016");
  ...
  script_name("Nmap NSE net: http-date");
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"http-date", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"http-date");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (http-date.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
