...
# $Id: gb_nmap_lexmark_config_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if (phase == 1) {
  argv = make_array();
  nmap_nse_register(script:"lexmark-config", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"lexmark-config");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (lexmark-config.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
