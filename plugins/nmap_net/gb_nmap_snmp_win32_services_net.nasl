...
# $Id: gb_nmap_snmp_win32_services_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104147");
  ...
  script_name("Nmap NSE net: snmp-win32-services");
  ...
  script_tag(name:"summary", value:"Attempts to enumerate Windows services through SNMP.
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"snmp-win32-services", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"snmp-win32-services");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (snmp-win32-services.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
