...
# $Id: gb_nmap_couchdb_stats_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://wiki.apache.org/couchdb/Runtime_Statistics");
  script_xref(name:"URL", value:"http://wiki.apache.org/couchdb/HTTP_database_API");

  script_tag(name:"summary", value:"Gets database statistics from a CouchDB database.

For more info about the CouchDB HTTP API and the statistics, see the references.
