...
# $Id: gb_nmap_nat_pmp_info_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if (phase == 1) {
  argv = make_array();
  nmap_nse_register(script:"nat-pmp-info", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"nat-pmp-info");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (nat-pmp-info.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
