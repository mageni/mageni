...
# $Id: gb_nmap_citrix_brute_xml_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104036");
  ...
  script_name("Nmap NSE net: citrix-brute-xml");
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"citrix-brute-xml", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"citrix-brute-xml");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (citrix-brute-xml.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
