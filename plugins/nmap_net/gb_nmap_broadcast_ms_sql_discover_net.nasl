...
# $Id: gb_nmap_broadcast_ms_sql_discover_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104026");
  ...
  script_name("Nmap NSE net: broadcast-ms-sql-discover");
  ...
  script_tag(name:"summary", value:"Discovers Microsoft SQL servers in the same broadcast domain.
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"broadcast-ms-sql-discover", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"broadcast-ms-sql-discover");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (broadcast-ms-sql-discover.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
