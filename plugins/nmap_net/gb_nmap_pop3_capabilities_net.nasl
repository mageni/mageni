...
# $Id: gb_nmap_pop3_capabilities_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if (phase == 1) {
  argv = make_array();
  nmap_nse_register(script:"pop3-capabilities", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"pop3-capabilities");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (pop3-capabilities.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
