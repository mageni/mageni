...
# $Id: gb_nmap_domcon_brute_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104051");
  ...
  script_name("Nmap NSE net: domcon-brute");
  ...
  script_tag(name:"summary", value:"Performs brute force password auditing against the Lotus Domino Console.
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"domcon-brute", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"domcon-brute");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (domcon-brute.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
