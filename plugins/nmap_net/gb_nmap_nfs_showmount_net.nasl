...
# $Id: gb_nmap_nfs_showmount_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"nfs-showmount", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"nfs-showmount");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (nfs-showmount.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
