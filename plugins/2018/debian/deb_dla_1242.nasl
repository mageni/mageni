...
# $Id: deb_dla_1242.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1242-1 using nvtgen 1.0
# Script version:1.1
# #
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1242-1] xmltooling security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxmltooling-dev", ver:"1.4.2-5+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxmltooling-doc", ver:"1.4.2-5+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxmltooling5", ver:"1.4.2-5+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"xmltooling-schemas", ver:"1.4.2-5+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
