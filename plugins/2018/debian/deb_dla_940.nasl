...
# $Id: deb_dla_940.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 940-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 940-1] sane-backends security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsane", ver:"1.0.22-7.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsane-common", ver:"1.0.22-7.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsane-dbg", ver:"1.0.22-7.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsane-dev", ver:"1.0.22-7.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sane-utils", ver:"1.0.22-7.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
