...
# $Id: deb_dla_1314.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1314-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1314-1] simplesamlphp security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"simplesamlphp", ver:"1.9.2-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
