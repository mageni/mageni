...
# $Id: deb_dla_1364.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1364-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libslp-dev", ver:"1.2.1-9+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libslp1", ver:"1.2.1-9+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openslp-doc", ver:"1.2.1-9+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"slpd", ver:"1.2.1-9+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"slptool", ver:"1.2.1-9+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
