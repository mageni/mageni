...
# $Id: deb_dla_867.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"audiofile-tools", ver:"0.3.4-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libaudiofile-dbg", ver:"0.3.4-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libaudiofile-dev", ver:"0.3.4-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libaudiofile1", ver:"0.3.4-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
