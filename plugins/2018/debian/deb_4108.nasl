...
# $Id: deb_4108.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"mailman", ver:"2.1.18-2+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"mailman", ver:"2.1.23-1+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
