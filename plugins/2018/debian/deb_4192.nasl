...
# $Id: deb_4192.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libmad0", ver:"0.15.1b-8+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmad0-dev", ver:"0.15.1b-8+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmad0", ver:"0.15.1b-8+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmad0-dev", ver:"0.15.1b-8+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
