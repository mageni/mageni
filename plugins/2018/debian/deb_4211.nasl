...
# $Id: deb_4211.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"xdg-utils", ver:"1.1.1-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"xdg-utils", ver:"1.1.0~rc1+git20111210-7.4+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
