...
# $Id: deb_dla_1013.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1013-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1013-1] graphite2 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libgraphite2-2.0.0", ver:"1.3.10-1~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgraphite2-2.0.0-dbg", ver:"1.3.10-1~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgraphite2-dev", ver:"1.3.10-1~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgraphite2-doc", ver:"1.3.10-1~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
