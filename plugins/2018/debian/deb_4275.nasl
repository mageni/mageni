...
# $Id: deb_4275.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"keystone", ver:"2:10.0.0-9+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"keystone-doc", ver:"2:10.0.0-9+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-keystone", ver:"2:10.0.0-9+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
