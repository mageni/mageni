...
# $Id: deb_4358.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DSA 4358-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 4358-1 (ruby-sanitize - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4358.html");
  ...
  script_tag(name:"affected", value:"ruby-sanitize on Debian Linux");
...
security tracker page linked in the references.");
  ...
  script_tag(name:"summary", value:"The Shopify Application Security Team discovered that ruby-sanitize, a
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"ruby-sanitize", ver:"2.1.0-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
