...
# $Id: deb_dla_1042.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1042-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1042-1] libquicktime security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libquicktime-dev", ver:"2:1.2.4-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libquicktime-doc", ver:"2:1.2.4-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libquicktime2", ver:"2:1.2.4-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"quicktime-utils", ver:"2:1.2.4-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"quicktime-x11utils", ver:"2:1.2.4-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
