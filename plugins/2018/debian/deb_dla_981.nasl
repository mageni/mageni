...
# $Id: deb_dla_981.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 981-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 981-1] apng2gif security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"apng2gif", ver:"1.5-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
