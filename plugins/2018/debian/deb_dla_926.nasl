...
# $Id: deb_dla_926.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 926-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 926-1] batik security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libbatik-java", ver:"1.7+dfsg-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
