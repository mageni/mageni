...
# $Id: deb_dla_1112.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"rubygems", ver:"1.8.24-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"rubygems-doc", ver:"1.8.24-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"rubygems1.8", ver:"1.8.24-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
