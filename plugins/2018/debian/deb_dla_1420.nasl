...
# $Id: deb_dla_1420.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"cinnamon", ver:"2.2.16-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cinnamon-common", ver:"2.2.16-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cinnamon-dbg", ver:"2.2.16-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
