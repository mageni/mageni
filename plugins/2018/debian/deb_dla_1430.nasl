...
# $Id: deb_dla_1430.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libtag1-dev", ver:"1.9.1-2.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtag1-doc", ver:"1.9.1-2.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtag1-vanilla", ver:"1.9.1-2.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtag1c2a", ver:"1.9.1-2.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtagc0", ver:"1.9.1-2.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtagc0-dev", ver:"1.9.1-2.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
