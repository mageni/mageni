...
# $Id: deb_dla_874.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"jbig2dec", ver:"0.13-4~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjbig2dec0", ver:"0.13-4~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjbig2dec0-dev", ver:"0.13-4~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
