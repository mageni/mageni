...
# $Id: deb_dla_1299.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libjgraphx-java", ver:"1.4.1.0-3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjgraphx-java-doc", ver:"1.4.1.0-3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
