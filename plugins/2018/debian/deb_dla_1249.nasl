...
# $Id: deb_dla_1249.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1249-1] smarty3 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"smarty3", ver:"3.1.10-2+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
