...
# $Id: deb_dla_975.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 975-1] wordpress security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"wordpress", ver:"3.6.1+dfsg-1~deb7u15", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"wordpress-l10n", ver:"3.6.1+dfsg-1~deb7u15", rls:"DEB7")) != NULL) {
  report += res;
}
