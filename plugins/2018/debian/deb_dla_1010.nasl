...
# $Id: deb_dla_1010.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"vorbis-tools", ver:"1.4.0-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"vorbis-tools-dbg", ver:"1.4.0-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
