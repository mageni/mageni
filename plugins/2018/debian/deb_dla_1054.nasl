...
# $Id: deb_dla_1054.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"gir1.2-gxps-0.1", ver:"0.2.2-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgxps-dev", ver:"0.2.2-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgxps-doc", ver:"0.2.2-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgxps-utils", ver:"0.2.2-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgxps2", ver:"0.2.2-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
