...
# $Id: deb_dla_1341.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1341-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsdl-image1.2", ver:"1.2.12-2+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsdl-image1.2-dev", ver:"1.2.12-2+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
