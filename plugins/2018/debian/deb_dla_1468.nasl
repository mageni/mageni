...
# $Id: deb_dla_1468.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"fuse", ver:"2.9.3-15+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"fuse-dbg", ver:"2.9.3-15+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"fuse-udeb", ver:"2.9.3-15+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfuse-dev", ver:"2.9.3-15+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfuse2", ver:"2.9.3-15+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfuse2-udeb", ver:"2.9.3-15+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
