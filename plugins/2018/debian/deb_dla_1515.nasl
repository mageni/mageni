...
# $Id: deb_dla_1515.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"hylafax-client", ver:"3:6.0.6-6+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"hylafax-client-dbg", ver:"3:6.0.6-6+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"hylafax-server", ver:"3:6.0.6-6+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"hylafax-server-dbg", ver:"3:6.0.6-6+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
