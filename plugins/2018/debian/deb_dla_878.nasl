...
# $Id: deb_dla_878.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libytnef0", ver:"1.5-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libytnef0-dev", ver:"1.5-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
