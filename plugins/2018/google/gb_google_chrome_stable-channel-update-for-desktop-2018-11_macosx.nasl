...
#
# Google Chrome Security Updates(stable-channel-update-for-desktop-2018-11)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814155");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2018-11)-MAC OS X");
  ...
  prior to 70.0.3538.102 on MAC OS X.");
