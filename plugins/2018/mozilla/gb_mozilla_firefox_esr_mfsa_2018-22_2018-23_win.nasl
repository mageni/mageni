...
# Id$
#
# Mozilla Firefox ESR Security Updates(mfsa_2018-22_2018-23)-Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814045");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-12385");
  script_tag(name:"cvss_base", value:"4.4");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-09-25 11:32:59 +0530 (Tue, 25 Sep 2018)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2018-22_2018-23)-Windows");
