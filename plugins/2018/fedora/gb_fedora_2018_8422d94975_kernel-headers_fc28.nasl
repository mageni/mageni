...
# $Id: gb_fedora_2018_8422d94975_kernel-headers_fc28.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J4U3ESAFCQ5BF35QGM32LZUL5BFBT2QO");
...
if(release == "FC28")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~4.17.17~1.fc28", rls:"FC28")) != NULL)
  {
