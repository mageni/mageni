...
# $Id: gb_fedora_2018_48569250d1_nasm_fc26.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.874019");
  ...
  script_name("Fedora Update for nasm FEDORA-2018-48569250d1");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QJF3J5MDVZF6ZWFS6NRX2DW3PG6ECUVU");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"nasm", rpm:"nasm~2.13.02~1.fc26", rls:"FC26")) != NULL)
  {
