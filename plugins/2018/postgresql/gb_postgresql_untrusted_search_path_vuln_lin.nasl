...
# $Id: gb_postgresql_untrusted_search_path_vuln_lin.nasl 12035 2018-10-23 11:46:01Z asteins $
#
# PostgreSQL < 7.3.19, 7.4.x < 7.4.17, 8.0.x < 8.0.13, 8.1.x < 8.1.9, and 8.2.x < 8.2.4 Untrusted Search Path Vulnerability (Linux)
#
# Authors:
...
if(description)
{
  ...
  8.1.x before 8.1.9, and 8.2.x before 8.2.4 on Linux.");
