...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814707");
  ...
  script_name("Microsoft .NET Framework 3.5 Multiple Vulnerabilities (KB4470502)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4470502");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4470502/");
...
foreach key(key_list)
{
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(sysdllVer)
          {
            if(version_in_range(version:sysdllVer, test_version:"3.5.30729.0", test_version2:"3.5.30729.9034")){
              vuln_range = '3.5.30729.0 - 3.5.30729.9034';
            }
            else if(version_in_range(version:sysdllVer, test_version:"4.7", test_version2:"4.7.3281")){
              vuln_range = '4.7 - 4.7.3281' ;
            }
          }
        }
      }
  ...
  if(vuln_range)
  {
    report = report_fixed_ver(file_checked:dotPath + "system.web.extensions.dll",
                              file_version:sysdllVer, vulnerable_range:vuln_range);
