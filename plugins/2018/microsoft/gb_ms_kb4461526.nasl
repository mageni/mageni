...
#
# Microsoft Word 2010 Service Pack 2 Remote Code Execution Vulnerability (KB4461526)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814175");
  ...
  script_tag(name:"creation_date", value:"2018-11-14 12:42:04 +0530 (Wed, 14 Nov 2018)");
  script_name("Microsoft Word 2010 Service Pack 2 Remote Code Execution Vulnerability (KB4461526)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4461526.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an error in Microsoft
  Wordr it fails to properly handle objects in memory.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4461526");
