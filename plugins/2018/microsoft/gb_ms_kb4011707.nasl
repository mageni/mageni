...
if(description)
{
  ...
  update according to Microsoft KB4011707");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4011707");
...
if(officeVer =~ "^14\.")
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"14.0", test_version2:"14.0.7194.4999"))
  {
    report = report_fixed_ver(file_checked:offPath + "\Mso.dll",
             file_version:offexeVer, vulnerable_range:"14.0 - 14.0.7194.4999");
