...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812920");
  ...
  script_tag(name:"creation_date", value:"2018-02-15 11:54:40 +0530 (Thu, 15 Feb 2018)");
  script_name("Adobe Acrobat DC (Continuous Track) Multiple Vulnerabilities-apsb18-02 (Windows)");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat DC (Continuous Track) 2018.009.20050
