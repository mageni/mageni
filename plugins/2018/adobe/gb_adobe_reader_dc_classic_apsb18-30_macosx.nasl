...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814235");
  ...
  script_name("Adobe Reader DC 2015 Security Updates(apsb18-30)-MAC OS X");
...
if(version_in_range(version:readerVer, test_version:"15.0", test_version2:"15.006.30455"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"2015.006.30456", install_path:InstallPath);
