...
#
# Adobe Acrobat DC (Classic Track) Multiple Arbitrary Code Execution Vulnerabilities-apsb18-29 (Mac OS X)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813857");
  ...
  script_name("Adobe Acrobat DC (Classic Track) Multiple Arbitrary Code Execution Vulnerabilities-apsb18-29 (Mac OS X)");

  script_tag(name:"summary", value:"This host is installed with Adobe Acrobat DC
  (Classic Track) and is prone to multiple arbitrary code execution vulnerabilities.");
...
{
  report =  report_fixed_ver(installed_version:vers, fixed_version:"2015.006.30448", install_path:path);
