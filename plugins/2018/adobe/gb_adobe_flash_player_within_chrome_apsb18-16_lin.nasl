...
#
# Adobe Flash Player Within Google Chrome Security Update(apsb18-16)-Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813351");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-4944");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-05-09 12:23:29 +0530 (Wed, 09 May 2018)");
  script_name("Adobe Flash Player Within Google Chrome Security Update(apsb18-16)-Linux");
