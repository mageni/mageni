...
#
# Adobe Flash Player Within Google Chrome Security Update(apsb18-24)- Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813641");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-5008", "CVE-2018-5007");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-07-11 08:12:46 +0530 (Wed, 11 Jul 2018)");
  script_name("Adobe Flash Player Within Google Chrome Security Update(apsb18-24)- Windows");
  ...
  Google Chrome 30.0.0.134, or later. Please see the references for more information.");
