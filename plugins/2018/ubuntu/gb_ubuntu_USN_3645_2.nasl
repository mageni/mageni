...
# $Id: gb_ubuntu_USN_3645_2.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_name("Ubuntu Update for firefox USN-3645-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
on the target host.");
  script_tag(name:"insight", value:"USN-3645-1 fixed vulnerabilities in Firefox. The
update caused an issue where users experienced long UI pauses in some circumsances.
...
(CVE-2018-5181)
 ...
 ...
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3645-2/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"60.0.1+build2-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"60.0.1+build2-0ubuntu0.17.10.1", rls:"UBUNTU17.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"60.0.1+build2-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"60.0.1+build2-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
