...
# $Id: gb_ubuntu_USN_3689_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
private keys.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3689-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt11", ver:"1.5.3-2ubuntu4.6", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt20", ver:"1.7.8-2ubuntu1.1", rls:"UBUNTU17.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt20", ver:"1.8.1-4ubuntu1.1", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt20", ver:"1.6.5-2ubuntu0.5", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
