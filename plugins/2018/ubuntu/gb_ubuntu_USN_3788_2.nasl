...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3788-2/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'texlive-bin'
  package(s) announced via the USN-3788-2 advisory.");
...
(CVE-2018-17407)");
  ...
  script_tag(name:"affected", value:"texlive-bin on Ubuntu 18.10.");
