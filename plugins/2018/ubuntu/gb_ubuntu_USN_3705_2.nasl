...
# $Id: gb_ubuntu_USN_3705_2.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
# Ubuntu Update for firefox USN-3705-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-07-11 05:51:21 +0200 (Wed, 11 Jul 2018)");
  ...
  script_name("Ubuntu Update for firefox USN-3705-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on
the target host.");
  script_tag(name:"insight", value:"USN-3705-1 fixed vulnerabilities in Firefox. The
update introduced various minor regressions. This update fixes the problems.
...
(CVE-2018-12369)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3705-2/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"61.0.1+build1-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"61.0.1+build1-0ubuntu0.17.10.1", rls:"UBUNTU17.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"61.0.1+build1-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"61.0.1+build1-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
