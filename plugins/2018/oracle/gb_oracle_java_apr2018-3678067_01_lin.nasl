...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813307");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-2783");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-04-19 12:45:43 +0530 (Thu, 19 Apr 2018)");
  script_name("Oracle Java SE Security Updates (apr2018-3678067) 01 - Linux");
  ...
  earlier, 1.7.0.161 and earlier, 1.8.0.152 and earlier on Linux.");
