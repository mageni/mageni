...
if(description)
{
  ...
  script_tag(name:"affected", value:"python-dulwich on openSUSE Leap 42.3");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"python-dulwich", rpm:"python-dulwich~0.18.5~11.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"python-dulwich-debuginfo", rpm:"python-dulwich-debuginfo~0.18.5~11.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"python-dulwich-debugsource", rpm:"python-dulwich-debugsource~0.18.5~11.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
