...
# $Id: gb_suse_2018_0026_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
# SuSE Update for kernel-firmware openSUSE-SU-2018:0026-1 (kernel-firmware)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for kernel-firmware openSUSE-SU-2018:0026-1 (kernel-firmware)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-01/msg00018.html");
...
if(release == "openSUSELeap42.2")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel-firmware-20170530", rpm:"kernel-firmware-20170530~7.12.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ucode-amd-20170530", rpm:"ucode-amd-20170530~7.12.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
