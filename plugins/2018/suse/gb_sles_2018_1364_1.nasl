...
if(description)
{
  ...
  script_cve_id("CVE-2015-1239","CVE-2017-171479","CVE-2017-17479");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1364-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-May/004068.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openjpeg2'
  package(s) announced via the SUSE-SU-2018:1364-1 advisory.");
