...
if(description)
{
  ...
  script_cve_id("CVE-2018-11440","CVE-2018-11577","CVE-2018-11683");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2780-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-September/004576.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'liblouis'
  package(s) announced via the SUSE-SU-2018:2780-1 advisory.");
