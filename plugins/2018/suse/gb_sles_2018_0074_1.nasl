...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000408","CVE-2017-1000409","CVE-2017-15670");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0074-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003592.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'glibc'
  package(s) announced via the SUSE-SU-2018:0074-1 advisory.");
