...
if(description)
{
  ...
  script_cve_id("CVE-2018-5150","CVE-2018-5154","CVE-2018-5155");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1334-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-May/004065.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'MozillaFirefox'
  package(s) announced via the SUSE-SU-2018:1334-1 advisory.");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~52.8.0esr~109.31.2", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-debuginfo", rpm:"MozillaFirefox-debuginfo~52.8.0esr~109.31.2", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-debugsource", rpm:"MozillaFirefox-debugsource~52.8.0esr~109.31.2", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-devel", rpm:"MozillaFirefox-devel~52.8.0esr~109.31.2", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations", rpm:"MozillaFirefox-translations~52.8.0esr~109.31.2", rls:"SLES12.0LTSS"))){
    report += res;
  }
