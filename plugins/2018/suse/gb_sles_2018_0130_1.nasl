...
if(description)
{
  ...
  script_cve_id("CVE-2017-10800","CVE-2017-11141","CVE-2017-11529");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0130-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003611.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ImageMagick'
  package(s) announced via the SUSE-SU-2018:0130-1 advisory.");
