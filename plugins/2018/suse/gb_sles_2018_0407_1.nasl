...
if(description)
{
  ...
  script_cve_id("CVE-2016-10219","CVE-2016-10317","CVE-2017-11714");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0407-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003717.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ghostscript'
  package(s) announced via the SUSE-SU-2018:0407-1 advisory.");
