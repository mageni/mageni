...
if(description)
{
  ...
  script_cve_id("CVE-2014-10070","CVE-2014-10071","CVE-2014-10072");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1072-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for 'zsh'
  package(s) announced via the SUSE-SU-2018:1072-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'zsh' package(s) on SUSE Linux Enterprise Server 12");
