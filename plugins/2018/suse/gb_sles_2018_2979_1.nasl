...
if(description)
{
  ...
  script_cve_id("CVE-2018-16741","CVE-2018-16742","CVE-2018-16743");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2979-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004636.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mgetty'
  package(s) announced via the SUSE-SU-2018:2979-1 advisory.");
