...
if(description)
{
  ...
  script_cve_id("CVE-2017-9432","CVE-2017-9433","CVE-2018-1055");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1076-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-April/003960.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'LibreOffice'
  package(s) announced via the SUSE-SU-2018:1076-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'LibreOffice' package(s) on SUSE Linux Enterprise Server 12");
