...
if(description)
{
  ...
  script_cve_id("CVE-2017-18344","CVE-2018-13053","CVE-2018-13405");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2344-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004427.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2018:2344-1 advisory.");
