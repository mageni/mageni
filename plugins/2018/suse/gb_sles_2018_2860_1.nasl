...
if(description)
{
  ...
  script_cve_id("CVE-2018-1000026","CVE-2018-10902","CVE-2018-10938");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2860-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-September/004598.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel  (Live Patch 17 for SLE 12 SP2)'
  package(s) announced via the SUSE-SU-2018:2860-1 advisory.");
