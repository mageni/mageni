...
if(description)
{
  ...
  script_cve_id("CVE-2018-1000199","CVE-2018-10087","CVE-2018-10124");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1366-1)");
  ...
  package(s) announced via the SUSE-SU-2018:1366-1 advisory.");
