...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2089-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-July/004331.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libgcrypt'
  package(s) announced via the SUSE-SU-2018:2089-1 advisory.");
