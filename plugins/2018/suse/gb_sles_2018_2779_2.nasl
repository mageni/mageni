...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.2779.2");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2779-2)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004710.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openslp'
  package(s) announced via the SUSE-SU-2018:2779-2 advisory.");
