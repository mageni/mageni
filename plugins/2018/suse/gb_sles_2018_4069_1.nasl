...
if(description)
{
  ...
  script_cve_id("CVE-2017-16533","CVE-2017-18224","CVE-2018-18281");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:4069-1)");
  ...
  package(s) announced via the SUSE-SU-2018:4069-1 advisory.");
