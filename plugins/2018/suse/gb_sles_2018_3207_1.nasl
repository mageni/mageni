...
if(description)
{
  ...
  script_cve_id("CVE-2014-9939","CVE-2017-15938","CVE-2017-15939");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3207-1)");
  ...
  package(s) announced via the SUSE-SU-2018:3207-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'binutils' package(s) on SUSE Linux Enterprise Server 12");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.31~9.26.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"binutils-debuginfo", rpm:"binutils-debuginfo~2.31~9.26.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"binutils-debugsource", rpm:"binutils-debugsource~2.31~9.26.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
