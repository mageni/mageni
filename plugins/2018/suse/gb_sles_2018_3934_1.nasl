...
if(description)
{
  ...
  script_cve_id("CVE-2017-16533","CVE-2017-18224","CVE-2018-18386");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3934-1)");
  ...
  package(s) announced via the SUSE-SU-2018:3934-1 advisory.");
