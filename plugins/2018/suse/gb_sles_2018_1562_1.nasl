...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1562-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004156.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'glibc'
  package(s) announced via the SUSE-SU-2018:1562-1 advisory.");
