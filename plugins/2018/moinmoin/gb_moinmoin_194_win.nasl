...
# $Id: gb_moinmoin_194_win.nasl 12120 2018-10-26 11:13:20Z mmartin $
#
# MoinMoin < 1.9.4 Cross-Site Scripting Vulnerabilities (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108325");
  ...
  script_name("MoinMoin < 1.9.4 Cross-Site Scripting Vulnerabilities (Windows)");
