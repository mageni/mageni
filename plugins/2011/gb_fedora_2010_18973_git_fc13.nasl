...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-January/052782.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862775");
  ...
  script_name("Fedora Update for git FEDORA-2010-18973");
  ...
  script_tag(name:"affected", value:"git on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"git", rpm:"git~1.7.3.4~1.fc13", rls:"FC13")) != NULL)
  {
