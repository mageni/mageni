...
#
# CentOS Update for curl CESA-2009:0341 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-March/015694.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880833");
  ...
  script_name("CentOS Update for curl CESA-2009:0341 centos3 i386");
