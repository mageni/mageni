...
# $Id: gb_ubuntu_USN_1128_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"vino", ver:"2.28.2-0ubuntu2.1", rls:"UBUNTU10.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU8.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"vino", ver:"2.22.2-0ubuntu1.1", rls:"UBUNTU8.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU11.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"vino", ver:"2.32.1-0ubuntu2.1", rls:"UBUNTU11.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU10.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"vino", ver:"2.32.0-0ubuntu1.2", rls:"UBUNTU10.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
