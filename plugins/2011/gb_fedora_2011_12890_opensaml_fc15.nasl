...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066308.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863553");
  ...
  script_tag(name:"affected", value:"opensaml on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"opensaml", rpm:"opensaml~2.3~4.fc15", rls:"FC15")) != NULL)
  {
