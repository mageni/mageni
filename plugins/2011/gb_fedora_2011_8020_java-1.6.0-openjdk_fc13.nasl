...
#
# Fedora Update for java-1.6.0-openjdk FEDORA-2011-8020
#
# Authors:
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.0~51.1.8.8.fc13", rls:"FC13")) != NULL)
  {
