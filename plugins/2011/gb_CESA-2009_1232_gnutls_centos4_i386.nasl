...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-August/016111.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880908");
  ...
  script_name("CentOS Update for gnutls CESA-2009:1232 centos4 i386");
  ...
  script_tag(name:"affected", value:"gnutls on CentOS 4");
