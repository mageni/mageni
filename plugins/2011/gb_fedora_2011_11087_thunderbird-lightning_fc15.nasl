...
#
# Fedora Update for thunderbird-lightning FEDORA-2011-11087
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-August/064400.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863454");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird-lightning", rpm:"thunderbird-lightning~1.0~0.48.b5.fc15", rls:"FC15")) != NULL)
  {
