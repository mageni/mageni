...
# $Id: gb_ubuntu_USN_1310_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1310-1/");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1310-1");
  script_tag(name:"affected", value:"libarchive on Ubuntu 11.04,
  Ubuntu 10.10,
  Ubuntu 10.04 LTS");
...
if(release == "UBUNTU10.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libarchive1", ver:"2.8.4-1ubuntu0.10.10.1", rls:"UBUNTU10.10")) != NULL)
  {
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libarchive1", ver:"2.8.0-2ubuntu0.1", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU11.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"libarchive1", ver:"2.8.4-1ubuntu0.11.04.1", rls:"UBUNTU11.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
