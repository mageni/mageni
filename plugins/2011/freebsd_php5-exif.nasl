...
# $Id: freebsd_php5-exif.nasl 11762 2018-10-05 10:54:12Z cfischer $
#
# Auto generated from VID cc3bfec6-56cd-11e0-9668-001fd0d616cf
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.69360");
  ...
  script_name("FreeBSD Ports: php5-exif");
  ...
  script_tag(name:"insight", value:"The following package is affected: php5-exif
