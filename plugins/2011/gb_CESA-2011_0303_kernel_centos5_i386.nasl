...
#
# CentOS Update for kernel CESA-2011:0303 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-April/017348.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880534");
  ...
  script_name("CentOS Update for kernel CESA-2011:0303 centos5 i386");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel-PAE", rpm:"kernel-PAE~2.6.18~238.5.1.el5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"kernel-PAE-devel", rpm:"kernel-PAE-devel~2.6.18~238.5.1.el5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
