...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-May/017512.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880537");
  ...
  script_name("CentOS Update for xmlsec1 CESA-2011:0486 centos5 i386");
