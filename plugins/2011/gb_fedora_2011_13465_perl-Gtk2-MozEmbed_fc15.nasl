...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066401.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863552");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-Gtk2-MozEmbed", rpm:"perl-Gtk2-MozEmbed~0.09~1.fc15.4", rls:"FC15")) != NULL)
  {
