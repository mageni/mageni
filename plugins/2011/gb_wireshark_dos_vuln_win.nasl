...
# $Id: gb_wireshark_dos_vuln_win.nasl 11997 2018-10-20 11:59:41Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The host is installed Wireshark and is prone to Denial of Service
  vulnerability.");
