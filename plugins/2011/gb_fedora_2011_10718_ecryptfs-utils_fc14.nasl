...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065061.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863473");
  ...
  script_name("Fedora Update for ecryptfs-utils FEDORA-2011-10718");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"ecryptfs-utils", rpm:"ecryptfs-utils~90~1.fc14", rls:"FC14")) != NULL)
  {
