...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'webmin'
  ...
  script_tag(name:"affected", value:"webmin on Mandriva Linux 2009.0,
  Mandriva Linux 2009.0/X86_64,
  Mandriva Linux 2010.1,
  Mandriva Linux 2010.1/X86_64,
  Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64");
  script_tag(name:"insight", value:"A vulnerability was discovered and corrected in webmin:
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"webmin", rpm:"webmin~1.550~0.2mdvmes5.2", rls:"MNDK_mes5")) != NULL)
  {
...
if(release == "MNDK_2010.1")
{
  ...
  if ((res = isrpmvuln(pkg:"webmin", rpm:"webmin~1.550~0.2mdv2010.2", rls:"MNDK_2010.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2009.0")
{
  ...
  if ((res = isrpmvuln(pkg:"webmin", rpm:"webmin~1.550~0.2mdv2009.0", rls:"MNDK_2009.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
