...
#
# CentOS Update for pango CESA-2009:0476 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015847.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880779");
  ...
  script_name("CentOS Update for pango CESA-2009:0476 centos3 i386");
  ...
  script_tag(name:"affected", value:"pango on CentOS 3");
