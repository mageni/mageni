...
# $Id: gb_roomjuice_47914.nasl 12018 2018-10-22 13:31:29Z mmartin $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Room Juice is prone to a cross-site scripting vulnerability because it
...
foreach dir( make_list_unique( "/roomjuice", cgi_dirs( port:port ) ) ) {
