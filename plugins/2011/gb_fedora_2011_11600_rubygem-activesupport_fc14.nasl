...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065189.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863488");
  ...
  script_tag(name:"affected", value:"rubygem-activesupport on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-activesupport", rpm:"rubygem-activesupport~2.3.8~4.fc14", rls:"FC14")) != NULL)
  {
