...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-January/052905.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862782");
  ...
  script_cve_id("CVE-2010-3711", "CVE-2010-2528", "CVE-2010-1624");
  script_name("Fedora Update for pidgin FEDORA-2010-19317");
  ...
  script_tag(name:"affected", value:"pidgin on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"pidgin", rpm:"pidgin~2.7.9~1.fc13", rls:"FC13")) != NULL)
  {
