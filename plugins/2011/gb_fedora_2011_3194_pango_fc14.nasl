...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/056065.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862915");
  ...
  script_tag(name:"affected", value:"pango on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"pango", rpm:"pango~1.28.1~5.fc14", rls:"FC14")) != NULL)
  {
