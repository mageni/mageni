...
# $Id: gb_igallery_49712.nasl 12018 2018-10-22 13:31:29Z mmartin $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"i-Gallery is prone to a cross-site scripting vulnerability because it
