...
#
# CentOS Update for freetype CESA-2010:0607 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2010-August/016872.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880590");
  ...
  script_name("CentOS Update for freetype CESA-2010:0607 centos5 i386");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"freetype", rpm:"freetype~2.2.1~26.el5_5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"freetype-demos", rpm:"freetype-demos~2.2.1~26.el5_5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"freetype-devel", rpm:"freetype-devel~2.2.1~26.el5_5", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
