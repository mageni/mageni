...
# $Id: gb_media_in_spot_39533.nasl 12018 2018-10-22 13:31:29Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Media in Spot CMS is prone to a local file-include vulnerability
