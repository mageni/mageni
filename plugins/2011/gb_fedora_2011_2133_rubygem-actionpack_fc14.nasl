...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/055074.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862877");
  ...
  script_name("Fedora Update for rubygem-actionpack FEDORA-2011-2133");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~2.3.8~3.fc14", rls:"FC14")) != NULL)
  {
