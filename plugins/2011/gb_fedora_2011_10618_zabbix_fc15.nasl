...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-August/063884.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863441");
  ...
  script_name("Fedora Update for zabbix FEDORA-2011-10618");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~1.8.6~1.fc15", rls:"FC15")) != NULL)
  {
