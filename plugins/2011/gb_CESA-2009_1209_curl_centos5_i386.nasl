...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-August/016095.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880682");
  ...
  script_name("CentOS Update for curl CESA-2009:1209 centos5 i386");
