...
#
# CentOS Update for openoffice.org-base CESA-2011:0182 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-May/017526.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880524");
  ...
  script_name("CentOS Update for openoffice.org-base CESA-2011:0182 centos5 i386");
