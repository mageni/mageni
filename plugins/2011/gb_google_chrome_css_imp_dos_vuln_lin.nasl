...
# $Id: gb_google_chrome_css_imp_dos_vuln_lin.nasl 11997 2018-10-20 11:59:41Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The host is install with Google Chrome and is prone to denial of
