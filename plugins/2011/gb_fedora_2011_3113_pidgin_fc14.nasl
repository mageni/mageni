...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/055874.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862917");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"pidgin", rpm:"pidgin~2.7.11~1.fc14", rls:"FC14")) != NULL)
  {
