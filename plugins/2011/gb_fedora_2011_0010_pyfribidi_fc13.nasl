...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-January/052936.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862783");
  ...
  script_name("Fedora Update for pyfribidi FEDORA-2011-0010");
  ...
  script_tag(name:"affected", value:"pyfribidi on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"pyfribidi", rpm:"pyfribidi~0.10.0~1.fc13", rls:"FC13")) != NULL)
  {
