...
# $Id: deb_2221_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202221-1");
  script_tag(name:"insight", value:"Viacheslav Tykhanovskyi discovered a directory traversal vulnerability in
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libmojolicious-perl", ver:"0.999926-1+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
