...
# $Id: deb_2270_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
# Description: Auto-generated from advisory DSA 2270-1 (qemu-kvm)
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202270-1");
  script_tag(name:"insight", value:"It was discovered that incorrect sanitising of virtio queue commands in
...
announced via advisory DSA 2270-1.");
