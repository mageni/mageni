...
if (egrep(pattern: "SERVER\s*:\s*EPSON_Linux", string: res, icase: TRUE) ||
    egrep(pattern: "Epson UPnP SDK", string: res, icase: TRUE) ||
    egrep(pattern: "Server\s*:\s*EPSON HTTP Server", string: res, icase: TRUE) ||
    egrep(pattern: "Server\s*:\s*EPSON-HTTP", string: res, icase: TRUE)) {
