...
if(description)
{
  ...
  script_version("2022-04-12T10:27:34+0000");
  ...
  script_name("Atlassian Crowd Detection (HTTP)");
  ...
  script_tag(name:"summary", value:"HTTP based detection of Atlassian Crowd.");
...
url = "/crowd/console/login.action";
res = http_get_cache(port: port, item: url);

# Atlassian Crowd&nbsp;-&nbsp;Login
# Atlassian Crowd - Login
if ((res =~ "<title>Atlassian Crowd[^-]+-[^L]+Login" &&
    ("/crowd/console/j_security_check" >< res || 'content="Crowd" display-name="Crowd"' >< res)) ||
  ...
  set_kb_item(name: "atlassian/crowd/detected", value: TRUE);
  set_kb_item(name: "atlassian/crowd/http/detected", value: TRUE);
  ...
  log_message(data: build_detection_report(app: "Atlassian Crowd", version: version, install: install,
