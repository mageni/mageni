...
#
# CentOS Update for openchange CESA-2016:0612 centos7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882460");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-04-14 05:19:15 +0200 (Thu, 14 Apr 2016)");
  ...
  script_name("CentOS Update for openchange CESA-2016:0612 centos7");
...
protection for LDAP connections. A man-in-the-middle attacker could  ...
  ...
  script_tag(name:"affected", value:"openchange on CentOS 7");
  script_tag(name:"solution", value:"Please install the updated packages.");

  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-April/021829.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"openchange", rpm:"openchange~2.0~10.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openchange-client", rpm:"openchange-client~2.0~10.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openchange-devel", rpm:"openchange-devel~2.0~10.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openchange-devel-docs", rpm:"openchange-devel-docs~2.0~10.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
