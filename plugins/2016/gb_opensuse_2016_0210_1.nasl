...
# $Id: gb_suse_2016_0210_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for roundcubemail openSUSE-SU-2016:0210-1 (roundcubemail)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for roundcubemail openSUSE-SU-2016:0210-1 (roundcubemail)");
...
if(release == "openSUSE13.2")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.0.8~17.1", rls:"openSUSE13.2")) != NULL)
  {
