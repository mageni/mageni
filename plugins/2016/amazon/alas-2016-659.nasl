...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2016-659)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"rpcbind", rpm:"rpcbind~0.2.0~11.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpcbind-debuginfo", rpm:"rpcbind-debuginfo~0.2.0~11.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }
