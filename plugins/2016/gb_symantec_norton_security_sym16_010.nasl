...
# $Id: gb_symantec_norton_security_sym16_010.nasl 11725 2018-10-02 10:50:50Z asteins $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.808514");
  ...
  script_name("Symantec Norton Security Decomposer Engine Multiple Parsing Vulnerabilities");

  script_tag(name:"summary", value:"This host is installed with Symantec
  Norton Security and is prone to multiple vulnerabilities.");
  ...
  script_tag(name:"affected", value:"Symantec Norton Security NGC 22.7 and prior.");
