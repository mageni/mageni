...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.5.52 / 5.6 <= 5.6.33 / 5.7 <= 5.7.15 Security Update (cpuoct2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.5.52 and earlier, 5.6.33 and earlier,
  5.7.15 and earlier.");
