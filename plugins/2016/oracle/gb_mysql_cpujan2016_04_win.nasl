...
if(description)
{
  ...
  script_version("2021-02-01T09:07:56+0000");
  ...
  script_name("Oracle MySQL <= 5.5.46 / 5.6 <= 5.6.27 / 5.7.9 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.46 and earlier, 5.6.27 and earlier, and 5.7.9.");
