...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809374");
  ...
  script_name("Oracle MySQL <= 5.5.50 / 5.6 <= 5.6.31 / 5.7 <= 5.7.13 Security Update (cpuoct2016) - Windows");

  script_tag(name:"summary", value:"Oracle MySQL is prone to an unspecified vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an unspecified error in the 'Server: DML'
  component.");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.5.50 and earlier, 5.6.31 and earlier, and
  5.7.13 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.5.50") ||
   version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.31") ||
