...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.5.45 / 5.6 <= 5.6.26 Security Update (cpujan2016) - Windows");

  script_tag(name:"summary", value:"Oracle MySQL is prone to a vulnerability in a third party library.");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.45 and earlier, 5.6.26 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.5.45") ||
   version_in_range(version:vers, test_version:"5.6.0", test_version2:"5.6.26")) {
