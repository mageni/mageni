...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.5.48 / 5.6 <= 5.6.29 / 5.7 <= 5.7.11 Security Update (cpuapr2016v3) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.48 and earlier, 5.6.29 and earlier, and 5.7.11 and earlier.");
