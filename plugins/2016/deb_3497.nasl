...
# $Id: deb_3497.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"php-horde", ver:"5.2.9+debian0-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"php-horde", ver:"5.2.1+debian0-2+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
