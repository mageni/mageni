...
if(description)
{
  ...
  script_tag(name:"affected", value:"ipsilon on Fedora 25");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4TIHC4JO7OTKYRM5HIOXRAJ74HOSEOPC");
...
if(release == "FC25")
{
  ...
  if ((res = isrpmvuln(pkg:"ipsilon", rpm:"ipsilon~2.0.2~2.fc25", rls:"FC25")) != NULL)
  {
