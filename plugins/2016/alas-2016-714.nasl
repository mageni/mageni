...
# $Id: alas-2016-714.nasl 11703 2018-10-01 08:05:31Z cfischer $
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2016-714");
...
if(release == "AMAZON")
{
  if ((res = isrpmvuln(pkg:"nss", rpm:"nss~1.0.12~4.22.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"nss-debuginfo", rpm:"nss-debuginfo~1.0.12~4.22.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
