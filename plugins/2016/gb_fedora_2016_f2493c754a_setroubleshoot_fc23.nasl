...
#
# Fedora Update for setroubleshoot FEDORA-2016-f2493c754a
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"setroubleshoot on Fedora 23");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"setroubleshoot", rpm:"setroubleshoot~3.3.9.1~1.fc23", rls:"FC23")) != NULL)
  {
