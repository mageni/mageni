...
# $Id: mgasa-2016-0008.nasl 14180 2019-03-14 12:29:16Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2016-0008");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"claws-mail", rpm:"claws-mail~3.11.1~3.mga5", rls:"MAGEIA5")) != NULL) {
