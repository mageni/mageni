...
# $Id: gb_google_chrome_mult_vuln_feb16_macosx.nasl 11969 2018-10-18 14:53:42Z asteins $
#
# Google Chrome Multiple Vulnerabilities Feb16 (Mac OS X)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.807252");
  ...
  script_name("Google Chrome Multiple Vulnerabilities Feb16 (Mac OS X)");
