...
# $Id: mgasa-2016-0140.nasl 14180 2019-03-14 12:29:16Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2016-0140");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"imlib2", rpm:"imlib2~1.4.8~1.mga5", rls:"MAGEIA5")) != NULL) {
