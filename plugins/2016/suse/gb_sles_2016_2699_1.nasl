...
if(description)
{
  ...
  script_cve_id("CVE-2016-7167","CVE-2016-8615","CVE-2016-8616");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2699-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002386.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'curl'
  package(s) announced via the SUSE-SU-2016:2699-1 advisory.");
