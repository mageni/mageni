...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2896-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002417.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tar'
  package(s) announced via the SUSE-SU-2016:2896-1 advisory.");
