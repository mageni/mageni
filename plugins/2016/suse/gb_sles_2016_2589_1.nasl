...
if(description)
{
  ...
  script_cve_id("CVE-2016-2391","CVE-2016-2392","CVE-2016-4453");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2589-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-October/002344.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2016:2589-1 advisory.");
