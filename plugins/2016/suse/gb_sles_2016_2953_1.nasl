...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2953-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002431.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_0-openjdk'
  package(s) announced via the SUSE-SU-2016:2953-1 advisory.");
