...
if(description)
{
  ...
  script_cve_id("CVE-2016-4953","CVE-2016-4954","CVE-2016-4955");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1563-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-June/002111.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ntp'
  package(s) announced via the SUSE-SU-2016:1563-1 advisory.");
