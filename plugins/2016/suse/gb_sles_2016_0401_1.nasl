...
if(description)
{
  ...
  script_cve_id("CVE-2015-5041","CVE-2015-7575","CVE-2015-7981");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0401-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-February/001868.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_1-ibm'
  package(s) announced via the SUSE-SU-2016:0401-1 advisory.");
