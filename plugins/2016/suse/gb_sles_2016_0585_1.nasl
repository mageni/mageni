...
if(description)
{
  ...
  script_cve_id("CVE-2013-7446","CVE-2015-0272","CVE-2015-5707");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0585-1)");
  ...
  package(s) announced via the SUSE-SU-2016:0585-1 advisory.");
