...
#
# Fedora Update for ca-certificates FEDORA-2016-7527145931
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for ca-certificates FEDORA-2016-7527145931");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"ca-certificates", rpm:"ca-certificates~2016.2.8~1.0.fc24", rls:"FC24")) != NULL)
  {
