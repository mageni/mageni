...
# $Id: gb_suse_2016_1660_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for obs-service-source_validator openSUSE-SU-2016:1660-1 (obs-service-source_validator)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for obs-service-source_validator openSUSE-SU-2016:1660-1 (obs-service-source_validator)");
...
if(release == "openSUSELeap42.1")
{
  ...
  if ((res = isrpmvuln(pkg:"obs-service-source_validator", rpm:"obs-service-source_validator~0.6+git20160531.fbfe336~11.1", rls:"openSUSELeap42.1")) != NULL)
  {
