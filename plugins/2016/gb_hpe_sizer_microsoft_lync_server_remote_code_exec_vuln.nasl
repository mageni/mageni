...
# $Id: gb_hpe_sizer_microsoft_lync_server_remote_code_exec_vuln.nasl 12149 2018-10-29 10:48:30Z asteins $
#
...
if(description)
{
  ...
  Microsoft Lync Server and is prone to remote arbitrary code execution
  vulnerability.");
