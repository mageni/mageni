...
if(description)
{
  ...
  script_name("Fedora Update for owasp-java-html-sanitizer FEDORA-2016-f3b40fcbc3");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'owasp-java-html-sanitizer'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"owasp-java-html-sanitizer on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"owasp-java-html-sanitizer", rpm:"owasp-java-html-sanitizer~20160422.1~1.fc24", rls:"FC24")) != NULL)
  {
