...
# $Id: alas-2016-705.nasl 11703 2018-10-01 08:05:31Z cfischer $
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2016-705");
...
if(release == "AMAZON")
{
  if ((res = isrpmvuln(pkg:"jq-libs", rpm:"jq-libs~1.5~1.2.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"jq", rpm:"jq~1.5~1.2.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"jq-devel", rpm:"jq-devel~1.5~1.2.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"jq-debuginfo", rpm:"jq-debuginfo~1.5~1.2.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
