...
check_f5['LTM'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.2.1-11.6.3;',
                             'unaffected', '');

check_f5['AAM'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['AFM'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['AVR'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['APM'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['ASM'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['GTM'] = make_array('affected',   '11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['LC'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                            'unaffected', '');

check_f5['PEM'] = make_array('affected',   '13.0.0-13.1.0;12.1.0-12.1.3;11.5.0-11.6.3;',
                             'unaffected', '');

check_f5['PSM'] = make_array('affected',   '10.2.1-10.2.4;',
