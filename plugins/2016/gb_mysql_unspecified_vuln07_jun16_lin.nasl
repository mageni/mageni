...
# $Id: gb_mysql_unspecified_vuln07_jun16_lin.nasl 36954 2014-05-08 13:23:07Z may$
#
# Oracle MySQL Multiple Unspecified Vulnerabilities-07 Jun16 (Linux)
#
# Authors:
...
if(description)
{
  ...
  component via unknown vectors related to DML, MyISAM, InnoDB, Optimizer,
  and Privileges.");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.6.15 and
  earlier on Linux.");
