...
# $Id: gb_ibm_websphere_privilage_escalation_vuln01_apr16.nasl 13803 2019-02-21 08:24:24Z cfischer $
#
# IBM Websphere Application Server Privilege Escalation Vulnerability-01 Apr16
#
# Authors:
...
if(description)
{
  ...
  script_name("IBM Websphere Application Server Privilege Escalation Vulnerability-01 Apr16");

  script_tag(name:"summary", value:"This host is installed with IBM Websphere
  application server and is prone to a privilege escalation vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to an application not
  having the correct serveServletsbyClassname setting");

  script_tag(name:"impact", value:"Successful exploitation will allow remote
  attackers to gain elevated privileges on the system.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server (WAS)
  7.0.0 before 7.0.0.39, 8.0.0 before 8.0.0.11, and 8.5 before 8.5.5.6.");

  script_tag(name:"solution", value:"Upgrade to IBM WebSphere Application
  Server (WAS) 7.0.0.39, or 8.0.0.11, or 8.5.5.6, or later.");
