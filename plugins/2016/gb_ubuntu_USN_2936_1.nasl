...
#
# Ubuntu Update for firefox USN-2936-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-05-06 15:29:27 +0530 (Fri, 06 May 2016)");
  ...
  script_name("Ubuntu Update for firefox USN-2936-1");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"Christian Holler, Tyson Smith, Phil
  Ringalda, Gary Kwong, Jesse Ruderman, Mats Palmgren, Carsten Book, Boris
  Zbarsky, David Bolter, Randell Jesup, Andrew McCreight, and Steve Fink
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2936-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"46.0+build5-0ubuntu0.14.04.2", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"46.0+build5-0ubuntu0.12.04.2", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU15.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"46.0+build5-0ubuntu0.15.10.2", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
