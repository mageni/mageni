...
# $Id: mgasa-2016-0032.nasl 14180 2019-03-14 12:29:16Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2016-0032.html");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2016-0032");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"kernel-tmb", rpm:"kernel-tmb~4.1.15~2.mga5", rls:"MAGEIA5")) != NULL) {
