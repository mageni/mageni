...
#
# Fedora Update for pulp-python FEDORA-2016-f9db2293a8
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/E7MPQGX4C3JGAUBCK3J4G7WRDADJJ6EK");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"pulp-python", rpm:"pulp-python~1.1.1~1.fc24", rls:"FC24")) != NULL)
  {
