...
#
# CentOS Update for firefox CESA-2016:2946 centos7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882612");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-12-17 05:31:06 +0100 (Sat, 17 Dec 2016)");
  ...
  script_name("CentOS Update for firefox CESA-2016:2946 centos7");
...
Forbes, and Boris Zbarsky as the original reporters.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-December/022179.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~45.6.0~1.el7.centos", rls:"CentOS7")) != NULL)
  {
