...
# $Id: deb_3450.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"ecryptfs-utils", ver:"99-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ecryptfs-utils-dbg", ver:"99-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libecryptfs-dev", ver:"99-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libecryptfs0", ver:"99-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-ecryptfs", ver:"99-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ecryptfs-utils", ver:"103-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ecryptfs-utils-dbg", ver:"103-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libecryptfs-dev", ver:"103-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libecryptfs0", ver:"103-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-ecryptfs", ver:"103-5+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
