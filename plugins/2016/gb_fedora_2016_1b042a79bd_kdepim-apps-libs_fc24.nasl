...
if(description)
{
  ...
  script_name("Fedora Update for kdepim-apps-libs FEDORA-2016-1b042a79bd");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kdepim-apps-libs'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"kdepim-apps-libs on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"kdepim-apps-libs", rpm:"kdepim-apps-libs~16.08.2~1.fc24", rls:"FC24")) != NULL)
  {
