...
# $Id: gb_hpe_sizer_microsoft_sharepoint_remote_code_exec_vuln.nasl 11961 2018-10-18 10:49:40Z asteins $
#
...
{
  if(version_is_less(version:hpVer, test_version:"16.11.0"))
  {
    report = report_fixed_ver(installed_version:hpVer, fixed_version:"16.11.0");
...
if(hpVer = get_app_version(cpe:CPE))
{
  if(version_is_less(version:hpVer, test_version:"16.13.1"))
  {
    report = report_fixed_ver(installed_version:hpVer, fixed_version:"16.13.1");
    security_message(data:report);
    exit(0);
  }
}
