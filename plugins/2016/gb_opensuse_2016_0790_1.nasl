...
# $Id: gb_suse_2016_0790_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for rubygem-actionview-4_2 openSUSE-SU-2016:0790-1 (rubygem-actionview-4_2)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for rubygem-actionview-4_2 openSUSE-SU-2016:0790-1 (rubygem-actionview-4_2)");
...
if(release == "openSUSELeap42.1")
{
  ...
  if ((res = isrpmvuln(pkg:"ruby2.1-rubygem-actionview-4_2", rpm:"ruby2.1-rubygem-actionview-4_2~4.2.4~9.1", rls:"openSUSELeap42.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ruby2.1-rubygem-actionview-doc-4_2", rpm:"uby2.1-rubygem-actionview-doc-4_2~4.2.4~9.1", rls:"openSUSELeap42.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
