...
#
# Fedora Update for openjpeg2 FEDORA-2016-27d3b7742f
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for openjpeg2 FEDORA-2016-27d3b7742f");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.1.1~3.fc24", rls:"FC24")) != NULL)
  {
