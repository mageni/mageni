...
# $Id: gb_suse_2016_0829_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for cgit openSUSE-SU-2016:0829-1 (cgit)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for cgit openSUSE-SU-2016:0829-1 (cgit)");
...
if(release == "openSUSE13.1")
{
  ...
  if ((res = isrpmvuln(pkg:"cgit", rpm:"cgit~0.12~11.12.1", rls:"openSUSE13.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cgit-debuginfo", rpm:"cgit-debuginfo~0.12~11.12.1", rls:"openSUSE13.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cgit-debugsource", rpm:"cgit-debugsource~0.12~11.12.1", rls:"openSUSE13.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
