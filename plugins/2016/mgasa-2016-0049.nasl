...
if(description)
{
  ...
  script_cve_id("CVE-2014-9762", "CVE-2014-9764", "CVE-2014-9763");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2016-0049");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"imlib2", rpm:"imlib2~1.4.7~1.mga5", rls:"MAGEIA5")) != NULL) {
