...
# $Id: deb_3741.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"tor", ver:"0.2.9.8-2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tor-dbg", ver:"0.2.9.8-2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tor-geoipdb", ver:"0.2.9.8-2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tor", ver:"0.2.5.12-4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tor-dbg", ver:"0.2.5.12-4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tor-geoipdb", ver:"0.2.5.12-4", rls:"DEB8")) != NULL) {
  report += res;
}
