...
# $Id: gb_adobe_acrobat_apsb16-33_macosx.nasl 11969 2018-10-18 14:53:42Z asteins $
#
# Adobe Acrobat Security Updates(apsb16-33)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809449");
  ...
  script_name("Adobe Acrobat Security Updates(apsb16-33)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat version 11.x before 11.0.18 on MAC OS X.");
