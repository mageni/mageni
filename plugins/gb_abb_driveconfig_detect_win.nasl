...
# $Id: gb_abb_driveconfig_detect_win.nasl 13473 2019-02-05 14:42:24Z mmartin $
#
# ABB DriveConfig Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-05 14:48:34 +0100 (Tue, 05 Feb 2019)");
  ...
  of ABB DriveConfig for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "DriveConfig") continue;
    ...
    register_and_report_cpe(app:"ABB " + appName, ver:version, concluded:concluded,
                          base:"cpe:/a:abb:driveconfig:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0);
    exit(0);
  }
}
