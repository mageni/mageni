...
# $Id: gb_omron_cx-programmer_detect.nasl 12685 2018-12-06 13:18:09Z jschulte $
#
...
if( description )
{
  ...
  script_name("Omron CX-Programmer Detection");
  ...
  script_tag(name:"summary", value:"Checks whether Omron CX-Programmer is installed
