...
# $Id: gb_solarwinds_orion_ncm_detect_win.nasl 12756 2018-12-11 11:23:23Z mmartin $
#
# SolarWinds Orion Network Configuration Manager Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("SolarWinds Orion Network Configuration Manager Version Detection (Windows)");
  ...
  of SolarWinds Orion Network Configuration Manager for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "SolarWinds Orion Network Configuration Manager") continue;
    version = "unknown";
    concluded += "SolarWinds Orion NCM";
    ...
    set_kb_item(name:"solarwinds/orion/ncm/win/detected", value:TRUE);
    set_kb_item(name:"solarwinds/orion/ncm/win/ver", value:version);
