...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146540");
  script_version("2021-08-20T09:04:25+0000");
  script_tag(name:"last_modification", value:"2021-08-23 10:21:16 +0000 (Mon, 23 Aug 2021)");
  script_tag(name:"creation_date", value:"2021-08-20 09:03:42 +0000 (Fri, 20 Aug 2021)");
  ...
  script_name("Live555 Streaming Media < 2021.08.13 Multiple Vulnerabilities - Windows");
