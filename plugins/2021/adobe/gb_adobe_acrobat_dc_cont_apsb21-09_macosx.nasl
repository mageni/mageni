...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817932");
  ...
  script_tag(name:"creation_date", value:"2021-02-11 18:09:11 +0530 (Thu, 11 Feb 2021)");
  script_name("Adobe Acrobat DC (Continuous) Security Update (APSB21-09) - Mac OS X");

  script_tag(name:"summary", value:"The host is installed with Adobe Acrobat DC
  ...
  to version 2021.001.20135 on Mac OS X.");
