...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818825");
  ...
  script_tag(name:"creation_date", value:"2021-10-14 17:51:07 +0530 (Thu, 14 Oct 2021)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB21-104) - Mac OS X");
...
if(version_is_less(version:vers, test_version:"21.007.20099"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2021.007.20099", install_path:path);
