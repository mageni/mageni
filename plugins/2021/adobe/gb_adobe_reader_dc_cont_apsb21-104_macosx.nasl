...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818822");
  ...
  script_tag(name:"creation_date", value:"2021-10-14 17:47:57 +0530 (Thu, 14 Oct 2021)");
  script_name("Adobe Reader DC Continuous Security Update (APSB21-104) - Mac OS X");
