...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818155");
  ...
  script_tag(name:"creation_date", value:"2021-06-10 14:56:00 +0530 (Thu, 10 Jun 2021)");
  script_name("Adobe Reader DC Continuous Security Update (APSB21-37) - Mac OS X");
  ...
  prior to 2021.005.20048 on Mac OS X.");
