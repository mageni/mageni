...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818551");
  ...
  script_name("Adobe Photoshop Buffer Overflow Vulnerability (APSB21-84) - Windows");
  ...
  Adobe Photoshop 2021 prior to 22.5.1 on Windows.");
