...
Upstream bug fixes (bsc#1027519)");
  ...
  script_tag(name:"affected", value:"'xen' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Server Applications 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2");
