...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.1863.2");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1863-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1863-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211863-2/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'umoci' package(s) announced via the SUSE-SU-2021:1863-2 advisory.");
...
CVE-2021-29136: Fixed overwriting of host files via malicious layer
 (bsc#1184147).");
  ...
  script_tag(name:"affected", value:"'umoci' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP3.");
