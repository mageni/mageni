...
if(description)
{
  ...
  script_cve_id("CVE-2020-0433","CVE-2020-25670","CVE-2020-25671");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:1210-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-April/008641.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2021:1210-1 advisory.");
