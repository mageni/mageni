...
Fix zmq bug that causes salt-call to freeze (bsc#1181368)");
  ...
  script_tag(name:"affected", value:"'Salt' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15");
