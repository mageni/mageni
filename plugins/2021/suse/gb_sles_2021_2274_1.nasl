...
CVE-2021-20286: A flaw was found in libnbd 1.7.3. An assertion failure
 in nbd_unlocked_opt_go in ilb/opt.c may lead to denial of service.");
  ...
  script_tag(name:"affected", value:"'kubevirt' package(s) on SUSE Linux Enterprise Module for Containers 15-SP3, SUSE Linux Enterprise Module for Containers 15-SP2");
