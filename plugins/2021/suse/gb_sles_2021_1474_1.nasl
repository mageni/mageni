 ...
 * BlueStore handles huge(>4GB) writes from RocksDB to BlueFS poorly,
 potentially causing data corruption (bsc#1183899).");
  ...
  script_tag(name:"affected", value:"'ceph' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Enterprise Storage 7");
