...
if(description)
{
  ...
  script_cve_id("CVE-2020-25639","CVE-2020-27835","CVE-2020-29568");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0532-1)");
  ...
  package(s) announced via the SUSE-SU-2021:0532-1 advisory.");
