...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.1168.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1168-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1168-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211168-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc' package(s) announced via the SUSE-SU-2021:1168-1 advisory.");
...
CVE-2020-26572: Fixed a stack-based buffer overflow in tcos_decipher
 (bsc#1177378).");
  ...
  script_tag(name:"affected", value:"'opensc' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
...
if(release == "SLES15.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.19.0~3.7.1", rls:"SLES15.0SP3"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-debuginfo", rpm:"opensc-debuginfo~0.19.0~3.7.1", rls:"SLES15.0SP3"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-debugsource", rpm:"opensc-debugsource~0.19.0~3.7.1", rls:"SLES15.0SP3"))){
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  if(!isnull(res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.19.0~3.7.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-debuginfo", rpm:"opensc-debuginfo~0.19.0~3.7.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-debugsource", rpm:"opensc-debugsource~0.19.0~3.7.1", rls:"SLES15.0SP2"))){
    report += res;
  }
