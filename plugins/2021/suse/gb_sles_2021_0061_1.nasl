...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.0061.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:0061-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:0061-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210061-1/");
  script_xref(name:"URL", value:"https://cwe.mitre.org/data/definitions/444.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs14' package(s) announced via the SUSE-SU-2021:0061-1 advisory.");
...
if(release == "SLES15.0SP2") {
  if(!isnull(res = isrpmvuln(pkg:"nodejs14", rpm:"nodejs14~14.15.4~5.6.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-debuginfo", rpm:"nodejs14-debuginfo~14.15.4~5.6.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-debugsource", rpm:"nodejs14-debugsource~14.15.4~5.6.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-devel", rpm:"nodejs14-devel~14.15.4~5.6.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm14", rpm:"npm14~14.15.4~5.6.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-docs", rpm:"nodejs14-docs~14.15.4~5.6.1", rls:"SLES15.0SP2"))){
    report += res;
  }
