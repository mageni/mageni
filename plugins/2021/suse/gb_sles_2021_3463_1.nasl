...
Fix for warning on mounts to CIFS with mount. (SG#57988, bsc#1174942)");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on HPE Helion Openstack 8, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud Crowbar 8.");
