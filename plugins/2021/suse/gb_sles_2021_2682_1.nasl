...
CVE-2021-20266: A flaw was found in RPM's hdrblobInit() in lib/header.c.
 ...
 system availability.");
  ...
  script_tag(name:"affected", value:"'rpm' package(s) on SUSE Linux Enterprise Module for SUSE Manager Server 4.2, SUSE Linux Enterprise Module for SUSE Manager Proxy 4.2, SUSE Linux Enterprise Module for Python2 15-SP3, SUSE Linux Enterprise Module for Public Cloud 15-SP3, SUSE Linux Enterprise Module for Development Tools 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP3.");
