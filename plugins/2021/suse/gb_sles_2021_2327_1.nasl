...
CVE-2020-7774: npm - Update y18n to fix Prototype-Pollution (bsc#1184450)");
  ...
  script_tag(name:"affected", value:"'nodejs12' package(s) on SUSE Linux Enterprise Module for Web Scripting 15-SP3, SUSE Linux Enterprise Module for Web Scripting 15-SP2");
