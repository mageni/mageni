...
CVE-2021-36090: Fixed an excessive memory allocation when reading a
 specially crafted ZIP archive. (bsc#1188466)");
  ...
  script_tag(name:"affected", value:"'apache-commons-compress' package(s) on SUSE Linux Enterprise Module for Development Tools 15-SP3, SUSE Linux Enterprise Module for Development Tools 15-SP2.");
