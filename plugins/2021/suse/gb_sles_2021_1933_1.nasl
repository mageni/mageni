...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.1933.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1933-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1933-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211933-1/");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2021:1933-1 advisory.");
...
Update for functional issues. Refer to [8th and 9th Gen Intel Core
 ...
 re/8th-gen-core-spec-update.htm... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
...
if(release == "SLES15.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20210525~7.1", rls:"SLES15.0SP3"))){
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20210525~7.1", rls:"SLES15.0SP2"))){
    report += res;
  }
