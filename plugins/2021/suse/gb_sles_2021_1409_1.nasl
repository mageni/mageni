...
Enable Position Independent Code and inherit CFLAGS from the build
 system (bsc#1184123).");
  ...
  script_tag(name:"affected", value:"'giflib' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
