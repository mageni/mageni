...
CVE-2021-3672: Fixed input validation on hostnames (bsc#1188881).");
  ...
  script_tag(name:"affected", value:"'libcares2' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Point of Sale 11-SP3, SUSE Linux Enterprise Debuginfo 11-SP4.");
