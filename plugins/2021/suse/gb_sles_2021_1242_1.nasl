...
if(description)
{
  ...
  script_cve_id("CVE-2020-11947","CVE-2020-12829","CVE-2020-13362");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:1242-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-April/008652.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2021:1242-1 advisory.");
