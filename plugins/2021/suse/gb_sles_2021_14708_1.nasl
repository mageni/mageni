...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.14708.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:14708-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:14708-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-202114708-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2021:14708-1 advisory.");
...
if(release == "SLES11.0SP4") {
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~78.10.0~78.126.1", rls:"SLES11.0SP4"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~78.10.0~78.126.1", rls:"SLES11.0SP4"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-other", rpm:"MozillaFirefox-translations-other~78.10.0~78.126.1", rls:"SLES11.0SP4"))){
    report += res;
  }
