...
Don't use %_stop_on_removal, because it was meant to be private and got
 ...
 supported and needed for now (bsc#1183168).");
  ...
  script_tag(name:"affected", value:"'postgresql10' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP2, SUSE Linux Enterprise Module for Legacy Software 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
