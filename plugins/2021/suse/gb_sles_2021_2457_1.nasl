...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-23 02:23:44 +0000 (Fri, 23 Jul 2021)");
...
DVB-S2-BB dissector infinite loop (bsc#1186790).");
  ...
  script_tag(name:"affected", value:"'wireshark' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15-SP3, SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2.");
