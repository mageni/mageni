...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-21 06:49:04 +0000 (Wed, 21 Jul 2021)");
...
Fixed permissions for /usr/lib/udev/compat-symlink-generation
 (bsc#1185807)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Server 12-SP5");
