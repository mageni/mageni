...
Disable icu for PostgreSQL 10 (and older) on TW (bsc#1179945).");
  ...
  script_tag(name:"affected", value:"'postgresql12' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP2, SUSE Linux Enterprise Module for Legacy Software 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
