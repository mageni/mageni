...
CVE-2019-16056: Fixed a parser issue in the email module. (bsc#1149955)");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Point of Sale 11-SP3, SUSE Linux Enterprise Debuginfo 11-SP4");
