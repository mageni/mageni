...
if(description)
{
  ...
  script_name("PostgreSQL 9.6.x < 9.6.22, 10.x < 10.17, 11.x < 11.12, 12.x < 12.7, 13.x < 13.3 Buffer Overflow Vulnerability - Windows");
