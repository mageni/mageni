...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118215");
  ...
  script_name("Python < 2.7.17, 3.x < 3.5.8, 3.6.x < 3.6.10, 3.7.x < 3.7.5 Improper Input Validation Vulnerability (bpo-34155) - Windows");
