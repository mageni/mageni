...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118227");
  ...
  script_name("Python 2.7.x < 2.7.17, 3.5.x < 3.5.7, 3.6.x < 3.6.9, 3.7.x < 3.7.3 Information Disclosure Vulnerability (bpo-36216) - Mac OS X");
