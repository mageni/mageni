...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.145382");
  script_version("2021-02-15T05:19:38+0000");
  script_tag(name:"last_modification", value:"2021-02-15 11:14:46 +0000 (Mon, 15 Feb 2021)");
  script_tag(name:"creation_date", value:"2021-02-15 05:15:20 +0000 (Mon, 15 Feb 2021)");
  ...
  script_name("Roundcube Webmail < 1.4.11 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Roundcube allows XSS via a crafted Cascading Style Sheets (CSS) token
  sequences during HTML email rendering.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Roundcube Webmail version 1.4.10 and prior.");
