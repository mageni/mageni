...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146222");
  script_version("2021-07-06T04:35:09+0000");
  script_tag(name:"last_modification", value:"2021-07-06 10:39:30 +0000 (Tue, 06 Jul 2021)");
  script_tag(name:"creation_date", value:"2021-07-06 04:07:40 +0000 (Tue, 06 Jul 2021)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:N/A:N");

  script_cve_id("CVE-2021-32472");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Moodle 3.8.x < 3.8.9, 3.9.x < 3.9.7, 3.10.x < 3.10.4 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"Forum CSV export could result in posts from all courses being
  exported.");

  script_tag(name:"affected", value:"Moodle version 3.8 through 3.8.8, 3.9 through 3.9.6 and 3.10
  through 3.10.3.");
