...
if (description)
{
  ...
  script_name("Oracle MySQL <= 5.6.50 / 5.7 <= 5.7.32 / 8.0 <= 8.0.22 Security Update (cpujan2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 5.6.50 and prior, 5.7 through 5.7.32 and 8.0 through 8.0.22.");
