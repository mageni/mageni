...
if(description)
{
  ...
  script_version("2021-08-24T10:28:31+0000");
  ...
  script_tag(name:"affected", value:"Oracle OpenJDK versions 16.0.1, 15.0.3, 13.0.7, 11.0.11, 8u292, 7u301 and prior.");
...
if( vers =~ "^16" ) {
  if( version_is_less_equal( version:vers, test_version:"16.0.1" ) ) {
...
if( vers =~ "^15" ) {
  if( version_is_less_equal( version:vers, test_version:"15.0.3" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
...
if( vers =~ "^13" ) {
  if( version_is_less_equal( version:vers, test_version:"13.0.7" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
...
if( vers =~ "^11" ) {
  if( version_is_less_equal( version:vers, test_version:"11.0.11" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
...
if( vers =~ "^1\.8" ) {
  if( version_is_less_equal( version:vers, test_version:"1.8.0.292" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
...
if( vers =~ "^1\.7" ) {
  if( version_is_less_equal( version:vers, test_version:"1.7.0.301" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
