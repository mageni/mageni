...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118170");
  ...
  script_name("Oracle Java SE Security Updates(jul2020) 05 - Windows");
...
if( version_in_range( version:vers, test_version:"11.0", test_version2:"11.0.7" ) ||
