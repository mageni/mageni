...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818835");
  ...
  script_tag(name:"creation_date", value:"2021-10-25 16:21:43 +0530 (Mon, 25 Oct 2021)");
  script_name("Oracle Java SE Security Update (oct2021) 04 - Linux");
