...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818828");
  script_version("2021-10-28T14:17:20+0000");
  script_cve_id("CVE-2021-35567", "CVE-2021-35578");
  ...
  script_name("Oracle Java SE Security Update (oct2021) 02 - Windows");
  ...
  and earlier, 11.0.12 and earlier, 17 and earlier on Windows.");
