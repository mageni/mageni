...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2013.66");
  script_cve_id("CVE-2013-1706", "CVE-2013-1707");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2013-66) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2013-66");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2013-66/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=888314");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=888361");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Buffer overflow in Mozilla Maintenance Service and Mozilla Updater
