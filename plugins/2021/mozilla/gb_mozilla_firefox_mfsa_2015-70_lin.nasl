...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2015.70");
  ...
  script_tag(name:"severity_date", value:"2021-01-20 14:15:00 +0000 (Wed, 20 Jan 2021)");

  script_name("Mozilla Firefox Security Advisory (MFSA2015-70) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2015-70");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2015-70/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1138554");
  ...
  script_tag(name:"insight", value:"NSS accepts export-length DHE keys with regular DHE cipher suites
