...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2013.29");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2013-29) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2013-29");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2013-29/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=848644");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Use-after-free in HTML Editor
VUPEN Security, via TippingPoint's Zero Day Initiative, reported a use-after-free within the HTML editor when content script is run by the document.execCommand() function while internal editor operations are occurring. This could allow for arbitrary code execution.");
  ...
  script_tag(name:"affected", value:"Firefox version(s) below 19.0.2.");
...
if (version_is_less(version: version, test_version: "19.0.2")) {
