...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2020-27) - Linux");
...
if (version_is_less(version: version, test_version: "68.10.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "68.10.1", install_path: location);
