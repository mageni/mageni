...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2014.12");
  script_cve_id("CVE-2014-1490", "CVE-2014-1491");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2014-12) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2014-12");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2014-12/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=930857");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=930874");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=934545");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"NSS ticket handling issues
