...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817909");
  ...
  script_name("Mozilla Firefox Security Update (mfsa2021-06)-Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 85.0.1 on
  Windows.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 85.0.1
...
if(version_is_less(version:vers, test_version:"85.0.1"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"85.0.1", install_path:path);
