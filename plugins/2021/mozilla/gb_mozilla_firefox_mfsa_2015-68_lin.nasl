...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2015.68");
  script_cve_id("CVE-2015-2742");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2015-68) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2015-68");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2015-68/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1138669");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"OS X crash reports may contain entered key press information
Mozilla developer David Parks discovered while reviewing
