...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818160");
  script_version("2021-07-15T09:57:41+0000");
  script_cve_id("CVE-2021-29960", "CVE-2021-29961", "CVE-2021-29959", "CVE-2021-29967",
                "CVE-2021-29966");
  ...
  script_name("Mozilla Firefox Security Updates(mfsa_2021-23_2021-25) - MAC OS X");
