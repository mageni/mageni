...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818177");
  ...
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2021-26_2021-30)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 78.12 on MAC OS X.");
