...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817965");
  ...
  script_name("Microsoft Excel 2013 Service Pack 1 Remote Code Execution Vulnerabilities (KB4493239)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4493239");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4493239");
...
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.0.5327.0999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"15.0 - 15.0.5327.0999");
