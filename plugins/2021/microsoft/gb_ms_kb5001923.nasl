...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817715");
  ...
  script_tag(name:"creation_date", value:"2021-05-12 19:18:25 +0530 (Wed, 12 May 2021)");
  script_name("Microsoft Office 2016 Remote Code Execution Vulnerabilities (KB5001923)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5001923");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001923");
...
if(officeVer =~ "^16\.")
{
  ...
  foreach key(key_list)
  {
    ...
    if(propath)
    {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5161.1000"))
      {
        report = report_fixed_ver(file_checked:offPath + "\graph.exe",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5161.0999");
