...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817717");
  ...
  script_tag(name:"creation_date", value:"2021-05-12 19:03:18 +0530 (Wed, 12 May 2021)");
  script_name("Microsoft Office Remote Code Execution Vulnerability (KB4464542)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4464542.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4464542");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    if(exeVer =~ "^(15\.)" && version_is_less(version:exeVer, test_version:"15.0.5345.1000"))
    {
      report = report_fixed_ver(file_checked:exePath + "\oart.dll",
                                file_version:exeVer, vulnerable_range:"15.0 - 15.0.5345.0999");
