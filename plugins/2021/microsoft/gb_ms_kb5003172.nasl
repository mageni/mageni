...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818118");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5003172)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5003172");
  ...
  - An error in Microsoft Jet Red Database Engine and Access Connectivity Engine.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5003172");
...
if(version_in_range(version:fileVer, test_version:"10.0.10240.0", test_version2:"10.0.10240.18931"))
{
  report = report_fixed_ver(file_checked:dllPath + "\pcadm.dll",
                            file_version:fileVer, vulnerable_range:"10.0.10240.0 - 10.0.10240.18931");
