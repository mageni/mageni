...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817594");
  ...
  script_tag(name:"creation_date", value:"2021-02-10 09:05:36 +0530 (Wed, 10 Feb 2021)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4601384)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4601384");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4601384");
...
if(version_is_less(version:fileVer, test_version:"6.3.9600.19941"))
{
  report = report_fixed_ver(file_checked:dllPath + "\localspl.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.3.9600.19941");
