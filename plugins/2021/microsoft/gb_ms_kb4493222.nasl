...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817915");
  ...
  script_name("Microsoft Excel 2010 Remote Code Execution Vulnerabilities (KB4493222)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4493222");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4493222");
...
if(version_in_range(version:vers, test_version:"14.0", test_version2:"14.0.7265.4999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"14.0 - 14.0.7265.4999");
