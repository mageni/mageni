...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818121");
  ...
  script_cve_id("CVE-2020-24587", "CVE-2020-24588", "CVE-2020-26144", "CVE-2021-26419",
                ...
                "CVE-2021-31187", "CVE-2021-31188", "CVE-2021-31191", "CVE-2021-31193",
                "CVE-2021-31194");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5003169)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5003169");
  ...
  - An error in Windows Projected File System FS Filter Driver.

  - An error in Windows Remote Desktop Protocol (RDP).
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5003169");
...
if(version_in_range(version:fileVer, test_version:"11.0.18362.0", test_version2:"11.0.18362.1555"))
{
  report = report_fixed_ver(file_checked:dllPath + "\mshtml.dll",
                            file_version:fileVer, vulnerable_range:"11.0.18362.0 - 11.0.18362.1555");
