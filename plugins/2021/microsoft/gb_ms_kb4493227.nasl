...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817679");
  ...
  script_name("Microsoft PowerPoint 2013 SP1 RCE Vulnerability (KB4493227");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4493227");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4493227");
...
foreach key(key_list)
{
  ...
  if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5325.1000"))
  {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll",
                            file_version:exeVer, vulnerable_range:"15.0 - 15.0.5325.0999");
