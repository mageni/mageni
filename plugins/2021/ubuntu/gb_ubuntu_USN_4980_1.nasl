...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for policykit-1 (USN-4980-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006058.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'policykit-1'
  package(s) announced via the USN-4980-1 advisory.");
...
possibly use this issue to escalate privileges.");
  ...
  script_tag(name:"affected", value:"'policykit-1' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS.");
