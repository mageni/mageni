...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for vim (USN-5093-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006212.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the USN-5093-1 advisory.");
...
arbitrary code with user privileges. (CVE-2021-3796)");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:8.0.1453-1ubuntu1.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:8.1.2269-1ubuntu5.3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
