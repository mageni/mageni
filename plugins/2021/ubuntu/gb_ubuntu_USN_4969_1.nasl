...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for isc-dhcp (USN-4969-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006044.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'isc-dhcp'
  package(s) announced via the USN-4969-1 advisory.");
...
to cause DHCP to crash, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'isc-dhcp' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
