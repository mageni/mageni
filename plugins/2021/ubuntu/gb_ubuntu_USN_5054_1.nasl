...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for uwsgi (USN-5054-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-August/006160.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'uwsgi'
  package(s) announced via the USN-5054-1 advisory.");
...
or potentially remote code execution.");
  ...
  script_tag(name:"affected", value:"'uwsgi' package(s) on Ubuntu 18.04 LTS.");
