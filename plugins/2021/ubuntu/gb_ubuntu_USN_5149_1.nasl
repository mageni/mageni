...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for accountsservice (USN-5149-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-November/006281.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'accountsservice'
  package(s) announced via the USN-5149-1 advisory.");
...
use this issue to escalate privileges.");
  ...
  script_tag(name:"affected", value:"'accountsservice' package(s) on Ubuntu 20.04 LTS.");
