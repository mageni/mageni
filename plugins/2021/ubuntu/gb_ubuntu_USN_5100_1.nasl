...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for containerd (USN-5100-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006223.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd'
  package(s) announced via the USN-5100-1 advisory.");
...
programs on the host filesystem, possibly leading to privilege escalation.");
  ...
  script_tag(name:"affected", value:"'containerd' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"containerd", ver:"1.5.2-0ubuntu1~18.04.3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"containerd", ver:"1.5.2-0ubuntu1~20.04.3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
