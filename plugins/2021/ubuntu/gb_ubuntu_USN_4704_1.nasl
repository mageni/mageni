...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libsndfile (USN-4704-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-January/005854.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsndfile'
  package(s) announced via the USN-4704-1 advisory.");
...
CVE-2018-19758, CVE-2019-3832)");
  ...
  script_tag(name:"affected", value:"'libsndfile' package(s) on Ubuntu 16.04 LTS.");
