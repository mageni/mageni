...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for python3.6 (USN-5199-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-December/006323.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.6'
  package(s) announced via the USN-5199-1 advisory.");
...
(CVE-2021-3737)");
  ...
  script_tag(name:"affected", value:"'python3.6' package(s) on Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpython3.6-stdlib", ver:"3.6.9-1~18.04ubuntu1.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.6", ver:"3.6.9-1~18.04ubuntu1.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.6-minimal", ver:"3.6.9-1~18.04ubuntu1.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
