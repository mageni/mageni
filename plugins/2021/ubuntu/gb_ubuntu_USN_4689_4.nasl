...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux (USN-4689-4)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-January/005851.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux'
  package(s) announced via the USN-4689-4 advisory.");
...
sensitive information. (CVE-2021-1056)");
  ...
  script_tag(name:"affected", value:"'linux' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
