...
if(description)
{
  ...
  script_cve_id("CVE-2019-3902", "CVE-2018-17983");
  ...
  script_name("Ubuntu: Security Advisory for mercurial (USN-5102-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006225.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mercurial'
  package(s) announced via the USN-5102-1 advisory.");
...
targets filesystem. (CVE-2019-3902)
...
execute arbitrary code. (CVE-2018-17983)");
  ...
  script_tag(name:"affected", value:"'mercurial' package(s) on Ubuntu 18.04 LTS.");
