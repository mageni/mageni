...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for flatpak (USN-4951-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006019.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'flatpak'
  package(s) announced via the USN-4951-1 advisory.");
