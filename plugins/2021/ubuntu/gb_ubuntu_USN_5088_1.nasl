...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for edk2 (USN-5088-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006205.html");
...
denial of service, or possibly execute arbitrary code. (CVE-2021-38575)");
  ...
  script_tag(name:"affected", value:"'edk2' package(s) on Ubuntu 20.04 LTS.");
