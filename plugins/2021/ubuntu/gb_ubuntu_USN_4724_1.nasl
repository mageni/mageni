...
if(description)
{
  ...
  script_cve_id("CVE-2020-36221", "CVE-2020-36222", "CVE-2020-36224", "CVE-2020-36225", "CVE-2020-36226", "CVE-2020-36223", "CVE-2020-36227", "CVE-2020-36228", "CVE-2020-36229", "CVE-2020-36230");
  ...
  script_name("Ubuntu: Security Advisory for openldap (USN-4724-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-February/005878.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openldap'
  package(s) announced via the USN-4724-1 advisory.");
...
resulting in a denial of service. (CVE-2020-36229, CVE-2020-36230)");
  ...
  script_tag(name:"affected", value:"'openldap' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"slapd", ver:"2.4.49+dfsg-2ubuntu1.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"slapd", ver:"2.4.45+dfsg-1ubuntu1.9", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"slapd", ver:"2.4.42+dfsg-2ubuntu3.12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"slapd", ver:"2.4.53+dfsg-1ubuntu1.3", rls:"UBUNTU20.10"))) {
    report += res;
  }
