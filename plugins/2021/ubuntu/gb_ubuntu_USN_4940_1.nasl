...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for pyyaml (USN-4940-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006008.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pyyaml'
  package(s) announced via the USN-4940-1 advisory.");
...
execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'pyyaml' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS.");
