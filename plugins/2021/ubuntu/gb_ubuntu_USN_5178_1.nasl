...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for python-django (USN-5178-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-December/006306.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django'
  package(s) announced via the USN-5178-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-django", ver:"2:2.2.12-1ubuntu0.8", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
