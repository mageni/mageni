...
if(description)
{
  ...
  script_cve_id("CVE-2021-3677", "CVE-2021-3449");
  ...
  script_name("Ubuntu: Security Advisory for postgresql-13 (USN-5038-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-August/006141.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-13'
  package(s) announced via the USN-5038-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-10", ver:"10.18-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-12", ver:"12.8-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
