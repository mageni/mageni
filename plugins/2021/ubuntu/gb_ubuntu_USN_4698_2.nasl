...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dnsmasq (USN-4698-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-February/005905.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq'
  package(s) announced via the USN-4698-2 advisory.");
