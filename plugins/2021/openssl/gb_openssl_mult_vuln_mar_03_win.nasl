...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112914");
  ...
  script_name("OpenSSL: Multiple Vulnerabilities (CVE-2003-0131, CVE-2003-0147) (Windows)");
  ...
  script_tag(name:"solution", value:"Update OpenSSL to version 0.9.6.j, 0.9.7b or later. See the references for
  more details.");
