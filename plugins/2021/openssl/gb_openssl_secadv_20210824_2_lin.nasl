...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112981");
  ...
  script_name("OpenSSL: Read Buffer Overruns Processing ASN.1 Strings (20210824) - Linux");
  ...
  script_tag(name:"insight", value:"ASN.1 strings are represented internally within OpenSSL as an
  ASN1_STRING structure which contains a buffer holding the string data and a field holding
  ...
  script_tag(name:"impact", value:"If a malicious actor can cause an application to directly
  construct an ASN1_STRING and then process it through one of the affected OpenSSL functions
