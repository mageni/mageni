...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854116");
  ...
  script_tag(name:"creation_date", value:"2021-08-26 03:02:24 +0000 (Thu, 26 Aug 2021)");
  script_name("openSUSE: Security Advisory for go1.16 (openSUSE-SU-2021:1199-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1199-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5LR4TSGW4J25HER35GR4VSKSJCKQY4GC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.16'
  package(s) announced via the openSUSE-SU-2021:1199-1 advisory.");
  ...
  - go#47348 cmd/go: 'go list -f &#x27 {{.Stale}}&#x27 ' stack overflow with
  cyclic
       imports
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.16", rpm:"go1.16~1.16.7~lp152.8.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.16-doc", rpm:"go1.16-doc~1.16.7~lp152.8.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.16-race", rpm:"go1.16-race~1.16.7~lp152.8.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
