...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854067");
  ...
  script_tag(name:"creation_date", value:"2021-08-14 03:01:33 +0000 (Sat, 14 Aug 2021)");
  script_name("openSUSE: Security Advisory for grafana (openSUSE-SU-2021:1148-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1148-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/7FZP3KR7QVZ36DM2NRRT76CHYDLB44JX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'grafana'
  package(s) announced via the openSUSE-SU-2021:1148-1 advisory.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grafana", rpm:"grafana~7.5.7~lp152.2.16.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
