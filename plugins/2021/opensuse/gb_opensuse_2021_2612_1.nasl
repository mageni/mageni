...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854036");
  ...
  script_tag(name:"creation_date", value:"2021-08-07 03:01:35 +0000 (Sat, 07 Aug 2021)");
  script_name("openSUSE: Security Advisory for apache-commons-compress (openSUSE-SU-2021:2612-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:2612-1");
  ...
  package(s) announced via the openSUSE-SU-2021:2612-1 advisory.");
  ...
  script_tag(name:"affected", value:"'apache-commons-compress' package(s) on openSUSE Leap 15.3.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apache-commons-compress", rpm:"apache-commons-compress~1.21~3.3.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache-commons-compress-javadoc", rpm:"apache-commons-compress-javadoc~1.21~3.3.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
