...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150632");
  ...
  script_cve_id("CVE-2010-4478");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("OpenSSH <= 5.6 Improper Authentication Vulnerability");
  ...
  script_tag(name:"summary", value:"OpenSSH 5.6 is prone to an authentication bypass vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"OpenSSH versions 5.6 or lower.");

  script_tag(name:"solution", value:"Update to version 5.7 or later.");

  script_xref(name:"URL", value:"https://github.com/seb-m/jpake");
