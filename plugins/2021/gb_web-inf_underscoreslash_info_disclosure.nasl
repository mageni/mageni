...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117709");
  script_version("2021-10-06T14:01:48+0000");
  script_cve_id("CVE-2019-8442");
  ...
  script_name("'/_/WEB-INF/' Information Disclosure Vulnerability (HTTP)");
  ...
  http://example.com/_/WEB-INF/web.xml

  http://example.com/_/web-inf/web.xml

  (note the '_/' before 'WEB-INF').");
...
foreach dir( make_list_unique( "/",
                               "/s/test", # nb: Atlassian Jira Server
  ...
  url = str_replace( string:url, find:"/WEB-INF/web.xml", replace:"/_/WEB-INF/web.xml" );
