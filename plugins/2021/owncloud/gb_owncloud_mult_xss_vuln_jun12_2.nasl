...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146735");
  script_version("2021-09-21T11:22:28+0000");
  script_tag(name:"last_modification", value:"2021-09-22 10:15:34 +0000 (Wed, 22 Sep 2021)");
  script_tag(name:"creation_date", value:"2021-09-21 09:07:14 +0000 (Tue, 21 Sep 2021)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");

  script_cve_id("CVE-2012-4397");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("ownCloud < 4.0.1 Multiple XSS Vulnerabilities");
  ...
  script_tag(name:"affected", value:"ownCloud prior to version 4.0.1.");
