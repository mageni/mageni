...
if(description)
{
  ...
  script_name("OpenLDAP DoS Vulnerability (Feb 2021)");
  ...
  script_tag(name:"insight", value:"In OpenLDAP an assertion failure in slapd can occur in the
  ...
  script_tag(name:"affected", value:"OpenLDAP version 2.4.57 and prior and 2.5.x through 2.5.1alpha.");

  script_tag(name:"solution", value:"Update to version 2.4.58, 2.5.4 or later.");

  script_xref(name:"URL", value:"https://bugs.openldap.org/show_bug.cgi?id=9454");
...
if (version =~ "^2\.5" && version_is_less(version: version, test_version: "2.5.4")) {
