...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150663");
  ...
  script_tag(name:"severity_date", value:"2017-06-30 00:00:00 +0000 (Fri, 30 Jun 2017)");
  ...
  script_name("RPCBind <= 0.2.1 DoS Vulnerability");
  ...
  script_tag(name:"affected", value:"RPCBind version 0.2.1 and prior.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_xref(name:"URL", value:"https://www.securityfocus.com/bid/76771");
...
if( version_is_less_equal( version:vers, test_version:"0.2.1" ) ) {
