...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2105");
  ...
  script_name("Huawei EulerOS: Security Advisory for wpa_supplicant (EulerOS-SA-2021-2105)");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~2.6~9.h8", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
