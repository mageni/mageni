...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2766");
  ...
  script_name("Huawei EulerOS: Security Advisory for glibc (EulerOS-SA-2021-2766)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2766");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2766");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'glibc' package(s) announced via the EulerOS-SA-2021-2766 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc", rpm:"glibc~2.28~61.h33.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"glibc-common", rpm:"glibc-common~2.28~61.h33.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libnsl", rpm:"libnsl~2.28~61.h33.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nscd", rpm:"nscd~2.28~61.h33.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
