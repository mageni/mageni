...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1095");
  ...
  script_name("Huawei EulerOS: Security Advisory for lldpad (EulerOS-SA-2021-1095)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1095");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1095");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'lldpad' package(s) announced via the EulerOS-SA-2021-1095 advisory.");
  ...
  script_tag(name:"affected", value:"'lldpad' package(s) on Huawei EulerOS V2.0SP3.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lldpad", rpm:"lldpad~1.0.1~2.git986eb2e.h1", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
