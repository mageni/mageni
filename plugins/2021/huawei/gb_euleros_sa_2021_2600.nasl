...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2600");
  ...
  script_tag(name:"severity_date", value:"2021-10-26 02:24:52 +0000 (Tue, 26 Oct 2021)");

  script_name("Huawei EulerOS: Security Advisory for OpenEXR (EulerOS-SA-2021-2600)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2600");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2600");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'OpenEXR' package(s) announced via the EulerOS-SA-2021-2600 advisory.");
...
There is a flaw in OpenEXR's dataWindowForTile function. An attacker who is able to submit a crafted file to be processed by OpenEXR could trigger an integer overflow, leading to an out-of-bounds write on the heap. The greatest impact of this flaw is to application availability, with some potential(CVE-2021-20303)
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"OpenEXR-libs", rpm:"OpenEXR-libs~1.7.1~7.h5", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
