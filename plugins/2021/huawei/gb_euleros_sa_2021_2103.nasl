...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2103");
  ...
  script_name("Huawei EulerOS: Security Advisory for libxml2 (EulerOS-SA-2021-2103)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2103");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2103");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libxml2' package(s) announced via the EulerOS-SA-2021-2103 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.9.1~6.3.h27", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxml2-devel", rpm:"libxml2-devel~2.9.1~6.3.h27", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxml2-python", rpm:"libxml2-python~2.9.1~6.3.h27", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
