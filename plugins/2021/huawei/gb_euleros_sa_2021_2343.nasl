...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2343");
  ...
  script_name("Huawei EulerOS: Security Advisory for perl-DBI (EulerOS-SA-2021-2343)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2343");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2343");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'perl-DBI' package(s) announced via the EulerOS-SA-2021-2343 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-DBI", rpm:"perl-DBI~1.627~4.h4.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
