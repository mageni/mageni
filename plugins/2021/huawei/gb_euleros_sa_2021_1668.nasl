...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1668");
  script_version("2021-03-12T07:26:23+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-12 07:26:23 +0000 (Fri, 12 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for edk2 (EulerOS-SA-2021-1668)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1668");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1668");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'edk2' package(s) announced via the EulerOS-SA-2021-1668 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2-aarch64", rpm:"edk2-aarch64~201903~2.9.1.2.33.noarch", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
