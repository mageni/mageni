...
if(description)
{
  ...
  'curl' package(s) announced via the EulerOS-SA-2021-2132 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.29.0~46.h16.x86_64", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.29.0~46.h16.x86_64", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
