...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1733");
  script_version("2021-04-13T06:15:22+0000");
  ...
  script_tag(name:"creation_date", value:"2021-04-13 06:15:22 +0000 (Tue, 13 Apr 2021)");
  script_name("Huawei EulerOS: Security Advisory for dnsmasq (EulerOS-SA-2021-1733)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1733");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1733");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'dnsmasq' package(s) announced via the EulerOS-SA-2021-1733 advisory.");
...
A flaw was found in dnsmasq. When getting a reply from a forwarded query, dnsmasq checks in the forward.c:reply_query() if the reply destination address/port is used by the pending forwarded queries. However, it does not use the address/port to retrieve the exact forwarded query, substantially reducing the number of attempts an attacker on the network would have to perform to forge a reply and get it acce ...
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on Huawei EulerOS Virtualization release 2.9.1.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.81~1.h6.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
