...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2373");
  ...
  script_name("Huawei EulerOS: Security Advisory for glib2 (EulerOS-SA-2021-2373)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2373");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2373");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'glib2' package(s) announced via the EulerOS-SA-2021-2373 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.50.3~3.h8", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"glib2-devel", rpm:"glib2-devel~2.50.3~3.h8", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
