...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2519");
  ...
  script_name("Huawei EulerOS: Security Advisory for squid (EulerOS-SA-2021-2519)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2519");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2519");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'squid' package(s) announced via the EulerOS-SA-2021-2519 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in Squid 4.x before 4.15 and 5.x before 5.0.6. If a remote server sends a certain response header over HTTP or HTTPS, there is a denial of service. This header can plausibly occur in benign network traffic.(CVE-2021-28662)
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~4.8~3.h11.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
