...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2177");
  script_version("2021-07-13T12:58:03+0000");
  ...
  script_tag(name:"creation_date", value:"2021-07-13 12:58:03 +0000 (Tue, 13 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for zstd (EulerOS-SA-2021-2177)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2177");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2177");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'zstd' package(s) announced via the EulerOS-SA-2021-2177 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zstd", rpm:"zstd~1.3.6~3.h1.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
