...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1099");
  ...
  script_name("Huawei EulerOS: Security Advisory for mysql-connector-java (EulerOS-SA-2021-1099)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1099");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1099");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'mysql-connector-java' package(s) announced via the EulerOS-SA-2021-1099 advisory.");
  ...
  script_tag(name:"affected", value:"'mysql-connector-java' package(s) on Huawei EulerOS V2.0SP3.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mysql-connector-java", rpm:"mysql-connector-java~5.1.25~3.h2", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
