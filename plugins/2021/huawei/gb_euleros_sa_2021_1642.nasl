...
if(description)
{
  ...
  script_version("2021-03-12T07:25:01+0000");
  ...
  'kernel' package(s) announced via the EulerOS-SA-2021-1642 advisory.");
...
A buffer over-read (at the framebuffer layer) in the fbcon code in the Linux kernel before 5.8.15 could be used by local attackers to rea ...
