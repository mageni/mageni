...
if(description)
{
  ...
  script_version("2021-05-03T06:23:15+0000");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1843");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'qpdf' package(s) announced via the EulerOS-SA-2021-1843 advisory.");
