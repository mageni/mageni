...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2077");
  ...
  script_tag(name:"creation_date", value:"2021-07-07 08:40:17 +0000 (Wed, 07 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for dhcp (EulerOS-SA-2021-2077)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2077");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2077");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'dhcp' package(s) announced via the EulerOS-SA-2021-2077 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhclient", rpm:"dhclient~4.2.5~68.1.h18", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.2.5~68.1.h18", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhcp-common", rpm:"dhcp-common~4.2.5~68.1.h18", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhcp-libs", rpm:"dhcp-libs~4.2.5~68.1.h18", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
