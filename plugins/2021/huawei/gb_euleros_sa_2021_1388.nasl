...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1388");
  script_version("2021-03-05T07:04:40+0000");
  script_cve_id("CVE-2019-17450", "CVE-2020-16592", "CVE-2020-16598", "CVE-2020-35493", "CVE-2020-35494", "CVE-2020-35495", "CVE-2020-35496", "CVE-2020-35507");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2021-03-08 11:21:31 +0000 (Mon, 08 Mar 2021)");
  script_tag(name:"creation_date", value:"2021-03-05 07:04:40 +0000 (Fri, 05 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for binutils (EulerOS-SA-2021-1388)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1388");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1388");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'binutils' package(s) announced via the EulerOS-SA-2021-1388 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"find_abstract_instance in dwarf2.c in the Binary File Descriptor (BFD) library (aka libbfd), as distributed in GNU Binutils 2.32, allows remote attackers to cause a denial of service (infinite recursion and application crash) via a crafted ELF file.CVE-2019-17450
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.27~28.base.1.h49", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
