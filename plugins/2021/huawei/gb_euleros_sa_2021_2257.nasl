...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2257");
  script_cve_id("CVE-2020-25650", "CVE-2020-25651", "CVE-2020-25652", "CVE-2020-25653");
  script_tag(name:"creation_date", value:"2021-08-09 10:10:48 +0000 (Mon, 09 Aug 2021)");
  ...
  script_name("Huawei EulerOS: Security Advisory for spice-vdagent (EulerOS-SA-2021-2257)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2257");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2257");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'spice-vdagent' package(s) announced via the EulerOS-SA-2021-2257 advisory.");
...
A race condition vulnerability was found in the way the spice-vdagentd daemon handled new client connections. This flaw may allow an unprivileged local guest user to become the active agent for spice-vdagentd, possibly resulting in a denial of service or information leakage from the host. The highest threat from this vulnerability is to data confidentiality as well as system availability. This flaw affects spice-vdagent versions 0.20 and prior.(CVE-2020-25653)");
  ...
  script_tag(name:"affected", value:"'spice-vdagent' package(s) on Huawei EulerOS V2.0SP9(x86_64).");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"spice-vdagent-help", rpm:"spice-vdagent-help~0.18.0~4.h1.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
