...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2045");
  script_version("2021-07-01T07:40:34+0000");
  script_cve_id("CVE-2020-35495", "CVE-2020-35496", "CVE-2020-35507", "CVE-2021-3487");
  script_tag(name:"cvss_base", value:"7.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:C");
  script_tag(name:"last_modification", value:"2021-07-02 10:34:13 +0000 (Fri, 02 Jul 2021)");
  script_tag(name:"creation_date", value:"2021-07-01 07:40:34 +0000 (Thu, 01 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for binutils (EulerOS-SA-2021-2045)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2045");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2045");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'binutils' package(s) announced via the EulerOS-SA-2021-2045 advisory.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.27~28.base.1.h50.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
