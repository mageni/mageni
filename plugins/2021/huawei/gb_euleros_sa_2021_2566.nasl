...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2566");
  script_cve_id("CVE-2017-3735", "CVE-2017-3737", "CVE-2018-0732", "CVE-2018-0737", "CVE-2018-0739", "CVE-2019-1563", "CVE-2020-1971", "CVE-2021-23840", "CVE-2021-23841");
  ...
  script_name("Huawei EulerOS: Security Advisory for shim (EulerOS-SA-2021-2566)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2566");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2566");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'shim' package(s) announced via the EulerOS-SA-2021-2566 advisory.");
...
Calls to EVP_CipherUpdate, EVP_EncryptUpdate and EVP_DecryptUpdate may overflow the output ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15~19.h6.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
