...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1678");
  script_version("2021-03-24T06:53:53+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-24 06:53:53 +0000 (Wed, 24 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for golang (EulerOS-SA-2021-1678)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1678");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1678");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'golang' package(s) announced via the EulerOS-SA-2021-1678 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang", rpm:"golang~1.13.3~9.h3.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-bin", rpm:"golang-bin~1.13.3~9.h3.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-src", rpm:"golang-src~1.13.3~9.h3.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
