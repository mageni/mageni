...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1705");
  script_version("2021-03-24T06:54:45+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-24 06:54:45 +0000 (Wed, 24 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for soundtouch (EulerOS-SA-2021-1705)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1705");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1705");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'soundtouch' package(s) announced via the EulerOS-SA-2021-1705 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"soundtouch version up to and including 2.0.0 contains a Buffer Overflow vulnerability in SoundStretch/WavFile.cpp:WavInFile::readHeaderBlock() that can result in arbitrary code execution. This attack appear to be exploitable via victim must open maliocius file in soundstretch utility.(CVE-2018-1000223)
...
The BPMDetect class in BPMDetect.cpp in libSoundTouch.a in Olli Parviainen SoundTouch 2.0 allows remote attackers to cause a denial of service (assertion failure and application exit), as demonstrated by SoundStretch.(CVE-2018-17096)
...
The TDStretchSSE::calcCrossCorr function in source/SoundTouch/sse_optimized.cpp in SoundTouch 1.9.2 allows remote attackers to cause a denial of service (heap-based buffer over-read and application crash) via a crafted wav file.(CVE-2017-9260)");
  ...
  script_tag(name:"affected", value:"'soundtouch' package(s) on Huawei EulerOS V2.0SP5.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"soundtouch", rpm:"soundtouch~1.4.0~9.h1.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
