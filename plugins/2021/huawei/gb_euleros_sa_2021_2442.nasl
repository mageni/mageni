...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2442");
  script_cve_id("CVE-2017-18186", "CVE-2017-9208", "CVE-2017-9209", "CVE-2017-9210");
  ...
  script_name("Huawei EulerOS: Security Advisory for qpdf (EulerOS-SA-2021-2442)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2442");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2442");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'qpdf' package(s) announced via the EulerOS-SA-2021-2442 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in QPDF before 7.0.0. There is an infinite loop due to looping xref tables in QPDF.cc.(CVE-2017-18186)
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qpdf-libs", rpm:"qpdf-libs~5.0.1~3.h3", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
