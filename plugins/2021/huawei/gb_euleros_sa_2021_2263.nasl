...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2263");
  script_cve_id("CVE-2021-20208");
  script_tag(name:"creation_date", value:"2021-08-09 10:11:06 +0000 (Mon, 09 Aug 2021)");
  ...
  script_name("Huawei EulerOS: Security Advisory for cifs-utils (EulerOS-SA-2021-2263)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2263");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2263");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cifs-utils' package(s) announced via the EulerOS-SA-2021-2263 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cifs-utils", rpm:"cifs-utils~6.10~0.h2.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
