...
if (description)
{
  ...
  script_tag(name:"insight", value:"The traceroute process suffers from a memory corruption issue.");

  script_tag(name:"impact", value:"By sending a crafted packet, an authenticated remote user can crash
  the traceroute process due to invalid memory access.");
