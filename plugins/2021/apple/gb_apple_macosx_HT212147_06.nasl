...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817908");
  script_version("2021-02-05T06:37:30+0000");
  script_cve_id("CVE-2021-1775", "CVE-2020-29608");
  ...
  script_name("Apple MacOSX Security Updates(HT212147)-06");
  ...
  to cause arbitrary code execution and disclosure of sensitive information.");

  script_tag(name:"affected", value:"Apple Mac OS X versions 10.14.x prior to
  10.14.6 Security Update 2021-001.");
