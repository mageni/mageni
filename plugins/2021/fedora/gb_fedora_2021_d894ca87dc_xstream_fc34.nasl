...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819019");
  ...
  script_tag(name:"creation_date", value:"2021-10-21 01:25:37 +0000 (Thu, 21 Oct 2021)");
  script_name("Fedora: Security Advisory for xstream (FEDORA-2021-d894ca87dc)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d894ca87dc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QGXIU3YDPG6OGTDHMBLAFN7BPBERXREB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xstream'
  package(s) announced via the FEDORA-2021-d894ca87dc advisory.");
...
are provided to help isolate and fix the problem.");
  ...
  script_tag(name:"affected", value:"'xstream' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xstream", rpm:"xstream~1.4.18~2.fc34", rls:"FC34"))) {
    report += res;
  }
