...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879585");
  ...
  script_name("Fedora: Security Advisory for djvulibre (FEDORA-2021-d4c1c98a58)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d4c1c98a58");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IBNKSFNJTVDUSQ4PM3ILS57VKMDPQRRF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the FEDORA-2021-d4c1c98a58 advisory.");
...
separate sub-package.");
  ...
  script_tag(name:"affected", value:"'djvulibre' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"djvulibre", rpm:"djvulibre~3.5.27~27.fc33", rls:"FC33"))) {
    report += res;
  }
