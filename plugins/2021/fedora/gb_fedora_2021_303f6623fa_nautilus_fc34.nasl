...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879141");
  ...
  script_name("Fedora: Security Advisory for nautilus (FEDORA-2021-303f6623fa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CDDLW2D64WADHABNHQ5LGDO3YOSWUO6R");
...
It is also responsible for handling the icons on the GNOME desktop.");
  ...
  script_tag(name:"affected", value:"'nautilus' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nautilus-40", rpm:"nautilus-40~rc~1.fc34", rls:"FC34"))) {
    report += res;
  }
