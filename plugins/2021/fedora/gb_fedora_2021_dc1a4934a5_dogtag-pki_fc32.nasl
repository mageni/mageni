...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879027");
  ...
  script_tag(name:"creation_date", value:"2021-03-05 04:02:25 +0000 (Fri, 05 Mar 2021)");
  script_name("Fedora: Security Advisory for dogtag-pki (FEDORA-2021-dc1a4934a5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/S3PBAR4A4ZFYWOD6TLQLTHAAJ7VTI4EQ");
...
PKI consists of the following components:
  ...
  * Token Processing Service (TPS)");
  ...
  script_tag(name:"affected", value:"'dogtag-pki' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dogtag-pki", rpm:"dogtag-pki~10.10.5~1.fc32", rls:"FC32"))) {
    report += res;
  }
