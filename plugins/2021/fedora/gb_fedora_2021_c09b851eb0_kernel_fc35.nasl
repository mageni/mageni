...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819301");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:24:54 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for kernel (FEDORA-2021-c09b851eb0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JWRTUWYPWWMNYLEA4EEY24XMPFH77QNY");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel", rpm:"kernel~5.15.4~201.fc35", rls:"FC35"))) {
    report += res;
  }
