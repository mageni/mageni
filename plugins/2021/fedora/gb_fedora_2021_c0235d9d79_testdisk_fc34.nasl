...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818460");
  ...
  script_name("Fedora: Security Advisory for testdisk (FEDORA-2021-c0235d9d79)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/44FIWEAGGBM4REQYSOCYBUTMW7NR7VAO");
...
440 file formats including JPG, MSOffice, OpenOffice documents.");
  ...
  script_tag(name:"affected", value:"'testdisk' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"testdisk", rpm:"testdisk~7.1~7.fc34", rls:"FC34"))) {
    report += res;
  }
