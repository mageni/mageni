...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879420");
  ...
  script_tag(name:"creation_date", value:"2021-04-24 03:08:26 +0000 (Sat, 24 Apr 2021)");
  script_name("Fedora: Security Advisory for python3-docs (FEDORA-2021-b6b6093b3a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BKOASPXHYLQOXYAXEN4O3SVFQEPKB37L");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-docs", rpm:"python3-docs~3.8.9~1.fc32", rls:"FC32"))) {
    report += res;
  }
