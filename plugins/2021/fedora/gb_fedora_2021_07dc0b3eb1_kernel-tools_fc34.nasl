...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879850");
  ...
  script_tag(name:"creation_date", value:"2021-07-27 03:23:11 +0000 (Tue, 27 Jul 2021)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2021-07dc0b3eb1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NBUZ5CIWXAGKUNH4HSXPV4JSEGCKH6GA");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.13.3~200.fc34", rls:"FC34"))) {
    report += res;
  }
