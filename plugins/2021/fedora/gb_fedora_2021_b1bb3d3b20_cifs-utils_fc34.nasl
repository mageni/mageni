...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818590");
  ...
  script_tag(name:"creation_date", value:"2021-10-02 01:22:17 +0000 (Sat, 02 Oct 2021)");
  script_name("Fedora: Security Advisory for cifs-utils (FEDORA-2021-b1bb3d3b20)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-b1bb3d3b20");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/66WJ3SVBHCSNQZAWSGLB6FBOCFU45FFG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cifs-utils'
  package(s) announced via the FEDORA-2021-b1bb3d3b20 advisory.");
...
file system.");
  ...
  script_tag(name:"affected", value:"'cifs-utils' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cifs-utils", rpm:"cifs-utils~6.13~3.fc34", rls:"FC34"))) {
    report += res;
  }
