...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818726");
  ...
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2021-764bc615bd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-764bc615bd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KUX3HHPIV7VDBOQHUPYAOLLFVIGRMQYG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2021-764bc615bd advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenmpt", rpm:"libopenmpt~0.5.11~1.fc35", rls:"FC35"))) {
    report += res;
  }
