...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819324");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:23:41 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for remmina (FEDORA-2021-ac23d9e47f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SEOXG5KDXRBLNNEXKKBFRH4CUZBEGMDO");
...
Please don&#39, t forget to install the plugins for the protocols you want to use.");
  ...
  script_tag(name:"affected", value:"'remmina' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"remmina", rpm:"remmina~1.4.21~1.fc33", rls:"FC33"))) {
    report += res;
  }
