...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879915");
  ...
  script_tag(name:"creation_date", value:"2021-08-05 03:21:25 +0000 (Thu, 05 Aug 2021)");
  script_name("Fedora: Security Advisory for buildah (FEDORA-2021-47d259d3cf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-47d259d3cf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WXJ2MVMAHOIGRH37ZSFYC4EVWLJFL2EQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah'
  package(s) announced via the FEDORA-2021-47d259d3cf advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.21.4~5.fc34", rls:"FC34"))) {
    report += res;
  }
