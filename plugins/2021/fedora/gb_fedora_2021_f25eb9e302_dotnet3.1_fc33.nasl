...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879619");
  ...
  script_name("Fedora: Security Advisory for dotnet3.1 (FEDORA-2021-f25eb9e302)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-f25eb9e302");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UV4ITB3SUDGR23G7XALUVKFJMZERFUKF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dotnet3.1'
  package(s) announced via the FEDORA-2021-f25eb9e302 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dotnet3.1", rpm:"dotnet3.1~3.1.115~1.fc33", rls:"FC33"))) {
    report += res;
  }
