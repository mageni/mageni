...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879828");
  ...
  script_name("Fedora: Security Advisory for perl-Mojolicious (FEDORA-2021-5bbf51d86d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-5bbf51d86d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LLJACE25ITC4DPORQVHAWJ7E7EOYEQEV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Mojolicious'
  package(s) announced via the FEDORA-2021-5bbf51d86d advisory.");
...
a new attempt at implementing this idea using state of the art technology.");
  ...
  script_tag(name:"affected", value:"'perl-Mojolicious' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Mojolicious", rpm:"perl-Mojolicious~8.73~2.fc34", rls:"FC34"))) {
    report += res;
  }
