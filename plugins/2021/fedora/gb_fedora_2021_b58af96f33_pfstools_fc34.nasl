...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819331");
  ...
  script_name("Fedora: Security Advisory for pfstools (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3GZSTURNO3M73L4NCOJZDH7L5S2W6ACI");
...
pfstools is similar to netpbm package for low-dynamic range images.");
  ...
  script_tag(name:"affected", value:"'pfstools' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pfstools", rpm:"pfstools~2.1.0~17.fc34.1", rls:"FC34"))) {
    report += res;
  }
