...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-591b3a2af0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PM7MOYYHJSWLIFZ4TPJTD7MSA3HSSLV2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2021-591b3a2af0 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~94.0.4606.61~1.fc35", rls:"FC35"))) {
    report += res;
  }
