...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819395");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:24:53 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2021-79ba5abef6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SQBCYJUIM5GVCMFUPRWKRZNXMMI5EFA4");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~20.10.11~1.fc35", rls:"FC35"))) {
    report += res;
  }
