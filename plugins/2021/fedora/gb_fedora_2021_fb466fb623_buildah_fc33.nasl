...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878981");
  ...
  script_tag(name:"creation_date", value:"2021-02-26 04:05:09 +0000 (Fri, 26 Feb 2021)");
  script_name("Fedora: Security Advisory for buildah (FEDORA-2021-fb466fb623)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RAX6QM2U6UNK37KXRHYC53FAM2FIBDJK");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.19.6~2.fc33", rls:"FC33"))) {
    report += res;
  }
