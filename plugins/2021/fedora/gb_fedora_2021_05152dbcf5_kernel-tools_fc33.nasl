...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879627");
  ...
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2021-05152dbcf5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BCC4ZXDH7NGCJVCRNYFP5IX3ZVZVHAW6");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.11.20~200.fc33", rls:"FC33"))) {
    report += res;
  }
