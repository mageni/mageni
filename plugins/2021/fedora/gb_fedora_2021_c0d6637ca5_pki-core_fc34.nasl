...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879132");
  ...
  script_tag(name:"creation_date", value:"2021-03-20 04:07:05 +0000 (Sat, 20 Mar 2021)");
  script_name("Fedora: Security Advisory for pki-core (FEDORA-2021-c0d6637ca5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GZBAAHM4EBQMLBDFJ6NKQZTGQKLSEQXX");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pki-core", rpm:"pki-core~10.10.5~6.fc34", rls:"FC34"))) {
    report += res;
  }
