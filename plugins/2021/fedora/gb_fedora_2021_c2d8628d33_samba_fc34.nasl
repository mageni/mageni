...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879276");
  ...
  script_name("Fedora: Security Advisory for samba (FEDORA-2021-c2d8628d33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/X5J3B6PN5XMXF3OHYBNHDKZ3XFSUGY4L");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"samba", rpm:"samba~4.14.2~0.fc34", rls:"FC34"))) {
    report += res;
  }
