...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819305");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:21 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for vips (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LC5W6BHFGM6UOP7RZK7S3LJMBPR32DCL");
...
against VIPS.");
  ...
  script_tag(name:"affected", value:"'vips' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vips", rpm:"vips~8.11.3~1.fc34.1", rls:"FC34"))) {
    report += res;
  }
