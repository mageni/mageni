...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879529");
  ...
  script_tag(name:"creation_date", value:"2021-05-05 03:17:24 +0000 (Wed, 05 May 2021)");
  script_name("Fedora: Security Advisory for pngcheck (FEDORA-2021-3f001ba18b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-3f001ba18b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DGE643ALPDU76YXVRUPIB5FNWLYX3PXF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pngcheck'
  package(s) announced via the FEDORA-2021-3f001ba18b advisory.");
...
of the images in Chris Nokleberg&#39, s brokensuite-20061204.");
  ...
  script_tag(name:"affected", value:"'pngcheck' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pngcheck", rpm:"pngcheck~3.0.3~1.fc34", rls:"FC34"))) {
    report += res;
  }
