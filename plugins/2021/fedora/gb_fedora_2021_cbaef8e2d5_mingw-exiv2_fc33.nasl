...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879991");
  ...
  script_tag(name:"creation_date", value:"2021-08-20 06:59:00 +0000 (Fri, 20 Aug 2021)");
  script_name("Fedora: Security Advisory for mingw-exiv2 (FEDORA-2021-cbaef8e2d5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-cbaef8e2d5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UYGDELIFFJWKUU7SO3QATCIXCZJERGAC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-exiv2'
  package(s) announced via the FEDORA-2021-cbaef8e2d5 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-exiv2", rpm:"mingw-exiv2~0.27.4~3.fc33", rls:"FC33"))) {
    report += res;
  }
