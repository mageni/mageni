...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879606");
  ...
  script_tag(name:"creation_date", value:"2021-05-20 04:53:27 +0000 (Thu, 20 May 2021)");
  script_name("Fedora: Security Advisory for python-impacket (FEDORA-2021-888ccfd5b6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-888ccfd5b6");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IPXDPWCAPVX3UWYZ3N2T5OLBSBBUHJP6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-impacket'
  package(s) announced via the FEDORA-2021-888ccfd5b6 advisory.");
...
the object oriented API makes it simple to work with deep protocol hierarchies.");
  ...
  script_tag(name:"affected", value:"'python-impacket' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-impacket", rpm:"python-impacket~0.9.22~3.fc33", rls:"FC33"))) {
    report += res;
  }
