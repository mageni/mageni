...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878905");
  ...
  script_tag(name:"creation_date", value:"2021-02-09 04:02:24 +0000 (Tue, 09 Feb 2021)");
  script_name("Fedora: Security Advisory for pngcheck (FEDORA-2021-674d704f6c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-674d704f6c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XTD56567QSWLCTKBJNTCF6HB5GLJZCHX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pngcheck'
  package(s) announced via the FEDORA-2021-674d704f6c advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pngcheck", rpm:"pngcheck~2.4.0~7.fc33", rls:"FC33"))) {
    report += res;
  }
