...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878986");
  ...
  script_name("Fedora: Security Advisory for containernetworking-plugins (FEDORA-2021-fb466fb623)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/O2K6F4S5TE5ZEI2ZEJGC4XEC5QW7JORX");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containernetworking-plugins", rpm:"containernetworking-plugins~0.9.1~2.fc33", rls:"FC33"))) {
    report += res;
  }
