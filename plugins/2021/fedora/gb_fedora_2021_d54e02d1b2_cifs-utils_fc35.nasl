...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818575");
  ...
  script_name("Fedora: Security Advisory for cifs-utils (FEDORA-2021-d54e02d1b2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d54e02d1b2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Z4BZSJXROEFHYATAAHHRR6P3HUSMPQB3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cifs-utils'
  package(s) announced via the FEDORA-2021-d54e02d1b2 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cifs-utils", rpm:"cifs-utils~6.13~3.fc35", rls:"FC35"))) {
    report += res;
  }
