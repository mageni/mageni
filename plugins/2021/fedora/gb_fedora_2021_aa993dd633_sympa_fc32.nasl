...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879557");
  ...
  script_tag(name:"creation_date", value:"2021-05-09 03:10:57 +0000 (Sun, 09 May 2021)");
  script_name("Fedora: Security Advisory for sympa (FEDORA-2021-aa993dd633)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-aa993dd633");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/B5MFWWYY4TSQAXBWZ6SBFX43BLUL3WWI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sympa'
  package(s) announced via the FEDORA-2021-aa993dd633 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sympa", rpm:"sympa~6.2.62~1.fc32", rls:"FC32"))) {
    report += res;
  }
