...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879542");
  ...
  script_tag(name:"creation_date", value:"2021-05-07 03:16:11 +0000 (Fri, 07 May 2021)");
  script_name("Fedora: Security Advisory for djvulibre (FEDORA-2021-d781fa9f44)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d781fa9f44");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AFBA3B7ZE5WL3W3IC3SJOZLTIMZPKXES");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the FEDORA-2021-d781fa9f44 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"djvulibre", rpm:"djvulibre~3.5.27~28.fc34", rls:"FC34"))) {
    report += res;
  }
