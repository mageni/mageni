...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879023");
  ...
  script_name("Fedora: Security Advisory for pki-core (FEDORA-2021-dc1a4934a5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M7E5GXKGASGX7VDZ726HVDIBOLH67JZF");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pki-core", rpm:"pki-core~10.10.5~1.fc32", rls:"FC32"))) {
    report += res;
  }
