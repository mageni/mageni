...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819328");
  ...
  script_name("Fedora: Security Advisory for vdr-scraper2vdr (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7MA6V2TZ3UKZBFPCU5KHIDWYMWCDHHIC");
...
not longer needed.");
  ...
  script_tag(name:"affected", value:"'vdr-scraper2vdr' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vdr-scraper2vdr", rpm:"vdr-scraper2vdr~1.0.11~14.20190128gitd9f6cb4.fc34.1", rls:"FC34"))) {
    report += res;
  }
