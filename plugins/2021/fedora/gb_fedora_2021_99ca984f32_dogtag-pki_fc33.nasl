...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879776");
  ...
  script_name("Fedora: Security Advisory for dogtag-pki (FEDORA-2021-99ca984f32)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KA2UZLAZP3BOUPGWY27H4QXFE2UOQWYV");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dogtag-pki", rpm:"dogtag-pki~10.10.6~1.fc33", rls:"FC33"))) {
    report += res;
  }
