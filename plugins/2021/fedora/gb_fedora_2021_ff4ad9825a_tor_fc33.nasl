...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879779");
  ...
  script_tag(name:"creation_date", value:"2021-06-24 05:39:18 +0000 (Thu, 24 Jun 2021)");
  script_name("Fedora: Security Advisory for tor (FEDORA-2021-ff4ad9825a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-ff4ad9825a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/J24TLBUQ7QPSFBYL2CAABEQZDVFTS5EC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2021-ff4ad9825a advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.5.9~1.fc33", rls:"FC33"))) {
    report += res;
  }
