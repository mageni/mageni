...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-904d0bd496");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TW3ZSJTTMZAFKGW7NJWTVVFZUYYU2SJZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dotnet5.0'
  package(s) announced via the FEDORA-2021-904d0bd496 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dotnet5.0", rpm:"dotnet5.0~5.0.104~1.fc34", rls:"FC34"))) {
    report += res;
  }
