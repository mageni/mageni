...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819192");
  ...
  script_name("Fedora: Security Advisory for autotrace (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Z6PWCAXLB55TT4LEDSLNOJ54DXVRXUPZ");
...
Postscript, SVG, xfig, SWF, and others.");
  ...
  script_tag(name:"affected", value:"'autotrace' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"autotrace", rpm:"autotrace~0.31.1~62.fc35", rls:"FC35"))) {
    report += res;
  }
