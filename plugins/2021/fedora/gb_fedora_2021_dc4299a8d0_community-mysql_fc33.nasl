...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817775");
  ...
  script_tag(name:"creation_date", value:"2021-08-26 03:11:16 +0000 (Thu, 26 Aug 2021)");
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2021-dc4299a8d0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-dc4299a8d0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6OO2Q5PIFURXLLKCIJE6XF6VL4LLMNO5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'community-mysql'
  package(s) announced via the FEDORA-2021-dc4299a8d0 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.26~1.fc33", rls:"FC33"))) {
    report += res;
  }
