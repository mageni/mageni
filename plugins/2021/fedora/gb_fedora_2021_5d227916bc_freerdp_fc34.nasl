...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819347");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:24:52 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for freerdp (FEDORA-2021-5d227916bc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/F4Y4JBBKKZEEBXUVDTGUNI6CT4H2GIDM");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freerdp", rpm:"freerdp~2.4.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
