...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879066");
  script_version("2021-03-17T09:33:35+0000");
  script_cve_id("CVE-2021-22881", "CVE-2021-22880");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2021-03-17 11:26:15 +0000 (Wed, 17 Mar 2021)");
  script_tag(name:"creation_date", value:"2021-03-13 04:03:04 +0000 (Sat, 13 Mar 2021)");
  script_name("Fedora: Security Advisory for rubygem-actionpack (FEDORA-2021-b571fca1b8)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XQ3NS4IBYE2I3MVMGAHFZBZBIZGHXHT3");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~6.0.3.4~2.fc33", rls:"FC33"))) {
    report += res;
  }
