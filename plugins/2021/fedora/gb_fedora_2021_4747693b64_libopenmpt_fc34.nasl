...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817765");
  ...
  script_tag(name:"creation_date", value:"2021-08-27 07:13:43 +0000 (Fri, 27 Aug 2021)");
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2021-4747693b64)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-4747693b64");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IFPRAIBLMZHE72LGATSJ65JSXAH6AMYT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2021-4747693b64 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenmpt", rpm:"libopenmpt~0.5.11~1.fc34", rls:"FC34"))) {
    report += res;
  }
