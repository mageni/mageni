...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819377");
  ...
  script_name("Fedora: Security Advisory for guacamole-server (FEDORA-2021-5d227916bc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KMLNN7AOCFDXBU3O2CHZJH5UIL23BK5V");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"guacamole-server", rpm:"guacamole-server~1.3.0~9.fc34", rls:"FC34"))) {
    report += res;
  }
