...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879476");
  ...
  script_name("Fedora: Security Advisory for openvpn (FEDORA-2021-b805c26afa)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-b805c26afa");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PLDB3OBQ3AODYYRN7NRCABV6I4AUFAT6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openvpn'
  package(s) announced via the FEDORA-2021-b805c26afa advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openvpn", rpm:"openvpn~2.5.2~1.fc34", rls:"FC34"))) {
    report += res;
  }
