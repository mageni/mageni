...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819039");
  ...
  script_tag(name:"creation_date", value:"2021-10-21 01:24:53 +0000 (Thu, 21 Oct 2021)");
  script_name("Fedora: Security Advisory for grafana (FEDORA-2021-dd83dc8b0b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-dd83dc8b0b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/E6ANHRDBXQT6TURLP2THM26ZPDINFBEG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'grafana'
  package(s) announced via the FEDORA-2021-dd83dc8b0b advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grafana", rpm:"grafana~7.5.11~1.fc34", rls:"FC34"))) {
    report += res;
  }
