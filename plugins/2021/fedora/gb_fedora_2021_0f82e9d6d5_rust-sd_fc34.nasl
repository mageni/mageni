...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879959");
  ...
  script_tag(name:"creation_date", value:"2021-08-16 09:24:05 +0000 (Mon, 16 Aug 2021)");
  script_name("Fedora: Security Advisory for rust-sd (FEDORA-2021-0f82e9d6d5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-0f82e9d6d5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OCLMH7B7B2MF55ET4NQNPH7JWISFX4RT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust-sd'
  package(s) announced via the FEDORA-2021-0f82e9d6d5 advisory.");
  ...
  * Smart, common-sense defaults
  ...
  script_tag(name:"affected", value:"'rust-sd' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-sd", rpm:"rust-sd~0.7.6~4.fc34", rls:"FC34"))) {
    report += res;
  }
