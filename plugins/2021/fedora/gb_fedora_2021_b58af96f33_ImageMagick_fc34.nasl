...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819320");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:17 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for ImageMagick (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BIM24EEJUSMYVXBXF4TT5AGITDMWKPGY");
...
ImageMagick-devel as well.");
  ...
  script_tag(name:"affected", value:"'ImageMagick' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~6.9.12.31~1.fc34", rls:"FC34"))) {
    report += res;
  }
