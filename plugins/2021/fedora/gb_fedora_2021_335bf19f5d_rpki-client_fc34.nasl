...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819176");
  ...
  script_name("Fedora: Security Advisory for rpki-client (FEDORA-2021-335bf19f5d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-335bf19f5d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PX6DUQ4X555XLRNKWNCIAOXMJ25CM3HO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client'
  package(s) announced via the FEDORA-2021-335bf19f5d advisory.");
...
also as CSV or JSON objects for consumption by other routing stacks.");
  ...
  script_tag(name:"affected", value:"'rpki-client' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~7.4~1.fc34", rls:"FC34"))) {
    report += res;
  }
