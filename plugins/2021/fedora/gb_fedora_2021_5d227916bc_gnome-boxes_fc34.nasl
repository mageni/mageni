...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819358");
  ...
  script_name("Fedora: Security Advisory for gnome-boxes (FEDORA-2021-5d227916bc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CRD4GK7LVKH4NHDXPNVLSLO25IHLVLMT");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-boxes", rpm:"gnome-boxes~40.3~2.fc34", rls:"FC34"))) {
    report += res;
  }
