...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878811");
  ...
  script_tag(name:"creation_date", value:"2021-01-14 09:51:31 +0000 (Thu, 14 Jan 2021)");
  script_name("Fedora: Security Advisory for adplug (FEDORA-2021-64168929e4)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LSWX4PRPYGJLOEXBKYDMGSM2RSARMRZK");
...
hardware. No OPL2/3 chips are required for playback.");
  ...
  script_tag(name:"affected", value:"'adplug' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"adplug", rpm:"adplug~2.3.3~1.fc33", rls:"FC33"))) {
    report += res;
  }
