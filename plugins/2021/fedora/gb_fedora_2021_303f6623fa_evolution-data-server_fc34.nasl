...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879190");
  ...
  script_tag(name:"creation_date", value:"2021-03-20 04:08:30 +0000 (Sat, 20 Mar 2021)");
  script_name("Fedora: Security Advisory for evolution-data-server (FEDORA-2021-303f6623fa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IF4POXHISHPFKAV7F6ZVS3HWPB6NTPIP");
...
by other packages.");
  ...
  script_tag(name:"affected", value:"'evolution-data-server' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"evolution-data-server", rpm:"evolution-data-server~3.39.3~1.fc34", rls:"FC34"))) {
    report += res;
  }
