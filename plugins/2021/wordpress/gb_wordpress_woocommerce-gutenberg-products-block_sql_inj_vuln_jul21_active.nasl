...
if(description)
{
  ...
  script_version("2021-07-21T10:00:11+0000");
...
# nb: Those are the endpoints which are added by the WooCommerce Blocks to the WordPress API once
# enabled. These are no checks for the WooCommerce plugin itself.
urls = make_list(
  # "Pretty" links
