...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883362");
  ...
  script_tag(name:"creation_date", value:"2021-07-16 03:01:29 +0000 (Fri, 16 Jul 2021)");
  script_name("CentOS: Security Advisory for firefox (CESA-2021:2741)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2021:2741");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2021-July/048343.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2021:2741 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~78.12.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
