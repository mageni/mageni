...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883329");
  ...
  script_tag(name:"creation_date", value:"2021-02-28 04:00:38 +0000 (Sun, 28 Feb 2021)");
  script_name("CentOS: Security Advisory for thunderbird (CESA-2021:0661)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2021:0661");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2021-February/048280.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the CESA-2021:0661 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~78.8.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
