...
if(description)
{
  ...
  script_version("2021-02-11T04:00:04+0000");
  # TODO: No CVE assigned yet. Check https://github.com/facebook/zstd/issues/1630 and https://security-tracker.debian.org/tracker/TEMP-0981404-911A2F
  ...
  script_name("Debian: Security Advisory for libzstd (DSA-4850-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4850.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4850-1");
  ...
  package(s) announced via the DSA-4850-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that zstd, a compression utility, temporarily
