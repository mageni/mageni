...
if(description)
{
  ...
  script_version("2021-06-11T03:00:06+0000");
  ...
  script_name("Debian: Security Advisory for rails (DSA-4929-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4929.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4929-1");
  ...
  package(s) announced via the DSA-4929-1 advisory.");
