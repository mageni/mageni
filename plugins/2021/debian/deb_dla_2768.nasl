...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for uwsgi (DLA-2768-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/09/msg00016.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2768-1");
  ...
  package(s) announced via the DLA-2768-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the uwsgi proxy module for Apache2
