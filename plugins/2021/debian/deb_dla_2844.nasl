...
if(description)
{
  ...
  script_version("2021-12-14T02:00:09+0000");
  script_cve_id("CVE-2021-44540", "CVE-2021-44543");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2021-12-14 02:00:09 +0000 (Tue, 14 Dec 2021)");
  script_tag(name:"creation_date", value:"2021-12-14 02:00:09 +0000 (Tue, 14 Dec 2021)");
  script_name("Debian LTS: Security Advisory for privoxy (DLA-2844-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/12/msg00008.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2844-1");
  ...
  package(s) announced via the DLA-2844-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Artem Ivanov and Joshua Rogers found an XSS and a DOS issue,
