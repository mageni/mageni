...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libextractor (DLA-2851-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/12/msg00016.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2851-1");
  script_xref(name:"Advisory-ID", value:"DLA-2851-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/935553");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libextractor'
  package(s) announced via the DLA-2851-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Invalid read for malformed DVI files was fixed in GNU libextractor,
