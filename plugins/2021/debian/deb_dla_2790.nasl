...
if(description)
{
  ...
  script_version("2021-10-22T01:00:10+0000");
  script_cve_id("CVE-2021-20095", "CVE-2021-42771");
  ...
  script_name("Debian LTS: Security Advisory for python-babel (DLA-2790-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/10/msg00018.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2790-1");
  script_xref(name:"Advisory-ID", value:"DLA-2790-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/987824");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-babel'
  package(s) announced via the DLA-2790-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tenable discovered that in Babel, a set of tools for
