...
if(description)
{
  ...
  script_version("2021-01-27T04:00:06+0000");
  ...
  script_name("Debian: Security Advisory for mutt (DSA-4838-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4838.html");
  script_xref(name:"Advisory-ID", value:"DSA-4838-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4838-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mutt'
  package(s) announced via the DSA-4838-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tavis Ormandy discovered a memory leak flaw in the rfc822 group recipient
