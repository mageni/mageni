...
if(description)
{
  ...
  script_version("2021-09-28T01:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for libxml-security-java (DLA-2767-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/09/msg00015.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2767-1");
  script_xref(name:"Advisory-ID", value:"DLA-2767-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/994569");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml-security-java'
  package(s) announced via the DLA-2767-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libxml-security-java", ver:"1.5.8-2+deb9u1", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libxml-security-java-doc", ver:"1.5.8-2+deb9u1", rls:"DEB9"))) {
  report += res;
}
