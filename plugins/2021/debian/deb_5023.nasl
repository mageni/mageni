...
if(description)
{
  ...
  script_name("Debian: Security Advisory for modsecurity-apache (DSA-5023-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5023.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5023-1");
  script_xref(name:"Advisory-ID", value:"DSA-5023-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'modsecurity-apache'
  package(s) announced via the DSA-5023-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that modsecurity-apache, an Apache module to tighten
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-security2", ver:"2.9.3-3+deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-security2", ver:"2.9.3-1+deb10u1", rls:"DEB10"))) {
  report += res;
}
