...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112905");
  script_version("2021-06-11T05:43:38+0000");
  ...
  script_name("Apache HTTP Server < 2.4.48 NULL Pointer Dereference Vulnerability - Linux");
  ...
  script_tag(name:"affected", value:"Apache HTTP Server before version 2.4.48 on Linux.");
