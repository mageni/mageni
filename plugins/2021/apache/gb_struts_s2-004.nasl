...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117660");
  script_version("2021-09-15T06:29:39+0000");
  ...
  script_name("Apache Struts Security Update (S2-004)");
  ...
  script_tag(name:"affected", value:"Apache Struts 2.0.0 through 2.0.11.2 and 2.1.0 through 2.1.2.");
...
if (version_in_range(version: version, test_version: "2.0.0", test_version2: "2.0.11.2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.0.12", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "2.1.0", test_version2: "2.1.2")) {
