...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112898");
  ...
  script_name("Apache HTTP Server 2.4.6 - 2.4.46 Tunneling Misconfiguration Vulnerability - Linux");
  ...
  script_tag(name:"affected", value:"Apache HTTP Server versions 2.4.6 to 2.4.46 on Linux.");
