...
if(description)
{
  ...
  script_version("2021-03-16T03:09:58+0000");
  ...
  script_tag(name:"insight", value:"NetTest web service can be used to overload the bandwidth of the server.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Apache OpenMeetings version 4.0.0 - 5.1.0.");
