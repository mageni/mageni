...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112901");
  ...
  script_name("Apache HTTP Server 2.4.41 - 2.4.46 NULL Pointer Dereference Vulnerability - Linux");
  ...
  script_tag(name:"affected", value:"Apache HTTP Server versions 2.4.41 to 2.4.46 on Linux.");
