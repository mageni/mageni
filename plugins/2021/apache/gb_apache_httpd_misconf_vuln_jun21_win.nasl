...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112899");
  ...
  script_cve_id("CVE-2019-17567");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Apache HTTP Server 2.4.6 - 2.4.46 Tunneling Misconfiguration Vulnerability - Windows");
  ...
  script_tag(name:"summary", value:"Apache HTTP Server is prone to a tunneling misconfiguration
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"mod_proxy_wstunnel configured on an URL that is not necessarily
  ...
  script_tag(name:"affected", value:"Apache HTTP Server versions 2.4.6 to 2.4.46 on Windows.");
...
if( version_in_range( version:version, test_version:"2.4.6", test_version2:"2.4.46" ) ) {
