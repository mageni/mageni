...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117667");
  ...
  script_name("Apache Struts Security Update (S2-013, S2-014)");
...
if (version_in_range(version: version, test_version: "2.0.0", test_version2: "2.3.14.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.3.14.2", install_path: location);
