...
if(description)
{
  ...
  script_version("2021-08-09T07:57:19+0000");
  ...
  a Stored XSS vulnerability on on 'Logic' via 'Content Manager'.

  Vendor statement: 'The Logic field is meant to put code in and it is only accessible for
