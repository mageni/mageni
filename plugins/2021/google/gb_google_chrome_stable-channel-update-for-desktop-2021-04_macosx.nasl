...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818037");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2021-04)-MAC OS X");
  ...
  prior to 89.0.4389.128 on MAC OS X");
