...
# $Id: deb_2807.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"links2 on Debian Linux");
...
We recommend that you upgrade your links2 packages.");
  script_tag(name:"summary", value:"Mikulas Patocka discovered an integer overflow in the parsing of HTML
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"links", ver:"2.3~pre1-1+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"links2", ver:"2.3~pre1-1+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"links", ver:"2.7-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"links2", ver:"2.7-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
