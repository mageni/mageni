...
# $Id: gb_ubuntu_USN_1871_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xserver-xorg-video-openchrome'
  ...
  script_tag(name:"affected", value:"xserver-xorg-video-openchrome on Ubuntu 13.04,
  Ubuntu 12.10,
  Ubuntu 12.04 LTS");
