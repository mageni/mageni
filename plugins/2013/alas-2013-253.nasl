...
# $Id: alas-2013-253.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-253");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"mod_nss", rpm:"mod_nss~1.0.8~19.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mod_nss-debuginfo", rpm:"mod_nss-debuginfo~1.0.8~19.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
