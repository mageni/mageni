...
if(description)
{
  ...
  script_tag(name:"affected", value:"php-symfony2-ClassLoader on Fedora 18");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-symfony2-ClassLoader'
