...
#
# RedHat Update for pixman RHSA-2013:0687-01
#
# Authors:
...
if(release == "RHENT_6")
{
  ...
  if ((res = isrpmvuln(pkg:"pixman", rpm:"pixman~0.26.2~5.0.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pixman-debuginfo", rpm:"pixman-debuginfo~0.26.2~5.0.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pixman-devel", rpm:"pixman-devel~0.26.2~5.0.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
