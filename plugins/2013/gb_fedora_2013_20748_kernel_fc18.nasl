...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867054");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-11-18 11:18:09 +0530 (Mon, 18 Nov 2013)");
  ...
  script_name("Fedora Update for kernel FEDORA-2013-20748");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121586.html");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.11.7~100.fc18", rls:"FC18")) != NULL)
  {
