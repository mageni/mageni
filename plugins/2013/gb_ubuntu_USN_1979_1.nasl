...
# $Id: gb_ubuntu_USN_1979_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"txt2man on Ubuntu 13.04,
  Ubuntu 12.10,
  Ubuntu 12.04 LTS");
...
installation, this should be prevented by the Yama link restrictions.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1979-1/");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'txt2man'
