...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864978");
  ...
  script_tag(name:"affected", value:"php-symfony2-HttpKernel on Fedora 16");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"php-symfony2-HttpKernel", rpm:"php-symfony2-HttpKernel~2.0.21~1.fc16", rls:"FC16")) != NULL)
  {
