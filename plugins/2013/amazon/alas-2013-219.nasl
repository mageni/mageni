...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-219)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"puppet-debuginfo", rpm:"puppet-debuginfo~2.7.23~1.0.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"puppet", rpm:"puppet~2.7.23~1.0.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"puppet-server", rpm:"puppet-server~2.7.23~1.0.amzn1", rls:"AMAZON"))) {
    report += res;
  }
