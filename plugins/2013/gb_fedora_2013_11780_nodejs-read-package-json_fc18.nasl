...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866355");
  ...
  script_tag(name:"affected", value:"nodejs-read-package-json on Fedora 18");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs-read-package-json'
