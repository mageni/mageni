...
# $Id: alas-2013-243.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-243");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"python-crypto-debuginfo", rpm:"python-crypto-debuginfo~2.6.1~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python-crypto", rpm:"python-crypto~2.6.1~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
