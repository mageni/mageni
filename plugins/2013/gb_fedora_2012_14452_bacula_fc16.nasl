...
#
# Fedora Update for bacula FEDORA-2012-14452
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.865245");
  ...
  script_tag(name:"affected", value:"bacula on Fedora 16");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"bacula", rpm:"bacula~5.0.3~33.fc16", rls:"FC16")) != NULL)
  {
