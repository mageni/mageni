...
# $Id: gb_adobe_shockwave_player_mult_vuln01_jul13_macosx.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_name("Adobe Shockwave Player Multiple Vulnerabilities-01 July13 (Mac OS X)");
