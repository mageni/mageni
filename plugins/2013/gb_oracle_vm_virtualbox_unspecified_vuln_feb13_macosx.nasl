...
# $Id: gb_oracle_vm_virtualbox_unspecified_vuln_feb13_macosx.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
vmVer = get_kb_item("Oracle/VirtualBox/MacOSX/Version");

if(vmVer && vmVer =~ "^4\.[0-2]")
{
