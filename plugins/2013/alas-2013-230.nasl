...
# $Id: alas-2013-230.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-230");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"rubygems-devel", rpm:"rubygems-devel~1.8.25~7.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"rubygems", rpm:"rubygems~1.8.25~7.12.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
