...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2013-February/098831.html");
  script_oid("1.3.6.1.4.1.25623.1.0.865361");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-02-18 11:11:06 +0530 (Mon, 18 Feb 2013)");
  script_cve_id("CVE-2013-0215", "CVE-2013-0153", "CVE-2012-6075", "CVE-2012-5634",
  ...
  script_name("Fedora Update for xen FEDORA-2013-2002");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"xen", rpm:"xen~4.1.4~4.fc17", rls:"FC17")) != NULL)
  {
