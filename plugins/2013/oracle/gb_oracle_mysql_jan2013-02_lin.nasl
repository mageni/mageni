...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117202");
  ...
  script_name("Oracle MySQL <= 5.1.66 / 5.5 <= 5.5.28 Security Update (cpujan2013) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 5.1.66 and prior, 5.5 versions 5.5.28 and prior.");
