...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117209");
  ...
  script_cve_id("CVE-2013-1521", "CVE-2013-1552", "CVE-2013-1555", "CVE-2012-5614");
  ...
  script_name("Oracle MySQL <= 5.1.67 / 5.5 <= 5.5.29 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.1.67 and prior, 5.5.29 and prior.");

  script_tag(name:"solution", value:"Update to version 5.1.68, 5.5.30 or later.");
