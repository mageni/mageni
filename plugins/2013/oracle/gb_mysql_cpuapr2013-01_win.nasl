...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117206");
  ...
  script_cve_id("CVE-2013-2378", "CVE-2013-1506");
  ...
  script_name("Oracle MySQL <= 5.1.67 / 5.5 <= 5.5.29 / 5.6 <= 5.6.10 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.1.67 and prior, 5.5.29 and prior, 5.6.10 and prior.");

  script_tag(name:"solution", value:"Update to version 5.1.68, 5.5.30, 5.6.11 or later.");
...
if (version_is_less_equal(version: version, test_version: "5.1.67")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.1.68", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

else if (version_in_range(version: version, test_version: "5.5", test_version2: "5.5.29")) {
