...
#
# Fedora Update for konsole FEDORA-2013-13499
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866399");
  ...
  script_name("Fedora Update for konsole FEDORA-2013-13499");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"konsole", rpm:"konsole~4.10.5~1.fc17", rls:"FC17")) != NULL)
  {
