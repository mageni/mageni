...
# $Id: gb_sea_monkey_mult_vuln01_feb13_macosx.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"SeaMonkey Version prior to 2.16 on Mac OS X");
