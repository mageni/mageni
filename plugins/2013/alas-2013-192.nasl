...
# $Id: alas-2013-192.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"openswan-doc", rpm:"openswan-doc~2.6.37~2.16.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"openswan-debuginfo", rpm:"openswan-debuginfo~2.6.37~2.16.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"openswan", rpm:"openswan~2.6.37~2.16.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
