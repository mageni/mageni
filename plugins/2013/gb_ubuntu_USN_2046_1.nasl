...
# $Id: gb_ubuntu_USN_2046_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-12-04 10:12:54 +0530 (Wed, 04 Dec 2013)");
  script_cve_id("CVE-2013-4299", "CVE-2013-4470");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-2046-1");
...
administrative privileges. (CVE-2013-4470)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2046-1/");
...
if(release == "UBUNTU13.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-236-omap4", ver:"3.5.0-236.52", rls:"UBUNTU13.04")) != NULL)
  {
