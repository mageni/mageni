...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867163");
  ...
  script_name("Fedora Update for nbd FEDORA-2013-22610");


  script_tag(name:"affected", value:"nbd on Fedora 19");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"nbd", rpm:"nbd~3.5~1.fc19", rls:"FC19")) != NULL)
  {
