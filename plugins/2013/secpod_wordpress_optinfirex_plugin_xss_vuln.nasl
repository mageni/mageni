...
# $Id: secpod_wordpress_optinfirex_plugin_xss_vuln.nasl 11401 2018-09-15 08:45:50Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with WordPress Optinfirex plugin and is prone to
