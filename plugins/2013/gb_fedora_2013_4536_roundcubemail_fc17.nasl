...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.865536");
  ...
  script_name("Fedora Update for roundcubemail FEDORA-2013-4536");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.8.6~1.fc17", rls:"FC17")) != NULL)
  {
