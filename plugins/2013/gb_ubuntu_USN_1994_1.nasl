...
# $Id: gb_ubuntu_USN_1994_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-10-29 16:20:51 +0530 (Tue, 29 Oct 2013)");
  script_cve_id("CVE-2013-2147");
  script_tag(name:"cvss_base", value:"2.1");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_name("Ubuntu Update for linux-lts-quantal USN-1994-1");
...
exploit this flaw to obtain sensitive information from kernel memory.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1994-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-42-generic", ver:"3.5.0-42.65~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
