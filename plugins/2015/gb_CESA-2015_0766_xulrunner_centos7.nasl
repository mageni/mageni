...
#
# CentOS Update for xulrunner CESA-2015:0766 centos7
#
# Authors:
...
if(description)
{
  ...
  script_name("CentOS Update for xulrunner CESA-2015:0766 centos7");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~31.6.0~2.el7.centos", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~31.6.0~2.el7.centos", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
