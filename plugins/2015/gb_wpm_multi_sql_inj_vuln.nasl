...
# $Id: gb_wpm_multi_sql_inj_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if (description)
{
  ...
  script_name("SolarWinds Web Performance Monitor Multiple SQL Injection Vulnerabilities");
  ...
  script_tag(name:"summary", value:"SolarWinds Web Performance Monitor is prone to multiple
