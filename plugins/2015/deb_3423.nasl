...
# $Id: deb_3423.nasl 14278 2019-03-18 14:47:26Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u7", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8f+ds1-3", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8b+dfsg-8+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
