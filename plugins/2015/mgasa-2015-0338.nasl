...
# $Id: mgasa-2015-0338.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-15 10:42:01 +0300 (Thu, 15 Oct 2015)");
  script_tag(name:"last_modification", value:"$Date: 2018-09-28 18:55:19 +0200 (Fri, 28 Sep 2018) $");
  script_name("Mageia Linux Local Check: mgasa-2015-0338");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0338");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"lighttpd", rpm:"lighttpd~1.4.37~1.mga5", rls:"MAGEIA5")) != NULL) {
