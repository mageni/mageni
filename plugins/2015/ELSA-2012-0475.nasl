...
# $Id: ELSA-2012-0475.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(release == "OracleLinux6")
{
  ...
  if ((res = isrpmvuln(pkg:"tomcat6-el", rpm:"tomcat6-el~2.1~api~6.0.24~36.el6_2", rls:"OracleLinux6")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"tomcat6-jsp", rpm:"tomcat6-jsp~2.1~api~6.0.24~36.el6_2", rls:"OracleLinux6")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"tomcat6-servlet", rpm:"tomcat6-servlet~2.5~api~6.0.24~36.el6_2", rls:"OracleLinux6")) != NULL) {
    security_message(data:res);
    exit(0);
  }
