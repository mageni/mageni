...
# $Id: ELSA-2007-0157.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2007-0157 -  Moderate: xorg-x11-apps/libX11 security updates. Please see the references for more insight.");
