...
#
# Ubuntu Update for freetype USN-2739-1
#
# Authors:
...
or hang, resulting in a denial of service, or possibly expose uninitialized
memory.");
  script_tag(name:"affected", value:"freetype on Ubuntu 14.04 LTS,
  Ubuntu 12.04 LTS");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libfreetype6:amd64", ver:"2.5.2-1ubuntu2.5", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libfreetype6:i386", ver:"2.5.2-1ubuntu2.5", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libfreetype6", ver:"2.4.8-1ubuntu2.3", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
