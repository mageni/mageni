...
# $Id: ELSA-2008-0233.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2008-0233 - kernel security and bug fix update. Please see the references for more insight.");
