...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.806140");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-10-24 07:56:21 +0200 (Sat, 24 Oct 2015)");
  script_cve_id("CVE-2015-5291");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("Fedora Update for mbedtls FEDORA-2015-7");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"mbedtls", rpm:"mbedtls~1.3.14~1.fc22", rls:"FC22")) != NULL)
  {
