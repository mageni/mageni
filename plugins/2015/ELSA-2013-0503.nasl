...
# $Id: ELSA-2013-0503.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2013-0503 - 389-ds-base security, bug fix, and enhancement update. Please see the references for more insight.");
