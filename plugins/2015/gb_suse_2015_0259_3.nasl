...
# $Id: gb_suse_2015_0259_3.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for ntp SUSE-SU-2015:0259-3 (ntp)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for ntp SUSE-SU-2015:0259-3 (ntp)");
...
if(release == "SLES11.0SP1")
{
  ...
  if ((res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.4p8~1.29.32.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.4p8~1.29.32.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
