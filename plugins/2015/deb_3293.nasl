...
# $Id: deb_3293.nasl 14275 2019-03-18 14:39:45Z cfischer $
# Auto-generated from advisory DSA 3293-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 3293-1 (pyjwt - security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-03-18 15:39:45 +0100 (Mon, 18 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-06-20 00:00:00 +0200 (Sat, 20 Jun 2015)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");

  script_xref(name:"URL", value:"http://www.debian.org/security/2015/dsa-3293.html");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-jwt", ver:"0.2.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python3-jwt", ver:"0.2.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
