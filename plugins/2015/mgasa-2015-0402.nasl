...
# $Id: mgasa-2015-0402.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0402.html");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"389-ds-base", rpm:"389-ds-base~1.3.3.13~1.mga5", rls:"MAGEIA5")) != NULL) {
