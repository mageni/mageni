...
#
# Fedora Update for nss-util FEDORA-2015-9161
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-June/160116.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.19.1~1.0.fc20", rls:"FC20")) != NULL)
  {
