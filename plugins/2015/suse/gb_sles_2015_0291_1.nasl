...
if(description)
{
  ...
  script_cve_id("CVE-2014-9328","CVE-2015-1461","CVE-2015-1462");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0291-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-February/001226.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'clamav'
  package(s) announced via the SUSE-SU-2015:0291-1 advisory.");
