...
if(description)
{
  ...
  script_cve_id("CVE-2013-5704","CVE-2014-3581","CVE-2014-8109");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0974-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-June/001415.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'apache2'
  package(s) announced via the SUSE-SU-2015:0974-1 advisory.");
