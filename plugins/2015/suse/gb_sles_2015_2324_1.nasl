...
if(description)
{
  ...
  script_cve_id("CVE-2015-3259","CVE-2015-4106","CVE-2015-5154");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:2324-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-December/001743.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2015:2324-1 advisory.");
