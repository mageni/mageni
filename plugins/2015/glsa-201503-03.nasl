...
# $Id: glsa-201503-03.nasl 12128 2018-10-26 13:35:25Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security.gentoo.org/glsa/201503-03");
  ...
  script_tag(name:"summary", value:"Gentoo Linux Local Security Checks GLSA 201503-03");
...
if((res=ispkgvuln(pkg:"dev-lang/php", unaffected: make_list("ge 5.5.21"), vulnerable: make_list() )) != NULL) {
...
if((res=ispkgvuln(pkg:"dev-lang/php", unaffected: make_list(), vulnerable: make_list("lt 5.5.21"))) != NULL) {
  report += res;
}
