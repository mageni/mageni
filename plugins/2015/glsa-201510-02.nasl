...
# $Id: glsa-201510-02.nasl 12128 2018-10-26 13:35:25Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security.gentoo.org/glsa/201510-02");
  ...
  script_tag(name:"summary", value:"Gentoo Linux Local Security Checks GLSA 201510-02");
...
if((res=ispkgvuln(pkg:"app-emulation/qemu", unaffected: make_list("ge 2.3.0-r4"), vulnerable: make_list("lt 2.3.0-r4"))) != NULL) {
  report += res;
}
