...
# $Id: gb_apache_http_dos_vuln_aug15_win.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
# Apache HTTP Server Denial Of Service Vulnerability August15 (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Apache HTTP Server version 2.4.12 on windows.");
...
if(version_is_equal(version:httpd_ver, test_version:"2.4.12"))
{
