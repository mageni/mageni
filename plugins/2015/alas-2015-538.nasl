...
# $Id: alas-2015-538.nasl 7335 2017-10-02 11:53:53Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2015-538");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"389-ds-base-devel", rpm:"389-ds-base-devel~1.3.3.1~16.41.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"389-ds-base-libs", rpm:"389-ds-base-libs~1.3.3.1~16.41.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"389-ds-base", rpm:"389-ds-base~1.3.3.1~16.41.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"389-ds-base-debuginfo", rpm:"389-ds-base-debuginfo~1.3.3.1~16.41.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
