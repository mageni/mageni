...
if(description)
{
  ...
  script_name("Fedora Update for php-ZendFramework2 FEDORA-2015-13488");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"php-ZendFramework2", rpm:"php-ZendFramework2~2.4.7~1.fc21", rls:"FC21")) != NULL)
  {
