...
# $Id: gb_suse_2014_1220_3.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for mozilla-nss SUSE-SU-2014:1220-3 (mozilla-nss)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for mozilla-nss SUSE-SU-2014:1220-3 (mozilla-nss)");
...
if(release == "SLES11.0SP1")
{
  ...
  if ((res = isrpmvuln(pkg:"libfreebl3", rpm:"libfreebl3~3.16.5~0.4.2.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"mozilla-nss", rpm:"mozilla-nss~3.16.5~0.4.2.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"mozilla-nss-tools", rpm:"mozilla-nss-tools~3.16.5~0.4.2.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libfreebl3-32bit", rpm:"libfreebl3-32bit~3.16.5~0.4.2.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"mozilla-nss-32bit", rpm:"mozilla-nss-32bit~3.16.5~0.4.2.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
