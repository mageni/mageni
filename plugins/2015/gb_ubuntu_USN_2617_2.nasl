...
#
# Ubuntu Update for ntfs-3g USN-2617-2
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for ntfs-3g USN-2617-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"USN-2617-1 fixed a vulnerability in FUSE.
This update provides the corresponding fix for the embedded FUSE copy in NTFS-3G.
...
A local attacker could use this issue to gain administrative privileges.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2617-2/");
...
if(release == "UBUNTU15.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"ntfs-3g", ver:"1:2014.2.15AR.3-1ubuntu0.1", rls:"UBUNTU15.04")) != NULL)
  {
