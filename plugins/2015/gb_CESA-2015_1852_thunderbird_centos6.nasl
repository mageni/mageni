...
#
# CentOS Update for thunderbird CESA-2015:1852 centos6
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882293");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-10-02 07:11:02 +0200 (Fri, 02 Oct 2015)");
  ...
  script_name("CentOS Update for thunderbird CESA-2015:1852 centos6");
...
to take effect.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-October/021422.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~38.3.0~1.el6.centos", rls:"CentOS6")) != NULL)
  {
