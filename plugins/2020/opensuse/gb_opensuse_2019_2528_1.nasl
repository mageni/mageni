...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.852957");
  ...
  script_tag(name:"creation_date", value:"2020-01-09 09:47:43 +0000 (Thu, 09 Jan 2020)");
  script_name("openSUSE Update for ucode-intel openSUSE-SU-2019:2528-1 (ucode-intel)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2019:2528_1 advisory.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20191112a~lp151.2.12.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
