...
if(description)
{
  ...
  script_name("openSUSE Update for bind openSUSE-SU-2019:2265-1 (bind)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00013.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind'
  package(s) announced via the openSUSE-SU-2019:2265_1 advisory.");
