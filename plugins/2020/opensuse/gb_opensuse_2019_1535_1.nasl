...
if(description)
{
  ...
  script_name("openSUSE Update for bubblewrap openSUSE-SU-2019:1535-1 (bubblewrap)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00028.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bubblewrap'
  package(s) announced via the openSUSE-SU-2019:1535_1 advisory.");
