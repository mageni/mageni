...
if(description)
{
  ...
  script_name("openSUSE Update for dhcp openSUSE-SU-2019:2341-1 (dhcp)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00048.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dhcp'
  package(s) announced via the openSUSE-SU-2019:2341_1 advisory.");
