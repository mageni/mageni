...
if(description)
{
  ...
  script_name("openSUSE Update for libopenmpt openSUSE-SU-2019:2306-1 (libopenmpt)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00035.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the openSUSE-SU-2019:2306_1 advisory.");
