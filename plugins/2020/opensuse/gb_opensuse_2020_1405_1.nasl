...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853424");
  ...
  script_tag(name:"creation_date", value:"2020-09-11 03:00:47 +0000 (Fri, 11 Sep 2020)");
  script_name("openSUSE: Security Advisory for go1.14 (openSUSE-SU-2020:1405-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1405-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-09/msg00029.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.14'
  package(s) announced via the openSUSE-SU-2020:1405-1 advisory.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.14", rpm:"go1.14~1.14.7~lp151.13.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.14-doc", rpm:"go1.14-doc~1.14.7~lp151.13.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.14-race", rpm:"go1.14-race~1.14.7~lp151.13.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
