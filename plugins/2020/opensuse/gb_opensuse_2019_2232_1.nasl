...
if(description)
{
  ...
  script_name("openSUSE Update for nghttp2 openSUSE-SU-2019:2232-1 (nghttp2)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00003.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nghttp2'
  package(s) announced via the openSUSE-SU-2019:2232_1 advisory.");
