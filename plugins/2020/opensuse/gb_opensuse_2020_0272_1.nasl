...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853053");
  script_version("2020-03-03T12:05:12+0000");
  script_cve_id("CVE-2009-4112", "CVE-2018-20723", "CVE-2018-20724", "CVE-2018-20725", "CVE-2018-20726", "CVE-2019-16723", "CVE-2019-17357", "CVE-2019-17358", "CVE-2020-7106", "CVE-2020-7237");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-03-03 12:05:12 +0000 (Tue, 03 Mar 2020)");
  script_tag(name:"creation_date", value:"2020-03-02 04:00:29 +0000 (Mon, 02 Mar 2020)");
  script_name("openSUSE: Security Advisory for cacti, (openSUSE-SU-2020:0272-1)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-03/msg00001.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cacti, '
  package(s) announced via the openSUSE-SU-2020:0272-1 advisory.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cacti-spine", rpm:"cacti-spine~1.2.9~lp151.3.3.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cacti-spine-debuginfo", rpm:"cacti-spine-debuginfo~1.2.9~lp151.3.3.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cacti-spine-debugsource", rpm:"cacti-spine-debugsource~1.2.9~lp151.3.3.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cacti", rpm:"cacti~1.2.9~lp151.3.3.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
