...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853361");
  ...
  script_tag(name:"creation_date", value:"2020-08-15 03:00:57 +0000 (Sat, 15 Aug 2020)");
  script_name("openSUSE: Security Advisory for hylafax+ (openSUSE-SU-2020:1209-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1209-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-08/msg00039.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'hylafax+'
  package(s) announced via the openSUSE-SU-2020:1209-1 advisory.");
  ...
  * fixes for build on FreeBSD 12.1 (31 Jan - 3 Feb 2020)
  ...
  script_tag(name:"affected", value:"'hylafax+' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"hylafax+", rpm:"hylafax+~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hylafax+-client", rpm:"hylafax+-client~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hylafax+-client-debuginfo", rpm:"hylafax+-client-debuginfo~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hylafax+-debuginfo", rpm:"hylafax+-debuginfo~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hylafax+-debugsource", rpm:"hylafax+-debugsource~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfaxutil7_0_3", rpm:"libfaxutil7_0_3~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfaxutil7_0_3-debuginfo", rpm:"libfaxutil7_0_3-debuginfo~7.0.3~lp152.3.6.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
