...
if(description)
{
  ...
  script_name("openSUSE Update for tomcat openSUSE-SU-2020:0038-1 (tomcat)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-01/msg00013.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat'
  package(s) announced via the openSUSE-SU-2020:0038_1 advisory.");
