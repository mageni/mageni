...
if(description)
{
  ...
  script_name("openSUSE Update for chromium openSUSE-SU-2019:2312-1 (chromium)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00038.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the openSUSE-SU-2019:2312_1 advisory.");
