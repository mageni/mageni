...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853324");
  ...
  script_name("openSUSE: Security Advisory for go1.13 (openSUSE-SU-2020:1095-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1095-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-07/msg00082.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.13'
  package(s) announced via the openSUSE-SU-2020:1095-1 advisory.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.13", rpm:"go1.13~1.13.14~lp152.2.4.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.13-doc", rpm:"go1.13-doc~1.13.14~lp152.2.4.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.13-race", rpm:"go1.13-race~1.13.14~lp152.2.4.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
