...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853263");
  ...
  script_tag(name:"creation_date", value:"2020-07-14 03:01:11 +0000 (Tue, 14 Jul 2020)");
  script_name("openSUSE: Security Advisory for nasm (openSUSE-SU-2020:0954-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:0954-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-07/msg00015.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nasm'
  package(s) announced via the openSUSE-SU-2020:0954-1 advisory.");
  ...
  * Added AVX512 VBMI2 (Additional ...
  ...
  script_tag(name:"affected", value:"'nasm' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nasm", rpm:"nasm~2.14.02~lp152.4.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nasm-debuginfo", rpm:"nasm-debuginfo~2.14.02~lp152.4.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nasm-debugsource", rpm:"nasm-debugsource~2.14.02~lp152.4.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
