...
if(description)
{
  ...
  script_name("openSUSE Update for postgresql openSUSE-SU-2019:2685-1 (postgresql)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-12/msg00030.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql'
  package(s) announced via the openSUSE-SU-2019:2685_1 advisory.");
