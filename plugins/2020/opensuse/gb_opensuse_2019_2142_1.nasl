...
if(description)
{
  ...
  script_name("openSUSE Update for samba openSUSE-SU-2019:2142-1 (samba)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the openSUSE-SU-2019:2142_1 advisory.");
