...
if(description)
{
  ...
  script_name("openSUSE Update for lxc openSUSE-SU-2019:2245-1 (lxc)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lxc'
  package(s) announced via the openSUSE-SU-2019:2245_1 advisory.");
