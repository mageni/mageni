...
if(description)
{
  ...
  script_name("openSUSE Update for nodejs10 openSUSE-SU-2019:1846-1 (nodejs10)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00010.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs10'
  package(s) announced via the openSUSE-SU-2019:1846_1 advisory.");
