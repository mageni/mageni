...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853306");
  script_version("2020-07-24T07:28:01+0000");
  script_cve_id("CVE-2019-11328", "CVE-2019-19724", "CVE-2020-13845", "CVE-2020-13846", "CVE-2020-13847");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-07-24 10:05:16 +0000 (Fri, 24 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-07-24 03:01:08 +0000 (Fri, 24 Jul 2020)");
  script_name("openSUSE: Security Advisory for singularity (openSUSE-SU-2020:1037-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1037-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-07/msg00059.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'singularity'
  package(s) announced via the openSUSE-SU-2020:1037-1 advisory.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"singularity", rpm:"singularity~3.6.0~lp151.2.6.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"singularity-debuginfo", rpm:"singularity-debuginfo~3.6.0~lp151.2.6.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
