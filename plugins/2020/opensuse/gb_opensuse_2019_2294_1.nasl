...
if(description)
{
  ...
  script_name("openSUSE Update for rust openSUSE-SU-2019:2294-1 (rust)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00031.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust'
  package(s) announced via the openSUSE-SU-2019:2294_1 advisory.");
