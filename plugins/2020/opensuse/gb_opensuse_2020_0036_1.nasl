...
if(description)
{
  ...
  script_name("openSUSE Update for rubygem-excon openSUSE-SU-2020:0036-1 (rubygem-excon)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-01/msg00021.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-excon'
  package(s) announced via the openSUSE-SU-2020:0036_1 advisory.");
