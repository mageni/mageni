...
if(description)
{
  ...
  script_name("Apple MacOSX Security Updates(HT211849) - 01");
  ...
  later for 10.15.x. Please see the references for more information.");
...
if(!osVer || osVer !~ "^(10\.(13|14|15))" || "Mac OS X" >!< osName){
  exit(0);
}
