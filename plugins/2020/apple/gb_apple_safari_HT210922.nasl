...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://support.apple.com/en-in/HT210922");
...
if(version_is_less(version:safVer, test_version:"13.0.5"))
{
  report = report_fixed_ver(installed_version:safVer, fixed_version:"13.0.5", install_path:path);
