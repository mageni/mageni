...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817496");
  script_version("2020-09-29T06:11:49+0000");
  script_cve_id("CVE-2020-9941");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-09-29 10:01:49 +0000 (Tue, 29 Sep 2020)");
  script_tag(name:"creation_date", value:"2020-09-25 12:55:59 +0530 (Fri, 25 Sep 2020)");
  script_name("Apple MacOSX Security Updates(HT211849)-03");
  ...
  script_tag(name:"insight", value:"The flaw is due to an improper check.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote
  attackers to unexpectedly alter application state.");
