...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817134");
  script_version("2020-05-29T08:53:11+0000");
  script_cve_id("CVE-2020-9772", "CVE-2020-9828");
  ...
  script_name("Apple MacOSX Security Updates(HT211170)-05");
  ...
  attackers to circumvent sandbox restrictions and gain access to sensitive user
  information.");

  script_tag(name:"affected", value:"Apple Mac OS X versions 10.14.x through
  10.14.6 and 10.13.x through 10.13.6");

  script_tag(name:"solution", value:"Apply security update 2020-003 for Apple
  Mac OS X version 10.13.x and 10.14.x. Please see the references for more
  information.");
...
if(osVer =~ "^(10\.13)")
{
  if(version_in_range(version:osVer, test_version:"10.13", test_version2:"10.13.6")){
