...
if(description)
{
  ...
  script_name("Elastic Kibana 6.7.0 < 6.8.9, 7.x <= 7.6.2 Prototype Pollution Vulnerability (Windows)");
...
if (version_in_range(version: version, test_version: "6.7.0", test_version: "6.8.8")) {
