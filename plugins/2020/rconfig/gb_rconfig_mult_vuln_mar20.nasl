...
if(description)
{
  ...
  script_version("2020-03-10T10:27:57+0000");
  ...
  script_name("rConfig <= 3.9.4 Multiple Vulnerabilities");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 10th March, 2020.
