...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108727");
  ...
  script_name("Discourse < 2.4.0.beta9 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse up to and including version 2.4.0.beta8.");

  script_tag(name:"solution", value:"Update to version 2.4.0.beta9 or later.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_xref(name:"URL", value:"https://meta.discourse.org/t/discourse-2-4-0-beta9-release-notes/136517");
...
if( version_is_less( version:vers, test_version:"2.4.0" ) ||
    version_in_range( version:vers, test_version:"2.4.0.beta1", test_version2:"2.4.0.beta8" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"2.4.0.beta9", install_path:infos["location"] );
