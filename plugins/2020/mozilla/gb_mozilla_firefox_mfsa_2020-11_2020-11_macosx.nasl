...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Updates( mfsa_2020-11_2020-11 )-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 74.0.1
...
if(version_is_less(version:ffVer, test_version:"74.0.1"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"74.0.1", install_path:ffPath);
