...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817212");
  ...
  script_name("Mozilla Firefox ESR Security Updates (Windows)-June 30 2020 ");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 68.10 on Windows.");
