...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Updates(mfsa_2020-36_2020-38)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 80 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 80
...
if(version_is_less(version:ffVer, test_version:"80"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"80", install_path:ffPath);
