...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Updates(mfsa_2020-54_2020-56)-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 84
...
if(version_is_less(version:ffVer, test_version:"84"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"84", install_path:ffPath);
