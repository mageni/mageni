...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817283");
  ...
  script_tag(name:"creation_date", value:"2020-09-02 11:52:03 +0530 (Wed, 02 Sep 2020)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-37)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 68.12 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 68.12
...
if(version_is_less(version:ffVer, test_version:"68.12"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"68.12", install_path:ffPath);
