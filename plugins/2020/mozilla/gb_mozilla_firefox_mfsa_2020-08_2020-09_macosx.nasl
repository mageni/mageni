...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Updates( mfsa_2020-08_2020-09 )-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 74 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 74
...
if(version_is_less(version:ffVer, test_version:"74"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"74", install_path:ffPath);
