...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816743");
  script_version("2020-04-10T03:46:49+0000");
  script_cve_id("CVE-2020-6828", "CVE-2020-6827", "CVE-2020-6821", "CVE-2020-6822",
                "CVE-2020-6825");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-04-14 09:52:40 +0000 (Tue, 14 Apr 2020)");
  script_tag(name:"creation_date", value:"2020-04-08 15:35:53 +0530 (Wed, 08 Apr 2020)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-12_2020-13)-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 68.7
...
if(version_is_less(version:ffVer, test_version:"68.7"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"68.7", install_path:ffPath);
