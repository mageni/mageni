...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817004");
  ...
  script_tag(name:"creation_date", value:"2020-05-06 18:08:42 +0530 (Wed, 06 May 2020)");
  script_name("Mozilla Thunderbird Security Updates(mfsa_2020-16_2020-18)-Windows");
  ...
  script_tag(name:"insight", value:"The multiple flaws exist due to Buffer
  ...
  script_tag(name:"affected", value:"Mozilla Thunderbird version before 68.8 on Windows.");
