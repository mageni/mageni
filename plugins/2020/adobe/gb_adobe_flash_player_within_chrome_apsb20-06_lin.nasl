...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815769");
  ...
  script_tag(name:"creation_date", value:"2020-02-12 10:44:30 +0530 (Wed, 12 Feb 2020)");
  script_name("Adobe Flash Player Within Google Chrome Security Update(apsb20-06)- Linux");
