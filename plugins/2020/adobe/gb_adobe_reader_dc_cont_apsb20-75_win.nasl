...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817869");
  ...
  script_name("Adobe Reader DC Continuous Security Update(apsb20-75) - Windows");
  ...
  versions before 2020.013.20074on Windows.");
