...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817344");
  ...
  script_name("Adobe Acrobat DC (Continuous) Security Updates(apsb20-48)-MAC OS X");
  ...
  to version 2020.012.20041 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade Adobe Acrobat DC (Continuous)
  to version 2020.012.20041 or later. Please see the references for more information.");
...
if(version_in_range(version:readerVer, test_version:"20.0", test_version2:"20.012.20040"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"20.012.20041(2020.012.20041)", install_path:InstallPath);
