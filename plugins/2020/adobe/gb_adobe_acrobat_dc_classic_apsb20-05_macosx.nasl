...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816576");
  ...
  script_name("Adobe Acrobat DC 2015 Security Updates(apsb20-05)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat DC 2015 version prior to version
  2015.006.30510 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Acrobat DC 2015 version
  2015.006.30510 or later. Please see the references for more information.");
...
if(version_in_range(version:readerVer, test_version:"15.0", test_version2:"15.006.30509"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"15.006.30510(2015.006.30510)", install_path:InstallPath);
