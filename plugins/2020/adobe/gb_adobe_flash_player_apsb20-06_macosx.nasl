...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815767");
  ...
  script_tag(name:"creation_date", value:"2020-02-12 10:33:42 +0530 (Wed, 12 Feb 2020)");
  script_name("Adobe Flash Player Security Updates(apsb20-06)-MAC OS X");
