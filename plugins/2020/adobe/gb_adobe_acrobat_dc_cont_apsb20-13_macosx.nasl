...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816810");
  ...
  script_name("Adobe Acrobat DC (Continuous) Security Updates(apsb20-13)-MAC OS X");
  ...
  to version 2020.006.20042 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Acrobat DC (Continuous)
  version 2020.006.20042 or later. Please see the references for more information.");
