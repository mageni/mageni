...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817820");
  ...
  script_name("Adobe Reader DC Continuous Security Updates(apsb20-67)-Windows");
  ...
  versions before 2020.013.20064 on Windows.");
