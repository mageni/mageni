...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple flaws exists due to various buffer
  ...
  4.5.11 or later. Please see the references for more information.");
...
{
  report = report_fixed_ver(installed_version:digitalVer, fixed_version:"4.5.11", install_path:digitalPath);
