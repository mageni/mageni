...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1983");
  ...
  script_tag(name:"creation_date", value:"2020-09-08 08:08:07 +0000 (Tue, 08 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for python-rtslib (EulerOS-SA-2020-1983)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1983");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1983");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'python-rtslib' package(s) announced via the EulerOS-SA-2020-1983 advisory.");
  ...
  script_tag(name:"affected", value:"'python-rtslib' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-rtslib", rpm:"python-rtslib~2.1.fb63~11.h3", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
