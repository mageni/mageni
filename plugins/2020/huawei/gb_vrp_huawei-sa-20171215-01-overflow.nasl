...
if(description)
{
  ...
  script_name("Huawei VRP Data Communication: Buffer Overflow Vulnerability (huawei-sa-20171215-01-overflow)");
  ...
  script_tag(name:"insight", value:"An unauthenticated, remote attacker may send specially crafted
  certificates to the affected products. Due to insufficient validation of the certificates, successful
  exploit may cause buffer overflow and some service abnormal.");
  ...
  AR2200, AR2200-S, AR3200, AR3600, AR510, DP300, NetEngine16EX, RP200, SRG1300, SRG2300, SRG3300, TE30, TE40,
  TE50, TE60, TP3106, TP3206 and ViewPoint 9030.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"http://www.huawei.com/en/psirt/security-advisories/huawei-sa-20171215-01-overflow-en");
