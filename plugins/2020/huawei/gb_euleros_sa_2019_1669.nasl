...
if(description)
{
  ...
  script_version("2020-01-23T12:19:33+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 12:19:33 +0000 (Thu, 23 Jan 2020)");
  ...
  'sssd' package(s) announced via the EulerOS-SA-2019-1669 advisory.");
