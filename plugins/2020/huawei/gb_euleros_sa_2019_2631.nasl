...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2631");
  ...
  script_tag(name:"creation_date", value:"2020-01-23 13:10:20 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for memcached (EulerOS-SA-2019-2631)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2631");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'memcached' package(s) announced via the EulerOS-SA-2019-2631 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"memcached", rpm:"memcached~1.4.15~10.1.h2", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
