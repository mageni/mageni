...
if(description)
{
  ...
  script_version("2020-01-23T13:18:18+0000");
  script_cve_id("CVE-2019-18218");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:18:18 +0000 (Thu, 23 Jan 2020)");
  ...
  'file' package(s) announced via the EulerOS-SA-2020-1052 advisory.");
