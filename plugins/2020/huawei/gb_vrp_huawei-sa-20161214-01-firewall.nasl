...
if(description)
{
  ...
  script_name("Huawei VRP Data Communication: DoS Vulnerability (huawei-sa-20161214-01-firewall)");
  ...
  script_tag(name:"summary", value:"Huawei firewalls are prone to a denial of service vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"There is a denial of service (DoS) vulnerability in Huawei firewalls due to
  no memory release after the execution of a specific command. A remote attacker with specific permission can
  log in to a device and deliver a large number of such commands to exhaust memory, causing a DoS condition.");

  script_tag(name:"impact", value:"Successful exploit could exhaust system memory, causing a DoS condition.");

  script_tag(name:"affected", value:"Huawei Secospace USG6300, Secospace USG6500 and Secospace USG6600.");
