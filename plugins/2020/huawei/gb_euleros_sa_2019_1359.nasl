...
if(description)
{
  ...
  script_version("2020-01-23T11:40:21+0000");
  script_cve_id("CVE-2019-9948");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 11:40:21 +0000 (Thu, 23 Jan 2020)");
  ...
  'python' package(s) announced via the EulerOS-SA-2019-1359 advisory.");
