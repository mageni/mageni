...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2017.1059");
  ...
  script_name("Huawei EulerOS: Security Advisory for icoutils (EulerOS-SA-2017-1059)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1059");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'icoutils' package(s) announced via the EulerOS-SA-2017-1059 advisory.");
...
Multiple vulnerabilities were found in icoutils, in the icotool program. An attacker could create a crafted ICO or CUR file that, when read by icotool, could result in memory corruption leading to a crash or potential code execution. (CVE-2017-6010, CVE-2017-6011)");
  ...
  script_tag(name:"affected", value:"'icoutils' package(s) on Huawei EulerOS V2.0SP2.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"icoutils", rpm:"icoutils~0.31.3~1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
