...
if(description)
{
  ...
  script_version("2020-01-23T11:06:04+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:06:04 +0000 (Thu, 23 Jan 2020)");
  ...
  'kernel' package(s) announced via the EulerOS-SA-2017-1292 advisory.");
...
The cdc_parse_cdc_header function in drivers/usb/core/message.c in  ...
