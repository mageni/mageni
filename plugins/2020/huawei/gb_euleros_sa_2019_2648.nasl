...
if(description)
{
  ...
  script_version("2020-01-23T13:11:05+0000");
  script_cve_id("CVE-2013-7422", "CVE-2014-4330", "CVE-2016-1238");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:11:05 +0000 (Thu, 23 Jan 2020)");
  ...
  'perl' package(s) announced via the EulerOS-SA-2019-2648 advisory.");
