...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2018.1198");
  script_version("2020-01-23T11:17:03+0000");
  script_cve_id("CVE-2018-1122", "CVE-2018-1123", "CVE-2018-1124", "CVE-2018-1125", "CVE-2018-1126");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:17:03 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 11:17:03 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for procps-ng (EulerOS-SA-2018-1198)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1198");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'procps-ng' package(s) announced via the EulerOS-SA-2018-1198 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"procps-ng, procps: Integer overflows leading to heap overflow in file2strvec (CVE-2018-1124)
...
If an argument longer than INT_MAX bytes is given to pgrep, 'int bytes' could wrap around back to a large positive int (rather than approaching zero), leading to a stack buffer overflow via strncat().(CVE-2018-1125)");
  ...
  script_tag(name:"affected", value:"'procps-ng' package(s) on Huawei EulerOS V2.0SP2.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"procps-ng", rpm:"procps-ng~3.3.10~17.2.h5", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
