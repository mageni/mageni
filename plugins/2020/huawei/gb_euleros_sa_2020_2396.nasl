...
if(description)
{
  ...
  script_version("2020-11-04T08:55:47+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2396");
  ...
  'samba' package(s) announced via the EulerOS-SA-2020-2396 advisory.");
