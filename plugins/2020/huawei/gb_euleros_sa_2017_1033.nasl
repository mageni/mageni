...
if(description)
{
  ...
  script_version("2020-01-23T10:45:01+0000");
  script_cve_id("CVE-2016-1248", "CVE-2017-5953");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 10:45:01 +0000 (Thu, 23 Jan 2020)");
  ...
  'vim' package(s) announced via the EulerOS-SA-2017-1033 advisory.");
