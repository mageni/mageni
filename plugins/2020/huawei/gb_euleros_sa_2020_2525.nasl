...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2525");
  script_version("2020-12-15T07:18:37+0000");
  script_cve_id("CVE-2014-10402", "CVE-2020-14392");
  script_tag(name:"cvss_base", value:"3.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-12-15 07:18:37 +0000 (Tue, 15 Dec 2020)");
  script_tag(name:"creation_date", value:"2020-12-15 07:18:37 +0000 (Tue, 15 Dec 2020)");
  script_name("Huawei EulerOS: Security Advisory for perl-DBI (EulerOS-SA-2020-2525)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2525");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2525");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'perl-DBI' package(s) announced via the EulerOS-SA-2020-2525 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-DBI", rpm:"perl-DBI~1.641~5.h2.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
