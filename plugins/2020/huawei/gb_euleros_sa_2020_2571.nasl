...
if(description)
{
  ...
  script_version("2020-12-15T07:19:45+0000");
  script_cve_id("CVE-2018-6381", "CVE-2018-6540");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-12-15 07:19:45 +0000 (Tue, 15 Dec 2020)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2571");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2571");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'zziplib' package(s) announced via the EulerOS-SA-2020-2571 advisory.");
