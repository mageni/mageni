...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2480");
  script_version("2020-01-23T13:01:05+0000");
  script_cve_id("CVE-2016-7942", "CVE-2016-7943", "CVE-2018-14598", "CVE-2018-14599", "CVE-2018-14600");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:01:05 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 13:01:05 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for libX11 (EulerOS-SA-2019-2480)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2480");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libX11' package(s) announced via the EulerOS-SA-2019-2480 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The XGetImage function in X.org libX11 before 1.6.4 might allow remote X servers to gain privileges via vectors involving image type and geometry, which triggers out-of-bounds read operations.(CVE-2016-7942)
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libX11", rpm:"libX11~1.6.3~2.h2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libX11-common", rpm:"libX11-common~1.6.3~2.h2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libX11-devel", rpm:"libX11-devel~1.6.3~2.h2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
