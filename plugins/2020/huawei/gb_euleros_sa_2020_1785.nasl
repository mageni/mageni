...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1785");
  script_version("2020-07-03T06:25:49+0000");
  ...
  script_tag(name:"creation_date", value:"2020-07-03 06:25:49 +0000 (Fri, 03 Jul 2020)");
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2020-1785)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1785");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1785");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'sudo' package(s) announced via the EulerOS-SA-2020-1785 advisory.");
...
In Sudo before 1.8.26, if pwfeedback is enabled in /etc/sudoers, users can trigger a stack-based buffer overflow in the privileged sudo process. (pwfeedback is a default setting in Linux Mint and elementary OS, however, it is NOT the default for upstream and many other packages, and would exist only if enabled by an administrator.) The attacker needs to deliver a long string to the stdin of getln() in tgetpass.c.(CVE-2019-18634)");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on Huawei EulerOS Virtualization 3.0.6.0.");
...
if(release == "EULEROSVIRT-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.8.19p2~14.h7.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.0"))) {
    report += res;
  }
