...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2454");
  script_version("2020-01-23T12:59:08+0000");
  script_cve_id("CVE-2017-11423", "CVE-2017-6419", "CVE-2018-18585");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:59:08 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:59:08 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for libmspack (EulerOS-SA-2019-2454)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2454");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libmspack' package(s) announced via the EulerOS-SA-2019-2454 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmspack", rpm:"libmspack~0.5~0.5.alpha.h4", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
