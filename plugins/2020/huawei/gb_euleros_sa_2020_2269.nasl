...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2269");
  script_version("2020-10-30T10:45:17+0000");
  ...
  script_tag(name:"creation_date", value:"2020-10-30 10:45:17 +0000 (Fri, 30 Oct 2020)");
  script_name("Huawei EulerOS: Security Advisory for PyYAML (EulerOS-SA-2020-2269)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2269");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2269");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'PyYAML' package(s) announced via the EulerOS-SA-2020-2269 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"PyYAML", rpm:"PyYAML~3.10~11.h4.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
