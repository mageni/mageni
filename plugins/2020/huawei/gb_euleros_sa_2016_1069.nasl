...
if(description)
{
  ...
  script_version("2020-01-23T10:42:09+0000");
  script_cve_id("CVE-2016-4455");
  script_tag(name:"cvss_base", value:"2.1");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 10:42:09 +0000 (Thu, 23 Jan 2020)");
  ...
  'subscription-manager, python-rhsm' package(s) announced via the EulerOS-SA-2016-1069 advisory.");
