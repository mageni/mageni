...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1312");
  script_version("2020-03-24T07:30:08+0000");
  ...
  script_tag(name:"last_modification", value:"2020-03-24 07:30:08 +0000 (Tue, 24 Mar 2020)");
  script_tag(name:"creation_date", value:"2020-03-24 07:30:08 +0000 (Tue, 24 Mar 2020)");
  script_name("Huawei EulerOS: Security Advisory for mutt (EulerOS-SA-2020-1312)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1312");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'mutt' package(s) announced via the EulerOS-SA-2020-1312 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mutt", rpm:"mutt~1.5.21~28.h2.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
