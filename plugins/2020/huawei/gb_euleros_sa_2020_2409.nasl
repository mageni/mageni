...
if(description)
{
  ...
  script_version("2020-11-04T08:56:11+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2409");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2409");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'cryptsetup' package(s) announced via the EulerOS-SA-2020-2409 advisory.");
