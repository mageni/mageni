...
if(description)
{
  ...
  script_version("2020-05-26T05:46:04+0000");
  ...
  script_name("Huawei EulerOS: Security Advisory for squid (EulerOS-SA-2020-1592)");
  ...
  'squid' package(s) announced via the EulerOS-SA-2020-1592 advisory.");
