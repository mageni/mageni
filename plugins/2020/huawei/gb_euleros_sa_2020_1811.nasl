...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1811");
  ...
  script_name("Huawei EulerOS: Security Advisory for libvncserver (EulerOS-SA-2020-1811)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1811");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1811");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libvncserver' package(s) announced via the EulerOS-SA-2020-1811 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in LibVNCServer before 0.9.13. libvncserver/hextile.c allows out-of-bounds access via encodings.(CVE-2020-14403)
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvncserver", rpm:"libvncserver~0.9.11~8.h2.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
