...
if(description)
{
  ...
  script_version("2020-01-23T11:13:33+0000");
  script_cve_id("CVE-2015-8605", "CVE-2018-1111");
  script_tag(name:"cvss_base", value:"7.9");
  script_tag(name:"cvss_base_vector", value:"AV:A/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 11:13:33 +0000 (Thu, 23 Jan 2020)");
  ...
  'dhcp' package(s) announced via the EulerOS-SA-2018-1123 advisory.");
