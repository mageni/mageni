...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1643");
  script_version("2020-01-23T12:18:46+0000");
  script_cve_id("CVE-2018-0732", "CVE-2018-0737");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:18:46 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:18:46 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for compat-openssl10 (EulerOS-SA-2019-1643)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1643");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'compat-openssl10' package(s) announced via the EulerOS-SA-2019-1643 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"compat-openssl10", rpm:"compat-openssl10~1.0.2o~3.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
