...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108769");
  ...
  script_name("Huawei Data Communication: Memory Leak Vulnerability in Some Huawei Products (huawei-sa-20161221-02-ldp)");
  ...
  script_tag(name:"affected", value:"CloudEngine 12800 versions V100R003C00SPC600 V100R003C10 V100R005C00 V100R005C10 V100R006C00");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_xref(name:"URL", value:"https://www.huawei.com/en/psirt/security-advisories/huawei-sa-20161221-02-ldp-en");
