...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1528");
  script_version("2020-04-30T12:11:42+0000");
  ...
  script_tag(name:"last_modification", value:"2020-04-30 12:11:42 +0000 (Thu, 30 Apr 2020)");
  script_tag(name:"creation_date", value:"2020-04-30 12:11:42 +0000 (Thu, 30 Apr 2020)");
  script_name("Huawei EulerOS: Security Advisory for ncurses (EulerOS-SA-2020-1528)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1528");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'ncurses' package(s) announced via the EulerOS-SA-2020-1528 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ncurses", rpm:"ncurses~5.9~14.20130511.h7", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ncurses-base", rpm:"ncurses-base~5.9~14.20130511.h7", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ncurses-libs", rpm:"ncurses-libs~5.9~14.20130511.h7", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
