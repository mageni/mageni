...
if(description)
{
  ...
  script_version("2020-04-30T12:11:53+0000");
  script_cve_id("CVE-2019-8675", "CVE-2019-8696");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-04-30 12:11:53 +0000 (Thu, 30 Apr 2020)");
  ...
  'cups' package(s) announced via the EulerOS-SA-2020-1531 advisory.");
