...
if(description)
{
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1736");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1736");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'e2fsprogs' package(s) announced via the EulerOS-SA-2020-1736 advisory.");
