...
if(description)
{
  ...
  script_version("2020-01-23T10:55:41+0000");
  script_cve_id("CVE-2017-3167", "CVE-2017-3169", "CVE-2017-7668", "CVE-2017-7679", "CVE-2017-9788");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 10:55:41 +0000 (Thu, 23 Jan 2020)");
  ...
  'httpd' package(s) announced via the EulerOS-SA-2017-1178 advisory.");
