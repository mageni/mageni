...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108927");
  ...
  script_name("Western Digital My Cloud Multiple Products < 2.31.163 Multiple Vulnerabilities");
  ...
  script_xref(name:"URL", value:"https://community.wd.com/t/new-release-my-cloud-firmware-versions-2-31-163-01-08-2019/229693");
  ...
  script_tag(name:"affected", value:"Western Digital My Cloud with firmware versions prior to 2.31.163.");

  script_tag(name:"solution", value:"Update to firmware version 2.31.163 or later.
...
if (version_is_less(version: version, test_version: "2.31.163")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.31.163");
