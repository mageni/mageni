...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108924");
  ...
  script_name("Western Digital My Cloud Multiple Products < 2.11.169 / 2.20 - 2.30 < 2.30.181 Unauthorized Upload Vulnerability");
  ...
  script_tag(name:"summary", value:"Multiple Western Digital My Cloud products are prone to an unauthorized
  ...
  - Unauthorized access to multipart upload functionality (CVE-2017-17560)");

  script_tag(name:"affected", value:"Western Digital My Cloud with firmware versions prior to 2.11.169
  and 2.2 - 2.3 versions prior to 2.30.181.");

  script_tag(name:"solution", value:"Update to firmware version 2.11.169, 2.30.181 or later.
...
if (version_is_less(version: version, test_version: "2.11.169")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.11.169");
  security_message(port: 0, data: report);
  exit(0);
}

else if (version =~ "^2\.[23][0-9]\." && version_is_less(version: version, test_version: "2.30.181")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.30.181");
  security_message(port: 0, data: report);
  exit(0);
}
