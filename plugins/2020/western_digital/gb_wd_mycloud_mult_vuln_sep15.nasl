...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108932");
  ...
  script_name("Western Digital My Cloud Multiple Products < 2.10.302 Multiple Vulnerabilities");
  ...
  - known command injection, SSH default password and CSRF security vulnerabilities");

  script_tag(name:"affected", value:"Western Digital My Cloud with firmware versions prior to 2.10.302.");

  script_tag(name:"solution", value:"Update to firmware version 2.10.302 or later.
...
if (version_is_less(version: version, test_version: "2.10.302")) {
