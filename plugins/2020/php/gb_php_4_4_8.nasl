...
if(description)
{
  ...
  script_name("PHP < 4.4.8 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"PHP before version 4.4.8.");
...
if( version_is_less( version:version, test_version:"4.4.8" ) ) {
