...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3457-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007824.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ucode-intel'
  package(s) announced via the SUSE-SU-2020:3457-1 advisory.");
