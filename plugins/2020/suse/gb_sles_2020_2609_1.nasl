...
if(description)
{
  ...
  script_cve_id("CVE-2019-19956","CVE-2019-20388","CVE-2020-24977");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2609-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-September/007409.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libxml2'
  package(s) announced via the SUSE-SU-2020:2609-1 advisory.");
