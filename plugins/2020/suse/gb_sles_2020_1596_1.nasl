...
if(description)
{
  ...
  script_cve_id("CVE-2020-0543","CVE-2020-10757","CVE-2020-12114");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:1596-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/006919.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2020:1596-1 advisory.");
