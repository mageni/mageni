...
if(description)
{
  ...
  script_cve_id("CVE-2019-12523","CVE-2019-12526","CVE-2019-12528");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0661-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-March/006603.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'squid'
  package(s) announced via the SUSE-SU-2020:0661-1 advisory.");
