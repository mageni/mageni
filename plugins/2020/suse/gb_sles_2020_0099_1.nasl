...
if(description)
{
  ...
  script_cve_id("CVE-2019-1547","CVE-2019-1549","CVE-2019-1551");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0099-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-January/006349.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openssl-1_1'
  package(s) announced via the SUSE-SU-2020:0099-1 advisory.");
