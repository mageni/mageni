...
if(description)
{
  ...
  script_cve_id("CVE-2012-0876","CVE-2016-0718","CVE-2016-4472");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0497-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-February/006536.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'python3'
  package(s) announced via the SUSE-SU-2020:0497-1 advisory.");
