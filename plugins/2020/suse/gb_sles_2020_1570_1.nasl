...
if(description)
{
  ...
  script_cve_id("CVE-2015-9096","CVE-2016-2339","CVE-2016-7798");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:1570-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/006905.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ruby2.1'
  package(s) announced via the SUSE-SU-2020:1570-1 advisory.");
