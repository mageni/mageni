...
if(description)
{
  ...
  script_cve_id("CVE-2020-15999","CVE-2020-16012","CVE-2020-26951");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3548-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007883.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'MozillaFirefox'
  package(s) announced via the SUSE-SU-2020:3548-1 advisory.");
