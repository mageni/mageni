...
if(description)
{
  ...
  script_cve_id("CVE-2020-13249","CVE-2020-2752","CVE-2020-2760");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:1710-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/007007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mariadb'
  package(s) announced via the SUSE-SU-2020:1710-1 advisory.");
