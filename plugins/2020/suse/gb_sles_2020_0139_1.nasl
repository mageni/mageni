...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0139-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-January/006385.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libssh'
  package(s) announced via the SUSE-SU-2020:0139-1 advisory.");
