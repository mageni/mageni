...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816862");
  script_version("2020-04-17T06:25:22+0000");
  script_cve_id("CVE-2020-2816", "CVE-2020-2767", "CVE-2020-2778");
  ...
  script_name("Oracle Java SE Security Updates(apr2020) 03 - Windows");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 11.0.6 and prior,
  14 on Windows.");
...
if(version_in_range(version:jreVer, test_version:"11.0", test_version2:"11.0.6") ||
