...
if (description)
{
  ...
  script_name("Oracle MySQL < 5.7.32 / 8.0.x < 8.0.22 Security Update (cpuoct2020) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.31 and prior, 8.0.21 and prior.");
