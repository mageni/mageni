...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816605");
  ...
  script_tag(name:"creation_date", value:"2020-01-16 15:20:43 +0530 (Thu, 16 Jan 2020)");
  script_name("Oracle Java SE Security Updates(jan2020) 03 - Linux");
...
if(version_in_range(version:jreVer, test_version:"11.0", test_version2:"11.0.5") ||
