...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144289");
  script_version("2021-02-10T15:21:20+0000");
  script_tag(name:"last_modification", value:"2021-02-11 11:09:43 +0000 (Thu, 11 Feb 2021)");
  script_tag(name:"creation_date", value:"2020-07-21 08:36:44 +0000 (Tue, 21 Jul 2020)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");

  script_cve_id("CVE-2020-1967", "CVE-2020-14539", "CVE-2020-14576", "CVE-2020-14540", "CVE-2020-14547",
                "CVE-2020-14559", "CVE-2020-14553");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL 5.7 <= 5.7.30 Security Update (cpujul2020) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 5.7 through 5.7.30.");
