...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816882");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 11:41:32 +0530 (Thu, 16 Apr 2020)");
  script_name("Microsoft Access Remote Code Execution Vulnerability (KB4464527)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4464527.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4464527");
...
if(version_in_range(version:accVer, test_version:"14.0", test_version2:"14.0.7248.4999"))
{
  report = report_fixed_ver(file_checked:"msaccess.exe",
           file_version:accVer, vulnerable_range:"14.0 - 14.0.7248.4999");
