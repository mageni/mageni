...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817636");
  ...
  script_name("Microsoft PowerPoint 2010 RCE Vulnerability (KB4484372)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484372");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484372");
