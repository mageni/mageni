...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817553");
  ...
  script_cve_id("CVE-2020-16958", "CVE-2020-16959", "CVE-2020-16960", "CVE-2020-16961",
                ...
                "CVE-2020-17097", "CVE-2020-17098", "CVE-2020-17103", "CVE-2020-17131",
                "CVE-2020-17134", "CVE-2020-17136", "CVE-2020-17137", "CVE-2020-17139",
                "CVE-2020-17140");
  ...
  script_tag(name:"creation_date", value:"2020-12-09 12:21:12 +0530 (Wed, 09 Dec 2020)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4592438)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4592438");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4592438");
...
if(version_in_range(version:fileVer, test_version:"10.0.19041.0", test_version2:"10.0.19041.684"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Gdiplus.dll",
                            file_version:fileVer, vulnerable_range:"10.0.19041.0 - 10.0.19041.684");
