...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817365");
  ...
  script_cve_id("CVE-2020-0648", "CVE-2020-0664", "CVE-2020-0718", "CVE-2020-0761",
                ...
                "CVE-2020-0856", "CVE-2020-0878", "CVE-2020-0911", "CVE-2020-0912",
                "CVE-2020-0921", "CVE-2020-0922", "CVE-2020-1012", "CVE-2020-1013",
                "CVE-2020-1030", "CVE-2020-1031", "CVE-2020-1038", "CVE-2020-1039",
                "CVE-2020-1052", "CVE-2020-1074", "CVE-2020-1083", "CVE-2020-1091",
                "CVE-2020-1097", "CVE-2020-1115", "CVE-2020-1228", "CVE-2020-1245",
                "CVE-2020-1250", "CVE-2020-1252", "CVE-2020-1256", "CVE-2020-1285",
                "CVE-2020-1376", "CVE-2020-1491", "CVE-2020-1508", "CVE-2020-1559",
                "CVE-2020-1589", "CVE-2020-1593", "CVE-2020-1596", "CVE-2020-1598");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4577051)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4577051");
  ...
  to execute arbitrary code, elevate privilges, conduct DoS condition and disclose
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4577051");
...
if(version_is_less(version:fileVer, test_version:"6.1.7601.24560"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"Less than 6.1.7601.24560");
