...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817834");
  script_version("2020-11-11T17:29:33+0000");
  script_cve_id("CVE-2020-17064", "CVE-2020-17065", "CVE-2020-17067");
  ...
  script_name("Microsoft Excel 2016 Security Feature Bypass And RCE Vulnerabilities (KB4486718)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4486718");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4486718");
...
if(version_in_range(version:excelVer, test_version:"16.0", test_version2:"16.0.5083.0999"))
{
  report = report_fixed_ver(file_checked:excelPath + "Excel.exe",
                            file_version:excelVer, vulnerable_range:"16.0 - 16.0.5083.0999");
