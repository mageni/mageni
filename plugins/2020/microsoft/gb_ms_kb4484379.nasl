...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817415");
  ...
  script_tag(name:"creation_date", value:"2020-08-12 12:15:37 +0530 (Wed, 12 Aug 2020)");
  script_name("Microsoft Office 2010 Service Pack 2 Remote Code Execution Vulnerability (KB4484379)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484379");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484379");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    if(msdllVer && version_in_range(version:msdllVer, test_version:"14.0", test_version2:"14.0.7256.4999"))
    {
      report = report_fixed_ver( file_checked:offPath + "\aceexcl.dll",
                                 file_version:msdllVer, vulnerable_range:"14.0 - 14.0.7256.4999");
