...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817057");
  ...
  script_tag(name:"creation_date", value:"2020-06-10 13:20:11 +0530 (Wed, 10 Jun 2020)");
  script_name("Microsoft Office 2010 Security Feature Bypass Vulnerability (KB4484373)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484373");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484373");
...
foreach key(key_list)
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"14.0", test_version2:"14.0.7252.4999"))
  {
    report = report_fixed_ver(file_checked:offPath + "\Mso.dll",
                              file_version:offexeVer, vulnerable_range:"14.0 - 14.0.7252.4999");
