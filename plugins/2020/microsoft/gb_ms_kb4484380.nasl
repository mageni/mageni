...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817049");
  ...
  script_tag(name:"creation_date", value:"2020-06-10 10:46:11 +0530 (Wed, 10 Jun 2020)");
  script_name("Microsoft Word 2010 Service Pack 2 Security Feature Bypass Vulnerability (KB4484380)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484380");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484380");
...
if(exeVer =~ "^14\." && version_is_less(version:exeVer, test_version:"14.0.7252.5000"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"14.0 - 14.0.7252.4999");
