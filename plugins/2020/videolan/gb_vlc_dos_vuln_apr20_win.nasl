...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112755");
  ...
  script_name("VLC Media Player < 3.0.9 DoS Vulnerability (Windows)");
  ...
  script_tag(name:"affected", value:"VideoLAN VLC Media Player before version 3.0.9 on Windows.");
