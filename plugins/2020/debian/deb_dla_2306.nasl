...
if(description)
{
  ...
  script_version("2020-08-03T03:00:06+0000");
  ...
  script_name("Debian LTS: Security Advisory for libphp-phpmailer (DLA-2306-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00004.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2306-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/962827");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libphp-phpmailer'
  package(s) announced via the DLA-2306-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libphp-phpmailer", ver:"5.2.14+dfsg-2.3+deb9u2", rls:"DEB9"))) {
  report += res;
}
