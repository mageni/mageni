...
if(description)
{
  ...
  script_version("2020-07-17T11:46:25+0000");
  ...
  script_name("Debian LTS: Security Advisory for fwupd (DLA-2274-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/07/msg00005.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2274-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/962517");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fwupd'
  package(s) announced via the DLA-2274-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a possible signature verification
issue in firmware update daemon library 'fwupd' as the return value
of gpgme_op_verify_result was not being checked.");

  script_tag(name:"affected", value:"'fwupd' package(s) on Debian Linux.");

  script_tag(name:"solution", value:"For Debian 9 'Stretch', this issue has been fixed in fwupd version
0.7.4-2+deb9u1.
