...
if(description)
{
  ...
  script_version("2020-05-21T03:00:12+0000");
  ...
  script_name("Debian: Security Advisory for bind9 (DSA-4689-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4689.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4689-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9'
  package(s) announced via the DSA-4689-1 advisory.");
