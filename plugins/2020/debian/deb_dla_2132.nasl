...
if(description)
{
  ...
  script_version("2020-03-04T04:00:06+0000");
  script_cve_id("CVE-2019-18900");
  script_tag(name:"cvss_base", value:"2.1");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-03-04 04:00:06 +0000 (Wed, 04 Mar 2020)");
  script_tag(name:"creation_date", value:"2020-03-04 04:00:06 +0000 (Wed, 04 Mar 2020)");
  script_name("Debian LTS: Security Advisory for libzypp (DLA-2132-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/03/msg00005.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2132-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libzypp'
  package(s) announced via the DLA-2132-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an issue where incorrect default
permissions on a HTTP cookie store could have allowed local attackers
to read private credentials.");

  script_tag(name:"affected", value:"'libzypp' package(s) on Debian Linux.");

  script_tag(name:"solution", value:"For Debian 8 'Jessie', this issue has been fixed in libzypp version
14.29.1-2+deb8u1.
