...
if(description)
{
  ...
  script_version("2020-08-07T03:00:14+0000");
  ...
  script_name("Debian LTS: Security Advisory for clamav (DLA-2314-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00010.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2314-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav'
  package(s) announced via the DLA-2314-1 advisory.");
