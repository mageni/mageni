...
if(description)
{
  ...
  script_version("2020-12-08T10:02:45+0000");
  script_cve_id("CVE-2020-14360", "CVE-2020-25712");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-12-08 10:02:45 +0000 (Tue, 08 Dec 2020)");
  script_tag(name:"creation_date", value:"2020-12-08 10:02:45 +0000 (Tue, 08 Dec 2020)");
  script_name("Debian: Security Advisory for xorg-server (DSA-4803-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4803.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4803-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server'
  package(s) announced via the DSA-4803-1 advisory.");
