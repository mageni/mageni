...
if(description)
{
  ...
  script_version("2020-02-11T04:00:08+0000");
  script_cve_id("CVE-2019-10782", "CVE-2019-9658");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-02-11 04:00:08 +0000 (Tue, 11 Feb 2020)");
  script_tag(name:"creation_date", value:"2020-02-11 04:00:08 +0000 (Tue, 11 Feb 2020)");
  script_name("Debian LTS: Security Advisory for checkstyle (DLA-2099-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00008.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2099-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'checkstyle'
  package(s) announced via the DLA-2099-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Security researchers from Snyk discovered that the fix for CVE-2019-9658
