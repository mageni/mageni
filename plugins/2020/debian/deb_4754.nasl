...
if(description)
{
  ...
  script_version("2020-08-30T03:00:19+0000");
  ...
  script_name("Debian: Security Advisory for thunderbird (DSA-4754-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4754.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4754-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the DSA-4754-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"calendar-google-provider", ver:"1:68.12.0-1~deb10u1", rls:"DEB10"))) {
  report += res;
}
