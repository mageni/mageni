...
if(description)
{
  ...
  script_version("2020-08-23T03:00:07+0000");
  ...
  script_name("Debian LTS: Security Advisory for firejail (DLA-2336-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00033.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2336-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firejail'
  package(s) announced via the DLA-2336-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"firejail", ver:"0.9.44.8-2+deb9u1", rls:"DEB9"))) {
  report += res;
}
