...
if(description)
{
  ...
  - Open redirection when using back parameter (CVE-2020-5270)

  - Reflected XSS with back parameter (CVE-2020-5285)");

  script_tag(name:"affected", value:"PrestaShop versions 1.7.6.0 - 1.7.6.4.");
