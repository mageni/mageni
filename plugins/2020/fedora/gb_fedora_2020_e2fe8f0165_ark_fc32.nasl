...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878183");
  ...
  script_tag(name:"creation_date", value:"2020-08-13 03:22:02 +0000 (Thu, 13 Aug 2020)");
  script_name("Fedora: Security Advisory for ark (FEDORA-2020-e2fe8f0165)");
  ...
  script_xref(name:"FEDORA", value:"2020-e2fe8f0165");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PMVXSQNCBILVSJLX32ODNU6KUY2X7HRM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ark'
  package(s) announced via the FEDORA-2020-e2fe8f0165 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ark", rpm:"ark~20.04.3~3.fc32", rls:"FC32"))) {
    report += res;
  }
