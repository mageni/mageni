...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878151");
  ...
  script_tag(name:"creation_date", value:"2020-07-31 03:14:14 +0000 (Fri, 31 Jul 2020)");
  script_name("Fedora: Security Advisory for zabbix (FEDORA-2020-519516feec)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TIRIMOXH6GSBAANDCB3ANLJK4CRLWRXT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zabbix'
  package(s) announced via the FEDORA-2020-519516feec advisory.");
...
multitude of servers.");
  ...
  script_tag(name:"affected", value:"'zabbix' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~4.0.22~1.fc31", rls:"FC31"))) {
    report += res;
  }
