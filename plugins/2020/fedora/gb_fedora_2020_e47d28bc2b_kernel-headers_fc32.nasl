...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877958");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-e47d28bc2b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MZJKQGU5QOOVYWAOAPKSAE7PFEDYZPKG");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.6.18~300.fc32", rls:"FC32"))) {
    report += res;
  }
