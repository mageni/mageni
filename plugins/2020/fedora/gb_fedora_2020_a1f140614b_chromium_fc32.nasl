...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878266");
  ...
  script_tag(name:"creation_date", value:"2020-09-05 03:07:23 +0000 (Sat, 05 Sep 2020)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2020-a1f140614b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DHOGK3FAOKKLAPGM5QISHAQYTOUX2VYA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2020-a1f140614b advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~85.0.4183.83~1.fc32", rls:"FC32"))) {
    report += res;
  }
