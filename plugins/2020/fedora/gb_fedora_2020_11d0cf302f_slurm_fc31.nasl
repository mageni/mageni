...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877938");
  ...
  script_name("Fedora: Security Advisory for slurm (FEDORA-2020-11d0cf302f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KNL5E5SK4WP6M3DKU4IKW2NPQD2XTZ4Y");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'slurm'
  package(s) announced via the FEDORA-2020-11d0cf302f advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"slurm", rpm:"slurm~19.05.7~1.fc31", rls:"FC31"))) {
    report += res;
  }
