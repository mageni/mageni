...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877310");
  script_version("2020-01-13T11:49:13+0000");
  script_cve_id("CVE-2019-18804");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-13 11:49:13 +0000 (Mon, 13 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-09 07:37:25 +0000 (Thu, 09 Jan 2020)");
  script_name("Fedora Update for djvulibre FEDORA-2019-18cf104b5d");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NYPWP5T7TSUNZV4UEIRRCTVWO6VBZWJV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the FEDORA-2019-18cf104b5d advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"djvulibre", rpm:"djvulibre~3.5.27~17.fc31", rls:"FC31"))) {
    report += res;
  }
