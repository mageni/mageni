...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878004");
  ...
  script_name("Fedora: Security Advisory for tcpreplay (FEDORA-2020-256ac53cc7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UOSEIQ3D2OONCJEVMGC2TYBC2QX4E5EJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay'
  package(s) announced via the FEDORA-2020-256ac53cc7 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.3.3~1.fc31", rls:"FC31"))) {
    report += res;
  }
