...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878167");
  ...
  script_tag(name:"creation_date", value:"2020-08-08 03:14:50 +0000 (Sat, 08 Aug 2020)");
  script_name("Fedora: Security Advisory for rpki-client (FEDORA-2020-9f31ce1df2)");
  ...
  script_xref(name:"FEDORA", value:"2020-9f31ce1df2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WBWEVI2CQT5QX3IIKB7HQUOICCRB34HZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client'
  package(s) announced via the FEDORA-2020-9f31ce1df2 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~6.7p1~1.fc31", rls:"FC31"))) {
    report += res;
  }
