...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878707");
  ...
  script_name("Fedora: Security Advisory for ceph (FEDORA-2020-a8f1120195)");
  ...
  script_xref(name:"FEDORA", value:"2020-a8f1120195");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UBC4KZ44QUQENTYZPVHORGL4K2KV5V4F");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ceph'
  package(s) announced via the FEDORA-2020-a8f1120195 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ceph", rpm:"ceph~15.2.7~1.fc33", rls:"FC33"))) {
    report += res;
  }
