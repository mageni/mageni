...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878325");
  ...
  script_name("Fedora: Security Advisory for samba (FEDORA-2020-0be2776ed3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/H4OTFBL6YDVFH2TBJFJIE4FMHPJEEJK3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the FEDORA-2020-0be2776ed3 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"samba", rpm:"samba~4.12.7~0.fc32", rls:"FC32"))) {
    report += res;
  }
