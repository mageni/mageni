...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877562");
  ...
  script_name("Fedora: Security Advisory for mbedtls (FEDORA-2020-0ab860bb95)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2U5SD5ORL6H6YYMFTMQNOIGNNXVYVCAM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mbedtls'
  package(s) announced via the FEDORA-2020-0ab860bb95 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mbedtls", rpm:"mbedtls~2.16.5~1.fc31", rls:"FC31"))) {
    report += res;
  }
