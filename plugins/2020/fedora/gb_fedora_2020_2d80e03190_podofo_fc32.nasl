...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878079");
  ...
  script_tag(name:"creation_date", value:"2020-07-12 03:19:48 +0000 (Sun, 12 Jul 2020)");
  script_name("Fedora: Security Advisory for podofo (FEDORA-2020-2d80e03190)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FB5WWVPYIMZC6XILQUPMFIUJC22YTSKX");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podofo", rpm:"podofo~0.9.6~11.fc32", rls:"FC32"))) {
    report += res;
  }
