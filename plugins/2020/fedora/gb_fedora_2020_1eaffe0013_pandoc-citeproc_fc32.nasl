...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878435");
  ...
  script_name("Fedora: Security Advisory for pandoc-citeproc (FEDORA-2020-1eaffe0013)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ANDQKM6QNCO2C2LQDULQDHTOGGEETPBD");
...
pandoc-citeproc originated as a fork of Andrea Rossato&#39, s citeproc-hs.");
  ...
  script_tag(name:"affected", value:"'pandoc-citeproc' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pandoc-citeproc", rpm:"pandoc-citeproc~0.16.2~2.fc32", rls:"FC32"))) {
    report += res;
  }
