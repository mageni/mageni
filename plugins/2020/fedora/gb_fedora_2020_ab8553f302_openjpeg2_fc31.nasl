...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877406");
  ...
  script_name("Fedora: Security Advisory for openjpeg2 (FEDORA-2020-ab8553f302)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XBRMI2D3XPVWKE3V52KRBW7BJVLS5LD3");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.3.1~4.fc31", rls:"FC31"))) {
    report += res;
  }
