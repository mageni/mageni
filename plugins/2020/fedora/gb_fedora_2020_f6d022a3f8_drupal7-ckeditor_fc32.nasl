...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877735");
  ...
  script_name("Fedora: Security Advisory for drupal7-ckeditor (FEDORA-2020-f6d022a3f8)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BDJ3CQJZ72GJSS353HG7HP5BZKDMTXNJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-ckeditor'
  package(s) announced via the FEDORA-2020-f6d022a3f8 advisory.");
...
installation on the client computer.");
  ...
  script_tag(name:"affected", value:"'drupal7-ckeditor' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-ckeditor", rpm:"drupal7-ckeditor~1.19~1.fc32", rls:"FC32"))) {
    report += res;
  }
