...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878433");
  ...
  script_tag(name:"creation_date", value:"2020-10-07 03:09:23 +0000 (Wed, 07 Oct 2020)");
  script_name("Fedora: Security Advisory for ghc-hakyll (FEDORA-2020-1eaffe0013)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BKI3A6SW7LN3YMAZXLGYZGBDOGER5ZKN");
...
as markdown or RST.");
  ...
  script_tag(name:"affected", value:"'ghc-hakyll' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghc-hakyll", rpm:"ghc-hakyll~4.13.4.0~1.fc32", rls:"FC32"))) {
    report += res;
  }
