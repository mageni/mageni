...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877565");
  ...
  script_name("Fedora: Security Advisory for monit (FEDORA-2020-9c19202d55)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/L475QJMFFI2QV5QEHAKKPVX6QX6ECUL6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'monit'
  package(s) announced via the FEDORA-2020-9c19202d55 advisory.");
...
and can execute meaningful causal actions in error situations.");
  ...
  script_tag(name:"affected", value:"'monit' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"monit", rpm:"monit~5.26.0~1.fc31", rls:"FC31"))) {
    report += res;
  }
