...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877858");
  script_version("2020-05-29T08:53:11+0000");
  script_cve_id("CVE-2020-11866", "CVE-2020-11863", "CVE-2020-11864", "CVE-2020-11865");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-06-02 09:39:52 +0000 (Tue, 02 Jun 2020)");
  script_tag(name:"creation_date", value:"2020-05-29 03:28:31 +0000 (Fri, 29 May 2020)");
  script_name("Fedora: Security Advisory for libEMF (FEDORA-2020-c696d8604b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2DFYDSKWFM2R5NKZOO2IN6X7SM3T2PWL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libEMF'
  package(s) announced via the FEDORA-2020-c696d8604b advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libEMF", rpm:"libEMF~1.0.12~1.fc31", rls:"FC31"))) {
    report += res;
  }
