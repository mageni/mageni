...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878597");
  ...
  script_tag(name:"creation_date", value:"2020-11-11 04:22:11 +0000 (Wed, 11 Nov 2020)");
  script_name("Fedora: Security Advisory for wordpress (FEDORA-2020-15e15c35da)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VAVVYJKA2I6CRQUINECDPBGWMQDEG244");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2020-15e15c35da advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.5.3~1.fc31", rls:"FC31"))) {
    report += res;
  }
