...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878270");
  ...
  script_tag(name:"creation_date", value:"2020-09-08 03:08:16 +0000 (Tue, 08 Sep 2020)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2020-708b23f2ce)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4IA6VCLCLRNA3MWPJYZTNZYC3X34XEST");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.8.6~200.fc32", rls:"FC32"))) {
    report += res;
  }
