...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878179");
  ...
  script_name("Fedora: Security Advisory for virtualbox-guest-additions (FEDORA-2020-5602840117)");
  ...
  script_xref(name:"FEDORA", value:"2020-5602840117");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EAFESA4R4OLWLZIMORFWX7NZRA2B7FMO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'virtualbox-guest-additions'
  package(s) announced via the FEDORA-2020-5602840117 advisory.");
...
with the Host, including file sharing, clipboard sharing and Seamless mode.");
  ...
  script_tag(name:"affected", value:"'virtualbox-guest-additions' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"virtualbox-guest-additions", rpm:"virtualbox-guest-additions~6.1.12~1.fc32", rls:"FC32"))) {
    report += res;
  }
