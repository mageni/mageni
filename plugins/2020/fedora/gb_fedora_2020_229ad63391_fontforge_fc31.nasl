...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877369");
  ...
  script_tag(name:"creation_date", value:"2020-01-27 09:24:02 +0000 (Mon, 27 Jan 2020)");
  script_name("Fedora: Security Advisory for fontforge (FEDORA-2020-229ad63391)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2S75EAVF4KPCH3WFBMZADUAU7EAXA7ZQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fontforge'
  package(s) announced via the FEDORA-2020-229ad63391 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fontforge", rpm:"fontforge~20190801~2.fc31", rls:"FC31"))) {
    report += res;
  }
