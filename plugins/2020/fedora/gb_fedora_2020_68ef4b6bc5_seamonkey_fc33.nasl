...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878625");
  ...
  script_tag(name:"creation_date", value:"2020-11-18 04:10:52 +0000 (Wed, 18 Nov 2020)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2020-68ef4b6bc5)");
  ...
  script_xref(name:"FEDORA", value:"2020-68ef4b6bc5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UEF63HJEH4DJXQYUF4BE2Z7YOPDI25HL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2020-68ef4b6bc5 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.5~2.fc33", rls:"FC33"))) {
    report += res;
  }
