...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877630");
  ...
  script_name("Fedora: Security Advisory for php (FEDORA-2020-ce5a2a7403)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TTMXJAARU77AE4OYYIXIQYBQVGRUOOUK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php'
  package(s) announced via the FEDORA-2020-ce5a2a7403 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php", rpm:"php~7.3.16~1.fc30", rls:"FC30"))) {
    report += res;
  }
