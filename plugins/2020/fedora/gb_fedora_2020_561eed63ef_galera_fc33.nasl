...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878584");
  ...
  script_tag(name:"creation_date", value:"2020-11-09 04:22:55 +0000 (Mon, 09 Nov 2020)");
  script_name("Fedora: Security Advisory for galera (FEDORA-2020-561eed63ef)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MYCPY4F72X5BIRQY43ULYTYZSXEQNGZC");
...
for transactional databases and similar applications.");
  ...
  script_tag(name:"affected", value:"'galera' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"galera", rpm:"galera~26.4.6~1.fc33", rls:"FC33"))) {
    report += res;
  }
