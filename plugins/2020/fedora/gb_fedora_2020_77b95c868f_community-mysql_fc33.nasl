...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878392");
  ...
  script_tag(name:"creation_date", value:"2020-10-02 03:11:13 +0000 (Fri, 02 Oct 2020)");
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2020-77b95c868f)");
  ...
  script_xref(name:"FEDORA", value:"2020-77b95c868f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SA2XMR2ZY2BPR3VLTDVLNV74JL7TA7KL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'community-mysql'
  package(s) announced via the FEDORA-2020-77b95c868f advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.21~11.fc33", rls:"FC33"))) {
    report += res;
  }
