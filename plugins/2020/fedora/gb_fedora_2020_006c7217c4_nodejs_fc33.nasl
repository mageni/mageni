...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878393");
  ...
  script_name("Fedora: Security Advisory for nodejs (FEDORA-2020-006c7217c4)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/X7FUCAHX36BPRDRYTC6PARBM6KJPT32L");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs", rpm:"nodejs~14.11.0~1.fc33", rls:"FC33"))) {
    report += res;
  }
