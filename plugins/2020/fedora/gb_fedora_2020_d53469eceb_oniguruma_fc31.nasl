...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878452");
  ...
  script_name("Fedora: Security Advisory for oniguruma (FEDORA-2020-d53469eceb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2ZCUPCKJNSUHQMXXZBRNDDGQQLBJ2ACT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'oniguruma'
  package(s) announced via the FEDORA-2020-d53469eceb advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"oniguruma", rpm:"oniguruma~6.9.4~2.fc31", rls:"FC31"))) {
    report += res;
  }
