...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877300");
  ...
  script_name("Fedora Update for wordpress FEDORA-2019-6897642e3c");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GEO6CI6WPO3I3TUVV3IOYODENTAJ2EYS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2019-6897642e3c advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.2.3~1.fc31", rls:"FC31"))) {
    report += res;
  }
