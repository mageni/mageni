...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877455");
  ...
  script_name("Fedora: Security Advisory for libuv (FEDORA-2020-3838c8ea98)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZLB676PDU4RJQLWQUA277YNGYYNEYGWO");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libuv", rpm:"libuv~1.34.2~1.fc31", rls:"FC31"))) {
    report += res;
  }
