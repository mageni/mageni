...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877480");
  ...
  script_tag(name:"creation_date", value:"2020-02-18 04:06:58 +0000 (Tue, 18 Feb 2020)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-2a5cdd665c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XBHTLGOQ462S63SWUIQFKQUCXQGOP2DZ");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.4.18~100.fc30", rls:"FC30"))) {
    report += res;
  }
