...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877467");
  ...
  script_name("Fedora: Security Advisory for radare2 (FEDORA-2020-4a3ff78ba5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DUW4XXPI6XCI2G4X22EP3TKU2APLQ5XD");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"radare2", rpm:"radare2~4.2.1~2.fc30", rls:"FC30"))) {
    report += res;
  }
