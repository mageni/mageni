...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878383");
  ...
  script_tag(name:"creation_date", value:"2020-09-29 03:20:02 +0000 (Tue, 29 Sep 2020)");
  script_name("Fedora: Security Advisory for ghc-hakyll (FEDORA-2020-c39d7a562c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BICTJLIS5TK2PJUEMTR5OVU3YMDCHQF3");
...
as markdown or RST.");
  ...
  script_tag(name:"affected", value:"'ghc-hakyll' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghc-hakyll", rpm:"ghc-hakyll~4.13.4.0~3.fc33", rls:"FC33"))) {
    report += res;
  }
