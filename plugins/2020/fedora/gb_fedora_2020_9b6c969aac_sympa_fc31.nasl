...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877913");
  ...
  script_tag(name:"creation_date", value:"2020-06-07 03:27:44 +0000 (Sun, 07 Jun 2020)");
  script_name("Fedora: Security Advisory for sympa (FEDORA-2020-9b6c969aac)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3J4NZLGAF4ZYK52XEBQDTBNHLGBEPXXN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sympa'
  package(s) announced via the FEDORA-2020-9b6c969aac advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sympa", rpm:"sympa~6.2.56~1.fc31", rls:"FC31"))) {
    report += res;
  }
