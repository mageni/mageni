...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878072");
  ...
  script_tag(name:"creation_date", value:"2020-07-12 03:19:41 +0000 (Sun, 12 Jul 2020)");
  script_name("Fedora: Security Advisory for gssdp (FEDORA-2020-e538e3e526)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/L3SHL4LOFGHJ3DIXSUIQELGVBDJ7V7LB");
...
GUPnP API is intended to be easy to use, efficient and flexible.");
  ...
  script_tag(name:"affected", value:"'gssdp' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gssdp", rpm:"gssdp~1.0.4~1.fc31", rls:"FC31"))) {
    report += res;
  }
