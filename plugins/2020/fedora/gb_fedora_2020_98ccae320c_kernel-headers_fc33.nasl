...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878619");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-98ccae320c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UMM2ZFOA5AQPUKEX2BVGUVNPL2FIJPRJ");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.9.7~200.fc33", rls:"FC33"))) {
    report += res;
  }
