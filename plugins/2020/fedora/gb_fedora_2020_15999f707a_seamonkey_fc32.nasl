...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878314");
  ...
  script_tag(name:"creation_date", value:"2020-09-19 03:07:32 +0000 (Sat, 19 Sep 2020)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2020-15999f707a)");
  ...
  script_xref(name:"FEDORA", value:"2020-15999f707a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NQEVUG2M6FWXAPNY6IA7A4X3OUGLSF3J");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2020-15999f707a advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.4~1.fc32", rls:"FC32"))) {
    report += res;
  }
