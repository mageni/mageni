...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877800");
  ...
  script_name("Fedora: Security Advisory for roundcubemail (FEDORA-2020-835b7f0615)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AVUTBZFUZJT3DFKXU2I6OUXZ4BRTVCRH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail'
  package(s) announced via the FEDORA-2020-835b7f0615 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.4.4~1.fc32", rls:"FC32"))) {
    report += res;
  }
