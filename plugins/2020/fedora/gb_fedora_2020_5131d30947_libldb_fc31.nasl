...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878107");
  ...
  script_tag(name:"creation_date", value:"2020-07-18 03:20:49 +0000 (Sat, 18 Jul 2020)");
  script_name("Fedora: Security Advisory for libldb (FEDORA-2020-5131d30947)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6YLNQ5GRXUKYRUAOFZ4DUBVN4SMTL6Q2");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libldb", rpm:"libldb~2.0.12~1.fc31", rls:"FC31"))) {
    report += res;
  }
