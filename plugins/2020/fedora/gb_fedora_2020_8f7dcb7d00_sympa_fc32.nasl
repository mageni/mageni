...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877589");
  ...
  script_tag(name:"creation_date", value:"2020-03-17 04:08:47 +0000 (Tue, 17 Mar 2020)");
  script_name("Fedora: Security Advisory for sympa (FEDORA-2020-8f7dcb7d00)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A3FUYYLV6URRLAJVWXNJYK2CNOKKNHXC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sympa'
  package(s) announced via the FEDORA-2020-8f7dcb7d00 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sympa", rpm:"sympa~6.2.54~1.fc32", rls:"FC32"))) {
    report += res;
  }
