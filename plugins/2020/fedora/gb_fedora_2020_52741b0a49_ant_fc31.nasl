...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877930");
  ...
  script_tag(name:"creation_date", value:"2020-06-07 03:28:02 +0000 (Sun, 07 Jun 2020)");
  script_name("Fedora: Security Advisory for ant (FEDORA-2020-52741b0a49)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RRVAWTCVXJMRYKQKEXYSNBF7NLSR6OEI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ant'
  package(s) announced via the FEDORA-2020-52741b0a49 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ant", rpm:"ant~1.10.8~1.fc31", rls:"FC31"))) {
    report += res;
  }
