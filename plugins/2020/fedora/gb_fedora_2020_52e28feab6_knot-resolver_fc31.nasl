...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878313");
  ...
  script_tag(name:"creation_date", value:"2020-09-18 03:08:13 +0000 (Fri, 18 Sep 2020)");
  script_name("Fedora: Security Advisory for knot-resolver (FEDORA-2020-52e28feab6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2EYFPLVYWBEOPXNFW5V2BBVB3XKBDLN4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'knot-resolver'
  package(s) announced via the FEDORA-2020-52e28feab6 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"knot-resolver", rpm:"knot-resolver~5.1.3~1.fc31", rls:"FC31"))) {
    report += res;
  }
