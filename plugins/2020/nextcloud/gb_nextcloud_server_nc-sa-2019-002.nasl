...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143469");
  script_version("2020-02-06T02:06:10+0000");
  script_tag(name:"last_modification", value:"2020-02-06 02:06:10 +0000 (Thu, 06 Feb 2020)");
  script_tag(name:"creation_date", value:"2020-02-06 02:00:27 +0000 (Thu, 06 Feb 2020)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:P/A:N");

  script_cve_id("CVE-2020-8122");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Nextcloud Server < 12.0.13, < 13.0.8, < 14.0.4 Access Control Vulnerability (NC-SA-2019-002)");
  ...
  script_tag(name:"summary", value:"Nextcloud Server is prone to an improper access control vulnerability.");

  script_tag(name:"insight", value:"A missing check could give recipient the possibility to extend the expiration
  date of a share they received.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Nextcloud server versions prior 12.0.13, prior 13.0.8 and prior 14.0.4.");

  script_tag(name:"solution", value:"Update to version 12.0.13, 13.0.8, 14.0.4, 15.0.0 or later.");

  script_xref(name:"URL", value:"https://nextcloud.com/security/advisory/?id=NC-SA-2019-002");
