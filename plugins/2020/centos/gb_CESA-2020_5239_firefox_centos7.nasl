...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883304");
  ...
  script_tag(name:"creation_date", value:"2020-12-10 04:00:48 +0000 (Thu, 10 Dec 2020)");
  script_name("CentOS: Security Advisory for firefox (CESA-2020:5239)");
  ...
  script_xref(name:"CESA", value:"2020:5239");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-December/048209.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2020:5239 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~78.5.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
