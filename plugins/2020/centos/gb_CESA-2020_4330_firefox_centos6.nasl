...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883281");
  ...
  script_tag(name:"creation_date", value:"2020-11-10 04:01:00 +0000 (Tue, 10 Nov 2020)");
  script_name("CentOS: Security Advisory for firefox (CESA-2020:4330)");
  ...
  script_xref(name:"CESA", value:"2020:4330");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-November/035817.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2020:4330 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~78.4.0~2.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
