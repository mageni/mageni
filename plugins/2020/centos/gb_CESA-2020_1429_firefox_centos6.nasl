...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883221");
  ...
  script_tag(name:"creation_date", value:"2020-04-28 03:00:40 +0000 (Tue, 28 Apr 2020)");
  script_name("CentOS: Security Advisory for firefox (CESA-2020:1429)");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-April/035699.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2020:1429 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.7.0~2.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
