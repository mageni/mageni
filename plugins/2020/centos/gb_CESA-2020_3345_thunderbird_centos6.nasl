...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883272");
  ...
  script_tag(name:"creation_date", value:"2020-08-08 03:01:04 +0000 (Sat, 08 Aug 2020)");
  script_name("CentOS: Security Advisory for thunderbird (CESA-2020:3345)");
  ...
  script_xref(name:"CESA", value:"2020:3345");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-August/035795.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the CESA-2020:3345 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~68.11.0~1.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
