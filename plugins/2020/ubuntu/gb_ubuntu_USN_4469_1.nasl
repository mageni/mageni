...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for ghostscript (USN-4469-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-August/005575.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript'
  package(s) announced via the USN-4469-1 advisory.");
...
execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
