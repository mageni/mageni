...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for openssl (USN-4376-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-May/005452.html");
  ...
  script_tag(name:"insight", value:"Cesar Pereida García, Sohaib ul Hassan, Nicola Tuveri, Iaroslav Gridin,
...
traffic. (CVE-2019-1563)");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.1", ver:"1.1.1c-1ubuntu4.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.1", ver:"1.1.1-1ubuntu2.1~18.04.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.0.0", ver:"1.0.2g-1ubuntu4.16", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
