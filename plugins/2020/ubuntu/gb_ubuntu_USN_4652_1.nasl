...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for sniffit (USN-4652-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-November/005785.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sniffit'
  package(s) announced via the USN-4652-1 advisory.");
...
files. An attacker could possibly use this issue to execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'sniffit' package(s) on Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sniffit", ver:"0.3.7.beta-19ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
