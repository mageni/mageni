...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for containerd (USN-4589-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-October/005696.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd'
  package(s) announced via the USN-4589-1 advisory.");
...
user's registry credentials.");
  ...
  script_tag(name:"affected", value:"'containerd' package(s) on Ubuntu 16.04 LTS.");
