...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for qtbase-opensource-src (USN-4275-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005323.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qtbase-opensource-src'
  package(s) announced via the USN-4275-1 advisory.");
...
(CVE-2020-0570)");
  ...
  script_tag(name:"affected", value:"'qtbase-opensource-src' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
