...
if(description)
{
  ...
  script_cve_id("CVE-2019-14466", "CVE-2019-11187", "CVE-2018-1000528");
  ...
  script_name("Ubuntu: Security Advisory for gosa (USN-4609-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-October/005732.html");
...
flaw to run arbitrary web scripts. (CVE-2018-1000528)");
  ...
  script_tag(name:"affected", value:"'gosa' package(s) on Ubuntu 16.04 LTS.");
