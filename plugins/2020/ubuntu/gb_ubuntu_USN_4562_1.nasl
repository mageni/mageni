...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for ruby-kramdown (USN-4562-1)");
  ...
  script_xref(name:"USN", value:"4562-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-September/005672.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-kramdown'
  package(s) announced via the USN-4562-1 advisory.");
...
execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'ruby-kramdown' package(s) on Ubuntu 20.04 LTS.");
