...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for apt (USN-4359-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-May/005431.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apt'
  package(s) announced via the USN-4359-1 advisory.");
...
to crash.");
  ...
  script_tag(name:"affected", value:"'apt' package(s) on Ubuntu 20.04 LTS, Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"1.9.4ubuntu0.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"1.6.12ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"1.2.32ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"2.0.2ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
