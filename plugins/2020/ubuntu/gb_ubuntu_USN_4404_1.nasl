...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for nvidia-graphics-drivers-390 (USN-4404-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-June/005490.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nvidia-graphics-drivers-390'
  package(s) announced via the USN-4404-1 advisory.");
...
service. (CVE-2020-5973)");
  ...
  script_tag(name:"affected", value:"'nvidia-graphics-drivers-390' package(s) on Ubuntu 20.04 LTS, Ubuntu 19.10, Ubuntu 18.04 LTS.");
