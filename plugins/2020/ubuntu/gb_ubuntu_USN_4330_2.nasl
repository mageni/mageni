...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for php7.4 (USN-4330-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-May/005419.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.4'
  package(s) announced via the USN-4330-2 advisory.");
...
(CVE-2020-7066)");
  ...
  script_tag(name:"affected", value:"'php7.4' package(s) on Ubuntu 20.04 LTS.");
