...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libmaxminddb (USN-4631-1)");
  ...
  script_xref(name:"USN", value:"4631-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-November/005759.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmaxminddb'
  package(s) announced via the USN-4631-1 advisory.");
...
applications using libmaxminddb to crash, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'libmaxminddb' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmaxminddb0", ver:"1.4.2-0ubuntu1.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmaxminddb0", ver:"1.4.2-0ubuntu1.20.10.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
