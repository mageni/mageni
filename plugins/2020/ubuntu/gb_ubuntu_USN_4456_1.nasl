...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dovecot (USN-4456-1)");
  ...
  script_xref(name:"USN", value:"4456-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-August/005556.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot'
  package(s) announced via the USN-4456-1 advisory.");
...
cause Dovecot to crash, resulting in a denial of service. (CVE-2020-12674)");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.33.2-1ubuntu4.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.22-1ubuntu2.13", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.3.7.2-1ubuntu3.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
