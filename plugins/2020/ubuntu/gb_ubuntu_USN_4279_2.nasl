...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for php7.0 (USN-4279-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005340.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.0'
  package(s) announced via the USN-4279-2 advisory.");
...
and Ubuntu 19.10. (CVE-2020-7060)");
  ...
  script_tag(name:"affected", value:"'php7.0' package(s) on Ubuntu 16.04 LTS.");
