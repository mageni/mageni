...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libexif (USN-4277-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005326.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libexif'
  package(s) announced via the USN-4277-1 advisory.");
...
possibly use this issue to execute arbitrary code. (CVE-2019-9278)");
  ...
  script_tag(name:"affected", value:"'libexif' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexif12", ver:"0.6.21-5.1ubuntu0.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexif12", ver:"0.6.21-4ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexif12", ver:"0.6.21-2ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
