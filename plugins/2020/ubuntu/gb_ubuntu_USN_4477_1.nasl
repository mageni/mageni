...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2020-09-02 11:52:01 +0530 (Wed, 02 Sep 2020)");
  script_name("Ubuntu: Security Advisory for squid (USN-4477-1)");
  ...
  script_xref(name:"USN", value:"4477-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-August/005582.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid'
  package(s) announced via the USN-4477-1 advisory.");
...
denial of service. (CVE-2020-24606)");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"4.10-1ubuntu1.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
