...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for snapcraft (USN-4661-1)");
  ...
  script_xref(name:"USN", value:"4661-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-December/005794.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snapcraft'
  package(s) announced via the USN-4661-1 advisory.");
...
launched from the directory containing the library.");
  ...
  script_tag(name:"affected", value:"'snapcraft' package(s) on Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapcraft", ver:"2.43.1+18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapcraft", ver:"2.43.1+16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"itself", ver:"to Snapcraft 4.4.4 which is unaffected. For users of the deb", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
