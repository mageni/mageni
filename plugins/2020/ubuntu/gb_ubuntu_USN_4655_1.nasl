...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for python-werkzeug (USN-4655-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-December/005788.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-werkzeug'
  package(s) announced via the USN-4655-1 advisory.");
...
This issue only affected Ubuntu 16.04 LTS. (CVE-2020-28724)");
  ...
  script_tag(name:"affected", value:"'python-werkzeug' package(s) on Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
