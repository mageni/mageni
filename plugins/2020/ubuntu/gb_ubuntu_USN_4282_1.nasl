...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for postgresql-11 (USN-4282-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005331.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-11'
  package(s) announced via the USN-4282-1 advisory.");
...
procedure, materialized view, index, or trigger under certain conditions.");
  ...
  script_tag(name:"affected", value:"'postgresql-11' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-11", ver:"11.7-0ubuntu0.19.10.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-10", ver:"10.12-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
