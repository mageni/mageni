...
if(description)
{
  ...
  script_version("2020-12-17T08:55:57+0000");
  ...
  script_name("Openfire <= 4.6.0 Multiple XSS Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Openfire version 4.6.0 and probably prior.");
...
if (version_is_less_equal(version: version, test_version: "4.6.0")) {
