...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144003");
  script_version("2020-05-28T08:44:03+0000");
  script_tag(name:"last_modification", value:"2020-05-29 08:52:53 +0000 (Fri, 29 May 2020)");
  script_tag(name:"creation_date", value:"2020-05-28 08:26:02 +0000 (Thu, 28 May 2020)");
  ...
  script_name("Drupal 7.x Open Redirect Vulnerability (SA-CORE-2020-003) (Linux)");
