...
if(description)
{
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_25-2020-08)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 85.0.4183.83 on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version 85.0.4183.83 or later.
