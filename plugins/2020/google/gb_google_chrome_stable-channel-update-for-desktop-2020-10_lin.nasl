...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817507");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-10)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 86.0.4240.75 on Linux");
