...
if(description)
{
  ...
  script_version("2020-12-16T03:28:54+0000");
  ...
  script_tag(name:"insight", value:"Some of the tag's attributes could perform a double evaluation if a developer
  applied forced OGNL evaluation by using the %{...} syntax. Using forced OGNL evaluation on untrusted user input
  can lead to a remote code execution and security degradation.");

  script_tag(name:"affected", value:"Apache Struts versions 2.0.0 to 2.5.25.");

  script_tag(name:"solution", value:"Upgrade to version 2.5.26 or later.");
