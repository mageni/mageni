...
if(description)
{
  ...
  script_name("Fingerprint web server with favicon.ico");
  ...
  script_tag(name:"solution", value:"Remove the 'favicon.ico' file or create a custom one for your site.");

  script_tag(name:"impact", value:"The 'favicon.ico' file found on the remote web server belongs to a
  popular webserver/application. This may be used to fingerprint the webserver/application.");

  script_tag(name:"summary", value:"The remote web server contains a graphic image that is prone to
