...
# $Id: gb_wordpress_eol_lin.nasl 11983 2018-10-19 10:04:45Z mmartin $
#
# Wordpress End of Life Detection (Linux)
#
# Authors:
...
if( description )
{
  ...
  script_name("Wordpress End of Life Detection (Linux)");
  ...
  script_tag(name:"summary", value:"The Wordpress version on the remote host has reached the end of life and should not be used anymore.");

  script_tag(name:"impact", value:"An end of life version of Wordpress is not receiving any security updates from the vendor. Unfixed security vulnerabilities
