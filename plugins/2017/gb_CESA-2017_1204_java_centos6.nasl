...
#
# CentOS Update for java CESA-2017:1204 centos6
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882710");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2017-05-10 06:52:10 +0200 (Wed, 10 May 2017)");
  ...
  script_name("CentOS Update for java CESA-2017:1204 centos6");
...
established by a Java application. (CVE-2017-3533, CVE-2017-3544)");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2017-May/022404.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.7.0-openjdk", rpm:"java-1.7.0-openjdk~1.7.0.141~2.6.10.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.7.0-openjdk-demo", rpm:"java-1.7.0-openjdk-demo~1.7.0.141~2.6.10.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.141~2.6.10.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.7.0-openjdk-javadoc", rpm:"java-1.7.0-openjdk-javadoc~1.7.0.141~2.6.10.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.7.0-openjdk-src", rpm:"java-1.7.0-openjdk-src~1.7.0.141~2.6.10.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
