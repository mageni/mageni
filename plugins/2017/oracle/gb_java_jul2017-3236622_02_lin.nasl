...
#
# Oracle Java SE Security Updates (jul2017-3236622) 02 - Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108376");
  ...
  script_name("Oracle Java SE Security Updates (jul2017-3236622) 02 - Linux");
