...
# $Id: gb_mozilla_thunderbird_mfsa_2017-05_2017-07_win.nasl 11888 2018-10-12 15:27:49Z cfischer $
#
# Mozilla Thunderbird Security Updates(mfsa_2017-05_2017-07)-Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809312");
  ...
  script_tag(name:"creation_date", value:"2017-03-08 11:24:24 +0530 (Wed, 08 Mar 2017)");
  script_name("Mozilla Thunderbird Security Updates(mfsa_2017-05_2017-07)-Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Thunderbird version before 45.8 on Windows.");
