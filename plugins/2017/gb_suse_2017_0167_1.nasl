...
# $Id: gb_suse_2017_0167_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for icoutils openSUSE-SU-2017:0167-1 (icoutils)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for icoutils openSUSE-SU-2017:0167-1 (icoutils)");
...
if(release == "openSUSELeap42.2")
{
  ...
  if ((res = isrpmvuln(pkg:"icoutils", rpm:"icoutils~0.31.1~8.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"icoutils-debuginfo", rpm:"icoutils-debuginfo~0.31.1~8.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"icoutils-debugsource", rpm:"icoutils-debugsource~0.31.1~8.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
