...
#
# CentOS Update for firefox CESA-2017:0459 centos5
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882675");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2017-03-09 05:01:08 +0100 (Thu, 09 Mar 2017)");
  ...
  script_name("CentOS Update for firefox CESA-2017:0459 centos5");
...
the original reporters.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2017-March/022326.html");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~45.8.0~2.el5.centos", rls:"CentOS5")) != NULL)
  {
