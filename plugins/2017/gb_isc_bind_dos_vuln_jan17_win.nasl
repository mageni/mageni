...
# $Id: gb_isc_bind_dos_vuln_jan17_win.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
...
if(description)
{
  ...
  9.10.4-P3, and 9.11.x before 9.11.0rc3 on Windows.");

  script_tag(name:"solution", value:"Upgrade to ISC BIND version 9.9.9-P3 or
  9.10.4-P3 or 9.11.0rc3 or later on Windows.");
