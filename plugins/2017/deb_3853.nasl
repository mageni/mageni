...
# $Id: deb_3853.nasl 14280 2019-03-18 14:50:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"bitlbee", ver:"3.2.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-common", ver:"3.2.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-dev", ver:"3.2.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-libpurple", ver:"3.2.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-plugin-otr", ver:"3.2.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee", ver:"3.5-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-common", ver:"3.5-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-dev", ver:"3.5-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-libpurple", ver:"3.5-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bitlbee-plugin-otr", ver:"3.5-1", rls:"DEB9")) != NULL) {
  report += res;
}
