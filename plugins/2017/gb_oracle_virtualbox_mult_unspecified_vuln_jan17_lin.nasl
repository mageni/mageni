...
# $Id: gb_oracle_virtualbox_mult_unspecified_vuln_jan17_lin.nasl 11936 2018-10-17 09:05:37Z mmartin $
#
# Oracle Virtualbox Multiple Unspecified Vulnerabilities - 01 Jan17 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810510");
  ...
  script_tag(name:"creation_date", value:"2017-01-19 10:54:24 +0530 (Thu, 19 Jan 2017)");
  script_name("Oracle Virtualbox Multiple Unspecified Vulnerabilities - 01 Jan17 (Linux)");
  ...
  and prior to 5.1.14 on Linux.");

  script_tag(name:"solution", value:"Upgrade to Oracle VirtualBox version
  5.0.32 or 5.1.14 or later on Linux.");
