...
#
# Adobe Flash Player Within Google Chrome Security Update (apsb16-37) - Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810633");
  ...
  script_tag(name:"creation_date", value:"2017-03-17 16:34:20 +0530 (Fri, 17 Mar 2017)");
  script_name("Adobe Flash Player Within Google Chrome Security Update (apsb16-37) - Linux");
