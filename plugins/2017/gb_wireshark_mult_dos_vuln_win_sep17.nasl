...
# $Id: gb_wireshark_mult_dos_vuln_win_sep17.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811596");
  ...
  script_name("Wireshark 'IrCOMM' And 'MSDP' Dissectors DoS Vulnerabilities (Windows)");
