...
#
# Microsoft SharePoint Server Remote Code Execution Vulnerability (3191913)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811034");
  ...
  script_tag(name:"creation_date", value:"2017-05-10 12:25:39 +0530 (Wed, 10 May 2017)");
  script_tag(name:"qod_type", value:"executable_version");
  script_name("Microsoft SharePoint Server Remote Code Execution Vulnerability (3191913)");

  script_tag(name:"summary", value:"This host is missing an important security
  update for Microsoft SharePoint Server according to Microsoft KB3191913");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/3191913");
