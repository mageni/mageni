...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:3106-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-November/003419.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'kernel-firmware'
  package(s) announced via the SUSE-SU-2017:3106-1 advisory.");
