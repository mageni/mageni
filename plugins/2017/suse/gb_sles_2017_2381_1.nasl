...
if(description)
{
  ...
  script_cve_id("CVE-2017-2862","CVE-2017-2870","CVE-2017-6312");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2381-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-September/003191.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'gdk-pixbuf'
  package(s) announced via the SUSE-SU-2017:2381-1 advisory.");
