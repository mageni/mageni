...
if(description)
{
  ...
  script_cve_id("CVE-2017-7511","CVE-2017-7515","CVE-2017-9406");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1999-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-July/003076.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'poppler'
  package(s) announced via the SUSE-SU-2017:1999-1 advisory.");
