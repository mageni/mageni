...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000252","CVE-2017-11472","CVE-2017-12134");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2847-1)");
  ...
  package(s) announced via the SUSE-SU-2017:2847-1 advisory.");
