...
if(description)
{
  ...
  script_cve_id("CVE-2016-10200","CVE-2016-2117","CVE-2016-9191");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1183-1)");
  ...
  package(s) announced via the SUSE-SU-2017:1183-1 advisory.");
