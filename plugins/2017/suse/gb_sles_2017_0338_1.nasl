...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0338-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-January/002610.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'policycoreutils'
  package(s) announced via the SUSE-SU-2017:0338-1 advisory.");
