...
if(description)
{
  ...
  script_cve_id("CVE-2016-10028","CVE-2016-10029","CVE-2016-10155");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0625-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-March/002684.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2017:0625-1 advisory.");
