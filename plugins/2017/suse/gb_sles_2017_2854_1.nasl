...
if(description)
{
  ...
  script_cve_id("CVE-2017-11108","CVE-2017-11541","CVE-2017-11542");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2854-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-October/003355.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tcpdump'
  package(s) announced via the SUSE-SU-2017:2854-1 advisory.");
