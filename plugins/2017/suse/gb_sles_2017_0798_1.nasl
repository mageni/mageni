...
if(description)
{
  ...
  script_cve_id("CVE-2016-10163","CVE-2016-10214","CVE-2017-5580");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0798-1)");
  ...
  package(s) announced via the SUSE-SU-2017:0798-1 advisory.");
