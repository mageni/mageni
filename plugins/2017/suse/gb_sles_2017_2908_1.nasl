...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000363","CVE-2017-1000365","CVE-2017-1000380");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2908-1)");
  ...
  package(s) announced via the SUSE-SU-2017:2908-1 advisory.");
