...
if(description)
{
  ...
  script_cve_id("CVE-2016-10251","CVE-2016-9583","CVE-2016-9600");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0953-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-April/002789.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'jasper'
  package(s) announced via the SUSE-SU-2017:0953-1 advisory.");
