...
# $Id: gb_google_chrome_stable-channel-update-for-desktop_15-2017-06_lin.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
# Google Chrome Security Updates(stable-channel-update-for-desktop_15-2017-06)-Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810951");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_15-2017-06)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 59.0.3071.104 on Linux");
