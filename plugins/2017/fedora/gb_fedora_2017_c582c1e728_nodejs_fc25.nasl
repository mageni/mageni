...
# $Id: gb_fedora_2017_c582c1e728_nodejs_fc25.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YIOZ3PHJMBMHJGZPHUHUKZTSXF3GWNWG");
...
if(release == "FC25")
{
  ...
  if ((res = isrpmvuln(pkg:"nodejs", rpm:"nodejs~6.11.5~1.fc25", rls:"FC25")) != NULL)
  {
