...
# $Id: gb_fedora_2017_2783ef2c63_libXfont_fc26.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ECO3W2TYE7J65GI36WDPJ2MPDAUKUKRM");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"libXfont", rpm:"libXfont~1.5.2~5.fc26", rls:"FC26")) != NULL)
  {
