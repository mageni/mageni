...
# $Id: gb_fedora_2017_2522df3526_nodejs-balanced-match_fc26.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs-balanced-match'
