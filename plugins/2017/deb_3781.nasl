...
# $Id: deb_3781.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsvgsalamander-java", ver:"0~svn95-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsvgsalamander-java-doc", ver:"0~svn95-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
