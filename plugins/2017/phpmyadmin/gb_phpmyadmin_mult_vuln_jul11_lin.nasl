...
# $Id: gb_phpmyadmin_mult_vuln_jul11_lin.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
# phpMyAdmin 3.4.x < 3.4.3.2 Multiple Directory Traversal Vulnerabilities (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108240");
  ...
  script_name("phpMyAdmin 3.4.x < 3.4.3.2 Multiple Directory Traversal Vulnerabilities (Linux)");
