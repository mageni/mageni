...
#
# Microsoft Outlook 2016 Multiple Vulnerabilities (KB4011052)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811263");
  script_version("2019-05-20T11:12:48+0000");
  script_cve_id("CVE-2017-8571", "CVE-2017-8572", "CVE-2017-8663");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-05-20 11:12:48 +0000 (Mon, 20 May 2019)");
  script_tag(name:"creation_date", value:"2017-07-28 16:05:18 +0530 (Fri, 28 Jul 2017)");
  script_name("Microsoft Outlook 2016 Multiple Vulnerabilities (KB4011052)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4011052");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4011052");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.4573.1000"))
{
  report = 'File checked:     ' +  outlookFile + "\outlook.exe" + '\n' +
           'File version:     ' +  outlookVer  + '\n' +
           'Vulnerable range:  16.0 - 16.0.4573.1000'+ '\n' ;
