...
if(description)
{
  ...
  script_version("2021-11-24T03:03:53+0000");
  script_cve_id("CVE-2016-9933", "CVE-2016-9934", "CVE-2016-10397");
  ...
  script_name("PHP Multiple Vulnerabilities (Aug 2016) - Windows");
  ...
  script_tag(name:"affected", value:"PHP versions before 5.6.28 and 7.x before 7.0.13.");
