...
# $Id: deb_4065.nasl 14275 2019-03-18 14:39:45Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libssl1.0-dev", ver:"1.0.2l-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libssl1.0.2", ver:"1.0.2l-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
