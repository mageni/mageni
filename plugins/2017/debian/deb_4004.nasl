...
# $Id: deb_4004.nasl 14275 2019-03-18 14:39:45Z cfischer $
#
...
input before attempting deserialization. This allowed an attacker to
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libjackson2-databind-java", ver:"2.4.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjackson2-databind-java-doc", ver:"2.4.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjackson2-databind-java", ver:"2.8.6-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjackson2-databind-java-doc", ver:"2.8.6-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
