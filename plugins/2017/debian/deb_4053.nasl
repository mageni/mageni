...
# $Id: deb_4053.nasl 14284 2019-03-18 15:02:15Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"exim4", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-base", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-config", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-daemon-heavy", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-daemon-heavy-dbg", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-daemon-light", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-daemon-light-dbg", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-dbg", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"exim4-dev", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"eximon4", ver:"4.89-2+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
