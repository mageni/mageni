...
# $Id: gb_piwigo_mult_vuln_nov16.nasl 7865 2017-11-22 13:13:07Z cfischer $
#
...
if (description)
{
  ...
  script_version("$Revision: 7865 $");
  script_tag(name:"last_modification", value:"$Date: 2017-11-22 14:13:07 +0100 (Wed, 22 Nov 2017) $");
