...
# $Id: gb_adobe_flash_player_apsb17-32_macosx.nasl 11983 2018-10-19 10:04:45Z mmartin $
#
# Adobe Flash Player Security Updates( apsb17-32 )-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811973");
  ...
  script_tag(name:"creation_date", value:"2017-10-17 11:14:19 +0530 (Tue, 17 Oct 2017)");
  script_name("Adobe Flash Player Security Updates( apsb17-32 )-MAC OS X");
