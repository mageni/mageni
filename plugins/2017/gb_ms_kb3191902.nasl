...
if(description)
{
  ...
  update according to Microsoft KB3191902");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/3191902");
...
if(shareVer =~ "^(14\.)")
{
  ...
  if(dllVer)
  {
    if(version_in_range(version:dllVer, test_version:"14.0", test_version2:"14.0.7183.4999"))
    {
