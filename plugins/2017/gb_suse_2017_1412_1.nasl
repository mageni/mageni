...
# $Id: gb_suse_2017_1412_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for rpcbind openSUSE-SU-2017:1412-1 (rpcbind)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for rpcbind openSUSE-SU-2017:1412-1 (rpcbind)");
...
if(release == "openSUSELeap42.2")
{
  ...
  if ((res = isrpmvuln(pkg:"rpcbind", rpm:"rpcbind~0.2.3~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"rpcbind-debuginfo", rpm:"rpcbind-debuginfo~0.2.3~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcbind-debugsource", rpm:"pcbind-debugsource~0.2.3~3.3.1", rls:"openSUSELeap42.2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
