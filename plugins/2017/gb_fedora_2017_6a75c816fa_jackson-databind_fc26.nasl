...
# $Id: gb_fedora_2017_6a75c816fa_jackson-databind_fc26.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WOZFIZO57G7LRXLM2S5I6IRFCSP6IJPW");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"jackson-databind", rpm:"jackson-databind~2.7.6~3.fc26", rls:"FC26")) != NULL)
  {
