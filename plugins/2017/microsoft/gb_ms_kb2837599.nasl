...
#
# Microsoft Office 2010 Service Pack 2 Defense in Depth Vulnerability (KB2837599)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812031");
  script_version("2019-05-20T11:12:48+0000");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-05-20 11:12:48 +0000 (Mon, 20 May 2019)");
  script_tag(name:"creation_date", value:"2017-10-11 11:45:54 +0530 (Wed, 11 Oct 2017)");
  script_name("Microsoft Office 2010 Service Pack 2 Defense in Depth Vulnerability (KB2837599)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB2837599");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/2837599");
...
if(commonpath)
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"14.0", test_version2:"14.0.7189.4999"))
  {
