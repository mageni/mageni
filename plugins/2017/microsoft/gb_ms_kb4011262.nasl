...
if(description)
{
  ...
  update according to Microsoft KB4011262");
  ...
  attacker who successfully exploited the vulnerability to run arbitrary
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4011262");
