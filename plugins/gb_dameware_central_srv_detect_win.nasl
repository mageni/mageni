...
# $Id: gb_dameware_central_srv_detect_win.nasl 12753 2018-12-11 08:48:01Z mmartin $
#
# DameWare Central Server Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("DameWare Central Server Version Detection (Windows)");
  ...
  of DameWare Central Server for Windows.");
...
foreach key (key_list) {
  ...
  # "DameWare" without any version
    ...
    if(!appName || appName !~ "DameWare Central Server") continue;
    version = "unknown";
    concluded = appName;
    location = "unknown";
