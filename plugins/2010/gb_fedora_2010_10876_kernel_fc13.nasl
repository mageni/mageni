...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/043944.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313376");
  ...
  script_name("Fedora Update for kernel FEDORA-2010-10876");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~2.6.33.6~147.fc13", rls:"FC13")) != NULL)
  {
