...
#
# Mandriva Update for xinit MDVA-2010:037 (xinit)
#
# Authors:
...
tag_affected = "xinit on Mandriva Linux 2010.0,
  Mandriva Linux 2010.0/X86_64";
tag_insight = "The xinit manpage in 2010.0 was not reflecting the real application
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.313130");
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"xinit", rpm:"xinit~1.1.0~5.2mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
