#
#VID b6069837-aadc-11df-82df-0015f2db7bde
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID b6069837-aadc-11df-82df-0015f2db7bde
#
# Authors:
...
OpenTTD before 1.0.3 does not properly clear a pointer in a linked
...
http://www.vuxml.org/freebsd/b6069837-aadc-11df-82df-0015f2db7bde.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.314990");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.1")>=0 && revcomp(a:bver, b:"1.0.3")<0) {
