...
#
# Fedora Update for php-ZendFramework FEDORA-2010-0601
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/033990.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314568");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"php-ZendFramework", rpm:"php-ZendFramework~1.9.7~1.fc11", rls:"FC11")) != NULL)
  {
