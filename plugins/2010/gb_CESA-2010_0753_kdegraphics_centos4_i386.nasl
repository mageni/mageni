...
#
# CentOS Update for kdegraphics CESA-2010:0753 centos4 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-October/017053.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313539");
  ...
  script_name("CentOS Update for kdegraphics CESA-2010:0753 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"kdegraphics", rpm:"kdegraphics~3.3.1~18.el4_8.1", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"kdegraphics-devel", rpm:"kdegraphics-devel~3.3.1~18.el4_8.1", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
