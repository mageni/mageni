...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052502.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314424");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.0.11~1.fc13", rls:"FC13")) != NULL)
  {
