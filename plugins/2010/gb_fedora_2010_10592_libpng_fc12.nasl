...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/043736.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312764");
  ...
  script_name("Fedora Update for libpng FEDORA-2010-10592");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.2.44~1.fc12", rls:"FC12")) != NULL)
  {
