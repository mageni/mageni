...
tag_affected = "gzip on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/034495.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312856");
  ...
  script_name("Fedora Update for gzip FEDORA-2010-0964");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"gzip", rpm:"gzip~1.3.12~10.fc11", rls:"FC11")) != NULL)
  {
