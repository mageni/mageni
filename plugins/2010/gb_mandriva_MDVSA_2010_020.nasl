...
tag_insight = "Multiple vulnerabilities has been found and corrected in gzip:
...
tag_affected = "gzip on Mandriva Linux 2008.0,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-01/msg00064.php");
  script_oid("1.3.6.1.4.1.25623.1.0.314564");
  ...
  script_name("Mandriva Update for gzip MDVSA-2010:020 (gzip)");
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"gzip", rpm:"gzip~1.3.12~1.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"gzip", rpm:"gzip~1.3.12~3.1mdvmes5", rls:"MNDK_mes5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"gzip", rpm:"gzip~1.3.12~5.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2009.1")
{
  ...
  if ((res = isrpmvuln(pkg:"gzip", rpm:"gzip~1.3.12~4.1mdv2009.1", rls:"MNDK_2009.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2009.0")
{
  ...
  if ((res = isrpmvuln(pkg:"gzip", rpm:"gzip~1.3.12~3.1mdv2009.0", rls:"MNDK_2009.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
