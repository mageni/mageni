...
# $Id: gb_hp_smh_unspecified_vuln_lin.nasl 13960 2019-03-01 13:18:27Z cfischer $
#
# HP System Management Homepage Unspecified Vulnerability (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("HP System Management Homepage Unspecified Vulnerability (Linux)");
  ...
  script_tag(name:"solution", value:"Upgrade to HP SMH version 6.0.0-95 or later.");
  ...
  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to partially access and
  modify data and cause partial denial of service conditions.");
  script_tag(name:"affected", value:"HP System Management Homepage (SMH) 6.0 prior to 6.0.0-95");
