...
tag_affected = "libpng10 on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044397.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312839");
  script_version("$Revision: 8447 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-17 17:12:19 +0100 (Wed, 17 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-07-23 16:10:25 +0200 (Fri, 23 Jul 2010)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_xref(name: "FEDORA", value: "2010-10833");
  script_cve_id("CVE-2010-1205", "CVE-2010-2249", "CVE-2010-0205");
  script_name("Fedora Update for libpng10 FEDORA-2010-10833");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"libpng10", rpm:"libpng10~1.0.54~1.fc12", rls:"FC12")) != NULL)
  {
