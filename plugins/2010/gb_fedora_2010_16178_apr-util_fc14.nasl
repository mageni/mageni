...
tag_affected = "apr-util on Fedora 14";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050670.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312966");
  ...
  script_name("Fedora Update for apr-util FEDORA-2010-16178");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"apr-util", rpm:"apr-util~1.3.10~1.fc14", rls:"FC14")) != NULL)
  {
