...
#
# Fedora Update for ocsinventory FEDORA-2010-1540
#
# Authors:
...
tag_affected = "ocsinventory on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/034888.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314579");
  script_version("$Revision: 8356 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-10 09:00:39 +0100 (Wed, 10 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-03-02 08:38:02 +0100 (Tue, 02 Mar 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-1540");
  script_name("Fedora Update for ocsinventory FEDORA-2010-1540");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"ocsinventory", rpm:"ocsinventory~1.02.3~1.fc11", rls:"FC11")) != NULL)
  {
