...
tag_insight = "The default pam.d/system-auth file contains references to the
...
tag_affected = "drakx-installer-stage2 on Mandriva Enterprise Server 5,
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.315070");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"drakx-installer-stage2", rpm:"drakx-installer-stage2~11.71.11~2.2mdvmes5", rls:"MNDK_mes5")) != NULL)
  {
