...
tag_affected = "trac on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/038240.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314547");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"trac", rpm:"trac~0.11.7~1.fc12", rls:"FC12")) != NULL)
  {
