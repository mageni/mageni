...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049360.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313228");
  ...
  script_name("Fedora Update for php-pear-CAS FEDORA-2010-15796");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"php-pear-CAS", rpm:"php-pear-CAS~1.1.3~1.fc14", rls:"FC14")) != NULL)
  {
