...
#
# RedHat Update for firefox RHSA-2010:0808-01
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2010-October/msg00031.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313609");
  script_version("$Revision: 8495 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-23 08:57:49 +0100 (Tue, 23 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-11-04 12:09:38 +0100 (Thu, 04 Nov 2010)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "RHSA", value: "2010:0808-01");
  script_cve_id("CVE-2010-3765");
  script_name("RedHat Update for firefox RHSA-2010:0808-01");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~3.6.11~4.el4_8", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"firefox-debuginfo", rpm:"firefox-debuginfo~3.6.11~4.el4_8", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
