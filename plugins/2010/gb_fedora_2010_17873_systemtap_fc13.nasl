...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/051127.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314665");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"systemtap", rpm:"systemtap~1.3~3.fc13", rls:"FC13")) != NULL)
  {
