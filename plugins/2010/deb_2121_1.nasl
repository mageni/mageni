...
tag_insight = "Several remote vulnerabilities have been discovered in TYPO3.  The
...
announced via advisory DSA 2121-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202121-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.313426");
 ...
 script_name("Debian Security Advisory DSA 2121-1 (typo3-src)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"typo3-src-4.2", ver:"4.2.5-1+lenny6", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"typo3", ver:"4.2.5-1+lenny6", rls:"DEB5.0")) != NULL) {
    report += res;
}
