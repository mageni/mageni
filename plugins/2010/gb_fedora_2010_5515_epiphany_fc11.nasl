...
#
# Fedora Update for epiphany FEDORA-2010-5515
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038346.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313438");
  ...
  script_name("Fedora Update for epiphany FEDORA-2010-5515");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"epiphany", rpm:"epiphany~2.26.3~9.fc11", rls:"FC11")) != NULL)
  {
