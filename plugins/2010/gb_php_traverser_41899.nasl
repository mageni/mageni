...
# $Id: gb_php_traverser_41899.nasl 14233 2019-03-16 13:32:43Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"PHP Traverser is prone to a remote file-include vulnerability because
