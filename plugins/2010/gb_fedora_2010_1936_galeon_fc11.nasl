...
#
# Fedora Update for galeon FEDORA-2010-1936
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035364.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314602");
  ...
  script_name("Fedora Update for galeon FEDORA-2010-1936");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.7~20.fc11", rls:"FC11")) != NULL)
  {
