...
#
# Fedora Update for java-1.6.0-openjdk FEDORA-2010-12758
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/045468.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314772");
  ...
  script_name("Fedora Update for java-1.6.0-openjdk FEDORA-2010-12758");
