...
tag_affected = "nss-softokn on Fedora 14";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049888.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314904");
  ...
  script_name("Fedora Update for nss-softokn FEDORA-2010-15897");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"nss-softokn", rpm:"nss-softokn~3.12.8~1.fc14", rls:"FC14")) != NULL)
  {
