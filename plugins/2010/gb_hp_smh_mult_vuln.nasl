...
if(description)
{
  ...
  script_name("HP/HPE System Management Homepage (SMH) Multiple Vulnerabilities (HPSBMA02584, HPSBMA02578");
  ...
  script_xref(name:"URL", value:"https://support.hpe.com/hpesc/public/docDisplay?docLocale=en_US&docId=c02514929");
  script_xref(name:"URL", value:"https://support.hpe.com/hpesc/public/docDisplay?docLocale=en_US&docId=c02514953");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaws are due to:

  - An unspecified error in the application, allows remote attackers to obtain sensitive information
  via unknown vectors.

  - An open redirect vulnerability in the application, allows remote attackers to redirect users to
  ...
  information or to redirect users to arbitrary web sites and conduct phishing attacks.");

  script_tag(name:"affected", value:"HP/HPE SMH prior to version 6.2 on all platforms.");
