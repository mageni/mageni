...
tag_affected = "zikula on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/042520.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314956");
  ...
  script_name("Fedora Update for zikula FEDORA-2010-8501");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"zikula", rpm:"zikula~1.2.3~1.fc13", rls:"FC13")) != NULL)
  {
