...
# $Id: gb_ms_ie_dep_remote_code_exec_vuln.nasl 12490 2018-11-22 13:45:33Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Internet Explorer Version 6.x, 7.x, 8.x");
  ...
  script_tag(name:"summary", value:"The host is installed with Internet Explorer and is prone to Remote Code
