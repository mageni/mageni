...
tag_affected = "libprelude on Fedora 12";
tag_insight = "Libprelude is a library that guarantees secure connections between
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041969.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313229");
  ...
  script_name("Fedora Update for libprelude FEDORA-2010-8756");

  script_tag(name: "summary" , value: "Check for the Version of libprelude");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"libprelude", rpm:"libprelude~0.9.24.1~2.fc12", rls:"FC12")) != NULL)
  {
