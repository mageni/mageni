...
tag_affected = "ocsinventory on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/034876.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313463");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"ocsinventory", rpm:"ocsinventory~1.02.3~1.fc12", rls:"FC12")) != NULL)
  {
