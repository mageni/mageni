...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.314666");
  ...
  script_name("Fedora Update for kdeutils FEDORA-2010-6096");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdeutils", rpm:"kdeutils~4.4.2~1.fc12", rls:"FC12")) != NULL)
  {
