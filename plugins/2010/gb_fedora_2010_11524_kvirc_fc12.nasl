...
#
# Fedora Update for kvirc FEDORA-2010-11524
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044643.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314500");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kvirc", rpm:"kvirc~4.0.0~3.fc12", rls:"FC12")) != NULL)
  {
