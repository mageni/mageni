...
tag_affected = "viewvc on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038456.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313300");
 ...
 script_version("$Revision: 8495 $");
  ...
  script_xref(name: "FEDORA", value: "2010-5524");
  script_name("Fedora Update for viewvc FEDORA-2010-5524");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"viewvc", rpm:"viewvc~1.1.5~1.fc12", rls:"FC12")) != NULL)
  {
