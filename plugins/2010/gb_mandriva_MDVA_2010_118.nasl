...
#
# Mandriva Update for firefox-ext-plasmanotify MDVA-2010:118 (firefox-ext-plasmanotify)
#
# Authors:
...
tag_affected = "firefox-ext-plasmanotify on Mandriva Linux 2010.0,
  Mandriva Linux 2010.0/X86_64";
tag_insight = "It was discovered that firefox-ext-plasmanotify-0.3.0 did not
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-04/msg00011.php");
  script_oid("1.3.6.1.4.1.25623.1.0.313629");
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox-ext-plasmanotify", rpm:"firefox-ext-plasmanotify~0.3.1~0.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
