...
tag_insight = "This update fixes several bugs in existing package:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-02/msg00011.php");
  script_oid("1.3.6.1.4.1.25623.1.0.313716");
  ...
  script_xref(name: "MDVA", value: "2010:054");
  script_name("Mandriva Update for cacti MDVA-2010:054 (cacti)");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.7e~8.1mdvmes5", rls:"MNDK_mes5")) != NULL)
  {
