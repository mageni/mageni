...
tag_affected = "libtiff on Red Hat Enterprise Linux AS version 3,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2010-July/msg00004.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313215");
  script_version("$Revision: 8314 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-08 09:01:01 +0100 (Mon, 08 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-07-12 11:56:20 +0200 (Mon, 12 Jul 2010)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "RHSA", value: "2010:0520-01");
  script_cve_id("CVE-2010-1411", "CVE-2010-2598");
  script_name("RedHat Update for libtiff RHSA-2010:0520-01");
...
if(release == "RHENT_3")
{
  ...
  if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.5.7~34.el3", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-debuginfo", rpm:"libtiff-debuginfo~3.5.7~34.el3", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.5.7~34.el3", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
