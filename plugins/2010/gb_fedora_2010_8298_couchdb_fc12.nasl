...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041183.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313199");
  script_version("$Revision: 8469 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-19 08:58:21 +0100 (Fri, 19 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-05-17 16:00:10 +0200 (Mon, 17 May 2010)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_xref(name: "FEDORA", value: "2010-8298");
  script_cve_id("CVE-2010-0009");
  script_name("Fedora Update for couchdb FEDORA-2010-8298");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"couchdb", rpm:"couchdb~0.10.2~1.fc12", rls:"FC12")) != NULL)
  {
