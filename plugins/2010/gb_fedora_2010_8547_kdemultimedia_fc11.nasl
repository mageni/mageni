...
#
# Fedora Update for kdemultimedia FEDORA-2010-8547
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041993.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313879");
  ...
  script_name("Fedora Update for kdemultimedia FEDORA-2010-8547");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"kdemultimedia", rpm:"kdemultimedia~4.4.3~1.fc11.1", rls:"FC11")) != NULL)
  {
