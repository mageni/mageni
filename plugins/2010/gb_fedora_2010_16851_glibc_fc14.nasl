...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/050096.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313900");
  script_version("$Revision: 8447 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-17 17:12:19 +0100 (Wed, 17 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_xref(name: "FEDORA", value: "2010-16851");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_cve_id("CVE-2010-3856");
  script_name("Fedora Update for glibc FEDORA-2010-16851");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"glibc", rpm:"glibc~2.12.90~18", rls:"FC14")) != NULL)
  {
