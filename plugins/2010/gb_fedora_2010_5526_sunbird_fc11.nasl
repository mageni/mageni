...
#
# Fedora Update for sunbird FEDORA-2010-5526
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038368.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314916");
  ...
  script_name("Fedora Update for sunbird FEDORA-2010-5526");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"sunbird", rpm:"sunbird~1.0~0.16.20090715hg.fc11", rls:"FC11")) != NULL)
  {
