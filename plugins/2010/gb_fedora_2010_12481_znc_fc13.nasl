...
#
# Fedora Update for znc FEDORA-2010-12481
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/045385.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314311");
  ...
  script_name("Fedora Update for znc FEDORA-2010-12481");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"znc", rpm:"znc~0.093~2.svn2101.fc13", rls:"FC13")) != NULL)
  {
