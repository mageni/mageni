...
tag_affected = "tar on Red Hat Enterprise Linux (v. 5 server),
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2010-March/msg00006.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314655");
  script_version("$Revision: 8528 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-25 08:57:36 +0100 (Thu, 25 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-03-22 11:34:53 +0100 (Mon, 22 Mar 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "RHSA", value: "2010:0141-01");
  script_cve_id("CVE-2007-4476", "CVE-2010-0624");
  script_name("RedHat Update for tar RHSA-2010:0141-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"tar", rpm:"tar~1.15.1~23.0.1.el5_4.2", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tar-debuginfo", rpm:"tar-debuginfo~1.15.1~23.0.1.el5_4.2", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"tar", rpm:"tar~1.14~13.el4_8.1", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tar-debuginfo", rpm:"tar-debuginfo~1.14~13.el4_8.1", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
