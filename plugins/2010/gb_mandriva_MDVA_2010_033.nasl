...
tag_affected = "gnupg2 on Mandriva Linux 2009.1,
  Mandriva Linux 2009.1/X86_64";
tag_insight = "A packaging mistake lead to that the gpg-agent was not started by
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-01/msg00054.php");
  script_oid("1.3.6.1.4.1.25623.1.0.313297");
...
if(release == "MNDK_2009.1")
{
  ...
  if ((res = isrpmvuln(pkg:"gnupg2", rpm:"gnupg2~2.0.11~1.3mdv2009.1", rls:"MNDK_2009.1")) != NULL)
  {
