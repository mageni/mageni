...
#
# Fedora Update for firefox FEDORA-2010-1727
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035423.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314992");
  ...
  script_name("Fedora Update for firefox FEDORA-2010-1727");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~3.5.8~1.fc12", rls:"FC12")) != NULL)
  {
