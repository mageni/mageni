...
#
# Fedora Update for kdeadmin FEDORA-2010-6096
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039469.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312806");
  ...
  script_name("Fedora Update for kdeadmin FEDORA-2010-6096");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdeadmin", rpm:"kdeadmin~4.4.2~1.fc12", rls:"FC12")) != NULL)
  {
