...
#
# Fedora Update for lighttpd FEDORA-2010-7643
#
# Authors:
...
tag_affected = "lighttpd on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041307.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314586");
  ...
  script_name("Fedora Update for lighttpd FEDORA-2010-7643");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"lighttpd", rpm:"lighttpd~1.4.26~2.fc12", rls:"FC12")) != NULL)
  {
