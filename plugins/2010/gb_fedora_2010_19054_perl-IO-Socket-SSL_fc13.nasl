...
tag_affected = "perl-IO-Socket-SSL on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052594.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314923");
  ...
  script_name("Fedora Update for perl-IO-Socket-SSL FEDORA-2010-19054");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-IO-Socket-SSL", rpm:"perl-IO-Socket-SSL~1.37~1.fc13", rls:"FC13")) != NULL)
  {
