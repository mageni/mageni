...
#
# Fedora Update for drupal-views FEDORA-2010-10124
#
# Authors:
...
tag_affected = "drupal-views on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043097.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313404");
  script_version("$Revision: 8244 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-25 08:29:28 +0100 (Mon, 25 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-06-25 12:25:26 +0200 (Fri, 25 Jun 2010)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-10124");
  script_name("Fedora Update for drupal-views FEDORA-2010-10124");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-views", rpm:"drupal-views~6.x.2.11~1.fc12", rls:"FC12")) != NULL)
  {
