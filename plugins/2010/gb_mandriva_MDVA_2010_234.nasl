...
tag_affected = "ocsinventory-agent on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "This updates fixes one bug:
  In file
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-11/msg00025.php");
  script_oid("1.3.6.1.4.1.25623.1.0.313378");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"ocsinventory-agent", rpm:"ocsinventory-agent~1.02~2.3mdvmes5.1", rls:"MNDK_mes5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"perl-Ocsinventory", rpm:"perl-Ocsinventory~1.02~2.3mdvmes5.1", rls:"MNDK_mes5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
