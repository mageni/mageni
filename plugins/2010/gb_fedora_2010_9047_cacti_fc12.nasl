...
#
# Fedora Update for cacti FEDORA-2010-9047
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041880.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313912");
  ...
  script_name("Fedora Update for cacti FEDORA-2010-9047");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.7f~1.fc12", rls:"FC12")) != NULL)
  {
