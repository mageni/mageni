...
tag_affected = "openssl on CentOS 3";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-March/016580.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313136");
  ...
  script_name("CentOS Update for openssl CESA-2010:0163 centos3 i386");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"openssl", rpm:"openssl~0.9.7a~33.26", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openssl-devel", rpm:"openssl-devel~0.9.7a~33.26", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openssl-perl", rpm:"openssl-perl~0.9.7a~33.26", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
