...
tag_affected = "pango on CentOS 3";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-March/016566.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314412");
  ...
  script_name("CentOS Update for pango CESA-2010:0140 centos3 i386");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"pango", rpm:"pango~1.2.5~10", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pango-devel", rpm:"pango-devel~1.2.5~10", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
