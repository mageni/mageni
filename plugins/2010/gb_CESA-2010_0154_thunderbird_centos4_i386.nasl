...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-March/016576.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314439");
  ...
  script_name("CentOS Update for thunderbird CESA-2010:0154 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~1.5.0.12~25.el4.centos", rls:"CentOS4")) != NULL)
  {
