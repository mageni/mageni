...
# $Id: gb_ms_ie_iframe_dos_vuln_june10.nasl 11553 2018-09-22 14:22:01Z cfischer $
#
...
denial of service.");
  script_tag(name:"affected", value:"Microsoft Internet Explorer version 6.0.2900.2180/8.0.7600.16385
and prior.");
  script_tag(name:"insight", value:"The flaw is due to improper handling of an 'JavaScript' code
which contains an infinite loop, that creates IFRAME elements for invalid
news:// URIs.");
