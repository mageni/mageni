...
tag_affected = "gnutls on CentOS 4";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-March/016605.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314909");
  ...
  script_name("CentOS Update for gnutls CESA-2010:0167 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~1.0.20~4.el4_8.7", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gnutls-devel", rpm:"gnutls-devel~1.0.20~4.el4_8.7", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
