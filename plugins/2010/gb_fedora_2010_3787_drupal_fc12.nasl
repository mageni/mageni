...
#
# Fedora Update for drupal FEDORA-2010-3787
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/036619.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313822");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.16~1.fc12", rls:"FC12")) != NULL)
  {
