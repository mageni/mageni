...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/040652.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313107");
  ...
  script_name("Fedora Update for httpd FEDORA-2010-6131");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.2.15~1.fc11.1", rls:"FC11")) != NULL)
  {
