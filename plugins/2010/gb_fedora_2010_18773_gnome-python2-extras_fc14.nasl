...
#
# Fedora Update for gnome-python2-extras FEDORA-2010-18773
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052034.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312717");
  ...
  script_name("Fedora Update for gnome-python2-extras FEDORA-2010-18773");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.25.3~26.fc14.1", rls:"FC14")) != NULL)
  {
