...
tag_affected = "ncpfs on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/034422.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314516");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"ncpfs", rpm:"ncpfs~2.2.6~12.fc11", rls:"FC11")) != NULL)
  {
