...
#
# Fedora Update for chmsee FEDORA-2010-5515
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038339.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314845");
  ...
  script_name("Fedora Update for chmsee FEDORA-2010-5515");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.1~16.fc11", rls:"FC11")) != NULL)
  {
