...
#
# Fedora Update for kdenetwork FEDORA-2010-8544
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041924.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313187");
  ...
  script_name("Fedora Update for kdenetwork FEDORA-2010-8544");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdenetwork", rpm:"kdenetwork~4.4.3~3.fc12", rls:"FC12")) != NULL)
  {
