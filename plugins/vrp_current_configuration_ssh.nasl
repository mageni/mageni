...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150243");
  ...
  script_name("Huawei Data Communication: Read current-configuration configuration ssh");
  ...
  script_tag(name:"summary", value:"Get the current SSH configuration of the VRP device.
...
cmd = "display current-configuration | include ssh";
...
if(!ret){
  set_kb_item(name:"Policy/vrp/current_configuration/ssh/ERROR", value:TRUE);
  exit(0);
}

set_kb_item(name:"Policy/vrp/current_configuration/ssh", value:ret);
