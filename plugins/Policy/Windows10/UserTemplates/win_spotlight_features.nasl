...
# $Id: win_spotlight_features.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Turn off all Windows spotlight features
# (users listed in HKU)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312240");
...
'Turn off all Windows spotlight features' on Windows hosts (at least Windows 10).

The setting turns off all Windows Spotlight features at once.");
  exit(0);
}
