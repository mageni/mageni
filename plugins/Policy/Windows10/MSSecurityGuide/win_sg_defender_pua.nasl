...
# $Id: win_sg_defender_pua.nasl 10797 2018-08-06 14:54:44Z emoss $
#
# Check value for Turn on Windows Defender protection against Potentially Unwanted Applications
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312287");
  ...
  script_name('Microsoft Windows 10: MS Security Guide: Windows Defender protection against PUA');
...
on Windows hosts (Windows 10).

The setting controls if Windows Defender protects against Potentially Unwanted
Applications (PUA).");
  exit(0);
}
