...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312234");
  ...
  script_name('Microsoft Windows 10: Prevent the usage of OneDrive for file storage');
...
Computer Configuration/Administrative Templates/Windows Components/OneDrive/' + title;
type = 'HKLM';
