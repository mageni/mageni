...
# $Id: win10_manage_auditing_security_log.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Manage auditing and security log (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312261");
  ...
  script_name('Microsoft Windows 10: Manage auditing and security log');
...
can specify object access audit options for individual resources such as files, 
Active Directory objects, and registry keys. These objects specify their system 
access control lists (SACL). A user who is assigned this user right can also 
view and clear the Security log in Event Viewer.");
  exit(0);
}
