...
# $Id: win10_debug_programs.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Debug programs (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312263");
  ...
  script_name('Microsoft Windows 10: Debug programs');
...
can attach to or open any process, even those they do not own. Developers who 
are debugging their own applications do not need to be assigned this user right. 
Developers who are debugging new system components need this user right. This 
user right provides access to sensitive and critical operating-system components.");
  exit(0);
}
