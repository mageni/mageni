...
# $Id: win_query_remote_server.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Microsoft Support Diagnostic Tool: Turn on MSDT interactive
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312638");
...
'Microsoft Support Diagnostic Tool: Turn on MSDT interactive communication with support provider' on
...
Earlier versions of Microsoft Windows are not supported any more.');
  exit(0);
}
