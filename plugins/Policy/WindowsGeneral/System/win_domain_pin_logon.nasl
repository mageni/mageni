...
# $Id: win_domain_pin_logon.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Turn on convenience PIN sign-in
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312631");
...
'Turn on convenience PIN sign-in' on Windows hosts (at least Windows 8.1).

The setting controls whether a domain user can sign in using a convenience PIN.");
  exit(0);
}
