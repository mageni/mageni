...
# $Id: win_network_activity_standby_plugged.nasl 10819 2018-08-07 14:11:07Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312597");
  ...
  script_name('Microsoft Windows: Allow network connectivity during connected-standby (plugged in)');
...
'Allow network connectivity during connected-standby (plugged in)' on Windows hosts (at least
Windows 8.1).
...
title = 'Allow network connectivity during connected-standby (plugged in)';
