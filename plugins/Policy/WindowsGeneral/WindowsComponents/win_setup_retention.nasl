...
# $Id: win_setup_retention.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Setup: Control Event Log behavior when the log file reaches
# its maximum size
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312404");
  ...
  script_name('Microsoft Windows: Event Log behavior when log file reaches its max size (Setup)');
