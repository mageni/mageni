...
# $Id: win_spynet_reporting.nasl 10989 2018-08-15 14:57:51Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312467");
  ...
  script_name('Microsoft Windows: Configure Microsoft SpyNet Reporting');
...
in Microsoft MAPS (formerly known as SpyNet).
