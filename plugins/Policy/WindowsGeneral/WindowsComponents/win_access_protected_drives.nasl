...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312421");
  ...
  script_name('Microsoft Windows: Access to BitLocker-protected fixed data drives (earlier Windows versions)');
...
The policy setting controls whether or not fixed data drives formatted with the
...
title = 'Allow access to BitLocker-protected fixed data drives from earlier versions of Windows';
fixtext = 'Set following UI path accordingly:
Computer Configuration/Administrative Templates/Windows Components/
BitLocker Drive Encryption/Fixed Data Drives/' + title;
type = 'HKLM';
key = 'Software\\Policies\\Microsoft\\FVE';
item = 'FDVDiscoveryVolumeType';
