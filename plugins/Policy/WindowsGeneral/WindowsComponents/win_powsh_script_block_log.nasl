...
# $Id: win_powsh_script_block_log.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Turn on PowerShell Script Block Logging
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312388");
...
'Turn on PowerShell Script Block Logging' on
Windows hosts (at least Windows 7).

The setting enables logging of all PowerShell script input to the
