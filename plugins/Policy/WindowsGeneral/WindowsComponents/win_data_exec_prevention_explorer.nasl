...
# $Id: win_data_exec_prevention_explorer.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Turn off Data Execution Prevention for Explorer
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312424");
  ...
  script_name('Microsoft Windows: Data Execution Prevention for Explorer');
...
'Turn off Data Execution Prevention for Explorer' on Windows hosts (at least Windows 7).
