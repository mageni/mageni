...
# $Id: win_ml_enableicmpredirect.nasl 10797 2018-08-06 14:54:44Z emoss $
#
# Check value for MSS: (EnableICMPRedirect) Allow ICMP redirects to override OSPF generated routes
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312697");
  script_version("$Revision: 10797 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-06 16:54:44 +0200 (Mon, 06 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-15 12:32:43 +0200 (Fri, 15 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: MSS: Allow ICMP redirects to override OSPF generated routes');
...
routes' on Windows hosts (at least Windows 7).");
  exit(0);
}
