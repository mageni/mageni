...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312526");
  ...
  script_name('Microsoft Windows: User Account Control: UIAccess applications prompt for elevation without secure desktop');
