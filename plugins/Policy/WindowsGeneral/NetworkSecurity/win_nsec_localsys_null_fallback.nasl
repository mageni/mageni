...
# $Id: win_nsec_localsys_null_fallback.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for Network security: Allow LocalSystem NULL session fallback
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312367");
  ...
  script_name('Microsoft Windows: Network security: Allow LocalSystem NULL session fallback');
...
The setting controls whether NTLM is allowed to fall back to a NULL session when
