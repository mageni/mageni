...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109934");
  ...
  script_name("Windows Defender Firewall: Domain Profile: Allow unicast response");
...
broadcast messages for a domain connection will be blocked.");
...
win_min_ver = "6.1";
title = "Domain Profile: Allow unicast response";
