...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109563");
  ...
  script_name("Microsoft Windows Firewall: Private: Settings: Display a notification");
...
win_min_ver = "6.1";
title = "Private Profile: Settings: Display a notification";
