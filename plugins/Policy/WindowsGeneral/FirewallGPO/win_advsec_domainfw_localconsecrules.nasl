...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109933");
  ...
  script_name("Windows Defender Firewall: Domain Profile: Apply local connection security rules");
...
win_min_ver = "6.1";
title = "Domain Profile: Settings: Apply local connection security rules";
