...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109575");
  ...
  script_name("Microsoft Windows Firewall: Public: Logging: Log successful connections");
...
win_min_ver = "6.1";
title = "Public Profile: Logging: Log successful connections";
