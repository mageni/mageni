...
# $Id: win_advsec_publicfw_localconsecrules.nasl 10010 2018-05-29 14:43:35Z emoss $
#
# Check value for Windows Defender Firewall: Public: Apply local connection security rules
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312490");
...
The policy determines whether the local connection rules are merged with GP
