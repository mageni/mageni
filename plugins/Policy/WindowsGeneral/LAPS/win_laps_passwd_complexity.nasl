...
# $Id: win_laps_passwd_complexity.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for Password Settings: Password Complexity
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312583");
  ...
  script_name('Microsoft Windows: LAPS: Password Settings: Password Complexity');
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2018 Greenbone Networks GmbH");
  script_family("Policy");
  script_dependencies("smb_reg_service_pack.nasl");
  script_add_preference(name:"Value", type:"radio", value:"4;1;2;3");
  script_mandatory_keys("Compliance/Launch");
  script_tag(name: "summary", value: "This test checks the setting for policy
'Password Settings: Password Complexity' on Windows hosts (at least Windows 7).
...
title = 'Password Settings: Password Complexity';
