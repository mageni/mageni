...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150230");
  ...
  script_name("Linux: SSH GatewayPorts");
  ...
  script_add_preference(name:"Value", type:"radio", value:"no;yes;clientspecified", id:1);
...
cmd = "grep '^GatewayPorts' /etc/ssh/sshd_config";
title = "SSH GatewayPorts";
...
if(get_kb_item("linux/mount/ERROR")){
  ...
  value = get_kb_item("Policy/linux/sshd_config/gatewayports");
