...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150066");
  ...
  script_name("Linux: SSH Protocol");
  ...
  script_add_preference(name:"Value", type:"entry", value:"2", id:1);
...
if(get_kb_item("Policy/linux/sshd_config/ERROR")){
  ...
  value = get_kb_item("Policy/linux/sshd_config/protocol");
