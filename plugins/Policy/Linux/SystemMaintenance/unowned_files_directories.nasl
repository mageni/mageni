...
This user automatically becomes the owner of these file or directory.
...
cmd = "df --local --output='target' | xargs -I '{}' find '{}' -xdev -nouser";
...
if(!get_kb_item("login/SSH/success") || !sock = ssh_login_or_reuse_connection()){
  ...
  compliant = "yes";
  ssh_cmd = 'df --local --output="target" | grep \'/\' | xargs -I \'{}\' find \'{}\' -xdev -nouser 2>/dev/null';
