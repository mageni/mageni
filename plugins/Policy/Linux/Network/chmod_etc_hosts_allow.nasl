...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150093");
  ...
  script_name("Linux: SSH /etc/hosts.allow chmod");
...
title = "chmod /etc/hosts.allow";
solution = "chmod PERMISSION /etc/hosts.allow";
test_type = "SSH_Cmd";
