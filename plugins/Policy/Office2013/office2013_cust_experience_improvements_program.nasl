...
# $Id: office2013_cust_experience_improvements_program.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Customer Experience Improvement Program
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312347");
  ...
  script_name('Microsoft Office 2013: Customer Experience Improvement Program');
  ...
  script_tag(name: "summary", value: 'Check Setting "Customer Experience Improvement Program" (Microsoft Office 2013).');
  exit(0);
}
