...
# $Id: office2013_first_run_on_app_boot.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Disable Office First Run on application boot
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312351");
  ...
  script_name('Microsoft Office 2013: Disable Office First Run on application boot');
  ...
  script_tag(name: "summary", value: 'Check Setting "Disable Office First Run on application boot" (Microsoft Office 2013).');
  exit(0);
}
...
type = 'HKCU';
key = 'Software\\Policies\\Microsoft\\Office\\15.0\\firstrun';
item = 'bootedrtm';
