...
# $Id: office2013_automation_security.nasl 9659 2018-04-27 11:55:11Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312309");
  ...
  script_name('Microsoft Office 2013: Automation Security');
  ...
  script_tag(name: "summary", value: 'Check Setting "Automation Security" (Microsoft Office 2013).');
  exit(0);
}
