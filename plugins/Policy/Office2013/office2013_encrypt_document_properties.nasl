...
# $Id: office2013_encrypt_document_properties.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Encrypt document properties
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312349");
  ...
  script_name('Microsoft Office 2013: Encrypt document properties');
  ...
  script_tag(name: "summary", value: 'Check Setting "Encrypt document properties" (Microsoft Office 2013).');
  exit(0);
}
