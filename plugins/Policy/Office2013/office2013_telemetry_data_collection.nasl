...
# $Id: office2013_telemetry_data_collection.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Turn on telemetry data collection
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312330");
  ...
  script_name('Microsoft Office 2013: Turn on telemetry data collection');
  ...
  script_tag(name: "summary", value: 'Check Setting "Turn on telemetry data collection" (Microsoft Office 2013).');
  exit(0);
}
