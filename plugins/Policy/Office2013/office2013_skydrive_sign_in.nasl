...
# $Id: office2013_skydrive_sign_in.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Show SkyDrive Sign In
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312338");
  ...
  script_name('Microsoft Office 2013: Show SkyDrive Sign In');
  ...
  script_tag(name: "summary", value: 'Check Setting "Show SkyDrive Sign In" (Microsoft Office 2013).');
  exit(0);
}
