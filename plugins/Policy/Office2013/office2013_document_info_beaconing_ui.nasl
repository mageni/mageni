...
# $Id: office2013_document_info_beaconing_ui.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Document Info Beaconing UI
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312319");
  ...
  script_name('Microsoft Office 2013: Document Information Panel Beaconing UI');
  ...
  script_tag(name: "summary", value: 'Check Setting "Document Information Panel Beaconing UI" (Microsoft Office 2013).');
  exit(0);
}
...
type = 'HKCU';
key = 'Software\\Policies\\Microsoft\\Office\\15.0\\common\\documentinformationpanel';
item = 'Beaconing';
