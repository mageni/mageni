...
# $Id: office2013_protect_passwd_protected_files_metadata.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Protect document metadata for password protected files
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312340");
  ...
  script_name('Microsoft Office 2013: Protect document metadata for password protected files');
  ...
  script_tag(name: "summary", value: 'Check Setting "Protect document metadata for password protected files" (Microsoft Office 2013).');
  exit(0);
}
