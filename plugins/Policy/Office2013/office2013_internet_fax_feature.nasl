...
# $Id: office2013_internet_fax_feature.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Disable Internet Fax feature
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312325");
  ...
  script_name('Microsoft Office 2013: Disable Internet Fax feature');
  ...
  script_tag(name: "summary", value: 'Check Setting "Disable Internet Fax feature" (Microsoft Office 2013).');
  exit(0);
}
...
type = 'HKCU';
key = 'Software\\Policies\\Microsoft\\Office\\15.0\\common\\services\\fax';
item = 'NoFax';
