...
register_and_report_cpe( app:"Delta Electronics CNCSoft A-Series MLCEditor", ver:version, concluded:concluded,
                         base:"cpe:/a:deltaww:cncsoft_mlceditor:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0 );
