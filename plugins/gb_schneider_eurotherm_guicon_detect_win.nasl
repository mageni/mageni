...
# $Id: gb_schneider_eurotherm_guicon_detect_win.nasl 13020 2019-01-10 12:37:40Z mmartin $
#
# Eurotherm by Schneider Electric GUIcon Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 13020 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-10 13:37:40 +0100 (Thu, 10 Jan 2019) $");
  script_tag(name:"creation_date", value:"2019-01-10 12:09:46 +0100 (Thu, 10 Jan 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("Eurotherm by Schneider Electric GUIcon Version Detection (Windows)");
