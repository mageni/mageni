...
if(description)
{
  ...
  script_version("2019-09-25T10:16:38+0000");
  script_tag(name:"last_modification", value:"2019-09-25 10:16:38 +0000 (Wed, 25 Sep 2019)");
  ...
  script_name("phpIPAM <= 1.4 Multiple SQL Injection Vulnerabilities");
  ...
  script_tag(name:"summary", value:"phpIPAM is prone to multiple SQL injection vulnerabilities.");
