...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815272");
  ...
  script_tag(name:"creation_date", value:"2019-08-08 11:00:55 +0530 (Thu, 08 Aug 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2019-08)-Linux");
