...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814884");
  ...
  script_tag(name:"creation_date", value:"2019-04-26 13:07:49 +0530 (Fri, 26 Apr 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_23-2019-04)-Mac OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 74.0.3729.108
  on Mac OS X");
