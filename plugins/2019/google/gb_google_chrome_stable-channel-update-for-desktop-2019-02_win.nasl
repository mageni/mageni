...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814835");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2019-5784");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2019-02-08 11:24:38 +0530 (Fri, 08 Feb 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2019-02)-Windows");
