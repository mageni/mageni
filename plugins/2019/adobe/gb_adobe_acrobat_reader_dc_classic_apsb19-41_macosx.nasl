...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815533");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 15:51:59 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Acrobat Reader DC (Classic Track) Multiple Vulnerabilities (apsb19-41) - Mac OS X");
  ...
  2015.006.30497 and earlier versions on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Acrobat Reader DC (Classic Track)
  version 2015.006.30499 or later. Please see the references for more information.");
...
## 2015.006.30499 => 15.006.30499
if(version_is_less(version:vers, test_version:"15.006.30499")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"15.006.30499 (2015.006.30499)", install_path:path);
