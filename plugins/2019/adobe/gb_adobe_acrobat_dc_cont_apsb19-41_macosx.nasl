...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815544");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 15:39:40 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Acrobat DC (Continuous Track) Security Updates (apsb19-41) - Mac OS X");
  ...
  2019.012.20034 and earlier versions on Mac OS X.");
