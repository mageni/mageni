...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815545");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 15:45:21 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Acrobat Reader DC (Classic Track) Multiple Vulnerabilities (apsb19-41) - Windows");
  ...
  2015.006.30498 and earlier versions on Windows.");
