...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815801");
  ...
  script_tag(name:"creation_date", value:"2019-10-16 11:59:28 +0530 (Wed, 16 Oct 2019)");
  script_name("Adobe Acrobat 2017 Security Updates (apsb19-49)-Mac OS X");
