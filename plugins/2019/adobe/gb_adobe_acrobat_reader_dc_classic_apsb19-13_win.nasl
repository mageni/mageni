...
if(description)
{
  ...
  DC (Classic Track) and is prone to an information disclosure vulnerability.");
...
{
  report =  report_fixed_ver(installed_version:vers, fixed_version:"15.006.30482", install_path:path);
