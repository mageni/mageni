...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815686");
  ...
  script_name("Adobe Reader 2017 Security Updates(apsb19-55)-Windows");
...
if(version_in_range(version:readerVer, test_version:"17.0", test_version2:"17.011.30155"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"17.011.30156(2017.011.30156)", install_path:InstallPath);
