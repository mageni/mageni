...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815236");
  ...
  script_tag(name:"creation_date", value:"2019-07-10 13:26:28 +0530 (Wed, 10 Jul 2019)");
  script_name("Microsoft Outlook 2013 Service Pack 1 Information Disclosure Vulnerability (KB4464592)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4464592");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4464592/");
...
if(version_in_range(version:outlookVer, test_version:"15.0", test_version2:"15.0.5153.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"15.0 - 15.0.5153.0999");
