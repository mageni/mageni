...
if(description)
{
  ...
  script_name(".NET Core SDK Spoofing Vulnerability (July 2019)");

  script_tag(name:"summary", value:"This host is installed with ASP.NET Core
  SDK and is prone to spoofing vulnerability.");
  ...
  2.2.108 or later. For updates refer the Reference link.");
