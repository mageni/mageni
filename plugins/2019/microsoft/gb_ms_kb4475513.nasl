...
if(description)
{
  ...
  update according to Microsoft KB4475513");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475513");
...
if(version_in_range(version:excelVer, test_version:"16.0", test_version2:"16.0.4873.0999"))
{
  report = report_fixed_ver(file_checked:excelPath + "Excel.exe",
                            file_version:excelVer, vulnerable_range:"16.0 - 16.0.4873.0999");
