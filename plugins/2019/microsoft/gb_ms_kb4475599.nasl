...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815604");
  script_version("2019-09-11T14:33:42+0000");
  script_cve_id("CVE-2019-1246");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-09-11 14:33:42 +0000 (Wed, 11 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-11 11:20:47 +0530 (Wed, 11 Sep 2019)");
  script_name("Microsoft Office 2010 Service Pack 2 Remote Code Execution Vulnerability (KB4475599)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4475599");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475599");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    if(msdllVer && version_in_range(version:msdllVer, test_version:"14.0", test_version2:"14.0.7237.4999"))
    {
      report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                 file_version:msdllVer, vulnerable_range:"14.0 - 14.0.7237.4999");
