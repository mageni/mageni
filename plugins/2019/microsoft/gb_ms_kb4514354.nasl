...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815613");
  ...
  script_name("Microsoft .NET Framework Privilege Escalation Vulnerability (KB4514354)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4514354");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4514354");
...
if(edgeVer =~ "^11\.0\.14393")
{
  ...
  foreach key(key_list)
  {
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ## https://support.microsoft.com/en-us/help/4514354
    ...
    if(vulnerable_range)
    {
      report = report_fixed_ver(file_checked:dotPath + "",
