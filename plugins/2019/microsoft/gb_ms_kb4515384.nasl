...
if(version_in_range(version:dllVer, test_version:"10.0.18362.0", test_version2:"10.0.18362.355"))
{
  report = report_fixed_ver(file_checked:sysPath + "\Gdiplus.dll",
                            file_version:dllVer, vulnerable_range:"10.0.18362.0 - 10.0.18362.355");
