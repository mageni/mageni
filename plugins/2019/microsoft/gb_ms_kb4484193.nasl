...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815670");
  ...
  script_name("Microsoft Office 2010 Service Pack 2 Multiple Vulnerabilities (KB4484193)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484193");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484193");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    if(msdllVer && version_in_range(version:msdllVer, test_version:"14.0", test_version2:"14.0.7243.4999"))
    {
      report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                 file_version:msdllVer, vulnerable_range:"14.0 - 14.0.7243.4999");
