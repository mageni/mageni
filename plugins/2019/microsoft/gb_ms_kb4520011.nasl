...
edgeVer = fetch_file_version(sysPath:sysPath, file_name:"Jscript.dll");
if(!edgeVer){
  exit(0);
}

if(version_in_range(version:edgeVer, test_version:"5.812.10240.0", test_version2:"5.812.10240.18367"))
{
  report = report_fixed_ver(file_checked:sysPath + "\Jscript.dll",
                            file_version:edgeVer, vulnerable_range:"5.812.10240.0 - 5.812.10240.18367");
