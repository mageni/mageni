...
if(description)
{
  ...
  script_name("Zoom Client Remote Code Execution Vulnerability July19 -MAC OS X");
  ...
  is running even after the application has been uninstalled and insecurely receives
  commands without validation and lets any website to interact with it.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote
  attackers to execute code with a maliciously crafted launch URL.");
...
if(version_is_less(version:zoomver, test_version:"4.4.53932.0709"))
{
