...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112601");
  ...
  script_name("TYPO3 8.3.x <= 8.7.26 and 9.x.x <= 9.5.7 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"It has been discovered that the t3:// URL handling is vulnerable
  to cross-site scripting when making use of javascript: or data: scheme in link fields.
  ...
  script_tag(name:"affected", value:"TYPO3 versions 8.3.0 through 8.7.26 and 9.0.0 through 9.5.7.");

  script_tag(name:"solution", value:"Update to version 8.7.27, 9.5.8 or later.");

  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2019-015/");
...
if(version_in_range(version: version, test_version: "8.3.0", test_version2: "8.7.26")) {
