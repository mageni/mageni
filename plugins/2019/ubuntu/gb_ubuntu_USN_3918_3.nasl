...
if(description)
{
  ...
  script_name("Ubuntu Update for firefox USN-3918-3");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3918-3/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the USN-3918-3 advisory.");
...
conduct man-in-the-middle (MITM) attacks. (CVE-2019-9803)");
  ...
  script_tag(name:"affected", value:"'firefox' package(s) on Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS, Ubuntu 14.04 LTS.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"66.0.2+build1-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"66.0.2+build1-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"66.0.2+build1-0ubuntu0.18.10.1", rls:"UBUNTU18.10"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"66.0.2+build1-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
