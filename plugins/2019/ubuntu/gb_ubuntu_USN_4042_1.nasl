...
if(description)
{
  ...
  script_cve_id("CVE-2017-9865", "CVE-2018-18897", "CVE-2018-20662", "CVE-2019-10018",
  ...
  script_name("Ubuntu Update for poppler USN-4042-1");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-4042-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'poppler'
  package(s) announced via the USN-4042-1 advisory.");
...
code");
  ...
  script_tag(name:"affected", value:"'poppler' package(s) on Ubuntu 19.04, Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
