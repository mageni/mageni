...
if(description)
{
  ...
  script_name("Ubuntu Update for irssi USN-4046-1");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-4046-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'irssi'
  package(s) announced via the USN-4046-1 advisory.");
...
or execute arbitrary code. (CVE-2019-13045)");
  ...
  script_tag(name:"affected", value:"'irssi' package(s) on Ubuntu 19.04, Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"1.1.1-1ubuntu1.2", rls:"UBUNTU18.10"))) {
    report += res;
  }
...
if(release == "UBUNTU19.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"1.2.0-2ubuntu1.1", rls:"UBUNTU19.04"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"1.0.5-1ubuntu4.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"0.8.19-1ubuntu1.9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
