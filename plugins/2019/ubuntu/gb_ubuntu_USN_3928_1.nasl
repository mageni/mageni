...
handled reading certain headers from the index. A local attacker could possibly
use this issue to escalate privileges.");

  script_tag(name:"affected", value:"'dovecot' package(s) on Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS, Ubuntu 14.04 LTS.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.9-1ubuntu2.6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.33.2-1ubuntu4.3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.3.2.1-1ubuntu3.2", rls:"UBUNTU18.10"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.2.22-1ubuntu2.10", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
