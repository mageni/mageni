...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-July/005029.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'patch'
  package(s) announced via the USN-4071-1 advisory.");
...
(CVE-2019-13638)");
  ...
  script_tag(name:"affected", value:"'patch' package(s) on Ubuntu 19.04, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"patch", ver:"2.7.6-2ubuntu1.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU19.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"patch", ver:"2.7.6-3ubuntu0.1", rls:"UBUNTU19.04"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"patch", ver:"2.7.5-1ubuntu0.16.04.2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
