...
if(description)
{
  ...
  script_name("Ubuntu Update for librabbitmq USN-4214-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-December/005238.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'librabbitmq'
  package(s) announced via the USN-4214-1 advisory.");
...
An attacker could possibly use this issue to execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'librabbitmq' package(s) on Ubuntu 19.04.");
