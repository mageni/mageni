...
# $Id: gb_ubuntu_USN_3874_1.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"65.0+build2-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"65.0+build2-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU18.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"65.0+build2-0ubuntu0.18.10.1", rls:"UBUNTU18.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"65.0+build2-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
