...
if(description)
{
  ...
  script_name("Ubuntu Update for php7.2 USN-4009-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-June/004943.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.2'
  package(s) announced via the USN-4009-1 advisory.");
...
a denial of service, or possibly execute arbitrary code. (CVE-2019-11040)");
  ...
  script_tag(name:"affected", value:"'php7.2' package(s) on Ubuntu 19.04, Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
