...
if(description)
{
  ...
  script_name("openSUSE Update for openexr openSUSE-SU-2019:1265-1 (openexr)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00089.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openexr'
  package(s) announced via the openSUSE-SU-2019:1265_1 advisory.");
