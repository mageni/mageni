...
if(description)
{
  ...
  script_name("openSUSE Update for sysstat openSUSE-SU-2019:2397-1 (sysstat)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00068.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sysstat'
  package(s) announced via the openSUSE-SU-2019:2397_1 advisory.");
