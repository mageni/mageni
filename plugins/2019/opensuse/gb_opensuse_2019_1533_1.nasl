...
if(description)
{
  ...
  script_name("openSUSE Update for bind openSUSE-SU-2019:1533-1 (bind)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00027.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind'
  package(s) announced via the openSUSE-SU-2019:1533_1 advisory.");
