...
if(description)
{
  ...
  script_name("openSUSE Update for evince openSUSE-SU-2019:1908-1 (evince)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00046.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'evince'
  package(s) announced via the openSUSE-SU-2019:1908_1 advisory.");
