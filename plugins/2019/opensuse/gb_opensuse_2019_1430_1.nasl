...
if(description)
{
  ...
  script_name("openSUSE Update for libxslt openSUSE-SU-2019:1430-1 (libxslt)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00053.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxslt'
  package(s) announced via the openSUSE-SU-2019:1430_1 advisory.");
