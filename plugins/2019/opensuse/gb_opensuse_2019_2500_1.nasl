...
if(description)
{
  ...
  script_name("openSUSE Update for rsyslog openSUSE-SU-2019:2500-1 (rsyslog)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00031.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsyslog'
  package(s) announced via the openSUSE-SU-2019:2500_1 advisory.");
