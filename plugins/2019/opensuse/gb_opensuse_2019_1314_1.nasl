...
if(description)
{
  ...
  script_name("openSUSE Update for ntfs-3g_ntfsprogs openSUSE-SU-2019:1314-1 (ntfs-3g_ntfsprogs)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00001.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g_ntfsprogs'
  package(s) announced via the openSUSE-SU-2019:1314_1 advisory.");
