...
if(description)
{
  ...
  script_name("openSUSE Update for clementine openSUSE-SU-2019:1780-1 (clementine)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00038.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clementine'
  package(s) announced via the openSUSE-SU-2019:1780_1 advisory.");
