...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.852777");
  ...
  script_tag(name:"creation_date", value:"2019-11-19 03:01:44 +0000 (Tue, 19 Nov 2019)");
  script_name("openSUSE Update for ucode-intel openSUSE-SU-2019:2527-1 (ucode-intel)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00046.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2019:2527_1 advisory.");
...
if(release == "openSUSELeap15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20191112a~lp150.2.33.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
