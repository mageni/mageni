...
if(description)
{
  ...
  script_name("openSUSE Update for python-Jinja2 openSUSE-SU-2019:1395-1 (python-Jinja2)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00030.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-Jinja2'
  package(s) announced via the openSUSE-SU-2019:1395_1 advisory.");
