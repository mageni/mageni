...
if(description)
{
  ...
  script_name("openSUSE Update for libssh2_org openSUSE-SU-2019:1075-1 (libssh2_org)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-03/msg00040.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh2_org'
  package(s) announced via the openSUSE-SU-2019:1075_1 advisory.");
