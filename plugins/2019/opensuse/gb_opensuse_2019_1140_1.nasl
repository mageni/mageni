...
if(description)
{
  ...
  script_name("openSUSE Update for gd openSUSE-SU-2019:1140-1 (gd)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00031.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gd'
  package(s) announced via the openSUSE-SU-2019:1140_1 advisory.");
