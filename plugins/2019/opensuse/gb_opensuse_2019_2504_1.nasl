...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.852771");
  ...
  script_tag(name:"creation_date", value:"2019-11-15 03:01:23 +0000 (Fri, 15 Nov 2019)");
  script_name("openSUSE Update for ucode-intel openSUSE-SU-2019:2504-1 (ucode-intel)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00033.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2019:2504_1 advisory.");
...
if(release == "openSUSELeap15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20191112~lp150.2.30.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
