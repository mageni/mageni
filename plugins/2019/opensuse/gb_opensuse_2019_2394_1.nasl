...
if(description)
{
  ...
  script_name("openSUSE Update for zziplib openSUSE-SU-2019:2394-1 (zziplib)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00066.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zziplib'
  package(s) announced via the openSUSE-SU-2019:2394_1 advisory.");
