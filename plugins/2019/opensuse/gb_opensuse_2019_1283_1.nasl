...
if(description)
{
  ...
  script_name("openSUSE Update for xerces-c openSUSE-SU-2019:1283-1 (xerces-c)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00099.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xerces-c'
  package(s) announced via the openSUSE-SU-2019:1283_1 advisory.");
