...
if(description)
{
  ...
  script_name("openSUSE Update for mumble openSUSE-SU-2019:1794-1 (mumble)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mumble'
  package(s) announced via the openSUSE-SU-2019:1794_1 advisory.");
