...
if(description)
{
  ...
  script_name("openSUSE Update for GraphicsMagick openSUSE-SU-2019:1619-1 (GraphicsMagick)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00065.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'GraphicsMagick'
  package(s) announced via the openSUSE-SU-2019:1619_1 advisory.");
