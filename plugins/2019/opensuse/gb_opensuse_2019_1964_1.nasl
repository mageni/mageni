...
if(description)
{
  ...
  script_name("openSUSE Update for tcpdump openSUSE-SU-2019:1964-1 (tcpdump)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00065.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpdump'
  package(s) announced via the openSUSE-SU-2019:1964_1 advisory.");
