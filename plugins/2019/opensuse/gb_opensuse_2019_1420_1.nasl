...
if(description)
{
  ...
  script_name("openSUSE Update for qemu openSUSE-SU-2019:1420-1 (qemu)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00044.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu'
  package(s) announced via the openSUSE-SU-2019:1420_1 advisory.");
...
if(release == "openSUSELeap42.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-sgabios-8", rpm:"qemu-sgabios-8~62.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
