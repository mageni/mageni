...
if(description)
{
  ...
  script_name("openSUSE Update for go1.12 openSUSE-SU-2019:2056-1 (go1.12)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00002.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.12'
  package(s) announced via the openSUSE-SU-2019:2056_1 advisory.");
