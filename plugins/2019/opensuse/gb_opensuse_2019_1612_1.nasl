...
if(description)
{
  ...
  script_name("openSUSE Update for enigmail openSUSE-SU-2019:1612-1 (enigmail)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00062.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'enigmail'
  package(s) announced via the openSUSE-SU-2019:1612_1 advisory.");
