...
if(description)
{
  ...
  script_name("openSUSE Update for schismtracker openSUSE-SU-2019:1994-1 (schismtracker)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00072.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'schismtracker'
  package(s) announced via the openSUSE-SU-2019:1994_1 advisory.");
