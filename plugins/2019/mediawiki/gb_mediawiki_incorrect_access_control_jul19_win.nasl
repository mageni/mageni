...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113439");
  ...
  script_name("MediaWiki >= 1.18.0, <= 1.32.1 Incorrect Access Control (Windows)");
  ...
  by using the API.");
  script_tag(name:"impact", value:"Successful exploitation would allow a blocked user to access and edit the Wiki anyway.");
