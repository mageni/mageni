...
if(description)
{
  ...
  script_version("2019-09-16T09:26:38+0000");
  script_tag(name:"last_modification", value:"2019-09-16 09:26:38 +0000 (Mon, 16 Sep 2019)");
...
url = dir + "/wp-content/plugins/wp-members/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== WP-Members Membership Plugin" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "3.2.8" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "3.2.8", file_checked: url );
