...
if(description)
{
  ...
  script_cve_id("CVE-2019-16932");

  script_name("WordPress Visualizer Plugin < 3.3.1 SSRF Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin Visualizer is prone to
  a server-side request forgery (SSRF) vulnerability.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"The vulnerability exists within wp-json/visualizer/v1/upload-data.");
  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to
  read and modify sensitive information.");
