...
if(description)
{
  ...
  script_version("2019-09-05T10:22:43+0000");
  script_tag(name:"last_modification", value:"2019-09-05 10:22:43 +0000 (Thu, 05 Sep 2019)");
  ...
  script_tag(name:"summary", value:"The WordPress plugin WP Ultimate Recipe is prone to cross-site scripting (XSS) vulnerability.");
...
url = dir + "/wp-content/plugins/wp-ultimate-recipe/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== WP Ultimate Recipe" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "3.12.7" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "3.12.7", file_checked: url );
