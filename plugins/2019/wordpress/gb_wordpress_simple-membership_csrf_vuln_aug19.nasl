...
if(description)
{
  ...
  script_version("2019-08-27T12:18:15+0000");
  script_tag(name:"last_modification", value:"2019-08-27 12:18:15 +0000 (Tue, 27 Aug 2019)");
...
if( "=== Simple Membership" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: vers[1], test_version: "3.3.3" ) ) {
    report = report_fixed_ver( installed_version: vers[1], fixed_version: "3.3.3", file_checked: url );
