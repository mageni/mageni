...
if (description)
{
  ...
  script_version("2019-05-13T11:38:26+0000");
  script_tag(name:"last_modification", value:"2019-05-13 11:38:26 +0000 (Mon, 13 May 2019)");
...
if("Blog2Social" >< res && "Changelog" >< res) {
  ...
  if(vers[1] && version_is_less(version: vers[1], test_version: "5.0.3")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "5.0.3", file_checked: url);
