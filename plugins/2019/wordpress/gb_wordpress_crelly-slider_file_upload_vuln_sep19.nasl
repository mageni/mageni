...
if(description)
{
  ...
  script_version("2019-09-12T09:30:28+0000");
  script_tag(name:"last_modification", value:"2019-09-12 09:30:28 +0000 (Thu, 12 Sep 2019)");
...
url = dir + "/wp-content/plugins/crelly-slider/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== Crelly Slider" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "1.3.5" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "1.3.5", file_checked: url );
