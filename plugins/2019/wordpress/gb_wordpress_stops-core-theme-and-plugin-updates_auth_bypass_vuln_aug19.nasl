...
if(description)
{
  ...
  script_version("2019-09-16T09:16:46+0000");
  script_tag(name:"last_modification", value:"2019-09-16 09:16:46 +0000 (Mon, 16 Sep 2019)");
...
url = dir + "/wp-content/plugins/stops-core-theme-and-plugin-updates/readme.txt";
res = http_get_cache( port: port, item: url );

if( ( "=== Easy Updates Manager" >< res || "=== Disable Updates Manager" >< res || "=== Disable All Updates" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "8.0.5" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "8.0.5", file_checked: url );
