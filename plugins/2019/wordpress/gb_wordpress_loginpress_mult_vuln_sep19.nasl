...
if(description)
{
  ...
  script_version("2019-09-12T10:04:39+0000");
  script_tag(name:"last_modification", value:"2019-09-12 10:04:39 +0000 (Thu, 12 Sep 2019)");
...
url = dir + "/wp-content/plugins/loginpress/readme.txt";
res = http_get_cache( port: port, item: url );

if( ( "=== LoginPress" >< res || "LoginPress ===" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "1.1.4" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "1.1.4", file_checked: url );
