...
url = dir + "/wp-content/plugins/wp-maintenance-mode/readme.txt";
...
if("=== WP Maintenance Mode ===" >< res && "Changelog" >< res) {
  ...
  if(vers[1] && version_is_less(version: vers[1], test_version: "2.0.7")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "2.0.7", file_checked: url);
