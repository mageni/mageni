...
if(description)
{
  ...
  script_version("2019-09-11T10:18:19+0000");
  script_tag(name:"last_modification", value:"2019-09-11 10:18:19 +0000 (Wed, 11 Sep 2019)");
...
url = dir + "/wp-content/plugins/shapepress-dsgvo/README.txt";
res = http_get_cache( port: port, item: url );

if( "=== WP DSGVO Tools" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.2.19" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.2.19", file_checked: url );
