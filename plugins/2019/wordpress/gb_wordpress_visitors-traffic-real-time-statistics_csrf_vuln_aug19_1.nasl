...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113499");
  script_version("2019-09-05T09:50:54+0000");
  script_tag(name:"last_modification", value:"2019-09-05 09:50:54 +0000 (Thu, 05 Sep 2019)");
  ...
  script_cve_id("CVE-2019-15831");

  script_name("WordPress Visitor Traffic Real Time Statistics Plugin < 1.12 CSRF Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress Visitor Traffic Real Time Statistics plugin through version 1.11.");
...
url = dir + "/wp-content/plugins/visitors-traffic-real-time-statistics/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== Visitors Traffic Real Time Statistics" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "1.12" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "1.12", file_checked: url );
