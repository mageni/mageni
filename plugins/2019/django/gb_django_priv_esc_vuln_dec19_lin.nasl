...
if (description)
{
  ...
  script_version("2019-12-09T04:52:09+0000");
  script_tag(name:"last_modification", value:"2019-12-09 04:52:09 +0000 (Mon, 09 Dec 2019)");
  ...
  script_name("Django 2.1.x < 2.1.15, 2.2.x < 2.2.8 Privilege Escalation Vulnerability (Linux)");
