...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815274");
  ...
  script_tag(name:"creation_date", value:"2019-08-16 10:34:53 +0530 (Fri, 16 Aug 2019)");
  script_name("Mozilla Firefox ESR Security Update (mfsa_2019-24_2019-24)-Windows");
