...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815144");
  ...
  script_tag(name:"creation_date", value:"2019-06-21 12:20:49 +0530 (Fri, 21 Jun 2019)");
  script_name("Mozilla Firefox Security Updates(mfsa_2019-19_2019-20)-Windows");
...
if(version_is_less(version:ffVer, test_version:"67.0.4"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"67.0.4", install_path:ffPath);
