...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814945");
  ...
  script_tag(name:"creation_date", value:"2019-03-26 11:27:07 +0530 (Tue, 26 Mar 2019)");
  script_name("Mozilla Thunderbird Security Updates(mfsa_2019-07_2019-11)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Thunderbird version before 60.6 on MAC OS X.");
