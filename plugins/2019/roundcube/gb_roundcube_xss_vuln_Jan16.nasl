...
if (description)
{
  ...
  script_name("Roundcube Webmail < 1.0.6 And 1.1.x < 1.1.2 XSS Vulnerability");
...
if(version_is_less(version: version, test_version: "1.0.6") || version_is_less_equal(version: version, test_version: "1.1") ||
