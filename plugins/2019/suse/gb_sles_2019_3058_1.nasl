...
if(description)
{
  ...
  script_cve_id("CVE-2016-5102","CVE-2018-17000","CVE-2019-14973");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:3058-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-November/006177.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tiff'
  package(s) announced via the SUSE-SU-2019:3058-1 advisory.");
