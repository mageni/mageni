...
if(description)
{
  ...
  script_cve_id("CVE-2019-0154","CVE-2019-14895","CVE-2019-14901");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:3316-1)");
  ...
  package(s) announced via the SUSE-SU-2019:3316-1 advisory.");
