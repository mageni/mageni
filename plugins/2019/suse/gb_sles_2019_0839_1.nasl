...
if(description)
{
  ...
  script_cve_id("CVE-2018-10360","CVE-2019-8905","CVE-2019-8906");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0839-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-April/005284.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'file'
  package(s) announced via the SUSE-SU-2019:0839-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'file' package(s) on SUSE Linux Enterprise Server 12");
