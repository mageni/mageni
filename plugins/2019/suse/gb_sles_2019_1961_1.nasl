...
if(description)
{
  ...
  script_cve_id("CVE-2016-1238","CVE-2017-15705","CVE-2018-11780");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1961-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005748.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'spamassassin'
  package(s) announced via the SUSE-SU-2019:1961-1 advisory.");
