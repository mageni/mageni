...
if(description)
{
  ...
  script_cve_id("CVE-2018-19636","CVE-2018-19637","CVE-2018-19638");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1122-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-April/005417.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'hostinfo, supportutils'
  package(s) announced via the SUSE-SU-2019:1122-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'hostinfo, supportutils' package(s) on SUSE Linux Enterprise Server 12");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"hostinfo", rpm:"hostinfo~1.0.1~19.5.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"supportutils", rpm:"supportutils~3.0~95.21.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
