...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1722-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005644.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'glib2'
  package(s) announced via the SUSE-SU-2019:1722-1 advisory.");
