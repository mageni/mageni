...
if (description)
{
  ...
  script_name("Oracle MySQL 5.6.0 < 5.6.46, 5.7.x < 5.7.28, 8.0.x < 8.0.18 Security Update (2019-5072832) - Windows");
  ...
  script_tag(name:"affected", value:"MySQL 5.6.0 - 5.6.45, 5.7.0 - 5.7.27 and 8.0.0 - 8.0.17.");
...
if (version_in_range(version: version, test_version: "5.6", test_version2: "5.6.45")) {
