...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815101");
  script_version("2019-04-30T06:00:47+0000");
  script_cve_id("CVE-2019-2699");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-04-30 06:00:47 +0000 (Tue, 30 Apr 2019)");
  script_tag(name:"creation_date", value:"2019-04-18 14:52:07 +0530 (Thu, 18 Apr 2019)");
  script_name("Oracle Java SE Security Updates (apr2019-5072813) 01 - Windows");
  ...
  'Windows DLL' component of Java SE");

  script_tag(name:"impact", value:"Successful exploitation of this
  vulnerability will allow remote remote attacker to have an impact on
  confidentiality, integrity and availability.");

  script_tag(name:"affected", value:"Oracle Java SE version 8u202(1.8.0.202)
...
if(jreVer =~ "^1\.8")
{
  if(version_in_range(version:jreVer, test_version:"1.8.0", test_version2:"1.8.0.202"))
  {
