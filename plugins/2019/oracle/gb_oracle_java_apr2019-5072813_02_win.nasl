...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815102");
  ...
  script_name("Oracle Java SE Security Updates (apr2019-5072813) 02 - Windows");
  ...
  in '2D' component of the Java SE");
  ...
  and earlier, 8u202(1.8.0.202) and earlier on Windows");
...
if(version_in_range(version:jreVer, test_version:"1.7.0", test_version2:"1.7.0.211")||
  version_in_range(version:jreVer, test_version:"1.8.0", test_version2:"1.8.0.202"))
{
