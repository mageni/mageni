...
#
# Oracle Java SE Multiple Vulnerabilities(Jan2019-5072801)-Windows
#
# Authors:
...
if(description)
{
  ...
  1.8.0 to 1.8.0.192 and 11.0.1 on Windows.");
...
if(version_in_range(version:jreVer, test_version:"1.7.0", test_version2:"1.7.0.201")||
  version_in_range(version:jreVer, test_version:"1.8.0", test_version2:"1.8.0.192")||
  version_in_range(version:jreVer, test_version:"11.0", test_version2:"11.0.1"))
{
