...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143032");
  ...
  script_name("Oracle MySQL 5.6.x < 5.6.45, 5.7.x < 5.7.27, 8.0.x < 8.0.17 Security Update (2019-5072832) - Windows");
  ...
  script_tag(name:"summary", value:"Oracle MySQL is prone to a local unauthenticated vulnerability.");
  ...
  script_tag(name:"affected", value:"MySQL 5.6.0 - 5.6.44, 5.7.0 - 5.7.26 and 8.0.0 - 8.0.16.");
...
if (version_in_range(version: version, test_version: "5.6", test_version2: "5.6.44")) {
