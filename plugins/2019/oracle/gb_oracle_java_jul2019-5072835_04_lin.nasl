...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815182");
  ...
  script_name("Oracle Java SE Security Updates (jul2019-5072835) 04 - Linux");
  ...
  earlier, 11.0.2 and earlier, 12.0.1 and earlier on Linux");
...
if(version_in_range(version:jreVer, test_version:"1.8.0", test_version2:"1.8.0.212")||
