...
if (description)
{
  ...
  script_name("Oracle MySQL 5.7.x < 5.7.26, 8.0.x < 8.0.16 Security Update (2019-5072835) - Windows");
  ...
  script_tag(name:"affected", value:"MySQL 5.7.25 and prior and 8.0.15 and prior.");
