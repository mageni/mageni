...
# $Id: gb_discourse_2.2.0beta8.nasl 13336 2019-01-29 07:11:23Z ckuersteiner $
#
...
if (version_is_less(version: version, test_version: "2.2.0.beta8")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.2.0.beta8");
