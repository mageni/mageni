...
if(description)
{
  ...
  script_version("2019-06-22T02:00:08+0000");
  script_cve_id("CVE-2019-12384", "CVE-2019-12814");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-06-22 02:00:08 +0000 (Sat, 22 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-22 02:00:08 +0000 (Sat, 22 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1831-1] jackson-databind security update)");
  ...
  package(s) announced via the DSA-1831-1 advisory.");
