...
if(description)
{
  ...
  script_version("2019-11-26T12:50:08+0000");
  script_cve_id("CVE-2019-16729");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-11-26 12:50:08 +0000 (Tue, 26 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-26 12:50:08 +0000 (Tue, 26 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2000-1] pam-python security update)");
  ...
  package(s) announced via the DSA-2000-1 advisory.");
