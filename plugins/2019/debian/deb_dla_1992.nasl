...
if(description)
{
  ...
  script_version("2019-11-15T03:00:11+0000");
  script_cve_id("CVE-2019-14869");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-15 03:00:11 +0000 (Fri, 15 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-15 03:00:11 +0000 (Fri, 15 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1992-1] ghostscript security update)");
  ...
  package(s) announced via the DSA-1992-1 advisory.");
