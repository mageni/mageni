...
if(description)
{
  ...
  script_version("2019-05-06T02:00:06+0000");
  script_cve_id("CVE-2018-19105");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-06 02:00:06 +0000 (Mon, 06 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-06 02:00:06 +0000 (Mon, 06 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1776-1] librecad security update)");
  ...
  package(s) announced via the DSA-1776-1 advisory.");
