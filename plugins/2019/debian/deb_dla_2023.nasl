...
if(description)
{
  ...
  script_version("2019-12-08T03:00:23+0000");
  ...
  script_tag(name:"last_modification", value:"2019-12-08 03:00:23 +0000 (Sun, 08 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-08 03:00:23 +0000 (Sun, 08 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2023-1] openjdk-7 security update)");
  ...
  package(s) announced via the DSA-2023-1 advisory.");
