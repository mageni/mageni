...
if(description)
{
  ...
  script_version("2019-06-29T02:00:10+0000");
  script_cve_id("CVE-2018-5686", "CVE-2018-6192", "CVE-2019-6130");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-06-29 02:00:10 +0000 (Sat, 29 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-29 02:00:10 +0000 (Sat, 29 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1838-1] mupdf security update)");
  ...
  package(s) announced via the DSA-1838-1 advisory.");
