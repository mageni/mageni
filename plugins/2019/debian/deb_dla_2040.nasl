...
if(description)
{
  ...
  script_version("2019-12-18T03:00:50+0000");
  script_cve_id("CVE-2015-8947");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-12-18 03:00:50 +0000 (Wed, 18 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-18 03:00:50 +0000 (Wed, 18 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2040-1] harfbuzz security update)");
  ...
  package(s) announced via the DSA-2040-1 advisory.");
