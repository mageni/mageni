...
if(description)
{
  ...
  script_version("2019-12-18T03:00:53+0000");
  script_cve_id("CVE-2019-14853", "CVE-2019-14859");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-12-18 03:00:53 +0000 (Wed, 18 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-18 03:00:53 +0000 (Wed, 18 Dec 2019)");
  script_name("Debian Security Advisory DSA 4588-1 (python-ecdsa - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4588.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4588-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-ecdsa'
  package(s) announced via the DSA-4588-1 advisory.");
