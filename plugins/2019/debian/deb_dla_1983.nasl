...
if(description)
{
  ...
  script_version("2019-11-07T03:00:07+0000");
  script_cve_id("CVE-2019-3465");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-07 03:00:07 +0000 (Thu, 07 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-07 03:00:07 +0000 (Thu, 07 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1983-1] simplesamlphp security update)");
  ...
  package(s) announced via the DSA-1983-1 advisory.");
