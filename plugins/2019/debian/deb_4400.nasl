...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 4400-1 (openssl1.0 - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4400.html");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libssl1.0-dev", ver:"1.0.2r-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libssl1.0.2", ver:"1.0.2r-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
