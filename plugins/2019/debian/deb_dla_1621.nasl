...
# $Id: deb_dla_1621.nasl 14274 2019-03-18 14:38:37Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libc3p0-java", ver:"0.9.1.2-9+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libc3p0-java-doc", ver:"0.9.1.2-9+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
