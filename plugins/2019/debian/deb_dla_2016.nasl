...
if(description)
{
  ...
  script_version("2019-11-30T03:00:14+0000");
  script_cve_id("CVE-2018-20020", "CVE-2018-20021", "CVE-2018-20022", "CVE-2018-20024");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_tag(name:"last_modification", value:"2019-11-30 03:00:14 +0000 (Sat, 30 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-30 03:00:14 +0000 (Sat, 30 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2016-1] ssvnc security update)");
  ...
  package(s) announced via the DSA-2016-1 advisory.");
