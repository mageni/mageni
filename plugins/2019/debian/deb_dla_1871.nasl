...
if(description)
{
  ...
  script_version("2019-08-04T02:00:08+0000");
  script_cve_id("CVE-2017-11109", "CVE-2017-17087", "CVE-2019-12735");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-08-04 02:00:08 +0000 (Sun, 04 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-04 02:00:08 +0000 (Sun, 04 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1871-1] vim security update)");
  ...
  package(s) announced via the DSA-1871-1 advisory.");
