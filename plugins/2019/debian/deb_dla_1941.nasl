...
if(description)
{
  ...
  script_version("2019-10-01T02:00:14+0000");
  script_cve_id("CVE-2019-16869");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-10-01 02:00:14 +0000 (Tue, 01 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-01 02:00:14 +0000 (Tue, 01 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1941-1] netty security update)");
  ...
  package(s) announced via the DSA-1941-1 advisory.");
