...
if(description)
{
  ...
  script_version("2019-09-10T02:00:16+0000");
  script_cve_id("CVE-2019-14811", "CVE-2019-14812", "CVE-2019-14813", "CVE-2019-14817");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-09-10 02:00:16 +0000 (Tue, 10 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-10 02:00:16 +0000 (Tue, 10 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1915-1] ghostscript security update)");
  ...
  package(s) announced via the DSA-1915-1 advisory.");
