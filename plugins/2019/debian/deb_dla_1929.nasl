...
if(description)
{
  ...
  script_version("2019-09-21T02:00:24+0000");
  script_cve_id("CVE-2016-7398");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-09-21 02:00:24 +0000 (Sat, 21 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-21 02:00:24 +0000 (Sat, 21 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1929-1] php-pecl-http security update)");
  ...
  package(s) announced via the DSA-1929-1 advisory.");
