...
if(description)
{
  ...
  script_version("2019-10-01T02:00:06+0000");
  script_cve_id("CVE-2019-16680");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-10-01 02:00:06 +0000 (Tue, 01 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-01 02:00:06 +0000 (Tue, 01 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1938-1] file-roller security update)");
  ...
  package(s) announced via the DSA-1938-1 advisory.");
