...
if(description)
{
  ...
  script_version("2019-05-24T02:00:29+0000");
  ...
  script_tag(name:"last_modification", value:"2019-05-24 02:00:29 +0000 (Fri, 24 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-24 02:00:29 +0000 (Fri, 24 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1800-1] firefox-esr security update)");
  ...
  package(s) announced via the DSA-1800-1 advisory.");
