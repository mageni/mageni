...
if(description)
{
  ...
  script_version("2019-08-01T02:00:14+0000");
  script_cve_id("CVE-2019-11555", "CVE-2019-9495", "CVE-2019-9497", "CVE-2019-9498", "CVE-2019-9499");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-08-01 02:00:14 +0000 (Thu, 01 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-01 02:00:14 +0000 (Thu, 01 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1867-1] wpa security update)");
  ...
  package(s) announced via the DSA-1867-1 advisory.");
