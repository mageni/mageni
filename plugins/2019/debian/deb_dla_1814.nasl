...
if(description)
{
  ...
  script_version("2019-06-06T02:00:06+0000");
  script_cve_id("CVE-2019-12308");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-06-06 02:00:06 +0000 (Thu, 06 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-06 02:00:06 +0000 (Thu, 06 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1814-1] python-django security update)");
  ...
  package(s) announced via the DSA-1814-1 advisory.");
