...
if(description)
{
  ...
  script_version("2019-08-30T02:00:11+0000");
  script_cve_id("CVE-2019-15142", "CVE-2019-15143", "CVE-2019-15144", "CVE-2019-15145");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-08-30 02:00:11 +0000 (Fri, 30 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-30 02:00:11 +0000 (Fri, 30 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1902-1] djvulibre security update)");
  ...
  package(s) announced via the DSA-1902-1 advisory.");
