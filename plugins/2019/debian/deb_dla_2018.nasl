...
if(description)
{
  ...
  script_version("2019-12-01T03:00:11+0000");
  script_cve_id("CVE-2019-19269");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-12-01 03:00:11 +0000 (Sun, 01 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-01 03:00:11 +0000 (Sun, 01 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2018-1] proftpd-dfsg security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00039.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2018-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'proftpd-dfsg'
  package(s) announced via the DSA-2018-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In mod_tls a crash with empty CRL was fixed.");
