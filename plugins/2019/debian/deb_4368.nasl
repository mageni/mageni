...
# $Id: deb_4368.nasl 14285 2019-03-18 15:08:34Z cfischer $
#
# Auto-generated from advisory DSA 4368-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 4368-1 (zeromq3 - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4368.html");
...
its security tracker page linked in the references.");
  ...
  script_tag(name:"summary", value:"Guido Vranken discovered that an incorrect bounds check in ZeroMQ, a
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libzmq3-dev", ver:"4.2.1-4+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libzmq5", ver:"4.2.1-4+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libzmq5-dbg", ver:"4.2.1-4+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
