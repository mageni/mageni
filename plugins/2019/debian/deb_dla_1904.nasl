...
if(description)
{
  ...
  script_version("2019-08-31T02:00:06+0000");
  script_cve_id("CVE-2019-15531");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-08-31 02:00:06 +0000 (Sat, 31 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-31 02:00:06 +0000 (Sat, 31 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1904-1] libextractor security update)");
  ...
  package(s) announced via the DSA-1904-1 advisory.");
