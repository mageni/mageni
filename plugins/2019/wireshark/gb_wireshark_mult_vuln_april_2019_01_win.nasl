...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814879");
  ...
  script_tag(name:"creation_date", value:"2019-04-12 15:53:21 +0530 (Fri, 12 Apr 2019)");
  script_name("Wireshark Security Updates April 2019 (Windows)-01");
  ...
  2.6.0 to 2.6.7 and 3.0.0 on Windows.");
