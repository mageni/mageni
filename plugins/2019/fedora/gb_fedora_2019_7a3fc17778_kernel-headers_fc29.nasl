...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876996");
  ...
  script_tag(name:"creation_date", value:"2019-11-14 03:30:18 +0000 (Thu, 14 Nov 2019)");
  script_name("Fedora Update for kernel-headers FEDORA-2019-7a3fc17778");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5SUGGC2X2BH75YJQX4G5KN6MBSMPYMPC");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.3.11~100.fc29", rls:"FC29"))) {
    report += res;
  }
