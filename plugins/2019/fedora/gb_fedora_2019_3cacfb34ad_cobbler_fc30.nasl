...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876792");
  ...
  script_tag(name:"creation_date", value:"2019-09-13 02:24:30 +0000 (Fri, 13 Sep 2019)");
  script_name("Fedora Update for cobbler FEDORA-2019-3cacfb34ad");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CMWK5KCCZXOGOYNR2H6BWDSABTQ5NYJA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2019-3cacfb34ad advisory.");
...
other applications.");
  ...
  script_tag(name:"affected", value:"'cobbler' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~2.8.5~0.1.fc30", rls:"FC30"))) {
    report += res;
  }
