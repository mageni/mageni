...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876788");
  ...
  script_name("Fedora Update for wordpress FEDORA-2019-5cd3a50c8a");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GM7IDGI2XRBHNQCOKHJLQH2NSG7ZBU2W");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2019-5cd3a50c8a advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.2.3~1.fc29", rls:"FC29"))) {
    report += res;
  }
