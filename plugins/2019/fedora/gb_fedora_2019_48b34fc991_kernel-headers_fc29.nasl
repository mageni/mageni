...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876446");
  ...
  script_tag(name:"creation_date", value:"2019-06-05 02:17:59 +0000 (Wed, 05 Jun 2019)");
  script_name("Fedora Update for kernel-headers FEDORA-2019-48b34fc991");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GJGZIMGB72TL7OGWRMHIL43WHXFQWU4X");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.0.19~200.fc29", rls:"FC29"))) {
    report += res;
  }
