...
if(description)
{
  ...
  for the 'php-horde-Horde-Image' package(s) announced via the FEDORA-2019-944ff52ce6
  advisory.");
...
if(release == "FC28")
{
  ...
  if ((res = isrpmvuln(pkg:"php-horde-Horde-Image", rpm:"php-horde-Horde-Image~2.5.4~1.fc28", rls:"FC28")) != NULL)
  {
