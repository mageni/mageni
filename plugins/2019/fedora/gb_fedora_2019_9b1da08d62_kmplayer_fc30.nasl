...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876807");
  ...
  script_name("Fedora Update for kmplayer FEDORA-2019-9b1da08d62");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VT5HBIKH64YRZFFAPXGOTHIQJHSTQJF7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kmplayer'
  package(s) announced via the FEDORA-2019-9b1da08d62 advisory.");
...
on a movie file, the movie is played inside Konqueror.");
  ...
  script_tag(name:"affected", value:"'kmplayer' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kmplayer", rpm:"kmplayer~0.12.0b~1.fc30", rls:"FC30"))) {
    report += res;
  }
