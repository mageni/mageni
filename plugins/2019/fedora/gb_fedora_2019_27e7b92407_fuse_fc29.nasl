...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875914");
  ...
  script_name("Fedora Update for fuse FEDORA-2019-27e7b92407");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QDJH5ERHEPULHS4GTG5XYAW6GRFTCX4S");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fuse", rpm:"fuse~2.9.9~3.fc29", rls:"FC29"))) {
    report += res;
  }
