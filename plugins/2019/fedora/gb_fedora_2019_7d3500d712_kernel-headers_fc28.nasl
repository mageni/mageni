...
if(description)
{
  ...
  the 'kernel-headers' package(s) announced via the FEDORA-2019-7d3500d712
  advisory.");
...
if(release == "FC28")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~4.20.6~100.fc28", rls:"FC28")) != NULL)
  {
