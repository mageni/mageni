...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877066");
  ...
  script_name("Fedora Update for firefox FEDORA-2019-4118f50595");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JH7XYDWE6T6KZDPE3YY7PFN7YVSGO3NE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the FEDORA-2019-4118f50595 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~71.0~8.npgo.fc30", rls:"FC30"))) {
    report += res;
  }
