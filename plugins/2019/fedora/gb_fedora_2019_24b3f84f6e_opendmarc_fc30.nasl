...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876913");
  ...
  script_tag(name:"creation_date", value:"2019-10-16 03:03:29 +0000 (Wed, 16 Oct 2019)");
  script_name("Fedora Update for opendmarc FEDORA-2019-24b3f84f6e");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Y7RT6ID7MBCEPNZEIUKK2TZIOCYPJR6E");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opendmarc'
  package(s) announced via the FEDORA-2019-24b3f84f6e advisory.");
...
/usr/share/opendmarc/contrib/rddmarc.");
  ...
  script_tag(name:"affected", value:"'opendmarc' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opendmarc", rpm:"opendmarc~1.3.2~1.fc30", rls:"FC30"))) {
    report += res;
  }
