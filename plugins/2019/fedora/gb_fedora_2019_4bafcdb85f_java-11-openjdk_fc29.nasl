...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876938");
  ...
  script_name("Fedora Update for java-11-openjdk FEDORA-2019-4bafcdb85f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Y5Y4UZ2IYHDEC6TFSOOGJBRXCKYBYRM7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openjdk'
  package(s) announced via the FEDORA-2019-4bafcdb85f advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk", rpm:"java-11-openjdk~11.0.5.10~0.fc29", rls:"FC29"))) {
    report += res;
  }
