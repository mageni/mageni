...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876656");
  ...
  script_tag(name:"creation_date", value:"2019-08-12 02:26:00 +0000 (Mon, 12 Aug 2019)");
  script_name("Fedora Update for upx FEDORA-2019-9a0f02c8c8");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MOCJ43HTM45GZCAQ2FLEBDNBM76V22RG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'upx'
  package(s) announced via the FEDORA-2019-9a0f02c8c8 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"upx", rpm:"upx~3.95~4.fc30", rls:"FC30"))) {
    report += res;
  }
