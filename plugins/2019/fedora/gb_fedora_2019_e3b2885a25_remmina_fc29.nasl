...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875601");
  ...
  script_name("Fedora Update for remmina FEDORA-2019-e3b2885a25");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5EW2TXFH2TXUXUEWZ55NEEIE62GQPOC4");
...
Please don&#39, t forget to install the plugins for the protocols you want to use.");
  ...
  script_tag(name:"affected", value:"'remmina' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"remmina", rpm:"remmina~1.3.3~1.fc29", rls:"FC29"))) {
    report += res;
  }
