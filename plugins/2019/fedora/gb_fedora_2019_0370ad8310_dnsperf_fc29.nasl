...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876462");
  ...
  script_tag(name:"creation_date", value:"2019-06-06 02:09:46 +0000 (Thu, 06 Jun 2019)");
  script_name("Fedora Update for dnsperf FEDORA-2019-0370ad8310");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XMHOREAJRSBQFRNZLCQULXF3FAWO7O7I");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsperf", rpm:"dnsperf~2.2.1~4.fc29", rls:"FC29"))) {
    report += res;
  }
