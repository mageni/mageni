...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875802");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2018-12543");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-07 02:21:36 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for mosquitto FEDORA-2018-ff1fdf28aa");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HE7WGRUD3NUCYV4CP3265IABHBJKFI32");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mosquitto'
  package(s) announced via the FEDORA-2018-ff1fdf28aa advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mosquitto", rpm:"mosquitto~1.5.3~1.fc29", rls:"FC29"))) {
    report += res;
  }
