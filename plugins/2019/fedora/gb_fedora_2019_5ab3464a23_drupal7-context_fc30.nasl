...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876444");
  ...
  script_tag(name:"creation_date", value:"2019-06-02 02:14:57 +0000 (Sun, 02 Jun 2019)");
  script_name("Fedora Update for drupal7-context FEDORA-2019-5ab3464a23");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RSCLHKIY5ICKYTB2HJEOCMI6ELDVG2CH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-context'
  package(s) announced via the FEDORA-2019-5ab3464a23 advisory.");
...
This package provides the following Drupal modules:
  ...
  * context_ui");
  ...
  script_tag(name:"affected", value:"'drupal7-context' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-context", rpm:"drupal7-context~3.10~1.fc30", rls:"FC30"))) {
    report += res;
  }
