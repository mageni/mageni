...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876713");
  ...
  script_tag(name:"creation_date", value:"2019-08-25 02:18:31 +0000 (Sun, 25 Aug 2019)");
  script_name("Fedora Update for nfdump FEDORA-2019-0fbfb00cbb");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ULSZMKA7P7REJMANVL7D6WMZ2L7IRSET");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nfdump'
  package(s) announced via the FEDORA-2019-0fbfb00cbb advisory.");
...
flows. Nfdump is fully IPv6 compatible.");
  ...
  script_tag(name:"affected", value:"'nfdump' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nfdump", rpm:"nfdump~1.6.18~1.fc30", rls:"FC30"))) {
    report += res;
  }
