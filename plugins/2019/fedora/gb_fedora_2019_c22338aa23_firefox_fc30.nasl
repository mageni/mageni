...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876487");
  ...
  script_name("Fedora Update for firefox FEDORA-2019-c22338aa23");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OYKEJXL3QPYJFXJMNDCVHDXMEKS46I4L");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the FEDORA-2019-c22338aa23 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~67.0.2~1.fc30", rls:"FC30"))) {
    report += res;
  }
