...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876797");
  ...
  script_tag(name:"creation_date", value:"2019-09-15 02:22:09 +0000 (Sun, 15 Sep 2019)");
  script_name("Fedora Update for sphinx FEDORA-2019-9231a18768");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YSLPW44RWIGHU5AG3P4U2HPSD3UBG4GJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sphinx'
  package(s) announced via the FEDORA-2019-9231a18768 advisory.");
...
Phrase Index. Yes, I know about CMU&#39, s Sphinx project.");
  ...
  script_tag(name:"affected", value:"'sphinx' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sphinx", rpm:"sphinx~2.2.11~12.fc30", rls:"FC30"))) {
    report += res;
  }
