...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876433");
  ...
  script_name("Fedora Update for drupal7-xmlsitemap FEDORA-2019-0b26efb6b8");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SDBOYUSH6LTWQE27PDH4T7J3WH7V72JJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-xmlsitemap'
  package(s) announced via the FEDORA-2019-0b26efb6b8 advisory.");
...
This package provides the following Drupal modules:
  ...
  * xmlsitemap_user");
  ...
  script_tag(name:"affected", value:"'drupal7-xmlsitemap' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-xmlsitemap", rpm:"drupal7-xmlsitemap~2.6~1.fc30", rls:"FC30"))) {
    report += res;
  }
