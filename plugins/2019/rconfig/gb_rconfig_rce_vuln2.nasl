...
if (description)
{
  ...
  script_cve_id("CVE-2019-16663");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"NoneAvailable");

  script_name("rConfig <= 3.9.2 Authenticated RCE Vulnerability");
  ...
  script_tag(name:"summary", value:"rConfig is prone to an authenticated remote code execution vulnerability in
  ...
  script_tag(name:"solution", value:"No known solution is available as of 05th November, 2019.
