...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-March/023222.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cloud-init'
  package(s) announced via the CESA-2019:0597 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The cloud-init packages provide a set of init scripts for cloud instances.
...
page(s) listed in the References section.");
  ...
  script_tag(name:"affected", value:"cloud-init on CentOS 7.");
...
if(release == "CentOS7")
{
  ...
  if((res = isrpmvuln(pkg:"cloud-init", rpm:"cloud-init~18.2~1.el7.centos.2", rls:"CentOS7")) != NULL) {
