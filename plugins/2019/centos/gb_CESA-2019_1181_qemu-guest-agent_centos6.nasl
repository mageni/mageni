...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883052");
  ...
  script_tag(name:"creation_date", value:"2019-05-16 02:00:54 +0000 (Thu, 16 May 2019)");
  script_name("CentOS Update for qemu-guest-agent CESA-2019:1181 centos6 ");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-May/023307.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu-guest-agent'
  package(s) announced via the CESA-2019:1181 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-guest-agent", rpm:"qemu-guest-agent~0.12.1.2~2.506.el6_10.3", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~0.12.1.2~2.506.el6_10.3", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm", rpm:"qemu-kvm~0.12.1.2~2.506.el6_10.3", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-kvm-tools", rpm:"qemu-kvm-tools~0.12.1.2~2.506.el6_10.3", rls:"CentOS6"))) {
    report += res;
  }
