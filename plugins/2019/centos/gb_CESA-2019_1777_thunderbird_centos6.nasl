...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883083");
  ...
  script_tag(name:"creation_date", value:"2019-07-18 02:00:34 +0000 (Thu, 18 Jul 2019)");
  script_name("CentOS Update for thunderbird CESA-2019:1777 centos6 ");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-July/023366.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the CESA-2019:1777 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~60.8.0~1.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
