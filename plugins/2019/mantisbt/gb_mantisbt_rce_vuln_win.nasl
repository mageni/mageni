...
if (description)
{
  ...
  script_version("2019-10-23T08:34:57+0000");
  script_tag(name:"last_modification", value:"2019-10-23 08:34:57 +0000 (Wed, 23 Oct 2019)");
  ...
  script_tag(name:"summary", value:"MantisBT is prone to a authenticated command injection vulnerability, leading
