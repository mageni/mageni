...
# $Id: nopsec_php_5_1_0.nasl 10460 2018-07-09 07:50:03Z cfischer $
#
# PHP Version < 5.1.0 Multiple Vulnerabilities
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.110170");
  ...
  script_name("PHP Version < 5.1.0 Multiple Vulnerabilities");
  ...
  script_tag(name:"summary", value:"PHP version smaller than 5.1.0 suffers from multiple vulnerabilities.");
...
if( version_is_less( version:vers, test_version:"5.1.0" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"5.1.0" );
