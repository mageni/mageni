...
# $Id: remote-pwcrack-ncrack-ssh.nasl 13568 2019-02-11 10:22:27Z cfischer $
#
...
if(description)
{
  ...
  script_mandatory_keys("Tools/Present/ncrack", "Secret/pwcrack/logins_file", "Secret/pwcrack/passwords_file", "ssh/server_banner/available");

  script_tag(name:"summary", value:"This plugin runs ncrack to find SSH accounts & passwords by brute force.");
