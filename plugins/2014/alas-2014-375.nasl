...
# $Id: alas-2014-375.nasl 6637 2017-07-10 09:58:13Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-375");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"mod24_wsgi", rpm:"mod24_wsgi~3.5~1.17.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mod24_wsgi-debuginfo", rpm:"mod24_wsgi-debuginfo~3.5~1.17.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mod24_wsgi-py27", rpm:"mod24_wsgi-py27~3.5~1.17.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
