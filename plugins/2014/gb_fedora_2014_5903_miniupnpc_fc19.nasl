...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867810");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-05-19 11:17:24 +0530 (Mon, 19 May 2014)");
  script_tag(name:"cvss_base", value:"8.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:C");
  script_name("Fedora Update for miniupnpc FEDORA-2014-5903");
  script_tag(name:"affected", value:"miniupnpc on Fedora 19");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"miniupnpc", rpm:"miniupnpc~1.9~1.fc19", rls:"FC19")) != NULL)
  {
