...
#
# RedHat Update for libvirt RHSA-2014:1873-01
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871294");
  script_version("$Revision: 12497 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-23 09:28:21 +0100 (Fri, 23 Nov 2018) $");
  script_tag(name:"creation_date", value:"2014-11-19 06:34:41 +0100 (Wed, 19 Nov 2014)");
  script_cve_id("CVE-2014-3633", "CVE-2014-3657", "CVE-2014-7823");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:P");
  script_name("RedHat Update for libvirt RHSA-2014:1873-01");
...
updated packages, libvirtd will be restarted automatically.");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2014-November/msg00037.html");
...
if(release == "RHENT_6")
{
  ...
  if ((res = isrpmvuln(pkg:"libvirt", rpm:"libvirt~0.10.2~46.el6_6.2", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libvirt-client", rpm:"libvirt-client~0.10.2~46.el6_6.2", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libvirt-debuginfo", rpm:"libvirt-debuginfo~0.10.2~46.el6_6.2", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libvirt-devel", rpm:"libvirt-devel~0.10.2~46.el6_6.2", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libvirt-python", rpm:"libvirt-python~0.10.2~46.el6_6.2", rls:"RHENT_6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
