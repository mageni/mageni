...
# $Id: alas-2014-300.nasl 6759 2017-07-19 09:56:33Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-300");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"socat", rpm:"socat~1.7.2.3~1.10.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"socat-debuginfo", rpm:"socat-debuginfo~1.7.2.3~1.10.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
