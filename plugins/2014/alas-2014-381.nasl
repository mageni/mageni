...
# $Id: alas-2014-381.nasl 6663 2017-07-11 09:58:05Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-381");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.8b~7.5.amzn1", rls:"AMAZON")) != NULL) {
