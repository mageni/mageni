...
# $Id: gb_ubuntu_USN_2139_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for linux-ti-omap4 USN-2139-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-03-12 09:36:38 +0530 (Wed, 12 Mar 2014)");
  ...
  script_name("Ubuntu Update for linux-ti-omap4 USN-2139-1");
...
An inf ...
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2139-1/");
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-239-omap4", ver:"3.5.0-239.55", rls:"UBUNTU12.10")) != NULL)
  {
