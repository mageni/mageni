...
# $Id: gb_ubuntu_USN_2411_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_name("Ubuntu Update for mountall USN-2411-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mountall'
...
filesystems possibly being mounted with incorrect permissions.");
  script_tag(name:"affected", value:"mountall on Ubuntu 14.10");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2411-1/");
...
if(release == "UBUNTU14.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"mountall", ver:"2.54ubuntu0.14.10.1", rls:"UBUNTU14.10")) != NULL)
  {
