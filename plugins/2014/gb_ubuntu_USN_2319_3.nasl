...
# $Id: gb_ubuntu_USN_2319_3.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"icedtea-7-jre-jamvm:i386", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
  ...
  if ((res = isdpkgvuln(pkg:"icedtea-7-jre-jamvm:amd64", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  ##for 32-bit architecture
  if ((res = isdpkgvuln(pkg:"openjdk-7-jre:i386", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  ##for 64-bit architecture
  if ((res = isdpkgvuln(pkg:"openjdk-7-jre:amd64", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  ##for 32-bit architecture
  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-headless:i386", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  ##for 64-bit architecture
  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-headless:amd64", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-lib", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  ##for 32-bit architecture
  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-zero:i386", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  ##for 64-bit architecture
  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-zero:amd64", ver:"7u65-2.5.2-3~14.04", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
