...
# $Id: alas-2014-334.nasl 6663 2017-07-11 09:58:05Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-334");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"mod24_security-debuginfo", rpm:"mod24_security-debuginfo~2.7.3~3.24.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mod24_security", rpm:"mod24_security~2.7.3~3.24.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"mlogc24", rpm:"mlogc24~2.7.3~3.24.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
