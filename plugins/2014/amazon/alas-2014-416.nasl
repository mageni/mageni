...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-416)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"json-c-debuginfo", rpm:"json-c-debuginfo~0.11~6.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"json-c", rpm:"json-c~0.11~6.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"json-c-doc", rpm:"json-c-doc~0.11~6.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }
