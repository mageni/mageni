...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-442)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"wget-debuginfo", rpm:"wget-debuginfo~1.16~1.13.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wget", rpm:"wget~1.16~1.13.amzn1", rls:"AMAZON"))) {
    report += res;
  }
