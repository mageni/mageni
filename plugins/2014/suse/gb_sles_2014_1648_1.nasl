...
if(description)
{
  ...
  script_cve_id("CVE-2014-5277","CVE-2014-5282","CVE-2014-6407");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2014:1648-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2014-December/001112.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'docker, sle2docker,  go'
  package(s) announced via the SUSE-SU-2014:1648-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'docker, sle2docker,  go' package(s) on SUSE Linux Enterprise Server 12 (x86_64)");
