...
# $Id: gb_ubuntu_USN_2102_2.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"27.0.1+build1-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU13.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"27.0.1+build1-0ubuntu0.13.10.1", rls:"UBUNTU13.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"27.0.1+build1-0ubuntu0.12.10.1", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
