...
# $Id: alas-2014-285.nasl 6769 2017-07-20 09:56:33Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-285");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"graphviz-php", rpm:"graphviz-php~2.30.1~6.30.amzn1", rls:"AMAZON")) != NULL) {
