...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882021");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-09-11 05:58:27 +0200 (Thu, 11 Sep 2014)");
  script_cve_id("CVE-2014-3618");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("CentOS Update for procmail CESA-2014:1172 centos5");
...
contain a backported patch to correct this issue.");
  script_tag(name:"affected", value:"procmail on CentOS 5");
  script_tag(name:"solution", value:"Please install the updated packages.");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2014-September/020551.html");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"procmail", rpm:"procmail~3.22~17.1.2.el5_10", rls:"CentOS5")) != NULL)
  {
