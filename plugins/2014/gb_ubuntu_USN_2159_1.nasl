...
# $Id: gb_ubuntu_USN_2159_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  Ubuntu 12.04 LTS,
  Ubuntu 10.04 LTS");
  script_tag(name:"insight", value:"It was discovered that NSS incorrectly handled wildcard
...
exploited to spoof SSL servers.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2159-1/");
