...
if(description)
{
  ...
  script_tag(name:"affected", value:"openstack-ceilometer on Fedora 20");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openstack-ceilometer'
