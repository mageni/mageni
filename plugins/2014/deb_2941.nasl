...
# $Id: deb_2941.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
We recommend that you upgrade your lxml packages.");
  script_tag(name:"summary", value:"It was discovered that clean_html() function of lxml (pythonic bindings
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-lxml", ver:"2.3.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-lxml-dbg", ver:"2.3.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-lxml-doc", ver:"2.3.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python3-lxml", ver:"2.3.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python3-lxml-dbg", ver:"2.3.2-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
