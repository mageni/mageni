...
# $Id: gb_nmap_smb_enum_sessions.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
# Wrapper for Nmap SMB Enum Sessions NSE script.
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801276");
  ...
  script_name("Nmap NSE: SMB Enum Sessions");
  ...
  script_tag(name:"summary", value:"This script attempts to enumerate the users logged into a system
  either locally or through an SMB share.

  This is a wrapper on the Nmap Security Scanner's smb-enum-sessions.nse.");
