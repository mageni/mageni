...
# $Id: gb_nmap_smbv2_enabled.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
# Wrapper for Nmap SMBV2 Enabled NSE script.
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801291");
  ...
  script_name("Nmap NSE: SMBV2 Enabled");
  ...
  script_tag(name:"summary", value:"This script attempts to check whether a server is running the SMBv2
  protocol or not.

  This is a wrapper on the Nmap Security Scanner's smbv2-enabled.nse.");
