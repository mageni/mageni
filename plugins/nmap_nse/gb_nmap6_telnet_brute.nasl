...
# $Id: gb_nmap6_telnet_brute.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803515");
  ...
  script_tag(name:"creation_date", value:"2013-02-28 19:00:04 +0530 (Thu, 28 Feb 2013)");
  script_name("Nmap NSE 6.01: telnet-brute");
