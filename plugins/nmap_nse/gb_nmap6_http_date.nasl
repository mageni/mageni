...
# $Id: gb_nmap6_http_date.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803543");
  ...
  script_tag(name:"creation_date", value:"2013-02-28 19:00:32 +0530 (Thu, 28 Feb 2013)");
  script_name("Nmap NSE 6.01: http-date");
  ...
  script_tag(name:"summary", value:"Gets the date from HTTP-like services. Also prints how much the date differs from local time. Local
time is the time the HTTP request was sent, so the difference includes at least the duration of one
RTT.
