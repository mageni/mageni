...
# $Id: gb_nmap6_http_trace.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  ...
  script_add_preference(name:"http-trace.path", value:"", type:"entry");
...
pref = script_get_preference("http-trace.path");
if (!isnull(pref) && pref != "") {
  args[i++] = string('"', 'http-trace.path', '=', pref, '"');
}
