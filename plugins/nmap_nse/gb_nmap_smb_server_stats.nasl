...
# $Id: gb_nmap_smb_server_stats.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script attempts to get the server's statistics over the SMB protocol.

  This is a wrapper on the Nmap Security Scanner's smb-server-stats.nse.");
...
argv = make_list("nmap", "--script=smb-server-stats.nse", "-p", port, get_host_ip());
