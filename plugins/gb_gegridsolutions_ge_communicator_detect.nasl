...
if(description)
{
  ...
  script_name("GE Grid Solutions GE Communicator Version Detection (Windows)");
  ...
  of GE Grid Solutions GE Communicator for Windows.");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    if( ! appName || appName !~ "GE Communicator" )
      continue;
