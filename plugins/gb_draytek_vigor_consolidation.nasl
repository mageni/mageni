...
if (description)
{
  ...
  script_dependencies("gb_draytek_vigor_http_detect.nasl", "gb_draytek_vigor_snmp_detect.nasl",
                      "gb_draytek_vigor_pptp_detect.nasl");
...
foreach source (make_list("snmp", "http", "pptp")) {
...
register_and_report_os(os: os_name, cpe: os_cpe, desc: "DrayTek Vigor Detection Consolidation",
                       runs_key: "unixoide");
