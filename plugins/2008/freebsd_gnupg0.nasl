...
CVE-2005-0366
The integrity check feature in OpenPGP, when handling a message that
was encrypted using cipher feedback (CFB) mode, allows remote
attackers to recover part of the plaintext via a chosen-ciphertext
attack when the first 2 bytes of a message block are known, and an
oracle or other mechanism is available to determine whether an
...
http://www.vuxml.org/freebsd/8375a73f-01bf-11da-bc08-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301307");
