...
tag_insight = "Multiple vulnerabilities have been discovered in phpCollab allowing for
remote injection of shell commands, PHP code and SQL statements.";
tag_solution = "phpCollab has been removed from the Portage tree. We recommend that users
unmerge phpCollab:

    # emerge --unmerge 'www-apps/phpcollab'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-20
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300331");
