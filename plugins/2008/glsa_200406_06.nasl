...
tag_insight = "Several serious new vulnerabilities have been found in CVS, which may allow
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-06
http://bugs.gentoo.org/show_bug.cgi?id=53408
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301754");
