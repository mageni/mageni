...
tag_insight = "There is a heap-based buffer overflow vulnerability in the neon library
used in cadaver, possibly leading to execution of arbitrary code when
connected to a malicious server.";
tag_solution = "All users of cadaver should upgrade to the latest stable version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303319");
