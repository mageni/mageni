...
tag_insight = "The NBD server is vulnerable to a buffer overflow that may result in the
execution of arbitrary code.";
tag_solution = "All NBD Tools users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=sys-block/nbd-2.8.2-r1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200512-14
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304255");
