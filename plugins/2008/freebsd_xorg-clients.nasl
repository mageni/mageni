#
#VID ff00f2ce-c54c-11d8-b708-00061bc2ad93
...
tag_insight = "The following package is affected: xorg-clients
...
http://www.vuxml.org/freebsd/ff00f2ce-c54c-11d8-b708-00061bc2ad93.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301682");
 ...
 script_name("FreeBSD Ports: xorg-clients");
...
txt = "";
vuln = 0;
bver = portver(pkg:"xorg-clients");
if(!isnull(bver) && revcomp(a:bver, b:"6.7.0")==0) {
    txt += 'Package xorg-clients version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
