...
tag_insight = "ImageMagick, imlib and imlib2 contain exploitable buffer overflow
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-12
http://bugs.gentoo.org/show_bug.cgi?id=62309
http://bugs.gentoo.org/show_bug.cgi?id=62487
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303227");
