...
# $Id: deb_248_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Ulf Harnhammar discovered two problems in hypermail, a program to
...
tag_summary = "The remote host is missing an update to hypermail
announced via advisory DSA 248-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20248-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304144");
 ...
 script_name("Debian Security Advisory DSA 248-1 (hypermail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hypermail", ver:"2.0b25-1.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"hypermail", ver:"2.1.3-2.0", rls:"DEB3.0")) != NULL) {
    report += res;
}
