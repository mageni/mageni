...
tag_insight = "A vulnerability in Bacula may allow local attackers to obtain sensitive
information.";
tag_solution = "A warning about this issue has been added in version 2.4.1, but the issue
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200807-10
http://bugs.gentoo.org/show_bug.cgi?id=196834";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304187");
