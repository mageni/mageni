...
# $Id: deb_015_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 015-1
#
# Authors:
...
tag_insight = "Versions of sash prior to 3.4-4 did not clone /etc/shadow properly
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20015-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301781");
