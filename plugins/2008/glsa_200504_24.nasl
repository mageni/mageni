...
tag_insight = "eGroupWare is affected by several SQL injection and cross-site scripting
(XSS) vulnerabilities.";
...
advisory GLSA 200504-24.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301243");
 ...
 script_name("Gentoo Security Advisory GLSA 200504-24 (eGroupWare)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"www-apps/egroupware", unaffected: make_list("ge 1.0.0.007"), vulnerable: make_list("lt 1.0.0.007"))) != NULL) {
    report += res;
}
