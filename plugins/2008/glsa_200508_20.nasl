...
tag_insight = "phpGroupWare is vulnerable to multiple issues ranging from information
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200508-20
http://bugs.gentoo.org/show_bug.cgi?id=102379
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300893");
