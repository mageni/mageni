#
#VID 76adaab0-e4e3-11d9-b875-0001020eed82
...
For a more detailed description of the problems existing with the
version of software you are running, please visit the referenced
security advisories.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303022");
