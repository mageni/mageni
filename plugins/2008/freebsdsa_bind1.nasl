...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:12.bind.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-05:12.bind.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300754");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-05:12.bind.asc)";
 script_name(name);
