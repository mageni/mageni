...
tag_insight = "The following package is affected: newspost

CVE-2005-0101
Buffer overflow in the socket_getline function in Newspost 2.1.1 and
earlier allows remote malicious NNTP servers to execute arbitrary code
via a long string without a newline character.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300788");
 ...
 script_name("FreeBSD Ports: newspost");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.1.1")<=0) {
    txt += 'Package newspost version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
