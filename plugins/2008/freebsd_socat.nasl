#
#VID f3017ce1-32a4-11d9-a9e7-0001020eed82
...
The installed version of socat has a format string
vulnerability in the _msg function when used as an
HTTP proxy client and run with the -ly option.
...
http://www.vuxml.org/freebsd/f3017ce1-32a4-11d9-a9e7-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301610");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.4.0.3")<0) {
