#
#VID e34d0c2e-9efb-11da-b410-000e0c2e438a
...
CVE-2005-3345
rssh 2.0.0 through 2.2.3 allows local users to bypass access
restrictions and gain root privileges by using the rssh_chroot_helper
command to chroot to an external directory.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.pizzashack.org/rssh/security.shtml
http://www.vuxml.org/freebsd/e34d0c2e-9efb-11da-b410-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300687");
