...
# $Id: deb_251_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20251-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300155");
 ...
 script_name("Debian Security Advisory DSA 251-1 (w3m, w3m-ssl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"w3m", ver:"0.3-2.4", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"w3m-img", ver:"0.3-2.4", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"w3m-ssl", ver:"0.3-2.4", rls:"DEB3.0")) != NULL) {
    report += res;
}
