#
#VID fd376b8b-41e1-11d8-b096-0020ed76ef5a
...
The remote inn server suffers from a control message
buffer overflow that allows an attacker to execute
arbitrary code on the system.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://marc.theaimsgroup.com/?l=inn-workers&m=107351974008605
http://www.vuxml.org/freebsd/fd376b8b-41e1-11d8-b096-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303366");
...
if(!isnull(bver) && revcomp(a:bver, b:"20031022_1")<0) {
    txt += 'Package inn-stable version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
