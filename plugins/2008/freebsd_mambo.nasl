#
#VID 0bf9d7fb-05b3-11da-bc08-0001020eed82
...
tag_insight = "The following package is affected: mambo

CVE-2005-2002
SQL injection vulnerability in content.php in Mambo 4.5.2.2 and
earlier allows remote attackers to execute arbitrary SQL commands via
the user_rating parameter.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://secunia.com/advisories/15710/
http://www.vuxml.org/freebsd/0bf9d7fb-05b3-11da-bc08-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301788");
