...
tag_insight = "The help viewer of the Horde Framework allows attackers to execute
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300590");
 ...
 script_name("Gentoo Security Advisory GLSA 200604-02 (horde)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"www-apps/horde", unaffected: make_list("ge 3.1.1"), vulnerable: make_list("lt 3.1.1"))) != NULL) {
    report += res;
}
