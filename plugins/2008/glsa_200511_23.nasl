...
tag_insight = "chmlib and KchmViewer contain a buffer overflow vulnerability which may
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200511-23
http://bugs.gentoo.org/show_bug.cgi?id=110557";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303276");
