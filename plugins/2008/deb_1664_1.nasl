...
# $Id: deb_1664_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "It was discovered that ekg, a console Gadu Gadu client performs
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201664-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304068");
 ...
 script_name("Debian Security Advisory DSA 1664-1 (ekg)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libgadu3", ver:"1.7~rc2-1etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgadu-dev", ver:"1.7~rc2-1etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ekg", ver:"1.7~rc2-1etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
