...
tag_insight = "A command validation error in umount can lead to an escalation of
privileges.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300989");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"sys-apps/util-linux", unaffected: make_list("ge 2.12q-r3"), vulnerable: make_list("lt 2.12q-r3"))) != NULL) {
    report += res;
}
