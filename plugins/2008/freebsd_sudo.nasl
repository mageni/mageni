#
#VID 045944a0-6bca-11d9-aaa6-000a95bc6fae
...
The installed version of sudo makes improper
use of the CDPATH environment variable.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.sudo.ws/bugs/show_bug.cgi?id=155
http://www.sudo.ws/pipermail/sudo-announce/2004-November/000044.html
http://www.vuxml.org/freebsd/045944a0-6bca-11d9-aaa6-000a95bc6fae.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303949");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.6.8.4")<0) {
