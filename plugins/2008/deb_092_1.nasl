...
# $Id: deb_092_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 092-1
#
# Authors:
...
tag_insight = "Nicolas Boullis found a nasty security problem in the wmtv (a
...
tag_summary = "The remote host is missing an update to wmtv
announced via advisory DSA 092-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20092-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303660");
 ...
 script_name("Debian Security Advisory DSA 092-1 (wmtv)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wmtv", ver:"0.6.5-2potato1", rls:"DEB2.2")) != NULL) {
    report += res;
}
