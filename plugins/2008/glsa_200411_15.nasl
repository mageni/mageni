...
tag_insight = "groffer, included in the Groff package, and the der_chop script, included
...
tag_solution = "All Groff users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302661");
 ...
 script_name("Gentoo Security Advisory GLSA 200411-15 (OpenSSL)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-libs/openssl", unaffected: make_list("ge 0.9.7d-r2"), vulnerable: make_list("lt 0.9.7d-r2"))) != NULL) {
    report += res;
}
if ((res = ispkgvuln(pkg:"sys-apps/groff", unaffected: make_list("ge 1.19.1-r2"), vulnerable: make_list("lt 1.19.1-r2"))) != NULL) {
    report += res;
}
