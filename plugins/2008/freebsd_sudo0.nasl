#
#VID bdd1537b-354c-11d9-a9e7-0001020eed82
...
http://www.vuxml.org/freebsd/bdd1537b-354c-11d9-a9e7-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301541");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.6.8.2")<0) {
