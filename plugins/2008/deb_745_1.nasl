...
# $Id: deb_745_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Two input validation errors were discovered in drupal and its bundled
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20745-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304184");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 23:00:53 +0100 (Thu, 17 Jan 2008)");
 script_cve_id("CVE-2005-2106", "CVE-2005-1921");
 script_tag(name:"cvss_base", value:"7.5");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
 script_name("Debian Security Advisory DSA 745-1 (drupal)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal", ver:"4.5.3-3", rls:"DEB3.1")) != NULL) {
    report += res;
}
