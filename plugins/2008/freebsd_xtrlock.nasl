...
tag_insight = "The following package is affected: xtrlock
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300418");
 ...
 script_name("FreeBSD Ports: xtrlock");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.0.10")<0) {
    txt += 'Package xtrlock version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
