...
# $Id: deb_880_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300818");
 ...
 script_name("Debian Security Advisory DSA 880-1 (phpmyadmin)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"2.6.2-3sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
