...
# $Id: deb_357_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "iSEC Security Research reports that wu-ftpd contains an off-by-one bug
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20357-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301606");
