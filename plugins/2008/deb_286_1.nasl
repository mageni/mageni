...
# $Id: deb_286_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Paul Szabo discovered insecure creation of a temporary file in
...
tag_summary = "The remote host is missing an update to gs-common
announced via advisory DSA 286-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20286-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302536");
 ...
 script_name("Debian Security Advisory DSA 286-1 (gs-common)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gs-common", ver:"0.3.3.0woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
