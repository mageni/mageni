#
#VID 34134fd4-5d81-11d8-80e3-0020ed76ef5a
...
The installed version of pine handles URLs
in messages in an insecure format.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300101");
 ...
 script_bugtraq_id(3815);
 script_cve_id("CVE-2002-0014");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.44")<0) {
