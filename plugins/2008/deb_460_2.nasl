...
# $Id: deb_460_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 460-2
#
# Authors:
...
announced via advisory DSA 460-2.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20460-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301696");
 ...
 script_name("Debian Security Advisory DSA 460-2 (sysstat)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"isag", ver:"4.0.4-1woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sysstat", ver:"4.0.4-1woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
