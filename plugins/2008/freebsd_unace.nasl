#
#VID 1d3a2737-7eb7-11d9-acf7-000854d03344
...
tag_insight = "The following package is affected: unace
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304152");
 ...
 script_name("FreeBSD Ports: unace");
...
txt = "";
vuln = 0;
bver = portver(pkg:"unace");
if(!isnull(bver) && revcomp(a:bver, b:"unace-1.2b_2")<0) {
    txt += 'Package unace version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
