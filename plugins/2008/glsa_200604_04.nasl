...
tag_insight = "Kaffeine is vulnerable to a buffer overflow that could lead to the
...
advisory GLSA 200604-04.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303699");
 ...
 script_name("Gentoo Security Advisory GLSA 200604-04 (kaffeine)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-video/kaffeine", unaffected: make_list("ge 0.7.1-r2"), vulnerable: make_list("lt 0.7.1-r2"))) != NULL) {
    report += res;
}
