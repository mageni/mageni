...
tag_insight = "Zope is vulnerable to a file inclusion vulnerability when exposing
RestructuredText functionalities to untrusted users.";
tag_solution = "All Zope users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose net-zope/zope

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200510-20
http://bugs.gentoo.org/show_bug.cgi?id=109087
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300527");
