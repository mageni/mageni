...
# $Id: deb_948_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300356");
 ...
 script_name("Debian Security Advisory DSA 948-1 (kdelibs)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"kdelibs-data", ver:"3.3.2-6.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"kdelibs4-doc", ver:"3.3.2-6.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"kdelibs", ver:"3.3.2-6.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"kdelibs-bin", ver:"3.3.2-6.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"kdelibs4", ver:"3.3.2-6.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"kdelibs4-dev", ver:"3.3.2-6.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
