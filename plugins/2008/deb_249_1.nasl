...
# $Id: deb_249_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 249-1
#
# Authors:
...
tag_insight = "Hironori Sakamoto, one of w3m developers, found two security
...
tag_summary = "The remote host is missing an update to w3mmee
announced via advisory DSA 249-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20249-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300543");
