...
# $Id: deb_814_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to lm-sensors
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303026");
 ...
 script_name("Debian Security Advisory DSA 814-1 (lm-sensors)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"kernel-patch-2.4-lm-sensors", ver:"2.9.1-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lm-sensors-source", ver:"2.9.1-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsensors-dev", ver:"2.9.1-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsensors3", ver:"2.9.1-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lm-sensors", ver:"2.9.1-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sensord", ver:"2.9.1-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
