...
# $Id: deb_661_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
announced via advisory DSA 661-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20661-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301740");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"f2c", ver:"20010821-3.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
