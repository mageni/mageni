...
# $Id: gb_opera_mult_vuln_oct08_win.nasl 12623 2018-12-03 13:11:38Z cfischer $
#
...
if(description)
{
  ...
  script_name("Opera Web Browser Multiple XSS Vulnerability (Windows)");
  ...
  script_tag(name:"affected", value:"Opera version prior to 9.61 on Windows.");
