...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303475");
 ...
 script_name("FreeBSD Ports: subversion, subversion-perl, subversion-python");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.8")<0) {
    txt += 'Package subversion-perl version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"subversion-python");
if(!isnull(bver) && revcomp(a:bver, b:"1.0.8")<0) {
    txt += 'Package subversion-python version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
