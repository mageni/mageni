#
#VID ff304c35-fb5b-11dc-91c1-00e0815b8da8
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302228");
 ...
 script_bugtraq_id(28373);
 script_tag(name:"cvss_base", value:"6.8");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
 script_name("FreeBSD Ports: silc-irssi-client, silc-client");
...
bver = portver(pkg:"silc-server");
if(!isnull(bver) && revcomp(a:bver, b:"1.1.2")<0) {
    txt += 'Package silc-server version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
