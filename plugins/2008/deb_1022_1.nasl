...
# $Id: deb_1022_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to storebackup
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302277");
 ...
 script_name("Debian Security Advisory DSA 1022-1 (storebackup)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"storebackup", ver:"1.18.4-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
