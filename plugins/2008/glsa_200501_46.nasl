...
tag_insight = "ClamAV contains two vulnerabilities that could lead to Denial of Service
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-46
http://bugs.gentoo.org/show_bug.cgi?id=78656
http://bugs.gentoo.org/show_bug.cgi?id=79194
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303777");
