...
tag_insight = "CVS is subject to a heap overflow vulnerability allowing source repository
compromise.";
tag_solution = "All users running a CVS server should upgrade to the latest stable version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200405-12
http://bugs.gentoo.org/show_bug.cgi?id=51460
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301925");
