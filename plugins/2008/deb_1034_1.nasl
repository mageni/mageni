...
# $Id: deb_1034_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1034-1
#
# Authors:
...
announced via advisory DSA 1034-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300593");
 ...
 script_name("Debian Security Advisory DSA 1034-1 (horde2)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"horde2", ver:"2.2.8-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
