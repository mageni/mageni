...
tag_insight = "Hyper-Threading Technology is the name used for the implementation of
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:09.htt.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304072");
 script_version("$Revision: 8023 $");
 script_tag(name:"last_modification", value:"$Date: 2017-12-07 09:36:26 +0100 (Thu, 07 Dec 2017) $");
 script_tag(name:"creation_date", value:"2008-09-04 20:41:11 +0200 (Thu, 04 Sep 2008)");
 script_bugtraq_id(12724);
 script_cve_id("CVE-2005-0109");
 script_tag(name:"cvss_base", value:"7.2");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
 name = "FreeBSD Security Advisory (FreeBSD-SA-05:09.htt.asc)";
 script_name(name);
