...
tag_insight = "OpenOffice.org contains a vulnerable version of libcurl that may cause a
heap overflow when parsing URLs.";
tag_solution = "All OpenOffice.org binary users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303097");
