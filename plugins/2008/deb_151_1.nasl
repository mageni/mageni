...
# $Id: deb_151_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 151-1
#
# Authors:
...
tag_insight = "Solar Designer found a vulnerability in xinetd, a replacement for the
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20151-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304206");
 ...
 script_name("Debian Security Advisory DSA 151-1 (xinetd)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xinetd", ver:"2.3.4-1.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
