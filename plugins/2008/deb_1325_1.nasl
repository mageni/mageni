...
# $Id: deb_1325_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several remote vulnerabilities have been discovered in Evolution, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201325-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300314");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"evolution-common", ver:"2.6.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"evolution", ver:"2.6.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"evolution-dbg", ver:"2.6.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"evolution-dev", ver:"2.6.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"evolution-plugins", ver:"2.6.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"evolution-plugins-experimental", ver:"2.6.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
