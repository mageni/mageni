...
tag_summary = "This plugin configures Scanner for NIDS evasion (see the 'Prefs' panel).
...
- Fake RST : each time a connection is established, the scanner
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312705");
