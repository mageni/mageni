...
# $Id: deb_292_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 292-1
#
# Authors:
...
tag_insight = "Colin Phipps discovered several problems in mime-support, that contains
...
announced via advisory DSA 292-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20292-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303581");
 ...
 script_name("Debian Security Advisory DSA 292-1 (mime-support)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mime-support", ver:"3.9-1.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mime-support", ver:"3.18-1.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
