...
# $Id: deb_998_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304234");
 ...
 script_name("Debian Security Advisory DSA 998-1 (libextractor)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"extract", ver:"0.4.2-2sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libextractor1", ver:"0.4.2-2sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libextractor1-dev", ver:"0.4.2-2sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
