...
# $Id: deb_554_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Hugo Espuny discovered a problem in sendmail, a commonly used program
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20554-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302508");
 ...
 script_name("Debian Security Advisory DSA 554-1 (sendmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sendmail-doc", ver:"8.12.3-7.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmilter-dev", ver:"8.12.3-7.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sendmail", ver:"8.12.3-7.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
