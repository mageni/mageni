...
# $Id: deb_1648_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Dmitry E. Oboukhov discovered that the test.alert script used in one of the
...
tag_summary = "The remote host is missing an update to mon
announced via advisory DSA 1648-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201648-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301155");
 ...
 script_name("Debian Security Advisory DSA 1648-1 (mon)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mon", ver:"0.99.2-9+etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
