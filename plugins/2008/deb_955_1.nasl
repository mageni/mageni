...
# $Id: deb_955_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 955-1
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301711");
 ...
 script_name("Debian Security Advisory DSA 955-1 (clamav)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
