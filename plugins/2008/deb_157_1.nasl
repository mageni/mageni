...
# $Id: deb_157_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The IRC client irssi is vulnerable to a denial of service condition.
...
tag_summary = "The remote host is missing an update to irssi-text
announced via advisory DSA 157-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20157-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302515");
 ...
 script_name("Debian Security Advisory DSA 157-1 (irssi-text)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"irssi-text", ver:"0.8.4-3.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
