#
#VID 013fa252-0724-11d9-b45d-000c41e2cdad
...
http://www.vuxml.org/freebsd/013fa252-0724-11d9-b45d-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300743");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.3_1")<=0) {
    txt += 'Package mod_dav version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
