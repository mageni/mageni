...
tag_insight = "The jabberd server was found to be vulnerable to a remote Denial of Service
attack.";
tag_solution = "All jabberd users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-31
http://bugs.gentoo.org/show_bug.cgi?id=64741
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303462");
