...
# $Id: deb_1209_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1209-2
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302969");
 ...
 script_name("Debian Security Advisory DSA 1209-2 (trac)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"trac", ver:"0.8.1-3sarge7", rls:"DEB3.1")) != NULL) {
    report += res;
}
