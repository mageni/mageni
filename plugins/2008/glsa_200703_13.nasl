...
tag_insight = "The SSH Secure Shell Server SFTP function is vulnerable to privilege
escalation.";
tag_solution = "This package is currently masked, there is no upgrade path for the 3.2.x
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-13
http://bugs.gentoo.org/show_bug.cgi?id=168584";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301604");
