...
# $Id: deb_799_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 799-1
#
# Authors:
...
We recommend that you upgrade your webcalendar package immediately.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20799-1";
tag_summary = "The remote host is missing an update to webcalendar
announced via advisory DSA 799-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300732");
 ...
 script_name("Debian Security Advisory DSA 799-1 (webcalendar)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"webcalendar", ver:"0.9.45-4sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
