...
# $Id: deb_687_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to bidwatcher
announced via advisory DSA 687-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20687-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301941");
 ...
 script_name("Debian Security Advisory DSA 687-1 (bidwatcher)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bidwatcher", ver:"1.3.3-1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
