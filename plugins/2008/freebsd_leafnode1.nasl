...
The fetchnews client in leafnode is vulnerable to
a denial of service condition triggered when the
the client reads malformed Usenet articles.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://leafnode.sourceforge.net/leafnode-SA-2004-01
...
http://www.vuxml.org/freebsd/a051a4ec-3aa1-4dd1-9bdc-a61eb5700153.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303221");
