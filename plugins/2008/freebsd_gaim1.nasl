#
#VID 3fa2b372-a9f5-11d9-a788-0001020eed82
...
http://www.vuxml.org/freebsd/3fa2b372-a9f5-11d9-a788-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300359");
 ...
 script_cve_id("CVE-2005-0965");
 script_bugtraq_id(12999);
