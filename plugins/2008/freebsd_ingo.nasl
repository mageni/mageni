#
#VID 18a14baa-5ee5-11db-ae08-0008743bf21a
...
tag_insight = "The following package is affected: ingo";
...
http://www.vuxml.org/freebsd/18a14baa-5ee5-11db-ae08-0008743bf21a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301060");
 ...
 script_name("FreeBSD Ports: ingo");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.1.2")<0) {
    txt += 'Package ingo version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
