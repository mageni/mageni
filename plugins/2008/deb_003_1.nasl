...
# $Id: deb_003_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The security fix for joe released on November 22, 2000 had a problem:
...
tag_summary = "The remote host is missing an update to joe
announced via advisory DSA 003-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20003-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303676");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 14:24:38 +0100 (Thu, 17 Jan 2008)");
 script_tag(name:"cvss_base", value:"7.2");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
 script_name("Debian Security Advisory DSA 003-1 (joe)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"joe", ver:"2.8-15.2", rls:"DEB2.2")) != NULL) {
    report += res;
}
