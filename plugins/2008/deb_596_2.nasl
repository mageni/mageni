...
# $Id: deb_596_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 596-2
#
# Authors:
...
tag_insight = "This update removes the debug output which was left over in the update
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20596-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301933");
 ...
 script_name("Debian Security Advisory DSA 596-2 (sudo)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sudo", ver:"1.6.6-1.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
