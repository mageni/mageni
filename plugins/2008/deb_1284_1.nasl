...
# $Id: deb_1284_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1284-1
#
# Authors:
...
announced via advisory DSA 1284-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201284-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300787");
 ...
 script_name("Debian Security Advisory DSA 1284-1 (qemu)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"qemu", ver:"0.6.1+20050407-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"qemu", ver:"0.8.2-4etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
