#
#VID 5b47c279-8cb5-11dc-8878-0016179b2dd5
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303731");
 ...
 script_name("FreeBSD Ports: perl, perl-threaded");
...
if(!isnull(bver) && revcomp(a:bver, b:"5.8")>0 && revcomp(a:bver, b:"5.8.8_1")<0) {
    txt += 'Package perl version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"perl-threaded");
if(!isnull(bver) && revcomp(a:bver, b:"5.8")>0 && revcomp(a:bver, b:"5.8.8_1")<0) {
    txt += 'Package perl-threaded version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
