...
tag_insight = "The following package is affected: cyrus-imapd

CVE-2004-1012
The argument parser of the PARTIAL command in Cyrus IMAP Server 2.2.6
and earlier allows remote authenticated users to execute arbitrary
code via a certain command ('body[p') that is treated as a different
command ('body.peek') and causes an index increment error that leads
to an out-of-bounds memory corruption.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303063");
