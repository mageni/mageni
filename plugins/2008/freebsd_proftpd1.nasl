#
#VID c28f4705-043f-11da-bc08-0001020eed82
...
CVE-2005-2390
Multiple format string vulnerabilities in ProFTPD before 1.3.0rc2
allow attackers to cause a denial of service or obtain sensitive
information via (1) certain inputs to the shutdown message from
ftpshut, or (2) the SQLShowInfo mod_sql directive.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302327");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.3.0.rc2")<0) {
