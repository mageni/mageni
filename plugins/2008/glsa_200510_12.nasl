...
tag_insight = "KOffice and KWord are vulnerable to a buffer overflow in the RTF importer,
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302622");
 ...
 script_name("Gentoo Security Advisory GLSA 200510-12 (koffice, kword)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-office/koffice", unaffected: make_list("ge 1.4.1-r1"), vulnerable: make_list("lt 1.4.1-r1"))) != NULL) {
    report += res;
}
if ((res = ispkgvuln(pkg:"app-office/kword", unaffected: make_list("ge 1.4.1-r1"), vulnerable: make_list("lt 1.4.1-r1"))) != NULL) {
    report += res;
}
