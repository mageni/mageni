...
# $Id: deb_1561_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Christian Herzog discovered that within the Linux Terminal Server Project,
...
tag_summary = "The remote host is missing an update to ldm
announced via advisory DSA 1561-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201561-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303638");
 ...
 script_name("Debian Security Advisory DSA 1561-1 (ldm)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ltsp-server-standalone", ver:"0.99debian11+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ltsp-server", ver:"0.99debian11+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ldm", ver:"0.99debian11+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ltsp-client", ver:"0.99debian11+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
