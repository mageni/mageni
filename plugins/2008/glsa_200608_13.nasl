...
tag_insight = "ClamAV is vulnerable to a heap-based buffer overflow resulting in a Denial
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200608-13
http://bugs.gentoo.org/show_bug.cgi?id=143093
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303264");
