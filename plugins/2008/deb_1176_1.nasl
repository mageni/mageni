...
# $Id: deb_1176_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1176-1
#
# Authors:
...
We recommend that you upgrade your Zope package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201176-1";
tag_summary = "The remote host is missing an update to zope2.7
announced via advisory DSA 1176-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301336");
 ...
 script_name("Debian Security Advisory DSA 1176-1 (zope2.7)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"zope2.7", ver:"2.7.5-2sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
