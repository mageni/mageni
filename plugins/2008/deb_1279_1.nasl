...
# $Id: deb_1279_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "It was discovered that WebCalendar, a PHP-based calendar application,
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201279-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302685");
 ...
 script_name("Debian Security Advisory DSA 1279-1 (webcalendar)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"webcalendar", ver:"0.9.45-4sarge7", rls:"DEB3.1")) != NULL) {
    report += res;
}
