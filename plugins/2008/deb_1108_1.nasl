...
# $Id: deb_1108_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1108-1
#
# Authors:
...
We recommend that you upgrade your mutt package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201108-1";
tag_summary = "The remote host is missing an update to mutt
announced via advisory DSA 1108-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302512");
 ...
 script_name("Debian Security Advisory DSA 1108-1 (mutt)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mutt", ver:"1.5.9-2sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
