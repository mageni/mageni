...
# $Id: deb_1111_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1111-1
#
# Authors:
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201111-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301020");
 ...
 script_name("Debian Security Advisory DSA 1111-1 (kernel-source-2.6.8 et. al.)");
...
if ((res = isdpkgvuln(pkg:"kernel-headers-2.6.8-3", ver:"2.6.8-12sarge4", rls:"DEB3.1")) != NULL) {
    report += res;
}
