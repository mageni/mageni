...
# $Id: deb_292_3.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "I am awfully and sincerely sorry.  Apparently, I wasn't able to assign
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20292-3";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304021");
 ...
 script_name("Debian Security Advisory DSA 292-3 (mime-support)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mime-support", ver:"3.9-1.3", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mime-support", ver:"3.18-1.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
