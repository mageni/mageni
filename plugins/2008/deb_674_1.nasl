...
# $Id: deb_674_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Two security related problems have been discovered in mailman,
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20674-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301081");
 ...
 script_name("Debian Security Advisory DSA 674-1 (mailman)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mailman", ver:"2.0.11-1woody9", rls:"DEB3.0")) != NULL) {
    report += res;
}
