#
#VID 70c59485-ee5a-11d9-8310-0001020eed82
...
CVE-2005-1625
Stack-based buffer overflow in the UnixAppOpenFilePerform function in
Adobe Reader 5.0.9 and 5.0.10 for Unix allows remote attackers to
execute arbitrary code via a PDF document with a long /Filespec tag.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.adobe.com/support/techdocs/329083.html
http://marc.theaimsgroup.com/?l=bugtraq&m=112059685332569
http://www.vuxml.org/freebsd/70c59485-ee5a-11d9-8310-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302409");
 ...
 script_name("FreeBSD Ports: acroread4, acroread5");
