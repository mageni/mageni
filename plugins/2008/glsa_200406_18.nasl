...
tag_insight = "gzip contain a bug potentially allowing an attacker to execute arbitrary
commands.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-18
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301147");
