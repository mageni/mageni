...
# $Id: deb_114_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Thomas Springer found a vulnerability in GNUJSP, a Java servlet that
...
tag_summary = "The remote host is missing an update to gnujsp
announced via advisory DSA 114-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20114-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303386");
