...
# $Id: deb_856_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to py2play
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302533");
 ...
 script_name("Debian Security Advisory DSA 856-1 (py2play)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-2play", ver:"0.1.7-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
