...
# $Id: deb_951_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 951-2
#
# Authors:
...
We recommend that you upgrade your trac package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20951-2";
tag_summary = "The remote host is missing an update to trac
announced via advisory DSA 951-2.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300900");
 ...
 script_name("Debian Security Advisory DSA 951-2 (trac)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"trac", ver:"0.8.1-3sarge4", rls:"DEB3.1")) != NULL) {
    report += res;
}
