...
# $Id: deb_1033_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303241");
 ...
 script_name("Debian Security Advisory DSA 1033-1 (horde3)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"horde3", ver:"3.0.4-4sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
