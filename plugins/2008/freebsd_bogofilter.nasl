...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301997");
 ...
 script_name("FreeBSD Ports: bogofilter, bogofilter-qdbm, bogofilter-tdb, ru-bogofilter");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.17.4")>=0 && revcomp(a:bver, b:"0.92.8")<0) {
    txt += 'Package bogofilter-qdbm version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"bogofilter-tdb");
if(!isnull(bver) && revcomp(a:bver, b:"0.17.4")>=0 && revcomp(a:bver, b:"0.92.8")<0) {
    txt += 'Package bogofilter-tdb version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"ru-bogofilter");
if(!isnull(bver) && revcomp(a:bver, b:"0.17.4")>=0 && revcomp(a:bver, b:"0.92.8")<0) {
    txt += 'Package ru-bogofilter version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
