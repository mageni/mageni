...
tag_insight = "The following package is affected: xview
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300345");
 ...
 script_name("FreeBSD Ports: xview");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.2.1_3")<0) {
    txt += 'Package xview version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
