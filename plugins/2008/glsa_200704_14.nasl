...
tag_insight = "A memory leak has been discovered in FreeRADIUS, possibly allowing for a
Denial of Service.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200704-14
http://bugs.gentoo.org/show_bug.cgi?id=174292";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303148");
