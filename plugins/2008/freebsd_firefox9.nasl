#
#VID e9f9d232-0cb2-11d9-8a8a-000c41e2cdad
...
allow remote attackers to use certain redirect sequences to spoof the
security lock icon that makes a web page appear to be encrypted.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

https://bugzilla.mozilla.org/show_bug.cgi?id=240053
http://www.vuxml.org/freebsd/e9f9d232-0cb2-11d9-8a8a-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302188");
