...
tag_insight = "Cube is vulnerable to a buffer overflow, invalid memory access and remote
client crashes, possibly leading to a Denial of Service or remote code
execution.";
tag_solution = "Upstream stated that there will be no fixed version of Cube, thus the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-10
http://bugs.gentoo.org/show_bug.cgi?id=125289";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303392");
