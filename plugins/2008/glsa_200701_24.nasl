...
tag_insight = "VLC media player improperly handles format strings, allowing for the
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302540");
 ...
 script_name("Gentoo Security Advisory GLSA 200701-24 (vlc)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-video/vlc", unaffected: make_list("ge 0.8.6-r1"), vulnerable: make_list("lt 0.8.6-r1"))) != NULL) {
    report += res;
}
