#
#VID e2e8d374-2e40-11db-b683-0008743bf21a
...
http://www.vuxml.org/freebsd/e2e8d374-2e40-11db-b683-0008743bf21a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304285");
 ...
 script_cve_id("CVE-2006-4256"); 
 script_bugtraq_id(19557,19544);
 script_tag(name:"cvss_base", value:"4.3"); 
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N"); 
 script_name("FreeBSD Ports: horde");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.1.2")<=0) {
    txt += 'Package imp version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
