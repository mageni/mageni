...
# $Id: deb_432_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20432-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301284");
 ...
 script_name("Debian Security Advisory DSA 432-1 (crawl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"crawl", ver:"4.0.0beta23-2woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
