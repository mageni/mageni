#
#VID 2c8a84d9-5bee-11db-a5ae-00508d6a62df
...
tag_insight = "The following package is affected: vtiger";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302889");
 ...
 script_name("FreeBSD Ports: vtiger");
...
txt = "";
vuln = 0;
bver = portver(pkg:"vtiger");
if(!isnull(bver) && revcomp(a:bver, b:"5.0")<0) {
    txt += 'Package vtiger version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
