...
# $Id: deb_033_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 033-1
#
# Authors:
...
tag_insight = "The author of analog, Stephen Turner, has found a buffer overflow bug
...
announced via advisory DSA 033-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20033-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303393");
 ...
 script_name("Debian Security Advisory DSA 033-1 (analog)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"analog", ver:"4.01-1potato1", rls:"DEB2.2")) != NULL) {
    report += res;
}
