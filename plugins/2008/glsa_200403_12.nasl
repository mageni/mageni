...
tag_insight = "A failed password operation can cause the OpenLDAP slapd server, if it is
using the back-ldbm backend, to free memory that was never allocated.";
tag_solution = "OpenLDAP users should upgrade to version 2.1.17 or later:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200403-12
http://bugs.gentoo.org/show_bug.cgi?id=26728
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302721");
