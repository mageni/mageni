...
tag_insight = "RAR and UnRAR contain a buffer overflow allowing the execution of arbitrary
code.";
tag_solution = "All UnRAR users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200702-04
http://bugs.gentoo.org/show_bug.cgi?id=166440";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302355");
