...
# $Id: deb_1077_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1077-1
#
# Authors:
...
tag_insight = "Michal Zalewski discovered that lynx, the popular text-mode WWW
...
announced via advisory DSA 1077-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201077-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302690");
 ...
 script_name("Debian Security Advisory DSA 1077-1 (lynx-ssl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"lynx-ssl", ver:"2.8.4.1b-3.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
