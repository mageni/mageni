...
# $Id: deb_1086_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to xmcd
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300159");
 ...
 script_name("Debian Security Advisory DSA 1086-1 (xmcd)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cddb", ver:"2.6-14woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xmcd", ver:"2.6-14woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cddb", ver:"2.6-17sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xmcd", ver:"2.6-17sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
