#
#VID 29edd807-438d-11d9-8bb9-00065be4b5b6
...
CVE-2004-0956
MySQL before 4.0.20 allows remote attackers to cause a denial of
service (application crash) via a MATCH AGAINST query with an opening
double quote but no closing double quote.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugs.mysql.com/bug.php?id=3870
http://www.vuxml.org/freebsd/29edd807-438d-11d9-8bb9-00065be4b5b6.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303457");
 ...
 script_cve_id("CVE-2004-0956");
 script_bugtraq_id(11432);
