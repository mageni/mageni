...
# $Id: deb_1106_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1106-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to ppp
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303084");
 ...
 script_name("Debian Security Advisory DSA 1106-1 (ppp)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ppp-dev", ver:"2.4.3-20050321+2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ppp", ver:"2.4.3-20050321+2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
