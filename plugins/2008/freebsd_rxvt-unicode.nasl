#
#VID d4bd4046-93a6-11d9-8378-000bdb1444a4
...
tag_insight = "The following package is affected: rxvt-unicode

CVE-2005-0764:
Buffer overflow in command.C for rxvt-unicode
allows remote attackers to execute arbitrary code
via a crafted file containing long escape sequences.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302303");
 ...
 script_name("FreeBSD Ports: rxvt-unicode");
...
txt = "";
vuln = 0;
bver = portver(pkg:"rxvt-unicode");
if(!isnull(bver) && revcomp(a:bver, b:"5.3")<0) {
    txt += 'Package rxvt-unicode version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
