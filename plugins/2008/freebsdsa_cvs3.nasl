...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:05.cvs.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-05:05.cvs.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301259");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-05:05.cvs.asc)";
 script_name(name);
...
vuln = 0;
if(patchlevelcmp(rel:"5.3", patchlevel:"10")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"4.11", patchlevel:"4")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"4.10", patchlevel:"9")<0) {
    vuln = 1;
}
