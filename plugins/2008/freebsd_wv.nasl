#
#VID d29dc506-8aa6-11db-bd0d-00123ffe8333
...
tag_insight = "The following package is affected: wv
...
http://www.vuxml.org/freebsd/d29dc506-8aa6-11db-bd0d-00123ffe8333.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304284");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.2.3")<0) {
    txt += 'Package wv version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
