...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304055");
 ...
 script_name("FreeBSD Ports: gnomevfs2");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.6.2_1")<0) {
    txt += 'Package gnomevfs2 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"gnomevfs");
if(!isnull(bver) && revcomp(a:bver, b:"1.0.5_6")<0) {
    txt += 'Package gnomevfs version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"mc");
