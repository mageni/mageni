...
tag_insight = "Sun Java Development Kit (JDK) and Java Runtime Environment (JRE) contain a
...
tag_solution = "All Sun Java Development Kit 1.5 users should upgrade to the latest
version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303474");
