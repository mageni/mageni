...
# $Id: deb_1208_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1208-1
#
# Authors:
...
We recommend that you upgrade your bugzilla packages.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201208-1";
tag_summary = "The remote host is missing an update to bugzilla
announced via advisory DSA 1208-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300087");
 ...
 script_name("Debian Security Advisory DSA 1208-1 (bugzilla)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bugzilla-doc", ver:"2.16.7-7sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"bugzilla", ver:"2.16.7-7sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
