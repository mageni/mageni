#
#VID 0ff0e9a6-4ee0-11d9-a9e7-0001020eed82
...
transformations enabled, allows remote attackers to execute arbitrary
...
http://www.vuxml.org/freebsd/0ff0e9a6-4ee0-11d9-a9e7-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.7.0.52275");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.6.0.2")>=0 && revcomp(a:bver, b:"2.6.1.r1")<0) {
