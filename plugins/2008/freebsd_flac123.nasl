#
#VID 32d38cbb-2632-11dc-94da-0016179b2dd5
...
tag_insight = "The following package is affected: flac123

=====";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://sourceforge.net/forum/forum.php?forum_id=710314
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301435");
 ...
 script_name("FreeBSD Ports: flac123");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.0.10")<0) {
    txt += 'Package flac123 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
