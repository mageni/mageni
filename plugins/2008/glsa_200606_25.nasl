...
tag_insight = "A heap overflow vulnerability in the Hashcash utility could allow an
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200606-25
http://bugs.gentoo.org/show_bug.cgi?id=134960
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301436");
