...
# $Id: deb_634_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Patrice Fournier discovered a vulnerability in the authorisation
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20634-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300138");
 ...
 script_name("Debian Security Advisory DSA 634-1 (hylafax)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hylafax-doc", ver:"4.1.1-3.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"hylafax-client", ver:"4.1.1-3.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"hylafax-server", ver:"4.1.1-3.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
