...
tag_insight = "Shorewall contains a bug in the code handling the creation of temporary
files and directories. This can allow a non-root user to overwrite
arbitrary system files.";
tag_solution = "All users should upgrade to the latest available version of Shorewall, as
follows:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-07
http://bugs.gentoo.org/show_bug.cgi?id=55675
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300840");
