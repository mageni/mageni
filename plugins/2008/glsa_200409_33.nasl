...
tag_insight = "A bug in the way Apache handles the Satisfy directive can lead to the
...
advisory GLSA 200409-33.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304355");
 ...
 script_name("Gentoo Security Advisory GLSA 200409-33 (net=www/apache)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-www/apache", unaffected: make_list("ge 2.0.51-r1", "lt 2.0.51"), vulnerable: make_list("eq 2.0.51"))) != NULL) {
    report += res;
}
