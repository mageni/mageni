...
# $Id: deb_900_3.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 900-3
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302092");
 ...
 script_name("Debian Security Advisory DSA 900-3 (fetchmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"fetchmail-ssl", ver:"5.9.11-6.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
