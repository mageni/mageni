#
#VID 73ea0706-9c57-11d8-9366-0020ed76ef5a
...
read/write daemon without using chroot, which allows remote attackers
to write files outside of the module's path.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301585");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.6.1")<0) {
