...
# $Id: deb_830_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 830-1
#
# Authors:
...
We recommend that you upgrade your ntlmaps package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20830-1";
tag_summary = "The remote host is missing an update to ntlmaps
announced via advisory DSA 830-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301097");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 23:03:37 +0100 (Thu, 17 Jan 2008)");
 script_bugtraq_id(16700);
 script_cve_id("CVE-2005-2962");
 script_tag(name:"cvss_base", value:"2.1");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:N");
 script_name("Debian Security Advisory DSA 830-1 (ntlmaps)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ntlmaps", ver:"0.9.9-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
