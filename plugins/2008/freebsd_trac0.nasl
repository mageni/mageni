#
#VID 7289187b-66a5-11da-99f6-00123ffe8333
...
tag_insight = "The following package is affected: trac";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://projects.edgewall.com/trac/wiki/ChangeLog#a0.9.2
http://secunia.com/advisories/17894/
http://www.vuxml.org/freebsd/7289187b-66a5-11da-99f6-00123ffe8333.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300934");
 script_version("$Revision: 4203 $");
 script_cve_id("CVE-2005-4065");
 script_bugtraq_id(15720);
