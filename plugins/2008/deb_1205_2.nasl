...
# $Id: deb_1205_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301944");
 ...
 script_name("Debian Security Advisory DSA 1205-2 (thttpd)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"thttpd", ver:"2.23beta1-3sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"thttpd-util", ver:"2.23beta1-3sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
