...
# $Id: deb_1080_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300233");
 ...
 script_name("Debian Security Advisory DSA 1080-1 (dovecot)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"dovecot", ver:"0.99.14-1sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dovecot-common", ver:"0.99.14-1sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dovecot-imapd", ver:"0.99.14-1sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dovecot-pop3d", ver:"0.99.14-1sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
