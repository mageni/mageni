...
# $Id: deb_349_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The logging code in nfs-utils contains an off-by-one buffer overrun
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20349-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300983");
