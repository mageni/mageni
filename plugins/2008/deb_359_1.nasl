...
# $Id: deb_359_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Steve Kemp discovered multiple buffer overflows in atari800, an Atari
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20359-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303051");
 ...
 script_name("Debian Security Advisory DSA 359-1 (atari800)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"atari800", ver:"1.2.2-1woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
