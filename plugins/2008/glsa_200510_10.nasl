...
tag_insight = "uw-imap is vulnerable to remote overflow of a buffer in the IMAP server
leading to execution of arbitrary code.";
tag_solution = "All uw-imap users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=net-mail/uw-imap-2004g'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200510-10
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301445");
