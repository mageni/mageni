...
tag_insight = "A buffer overflow was found in MPlayer's RTSP plugin that could lead to a
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200702-11
http://bugs.gentoo.org/show_bug.cgi?id=159727
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300892");
