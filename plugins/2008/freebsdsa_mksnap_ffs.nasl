#
#ADV FreeBSD-SA-04:01.mksnap_ffs.asc
...
tag_insight = "Mounted filesystems can have a variety of flags set on them.  Some
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:01.mksnap_ffs.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-04:01.mksnap_ffs.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300049");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-04:01.mksnap_ffs.asc)";
 script_name(name);
...
vuln = 0;
if(patchlevelcmp(rel:"5.1", patchlevel:"12")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"5.2", patchlevel:"1")<0) {
    vuln = 1;
}
