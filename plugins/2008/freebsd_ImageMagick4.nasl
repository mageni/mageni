#
#VID cd286cc5-b762-11d9-bfb7-000c6ec775d9
...
The installed version of ImageMagick is vulnerable
to a heap-based buffer overflow in the ReadPNMImage
function.  Attackers may trigger a denial of service
attack via a PNM file with small colors value.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://marc.theaimsgroup.com/?l=bugtraq&m=111445767107869
http://www.vuxml.org/freebsd/cd286cc5-b762-11d9-bfb7-000c6ec775d9.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303441");
