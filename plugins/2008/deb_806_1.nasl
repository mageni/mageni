...
# $Id: deb_806_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 806-1
#
# Authors:
...
We recommend that you upgrade your gcvs package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20806-1";
tag_summary = "The remote host is missing an update to cvs
announced via advisory DSA 806-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300363");
 ...
 script_name("Debian Security Advisory DSA 806-1 (cvs)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gcvs", ver:"1.0a7-2woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gcvs", ver:"1.0final-5sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
