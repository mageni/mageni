...
tag_insight = "WordPress contains PHP script injection, cross-site scripting and path
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200507-02
http://bugs.gentoo.org/show_bug.cgi?id=97374
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301786");
