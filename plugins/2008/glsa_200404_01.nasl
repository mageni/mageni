...
tag_insight = "A flaw has been found in the temporary file handling algorithms for the
...
on the system.";
tag_solution = "Users should upgrade to Portage 2.0.50-r3 or later:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200404-01
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302639");
