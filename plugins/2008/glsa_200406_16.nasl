...
tag_insight = "A bug in mod_proxy may allow a remote attacker to execute arbitrary code
when Apache is configured a certain way.";
tag_solution = "Apache 1.x users should upgrade to the latest version of Apache:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-16
http://bugs.gentoo.org/show_bug.cgi?id=53544
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303039");
