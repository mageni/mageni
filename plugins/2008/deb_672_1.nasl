...
# $Id: deb_672_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Erik Sjölund discovered that programs linked against xview are
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301033");
