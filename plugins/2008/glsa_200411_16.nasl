...
tag_insight = "zip contains a buffer overflow when creating a ZIP archive of files with
very long path names. This could lead to the execution of arbitrary code.";
tag_solution = "All zip users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-arch/zip-2.3-r4'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-16
http://bugs.gentoo.org/show_bug.cgi?id=70227
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303152");
