...
tag_insight = "The Blackdown JDK and the Blackdown JRE suffer from the multiple
unspecified vulnerabilities that already affected the Sun JDK and JRE.";
tag_solution = "Since there is no fixed update from Blackdown and since the flaw only
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200705-20
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302306");
