...
# $Id: deb_274_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Byrial Jensen discovered a couple of off-by-one buffer overflow in the
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20274-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304064");
 ...
 script_name("Debian Security Advisory DSA 274-1 (mutt)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mutt", ver:"1.3.28-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mutt-utf8", ver:"1.3.28-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
