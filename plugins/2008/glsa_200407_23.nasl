...
tag_insight = "SoX contains two buffer overflow vulnerabilities in the WAV header parser
code.";
tag_solution = "All SoX users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-23
http://bugs.gentoo.org/show_bug.cgi?id=58733
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301070");
