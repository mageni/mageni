...
tag_insight = "Mozilla Suite and Firefox are vulnerable to a buffer overflow that might be
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200509-11
http://bugs.gentoo.org/show_bug.cgi?id=105396
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302362");
