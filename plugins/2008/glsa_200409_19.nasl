...
tag_insight = "Several bugs exist in the Heimdal ftp daemon which could allow a remote
...
advisory GLSA 200409-19.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302504");
 ...
 script_name("Gentoo Security Advisory GLSA 200409-19 (heimdal)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-crypt/heimdal", unaffected: make_list("ge 0.6.3"), vulnerable: make_list("lt 0.6.3"))) != NULL) {
    report += res;
}
