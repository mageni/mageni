...
# $Id: deb_1214_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1214-2
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304237");
 ...
 script_name("Debian Security Advisory DSA 1214-2 (gv)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gv", ver:"3.6.1-10sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
