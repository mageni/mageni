...
tag_insight = "Multiple vulnerabilities in Comix may lead to execution of arbitrary
commands and a Denial of Service.";
tag_solution = "All Comix users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=media-gfx/comix-3.6.4-r1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-29
http://bugs.gentoo.org/show_bug.cgi?id=215694";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300185");
