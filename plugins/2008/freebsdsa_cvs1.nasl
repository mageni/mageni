...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:10.cvs.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-04:10.cvs.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302154");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-04:10.cvs.asc)";
 script_name(name);
...
vuln = 0;
if(patchlevelcmp(rel:"4.9", patchlevel:"8")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"4.8", patchlevel:"21")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"4.7", patchlevel:"27")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"5.2.1", patchlevel:"7")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"5.1", patchlevel:"17")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"5.0", patchlevel:"21")<0) {
    vuln = 1;
}
