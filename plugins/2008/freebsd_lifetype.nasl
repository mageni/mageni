...
tag_insight = "The following package is affected: lifetype
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303069");
 ...
 script_name("FreeBSD Ports: lifetype");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.3")<0) {
    txt += 'Package lifetype version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
