...
tag_insight = "A memory allocation bug in Freeciv allows a remote attacker to perform a
Denial of Service attack.";
tag_solution = "All Freeciv users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=games-strategy/freeciv-2.0.8'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-11
http://bugs.gentoo.org/show_bug.cgi?id=125304
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300372");
