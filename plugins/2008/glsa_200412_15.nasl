...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-15
http://bugs.gentoo.org/show_bug.cgi?id=74443
http://www.ethereal.com/appnotes/enpa-sa-00016.html";
tag_summary = "The remote host is missing updates announced in
advisory GLSA 200412-15.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303205");
 ...
 script_name("Gentoo Security Advisory GLSA 200412-15 (Ethereal)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-analyzer/ethereal", unaffected: make_list("ge 0.10.8"), vulnerable: make_list("lt 0.10.8"))) != NULL) {
    report += res;
}
