#
#ADV FreeBSD-SA-06:16.smbfs.asc
...
tag_insight = "smbfs is a network file-system used to access file servers using the
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:16.smbfs.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302892");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-06:16.smbfs.asc)";
 script_name(name);
