...
# $Id: deb_337_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "semi, a MIME library for GNU Emacs, does not take appropriate
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20337-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300612");
 ...
 script_name("Debian Security Advisory DSA 337-1 (semi, wemi)");
