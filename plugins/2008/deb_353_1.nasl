...
# $Id: deb_353_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "sup, a package used to maintain collections of files in identical
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20353-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303969");
 ...
 script_name("Debian Security Advisory DSA 353-1 (sup)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sup", ver:"1.8-8woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
