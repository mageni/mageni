...
# $Id: gb_avast_endpoint_protection_detect.nasl 11279 2018-09-07 09:08:31Z cfischer $
#
# Avast Endpoint Protection Version Detection
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810211");
  script_version("$Revision: 11279 $");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2018-09-07 11:08:31 +0200 (Fri, 07 Sep 2018) $");
  script_tag(name:"creation_date", value:"2016-11-24 12:04:38 +0530 (Thu, 24 Nov 2016)");
  script_name("Avast Endpoint Protection Version Detection");

  script_tag(name:"summary", value:"Detects the installed version of
  Avast Endpoint Protection.

  The script logs in via smb, searches for string 'Avast Endpoint Protection' in
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if(avastName =~ "avast! Endpoint Protection$")
  {
    ...
    if(avastVer)
    {
      set_kb_item(name:"Avast/Endpoint-Protection/Win/Ver", value:avastVer);

      cpe = build_cpe(value:avastVer, exp:"^([0-9.]+)", base:"cpe:/a:avast:endpoint_protection:");
      if(isnull(cpe))
        cpe = "cpe:/a:avast:endpoint_protection";

      register_product(cpe:cpe, location:avastPath);

      log_message(data: build_detection_report(app: "Avast Endpoint Protection",
                                               version: avastVer,
                                               install: avastPath,
                                               cpe: cpe,
                                               concluded: avastVer));
