...
#
# IT-Grundschutz, 13. EL, Maßnahme 4.014
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94110");
  script_version("$Revision: 10623 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-25 17:14:01 +0200 (Wed, 25 Jul 2018) $");
  script_tag(name:"creation_date", value:"2013-11-20 13:44:53 +0100 (Wed, 20 Nov 2013)");
...
wird: OID 1.3.6.1.4.1.25623.1.0.94181
