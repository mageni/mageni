...
# $Id: GSHB_M4_197.nasl 11531 2018-09-21 18:50:24Z cfischer $
#
# IT-Grundschutz, 11. EL, Maßnahme 4.197
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.894197");
  ...
  script_name("IT-Grundschutz M4.197: Servererweiterungen für dynamische Webseiten beim Apache-Webserver (Windows)");
  script_xref(name:"URL", value:"http://www.bsi.bund.de/DE/Themen/ITGrundschutz/ITGrundschutzKataloge/Inhalt/_content/m/m04/m04197.html");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.197: Servererweiterungen für dynamische Webseiten beim Apache-Webserver (Windows).
