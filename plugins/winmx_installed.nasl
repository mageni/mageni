...
# Description: WinMX Detection (Windows SMB Login)
#
# Authors:
...
if(description)
{
  ...
  script_name("WinMX Detection (Windows SMB Login)");
  ...
  script_tag(name:"summary", value:"SMB login-based detection of WinMX.");
