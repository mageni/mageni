...
# $Id: gb_rslogix5000_data_preserved_download_tool_detect_win.nasl 13738 2019-02-18 13:50:40Z mmartin $
#
...
if(description)
{
  ...
  script_name("Rockwell Automation RSLogix5000 Data Preserved Download ToolVersion Detection (Windows)");
