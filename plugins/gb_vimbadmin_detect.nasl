...
# $Id: gb_vimbadmin_detect.nasl 10888 2018-08-10 12:08:02Z cfischer $
#
# ViMbAdmin Detection
#
# Authors:
...
foreach dir (make_list_unique("/vimbadmin", cgi_dirs(port: port))) {
  install = dir;
  if (dir == "/")
    dir = "";
  ...
  if ('keywords" content="ViMbAdmin' >< res && "Login to ViMbAdmin" >< res) {
    version = "unknown";
    ...
    log_message(data: build_detection_report(app: "ViMbAdmin", version: version, install: install, cpe: cpe,
                                             concluded: vers[0]),
                port: port);
  }
}
