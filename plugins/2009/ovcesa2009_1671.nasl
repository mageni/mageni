...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304610");
...
if ((res = isrpmvuln(pkg:"kernel-largesmp", rpm:"kernel-largesmp~2.6.9~89.0.18.EL", rls:"CentOS4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"kernel-largesmp-devel", rpm:"kernel-largesmp-devel~2.6.9~89.0.18.EL", rls:"CentOS4")) != NULL) {
    report += res;
}
