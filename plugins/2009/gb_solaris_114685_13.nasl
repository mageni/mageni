...
#
# Solaris Update for Samba 114685-13
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.308330");
  ...
  script_name( "Solaris Update for Samba 114685-13");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-114685-13-1");
...
if(solaris_check_patch(release:"5.9", arch:"i386", patch:"114685-13", package:"SUNWsmbau SUNWsmbaS SUNWsmbac SUNWsmbar") < 0)
{
  security_message(0);
  exit(0);
}