...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-November/015394.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311174");
  ...
  script_name( "CentOS Update for httpd CESA-2008:0967 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.0.46~71.ent", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"httpd-devel", rpm:"httpd-devel~2.0.46~71.ent", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"mod_ssl", rpm:"mod_ssl~2.0.46~71.ent", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
