...
tag_affected = "blender on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00178.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309754");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-16 14:16:57 +0100 (Mon, 16 Feb 2009)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2008-10448");
  script_cve_id("CVE-2008-4863");
  script_name( "Fedora Update for blender FEDORA-2008-10448");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"blender", rpm:"blender~2.48a~4.fc10", rls:"FC10")) != NULL)
  {
