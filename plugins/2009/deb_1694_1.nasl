...
tag_insight = "Paul Szabo discovered that xterm, a terminal emulator for the X Window
...
announced via advisory DSA 1694-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201694-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308645");
 ...
 script_name("Debian Security Advisory DSA 1694-1 (xterm)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xterm", ver:"222-1etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
