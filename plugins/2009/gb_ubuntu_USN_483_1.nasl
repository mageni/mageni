...
# $Id: gb_ubuntu_USN_483_1.nasl 7969 2017-12-01 09:23:16Z santu $
#
...
tag_insight = "Peter Johannes Holzer discovered that the Net::DNS Perl module had
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-483-1";
tag_affected = "libnet-dns-perl vulnerabilities on Ubuntu 6.06 LTS ,
  Ubuntu 6.10";
...
if(description)
{
  script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-483-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.307486");
...
if(release == "UBUNTU6.06 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libnet-dns-perl", ver:"0.53-2ubuntu1", rls:"UBUNTU6.06 LTS")) != NULL)
  {
...
if(release == "UBUNTU6.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libnet-dns-perl", ver:"0.57-1ubuntu1", rls:"UBUNTU6.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
