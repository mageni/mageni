...
tag_affected = "pcre on Red Hat Enterprise Linux AS version 4,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2007-November/msg00005.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306511");
  ...
  script_name( "RedHat Update for pcre RHSA-2007:1068-01");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"pcre", rpm:"pcre~4.5~4.el4_6.6", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcre-debuginfo", rpm:"pcre-debuginfo~4.5~4.el4_6.6", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcre-devel", rpm:"pcre-devel~4.5~4.el4_6.6", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
