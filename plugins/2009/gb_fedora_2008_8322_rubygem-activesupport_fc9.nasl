...
tag_affected = "rubygem-activesupport on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01317.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311355");
  ...
  script_name( "Fedora Update for rubygem-activesupport FEDORA-2008-8322");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-activesupport", rpm:"rubygem-activesupport~2.1.1~1.fc9", rls:"FC9")) != NULL)
  {
