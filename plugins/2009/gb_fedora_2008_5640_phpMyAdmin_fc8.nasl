...
#
# Fedora Update for phpMyAdmin FEDORA-2008-5640
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00917.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311479");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-5640");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.7~1.fc8", rls:"FC8")) != NULL)
  {
