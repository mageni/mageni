...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309198");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.3.1_2")<0) {
    txt += 'Package kdebase4-runtime version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"kdelibs4");
if(!isnull(bver) && revcomp(a:bver, b:"4.3.1_5")<0) {
    txt += 'Package kdelibs4 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
