...
#
# Fedora Update for epiphany FEDORA-2008-6518
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00659.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304592");
  ...
  script_name( "Fedora Update for epiphany FEDORA-2008-6518");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"epiphany", rpm:"epiphany~2.22.2~3.fc9", rls:"FC9")) != NULL)
  {
