...
# $Id: sles9p5061160.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310530");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"cyrus-imapd", rpm:"cyrus-imapd~2.2.3~83.42", rls:"SLES9.0")) != NULL) {
    report += res;
}
