...
# $Id: fcore_2009_10822.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to sahana
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.312048");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"sahana", rpm:"sahana~0.6.2.2~6.fc10", rls:"FC10")) != NULL) {
    report += res;
}
