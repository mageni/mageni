...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00052.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309073");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"imlib2", rpm:"imlib2~1.4.0~7.fc9", rls:"FC9")) != NULL)
  {
