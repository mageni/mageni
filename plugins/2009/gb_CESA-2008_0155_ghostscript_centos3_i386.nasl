...
#
# CentOS Update for ghostscript CESA-2008:0155 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-February/014716.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308181");
  ...
  script_name( "CentOS Update for ghostscript CESA-2008:0155 centos3 i386");
