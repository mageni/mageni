...
#
# Fedora Update for cacti FEDORA-2007-2199
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-September/msg00307.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311158");
  ...
  script_name( "Fedora Update for cacti FEDORA-2007-2199");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.6j~8.fc7", rls:"FC7")) != NULL)
  {
