...
# $Id: gb_flock_addr_bar_spoofing_vuln_win.nasl 11554 2018-09-22 15:11:42Z cfischer $
#
...
the address bar shows an arbitrary path on a possibly trusted host.");
  ...
  script_tag(name:"summary", value:"This host is installed with Flock Browser and is prone to
