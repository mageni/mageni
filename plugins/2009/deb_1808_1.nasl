...
# $Id: deb_1808_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "Markus Petrux discovered a cross-site scripting vulnerability in the
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201808-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310367");
 ...
 script_name("Debian Security Advisory DSA 1808-1 (drupal6)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal6", ver:"6.6-3lenny2", rls:"DEB5.0")) != NULL) {
    report += res;
}
