...
tag_affected = "libxslt on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-August/msg00118.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305839");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"libxslt", rpm:"libxslt~1.1.24~2.fc9", rls:"FC9")) != NULL)
  {
