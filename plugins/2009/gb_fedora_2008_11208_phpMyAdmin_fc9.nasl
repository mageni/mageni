...
#
# Fedora Update for phpMyAdmin FEDORA-2008-11208
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00757.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305241");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.1.1~1.fc9", rls:"FC9")) != NULL)
  {
