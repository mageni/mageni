...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00030.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307234");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-16 16:22:52 +0100 (Mon, 16 Feb 2009)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_xref(name: "FEDORA", value: "2008-2159");
  script_name( "Fedora Update for viewvc FEDORA-2008-2159");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"viewvc", rpm:"viewvc~1.0.5~1.fc8", rls:"FC8")) != NULL)
  {
