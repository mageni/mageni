...
tag_affected = "syslog-ng on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00237.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308302");
  ...
  script_name( "Fedora Update for syslog-ng FEDORA-2008-10752");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"syslog-ng", rpm:"syslog-ng~2.0.10~1.fc9", rls:"FC9")) != NULL)
  {
