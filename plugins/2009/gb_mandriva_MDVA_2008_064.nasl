...
tag_insight = "This update fixes a few issues in draksnapshot. It prevents the applet
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-05/msg00017.php");
  script_oid("1.3.6.1.4.1.25623.1.0.310146");
  ...
  script_name( "Mandriva Update for draksnapshot MDVA-2008:064 (draksnapshot)");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"draksnapshot", rpm:"draksnapshot~0.10~1.1mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
