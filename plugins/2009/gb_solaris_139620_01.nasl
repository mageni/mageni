...
#
# Solaris Update for CDE 1.6 139620-01
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.307253");
  ...
  script_name("Solaris Update for CDE 1.6 139620-01");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-139620-01-1");
...
if(solaris_check_patch(release:"5.10", arch:"sparc", patch:"139620-01", package:"SUNWdtbas") < 0)
{
  security_message(0);
  exit(0);
}
