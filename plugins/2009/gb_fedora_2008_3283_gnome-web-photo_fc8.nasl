...
#
# Fedora Update for gnome-web-photo FEDORA-2008-3283
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00483.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305689");
  ...
  script_name( "Fedora Update for gnome-web-photo FEDORA-2008-3283");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.3~10.fc8", rls:"FC8")) != NULL)
  {
