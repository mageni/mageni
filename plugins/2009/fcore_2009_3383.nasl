...
# $Id: fcore_2009_3383.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-3383 (mapserver)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-3383";
tag_summary = "The remote host is missing an update to mapserver
announced via advisory FEDORA-2009-3383.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305897");
 ...
 script_name("Fedora Core 9 FEDORA-2009-3383 (mapserver)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mapserver", rpm:"mapserver~5.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mapserver-java", rpm:"mapserver-java~5.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mapserver-perl", rpm:"mapserver-perl~5.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mapserver-python", rpm:"mapserver-python~5.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"php-mapserver", rpm:"php-mapserver~5.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mapserver-debuginfo", rpm:"mapserver-debuginfo~5.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
