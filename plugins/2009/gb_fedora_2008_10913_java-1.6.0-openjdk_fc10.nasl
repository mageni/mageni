...
tag_affected = "java-1.6.0-openjdk on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00444.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310214");
