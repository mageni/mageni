...
# $Id: deb_1923_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "A denial of service vulnerability has been found in libhtml-parser-perl,
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201923-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304651");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libhtml-parser-perl", ver:"3.55-1+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libhtml-parser-perl", ver:"3.56-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
