...
# $Id: fcore_2009_3761.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_insight = "The permissions on the prewikka.conf file are world readable and contain the sql
...
tag_summary = "The remote host is missing an update to prewikka
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"prewikka", rpm:"prewikka~0.9.14~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
