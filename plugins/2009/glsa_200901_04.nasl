...
tag_insight = "An error condition can cause D-Bus to crash.";
tag_solution = "All D-Bus users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=sys-apps/dbus-1.2.3-r1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-04
http://bugs.gentoo.org/show_bug.cgi?id=240308";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308234");
