...
#
# Fedora Update for kazehakase FEDORA-2008-8425
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01348.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305921");
  ...
  script_name( "Fedora Update for kazehakase FEDORA-2008-8425");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"kazehakase", rpm:"kazehakase~0.5.5~1.fc9.1", rls:"FC9")) != NULL)
  {
