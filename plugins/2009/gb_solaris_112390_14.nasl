...
#
# Solaris Update for Supplemental Encryption Kerberos V5 112390-14
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.310094");
  ...
  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-112390-14-1");
...
if(solaris_check_patch(release:"5.8", arch:"sparc", patch:"112390-14", package:"SUNWk5pu SUNWk5pk SUNWk5pkx SUNWk5pux") < 0)
{
  security_message(0);
  exit(0);
}
