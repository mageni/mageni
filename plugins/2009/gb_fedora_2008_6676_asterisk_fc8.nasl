...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00839.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309021");
  ...
  script_name( "Fedora Update for asterisk FEDORA-2008-6676");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.4.21.2~1.fc8", rls:"FC8")) != NULL)
  {
