...
tag_insight = "USN-459-1 fixed vulnerabilities in pptpd.  However, a portion of the fix
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-459-2";
tag_affected = "pptpd vulnerabilities on Ubuntu 6.06 LTS";
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.308209");
...
if(release == "UBUNTU6.06 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"bcrelay", ver:"1.2.3-1ubuntu0.2", rls:"UBUNTU6.06 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"pptpd", ver:"1.2.3-1ubuntu0.2", rls:"UBUNTU6.06 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
