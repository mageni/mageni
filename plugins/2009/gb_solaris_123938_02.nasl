...
#
# Solaris Update for GNOME 2.6.0 123938-02
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.304875");
  ...
  script_name("Solaris Update for GNOME 2.6.0 123938-02");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-123938-02-1");
...
if(solaris_check_patch(release:"5.10", arch:"sparc", patch:"123938-02", package:"SUNWgnutls") < 0)
{
  security_message(0);
  exit(0);
}