...
# $Id: eggdrop_24070.nasl 14031 2019-03-07 10:47:29Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"impact", value:"An attacker can exploit this issue to execute arbitrary code within the context
