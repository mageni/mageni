...
# $Id: mdksa_2009_252_1.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
tag_insight = "A vulnerability was discovered and corrected in perl-IO-Socket-SSL:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309322");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"perl-IO-Socket-SSL", rpm:"perl-IO-Socket-SSL~1.15~1.2mdv2009.0", rls:"MNDK_2009.0")) != NULL) {
    report += res;
}
