...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00347.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310443");
  ...
  script_name( "Fedora Update for libxml2 FEDORA-2008-7395");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.6.32~3.fc9", rls:"FC9")) != NULL)
  {
