...
# $Id: fcore_2009_12674.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307908");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"dstat", rpm:"dstat~0.7.0~1.fc12", rls:"FC12")) != NULL) {
    report += res;
}
