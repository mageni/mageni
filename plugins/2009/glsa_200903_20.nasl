...
tag_insight = "Multiple vulnerabilities in WebSVN allow for file overwrite and information
disclosure.";
tag_solution = "All WebSVN users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-apps/websvn-2.1.0'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-20
http://bugs.gentoo.org/show_bug.cgi?id=243852";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306801");
