...
#
# Mandriva Update for timezone MDKA-2007:096 (timezone)
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-10/msg00018.php");
  script_oid("1.3.6.1.4.1.25623.1.0.311778");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"timezone-2007h", rpm:"timezone-2007h~1.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"timezone-2007h", rpm:"timezone-2007h~1.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
