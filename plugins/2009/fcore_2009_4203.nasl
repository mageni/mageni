...
# $Id: fcore_2009_4203.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309076");
 ...
 script_name("Fedora Core 9 FEDORA-2009-4203 (drupal)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.11~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
