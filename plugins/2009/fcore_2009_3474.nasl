...
# $Id: fcore_2009_3474.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-3474 (wordpress-mu)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-3474";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309708");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wordpress-mu", rpm:"wordpress-mu~2.6.5~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
