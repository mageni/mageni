...
tag_affected = "wesnoth on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00006.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309495");
  ...
  script_name( "Fedora Update for wesnoth FEDORA-2007-3989");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"wesnoth", rpm:"wesnoth~1.2.8~2.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wesnoth-debuginfo", rpm:"wesnoth-debuginfo~1.2.8~2.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wesnoth-server", rpm:"wesnoth-server~1.2.8~2.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wesnoth-tools", rpm:"wesnoth-tools~1.2.8~2.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
