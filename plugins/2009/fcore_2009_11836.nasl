...
# $Id: fcore_2009_11836.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309635");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wget", rpm:"wget~1.12~2.fc12", rls:"FC12")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"wget-debuginfo", rpm:"wget-debuginfo~1.12~2.fc12", rls:"FC12")) != NULL) {
    report += res;
}
