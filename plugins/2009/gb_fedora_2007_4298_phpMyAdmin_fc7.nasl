...
#
# Fedora Update for phpMyAdmin FEDORA-2007-4298
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00326.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308614");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2007-4298");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.3~1.fc7", rls:"FC7")) != NULL)
  {
