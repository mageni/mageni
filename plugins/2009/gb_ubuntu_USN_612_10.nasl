...
# $Id: gb_ubuntu_USN_612_10.nasl 7969 2017-12-01 09:23:16Z santu $
#
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-612-10";
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.304989");
...
if(release == "UBUNTU7.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"openvpn", ver:"2.0.9-5ubuntu0.3", rls:"UBUNTU7.04")) != NULL)
  {
...
if(release == "UBUNTU8.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"openvpn", ver:"2.1~rc7-1ubuntu3.3", rls:"UBUNTU8.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU7.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"openvpn", ver:"2.0.9-8ubuntu0.3", rls:"UBUNTU7.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
