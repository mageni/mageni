...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-May/014920.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306045");
  ...
  script_name( "CentOS Update for libxslt CESA-2008:0287 centos3 i386");
