...
#
# CentOS Update for pcre CESA-2007:1063 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2007-November/014467.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311827");
  ...
  script_name( "CentOS Update for pcre CESA-2007:1063 centos3 i386");
