...
# $Id: fcore_2009_11693.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308829");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.8.6~2.fc11", rls:"FC11")) != NULL) {
    report += res;
}
