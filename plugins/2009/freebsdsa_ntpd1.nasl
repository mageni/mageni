#
#ADV FreeBSD-SA-09:11.ntpd.asc
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from ADV FreeBSD-SA-09:11.ntpd.asc
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:11.ntpd.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-09:11.ntpd.asc";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311524");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-09:11.ntpd.asc)";
 script_name(name);
