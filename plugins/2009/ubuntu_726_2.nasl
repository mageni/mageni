...
# $Id: ubuntu_726_2.nasl 7969 2017-12-01 09:23:16Z santu $
# $Id: ubuntu_726_2.nasl 7969 2017-12-01 09:23:16Z santu $
# Description: Auto-generated from advisory USN-726-2 (curl)
#
# Authors:
...
tag_insight = "USN-726-1 fixed a vulnerability in curl. Due to an incomplete fix, a regression
...
announced via advisory USN-726-2.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310070");
 ...
 script_name("Ubuntu USN-726-2 (curl)");



 script_category(ACT_GATHER_INFO);
 script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-726-2/");
