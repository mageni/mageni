...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00633.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308968");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:05:11 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-8956");
  script_name( "Fedora Update for php-Smarty FEDORA-2008-8956");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"php-Smarty", rpm:"php-Smarty~2.6.20~1.fc8", rls:"FC8")) != NULL)
  {
