...
#
# Fedora Update for namazu FEDORA-2008-2678
#
# Authors:
...
tag_affected = "namazu on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00575.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309042");
  ...
  script_name( "Fedora Update for namazu FEDORA-2008-2678");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"namazu", rpm:"namazu~2.0.18~1.fc7", rls:"FC7")) != NULL)
  {
