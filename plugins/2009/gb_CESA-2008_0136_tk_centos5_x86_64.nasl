...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-February/014700.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309770");
  ...
  script_name( "CentOS Update for tk CESA-2008:0136 centos5 x86_64");
