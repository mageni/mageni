...
tag_affected = "nagios on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00125.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309564");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"nagios", rpm:"nagios~2.10~3.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"nagios-debuginfo", rpm:"nagios-debuginfo~2.10~3.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"nagios-devel", rpm:"nagios-devel~2.10~3.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
