...
# $Id: secpod_firefox_pdf_js_rest_bypass_vuln_lin.nasl 12629 2018-12-03 15:19:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Firefox version 3.0.10 and prior on Linux.");
