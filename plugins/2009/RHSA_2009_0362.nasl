...
# $Id: RHSA_2009_0362.nasl 6683 2017-07-12 09:41:57Z cfischer $
# Description: Auto-generated from advisory RHSA-2009:0362 ()
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307656");
 ...
 script_name("RedHat Security Advisory RHSA-2009:0362");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-0362.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"NetworkManager", rpm:"NetworkManager~0.3.1~5.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"NetworkManager-debuginfo", rpm:"NetworkManager-debuginfo~0.3.1~5.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"NetworkManager-gnome", rpm:"NetworkManager-gnome~0.3.1~5.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
