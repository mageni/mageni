...
#
# Fedora Update for yelp FEDORA-2008-3283
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00482.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306469");
  ...
  script_name( "Fedora Update for yelp FEDORA-2008-3283");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"yelp", rpm:"yelp~2.20.0~9.fc8", rls:"FC8")) != NULL)
  {
