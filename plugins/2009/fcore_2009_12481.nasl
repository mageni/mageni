...
# $Id: fcore_2009_12481.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307735");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=541558");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.2.2~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
