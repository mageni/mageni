...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015063.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308500");
  ...
  script_name( "CentOS Update for firefox CESA-2008:0549 centos4 x86_64");
