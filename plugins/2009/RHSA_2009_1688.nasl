...
# $Id: RHSA_2009_1688.nasl 6683 2017-07-12 09:41:57Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309190");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-1688.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"condor", rpm:"condor~7.4.1~0.7.1.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"condor-debuginfo", rpm:"condor-debuginfo~7.4.1~0.7.1.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"condor-kbdd", rpm:"condor-kbdd~7.4.1~0.7.1.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"condor-qmf-plugins", rpm:"condor-qmf-plugins~7.4.1~0.7.1.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
