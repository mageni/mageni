...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00817.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310213");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-13 10:35:30 +0100 (Fri, 13 Feb 2009)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2008-11247");
  script_name( "Fedora Update for roundcubemail FEDORA-2008-11247");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.2~4.beta.fc10", rls:"FC10")) != NULL)
  {
