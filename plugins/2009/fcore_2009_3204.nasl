...
# $Id: fcore_2009_3204.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305128");
 ...
 script_name("Fedora Core 10 FEDORA-2009-3204 (pam)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"pam", rpm:"pam~1.0.4~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"pam-devel", rpm:"pam-devel~1.0.4~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"pam-debuginfo", rpm:"pam-debuginfo~1.0.4~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
