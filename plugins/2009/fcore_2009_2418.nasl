...
# $Id: fcore_2009_2418.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-2418 (bugzilla)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2418";
tag_summary = "The remote host is missing an update to bugzilla
announced via advisory FEDORA-2009-2418.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308904");
 ...
 script_name("Fedora Core 9 FEDORA-2009-2418 (bugzilla)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"bugzilla", rpm:"bugzilla~3.2.2~2.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"bugzilla-contrib", rpm:"bugzilla-contrib~3.2.2~2.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"bugzilla-doc", rpm:"bugzilla-doc~3.2.2~2.fc9", rls:"FC9")) != NULL) {
    report += res;
}
