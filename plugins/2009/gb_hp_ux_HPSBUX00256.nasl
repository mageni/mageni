...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c00944545-1");
  script_oid("1.3.6.1.4.1.25623.1.0.304635");
  ...
  script_name( "HP-UX Update for Apache HPSBUX00256");
...
if(release == "HPUX11.22")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"hpuxwsAPACHE", revision:"A.1.0.03.01", rls:"HPUX11.22")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
