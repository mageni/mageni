...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-October/msg00194.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311107");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-27 16:01:32 +0100 (Fri, 27 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_xref(name: "FEDORA", value: "2007-2496");
  script_cve_id("CVE-2007-3917");
  script_name( "Fedora Update for wesnoth FEDORA-2007-2496");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"wesnoth", rpm:"wesnoth~1.2.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wesnoth-debuginfo", rpm:"wesnoth-debuginfo~1.2.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wesnoth-tools", rpm:"wesnoth-tools~1.2.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wesnoth-server", rpm:"wesnoth-server~1.2.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
