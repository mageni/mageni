...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00959.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310338");
  ...
  script_name( "Fedora Update for horde FEDORA-2008-5691");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"horde", rpm:"horde~3.2.1~1.fc8", rls:"FC8")) != NULL)
  {
