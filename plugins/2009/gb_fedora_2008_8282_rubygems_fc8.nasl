...
tag_affected = "rubygems on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00322.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309112");
  ...
  script_name( "Fedora Update for rubygems FEDORA-2008-8282");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygems", rpm:"rubygems~1.2.0~2.fc8", rls:"FC8")) != NULL)
  {
