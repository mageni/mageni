...
#
# Fedora Update for seamonkey FEDORA-2008-6193
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00288.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312085");
  ...
  script_name( "Fedora Update for seamonkey FEDORA-2008-6193");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.1.10~1.fc9", rls:"FC9")) != NULL)
  {
