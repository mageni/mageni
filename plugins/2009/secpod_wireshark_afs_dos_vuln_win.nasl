...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.900594");
  ...
  script_tag(name:"affected", value:"Wireshark version 0.9.2 through 1.2.0 on Windows");
...
if(version_in_range(version:sharkVer, test_version:"0.9.2", test_version2:"1.2.0")){
