...
#
# CentOS Update for ed CESA-2008:0946 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-October/015334.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305105");
  ...
  script_name( "CentOS Update for ed CESA-2008:0946 centos3 i386");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"ed", rpm:"ed~0.2~33.30E.1", rls:"CentOS3")) != NULL)
  {
