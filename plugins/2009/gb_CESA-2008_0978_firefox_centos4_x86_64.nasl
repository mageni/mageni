...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-November/015434.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307421");
  ...
  script_name( "CentOS Update for firefox CESA-2008:0978 centos4 x86_64");
