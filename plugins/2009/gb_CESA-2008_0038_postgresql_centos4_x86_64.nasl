...
#
# CentOS Update for postgresql CESA-2008:0038 centos4 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-January/014603.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308943");
  ...
  script_name( "CentOS Update for postgresql CESA-2008:0038 centos4 x86_64");
