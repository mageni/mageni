...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00802.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309868");
  ...
  script_xref(name: "FEDORA", value: "2008-11234");
  script_name( "Fedora Update for roundcubemail FEDORA-2008-11234");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.2~4.beta.fc9", rls:"FC9")) != NULL)
  {
