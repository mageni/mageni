...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c01087206-1");
  script_oid("1.3.6.1.4.1.25623.1.0.307609");
  ...
  script_name( "HP-UX Update for ARPA Transport HPSBUX02248");
...
if(release == "HPUX11.31")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"Networking.NET2-KRN", patch_list:['PHNE_35352'], rls:"HPUX11.31")) != NULL)
  {
...
if(release == "HPUX11.23")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"Networking.NET2-KRN", patch_list:['PHNE_35766'], rls:"HPUX11.23")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"Networking.NET2-KRN", patch_list:['PHNE_35351'], rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
