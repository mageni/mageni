...
tag_affected = "xfce4-places-plugin on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00559.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306170");
  ...
  script_name( "Fedora Update for xfce4-places-plugin FEDORA-2007-4368");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"xfce4-places-plugin", rpm:"xfce4-places-plugin~1.0.0~2.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xfce4-places-plugin-debuginfo", rpm:"xfce4-places-plugin-debuginfo~1.0.0~2.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
