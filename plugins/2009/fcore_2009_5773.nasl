...
# $Id: fcore_2009_5773.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305193");
 ...
 script_name("Fedora Core 10 FEDORA-2009-5773 (ocsinventory)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ocsinventory", rpm:"ocsinventory~1.02.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ocsinventory-reports", rpm:"ocsinventory-reports~1.02.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ocsinventory-server", rpm:"ocsinventory-server~1.02.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
