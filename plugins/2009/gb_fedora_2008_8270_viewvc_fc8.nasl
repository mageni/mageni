...
#
# Fedora Update for viewvc FEDORA-2008-8270
#
# Authors:
...
tag_affected = "viewvc on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01142.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311984");
  script_cve_id("CVE-2008-4325");
 script_tag(name:"cvss_base", value:"5.8");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
 script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:05:11 +0100 (Tue, 17 Feb 2009)");
  script_xref(name: "FEDORA", value: "2008-8270");
  script_name( "Fedora Update for viewvc FEDORA-2008-8270");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"viewvc", rpm:"viewvc~1.0.6~1.fc8", rls:"FC8")) != NULL)
  {
