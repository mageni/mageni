...
tag_insight = "Alfredo Ortega found a flaw in how Vinagre uses format strings.
...
tag_affected = "vinagre on Mandriva Linux 2008.1,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-12/msg00016.php");
  script_oid("1.3.6.1.4.1.25623.1.0.310356");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"vinagre", rpm:"vinagre~0.5.0~1.1mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
...
if(release == "MNDK_2009.0")
{
  ...
  if ((res = isrpmvuln(pkg:"vinagre", rpm:"vinagre~2.24.0~1.1mdv2009.0", rls:"MNDK_2009.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
