...
#
# Fedora Update for chmsee FEDORA-2008-11551
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01118.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305375");
  ...
  script_name( "Fedora Update for chmsee FEDORA-2008-11551");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.0~6.31.fc8", rls:"FC8")) != NULL)
  {
