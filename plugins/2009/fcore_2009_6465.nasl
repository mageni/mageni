...
# $Id: fcore_2009_6465.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-6465 (mutt)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-6465";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308279");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mutt", rpm:"mutt~1.5.19~5.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mutt-debuginfo", rpm:"mutt-debuginfo~1.5.19~5.fc11", rls:"FC11")) != NULL) {
    report += res;
}
