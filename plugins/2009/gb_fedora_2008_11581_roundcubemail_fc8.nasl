...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01021.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310854");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.2~5.beta.fc8", rls:"FC8")) != NULL)
  {
