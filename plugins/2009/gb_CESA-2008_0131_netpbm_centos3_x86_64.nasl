...
#
# CentOS Update for netpbm CESA-2008:0131 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-February/014719.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309367");
  ...
  script_name( "CentOS Update for netpbm CESA-2008:0131 centos3 x86_64");
