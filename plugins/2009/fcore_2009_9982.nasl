...
# $Id: fcore_2009_9982.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306765");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=518412");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"BackupPC", rpm:"BackupPC~3.1.0~7.fc11", rls:"FC11")) != NULL) {
    report += res;
}
