...
tag_insight = "A certificate validation error in GnuTLS might allow for spoofing attacks.";
tag_solution = "All GnuTLS users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=net-libs/gnutls-2.4.1-r2'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-10
http://bugs.gentoo.org/show_bug.cgi?id=245850";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305229");
