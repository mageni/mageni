...
# $Id: fcore_2009_8487.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-8487 (wordpress)
#
# Authors:
...
announced via advisory FEDORA-2009-8487.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310887");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.8.3~2.fc10", rls:"FC10")) != NULL) {
    report += res;
}
