...
tag_insight = "EKG (&quot;Eksperymentalny Klient Gadu-Gadu&quot;) is an open source gadu-gadu
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-July/msg00010.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306257");
  ...
  script_tag(name:"summary", value:"Check for the Version of ekg");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"ekg", rpm:"ekg~1.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ekg-debuginfo", rpm:"ekg-debuginfo~1.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
