...
# $Id: deb_1911_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "It was discovered that pygresql, a PostgreSQL module for Python, was
...
tag_summary = "The remote host is missing an update to pygresql
announced via advisory DSA 1911-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201911-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305980");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-pygresql", ver:"3.8.1-1etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-pygresql", ver:"3.8.1-3+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python-pygresql-dbg", ver:"3.8.1-3+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
