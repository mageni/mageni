...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2007-December/msg00009.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306063");
  ...
  script_name( "RedHat Update for autofs RHSA-2007:1128-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"autofs", rpm:"autofs~5.0.1~0.rc2.55.el5.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"autofs-debuginfo", rpm:"autofs-debuginfo~5.0.1~0.rc2.55.el5.1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
