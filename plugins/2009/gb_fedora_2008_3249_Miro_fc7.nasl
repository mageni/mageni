...
#
# Fedora Update for Miro FEDORA-2008-3249
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00436.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311709");
  ...
  script_name( "Fedora Update for Miro FEDORA-2008-3249");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"Miro", rpm:"Miro~1.2~2.fc7", rls:"FC7")) != NULL)
  {
