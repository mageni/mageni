...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2007-December/014544.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307746");
  ...
  script_name( "CentOS Update for libexif CESA-2007:1166 centos4 x86_64");
