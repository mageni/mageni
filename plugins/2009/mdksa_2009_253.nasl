...
# $Id: mdksa_2009_253.nasl 6587 2017-07-07 06:35:35Z cfischer $
# Description: Auto-generated from advisory MDVSA-2009:253 (backuppc)
#
# Authors:
...
tag_insight = "A vulnerability was discovered and corrected in backuppc:
...
https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:253";
tag_summary = "The remote host is missing an update to backuppc
announced via advisory MDVSA-2009:253.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307080");
 ...
 script_name("Mandrake Security Advisory MDVSA-2009:253 (backuppc)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"backuppc", rpm:"backuppc~3.1.0~7.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
