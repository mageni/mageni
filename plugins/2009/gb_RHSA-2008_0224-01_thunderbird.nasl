...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-April/msg00027.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305377");
  script_version("$Revision: 6683 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-12 11:41:57 +0200 (Wed, 12 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-03-06 07:30:35 +0100 (Fri, 06 Mar 2009)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "RHSA", value: "2008:0224-01");
  script_cve_id("CVE-2008-1380");
  script_name( "RedHat Update for thunderbird RHSA-2008:0224-01");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~1.5.0.12~11.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"thunderbird-debuginfo", rpm:"thunderbird-debuginfo~1.5.0.12~11.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
