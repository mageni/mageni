...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-December/015513.html");
  script_oid("1.3.6.1.4.1.25623.1.0.315146");
  ...
  script_name( "CentOS Update for finch CESA-2008:1023 centos4 x86_64");
