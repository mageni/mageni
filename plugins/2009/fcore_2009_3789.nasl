...
# $Id: fcore_2009_3789.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311719");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"prewikka", rpm:"prewikka~0.9.14~2.fc9", rls:"FC9")) != NULL) {
    report += res;
}
