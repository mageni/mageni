...
tag_affected = "viewvc on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00019.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305503");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"viewvc", rpm:"viewvc~1.0.5~1.fc7", rls:"FC7")) != NULL)
  {
