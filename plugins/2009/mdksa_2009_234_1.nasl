...
# $Id: mdksa_2009_234_1.nasl 6587 2017-07-07 06:35:35Z cfischer $
# Description: Auto-generated from advisory MDVSA-2009:234-1 (silc-toolkit)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:234-1";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311267");
 ...
 script_name("Mandrake Security Advisory MDVSA-2009:234-1 (silc-toolkit)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"libsilc1.1_2", rpm:"libsilc1.1_2~1.1.7~4.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libsilcclient1.1_2", rpm:"libsilcclient1.1_2~1.1.7~4.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"silc-toolkit", rpm:"silc-toolkit~1.1.7~4.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"silc-toolkit-devel", rpm:"silc-toolkit-devel~1.1.7~4.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"lib64silc1.1_2", rpm:"lib64silc1.1_2~1.1.7~4.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"lib64silcclient1.1_2", rpm:"lib64silcclient1.1_2~1.1.7~4.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
