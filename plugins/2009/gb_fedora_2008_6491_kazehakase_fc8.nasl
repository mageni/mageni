...
#
# Fedora Update for kazehakase FEDORA-2008-6491
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00689.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309809");
  ...
  script_name( "Fedora Update for kazehakase FEDORA-2008-6491");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"kazehakase", rpm:"kazehakase~0.5.4~2.fc8.3", rls:"FC8")) != NULL)
  {
