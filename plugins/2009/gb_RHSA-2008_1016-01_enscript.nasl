...
#
# RedHat Update for enscript RHSA-2008:1016-01
#
# Authors:
...
tag_affected = "enscript on Red Hat Enterprise Linux (v. 5 server)";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-December/msg00005.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305102");
  script_version("$Revision: 6683 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-12 11:41:57 +0200 (Wed, 12 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-03-06 07:30:35 +0100 (Fri, 06 Mar 2009)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "RHSA", value: "2008:1016-01");
  script_cve_id("CVE-2008-3863", "CVE-2008-4306");
  script_name( "RedHat Update for enscript RHSA-2008:1016-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"enscript", rpm:"enscript~1.6.4~4.1.1.el5_2", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"enscript-debuginfo", rpm:"enscript-debuginfo~1.6.4~4.1.1.el5_2", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
