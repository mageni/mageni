...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00689.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306866");
  ...
  script_name( "Fedora Update for kvm FEDORA-2008-10000");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"kvm", rpm:"kvm~74~6.fc10", rls:"FC10")) != NULL)
  {
