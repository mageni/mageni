...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.308731");
  ...
  script_name( "Solaris Update for Supplemental Encryption Kerberos V5 112240-13");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-112240-13-1");
...
if(solaris_check_patch(release:"5.8", arch:"i386", patch:"112240-13", package:"SUNWk5pu SUNWk5pk") < 0)
{
  security_message(0);
  exit(0);
}
