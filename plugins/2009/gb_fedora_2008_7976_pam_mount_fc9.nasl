...
#
# Fedora Update for pam_mount FEDORA-2008-7976
#
# Authors:
...
tag_affected = "pam_mount on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00729.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308185");
  ...
  script_name( "Fedora Update for pam_mount FEDORA-2008-7976");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"pam_mount", rpm:"pam_mount~0.47~1.fc9", rls:"FC9")) != NULL)
  {
