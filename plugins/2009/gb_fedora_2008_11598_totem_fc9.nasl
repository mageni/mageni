...
#
# Fedora Update for totem FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01069.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306980");
  ...
  script_name( "Fedora Update for totem FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"totem", rpm:"totem~2.23.2~9.fc9", rls:"FC9")) != NULL)
  {
