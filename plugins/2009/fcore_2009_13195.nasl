...
# $Id: fcore_2009_13195.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to merkaartor
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304444");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=544284");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"merkaartor", rpm:"merkaartor~0.14~2.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"merkaartor-debuginfo", rpm:"merkaartor-debuginfo~0.14~2.fc11", rls:"FC11")) != NULL) {
    report += res;
}
