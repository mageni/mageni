...
#
# Fedora Update for thunar-volman FEDORA-2007-4385
#
# Authors:
...
tag_affected = "thunar-volman on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00541.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308768");
  ...
  script_name( "Fedora Update for thunar-volman FEDORA-2007-4385");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"thunar-volman", rpm:"thunar-volman~0.2.0~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"thunar-volman-debuginfo", rpm:"thunar-volman-debuginfo~0.2.0~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
