...
# $Id: fcore_2009_8804.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to gupnp-igd
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306252");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"gupnp-igd", rpm:"gupnp-igd~0.1.3~3.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gupnp-igd-devel", rpm:"gupnp-igd-devel~0.1.3~3.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gupnp-igd-debuginfo", rpm:"gupnp-igd-debuginfo~0.1.3~3.fc11", rls:"FC11")) != NULL) {
    report += res;
}
