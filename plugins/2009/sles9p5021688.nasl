...
# $Id: sles9p5021688.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
5021688 within the SuSE Enterprise Server 9 patch
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.312076");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"php4-exif", rpm:"php4-exif~4.3.4~43.44", rls:"SLES9.0")) != NULL) {
    report += res;
}
