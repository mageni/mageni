...
#
# Fedora Update for epiphany FEDORA-2008-3283
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00490.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304691");
  ...
  script_name( "Fedora Update for epiphany FEDORA-2008-3283");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"epiphany", rpm:"epiphany~2.20.3~3.fc8", rls:"FC8")) != NULL)
  {
