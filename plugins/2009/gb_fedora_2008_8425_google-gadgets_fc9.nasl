...
#
# Fedora Update for google-gadgets FEDORA-2008-8425
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01346.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304620");
  ...
  script_name( "Fedora Update for google-gadgets FEDORA-2008-8425");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"google-gadgets", rpm:"google-gadgets~0.10.1~5.fc9", rls:"FC9")) != NULL)
  {
