...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015166.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306781");
  ...
  script_name( "CentOS Update for vsftpd CESA-2008:0579 centos3 x86_64");
