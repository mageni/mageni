...
# $Id: sles9p5021746.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
5021746 within the SuSE Enterprise Server 9 patch
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308990");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ethereal", rpm:"ethereal~0.10.13~2.4", rls:"SLES9.0")) != NULL) {
    report += res;
}
