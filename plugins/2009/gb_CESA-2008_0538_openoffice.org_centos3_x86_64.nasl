...
#
# CentOS Update for openoffice.org CESA-2008:0538 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/014978.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308319");
  ...
  script_name( "CentOS Update for openoffice.org CESA-2008:0538 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"openoffice.org", rpm:"openoffice.org~1.1.2~42.2.0.EL3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openoffice.org-i18n", rpm:"openoffice.org-i18n~1.1.2~42.2.0.EL3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openoffice.org-libs", rpm:"openoffice.org-libs~1.1.2~42.2.0.EL3", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
