...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01223.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311371");
  ...
  script_cve_id("CVE-2008-4539", "CVE-2008-2382", "CVE-2007-1320");
  script_name( "Fedora Update for kvm FEDORA-2008-11705");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"kvm", rpm:"kvm~65~15.fc9", rls:"FC9")) != NULL)
  {
