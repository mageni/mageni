...
tag_affected = "unzip on CentOS 3";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-March/014756.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309256");
  ...
  script_name( "CentOS Update for unzip CESA-2008:0196 centos3 i386");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"unzip", rpm:"unzip~5.50~36.EL3", rls:"CentOS3")) != NULL)
  {
