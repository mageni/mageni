...
# $Id: fcore_2009_0297.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311980");
 ...
 script_name("Fedora Core 9 FEDORA-2009-0297 (nfs-utils)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"nfs-utils", rpm:"nfs-utils~1.1.2~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"nfs-utils-debuginfo", rpm:"nfs-utils-debuginfo~1.1.2~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
