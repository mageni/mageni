...
# $Id: fcore_2009_0636.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"libnasl", rpm:"libnasl~2.2.11~3.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libnasl-devel", rpm:"libnasl-devel~2.2.11~3.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libnasl-doc", rpm:"libnasl-doc~2.2.11~3.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libnasl-debuginfo", rpm:"libnasl-debuginfo~2.2.11~3.fc9", rls:"FC9")) != NULL) {
    report += res;
}
