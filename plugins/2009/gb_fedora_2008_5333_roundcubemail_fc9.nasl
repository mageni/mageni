...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00625.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304439");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 16:50:22 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2008-5333");
  script_cve_id("CVE-2007-6321");
  script_name( "Fedora Update for roundcubemail FEDORA-2008-5333");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~0.2~0.alpha.fc9", rls:"FC9")) != NULL)
  {
