...
tag_affected = "balsa on Fedora 7";
tag_insight = "Balsa is a GNOME email client which supports mbox, maildir, and mh
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-August/msg00086.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308254");
  ...
  script_tag(name:"summary", value:"Check for the Version of balsa");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"balsa", rpm:"balsa~2.3.17~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"balsa-debuginfo", rpm:"balsa-debuginfo~2.3.17~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
