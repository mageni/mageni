...
#
# Fedora Update for galeon FEDORA-2008-3249
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00441.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309298");
  ...
  script_name( "Fedora Update for galeon FEDORA-2008-3249");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.3~17.fc7", rls:"FC7")) != NULL)
  {
