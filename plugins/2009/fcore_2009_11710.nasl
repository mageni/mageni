...
# $Id: fcore_2009_11710.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309041");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.8.6~2.fc12", rls:"FC12")) != NULL) {
    report += res;
}
