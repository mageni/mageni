...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00713.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310475");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:03:12 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2008-7936");
  script_cve_id("CVE-2008-3146", "CVE-2008-3932", "CVE-2008-3933", "CVE-2008-3934");
  script_name( "Fedora Update for wireshark FEDORA-2008-7936");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~1.0.3~1.fc9", rls:"FC9")) != NULL)
  {
