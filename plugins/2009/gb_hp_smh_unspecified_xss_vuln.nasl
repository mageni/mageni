...
if(description)
{
  ...
  script_name("HP/HPE System Management Homepage (SMH) Unspecified XSS Vulnerability (HPSBMA02428)");
  ...
  script_xref(name:"URL", value:"https://support.hpe.com/hpesc/public/docDisplay?docLocale=en_US&docId=emr_na-c01745065");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The HP/HPE SMH application fails to validate user supplied input.");

  script_tag(name:"solution", value:"Update to version 3.0.1.73 or later.");
  ...
  cookie-based authentication credentials and execute arbitrary script on the user's web browser by
  injecting web script or HTML vi remote vectors.");

  script_tag(name:"affected", value:"HP/HPE SMH prior to version 3.0.1.73 on all platforms.");
