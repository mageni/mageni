...
tag_insight = "Synce-serial is part of the SynCE project: <a  rel= &qt nofollow &qt  href= &qt http://www.synce.org &qt >http://www.synce.org</a>
...
tag_affected = "synce-serial on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00134.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312092");
  ...
  script_name( "Fedora Update for synce-serial FEDORA-2008-0680");

  script_tag(name:"summary", value:"Check for the Version of synce-serial");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"synce-serial", rpm:"synce-serial~0.11~1.fc8", rls:"FC8")) != NULL)
  {
