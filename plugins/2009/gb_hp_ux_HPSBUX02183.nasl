...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c00841370-2");
  script_oid("1.3.6.1.4.1.25623.1.0.310628");
  script_version("$Revision: 6584 $");
  script_cve_id("CVE-2007-2246");
  script_tag(name:"last_modification", value:"$Date: 2017-07-06 16:13:23 +0200 (Thu, 06 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-05-05 12:14:23 +0200 (Tue, 05 May 2009)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_xref(name: "HPSBUX", value: "02183");
  script_name( "HP-UX Update for sendmail HPSBUX02183");
...
if(release == "HPUX11.00")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"SMAIL-811.INETSVCS-SMAIL", patch_list:['PHNE_35484'], rls:"HPUX11.00")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = ishpuxpkgvuln(pkg:"InternetSrvcs.INETSVCS-RUN", patch_list:['PHNE_35484'], rls:"HPUX11.00")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"SMAIL-811.INETSVCS-SMAIL", patch_list:['PHNE_35484'], rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
