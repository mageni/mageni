...
tag_insight = "Multiple vulnerabilities in Pidgin might allow for the remote execution of
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200905-07
http://bugs.gentoo.org/show_bug.cgi?id=270811
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311634");
