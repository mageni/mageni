...
# $Id: mdksa_2009_215_1.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.312017");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"audacity", rpm:"audacity~1.3.3~1.3mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
