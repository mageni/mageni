...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00179.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309455");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"mediawiki", rpm:"mediawiki~1.13.2~41.fc9", rls:"FC9")) != NULL)
  {
