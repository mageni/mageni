...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00388.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308893");
  ...
  script_name( "Fedora Update for drupal FEDORA-2008-8852");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.5~1.fc9", rls:"FC9")) != NULL)
  {
