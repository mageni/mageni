...
tag_insight = "An untrusted search path vulnerability in the dstat might result in the
    execution of arbitrary code.";
tag_solution = "All dstat users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307357");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"sys-apps/dstat", unaffected: make_list("ge 0.6.9-r1"), vulnerable: make_list("lt 0.6.9-r1"))) != NULL) {
    report += res;
}
