...
# $Id: deb_1875_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "Josh Triplett discovered that the blacklist for potentially harmful TeX
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201875-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308579");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ikiwiki", ver:"2.53.4", rls:"DEB5.0")) != NULL) {
    report += res;
}
