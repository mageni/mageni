...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109994");
...
"gsf/Policy/WindowsGeneral/WindowsComponents/win_prevent_join_homegroup.nasl",
"gsf/Policy/WindowsGeneral/UserTemplates/win_share_files_profile.nasl");
...
Die Standard-Anforderung 'A8: Verwendung der Heimnetzgruppen-Funktion' beschreibt, dass Nutzer keine
Datei- und Druckerfreigaben anbieten, sowie Heimnetzgruppen nicht beitreten koennen sollten.");
...
title = "Verwendung der Heimnetzgruppen-Funktion";
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109450",
"1.3.6.1.4.1.25623.1.0.109524");

if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A8");
  exit(0);
}
