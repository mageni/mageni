...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109991");
...
Die Standard-Anforderung 'A5: Lokale Sicherheitsrichtlinien' beschreibt, dass alle sicherheitsrelevanten
Einstellungen mittels Sicherheitsrichtlinien konfiguriert werden sollten.");
...
if (host_runs("windows_8.1") != "yes"){
  ...
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A5");
  exit(0);
}
