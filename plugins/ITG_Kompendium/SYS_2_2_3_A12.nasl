...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109974");
...
"gsf/Policy/WindowsGeneral/NetworkAccess/win_na_shared_access_anonym.nasl");
...
Die Standard-Anforderung 'A12: Datei- und Freigabeberechtigungen' beschreibt, dass der Zugriff auf
Dateiern und Ordnern nach einem Berechtigungs- und Zugriffskonzept konfiguriert werden muss.");
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109227");
...
itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.3.A12");
