...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819969");
  ...
  script_tag(name:"creation_date", value:"2022-01-19 23:52:46 +0530 (Wed, 19 Jan 2022)");
  script_name("Oracle VirtualBox Security Update(Jan2022) - Mac OS X");
