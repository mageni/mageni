...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819971");
  ...
  script_tag(name:"creation_date", value:"2022-01-19 23:54:01 +0530 (Wed, 19 Jan 2022)");
  script_name("Oracle Java SE Security Update (jan2022) 02 - Linux");
