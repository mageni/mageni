...
if(description)
{
  ...
  script_version("2022-03-05T02:00:06+0000");
  ...
  script_name("Debian: Security Advisory for varnish (DSA-5088-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5088.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5088-1");
  ...
  package(s) announced via the DSA-5088-1 advisory.");
