...
if(description)
{
  ...
  script_version("2022-03-26T02:00:11+0000");
  ...
  script_name("Debian: Security Advisory for tiff (DSA-5108-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5108.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5108-1");
  ...
  package(s) announced via the DSA-5108-1 advisory.");
