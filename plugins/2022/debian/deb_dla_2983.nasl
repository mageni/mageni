...
if(description)
{
  ...
  script_version("2022-04-19T14:03:58+0000");
  ...
  script_name("Debian LTS: Security Advisory for abcm2ps (DLA-2983-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/04/msg00015.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2983-1");
  ...
  package(s) announced via the DLA-2983-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in abcm2ps: program which
...
attackers to cause a denial of service via unspecified vectors.");
  ...
  script_tag(name:"affected", value:"'abcm2ps' package(s) on Debian Linux.");
