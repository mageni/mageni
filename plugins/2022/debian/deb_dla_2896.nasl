...
if(description)
{
  ...
  script_version("2022-01-25T02:00:03+0000");
  ...
  script_name("Debian LTS: Security Advisory for ipython (DLA-2896-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00021.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2896-1");
  script_xref(name:"Advisory-ID", value:"DLA-2896-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1004122");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ipython'
  package(s) announced via the DLA-2896-1 advisory.");
