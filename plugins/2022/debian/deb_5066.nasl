...
if(description)
{
  ...
  script_version("2022-02-05T02:00:18+0000");
  ...
  script_name("Debian: Security Advisory for ruby2.5 (DSA-5066-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5066.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5066-1");
  ...
  package(s) announced via the DSA-5066-1 advisory.");
