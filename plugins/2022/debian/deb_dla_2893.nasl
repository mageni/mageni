...
if(description)
{
  ...
  script_version("2022-01-24T02:00:06+0000");
  ...
  script_name("Debian LTS: Security Advisory for pillow (DLA-2893-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00018.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2893-1");
  script_xref(name:"Advisory-ID", value:"DLA-2893-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pillow'
  package(s) announced via the DLA-2893-1 advisory.");
