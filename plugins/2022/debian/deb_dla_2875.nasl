...
if(description)
{
  ...
  script_version("2022-01-11T02:00:04+0000");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-01-11 02:00:04 +0000 (Tue, 11 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-11 02:00:04 +0000 (Tue, 11 Jan 2022)");
  script_name("Debian LTS: Security Advisory for clamav (DLA-2875-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00002.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2875-1");
  script_xref(name:"Advisory-ID", value:"DLA-2875-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav'
  package(s) announced via the DLA-2875-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Version 0.102 of ClamAV, an anti-virus toolkit, is end-of-life. ClamAV
