...
if(description)
{
  ...
  script_version("2022-05-18T05:50:21+0000");
  ...
  script_name("Debian LTS: Security Advisory for libxml2 (DLA-3012-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00023.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3012-1");
  script_xref(name:"Advisory-ID", value:"DLA-3012-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1010526");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2'
  package(s) announced via the DLA-3012-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Felix Wilhelm discovered that libxml2, the GNOME XML library, did not correctly
