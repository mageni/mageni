...
if(description)
{
  ...
  script_version("2022-02-11T02:00:20+0000");
  ...
  script_name("Debian LTS: Security Advisory for openjdk-8 (DLA-2917-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/02/msg00011.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2917-1");
  ...
  package(s) announced via the DLA-2917-1 advisory.");
