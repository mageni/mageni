...
if(description)
{
  ...
  script_version("2022-01-11T13:38:48+0000");
  ...
  script_name("Debian: Security Advisory for wordpress (DSA-5039-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5039.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5039-1");
  script_xref(name:"Advisory-ID", value:"DSA-5039-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the DSA-5039-1 advisory.");
