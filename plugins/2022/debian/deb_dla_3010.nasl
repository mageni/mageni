...
if(description)
{
  ...
  script_version("2022-05-18T05:50:11+0000");
  ...
  script_name("Debian LTS: Security Advisory for ffmpeg (DLA-3010-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00021.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3010-1");
  ...
  package(s) announced via the DLA-3010-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The ffmpeg project released the new version 3.2.18 with fixes for various
issues found by the OSS-Fuzz project.");

  script_tag(name:"affected", value:"'ffmpeg' package(s) on Debian Linux.");

  script_tag(name:"solution", value:"For Debian 9 stretch, this problem has been fixed in version 7:3.2.18-0+deb9u1.
