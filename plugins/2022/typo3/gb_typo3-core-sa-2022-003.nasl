...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148271");
  script_version("2022-06-15T04:39:05+0000");
  script_tag(name:"last_modification", value:"2022-06-15 10:13:29 +0000 (Wed, 15 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-06-15 04:12:27 +0000 (Wed, 15 Jun 2022)");
  script_tag(name:"cvss_base", value:"5.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:N");

  script_cve_id("CVE-2022-31048");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("TYPO3 XSS Vulnerability (TYPO3-CORE-SA-2022-003)");
  ...
  script_tag(name:"insight", value:"It has been discovered that the Form Designer backend module of
  the Form Framework is vulnerable to cross-site scripting. A valid backend user account with
  access to the form module is needed to exploit this vulnerability.");

  script_tag(name:"affected", value:"TYPO3 version 8.0.0 through 8.7.46 ELTS, 9.0.0 through 9.5.34
  ELTS, 10.0.0 through 10.4.28 and 11.0.0 through 11.5.10.");

  script_tag(name:"solution", value:"Update to version 8.7.47 ELTS, 9.5.35 ELTS, 10.4.29, 11.5.11
  or later.");

  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-003");
