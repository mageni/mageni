...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148250");
  script_version("2022-06-10T04:18:16+0000");
  script_tag(name:"last_modification", value:"2022-06-10 10:05:32 +0000 (Fri, 10 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-06-10 04:16:52 +0000 (Fri, 10 Jun 2022)");
  ...
  script_name("PHP < 7.4.30, 8.0.x < 8.0.20, 8.1.x < 8.1.7 Security Update (Jun 2022) - Windows");
