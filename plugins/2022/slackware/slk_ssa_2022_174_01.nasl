...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2022.174.01");
  script_cve_id("CVE-2022-1292", "CVE-2022-2068");
  script_tag(name:"creation_date", value:"2022-06-23 12:20:26 +0000 (Thu, 23 Jun 2022)");
  script_version("2022-06-23T12:20:26+0000");
  script_tag(name:"last_modification", value:"2022-06-23 12:20:26 +0000 (Thu, 23 Jun 2022)");
  ...
  script_name("Slackware: Security Advisory (SSA:2022-174-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2022-174-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2022&m=slackware-security.667480");
  script_xref(name:"URL", value:"https://www.openssl.org/news/secadv/20220621.txt");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the SSA:2022-174-01 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"New openssl packages are available for Slackware 14.0, 14.1, 14.2, 15.0,
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Slackware 14.0, Slackware 14.1, Slackware 14.2, Slackware 15.0, Slackware current.");
...
if(!isnull(res = isslkpkgvuln(pkg:"openssl", ver:"1.1.1p-i586-1_slack15.0", rls:"SLK15.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"openssl", ver:"1.1.1p-x86_64-1_slack15.0", rls:"SLK15.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"openssl-solibs", ver:"1.1.1p-i586-1_slack15.0", rls:"SLK15.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"openssl-solibs", ver:"1.1.1p-x86_64-1_slack15.0", rls:"SLK15.0"))) {
  report += res;
}
