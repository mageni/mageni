...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2018.339.02");
  ...
  script_name("Slackware: Security Advisory (SSA:2018-339-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2018-339-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2018&m=slackware-security.361295");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nettle' package(s) announced via the SSA:2018-339-02 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"New nettle packages are available for Slackware 14.2 and -current to
fix security issues.
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'nettle' package(s) on Slackware 14.2, Slackware current.");
...
if(!isnull(res = isslkpkgvuln(pkg:"nettle", ver:"3.4.1-i586-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"nettle", ver:"3.4.1-x86_64-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
