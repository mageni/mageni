...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2014.044.02");
  ...
  script_name("Slackware: Security Advisory (SSA:2014-044-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2014-044-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2014&m=slackware-security.575205");
  script_xref(name:"URL", value:"http://www.kb.cert.org/vuls/id/348126");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the SSA:2014-044-02 advisory.");
...
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-i486-1_slack13.0", rls:"SLK13.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-x86_64-1_slack13.0", rls:"SLK13.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-i486-1_slack13.1", rls:"SLK13.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-x86_64-1_slack13.1", rls:"SLK13.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-i486-1_slack13.37", rls:"SLK13.37"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-x86_64-1_slack13.37", rls:"SLK13.37"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-i486-3_slack14.0", rls:"SLK14.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-x86_64-3_slack14.0", rls:"SLK14.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-i486-5_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"ntp", ver:"4.2.6p5-x86_64-5_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
