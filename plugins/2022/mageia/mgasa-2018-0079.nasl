...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode, microcode' package(s) announced via the MGASA-2018-0079 advisory.");
...
firmwares from your hardware vendor.");
  ...
  script_tag(name:"affected", value:"'microcode, microcode' package(s) on Mageia 5, Mageia 6.");
