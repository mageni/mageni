...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python, python' package(s) announced via the MGASA-2013-0250 advisory.");
...
pip and virtualenv has been fixed in Mageia 3 (mga#10102).");
  ...
  script_tag(name:"affected", value:"'python, python' package(s) on Mageia 2, Mageia 3.");
