...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'jhead, jhead' package(s) announced via the MGASA-2021-0328 advisory.");
...
in exif.c when processing a crafted file (CVE-2021-3496).");
  ...
  script_tag(name:"affected", value:"'jhead, jhead' package(s) on Mageia 7, Mageia 8.");
