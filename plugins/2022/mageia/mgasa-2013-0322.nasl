...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.7.0-openjdk, java-1.7.0-openjdk' package(s) announced via the MGASA-2013-0322 advisory.");
...
The Java Heap ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'java-1.7.0-openjdk, java-1.7.0-openjdk' package(s) on Mageia 2, Mageia 3.");
