...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django, python-django' package(s) announced via the MGASA-2013-0256 advisory.");
...
(CVE-2013-4249).");
  ...
  script_tag(name:"affected", value:"'python-django, python-django' package(s) on Mageia 2, Mageia 3.");
