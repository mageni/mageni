...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-scipy, python-scipy' package(s) announced via the MGASA-2013-0330 advisory.");
...
The update also adds some missing dependencies.");
  ...
  script_tag(name:"affected", value:"'python-scipy, python-scipy' package(s) on Mageia 2, Mageia 3.");
