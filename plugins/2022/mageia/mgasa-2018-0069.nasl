...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2018.0069");
  ...
  script_name("Mageia: Security Advisory (MGASA-2018-0069)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2018-0069");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2018-0069.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=22328");
  script_xref(name:"URL", value:"https://usn.ubuntu.com/usn/usn-3527-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'irssi, irssi' package(s) announced via the MGASA-2018-0069 advisory.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"irssi", rpm:"irssi~0.8.21~1.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"irssi-devel", rpm:"irssi-devel~0.8.21~1.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"irssi-perl", rpm:"irssi-perl~0.8.21~1.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"irssi", rpm:"irssi~1.0.6~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"irssi-devel", rpm:"irssi-devel~1.0.6~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"irssi-perl", rpm:"irssi-perl~1.0.6~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
