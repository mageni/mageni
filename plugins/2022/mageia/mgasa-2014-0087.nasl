...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-12 17:09:00 +0000 (Wed, 12 Feb 2020)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'imagemagick, imagemagick' package(s) announced via the MGASA-2014-0087 advisory.");
...
the input data has a large number of unlabeled layers (CVE-2014-2030).");
  ...
  script_tag(name:"affected", value:"'imagemagick, imagemagick' package(s) on Mageia 3, Mageia 4.");
