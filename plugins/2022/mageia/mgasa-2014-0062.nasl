...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openldap, openldap' package(s) announced via the MGASA-2014-0062 advisory.");
...
sending a search request (CVE-2013-4449).");
  ...
  script_tag(name:"affected", value:"'openldap, openldap' package(s) on Mageia 3, Mageia 4.");
