...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nvidia390, nvidia390' package(s) announced via the MGASA-2021-0202 advisory.");
...
kernels.");
  ...
  script_tag(name:"affected", value:"'nvidia390, nvidia390' package(s) on Mageia 7, Mageia 8.");
