...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2013-08-30 00:46:00 +0000 (Fri, 30 Aug 2013)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libdigidoc, libdigidoc' package(s) announced via the MGASA-2013-0268 advisory.");
...
of the victim (CVE-2013-5648).");
  ...
  script_tag(name:"affected", value:"'libdigidoc, libdigidoc' package(s) on Mageia 2, Mageia 3.");
