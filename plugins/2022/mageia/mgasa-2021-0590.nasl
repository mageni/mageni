...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2021-0590");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2021-0590.html");
  ...
  script_tag(name:"insight", value:"CryptSym: fix AES output IV (CVE-2021-3505).
...
Marshal event sequence objects' hash state");
  ...
  script_tag(name:"affected", value:"'libtpms, swtpm' package(s) on Mageia 8.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64tpms-devel", rpm:"lib64tpms-devel~0.9.1~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64tpms0", rpm:"lib64tpms0~0.9.1~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64wtpm_libtpms-devel", rpm:"lib64wtpm_libtpms-devel~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64wtpm_libtpms0", rpm:"lib64wtpm_libtpms0~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtpms", rpm:"libtpms~0.9.1~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtpms-devel", rpm:"libtpms-devel~0.9.1~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtpms0", rpm:"libtpms0~0.9.1~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libwtpm_libtpms-devel", rpm:"libwtpm_libtpms-devel~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libwtpm_libtpms0", rpm:"libwtpm_libtpms0~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"swtpm", rpm:"swtpm~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"swtpm-tools", rpm:"swtpm-tools~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"swtpm-tools-pkcs11", rpm:"swtpm-tools-pkcs11~0.7.0~5.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
