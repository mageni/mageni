...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-24 14:27:00 +0000 (Wed, 24 Apr 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'imagemagick, imagemagick, libheif' package(s) announced via the MGASA-2019-0290 advisory.");
...
Also, imagemagick has been updated to 7.0.8.62 to fix various bugs.");
  ...
  script_tag(name:"affected", value:"'imagemagick, imagemagick, libheif' package(s) on Mageia 7.");
