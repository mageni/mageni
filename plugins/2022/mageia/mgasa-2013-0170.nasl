...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-11-08 14:38:00 +0000 (Tue, 08 Nov 2016)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'telepathy-gabble, telepathy-gabble' package(s) announced via the MGASA-2013-0170 advisory.");
...
bypass TLS verification and perform a man-in-the-middle attack.");
  ...
  script_tag(name:"affected", value:"'telepathy-gabble, telepathy-gabble' package(s) on Mageia 2, Mageia 3.");
