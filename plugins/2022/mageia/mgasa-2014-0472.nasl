...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby, ruby' package(s) announced via the MGASA-2014-0472 advisory.");
...
machine, causing a denial of service (CVE-2014-8090).");
  ...
  script_tag(name:"affected", value:"'ruby, ruby' package(s) on Mageia 3, Mageia 4.");
