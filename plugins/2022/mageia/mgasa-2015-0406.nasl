...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2015.0406");
  ...
  script_name("Mageia: Security Advisory (MGASA-2015-0406)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2015-0406");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0406.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=16872");
  script_xref(name:"URL", value:"http://lwn.net/Alerts/658923/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fuseiso' package(s) announced via the MGASA-2015-0406 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An integer overflow, leading to a heap-based buffer overflow flaw was
...
gets exceeded.");
  ...
  script_tag(name:"affected", value:"'fuseiso' package(s) on Mageia 5.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fuseiso", rpm:"fuseiso~20070708~11.1.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
