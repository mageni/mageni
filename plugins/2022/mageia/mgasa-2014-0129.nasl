...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'udisks, udisks, udisks2, udisks2' package(s) announced via the MGASA-2014-0129 advisory.");
...
privileges of the udisks daemon (root) (CVE-2014-0004).");
  ...
  script_tag(name:"affected", value:"'udisks, udisks, udisks2, udisks2' package(s) on Mageia 3, Mageia 4.");
