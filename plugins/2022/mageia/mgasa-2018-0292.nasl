...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnupg, gnupg, gnupg2, gnupg2, python-gnupg, python-gnupg' package(s) announced via the MGASA-2018-0292 advisory.");
...
of the cryptographic operation reported by GnuPG (CVE-2018-12020).");
  ...
  script_tag(name:"affected", value:"'gnupg, gnupg, gnupg2, gnupg2, python-gnupg, python-gnupg' package(s) on Mageia 5, Mageia 6.");
