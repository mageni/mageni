...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-06-17 01:59:00 +0000 (Fri, 17 Jun 2016)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl, curl' package(s) announced via the MGASA-2013-0338 advisory.");
...
(CVE-2013-4545).");
  ...
  script_tag(name:"affected", value:"'curl, curl' package(s) on Mageia 2, Mageia 3.");
