...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Authen-Captcha, perl-Authen-Captcha' package(s) announced via the MGASA-2014-0167 advisory.");
...
random filename for the captcha.");
  ...
  script_tag(name:"affected", value:"'perl-Authen-Captcha, perl-Authen-Captcha' package(s) on Mageia 3, Mageia 4.");
