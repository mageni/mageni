...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-23 01:29:00 +0000 (Tue, 23 May 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat, tomcat' package(s) announced via the MGASA-2013-0191 advisory.");
...
the requests that it processes (CVE-2013-2071).");
  ...
  script_tag(name:"affected", value:"'tomcat, tomcat' package(s) on Mageia 2, Mageia 3.");
