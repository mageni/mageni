...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2013.0227");
  ...
  script_name("Mageia: Security Advisory (MGASA-2013-0227)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2013-0227");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2013-0227.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the MGASA-2013-0227 advisory.");
...
(CVE-2013-4115).");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on Mageia 2.");
...
if(release == "MAGEIA2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~3.1.19~4.4.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~3.1.19~4.4.mga2", rls:"MAGEIA2"))) {
    report += res;
  }
