...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-DBD-mysql, perl-DBD-mysql' package(s) announced via the MGASA-2018-0283 advisory.");
