...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-08-09 16:14:00 +0000 (Thu, 09 Aug 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox, firefox-l10n, firefox-l10n, nspr, nspr, nss, nss' package(s) announced via the MGASA-2017-0361 advisory.");
...
CVE-2017-7819, CVE-2017-7824, CVE-2017-7814, CVE-2017-7823).");
  ...
  script_tag(name:"affected", value:"'firefox, firefox, firefox-l10n, firefox-l10n, nspr, nspr, nss, nss' package(s) on Mageia 5, Mageia 6.");
