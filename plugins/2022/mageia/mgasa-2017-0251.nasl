...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'atril, atril' package(s) announced via the MGASA-2017-0251 advisory.");
...
entirely (CVE-2017-1000083).");
  ...
  script_tag(name:"affected", value:"'atril, atril' package(s) on Mageia 5, Mageia 6.");
