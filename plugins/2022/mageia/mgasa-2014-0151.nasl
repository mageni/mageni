...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-ZendFramework, php-ZendFramework' package(s) announced via the MGASA-2014-0151 advisory.");
