...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'vlc, vlc, vlc, vlc' package(s) announced via the MGASA-2021-0227 advisory.");
...
We updated VLC to latest version available.");
  ...
  script_tag(name:"affected", value:"'vlc, vlc, vlc, vlc' package(s) on Mageia 7, Mageia 8.");
