...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mad, mad' package(s) announced via the MGASA-2018-0019 advisory.");
...
and application crash) via a crafted audio file (CVE-2017-8374).");
  ...
  script_tag(name:"affected", value:"'mad, mad' package(s) on Mageia 5, Mageia 6.");
