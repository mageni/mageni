...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-11-17 17:38:00 +0000 (Mon, 17 Nov 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mumble, mumble' package(s) announced via the MGASA-2014-0245 advisory.");
...
(CVE-2014-3756).");
  ...
  script_tag(name:"affected", value:"'mumble, mumble' package(s) on Mageia 3, Mageia 4.");
