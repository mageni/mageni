...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-02-02 18:44:00 +0000 (Tue, 02 Feb 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5, krb5' package(s) announced via the MGASA-2013-0161 advisory.");
...
ping-pong attack (CVE-2002-2443).");
  ...
  script_tag(name:"affected", value:"'krb5, krb5' package(s) on Mageia 2, Mageia 3.");
