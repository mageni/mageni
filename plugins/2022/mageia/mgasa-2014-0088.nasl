...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'freeradius, freeradius' package(s) announced via the MGASA-2014-0088 advisory.");
...
unusually long hashed password (CVE-2014-2015).");
  ...
  script_tag(name:"affected", value:"'freeradius, freeradius' package(s) on Mageia 3, Mageia 4.");
