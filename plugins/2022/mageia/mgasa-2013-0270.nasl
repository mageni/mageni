...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail, roundcubemail' package(s) announced via the MGASA-2013-0270 advisory.");
