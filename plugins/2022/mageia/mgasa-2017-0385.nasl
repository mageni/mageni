...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'recode, recode' package(s) announced via the MGASA-2017-0385 advisory.");
...
(rhbz#1422545).");
  ...
  script_tag(name:"affected", value:"'recode, recode' package(s) on Mageia 5, Mageia 6.");
