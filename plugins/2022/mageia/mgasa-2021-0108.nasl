...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'compat-openssl10, openssl, openssl' package(s) announced via the MGASA-2021-0108 advisory.");
...
crash, resulting in a denial of service (CVE-2021-23841).");
  ...
  script_tag(name:"affected", value:"'compat-openssl10, openssl, openssl' package(s) on Mageia 7, Mageia 8.");
