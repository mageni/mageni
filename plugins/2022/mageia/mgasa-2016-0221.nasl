...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mad, vlc, vlc' package(s) announced via the MGASA-2016-0221 advisory.");
...
an invalid mp3 file.");
  ...
  script_tag(name:"affected", value:"'mad, vlc, vlc' package(s) on Mageia 5.");
