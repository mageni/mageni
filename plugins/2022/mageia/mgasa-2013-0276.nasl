...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mediawiki, mediawiki' package(s) announced via the MGASA-2013-0276 advisory.");
...
Internet Explorer (CVE-2013-4303).");
  ...
  script_tag(name:"affected", value:"'mediawiki, mediawiki' package(s) on Mageia 2, Mageia 3.");
