...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2019.0158");
  script_cve_id("CVE-2019-8376", "CVE-2019-8377", "CVE-2019-8381");
  ...
  script_tag(name:"severity_date", value:"2019-03-30 01:29:00 +0000 (Sat, 30 Mar 2019)");

  script_name("Mageia: Security Advisory (MGASA-2019-0158)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2019-0158");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2019-0158.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=24581");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/thread/4V3SADKXUSHWTVAPU3WLXBDEQUHRA6ZO/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay' package(s) announced via the MGASA-2019-0158 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Updated tcpreplay package fixes security vulnerabilities:
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.3.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
