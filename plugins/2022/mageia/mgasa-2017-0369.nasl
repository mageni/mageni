...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'weechat, weechat' package(s) announced via the MGASA-2017-0369 advisory.");
...
is not initialized (CVE-2017-14727).");
  ...
  script_tag(name:"affected", value:"'weechat, weechat' package(s) on Mageia 5, Mageia 6.");
