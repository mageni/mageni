...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmspack, libmspack' package(s) announced via the MGASA-2017-0283 advisory.");
...
resulting in a denial of service (CVE-2017-11423).");
  ...
  script_tag(name:"affected", value:"'libmspack, libmspack' package(s) on Mageia 5, Mageia 6.");
