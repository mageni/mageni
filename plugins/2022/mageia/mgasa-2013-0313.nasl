...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-11-16 20:47:00 +0000 (Mon, 16 Nov 2020)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-mod_fcgid, apache-mod_fcgid' package(s) announced via the MGASA-2013-0313 advisory.");
...
allowing the execution of arbitrary code (CVE-2013-4365).");
  ...
  script_tag(name:"affected", value:"'apache-mod_fcgid, apache-mod_fcgid' package(s) on Mageia 2, Mageia 3.");
