...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0503");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0503)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0503");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0503.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=14673");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144951.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpdump' package(s) announced via the MGASA-2014-0503 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The Tcpdump program could crash when processing a malformed OLSR payload
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpdump", rpm:"tcpdump~4.4.0~2.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
