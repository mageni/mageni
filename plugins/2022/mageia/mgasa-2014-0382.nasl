...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'flash-player-plugin, flash-player-plugin' package(s) announced via the MGASA-2014-0382 advisory.");
