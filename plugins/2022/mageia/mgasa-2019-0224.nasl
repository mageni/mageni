...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb, mariadb' package(s) announced via the MGASA-2019-0224 advisory.");
...
tables, Indexed virtual columns, Recovery & Mariabackup.");
  ...
  script_tag(name:"affected", value:"'mariadb, mariadb' package(s) on Mageia 6, Mageia 7.");
