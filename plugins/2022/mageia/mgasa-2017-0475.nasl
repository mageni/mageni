...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2017.0475");
  ...
  script_name("Mageia: Security Advisory (MGASA-2017-0475)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2017-0475");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2017-0475.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=21448");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'freerdp' package(s) announced via the MGASA-2017-0475 advisory.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freerdp", rpm:"freerdp~1.0.2~5.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64freerdp-devel", rpm:"lib64freerdp-devel~1.0.2~5.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64freerdp1", rpm:"lib64freerdp1~1.0.2~5.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfreerdp-devel", rpm:"libfreerdp-devel~1.0.2~5.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfreerdp1", rpm:"libfreerdp1~1.0.2~5.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
