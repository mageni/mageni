...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'fontforge, fontforge' package(s) announced via the MGASA-2018-0037 advisory.");
...
CVE-2017-11574, CVE-2017-11575, CVE-2017-11576, CVE-2017-11577).");
  ...
  script_tag(name:"affected", value:"'fontforge, fontforge' package(s) on Mageia 5, Mageia 6.");
