...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2015.0063");
  ...
  script_name("Mageia: Security Advisory (MGASA-2015-0063)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2015-0063");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0063.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=15214");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the MGASA-2015-0063 advisory.");
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.6p5~15.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-client", rpm:"ntp-client~4.2.6p5~15.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.6p5~15.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
