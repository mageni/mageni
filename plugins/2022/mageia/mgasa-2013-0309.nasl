...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libtar, libtar' package(s) announced via the MGASA-2013-0309 advisory.");
...
libtar to crash or, potentially, execute arbitrary code (CVE-2013-4397).");
  ...
  script_tag(name:"affected", value:"'libtar, libtar' package(s) on Mageia 2, Mageia 3.");
