...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-07-07 14:49:00 +0000 (Mon, 07 Jul 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'iodine, iodine' package(s) announced via the MGASA-2014-0277 advisory.");
...
traffic by exploiting this flaw (CVE-2014-4168).");
  ...
  script_tag(name:"affected", value:"'iodine, iodine' package(s) on Mageia 3, Mageia 4.");
