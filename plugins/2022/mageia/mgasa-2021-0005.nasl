...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'vlc, vlc' package(s) announced via the MGASA-2021-0005 advisory.");
...
See the upstream NEWS file for details.");
  ...
  script_tag(name:"affected", value:"'vlc, vlc' package(s) on Mageia 7.");
