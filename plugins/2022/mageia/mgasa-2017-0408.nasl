...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'jackson-databind, jackson-databind' package(s) announced via the MGASA-2017-0408 advisory.");
