...
if(description)
{
  ...
  script_tag(name:"insight", value:"Directory traversal vulnerability in the minitar before 0.6 and
...
make minitar work.");
  ...
  script_tag(name:"affected", value:"'ruby-archive-tar-minitar' package(s) on Mageia 5.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby-archive-tar-minitar", rpm:"ruby-archive-tar-minitar~0.5.2~14.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ruby-archive-tar-minitar-doc", rpm:"ruby-archive-tar-minitar-doc~0.5.2~14.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
