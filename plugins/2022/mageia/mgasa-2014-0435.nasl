...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mythtv, mythtv, mythtv, mythtv, mythtv-mythweb, mythtv-mythweb' package(s) announced via the MGASA-2014-0435 advisory.");
...
service for continued operation going forward.");
  ...
  script_tag(name:"affected", value:"'mythtv, mythtv, mythtv, mythtv, mythtv-mythweb, mythtv-mythweb' package(s) on Mageia 3, Mageia 4.");
