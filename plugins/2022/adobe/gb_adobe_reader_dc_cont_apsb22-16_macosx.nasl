...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821203");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 16:58:06 +0530 (Fri, 29 Apr 2022)");
  script_name("Adobe Reader DC Continuous Security Update (APSB22-16) - Mac OS X");
