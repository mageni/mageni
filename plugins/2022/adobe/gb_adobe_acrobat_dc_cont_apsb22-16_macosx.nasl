...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820097");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 17:45:43 +0530 (Fri, 29 Apr 2022)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB22-16) - Mac OS X");
  ...
  22.001.20085 and earlier on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Acrobat DC (Continuous)
  to version 2022.001.20112 or later.");
...
if(version_is_less(version:vers, test_version:"22.001.20112"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2022.001.20112", install_path:path);
