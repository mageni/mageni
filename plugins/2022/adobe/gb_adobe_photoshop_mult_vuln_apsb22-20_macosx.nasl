...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820094");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 13:14:46 +0530 (Fri, 29 Apr 2022)");
  script_name("Adobe Photoshop Multiple Vulnerabilities (APSB22-20) - Mac OS X");
