...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819942");
  ...
  script_tag(name:"creation_date", value:"2022-01-13 18:48:29 +0530 (Thu, 13 Jan 2022)");
  script_name("Adobe Reader DC Continuous Security Update (APSB22-01) - Mac OS X");
