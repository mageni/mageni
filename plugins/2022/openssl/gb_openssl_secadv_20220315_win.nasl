...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147808");
  script_version("2022-03-16T03:03:40+0000");
  script_tag(name:"last_modification", value:"2022-03-16 03:03:40 +0000 (Wed, 16 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-16 03:03:00 +0000 (Wed, 16 Mar 2022)");
  ...
  script_name("OpenSSL: Infinite loop in BN_mod_sqrt() reachable when parsing certificates (CVE-2022-0778) - Windows");
  ...
  script_tag(name:"summary", value:"OpenSSL is prone to an infinite loop vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The BN_mod_sqrt() function, which computes a modular square
  ...
  script_tag(name:"solution", value:"Update to version 1.0.2zd, 1.1.1n, 3.0.2 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "1.0.2", test_version_up: "1.0.2zd")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.0.2zd", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "1.1.0", test_version_up: "1.1.1n")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.1.1n", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "3.0.0", test_version_up: "3.0.2")) {
