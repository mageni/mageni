...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147539");
  script_version("2022-01-31T04:35:24+0000");
  script_tag(name:"last_modification", value:"2022-01-31 10:37:41 +0000 (Mon, 31 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-31 04:07:23 +0000 (Mon, 31 Jan 2022)");
  ...
  script_name("MariaDB DoS Vulnerability (MDEV-25629) - Linux");
  ...
  script_tag(name:"affected", value:"MariaDB versions 5.5.x through 10.6.x.");

  script_tag(name:"solution", value:"Update to version 10.2.39, 10.3.30, 10.4.20, 10.5.11,
  10.6.2 or later.");
...
if (version_in_range(version: version, test_version: "5.5.0", test_version2: "10.2.38")) {
