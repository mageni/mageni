...
if (description)
{
  ...
  script_name("MariaDB DoS Vulnerability (MDEV-25631) - Linux");
  ...
  script_tag(name:"affected", value:"MariaDB versions 5.5.x through 10.7.x.");
...
if (version_in_range(version: version, test_version: "5.5.0", test_version2: "10.2.41")) {
