...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147520");
  script_version("2022-01-27T11:21:53+0000");
  script_tag(name:"last_modification", value:"2022-01-27 13:28:49 +0000 (Thu, 27 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-27 02:01:26 +0000 (Thu, 27 Jan 2022)");
  ...
  script_name("phpMyAdmin 4.9.x < 4.9.8, 5.1.x < 5.1.2 2FA Bypass Vulnerability (PMASA-2022-1) - Windows");
