...
if( description )
{
  script_oid("1.3.6.1.4.1.25623.1.0.147846");
  script_version("2022-03-25T02:44:39+0000");
  script_tag(name:"last_modification", value:"2022-03-25 11:41:51 +0000 (Fri, 25 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-25 02:39:48 +0000 (Fri, 25 Mar 2022)");
  ...
  script_name("elFinder < 2.1.61 Multiple Vulnerabilities");
  ...
  - CVE-2022-26960: Directory traversal in connector.minimal.php

  - Filename bypass leading to remote code execution (RCE) on Windows server");
...
if (version_is_less(version: version, test_version: "2.1.61")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.1.61", install_path: location);
