...
if(description)
{
  ...
  script_name("Discourse < 2.7.13 Information Disclosure Vulnerability");
  ...
  script_tag(name:"affected", value:"Discourse prior to version 2.7.13.");

  script_tag(name:"solution", value:"Update to version 2.7.13 or later.");
