...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819948");
  ...
  script_tag(name:"creation_date", value:"2022-01-14 11:29:22 +0530 (Fri, 14 Jan 2022)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2022-01)-Mac OS X");
