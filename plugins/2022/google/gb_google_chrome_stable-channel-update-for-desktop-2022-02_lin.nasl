...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819979");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2022-02)-Linux");
  ...
  to execute arbitrary code, disclose sensitive information and cause
  ...
  98.0.4758.80 or later. Please see the references for more information.");
