...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819914");
  ...
  script_name("Microsoft Office 2013 Remote Code Execution Vulnerability (KB5002124)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002124");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002124");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    {
      if(version_is_less(version:msdllVer, test_version:"15.0.5415.1001"))
      {
        report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                   file_version:msdllVer, vulnerable_range:"15.0 - 15.0.5415.1000");
