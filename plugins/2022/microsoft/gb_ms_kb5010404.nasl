...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818968");
  script_version("2022-02-09T15:13:32+0000");
  script_cve_id("CVE-2022-21981", "CVE-2022-21985", "CVE-2022-21989", "CVE-2022-21997",
                "CVE-2022-21998", "CVE-2022-21999", "CVE-2022-22000", "CVE-2022-22710",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5010404)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5010404");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5010404");
...
if(version_is_less(version:fileVer, test_version:"6.1.7601.25860"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"Less than 6.1.7601.25860");
