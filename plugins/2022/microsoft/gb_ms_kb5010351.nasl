...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818966");
  script_version("2022-02-09T15:13:32+0000");
  script_cve_id("CVE-2022-21971", "CVE-2022-21974", "CVE-2022-21981", "CVE-2022-21985",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5010351)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5010351");
  ...
  to elevate privileges, disclose sensitive information, conduct code execution,
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5010351");
...
if(version_in_range(version:fileVer, test_version:"10.0.17763.0", test_version2:"10.0.17763.2564"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.17763.0 - 10.0.17763.2564");
