...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820071");
  ...
  script_name("Microsoft Excel 2013 RCE Vulnerability (KB5002175)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5002175");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002175");
...
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.0.5441.999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"15.0 - 15.0.5441.999");
