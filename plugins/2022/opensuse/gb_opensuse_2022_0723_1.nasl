...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854539");
  ...
  script_tag(name:"creation_date", value:"2022-03-05 02:02:09 +0000 (Sat, 05 Mar 2022)");
  script_name("openSUSE: Security Advisory for go1.17 (openSUSE-SU-2022:0723-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:0723-1");
  ...
  package(s) announced via the openSUSE-SU-2022:0723-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.17", rpm:"go1.17~1.17.7~1.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.17-doc", rpm:"go1.17-doc~1.17.7~1.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.17-race", rpm:"go1.17-race~1.17.7~1.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.17", rpm:"go1.17~1.17.7~1.20.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.17-doc", rpm:"go1.17-doc~1.17.7~1.20.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.17-race", rpm:"go1.17-race~1.17.7~1.20.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
