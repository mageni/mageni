...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854653");
  ...
  script_tag(name:"creation_date", value:"2022-05-17 12:07:29 +0000 (Tue, 17 May 2022)");
  script_name("openSUSE: Security Advisory for buildah (SUSE-SU-2022:1437-1)");
  ...
  package(s) announced via the SUSE-SU-2022:1437-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.25.1~150300.8.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
