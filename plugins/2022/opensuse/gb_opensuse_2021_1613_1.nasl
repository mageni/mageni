...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854382");
  ...
  script_tag(name:"creation_date", value:"2022-02-01 06:34:14 +0000 (Tue, 01 Feb 2022)");
  script_name("openSUSE: Security Advisory for logback (openSUSE-SU-2021:1613-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1613-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/HKG4SHDRVYYGSRQNKBCCH6YJUQX2D54K");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'logback'
  package(s) announced via the openSUSE-SU-2021:1613-1 advisory.");
  ...
  script_tag(name:"affected", value:"'logback' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"logback", rpm:"logback~1.2.8~lp152.2.3.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"logback-access", rpm:"logback-access~1.2.8~lp152.2.3.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"logback-examples", rpm:"logback-examples~1.2.8~lp152.2.3.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"logback-javadoc", rpm:"logback-javadoc~1.2.8~lp152.2.3.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }
