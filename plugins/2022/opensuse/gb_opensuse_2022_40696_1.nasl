...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854538");
  ...
  script_tag(name:"creation_date", value:"2022-03-05 02:02:05 +0000 (Sat, 05 Mar 2022)");
  script_name("openSUSE: Security Advisory for MozillaFirefox (openSUSE-SU-2022:40696-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:40696-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GLKBY66GKNX6KTZGJNPYOI7GCDSXWVYU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox'
  package(s) announced via the openSUSE-SU-2022:40696-1 advisory.");
