...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854527");
  ...
  script_tag(name:"creation_date", value:"2022-03-05 02:01:22 +0000 (Sat, 05 Mar 2022)");
  script_name("openSUSE: Security Advisory for php7 (openSUSE-SU-2022:0699-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:0699-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/JTK7KI5DNPAM32GVDSKIK3NDYP7OGBGQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7'
  package(s) announced via the openSUSE-SU-2022:0699-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php7-firebird", rpm:"php7-firebird~7.4.6~3.32.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"php7-firebird-debuginfo", rpm:"php7-firebird-debuginfo~7.4.6~3.32.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
