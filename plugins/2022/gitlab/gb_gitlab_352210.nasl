...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124102");
  script_version("2022-07-11T04:13:20+0000");
  script_tag(name:"last_modification", value:"2022-07-11 04:13:20 +0000 (Mon, 11 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-04-11 09:47:46 +0000 (Mon, 11 Apr 2022)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_cve_id("CVE-2022-1963");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 13.4.x < 14.10.5, 15.0.x < 15.0.4, 15.1.x < 15.1.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"GitLab reveals if a user has enabled two-factor authentication
  on their account in the HTML source, to unauthenticated users.");

  script_tag(name:"affected", value:"GitLab version 13.4.x through 14.10.4, 15.0.x through 15.0.3
  and 15.1.0.");

  script_tag(name:"solution", value:"Update to version 14.10.5, 15.0.4, 15.1.1 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-1963.json");
...
if (version_in_range_exclusive(version: version, test_version_lo: "13.4", test_version_up: "14.10.5")) {
