...
if (description)
{
  ...
  script_name("GitLab 12.2.x < 14.7.7, 14.8.x < 14.8.5, 14.9.x < 14.9.2 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"An issue has been discovered that allowed for an unauthorised
  user to read the approval rules of a private project.");

  script_tag(name:"affected", value:"GitLab version 12.2.x prior to 14.7.7, 14.8.x prior to 14.8.5
...
if (version_in_range_exclusive(version: version, test_version_lo: "12.2.0", test_version_up: "14.7.7")) {
