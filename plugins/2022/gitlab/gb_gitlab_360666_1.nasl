...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124112");
  ...
  script_cve_id("CVE-2022-2243");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 14.8.x < 14.10.5, 15.0.x < 15.0.4, 15.1.x < 15.1.1 Authorization Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to an authorization bypass vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"GitLab allows authenticated users to enumerate issues in non-
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2243.json");
