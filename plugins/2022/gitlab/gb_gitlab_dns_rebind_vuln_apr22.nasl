...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147965");
  script_version("2022-04-11T09:50:25+0000");
  script_tag(name:"last_modification", value:"2022-04-12 10:03:57 +0000 (Tue, 12 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-11 07:14:29 +0000 (Mon, 11 Apr 2022)");
  ...
  script_name("GitLab 7.9.x < 14.5.4, 14.6.x < 14.6.4, 14.7.x < 14.7.1 DNS Rebinding Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a DNS rebinding vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"A DNS rebinding vulnerability in the Irker IRC Gateway
  integration allows an attacker to trigger server-side request forgery (SSRF) attacks.");

  script_tag(name:"affected", value:"GitLab version 7.9.x through 14.5.3, 14.6.x through 14.6.3 and
  14.7.0.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.9", test_version_up: "14.5.4")) {
