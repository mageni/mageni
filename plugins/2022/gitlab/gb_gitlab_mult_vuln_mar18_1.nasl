...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170074");
  ...
  script_name("GitLab 8.9.x - 9.5.10, 10.x - 10.1.5, 10.2.x - 10.2.5, 10.3.x - 10.3.3 Multiple Vulnerabilities");
  ...
  - CVE-2017-0915: command injection by overwriting authorized_keys file through GitLab import

  - CVE-2018-3710: remote command execution via project import");

  script_tag(name:"affected", value:"GitLab version 8.9.x through 9.5.10, 10.x through 10.1.5,
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/41757");
  script_xref(name:"URL", value:"https://hackerone.com/reports/298873");
...
if ( version_in_range( version:version, test_version:"8.9.0", test_version2:"9.5.10" ) ) {
