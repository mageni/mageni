...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170068");
  ...
  script_tag(name:"severity_date", value:"2018-11-19 23:40:00 +0000 (Mon, 19 Nov 2018)");

  script_cve_id("CVE-2018-16050");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 10.7.x - 10.7.6, 10.8.x - 10.8.5, 11.1.x - 11.1.4, 11.2.x - 11.2.1 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a missing authorization control
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Persistent XSS rendering/escaping of diff location lines `@@` in
  Merge Request changes view.");

  script_tag(name:"affected", value:"GitLab version 10.7.x through 10.7.6, 10.8.x through 10.8.5,
  11.1.x through 11.1.4 and 11.2.x through 11.2.1.");

  script_tag(name:"solution", value:"Update to version 10.7.7, 10.8.6, 11.1.5, 11.2.2 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/49085");
...
if ( version_in_range( version:version, test_version:"10.7.0", test_version2:"10.7.6" ) ) {
