...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147917");
  script_version("2022-04-05T03:09:53+0000");
  script_tag(name:"last_modification", value:"2022-04-05 10:21:53 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-05 02:59:27 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"cvss_base", value:"2.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:S/C:N/I:P/A:N");

  script_cve_id("CVE-2022-0740");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 7.8.x < 14.7.7, 14.8.x < 14.8.5, 14.9.x < 14.9.2 Restriction Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a restriction bypass vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Incorrect authorization in the Asana integration's branch
  restriction feature makes it possible to close Asana tasks from unrestricted branches.");

  script_tag(name:"affected", value:"GitLab version 7.8.x prior to 14.7.7, 14.8.x prior to 14.8.5
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.8.0", test_version_up: "14.7.7")) {
