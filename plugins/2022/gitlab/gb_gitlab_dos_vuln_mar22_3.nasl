...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147915");
  script_version("2022-04-05T03:09:53+0000");
  script_tag(name:"last_modification", value:"2022-04-05 10:21:53 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-05 02:51:47 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");

  script_cve_id("CVE-2022-1174");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 13.7.x < 14.7.7, 14.8.x < 14.8.5, 14.9.x < 14.9.2 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"A potential DoS vulnerability allowed an attacker to trigger
  high CPU usage via a special crafted input added in Issues, Merge requests, Milestones, Snippets,
  Wiki pages, etc.");

  script_tag(name:"affected", value:"GitLab version 13.7.x prior to 14.7.7, 14.8.x prior to 14.8.5
...
if (version_in_range_exclusive(version: version, test_version_lo: "13.7.0", test_version_up: "14.7.7")) {
