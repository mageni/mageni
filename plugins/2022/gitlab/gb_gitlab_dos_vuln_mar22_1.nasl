...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147909");
  script_version("2022-04-05T03:09:53+0000");
  script_tag(name:"last_modification", value:"2022-04-05 10:21:53 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-05 02:26:11 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");

  script_cve_id("CVE-2022-1185");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 10.x < 14.7.7, 14.8.x < 14.8.5, 14.9.x < 14.9.2 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"A denial of service vulnerability when rendering RDoc files
  allows an attacker to crash the GitLab web application with a maliciously crafted RDoc file.");

  script_tag(name:"affected", value:"GitLab version 10.x prior to 14.7.7, 14.8.x prior to 14.8.5
...
if (version_in_range_exclusive(version: version, test_version_lo: "10.0.0", test_version_up: "14.7.7")) {
