...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1309");
  ...
  script_name("Huawei EulerOS: Security Advisory for libsepol (EulerOS-SA-2022-1309)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1309");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1309");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsepol' package(s) announced via the EulerOS-SA-2022-1309 advisory.");
...
The CIL compiler in SELinux 3.2 has a heap-based buffer over-read in ebitmap_match_any (called indirectly from cil_check_neverallow). This occurs because there is sometimes a lack of checks for invalid statements in an optional block.(CVE-2021-36087)");
  ...
  script_tag(name:"affected", value:"'libsepol' package(s) on Huawei EulerOS V2.0SP9.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsepol", rpm:"libsepol~2.9~1.h10.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
