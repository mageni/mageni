...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1351");
  ...
  script_name("Huawei EulerOS: Security Advisory for keepalived (EulerOS-SA-2022-1351)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1351");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1351");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'keepalived' package(s) announced via the EulerOS-SA-2022-1351 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"keepalived", rpm:"keepalived~2.0.6~78.h5.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
