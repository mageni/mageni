...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1544");
  ...
  script_name("Huawei EulerOS: Security Advisory for OpenEXR (EulerOS-SA-2022-1544)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1544");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1544");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'OpenEXR' package(s) announced via the EulerOS-SA-2022-1544 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"OpenEXR-libs", rpm:"OpenEXR-libs~1.7.1~7.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
