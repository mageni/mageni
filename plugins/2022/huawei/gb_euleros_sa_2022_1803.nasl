...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1803");
  ...
  script_name("Huawei EulerOS: Security Advisory for expat (EulerOS-SA-2022-1803)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1803");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1803");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2022-1803 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In Expat (aka libexpat) before 2.4.5, there is an integer overflow in copyString.(CVE-2022-25314)
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.2.9~2.h5.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
