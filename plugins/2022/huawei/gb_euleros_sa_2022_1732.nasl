...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1732");
  script_cve_id("CVE-2022-21248", "CVE-2022-21282", "CVE-2022-21283", "CVE-2022-21293", "CVE-2022-21296", "CVE-2022-21305", "CVE-2022-21340", "CVE-2022-21349", "CVE-2022-21360", "CVE-2022-21365");
  ...
  script_name("Huawei EulerOS: Security Advisory for java-1.7.0-openjdk (EulerOS-SA-2022-1732)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1732");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1732");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'java-1.7.0-openjdk' package(s) announced via the EulerOS-SA-2022-1732 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk", rpm:"java-1.7.0-openjdk~1.7.0.191~2.6.15.4.h12", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.191~2.6.15.4.h12", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-headless", rpm:"java-1.7.0-openjdk-headless~1.7.0.191~2.6.15.4.h12", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
