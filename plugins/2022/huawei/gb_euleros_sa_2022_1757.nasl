...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1757");
  ...
  script_name("Huawei EulerOS: Security Advisory for python (EulerOS-SA-2022-1757)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1757");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1757");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python' package(s) announced via the EulerOS-SA-2022-1757 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python", rpm:"python~2.7.5~58.h34", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-devel", rpm:"python-devel~2.7.5~58.h34", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-libs", rpm:"python-libs~2.7.5~58.h34", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tkinter", rpm:"tkinter~2.7.5~58.h34", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
