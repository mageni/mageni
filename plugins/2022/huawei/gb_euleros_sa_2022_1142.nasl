...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1142");
  script_cve_id("CVE-2021-23437", "CVE-2021-28675", "CVE-2021-28676", "CVE-2021-28677", "CVE-2021-34552");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-pillow (EulerOS-SA-2022-1142)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1142");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1142");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-pillow' package(s) announced via the EulerOS-SA-2022-1142 advisory.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-pillow", rpm:"python-pillow~2.0.0~19.h14.gitd1c6db8.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
