...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1577");
  script_cve_id("CVE-2018-18088", "CVE-2018-20845", "CVE-2018-5727", "CVE-2019-12973");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg2 (EulerOS-SA-2022-1577)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1577");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1577");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg2' package(s) announced via the EulerOS-SA-2022-1577 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.3.0~9.h12.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
