...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1522");
  ...
  script_name("Huawei EulerOS: Security Advisory for udisks2 (EulerOS-SA-2022-1522)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1522");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1522");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'udisks2' package(s) announced via the EulerOS-SA-2022-1522 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libudisks2", rpm:"libudisks2~2.9.0~2.h3.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"udisks2", rpm:"udisks2~2.9.0~2.h3.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
