...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1180");
  ...
  script_name("Huawei EulerOS: Security Advisory for openssl098e (EulerOS-SA-2022-1180)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1180");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1180");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openssl098e' package(s) announced via the EulerOS-SA-2022-1180 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssl098e", rpm:"openssl098e~0.9.8e~29.3.h11", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
