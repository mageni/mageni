...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124002");
  ...
  script_cve_id("CVE-2021-45327");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("gitea < 1.11.2 RCE Vulnerability");
  ...
  script_tag(name:"insight", value:"Gitea is affected by Trusting HTTP Permission Methods on the 
  Server Side when referencing the vulnerable admin or user API. This could enable a remote 
  malicious user to execute arbitrary code.");

  script_tag(name:"affected", value:"Gitea prior to version 1.11.2.");

  script_tag(name:"solution", value:"Update to version 1.11.2 or later.");

  script_xref(name:"URL", value:"https://github.com/go-gitea/gitea/releases/tag/v1.11.2");
  script_xref(name:"URL", value:"https://blog.gitea.io/2020/03/gitea-1.11.2-is-released/");
