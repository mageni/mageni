...
if(description)
{
  ...
  script_cve_id("CVE-2022-25636", "CVE-2022-23960", "CVE-2022-0847", "CVE-2022-0001", "CVE-2022-0002");
  ...
  script_name("Ubuntu: Security Advisory for linux (USN-5317-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006436.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux'
  package(s) announced via the USN-5317-1 advisory.");
