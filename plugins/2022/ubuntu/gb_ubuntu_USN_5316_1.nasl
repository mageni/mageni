...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for redis (USN-5316-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006435.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis'
  package(s) announced via the USN-5316-1 advisory.");
...
Lua sandbox and execute arbitrary code on the host.");
  ...
  script_tag(name:"affected", value:"'redis' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS.");
