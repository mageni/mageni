...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for openjdk-17 (USN-5313-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006433.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-17'
  package(s) announced via the USN-5313-1 advisory.");
...
(CVE-2022-21365)");
  ...
  script_tag(name:"affected", value:"'openjdk-17' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
