...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for isc-dhcp (USN-4969-3)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006063.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'isc-dhcp'
  package(s) announced via the USN-4969-3 advisory.");
