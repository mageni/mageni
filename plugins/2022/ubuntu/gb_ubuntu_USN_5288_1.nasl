...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for expat (USN-5288-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006409.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the USN-5288-1 advisory.");
...
execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexpat1", ver:"2.4.1-2ubuntu0.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexpat1", ver:"2.2.5-3ubuntu0.4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexpat1", ver:"2.2.9-1ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
