...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for mysql-8.0 (USN-5270-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006388.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-8.0'
  package(s) announced via the USN-5270-1 advisory.");
...
features, and possibly incompatible changes.");
  ...
  script_tag(name:"affected", value:"'mysql-8.0' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
