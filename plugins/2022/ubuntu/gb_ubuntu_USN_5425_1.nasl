...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for pcre3 (USN-5425-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006567.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pcre3'
  package(s) announced via the USN-5425-1 advisory.");
...
Ubuntu 18.04 LTS and Ubuntu 20.04 LTS. (CVE-2020-14155)");
  ...
  script_tag(name:"affected", value:"'pcre3' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpcre3", ver:"2:8.39-13ubuntu0.21.10.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpcre3", ver:"2:8.39-9ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpcre3", ver:"2:8.39-13ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpcre3", ver:"2:8.39-12ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
