...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-06-24 20:55:00 +0000 (Fri, 24 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-07-02 01:01:26 +0000 (Sat, 02 Jul 2022)");
  script_name("Ubuntu: Security Advisory for linux-oem-5.14 (USN-5485-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-July/006651.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.14'
  package(s) announced via the USN-5485-2 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"corresponding", ver:"processor microcode/firmware updates.", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
