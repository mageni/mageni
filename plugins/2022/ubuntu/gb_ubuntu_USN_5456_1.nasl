...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for imagemagick (USN-5456-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006603.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'imagemagick'
  package(s) announced via the USN-5456-1 advisory.");
...
denial of service or other unspecified impact.");
  ...
  script_tag(name:"affected", value:"'imagemagick' package(s) on Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"-6.q16-7", ver:"8:6.9.7.4+dfsg-16ubuntu6.13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"-6.q16hdri-7", ver:"8:6.9.7.4+dfsg-16ubuntu6.13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
