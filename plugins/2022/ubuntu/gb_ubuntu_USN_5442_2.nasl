...
if(description)
{
  ...
  script_cve_id("CVE-2022-29581", "CVE-2022-1116", "CVE-2022-30594");
  ...
  script_name("Ubuntu: Security Advisory for linux-gkeop (USN-5442-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006600.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gkeop'
  package(s) announced via the USN-5442-2 advisory.");
...
intended seccomp sandbox restrictions. (CVE-2022-30594)");
  ...
  script_tag(name:"affected", value:"'linux-gkeop' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
