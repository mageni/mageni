...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for rust-pleaser (USN-4955-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006025.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust-pleaser'
  package(s) announced via the USN-4955-1 advisory.");
