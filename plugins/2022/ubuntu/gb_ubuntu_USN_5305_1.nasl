...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for mariadb-10.5 (USN-5305-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006423.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb-10.5'
  package(s) announced via the USN-5305-1 advisory.");
...
new features, and possibly incompatible changes.");
  ...
  script_tag(name:"affected", value:"'mariadb-10.5' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS.");
