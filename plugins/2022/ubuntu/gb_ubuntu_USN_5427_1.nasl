...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for apport (USN-5427-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006568.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apport'
  package(s) announced via the USN-5427-1 advisory.");
...
arguments to the Apport daemon. (CVE-2022-28658)");
  ...
  script_tag(name:"affected", value:"'apport' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
