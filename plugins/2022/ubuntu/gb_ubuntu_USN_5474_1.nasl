...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for varnish (USN-5474-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006622.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'varnish'
  package(s) announced via the USN-5474-1 advisory.");
...
sensitive information. (CVE-2022-23959)");
  ...
  script_tag(name:"affected", value:"'varnish' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
