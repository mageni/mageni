...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for shadow (USN-5254-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-January/006375.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'shadow'
  package(s) announced via the USN-5254-1 advisory.");
...
(CVE-2018-7169)");
  ...
  script_tag(name:"affected", value:"'shadow' package(s) on Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"login", ver:"1:4.5-1ubuntu2.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"passwd", ver:"1:4.5-1ubuntu2.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"uidmap", ver:"1:4.5-1ubuntu2.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
