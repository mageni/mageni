...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170121");
  ...
  script_name("QNAP QuTS hero Privilege Escalation Vulnerability (QSA-22-05)");
  ...
  script_tag(name:"summary", value:"QNAP QuTS hero is prone to a local privilege escalation
  vulnerability, also known as dirty pipe.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"If exploited, this vulnerability allows an unprivileged user to
  gain administrator privileges and inject malicious code.");

  script_tag(name:"affected", value:"QNAP QuTS hero version h5.x prior to h5.0.0 build 20220324.");

  script_tag(name:"solution", value:"Update to version h5.0.0 build 20220324.");
