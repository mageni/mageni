...
if(description)
{
  ...
  script_version("2022-02-17T03:39:09+0000");
  ...
  script_name("QNAP QTS 5.x Multiple Vulnerabilities (QSA-21-57)");
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.0", test_version_up: "5.0.0_20211221")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.0.0_20211221");
