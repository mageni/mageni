...
if (version_in_range_exclusive(version: version, test_version_lo: "4.4.0", test_version_up: "4.5.4_20220128")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.5.4_20220128");
  security_message(port: 0, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "5.0.0", test_version_up: "5.0.0_20220129")) {
