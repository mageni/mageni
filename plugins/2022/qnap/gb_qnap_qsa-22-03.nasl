...
if(description)
{
  ...
  script_version("2022-02-17T11:37:18+0000");
  ...
  script_tag(name:"affected", value:"QNAP QTS versions prior to 4.5.4.1931 build 20220128 and 5.x
  prior to 5.0.0.1932 build 20220129.");

  script_tag(name:"solution", value:"Update to version 4.5.4.1931 build 20220128, 5.0.0.1932 build
  20220129 or later.
...
# TODO: According to QSA-22-03 fixes for the 4.3.x branches are not available yet. Check the
# availability of patches in a few weeks.
if (version_is_less(version: version, test_version:"4.5.4_20220128")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.5.4_20220128");
  security_message(port: 0, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "5.0", test_version_up: "5.0.0_20220129")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.0.0_20220129");
  security_message(port: 0, data: report);
  exit(0);
}
