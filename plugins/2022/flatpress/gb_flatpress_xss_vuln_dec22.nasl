...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147686");
  script_version("2022-02-23T06:52:25+0000");
  script_tag(name:"last_modification", value:"2022-02-23 11:20:38 +0000 (Wed, 23 Feb 2022)");
  script_tag(name:"creation_date", value:"2022-02-22 09:12:47 +0000 (Tue, 22 Feb 2022)");
  script_tag(name:"cvss_base", value:"3.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:N");

  script_cve_id("CVE-2020-35241");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"NoneAvailable");

  script_name("FlatPress <= 1.2.1 XSS Vulnerability (CVE-2020-35241)");
  ...
  vulnerability in the Blog Content component.");
  ...
  script_xref(name:"URL", value:"https://github.com/flatpressblog/flatpress/issues/72");
  script_xref(name:"URL", value:"https://github.com/hemantsolo/CVE-Reference/blob/main/CVE-2020-35241.md");
