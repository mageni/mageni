...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.14878.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:14878-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:14878-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-202214878-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat' package(s) announced via the SUSE-SU-2022:14878-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.0.1~88.42.12.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libexpat1", rpm:"libexpat1~2.0.1~88.42.12.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libexpat1-32bit", rpm:"libexpat1-32bit~2.0.1~88.42.12.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
