...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.0704.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:0704-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:0704-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220704-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs8' package(s) announced via the SUSE-SU-2022:0704-1 advisory.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs-common", rpm:"nodejs-common~2.0~3.4.1", rls:"SLES15.0"))) {
    report += res;
  }
...
if(release == "SLES15.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs-common", rpm:"nodejs-common~2.0~3.4.1", rls:"SLES15.0SP1"))) {
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs-common", rpm:"nodejs-common~2.0~3.4.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs8", rpm:"nodejs8~8.17.0~10.19.2", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs8-debuginfo", rpm:"nodejs8-debuginfo~8.17.0~10.19.2", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs8-debugsource", rpm:"nodejs8-debugsource~8.17.0~10.19.2", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs8-devel", rpm:"nodejs8-devel~8.17.0~10.19.2", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs8-docs", rpm:"nodejs8-docs~8.17.0~10.19.2", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm8", rpm:"npm8~8.17.0~10.19.2", rls:"SLES15.0SP2"))) {
    report += res;
  }
