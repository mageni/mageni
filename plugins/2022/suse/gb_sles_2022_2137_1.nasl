...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.2137.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:2137-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:2137-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222137-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-prometheus-node_exporter' package(s) announced via the SUSE-SU-2022:2137-1 advisory.");
...
Update to 1.1.2
 * Bug fixes
 + Handle errors from disabled PSI subsystem ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'golang-github-prometheus-node_exporter' package(s) on SUSE Linux Enterprise High Performance Computing 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP 15.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-node_exporter", rpm:"golang-github-prometheus-node_exporter~1.3.0~150000.3.12.1", rls:"SLES15.0"))) {
    report += res;
  }
