...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820180");
  ...
  script_name("Fedora: Security Advisory for leptonica (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7X7IIA3LGRMRPIM4RP2XNAW27SXRM4LB");
...
Fundamental image processing and image analysis operations
  ...
  * Pixelwise masking, blending, enhancement, arithmetic ops,
  ...
  script_tag(name:"affected", value:"'leptonica' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"leptonica", rpm:"leptonica~1.82.0~6.fc36", rls:"FC36"))) {
    report += res;
  }
