...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820117");
  ...
  script_name("Fedora: Security Advisory for libwebp (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IXQO32A4ZJTUISY2WERG2FZKGOCKLY63");
...
images more efficiently.");
  ...
  script_tag(name:"affected", value:"'libwebp' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libwebp", rpm:"libwebp~1.2.2~4.fc36", rls:"FC36"))) {
    report += res;
  }
