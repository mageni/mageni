...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821065");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:43:05 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for syncthing (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SRDVPICJVZQ2VBBQWDLNMHEXIZBFOE6F");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"syncthing", rpm:"syncthing~1.20.2~2.fc36", rls:"FC36"))) {
    report += res;
  }
