...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820530");
  ...
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-08ae2dd481)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YXSIH2XCRUZ7NKCLPYY7N5WCMELSXNVP");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.6.2~2.fc36", rls:"FC36"))) {
    report += res;
  }
