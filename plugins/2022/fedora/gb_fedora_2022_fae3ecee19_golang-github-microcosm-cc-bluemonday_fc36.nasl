...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820891");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:44:06 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-microcosm-cc-bluemonday (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FXTC6FW73R5BCABMX3JD6F5UUGO73H2M");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-microcosm-cc-bluemonday", rpm:"golang-github-microcosm-cc-bluemonday~1.0.17~3.fc36", rls:"FC36"))) {
    report += res;
  }
