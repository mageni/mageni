...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821047");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:22:23 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-nicksnyder-i18n-2 (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YAEF62EARZNK6SYXLY4SQMGSMC3IM7XO");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nicksnyder-i18n-2", rpm:"golang-github-nicksnyder-i18n-2~2.1.2~5.fc36", rls:"FC36"))) {
    report += res;
  }
