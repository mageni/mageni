...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820764");
  ...
  script_name("Fedora: Security Advisory for ntfs-3g (FEDORA-2022-8f775872c9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-8f775872c9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7JPX6OUCQKZX4PN5DQPVDUFZCOOZUX7Z");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g'
  package(s) announced via the FEDORA-2022-8f775872c9 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntfs-3g", rpm:"ntfs-3g~2022.5.17~1.fc36", rls:"FC36"))) {
    report += res;
  }
