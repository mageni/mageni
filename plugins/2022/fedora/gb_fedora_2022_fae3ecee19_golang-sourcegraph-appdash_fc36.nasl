...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820961");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:41:40 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-sourcegraph-appdash (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OHZYT2W7YBYNJT2HLN2UIDORHYRGLJWI");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-sourcegraph-appdash-0", rpm:"golang-sourcegraph-appdash-0~0.9.20210113gitebfcffb.fc36", rls:"FC36"))) {
    report += res;
  }
