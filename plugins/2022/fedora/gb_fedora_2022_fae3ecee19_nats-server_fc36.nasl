...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820981");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:34:47 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for nats-server (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PPX62NU4GOE7UMFTRBN6U7RXZOXSED4B");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nats-server", rpm:"nats-server~2.1.9~6.fc36", rls:"FC36"))) {
    report += res;
  }
