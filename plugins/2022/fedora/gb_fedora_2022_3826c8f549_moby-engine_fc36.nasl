...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820621");
  ...
  script_tag(name:"creation_date", value:"2022-05-08 01:10:41 +0000 (Sun, 08 May 2022)");
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2022-3826c8f549)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-3826c8f549");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HQCVS7WBFSTKJFNX5PGDRARMTOFWV2O7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'moby-engine'
  package(s) announced via the FEDORA-2022-3826c8f549 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~20.10.14~1.fc36", rls:"FC36"))) {
    report += res;
  }
