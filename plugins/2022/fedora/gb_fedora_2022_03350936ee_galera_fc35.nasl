...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820524");
  ...
  script_tag(name:"creation_date", value:"2022-05-09 01:05:45 +0000 (Mon, 09 May 2022)");
  script_name("Fedora: Security Advisory for galera (FEDORA-2022-03350936ee)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KWFA74GUELGWMFULGISQCESXHHSYHQCG");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"galera", rpm:"galera~26.4.11~1.fc35", rls:"FC35"))) {
    report += res;
  }
