...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820770");
  ...
  script_name("Fedora: Security Advisory for ntfs-3g-system-compression (FEDORA-2022-13bc8c91b0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-13bc8c91b0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ECDCISL24TYH4CTDFCUVF24WAKRSYF7F");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntfs-3g-system-compression'
  package(s) announced via the FEDORA-2022-13bc8c91b0 advisory.");
...
utility on Windows.");
  ...
  script_tag(name:"affected", value:"'ntfs-3g-system-compression' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntfs-3g-system-compression", rpm:"ntfs-3g-system-compression~1.0~9.fc36", rls:"FC36"))) {
    report += res;
  }
