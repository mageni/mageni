...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820160");
  ...
  script_tag(name:"creation_date", value:"2022-03-31 01:04:46 +0000 (Thu, 31 Mar 2022)");
  script_name("Fedora: Security Advisory for unrealircd (FEDORA-2022-a9349c1299)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-a9349c1299");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/W7SHZ6CK4YFTD6WN3PSC5SU4EXHPQ5PD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'unrealircd'
  package(s) announced via the FEDORA-2022-a9349c1299 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"unrealircd", rpm:"unrealircd~6.0.2~1.fc35", rls:"FC35"))) {
    report += res;
  }
