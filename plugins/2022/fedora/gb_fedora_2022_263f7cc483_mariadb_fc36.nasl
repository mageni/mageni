...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820426");
  ...
  script_name("Fedora: Security Advisory for mariadb (FEDORA-2022-263f7cc483)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/23GUM3POBXREAZYFAHPNZATREX5CZH7P");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb", rpm:"mariadb~10.5.15~1.fc36", rls:"FC36"))) {
    report += res;
  }
