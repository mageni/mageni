...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820608");
  ...
  script_name("Fedora: Security Advisory for bettercap (FEDORA-2022-08ae2dd481)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LCZDNZXAEZWMYWFDAM3TBK4FMHCJQFQC");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bettercap", rpm:"bettercap~2.28~9.fc36", rls:"FC36"))) {
    report += res;
  }
