...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820188");
  ...
  script_name("Fedora: Security Advisory for zathura-pdf-mupdf (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5RI5AVVNK42R2XUZ3JDXBWHAOSJ236SG");
  ...
  script_tag(name:"affected", value:"'zathura-pdf-mupdf' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zathura-pdf-mupdf", rpm:"zathura-pdf-mupdf~0.3.7~6.fc36", rls:"FC36"))) {
    report += res;
  }
