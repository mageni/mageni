...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819743");
  ...
  script_tag(name:"creation_date", value:"2022-02-20 02:02:46 +0000 (Sun, 20 Feb 2022)");
  script_name("Fedora: Security Advisory for cyrus-imapd (FEDORA-2022-d45bcc5447)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-d45bcc5447");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6HEO3RURJW6NLIXS7NK5PVU6MGHC4SCM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cyrus-imapd'
  package(s) announced via the FEDORA-2022-d45bcc5447 advisory.");
...
hierarchies.");
  ...
  script_tag(name:"affected", value:"'cyrus-imapd' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cyrus-imapd", rpm:"cyrus-imapd~3.2.8~2.fc34", rls:"FC34"))) {
    report += res;
  }
