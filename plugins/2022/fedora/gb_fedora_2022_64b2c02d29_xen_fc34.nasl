...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-64b2c02d29");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6ETPM2OVZZ6KOS2L7QO7SIW6XWT5OW3F");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen'
  package(s) announced via the FEDORA-2022-64b2c02d29 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.14.5~1.fc34", rls:"FC34"))) {
    report += res;
  }
