...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819716");
  ...
  script_tag(name:"creation_date", value:"2022-02-15 02:03:17 +0000 (Tue, 15 Feb 2022)");
  script_name("Fedora: Security Advisory for containerd (FEDORA-2022-f668c3d70d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-f668c3d70d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GD5GH7NMK5VJMA2Y5CYB5O5GTPYMWMLX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd'
  package(s) announced via the FEDORA-2022-f668c3d70d advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd-1.6.0", rpm:"containerd-1.6.0~rc.2~3.fc34", rls:"FC34"))) {
    report += res;
  }
