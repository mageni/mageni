...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820120");
  ...
  script_name("Fedora: Security Advisory for python-PyMuPDF (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/K5Z4EWGSO6SE37LNQVE6PMRVR6YIT6L6");
...
*.pdf, *.xps, *.oxps, *.epub, *.cbz or *.fb2 from your Python scripts.");
  ...
  script_tag(name:"affected", value:"'python-PyMuPDF' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-PyMuPDF", rpm:"python-PyMuPDF~1.19.5~2.fc36", rls:"FC36"))) {
    report += res;
  }
