...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820418");
  ...
  script_tag(name:"creation_date", value:"2022-05-08 01:10:18 +0000 (Sun, 08 May 2022)");
  script_name("Fedora: Security Advisory for buildah (FEDORA-2022-1a15fe81f0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-1a15fe81f0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/25YI27MENCEPZTTGRVU6BQD5V53FNI52");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah'
  package(s) announced via the FEDORA-2022-1a15fe81f0 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.25.1~1.fc36", rls:"FC36"))) {
    report += res;
  }
