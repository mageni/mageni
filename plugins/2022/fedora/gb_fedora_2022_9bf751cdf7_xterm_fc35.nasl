...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819764");
  ...
  script_name("Fedora: Security Advisory for xterm (FEDORA-2022-9bf751cdf7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-9bf751cdf7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T4CWYYEBT6AJRJBBQU2KLUOQDHRM7WAV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xterm'
  package(s) announced via the FEDORA-2022-9bf751cdf7 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xterm", rpm:"xterm~370~3.fc35", rls:"FC35"))) {
    report += res;
  }
