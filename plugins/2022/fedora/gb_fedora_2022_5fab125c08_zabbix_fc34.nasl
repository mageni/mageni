...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819838");
  ...
  script_name("Fedora: Security Advisory for zabbix (FEDORA-2022-5fab125c08)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-5fab125c08");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2V4N22R3QVTYAJMWFK2U2O6QXAZYM35Z");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zabbix'
  package(s) announced via the FEDORA-2022-5fab125c08 advisory.");
...
multitude of servers.");
  ...
  script_tag(name:"affected", value:"'zabbix' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~5.0.21~1.fc34", rls:"FC34"))) {
    report += res;
  }
