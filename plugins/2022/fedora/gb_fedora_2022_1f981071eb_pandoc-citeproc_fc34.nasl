...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820257");
  ...
  script_tag(name:"creation_date", value:"2022-04-03 01:05:01 +0000 (Sun, 03 Apr 2022)");
  script_name("Fedora: Security Advisory for pandoc-citeproc (FEDORA-2022-1f981071eb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KH4UQA6VWVZU5EW3HNEAB7D7BTCNJSJ2");
...
pandoc-citeproc originated as a fork of Andrea Rossato&#39, s citeproc-hs.");
  ...
  script_tag(name:"affected", value:"'pandoc-citeproc' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pandoc-citeproc", rpm:"pandoc-citeproc~0.17.0.1~5.fc34", rls:"FC34"))) {
    report += res;
  }
