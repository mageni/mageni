...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820388");
  ...
  script_name("Fedora: Security Advisory for golang-github-spf13-cobra (FEDORA-2022-3a63897745)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6O2PQN6JSSYP7W2TNO3CHA3MCRVZTCRF");
...
Cobra provides:
  ...
  script_tag(name:"affected", value:"'golang-github-spf13-cobra' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-spf13-cobra", rpm:"golang-github-spf13-cobra~1.4.0~2.fc35", rls:"FC35"))) {
    report += res;
  }
