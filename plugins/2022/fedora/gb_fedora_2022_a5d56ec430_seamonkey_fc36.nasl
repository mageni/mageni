...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820177");
  ...
  script_tag(name:"creation_date", value:"2022-03-31 01:04:43 +0000 (Thu, 31 Mar 2022)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2022-a5d56ec430)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-a5d56ec430");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6O6RMR45H2FK7QJFLXMTP3IYMSLPT3DK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2022-a5d56ec430 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.11.1~1.fc36", rls:"FC36"))) {
    report += res;
  }
