...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820841");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:33:07 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-gohugoio-testmodbuilder (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BZOJSOMQBJNV2ZKEPZOMXPITIYRE3NAT");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-gohugoio-testmodbuilder-0", rpm:"golang-github-gohugoio-testmodbuilder-0~0.10.20201030git72e1e0c.fc36", rls:"FC36"))) {
    report += res;
  }
