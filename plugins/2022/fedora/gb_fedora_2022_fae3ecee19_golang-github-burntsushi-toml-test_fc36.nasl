...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821060");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:38:47 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-burntsushi-toml-test (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LIOKQY75JJX3HKEWVDGP7L7HF6XOHANT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-burntsushi-toml-test'
  package(s) announced via the FEDORA-2022-fae3ecee19 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Toml-test is a higher-order program that tests other TOML decoders or encoders.
...
format as the JSON that a TOML decoder should output.");
  ...
  script_tag(name:"affected", value:"'golang-github-burntsushi-toml-test' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-burntsushi-toml-test", rpm:"golang-github-burntsushi-toml-test~0.2.0~11.20210108git9767d20.fc36", rls:"FC36"))) {
    report += res;
  }
