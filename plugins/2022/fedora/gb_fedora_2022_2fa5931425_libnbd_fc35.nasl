...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-2fa5931425");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UF6VSYU2A5U77W6GYYP5ZBDZYAAZNHJQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libnbd'
  package(s) announced via the FEDORA-2022-2fa5931425 advisory.");
...
The key features are:
  ...
  * Bindings in several programming languages.");
  ...
  script_tag(name:"affected", value:"'libnbd' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libnbd", rpm:"libnbd~1.10.5~1.fc35", rls:"FC35"))) {
    report += res;
  }
