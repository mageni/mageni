...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-April/078206.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864156");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw32-gnutls'
  ...
  script_tag(name:"affected", value:"mingw32-gnutls on Fedora 15");
