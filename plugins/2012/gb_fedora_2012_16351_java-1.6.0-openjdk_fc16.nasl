...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-October/090196.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864793");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-10-19 09:46:51 +0530 (Fri, 19 Oct 2012)");
  ...
  script_name("Fedora Update for java-1.6.0-openjdk FEDORA-2012-16351");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.0~68.1.11.5.fc16", rls:"FC16")) != NULL)
  {
