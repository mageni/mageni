...
#
# Fedora Update for openstack-nova FEDORA-2012-6365
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864195");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"openstack-nova", rpm:"openstack-nova~2011.3.1~8.fc16", rls:"FC16")) != NULL)
  {
