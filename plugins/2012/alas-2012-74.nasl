...
# $Id: alas-2012-74.nasl 6578 2017-07-06 13:44:33Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2012-74");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"nginx", rpm:"nginx~1.0.15~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"nginx-debuginfo", rpm:"nginx-debuginfo~1.0.15~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
