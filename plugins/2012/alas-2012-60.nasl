...
# $Id: alas-2012-60.nasl 6578 2017-07-06 13:44:33Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2012-60");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"libtasn1-tools", rpm:"libtasn1-tools~2.3~3.4.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libtasn1-debuginfo", rpm:"libtasn1-debuginfo~2.3~3.4.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libtasn1", rpm:"libtasn1~2.3~3.4.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libtasn1-devel", rpm:"libtasn1-devel~2.3~3.4.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
