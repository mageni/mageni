...
# $Id: gb_joomla_com_br_lfi_vuln.nasl 10754 2018-08-03 10:38:29Z ckuersteiner $
#
...
attacks and read arbitrary files on the affected application.");
  ...
  script_tag(name:"affected", value:"Joomla BR Component");
...
a newer release, disable respective features, remove the product or replace the product by another one.");
  ...
  script_tag(name:"summary", value:"This host is running Joomla BR component and is prone to local file inclusion
vulnerability.");
...
foreach file (keys(files)) {
  url = dir + "/index.php?option=com_br&controller=" + crap(data:"../",length:3*15) + files[file] + "%00";
