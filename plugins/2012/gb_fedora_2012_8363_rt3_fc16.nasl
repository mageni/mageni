...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-June/081684.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864268");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"rt3", rpm:"rt3~3.8.12~1.fc16", rls:"FC16")) != NULL)
  {
