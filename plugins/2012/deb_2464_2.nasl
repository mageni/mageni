...
# $Id: deb_2464_2.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_version("$Revision: 14275 $");  script_tag(name:"cvss_base", value:"6.8");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202464-2");
  script_tag(name:"insight", value:"The latest security update, DSA-2464-1, for Icedove, Debian's version
