...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-February/072907.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863910");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-04-02 12:33:32 +0530 (Mon, 02 Apr 2012)");
  ...
  script_name("Fedora Update for mysql FEDORA-2012-0972");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"mysql", rpm:"mysql~5.5.20~1.fc16", rls:"FC16")) != NULL)
  {
