...
# $Id: alas-2012-79.nasl 6578 2017-07-06 13:44:33Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2012-79");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"rubygems-devel", rpm:"rubygems-devel~1.8.11~3.1.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"rubygems", rpm:"rubygems~1.8.11~3.1.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
