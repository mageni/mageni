...
# $Id: deb_2487_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202487-1");
  script_tag(name:"insight", value:"It was discovered that OpenOffice.org would not properly process
