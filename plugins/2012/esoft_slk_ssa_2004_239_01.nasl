...
# $Id: esoft_slk_ssa_2004_239_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2004-239-01 gaim");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-239-01");
...
if((res = isslkpkgvuln(pkg:"gaim", ver:"0.82-i486-1", rls:"SLK9.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"gaim", ver:"0.82-i486-1", rls:"SLK10.0")) != NULL) {
  report += res;
}
