...
# $Id: freebsd_libpurple0.nasl 11762 2018-10-05 10:54:12Z cfischer $
#
# Auto generated from VID 64f8b72d-9c4e-11e1-9c94-000bcdf0a03b
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.71378");
  script_cve_id("CVE-2012-2214");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.10.4")<0) {
