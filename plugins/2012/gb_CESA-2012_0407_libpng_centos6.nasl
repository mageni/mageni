...
#
# CentOS Update for libpng CESA-2012:0407 centos6
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2012-March/018508.html");
  script_oid("1.3.6.1.4.1.25623.1.0.881224");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-07-30 16:51:14 +0530 (Mon, 30 Jul 2012)");
  script_cve_id("CVE-2011-3045");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_name("CentOS Update for libpng CESA-2012:0407 centos6");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.2.48~1.el6_2", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libpng-devel", rpm:"libpng-devel~1.2.48~1.el6_2", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libpng-static", rpm:"libpng-static~1.2.48~1.el6_2", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
