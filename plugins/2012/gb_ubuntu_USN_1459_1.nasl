...
# $Id: gb_ubuntu_USN_1459_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-ti-omap4 USN-1459-1
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1459-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841019");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-06-01 09:51:21 +0530 (Fri, 01 Jun 2012)");
  script_cve_id("CVE-2012-1601", "CVE-2012-2123");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-1459-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1459-1");
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.0.0-1210-omap4", ver:"3.0.0-1210.22", rls:"UBUNTU11.10")) != NULL)
  {
