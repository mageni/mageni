...
# $Id: gb_google_chrome_webcore_webkit_xss_vuln_win.nasl 11549 2018-09-22 12:11:10Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.802496");
  ...
  script_tag(name:"creation_date", value:"2012-11-21 13:29:23 +0530 (Wed, 21 Nov 2012)");
  script_name("Google Chrome Webcore Webkit 'XSSAuditor.cpp' XSS Vulnerability (Windows)");
...
site scripting (XSS) protection mechanism via a crafted string.");
  script_tag(name:"affected", value:"Google Chrome version 4.x to 22 on Windows");
