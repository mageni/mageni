...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-September/018009.html");
  script_oid("1.3.6.1.4.1.25623.1.0.881432");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-07-30 17:51:41 +0530 (Mon, 30 Jul 2012)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("CentOS Update for thunderbird CESA-2011:1243 centos5 x86_64");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~2.0.0.24~24.el5.centos", rls:"CentOS5")) != NULL)
  {
