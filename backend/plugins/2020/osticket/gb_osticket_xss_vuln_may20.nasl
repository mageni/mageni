...
if (description)
{
  ...
  script_version("2020-06-16T06:52:12+0000");
  ...
  script_name("osTicket <= 1.14.2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"scp/categories.php in osTicket allows XSS via a Knowledgebase Category Name
  or Category Description. The attacker must be an Agent.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"osTicket version 1.14.2 and probably prior.");

  script_tag(name:"solution", value:"No known solution is available as of 16th June, 2020.
...
if (version_is_less_equal(version: version, test_version: "1.14.2")) {
