...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144524");
  script_version("2020-09-03T04:55:01+0000");
  script_tag(name:"last_modification", value:"2020-09-03 09:52:01 +0000 (Thu, 03 Sep 2020)");
  script_tag(name:"creation_date", value:"2020-09-03 04:43:47 +0000 (Thu, 03 Sep 2020)");
  ...
  script_name("Squid Proxy Cache Security Update Advisory SQUID-2020:8 SQUID-2020:10");
  ...
  - HTTP(S) request smuggling (CVE-2020-15810)

  - HTTP(S) request splitting (CVE-2020-15811)");

  script_tag(name:"impact", value:"These vulnerabilities may lead to cache poisoning.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Squid versions 2.5 - 3.5.28, 4.0 - 4.12 and 5.0.1 - 5.0.3.");
...
if (version_in_range(version: version, test_version: "2.5", test_version2: "4.12")) {
