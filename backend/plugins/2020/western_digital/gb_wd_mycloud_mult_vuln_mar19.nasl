...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108928");
  ...
  script_cve_id("CVE-2018-1160", "CVE-2019-9950", "CVE-2019-9951");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Western Digital My Cloud Multiple Products < 2.31.174 Multiple Vulnerabilities");
  ...
  script_xref(name:"URL", value:"https://community.wd.com/t/new-release-my-cloud-firmware-version-2-31-174-03-26-2019/235932");
  ...
  - Resolved Netatalk Arbitrary Code Execution Vulnerability (CVE-2018-1160)
  ...
  script_tag(name:"affected", value:"Western Digital My Cloud with firmware versions prior to 2.31.174.");

  script_tag(name:"solution", value:"Update to firmware version 2.31.174 or later.
...
if (version_is_less(version: version, test_version: "2.31.174")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.31.174");
