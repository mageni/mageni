...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143869");
  script_version("2020-05-08T07:06:34+0000");
  script_tag(name:"last_modification", value:"2020-05-11 12:46:33 +0000 (Mon, 11 May 2020)");
  script_tag(name:"creation_date", value:"2020-05-08 06:47:18 +0000 (Fri, 08 May 2020)");
  ...
  script_name("MongoDB 3.6 < 3.6.18, 4.0 < 4.0.15, 4.2 < 4.2.3, 4.3 < 4.3.3 Improper Serialization Vulnerability - Linux");
