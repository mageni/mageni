...
if(description)
{
  ...
  script_name("Mozilla Thunderbird Security Updates(mfsa_2020-10)-Mac OS X");
...
if(version_is_less(version:tbVer, test_version:"68.6"))
{
  report = report_fixed_ver(installed_version:tbVer, fixed_version:"68.6", install_path:tbPath);
