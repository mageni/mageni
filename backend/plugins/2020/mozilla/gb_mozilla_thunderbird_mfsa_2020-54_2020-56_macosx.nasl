...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817559");
  ...
  script_tag(name:"creation_date", value:"2020-12-16 11:21:48 +0530 (Wed, 16 Dec 2020)");
  script_name("Mozilla Thunderbird Security Updates(mfsa_2020-54_2020-56)-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Thunderbird version 78.6
...
if(version_is_less(version:tbVer, test_version:"78.6"))
{
  report = report_fixed_ver(installed_version:tbVer, fixed_version:"78.6", install_path:tbPath);
