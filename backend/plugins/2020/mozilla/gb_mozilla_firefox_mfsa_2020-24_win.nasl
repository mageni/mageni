...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817210");
  ...
  script_name("Mozilla Firefox Security Updates (Windows)-June 30 2020");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 78 on Windows.");
