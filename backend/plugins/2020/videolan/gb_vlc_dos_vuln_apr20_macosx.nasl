...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112754");
  script_version("2020-05-19T13:26:14+0000");
  ...
  script_name("VLC Media Player < 3.0.9 DoS Vulnerability (Mac OS X)");
  ...
  script_tag(name:"affected", value:"VideoLAN VLC Media Player before version 3.0.9 on Mac OS X.");
