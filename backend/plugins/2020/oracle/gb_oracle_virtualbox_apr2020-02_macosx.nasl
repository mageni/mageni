...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816850");
  ...
  script_name("Oracle VirtualBox Security Updates(apr2020) 02 - Mac OS X");
  ...
  prior to 6.1.2 and 6.0.x prior to 6.0.16 on Mac OS X.");
