...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108963");
  ...
  script_cve_id("CVE-2020-14775", "CVE-2020-14827", "CVE-2020-14776", "CVE-2020-14789", "CVE-2020-14790",
                "CVE-2020-14869", "CVE-2020-14771");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL 5.7 <= 5.7.31 / 8.0 <= 8.0.21 Security Update (cpuoct2020) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 5.7 through 5.7.31 and 8.0 through 8.0.21.");

  script_tag(name:"solution", value:"Update to version 5.7.32, 8.0.22 or later.");
