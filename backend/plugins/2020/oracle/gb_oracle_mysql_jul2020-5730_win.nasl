...
if (description)
{
  ...
  script_name("Oracle MySQL 5.7.x < 5.7.30 Security Update (cpujul2020) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.0 - 5.7.29.");
