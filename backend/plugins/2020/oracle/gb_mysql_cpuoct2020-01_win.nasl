...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108959");
  ...
  script_name("Oracle MySQL <= 5.6.49 / 5.7 <= 5.7.31 / 8.0 <= 8.0.21 Security Update (cpuoct2020) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 5.6.49 and prior, 5.7 through 5.7.31 and 8.0 through 8.0.21.");
...
if (version_is_less_equal(version: version, test_version: "5.6.49")) {
