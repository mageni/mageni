...
if (description)
{
  ...
  script_version("2020-04-17T06:36:20+0000");
  ...
  script_name("PHP 7.3 < 7.3.17, 7.4 < 7.4.5 DoS Vulnerability - Apr20 (Windows)");
  ...
  script_tag(name:"affected", value:"PHP versions 7.3 prior 7.3.17 and 7.4 prior to 7.4.5.");

  script_tag(name:"solution", value:"Update to version 7.3.17, 7.4.5 or later.");
