...
if(description)
{
  ...
  script_name("Apple iCloud Security Updates (HT211107)");
  ...
  script_tag(name:"solution", value:"Upgrade to Apple iCloud 7.18 or later. Please see the references for more information.");
...
if(version_is_less(version:icVer, test_version:"7.18"))
{
  report = report_fixed_ver(installed_version:icVer, fixed_version:"7.18", install_path:icPath);
