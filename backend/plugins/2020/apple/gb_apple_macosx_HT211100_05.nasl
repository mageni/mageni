...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816726");
  script_version("2020-03-29T02:34:12+0000");
  script_cve_id("CVE-2020-3906");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-03-30 09:58:56 +0000 (Mon, 30 Mar 2020)");
  script_tag(name:"creation_date", value:"2020-03-26 12:25:29 +0530 (Thu, 26 Mar 2020)");
  script_name("Apple MacOSX Security Updates(HT211100)-05");
  ...
  script_tag(name:"insight", value:"The flaw exists due to a logic issue caused by
  improper restrictions.");

  script_tag(name:"impact", value:"Successful exploitation allow remote attackers
  to bypass security restrictions and launch further attacks.");

  script_tag(name:"affected", value:"Apple Mac OS X versions,
  10.14.x through 10.14.6, and 10.15.x through 10.15.3");

  script_tag(name:"solution", value:"Apply security update 2020-002 for
  Apple Mac OS X 10.14.x or upgrade to version 10.15.4 or later. Please
