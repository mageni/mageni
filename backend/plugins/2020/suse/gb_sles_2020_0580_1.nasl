...
if(description)
{
  ...
  script_cve_id("CVE-2019-14615","CVE-2019-14896","CVE-2019-14897");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0580-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-March/006577.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2020:0580-1 advisory.");
