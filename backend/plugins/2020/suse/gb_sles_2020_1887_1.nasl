...
if(description)
{
  ...
  script_cve_id("CVE-2020-0543","CVE-2020-15563","CVE-2020-15565");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:1887-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-July/007115.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2020:1887-1 advisory.");
