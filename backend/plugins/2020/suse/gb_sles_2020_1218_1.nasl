...
if(description)
{
  ...
  script_cve_id("CVE-2020-12387","CVE-2020-12388","CVE-2020-12389");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:1218-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-May/006803.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'MozillaFirefox'
  package(s) announced via the SUSE-SU-2020:1218-1 advisory.");
