...
if(description)
{
  ...
  script_cve_id("CVE-2019-8625","CVE-2019-8710","CVE-2019-8720");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:1135-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-April/006752.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2020:1135-1 advisory.");
