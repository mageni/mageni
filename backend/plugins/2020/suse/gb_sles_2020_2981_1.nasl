...
if(description)
{
  ...
  script_cve_id("CVE-2020-12351","CVE-2020-12352","CVE-2020-25212");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2981-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-October/007604.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2020:2981-1 advisory.");
