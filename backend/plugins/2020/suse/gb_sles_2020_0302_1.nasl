...
if(description)
{
  ...
  script_cve_id("CVE-2017-18207","CVE-2018-1000802","CVE-2018-1060");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0302-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-February/006445.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'python36'
  package(s) announced via the SUSE-SU-2020:0302-1 advisory.");
