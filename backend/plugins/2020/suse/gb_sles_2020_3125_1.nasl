...
if(description)
{
  ...
  script_cve_id("CVE-2017-6318","CVE-2020-12861","CVE-2020-12862");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3125-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007683.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'sane-backends'
  package(s) announced via the SUSE-SU-2020:3125-1 advisory.");
