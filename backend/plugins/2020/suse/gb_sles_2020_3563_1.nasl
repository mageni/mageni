...
if(description)
{
  ...
  script_cve_id("CVE-2019-16056","CVE-2019-20907","CVE-2019-20916");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3563-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007892.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'python36'
  package(s) announced via the SUSE-SU-2020:3563-1 advisory.");
