...
if(description)
{
  ...
  script_cve_id("CVE-2019-11745","CVE-2019-17006");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0088-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-January/006334.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mozilla-nspr, mozilla-nss'
  package(s) announced via the SUSE-SU-2020:0088-1 advisory.");
