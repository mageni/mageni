...
if(description)
{
  ...
  script_cve_id("CVE-2020-0430","CVE-2020-12351","CVE-2020-12352");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3281-1)");
  ...
  package(s) announced via the SUSE-SU-2020:3281-1 advisory.");
