...
if(description)
{
  ...
  script_cve_id("CVE-2020-0429","CVE-2020-0431","CVE-2020-11668");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3219-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007728.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel (Live Patch 35 for SLE 12 SP3)'
  package(s) announced via the SUSE-SU-2020:3219-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'the Linux Kernel (Live Patch 35 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12");
