...
if(description)
{
  ...
  script_cve_id("CVE-2018-12207","CVE-2018-19965","CVE-2019-11135");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0388-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-February/006485.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2020:0388-1 advisory.");
