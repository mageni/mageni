...
if(description)
{
  ...
  script_cve_id("CVE-2017-9239","CVE-2018-17581","CVE-2019-13110");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0860-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-April/006670.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'exiv2'
  package(s) announced via the SUSE-SU-2020:0860-1 advisory.");
