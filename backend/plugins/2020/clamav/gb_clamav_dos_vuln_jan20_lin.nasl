...
if(description)
{
  ...
  script_version("2020-01-20T11:46:24+0000");
  script_tag(name:"last_modification", value:"2020-01-20 11:46:24 +0000 (Mon, 20 Jan 2020)");
  ...
  script_name("ClamAV <= 0.101.4, 0.102.0 Denial of Service (DoS) Vulnerability (Linux)");
