...
if (description)
{
  ...
  - Cross-Site Scripting (XSS) in template object username

  - Cross-Site Scripting (XSS) via malicious XML attachment

  - Multiple Cross-Site Scripting (XSS) in Installer
