...
if(description)
{
  ...
  script_name("openSUSE Update for fish3 openSUSE-SU-2019:2188-1 (fish3)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00071.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fish3'
  package(s) announced via the openSUSE-SU-2019:2188_1 advisory.");
