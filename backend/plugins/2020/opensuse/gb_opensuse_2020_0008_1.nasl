...
if(description)
{
  ...
  script_name("openSUSE Update for mozilla-nspr, openSUSE-SU-2020:0008-1 (mozilla-nspr, )");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-01/msg00006.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-nspr, '
  package(s) announced via the openSUSE-SU-2020:0008_1 advisory.");
