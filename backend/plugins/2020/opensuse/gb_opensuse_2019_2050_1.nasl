...
if(description)
{
  ...
  script_name("openSUSE Update for httpie openSUSE-SU-2019:2050-1 (httpie)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00003.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'httpie'
  package(s) announced via the openSUSE-SU-2019:2050_1 advisory.");
