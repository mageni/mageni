...
if(description)
{
  ...
  script_name("openSUSE Update for containerd, openSUSE-SU-2019:1444-1 (containerd, )");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00060.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd, '
  package(s) announced via the openSUSE-SU-2019:1444_1 advisory.");
