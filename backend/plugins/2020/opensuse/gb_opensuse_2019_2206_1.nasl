...
if(description)
{
  ...
  script_name("openSUSE Update for mosquitto openSUSE-SU-2019:2206-1 (mosquitto)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00077.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mosquitto'
  package(s) announced via the openSUSE-SU-2019:2206_1 advisory.");
