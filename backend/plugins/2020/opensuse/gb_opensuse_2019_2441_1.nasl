...
if(description)
{
  ...
  script_name("openSUSE Update for php7 openSUSE-SU-2019:2441-1 (php7)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00011.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7'
  package(s) announced via the openSUSE-SU-2019:2441_1 advisory.");
