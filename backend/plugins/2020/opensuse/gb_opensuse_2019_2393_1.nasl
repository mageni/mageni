...
if(description)
{
  ...
  script_name("openSUSE Update for python openSUSE-SU-2019:2393-1 (python)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00063.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python'
  package(s) announced via the openSUSE-SU-2019:2393_1 advisory.");
