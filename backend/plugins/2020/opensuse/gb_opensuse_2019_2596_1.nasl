...
if(description)
{
  ...
  script_name("openSUSE Update for cpio openSUSE-SU-2019:2596-1 (cpio)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00076.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cpio'
  package(s) announced via the openSUSE-SU-2019:2596_1 advisory.");
