...
if(description)
{
  ...
  script_name("openSUSE Update for MozillaFirefox openSUSE-SU-2019:1595-1 (MozillaFirefox)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00055.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox'
  package(s) announced via the openSUSE-SU-2019:1595_1 advisory.");
