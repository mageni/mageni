...
if(description)
{
  ...
  script_name("openSUSE Update for nmap openSUSE-SU-2019:2200-1 (nmap)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00075.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nmap'
  package(s) announced via the openSUSE-SU-2019:2200_1 advisory.");
