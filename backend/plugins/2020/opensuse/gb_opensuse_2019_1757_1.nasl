...
if(description)
{
  ...
  script_name("openSUSE Update for the openSUSE-SU-2019:1757-1 (the)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00025.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the'
  package(s) announced via the openSUSE-SU-2019:1757_1 advisory.");
