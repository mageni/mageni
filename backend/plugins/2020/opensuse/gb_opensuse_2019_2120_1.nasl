...
if(description)
{
  ...
  script_name("openSUSE Update for nginx openSUSE-SU-2019:2120-1 (nginx)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00035.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nginx'
  package(s) announced via the openSUSE-SU-2019:2120_1 advisory.");
