...
if(description)
{
  ...
  script_name("openSUSE Update for ibus openSUSE-SU-2019:2199-1 (ibus)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00074.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ibus'
  package(s) announced via the openSUSE-SU-2019:2199_1 advisory.");
