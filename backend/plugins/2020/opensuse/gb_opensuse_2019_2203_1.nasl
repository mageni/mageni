...
if(description)
{
  ...
  script_name("openSUSE Update for rust openSUSE-SU-2019:2203-1 (rust)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00076.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust'
  package(s) announced via the openSUSE-SU-2019:2203_1 advisory.");
