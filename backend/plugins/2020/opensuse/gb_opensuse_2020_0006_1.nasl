...
if(description)
{
  ...
  script_name("openSUSE Update for chromium openSUSE-SU-2020:0006-1 (chromium)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-01/msg00004.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the openSUSE-SU-2020:0006_1 advisory.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libre2", rpm:"libre2~0~20200101~lp151.10.6.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libre2", rpm:"libre2~0~debuginfo~20200101~lp151.10.6.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libre2", rpm:"libre2~0~32bit~20200101~lp151.10.6.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libre2", rpm:"libre2~0~32bit~debuginfo~20200101~lp151.10.6.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
