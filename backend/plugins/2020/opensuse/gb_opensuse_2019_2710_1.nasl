...
if(description)
{
  ...
  script_name("openSUSE Update for spectre-meltdown-checker openSUSE-SU-2019:2710-1 (spectre-meltdown-checker)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-12/msg00042.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spectre-meltdown-checker'
  package(s) announced via the openSUSE-SU-2019:2710_1 advisory.");
