...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878214");
  ...
  script_name("Fedora: Security Advisory for roundcubemail (FEDORA-2020-d0f8f20cfc)");
  ...
  script_xref(name:"FEDORA", value:"2020-d0f8f20cfc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3DAXK3565NYK4OEZVTW6S5LEVIDQEY2E");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail'
  package(s) announced via the FEDORA-2020-d0f8f20cfc advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.4.8~1.fc32", rls:"FC32"))) {
    report += res;
  }
