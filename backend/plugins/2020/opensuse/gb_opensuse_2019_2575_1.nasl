...
if(description)
{
  ...
  script_name("openSUSE Update for cups openSUSE-SU-2019:2575-1 (cups)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00070.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups'
  package(s) announced via the openSUSE-SU-2019:2575_1 advisory.");
