...
if(description)
{
  ...
  script_name("openSUSE Update for gdb openSUSE-SU-2019:2494-1 (gdb)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00028.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdb'
  package(s) announced via the openSUSE-SU-2019:2494_1 advisory.");
