...
if(description)
{
  ...
  script_name("openSUSE Update for osc openSUSE-SU-2019:1844-1 (osc)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'osc'
  package(s) announced via the openSUSE-SU-2019:1844_1 advisory.");
