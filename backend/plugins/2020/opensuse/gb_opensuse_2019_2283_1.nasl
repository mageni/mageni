...
if(description)
{
  ...
  script_name("openSUSE Update for libseccomp openSUSE-SU-2019:2283-1 (libseccomp)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00022.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libseccomp'
  package(s) announced via the openSUSE-SU-2019:2283_1 advisory.");
