...
if(description)
{
  ...
  script_name("openSUSE Update for libvirt openSUSE-SU-2019:1753-1 (libvirt)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00019.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt'
  package(s) announced via the openSUSE-SU-2019:1753_1 advisory.");
