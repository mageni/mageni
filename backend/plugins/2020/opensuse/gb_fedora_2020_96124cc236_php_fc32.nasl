...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878205");
  ...
  script_name("Fedora: Security Advisory for php (FEDORA-2020-96124cc236)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/V5UTOSTWSMQ2SSNZBURRF3QWT5J33ARJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php'
  package(s) announced via the FEDORA-2020-96124cc236 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php", rpm:"php~7.4.9~1.fc32", rls:"FC32"))) {
    report += res;
  }
