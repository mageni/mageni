...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-01/msg00059.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman'
  package(s) announced via the openSUSE-SU-2020:0148_1 advisory.");
  ...
  Could be exploited by a local users who is members of the the mailman
  group. (boo#1154328)
