...
if(description)
{
  ...
  script_cve_id("CVE-2019-2737", "CVE-2019-2739", "CVE-2019-2740", "CVE-2019-2758",
  ...
  script_name("openSUSE Update for mariadb openSUSE-SU-2019:2698-1 (mariadb)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-12/msg00037.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb'
  package(s) announced via the openSUSE-SU-2019:2698_1 advisory.");
