...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853461");
  ...
  script_tag(name:"creation_date", value:"2020-09-28 03:00:44 +0000 (Mon, 28 Sep 2020)");
  script_name("openSUSE: Security Advisory for conmon, (openSUSE-SU-2020:1552-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1552-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-09/msg00097.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'conmon, '
  package(s) announced via the openSUSE-SU-2020:1552-1 advisory.");
  ...
  * Bugfixes
  ...
  script_tag(name:"affected", value:"'conmon, ' package(s) on openSUSE Leap 15.1.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"conmon", rpm:"conmon~2.0.20~lp151.5.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"conmon-debuginfo", rpm:"conmon-debuginfo~2.0.20~lp151.5.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fuse-overlayfs", rpm:"fuse-overlayfs~1.1.2~lp151.8.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fuse-overlayfs-debuginfo", rpm:"fuse-overlayfs-debuginfo~1.1.2~lp151.8.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fuse-overlayfs-debugsource", rpm:"fuse-overlayfs-debugsource~1.1.2~lp151.8.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~2.0.6~lp151.3.21.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcontainers-common", rpm:"libcontainers-common~20200727~lp151.2.10.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman-cni-config", rpm:"podman-cni-config~2.0.6~lp151.3.21.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
