...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817258");
  ...
  script_tag(name:"creation_date", value:"2020-08-03 13:38:47 +0530 (Mon, 03 Aug 2020)");
  script_name("Libre Office Multiple Vulnerabilities(June-2020)-MacOSX");

  script_tag(name:"summary", value:"The host is installed with Libre Office
  ...
  script_tag(name:"affected", value:"Libre Office before version 6.4.4 on MacOSX.");

  script_tag(name:"solution", value:"Upgrade to Libre Office 6.4.4
...
if(version_is_less(version:libre_ver, test_version:"6.4.4")){
  report = report_fixed_ver(installed_version:libre_ver, fixed_version:"6.4.4", install_path:libre_path);
