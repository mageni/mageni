...
if(description)
{
  ...
  script_tag(name:"impact", value:"A group-share recipient can remove the received group share for all
  ...
  script_xref(name:"URL", value:"https://owncloud.com/security/deleting-received-group-share-for-whole-group/");
