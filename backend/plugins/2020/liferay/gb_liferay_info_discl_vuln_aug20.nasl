...
if (description)
{
  ...
  script_version("2020-09-28T09:47:49+0000");
  ...
  script_tag(name:"summary", value:"Liferay Portal is prone to an information disclosure vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Liferay Portal does not decode a URL before determining if the resource should
  be served, which allows remote attackers to access restricted portlet resources (e.g., files within /META-INF
  and /WEB-IN) via double encoded URLs.");
...
if (version_is_less(version: version, test_verison: "7.3.1")) {
