...
if (description)
{
  ...
  script_version("2020-03-23T04:55:02+0000");
  script_tag(name:"last_modification", value:"2020-03-23 04:55:02 +0000 (Mon, 23 Mar 2020)");
  ...
  script_name("Liferay Portal < 7.2.1 RCE Vulnerability");
  ...
  script_tag(name:"summary", value:"Liferay Portal is prone to an unauthenticated remote code execution vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Deserialization of Untrusted Data in Liferay Portal allows remote attackers
