...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2148");
  ...
  script_tag(name:"creation_date", value:"2020-09-29 13:48:49 +0000 (Tue, 29 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for giflib (EulerOS-SA-2020-2148)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2148");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2148");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'giflib' package(s) announced via the EulerOS-SA-2020-2148 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"giflib", rpm:"giflib~4.1.6~9.h4", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
