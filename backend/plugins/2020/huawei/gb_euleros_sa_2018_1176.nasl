...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2018.1176");
  ...
  script_tag(name:"creation_date", value:"2020-01-23 11:15:57 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for libvncserver (EulerOS-SA-2018-1176)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1176");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libvncserver' package(s) announced via the EulerOS-SA-2018-1176 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvncserver", rpm:"libvncserver~0.9.9~12.h1", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
