...
if(description)
{
  ...
  script_version("2020-05-26T05:46:00+0000");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-paramiko (EulerOS-SA-2020-1589)");
  ...
  'python-paramiko' package(s) announced via the EulerOS-SA-2020-1589 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-paramiko", rpm:"python2-paramiko~2.4.1~5.h1.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-paramiko", rpm:"python3-paramiko~2.4.1~5.h1.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
