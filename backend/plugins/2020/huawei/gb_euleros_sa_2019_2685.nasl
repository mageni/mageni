...
if(description)
{
  ...
  script_version("2020-01-23T13:13:55+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 13:13:55 +0000 (Thu, 23 Jan 2020)");
  ...
  'zziplib' package(s) announced via the EulerOS-SA-2019-2685 advisory.");
