...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2018.1117");
  script_version("2020-01-23T11:13:08+0000");
  script_cve_id("CVE-2018-5125", "CVE-2018-5127", "CVE-2018-5129", "CVE-2018-5130", "CVE-2018-5131", "CVE-2018-5144", "CVE-2018-5145", "CVE-2018-5146");
  ...
  script_name("Huawei EulerOS: Security Advisory for firefox (EulerOS-SA-2018-1117)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1117");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'firefox' package(s) announced via the EulerOS-SA-2018-1117 advisory.");
...
if(release == "EULEROS-2.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~52.7.2~1.h1", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
