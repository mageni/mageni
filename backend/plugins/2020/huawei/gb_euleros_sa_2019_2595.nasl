...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2595");
  script_version("2020-01-23T13:08:02+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 13:08:02 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 13:08:02 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for irssi (EulerOS-SA-2019-2595)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2595");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'irssi' package(s) announced via the EulerOS-SA-2019-2595 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in Irssi before 1.0.4. When receiving messages with invalid time stamps, Irssi would try to dereference a NULL pointer.(CVE-2017-10965)
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"irssi", rpm:"irssi~0.8.15~16.h9", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
