...
if(description)
{
  ...
  script_version("2020-01-23T11:17:26+0000");
  script_cve_id("CVE-2017-10140");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:17:26 +0000 (Thu, 23 Jan 2020)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1205");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'postfix' package(s) announced via the EulerOS-SA-2018-1205 advisory.");
