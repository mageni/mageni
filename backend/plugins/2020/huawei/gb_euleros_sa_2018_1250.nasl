...
if(description)
{
  ...
  script_version("2020-01-23T11:18:58+0000");
  script_cve_id("CVE-2018-5732", "CVE-2018-5733");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:18:58 +0000 (Thu, 23 Jan 2020)");
  ...
  'dhcp' package(s) announced via the EulerOS-SA-2018-1250 advisory.");
