...
if(description)
{
  ...
  script_version("2020-04-30T12:13:56+0000");
  script_cve_id("CVE-2019-15540", "CVE-2019-15757");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-04-30 12:13:56 +0000 (Thu, 30 Apr 2020)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1565");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libmirage' package(s) announced via the EulerOS-SA-2020-1565 advisory.");
