...
if(description)
{
  ...
  script_version("2020-01-23T11:41:27+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:41:27 +0000 (Thu, 23 Jan 2020)");
  ...
  'httpd' package(s) announced via the EulerOS-SA-2019-1389 advisory.");
