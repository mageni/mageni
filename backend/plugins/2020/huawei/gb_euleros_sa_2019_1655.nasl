...
if(description)
{
  ...
  script_version("2020-01-23T12:19:08+0000");
  script_cve_id("CVE-2019-11036");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:19:08 +0000 (Thu, 23 Jan 2020)");
  ...
  'php' package(s) announced via the EulerOS-SA-2019-1655 advisory.");
