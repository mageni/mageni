...
if(description)
{
  ...
  script_version("2020-01-23T12:26:54+0000");
  script_cve_id("CVE-2018-6954", "CVE-2019-3842");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 12:26:54 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgudev1-219", rpm:"libgudev1-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-219", rpm:"systemd-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-libs-219", rpm:"systemd-libs-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-networkd-219", rpm:"systemd-networkd-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-python-219", rpm:"systemd-python-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-resolved-219", rpm:"systemd-resolved-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-sysv-219", rpm:"systemd-sysv-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"systemd-udev-compat-219", rpm:"systemd-udev-compat-219~62.5.h107", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
