...
if(description)
{
  ...
  script_version("2020-01-23T12:17:22+0000");
  script_cve_id("CVE-2019-3835", "CVE-2019-3838", "CVE-2019-3839", "CVE-2019-6116");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:17:22 +0000 (Thu, 23 Jan 2020)");
  ...
  'ghostscript' package(s) announced via the EulerOS-SA-2019-1613 advisory.");
