...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1660");
  ...
  script_name("Huawei EulerOS: Security Advisory for dnsmasq (EulerOS-SA-2020-1660)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1660");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1660");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'dnsmasq' package(s) announced via the EulerOS-SA-2020-1660 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.76~2.2.h1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dnsmasq-utils", rpm:"dnsmasq-utils~2.76~2.2.h1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
