...
if(description)
{
  ...
  script_version("2020-01-23T13:13:27+0000");
  script_cve_id("CVE-2018-1304", "CVE-2018-1305", "CVE-2018-8034");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 13:13:27 +0000 (Thu, 23 Jan 2020)");
  ...
  'tomcat' package(s) announced via the EulerOS-SA-2019-2675 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-el", rpm:"tomcat-el~2.2~api~7.0.76~8.h6", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat-jsp", rpm:"tomcat-jsp~2.2~api~7.0.76~8.h6", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-servlet", rpm:"tomcat-servlet~3.0~api~7.0.76~8.h6", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
