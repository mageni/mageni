...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1375");
  ...
  script_name("Huawei EulerOS: Security Advisory for augeas (EulerOS-SA-2019-1375)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1375");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'augeas' package(s) announced via the EulerOS-SA-2019-1375 advisory.");
  ...
  script_tag(name:"affected", value:"'augeas' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.1.0.");
...
if(release == "EULEROSVIRTARM64-3.0.1.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"augeas-libs", rpm:"augeas-libs~1.4.0~5.1", rls:"EULEROSVIRTARM64-3.0.1.0"))) {
    report += res;
  }
