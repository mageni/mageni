...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1939");
  ...
  script_tag(name:"creation_date", value:"2020-09-04 16:35:22 +0000 (Fri, 04 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for libjpeg-turbo (EulerOS-SA-2020-1939)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1939");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1939");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libjpeg-turbo' package(s) announced via the EulerOS-SA-2020-1939 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libjpeg-turbo", rpm:"libjpeg-turbo~1.2.90~6.h7.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libjpeg-turbo-devel", rpm:"libjpeg-turbo-devel~1.2.90~6.h7.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
