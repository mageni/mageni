...
if(description)
{
  ...
  script_version("2020-02-25T13:57:41+0000");
  script_cve_id("CVE-2019-14889");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-02-25 13:57:41 +0000 (Tue, 25 Feb 2020)");
  ...
  'libssh' package(s) announced via the EulerOS-SA-2020-1164 advisory.");
