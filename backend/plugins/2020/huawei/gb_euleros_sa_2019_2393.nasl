...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2393");
  script_version("2020-01-23T12:53:16+0000");
  script_cve_id("CVE-2014-4617", "CVE-2018-9234");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:53:16 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:53:16 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for gnupg2 (EulerOS-SA-2019-2393)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2393");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'gnupg2' package(s) announced via the EulerOS-SA-2019-2393 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnupg2", rpm:"gnupg2~2.0.22~5.h2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
