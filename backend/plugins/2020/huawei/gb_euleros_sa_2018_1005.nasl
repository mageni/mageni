...
if(description)
{
  ...
  script_version("2020-01-23T11:08:04+0000");
  script_cve_id("CVE-2017-16879");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:08:04 +0000 (Thu, 23 Jan 2020)");
  ...
  'ncurses' package(s) announced via the EulerOS-SA-2018-1005 advisory.");
