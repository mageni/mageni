...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2435");
  script_version("2020-01-23T12:56:38+0000");
  script_cve_id("CVE-2017-11108", "CVE-2017-11541", "CVE-2017-11542", "CVE-2017-11543");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:56:38 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:56:38 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for tcpdump (EulerOS-SA-2019-2435)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2435");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'tcpdump' package(s) announced via the EulerOS-SA-2019-2435 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpdump", rpm:"tcpdump~4.9.0~5.h176", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
