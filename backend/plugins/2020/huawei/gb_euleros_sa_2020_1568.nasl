...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1568");
  script_version("2020-04-30T12:14:02+0000");
  script_cve_id("CVE-2017-15422", "CVE-2020-10531");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-04-30 12:14:02 +0000 (Thu, 30 Apr 2020)");
  script_tag(name:"creation_date", value:"2020-04-30 12:14:02 +0000 (Thu, 30 Apr 2020)");
  script_name("Huawei EulerOS: Security Advisory for icu (EulerOS-SA-2020-1568)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1568");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'icu' package(s) announced via the EulerOS-SA-2020-1568 advisory.");
