...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2428");
  script_version("2020-11-04T08:56:44+0000");
  ...
  script_tag(name:"creation_date", value:"2020-11-04 08:56:44 +0000 (Wed, 04 Nov 2020)");
  script_name("Huawei EulerOS: Security Advisory for dpdk (EulerOS-SA-2020-2428)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2428");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2428");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'dpdk' package(s) announced via the EulerOS-SA-2020-2428 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dpdk", rpm:"dpdk~19.11~0.h16.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dpdk-tools", rpm:"dpdk-tools~19.11~0.h16.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
