...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1981");
  ...
  script_tag(name:"creation_date", value:"2020-09-08 08:08:04 +0000 (Tue, 08 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for wpa_supplicant (EulerOS-SA-2020-1981)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1981");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1981");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'wpa_supplicant' package(s) announced via the EulerOS-SA-2020-1981 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~2.6~9.h7", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
