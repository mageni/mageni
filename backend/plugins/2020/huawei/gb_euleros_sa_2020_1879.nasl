...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1879");
  script_version("2020-08-31T07:04:08+0000");
  ...
  script_tag(name:"creation_date", value:"2020-08-31 07:04:08 +0000 (Mon, 31 Aug 2020)");
  script_name("Huawei EulerOS: Security Advisory for python-waitress (EulerOS-SA-2020-1879)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1879");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1879");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'python-waitress' package(s) announced via the EulerOS-SA-2020-1879 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-waitress", rpm:"python2-waitress~1.1.0~6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
