...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2017.1320");
  ...
  script_tag(name:"creation_date", value:"2020-01-23 11:07:01 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for qemu-kvm (EulerOS-SA-2017-1320)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1320");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'qemu-kvm' package(s) announced via the EulerOS-SA-2017-1320 advisory.");
...
if(release == "EULEROS-2.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~1.5.3~141.4.h2", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
