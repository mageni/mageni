...
if(description)
{
  ...
  script_version("2020-01-23T10:57:37+0000");
  script_cve_id("CVE-2017-7488");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 10:57:37 +0000 (Thu, 23 Jan 2020)");
  ...
  'authconfig' package(s) announced via the EulerOS-SA-2017-1196 advisory.");
