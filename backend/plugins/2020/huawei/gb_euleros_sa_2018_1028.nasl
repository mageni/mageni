...
if(description)
{
  ...
  script_version("2020-01-23T11:09:06+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:09:06 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~1.8.0.161~0.b14", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~devel~1.8.0.161~0.b14", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~headless~1.8.0.161~0.b14", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
