...
if(description)
{
  ...
  script_version("2020-01-23T11:10:51+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:10:51 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~1.7.0.171~2.6.13.0", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~devel~1.7.0.171~2.6.13.0", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~headless~1.7.0.171~2.6.13.0", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
