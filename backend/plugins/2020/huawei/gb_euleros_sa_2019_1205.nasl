...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1205");
  script_version("2020-01-23T11:34:33+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:34:33 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 11:34:33 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for ghostscript (EulerOS-SA-2019-1205)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1205");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'ghostscript' package(s) announced via the EulerOS-SA-2019-1205 advisory.");
...
if(release == "EULEROSVIRT-2.5.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~9.07~31.6.h1", rls:"EULEROSVIRT-2.5.3"))) {
    report += res;
  }
