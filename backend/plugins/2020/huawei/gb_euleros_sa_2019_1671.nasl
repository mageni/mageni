...
if(description)
{
  ...
  script_version("2020-01-23T12:19:35+0000");
  script_cve_id("CVE-2019-11487");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 12:19:35 +0000 (Thu, 23 Jan 2020)");
  ...
  'kernel' package(s) announced via the EulerOS-SA-2019-1671 advisory.");
