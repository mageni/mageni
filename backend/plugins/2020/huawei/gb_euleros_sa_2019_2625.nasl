...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.2625");
  script_version("2020-01-23T13:10:01+0000");
  script_cve_id("CVE-2017-13720", "CVE-2017-13722", "CVE-2017-16611");
  script_tag(name:"cvss_base", value:"3.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:10:01 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 13:10:01 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for libXfont (EulerOS-SA-2019-2625)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2625");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libXfont' package(s) announced via the EulerOS-SA-2019-2625 advisory.");
...
In the pcfGetProperties function in bitmap/pcfread.c in libXfont through 1.5.2 and 2.x before 2.0.2, a missing boundary check (for PCF files) could be used by local attackers authenticated to an Xserver for a buffer over-read, for information disclosure or a crash of the X server.(CVE-2017-13722)");
  ...
  script_tag(name:"affected", value:"'libXfont' package(s) on Huawei EulerOS V2.0SP3.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libXfont", rpm:"libXfont~1.5.2~1.h1", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
