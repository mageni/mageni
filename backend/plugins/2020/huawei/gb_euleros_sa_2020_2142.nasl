...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2142");
  script_version("2020-09-29T14:06:08+0000");
  script_cve_id("CVE-2020-12767", "CVE-2020-13112", "CVE-2020-13113", "CVE-2020-13114");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-09-29 14:06:08 +0000 (Tue, 29 Sep 2020)");
  script_tag(name:"creation_date", value:"2020-09-29 13:48:00 +0000 (Tue, 29 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for libexif (EulerOS-SA-2020-2142)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2142");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2142");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libexif' package(s) announced via the EulerOS-SA-2020-2142 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"exif_entry_get_value in exif-entry.c in libexif 0.6.21 has a divide-by-zero error.(CVE-2020-12767)
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libexif", rpm:"libexif~0.6.21~6.h4", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
