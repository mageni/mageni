...
if(description)
{
  ...
  script_version("2020-01-23T11:37:46+0000");
  script_cve_id("CVE-2015-3202");
  script_tag(name:"cvss_base", value:"3.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:37:46 +0000 (Thu, 23 Jan 2020)");
  ...
  'fuse' package(s) announced via the EulerOS-SA-2019-1286 advisory.");
