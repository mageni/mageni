...
if(description)
{
  ...
  script_version("2020-01-23T12:47:54+0000");
  script_cve_id("CVE-2018-16872", "CVE-2018-19364", "CVE-2018-19489", "CVE-2019-3812", "CVE-2019-6778");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:47:54 +0000 (Thu, 23 Jan 2020)");
  ...
  'qemu-kvm' package(s) announced via the EulerOS-SA-2019-2352 advisory.");
