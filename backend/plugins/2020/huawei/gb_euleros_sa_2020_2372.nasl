...
if(description)
{
  ...
  script_version("2020-11-04T08:54:47+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2372");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2372");
