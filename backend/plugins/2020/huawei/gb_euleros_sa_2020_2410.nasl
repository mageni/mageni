...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2410");
  script_version("2020-11-04T08:56:12+0000");
  ...
  script_tag(name:"creation_date", value:"2020-11-04 08:56:12 +0000 (Wed, 04 Nov 2020)");
  script_name("Huawei EulerOS: Security Advisory for dpdk (EulerOS-SA-2020-2410)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2410");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2410");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'dpdk' package(s) announced via the EulerOS-SA-2020-2410 advisory.");
...
An integer underflow in dpdk versions before 18.11.10 and before 19.11.5 in the `move_desc` function can lead to large amounts of CPU cycles being eaten up in a long running loop. An attacker could cause `move_desc` to get stuck in a 4,294,967,295-count iteration loop. Depending on how `vhost_crypto` is being used this could prevent other VMs or network tasks from being serviced by the busy DPDK lcore for an extended period.(CVE-2020-14378)");
  ...
  script_tag(name:"affected", value:"'dpdk' package(s) on Huawei EulerOS V2.0SP9.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dpdk", rpm:"dpdk~19.11~0.h16.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dpdk-tools", rpm:"dpdk-tools~19.11~0.h16.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
