...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.107822");
  ...
  script_cve_id("CVE-2017-17202");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Huawei Data Communication: Out-Of-Bounds Read Vulnerability (huawei-sa-20180131-01-sip)");
  ...
  script_tag(name:"summary", value:"Some Huawei products have an out-of-bounds read vulnerability due to
  insufficient input validation.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Some Huawei products have an out-of-bounds read vulnerability due to
  insufficient input validation.");

  script_tag(name:"impact", value:"An unauthenticated, remote attacker could exploit this vulnerability by
  sending malformed Session Initiation Protocol(SIP) packets to the target device. Successful exploitation
  could make the device read out of bounds and thus cause a service to be unavailable.");
  ...
  script_xref(name:"URL", value:"https://www.huawei.com/en/psirt/security-advisories/huawei-sa-20180131-01-sip-en");
