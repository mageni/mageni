...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2282");
  script_version("2020-10-30T10:45:35+0000");
  ...
  script_tag(name:"creation_date", value:"2020-10-30 10:45:35 +0000 (Fri, 30 Oct 2020)");
  script_name("Huawei EulerOS: Security Advisory for ghostscript (EulerOS-SA-2020-2282)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2282");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2282");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'ghostscript' package(s) announced via the EulerOS-SA-2020-2282 advisory.");
...
A buffer overflow vulnerability in GetNumSameData() in contrib/li ...
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~9.07~31.6.h19.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ghostscript-cups", rpm:"ghostscript-cups~9.07~31.6.h19.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
