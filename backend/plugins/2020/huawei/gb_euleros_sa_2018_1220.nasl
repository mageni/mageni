...
if(description)
{
  ...
  script_version("2020-01-23T11:17:54+0000");
  script_cve_id("CVE-2018-8014");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:17:54 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-el", rpm:"tomcat-el~2.2~api~7.0.76~3.h1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat-jsp", rpm:"tomcat-jsp~2.2~api~7.0.76~3.h1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-servlet", rpm:"tomcat-servlet~3.0~api~7.0.76~3.h1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
