...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1139");
  script_version("2020-02-24T09:07:35+0000");
  ...
  script_tag(name:"creation_date", value:"2020-02-24 09:07:35 +0000 (Mon, 24 Feb 2020)");
  script_name("Huawei EulerOS: Security Advisory for wireshark (EulerOS-SA-2020-1139)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1139");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'wireshark' package(s) announced via the EulerOS-SA-2020-1139 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In Wireshark 2.4.0 to 2.4.13, 2.6.0 to 2.6.7, and 3.0.0, the NetScaler file parser could crash. This was addressed in wiretap/netscaler.c by improving data validation.(CVE-2019-10895)
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~1.10.14~14.h4.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wireshark-gnome", rpm:"wireshark-gnome~1.10.14~14.h4.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
