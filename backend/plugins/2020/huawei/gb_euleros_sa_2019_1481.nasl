...
if(description)
{
  ...
  script_version("2020-01-23T11:52:15+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:52:15 +0000 (Thu, 23 Jan 2020)");
  ...
  'kernel' package(s) announced via the EulerOS-SA-2019-1481 advisory.");
...
A flaw was found in the way the Linux kernel's VFS subsystem handled reference counting when performing unmou ...
