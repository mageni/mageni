...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1971");
  script_version("2020-01-23T12:29:00+0000");
  script_cve_id("CVE-2017-10965", "CVE-2017-10966", "CVE-2017-5193", "CVE-2017-5194", "CVE-2017-5356", "CVE-2017-9468", "CVE-2017-9469");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:29:00 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 12:29:00 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for irssi (EulerOS-SA-2019-1971)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1971");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'irssi' package(s) announced via the EulerOS-SA-2019-1971 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The nickcmp function in Irssi before 0.8.21 allows remote attackers to cause a denial of service (NULL pointer dereference and crash) via a message without a nick.(CVE-2017-5193)
...
An issue was discovered in Irssi before 1.0.4. While updating the internal nick list, Irssi could incorrectly use the GHashTable interface and free the nick while updating it. This would then result in use-after-free conditions on each access of the hash table.(CVE-2017-10966)");
  ...
  script_tag(name:"affected", value:"'irssi' package(s) on Huawei EulerOS V2.0SP5.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"irssi", rpm:"irssi~0.8.15~16.h8.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
