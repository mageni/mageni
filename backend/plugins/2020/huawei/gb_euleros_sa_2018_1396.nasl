...
if(description)
{
  ...
  script_version("2020-01-23T11:24:29+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:24:29 +0000 (Thu, 23 Jan 2020)");
  ...
  'zsh' package(s) announced via the EulerOS-SA-2018-1396 advisory.");
