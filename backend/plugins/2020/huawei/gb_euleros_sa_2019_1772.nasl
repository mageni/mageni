...
if(description)
{
  ...
  script_version("2020-01-23T12:22:01+0000");
  script_cve_id("CVE-2018-11784", "CVE-2019-0199");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:22:01 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-el", rpm:"tomcat-el~3.0~api~9.0.10~1.h2.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat-jsp", rpm:"tomcat-jsp~2.3~api~9.0.10~1.h2.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-servlet", rpm:"tomcat-servlet~4.0~api~9.0.10~1.h2.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
