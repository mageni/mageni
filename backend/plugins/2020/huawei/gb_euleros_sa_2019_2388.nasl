...
if(description)
{
  ...
  script_version("2020-01-23T12:52:57+0000");
  script_cve_id("CVE-2016-2145", "CVE-2016-2146", "CVE-2017-6807");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:52:57 +0000 (Thu, 23 Jan 2020)");
  ...
  'mod_auth_mellon' package(s) announced via the EulerOS-SA-2019-2388 advisory.");
