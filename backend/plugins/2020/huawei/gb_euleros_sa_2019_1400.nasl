...
if(description)
{
  ...
  script_version("2020-01-23T11:41:57+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:41:57 +0000 (Thu, 23 Jan 2020)");
  ...
  'openssl' package(s) announced via the EulerOS-SA-2019-1400 advisory.");
...
Libgcrypt before 1.7.10 and 1.8.x before 1.8.3 allows a memory-cache side-channel attack on ECDSA signatures that can be mitigated through the use of blinding during the signing process in the _gcry_ecc_ecdsa_sign function in cipher/ecc-ecdsa.c, aka the Return Of the Hidde ...
