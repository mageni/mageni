...
if(description)
{
  ...
  script_version("2020-01-23T13:01:42+0000");
  script_cve_id("CVE-2015-7555", "CVE-2016-3977", "CVE-2019-15133");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:01:42 +0000 (Thu, 23 Jan 2020)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2498");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'giflib' package(s) announced via the EulerOS-SA-2019-2498 advisory.");
