...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1583");
  ...
  script_name("Huawei EulerOS: Security Advisory for ksh (EulerOS-SA-2020-1583)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1583");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'ksh' package(s) announced via the EulerOS-SA-2020-1583 advisory.");
  ...
  script_tag(name:"affected", value:"'ksh' package(s) on Huawei EulerOS V2.0SP8.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ksh", rpm:"ksh~20120801~248.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
