...
if(description)
{
  ...
  script_version("2020-01-23T11:18:08+0000");
  script_cve_id("CVE-2018-10841");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:18:08 +0000 (Thu, 23 Jan 2020)");
  ...
  'glusterfs' package(s) announced via the EulerOS-SA-2018-1229 advisory.");
