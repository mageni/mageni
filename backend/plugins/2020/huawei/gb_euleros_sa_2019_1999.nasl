...
if(description)
{
  ...
  script_version("2020-01-23T12:30:27+0000");
  script_cve_id("CVE-2013-4533", "CVE-2013-4534", "CVE-2013-4537", "CVE-2013-4538");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:30:27 +0000 (Thu, 23 Jan 2020)");
  ...
  'qemu-kvm' package(s) announced via the EulerOS-SA-2019-1999 advisory.");
