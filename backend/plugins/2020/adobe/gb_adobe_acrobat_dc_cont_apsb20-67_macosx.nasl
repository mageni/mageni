...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817813");
  ...
  script_tag(name:"creation_date", value:"2020-11-04 17:59:20 +0530 (Wed, 04 Nov 2020)");
  script_name("Adobe Acrobat DC (Continuous) Security Updates(apsb20-67)-Mac OS X");
  ...
  to version 2020.013.20064  on Mac OS X.");
