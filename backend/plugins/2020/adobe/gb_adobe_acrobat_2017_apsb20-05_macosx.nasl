...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816569");
  ...
  script_name("Adobe Acrobat 2017 Security Updates(apsb20-05)-MAC OS X");
...
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"17.011.30158(2017.011.30158)", install_path:InstallPath);
