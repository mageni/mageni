...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816573");
  ...
  script_name("Adobe Reader DC Security Updates(apsb20-05)-Windows");
  ...
  versions before 2020.006.20034 on Windows.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC (Continuous)
  to version 2020.006.20034 or later. Please see the references for more information.");
...
if(version_in_range(version:readerVer, test_version:"20.0", test_version2:"20.006.20033"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"20.006.20033 (2020.006.20034)", install_path:InstallPath);
