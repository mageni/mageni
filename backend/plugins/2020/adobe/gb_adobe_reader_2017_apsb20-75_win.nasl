...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817867");
  ...
  script_name("Adobe Reader 2017 Security Update(apsb20-75) - Windows");
  ...
  2017.011.30188on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Reader 2017 version
  2017.011.30188or later. Please see the references for more information.");
