...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817817");
  ...
  script_tag(name:"creation_date", value:"2020-11-04 18:00:00 +0530 (Wed, 04 Nov 2020)");
  script_name("Adobe Reader DC 2020 Security Updates(apsb20-67)-Mac OS X");
  ...
  to version  on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Reader DC 2020 (Classic) to
