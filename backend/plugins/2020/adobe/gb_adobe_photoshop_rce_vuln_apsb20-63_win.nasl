...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817600");
  ...
  script_name("Adobe Photoshop CC RCE Vulnerability-APSB20-63 (Windows)");
  ...
  and Adobe Photoshop 2020 21.2.2 and earlier versions on Windows.");
