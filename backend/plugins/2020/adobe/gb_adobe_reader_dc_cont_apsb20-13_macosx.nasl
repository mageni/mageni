...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816812");
  ...
  script_name("Adobe Reader DC (Continuous) Security Updates(apsb20-13)-MAC OS X");
  ...
  versions before 2020.006.20042 on MAC OS X.");
