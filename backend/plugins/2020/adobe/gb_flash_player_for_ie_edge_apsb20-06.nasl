...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Adobe Flash Player 32.0.0.330 or later.
...
if(version_is_less(version:flashVer, test_version:"32.0.0.330"))
{
  report = report_fixed_ver(file_checked:flashPath,
                            file_version:flashVer, vulnerable_range:"Less than 32.0.0.330");
