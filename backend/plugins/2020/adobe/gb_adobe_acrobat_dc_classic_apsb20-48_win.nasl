...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817345");
  ...
  script_name("Adobe Acrobat DC 2015 Security Updates(apsb20-48)-Windows");
  ...
  to version 2015.006.30527 on Windows.");
...
if(version_in_range(version:readerVer, test_version:"15.0", test_version2:"15.006.30526"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"15.006.30527(2015.006.30527)", install_path:InstallPath);
