...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816577");
  ...
  script_name("Adobe Reader DC 2015 Security Updates(apsb20-05)-Windows");
  ...
  to version 2015.006.30510 on Windows.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC 2015 (Classic) to
  version 2015.006.30510 or later. Please see the references for more information.");
