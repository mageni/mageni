...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817351");
  ...
  script_name("Adobe Reader DC 2015 Security Updates(apsb20-48)-Windows");
...
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"15.006.30526(2015.006.30526)", install_path:InstallPath);
