...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817154");
  ...
  script_name("Adobe Flash Player Security Updates(apsb20-30)-Linux");
  ...
  script_tag(name:"affected", value:"Adobe Flash Player version before 32.0.0.387 on Linux.");
