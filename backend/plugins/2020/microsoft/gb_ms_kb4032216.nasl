...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815586");
  ...
  script_tag(name:"creation_date", value:"2020-04-15 09:31:42 +0530 (Wed, 15 Apr 2020)");
  script_name("Microsoft Publisher 2010 Service Pack 2 Remote Code Execution Vulnerability (KB4032216)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4032216");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4032216");
...
if(exeVer && exeVer =~ "^14.*")
{
  if(version_in_range(version:exeVer, test_version:"14.0", test_version2:"14.0.7248.4999"))
  {
