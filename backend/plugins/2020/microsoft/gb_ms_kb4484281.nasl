...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816880");
  ...
  script_tag(name:"creation_date", value:"2020-04-16 11:11:48 +0530 (Thu, 16 Apr 2020)");
  script_name("Microsoft Outlook 2013 Service Pack 1 Remote Code Execution Vulnerability (KB4484281)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484281");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484281");
...
if(version_in_range(version:outlookVer, test_version:"15.0", test_version2:"15.0.5233.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"15.0 - 15.0.5233.0999");
