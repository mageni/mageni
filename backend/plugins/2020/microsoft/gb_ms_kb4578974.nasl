...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817394");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB4578974)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4578974");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4578974");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9155"))
              {
                vulnerable_range = "2.0.50727 - 2.0.50727.9155" ;
                break;
              }
