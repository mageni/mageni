...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817391");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB4579979)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4579979");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4579979");
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            ...
            else if(version_in_range(version:dllVer, test_version:"4.6", test_version2:"4.7.3700"))
            {
