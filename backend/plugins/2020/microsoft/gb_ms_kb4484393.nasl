...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817635");
  ...
  script_name("Microsoft PowerPoint 2016 RCE Vulnerability (KB4484393)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484393");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484393");
...
foreach key(key_list)
{
  ...
  if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.5095.1000"))
  {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll",
                            file_version:exeVer, vulnerable_range:"16.0 - 16.0.5095.0999");
