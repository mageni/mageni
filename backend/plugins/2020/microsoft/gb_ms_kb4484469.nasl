...
if(description)
{
  ...
  update according to Microsoft KB4484469");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484469");
...
foreach key(key_list)
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"15.0", test_version2:"15.0.5275.0999"))
  {
    report = report_fixed_ver(file_checked:offPath + "\Mso.dll",
                              file_version:offexeVer, vulnerable_range:"15.0 - 15.0.5275.0999");
