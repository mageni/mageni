...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815765");
  ...
  script_tag(name:"creation_date", value:"2020-02-12 09:55:08 +0530 (Wed, 12 Feb 2020)");
  script_name("Microsoft Outlook 2016 Security Feature Bypass Vulnerability (KB4484250)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484250");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484250");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.4966.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.4966.0999");
