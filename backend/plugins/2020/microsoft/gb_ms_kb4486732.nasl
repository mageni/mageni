...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817856");
  ...
  script_name("Microsoft Outlook 2013 Service Pack 1 Denial of Service Vulnerability (KB4486732)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4486732");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4486732");
...
if(version_in_range(version:outlookVer, test_version:"15.0", test_version2:"15.0.5301.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "olmapi32.dll",
                            file_version:outlookVer, vulnerable_range:"15.0 - 15.0.5301.0999");
