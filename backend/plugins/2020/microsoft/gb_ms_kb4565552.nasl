...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817243");
  ...
  script_tag(name:"creation_date", value:"2020-07-16 16:02:42 +0530 (Thu, 16 Jul 2020)");
  script_name("Windows Modules Installer Elevation of Privilege Vulnerability (KB4565552)");

  script_tag(name:"summary", value:"This host is missing a important security
  update according to Microsoft KB4565552");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4565552");
...
if(version_in_range(version:fileVer, test_version:"10.0.17134.0", test_version2:"10.0.17134.1599"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Updateagent.dll",
                            file_version:fileVer, vulnerable_range:"10.0.17134.0 - 10.0.17134.1599");
