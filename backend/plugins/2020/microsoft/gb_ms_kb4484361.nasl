...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817050");
  ...
  script_tag(name:"creation_date", value:"2020-06-10 10:53:16 +0530 (Wed, 10 Jun 2020)");
  script_name("Microsoft Word 2013 Service Pack 1 Security Feature Bypass Vulnerability (KB4484361)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484361");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484361");
...
if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5249.1000"))
{
