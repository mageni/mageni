...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple flaws exists due to errors when the OneDrive for Windows
...
{
  report = report_fixed_ver(installed_version:version, fixed_version: "20.170.0824.0001");
