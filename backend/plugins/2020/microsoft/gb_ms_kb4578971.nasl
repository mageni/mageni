...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817397");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB4578971)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4578971");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4578971");
