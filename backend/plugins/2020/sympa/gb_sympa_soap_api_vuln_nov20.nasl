...
if(description)
{
  ...
  script_version("2020-12-15T05:31:27+0000");
  ...
  script_tag(name:"summary", value:"Sympa is prone to an authentication bypass vulnerability in the SOAP API.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Sympa allows remote attackers to obtain full SOAP API access by sending any
  arbitrary string (except one from an expired cookie) as the cookie value to authenticateAndRun.");

  script_tag(name:"impact", value:"Successful exploitation may allow an unauthenticated attacker to execute
  arbitrary SOAP API calls.");
