...
if(description)
{
  ...
  script_version("2020-04-07T08:10:29+0000");
  ...
  script_cve_id("CVE-2020-8637", "CVE-2020-8638", "CVE-2020-8639");
  ...
  - SQL injection in dragdroptreenodes.php via the node_id parameter.

  - SQL injection in planUrgency.php via the urgency parameter.

  - Arbitrary code execution due to unrestricted file uploads in keywordsImport.php.");
