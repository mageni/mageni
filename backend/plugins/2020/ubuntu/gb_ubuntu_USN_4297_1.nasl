...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for runc (USN-4297-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-March/005353.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc'
  package(s) announced via the USN-4297-1 advisory.");
...
(CVE-2019-19921)");
  ...
  script_tag(name:"affected", value:"'runc' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS.");
