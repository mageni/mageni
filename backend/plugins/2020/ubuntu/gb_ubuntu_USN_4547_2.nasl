...
if(description)
{
  ...
  script_cve_id("CVE-2018-20020", "CVE-2018-20021", "CVE-2018-20022", "CVE-2018-2024", "CVE-2018-20024");
  ...
  script_name("Ubuntu: Security Advisory for ssvnc (USN-4547-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-September/005665.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ssvnc'
  package(s) announced via the USN-4547-2 advisory.");
...
code. (CVE-2018-20020, CVE-2018-20021, CVE-2018-20022, CVE-2018-2024)");
  ...
  script_tag(name:"affected", value:"'ssvnc' package(s) on Ubuntu 16.04 LTS.");
