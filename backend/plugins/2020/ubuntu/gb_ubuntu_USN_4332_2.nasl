...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for file-roller (USN-4332-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-April/005404.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'file-roller'
  package(s) announced via the USN-4332-2 advisory.");
...
An attacker could possibly use this issue to expose sensitive information.");
  ...
  script_tag(name:"affected", value:"'file-roller' package(s) on Ubuntu 20.04 LTS.");
