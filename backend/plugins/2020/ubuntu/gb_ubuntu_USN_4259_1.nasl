...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for lucene-solr (USN-4259-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-January/005305.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lucene-solr'
  package(s) announced via the USN-4259-1 advisory.");
...
remotely execute code.");
  ...
  script_tag(name:"affected", value:"'lucene-solr' package(s) on Ubuntu 16.04 LTS.");
