...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for poppler (USN-4646-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-November/005777.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'poppler'
  package(s) announced via the USN-4646-1 advisory.");
