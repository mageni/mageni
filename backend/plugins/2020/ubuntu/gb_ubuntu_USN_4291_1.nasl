...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libapache2-mod-auth-mellon (USN-4291-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005344.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libapache2-mod-auth-mellon'
  package(s) announced via the USN-4291-1 advisory.");
...
malicious URL.");
  ...
  script_tag(name:"affected", value:"'libapache2-mod-auth-mellon' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-auth-mellon", ver:"0.14.2-1ubuntu1.19.10.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-auth-mellon", ver:"0.13.1-1ubuntu0.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
