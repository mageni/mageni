...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for postgresql-12 (USN-4633-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-November/005762.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-12'
  package(s) announced via the USN-4633-1 advisory.");
...
use this issue to execute arbitrary code. (CVE-2020-25696)");
  ...
  script_tag(name:"affected", value:"'postgresql-12' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
