...
if(description)
{
  ...
  script_cve_id("CVE-2017-1110", "CVE-2017-5953", "CVE-2018-20786", "CVE-2019-20079", "CVE-2017-6349", "CVE-2017-6350", "CVE-2017-11109");
  ...
  script_name("Ubuntu: Security Advisory for vim (USN-4309-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-March/005368.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the USN-4309-1 advisory.");
...
(CVE-2017-6349, CVE-2017-6350)");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
