...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for python-django (USN-4264-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005310.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django'
  package(s) announced via the USN-4264-1 advisory.");
...
injection attacks.");
  ...
  script_tag(name:"affected", value:"'python-django' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS.");
