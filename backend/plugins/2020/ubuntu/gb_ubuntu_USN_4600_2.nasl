...
if(description)
{
  ...
  script_cve_id("CVE-2019-20444", "CVE-2019-20445", "CVE-2020-11612", "CVE-2019-16869", "CVE-2020-7238");
  ...
  script_name("Ubuntu: Security Advisory for netty (USN-4600-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-October/005728.html");
  ...
  script_tag(name:"insight", value:"USN-4600-1 fixed multiple vunerabilities in Netty 3.9. This update provides
...
CVE-2019-20444, CVE-2019-20445, CVE-2020-7238)");
  ...
  script_tag(name:"affected", value:"'netty' package(s) on Ubuntu 18.04 LTS.");
