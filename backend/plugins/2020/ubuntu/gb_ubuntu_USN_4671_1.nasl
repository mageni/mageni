...
if(description)
{
  ...
  script_cve_id("CVE-2020-16042", "CVE-2020-26971", "CVE-2020-26972", "CVE-2020-26793", "CVE-2020-26974", "CVE-2020-26976", "CVE-2020-26978", "CVE-2020-26979", "CVE-2020-35113", "CVE-2020-35114", "CVE-2020-35111", "CVE-2020-26973");
  ...
  script_name("Ubuntu: Security Advisory for firefox (USN-4671-1)");
  ...
  script_xref(name:"USN", value:"4671-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-December/005811.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the USN-4671-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"84.0+build3-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"84.0+build3-0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"84.0+build3-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"84.0+build3-0ubuntu0.20.10.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
