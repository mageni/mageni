...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for miniupnpd (USN-4542-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-September/005651.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'miniupnpd'
  package(s) announced via the USN-4542-1 advisory.");
...
crash, resulting in a denial of service. (CVE-2019-12111)");
  ...
  script_tag(name:"affected", value:"'miniupnpd' package(s) on Ubuntu 16.04 LTS.");
