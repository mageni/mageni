...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libarchive (USN-4293-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-March/005347.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive'
  package(s) announced via the USN-4293-1 advisory.");
...
(CVE-2020-9308)");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libarchive13", ver:"3.4.0-1ubuntu0.1", rls:"UBUNTU19.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libarchive13", ver:"3.2.2-3.1ubuntu0.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libarchive13", ver:"3.1.2-11ubuntu0.16.04.8", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
