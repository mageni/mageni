...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for atftp (USN-4540-1)");
  ...
  script_xref(name:"USN", value:"4540-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-September/005650.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'atftp'
  package(s) announced via the USN-4540-1 advisory.");
...
crash, resulting in a denial of service. (CVE-2019-11366)");
  ...
  script_tag(name:"affected", value:"'atftp' package(s) on Ubuntu 18.04 LTS.");
