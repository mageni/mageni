...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883192");
  ...
  script_tag(name:"creation_date", value:"2020-02-28 04:01:25 +0000 (Fri, 28 Feb 2020)");
  script_name("CentOS: Security Advisory for java (CESA-2020:0632)");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-February/035651.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java'
  package(s) announced via the CESA-2020:0632 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-1.7.0.251", rpm:"java-1.7.0-openjdk-1.7.0.251~2.6.21.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-demo", rpm:"java-1.7.0-openjdk-demo~1.7.0.251~2.6.21.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.251~2.6.21.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-javadoc", rpm:"java-1.7.0-openjdk-javadoc~1.7.0.251~2.6.21.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-src", rpm:"java-1.7.0-openjdk-src~1.7.0.251~2.6.21.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }
