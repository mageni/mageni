...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883259");
  script_version("2020-07-09T12:15:58+0000");
  script_cve_id("CVE-2020-12418", "CVE-2020-12419", "CVE-2020-12420", "CVE-2020-12421");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-07-10 11:44:30 +0000 (Fri, 10 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-07-09 03:00:45 +0000 (Thu, 09 Jul 2020)");
  script_name("CentOS: Security Advisory for firefox (CESA-2020:2824)");
  ...
  script_xref(name:"CESA", value:"2020:2824");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-July/035776.html");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.10.0~1.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
