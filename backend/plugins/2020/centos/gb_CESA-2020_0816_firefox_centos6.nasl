...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883214");
  ...
  script_tag(name:"creation_date", value:"2020-03-26 04:01:25 +0000 (Thu, 26 Mar 2020)");
  script_name("CentOS: Security Advisory for firefox (CESA-2020:0816)");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-March/035686.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2020:0816 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.6.0~1.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
