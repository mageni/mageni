...
if(description)
{
  ...
  script_version("2020-08-17T08:58:48+0000");
  ...
  script_name("CMS Made Simple <= 2.2.14 Arbitrary File Upload Vulnerability");
  ...
  script_tag(name:"summary", value:"CMS Made Simple is prone to an arbitrary file upload vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability exists
  because the File Manager does not block .ptar files.");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 17th August, 2020.
