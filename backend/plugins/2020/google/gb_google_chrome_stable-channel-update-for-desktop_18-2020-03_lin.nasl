...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816711");
  ...
  script_tag(name:"creation_date", value:"2020-03-20 13:13:56 +0530 (Fri, 20 Mar 2020)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_18-2020-03)-Linux");
  ...
  prior to 80.0.3987.149 on Linux");
