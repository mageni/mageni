...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817518");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_20-2020-10)-Windows");
  ...
  prior to 86.0.4240.111 on Windows");
