...
if (description)
{
  ...
  script_name("Google Chrome Use After Free In Extensions Vulnerability (Linux)-June 2020");
  ...
  script_tag(name:"affected", value:"Google Chrome before 83.0.4103.116 on Linux.");
