...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816712");
  ...
  script_tag(name:"creation_date", value:"2020-03-20 13:43:47 +0530 (Fri, 20 Mar 2020)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_18-2020-03)-MAC OS X");
  ...
  prior to 80.0.3987.149 on MAC OS X");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  80.0.3987.149 or later. Please see the references for more information.");
...
if(version_is_less(version:chr_ver, test_version:"80.0.3987.149"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"80.0.3987.149", install_path:chr_path);
