...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817027");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_19-2020-05)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 83.0.4103.61 on MAC OS X");

  script_tag(name:"solution", value:"Upgrade to Google Chrome 83.0.4103.61 or later.
...
if(version_is_less(version:chr_ver, test_version:"83.0.4103.61"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"83.0.4103.61", install_path:chr_path);
