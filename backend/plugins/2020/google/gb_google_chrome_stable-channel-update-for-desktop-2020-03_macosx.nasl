...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815786");
  ...
  script_tag(name:"creation_date", value:"2020-03-04 14:58:35 +0530 (Wed, 04 Mar 2020)");
  script_name("Google Chrome Security Updates (stable-channel-update-for-desktop-2020-03)-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Google Chrome version 80.0.3987.132
...
if(version_is_less(version:chr_ver, test_version:"80.0.3987.132"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"80.0.3987.132", install_path:chr_path);
