...
if(description)
{
  ...
  script_version("2020-05-12T04:30:11+0000");
  ...
  script_cve_id("CVE-2020-11108");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Pi-hole Ad-Blocker < 5.0 Remote Code Execution Vulnerability");
  ...
  script_tag(name:"insight", value:"The Gravity updater in Pi-hole allows an authenticated adversary to upload
  arbitrary files. This can be abused for Remote Code Execution by writing to a PHP file in the web directory.
  (Also, it can be used in conjunction with the sudo rule for the www-data user to escalate privileges to root.)
  The code error is in gravity_DownloadBlocklistFromUrl in gravity.sh.");
