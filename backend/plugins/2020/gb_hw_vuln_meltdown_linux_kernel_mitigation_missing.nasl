...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108841");
  ...
  script_name("Missing Linux Kernel mitigations for 'Meltdown' hardware vulnerabilities");
  ...
  side for the referenced 'Meltdown' hardware vulnerabilities.");
