...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877737");
  ...
  script_tag(name:"creation_date", value:"2020-04-30 03:14:50 +0000 (Thu, 30 Apr 2020)");
  script_name("Fedora: Security Advisory for gnuchess (FEDORA-2020-dbccd7e9be)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TGIICRUZRFAK5M7SNHZKR7SKE77SFKWE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnuchess'
  package(s) announced via the FEDORA-2020-dbccd7e9be advisory.");
...
you&#39, ll also need to install the xboard package and the X Window System.");
  ...
  script_tag(name:"affected", value:"'gnuchess' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnuchess", rpm:"gnuchess~6.2.6~1.fc31", rls:"FC31"))) {
    report += res;
  }
