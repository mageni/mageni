...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878760");
  ...
  script_name("Fedora: Security Advisory for pngcheck (FEDORA-2020-f3a397cbf8)");
  ...
  script_xref(name:"FEDORA", value:"2020-f3a397cbf8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JII3RE2ULIVFVHUICD6G6VSJHJGEZBX7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pngcheck'
  package(s) announced via the FEDORA-2020-f3a397cbf8 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pngcheck", rpm:"pngcheck~2.4.0~5.fc33", rls:"FC33"))) {
    report += res;
  }
