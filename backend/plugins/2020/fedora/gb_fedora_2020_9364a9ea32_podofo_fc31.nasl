...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878084");
  ...
  script_name("Fedora: Security Advisory for podofo (FEDORA-2020-9364a9ea32)");
  ...
  script_xref(name:"FEDORA", value:"2020-9364a9ea32");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WR6XY3TOLJPLXOGHYPCB42JW3SWRZNY4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podofo'
  package(s) announced via the FEDORA-2020-9364a9ea32 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podofo", rpm:"podofo~0.9.6~12.fc31", rls:"FC31"))) {
    report += res;
  }
