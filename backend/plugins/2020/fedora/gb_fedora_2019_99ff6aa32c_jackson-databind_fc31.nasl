...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877141");
  ...
  script_tag(name:"creation_date", value:"2020-01-09 07:28:25 +0000 (Thu, 09 Jan 2020)");
  script_name("Fedora Update for jackson-databind FEDORA-2019-99ff6aa32c");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UKUALE2TUCKEKOHE2D342PQXN4MWCSLC");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jackson-databind", rpm:"jackson-databind~2.9.9.3~1.fc31", rls:"FC31"))) {
    report += res;
  }
