...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878291");
  ...
  script_tag(name:"creation_date", value:"2020-09-13 03:07:19 +0000 (Sun, 13 Sep 2020)");
  script_name("Fedora: Security Advisory for dotnet3.1 (FEDORA-2020-cad5d17c6d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZW4CBI26KSO3PRL3HLVVISXPPOYUHSXO");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dotnet3.1", rpm:"dotnet3.1~3.1.107~1.fc32", rls:"FC32"))) {
    report += res;
  }
