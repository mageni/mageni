...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877380");
  ...
  script_name("Fedora: Security Advisory for mingw-podofo (FEDORA-2020-968a89619e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XHFOCBZCF3GX7A6FWE3JM7P37TQWGINJ");
  ...
  script_tag(name:"affected", value:"'mingw-podofo' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-podofo", rpm:"mingw-podofo~0.9.6~13.fc30", rls:"FC30"))) {
    report += res;
  }
