...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878428");
  ...
  script_tag(name:"creation_date", value:"2020-10-06 03:11:05 +0000 (Tue, 06 Oct 2020)");
  script_name("Fedora: Security Advisory for podman (FEDORA-2020-7b6058fec9)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VE4QTIG2AV6WSHAGUCFIRXEKVB72ZRWY");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~2.1.1~10.fc33", rls:"FC33"))) {
    report += res;
  }
