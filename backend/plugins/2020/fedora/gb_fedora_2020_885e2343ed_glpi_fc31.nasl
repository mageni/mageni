...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877830");
  script_version("2020-05-20T02:28:18+0000");
  script_cve_id("CVE-2020-11033", "CVE-2020-11036", "CVE-2020-11035", "CVE-2020-11034");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-05-20 09:55:38 +0000 (Wed, 20 May 2020)");
  script_tag(name:"creation_date", value:"2020-05-15 03:23:31 +0000 (Fri, 15 May 2020)");
  script_name("Fedora: Security Advisory for glpi (FEDORA-2020-885e2343ed)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5WQMONZRWLWOXMHMYWR7A5Q5JJERPMVC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glpi'
  package(s) announced via the FEDORA-2020-885e2343ed advisory.");
...
about your network-topology.");
  ...
  script_tag(name:"affected", value:"'glpi' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glpi", rpm:"glpi~9.4.6~1.fc31", rls:"FC31"))) {
    report += res;
  }
