...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878119");
  ...
  script_tag(name:"creation_date", value:"2020-07-22 03:19:22 +0000 (Wed, 22 Jul 2020)");
  script_name("Fedora: Security Advisory for mailman (FEDORA-2020-62f2df3ca4)");
  ...
  script_xref(name:"FEDORA", value:"2020-62f2df3ca4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/74EQIVFB34Q4UYAQLCUWG55YLKAUWCHD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman'
  package(s) announced via the FEDORA-2020-62f2df3ca4 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mailman", rpm:"mailman~2.1.34~1.fc31", rls:"FC31"))) {
    report += res;
  }
