...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878525");
  ...
  script_name("Fedora: Security Advisory for java-1.8.0-openjdk (FEDORA-2020-5708dd5b87)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OMJMTXFJRONFT72YAEQNRFKYZZU4W3HD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk'
  package(s) announced via the FEDORA-2020-5708dd5b87 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.8.0-openjdk", rpm:"java-1.8.0-openjdk~1.8.0.272.b10~0.fc33", rls:"FC33"))) {
    report += res;
  }
