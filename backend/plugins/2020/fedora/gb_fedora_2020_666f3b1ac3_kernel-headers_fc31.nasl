...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877676");
  ...
  script_tag(name:"creation_date", value:"2020-04-09 03:16:33 +0000 (Thu, 09 Apr 2020)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-666f3b1ac3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JTOFHZTEXUSF3XCLZ7K2VDUQ2GBM7X3W");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.5.15~200.fc31", rls:"FC31"))) {
    report += res;
  }
