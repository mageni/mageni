...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878544");
  ...
  script_tag(name:"creation_date", value:"2020-10-31 04:14:10 +0000 (Sat, 31 Oct 2020)");
  script_name("Fedora: Security Advisory for java-11-openjdk (FEDORA-2020-421f817e5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YCKZAI4AWSKO5O5VDXHFFKNLOZGZ3KEE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openjdk'
  package(s) announced via the FEDORA-2020-421f817e5f advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk", rpm:"java-11-openjdk~11.0.9.11~0.fc31", rls:"FC31"))) {
    report += res;
  }
