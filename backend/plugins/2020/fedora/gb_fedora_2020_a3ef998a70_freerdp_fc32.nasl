...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878073");
  ...
  script_name("Fedora: Security Advisory for freerdp (FEDORA-2020-a3ef998a70)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IGSY4CEBOH6TVJLIW53YL7YDGHY3RMPU");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freerdp", rpm:"freerdp~2.1.2~1.fc32", rls:"FC32"))) {
    report += res;
  }
