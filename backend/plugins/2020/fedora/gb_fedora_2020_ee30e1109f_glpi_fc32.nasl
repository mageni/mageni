...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877837");
  ...
  script_name("Fedora: Security Advisory for glpi (FEDORA-2020-ee30e1109f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Q4BG2UTINBVV7MTJRXKBQ26GV2UINA6L");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glpi'
  package(s) announced via the FEDORA-2020-ee30e1109f advisory.");
...
about your network-topology.");
  ...
  script_tag(name:"affected", value:"'glpi' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glpi", rpm:"glpi~9.4.6~1.fc32", rls:"FC32"))) {
    report += res;
  }
