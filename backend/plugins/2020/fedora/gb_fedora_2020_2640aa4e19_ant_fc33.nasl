...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878501");
  ...
  script_name("Fedora: Security Advisory for ant (FEDORA-2020-2640aa4e19)");
  ...
  script_xref(name:"FEDORA", value:"2020-2640aa4e19");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/U3NRQQ7ECII4ZNGW7GBC225LVYMPQEKB");
...
and tasks.");
  ...
  script_tag(name:"affected", value:"'ant' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ant", rpm:"ant~1.10.9~1.fc33", rls:"FC33"))) {
    report += res;
  }
