...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878638");
  ...
  script_tag(name:"creation_date", value:"2020-11-22 04:14:41 +0000 (Sun, 22 Nov 2020)");
  script_name("Fedora: Security Advisory for rpki-client (FEDORA-2020-538e0ee110)");
  ...
  script_xref(name:"FEDORA", value:"2020-538e0ee110");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ELXTM7ZORYITM2HEGXLVYIB2EHWXUGJT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client'
  package(s) announced via the FEDORA-2020-538e0ee110 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~6.8p1~1.fc32", rls:"FC32"))) {
    report += res;
  }
