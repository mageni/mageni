...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877628");
  ...
  script_tag(name:"creation_date", value:"2020-03-29 03:14:39 +0000 (Sun, 29 Mar 2020)");
  script_name("Fedora: Security Advisory for python-nltk (FEDORA-2020-1b90085f8d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZGZSSEJH7RHH3RBUEVWWYT75QU67J7SE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-nltk'
  package(s) announced via the FEDORA-2020-1b90085f8d advisory.");
...
research projects.");
  ...
  script_tag(name:"affected", value:"'python-nltk' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-nltk", rpm:"python-nltk~3.4.5~2.fc32", rls:"FC32"))) {
    report += res;
  }
