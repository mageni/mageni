...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877303");
  script_version("2020-01-13T11:49:13+0000");
  script_cve_id("CVE-2018-20852", "CVE-2019-16056", "CVE-2019-16935");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-13 11:49:13 +0000 (Mon, 13 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-09 07:36:45 +0000 (Thu, 09 Jan 2020)");
  script_name("Fedora Update for python2 FEDORA-2019-0d3fcae639");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JTK5Y24SHCLJR6OQ6WMV5YUGFIBAPMDJ");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2", rpm:"python2~2.7.17~1.fc31", rls:"FC31"))) {
    report += res;
  }
