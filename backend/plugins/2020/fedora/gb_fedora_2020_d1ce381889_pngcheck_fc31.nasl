...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878579");
  ...
  script_name("Fedora: Security Advisory for pngcheck (FEDORA-2020-d1ce381889)");
  ...
  script_xref(name:"FEDORA", value:"2020-d1ce381889");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZZXZH3QYOMLKGBBJY3JXNC4EAVGUEKLD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pngcheck'
  package(s) announced via the FEDORA-2020-d1ce381889 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pngcheck", rpm:"pngcheck~2.3.0~3.fc31", rls:"FC31"))) {
    report += res;
  }
