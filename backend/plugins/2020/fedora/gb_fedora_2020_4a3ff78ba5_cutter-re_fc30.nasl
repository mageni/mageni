...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877465");
  ...
  script_tag(name:"creation_date", value:"2020-02-14 04:12:15 +0000 (Fri, 14 Feb 2020)");
  script_name("Fedora: Security Advisory for cutter-re (FEDORA-2020-4a3ff78ba5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YQTOWEDFXDTGTD6D4NHRB4FUURQSTTEN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cutter-re'
  package(s) announced via the FEDORA-2020-4a3ff78ba5 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cutter-re", rpm:"cutter-re~1.10.1~3.fc30", rls:"FC30"))) {
    report += res;
  }
