...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878482");
  ...
  script_name("Fedora: Security Advisory for dnf (FEDORA-2020-5d9f0ce2b3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JXSUSDBDUZYUICF5RTDG6OTGEEYGCKKU");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnf", rpm:"dnf~4.4.0~1.fc32", rls:"FC32"))) {
    report += res;
  }
