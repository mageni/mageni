...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877695");
  ...
  script_name("Fedora: Security Advisory for drupal7-ckeditor (FEDORA-2020-e653bca022)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DBQEMDUR6437TFTEIKNGIGQCJLCOW6RB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-ckeditor'
  package(s) announced via the FEDORA-2020-e653bca022 advisory.");
...
installation on the client computer.");
  ...
  script_tag(name:"affected", value:"'drupal7-ckeditor' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-ckeditor", rpm:"drupal7-ckeditor~1.19~1.fc30", rls:"FC30"))) {
    report += res;
  }
