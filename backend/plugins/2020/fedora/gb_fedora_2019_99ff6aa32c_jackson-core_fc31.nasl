...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877251");
  ...
  script_tag(name:"creation_date", value:"2020-01-09 07:33:50 +0000 (Thu, 09 Jan 2020)");
  script_name("Fedora Update for jackson-core FEDORA-2019-99ff6aa32c");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LQQAL6N4QQD2PN3Y6IRR3MJ47X6UP3BM");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jackson-core", rpm:"jackson-core~2.9.9~1.fc31", rls:"FC31"))) {
    report += res;
  }
