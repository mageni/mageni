...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877275");
  ...
  script_name("Fedora Update for libmp4v2 FEDORA-2019-d53d4a79ac");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6YCHVOYPIBGM5HYUMQ77KZH2IHSITKVE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmp4v2'
  package(s) announced via the FEDORA-2019-d53d4a79ac advisory.");
...
and is an exact copy of the library distributed in the mpeg4ip package.");
  ...
  script_tag(name:"affected", value:"'libmp4v2' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmp4v2", rpm:"libmp4v2~2.1.0~0.19.trunkREV507.fc31", rls:"FC31"))) {
    report += res;
  }
