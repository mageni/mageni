...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877693");
  ...
  script_tag(name:"creation_date", value:"2020-04-14 03:09:09 +0000 (Tue, 14 Apr 2020)");
  script_name("Fedora: Security Advisory for php-robrichards-xmlseclibs1 (FEDORA-2020-46d0f456a9)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BBKVDUZ7G5ZOUO4BFJWLNJ6VOKBQJX5U");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-robrichards-xmlseclibs1'
  package(s) announced via the FEDORA-2020-46d0f456a9 advisory.");
...
Autoloader: /usr/share/php/robrichards-xmlseclibs/autoload.php");
  ...
  script_tag(name:"affected", value:"'php-robrichards-xmlseclibs1' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-robrichards-xmlseclibs1", rpm:"php-robrichards-xmlseclibs1~1.4.3~1.fc31", rls:"FC31"))) {
    report += res;
  }
