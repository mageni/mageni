...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877463");
  ...
  script_tag(name:"creation_date", value:"2020-02-14 04:12:11 +0000 (Fri, 14 Feb 2020)");
  script_name("Fedora: Security Advisory for cutter-re (FEDORA-2020-acd8cdb08d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4GRLHCESUHAIMYUJT2A6FOKP44IBCR5M");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cutter-re", rpm:"cutter-re~1.10.1~3.fc31", rls:"FC31"))) {
    report += res;
  }
