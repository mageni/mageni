...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878634");
  ...
  script_tag(name:"creation_date", value:"2020-11-22 04:14:36 +0000 (Sun, 22 Nov 2020)");
  script_name("Fedora: Security Advisory for rpki-client (FEDORA-2020-ce591c8f46)");
  ...
  script_xref(name:"FEDORA", value:"2020-ce591c8f46");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QYRY7B5VROND5FSI5WQFCRKXANBWG4AY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client'
  package(s) announced via the FEDORA-2020-ce591c8f46 advisory.");
...
also as CSV or JSON objects for consumption by other routing stacks.");
  ...
  script_tag(name:"affected", value:"'rpki-client' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~6.8p1~1.fc31", rls:"FC31"))) {
    report += res;
  }
