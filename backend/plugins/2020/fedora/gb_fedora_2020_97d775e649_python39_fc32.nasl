...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878146");
  ...
  script_tag(name:"creation_date", value:"2020-07-31 03:14:02 +0000 (Fri, 31 Jul 2020)");
  script_name("Fedora: Security Advisory for python39 (FEDORA-2020-97d775e649)");
  ...
  script_xref(name:"FEDORA", value:"2020-97d775e649");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TOGKLGTXZLHQQFBVCAPSUDA6DOOJFNRY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python39'
  package(s) announced via the FEDORA-2020-97d775e649 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python39-3.9.0", rpm:"python39-3.9.0~b5~1.fc32", rls:"FC32"))) {
    report += res;
  }
