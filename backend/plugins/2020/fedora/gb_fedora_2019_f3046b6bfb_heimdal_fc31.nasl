...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877324");
  script_version("2020-01-13T11:49:13+0000");
  script_cve_id("CVE-2019-12098");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-01-13 11:49:13 +0000 (Mon, 13 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-09 07:38:08 +0000 (Thu, 09 Jan 2020)");
  script_name("Fedora Update for heimdal FEDORA-2019-f3046b6bfb");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GIXEDVVMPD6ZAJSMI2EZ7FNEIVNWE5PD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'heimdal'
  package(s) announced via the FEDORA-2019-f3046b6bfb advisory.");
...
by default since it is deemed too big a security risk by the packager.");
  ...
  script_tag(name:"affected", value:"'heimdal' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"heimdal", rpm:"heimdal~7.7.0~2.fc31", rls:"FC31"))) {
    report += res;
  }
