...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878225");
  ...
  script_tag(name:"creation_date", value:"2020-09-02 11:51:36 +0530 (Wed, 02 Sep 2020)");
  script_name("Fedora: Security Advisory for dnsperf (FEDORA-2020-a02b7a0f21)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7727ASARCXGR4SB3O25MBONVJX4J2SFP");
...
For more information, see the dnsperf(1) and resperf(1) man pages.");
  ...
  script_tag(name:"affected", value:"'dnsperf' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsperf", rpm:"dnsperf~2.3.4~2.fc32", rls:"FC32"))) {
    report += res;
  }
