...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878676");
  ...
  script_name("Fedora: Security Advisory for libuv (FEDORA-2020-eb942ee0db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YYVYVKMYO3GYOMOTOFPALB2245U3KNQK");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libuv", rpm:"libuv~1.39.0~1.fc32", rls:"FC32"))) {
    report += res;
  }
