...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877718");
  ...
  script_name("Fedora: Security Advisory for liblas (FEDORA-2020-b0695fcdf7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YFI3F3PRKPXOITWD47LF6ON4L5MJQQYM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'liblas'
  package(s) announced via the FEDORA-2020-b0695fcdf7 advisory.");
...
interchange and archival.");
  ...
  script_tag(name:"affected", value:"'liblas' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"liblas", rpm:"liblas~1.8.1~5.fc31", rls:"FC31"))) {
    report += res;
  }
