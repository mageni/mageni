...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878754");
  ...
  script_name("Fedora: Security Advisory for phpldapadmin (FEDORA-2020-c6fa47ecd7)");
  ...
  script_xref(name:"FEDORA", value:"2020-c6fa47ecd7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/W6PZH3EY2T66N2MGOA7DWCAIVYIJH4BC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpldapadmin'
  package(s) announced via the FEDORA-2020-c6fa47ecd7 advisory.");
...
access by remote web-clients.");
  ...
  script_tag(name:"affected", value:"'phpldapadmin' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phpldapadmin", rpm:"phpldapadmin~1.2.6.2~1.fc32", rls:"FC32"))) {
    report += res;
  }
