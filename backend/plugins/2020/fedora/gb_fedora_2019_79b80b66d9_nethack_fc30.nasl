...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877100");
  ...
  script_name("Fedora Update for nethack FEDORA-2019-79b80b66d9");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FA4UFIZAFUH2DLHZW5ID6GQSM7RAZUPJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nethack'
  package(s) announced via the FEDORA-2019-79b80b66d9 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nethack", rpm:"nethack~3.6.4~1.fc30", rls:"FC30"))) {
    report += res;
  }
