...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878267");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-708b23f2ce)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6M3WWYDLTJY2PUVGQ5JBZJDSSVYDW7MT");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.8.6~200.fc32", rls:"FC32"))) {
    report += res;
  }
