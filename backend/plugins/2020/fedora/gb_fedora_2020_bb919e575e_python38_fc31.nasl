...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878141");
  ...
  script_tag(name:"creation_date", value:"2020-07-31 03:13:34 +0000 (Fri, 31 Jul 2020)");
  script_name("Fedora: Security Advisory for python38 (FEDORA-2020-bb919e575e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LE4O3PNDNNOMSKHNUKZKD3NGHIFUFDPX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python38'
  package(s) announced via the FEDORA-2020-bb919e575e advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python38", rpm:"python38~3.8.5~1.fc31", rls:"FC31"))) {
    report += res;
  }
