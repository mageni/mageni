...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877532");
  ...
  script_tag(name:"creation_date", value:"2020-02-29 04:03:27 +0000 (Sat, 29 Feb 2020)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-3cd64d683c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NAJDTVX4SBKMP3HPBWCFNQUOBIQUURJA");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.5.6~200.fc31", rls:"FC31"))) {
    report += res;
  }
