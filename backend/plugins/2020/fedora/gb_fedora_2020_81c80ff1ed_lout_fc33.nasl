...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878541");
  ...
  script_tag(name:"creation_date", value:"2020-10-31 04:14:03 +0000 (Sat, 31 Oct 2020)");
  script_name("Fedora: Security Advisory for lout (FEDORA-2020-81c80ff1ed)");
  ...
  script_xref(name:"FEDORA", value:"2020-81c80ff1ed");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QGZKTKGRJTQE43SFU77X5QJHKXTTOJYB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lout'
  package(s) announced via the FEDORA-2020-81c80ff1ed advisory.");
...
graphics). Lout is inherently multilingual. Adding new languages is easy.");
  ...
  script_tag(name:"affected", value:"'lout' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lout", rpm:"lout~3.40~18.fc33", rls:"FC33"))) {
    report += res;
  }
