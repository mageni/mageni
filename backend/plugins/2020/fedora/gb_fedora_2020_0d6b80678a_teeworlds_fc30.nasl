...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877817");
  ...
  script_tag(name:"creation_date", value:"2020-05-11 03:22:28 +0000 (Mon, 11 May 2020)");
  script_name("Fedora: Security Advisory for teeworlds (FEDORA-2020-0d6b80678a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AVYG7CCPS5F3OPOQMJKVNXTQ7BXSEX2V");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'teeworlds'
  package(s) announced via the FEDORA-2020-0d6b80678a advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"teeworlds", rpm:"teeworlds~0.7.5~1.fc30", rls:"FC30"))) {
    report += res;
  }
