...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877803");
  ...
  script_name("Fedora: Security Advisory for crawl (FEDORA-2020-de88782eaa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6QLPN635S7J3MUXLIHYK6MDAHEIASFYP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'crawl'
  package(s) announced via the FEDORA-2020-de88782eaa advisory.");
...
run from, making each game unique and challenging.");
  ...
  script_tag(name:"affected", value:"'crawl' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"crawl", rpm:"crawl~0.24.1~2.fc31", rls:"FC31"))) {
    report += res;
  }
