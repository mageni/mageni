...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878662");
  ...
  script_name("Fedora: Security Advisory for slurm (FEDORA-2020-49b97c38e7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EXGA4WHS6JC6NIKAY5YNUT6MVUUWI6FF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'slurm'
  package(s) announced via the FEDORA-2020-49b97c38e7 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"slurm", rpm:"slurm~20.02.6~1.fc33", rls:"FC33"))) {
    report += res;
  }
