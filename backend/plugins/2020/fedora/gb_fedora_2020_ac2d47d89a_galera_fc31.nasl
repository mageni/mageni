...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878599");
  ...
  script_name("Fedora: Security Advisory for galera (FEDORA-2020-ac2d47d89a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MVWYCFTD6DTTQF3DTUVAJFLIGKBAATIP");
...
for transactional databases and similar applications");
  ...
  script_tag(name:"affected", value:"'galera' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"galera", rpm:"galera~25.3.31~1.fc31", rls:"FC31"))) {
    report += res;
  }
