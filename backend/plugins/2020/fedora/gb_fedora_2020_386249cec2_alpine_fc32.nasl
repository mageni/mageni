...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878026");
  ...
  script_name("Fedora: Security Advisory for alpine (FEDORA-2020-386249cec2)");
  ...
  script_xref(name:"FEDORA", value:"2020-386249cec2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZJLY6JDVGDNAJZ3UQDWYWSDBWOAOXMNX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'alpine'
  package(s) announced via the FEDORA-2020-386249cec2 advisory.");
...
GNU Build System&#39, s autotools.");
  ...
  script_tag(name:"affected", value:"'alpine' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"alpine", rpm:"alpine~2.23~2.fc32", rls:"FC32"))) {
    report += res;
  }
