...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878282");
  ...
  script_tag(name:"creation_date", value:"2020-09-12 03:08:45 +0000 (Sat, 12 Sep 2020)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2020-88bf0a76d1)");
  ...
  script_xref(name:"FEDORA", value:"2020-88bf0a76d1");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JMBWCDYK5EQZ4RST4MVGDSRDK66TULNB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2020-88bf0a76d1 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~85.0.4183.83~1.fc31", rls:"FC31"))) {
    report += res;
  }
