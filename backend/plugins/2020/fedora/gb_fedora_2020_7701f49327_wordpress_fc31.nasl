...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877823");
  ...
  script_name("Fedora: Security Advisory for wordpress (FEDORA-2020-7701f49327)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HVU4E3B33EMZ4I2STRIVACBIZDOYLXW2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2020-7701f49327 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.4.1~1.fc31", rls:"FC31"))) {
    report += res;
  }
