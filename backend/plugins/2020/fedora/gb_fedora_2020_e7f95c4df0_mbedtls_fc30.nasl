...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877570");
  ...
  script_name("Fedora: Security Advisory for mbedtls (FEDORA-2020-e7f95c4df0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JW6G4RY5NWXAKK3U65ZEMKOGSAVUB3G5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mbedtls'
  package(s) announced via the FEDORA-2020-e7f95c4df0 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mbedtls", rpm:"mbedtls~2.16.5~1.fc30", rls:"FC30"))) {
    report += res;
  }
