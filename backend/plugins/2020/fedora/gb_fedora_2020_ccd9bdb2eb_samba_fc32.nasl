...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878040");
  ...
  script_name("Fedora: Security Advisory for samba (FEDORA-2020-ccd9bdb2eb)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FUWHKO6ZM7LMJAIIORM5A5BDK6NBELVP");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"samba", rpm:"samba~4.12.5~0.fc32", rls:"FC32"))) {
    report += res;
  }
