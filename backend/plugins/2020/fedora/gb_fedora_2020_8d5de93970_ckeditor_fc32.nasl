...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877622");
  ...
  script_name("Fedora: Security Advisory for ckeditor (FEDORA-2020-8d5de93970)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7OJ4BSS3VEAEXPNSOOUAXX6RDNECGZNO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ckeditor'
  package(s) announced via the FEDORA-2020-8d5de93970 advisory.");
...
OpenOffice.");
  ...
  script_tag(name:"affected", value:"'ckeditor' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ckeditor", rpm:"ckeditor~4.14.0~1.fc32", rls:"FC32"))) {
    report += res;
  }
