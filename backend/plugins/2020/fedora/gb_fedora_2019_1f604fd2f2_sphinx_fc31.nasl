...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877157");
  ...
  script_name("Fedora Update for sphinx FEDORA-2019-1f604fd2f2");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3FPPNZZMWTZOMFGFETMET6YKIH2DQDKS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sphinx'
  package(s) announced via the FEDORA-2019-1f604fd2f2 advisory.");
...
Phrase Index. Yes, I know about CMU&#39, s Sphinx project.");
  ...
  script_tag(name:"affected", value:"'sphinx' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sphinx", rpm:"sphinx~2.2.11~13.fc31", rls:"FC31"))) {
    report += res;
  }
