...
if(description)
{
  ...
  script_version("2020-11-19T04:00:09+0000");
  ...
  script_name("Debian LTS: Security Advisory for packer (DLA-2455-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00031.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2455-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'packer'
  package(s) announced via the DLA-2455-1 advisory.");
...
invalid Public key.");
  ...
  script_tag(name:"affected", value:"'packer' package(s) on Debian Linux.");
