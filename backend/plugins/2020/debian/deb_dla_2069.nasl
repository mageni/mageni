...
if(description)
{
  ...
  script_version("2020-01-19T04:00:52+0000");
  script_cve_id("CVE-2020-7106");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-01-19 04:00:52 +0000 (Sun, 19 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-19 04:00:52 +0000 (Sun, 19 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2069-1] cacti security update)");
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2069-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cacti'
  package(s) announced via the DSA-2069-1 advisory.");
