...
if(description)
{
  ...
  script_version("2020-01-02T03:00:08+0000");
  # TODO: No CVE assigned yet.
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-02 03:00:08 +0000 (Thu, 02 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-02 03:00:08 +0000 (Thu, 02 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2056-1] waitress security update)");
  ...
  package(s) announced via the DSA-2056-1 advisory.");
