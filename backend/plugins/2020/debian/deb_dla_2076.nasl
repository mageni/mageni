...
if(description)
{
  ...
  script_version("2020-01-27T04:00:05+0000");
  script_cve_id("CVE-2020-7039");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-27 04:00:05 +0000 (Mon, 27 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-27 04:00:05 +0000 (Mon, 27 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2076-1] slirp security update)");
  ...
  package(s) announced via the DSA-2076-1 advisory.");
