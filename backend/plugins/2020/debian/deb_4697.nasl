...
if(description)
{
  ...
  script_version("2020-06-07T03:00:04+0000");
  ...
  script_name("Debian: Security Advisory for gnutls28 (DSA-4697-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4697.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4697-1");
  ...
  script_tag(name:"insight", value:"A flaw was reported in the TLS session ticket key construction in
