...
if(description)
{
  ...
  script_version("2020-02-27T04:00:07+0000");
  ...
  script_name("Debian: Security Advisory for proftpd-dfsg (DSA-4635-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4635.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4635-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'proftpd-dfsg'
  package(s) announced via the DSA-4635-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Antonio Morales discovered an user-after-free flaw in the memory pool
