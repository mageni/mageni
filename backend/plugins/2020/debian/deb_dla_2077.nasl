...
if(description)
{
  ...
  script_version("2020-01-28T04:00:07+0000");
  script_cve_id("CVE-2019-12418", "CVE-2019-17563");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-28 04:00:07 +0000 (Tue, 28 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-28 04:00:07 +0000 (Tue, 28 Jan 2020)");
  script_name("Debian LTS: Security Advisory for tomcat7 (DLA-2077-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/01/msg00024.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2077-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat7'
  package(s) announced via the DLA-2077-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two security vulnerabilities have been fixed in the Tomcat
