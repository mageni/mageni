...
if(description)
{
  ...
  script_version("2020-11-26T04:00:10+0000");
  ...
  script_name("Debian: Security Advisory for webkit2gtk (DSA-4797-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4797.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4797-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk'
  package(s) announced via the DSA-4797-1 advisory.");
