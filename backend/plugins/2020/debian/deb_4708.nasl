...
if(description)
{
  ...
  script_version("2020-06-23T03:00:06+0000");
  ...
  script_name("Debian: Security Advisory for neomutt (DSA-4708-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4708.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4708-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'neomutt'
  package(s) announced via the DSA-4708-1 advisory.");
...
attacks.");
  ...
  script_tag(name:"affected", value:"'neomutt' package(s) on Debian Linux.");
