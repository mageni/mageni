...
if(description)
{
  ...
  script_version("2020-06-29T10:32:32+0000");
  ...
  script_name("Debian LTS: Security Advisory for libtirpc (DLA-2256-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00027.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2256-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libtirpc'
  package(s) announced via the DLA-2256-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that libtiprc, a transport-independent RPC library,
