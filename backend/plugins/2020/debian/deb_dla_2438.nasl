...
if(description)
{
  ...
  script_version("2020-11-08T04:00:14+0000");
  ...
  script_name("Debian LTS: Security Advisory for raptor2 (DLA-2438-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00012.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2438-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/973889");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'raptor2'
  package(s) announced via the DLA-2438-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there were two heap overflow vulnerabilities
