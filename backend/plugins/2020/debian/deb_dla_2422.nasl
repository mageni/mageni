...
if(description)
{
  ...
  script_version("2020-11-03T04:00:07+0000");
  ...
  script_name("Debian LTS: Security Advisory for qtsvg-opensource-src (DLA-2422-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00035.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2422-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qtsvg-opensource-src'
  package(s) announced via the DLA-2422-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Malformed SVG images were able to cause a segmentation fault
