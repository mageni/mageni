...
if(description)
{
  ...
  script_version("2020-01-24T04:00:10+0000");
  script_cve_id("CVE-2019-15795", "CVE-2019-15796");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-24 04:00:10 +0000 (Fri, 24 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-24 04:00:10 +0000 (Fri, 24 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2074-1] python-apt security update)");
  ...
  package(s) announced via the DSA-2074-1 advisory.");
