...
if(description)
{
  ...
  script_version("2020-06-30T03:00:16+0000");
  ...
  script_name("Debian: Security Advisory for coturn (DSA-4711-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4711.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4711-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'coturn'
  package(s) announced via the DSA-4711-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in coturn, a TURN and STUN
server for VoIP.
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"coturn", ver:"4.5.1.1-1.1+deb10u1", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"coturn", ver:"4.5.0.5-1+deb9u2", rls:"DEB9"))) {
  report += res;
}
