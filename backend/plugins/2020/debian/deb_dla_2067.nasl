...
if(description)
{
  ...
  script_version("2020-01-15T04:00:09+0000");
  script_cve_id("CVE-2019-20041");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-15 04:00:09 +0000 (Wed, 15 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-15 04:00:09 +0000 (Wed, 15 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2067-1] wordpress security update)");
  ...
  package(s) announced via the DSA-2067-1 advisory.");
