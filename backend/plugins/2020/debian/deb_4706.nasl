...
if(description)
{
  ...
  script_version("2020-06-20T03:00:05+0000");
  ...
  script_name("Debian: Security Advisory for drupal7 (DSA-4706-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4706.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4706-1");
  ...
  package(s) announced via the DSA-4706-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Drupal, a fully-featured content management
