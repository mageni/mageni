...
if(description)
{
  ...
  script_version("2020-01-24T04:00:08+0000");
  script_cve_id("CVE-2019-1348", "CVE-2019-1349", "CVE-2019-1352", "CVE-2019-1353", "CVE-2019-1387");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-24 04:00:08 +0000 (Fri, 24 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-24 04:00:08 +0000 (Fri, 24 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2059-1] git security update)");
  ...
  package(s) announced via the DSA-2059-1 advisory.");
