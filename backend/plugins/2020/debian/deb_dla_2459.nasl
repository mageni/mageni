...
if(description)
{
  ...
  script_version("2020-11-22T04:00:10+0000");
  ...
  script_name("Debian LTS: Security Advisory for golang-1.7 (DLA-2459-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00037.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2459-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-1.7'
  package(s) announced via the DLA-2459-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two issues have been found in golang-1.7, a Go programming language
