...
if(description)
{
  ...
  script_version("2020-01-27T04:00:04+0000");
  script_cve_id("CVE-2015-6748");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-01-27 04:00:04 +0000 (Mon, 27 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-27 04:00:04 +0000 (Mon, 27 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2075-1] jsoup security update)");
  ...
  package(s) announced via the DSA-2075-1 advisory.");
