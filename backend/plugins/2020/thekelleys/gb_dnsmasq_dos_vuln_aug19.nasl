...
if(description)
{
  ...
  script_version("2020-01-08T08:59:08+0000");
  script_tag(name:"last_modification", value:"2020-01-08 08:59:08 +0000 (Wed, 08 Jan 2020)");
  ...
  script_name("Dnsmasq < 2.81 Denial of Service Vulnerability");
  ...
  script_tag(name:"impact", value:"The memory leak allows remote attackers to cause a denial of service
  (memory consumption) via vectors involving DHCP response creation.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Dnsmasq versions prior to 2.81.");
...
if(version_is_less(version: version, test_version: "2.81")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.81");
