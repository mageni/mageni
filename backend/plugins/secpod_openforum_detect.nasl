...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detects the installed version of OpenForum and
...
foreach dir( make_list_unique( "/openforum", "/opnfrm", "/forum", cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "HTTP/1.. 200" && "OpenForum" >< rcvRes ) {
