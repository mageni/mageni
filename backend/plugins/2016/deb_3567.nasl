...
# $Id: deb_3567.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libpam-sshauth", ver:"0.3.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpam-sshauth", ver:"0.4.1-2", rls:"DEB9")) != NULL) {
  report += res;
}
