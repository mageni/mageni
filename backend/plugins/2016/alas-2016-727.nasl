...
# $Id: alas-2016-727.nasl 11711 2018-10-01 12:30:57Z cfischer $
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2016-727");
...
if(release == "AMAZON")
{
  if ((res = isrpmvuln(pkg:"ntpdate", rpm:"ntpdate~4.2.6p5~41.32.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.6p5~41.32.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"ntp-debuginfo", rpm:"ntp-debuginfo~4.2.6p5~41.32.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.6p5~41.32.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"ntp-perl", rpm:"ntp-perl~4.2.6p5~41.32.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
