...
# $Id: gb_suse_2016_1258_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This update to MozillaFirefox 38.8.0 ESR fixes the following issues
  (bsc#977333):
