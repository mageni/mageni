...
if(description)
{
  ...
  script_name("Fedora Update for optipng FEDORA-2016-b8f91621c7");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'optipng'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"optipng on Fedora 23");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"optipng", rpm:"optipng~0.7.6~1.fc23", rls:"FC23")) != NULL)
  {
