...
# $Id: gb_php_fileinfo_component_dos_vuln_win.nasl 11903 2018-10-15 10:26:16Z asteins $
#
# PHP Fileinfo Component Denial of Service Vulnerability (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to PHP version 5.6.0");
