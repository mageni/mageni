...
# $Id: gb_fortimanager_cve_2016_3196.nasl 12363 2018-11-15 09:51:15Z asteins $
#
# FortiManager Persistent XSS Vulnerability
#
# Authors:
...
if (description)
{
  ...
  script_name("FortiManager Persistent XSS Vulnerability");
  ...
  script_tag(name:"solution", value:"Upgrade to FortiManager 5.4.0 and above or 5.2.6 and above");
  ...
  This potentially enables stored XSS attacks.");

  script_tag(name:"affected", value:"FortiManager: 5.0.0 - 5.0.11, 5.2.0 - 5.2.5");
