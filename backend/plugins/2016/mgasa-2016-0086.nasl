...
if(description)
{
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2016-0086");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~11.21.2~1.mga5", rls:"MAGEIA5")) != NULL) {
