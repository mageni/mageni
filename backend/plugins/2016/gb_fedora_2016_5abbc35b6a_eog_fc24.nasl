...
#
# Fedora Update for eog FEDORA-2016-5abbc35b6a
#
# Authors:
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"eog", rpm:"eog~3.20.4~1.fc24", rls:"FC24")) != NULL)
  {
