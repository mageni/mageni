...
# $Id: deb_3527.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"inspircd", ver:"2.0.20-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"inspircd-dbg", ver:"2.0.20-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"inspircd-dev", ver:"2.0.20-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"inspircd", ver:"2.0.17-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"inspircd-dbg", ver:"2.0.17-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"inspircd", ver:"2.0.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"inspircd-dbg", ver:"2.0.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
