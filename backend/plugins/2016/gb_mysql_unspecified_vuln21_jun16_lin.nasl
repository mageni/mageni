...
# $Id: gb_mysql_unspecified_vuln21_jun16_lin.nasl 36954 2014-05-08 12:56:56Z may$
#
...
if(mysqlVer =~ "^(5\.(5|6))")
{
  if(version_in_range(version:mysqlVer, test_version:"5.5", test_version2:"5.5.35")||
     version_in_range(version:mysqlVer, test_version:"5.6", test_version2:"5.6.15"))
  {
