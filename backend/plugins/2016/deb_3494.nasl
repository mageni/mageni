...
# $Id: deb_3494.nasl 14279 2019-03-18 14:48:34Z cfischer $
# Auto-generated from advisory DSA 3494-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian Security Advisory DSA 3494-1 (cacti - security update)");
  script_tag(name:"last_modification", value:"$Date: 2019-03-18 15:48:34 +0100 (Mon, 18 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-03-08 12:37:48 +0530 (Tue, 08 Mar 2016)");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");

  script_xref(name:"URL", value:"http://www.debian.org/security/2016/dsa-3494.html");
...
We recommend that you upgrade your cacti packages.");
  script_tag(name:"summary", value:"Two SQL injection vulnerabilities were discovered in cacti, a web
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8b+dfsg-8+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8f+ds1-4", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u8", rls:"DEB7")) != NULL) {
  report += res;
}
