...
#
# Fedora Update for postgresql FEDORA-2016-30b01bdedd
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for postgresql FEDORA-2016-30b01bdedd");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"postgresql", rpm:"postgresql~9.5.4~1.fc24", rls:"FC24")) != NULL)
  {
