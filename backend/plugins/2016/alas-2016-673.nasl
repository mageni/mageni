...
# $Id: alas-2016-673.nasl 6574 2017-07-06 13:41:26Z cfischer$
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-31 08:02:06 +0300 (Thu, 31 Mar 2016)");
  script_tag(name:"last_modification", value:"$Date: 2019-03-14 13:29:16 +0100 (Thu, 14 Mar 2019) $");
  script_name("Amazon Linux Local Check: alas-2016-673");
  ...
  script_cve_id("CVE-2014-5025", "CVE-2015-8604", "CVE-2014-5026", "CVE-2015-4634", "CVE-2015-8377", "CVE-2013-5589", "CVE-2013-5588", "CVE-2015-4342");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.8g~7.6.amzn1", rls:"AMAZON")) != NULL) {
