...
if(description)
{
  ...
  script_name("Fedora Update for php-ZendFramework FEDORA-2016-7f193a0c59");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-ZendFramework'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"php-ZendFramework on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"php-ZendFramework", rpm:"php-ZendFramework~1.12.20~1.fc24", rls:"FC24")) != NULL)
  {
