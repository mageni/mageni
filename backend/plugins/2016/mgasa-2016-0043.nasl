...
# $Id: mgasa-2016-0043.nasl 14180 2019-03-14 12:29:16Z cfischer $
#
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"docker", rpm:"docker~1.9.1~1.mga5", rls:"MAGEIA5")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"golang", rpm:"golang~1.4.3~1.mga5", rls:"MAGEIA5")) != NULL) {
  security_message(data:res);
  exit(0);
}
