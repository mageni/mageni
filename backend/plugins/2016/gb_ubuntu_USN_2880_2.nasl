...
#
# Ubuntu Update for firefox USN-2880-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-02-09 06:24:25 +0100 (Tue, 09 Feb 2016)");
  ...
  script_name("Ubuntu Update for firefox USN-2880-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"USN-2880-1 fixed vulnerabilities in Firefox.
  This update introduced a regression which caused Firefox to crash on startup with
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2880-2/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"44.0.1+build2-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"44.0.1+build2-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU15.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"44.0.1+build2-0ubuntu0.15.10.1", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
