...
#
# Fedora Update for imlib2 FEDORA-2016-3
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for imlib2 FEDORA-2016-3");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"imlib2", rpm:"imlib2~1.4.7~1.fc22", rls:"FC22")) != NULL)
  {
