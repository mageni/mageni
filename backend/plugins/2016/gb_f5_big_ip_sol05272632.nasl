...
# $Id: gb_f5_big_ip_sol05272632.nasl 12431 2018-11-20 09:21:00Z asteins $
#
# F5 BIG-IP - SOL05272632 - BIG-IP AOM password sync vulnerability CVE-2015-8611
#
# Authors:
...
if (description)
{
  ...
  script_name("F5 BIG-IP - SOL05272632 - BIG-IP AOM password sync vulnerability CVE-2015-8611");

  script_xref(name:"URL", value:"https://support.f5.com/kb/en-us/solutions/public/k/05/sol05272632.html");
  ...
  script_tag(name:"insight", value:"BIG-IP systems on the 2000, 4000, 5000, 7000, and 10000 platforms may fail to sync passwords to the Always-On-Management (AOM).");
