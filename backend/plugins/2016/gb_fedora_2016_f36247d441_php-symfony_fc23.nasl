...
#
# Fedora Update for php-symfony FEDORA-2016-f36247d441
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for php-symfony FEDORA-2016-f36247d441");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-symfony'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"php-symfony on Fedora 23");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"php-symfony", rpm:"php-symfony~2.7.13~1.fc23", rls:"FC23")) != NULL)
  {
