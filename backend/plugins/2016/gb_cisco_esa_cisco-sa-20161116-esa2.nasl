...
# $Id: gb_cisco_esa_cisco-sa-20161116-esa2.nasl 12051 2018-10-24 09:14:54Z asteins $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.106393");
  script_cve_id("CVE-2016-6463");
  ...
  script_xref(name:"URL", value:"http://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20161116-esa2");
...
Software for Cisco Email Security Appliances could allow an unauthenticated, remote attacker to bypass
Advanced Malware Protection (AMP) filters that are configured for an affected device.");
...
configurations for the device.");
  ...
  script_tag(name:"creation_date", value:"2016-11-17 11:27:28 +0700 (Thu, 17 Nov 2016)");
