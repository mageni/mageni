...
# $Id: gb_adobe_flash_player_apsb16-32_lin.nasl 11969 2018-10-18 14:53:42Z asteins $
#
...
if(version_is_less(version:playerVer, test_version:"11.2.202.637"))
{
  report =  report_fixed_ver(installed_version:playerVer, fixed_version:"11.2.202.637");
