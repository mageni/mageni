...
#
# CentOS Update for libtevent CESA-2016:0612 centos6
#
# Authors:
...
if(description)
{
  ...
  script_name("CentOS Update for libtevent CESA-2016:0612 centos6");
...
protection for LDAP connections. A man-in-the-middle attacker could u ...
  ...
  script_tag(name:"affected", value:"libtevent on CentOS 6");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"libtevent", rpm:"libtevent~0.9.26~2.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtevent-devel", rpm:"libtevent-devel~0.9.26~2.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"python-tevent", rpm:"python-tevent~0.9.26~2.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
