...
#
# Fedora Update for libXrandr FEDORA-2016-83040426d6
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for libXrandr FEDORA-2016-83040426d6");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libXrandr'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"libXrandr on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"libXrandr", rpm:"libXrandr~1.5.1~1.fc24", rls:"FC24")) != NULL)
  {
