...
if(description)
{
  ...
  script_name("Fedora Update for ecryptfs-utils FEDORA-2016-41301e2187");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ecryptfs-utils'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"ecryptfs-utils on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"ecryptfs-utils", rpm:"ecryptfs-utils~111~1.fc24", rls:"FC24")) != NULL)
  {
