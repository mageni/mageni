...
#
# Ubuntu Update for spice USN-3014-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for spice USN-3014-1");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'spice'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"Jing Zhao discovered that the Spice
...
exploit this issue to escape virtualization. (CVE-2016-2150)");
  script_tag(name:"affected", value:"spice on Ubuntu 16.04 LTS,
  Ubuntu 15.10,
  Ubuntu 14.04 LTS");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libspice-server1:i386", ver:"0.12.4-0nocelt2ubuntu1.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
     security_message(data:res);
     exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libspice-server1:amd64", ver:"0.12.4-0nocelt2ubuntu1.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
     security_message(data:res);
     exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libspice-server1:i386", ver:"0.12.6-4ubuntu0.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
     security_message(data:res);
     exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libspice-server1:amd64", ver:"0.12.6-4ubuntu0.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
     security_message(data:res);
     exit(0);
  }
...
if(release == "UBUNTU15.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libspice-server1:i386", ver:"0.12.5-1.1ubuntu2.1", rls:"UBUNTU15.10")) != NULL)
  {
     security_message(data:res);
     exit(0);
  }

  if ((res = isdpkgvuln(pkg:"libspice-server1:amd64", ver:"0.12.5-1.1ubuntu2.1", rls:"UBUNTU15.10")) != NULL)
  {
     security_message(data:res);
     exit(0);
  }
