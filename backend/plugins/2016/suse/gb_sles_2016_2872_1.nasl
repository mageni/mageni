...
if(description)
{
  ...
  script_cve_id("CVE-2014-6277","CVE-2014-6278","CVE-2016-0634");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2872-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002410.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'bash'
  package(s) announced via the SUSE-SU-2016:2872-1 advisory.");
