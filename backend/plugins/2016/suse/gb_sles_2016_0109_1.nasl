...
if(description)
{
  ...
  script_cve_id("CVE-2015-7830","CVE-2015-8711","CVE-2015-8712");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0109-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-January/001797.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2016:0109-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'wireshark' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12 (ppc64le s390x x86_64)");
