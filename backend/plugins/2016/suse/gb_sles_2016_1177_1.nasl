...
if(description)
{
  ...
  script_cve_id("CVE-2015-5300","CVE-2015-7973","CVE-2015-7974");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1177-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-April/002033.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ntp'
  package(s) announced via the SUSE-SU-2016:1177-1 advisory.");
