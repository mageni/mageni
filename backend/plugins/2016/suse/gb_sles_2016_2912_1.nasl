...
if(description)
{
  ...
  script_cve_id("CVE-2015-8956","CVE-2016-5696","CVE-2016-6130");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2912-1)");
  ...
  package(s) announced via the SUSE-SU-2016:2912-1 advisory.");
