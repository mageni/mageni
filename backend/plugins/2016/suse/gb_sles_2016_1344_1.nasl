...
if(description)
{
  ...
  script_cve_id("CVE-2016-2523","CVE-2016-2530","CVE-2016-2531");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1344-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-May/002068.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2016:1344-1 advisory.");
