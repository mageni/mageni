...
if(description)
{
  ...
  script_cve_id("CVE-2016-9434","CVE-2016-9435","CVE-2016-9436");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:3053-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002454.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'w3m'
  package(s) announced via the SUSE-SU-2016:3053-1 advisory.");
