...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1140-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-April/002025.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'giflib'
  package(s) announced via the SUSE-SU-2016:1140-1 advisory.");
