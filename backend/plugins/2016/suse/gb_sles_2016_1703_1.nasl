...
if(description)
{
  ...
  script_cve_id("CVE-2015-5745","CVE-2015-7549","CVE-2015-8504");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1703-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-June/002141.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2016:1703-1 advisory.");
