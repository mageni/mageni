...
if(description)
{
  ...
  script_cve_id("CVE-2015-5370","CVE-2016-2110","CVE-2016-2111");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1022-1)");
  ...
  package(s) announced via the SUSE-SU-2016:1022-1 advisory.");
