...
if(description)
{
  ...
  script_cve_id("CVE-2016-3714","CVE-2016-3715","CVE-2016-3716");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1260-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-May/002049.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ImageMagick'
  package(s) announced via the SUSE-SU-2016:1260-1 advisory.");
