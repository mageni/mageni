...
if(description)
{
  ...
  script_cve_id("CVE-2016-3458","CVE-2016-3485","CVE-2016-3498");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2012-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-August/002198.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_8_0-openjdk'
  package(s) announced via the SUSE-SU-2016:2012-1 advisory.");
