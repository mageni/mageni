...
if(description)
{
  ...
  script_cve_id("CVE-2016-0762","CVE-2016-5018","CVE-2016-6794");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:3079-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002463.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tomcat'
  package(s) announced via the SUSE-SU-2016:3079-1 advisory.");
