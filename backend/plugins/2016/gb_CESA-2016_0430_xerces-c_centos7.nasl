...
#
# CentOS Update for xerces-c CESA-2016:0430 centos7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882418");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-03-11 06:01:54 +0100 (Fri, 11 Mar 2016)");
  script_cve_id("CVE-2016-0729");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("CentOS Update for xerces-c CESA-2016:0430 centos7");
...
to take effect.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-March/021729.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"xerces-c", rpm:"xerces-c~3.1.1~8.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xerces-c-devel", rpm:"xerces-c-devel~3.1.1~8.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xerces-c-doc", rpm:"xerces-c-doc~3.1.1~8.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
