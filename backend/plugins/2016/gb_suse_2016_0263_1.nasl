...
# $Id: gb_suse_2016_0263_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"java-1_8_0-openjdk was updated to version 7u95 to fix 9 security issues.
  (bsc#962743)
