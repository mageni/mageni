...
#
# CentOS Update for thunderbird CESA-2016:0001 centos6
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882353");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-01-07 05:00:54 +0100 (Thu, 07 Jan 2016)");
  script_cve_id("CVE-2015-7201", "CVE-2015-7205", "CVE-2015-7212", "CVE-2015-7213",
                "CVE-2015-7214");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("CentOS Update for thunderbird CESA-2016:0001 centos6");
...
take effect.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-January/021588.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~38.5.0~1.el6.centos", rls:"CentOS6")) != NULL)
  {
