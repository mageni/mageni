...
# $Id: gb_mysql_unspecified_vuln31_jun16_lin.nasl 34604 2014-01-21 15:11:24Z Jan$
#
# Oracle MySQL Multiple Unspecified Vulnerabilities - 31 Jun16 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.808143");
  ...
  script_tag(name:"creation_date", value:"2016-06-03 13:42:23 +0530 (Fri, 03 Jun 2016)");
  script_name("Oracle MySQL Multiple Unspecified Vulnerabilities - 31 Jun16 (Linux)");
  ...
  component via unknown vectors related to Partition.");

  script_tag(name:"impact", value:"Successful exploitation will allow
  attackers to manipulate certain data and cause a DoS (Denial of Service).");

  script_tag(name:"affected", value:"Oracle MySQL version 5.5.33 and
  earlier on Linux, Oracle MySQL version 5.6.13 and earlier on Linux");
...
if(mysqlVer =~ "^(5\.(5|6))")
{
  if(version_in_range(version:mysqlVer, test_version:"5.5", test_version2:"5.5.33")||
