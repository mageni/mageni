...
if(description)
{
  ...
  script_version("2021-01-29T12:51:16+0000");
  ...
  script_name("Oracle MySQL <= 5.5.31 / 5.6 <= 5.6.11 Security Update (cpujan2016) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.31 and earlier and 5.6.11 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.5.31") ||
   version_in_range(version:vers, test_version:"5.6.0", test_version2:"5.6.11")) {
