...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.7.12 Security Update (cpujul2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.12 and earlier.");
...
if(version_is_less(version:vers, test_version:"5.7.13")) {
