...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.806877");
  ...
  script_name("Oracle MySQL <= 5.5.46 / 5.6 <= 5.6.27 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.46 and earlier and 5.6.27 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.5.46") ||
   version_in_range(version:vers, test_version:"5.6.0", test_version2:"5.6.27")) {
