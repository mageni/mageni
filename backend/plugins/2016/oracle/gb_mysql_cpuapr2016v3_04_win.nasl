...
if(description)
{
  ...
  script_cve_id("CVE-2016-0663", "CVE-2016-0658", "CVE-2016-0656", "CVE-2016-0653", "CVE-2016-0654",
                "CVE-2016-0652");
  ...
  script_name("Oracle MySQL <= 5.7.10 Security Update (cpuapr2016v3) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.10 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.7.10")) {
