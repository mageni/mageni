...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.6.28 / 5.7 <= 5.7.10 Security Update (cpuapr2016v3) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.6.28 and earlier, 5.7.10 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.6.28") ||
