...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809388");
  ...
  script_name("Oracle MySQL <= 5.6.30 / 5.7 <= 5.7.12 Security Update (cpuoct2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.6.30 and earlier, 5.7.12 and earlier.");
