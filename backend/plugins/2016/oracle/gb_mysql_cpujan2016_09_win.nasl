...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117192");
  ...
  script_name("Oracle MySQL <= 5.6.27 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.6.27 and earlier.");
