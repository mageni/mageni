...
if(description)
{
  ...
  script_cve_id("CVE-2016-3492", "CVE-2016-5626", "CVE-2016-5629", "CVE-2016-5616", "CVE-2016-5617",
                "CVE-2016-8283", "CVE-2016-6663", "CVE-2016-6664"); # nb: From the advisory: CVE-2016-5616 is equivalent to CVE-2016-6663, and CVE-2016-5617 is equivalent to CVE-2016-6664.
  ...
  script_name("Oracle MySQL <= 5.5.51 / 5.6 <= 5.6.32 / 5.7 <= 5.7.14 Security Update (cpuoct2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.5.51 and earlier, 5.6.32 and earlier,
  5.7.14 and earlier.");
