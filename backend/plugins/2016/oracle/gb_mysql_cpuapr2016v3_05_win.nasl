...
if(description)
{
  ...
  script_cve_id("CVE-2016-0655", "CVE-2016-0639", "CVE-2016-0705", "CVE-2015-3197", "CVE-2016-0702",
                "CVE-2016-0797", "CVE-2016-0798", "CVE-2016-0799", "CVE-2016-0800");
                # nb: From the linked advisory: CVE-2016-0705 fix also addresses CVE-2015-3197, CVE-2016-0702, CVE-2016-0797, CVE-2016-0798, CVE-2016-0799, CVE-2016-0800.
  ...
  script_name("Oracle MySQL <= 5.6.29 / 5.7 <= 5.7.11 Security Update (cpuapr2016v3) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.6.29 and earlier, 5.7.11 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.6.29") ||
