...
#
# Fedora Update for libidn FEDORA-2016-42514bee97
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for libidn FEDORA-2016-42514bee97");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libidn'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"libidn on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"libidn", rpm:"libidn~1.33~1.fc24", rls:"FC24")) != NULL)
  {
