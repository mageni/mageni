...
# $Id: ELSA-2016-0204.nasl 14180 2019-03-14 12:29:16Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2016-0204 - 389-ds-base security and bug fix update. Please see the references for more insight.");
