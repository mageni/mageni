...
#
# Fedora Update for libksba FEDORA-2016-4751a94476
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for libksba FEDORA-2016-4751a94476");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libksba'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"libksba on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"libksba", rpm:"libksba~1.3.5~1.fc24", rls:"FC24")) != NULL)
  {
