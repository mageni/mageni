...
if(description)
{
  ...
  script_name("CentOS Update for ntp CESA-2016:1141 centos6");
...
The CVE-2016-1548 issue was discovered by Miroslav Lichvar (Red Hat).");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-May/021898.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.6p5~10.el6.centos.1", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ntpdate", rpm:"ntpdate~4.2.6p5~10.el6.centos.1", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.6p5~10.el6.centos.1", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ntp-perl", rpm:"ntp-perl~4.2.6p5~10.el6.centos.1", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
