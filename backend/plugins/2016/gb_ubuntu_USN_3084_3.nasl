...
#
# Ubuntu Update for linux-raspi2 USN-3084-3
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-09-20 05:41:52 +0200 (Tue, 20 Sep 2016)");
  script_cve_id("CVE-2016-6136", "CVE-2016-5412", "CVE-2016-6156");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:S/C:N/I:N/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-raspi2 USN-3084-3");
...
this to cause a denial of service (system crash). (CVE-2016-6156)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3084-3/");
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-4.4.0-1023-raspi2", ver:"4.4.0-1023.29", rls:"UBUNTU16.04 LTS")) != NULL)
  {
