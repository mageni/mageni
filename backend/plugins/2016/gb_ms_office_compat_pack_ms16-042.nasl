...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.807319");
  script_version("2019-05-03T10:54:50+0000");
  script_cve_id("CVE-2016-0122", "CVE-2016-0136");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-05-03 10:54:50 +0000 (Fri, 03 May 2019)");
  script_tag(name:"creation_date", value:"2016-04-13 11:54:47 +0530 (Wed, 13 Apr 2016)");
  script_tag(name:"qod_type", value:"executable_version");
  script_name("Microsoft Office Compatibility Pack Remote Code Execution Vulnerabilities (3148775)");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-in/kb/3114895");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-in/kb/3114982");
...
if(cmpPckVer && cmpPckVer =~ "^12\.")
{
  ...
  if(xlcnvVer && xlcnvVer =~ "^12\.")
  {
    ...
    if(version_in_range(version:xlcnvVer, test_version:"12.0", test_version2:"12.0.6747.4999"))
    {
...
if(wordcnvVer && wordcnvVer =~ "^12\.")
{
  ...
  if(path)
  {
    ...
    if(sysVer && sysVer =~ "^12\.")
    {
      if(version_in_range(version:sysVer, test_version:"12.0", test_version2:"12.0.6747.4999"))
      {
