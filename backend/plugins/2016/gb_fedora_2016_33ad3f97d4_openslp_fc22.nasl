...
#
# Fedora Update for openslp FEDORA-2016-33ad3f97d4
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"openslp on Fedora 22");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"openslp", rpm:"openslp~2.0.0~6.fc22", rls:"FC22")) != NULL)
  {
