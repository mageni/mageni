...
#
# Fedora Update for dropbear FEDORA-2016-6de0b19b3b
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for dropbear FEDORA-2016-6de0b19b3b");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"dropbear", rpm:"dropbear~2016.74~1.fc23", rls:"FC23")) != NULL)
  {
