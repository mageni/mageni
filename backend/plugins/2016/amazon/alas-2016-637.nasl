...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2016-637)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"dhcp-debuginfo", rpm:"dhcp-debuginfo~4.1.1~43.P1.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhcp-devel", rpm:"dhcp-devel~4.1.1~43.P1.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhcp-common", rpm:"dhcp-common~4.1.1~43.P1.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.1.1~43.P1.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dhclient", rpm:"dhclient~4.1.1~43.P1.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }
