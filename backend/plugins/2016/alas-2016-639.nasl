...
# $Id: alas-2016-639.nasl 6574 2017-07-06 13:41:26Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2016-639");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"grep-debuginfo", rpm:"grep-debuginfo~2.20~1.16.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"grep", rpm:"grep~2.20~1.16.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
