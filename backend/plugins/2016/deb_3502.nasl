...
# $Id: deb_3502.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"roundup", ver:"1.4.20-1.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"roundup", ver:"1.4.20-1.1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
