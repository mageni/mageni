...
#
# Ubuntu Update for clamav USN-3093-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for clamav USN-3093-1");
...
AppArmor profile.");
  script_tag(name:"affected", value:"clamav on Ubuntu 16.04 LTS,
  Ubuntu 14.04 LTS,
  Ubuntu 12.04 LTS");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"clamav", ver:"0.99.2+addedllvm-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"clamav", ver:"0.99.2+addedllvm-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"clamav", ver:"0.99.2+dfsg-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
