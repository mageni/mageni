...
#
# CentOS Update for firefox CESA-2016:0695 centos7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882478");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-04-27 05:19:04 +0200 (Wed, 27 Apr 2016)");
  script_cve_id("CVE-2016-2805", "CVE-2016-2806", "CVE-2016-2807", "CVE-2016-2808",
                "CVE-2016-2814");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("CentOS Update for firefox CESA-2016:0695 centos7");
...
Jesup as the original reporters.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-April/021852.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~45.1.0~1.el7.centos", rls:"CentOS7")) != NULL)
  {
