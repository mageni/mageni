...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2899");
  ...
  script_name("Huawei EulerOS: Security Advisory for hivex (EulerOS-SA-2021-2899)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2899");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2899");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'hivex' package(s) announced via the EulerOS-SA-2021-2899 advisory.");
...
A flaw was found in the hivex library. This flaw allows an attacker to input a specially crafted Windows Registry (hive) file, which would cause hivex to recursively call the _get_children() function, leading to a stack overflow. The highest threat from this vulnerability is to system availability.(CVE-2021-3622)");
  ...
  script_tag(name:"affected", value:"'hivex' package(s) on Huawei EulerOS Virtualization 3.0.2.6.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"hivex", rpm:"hivex~1.3.10~6.9.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-hivex", rpm:"perl-hivex~1.3.10~6.9.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
