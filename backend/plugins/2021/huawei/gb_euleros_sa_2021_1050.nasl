...
if(description)
{
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1050");
  ...
  'samba' package(s) announced via the EulerOS-SA-2021-1050 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A null pointer dereference flaw was found in samba's Winbind service in versions before 4.11.15, before 4.12.9 and before 4.13.1. A local user could use this flaw to crash the winbind service causing denial of service.CVE-2020-14323CVE-2020-14318
