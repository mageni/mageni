...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1849");
  script_version("2021-05-03T06:23:24+0000");
  ...
  script_tag(name:"creation_date", value:"2021-05-03 06:23:24 +0000 (Mon, 03 May 2021)");
  script_name("Huawei EulerOS: Security Advisory for soundtouch (EulerOS-SA-2021-1849)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1849");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1849");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'soundtouch' package(s) announced via the EulerOS-SA-2021-1849 advisory.");
...
The TDStretchSSE::calcCrossCorr function in source/SoundTouch/sse_optimized.cpp in SoundTouch 1.9.2 allows remote attackers to cause a denial of service (heap-based buffer over-read and application crash) via a crafted wav file.(CVE-2017-9260)");
  ...
  script_tag(name:"affected", value:"'soundtouch' package(s) on Huawei EulerOS V2.0SP3.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"soundtouch", rpm:"soundtouch~1.4.0~9.h2", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
