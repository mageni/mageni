...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1086");
  script_version("2021-01-19T10:10:49+0000");
  ...
  script_tag(name:"creation_date", value:"2021-01-19 10:10:49 +0000 (Tue, 19 Jan 2021)");
  script_name("Huawei EulerOS: Security Advisory for libksba (EulerOS-SA-2021-1086)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1086");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1086");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libksba' package(s) announced via the EulerOS-SA-2021-1086 advisory.");
...
Libksba before 1.3.4 allows remote attackers to cause a denial of service (out-of-bounds read and crash) via unspecified vectors, related to the 'returned length of the object from _ksba_ber_parse_tl.'(CVE-2016-4579)");
  ...
  script_tag(name:"affected", value:"'libksba' package(s) on Huawei EulerOS V2.0SP3.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libksba", rpm:"libksba~1.3.0~5.h1", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
