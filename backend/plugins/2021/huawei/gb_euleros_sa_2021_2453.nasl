...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2453");
  ...
  script_name("Huawei EulerOS: Security Advisory for ant (EulerOS-SA-2021-2453)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2453");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2453");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ant' package(s) announced via the EulerOS-SA-2021-2453 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"When reading a specially crafted ZIP archive, or a derived formats, an Apache Ant build can be made to allocate large amounts of memory that leads to an out of memory error, even for small inputs. This can be used to disrupt builds using Apache Ant. Commonly used derived formats from ZIP archives are for instance JAR files and many office files. Apache Ant prior to 1.9.16 and 1.10.11 were affected.(CVE-2021-36374)
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ant", rpm:"ant~1.10.5~2.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ant-lib", rpm:"ant-lib~1.10.5~2.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
