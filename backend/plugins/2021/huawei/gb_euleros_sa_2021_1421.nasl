...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1421");
  script_version("2021-03-05T07:05:46+0000");
  script_cve_id("CVE-2014-9601", "CVE-2020-10177", "CVE-2020-10378", "CVE-2020-35653");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2021-03-08 11:21:31 +0000 (Mon, 08 Mar 2021)");
  script_tag(name:"creation_date", value:"2021-03-05 07:05:46 +0000 (Fri, 05 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for python-pillow (EulerOS-SA-2021-1421)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1421");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1421");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'python-pillow' package(s) announced via the EulerOS-SA-2021-1421 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-pillow", rpm:"python-pillow~2.0.0~19.h9.gitd1c6db8.eulerosv2r7.x86_64", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
