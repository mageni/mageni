...
if(description)
{
  ...
  script_version("2021-02-22T08:27:37+0000");
  ...
  'java-1.7.0-openjdk' package(s) announced via the EulerOS-SA-2021-1309 advisory.");
...
Vulnerability in the Java SE, Java SE Embedded product of Oracle Java SE (component: Networking). Supported versions that are affected are Java SE: 7u231, 8u221, 11.0.4 and 13, Java SE Embedded: 8u221. Difficult to exploit vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise Java SE, Java SE Embedded. Successful attacks require human interaction from a person other than the attac ...
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.191~2.6.15.4.h11", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
