...
if(description)
{
  ...
  script_version("2021-07-01T07:39:28+0000");
  ...
  'tar' package(s) announced via the EulerOS-SA-2021-2036 advisory.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tar", rpm:"tar~1.26~34.h4.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
