...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2814");
  ...
  script_name("Huawei EulerOS: Security Advisory for squashfs-tools (EulerOS-SA-2021-2814)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2814");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2814");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'squashfs-tools' package(s) announced via the EulerOS-SA-2021-2814 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squashfs-tools", rpm:"squashfs-tools~4.3~16.h7.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
