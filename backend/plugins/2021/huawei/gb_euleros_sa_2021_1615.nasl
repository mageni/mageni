...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1615");
  script_version("2021-03-12T07:23:36+0000");
  script_cve_id("CVE-2019-17006", "CVE-2019-17007", "CVE-2020-12399", "CVE-2020-12400", "CVE-2020-12403", "CVE-2020-1971", "CVE-2020-25648");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2021-03-12 11:34:52 +0000 (Fri, 12 Mar 2021)");
  script_tag(name:"creation_date", value:"2021-03-12 07:23:36 +0000 (Fri, 12 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for nss (EulerOS-SA-2021-1615)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1615");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1615");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'nss' package(s) announced via the EulerOS-SA-2021-1615 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss", rpm:"nss~3.40.1~11.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-softokn", rpm:"nss-softokn~3.40.1~11.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.40.1~11.h8.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
