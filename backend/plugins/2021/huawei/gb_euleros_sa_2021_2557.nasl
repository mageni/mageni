...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2557");
  ...
  script_name("Huawei EulerOS: Security Advisory for libsolv (EulerOS-SA-2021-2557)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2557");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2557");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsolv' package(s) announced via the EulerOS-SA-2021-2557 advisory.");
  ...
  script_tag(name:"affected", value:"'libsolv' package(s) on Huawei EulerOS V2.0SP9(x86_64).");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsolv", rpm:"libsolv~0.7.7~2.h3.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
