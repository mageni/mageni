...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2760");
  ...
  script_name("Huawei EulerOS: Security Advisory for tar (EulerOS-SA-2021-2760)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2760");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2760");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'tar' package(s) announced via the EulerOS-SA-2021-2760 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tar", rpm:"tar~1.30~11.h2.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
