...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2536");
  ...
  script_name("Huawei EulerOS: Security Advisory for nettle (EulerOS-SA-2021-2536)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2536");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2536");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'nettle' package(s) announced via the EulerOS-SA-2021-2536 advisory.");
...
nettle: Remote crash in RSA decryption via manipulated ciphertext.(CVE-2021-3580)");
  ...
  script_tag(name:"affected", value:"'nettle' package(s) on Huawei EulerOS V2.0SP9.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nettle", rpm:"nettle~3.4.1rc1~5.h3.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
