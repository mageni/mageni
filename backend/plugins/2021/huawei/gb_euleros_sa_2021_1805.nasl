...
if(description)
{
  ...
  script_version("2021-05-03T06:20:58+0000");
  ...
  'java-1.7.0-openjdk' package(s) announced via the EulerOS-SA-2021-1805 advisory.");
...
Vulnerability in the Java SE product of Oracle Java SE (component: Javadoc). Supported versions that are affected are Java SE: 7u231, 8u221, 11.0.4 and 13. Difficult to exploit vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise Java SE. Successful attacks require human interaction from a person other than the attacker and while the vulnerability is in  ...
