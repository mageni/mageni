...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1824");
  script_version("2021-05-03T06:22:25+0000");
  ...
  script_tag(name:"creation_date", value:"2021-05-03 06:22:25 +0000 (Mon, 03 May 2021)");
  script_name("Huawei EulerOS: Security Advisory for openldap (EulerOS-SA-2021-1824)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1824");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1824");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openldap' package(s) announced via the EulerOS-SA-2021-1824 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was discovered in ldap_X509dn2bv in OpenLDAP before 2.4.57 leading to a slapd crash in the X.509 DN parsing in ad_keystring, resulting in denial of service.(CVE-2020-36229)
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.4.44~5.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-clients", rpm:"openldap-clients~2.4.44~5.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-devel", rpm:"openldap-devel~2.4.44~5.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-servers", rpm:"openldap-servers~2.4.44~5.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
