...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2891");
  ...
  script_name("Huawei EulerOS: Security Advisory for gd (EulerOS-SA-2021-2891)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2891");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2891");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gd' package(s) announced via the EulerOS-SA-2021-2891 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gd", rpm:"gd~2.0.35~26.h10.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
