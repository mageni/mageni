...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2361");
  ...
  script_name("Huawei EulerOS: Security Advisory for compat-openldap (EulerOS-SA-2021-2361)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2361");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2361");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'compat-openldap' package(s) announced via the EulerOS-SA-2021-2361 advisory.");
...
A flaw was discovered in OpenLDAP before 2.4.57 leading to an infinite loop in slapd with the cancel_extop Cancel operation, resulting in denial of service.(CVE-2020-36227)");
  ...
  script_tag(name:"affected", value:"'compat-openldap' package(s) on Huawei EulerOS V2.0SP2.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"compat-openldap", rpm:"compat-openldap~2.3.43~5.h3", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
