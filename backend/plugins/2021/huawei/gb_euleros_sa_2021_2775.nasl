...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2775");
  script_cve_id("CVE-2021-23437", "CVE-2021-25292", "CVE-2021-25293", "CVE-2021-34552");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-pillow (EulerOS-SA-2021-2775)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2775");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2775");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-pillow' package(s) announced via the EulerOS-SA-2021-2775 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in Pillow before 8.1.1. There is an out-of-bounds read in SGIRleDecode.c.(CVE-2021-25293)
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-pillow", rpm:"python3-pillow~5.3.0~4.h19.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
