...
if(description)
{
  ...
  script_version("2021-03-05T07:04:47+0000");
  ...
  'dnsmasq' package(s) announced via the EulerOS-SA-2021-1389 advisory.");
...
A flaw was found in dnsmasq. A heap-based buffer overflow was discovered in dnsmasq when DNSSEC is enabled and before it validates the received DNS en ...
