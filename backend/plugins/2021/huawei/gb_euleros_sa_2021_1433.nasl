...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1433");
  script_version("2021-03-05T07:06:08+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-05 07:06:08 +0000 (Fri, 05 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for gdk-pixbuf2 (EulerOS-SA-2021-1433)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1433");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1433");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'gdk-pixbuf2' package(s) announced via the EulerOS-SA-2021-1433 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdk-pixbuf2", rpm:"gdk-pixbuf2~2.36.5~1.h6.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
