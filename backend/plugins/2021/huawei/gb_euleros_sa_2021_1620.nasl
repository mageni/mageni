...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1620");
  script_version("2021-03-12T07:23:47+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-12 07:23:47 +0000 (Fri, 12 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for p11-kit (EulerOS-SA-2021-1620)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1620");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1620");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'p11-kit' package(s) announced via the EulerOS-SA-2021-1620 advisory.");
...
An issue was discovered in p11-kit 0.23.6 through 0.23.21. A heap-based buffer overflow has been discovered in the RPC protocol used by p11-kit server/remote commands and the client library. When the remote entity supplies a serialized byte array in a CK_ATTRIBUTE, the receiving entity may not allocate sufficient length for the buffer to store the deserialized value.(CVE-2020-29363)");
  ...
  script_tag(name:"affected", value:"'p11-kit' package(s) on Huawei EulerOS Virtualization release 2.9.1.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"p11-kit", rpm:"p11-kit~0.23.14~6.h2.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
