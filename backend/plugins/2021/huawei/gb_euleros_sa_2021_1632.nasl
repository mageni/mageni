...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1632");
  script_version("2021-03-12T07:24:14+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-12 07:24:14 +0000 (Fri, 12 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for qemu (EulerOS-SA-2021-1632)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1632");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1632");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'qemu' package(s) announced via the EulerOS-SA-2021-1632 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu", rpm:"qemu~4.1.0~2.9.1.2.208.aarch64", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-debuginfo", rpm:"qemu-debuginfo~4.1.0~2.9.1.1.208.aarch64", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-debugsource", rpm:"qemu-debugsource~4.1.0~2.9.1.2.208.aarch64", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-guest-agent", rpm:"qemu-guest-agent~4.1.0~2.9.1.2.208.aarch64", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~4.1.0~2.9.1.2.208.aarch64", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
