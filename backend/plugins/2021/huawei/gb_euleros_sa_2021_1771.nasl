...
if(description)
{
  ...
  script_version("2021-05-03T06:19:41+0000");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1771");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'compat-openldap' package(s) announced via the EulerOS-SA-2021-1771 advisory.");
