...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2004");
  script_version("2021-07-01T07:38:16+0000");
  ...
  script_tag(name:"creation_date", value:"2021-07-01 07:38:16 +0000 (Thu, 01 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for openldap (EulerOS-SA-2021-2004)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2004");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2004");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openldap' package(s) announced via the EulerOS-SA-2021-2004 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.4.46~8.h12.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-clients", rpm:"openldap-clients~2.4.46~8.h12.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-devel", rpm:"openldap-devel~2.4.46~8.h12.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-servers", rpm:"openldap-servers~2.4.46~8.h12.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
