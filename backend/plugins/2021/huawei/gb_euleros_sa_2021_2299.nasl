...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2299");
  script_cve_id("CVE-2021-20309", "CVE-2021-20311", "CVE-2021-20312", "CVE-2021-20313");
  script_tag(name:"creation_date", value:"2021-08-09 10:12:26 +0000 (Mon, 09 Aug 2021)");
  ...
  script_name("Huawei EulerOS: Security Advisory for ImageMagick (EulerOS-SA-2021-2299)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2299");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2299");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ImageMagick' package(s) announced via the EulerOS-SA-2021-2299 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~6.9.9.38~3.h20.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-c++", rpm:"ImageMagick-c++~6.9.9.38~3.h20.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-libs", rpm:"ImageMagick-libs~6.9.9.38~3.h20.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-perl", rpm:"ImageMagick-perl~6.9.9.38~3.h20.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
