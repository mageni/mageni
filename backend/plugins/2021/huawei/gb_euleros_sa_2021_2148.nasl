...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2148");
  ...
  script_tag(name:"creation_date", value:"2021-07-07 08:43:57 +0000 (Wed, 07 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for mariadb (EulerOS-SA-2021-2148)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2148");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2148");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'mariadb' package(s) announced via the EulerOS-SA-2021-2148 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb", rpm:"mariadb~5.5.66~1.h1.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
