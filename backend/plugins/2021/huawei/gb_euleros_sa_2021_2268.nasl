...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2268");
  script_cve_id("CVE-2021-3448");
  script_tag(name:"creation_date", value:"2021-08-09 10:11:11 +0000 (Mon, 09 Aug 2021)");
  ...
  script_name("Huawei EulerOS: Security Advisory for dnsmasq (EulerOS-SA-2021-2268)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2268");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2268");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dnsmasq' package(s) announced via the EulerOS-SA-2021-2268 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.81~1.h8.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
