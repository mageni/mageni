...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2439");
  ...
  script_name("Huawei EulerOS: Security Advisory for wpa_supplicant (EulerOS-SA-2021-2439)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2439");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2439");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'wpa_supplicant' package(s) announced via the EulerOS-SA-2021-2439 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~2.6~5.1.h12", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
