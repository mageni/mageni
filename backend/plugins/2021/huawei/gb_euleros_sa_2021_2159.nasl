...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2159");
  script_version("2021-07-07T09:11:54+0000");
  script_cve_id("CVE-2019-20907", "CVE-2020-26116", "CVE-2020-27619", "CVE-2021-23336");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2021-07-07 09:11:54 +0000 (Wed, 07 Jul 2021)");
  script_tag(name:"creation_date", value:"2021-07-07 08:44:33 +0000 (Wed, 07 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for python (EulerOS-SA-2021-2159)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2159");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2159");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'python' package(s) announced via the EulerOS-SA-2021-2159 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python", rpm:"python~2.7.5~69.h26.x86_64", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-libs", rpm:"python-libs~2.7.5~69.h26.x86_64", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
