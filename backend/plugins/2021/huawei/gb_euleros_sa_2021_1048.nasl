...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1048");
  ...
  script_tag(name:"creation_date", value:"2021-01-08 21:54:45 +0000 (Fri, 08 Jan 2021)");
  script_name("Huawei EulerOS: Security Advisory for xorg-x11-server (EulerOS-SA-2021-1048)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1048");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1048");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'xorg-x11-server' package(s) announced via the EulerOS-SA-2021-1048 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-Xorg", rpm:"xorg-x11-server-Xorg~1.19.5~5.h11", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-common", rpm:"xorg-x11-server-common~1.19.5~5.h11", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
