...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1053");
  ...
  script_tag(name:"creation_date", value:"2021-01-08 21:55:08 +0000 (Fri, 08 Jan 2021)");
  script_name("Huawei EulerOS: Security Advisory for perl-DBD-MySQL (EulerOS-SA-2021-1053)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1053");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1053");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'perl-DBD-MySQL' package(s) announced via the EulerOS-SA-2021-1053 advisory.");
