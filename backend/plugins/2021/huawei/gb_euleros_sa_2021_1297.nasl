...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1297");
  script_version("2021-02-22T08:18:22+0000");
  ...
  script_tag(name:"creation_date", value:"2021-02-22 08:18:22 +0000 (Mon, 22 Feb 2021)");
  script_name("Huawei EulerOS: Security Advisory for gdm (EulerOS-SA-2021-1297)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1297");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1297");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'gdm' package(s) announced via the EulerOS-SA-2021-1297 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdm", rpm:"gdm~3.14.2~12.h3", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
