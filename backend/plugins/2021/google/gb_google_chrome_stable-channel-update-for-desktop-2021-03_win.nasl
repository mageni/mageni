...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818004");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2021-03)-Windows");
  ...
  prior to 89.0.4389.72 on Windows");
