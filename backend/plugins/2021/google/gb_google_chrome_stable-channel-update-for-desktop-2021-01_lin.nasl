...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817561");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2021-01)-Linux");
  ...
  prior to 87.0.4280.141 on Linux");
