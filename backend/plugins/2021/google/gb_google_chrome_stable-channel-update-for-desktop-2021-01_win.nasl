...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817560");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2021-01)-Windows");
  ...
  prior to 87.0.4280.141 on Windows");
