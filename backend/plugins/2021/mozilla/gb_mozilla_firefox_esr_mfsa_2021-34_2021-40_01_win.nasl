...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818516");
  ...
  script_name("Mozilla Firefox ESR Security Update(mfsa_2021-34_2021-40) -01 - Windows");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 91.1
...
if(version_in_range(version:vers, test_version:"91.0", test_version2:"91.0.2"))
{
