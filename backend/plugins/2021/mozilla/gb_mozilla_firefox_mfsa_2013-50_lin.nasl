...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2013.50");
  script_cve_id("CVE-2013-1684", "CVE-2013-1685", "CVE-2013-1686");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2013-50) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2013-50");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2013-50/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=865537");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=871099");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=876155");
