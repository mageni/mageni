...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2014.31");
  script_cve_id("CVE-2014-1513");
  ...
  script_tag(name:"severity_date", value:"2020-08-11 11:54:00 +0000 (Tue, 11 Aug 2020)");

  script_name("Mozilla Firefox Security Advisory (MFSA2014-31) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2014-31");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2014-31/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=982974");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Out-of-bounds read/write through neutering ArrayBuffer objects
Security researcher Juri Aedla, via TippingPoint's
