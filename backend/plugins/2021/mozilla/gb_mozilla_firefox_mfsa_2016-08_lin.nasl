...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2016.08");
  script_cve_id("CVE-2016-1941");
  ...
  script_tag(name:"severity_date", value:"2017-09-09 23:29:00 +0000 (Sat, 09 Sep 2017)");

  script_name("Mozilla Firefox Security Advisory (MFSA2016-08) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2016-08");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2016-08/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1116385");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Delay following click events in file download dialog too short on OS X
