...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2013.31");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2013-31) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2013-31");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2013-31/");
  ...
  script_tag(name:"insight", value:"Out-of-bounds write in Cairo library
