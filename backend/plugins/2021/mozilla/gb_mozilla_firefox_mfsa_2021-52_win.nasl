...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818878");
  ...
  script_name("Mozilla Firefox Security Update (mfsa2021-52) - Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 95 on
  Windows.");

  script_tag(name:"solution", value:"Update to Mozilla Firefox version 95
...
if(version_is_less(version:vers, test_version:"95")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"95", install_path:path);
