...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2012.103");
  script_cve_id("CVE-2012-4209");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2012-103) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2012-103");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2012-103/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=792405");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Frames can shadow top.location
