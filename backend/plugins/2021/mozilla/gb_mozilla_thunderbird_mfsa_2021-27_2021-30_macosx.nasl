...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818179");
  ...
  script_name("Mozilla Thunderbird Security Updates(mfsa_2021-27_2021-30)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Thunderbird version before 78.12 on MAC OS X.");
