...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818174");
  ...
  script_name("Mozilla Firefox Security Updates(mfsa_2021-28_2021-30)-Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox version before 90 on Windows.");
