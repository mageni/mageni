...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818513");
  ...
  script_name("Mozilla Firefox ESR Security Update(mfsa_2021-34_2021-40) -01 - MAC OS X");
...
if(version_is_less(version:vers, test_version:"91.1"))
{
