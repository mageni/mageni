...
if(description)
{
  ...
  script_version("2021-06-02T09:07:16+0000");
  ...
  script_tag(name:"affected", value:"Oracle OpenJDK versions 13, 11.0.4, 8u222, 7u231 and prior.");
...
if( vers =~ "^11" ) {
  if( version_is_less_equal( version:vers, test_version:"11.0.4" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
...
if( vers =~ "^1\.8" ) {
  if( version_is_less_equal( version:vers, test_version:"1.8.0.222" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
...
if( vers =~ "^1\.7" ) {
  if( version_is_less_equal( version:vers, test_version:"1.7.0.231" ) ) {
    report = report_fixed_ver( installed_version:vers, fixed_version:"See advisory", install_path:path );
    security_message( port:port, data:report );
    exit( 0 );
  }
