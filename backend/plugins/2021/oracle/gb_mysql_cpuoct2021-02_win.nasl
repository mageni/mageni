...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117743");
  ...
  script_cve_id("CVE-2021-35583", "CVE-2021-35537", "CVE-2021-35629");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0 <= 8.0.25 Security Update (cpuoct2021) - Windows");
