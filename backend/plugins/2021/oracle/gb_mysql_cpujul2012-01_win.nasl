...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117263");
  ...
  script_name("Oracle MySQL Server <= 5.1.62 / 5.4.x <= 5.5.22 Security Update (cpujul2012) - Windows");
...
else if (version_in_range(version: version, test_version: "5.4", test_version2: "5.5.22")) {
