...
if (description)
{
  ...
  script_name("Oracle MySQL < 5.6.51 / 5.7.x < 5.7.33 / 8.0.x < 8.0.23 Security Update (cpujan2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.6.50 and prior, 5.7.32 and prior, 8.0.22 and prior.");
