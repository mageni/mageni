...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818836");
  script_version("2021-10-29T03:03:24+0000");
  script_cve_id("CVE-2021-35588");
  ...
  script_tag(name:"severity_date", value:"2021-10-27 19:52:00 +0000 (Wed, 27 Oct 2021)");
  script_tag(name:"creation_date", value:"2021-10-25 16:21:51 +0530 (Mon, 25 Oct 2021)");
  script_name("Oracle Java SE Security Update (oct2021) 05 - Linux");

  script_tag(name:"summary", value:"Oracle Java SE is prone to a denial of service
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw is due to an error in 'Hotspot'
  component.");
  ...
  and earlier, 7u311 (1.7.0.311) and earlier on Linux.");
