...
if (description)
{
  ...
  script_name("Oracle MySQL 5.7.x < 5.7.33 / 8.0.x < 8.0.23 Security Update (cpujan2021) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.32 and prior, 8.0.22 and prior.");
