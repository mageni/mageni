...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818911");
  ...
  script_name("Microsoft Word 2016 RCE Vulnerability (KB5002004)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5002004");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002004");
...
if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.5227.1000 "))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"16.0 - 16.0.5227.0999");
