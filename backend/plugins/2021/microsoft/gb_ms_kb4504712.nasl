...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817996");
  ...
  script_name("Microsoft Outlook 2016 Memory Corruption Vulnerability (KB4504712)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4504712");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4504712");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.5149.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.5149.0999");
