...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818024");
  ...
  script_tag(name:"creation_date", value:"2021-04-14 12:12:13 +0530 (Wed, 14 Apr 2021)");
  script_name("Microsoft Office Remote Code Execution Vulnerability (KB3178639)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB3178639");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an improper
  input validation in Microsoft Office.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/3178639");
