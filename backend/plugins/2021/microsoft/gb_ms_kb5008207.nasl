...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818928");
  ...
  script_cve_id("CVE-2021-41333", "CVE-2021-43207", "CVE-2021-43215", "CVE-2021-43216",
                ...
                "CVE-2021-43231", "CVE-2021-43232", "CVE-2021-43233", "CVE-2021-43234",
                "CVE-2021-43235", "CVE-2021-43236", "CVE-2021-43238", "CVE-2021-43248",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5008207)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5008207");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5008207");
...
if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.4824"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.4824");
