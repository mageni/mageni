...
if(description)
{
  ...
  script_cve_id("CVE-2021-26424", "CVE-2021-26425", "CVE-2021-26426", "CVE-2021-26432",
                ...
                "CVE-2021-36937", "CVE-2021-36947", "CVE-2021-36948");
...
if(version_in_range(version:fileVer, test_version:"10.0.18362.0", test_version2:"10.0.18362.1592"))
{
  report = report_fixed_ver(file_checked:dllPath + "\localspl.dll",
                            file_version:fileVer, vulnerable_range:"10.0.18362.0 - 10.0.18362.1592");
