...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817690");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5001337)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5001337");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001337");
...
if(version_in_range(version:fileVer, test_version:"10.0.18362.0", test_version2:"10.0.18362.1499"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.18362.0 - 10.0.18362.1499");
