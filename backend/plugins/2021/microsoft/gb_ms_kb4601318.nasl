...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817598");
  ...
  script_cve_id("CVE-2021-1722", "CVE-2021-1727", "CVE-2021-1734", "CVE-2021-24074",
                ...
                "CVE-2021-24086", "CVE-2021-24088", "CVE-2021-24091", "CVE-2021-24093",
                "CVE-2021-24094", "CVE-2021-24096", "CVE-2021-24102", "CVE-2021-24103",
                "CVE-2021-24111", "CVE-2021-25195");
  ...
  script_tag(name:"creation_date", value:"2021-02-10 10:58:34 +0530 (Wed, 10 Feb 2021)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4601318)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4601318");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4601318");
...
if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.4224"))
{
  report = report_fixed_ver(file_checked:dllPath + "\ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.4224");
