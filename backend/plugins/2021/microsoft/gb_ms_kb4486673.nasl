...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817682");
  ...
  script_name("Microsoft Visio 2013 SP1 Security Feature Bypass Vulnerability (KB4486673");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4486673");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4486673");
...
if(version_in_range(version:excelVer, test_version:"15.0", test_version2:"15.0.5327.0999"))
{
  report = report_fixed_ver(file_checked:"visio.exe",
           file_version:excelVer, vulnerable_range:"15.0 - 15.0.5327.0999");
