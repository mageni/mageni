...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817713");
  script_version("2021-05-13T02:37:14+0000");
  script_cve_id("CVE-2021-31176");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2021-05-14 09:39:56 +0000 (Fri, 14 May 2021)");
  script_tag(name:"creation_date", value:"2021-05-13 08:05:20 +0530 (Thu, 13 May 2021)");
  script_name("Microsoft Office 2016 Remote Code Execution Vulnerability (KB5001920)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5001920.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001920");
