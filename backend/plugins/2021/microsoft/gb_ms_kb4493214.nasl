...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817961");
  ...
  script_name("Microsoft Office 2010 Remote Code Execution Vulnerabilities (KB4493214)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4493214");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4493214");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    if(msdllVer && version_in_range(version:msdllVer, test_version:"14.0", test_version2:"14.0.7266.4999"))
    {
      report = report_fixed_ver( file_checked:offPath + "\graph.exe",
                                 file_version:msdllVer, vulnerable_range:"14.0 - 14.0.7266.4999");
