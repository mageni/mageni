...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818854");
  script_version("2021-11-12T03:03:36+0000");
  script_cve_id("CVE-2021-38631", "CVE-2021-38665", "CVE-2021-38666", "CVE-2021-41367",
                "CVE-2021-41370", "CVE-2021-41371", "CVE-2021-41377", "CVE-2021-41379",
                "CVE-2021-42275", "CVE-2021-42278", "CVE-2021-42282", "CVE-2021-42283",
                "CVE-2021-42285", "CVE-2021-42287", "CVE-2021-42291");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5007236)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5007236");
  ...
  to disclose sensitive information, perform remote code execution and elevate
  privileges.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5007236");
...
if(version_is_less(version:fileVer, test_version:"6.1.7601.25767"))
{
  report = report_fixed_ver(file_checked:dllPath + "\advapi32.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.1.7601.25767");
