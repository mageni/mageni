...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818525");
  ...
  script_cve_id("CVE-2021-26435", "CVE-2021-36955", "CVE-2021-36959", "CVE-2021-36960",
                ...
                "CVE-2021-38629", "CVE-2021-38630", "CVE-2021-38632", "CVE-2021-38633",
                "CVE-2021-38634", "CVE-2021-38635", "CVE-2021-38636", "CVE-2021-38638",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5005573)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5005573");
  ...
  - A memory corruption error in Windows Scripting Engine.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5005573");
...
if(version_in_range(version:fileVer, test_version:"10.0.14393.0", test_version2:"10.0.14393.4650"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Pcadm.dll",
                            file_version:fileVer, vulnerable_range:"10.0.14393.0 - 10.0.14393.4650");
