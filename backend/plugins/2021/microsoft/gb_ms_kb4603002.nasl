...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817665");
  ...
  script_name("Microsoft .NET Framework Denial of Service Vulnerability (KB4603002)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4603002");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 4.6, 4.6.1, 4.6.2, 4.7, 4.7.1, 4.7.2, 4.8 for Microsoft Windows 7 SP1 and Microsoft Windows Server 2008 R2 SP1.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4603002");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            if(version_in_range(version:dllVer, test_version:"4.6", test_version2:"4.7.3769"))
            {
              vulnerable_range = "4.6 - 4.7.3769";
              break;
            }
            else if(version_in_range(version:dllVer, test_version:"4.8", test_version2:"4.8.4329"))
            {
