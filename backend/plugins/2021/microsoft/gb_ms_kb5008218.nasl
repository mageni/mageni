...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818925");
  ...
  script_cve_id("CVE-2021-41333", "CVE-2021-43207", "CVE-2021-43215", "CVE-2021-43216",
                ...
                "CVE-2021-43238", "CVE-2021-43244", "CVE-2021-43246", "CVE-2021-43247",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5008218)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5008218");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5008218");
...
if(version_in_range(version:fileVer, test_version:"10.0.17763.0", test_version2:"10.0.17763.2365"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.17763.0 - 10.0.17763.2365");
