...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818114");
  script_version("2021-05-13T02:37:14+0000");
  script_cve_id("CVE-2020-24587", "CVE-2020-24588", "CVE-2020-26144", "CVE-2021-26419",
                "CVE-2021-28455", "CVE-2021-28476", "CVE-2021-28479", "CVE-2021-31170",
                "CVE-2021-31182", "CVE-2021-31184", "CVE-2021-31186", "CVE-2021-31187",
                "CVE-2021-31188", "CVE-2021-31191", "CVE-2021-31193", "CVE-2021-31194");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5003174)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5003174");
  ...
  - An error in Windows WalletService.
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5003174");
...
if(version_in_range(version:fileVer, test_version:"10.0.17134.0", test_version2:"10.0.17134.2207"))
{
  report = report_fixed_ver(file_checked:dllPath + "\ci.dll",
                            file_version:fileVer, vulnerable_range:"10.0.17134.0 - 10.0.17134.2207");
