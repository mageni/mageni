...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817678");
  ...
  script_name("Microsoft PowerPoint 2010 SP2 RCE Vulnerability (KB4504702");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4504702");
  ...
  script_tag(name:"affected", value:"Microsoft PowerPoint 2010 SP2.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4504702");
...
foreach key(key_list)
{
  ...
  if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"14.0.7266.5000"))
  {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll",
                            file_version:exeVer, vulnerable_range:"14.0 - 14.0.7266.4999");
