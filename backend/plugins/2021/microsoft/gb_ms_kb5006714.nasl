...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818806");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5006714)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5006714");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5006714");
...
fileVer = fetch_file_version(sysPath:dllPath, file_name:"ole32.dll");
if(!fileVer){
  exit(0);
}

if(version_is_less(version:fileVer, test_version:"6.3.9600.20144"))
{
  report = report_fixed_ver(file_checked:dllPath + "\ole32.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.3.9600.20144");
