...
MD5 warning message using host, dig, nslookup (bind-utils) with FIPS
 enabled (bsc#1181495).");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, HPE Helion Openstack 8");
