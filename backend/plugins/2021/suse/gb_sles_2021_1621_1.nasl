...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-29 03:15:00 +0000 (Sat, 29 May 2021)");
  ...
  script_mandatory_keys("ssh/login/suse_sles", "ssh/login/rpms", re:"ssh/login/release=(SLES12\.0SP5|SLES12\.0SP4|SLES12\.0SP3|SLES12\.0SP2|SLES12\.0)");
...
Make sure to close the 'import_failed.map' file after the exception has
 ...
 is part of a try...except block");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 9, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Module for Web Scripting 12, HPE Helion Openstack 8");
