...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.14821.1");
  ...
  script_tag(name:"creation_date", value:"2021-10-04 02:19:37 +0000 (Mon, 04 Oct 2021)");
  script_version("2021-10-04T02:19:37+0000");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:14821-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:14821-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-202114821-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2021:14821-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~78.14.0~78.140.4", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~78.14.0~78.140.4", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-other", rpm:"MozillaFirefox-translations-other~78.14.0~78.140.4", rls:"SLES11.0SP4"))) {
    report += res;
  }
