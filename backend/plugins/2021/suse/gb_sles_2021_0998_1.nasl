...
if(description)
{
  ...
  script_cve_id("CVE-2019-15945","CVE-2019-15946","CVE-2019-19479");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0998-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-March/008574.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'opensc'
  package(s) announced via the SUSE-SU-2021:0998-1 advisory.");
