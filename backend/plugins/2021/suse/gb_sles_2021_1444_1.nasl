...
Adjust smbcacls '--propagate-inheritance' feature to align with upstream
 (bsc#1178469).");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on SUSE Linux Enterprise Module for Python2 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise High Availability 15-SP2");
