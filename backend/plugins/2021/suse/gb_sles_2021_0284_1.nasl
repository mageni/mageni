...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0284-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-February/008266.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openvswitch'
  package(s) announced via the SUSE-SU-2021:0284-1 advisory.");
