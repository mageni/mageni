...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.1785.2");
  script_cve_id("CVE-2021-32027", "CVE-2021-32028", "CVE-2021-32029");
  script_tag(name:"creation_date", value:"2021-07-12 02:35:14 +0000 (Mon, 12 Jul 2021)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1785-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1785-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211785-2/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql13' package(s) announced via the SUSE-SU-2021:1785-2 advisory.");
...
Disable icu for PostgreSQL 10 (and older) on TW (bsc#1179945).");
  ...
  script_tag(name:"affected", value:"'postgresql13' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP3");
...
if(release == "SLES15.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"postgresql13-test", rpm:"postgresql13-test~13.3~5.10.1", rls:"SLES15.0SP3"))){
    report += res;
  }
