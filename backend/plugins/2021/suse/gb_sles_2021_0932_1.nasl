...
if(description)
{
  ...
  script_cve_id("CVE-2016-1544","CVE-2018-1000168","CVE-2019-9511");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0932-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-March/008541.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'nghttp2'
  package(s) announced via the SUSE-SU-2021:0932-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'nghttp2' package(s) on SUSE Linux Enterprise Server 12");
