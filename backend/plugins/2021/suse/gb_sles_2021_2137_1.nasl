...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.2137.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:2137-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:2137-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212137-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cryptctl' package(s) announced via the SUSE-SU-2021:2137-1 advisory.");
...
avoid hard coding 127.0.0.1 in host ID of alive message test, let system
 ...
 key server.");
  ...
  script_tag(name:"affected", value:"'cryptctl' package(s) on SUSE Linux Enterprise Server for SAP 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP5");
...
if(release == "SLES12.0SP5") {
  if(!isnull(res = isrpmvuln(pkg:"cryptctl", rpm:"cryptctl~2.4~2.10.1", rls:"SLES12.0SP5"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cryptctl-debuginfo", rpm:"cryptctl-debuginfo~2.4~2.10.1", rls:"SLES12.0SP5"))){
    report += res;
  }
