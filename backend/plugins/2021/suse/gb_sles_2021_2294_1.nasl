...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.2294.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:2294-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:2294-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212294-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the SUSE-SU-2021:2294-1 advisory.");
...
if(release == "SLES15.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.0.14~6.5.1", rls:"SLES15.0SP3"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"redis-debuginfo", rpm:"redis-debuginfo~6.0.14~6.5.1", rls:"SLES15.0SP3"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"redis-debugsource", rpm:"redis-debugsource~6.0.14~6.5.1", rls:"SLES15.0SP3"))){
    report += res;
  }
...
if(release == "SLES15.0SP2") {
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.0.14~6.5.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"redis-debuginfo", rpm:"redis-debuginfo~6.0.14~6.5.1", rls:"SLES15.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"redis-debugsource", rpm:"redis-debugsource~6.0.14~6.5.1", rls:"SLES15.0SP2"))){
    report += res;
  }
