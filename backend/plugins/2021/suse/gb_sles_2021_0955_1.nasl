...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-17 17:04:00 +0000 (Thu, 17 Jun 2021)");
...
CVE-2021-3449: An OpenSSL TLS server may crash if sent a maliciously
 ...
 attack. OpenSSL TLS clients are not impacted by this issue. [bsc#1183852]");
  ...
  script_tag(name:"affected", value:"'openssl-1_1' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
