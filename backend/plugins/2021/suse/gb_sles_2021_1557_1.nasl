...
CVE-2021-3426: Fixed an information disclosure via pydoc (bsc#1183374)");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Development Tools 15-SP3, SUSE Linux Enterprise Module for Development Tools 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
