...
if(description)
{
  ...
  script_cve_id("CVE-2019-19063","CVE-2019-20934","CVE-2019-6133");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0437-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-February/008312.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2021:0437-1 advisory.");
