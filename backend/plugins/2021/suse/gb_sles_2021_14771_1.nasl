...
CVE-2019-20218: Fixed a stack unwinding flaw in the selectExpander after
 a parsing error. (bsc#1160439)");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Point of Sale 11-SP3, SUSE Linux Enterprise Debuginfo 11-SP4.");
