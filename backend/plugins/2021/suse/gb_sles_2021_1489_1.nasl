...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-11 18:41:00 +0000 (Fri, 11 Jun 2021)");
...
CVE-2021-3479: Fixed an Out-of-memory caused by allocation of a very
 large buffer (bsc#1184354).");
  ...
  script_tag(name:"affected", value:"'openexr' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15-SP3, SUSE Linux Enterprise Module for Desktop Applications 15-SP2");
