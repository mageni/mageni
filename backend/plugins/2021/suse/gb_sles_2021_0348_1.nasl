...
if(description)
{
  ...
  script_cve_id("CVE-2020-25639","CVE-2020-27835","CVE-2020-28374");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0348-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-February/008288.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2021:0348-1 advisory.");
