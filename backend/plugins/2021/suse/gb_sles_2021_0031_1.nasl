...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0031-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-January/008151.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tomcat'
  package(s) announced via the SUSE-SU-2021:0031-1 advisory.");
