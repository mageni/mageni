...
Fixed an integer underflow in the GIF loader (bsc#1174307).");
  ...
  script_tag(name:"affected", value:"'gdk-pixbuf' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2");
