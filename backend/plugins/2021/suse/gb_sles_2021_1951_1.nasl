...
Remove duplicate directories");
  ...
  script_tag(name:"affected", value:"'salt' package(s) on SUSE Linux Enterprise Module for Transactional Server 15-SP3, SUSE Linux Enterprise Module for Server Applications 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP3");
