...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.4059.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:4059-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:4059-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20214059-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc' package(s) announced via the SUSE-SU-2021:4059-1 advisory.");
...
Fixed returning error from GetStats when hugetlb is unsupported (which
 causes excessive logging for kubernetes).");
  ...
  script_tag(name:"affected", value:"'runc' package(s) on SUSE Linux Enterprise Module for Containers 12.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.0.3~16.18.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"runc-debuginfo", rpm:"runc-debuginfo~1.0.3~16.18.1", rls:"SLES12.0"))) {
    report += res;
  }
