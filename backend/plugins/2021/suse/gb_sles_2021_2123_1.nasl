...
CVE-2021-33515: Attacker can potentially steal user credentials and
 mails (bsc#1187419)");
  ...
  script_tag(name:"affected", value:"'dovecot23' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP3, SUSE Linux Enterprise Module for Server Applications 15-SP2");
