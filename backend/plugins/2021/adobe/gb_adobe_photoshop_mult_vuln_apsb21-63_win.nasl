...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817749");
  ...
  script_name("Adobe Photoshop Multiple Vulnerabilities (APSB21-63) - Windows");
  ...
  and Adobe Photoshop 2021 prior to 22.4.3 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Photoshop 2020 21.2.10
  or Adobe Photoshop 2021 22.4.3 or later. Please see the references for more
  information.");
