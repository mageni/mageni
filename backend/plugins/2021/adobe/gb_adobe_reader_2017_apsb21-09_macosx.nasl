...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817935");
  ...
  script_tag(name:"creation_date", value:"2021-02-11 18:09:59 +0530 (Thu, 11 Feb 2021)");
  script_name("Adobe Reader 2017 Security Update (APSB21-09) - Mac OS X");
  ...
  2017.011.30190on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Reader 2017 version
  2017.011.30190or later. Please see the references for more information.");
