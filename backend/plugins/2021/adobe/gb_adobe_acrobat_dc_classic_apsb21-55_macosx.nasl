...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818547");
  ...
  script_tag(name:"creation_date", value:"2021-09-17 08:31:49 +0530 (Fri, 17 Sep 2021)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB21-55) - Mac OS X");
