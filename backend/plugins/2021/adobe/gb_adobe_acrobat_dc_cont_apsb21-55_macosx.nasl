...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818548");
  ...
  script_tag(name:"creation_date", value:"2021-09-17 08:32:03 +0530 (Fri, 17 Sep 2021)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB21-55) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat DC (Continuous) version prior to 2021.007.20091on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Acrobat DC (Continuous)
  to version 2021.007.20091 or later. Please see the references for more information.");
...
if(version_is_less(version:vers, test_version:"21.007.20091"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2021.007.20091", install_path:path);
