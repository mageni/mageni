...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817925");
  ...
  script_name("Adobe Reader DC Continuous Security Update (APSB21-09) - Windows");
  ...
  2020.013.20074and earlierversions on Windows.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC (Continuous)
  to version 2021.001.20135or later. Please see the references for more information.");
