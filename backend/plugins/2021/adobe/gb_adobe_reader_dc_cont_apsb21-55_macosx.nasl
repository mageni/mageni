...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818550");
  ...
  script_tag(name:"creation_date", value:"2021-09-17 08:32:15 +0530 (Fri, 17 Sep 2021)");
  script_name("Adobe Reader DC Continuous Security Update (APSB21-55) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Reader DC (Continuous) version prior to
  2021.007.20091on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Reader DC (Continuous)
  to version 2021.007.20091or later. Please see the references for more information.");
