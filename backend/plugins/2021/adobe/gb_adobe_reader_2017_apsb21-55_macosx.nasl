...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818549");
  ...
  script_tag(name:"creation_date", value:"2021-09-17 08:30:49 +0530 (Fri, 17 Sep 2021)");
  script_name("Adobe Reader 2017 Security Update (APSB21-55) - Mac OS X");
