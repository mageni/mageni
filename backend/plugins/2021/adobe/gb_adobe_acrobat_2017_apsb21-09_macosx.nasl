...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817931");
  ...
  script_tag(name:"creation_date", value:"2021-02-11 18:08:48 +0530 (Thu, 11 Feb 2021)");
  script_name("Adobe Acrobat 2017 Security Update (APSB21-09) - Mac OS X");

  script_tag(name:"summary", value:"The host is installed with Adobe Acrobat 2017
  ...
  2017.011.30190 on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Acrobat 2017 version
  2017.011.30190 or later. Please see the references for more information.");
...
if(version_in_range(version:vers, test_version:"17.0", test_version2:"17.011.30188"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"17.011.30190(2017.011.30190)", install_path:path);
