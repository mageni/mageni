...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818154");
  ...
  script_tag(name:"creation_date", value:"2021-06-10 14:56:30 +0530 (Thu, 10 Jun 2021)");
  script_name("Adobe Reader Classic 2020 Security Update (APSB21-37) - Mac OS X");
  ...
  version 2020.004.30005 or later. Please see the references for more information.");
