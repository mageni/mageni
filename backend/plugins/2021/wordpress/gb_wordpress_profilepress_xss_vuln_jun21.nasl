...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146797");
  script_version("2021-09-28T15:12:33+0000");
  script_tag(name:"last_modification", value:"2021-09-29 10:16:16 +0000 (Wed, 29 Sep 2021)");
  script_tag(name:"creation_date", value:"2021-09-28 15:06:44 +0000 (Tue, 28 Sep 2021)");
  script_tag(name:"cvss_base", value:"3.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:N");

  script_cve_id("CVE-2021-24450");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress ProfilePress Plugin < 3.1.8 XSS Vulnerability");
  ...
  to an authenticated stored cross-site scripting (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"WordPress ProfilePress plugin prior to version 3.1.8.");

  script_tag(name:"solution", value:"Update to version 3.1.8 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/a8625579-fe8f-4bc1-a641-0e26ad141c92");
