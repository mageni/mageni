...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853924");
  ...
  script_tag(name:"creation_date", value:"2021-07-13 03:03:26 +0000 (Tue, 13 Jul 2021)");
  script_name("openSUSE: Security Advisory for ucode-intel (openSUSE-SU-2021:1933-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1933-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/JL4WBLDZZMRKCJPRBNYNFPGJBJE5OQZO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2021:1933-1 advisory.");
  ...
  script_tag(name:"affected", value:"'ucode-intel' package(s) on openSUSE Leap 15.3.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-20210525", rpm:"ucode-intel-20210525~7.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
