...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853923");
  ...
  script_tag(name:"creation_date", value:"2021-07-13 03:03:24 +0000 (Tue, 13 Jul 2021)");
  script_name("openSUSE: Security Advisory for python-urllib3 (openSUSE-SU-2021:2012-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:2012-1");
  ...
  package(s) announced via the openSUSE-SU-2021:2012-1 advisory.");
  ...
  script_tag(name:"affected", value:"'python-urllib3' package(s) on openSUSE Leap 15.3.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-urllib3", rpm:"python3-urllib3~1.25.10~4.3.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
