...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854274");
  ...
  script_tag(name:"creation_date", value:"2021-11-03 02:02:48 +0000 (Wed, 03 Nov 2021)");
  script_name("openSUSE: Security Advisory for transfig (openSUSE-SU-2021:1439-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1439-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/4JLSTM3B2XXVZAOO3A7DAIVZCM7BWWB5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'transfig'
  package(s) announced via the openSUSE-SU-2021:1439-1 advisory.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"transfig", rpm:"transfig~3.2.8b~lp152.6.9.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"transfig-debuginfo", rpm:"transfig-debuginfo~3.2.8b~lp152.6.9.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"transfig-debugsource", rpm:"transfig-debugsource~3.2.8b~lp152.6.9.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
