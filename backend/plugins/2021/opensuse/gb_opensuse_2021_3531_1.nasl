...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854252");
  ...
  script_tag(name:"creation_date", value:"2021-10-28 01:02:26 +0000 (Thu, 28 Oct 2021)");
  script_name("openSUSE: Security Advisory for busybox (openSUSE-SU-2021:3531-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:3531-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/EXGVAQ34C33F4R3O65TKB73FYUDCIM6B");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox'
  package(s) announced via the openSUSE-SU-2021:3531-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox", rpm:"busybox~1.26.2~4.5.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"busybox-static", rpm:"busybox-static~1.26.2~4.5.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
