...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854362");
  ...
  script_tag(name:"creation_date", value:"2021-12-08 02:02:16 +0000 (Wed, 08 Dec 2021)");
  script_name("openSUSE: Security Advisory for nodejs14 (openSUSE-SU-2021:3964-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:3964-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/EB6I33SJCMQ2K7LAKKPS54HRXSB7FQXG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs14'
  package(s) announced via the openSUSE-SU-2021:3964-1 advisory.");
  ...
  * child_process:
         ...
         + add &#x27 overlapped&#x27  stdio flag
  ...
  * process: add &#x27 worker&#x27  event
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs14", rpm:"nodejs14~14.18.1~15.21.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-debuginfo", rpm:"nodejs14-debuginfo~14.18.1~15.21.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-debugsource", rpm:"nodejs14-debugsource~14.18.1~15.21.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-devel", rpm:"nodejs14-devel~14.18.1~15.21.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm14", rpm:"npm14~14.18.1~15.21.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs14-docs", rpm:"nodejs14-docs~14.18.1~15.21.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }
