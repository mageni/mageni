...
if(description)
{
  ...
  script_version("2021-04-06T14:03:51+0000");
  ...
  script_name("Apache Struts Unspecified Vulnerability (S2-024)");
  ...
  # Only vuln if default settings are applied, mitigation also possible via a configuration change.
