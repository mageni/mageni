...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112896");
  ...
  script_cve_id("CVE-2020-13938", "CVE-2020-35452", "CVE-2021-26690", "CVE-2021-26691");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Apache HTTP Server 2.4.0 - 2.4.46 Multiple Vulnerabilities - Windows");
  ...
  script_tag(name:"impact", value:"- CVE-2020-13938: This flaw lets unprivileged local users
  ...
  script_tag(name:"affected", value:"Apache HTTP Server versions 2.4.0 to 2.4.46 on Windows.");
