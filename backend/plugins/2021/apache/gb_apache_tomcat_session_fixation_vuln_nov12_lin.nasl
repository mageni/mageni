...
if (description)
{
  ...
  script_name("Apache Tomcat Session Fixation Vulnerability (Nov 2012) - Linux");
  ...
  script_tag(name:"affected", value:"Apache Tomcat 6.0.21 through 6.0.36 and 7.x before 7.0.33.");
...
if (version_in_range(version: version, test_version: "6.0.21", test_version2: "6.0.36")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "6.0.37", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "7.0.0", test_version2: "7.0.32")) {
