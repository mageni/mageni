...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118268");
  ...
  script_name("Python < 2.6.8, 2.7.x < 2.7.3, 3.1.x < 3.1.5, 3.2.x < 3.2.3 Hash DoS (bpo-13703) - Linux");
  ...
  script_tag(name:"insight", value:"Python computes hash values without restricting the ability to
  trigger hash collisions predictably, which allows context-dependent attackers to cause a DoS
  ...
  script_xref(name:"URL", value:"https://python-security.readthedocs.io/vuln/hash-dos.html");
  script_xref(name:"Advisory-ID", value:"bpo-13703");
