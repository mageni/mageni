...
if(description)
{
  ...
  script_cve_id("CVE-2021-41073", "CVE-2020-26541", "CVE-2021-22543", "CVE-2021-3612", "CVE-2021-38160", "CVE-2021-38199");
  ...
  script_name("Ubuntu: Security Advisory for linux-oem-5.10 (USN-5106-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006230.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.10'
  package(s) announced via the USN-5106-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.10.0-1049-oem", ver:"5.10.0-1049.51", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04", ver:"5.10.0.1049.51", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04b", ver:"5.10.0.1049.51", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
