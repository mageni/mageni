...
if(description)
{
  ...
  script_cve_id("CVE-2021-3655", "CVE-2021-3744", "CVE-2021-3764", "CVE-2021-3760", "CVE-2021-41864", "CVE-2021-43056", "CVE-2021-43389");
  ...
  script_name("Ubuntu: Security Advisory for linux-oem-5.10 (USN-5139-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-November/006272.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.10'
  package(s) announced via the USN-5139-1 advisory.");
