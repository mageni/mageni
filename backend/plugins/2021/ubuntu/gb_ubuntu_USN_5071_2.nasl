...
if(description)
{
  ...
  script_cve_id("CVE-2021-3656", "CVE-2021-3653", "CVE-2020-36311", "CVE-2021-22543", "CVE-2021-3612");
  ...
  script_name("Ubuntu: Security Advisory for linux-hwe-5.4 (USN-5071-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006194.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe-5.4'
  package(s) announced via the USN-5071-2 advisory.");
...
registered. (CVE-2021-3612)");
  ...
  script_tag(name:"affected", value:"'linux-hwe-5.4' package(s) on Ubuntu 18.04 LTS.");
