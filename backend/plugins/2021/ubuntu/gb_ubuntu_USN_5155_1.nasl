...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for bluez (USN-5155-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-November/006288.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bluez'
  package(s) announced via the USN-5155-1 advisory.");
...
BlueZ to crash, leading to a denial of service. (CVE-2021-43400)");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bluez", ver:"5.48-0ubuntu3.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libbluetooth3", ver:"5.48-0ubuntu3.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bluez", ver:"5.53-0ubuntu3.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libbluetooth3", ver:"5.53-0ubuntu3.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
