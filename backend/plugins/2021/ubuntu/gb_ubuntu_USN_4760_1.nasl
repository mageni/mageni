...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libzstd (USN-4760-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-March/005923.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libzstd'
  package(s) announced via the USN-4760-1 advisory.");
...
contrary to expectations.");
  ...
  script_tag(name:"affected", value:"'libzstd' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
