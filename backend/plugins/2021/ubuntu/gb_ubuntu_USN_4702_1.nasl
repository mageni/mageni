...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for pound (USN-4702-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-January/005852.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pound'
  package(s) announced via the USN-4702-1 advisory.");
...
information. (CVE-2016-10711, CVE-2018-21245)");
  ...
  script_tag(name:"affected", value:"'pound' package(s) on Ubuntu 16.04 LTS.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pound", ver:"2.6-6.1ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
