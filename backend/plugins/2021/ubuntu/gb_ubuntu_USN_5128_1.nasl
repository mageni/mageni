...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for ceph (USN-5128-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-November/006262.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ceph'
  package(s) announced via the USN-5128-1 advisory.");
...
service. (CVE-2021-3531)");
  ...
  script_tag(name:"affected", value:"'ceph' package(s) on Ubuntu 18.04 LTS.");
