...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux (USN-5000-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006086.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux'
  package(s) announced via the USN-5000-1 advisory.");
...
Piotr Krysiuk discovered eBPF implementation in the Linux kernel
...
nfc implementation in the Linux  ...
