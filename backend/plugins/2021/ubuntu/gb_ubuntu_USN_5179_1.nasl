...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for busybox (USN-5179-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-December/006307.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox'
  package(s) announced via the USN-5179-1 advisory.");
