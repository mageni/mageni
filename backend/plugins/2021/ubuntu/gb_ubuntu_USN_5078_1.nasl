...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for squashfs-tools (USN-5078-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006186.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools'
  package(s) announced via the USN-5078-1 advisory.");
...
write arbitrary files to the filesystem.");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squashfs-tools", ver:"1:4.3-6ubuntu0.18.04.4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squashfs-tools", ver:"1:4.4-1ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
