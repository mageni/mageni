...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for qtbase-opensource-src (USN-5081-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006192.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qtbase-opensource-src'
  package(s) announced via the USN-5081-1 advisory.");
...
denial of service. (CVE-2021-38593)");
  ...
  script_tag(name:"affected", value:"'qtbase-opensource-src' package(s) on Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libqt5core5a", ver:"5.9.5+dfsg-0ubuntu2.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libqt5gui5", ver:"5.9.5+dfsg-0ubuntu2.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
