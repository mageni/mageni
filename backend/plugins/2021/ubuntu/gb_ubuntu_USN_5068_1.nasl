...
if(description)
{
  ...
  script_cve_id("CVE-2017-6363", "CVE-2021-40145", "CVE-2021-38115");
  ...
  script_name("Ubuntu: Security Advisory for libgd2 (USN-5068-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006173.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgd2'
  package(s) announced via the USN-5068-1 advisory.");
...
(CVE-2021-40145)");
  ...
  script_tag(name:"affected", value:"'libgd2' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgd3", ver:"2.2.5-4ubuntu0.5", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgd3", ver:"2.2.5-5.2ubuntu2.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
