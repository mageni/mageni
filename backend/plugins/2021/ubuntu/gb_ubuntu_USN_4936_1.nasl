...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for thunderbird (USN-4936-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006005.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the USN-4936-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:78.8.1+build1-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:78.8.1+build1-0ubuntu0.20.10.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
