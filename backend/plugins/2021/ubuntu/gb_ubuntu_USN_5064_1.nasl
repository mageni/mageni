...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for cpio (USN-5064-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-September/006168.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cpio'
  package(s) announced via the USN-5064-1 advisory.");
...
code.");
  ...
  script_tag(name:"affected", value:"'cpio' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
