...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for python3.7 (USN-5200-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-December/006322.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.7'
  package(s) announced via the USN-5200-1 advisory.");
...
(CVE-2021-3737)");
  ...
  script_tag(name:"affected", value:"'python3.7' package(s) on Ubuntu 18.04 LTS.");
