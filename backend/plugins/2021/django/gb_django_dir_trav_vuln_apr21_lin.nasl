...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112877");
  script_version("2021-04-07T09:34:25+0000");
  script_tag(name:"last_modification", value:"2021-04-07 09:34:25 +0000 (Wed, 07 Apr 2021)");
  ...
  script_name("Django 2.2 < 2.2.20, 3.0 < 3.0.14, 3.1 < 3.1.8 Directory Traversal Vulnerability (Linux)");
