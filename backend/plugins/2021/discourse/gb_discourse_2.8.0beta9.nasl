...
if(description)
{
  ...
  script_name("Discourse 2.8.x < 2.8.0.beta9 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse version 2.8.0.beta1 through 2.8.0.beta8.");

  script_tag(name:"solution", value:"Update to version 2.8.0.beta9 or later.");
...
if (version_in_range(version: version, test_version: "2.8.0.beta1", test_version2: "2.8.0.beta8")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.8.0.beta9", install_path: location);
