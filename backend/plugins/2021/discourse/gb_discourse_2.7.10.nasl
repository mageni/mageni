...
if(description)
{
  ...
  script_name("Discourse < 2.7.10 Cache Poisoning Vulnerability");
  ...
  script_tag(name:"affected", value:"Discourse prior to version 2.7.10.");
