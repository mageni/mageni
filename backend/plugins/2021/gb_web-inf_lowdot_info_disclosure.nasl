...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117225");
  script_version("2021-02-15T08:06:58+0000");
  script_tag(name:"last_modification", value:"2021-02-15 11:14:46 +0000 (Mon, 15 Feb 2021)");
  script_tag(name:"creation_date", value:"2021-02-15 08:05:28 +0000 (Mon, 15 Feb 2021)");
  ...
  script_xref(name:"URL", value:"https://bz.apache.org/bugzilla/show_bug.cgi?id=60667");
  ...
  http://example.com/META-INf./web.xml
