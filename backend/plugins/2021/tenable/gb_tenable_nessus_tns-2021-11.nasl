...
if(description)
{
  ...
  script_version("2021-06-16T15:26:26+0000");
  ...
  script_name("Tenable Nessus < 8.15.0 on Windows: Multiple Vulnerabilities (TNS-2021-11)");
  ...
  script_tag(name:"affected", value:"Tenable Nessus on Windows prior to version 8.15.0.");
