...
if(description)
{
  ...
  script_version("2021-11-04T07:48:07+0000");
  script_tag(name:"last_modification", value:"2021-11-04 07:48:07 +0000 (Thu, 04 Nov 2021)");
  ...
  script_tag(name:"insight", value:"Nessus contains a local privilege escalation vulnerability
  which could allow an authenticated, local administrator to run specific executables on the
  Nessus Agent host.");
