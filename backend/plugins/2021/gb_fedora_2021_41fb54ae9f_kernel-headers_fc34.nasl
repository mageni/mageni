...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879323");
  ...
  script_tag(name:"creation_date", value:"2021-04-02 03:06:04 +0000 (Fri, 02 Apr 2021)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-41fb54ae9f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WKRNELXLVFDY6Y5XDMWLIH3VKIMQXLLR");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.11.11~300.fc34", rls:"FC34"))) {
    report += res;
  }
