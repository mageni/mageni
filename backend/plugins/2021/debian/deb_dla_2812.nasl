...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for botan1.10 (DLA-2812-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/11/msg00006.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2812-1");
  script_xref(name:"Advisory-ID", value:"DLA-2812-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'botan1.10'
  package(s) announced via the DLA-2812-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"One security issue has been discovered in botan1.10: a C++ cryptography
library.
...
secret exponents as used in RSA, DH, etc. with help of cache analysis.");
  ...
  script_tag(name:"affected", value:"'botan1.10' package(s) on Debian Linux.");
