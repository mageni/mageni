...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libzip (DLA-2858-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/12/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2858-1");
  script_xref(name:"Advisory-ID", value:"DLA-2858-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libzip'
  package(s) announced via the DLA-2858-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue has been found in libzip, a library for reading, creating, and
...
service due to memorey allocation failure by mishandling EOCD records.");
  ...
  script_tag(name:"affected", value:"'libzip' package(s) on Debian Linux.");
