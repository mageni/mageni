...
if(description)
{
  ...
  script_version("2021-12-14T02:00:12+0000");
  script_cve_id("CVE-2017-7697");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2021-12-14 02:00:12 +0000 (Tue, 14 Dec 2021)");
  script_tag(name:"creation_date", value:"2021-12-14 02:00:12 +0000 (Tue, 14 Dec 2021)");
  script_name("Debian LTS: Security Advisory for libsamplerate (DLA-2845-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/12/msg00010.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2845-1");
  ...
  package(s) announced via the DLA-2845-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue has been found in libsamplerate, an audio sample rate conversion
library. Using a crafted audio file a buffer over-read might happen in
calc_output_single() in src_sinc.c.");

  script_tag(name:"affected", value:"'libsamplerate' package(s) on Debian Linux.");
