...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for cron (DLA-2801-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/10/msg00029.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2801-1");
  script_xref(name:"Advisory-ID", value:"DLA-2801-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/809167");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cron'
  package(s) announced via the DLA-2801-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2017-9525
...
executing crontab(1). Users will now be denied by default if they aren't.");
  ...
  script_tag(name:"affected", value:"'cron' package(s) on Debian Linux.");
