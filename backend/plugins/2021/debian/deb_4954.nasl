...
if(description)
{
  ...
  script_version("2021-08-12T03:00:06+0000");
  ...
  script_name("Debian: Security Advisory for c-ares (DSA-4954-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4954.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4954-1");
  script_xref(name:"Advisory-ID", value:"DSA-4954-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'c-ares'
  package(s) announced via the DSA-4954-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Philipp Jeitner and Haya Shulman discovered a flaw in c-ares, a library
