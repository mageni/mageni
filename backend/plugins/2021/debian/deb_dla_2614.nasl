...
if(description)
{
  ...
  script_version("2021-04-21T12:19:57+0000");
  ...
  script_name("Debian LTS: Security Advisory for busybox (DLA-2614-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00001.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2614-1");
  script_xref(name:"Advisory-ID", value:"DLA-2614-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/986217");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox'
  package(s) announced via the DLA-2614-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The gunzip decompressor of Busybox, tiny utilities for small and embedded
