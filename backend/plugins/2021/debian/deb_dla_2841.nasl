...
if(description)
{
  ...
  script_version("2021-12-07T02:00:21+0000");
  ...
  script_name("Debian LTS: Security Advisory for runc (DLA-2841-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/12/msg00005.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2841-1");
  ...
  package(s) announced via the DLA-2841-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an overflow issue in runc, the
...
Netlink payload which disables all namespaces.");
  ...
  script_tag(name:"affected", value:"'runc' package(s) on Debian Linux.");
