...
if(description)
{
  ...
  script_version("2021-04-26T03:00:07+0000");
  ...
  script_name("Debian: Security Advisory for gst-libav1.0 (DSA-4901-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4901.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4901-1");
  script_xref(name:"Advisory-ID", value:"DSA-4901-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gst-libav1.0'
  package(s) announced via the DSA-4901-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-libav", ver:"1.15.0.1+git20180723+db823502-2+deb10u1", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-libav-dbg", ver:"1.15.0.1+git20180723+db823502-2+deb10u1", rls:"DEB10"))) {
  report += res;
}
