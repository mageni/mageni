...
if(description)
{
  ...
  script_version("2021-10-18T01:00:06+0000");
  ...
  script_name("Debian: Security Advisory for libreoffice (DSA-4988-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4988.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4988-1");
  ...
  package(s) announced via the DSA-4988-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two security issues have been discovered in LibreOffice's support for
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"fonts-opensymbol", ver:"1:7.0.4-4+deb11u1", rls:"DEB11"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"libreoffice-nlpsolver", ver:"1:7.0.4-4+deb11u1", rls:"DEB11"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"libreoffice-wiki-publisher", ver:"1:7.0.4-4+deb11u1", rls:"DEB11"))) {
  report += res;
}
