...
if(description)
{
  ...
  script_name("Debian: Security Advisory for webkit2gtk (DSA-4995-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4995.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4995-1");
  script_xref(name:"Advisory-ID", value:"DSA-4995-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk'
  package(s) announced via the DSA-4995-1 advisory.");
...
if(!isnull(res = isdpkgvuln(pkg:"libwebkit2gtk-4.0-37-gtk2", ver:"2.34.1-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
