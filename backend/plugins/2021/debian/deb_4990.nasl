...
if(description)
{
  ...
  script_name("Debian: Security Advisory for ffmpeg (DSA-4990-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4990.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4990-1");
  script_xref(name:"Advisory-ID", value:"DSA-4990-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ffmpeg'
  package(s) announced via the DSA-4990-1 advisory.");
