...
if(description)
{
  ...
  script_version("2021-12-23T10:04:56+0000");
  # TODO: No CVE assigned yet. Check https://security-tracker.debian.org/tracker/TEMP-0000000-1B6797 later.
  ...
  script_name("Debian: Security Advisory for spip (DSA-5028-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5028.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5028-1");
  ...
  package(s) announced via the DSA-5028-1 advisory.");
