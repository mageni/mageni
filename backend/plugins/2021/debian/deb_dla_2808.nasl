...
if(description)
{
  ...
  script_version("2021-11-06T02:00:15+0000");
  ...
  script_name("Debian LTS: Security Advisory for python3.5 (DLA-2808-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/11/msg00003.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2808-1");
  ...
  package(s) announced via the DLA-2808-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"There were a couple of vulnerabilities found in src:python3.5, the
