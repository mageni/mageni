...
if(description)
{
  ...
  script_version("2021-05-27T03:00:19+0000");
  ...
  script_name("Debian LTS: Security Advisory for djvulibre (DLA-2667-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/05/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2667-1");
  script_xref(name:"Advisory-ID", value:"DLA-2667-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/945114");
  script_xref(name:"URL", value:"https://bugs.debian.org/988215");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the DLA-2667-1 advisory.");
