...
if(description)
{
  ...
  script_version("2021-04-26T03:00:05+0000");
  ...
  script_name("Debian: Security Advisory for gst-plugins-base1.0 (DSA-4903-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4903.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4903-1");
  ...
  package(s) announced via the DSA-4903-1 advisory.");
