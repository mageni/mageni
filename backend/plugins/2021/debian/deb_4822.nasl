...
if(description)
{
  ...
  script_name("Debian: Security Advisory for p11-kit (DSA-4822-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4822.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4822-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'p11-kit'
  package(s) announced via the DSA-4822-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"David Cook reported several memory safety issues affecting the RPC
