...
if(description)
{
  ...
  script_version("2021-08-05T03:00:14+0000");
  ...
  script_name("Debian LTS: Security Advisory for wordpress (DLA-2731-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/08/msg00007.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2731-1");
  script_xref(name:"Advisory-ID", value:"DLA-2731-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the DLA-2731-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"One security issue affects WordPress, a weblog manager, versions
