...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883395");
  ...
  script_tag(name:"creation_date", value:"2021-11-18 02:02:27 +0000 (Thu, 18 Nov 2021)");
  script_name("CentOS: Security Advisory for firefox (CESA-2021:3791)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2021:3791");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2021-November/048399.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2021:3791 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~91.2.0~4.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
