...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879868");
  ...
  script_name("Fedora: Security Advisory for varnish-modules (FEDORA-2021-cf7585f0ca)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2G7254YH6B7LHH7GOAZZJPQ6VRIAD3K3");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"varnish-modules", rpm:"varnish-modules~0.17.1~2.fc34", rls:"FC34"))) {
    report += res;
  }
