...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879017");
  ...
  script_tag(name:"creation_date", value:"2021-03-04 04:02:58 +0000 (Thu, 04 Mar 2021)");
  script_name("Fedora: Security Advisory for dogtag-pki (FEDORA-2021-7458e2d835)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3QU2M5777TJGW2WRWVKR4JBUAYS6INGE");
...
PKI consists of the following components:
  ...
  * Token Processing Service (TPS)");
  ...
  script_tag(name:"affected", value:"'dogtag-pki' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dogtag-pki", rpm:"dogtag-pki~10.10.5~1.fc33", rls:"FC33"))) {
    report += res;
  }
