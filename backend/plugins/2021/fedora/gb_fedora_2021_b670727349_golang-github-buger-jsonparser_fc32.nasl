...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878826");
  ...
  script_tag(name:"creation_date", value:"2021-01-17 04:13:48 +0000 (Sun, 17 Jan 2021)");
  script_name("Fedora: Security Advisory for golang-github-buger-jsonparser (FEDORA-2021-b670727349)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/27EA7OGCELV7QFAGVIHODHWKMKGFVIUZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-buger-jsonparser'
  package(s) announced via the FEDORA-2021-b670727349 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-buger-jsonparser", rpm:"golang-github-buger-jsonparser~1.1.1~1.fc32", rls:"FC32"))) {
    report += res;
  }
