...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818745");
  ...
  script_tag(name:"creation_date", value:"2021-10-02 01:21:40 +0000 (Sat, 02 Oct 2021)");
  script_name("Fedora: Security Advisory for mosquitto (FEDORA-2021-dc6df3744a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-dc6df3744a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RLUUM52Y6AEICPXPSRRXC6OBY4H5XKW7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mosquitto'
  package(s) announced via the FEDORA-2021-dc6df3744a advisory.");
...
like the Arduino.");
  ...
  script_tag(name:"affected", value:"'mosquitto' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mosquitto", rpm:"mosquitto~2.0.12~1.fc35", rls:"FC35"))) {
    report += res;
  }
