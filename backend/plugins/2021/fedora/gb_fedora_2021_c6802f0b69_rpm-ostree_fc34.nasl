...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879458");
  ...
  script_name("Fedora: Security Advisory for rpm-ostree (FEDORA-2021-c6802f0b69)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-c6802f0b69");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DPMFGGQ5T6WVFTFX3OKMVTTM5O4EXWZR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpm-ostree'
  package(s) announced via the FEDORA-2021-c6802f0b69 advisory.");
...
a 'best of both worlds' approach.");
  ...
  script_tag(name:"affected", value:"'rpm-ostree' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpm-ostree", rpm:"rpm-ostree~2021.4~1.fc34", rls:"FC34"))) {
    report += res;
  }
