...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879928");
  ...
  script_name("Fedora: Security Advisory for sylpheed (FEDORA-2021-3823463b9a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-3823463b9a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RCJXHUSYHGVBSH2ULD7HNXLM7QNRECZ6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sylpheed'
  package(s) announced via the FEDORA-2021-3823463b9a advisory.");
...
See /usr/share/doc/sylpheed*/README for more information.");
  ...
  script_tag(name:"affected", value:"'sylpheed' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sylpheed", rpm:"sylpheed~3.7.0~10.fc34", rls:"FC34"))) {
    report += res;
  }
