...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819424");
  ...
  script_name("Fedora: Security Advisory for php-pecl-imagick (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M7L6C5QVYSC4OEECQJA7CEIQWYQET4JY");
...
ImageMagick API.");
  ...
  script_tag(name:"affected", value:"'php-pecl-imagick' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-pecl-imagick", rpm:"php-pecl-imagick~3.5.0~1.fc34.1", rls:"FC34"))) {
    report += res;
  }
