...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819059");
  ...
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2021-d1aef08c6e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d1aef08c6e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/V7IBZWA5NUBCT4AXDHR7KBSFHGT4S3OG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2021-d1aef08c6e advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenmpt", rpm:"libopenmpt~0.5.12~1.fc35", rls:"FC35"))) {
    report += res;
  }
