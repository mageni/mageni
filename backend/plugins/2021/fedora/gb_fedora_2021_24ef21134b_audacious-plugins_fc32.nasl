...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878805");
  ...
  script_tag(name:"creation_date", value:"2021-01-14 09:51:15 +0000 (Thu, 14 Jan 2021)");
  script_name("Fedora: Security Advisory for audacious-plugins (FEDORA-2021-24ef21134b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2JBNGPZX4NL3EIMBOHSOXCEXRE4EY5OS");
  ...
  script_tag(name:"affected", value:"'audacious-plugins' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"audacious-plugins", rpm:"audacious-plugins~3.10.1~7.fc32", rls:"FC32"))) {
    report += res;
  }
