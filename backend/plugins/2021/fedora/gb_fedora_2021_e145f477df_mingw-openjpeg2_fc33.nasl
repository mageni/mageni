...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879720");
  ...
  script_name("Fedora: Security Advisory for mingw-openjpeg2 (FEDORA-2021-e145f477df)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/C5XGPQ7LFDYR22V6WATFLOYFWGMJHU62");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-openjpeg2", rpm:"mingw-openjpeg2~2.3.1~12.fc33", rls:"FC33"))) {
    report += res;
  }
