...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819344");
  ...
  script_name("Fedora: Security Advisory for busybox (FEDORA-2021-c52c0fe490)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-c52c0fe490");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6T2TURBYYJGBMQTTN2DSOAIQGP7WCPGV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox'
  package(s) announced via the FEDORA-2021-c52c0fe490 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox", rpm:"busybox~1.34.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
