...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879865");
  ...
  script_name("Fedora: Security Advisory for opendmarc (FEDORA-2021-889af802f2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-889af802f2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VZHZD4WZDYRBB2XVW2EQ4DQ2KYMAGPUO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opendmarc'
  package(s) announced via the FEDORA-2021-889af802f2 advisory.");
...
/usr/share/opendmarc/contrib/rddmarc.");
  ...
  script_tag(name:"affected", value:"'opendmarc' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opendmarc", rpm:"opendmarc~1.4.1.1~3.fc34", rls:"FC34"))) {
    report += res;
  }
