...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879454");
  ...
  script_name("Fedora: Security Advisory for runc (FEDORA-2021-83b3740389)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZNMB7O2UIXE34PGSCSOULGHPX5LIJBMM");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.0.0~377.rc93.fc34", rls:"FC34"))) {
    report += res;
  }
