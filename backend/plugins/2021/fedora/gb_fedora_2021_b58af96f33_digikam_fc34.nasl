...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819321");
  ...
  script_name("Fedora: Security Advisory for digikam (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KOIS6CRZRE6XOQCNYJGHNQOVFSZ7PC4Q");
...
digiKam built-in image editor makes the common photo correction a simple task.");
  ...
  script_tag(name:"affected", value:"'digikam' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"digikam", rpm:"digikam~7.3.0~4.fc34", rls:"FC34"))) {
    report += res;
  }
