...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818720");
  ...
  script_tag(name:"creation_date", value:"2021-10-03 01:22:58 +0000 (Sun, 03 Oct 2021)");
  script_name("Fedora: Security Advisory for cobbler (FEDORA-2021-5f1e30aa56)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-5f1e30aa56");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/23TXEZAUSZPDJ7SGUR7IGSBJU2FOQUDF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2021-5f1e30aa56 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~3.2.2~2.fc34", rls:"FC34"))) {
    report += res;
  }
