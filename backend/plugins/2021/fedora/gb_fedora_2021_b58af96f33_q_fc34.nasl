...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819352");
  ...
  script_name("Fedora: Security Advisory for q (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JBFMVTWH4RYUUXL5IV6UUJ4EEPOJJF2B");
...
ODBC, GNU Octave, ImageMagick, Tcl/Tk, XML/XSLT and an Emacs mode.");
  ...
  script_tag(name:"affected", value:"'q' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"q", rpm:"q~7.11~44.fc34", rls:"FC34"))) {
    report += res;
  }
