...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818464");
  ...
  script_name("Fedora: Security Advisory for wimlib (FEDORA-2021-38d1b07839)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HTCBVA5IWHNX2MMWCCQRW6J3XEVQWXAS");
...
WIMGAPI, ImageX, and DISM.");
  ...
  script_tag(name:"affected", value:"'wimlib' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wimlib", rpm:"wimlib~1.13.4~2.fc33", rls:"FC33"))) {
    report += res;
  }
