...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819159");
  ...
  script_name("Fedora: Security Advisory for rpki-client (FEDORA-2021-2f9642ec0c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-2f9642ec0c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ILQ3IA2SR6VE6LVI2HOAU24HGG3X6TP6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client'
  package(s) announced via the FEDORA-2021-2f9642ec0c advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~7.5~1.fc34", rls:"FC34"))) {
    report += res;
  }
