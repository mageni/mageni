...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878984");
  ...
  script_name("Fedora: Security Advisory for containers-common (FEDORA-2021-fb466fb623)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DJKISXPHWVVWEZKL4ZYF465YTGC45B4Q");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containers-common", rpm:"containers-common~1~4.fc33", rls:"FC33"))) {
    report += res;
  }
