...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879851");
  ...
  script_name("Fedora: Security Advisory for crun (FEDORA-2021-0c53d8738d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WYEKQOCOMRYA54WFUPJNNBZD5CPNRGHX");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"crun", rpm:"crun~0.20.1~1.fc33", rls:"FC33"))) {
    report += res;
  }
