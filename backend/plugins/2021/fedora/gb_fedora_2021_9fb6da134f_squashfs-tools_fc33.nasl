...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818730");
  ...
  script_name("Fedora: Security Advisory for squashfs-tools (FEDORA-2021-9fb6da134f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-9fb6da134f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GSMRKVJMJFX3MB7D3PXJSYY3TLZROE5S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools'
  package(s) announced via the FEDORA-2021-9fb6da134f advisory.");
...
contains the utilities for manipulating squashfs filesystems.");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squashfs-tools", rpm:"squashfs-tools~4.5~3.20210913gite048580.fc33", rls:"FC33"))) {
    report += res;
  }
