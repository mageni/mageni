...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819415");
  ...
  script_name("Fedora: Security Advisory for WindowMaker (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KQPC7MLUSUUDPJAF375YI36JTK255SOA");
...
most useful and universal window managers available.");
  ...
  script_tag(name:"affected", value:"'WindowMaker' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"WindowMaker", rpm:"WindowMaker~0.95.9~7.fc34", rls:"FC34"))) {
    report += res;
  }
