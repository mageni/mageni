...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818717");
  ...
  script_name("Fedora: Security Advisory for libspf2 (FEDORA-2021-994751581f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-994751581f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GFXJRHPE5OSCPTNA3ZZ4ORDHT4JQH3Y4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libspf2'
  package(s) announced via the FEDORA-2021-994751581f advisory.");
...
great deal of effort has been put into the regression tests.");
  ...
  script_tag(name:"affected", value:"'libspf2' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libspf2", rpm:"libspf2~1.2.11~1.20210922git4915c308.fc34", rls:"FC34"))) {
    report += res;
  }
