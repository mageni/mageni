...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879676");
  ...
  script_tag(name:"creation_date", value:"2021-06-03 06:24:12 +0000 (Thu, 03 Jun 2021)");
  script_name("Fedora: Security Advisory for mingw-python-pillow (FEDORA-2021-77756994ba)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MQHA5HAIBOYI3R6HDWCLAGFTIQP767FL");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-python-pillow", rpm:"mingw-python-pillow~7.2.0~6.fc33", rls:"FC33"))) {
    report += res;
  }
