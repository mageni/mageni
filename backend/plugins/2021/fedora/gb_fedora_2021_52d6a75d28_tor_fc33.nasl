...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817774");
  ...
  script_name("Fedora: Security Advisory for tor (FEDORA-2021-52d6a75d28)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-52d6a75d28");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EXVMIDCL5HMBLBOYRB4LKR6JUN2GUF2C");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2021-52d6a75d28 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.5.10~1.fc33", rls:"FC33"))) {
    report += res;
  }
