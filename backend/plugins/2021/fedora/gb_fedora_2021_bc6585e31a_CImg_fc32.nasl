...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2021-04-23 03:16:16 +0000 (Fri, 23 Apr 2021)");
  script_name("Fedora: Security Advisory for CImg (FEDORA-2021-bc6585e31a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KKOQLY3N723PR3GC6E5RPTDOUCGCEX4B");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"CImg", rpm:"CImg~2.9.7~1.fc32", rls:"FC32"))) {
    report += res;
  }
