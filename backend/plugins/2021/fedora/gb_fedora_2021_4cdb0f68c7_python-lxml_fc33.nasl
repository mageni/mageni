...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879708");
  ...
  script_tag(name:"creation_date", value:"2021-06-04 06:29:05 +0000 (Fri, 04 Jun 2021)");
  script_name("Fedora: Security Advisory for python-lxml (FEDORA-2021-4cdb0f68c7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-4cdb0f68c7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XXN3QPWCTQVOGW4BMWV3AUUZZ4NRZNSQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-lxml'
  package(s) announced via the FEDORA-2021-4cdb0f68c7 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-lxml", rpm:"python-lxml~4.5.1~4.fc33", rls:"FC33"))) {
    report += res;
  }
