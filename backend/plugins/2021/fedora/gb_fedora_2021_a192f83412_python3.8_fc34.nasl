...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818433");
  ...
  script_name("Fedora: Security Advisory for python3.8 (FEDORA-2021-a192f83412)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-a192f83412");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/K7QDAEX4PWRYYEIXRF5QDGKJULJO6HKD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.8'
  package(s) announced via the FEDORA-2021-a192f83412 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.8", rpm:"python3.8~3.8.12~1.fc34", rls:"FC34"))) {
    report += res;
  }
