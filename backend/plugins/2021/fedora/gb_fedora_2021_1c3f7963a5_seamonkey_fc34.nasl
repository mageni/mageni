...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879722");
  ...
  script_tag(name:"creation_date", value:"2021-06-17 03:24:03 +0000 (Thu, 17 Jun 2021)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2021-1c3f7963a5)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KXUXOSGXW3LXFOT7VUQJDRZ4HHVP537W");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.7~5.fc34", rls:"FC34"))) {
    report += res;
  }
