...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818455");
  ...
  script_name("Fedora: Security Advisory for partclone (FEDORA-2021-38d1b07839)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XFS2N6CIGTYNX2ZUJKUDO4JM5YHFP7AV");
...
libraries, e.g. e2fslibs is used to read and write the ext2 partition.");
  ...
  script_tag(name:"affected", value:"'partclone' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"partclone", rpm:"partclone~0.3.17~4.fc33", rls:"FC33"))) {
    report += res;
  }
