...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819303");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:24:49 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-c09b851eb0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YODMYMGZYDXQKGJGX7TJG4XV4L5YLLBD");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.15.4~200.fc35", rls:"FC35"))) {
    report += res;
  }
