...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879848");
  ...
  script_tag(name:"creation_date", value:"2021-07-27 03:23:09 +0000 (Tue, 27 Jul 2021)");
  script_name("Fedora: Security Advisory for podman (FEDORA-2021-0c53d8738d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/75MV35CPCW3Q5MAQR6OGEJEYVVEZ2MXI");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~3.2.3~1.fc33", rls:"FC33"))) {
    report += res;
  }
