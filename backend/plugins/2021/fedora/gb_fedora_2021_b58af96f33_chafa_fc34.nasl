...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819379");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:05 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for chafa (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IBAINRRCV4JPQM6GQXD6TQWZY6KZTIAZ");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chafa", rpm:"chafa~1.2.1~6.fc34", rls:"FC34"))) {
    report += res;
  }
