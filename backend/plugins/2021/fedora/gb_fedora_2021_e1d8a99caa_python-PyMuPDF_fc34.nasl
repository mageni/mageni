...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819052");
  ...
  script_tag(name:"creation_date", value:"2021-11-06 02:24:51 +0000 (Sat, 06 Nov 2021)");
  script_name("Fedora: Security Advisory for python-PyMuPDF (FEDORA-2021-e1d8a99caa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TKRMREIYUBGG2GV73CU7BJNW2Q34IP23");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-PyMuPDF", rpm:"python-PyMuPDF~1.19.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
