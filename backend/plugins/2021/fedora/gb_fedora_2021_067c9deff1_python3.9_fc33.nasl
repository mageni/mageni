...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879421");
  ...
  script_tag(name:"creation_date", value:"2021-04-24 03:08:29 +0000 (Sat, 24 Apr 2021)");
  script_name("Fedora: Security Advisory for python3.9 (FEDORA-2021-067c9deff1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KZQ4MC5O36W7DYOPV5KDU6TKPH5AK5TX");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.9", rpm:"python3.9~3.9.4~1.fc33", rls:"FC33"))) {
    report += res;
  }
