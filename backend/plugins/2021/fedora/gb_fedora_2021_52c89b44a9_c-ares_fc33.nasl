...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818401");
  ...
  script_name("Fedora: Security Advisory for c-ares (FEDORA-2021-52c89b44a9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-52c89b44a9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GUQDIJWPKFYJPT2T5DYI6E2ROYH7UVZH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'c-ares'
  package(s) announced via the FEDORA-2021-52c89b44a9 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"c-ares", rpm:"c-ares~1.17.2~1.fc33", rls:"FC33"))) {
    report += res;
  }
