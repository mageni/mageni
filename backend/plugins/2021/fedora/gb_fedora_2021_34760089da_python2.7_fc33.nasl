...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818708");
  ...
  script_name("Fedora: Security Advisory for python2.7 (FEDORA-2021-34760089da)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-34760089da");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6BOXKUYVDVTJOPHD2BKK5LLZKWW4YV6O");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7'
  package(s) announced via the FEDORA-2021-34760089da advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2.7", rpm:"python2.7~2.7.18~15.fc33", rls:"FC33"))) {
    report += res;
  }
