...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819332");
  ...
  script_name("Fedora: Security Advisory for R-magick (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/S7OLHGTDDHOTX534EALNWYA5BNFLJESR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'R-magick'
  package(s) announced via the FEDORA-2021-b58af96f33 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Bindings to &#39, ImageMagick&#39, : the most comprehensive open-source image
...
coordinates.");
  ...
  script_tag(name:"affected", value:"'R-magick' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"R-magick", rpm:"R-magick~2.7.3~2.fc34", rls:"FC34"))) {
    report += res;
  }
