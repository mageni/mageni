...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819315");
  ...
  script_name("Fedora: Security Advisory for gnome-remote-desktop (FEDORA-2021-ac23d9e47f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M3CIZYSXXPQVYRJTJPQX7UOEWFBGVHZL");
...
GNOME desktop environment.");
  ...
  script_tag(name:"affected", value:"'gnome-remote-desktop' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-remote-desktop", rpm:"gnome-remote-desktop~0.1.9~3.fc33", rls:"FC33"))) {
    report += res;
  }
