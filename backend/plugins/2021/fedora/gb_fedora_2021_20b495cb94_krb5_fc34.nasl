...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879994");
  ...
  script_name("Fedora: Security Advisory for krb5 (FEDORA-2021-20b495cb94)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-20b495cb94");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P7AFEQGFR3FNSR2E7F6TUACWHAX2J4PQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5'
  package(s) announced via the FEDORA-2021-20b495cb94 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.19.2~2.fc34", rls:"FC34"))) {
    report += res;
  }
