...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879834");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2021-01f851ab8d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-01f851ab8d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FOKQDLCFIUIZLCELA7SQ5VZ2OB27YORA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2021-01f851ab8d advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.8~1.fc33", rls:"FC33"))) {
    report += res;
  }
