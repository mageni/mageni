...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819386");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:24:04 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for gnome-boxes (FEDORA-2021-ac23d9e47f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A2WBDHIS7A54SECQBR5BCC3PDH7YUFKM");
  ...
  * When technology permits, set up access for applications on
  ...
  script_tag(name:"affected", value:"'gnome-boxes' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-boxes", rpm:"gnome-boxes~3.38.2~3.fc33", rls:"FC33"))) {
    report += res;
  }
