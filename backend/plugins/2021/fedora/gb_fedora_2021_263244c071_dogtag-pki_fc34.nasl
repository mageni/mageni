...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879018");
  ...
  script_name("Fedora: Security Advisory for dogtag-pki (FEDORA-2021-263244c071)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/X6VOZ7M7IGQFFXTODEMFNLEKG2SGCS5U");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dogtag-pki", rpm:"dogtag-pki~10.10.5~1.fc34", rls:"FC34"))) {
    report += res;
  }
