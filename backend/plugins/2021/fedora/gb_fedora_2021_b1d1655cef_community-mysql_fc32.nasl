...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878941");
  ...
  script_tag(name:"creation_date", value:"2021-02-15 04:03:14 +0000 (Mon, 15 Feb 2021)");
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2021-b1d1655cef)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/APER2RLZSLCLWV7KVOT5ZZCOXKS7BJGZ");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.23~1.fc32", rls:"FC32"))) {
    report += res;
  }
