...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879231");
  ...
  script_name("Fedora: Security Advisory for tor (FEDORA-2021-e219483023)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-e219483023");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XQQLEHKD3F5JQ4LH6IIGMWJXAQM4FXOW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2021-e219483023 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.5.7~1.fc34", rls:"FC34"))) {
    report += res;
  }
