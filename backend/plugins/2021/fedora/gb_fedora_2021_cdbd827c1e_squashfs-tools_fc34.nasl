...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818467");
  ...
  script_name("Fedora: Security Advisory for squashfs-tools (FEDORA-2021-cdbd827c1e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-cdbd827c1e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RAOZ4BKWAC4Y3U2K5MMW3S77HWWXHQDL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools'
  package(s) announced via the FEDORA-2021-cdbd827c1e advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squashfs-tools", rpm:"squashfs-tools~4.5~2.fc34", rls:"FC34"))) {
    report += res;
  }
