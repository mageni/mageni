...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878938");
  ...
  script_tag(name:"creation_date", value:"2021-02-15 04:02:54 +0000 (Mon, 15 Feb 2021)");
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2021-db50ab62d3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T7EAHJPWOOF4D6PEFLXW5IQWRRSZ3HRC");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.23~1.fc33", rls:"FC33"))) {
    report += res;
  }
