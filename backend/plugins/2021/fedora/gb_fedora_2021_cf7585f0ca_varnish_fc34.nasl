...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879843");
  ...
  script_name("Fedora: Security Advisory for varnish (FEDORA-2021-cf7585f0ca)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/THV2DQA2GS65HUCKK4KSD2XLN3AAQ2V5");
...
significant speed up.");
  ...
  script_tag(name:"affected", value:"'varnish' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"varnish", rpm:"varnish~6.5.2~1.fc34", rls:"FC34"))) {
    report += res;
  }
