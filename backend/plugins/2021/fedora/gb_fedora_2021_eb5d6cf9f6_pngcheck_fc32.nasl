...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879521");
  ...
  script_name("Fedora: Security Advisory for pngcheck (FEDORA-2021-eb5d6cf9f6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-eb5d6cf9f6");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CTHHCUFFFGVQ4ENLH7NRU2I7XRYMLDNI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pngcheck'
  package(s) announced via the FEDORA-2021-eb5d6cf9f6 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pngcheck", rpm:"pngcheck~2.4.0~8.fc32", rls:"FC32"))) {
    report += res;
  }
