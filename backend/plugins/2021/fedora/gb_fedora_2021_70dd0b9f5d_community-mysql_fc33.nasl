...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819087");
  ...
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2021-70dd0b9f5d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-70dd0b9f5d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5MLAXYFLUDC636S46X34USCLDZAOFBM2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'community-mysql'
  package(s) announced via the FEDORA-2021-70dd0b9f5d advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.27~1.fc33", rls:"FC33"))) {
    report += res;
  }
