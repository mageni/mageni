...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879699");
  ...
  script_name("Fedora: Security Advisory for php-symfony4 (FEDORA-2021-121edb82dd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-121edb82dd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VRUS2H2SSOQWNLBD35SKIWIDQEMV2PD3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-symfony4'
  package(s) announced via the FEDORA-2021-121edb82dd advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-symfony4", rpm:"php-symfony4~4.4.24~1.fc33", rls:"FC33"))) {
    report += res;
  }
