...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819003");
  ...
  script_tag(name:"creation_date", value:"2021-10-24 01:24:37 +0000 (Sun, 24 Oct 2021)");
  script_name("Fedora: Security Advisory for watchdog (FEDORA-2021-31748c40a6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-31748c40a6");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FNJD3VQZRYHWGEGDOO3I4ONSNG3YBRGE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'watchdog'
  package(s) announced via the FEDORA-2021-31748c40a6 advisory.");
...
expiration) initiated by the BMC.");
  ...
  script_tag(name:"affected", value:"'watchdog' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"watchdog", rpm:"watchdog~5.16~2.fc34", rls:"FC34"))) {
    report += res;
  }
