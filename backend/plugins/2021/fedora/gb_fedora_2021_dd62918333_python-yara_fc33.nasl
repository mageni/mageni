...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879532");
  ...
  script_tag(name:"creation_date", value:"2021-05-06 03:13:41 +0000 (Thu, 06 May 2021)");
  script_name("Fedora: Security Advisory for python-yara (FEDORA-2021-dd62918333)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FKNXSH5ERG6NELTXCYVJLUPJJJ2TNEBD");
...
and a Boolean expression which determine its logic.");
  ...
  script_tag(name:"affected", value:"'python-yara' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-yara", rpm:"python-yara~4.1.0~1.fc33", rls:"FC33"))) {
    report += res;
  }
