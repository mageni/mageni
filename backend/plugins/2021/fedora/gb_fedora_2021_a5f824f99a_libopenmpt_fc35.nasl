...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819494");
  ...
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2021-a5f824f99a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-a5f824f99a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Q5G2WNZ7K6V44WAKBEMH5INHFRSHDOM4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2021-a5f824f99a advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenmpt", rpm:"libopenmpt~0.5.15~1.fc35", rls:"FC35"))) {
    report += res;
  }
