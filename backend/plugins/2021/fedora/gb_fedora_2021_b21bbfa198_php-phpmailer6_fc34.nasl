...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879559");
  ...
  script_tag(name:"creation_date", value:"2021-05-13 03:18:25 +0000 (Thu, 13 May 2021)");
  script_name("Fedora: Security Advisory for php-phpmailer6 (FEDORA-2021-b21bbfa198)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-b21bbfa198");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KPU66INRFY5BQ3ESVPRUXJR4DXQAFJVT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-phpmailer6'
  package(s) announced via the FEDORA-2021-b21bbfa198 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-phpmailer6", rpm:"php-phpmailer6~6.4.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
