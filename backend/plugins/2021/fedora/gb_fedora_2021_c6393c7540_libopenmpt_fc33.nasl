...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818403");
  ...
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2021-c6393c7540)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-c6393c7540");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T4QY4XI7ZDTJO6IQSPRBCD7CGUZRLQHI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2021-c6393c7540 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenmpt", rpm:"libopenmpt~0.4.23~1.fc33", rls:"FC33"))) {
    report += res;
  }
