...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818570");
  ...
  script_tag(name:"creation_date", value:"2021-10-07 01:10:58 +0000 (Thu, 07 Oct 2021)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2021-bc2770caed)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-bc2770caed");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WKQDE3PWDKASAPSUJYMOQGL73L3YQRFS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2021-bc2770caed advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~94.0.4606.61~1.fc34", rls:"FC34"))) {
    report += res;
  }
