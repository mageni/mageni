...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879647");
  ...
  script_tag(name:"creation_date", value:"2021-05-27 03:19:57 +0000 (Thu, 27 May 2021)");
  script_name("Fedora: Security Advisory for slapi-nis (FEDORA-2021-a4ee3426c4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-a4ee3426c4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GVQCDRQRFHXVR3Z3FQYM3UMC7QZUDDRJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'slapi-nis'
  package(s) announced via the FEDORA-2021-a4ee3426c4 advisory.");
...
for attributes from multiple entries in the tree.");
  ...
  script_tag(name:"affected", value:"'slapi-nis' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"slapi-nis", rpm:"slapi-nis~0.56.7~1.fc33", rls:"FC33"))) {
    report += res;
  }
