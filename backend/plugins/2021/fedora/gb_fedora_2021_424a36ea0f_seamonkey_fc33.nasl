...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879902");
  ...
  script_tag(name:"creation_date", value:"2021-08-02 03:18:27 +0000 (Mon, 02 Aug 2021)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2021-424a36ea0f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-424a36ea0f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NTVPVVOZ7KLT3INPY56B6PRFFZH2QP3F");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2021-424a36ea0f advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.8.1~1.fc33", rls:"FC33"))) {
    report += res;
  }
