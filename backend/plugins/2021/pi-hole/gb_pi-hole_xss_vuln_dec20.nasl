...
if(description)
{
  ...
  script_version("2021-01-12T09:32:15+0000");
  ...
  script_name("Pi-hole Ad-Blocker < 5.2.2 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The Pi-hole Ad-Blocker is prone to a cross-site scripting (XSS) vulnerability.");

  script_tag(name:"insight", value:"The DNS query log in Pi-hole is vulnerable to stored XSS. An attacker with
  the ability to directly or indirectly query DNS with a malicious hostname can cause arbitrary JavaScript to
  execute when the Pi-hole administrator visits the Query Log or Long-term data Query Log page.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Pi-hole Ad-Blocker version 5.2.1 and probably prior.");
