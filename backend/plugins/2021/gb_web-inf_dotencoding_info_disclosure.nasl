...
if(description)
{
  ...
  - Update Eclipse Jetty to version 9.4.39 or later.
...
foreach dir( make_list_unique( "/", "/context", http_cgi_dirs( port:port ) ) ) {
  ...
  url = str_replace( string:url, find:"/WEB-INF/web.xml", replace:"/%2e/WEB-INF/web.xml" );
