...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113792");
  ...
  script_name("PostgreSQL < 9.5.25, 9.6.x < 9.6.21, 10.x < 10.16, 11.x < 11.11, 12.x < 12.6, 13.x < 13.2 Information Disclosure Vulnerability (Windows)");
