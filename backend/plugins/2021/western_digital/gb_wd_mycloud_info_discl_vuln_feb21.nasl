...
if(description)
{
  ...
  script_version("2021-03-01T14:44:16+0000");
  ...
  script_name("Western Digital My Cloud Multiple Products 5.0 < 5.10.122 Multiple Information Disclosure Vulnerabilities");
  ...
  script_tag(name:"insight", value:"Resolved an issue that allowed SMB and AFP shares to
  follow symlinks. Configuration changes were also made to a few files to prevent
  unprivileged users from accessing them.");
