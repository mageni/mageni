...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117707");
  script_version("2021-10-06T14:01:48+0000");
  script_cve_id("CVE-2021-41381");
  ...
  script_tag(name:"severity_date", value:"2021-09-29 17:55:00 +0000 (Wed, 29 Sep 2021)");
  ...
  script_xref(name:"URL", value:"https://www.syss.de/fileadmin/dokumente/Publikationen/Advisories/SYSS-2021-054.txt");
  script_xref(name:"URL", value:"http://packetstormsecurity.com/files/164365/Payara-Micro-Community-5.2021.6-Directory-Traversal.html");
