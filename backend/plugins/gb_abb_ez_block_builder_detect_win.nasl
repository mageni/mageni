...
# $Id: gb_abb_ez_block_builder_detect_win.nasl 13308 2019-01-26 09:17:32Z mmartin $
#
# ABB EZ Block Builder Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 13308 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-26 10:17:32 +0100 (Sat, 26 Jan 2019) $");
  script_tag(name:"creation_date", value:"2019-01-26 10:11:36 +0100 (Sat, 26 Jan 2019)");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    register_and_report_cpe(app:appName , ver:version, concluded:concluded,
                          base:"cpe:/a:abb:ez_block_builder:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0);
    exit(0);
  }
}
