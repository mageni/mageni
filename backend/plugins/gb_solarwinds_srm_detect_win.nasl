...
# $Id: gb_solarwinds_srm_detect_win.nasl 12756 2018-12-11 11:23:23Z mmartin $
#
...
if(description)
{
  ...
  script_name("SolarWinds Storage Resource Monitor Version Detection (Windows)");
  ...
  of SolarWinds Storage Resource Monitor for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "SolarWinds Storage Resource Monitor") continue;
    version = "unknown";
    concluded += "SolarWinds SRM";
    ...
    set_kb_item(name:"solarwinds/srm/win/detected", value:TRUE);
