...
# $Id: gb_oracle_ats_detect_win.nasl 13344 2019-01-29 13:56:52Z mmartin $
#
# Oracle Application Testing Suite Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 13344 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-29 14:56:52 +0100 (Tue, 29 Jan 2019) $");
  script_tag(name:"creation_date", value:"2019-01-29 14:44:33 +0100 (Tue, 29 Jan 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("Oracle Application Testing Suite Version Detection (Windows)");
  ...
  of Oracle Application Testing Suite for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "Oracle ATS Agent") continue;
