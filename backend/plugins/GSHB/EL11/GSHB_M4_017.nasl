...
# $Id: GSHB_M4_017.nasl 11531 2018-09-21 18:50:24Z cfischer $
#
# IT-Grundschutz, 11. EL, Maßnahme 4.017
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.894017");
  ...
  script_dependencies("GSHB/GSHB_SSH_lastlogin.nasl", "GSHB/GSHB_LDAP_User_lastlogon.nasl", "GSHB/GSHB_WMI_OSInfo.nasl");
  ...
  wird: OID 1.3.6.1.4.1.25623.1.0.94184
