...
# $Id: GSHB_M4_332.nasl 10623 2018-07-25 15:14:01Z cfischer $
#
# IT-Grundschutz, 11. EL, Maßnahme 4.332
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.894332");
  script_version("$Revision: 10623 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-25 17:14:01 +0200 (Wed, 25 Jul 2018) $");
  script_tag(name:"creation_date", value:"2010-05-28 10:26:40 +0200 (Fri, 28 May 2010)");
  ...
  script_dependencies("netbios_name_get.nasl", "GSHB/GSHB_SSH_SAMBA_ntfs_ACL_ADS.nasl");
  ...
  wird: OID 1.3.6.1.4.1.25623.1.0.94239
