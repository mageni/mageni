...
# $Id: GSHB_M5_020.nasl 11531 2018-09-21 18:50:24Z cfischer $
#
# IT-Grundschutz, 11. EL, Maßnahme 5.020
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.895020");
  script_version("$Revision: 11531 $");
  script_tag(name:"last_modification", value:"$Date: 2018-09-21 20:50:24 +0200 (Fri, 21 Sep 2018) $");
  script_tag(name:"creation_date", value:"2010-05-04 16:04:36 +0200 (Tue, 04 May 2010)");
  ...
  wird: OID 1.3.6.1.4.1.25623.1.0.95057
