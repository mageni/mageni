...
# $Id: GSHB_M4_189.nasl 11531 2018-09-21 18:50:24Z cfischer $
#
# IT-Grundschutz, 11. EL, Maßnahme 4.189
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.894189");
  ...
  script_name("IT-Grundschutz M4.189: Schutz vor unzulässigen Programmaufrufen beim IIS-Einsatz (Windows)");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.189: Schutz vor unzulässigen Programmaufrufen beim IIS-Einsatz.
