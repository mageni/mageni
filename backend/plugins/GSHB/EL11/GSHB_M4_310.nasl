...
# $Id: GSHB_M4_310.nasl 10625 2018-07-25 15:24:35Z cfischer $
#
# IT-Grundschutz, 11. EL, Maßnahme 4.310
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.894310");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.310: Einrichtung des LDAP-Zugriffs auf Verzeichnisdienste (Windows).
