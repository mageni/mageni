...
#
# IT-Grundschutz, 11. EL, Maßnahme 4.285
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.894285");
  script_version("$Revision: 10646 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-27 09:00:22 +0200 (Fri, 27 Jul 2018) $");
  script_tag(name:"creation_date", value:"2010-01-14 14:29:35 +0100 (Thu, 14 Jan 2010)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("IT-Grundschutz M4.285: Deinstallation nicht benötigter Client-Funktionen von Windows Server 2003 (Windows)");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.285: Deinstallation nicht benötigter Client-Funktionen von Windows Server 2003 (Windows).
