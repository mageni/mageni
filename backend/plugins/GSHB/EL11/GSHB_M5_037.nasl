...
# $Id: GSHB_M5_037.nasl 10129 2018-06-08 08:13:23Z emoss $
#
# IT-Grundschutz, 11. EL, Massnahme 5.037
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.895037");
  ...
  script_name("IT-Grundschutz M5.037: Einschraenken der Peer-to-Peer-Funktionalitaeten in einem servergestuetzten Netz (Windows)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2010 Greenbone Networks GmbH");
  script_family("IT-Grundschutz-11");
  script_mandatory_keys("Tools/Present/wmi", "Compliance/Launch/GSHB-11");
  script_dependencies("GSHB/GSHB_WMI_PolSecSet.nasl", "GSHB/GSHB_WMI_OSInfo.nasl");
  script_require_keys("WMI/Shares");

  script_xref(name:"URL", value:"http://www.bsi.bund.de/DE/Themen/ITGrundschutz/ITGrundschutzKataloge/Inhalt/_content/m/m05/m05037.html");

  script_tag(name:"summary", value:"IT-Grundschutz M5.037: Einschraenken der Peer-to-Peer-Funktionalitaeten in einem servergestuetzten Netz (Windows).
