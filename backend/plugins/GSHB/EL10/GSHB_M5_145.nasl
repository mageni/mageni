...
# $Id: GSHB_M5_145.nasl 11531 2018-09-21 18:50:24Z cfischer $
#
# IT-Grundschutz, 10. EL, Maßnahme 5.145
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.95145");
  script_version("$Revision: 11531 $");
  script_tag(name:"last_modification", value:"$Date: 2018-09-21 20:50:24 +0200 (Fri, 21 Sep 2018) $");
  script_tag(name:"creation_date", value:"2010-04-26 10:43:38 +0200 (Mon, 26 Apr 2010)");
