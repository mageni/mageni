...
# $Id: GSHB_M4_055.nasl 10129 2018-06-08 08:13:23Z emoss $
#
# IT-Grundschutz, 10. EL, Massnahme 4.055
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94055");
  ...
  script_require_keys("WMI/SessionManagerOS2", "WMI/SessionManagerPosix", "WMI/OS2", "WMI/Posix", "WMI/DontDisplayLastUserName",
                      "WMI/LegalNoticeCaption", "WMI/LegalNoticeText");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.055: Sichere Installation von Windows NT (Windows)
