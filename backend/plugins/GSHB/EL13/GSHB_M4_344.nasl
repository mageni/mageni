...
#
# IT-Grundschutz, 13. EL, Maßnahme 4.344
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94169");
  script_version("$Revision: 10623 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-25 17:14:01 +0200 (Wed, 25 Jul 2018) $");
  script_tag(name:"creation_date", value:"2013-11-20 15:59:23 +0100 (Wed, 20 Nov 2013)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("IT-Grundschutz M4.344: Überwachung von Windows Vista-, Windows 7 und Windows Server 2008-Systemen");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.344: Überwachung von Windows Vista-, Windows 7 und Windows Server 2008-Systemen.
