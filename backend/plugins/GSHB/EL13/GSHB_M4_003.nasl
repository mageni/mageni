...
# $Id: GSHB_M4_003.nasl 10625 2018-07-25 15:24:35Z cfischer $
#
# IT-Grundschutz, 13. EL, Maßnahme 4.003
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94104");
  script_version("$Revision: 10625 $");
  script_tag(name:"last_modification", value:"$Date: 2018-07-25 17:24:35 +0200 (Wed, 25 Jul 2018) $");
  script_tag(name:"creation_date", value:"2013-11-20 13:40:53 +0100 (Wed, 20 Nov 2013)");
...
wird: OID 1.3.6.1.4.1.25623.1.0.94174
