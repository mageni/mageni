...
# $Id: gb_nmap_snmp_win32_software_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Attempts to enumerate installed software through SNMP.
