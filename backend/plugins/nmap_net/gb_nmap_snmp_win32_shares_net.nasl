...
# $Id: gb_nmap_snmp_win32_shares_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104106");
  ...
  script_name("Nmap NSE net: snmp-win32-shares");
  ...
  script_tag(name:"summary", value:"Attempts to enumerate Windows Shares through SNMP.
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"snmp-win32-shares", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"snmp-win32-shares");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (snmp-win32-shares.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
