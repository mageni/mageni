...
if (phase == 1) {
    ...
    nmap_nse_register(script:"smb-enum-groups", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"smb-enum-groups");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (smb-enum-groups.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
