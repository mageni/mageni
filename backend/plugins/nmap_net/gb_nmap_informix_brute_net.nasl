...
# $Id: gb_nmap_informix_brute_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"informix-brute", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"informix-brute");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (informix-brute.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
