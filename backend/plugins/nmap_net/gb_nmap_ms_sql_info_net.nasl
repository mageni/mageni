...
# $Id: gb_nmap_ms_sql_info_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104014");
  ...
  script_name("Nmap NSE net: ms-sql-info");
  ...
  script_tag(name:"summary", value:"Attempts to extract information from Microsoft SQL Server instances.
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"ms-sql-info", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"ms-sql-info");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (ms-sql-info.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
