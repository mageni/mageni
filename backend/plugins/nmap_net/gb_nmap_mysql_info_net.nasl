...
# $Id: gb_nmap_mysql_info_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104133");
  ...
  script_name("Nmap NSE net: mysql-info");
...
if (phase == 1) {
  argv = make_array();
  nmap_nse_register(script:"mysql-info", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"mysql-info");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (mysql-info.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
