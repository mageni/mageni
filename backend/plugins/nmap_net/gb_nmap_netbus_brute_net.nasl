...
# $Id: gb_nmap_netbus_brute_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104132");
  ...
  script_name("Nmap NSE net: netbus-brute");
  ...
  script_tag(name:"summary", value:"Performs brute force password auditing against the Netbus backdoor ('remote administration')
service.
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"netbus-brute", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"netbus-brute");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (netbus-brute.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
