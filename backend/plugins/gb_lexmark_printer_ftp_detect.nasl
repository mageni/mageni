...
# 220 ET0021B79D44F9 Lexmark MX310dn FTP Server NH5.SB.N543 ready.
# 220 ET000400F531C2 Lexmark T642 FTP Server NS.NP.N118 ready.
# 220 ET0021B71789AC Lexmark MX622adhe FTP Server MXTGM.052.026 ready.
# Note: Nxxxx.xxx.xxx is the network version and not the firmware version
if (banner && "Lexmark" >< banner && "FTP Server" >< banner) {
