...
# $Id: nopsec_php_4_4_8.nasl 10460 2018-07-09 07:50:03Z cfischer $
#
# PHP Version < 4.4.8 Multiple Vulnerabilities
#
# Authors:
...
if( version_is_less( version:vers, test_version:"4.4.8" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"4.4.8" );
