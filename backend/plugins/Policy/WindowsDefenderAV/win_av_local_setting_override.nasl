...
if(description)
{
  ...
  script_tag(name:"summary", value:"This policy setting configures a local override for the
configuration to join Microsoft MAPS. This setting can only be set by Group Policy.

If you enable this setting, the local preference setting will take priority over Group Policy.

If you disable or do not configure this setting, Group Policy will take priority over the local
preference setting.
...
solution = "Set following UI path accordingly: Windows Components/Windows Defender Antivirus/MAPS/" + title;
type = "HKLM";
