...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150075");
  ...
  script_name("Linux: SSH LoginGraceTime");
...
if(get_kb_item("Policy/linux/sshd_config/ERROR")){
  ...
  value = get_kb_item("Policy/linux/sshd_config/logingracetime");
