...
if(description)
{
  ...
  script_add_preference(name:"Value", type:"entry", value:"IPv4,IPv6", id:1);
...
if(get_kb_item("Policy/linux/sshd_config/ERROR")){
  ...
  listenaddress = get_kb_list("Policy/linux/sshd_config/listenaddress");
  value = policy_build_string_from_list(list:listenaddress, sep:",");
