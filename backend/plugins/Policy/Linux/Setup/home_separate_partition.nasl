...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150059");
  ...
  script_name("Linux: Separate partition for /home");
...
This script tests if a separate partition exists for /home.");
...
solution = "Create a new partition and configure /home as appropriate";
test_type = "SSH_Cmd";
...
if(get_kb_item("linux/mount/ERROR")){
  ...
  if(!in_array(search:"/home", array:mounted_partitions, part_match:FALSE))
    value = "no";
  else
    value = "yes";
