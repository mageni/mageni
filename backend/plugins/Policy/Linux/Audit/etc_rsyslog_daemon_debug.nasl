...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150161");
  script_version("2020-07-29T09:51:47+0000");
  script_tag(name:"last_modification", value:"2020-07-30 10:23:02 +0000 (Thu, 30 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-03-12 15:12:05 +0000 (Thu, 12 Mar 2020)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");

  script_name("Linux: daemon.debug in /etc/rsyslog.conf");
  ...
  script_add_preference(name:"Value", type:"entry", value:"/var/log/daemon.log", id:1);
  ...
  script_tag(name:"summary", value:"Test if and to which file the debug logs generated by the daemon
...
cmd = "grep 'daemon.debug' /etc/rsyslog.conf";
title = "Record debug logs generated by the daemon process";
solution = "Add 'daemon.debug FILE' to /etc/rsyslog.conf";
test_type = "SSH_Cmd";
...
if(get_kb_item("Policy/linux//etc/rsyslog.conf/ERROR")){
  ...
  grep = egrep(string:content, pattern:"daemon.debug");
  if(grep){
