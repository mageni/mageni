...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150150");
  script_version("2020-07-29T09:51:47+0000");
  script_tag(name:"last_modification", value:"2020-07-30 10:23:02 +0000 (Thu, 30 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-03-10 08:37:03 +0000 (Tue, 10 Mar 2020)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");

  script_name("Linux: TCP timestamps");
  ...
  script_xref(name:"URL", value:"https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux_for_real_time/7/html/tuning_guide/reduce_tcp_performance_spikes");

  script_tag(name:"summary", value:"The tcp_timestamps function makes the system prone to DoS attacks.

This script tests whether the Linux host is configured to disable tcp_timestamps.");
...
cmd = "sysctl net.ipv4.tcp_timestamps";
title = "TCP timestamps";
solution = "sysctl -w net.ipv4.tcp_timestamps = [0,1]";
test_type = "SSH_Cmd";
...
if(get_kb_item("Policy/linux/sysctl/ssh/ERROR")){
  ...
  # sysctl -a output
  net_ipv4_tcp_timestamps = get_kb_item("Policy/linux/sysctl/net.ipv4.tcp_timestamps");
  ...
  if(get_kb_item("Policy/linux/sysctl/conf/ERROR")){
    ...
    foreach file (files){
      ...
      grep_pattern = egrep(string:content, pattern:"net.ipv4.tcp_timestamps");
      if(grep_pattern){
