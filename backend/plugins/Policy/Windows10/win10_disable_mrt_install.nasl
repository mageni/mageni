...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312283");
  ...
  script_name('Microsoft Windows 10: Disable Malicious Software Removal Tool From Installing');
