...
# $Id: win10_adjust_memory_quotas_process.nasl 10649 2018-07-27 07:16:55Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312264");
  ...
  script_add_preference(name:"Value", type:"entry", value:"Administrators, LOCAL SERVICE, NETWORK SERVICE");
