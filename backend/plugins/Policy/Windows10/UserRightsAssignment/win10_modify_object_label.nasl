...
# $Id: win10_modify_object_label.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Modify an object label (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312274");
  ...
  script_name('Microsoft Windows 10: Modify an object label');
  ...
  script_tag(name: "summary", value: "This privilege determines which user 
accounts can modify the integrity label of objects, such as files, registry keys, 
or processes owned by other users. Processes running under a user account can 
modify the label of an object owned by that user to a lower level without this 
privilege.");
  exit(0);
}
