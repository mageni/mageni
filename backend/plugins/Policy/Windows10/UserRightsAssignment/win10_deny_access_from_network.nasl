...
# $Id: win10_deny_access_from_network.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Deny access to this computer from the network (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312268");
  ...
  script_name('Microsoft Windows 10: Deny access to this computer from the network');
...
users are prevented from accessing a device over the network.");
  exit(0);
}
...
select = 'AccountList';
keyname = 'SeDenyNetworkLogonRight';
