...
# $Id: win10_increase_scheduling_priority.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Increase scheduling priority (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312265");
  ...
  script_name('Microsoft Windows 10: Increase scheduling priority');
  ...
  script_tag(name: "summary", value: "This policy setting determines which user 
accounts can increase the base priority class of a process. It is not a 
privileged operation to increase relative priority within a priority class. This 
user right is not required by administrative tools that are supplied with the 
operating system, but it might be required by software development tools.");
  exit(0);
}
...
select = 'AccountList';
keyname = 'SeIncreaseBasePriorityPrivilege';
