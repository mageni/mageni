...
# $Id: win10_profile_system_performance.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Profile system performance (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312243");
  ...
  script_name('Microsoft Windows 10: Profile system performance');
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2018 Greenbone Networks GmbH");
  script_family("Policy");
  script_dependencies("gb_wmi_access.nasl", "smb_reg_service_pack.nasl");
  script_add_preference(name:"Value", type:"entry", value:"Administrators, NT SERVICE\WdiServiceHost");
  script_mandatory_keys("Compliance/Launch");
  script_require_keys("WMI/access_successful");
  script_tag(name: "summary", value: "This security setting determines which 
users can use Windows performance monitoring tools to monitor the performance 
of system processes.");
  exit(0);
}
...
select = 'AccountList';
keyname = 'SeSystemProfilePrivilege';
