...
# $Id: win10_act_as_part_of_os.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Act as part of the operating system (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312259");
  ...
  script_name('Microsoft Windows 10: Act as part of the operating system');
  ...
  script_tag(name: "summary", value: "The Act as part of the operating system 
policy setting determines whether a process can assume the identity of any user 
and thereby gain access to the resources that the user is authorized to access.");
  exit(0);
}
