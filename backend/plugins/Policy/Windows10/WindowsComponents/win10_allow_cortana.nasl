...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312201");
  ...
  script_name('Microsoft Windows 10: Allow Cortana');
  ...
  script_tag(name:"summary", value:"This policy setting disables Cortana.
If disabled, Cortana will be turned off.");
  exit(0);
}
