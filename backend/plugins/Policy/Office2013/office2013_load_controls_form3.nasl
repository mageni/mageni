...
# $Id: office2013_load_controls_form3.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Load Controls in Forms3
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312332");
  ...
  script_name('Microsoft Office 2013: Load Controls in Forms3');
  ...
  script_tag(name: "summary", value: 'Check Setting "Load Controls in Forms3" (Microsoft Office 2013).');
  exit(0);
}
