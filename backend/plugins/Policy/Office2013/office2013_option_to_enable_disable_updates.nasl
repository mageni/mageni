...
# $Id: office2013_option_to_enable_disable_updates.nasl 9659 2018-04-27 11:55:11Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312350");
  ...
  script_name('Microsoft Office 2013: Hide option to enable or disable updates');
  ...
  script_tag(name: "summary", value: 'Check Setting "Hide option to enable or disable updates" (Microsoft Office 2013).');
  exit(0);
}
