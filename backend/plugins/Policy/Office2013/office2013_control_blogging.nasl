...
# $Id: office2013_control_blogging.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Control Blogging
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312314");
  ...
  script_name('Microsoft Office 2013: Control Blogging');
  ...
  script_tag(name: "summary", value: 'Check Setting "Control Blogging" (Microsoft Office 2013).');
  exit(0);
}
...
type = 'HKCU';
key = 'Software\\Policies\\Microsoft\\Office\\Common\\Blog';
item = 'DisableBlog';
