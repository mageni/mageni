...
# $Id: office2013_encr_type_passwd_protected_files.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Encryption type for password protected Office 97-2003 files
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312312");
  ...
  script_name('Microsoft Office 2013: Encryption type for password protected Office 97-2003 files');
  ...
  script_tag(name: "summary", value: 'Check Setting "Encryption type for password protected Office 97-2003 files" (Microsoft Office 2013).');
  exit(0);
}
