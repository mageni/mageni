...
# $Id: office2013_opt-in_wizard.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Disable Opt-in Wizard on first run
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312352");
  ...
  script_name('Microsoft Office 2013: Disable Opt-in Wizard on first run');
  ...
  script_tag(name: "summary", value: 'Check Setting "Disable Opt-in Wizard on first run" (Microsoft Office 2013).');
  exit(0);
}
