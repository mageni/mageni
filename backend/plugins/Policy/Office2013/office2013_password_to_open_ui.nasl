...
# $Id: office2013_password_to_open_ui.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Disable password to open UI
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312320");
  ...
  script_name('Microsoft Office 2013: Disable password to open UI');
  ...
  script_tag(name: "summary", value: 'Check Setting "Disable password to open UI" (Microsoft Office 2013).');
  exit(0);
}
