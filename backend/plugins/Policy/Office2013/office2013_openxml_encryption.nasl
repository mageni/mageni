...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312313");
  ...
  script_name('Microsoft Office 2013: Encryption type for password protected Office Open XML files');
  ...
  script_tag(name: "summary", value: 'Check Setting "Encryption type for password protected Office Open XML files" (Microsoft Office 2013).');
  exit(0);
}
