...
# $Id: office2013_send_office_feedback.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Send Office Feedback
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312335");
  ...
  script_name('Microsoft Office 2013: Send Office Feedback');
  ...
  script_tag(name: "summary", value: 'Check Setting "Send Office Feedback" (Microsoft Office 2013).');
  exit(0);
}
