...
# $Id: office2013_automatic_updates.nasl 9659 2018-04-27 11:55:11Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312342");
  ...
  script_name('Microsoft Office 2013: Enable Automatic Updates');
  ...
  script_tag(name: "summary", value: 'Check Setting "Enable Automatic Updates" (Microsoft Office 2013).');
  exit(0);
}
