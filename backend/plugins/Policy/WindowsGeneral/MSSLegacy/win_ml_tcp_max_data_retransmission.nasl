...
# $Id: win_ml_tcp_max_data_retransmission.nasl 10797 2018-08-06 14:54:44Z emoss $
#
# Check value for MSS: (TcpMaxDataRetransmissions) How many times unacknowledged
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312691");
  script_version("$Revision: 10797 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-06 16:54:44 +0200 (Mon, 06 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-15 14:49:46 +0200 (Fri, 15 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: MSS: How many times unacknowledged data is retransmitted');
...
(3 recommended, 5 is default)' on Windows hosts (at least Windows 7).");
  exit(0);
}
