...
# $Id: win_computer_browser.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Computer Browser (Browser)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312681");
  ...
  script_name('Microsoft Windows: Service: Computer Browser');
...
'Computer Browser (Browser)' on Windows hosts (at least Windows 7).
