...
# $Id: win_addauth_bitlocker_no_tpm.nasl 10893 2018-08-10 13:07:24Z emoss $
#
# Check value for Require additional authentication at startup: Allow BitLocker
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312468");
...
'Require additional authentication at startup: Allow BitLocker without a
compatible TPM' on Windows hosts (at least Windows 7).
