...
# $Id: win_rdhost_pnp_redirection.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Do not allow supported Plug and Play device redirection
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312427");
...
'Do not allow supported Plug and Play device redirection' on Windows hosts (at
least Windows 7).

The setting controls the redirection of supported Plug and Play and RemoteFX USB
devices to the remote computer in a Remote Desktop Services session.
By default, Remote Desktop Services does not allow redirection of supported Plug
and Play and RemoteFX USB devices.");
  exit(0);
}
