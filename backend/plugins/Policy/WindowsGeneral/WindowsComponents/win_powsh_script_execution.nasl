...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109607");
  ...
  script_name("Microsoft Windows: Script Execution");
...
If you disable or do not configure this policy setting, it reverts to a per-machine preference
setting, the default if that is not configured is 'No scripts allowed'.
