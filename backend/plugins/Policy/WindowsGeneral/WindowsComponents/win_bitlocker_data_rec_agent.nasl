...
# $Id: win_bitlocker_data_rec_agent.nasl 10842 2018-08-08 14:01:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312469");
  script_version("$Revision: 10842 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-08 16:01:21 +0200 (Wed, 08 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-25 14:13:24 +0200 (Mon, 25 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: Recovering of BitLocker-protected fixed drives (agent)');
...
'Choose how BitLocker-protected fixed drives can be recovered:Allow data
recovery agent' on Windows hosts (at least Windows 7).
...
The option is used to specify whether a data recovery agent can be used with
...
title = 'Choose how BitLocker-protected fixed drives can be recovered: Allow data recovery agent';
