...
# $Id: win_rmclient_unencrypted.nasl 10989 2018-08-15 14:57:51Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312479");
  script_version("$Revision: 10989 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-15 16:57:51 +0200 (Wed, 15 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-28 09:09:13 +0200 (Thu, 28 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: Unencrypted traffic (RM Client)');
...
The setting controls whether the Windows Remote Management (WinRM) client sends
