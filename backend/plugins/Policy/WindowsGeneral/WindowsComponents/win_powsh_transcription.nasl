...
# $Id: win_powsh_transcription.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Turn on PowerShell Transcription
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312449");
...
'Turn on PowerShell Transcription' on Windows hosts (at least Windows 7).

The setting allows to capture the input and output of Windows PowerShell
