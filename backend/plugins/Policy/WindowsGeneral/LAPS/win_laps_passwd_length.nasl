...
# $Id: win_laps_passwd_length.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for Password Settings: Password Length
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312580");
  script_version("$Revision: 10740 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-02 16:13:50 +0200 (Thu, 02 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-15 10:38:19 +0200 (Fri, 15 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: LAPS: Password Settings: Password Length');
...
'Password Settings: Password Length' on Windows hosts (at least Windows 7).
...
title = 'Password Settings: Password Length';
