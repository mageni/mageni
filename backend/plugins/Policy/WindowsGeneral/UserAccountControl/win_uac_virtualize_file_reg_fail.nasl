...
# $Id: win_uac_virtualize_file_reg_fail.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for User Account Control: Virtualize file and registry write failures to per-user locations
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312529");
...
locations' on Windows hosts (at least Windows 7).

The policy setting controls the redirection of the write failures of earlier
applications to defined locations in the registry and the file system.");
  exit(0);
}
