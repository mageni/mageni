...
# $Id: win_uac_all_admins_approval_mode.nasl 10740 2018-08-02 14:13:50Z emoss $
#
# Check value for User Account Control: Run all administrators in Admin Approval Mode
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312530");
...
'User Account Control: Run all administrators in Admin Approval Mode' on Windows
hosts (at least Windows 7).

The policy setting controls the behavior of all User Account Control (UAC)
policies for the entire system. The setting turns UAC on or off.");
  exit(0);
}
