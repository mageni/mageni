...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312602");
  ...
  script_name('Microsoft Windows: Prevent installation of devices also to already installed (Driver Setup Class)');
...
Device Installation Restrictions/Prevent installation of devices using drivers that match these device setup classes:' + title;
type = 'HKLM';
