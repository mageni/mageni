...
# $Id: win_passwd_wakes_battery.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Require a password when a computer wakes (on battery)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312623");
  ...
  script_name('Microsoft Windows: Require a password when a computer wakes (on battery)');
...
'Require a password when a computer wakes (on battery)' on Windows hosts (at least Windows 8.1).
