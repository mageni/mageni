...
# $Id: win_unauth_rpc_client.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Restrict Unauthenticated RPC clients
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312639");
  ...
  script_name('Microsoft Windows: Restrict Unauthenticated RPC clients');
...
'Restrict Unauthenticated RPC clients' on Windows hosts (at least Windows 8.1).

The setting controls how the RPC server runtime handles unauthenticated RPC clients connecting to
RPC servers.");
  exit(0);
}
