...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109601");
  ...
  script_name("Microsoft Windows: Turn On Virtualization Based Security (Select Platform Security Level)");
  ...
  script_add_preference(name:"Value", type:"radio", value:"1;3");
...
win_min_ver = "6.3";
title = "Turn On Virtualization Based Security (Select Platform Security Level)";
...
item = "RequirePlatformSecurityFeatures";
