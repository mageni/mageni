...
# $Id: win_solicited_remote_assistance.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Configure Solicited Remote Assistance
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312598");
...
'Configure Solicited Remote Assistance' on Windows hosts (at least Windows 8.1).

The setting turns on or off Solicited (Ask for) Remote Assistance on this computer.");
  exit(0);
}
