...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109935");
  ...
  script_name("Windows Defender Firewall: Private Profile: Allow unicast response");
...
broadcast messages for a private connection will be blocked.");
...
win_min_ver = "6.1";
title = "Private Profile: Allow unicast response";
