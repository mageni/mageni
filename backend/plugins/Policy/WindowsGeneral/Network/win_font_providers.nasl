...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312578");
  ...
  script_name('Microsoft Windows: Enable Font Providers');
...
Computer Configuration/Policies/Administrative Templates/Network/Fonts/' + title;
type = 'HKLM';
key = 'Software\\Policies\\Microsoft\\Windows\\System';
item = 'EnableFontProviders';
