...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.142507");
  script_version("2019-06-26T06:12:23+0000");
  script_tag(name:"last_modification", value:"2019-06-26 06:12:23 +0000 (Wed, 26 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-26 06:04:16 +0000 (Wed, 26 Jun 2019)");
  ...
  script_name("Django AdminURLFieldWidget XSS Vulnerability (Windows)");
