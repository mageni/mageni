...
if (description)
{
  ...
  script_name("OTRS 7.0.x < 7.0.9 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"A customer user can use the search results to disclose information
  from their 'company' tickets (with the same CustomerID), even when CustomerDisableCompanyTicketAccess setting is turned on.");

  script_tag(name:"affected", value:"OTRS 7.0.x through 7.0.8.");
