...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883125");
  ...
  script_tag(name:"creation_date", value:"2019-11-01 03:00:50 +0000 (Fri, 01 Nov 2019)");
  script_name("CentOS Update for firefox CESA-2019:3193 centos7 ");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-October/023497.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2019:3193 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.2.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
