...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883025");
  ...
  script_tag(name:"creation_date", value:"2019-03-28 13:44:52 +0000 (Thu, 28 Mar 2019)");
  script_name("CentOS Update for firefox CESA-2019:0623 centos6 ");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-March/023249.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2019:0623 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~60.6.0~3.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
