...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kde-settings-19", rpm:"kde-settings-19~23.10.el7.centos", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kde-settings-ksplash-19", rpm:"kde-settings-ksplash-19~23.10.el7.centos", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kde-settings-minimal-19", rpm:"kde-settings-minimal-19~23.10.el7.centos", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kde-settings-plasma-19", rpm:"kde-settings-plasma-19~23.10.el7.centos", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kde-settings-pulseaudio-19", rpm:"kde-settings-pulseaudio-19~23.10.el7.centos", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qt-settings-19", rpm:"qt-settings-19~23.10.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
