...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883142");
  ...
  script_tag(name:"creation_date", value:"2019-12-12 03:00:49 +0000 (Thu, 12 Dec 2019)");
  script_name("CentOS Update for firefox CESA-2019:4108 centos6 ");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-December/023539.html");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.3.0~1.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
