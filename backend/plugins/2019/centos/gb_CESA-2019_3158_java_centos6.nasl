...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883122");
  ...
  script_tag(name:"creation_date", value:"2019-10-24 02:01:22 +0000 (Thu, 24 Oct 2019)");
  script_name("CentOS Update for java CESA-2019:3158 centos6 ");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2019-October/023490.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java'
  package(s) announced via the CESA-2019:3158 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk", rpm:"java-1.7.0-openjdk~1.7.0.241~2.6.20.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-demo", rpm:"java-1.7.0-openjdk-demo~1.7.0.241~2.6.20.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.241~2.6.20.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-javadoc", rpm:"java-1.7.0-openjdk-javadoc~1.7.0.241~2.6.20.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-src", rpm:"java-1.7.0-openjdk-src~1.7.0.241~2.6.20.0.el6_10", rls:"CentOS6"))) {
    report += res;
  }
