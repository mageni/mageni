...
if(description)
{
  ...
  script_name("Apple iCloud Security Updates( HT210357 )");
  ...
  script_tag(name:"affected", value:"Apple iCloud versions before 7.13 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Apple iCloud 7.13 or later. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://support.apple.com/en-in/HT210357");
...
#7.13 == 7.13.0.14
if(version_is_less(version:icVer, test_version:"7.13.0.14"))
{
  report = report_fixed_ver(installed_version:icVer, fixed_version:"7.13 (7.13.0.14)", install_path:icPath);
