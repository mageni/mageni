...
if(description)
{
  ...
  script_name("Ubuntu Update for snapd USN-3917-1");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3917-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snapd'
  package(s) announced via the USN-3917-1 advisory.");
...
automatically refreshed itself to snapd 2.37.4 which is unaffected.");
  ...
  script_tag(name:"affected", value:"'snapd' package(s) on Ubuntu 18.10,
  Ubuntu 18.04 LTS,
  Ubuntu 16.04 LTS,
  Ubuntu 14.04 LTS.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapd", ver:"2.37.4~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapd", ver:"2.37.4+18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapd", ver:"2.37.4+18.10.1", rls:"UBUNTU18.10"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapd", ver:"2.37.4ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
