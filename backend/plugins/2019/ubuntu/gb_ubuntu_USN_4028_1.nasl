...
if(description)
{
  ...
  script_name("Ubuntu Update for thunderbird USN-4028-1");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-4028-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the USN-4028-1 advisory.");
