...
if(description)
{
  ...
  script_name("Ubuntu Update for glib2.0 USN-4049-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-July/004999.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2.0'
  package(s) announced via the USN-4049-1 advisory.");
...
sensitive information.");
  ...
  script_tag(name:"affected", value:"'glib2.0' package(s) on Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
