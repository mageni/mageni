...
if(description)
{
  ...
  script_name("Ubuntu Update for expat USN-4040-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-June/004985.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the USN-4040-1 advisory.");
...
An attacker could possibly use this issue to cause a denial of service.");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on Ubuntu 19.04, Ubuntu 18.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
