...
if (description)
{
  ...
  script_version("2019-06-05T04:57:14+0000");
  script_tag(name:"last_modification", value:"2019-06-05 04:57:14 +0000 (Wed, 05 Jun 2019)");
  ...
  script_tag(name:"insight", value:"app/Core/Paginator.php has a XSS in pagination sorting.");
