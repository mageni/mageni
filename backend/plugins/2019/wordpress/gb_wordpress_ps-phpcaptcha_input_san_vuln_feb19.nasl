...
url = dir + "/wp-content/plugins/ps-phpcaptcha/readme.txt";
...
if("=== PS PHPCaptcha WP ===" >< res && "Changelog" >< res) {
  ...
  if(vers[1] && version_is_less(version: vers[1], test_version: "1.2.0")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "1.2.0", file_checked: url);
