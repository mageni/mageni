...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113465");
  ...
  script_cve_id("CVE-2015-9310");

  script_name("WordPress All In One WP Security & Firewall Plugin < 3.9.1 SQL Injection Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress All In One WP Security & Firewall plugin through version 3.9.0.");
...
if( "=== All In One WP Security & Firewall" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: vers[1], test_version: "3.9.1" ) ) {
    report = report_fixed_ver( installed_version: vers[1], fixed_version: "3.9.1", install_path: dir );
