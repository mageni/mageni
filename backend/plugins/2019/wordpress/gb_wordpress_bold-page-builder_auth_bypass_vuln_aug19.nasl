...
if(description)
{
  ...
  script_version("2019-09-04T11:14:14+0000");
  script_tag(name:"last_modification", value:"2019-09-04 11:14:14 +0000 (Wed, 04 Sep 2019)");
...
url = dir + "/wp-content/plugins/bold-page-builder/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== Bold Page Builder" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.3.2" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.3.2", file_checked: url );
