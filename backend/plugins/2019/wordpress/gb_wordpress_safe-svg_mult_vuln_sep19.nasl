...
if (description)
{
  ...
  script_version("2019-11-12T08:20:34+0000");
  script_tag(name:"last_modification", value:"2019-11-12 08:20:34 +0000 (Tue, 12 Nov 2019)");
  ...
  script_tag(name:"summary", value:"The WordPress plugin Safe SVG is prone to a denial of service vulnerability.");
...
url = dir + "/wp-content/plugins/safe-svg/readme.txt";
res = http_get_cache(port: port, item: url);

if("=== Safe SVG ===" >< res && "Changelog" >< res) {

  vers = eregmatch(pattern: "Stable tag: ([0-9.]+)", string: res);

  if(vers[1] && version_is_less(version: vers[1], test_version: "1.9.5")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "1.9.5", file_checked: url);
