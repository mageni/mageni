...
if (description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to version 2.0.22 or later.");

  script_xref(name:"URL", value:"https://www.webarxsecurity.com/wordpress-plugin-simple-social-buttons/");
  script_xref(name:"URL", value:"https://de.wordpress.org/plugins/simple-social-buttons/#developers");
