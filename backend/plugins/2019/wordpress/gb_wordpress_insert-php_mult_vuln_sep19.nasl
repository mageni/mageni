...
if(description)
{
  ...
  script_version("2019-09-13T07:44:16+0000");
  script_tag(name:"last_modification", value:"2019-09-13 07:44:16 +0000 (Fri, 13 Sep 2019)");
...
if( ( "=== Insert PHP" >< res || "=== PHP code snippets" >< res || "=== Woody ad snippets" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.2.5" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.2.5", file_checked: url );
