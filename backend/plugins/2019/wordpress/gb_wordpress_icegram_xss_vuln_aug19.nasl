...
if(description)
{
  ...
  script_version("2019-09-05T09:37:26+0000");
  script_tag(name:"last_modification", value:"2019-09-05 09:37:26 +0000 (Thu, 05 Sep 2019)");
...
url = dir + "/wp-content/plugins/icegram/readme.txt";
res = http_get_cache( port: port, item: url );

if( ( "=== Icegram" >< res || "Icegram ===" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "1.10.29" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "1.10.29", file_checked: url );
