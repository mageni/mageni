...
if(description)
{
  ...
  script_version("2019-09-16T13:08:53+0000");
  script_tag(name:"last_modification", value:"2019-09-16 13:08:53 +0000 (Mon, 16 Sep 2019)");
...
url = dir + "/wp-content/plugins/the-events-calendar/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== The Events Calendar" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "4.8.2" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "4.8.2", file_checked: url );
