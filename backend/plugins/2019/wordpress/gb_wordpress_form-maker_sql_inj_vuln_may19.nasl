...
if (description)
{
  ...
  script_version("2019-06-03T13:18:55+0000");
  script_tag(name:"last_modification", value:"2019-06-03 13:18:55 +0000 (Mon, 03 Jun 2019)");
...
if("= Form Maker" >< res && "Changelog" >< res) {
  ...
  if(vers[1] && version_is_less(version: vers[1], test_version: "1.13.3")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "1.13.3", file_checked: url);
