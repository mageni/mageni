...
if(description)
{
  ...
  script_version("2019-09-16T11:38:53+0000");
  script_tag(name:"last_modification", value:"2019-09-16 11:38:53 +0000 (Mon, 16 Sep 2019)");
  ...
  script_tag(name:"summary", value:"The WordPress plugin GiveWP is prone to a cross-site scripting (XSS) vulnerability.");
...
if( "=== Give" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.4.7" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.4.7", file_checked: url );
