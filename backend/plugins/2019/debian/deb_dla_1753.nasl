...
if(description)
{
  ...
  script_version("2019-04-09T02:00:10+0000");
  # TODO: No CVE assigned yet.
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-04-09 02:00:10 +0000 (Tue, 09 Apr 2019)");
  script_tag(name:"creation_date", value:"2019-04-09 02:00:10 +0000 (Tue, 09 Apr 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1753-1] proftpd-dfsg security update)");
  ...
  package(s) announced via the DSA-1753-1 advisory.");
