...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1890-1] kde4libs security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/08/msg00023.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1890-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/934268");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kde4libs'
  package(s) announced via the DSA-1890-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Dominik Penner discovered a flaw in how KConfig interpreted shell
...
removed.");
  ...
  script_tag(name:"affected", value:"'kde4libs' package(s) on Debian Linux.");
