...
if(description)
{
  ...
  script_version("2019-09-14T02:00:07+0000");
  script_cve_id("CVE-2019-5482");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-09-14 02:00:07 +0000 (Sat, 14 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-14 02:00:07 +0000 (Sat, 14 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1917-1] curl security update)");
  ...
  package(s) announced via the DSA-1917-1 advisory.");
