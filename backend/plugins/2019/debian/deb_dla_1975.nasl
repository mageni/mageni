...
if(description)
{
  ...
  script_version("2019-10-29T03:00:22+0000");
  script_cve_id("CVE-2019-16391", "CVE-2019-16392", "CVE-2019-16393", "CVE-2019-16394");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-10-29 03:00:22 +0000 (Tue, 29 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-29 03:00:22 +0000 (Tue, 29 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1975-1] spip security update)");
  ...
  package(s) announced via the DSA-1975-1 advisory.");
