...
if(description)
{
  ...
  script_version("2019-12-18T03:00:49+0000");
  script_cve_id("CVE-2017-11333", "CVE-2017-14633");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-12-18 03:00:49 +0000 (Wed, 18 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-18 03:00:49 +0000 (Wed, 18 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2039-1] libvorbis security update)");
  ...
  package(s) announced via the DSA-2039-1 advisory.");
