...
if(description)
{
  ...
  script_version("2019-10-04T02:00:07+0000");
  script_cve_id("CVE-2019-12412");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-10-04 02:00:07 +0000 (Fri, 04 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-04 02:00:07 +0000 (Fri, 04 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1944-1] libapreq2 security update)");
  ...
  package(s) announced via the DSA-1944-1 advisory.");
