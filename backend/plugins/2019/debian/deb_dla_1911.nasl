...
if(description)
{
  ...
  script_version("2019-09-07T02:00:20+0000");
  script_cve_id("CVE-2019-15846");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-09-07 02:00:20 +0000 (Sat, 07 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-07 02:00:20 +0000 (Sat, 07 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1911-1] exim4 security update)");
  ...
  package(s) announced via the DSA-1911-1 advisory.");
