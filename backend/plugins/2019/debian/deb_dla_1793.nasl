...
if(description)
{
  ...
  script_version("2019-05-20T02:00:10+0000");
  script_cve_id("CVE-2019-11579");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-05-20 02:00:10 +0000 (Mon, 20 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-20 02:00:10 +0000 (Mon, 20 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1793-1] dhcpcd5 security update)");
  ...
  package(s) announced via the DSA-1793-1 advisory.");
