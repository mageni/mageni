...
if(description)
{
  ...
  script_version("2019-08-08T02:00:06+0000");
  script_cve_id("CVE-2019-12815");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-08-08 02:00:06 +0000 (Thu, 08 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-08 02:00:06 +0000 (Thu, 08 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1873-1] proftpd-dfsg security update)");
  ...
  package(s) announced via the DSA-1873-1 advisory.");
