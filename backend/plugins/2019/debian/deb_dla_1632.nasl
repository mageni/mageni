...
# $Id: deb_dla_1632.nasl 14274 2019-03-18 14:38:37Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/01/msg00008.html");
...
We recommend that you upgrade your libsndfile packages.");
  script_tag(name:"summary", value:"heap-buffer-overflow vulnerability was discovered in libsndfile, the
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsndfile1", ver:"1.0.25-9.1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsndfile1-dbg", ver:"1.0.25-9.1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsndfile1-dev", ver:"1.0.25-9.1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sndfile-programs", ver:"1.0.25-9.1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sndfile-programs-dbg", ver:"1.0.25-9.1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
