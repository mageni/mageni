...
if(description)
{
  ...
  script_version("2019-05-07T02:00:12+0000");
  script_cve_id("CVE-2019-3883");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-07 02:00:12 +0000 (Tue, 07 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-07 02:00:12 +0000 (Tue, 07 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1779-1] 389-ds-base security update)");
  ...
  package(s) announced via the DSA-1779-1 advisory.");
