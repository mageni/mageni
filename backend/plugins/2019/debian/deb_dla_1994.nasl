...
if(description)
{
  ...
  script_version("2019-11-26T12:49:48+0000");
  script_cve_id("CVE-2019-3466");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-26 12:49:48 +0000 (Tue, 26 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-26 12:49:48 +0000 (Tue, 26 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA-1994-1] postgresql-common security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1994-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-common'
  package(s) announced via the DSA-1994-1 advisory.");
...
could result in local privilege escalation.");
  ...
  script_tag(name:"solution", value:"For the Debian 8 'Jessie', this problem has been fixed
