...
if(description)
{
  ...
  script_version("2019-11-30T03:00:19+0000");
  script_cve_id("CVE-2019-14824");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-30 03:00:19 +0000 (Sat, 30 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-30 03:00:19 +0000 (Sat, 30 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2004-1] 389-ds-base security update)");
  ...
  package(s) announced via the DSA-2004-1 advisory.");
