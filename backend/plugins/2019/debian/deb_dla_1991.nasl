...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1991-1] libssh2 security update)");
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1991-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/943562");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh2'
  package(s) announced via the DSA-1991-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In libssh2, SSH_MSG_DISCONNECT logic in packet.c has an integer
