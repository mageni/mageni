...
if(description)
{
  ...
  script_version("2019-06-07T02:00:09+0000");
  script_cve_id("CVE-2019-10872", "CVE-2019-12293", "CVE-2019-12360");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-06-07 02:00:09 +0000 (Fri, 07 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-07 02:00:09 +0000 (Fri, 07 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1815-1] poppler security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/06/msg00002.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1815-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'poppler'
  package(s) announced via the DSA-1815-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities have been found in the poppler PDF rendering
