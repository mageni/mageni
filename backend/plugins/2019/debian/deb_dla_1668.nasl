...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1668-1] libarchive security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"bsdcpio", ver:"3.1.2-11+deb8u7", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bsdtar", ver:"3.1.2-11+deb8u7", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libarchive-dev", ver:"3.1.2-11+deb8u7", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libarchive13", ver:"3.1.2-11+deb8u7", rls:"DEB8")) != NULL) {
  report += res;
}
