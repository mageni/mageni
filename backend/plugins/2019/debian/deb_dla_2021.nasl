...
if(description)
{
  ...
  script_version("2019-12-06T03:00:15+0000");
  ...
  script_tag(name:"last_modification", value:"2019-12-06 03:00:15 +0000 (Fri, 06 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-06 03:00:15 +0000 (Fri, 06 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2021-1] libav security update)");
  ...
  package(s) announced via the DSA-2021-1 advisory.");
