...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libsox-dev", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-all", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-alsa", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-ao", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-base", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-mp3", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-oss", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox-fmt-pulse", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libsox2", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sox", ver:"14.4.1-5+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
