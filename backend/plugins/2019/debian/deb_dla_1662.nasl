...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1662-1] libthrift-java security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libthrift-java", ver:"0.9.1-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
