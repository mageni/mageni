...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/06/msg00025.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1837-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/930387");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rdesktop'
  package(s) announced via the DSA-1837-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities were discovered in the rdesktop RDP
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"rdesktop", ver:"1.8.6-0+deb8u1", rls:"DEB8"))) {
  report += res;
}
