...
if(description)
{
  ...
  script_version("2019-06-01T09:22:33+0000");
  script_cve_id("CVE-2019-0221");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-06-01 09:22:33 +0000 (Sat, 01 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-01 09:22:33 +0000 (Sat, 01 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1810-1] tomcat7 security update)");
  ...
  package(s) announced via the DSA-1810-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Nightwatch Cybersecurity Research team identified a XSS vulnerability
