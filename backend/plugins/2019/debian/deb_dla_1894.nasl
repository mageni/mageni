...
if(description)
{
  ...
  script_version("2019-08-24T02:00:07+0000");
  script_cve_id("CVE-2019-1010247");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-08-24 02:00:07 +0000 (Sat, 24 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-24 02:00:07 +0000 (Sat, 24 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1894-1] libapache2-mod-auth-openidc security)");
  ...
  package(s) announced via the DSA-1894-1 advisory.");
