...
if(description)
{
  ...
  script_version("2019-12-23T03:00:08+0000");
  script_cve_id("CVE-2019-2228");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-12-23 03:00:08 +0000 (Mon, 23 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-23 03:00:08 +0000 (Mon, 23 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2047-1] cups security update)");
  ...
  package(s) announced via the DSA-2047-1 advisory.");
