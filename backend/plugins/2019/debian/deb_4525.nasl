...
if(description)
{
  ...
  script_version("2019-09-19T02:00:05+0000");
  script_cve_id("CVE-2019-14822");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-09-19 02:00:05 +0000 (Thu, 19 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-19 02:00:05 +0000 (Thu, 19 Sep 2019)");
  script_name("Debian Security Advisory DSA 4525-1 (ibus - security update)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4525.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4525-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ibus'
  package(s) announced via the DSA-4525-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Simon McVittie reported a flaw in ibus, the Intelligent Input Bus. Due
...
configurations through DBus method calls.");
  ...
  script_tag(name:"affected", value:"'ibus' package(s) on Debian Linux.");
