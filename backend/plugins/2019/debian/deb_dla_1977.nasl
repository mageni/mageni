...
if(description)
{
  ...
  script_version("2019-10-31T03:00:09+0000");
  script_cve_id("CVE-2019-15681");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-10-31 03:00:09 +0000 (Thu, 31 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-31 03:00:09 +0000 (Thu, 31 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1977-1] libvncserver security update)");
  ...
  package(s) announced via the DSA-1977-1 advisory.");
