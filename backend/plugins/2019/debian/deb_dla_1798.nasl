...
if(description)
{
  ...
  script_version("2019-05-22T02:00:06+0000");
  script_cve_id("CVE-2019-12086");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-05-22 02:00:06 +0000 (Wed, 22 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-22 02:00:06 +0000 (Wed, 22 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1798-1] jackson-databind security update)");
  ...
  package(s) announced via the DSA-1798-1 advisory.");
