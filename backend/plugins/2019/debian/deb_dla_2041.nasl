...
if(description)
{
  ...
  script_version("2019-12-19T03:00:07+0000");
  script_cve_id("CVE-2019-3467");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-12-19 03:00:07 +0000 (Thu, 19 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-19 03:00:07 +0000 (Thu, 19 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2041-1] debian-edu-config security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00023.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2041-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/946797");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'debian-edu-config'
  package(s) announced via the DSA-2041-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that debian-edu-config, the package containing the
