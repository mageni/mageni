...
if(description)
{
  ...
  script_version("2019-09-17T02:00:21+0000");
  script_cve_id("CVE-2019-16275");
  script_tag(name:"cvss_base", value:"3.3");
  script_tag(name:"cvss_base_vector", value:"AV:A/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-09-17 02:00:21 +0000 (Tue, 17 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-17 02:00:21 +0000 (Tue, 17 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1922-1] wpa security update)");
  ...
  package(s) announced via the DSA-1922-1 advisory.");
