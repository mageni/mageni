...
if(description)
{
  ...
  script_version("2019-10-28T03:00:11+0000");
  script_cve_id("CVE-2019-18197");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-10-28 03:00:11 +0000 (Mon, 28 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-28 03:00:11 +0000 (Mon, 28 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1973-1] libxslt security update)");
  ...
  package(s) announced via the DSA-1973-1 advisory.");
