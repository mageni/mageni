...
if(description)
{
  ...
  script_version("2019-04-15T09:29:08+0000");
  script_tag(name:"last_modification", value:"2019-04-15 09:29:08 +0000 (Mon, 15 Apr 2019)");
...
if( version_is_less( version: version, test_version: "3.9.5" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "3.9.5" );
