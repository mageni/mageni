...
# $Id: gb_apache_httpd_modssl_dos_vuln_lin.nasl 13547 2019-02-08 15:53:13Z cfischer $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.141962");
  script_version("$Revision: 13547 $");
  script_tag(name:"last_modification", value:"$Date: 2019-02-08 16:53:13 +0100 (Fri, 08 Feb 2019) $");
  script_tag(name:"creation_date", value:"2019-02-05 13:20:11 +0700 (Tue, 05 Feb 2019)");
  ...
  script_name("Apache HTTP Server 2.4.37 mod_ssl DoS Vulnerability (Linux)");
