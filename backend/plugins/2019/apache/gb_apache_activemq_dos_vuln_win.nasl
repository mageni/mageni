...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.142372");
  script_version("2019-05-06T11:28:02+0000");
  script_tag(name:"last_modification", value:"2019-05-06 11:28:02 +0000 (Mon, 06 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-06 11:27:14 +0000 (Mon, 06 May 2019)");
  ...
  script_name("Apache ActiveMQ < 5.15.9 DoS Vulnerability - Windows");
...
if (version_in_range(version: version, test_version: "5.0.0", test_version2: "5.15.8")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.15.9", install_path: path);
