...
if (description)
{
  ...
  script_version("2019-04-10T11:42:27+0000");
  script_tag(name:"last_modification", value:"2019-04-10 11:42:27 +0000 (Wed, 10 Apr 2019)");
  ...
  script_name("Open-Xchange (OX) AppSuite Access Control Vulnerability (61315)");
  ...
  script_tag(name:"solution", value:"Update to version 7.8.3-rev53, 7.8.4-rev51, 7.10.0-rev25, 7.10.1-rev7 or
  later.");
