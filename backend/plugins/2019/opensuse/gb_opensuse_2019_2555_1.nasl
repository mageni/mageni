...
if(description)
{
  ...
  script_name("openSUSE Update for haproxy openSUSE-SU-2019:2555-1 (haproxy)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00060.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'haproxy'
  package(s) announced via the openSUSE-SU-2019:2555_1 advisory.");
