...
if(description)
{
  ...
  script_name("openSUSE Update for libgcrypt openSUSE-SU-2019:2161-1 (libgcrypt)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00060.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgcrypt'
  package(s) announced via the openSUSE-SU-2019:2161_1 advisory.");
