...
if(description)
{
  ...
  script_name("openSUSE Update for python-Twisted openSUSE-SU-2019:1760-1 (python-Twisted)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00030.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-Twisted'
  package(s) announced via the openSUSE-SU-2019:1760_1 advisory.");
