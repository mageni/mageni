...
if(description)
{
  ...
  script_name("openSUSE Update for openssl-1_1 openSUSE-SU-2019:1147-1 (openssl-1_1)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00027.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl-1_1'
  package(s) announced via the openSUSE-SU-2019:1147_1 advisory.");
