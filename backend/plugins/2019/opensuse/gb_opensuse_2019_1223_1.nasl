...
if(description)
{
  ...
  script_name("openSUSE Update for SDL openSUSE-SU-2019:1223-1 (SDL)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00073.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'SDL'
  package(s) announced via the openSUSE-SU-2019:1223_1 advisory.");
