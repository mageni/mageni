...
if(description)
{
  ...
  script_name("openSUSE Update for audiofile openSUSE-SU-2019:1260-1 (audiofile)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00087.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'audiofile'
  package(s) announced via the openSUSE-SU-2019:1260_1 advisory.");
