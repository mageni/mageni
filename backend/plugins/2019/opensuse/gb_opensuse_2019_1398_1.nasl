...
if(description)
{
  ...
  script_name("openSUSE Update for bzip2 openSUSE-SU-2019:1398-1 (bzip2)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00035.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bzip2'
  package(s) announced via the openSUSE-SU-2019:1398_1 advisory.");
