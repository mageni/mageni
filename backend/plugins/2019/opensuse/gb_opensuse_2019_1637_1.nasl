...
if(description)
{
  ...
  script_name("openSUSE Update for compat-openssl098 openSUSE-SU-2019:1637-1 (compat-openssl098)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00080.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'compat-openssl098'
  package(s) announced via the openSUSE-SU-2019:1637_1 advisory.");
