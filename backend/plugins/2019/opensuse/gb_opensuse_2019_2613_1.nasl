...
if(description)
{
  ...
  script_name("openSUSE Update for libidn2 openSUSE-SU-2019:2613-1 (libidn2)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-12/msg00008.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libidn2'
  package(s) announced via the openSUSE-SU-2019:2613_1 advisory.");
