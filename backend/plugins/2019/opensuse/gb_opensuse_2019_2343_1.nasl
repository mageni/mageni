...
if(description)
{
  ...
  script_name("openSUSE Update for libpcap openSUSE-SU-2019:2343-1 (libpcap)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00052.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpcap'
  package(s) announced via the openSUSE-SU-2019:2343_1 advisory.");
