...
if(description)
{
  ...
  script_name("openSUSE Update for samba openSUSE-SU-2019:2458-1 (samba)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00015.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the openSUSE-SU-2019:2458_1 advisory.");
