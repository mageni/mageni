...
if(description)
{
  ...
  script_name("openSUSE Update for glibc openSUSE-SU-2019:1250-1 (glibc)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00082.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc'
  package(s) announced via the openSUSE-SU-2019:1250_1 advisory.");
