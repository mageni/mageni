...
if(description)
{
  ...
  script_name("openSUSE Update for fence-agents openSUSE-SU-2019:1719-1 (fence-agents)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00016.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fence-agents'
  package(s) announced via the openSUSE-SU-2019:1719_1 advisory.");
