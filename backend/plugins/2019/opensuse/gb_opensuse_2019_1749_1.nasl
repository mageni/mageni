...
if(description)
{
  ...
  script_name("openSUSE Update for glib2 openSUSE-SU-2019:1749-1 (glib2)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00022.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2'
  package(s) announced via the openSUSE-SU-2019:1749_1 advisory.");
