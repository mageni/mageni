...
if(description)
{
  ...
  script_name("openSUSE Update for djvulibre openSUSE-SU-2019:2217-1 (djvulibre)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00086.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the openSUSE-SU-2019:2217_1 advisory.");
