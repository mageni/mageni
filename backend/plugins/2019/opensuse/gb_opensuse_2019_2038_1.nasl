...
if(description)
{
  ...
  script_name("openSUSE Update for flatpak openSUSE-SU-2019:2038-1 (flatpak)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00088.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'flatpak'
  package(s) announced via the openSUSE-SU-2019:2038_1 advisory.");
