...
if(description)
{
  ...
  script_name("openSUSE Update for libmediainfo openSUSE-SU-2019:1629-1 (libmediainfo)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00069.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmediainfo'
  package(s) announced via the openSUSE-SU-2019:1629_1 advisory.");
