...
if(description)
{
  ...
  script_name("openSUSE Update for SDL2_image openSUSE-SU-2019:2070-1 (SDL2_image)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00012.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'SDL2_image'
  package(s) announced via the openSUSE-SU-2019:2070_1 advisory.");
