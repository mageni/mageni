...
if(description)
{
  ...
  script_name("openSUSE Update for webkit2gtk3 openSUSE-SU-2019:2207-1 (webkit2gtk3)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00083.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk3'
  package(s) announced via the openSUSE-SU-2019:2207_1 advisory.");
