...
if(description)
{
  ...
  script_name("openSUSE Update for expat openSUSE-SU-2019:1777-1 (expat)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00039.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the openSUSE-SU-2019:1777_1 advisory.");
