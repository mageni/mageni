...
if(description)
{
  ...
  script_name("openSUSE Update for putty openSUSE-SU-2019:1113-1 (putty)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00004.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'putty'
  package(s) announced via the openSUSE-SU-2019:1113_1 advisory.");
