...
if(description)
{
  ...
  script_name("openSUSE Update for vim openSUSE-SU-2019:1562-1 (vim)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00036.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the openSUSE-SU-2019:1562_1 advisory.");
