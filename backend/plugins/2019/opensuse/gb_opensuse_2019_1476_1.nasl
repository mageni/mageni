...
if(description)
{
  ...
  script_name("openSUSE Update for bluez openSUSE-SU-2019:1476-1 (bluez)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00069.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bluez'
  package(s) announced via the openSUSE-SU-2019:1476_1 advisory.");
