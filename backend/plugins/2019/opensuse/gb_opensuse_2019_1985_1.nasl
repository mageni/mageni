...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.852676");
  ...
  script_tag(name:"creation_date", value:"2019-08-22 02:01:52 +0000 (Thu, 22 Aug 2019)");
  script_name("openSUSE Update for Recommended openSUSE-SU-2019:1985-1 (Recommended)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00070.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Recommended'
  package(s) announced via the openSUSE-SU-2019:1985_1 advisory.");
...
if(release == "openSUSELeap15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"putty", rpm:"putty~0.72~lp150.15.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"putty-debuginfo", rpm:"putty-debuginfo~0.72~lp150.15.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"putty-debugsource", rpm:"putty-debugsource~0.72~lp150.15.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
