...
if(description)
{
  ...
  script_name("openSUSE Update for openssl-1_1 openSUSE-SU-2019:2189-1 (openssl-1_1)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00072.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl-1_1'
  package(s) announced via the openSUSE-SU-2019:2189_1 advisory.");
