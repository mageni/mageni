...
if(description)
{
  ...
  script_name("openSUSE Update for squid openSUSE-SU-2019:1963-1 (squid)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00067.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid'
  package(s) announced via the openSUSE-SU-2019:1963_1 advisory.");
