...
if(description)
{
  ...
  script_name("openSUSE Update for ntp openSUSE-SU-2019:1143-1 (ntp)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00032.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp'
  package(s) announced via the openSUSE-SU-2019:1143_1 advisory.");
