...
if(description)
{
  ...
  script_name("openSUSE Update for dbus-1 openSUSE-SU-2019:1671-1 (dbus-1)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00092.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dbus-1'
  package(s) announced via the openSUSE-SU-2019:1671_1 advisory.");
