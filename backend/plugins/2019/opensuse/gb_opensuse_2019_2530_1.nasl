...
if(description)
{
  ...
  script_name("openSUSE Update for libjpeg-turbo openSUSE-SU-2019:2530-1 (libjpeg-turbo)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00048.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libjpeg-turbo'
  package(s) announced via the openSUSE-SU-2019:2530_1 advisory.");
