...
if(description)
{
  ...
  script_name("openSUSE Update for nodejs10 openSUSE-SU-2019:2114-1 (nodejs10)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00032.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs10'
  package(s) announced via the openSUSE-SU-2019:2114_1 advisory.");
