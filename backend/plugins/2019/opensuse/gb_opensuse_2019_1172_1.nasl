...
if(description)
{
  ...
  script_name("openSUSE Update for ovmf openSUSE-SU-2019:1172-1 (ovmf)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00048.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ovmf'
  package(s) announced via the openSUSE-SU-2019:1172_1 advisory.");
...
if(release == "openSUSELeap15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86", rpm:"qemu-ovmf-x86~64~2017+git1510945757.b2662641d5~lp150.4.16.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86", rpm:"qemu-ovmf-x86~64~debug~2017+git1510945757.b2662641d5~lp150.4.16.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
