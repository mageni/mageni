...
if(description)
{
  ...
  script_name("openSUSE Update for ghostscript openSUSE-SU-2019:2534-1 (ghostscript)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00049.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript'
  package(s) announced via the openSUSE-SU-2019:2534_1 advisory.");
