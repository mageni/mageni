...
if(description)
{
  ...
  script_name("openSUSE Update for zeromq openSUSE-SU-2019:1767-1 (zeromq)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00033.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zeromq'
  package(s) announced via the openSUSE-SU-2019:1767_1 advisory.");
