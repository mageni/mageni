...
if(description)
{
  ...
  script_name("openSUSE Update for rubygem-actionpack-5_1 openSUSE-SU-2019:1344-1 (rubygem-actionpack-5_1)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00011.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-actionpack-5_1'
  package(s) announced via the openSUSE-SU-2019:1344_1 advisory.");
