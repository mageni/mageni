...
if(description)
{
  ...
  script_name("openSUSE Update for freeradius-server openSUSE-SU-2019:1394-1 (freeradius-server)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00032.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freeradius-server'
  package(s) announced via the openSUSE-SU-2019:1394_1 advisory.");
