...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2798-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-October/006064.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'python3'
  package(s) announced via the SUSE-SU-2019:2798-1 advisory.");
