...
if(description)
{
  ...
  script_cve_id("CVE-2019-1348","CVE-2019-1349","CVE-2019-1350");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:3311-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-December/006258.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'git'
  package(s) announced via the SUSE-SU-2019:3311-1 advisory.");
