...
if(description)
{
  ...
  script_cve_id("CVE-2017-5753","CVE-2018-12232","CVE-2018-14625");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0222-1)");
  ...
  package(s) announced via the SUSE-SU-2019:0222-1 advisory.");
