...
if(description)
{
  ...
  script_cve_id("CVE-2019-3855","CVE-2019-3856","CVE-2019-3857");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0655-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-March/005210.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libssh2_org'
  package(s) announced via the SUSE-SU-2019:0655-1 advisory.");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"libssh2-1", rpm:"libssh2-1~1.4.3~20.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-1-debuginfo", rpm:"libssh2-1-debuginfo~1.4.3~20.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2_org-debugsource", rpm:"libssh2_org-debugsource~1.4.3~20.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-1-32bit", rpm:"libssh2-1-32bit~1.4.3~20.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-1-debuginfo-32bit", rpm:"libssh2-1-debuginfo-32bit~1.4.3~20.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
