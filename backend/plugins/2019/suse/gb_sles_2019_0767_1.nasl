...
if(description)
{
  ...
  script_cve_id("CVE-2018-20669","CVE-2019-2024","CVE-2019-3459");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0767-1)");
  ...
  package(s) announced via the SUSE-SU-2019:0767-1 advisory.");
