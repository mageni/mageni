...
if(description)
{
  ...
  script_cve_id("CVE-2017-18551","CVE-2018-20855","CVE-2018-20856");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2299-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-September/005881.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2019:2299-1 advisory.");
