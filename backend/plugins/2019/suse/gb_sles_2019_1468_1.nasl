...
if(description)
{
  ...
  script_cve_id("CVE-2017-7960","CVE-2017-7961","CVE-2017-8834");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1468-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for 'libcroco'
  package(s) announced via the SUSE-SU-2019:1468-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'libcroco' package(s) on SUSE Linux Enterprise Server 12");
