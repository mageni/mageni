...
if(description)
{
  ...
  script_cve_id("CVE-2019-10894","CVE-2019-10895","CVE-2019-10896");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1038-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-April/005364.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2019:1038-1 advisory.");
