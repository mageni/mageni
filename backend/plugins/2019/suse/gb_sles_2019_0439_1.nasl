...
if(description)
{
  ...
  script_cve_id("CVE-2018-16862","CVE-2018-16884","CVE-2018-18281");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0439-1)");
  ...
  package(s) announced via the SUSE-SU-2019:0439-1 advisory.");
