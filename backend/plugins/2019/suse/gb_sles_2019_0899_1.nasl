...
if(description)
{
  ...
  script_cve_id("CVE-2019-7572","CVE-2019-7573","CVE-2019-7574");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0899-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-April/005311.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'SDL'
  package(s) announced via the SUSE-SU-2019:0899-1 advisory.");
