...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0956-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-April/005343.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wget'
  package(s) announced via the SUSE-SU-2019:0956-1 advisory.");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"wget", rpm:"wget~1.14~21.10.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wget-debuginfo", rpm:"wget-debuginfo~1.14~21.10.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wget-debugsource", rpm:"wget-debugsource~1.14~21.10.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
