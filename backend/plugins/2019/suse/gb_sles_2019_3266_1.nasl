...
if(description)
{
  ...
  script_cve_id("CVE-2018-10811","CVE-2018-16151","CVE-2018-16152");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:3266-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-December/006239.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'strongswan'
  package(s) announced via the SUSE-SU-2019:3266-1 advisory.");
