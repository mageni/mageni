...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815611");
  ...
  script_name("Microsoft .NET Framework Privilege Escalation Vulnerability (KB4514359)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4514359");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4514359");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ## https://support.microsoft.com/en-us/help/4514359
              if(version_in_range(version:dllVer, test_version:"2.0.50727.5700", test_version2:"2.0.50727.9147"))
              {
                vulnerable_range = "2.0.50727.5700 - 2.0.50727.9147" ;
                break;
              }
              ## https://support.microsoft.com/en-us/help/4514359
