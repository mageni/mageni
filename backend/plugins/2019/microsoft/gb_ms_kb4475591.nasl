...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815602");
  ...
  script_name("Microsoft Office 2016 Remote Code Execution Vulnerability (KB4475591)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4475591");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475591");
...
foreach key(key_list)
{
  ...
  if(propath)
  {
    ...
    if(version_is_less(version:offdllVer, test_version:"16.0.4900.1000"))
    {
      report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                 file_version:offdllVer, vulnerable_range:"16.0 - 16.0.4900.0999");
