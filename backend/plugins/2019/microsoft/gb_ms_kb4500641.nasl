...
if(description)
{
  ...
  update according to Microsoft KB4500641.");
  ...
  script_tag(name:"affected", value:"Windows 10 Version 1709 32-bit Systems
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4500641/windows-10-update-kb4500641");
...
if(edgeVer =~ "11\.0\.16299")
{
  ...
  if(max_version && version_is_less(version:max_version, test_version:"10.0.16299.961")) {
    report = report_fixed_ver(file_checked:path, file_version:max_version, vulnerable_range:"Less than 10.0.16299.961");
