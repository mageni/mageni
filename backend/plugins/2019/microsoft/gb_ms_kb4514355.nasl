...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815612");
  ...
  script_name("Microsoft .NET Framework Privilege Escalation Vulnerability (KB4514355)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4514355");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4514355");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ## https://support.microsoft.com/en-us/help/4514355
