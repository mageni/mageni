...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815132");
  ...
  script_name("Microsoft Windows Latest Servicing Stack Updates-Defense in Depth (KB4498353)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4498353.");
  ...
  script_tag(name:"affected", value:"Windows 10 Version 1507 32-bit Systems
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4498353/windows-10-update-kb4498353");
...
if(edgeVer =~ "11\.0\.10240") {
  ...
  if(max_version && version_is_less(version:max_version, test_version:"10.0.10240.17831")) {
