...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815523");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 10:35:17 +0530 (Wed, 14 Aug 2019)");
  script_name("Microsoft Word Remote Code Execution Vulnerability (KB4475540)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4475540");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475540");
...
if(version_in_range(version:exeVer, test_version:"16.0", test_version2:"16.0.4888.0999"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"16.0 - 16.0.4888.0999");
