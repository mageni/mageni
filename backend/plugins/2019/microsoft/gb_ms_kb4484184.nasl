...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815667");
  ...
  script_name("Microsoft Office 2013 Service Pack 1 Information Disclosure Vulnerability (KB4484184)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484184");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484184");
    ...
    if(msdllVer && msdllVer =~ "^15\.")
    {
      if(version_is_less(version:msdllVer, test_version:"15.0.5197.1000"))
      {
        report = report_fixed_ver( file_checked:offPath + "\graph.exe",
                                   file_version:msdllVer, vulnerable_range:"15.0 - 15.0.5197.0999");
