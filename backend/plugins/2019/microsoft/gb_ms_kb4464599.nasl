...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815194");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 11:30:30 +0530 (Wed, 14 Aug 2019)");
  script_name("Microsoft Office 2013 Service Pack 1 Remote Code Execution Vulnerability (KB4464599)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4464599");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4464599");
...
foreach key(key_list)
{
  ...
  if(msPath)
  {
    ...
    {
      if(version_is_less(version:msdllVer, test_version:"15.0.5163.1000"))
      {
        report = report_fixed_ver( file_checked:offPath + "\aceexcl.dll",
                                   file_version:msdllVer, vulnerable_range:"15.0 - 15.0.5163.0999");
