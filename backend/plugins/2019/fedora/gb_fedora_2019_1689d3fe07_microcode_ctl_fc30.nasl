...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876993");
  ...
  script_tag(name:"creation_date", value:"2019-11-14 03:29:21 +0000 (Thu, 14 Nov 2019)");
  script_name("Fedora Update for microcode_ctl FEDORA-2019-1689d3fe07");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2FH6BQUN32TT6GQDYAAKI7DZNW7W6E3F");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~33.fc30", rls:"FC30"))) {
    report += res;
  }
