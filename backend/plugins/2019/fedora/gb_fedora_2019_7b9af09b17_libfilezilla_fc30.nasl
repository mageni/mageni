...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876560");
  ...
  script_name("Fedora Update for libfilezilla FEDORA-2019-7b9af09b17");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LPQ3OUS2C3NIXCARPY7ELMMGKDQZXFUH");
...
functionality to build high-performing, platform-independent programs.");
  ...
  script_tag(name:"affected", value:"'libfilezilla' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libfilezilla", rpm:"libfilezilla~0.17.1~1.fc30", rls:"FC30"))) {
    report += res;
  }
