...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876448");
  script_version("2019-06-06T13:02:35+0000");
  script_cve_id("CVE-2019-11498", "CVE-2018-19840", "CVE-2018-19841");
  ...
  script_name("Fedora Update for wavpack FEDORA-2019-b8a704ff4b");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SCK2YJXY6V5CKGKSF2PPN7RL2DXVOC6G");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wavpack'
  package(s) announced via the FEDORA-2019-b8a704ff4b advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wavpack", rpm:"wavpack~5.1.0~13.fc29", rls:"FC29"))) {
    report += res;
  }
