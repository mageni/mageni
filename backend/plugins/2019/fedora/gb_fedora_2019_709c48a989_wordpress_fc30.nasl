...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876931");
  ...
  script_tag(name:"creation_date", value:"2019-10-26 02:27:02 +0000 (Sat, 26 Oct 2019)");
  script_name("Fedora Update for wordpress FEDORA-2019-709c48a989");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZKQOSGTBOKAYRDGBAAHUDIPNJVZ3Q32P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2019-709c48a989 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.2.4~1.fc30", rls:"FC30"))) {
    report += res;
  }
