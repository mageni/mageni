...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876700");
  ...
  script_tag(name:"creation_date", value:"2019-08-20 02:24:34 +0000 (Tue, 20 Aug 2019)");
  script_name("Fedora Update for mgetty FEDORA-2019-732b5488c2");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YH7KTF6IB4LZURQHCOICNVE6YDAIHV62");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mgetty'
  package(s) announced via the FEDORA-2019-732b5488c2 advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mgetty", rpm:"mgetty~1.2.1~6.fc29", rls:"FC29"))) {
    report += res;
  }
