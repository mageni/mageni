...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876454");
  ...
  script_name("Fedora Update for sleuthkit FEDORA-2019-61b6dae771");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LZXFYOOMSP7NWRTSO4XXGHXAY3CJNAJ6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sleuthkit'
  package(s) announced via the FEDORA-2019-61b6dae771 advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sleuthkit", rpm:"sleuthkit~4.6.6~1.fc29", rls:"FC29"))) {
    report += res;
  }
