...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5FOR4ADC356JPCHAJI5UXZORLC3VNBPS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pam-u2f'
  package(s) announced via the FEDORA-2019-b6d3c8b0a8 advisory.");
...
authentication infrastructure.");
  ...
  script_tag(name:"affected", value:"'pam-u2f' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pam-u2f", rpm:"pam-u2f~1.0.8~1.fc30", rls:"FC30"))) {
    report += res;
  }
