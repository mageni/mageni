...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877016");
  ...
  script_tag(name:"creation_date", value:"2019-11-17 03:32:52 +0000 (Sun, 17 Nov 2019)");
  script_name("Fedora Update for php-robrichards-xmlseclibs FEDORA-2019-81f61cdceb");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MAWOVYLZKYDCQBLQEJCFAAD3KQTBPHXE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-robrichards-xmlseclibs'
  package(s) announced via the FEDORA-2019-81f61cdceb advisory.");
...
Autoloader: /usr/share/php/RobRichards/XMLSecLibs/autoload.php");
  ...
  script_tag(name:"affected", value:"'php-robrichards-xmlseclibs' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-robrichards-xmlseclibs", rpm:"php-robrichards-xmlseclibs~2.1.1~1.fc29", rls:"FC29"))) {
    report += res;
  }
