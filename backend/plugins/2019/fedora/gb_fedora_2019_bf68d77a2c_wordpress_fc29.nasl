...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875999");
  ...
  script_name("Fedora Update for wordpress FEDORA-2019-bf68d77a2c");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2HEZTXMN4ANLZIY4LL5XF2XEU6DYXCBU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2019-bf68d77a2c advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.1.1~1.fc29", rls:"FC29"))) {
    report += res;
  }
