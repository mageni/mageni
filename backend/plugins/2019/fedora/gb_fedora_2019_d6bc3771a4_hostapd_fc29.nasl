...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876642");
  ...
  script_tag(name:"creation_date", value:"2019-08-09 02:18:28 +0000 (Fri, 09 Aug 2019)");
  script_name("Fedora Update for hostapd FEDORA-2019-d6bc3771a4");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DJKZHAT5KPUN26JL77EUH563GAH5XZ5C");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'hostapd'
  package(s) announced via the FEDORA-2019-d6bc3771a4 advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"hostapd", rpm:"hostapd~2.8~1.fc29", rls:"FC29"))) {
    report += res;
  }
