...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876080");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2018-3258");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-07 02:33:53 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for mysql-connector-java FEDORA-2018-6b350bb946");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/674XGWEZN7DMLSDLCBXDKKN75BDDFP45");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-connector-java'
  package(s) announced via the FEDORA-2018-6b350bb946 advisory.");
...
capabilities of MySQL.");
  ...
  script_tag(name:"affected", value:"'mysql-connector-java' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mysql-connector-java", rpm:"mysql-connector-java~8.0.13~1.fc29", rls:"FC29"))) {
    report += res;
  }
