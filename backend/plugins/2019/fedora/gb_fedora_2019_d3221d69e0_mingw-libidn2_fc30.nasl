...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876968");
  ...
  script_tag(name:"creation_date", value:"2019-11-04 03:21:20 +0000 (Mon, 04 Nov 2019)");
  script_name("Fedora Update for mingw-libidn2 FEDORA-2019-d3221d69e0");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MINU5RKDFE6TKAFY5DRFN3WSFDS4DYVS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-libidn2'
  package(s) announced via the FEDORA-2019-d3221d69e0 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-libidn2", rpm:"mingw-libidn2~2.2.0~1.fc30", rls:"FC30"))) {
    report += res;
  }
