...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875717");
  ...
  script_name("Fedora Update for wordpress FEDORA-2018-25b3204dc8");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P4OFE7XNSBM7RCG24KPXRZT3A55Q5SZI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2018-25b3204dc8 advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.0.2~1.fc29", rls:"FC29"))) {
    report += res;
  }
