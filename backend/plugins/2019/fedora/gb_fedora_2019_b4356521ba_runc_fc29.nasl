...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875847");
  ...
  script_name("Fedora Update for runc FEDORA-2019-b4356521ba");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SMFQ54VEZPJT4H2C2TBILCPDX2VMAIZ2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc'
  package(s) announced via the FEDORA-2019-b4356521ba advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.0.0~67.dev.git12f6a99.fc29", rls:"FC29"))) {
    report += res;
  }
