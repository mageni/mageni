...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876837");
  ...
  script_tag(name:"creation_date", value:"2019-09-23 02:28:24 +0000 (Mon, 23 Sep 2019)");
  script_name("Fedora Update for jackson-annotations FEDORA-2019-ae6a703b8f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5XEXBN53BYTEL7RKA2OOMSQONMFIVRU3");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jackson-annotations", rpm:"jackson-annotations~2.9.9~1.fc30", rls:"FC30"))) {
    report += res;
  }
