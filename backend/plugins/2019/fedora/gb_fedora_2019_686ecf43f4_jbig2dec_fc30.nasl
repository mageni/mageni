...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876802");
  ...
  script_name("Fedora Update for jbig2dec FEDORA-2019-686ecf43f4");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SMTUT4OKZ2FGY26TCJTNOVJDC72BQSZS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jbig2dec'
  package(s) announced via the FEDORA-2019-686ecf43f4 advisory.");
...
ratios on the order of 100:1.");
  ...
  script_tag(name:"affected", value:"'jbig2dec' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jbig2dec", rpm:"jbig2dec~0.16~1.fc30", rls:"FC30"))) {
    report += res;
  }
