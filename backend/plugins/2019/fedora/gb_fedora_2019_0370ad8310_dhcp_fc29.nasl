...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876460");
  ...
  script_name("Fedora Update for dhcp FEDORA-2019-0370ad8310");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CO42JSXTUC3QDLEEZJZDG2BNGDYUJZF7");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.3.6~31.fc29", rls:"FC29"))) {
    report += res;
  }
