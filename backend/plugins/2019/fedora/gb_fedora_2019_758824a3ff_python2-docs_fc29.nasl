...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876978");
  ...
  script_tag(name:"creation_date", value:"2019-11-10 03:24:32 +0000 (Sun, 10 Nov 2019)");
  script_name("Fedora Update for python2-docs FEDORA-2019-758824a3ff");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/COATURTCY7G67AYI6UDV5B2JZTBCKIDX");
...
for the Python 2 language.");
  ...
  script_tag(name:"affected", value:"'python2-docs' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-docs", rpm:"python2-docs~2.7.17~1.fc29", rls:"FC29"))) {
    report += res;
  }
