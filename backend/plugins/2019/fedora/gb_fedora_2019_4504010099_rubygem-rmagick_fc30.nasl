...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877065");
  ...
  script_name("Fedora Update for rubygem-rmagick FEDORA-2019-4504010099");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6P33PX6CGHA7AFAO7PGKXHOT456JAQ4C");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-rmagick", rpm:"rubygem-rmagick~2.16.0~27.fc30", rls:"FC30"))) {
    report += res;
  }
