...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876953");
  ...
  script_tag(name:"creation_date", value:"2019-10-30 03:35:44 +0000 (Wed, 30 Oct 2019)");
  script_name("Fedora Update for proftpd FEDORA-2019-ae019c7e9f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NJDQRVZTILBX4BUCTIRKP2WBHDHDCJR5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'proftpd'
  package(s) announced via the FEDORA-2019-ae019c7e9f advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"proftpd", rpm:"proftpd~1.3.6b~1.fc29", rls:"FC29"))) {
    report += res;
  }
