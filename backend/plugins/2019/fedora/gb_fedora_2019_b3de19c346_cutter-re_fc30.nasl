...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876897");
  ...
  script_tag(name:"creation_date", value:"2019-10-12 02:30:17 +0000 (Sat, 12 Oct 2019)");
  script_name("Fedora Update for cutter-re FEDORA-2019-b3de19c346");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MGA2PVBFA6VPWWLMBGWVBESHAJBQ7OXJ");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cutter-re", rpm:"cutter-re~1.9.0~1.fc30", rls:"FC30"))) {
    report += res;
  }
