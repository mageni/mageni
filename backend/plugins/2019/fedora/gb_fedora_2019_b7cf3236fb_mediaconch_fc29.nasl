...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876409");
  ...
  script_tag(name:"creation_date", value:"2019-05-26 02:12:04 +0000 (Sun, 26 May 2019)");
  script_name("Fedora Update for mediaconch FEDORA-2019-b7cf3236fb");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NJYASICJ2VUUNGHDBB62FGYQN2SNITM5");
...
This package includes the command line interface.");
  ...
  script_tag(name:"affected", value:"'mediaconch' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mediaconch", rpm:"mediaconch~18.03.2~7.fc29", rls:"FC29"))) {
    report += res;
  }
