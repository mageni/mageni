...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876691");
  ...
  script_name("Fedora Update for mariadb-connector-c FEDORA-2019-60befaed69");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/236B5KMZZEFAFIRHPWVMGAQK3LCWVCW7");
...
developed in C/C++ to MariaDB and MySQL databases.");
  ...
  script_tag(name:"affected", value:"'mariadb-connector-c' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb-connector-c", rpm:"mariadb-connector-c~3.1.3~1.fc30", rls:"FC30"))) {
    report += res;
  }
