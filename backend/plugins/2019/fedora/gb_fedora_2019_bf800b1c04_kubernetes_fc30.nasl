...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876521");
  ...
  script_name("Fedora Update for kubernetes FEDORA-2019-bf800b1c04");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BPV2RE5RMOGUVP5WJMXKQJZUBBLAFZPZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes'
  package(s) announced via the FEDORA-2019-bf800b1c04 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes", rpm:"kubernetes~1.13.5~1.fc30", rls:"FC30"))) {
    report += res;
  }
