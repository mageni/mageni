...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876695");
  script_version("2019-08-20T10:47:01+0000");
  script_cve_id("CVE-2019-13377", "CVE-2019-9494", "CVE-2019-9495", "CVE-2019-9496", "CVE-2019-9497", "CVE-2019-9498", "CVE-2019-9499");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-08-20 10:47:01 +0000 (Tue, 20 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-20 02:24:21 +0000 (Tue, 20 Aug 2019)");
  script_name("Fedora Update for hostapd FEDORA-2019-97e9040197");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IELLEPIXWQOJFW4SZMU3WQHO63JFAHA4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'hostapd'
  package(s) announced via the FEDORA-2019-97e9040197 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"hostapd", rpm:"hostapd~2.9~1.fc30", rls:"FC30"))) {
    report += res;
  }
