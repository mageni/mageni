...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876312");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2019-3825");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-07 02:43:59 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for gdm FEDORA-2019-caab5920f2");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LTST2DR6AX72XV76ZQCXME5PVKYDUVJK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdm'
  package(s) announced via the FEDORA-2019-caab5920f2 advisory.");
...
server on behalf of the session.");
  ...
  script_tag(name:"affected", value:"'gdm' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdm", rpm:"gdm~3.30.3~1.fc29", rls:"FC29"))) {
    report += res;
  }
