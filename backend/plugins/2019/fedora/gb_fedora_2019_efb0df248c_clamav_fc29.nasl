...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876684");
  ...
  script_name("Fedora Update for clamav FEDORA-2019-efb0df248c");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2WUJETP4BMLFAHNTLKQUBSFHEVA4CKLI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav'
  package(s) announced via the FEDORA-2019-efb0df248c advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav", rpm:"clamav~0.101.3~1.fc29", rls:"FC29"))) {
    report += res;
  }
