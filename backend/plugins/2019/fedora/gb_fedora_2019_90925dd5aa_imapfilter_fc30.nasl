...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877046");
  ...
  script_tag(name:"creation_date", value:"2019-11-30 03:38:58 +0000 (Sat, 30 Nov 2019)");
  script_name("Fedora Update for imapfilter FEDORA-2019-90925dd5aa");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IQUH2TOCNEST7JB2RJVVJT3RZS5XZCFZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'imapfilter'
  package(s) announced via the FEDORA-2019-90925dd5aa advisory.");
...
protocol are supported.");
  ...
  script_tag(name:"affected", value:"'imapfilter' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"imapfilter", rpm:"imapfilter~2.6.15~1.fc30", rls:"FC30"))) {
    report += res;
  }
