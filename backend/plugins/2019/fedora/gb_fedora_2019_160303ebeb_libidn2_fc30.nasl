...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877079");
  ...
  script_name("Fedora Update for libidn2 FEDORA-2019-160303ebeb");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ONG3GJRRJO35COPGVJXXSZLU4J5Y42AT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libidn2'
  package(s) announced via the FEDORA-2019-160303ebeb advisory.");
...
(IDN). It is a standalone library, without any dependency on libidn.");
  ...
  script_tag(name:"affected", value:"'libidn2' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libidn2", rpm:"libidn2~2.3.0~1.fc30", rls:"FC30"))) {
    report += res;
  }
