...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876692");
  ...
  script_name("Fedora Update for mariadb-connector-odbc FEDORA-2019-f873e2799f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/44DMMTKIP2SA6RYT7N34TI7WLBT6Q5TO");
...
and it supports both Unicode and ANSI modes.");
  ...
  script_tag(name:"affected", value:"'mariadb-connector-odbc' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb-connector-odbc", rpm:"mariadb-connector-odbc~3.1.2~1.fc29", rls:"FC29"))) {
    report += res;
  }
