...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876793");
  ...
  script_tag(name:"creation_date", value:"2019-09-15 02:22:05 +0000 (Sun, 15 Sep 2019)");
  script_name("Fedora Update for bind-dyndb-ldap FEDORA-2019-d04f66e595");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5SHJKX3L5NJSAXT6PHWBCIHHLTU7NUTH");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bind-dyndb-ldap", rpm:"bind-dyndb-ldap~11.1~19.fc29", rls:"FC29"))) {
    report += res;
  }
