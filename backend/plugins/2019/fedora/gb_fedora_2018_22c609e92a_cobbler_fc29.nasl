...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875990");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2018-1000226", "CVE-2018-10931");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-07 02:30:39 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for cobbler FEDORA-2018-22c609e92a");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CXGGLVHVKFFFCKYZIOJ6COUP3SEEJBDG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2018-22c609e92a advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~2.8.4~5.fc29", rls:"FC29"))) {
    report += res;
  }
