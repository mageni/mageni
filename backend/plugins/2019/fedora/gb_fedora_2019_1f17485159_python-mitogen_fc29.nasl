...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876746");
  ...
  script_tag(name:"creation_date", value:"2019-09-05 02:25:43 +0000 (Thu, 05 Sep 2019)");
  script_name("Fedora Update for python-mitogen FEDORA-2019-1f17485159");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RRXY6JHRIC43CANYJ7LZ7NVJZJFKHBXC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-mitogen'
  package(s) announced via the FEDORA-2019-1f17485159 advisory.");
...
with exotic connection methods such as WMI, telnet, or console-over-IPMI.");
  ...
  script_tag(name:"affected", value:"'python-mitogen' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-mitogen", rpm:"python-mitogen~0.2.8~1.fc29", rls:"FC29"))) {
    report += res;
  }
