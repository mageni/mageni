...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876926");
  ...
  script_name("Fedora Update for java-11-openjdk FEDORA-2019-f36ac0db92");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UTW7H7ML5RO6WUYBEVOMPGSALGLM7D3D");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openjdk'
  package(s) announced via the FEDORA-2019-f36ac0db92 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk", rpm:"java-11-openjdk~11.0.5.10~0.fc30", rls:"FC30"))) {
    report += res;
  }
