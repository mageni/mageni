...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876590");
  ...
  script_name("Fedora Update for freetds FEDORA-2019-14d102033e");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ABH7AV5DCQT3EQQUGV63GHHCMTZ5LHDK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freetds'
  package(s) announced via the FEDORA-2019-14d102033e advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freetds", rpm:"freetds~1.1.11~1.fc29", rls:"FC29"))) {
    report += res;
  }
