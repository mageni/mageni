...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877064");
  ...
  script_tag(name:"creation_date", value:"2019-12-08 03:30:41 +0000 (Sun, 08 Dec 2019)");
  script_name("Fedora Update for cyrus-imapd FEDORA-2019-393e1cef4d");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PHV3TUU53WCKJ3BBRK2EHAF44MSZEFK6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cyrus-imapd'
  package(s) announced via the FEDORA-2019-393e1cef4d advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cyrus-imapd", rpm:"cyrus-imapd~3.0.12~1.fc30", rls:"FC30"))) {
    report += res;
  }
