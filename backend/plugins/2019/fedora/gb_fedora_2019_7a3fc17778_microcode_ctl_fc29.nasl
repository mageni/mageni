...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876998");
  ...
  script_tag(name:"creation_date", value:"2019-11-14 03:30:24 +0000 (Thu, 14 Nov 2019)");
  script_name("Fedora Update for microcode_ctl FEDORA-2019-7a3fc17778");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/F3QG6NFCCY4HS7F4XK63OUOZXOEE6AJP");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~33.fc29", rls:"FC29"))) {
    report += res;
  }
