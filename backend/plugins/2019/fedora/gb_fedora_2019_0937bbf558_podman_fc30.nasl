...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876478");
  ...
  script_tag(name:"creation_date", value:"2019-06-12 02:12:26 +0000 (Wed, 12 Jun 2019)");
  script_name("Fedora Update for podman FEDORA-2019-0937bbf558");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BLTURG4O32BOQUTZSZJFWYWB2T2LRAS3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman'
  package(s) announced via the FEDORA-2019-0937bbf558 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~1.4.0~1.fc30", rls:"FC30"))) {
    report += res;
  }
