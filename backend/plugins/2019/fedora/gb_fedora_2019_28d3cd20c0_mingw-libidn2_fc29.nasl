...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877042");
  ...
  script_tag(name:"creation_date", value:"2019-11-26 13:36:16 +0000 (Tue, 26 Nov 2019)");
  script_name("Fedora Update for mingw-libidn2 FEDORA-2019-28d3cd20c0");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KXDKYWFV6N2HHVSE67FFDM7G3FEL2ZNE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-libidn2'
  package(s) announced via the FEDORA-2019-28d3cd20c0 advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-libidn2", rpm:"mingw-libidn2~2.3.0~1.fc29", rls:"FC29"))) {
    report += res;
  }
