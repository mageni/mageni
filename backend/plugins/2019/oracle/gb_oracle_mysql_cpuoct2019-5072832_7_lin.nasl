...
if (description)
{
  ...
  script_name("Oracle MySQL 5.7.x < 5.7.27, 8.0.x < 8.0.17 Security Update (2019-5072832) - Linux");
  ...
  script_tag(name:"affected", value:"MySQL 5.7.0 - 5.7.26, 8.0.0 - 8.0.16.");
