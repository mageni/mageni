...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815647");
  ...
  script_tag(name:"creation_date", value:"2019-10-16 12:29:53 +0530 (Wed, 16 Oct 2019)");
  script_name("Oracle VirtualBox Security Updates (oct2019-5072832) 02 - Linux");
