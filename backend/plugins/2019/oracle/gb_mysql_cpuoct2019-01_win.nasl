...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143026");
  script_version("2021-02-12T10:44:24+0000");
  script_tag(name:"last_modification", value:"2021-02-15 11:14:46 +0000 (Mon, 15 Feb 2021)");
  script_tag(name:"creation_date", value:"2019-10-23 05:10:47 +0000 (Wed, 23 Oct 2019)");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");

  # nb: From the vendor advisory: The patch for CVE-2019-5443 also addresses CVE-2019-5435 and CVE-2019-5436.
  script_cve_id("CVE-2019-5443", "CVE-2019-2946", "CVE-2019-2914", "CVE-2019-2993", "CVE-2019-2960",
                "CVE-2019-2938", "CVE-2019-5435", "CVE-2019-5436");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 5.7 <= 5.7.27 / 8.0 <= 8.0.17 Security Update (cpuoct2019) - Windows");
