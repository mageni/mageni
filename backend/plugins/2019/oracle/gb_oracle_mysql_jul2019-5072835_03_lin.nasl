...
if (description)
{
  ...
  script_name("Oracle MySQL 5.7.x < 5.7.24 Security Update (2019-5072835) - Linux");
  ...
  script_tag(name:"affected", value:"MySQL 5.7.23 and prior.");
