...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143036");
  script_version("2021-02-12T10:44:24+0000");
  script_tag(name:"last_modification", value:"2021-02-15 11:14:46 +0000 (Mon, 15 Feb 2021)");
  script_tag(name:"creation_date", value:"2019-10-23 06:16:47 +0000 (Wed, 23 Oct 2019)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");

  script_cve_id("CVE-2019-3003", "CVE-2019-2950");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0 <= 8.0.16 Security Update (cpuoct2019) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 8.0 through 8.0.16.");
