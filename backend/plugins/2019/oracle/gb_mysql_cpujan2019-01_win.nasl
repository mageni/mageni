...
if (description)
{
  ...
  # nb: From the vendor advisory: The fix for CVE-2018-0734 also addresses CVE-2018-5407.
  ...
  script_name("Oracle MySQL Server <= 5.6.42 / 5.7 <= 5.7.24 / 8.0 <= 8.0.13 Security Update (cpujan2019) - Windows");
...
if(version_is_less_equal(version: vers, test_version: "5.6.42")) {
