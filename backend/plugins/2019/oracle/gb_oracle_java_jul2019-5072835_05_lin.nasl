...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815184");
  ...
  script_name("Oracle Java SE Security Updates (jul2019-5072835) 05 - Linux");
  ...
  1.8.0 to 1.8.0.212 and 11.0 to 11.0.3 on Linux");
