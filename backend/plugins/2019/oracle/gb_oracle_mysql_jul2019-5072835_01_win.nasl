...
if (description)
{
  ...
  script_name("Oracle MySQL 5.x < 5.6.45, 5.7.x < 5.7.19 Security Update (2019-5072835) - Windows");
  ...
  script_tag(name:"affected", value:"MySQL 5.6.44 and prior and 5.7.18 and prior.");
