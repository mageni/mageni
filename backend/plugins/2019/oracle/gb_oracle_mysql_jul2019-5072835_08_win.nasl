...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.142657");
  ...
  script_name("Oracle MySQL 8.0.x < 8.0.16 Security Update (2019-5072835) - Windows");
  ...
  script_tag(name:"summary", value:"Oracle MySQL is prone to a unspecified denial of service vulnerability.");
