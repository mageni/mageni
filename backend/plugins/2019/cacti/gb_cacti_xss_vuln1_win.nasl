...
# $Id: gb_cacti_xss_vuln1_win.nasl 13131 2019-01-18 03:06:38Z ckuersteiner $
#
# Cacti < 1.1.37 Multiple XSS Vulnerabilities (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.141888");
  ...
  script_name("Cacti < 1.1.37 Multiple XSS Vulnerabilities (Windows)");
