...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815521");
  ...
  script_tag(name:"creation_date", value:"2019-07-16 10:27:23 +0530 (Tue, 16 Jul 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2019-07)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 75.0.3770.142 on Windows");
