...
if(description)
{
  ...
  script_version("2019-10-30T01:30:49+0000");
  script_tag(name:"last_modification", value:"2019-10-30 01:30:49 +0000 (Wed, 30 Oct 2019)");
  ...
  script_tag(name:"summary", value:"vBulletin mishandles external URLs within the /core/vb/vurl.php file and the
  /core/vb/vurl directories.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"vBulletin 5.5.4 and prior.");

  script_tag(name:"solution", value:"Update to 5.5.5 or later. Additional make sure the /core/vb/vurl.php file and
  /core/vb/vurl directories are deleted from your server.");
