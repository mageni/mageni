...
if (description)
{
  ...
  script_version("2019-10-30T06:57:18+0000");
  script_tag(name:"last_modification", value:"2019-10-30 06:57:18 +0000 (Wed, 30 Oct 2019)");
  ...
  script_name("Horde Groupware Webmail <= 5.2.22 Multiple Vulnerabilities (Windows)");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 30th October, 2019.
