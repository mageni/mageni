...
if(description)
{
  ...
  script_version("2019-06-22T09:38:54+0000");
  script_cve_id("CVE-2018-16514");
  script_tag(name:"cvss_base", value:"2.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-06-22 09:38:54 +0000 (Sat, 22 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-22 11:26:28 +0200 (Sat, 22 Jun 2019)");
  script_name("MantisBT 'View Filters' And 'Edit Filter' Pages XSS Vulnerability - June19");
  ...
  script_tag(name:"solution", value:"Upgrade to MantisBT version 2.17.1 or later. Please see the references for more information.");
