...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815479");
  ...
  script_tag(name:"creation_date", value:"2019-10-07 11:10:06 +0530 (Mon, 07 Oct 2019)");
  script_name("Wireshark Security Updates(wnpa-sec-2019-21)-Mac OS X");
  ...
  2.6.0 to 2.6.10 on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Wireshark version 3.0.4 or
  2.6.11 or later. Please see the references for more information.");
...
if(version_in_range(version:wirversion, test_version:"3.0.0", test_version2:"3.0.3")){
  fix = "3.0.4";
}

else if(version_in_range(version:wirversion, test_version:"2.6.0", test_version2:"2.6.10")){
  fix = "2.6.11";
}
