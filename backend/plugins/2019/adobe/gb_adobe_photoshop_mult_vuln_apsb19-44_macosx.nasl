...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815541");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 17:22:04 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Photoshop CC Multiple Vulnerabilities August19 (Mac OS X.)");
  ...
  and Adobe Photoshop CC 2019 20.0.5 and earlier versions on Mac OS X..");
