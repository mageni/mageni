...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815531");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 15:36:22 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Acrobat DC (Continuous Track) Security Updates (apsb19-41) - Windows");
