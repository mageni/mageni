...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815536");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 16:12:14 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Acrobat Reader 2017 Security Updates (apsb19-41)-Windows");
  ...
  attacker to execute arbitrary code and disclose the sensitive information.");

  script_tag(name:"affected", value:"Adobe Acrobat Reader 2017.011.30143 and earlier
  versions on Windows.");
