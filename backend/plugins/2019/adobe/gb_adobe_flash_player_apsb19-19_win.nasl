...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815027");
  script_version("2019-05-03T08:55:39+0000");
  script_cve_id("CVE-2019-7108", "CVE-2019-7096");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-05-03 08:55:39 +0000 (Fri, 03 May 2019)");
  script_tag(name:"creation_date", value:"2019-04-10 11:01:17 +0530 (Wed, 10 Apr 2019)");
  script_name("Adobe Flash Player Security Updates(apsb19-19)-Windows");
