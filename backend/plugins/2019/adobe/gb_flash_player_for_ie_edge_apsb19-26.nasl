...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815061");
  ...
  script_name("Adobe Flash Player Microsoft Edge and Internet Explorer Security Update(apsb19-26)-Windows");
  ...
  script_tag(name:"solution", value:"Upgrade to Adobe Flash Player 32.0.0.192 or later. Please see the references for more information.");
...
if(version_is_less(version:flashVer, test_version:"32.0.0.192"))
{
  report = report_fixed_ver(file_checked:flashPath,
                            file_version:flashVer, vulnerable_range:"Less than 32.0.0.192");
