...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815534");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 15:58:25 +0530 (Wed, 14 Aug 2019)");
  script_name("Adobe Acrobat DC (Classic Track) Security Updates (apsb19-41) - Windows");
  ...
  before 2015.006.30499 on Windows.");
...
## 2015.006.30498 => 15.006.30498
if(version_in_range(version:vers, test_version:"15.0", test_version2:"15.006.30498")) {
