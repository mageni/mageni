...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815691");
  ...
  script_name("Adobe Reader DC (Continuous) Security Updates(apsb19-55)-Windows");
  ...
  to version 2019.021.20058 on Windows.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC 2019 (Continuous)
