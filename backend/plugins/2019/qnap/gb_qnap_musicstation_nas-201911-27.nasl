...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143221");
  script_version("2019-12-05T04:29:14+0000");
  script_tag(name:"last_modification", value:"2019-12-05 04:29:14 +0000 (Thu, 05 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-05 04:08:32 +0000 (Thu, 05 Dec 2019)");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:N");

  script_cve_id("CVE-2019-7185");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("QNAP QTS Music Station XSS Vulnerability (NAS-201911-27)");
  ...
  script_tag(name:"summary", value:"QNAP Music Station is prone to a cross-site scripting vulnerability on the
  administrator's management console.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"QNAP Music Station versions prior to 5.1.11, 5.2.7 and 5.3.5.");

  script_tag(name:"solution", value:"Update to version 5.1.11, 5.2.7, 5.3.5 or later.");
...
if (version_is_less(version: version, test_version: "5.1.11")) {
