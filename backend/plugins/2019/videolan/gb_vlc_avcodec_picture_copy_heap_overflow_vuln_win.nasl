...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815429");
  ...
  script_tag(name:"creation_date", value:"2019-07-24 17:33:01 +0530 (Wed, 24 Jul 2019)");
  script_name("VLC Media Player 'avcodec picture copy' Heap Buffer Overflow Vulnerability (Windows)");
