...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831676");
  ...
  script_tag(name:"affected", value:"acpid on Mandriva Enterprise Server 5.2,
  Mandriva Linux 2010.1");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"insight", value:"A vulnerability has been discovered and corrected in acpid:
