...
# $Id: deb_2519_2.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202519-2");
  script_tag(name:"insight", value:"It was discovered that the recent update for isc-dhcp, did not contain
