...
# $Id: esoft_slk_ssa_2005_242_02.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-242-02 PHP");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-242-02");
...
if((res = isslkpkgvuln(pkg:"php", ver:"4.3.11-i386-4", rls:"SLK8.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"php", ver:"4.3.11-i386-4", rls:"SLK9.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"php", ver:"4.3.11-i486-4", rls:"SLK9.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"php", ver:"4.3.11-i486-3", rls:"SLK10.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"php", ver:"4.3.11-i486-3", rls:"SLK10.1")) != NULL) {
  report += res;
}
