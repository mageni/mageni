...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864762");
  ...
  script_tag(name:"affected", value:"spice-gtk on Fedora 16");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"spice-gtk", rpm:"spice-gtk~0.11~5.fc16", rls:"FC16")) != NULL)
  {
