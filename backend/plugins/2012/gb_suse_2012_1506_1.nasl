...
# $Id: gb_suse_2012_1506_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This update of plib fixed two stack-based buffer overflows.");
