...
# $Id: esoft_slk_ssa_2004_136_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2004-136-01 mc");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-136-01");
...
if((res = isslkpkgvuln(pkg:"mc", ver:"4.6.0-i486-2", rls:"SLK9.1")) != NULL) {
  report += res;
}
