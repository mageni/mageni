...
# $Id: gb_ubuntu_USN_1336_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Jueri Aedla discovered that the kernel incorrectly handled /proc/<pid>/mem
