...
#
# Fedora Update for perl-DBD-Pg FEDORA-2012-10871
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864581");
  ...
  script_tag(name:"affected", value:"perl-DBD-Pg on Fedora 16");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-DBD-Pg", rpm:"perl-DBD-Pg~2.19.2~1.fc16", rls:"FC16")) != NULL)
  {
