...
# $Id: esoft_slk_ssa_2005_310_05.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-310-05 PHP");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-310-05");
...
if((res = isslkpkgvuln(pkg:"php", ver:"4.4.1-i486-1", rls:"SLK10.2")) != NULL) {
  report += res;
}
