...
#
# Fedora Update for kde-partitionmanager FEDORA-2012-5873
#
# Authors:
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"kde-partitionmanager", rpm:"kde-partitionmanager~1.0.3~7.20120205svn.fc17", rls:"FC17")) != NULL)
  {
