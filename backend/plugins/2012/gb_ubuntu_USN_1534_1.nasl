...
# $Id: gb_ubuntu_USN_1534_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-ec2 USN-1534-1
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1534-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841107");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-08-14 10:40:38 +0530 (Tue, 14 Aug 2012)");
  script_cve_id("CVE-2012-2136", "CVE-2012-2390");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-ec2 USN-1534-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1534-1");
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-2.6.32-347-ec2", ver:"2.6.32-347.52", rls:"UBUNTU10.04 LTS")) != NULL)
  {
