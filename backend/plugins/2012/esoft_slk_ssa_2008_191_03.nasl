...
# $Id: esoft_slk_ssa_2008_191_03.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61463");
  ...
  script_name("Slackware Advisory SSA:2008-191-03 seamonkey");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2008-191-03");
...
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.10-i486-1_slack11.0", rls:"SLK11.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.10-i486-1_slack12.0", rls:"SLK12.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.10-i486-1_slack12.1", rls:"SLK12.1")) != NULL) {
  report += res;
}
