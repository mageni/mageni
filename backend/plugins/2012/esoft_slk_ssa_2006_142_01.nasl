...
# $Id: esoft_slk_ssa_2006_142_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2006-142-01 tetex PDF security");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2006-142-01");
...
if((res = isslkpkgvuln(pkg:"tetex", ver:"3.0-i486-2_10.2", rls:"SLK10.2")) != NULL) {
  report += res;
}
