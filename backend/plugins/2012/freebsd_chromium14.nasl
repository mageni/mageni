...
# $Id: freebsd_chromium14.nasl 11762 2018-10-05 10:54:12Z cfischer $
#
# Auto generated from VID 60bbe12c-e2c1-11e1-a8ca-00262d5ed8ee
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.71504");
...
before 21.0.1180.75 allows remote attackers to cause a denial of
...
operations.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/60bbe12c-e2c1-11e1-a8ca-00262d5ed8ee.html");
...
if(!isnull(bver) && revcomp(a:bver, b:"21.0.1180.75")<0) {
