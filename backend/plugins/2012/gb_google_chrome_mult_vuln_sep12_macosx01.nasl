...
# $Id: gb_google_chrome_mult_vuln_sep12_macosx01.nasl 11857 2018-10-12 08:25:16Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.802974");
  ...
  script_cve_id("CVE-2012-2888", "CVE-2012-2887", "CVE-2012-2886", "CVE-2012-2885",
                ...
                "CVE-2012-2895", "CVE-2012-2874", "CVE-2012-2896");
  ...
  script_name("Google Chrome Multiple Vulnerabilities - Sep12 (Mac OS X-01)");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 22.0.1229.79 on Mac OS X");
