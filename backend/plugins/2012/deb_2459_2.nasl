...
# $Id: deb_2459_2.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202459-2");
  script_tag(name:"insight", value:"The recent quagga update, DSA-2459-1, introduced a memory leak in the
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"quagga", ver:"0.99.20.1-0+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"quagga-dbg", ver:"0.99.20.1-0+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"quagga-doc", ver:"0.99.20.1-0+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
