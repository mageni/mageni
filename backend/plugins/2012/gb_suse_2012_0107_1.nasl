...
# $Id: gb_suse_2012_0107_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850249");
  ...
  script_tag(name:"affected", value:"libxml2 on openSUSE 11.4, openSUSE 11.3");
  script_tag(name:"insight", value:"A heap-based buffer overflow during decoding of entity
