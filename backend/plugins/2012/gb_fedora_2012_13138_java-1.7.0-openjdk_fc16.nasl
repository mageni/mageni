...
#
# Fedora Update for java-1.7.0-openjdk FEDORA-2012-13138
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-September/085935.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864684");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-09-04 11:32:25 +0530 (Tue, 04 Sep 2012)");
  ...
  script_name("Fedora Update for java-1.7.0-openjdk FEDORA-2012-13138");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.7.0-openjdk", rpm:"java-1.7.0-openjdk~1.7.0.6~2.3.1.fc16.2", rls:"FC16")) != NULL)
  {
