...
#
# CentOS Update for libpng CESA-2012:0523 centos5
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.881230");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.2.10~17.el5_8", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libpng-devel", rpm:"libpng-devel~1.2.10~17.el5_8", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
