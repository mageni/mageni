...
# $Id: gb_suse_2012_1461_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for update openSUSE-SU-2012:1461-1 (update)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for update openSUSE-SU-2012:1461-1 (update)");
