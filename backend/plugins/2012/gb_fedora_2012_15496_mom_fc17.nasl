...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864796");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mom'
  ...
  script_tag(name:"affected", value:"mom on Fedora 17");
