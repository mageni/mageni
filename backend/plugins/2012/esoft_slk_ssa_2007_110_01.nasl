...
# $Id: esoft_slk_ssa_2007_110_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2007-110-01 Slackware 11.0 x11-6.9.0 patch fix");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-110-01");
...
if((res = isslkpkgvuln(pkg:"x11", ver:"6.9.0-i486-14_slack11.0", rls:"SLK11.0")) != NULL) {
  report += res;
}
