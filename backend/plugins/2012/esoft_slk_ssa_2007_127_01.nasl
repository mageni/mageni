...
# $Id: esoft_slk_ssa_2007_127_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2007-127-01 php");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-127-01");
...
if((res = isslkpkgvuln(pkg:"php", ver:"5.2.2-i486-1_slack10.2", rls:"SLK10.2")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"php", ver:"5.2.2-i486-1_slack11.0", rls:"SLK11.0")) != NULL) {
  report += res;
}
