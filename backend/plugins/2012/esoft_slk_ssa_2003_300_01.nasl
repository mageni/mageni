...
# $Id: esoft_slk_ssa_2003_300_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2003-300-01 gdm security update");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2003-300-01");

  script_tag(name:"insight", value:"GDM is the GNOME Display Manager, and is commonly used to provide
...
if((res = isslkpkgvuln(pkg:"gdm", ver:"2.4.1.7-i386-1", rls:"SLK9.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"gdm", ver:"2.4.4.5-i486-1", rls:"SLK9.1")) != NULL) {
  report += res;
}
