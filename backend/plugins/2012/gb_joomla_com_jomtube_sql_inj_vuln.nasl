...
# $Id: gb_joomla_com_jomtube_sql_inj_vuln.nasl 11549 2018-09-22 12:11:10Z cfischer $
#
...
injecting arbitrary SQL code.");
  ...
  script_tag(name:"affected", value:"Joomla Jomtube Component");

  script_tag(name:"insight", value:"The flaw is due to an input passed via the 'id' parameter to 'index.php' (when
'option' is set to 'com_jomtube' and 'view' set to 'video') is not properly sanitised before being used in an SQL
query.");
...
a newer release, disable respective features, remove the product or replace the product by another one.");
  ...
  script_tag(name:"summary", value:"This host is running Joomla Jomtube component and is prone to SQL injection
vulnerability.");
...
url = dir + "/index.php?option=com_jomtube&view=video&id='";

if (http_vuln_check(port: port, url: url, pattern: "Invalid argument supplied for foreach\(\)",
