...
# $Id: esoft_slk_ssa_2007_243_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2007-243-01 java (jre, jdk)");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-243-01");
...
One such advisory is linked in the references.

Updated versions of both the jre and jdk packages are provided
which address all known flaws in Java(TM) at this time.
...
if((res = isslkpkgvuln(pkg:"jre", ver:"6u2-i586-1", rls:"SLK12.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"jdk", ver:"6u2-i586-1", rls:"SLK12.0")) != NULL) {
  report += res;
}
