...
#
# CentOS Update for libtiff CESA-2012:1054 centos5
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2012-July/018704.html");
  script_oid("1.3.6.1.4.1.25623.1.0.881205");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-07-30 16:45:08 +0530 (Mon, 30 Jul 2012)");
  script_cve_id("CVE-2012-2088", "CVE-2012-2113");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("CentOS Update for libtiff CESA-2012:1054 centos5");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.8.2~15.el5_8", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.8.2~15.el5_8", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
