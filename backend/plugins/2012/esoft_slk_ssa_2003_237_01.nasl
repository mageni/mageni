...
# $Id: esoft_slk_ssa_2003_237_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2003-237-01 unzip vulnerability patched");
...
if((res = isslkpkgvuln(pkg:"infozip", ver:"5.50-i386-2", rls:"SLK9.0")) != NULL) {
  report += res;
}
