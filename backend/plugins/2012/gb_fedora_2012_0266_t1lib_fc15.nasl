...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.863708");
  ...
  script_tag(name:"affected", value:"t1lib on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"t1lib", rpm:"t1lib~5.1.2~9.fc15", rls:"FC15")) != NULL)
  {
