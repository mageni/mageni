...
# $Id: gb_ubuntu_USN_1638_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for firefox USN-1638-1
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1638-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841224");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-11-23 11:53:46 +0530 (Fri, 23 Nov 2012)");
  ...
  script_name("Ubuntu Update for firefox USN-1638-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1638-1");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"17.0+build2-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"17.0+build2-0ubuntu0.11.10.1", rls:"UBUNTU11.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"17.0+build2-0ubuntu0.10.04.1", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"17.0+build2-0ubuntu0.12.10.1", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
