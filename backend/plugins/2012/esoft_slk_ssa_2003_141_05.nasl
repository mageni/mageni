...
# $Id: esoft_slk_ssa_2003_141_05.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2003-141-05 mod_ssl RSA blinding fixes");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2003-141-05");
...
if((res = isslkpkgvuln(pkg:"mod_ssl", ver:"2.8.14_1.3.27-i386-1", rls:"SLK9.0")) != NULL) {
  report += res;
}
