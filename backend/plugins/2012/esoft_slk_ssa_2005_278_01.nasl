...
# $Id: esoft_slk_ssa_2005_278_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-278-01 Thunderbird email client");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-278-01");
...
if((res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"1.0.7-i686-1", rls:"SLK10.2")) != NULL) {
  report += res;
}
