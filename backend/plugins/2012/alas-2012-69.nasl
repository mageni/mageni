...
# $Id: alas-2012-69.nasl 6578 2017-07-06 13:44:33Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2012-69");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"perl-YAML-LibYAML-debuginfo", rpm:"perl-YAML-LibYAML-debuginfo~0.38~2.2.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"perl-YAML-LibYAML", rpm:"perl-YAML-LibYAML~0.38~2.2.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
