...
# $Id: gb_ubuntu_USN_1532_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-ti-omap4 USN-1532-1
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1532-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841102");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-08-14 10:40:05 +0530 (Tue, 14 Aug 2012)");
  script_cve_id("CVE-2012-2136", "CVE-2012-2373", "CVE-2012-3375", "CVE-2012-3400");
  script_tag(name:"cvss_base", value:"7.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-1532-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1532-1");
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.0.0-1214-omap4", ver:"3.0.0-1214.26", rls:"UBUNTU11.10")) != NULL)
  {
