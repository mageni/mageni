...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831680");
  ...
  script_tag(name:"affected", value:"nginx on Mandriva Linux 2011.0,
  Mandriva Linux 2010.1");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"insight", value:"A vulnerability has been found and corrected in nginx:
...
if(release == "MNDK_2011.0")
{
  ...
  if ((res = isrpmvuln(pkg:"nginx", rpm:"nginx~1.0.5~1.1", rls:"MNDK_2011.0")) != NULL)
  {
...
if(release == "MNDK_2010.1")
{
  ...
  if ((res = isrpmvuln(pkg:"nginx", rpm:"nginx~0.8.41~1.1mdv2010.2", rls:"MNDK_2010.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
