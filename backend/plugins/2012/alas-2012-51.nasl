...
# $Id: alas-2012-51.nasl 6578 2017-07-06 13:44:33Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2012-51");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"cvs-debuginfo", rpm:"cvs-debuginfo~1.11.23~11.6.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"cvs", rpm:"cvs~1.11.23~11.6.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
