...
# $Id: secpod_google_chrome_navigation_entry_mult_vuln_macosx.nasl 11857 2018-10-12 08:25:16Z cfischer $
#
...
if(description)
{
  ...
  script_name("Google Chrome Multiple Vulnerabilities - Jan12 (Mac OS X)");
