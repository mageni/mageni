...
# $Id: esoft_slk_ssa_2004_266_04.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2004-266-04 xine-lib");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-266-04");
...
if((res = isslkpkgvuln(pkg:"xine-lib", ver:"1rc6a-i686-1", rls:"SLK10.0")) != NULL) {
  report += res;
}
