...
#
# Fedora Update for cifs-utils FEDORA-2012-6398
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-May/079452.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864211");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"cifs-utils", rpm:"cifs-utils~5.4~1.fc15", rls:"FC15")) != NULL)
  {
