...
# $Id: esoft_slk_ssa_2004_257_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2004-257-01 samba DoS");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-257-01");
...
if((res = isslkpkgvuln(pkg:"samba", ver:"3.0.5-i486-3", rls:"SLK10.0")) != NULL) {
  report += res;
}
