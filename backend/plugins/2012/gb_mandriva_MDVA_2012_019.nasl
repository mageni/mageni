...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831545");
  ...
  script_tag(name:"affected", value:"mozilla-thunderbird on Mandriva Linux 2010.1,
  Mandriva Linux 2010.1/X86_64");
  script_tag(name:"insight", value:"This is a maintenance and bugfix release that provides thunderbird
