...
# $Id: alas-2012-73.nasl 6578 2017-07-06 13:44:33Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2012-73");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"openssl098e", rpm:"openssl098e~0.9.8e~17.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"openssl098e-debuginfo", rpm:"openssl098e-debuginfo~0.9.8e~17.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
