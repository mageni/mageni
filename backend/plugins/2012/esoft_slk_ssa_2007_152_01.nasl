...
# $Id: esoft_slk_ssa_2007_152_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_cve_id("CVE-2007-1900", "CVE-2007-2756", "CVE-2007-2872", "CVE-2007-1887");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_version("$Revision: 14202 $");
  script_name("Slackware Advisory SSA:2007-152-01 php5");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-152-01");
...
if((res = isslkpkgvuln(pkg:"php", ver:"5.2.3-i486-1_slack10.2", rls:"SLK10.2")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"php", ver:"5.2.3-i486-1_slack11.0", rls:"SLK11.0")) != NULL) {
  report += res;
}
