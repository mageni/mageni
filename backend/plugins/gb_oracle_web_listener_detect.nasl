...
if(description)
{
  ...
  script_name("Oracle Web Listener Detection");
  ...
  script_tag(name:"summary", value:"Checks whether Oracle Web Listener is present on
...
if( buf =~ 'Server: *Oracle_Web_Listener' ) {
