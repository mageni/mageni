...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detects the installed version of Flatchat and
...
foreach dir( make_list_unique( "/flatchat", "/", cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "HTTP/1.. 200" && "Flat Chat" >< rcvRes && "Login" >< rcvRes ) {
