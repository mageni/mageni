...
# Description: Too long basic authentication DoS
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.12201");
  script_version("2019-04-24T07:26:10+0000");
  script_tag(name:"last_modification", value:"2019-04-24 07:26:10 +0000 (Wed, 24 Apr 2019)");
  script_tag(name:"creation_date", value:"2005-11-03 14:08:04 +0100 (Thu, 03 Nov 2005)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("Too long basic authentication DoS");
  ...
  script_tag(name:"affected", value:"Monit web server. Other products might be affected as well.");
