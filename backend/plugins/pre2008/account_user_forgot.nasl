...
# $Id: account_user_forgot.nasl 9567 2018-04-23 13:22:46Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.17294");
  ...
  script_tag(name:"summary", value:"The account 'user' has the password 'forgot'.");
