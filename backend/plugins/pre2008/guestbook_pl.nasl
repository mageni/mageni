...
# $Id: guestbook_pl.nasl 6040 2017-04-27 09:02:38Z teissa $
#
# guestbook.pl
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.10099");
  ...
  script_tag(name:"summary", value:"The 'guestbook.pl' is installed. This CGI has
