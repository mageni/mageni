...
# $Id: sendmail_parsing_redirection.nasl 13074 2019-01-15 09:12:34Z cfischer $
...
# nb: 8.8.*, 8.9.2
if(vers =~ "^8\.(8|8\.[0-9]+|9\.2)$") {
  report = report_fixed_ver(installed_version:vers, fixed_version:"> 8.9.3");
