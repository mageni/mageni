...
# $Id: fcore_2009_6121.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_insight = "CVE-2009-0153 Handle illegal sequences consistently
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307428");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"icu", rpm:"icu~3.8.1~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libicu", rpm:"libicu~3.8.1~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libicu-devel", rpm:"libicu-devel~3.8.1~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libicu-doc", rpm:"libicu-doc~3.8.1~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"icu-debuginfo", rpm:"icu-debuginfo~3.8.1~9.fc9", rls:"FC9")) != NULL) {
    report += res;
}
