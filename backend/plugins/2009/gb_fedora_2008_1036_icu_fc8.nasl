...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-January/msg00896.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307701");
  ...
  script_name( "Fedora Update for icu FEDORA-2008-1036");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"icu", rpm:"icu~3.8~5.fc8", rls:"FC8")) != NULL)
  {
