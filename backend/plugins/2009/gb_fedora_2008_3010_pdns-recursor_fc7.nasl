...
tag_affected = "pdns-recursor on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00198.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307929");
  ...
  script_name( "Fedora Update for pdns-recursor FEDORA-2008-3010");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"pdns-recursor", rpm:"pdns-recursor~3.1.5~1.fc7", rls:"FC7")) != NULL)
  {
