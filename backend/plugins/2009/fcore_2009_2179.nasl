...
# $Id: fcore_2009_2179.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.312166");
 ...
 script_name("Fedora Core 9 FEDORA-2009-2179 (rubygem-actionpack)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~2.1.1~2.fc9", rls:"FC9")) != NULL) {
    report += res;
}
