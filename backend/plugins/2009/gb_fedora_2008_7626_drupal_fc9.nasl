...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00508.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311018");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:03:12 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-7626");
  script_cve_id("CVE-2008-3740", "CVE-2008-3741", "CVE-2008-3742", "CVE-2008-3743", "CVE-2008-3744", "CVE-2008-3745");
  script_name( "Fedora Update for drupal FEDORA-2008-7626");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.4~1.fc9", rls:"FC9")) != NULL)
  {
