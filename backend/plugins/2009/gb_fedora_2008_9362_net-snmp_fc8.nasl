...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00021.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304778");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"net-snmp", rpm:"net-snmp~5.4.1~8.fc8", rls:"FC8")) != NULL)
  {
