...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00570.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307993");
  ...
  script_name( "Fedora Update for cacti FEDORA-2008-1699");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"cacti", rpm:"cacti~0.8.7b~1.fc8", rls:"FC8")) != NULL)
  {
