...
tag_affected = "pam_mount on Mandriva Linux 2008.1,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-10/msg00029.php");
  script_oid("1.3.6.1.4.1.25623.1.0.309472");
  ...
  script_name( "Mandriva Update for pam_mount MDVSA-2008:208-1 (pam_mount)");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"pam_mount", rpm:"pam_mount~0.33~2.3mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
