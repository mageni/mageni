...
tag_insight = "Buffer overflow in the safer_name_suffix function in GNU cpio
...
tag_affected = "cpio on Mandriva Linux 2007.0,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-11/msg00055.php");
  script_oid("1.3.6.1.4.1.25623.1.0.310900");
  ...
  script_name( "Mandriva Update for cpio MDKSA-2007:233 (cpio)");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"cpio", rpm:"cpio~2.7~3.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"cpio", rpm:"cpio~2.6~7.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"cpio", rpm:"cpio~2.9~2.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
