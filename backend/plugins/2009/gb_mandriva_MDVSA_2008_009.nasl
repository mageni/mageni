...
#
# Mandriva Update for autofs MDVSA-2008:009 (autofs)
#
# Authors:
...
tag_affected = "autofs on Mandriva Linux 2007.0,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-01/msg00018.php");
  script_oid("1.3.6.1.4.1.25623.1.0.307649");
  script_version("$Revision: 6568 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-06 15:04:21 +0200 (Thu, 06 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-04-09 14:26:37 +0200 (Thu, 09 Apr 2009)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "MDVSA", value: "2008:009");
  script_cve_id("CVE-2007-5964", "CVE-2007-6285");
  script_name( "Mandriva Update for autofs MDVSA-2008:009 (autofs)");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"autofs", rpm:"autofs~5.0.2~8.3mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"autofs", rpm:"autofs~5.0.1~0.rc3.1.2mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"autofs", rpm:"autofs~5.0.2~8.3mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
