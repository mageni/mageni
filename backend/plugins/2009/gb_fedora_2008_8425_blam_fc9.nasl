...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01338.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304759");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"blam", rpm:"blam~1.8.5~2.fc9", rls:"FC9")) != NULL)
  {
