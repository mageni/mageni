...
tag_insight = "The following package is affected: pligg
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.312189");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.3b")<0) {
    txt += 'Package pligg version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
