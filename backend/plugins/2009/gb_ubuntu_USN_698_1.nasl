...
# $Id: gb_ubuntu_USN_698_1.nasl 7969 2017-12-01 09:23:16Z santu $
#
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-698-1";
tag_affected = "nagios vulnerability on Ubuntu 6.06 LTS";
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.311146");
