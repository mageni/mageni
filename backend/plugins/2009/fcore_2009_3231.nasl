...
# $Id: fcore_2009_3231.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-3231 (pam)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-3231";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304857");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"pam", rpm:"pam~1.0.4~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"pam-devel", rpm:"pam-devel~1.0.4~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"pam-debuginfo", rpm:"pam-debuginfo~1.0.4~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
