...
# $Id: gb_mozilla_prdts_addr_bar_spoofing_vuln_lin.nasl 12629 2018-12-03 15:19:43Z cfischer $
#
...
trusted.");
  script_tag(name:"affected", value:"Mozilla Firefox version 3.5.1 and 3.5.2, Seamonkey 1.1.17 and on Linux.");
...
the address bar shows an arbitrary path on a possibly trusted host.");
  ...
  script_tag(name:"summary", value:"This host is installed with Mozilla Products and is prone to Address
