...
# $Id: fcore_2009_1295.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310231");
 ...
 script_name("Fedora Core 9 FEDORA-2009-1295 (gnumeric)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"gnumeric", rpm:"gnumeric~1.8.2~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gnumeric-devel", rpm:"gnumeric-devel~1.8.2~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gnumeric-plugins-extras", rpm:"gnumeric-plugins-extras~1.8.2~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gnumeric-debuginfo", rpm:"gnumeric-debuginfo~1.8.2~4.fc9", rls:"FC9")) != NULL) {
    report += res;
}
