...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-05/msg00016.php");
  script_oid("1.3.6.1.4.1.25623.1.0.312130");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"rpmdrake", rpm:"rpmdrake~4.9.13.1~1.1mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
