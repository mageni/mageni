...
#
# Fedora Update for mediawiki FEDORA-2008-8678
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00220.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309523");
  ...
  script_name( "Fedora Update for mediawiki FEDORA-2008-8678");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"mediawiki", rpm:"mediawiki~1.13.2~40.99.fc8", rls:"FC8")) != NULL)
  {
