...
#
# Fedora Update for gallery2 FEDORA-2008-5479
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00766.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309192");
  ...
  script_name( "Fedora Update for gallery2 FEDORA-2008-5479");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gallery2", rpm:"gallery2~2.2.5~1.fc8", rls:"FC8")) != NULL)
  {
