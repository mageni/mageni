...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00223.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308471");
  ...
  script_name( "Fedora Update for squirrelmail FEDORA-2008-10740");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"squirrelmail", rpm:"squirrelmail~1.4.17~1.fc9", rls:"FC9")) != NULL)
  {
