...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01049.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309347");
  ...
  script_name( "Fedora Update for firefox FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~3.0.5~1.fc9", rls:"FC9")) != NULL)
  {
