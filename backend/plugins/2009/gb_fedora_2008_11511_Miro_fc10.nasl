...
#
# Fedora Update for Miro FEDORA-2008-11511
#
# Authors:
...
tag_affected = "Miro on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01010.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306366");
  ...
  script_name( "Fedora Update for Miro FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"Miro", rpm:"Miro~1.2.7~3.fc10", rls:"FC10")) != NULL)
  {
