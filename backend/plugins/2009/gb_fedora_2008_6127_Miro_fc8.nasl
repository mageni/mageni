...
#
# Fedora Update for Miro FEDORA-2008-6127
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00209.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306259");
  ...
  script_name( "Fedora Update for Miro FEDORA-2008-6127");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"Miro", rpm:"Miro~1.2.3~2.fc8", rls:"FC8")) != NULL)
  {
