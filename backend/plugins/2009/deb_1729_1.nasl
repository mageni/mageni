...
# $Id: deb_1729_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "Several vulnerabilities have been found in gst-plugins-bad0.10, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201729-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308822");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gstreamer0.10-plugins-bad", ver:"0.10.3-3.1+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
