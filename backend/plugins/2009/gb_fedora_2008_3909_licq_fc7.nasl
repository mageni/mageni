...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg00255.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306071");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"licq", rpm:"licq~1.3.4~8.fc7", rls:"FC7")) != NULL)
  {
