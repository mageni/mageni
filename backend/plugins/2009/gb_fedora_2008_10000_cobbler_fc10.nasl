...
tag_affected = "cobbler on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00789.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309478");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~1.2.9~1.fc10", rls:"FC10")) != NULL)
  {
