...
#
# Fedora Update for ruby-gnome2 FEDORA-2008-11511
#
# Authors:
...
tag_affected = "ruby-gnome2 on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01013.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306077");
  ...
  script_name( "Fedora Update for ruby-gnome2 FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"ruby-gnome2", rpm:"ruby-gnome2~0.18.1~2.fc10", rls:"FC10")) != NULL)
  {
