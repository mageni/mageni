...
tag_insight = "rsync before 3.0.0pre6, when running a writable rsync daemon that is
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-01/msg00020.php");
  script_oid("1.3.6.1.4.1.25623.1.0.308985");
  ...
  script_name( "Mandriva Update for rsync MDVSA-2008:011 (rsync)");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"rsync", rpm:"rsync~2.6.9~1.2mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"rsync", rpm:"rsync~2.6.9~0.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"rsync", rpm:"rsync~2.6.9~5.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
