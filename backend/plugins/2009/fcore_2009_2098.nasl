...
# $Id: fcore_2009_2098.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308204");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"optipng", rpm:"optipng~0.6.2.1~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"optipng-debuginfo", rpm:"optipng-debuginfo~0.6.2.1~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
