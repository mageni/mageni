...
#
# CentOS Update for openoffice.org CESA-2008:0538 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/014979.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312174");
  ...
  script_name( "CentOS Update for openoffice.org CESA-2008:0538 centos3 i386");
