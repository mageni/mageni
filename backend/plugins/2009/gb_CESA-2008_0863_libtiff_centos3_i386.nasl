...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-August/015220.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305208");
  ...
  script_name( "CentOS Update for libtiff CESA-2008:0863 centos3 i386");
