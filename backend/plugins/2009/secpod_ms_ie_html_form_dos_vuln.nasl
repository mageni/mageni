...
# $Id: secpod_ms_ie_html_form_dos_vuln.nasl 12629 2018-12-03 15:19:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Microsoft Internet Explorer version 7.0 and prior on Windows.");
