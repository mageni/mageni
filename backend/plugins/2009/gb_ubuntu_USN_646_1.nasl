...
# $Id: gb_ubuntu_USN_646_1.nasl 7969 2017-12-01 09:23:16Z santu $
#
...
tag_insight = "It was discovered that rdesktop did not properly validate the length
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-646-1";
tag_affected = "rdesktop vulnerabilities on Ubuntu 6.06 LTS ,
  Ubuntu 7.04 ,
  Ubuntu 7.10 ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-646-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.310084");
  ...
  script_name( "Ubuntu Update for rdesktop vulnerabilities USN-646-1");
...
if(release == "UBUNTU6.06 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"rdesktop", ver:"1.4.1-1.1ubuntu0.6.06.1", rls:"UBUNTU6.06 LTS")) != NULL)
  {
...
if(release == "UBUNTU7.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"rdesktop", ver:"1.5.0-1ubuntu1.1", rls:"UBUNTU7.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU8.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"rdesktop", ver:"1.5.0-3+cvs20071006ubuntu0.1", rls:"UBUNTU8.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU7.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"rdesktop", ver:"1.5.0-2ubuntu0.1", rls:"UBUNTU7.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
