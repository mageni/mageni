...
#
# Solaris Update for GNOME 2.6.0 122212-33
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.309128");
  ...
  script_name("Solaris Update for GNOME 2.6.0 122212-33");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-122212-33-1");
