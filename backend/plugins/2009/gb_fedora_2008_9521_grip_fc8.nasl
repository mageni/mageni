...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00490.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304626");
  ...
  script_tag(name:"summary", value:"Check for the Version of grip");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"grip", rpm:"grip~3.2.0~24.fc8", rls:"FC8")) != NULL)
  {
