...
# $Id: sles9p5060841.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305494");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"libsmbclient", rpm:"libsmbclient~3.0.26a~0.11", rls:"SLES9.0")) != NULL) {
    report += res;
}
