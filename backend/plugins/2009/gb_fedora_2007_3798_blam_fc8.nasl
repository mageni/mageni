...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-November/msg00918.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307106");
  ...
  script_name( "Fedora Update for blam FEDORA-2007-3798");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"blam", rpm:"blam~1.8.3~11.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"blam-debuginfo", rpm:"blam-debuginfo~1.8.3~11.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
