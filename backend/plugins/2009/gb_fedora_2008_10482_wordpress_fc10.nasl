...
tag_affected = "wordpress on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00083.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311037");
  ...
  script_name( "Fedora Update for wordpress FEDORA-2008-10482");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.6.5~2.fc10", rls:"FC10")) != NULL)
  {
