...
tag_affected = "adminutil on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00449.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309811");
  ...
  script_name( "Fedora Update for adminutil FEDORA-2008-7339");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"adminutil", rpm:"adminutil~1.1.7~1.fc9", rls:"FC9")) != NULL)
  {
