...
#
# Fedora Update for horde FEDORA-2008-2362
#
# Authors:
...
tag_affected = "horde on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00253.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308986");
  ...
  script_xref(name: "FEDORA", value: "2008-2362");
  script_name( "Fedora Update for horde FEDORA-2008-2362");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"horde", rpm:"horde~3.1.7~1.fc8", rls:"FC8")) != NULL)
  {
