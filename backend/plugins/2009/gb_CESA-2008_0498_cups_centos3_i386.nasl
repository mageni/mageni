...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/014960.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311331");
  ...
  script_name( "CentOS Update for cups CESA-2008:0498 centos3 i386");
