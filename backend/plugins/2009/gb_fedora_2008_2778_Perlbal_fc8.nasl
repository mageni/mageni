...
#
# Fedora Update for Perlbal FEDORA-2008-2778
#
# Authors:
...
tag_affected = "Perlbal on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00665.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310799");
  ...
  script_xref(name: "FEDORA", value: "2008-2778");
  script_name( "Fedora Update for Perlbal FEDORA-2008-2778");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"Perlbal", rpm:"Perlbal~1.70~1.fc8", rls:"FC8")) != NULL)
  {
