...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308621");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.9.6~17.7", rls:"SLES10.0")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"opensc-devel", rpm:"opensc-devel~0.9.6~17.7", rls:"SLES10.0")) != NULL) {
    report += res;
}
