...
# $Id: fcore_2009_1092.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"glpi", rpm:"glpi~0.71.5~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
