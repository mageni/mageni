...
#
# CentOS Update for pidgin CESA-2008:0584 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015085.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308913");
  ...
  script_name( "CentOS Update for pidgin CESA-2008:0584 centos3 i386");
