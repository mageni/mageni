...
# $Id: sles9p5062940.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305481");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"expat", rpm:"expat~1.95.7~37.4", rls:"SLES9.0")) != NULL) {
    report += res;
}
