...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-October/015337.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308883");
  ...
  script_name( "CentOS Update for ed CESA-2008:0946-01 centos2 i386");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"ed", rpm:"ed~0.2~21.1", rls:"CentOS2")) != NULL)
  {
