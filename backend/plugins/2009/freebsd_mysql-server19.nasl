#
#VID bb4e9a44-dff2-11dd-a765-0030843d3802
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID bb4e9a44-dff2-11dd-a765-0030843d3802
#
# Authors:
...
http://www.vuxml.org/freebsd/bb4e9a44-dff2-11dd-a765-0030843d3802.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309555");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.1")>=0 && revcomp(a:bver, b:"4.1.23")<0) {
    txt += 'Package mysql-server version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"5.0")>=0 && revcomp(a:bver, b:"5.0.42")<0) {
    txt += 'Package mysql-server version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"5.1")>=0 && revcomp(a:bver, b:"5.1.18")<0) {
    txt += 'Package mysql-server version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
