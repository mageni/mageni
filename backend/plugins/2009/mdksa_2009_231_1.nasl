...
# $Id: mdksa_2009_231_1.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305071");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"htmldoc", rpm:"htmldoc~1.8.27~1.1mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"htmldoc-nogui", rpm:"htmldoc-nogui~1.8.27~1.1mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
