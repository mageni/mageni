...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/015042.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306637");
  ...
  script_name( "CentOS Update for perl CESA-2008:0522 centos4 x86_64");
