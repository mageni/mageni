...
tag_affected = "unzip on CentOS 2";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-March/014760.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306877");
  ...
  script_name( "CentOS Update for unzip CESA-2008:0196-01 centos2 i386");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"unzip", rpm:"unzip~5.50~31.EL2.1", rls:"CentOS2")) != NULL)
  {
