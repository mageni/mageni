...
#
# Fedora Update for seamonkey FEDORA-2008-2812
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00010.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308395");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.1.9~1.fc7", rls:"FC7")) != NULL)
  {
