...
# $Id: fcore_2009_2983.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-2983 (java-1.6.0-openjdk)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2983";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307918");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.0~0.21.b09.fc9", rls:"FC9")) != NULL) {
    report += res;
}
