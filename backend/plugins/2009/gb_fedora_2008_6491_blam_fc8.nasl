...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00680.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309094");
  ...
  script_cve_id("CVE-2008-2785", "CVE-2008-2933", "CVE-2005-4790");
  script_name( "Fedora Update for blam FEDORA-2008-6491");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"blam", rpm:"blam~1.8.3~17.fc8", rls:"FC8")) != NULL)
  {
