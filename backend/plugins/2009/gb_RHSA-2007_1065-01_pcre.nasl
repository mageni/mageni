...
tag_affected = "pcre on Red Hat Enterprise Linux AS (Advanced Server) version 2.1,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2007-November/msg00004.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310830");
  ...
  script_name( "RedHat Update for pcre RHSA-2007:1065-01");
...
if(release == "RHENT_2.1")
{
  ...
  if ((res = isrpmvuln(pkg:"pcre", rpm:"pcre~3.4~2.4", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pcre-devel", rpm:"pcre-devel~3.4~2.4", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
