...
tag_affected = "evolution on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00157.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311170");
  ...
  script_name( "Fedora Update for evolution FEDORA-2008-4990");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"evolution", rpm:"evolution~2.22.2~2.fc9", rls:"FC9")) != NULL)
  {
