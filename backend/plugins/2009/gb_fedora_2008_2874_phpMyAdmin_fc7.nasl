...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00080.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311541");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-2874");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.5.1~1.fc7", rls:"FC7")) != NULL)
  {
