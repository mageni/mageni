...
tag_affected = "dovecot on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00844.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307688");
  ...
  script_name( "Fedora Update for dovecot FEDORA-2008-9232");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"dovecot", rpm:"dovecot~1.0.15~14.fc8", rls:"FC8")) != NULL)
  {
