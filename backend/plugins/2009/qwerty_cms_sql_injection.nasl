...
# $Id: qwerty_cms_sql_injection.nasl 14335 2019-03-19 14:46:57Z asteins $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Qwerty CMS is prone to an SQL-injection vulnerability because it fails to
...
foreach dir( make_list_unique( "/cms", "/qwerty", cgi_dirs( port:port ) ) ) {
  ...
  if( dir == "/" ) dir = "";
  url = string(dir, "/index.php?act=publ&id=-3+UNION+SELECT+1,2,3,4,0x53514c2d496e6a656374696f6e2d54657374");
