...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c00958403-1");
  script_oid("1.3.6.1.4.1.25623.1.0.308220");
  ...
  script_name( "HP-UX Update for DCE HPSBUX00276");
