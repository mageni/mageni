...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01064.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312049");
  ...
  script_name( "Fedora Update for Miro FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"Miro", rpm:"Miro~1.2.7~3.fc9", rls:"FC9")) != NULL)
  {
