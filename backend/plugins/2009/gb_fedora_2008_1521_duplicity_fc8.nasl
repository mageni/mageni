...
tag_affected = "duplicity on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00356.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308612");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-16 14:16:57 +0100 (Mon, 16 Feb 2009)");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-1521");
  script_cve_id("CVE-2007-5201");
  script_name( "Fedora Update for duplicity FEDORA-2008-1521");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"duplicity", rpm:"duplicity~0.4.9~1.fc8", rls:"FC8")) != NULL)
  {
