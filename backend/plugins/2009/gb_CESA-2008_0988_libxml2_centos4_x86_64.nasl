...
#
# CentOS Update for libxml2 CESA-2008:0988 centos4 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-November/015431.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309064");
  ...
  script_name( "CentOS Update for libxml2 CESA-2008:0988 centos4 x86_64");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.6.16~12.6", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libxml2-devel", rpm:"libxml2-devel~2.6.16~12.6", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libxml2-python", rpm:"libxml2-python~2.6.16~12.6", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
