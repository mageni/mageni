...
# $Id: fcore_2009_7567.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-7567 (seamonkey)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-7567";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310677");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.1.17~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"seamonkey-debuginfo", rpm:"seamonkey-debuginfo~1.1.17~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
