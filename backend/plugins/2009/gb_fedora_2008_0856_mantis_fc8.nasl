...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-January/msg00734.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308490");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"mantis", rpm:"mantis~1.1.1~1.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"mantis-config-httpd", rpm:"mantis-config-httpd~1.1.1~1.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
