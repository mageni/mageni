...
#
# Fedora Update for xine-lib FEDORA-2008-2945
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00143.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305561");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-16 16:22:52 +0100 (Mon, 16 Feb 2009)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-2945");
  script_cve_id("CVE-2008-0073", "CVE-2008-1482");
  script_name( "Fedora Update for xine-lib FEDORA-2008-2945");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"xine-lib", rpm:"xine-lib~1.1.11.1~1.fc7", rls:"FC7")) != NULL)
  {
