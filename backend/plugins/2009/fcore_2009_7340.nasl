...
# $Id: fcore_2009_7340.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-7340 (phpMyAdmin)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-7340";
tag_summary = "The remote host is missing an update to phpMyAdmin
announced via advisory FEDORA-2009-7340.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305935");
 ...
 script_name("Fedora Core 10 FEDORA-2009-7340 (phpMyAdmin)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.2.0.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
