...
# $Id: RHSA_2009_1658.nasl 6683 2017-07-12 09:41:57Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305166");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-1658.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"flash-plugin", rpm:"flash-plugin~9.0.260.0~1.el3.with.oss", rls:"RHENT_3")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"flash-plugin", rpm:"flash-plugin~9.0.260.0~1.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
