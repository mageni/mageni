...
tag_insight = "Multiple integer overflows might allow for the execution of arbitrary code
when performing base64 conversion.";
tag_solution = "All GLib 2.18 users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200904-02
http://bugs.gentoo.org/show_bug.cgi?id=249214";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309603");
