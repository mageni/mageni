...
#
# Fedora Update for google-gadgets FEDORA-2008-11511
#
# Authors:
...
tag_affected = "google-gadgets on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01008.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307777");
  ...
  script_name( "Fedora Update for google-gadgets FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"google-gadgets", rpm:"google-gadgets~0.10.3~2.fc10", rls:"FC10")) != NULL)
  {
