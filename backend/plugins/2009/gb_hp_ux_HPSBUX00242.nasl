...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c00958271-2");
  script_oid("1.3.6.1.4.1.25623.1.0.305326");
  ...
  script_name( "HP-UX Update for rpc.yppasswdd HPSBUX00242");
...
if(release == "HPUX11.00")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"NFS.NIS-SERVER", patch_list:['PHNE_28102'], rls:"HPUX11.00")) != NULL)
  {
...
if(release == "HPUX11.22")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"NFS.NIS-SERVER", patch_list:['PHNE_28138'], rls:"HPUX11.22")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX10.20")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"NFS.NIS-SERVER", patch_list:['PHNE_28886'], rls:"HPUX10.20")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"NFS.NIS-SERVER", patch_list:['PHNE_28103'], rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
