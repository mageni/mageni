...
#
# Fedora Update for epiphany FEDORA-2008-8425
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01339.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306491");
  ...
  script_name( "Fedora Update for epiphany FEDORA-2008-8425");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"epiphany", rpm:"epiphany~2.22.2~4.fc9", rls:"FC9")) != NULL)
  {
