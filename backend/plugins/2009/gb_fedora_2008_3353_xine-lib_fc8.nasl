...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00571.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304455");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"xine-lib", rpm:"xine-lib~1.1.12~2.fc8", rls:"FC8")) != NULL)
  {
