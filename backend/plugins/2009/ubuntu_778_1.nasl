...
# $Id: ubuntu_778_1.nasl 7969 2017-12-01 09:23:16Z santu $
# $Id: ubuntu_778_1.nasl 7969 2017-12-01 09:23:16Z santu $
...
tag_insight = "It was discovered that cron did not properly check the return code of
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306273");
 ...
 script_name("Ubuntu USN-778-1 (cron)");



 script_category(ACT_GATHER_INFO);
 script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-778-1/");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cron", ver:"3.0pl1-92ubuntu1.1", rls:"UBUNTU6.06 LTS")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cron", ver:"3.0pl1-100ubuntu2.1", rls:"UBUNTU8.04 LTS")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cron", ver:"3.0pl1-104+ubuntu5.1", rls:"UBUNTU8.10")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cron", ver:"3.0pl1-105ubuntu1.1", rls:"UBUNTU9.04")) != NULL) {
    report += res;
}
