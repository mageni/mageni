...
tag_affected = "tomboy on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-November/msg00206.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311397");
  ...
  script_name( "Fedora Update for tomboy FEDORA-2007-3011");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"tomboy", rpm:"tomboy~0.6.1~2.fc7", rls:"FC7")) != NULL)
  {
  ...
  if ((res = isrpmvuln(pkg:"tomboy-debuginfo", rpm:"tomboy-debuginfo~0.6.1~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
