...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-October/015357.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305707");
  ...
  script_name( "CentOS Update for ed CESA-2008:0946 centos4 i386");
