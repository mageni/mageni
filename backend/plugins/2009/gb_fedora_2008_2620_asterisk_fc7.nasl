...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00514.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307201");
  ...
  script_name( "Fedora Update for asterisk FEDORA-2008-2620");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.4.18.1~1.fc7", rls:"FC7")) != NULL)
  {
