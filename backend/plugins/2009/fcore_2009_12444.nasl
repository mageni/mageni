...
# $Id: fcore_2009_12444.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311156");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"awstats", rpm:"awstats~6.95~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
