...
# $Id: fcore_2009_4078.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310719");
 ...
 script_name("Fedora Core 9 FEDORA-2009-4078 (xulrunner)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~1.9.0.10~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~1.9.0.10~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"xulrunner-devel-unstable", rpm:"xulrunner-devel-unstable~1.9.0.10~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"xulrunner-debuginfo", rpm:"xulrunner-debuginfo~1.9.0.10~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
