...
#
# Fedora Update for gnome-web-photo FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01059.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309685");
  ...
  script_name( "Fedora Update for gnome-web-photo FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.3~16.fc9", rls:"FC9")) != NULL)
  {
