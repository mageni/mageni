...
tag_affected = "emacspeak on Fedora 9";
tag_insight = "Emacspeak is a speech interface that allows visually impaired users to
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00010.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308732");
  ...
  script_name( "Fedora Update for emacspeak FEDORA-2008-8379");

  script_tag(name:"summary", value:"Check for the Version of emacspeak");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"emacspeak", rpm:"emacspeak~28.0~3.fc9", rls:"FC9")) != NULL)
  {
