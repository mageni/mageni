...
#
# Solaris Update for Samba 114684-13
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.309080");
  ...
  script_name( "Solaris Update for Samba 114684-13");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-114684-13-1");
...
if(solaris_check_patch(release:"5.9", arch:"sparc", patch:"114684-13", package:"SUNWsmbau SUNWsmbaS SUNWsmbac SUNWsmbar") < 0)
{
  security_message(0);
  exit(0);
}