...
tag_insight = "Two vulnerabilities in ProFTPD might allow for SQL injection attacks.";
tag_solution = "All ProFTPD users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=net-ftp/proftpd-1.3.2'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-27
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305432");
