...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015106.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307223");
  ...
  script_name( "CentOS Update for pidgin CESA-2008:0584 centos4 i386");
