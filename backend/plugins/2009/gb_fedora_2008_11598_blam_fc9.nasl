...
#
# Fedora Update for blam FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01051.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304760");
  ...
  script_name( "Fedora Update for blam FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"blam", rpm:"blam~1.8.5~4.fc9.1", rls:"FC9")) != NULL)
  {
