...
#
# Fedora Update for epiphany FEDORA-2008-11511
#
# Authors:
...
tag_affected = "epiphany on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00998.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306920");
  ...
  script_name( "Fedora Update for epiphany FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"epiphany", rpm:"epiphany~2.24.1~3.fc10", rls:"FC10")) != NULL)
  {
