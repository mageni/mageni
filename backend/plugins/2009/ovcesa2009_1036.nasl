#CESA-2009:1036 64016 2
# $Id: ovcesa2009_1036.nasl 6650 2017-07-10 11:43:12Z cfischer $
...
tag_summary = "The remote host is missing updates to ipsec-tools announced in
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310781");
 ...
 script_name("CentOS Security Advisory CESA-2009:1036 (ipsec-tools)");
