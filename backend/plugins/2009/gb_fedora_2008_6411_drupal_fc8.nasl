...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00551.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308102");
 ...
 script_version("$Revision: 6623 $");
  ...
  script_xref(name: "FEDORA", value: "2008-6411");
  script_name( "Fedora Update for drupal FEDORA-2008-6411");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~5.8~1.fc8", rls:"FC8")) != NULL)
  {
