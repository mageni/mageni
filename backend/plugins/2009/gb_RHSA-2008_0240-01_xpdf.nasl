...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-April/msg00022.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311866");
  ...
  script_name( "RedHat Update for xpdf RHSA-2008:0240-01");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"xpdf", rpm:"xpdf~3.00~16.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xpdf-debuginfo", rpm:"xpdf-debuginfo~3.00~16.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
