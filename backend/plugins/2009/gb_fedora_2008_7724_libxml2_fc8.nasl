...
#
# Fedora Update for libxml2 FEDORA-2008-7724
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00162.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307671");
  ...
  script_name( "Fedora Update for libxml2 FEDORA-2008-7724");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.6.32~2.fc8", rls:"FC8")) != NULL)
  {
