...
tag_insight = "An input sanitation error in PEAR Net_Traceroute might allow remote
    attackers to execute arbitrary commands.";
tag_solution = "All PEAR Net_Traceroute users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308783");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-php/PEAR-Net_Traceroute", unaffected: make_list("ge 0.21.2"), vulnerable: make_list("lt 0.21.2"))) != NULL) {
    report += res;
}
