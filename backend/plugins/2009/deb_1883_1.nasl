...
# $Id: deb_1883_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
# Description: Auto-generated from advisory DSA 1883-1 (nagios2)
#
# Authors:
...
tag_insight = "Several vulnerabilities have been found in nagios2, ahost/service/network
...
announced via advisory DSA 1883-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201883-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308067");
 ...
 script_name("Debian Security Advisory DSA 1883-1 (nagios2)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"nagios2-doc", ver:"2.6-2+etch4", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios2-common", ver:"2.6-2+etch4", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios2", ver:"2.6-2+etch4", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios2-dbg", ver:"2.6-2+etch4", rls:"DEB4.0")) != NULL) {
    report += res;
}
