...
#
# CentOS Update for ed CESA-2008:0946 centos4 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-October/015356.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308975");
  ...
  script_name( "CentOS Update for ed CESA-2008:0946 centos4 x86_64");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"ed", rpm:"ed~0.2~36.el4_7.1", rls:"CentOS4")) != NULL)
  {
