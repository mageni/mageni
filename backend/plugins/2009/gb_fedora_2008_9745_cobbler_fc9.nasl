...
tag_affected = "cobbler on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00485.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304795");
 ...
 script_version("$Revision: 6623 $");
  ...
  script_xref(name: "FEDORA", value: "2008-9745");
  script_name( "Fedora Update for cobbler FEDORA-2008-9745");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~1.2.9~1.fc9", rls:"FC9")) != NULL)
  {
