...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-April/014818.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308291");
  ...
  script_name( "CentOS Update for squid CESA-2008:0214 centos3 i386");
