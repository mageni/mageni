...
tag_affected = "viewvc on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01101.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310823");
 ...
 script_version("$Revision: 6623 $");
  ...
  script_xref(name: "FEDORA", value: "2008-8252");
  script_name( "Fedora Update for viewvc FEDORA-2008-8252");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"viewvc", rpm:"viewvc~1.0.6~1.fc9", rls:"FC9")) != NULL)
  {
