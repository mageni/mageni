...
# $Id: fcore_2009_9550.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309417");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"bugzilla", rpm:"bugzilla~3.2.5~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"bugzilla-contrib", rpm:"bugzilla-contrib~3.2.5~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"bugzilla-doc", rpm:"bugzilla-doc~3.2.5~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
