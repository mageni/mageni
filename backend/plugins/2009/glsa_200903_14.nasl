...
tag_insight = "Incomplete verification of RSA and DSA certificates might lead to spoofed
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-14
http://bugs.gentoo.org/show_bug.cgi?id=254134
http://bugs.gentoo.org/show_bug.cgi?id=257949";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306093");
