...
tag_insight = "The yum-rhn-plugin provides support for yum to securely access a Red Hat
...
tag_affected = "yum-rhn-plugin on Red Hat Enterprise Linux (v. 5 server)";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-August/msg00014.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305853");
  ...
  script_name( "RedHat Update for yum-rhn-plugin RHSA-2008:0815-01");

  script_tag(name:"summary", value:"Check for the Version of yum-rhn-plugin");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"yum-rhn-plugin", rpm:"yum-rhn-plugin~0.5.3~12.el5_2.9", rls:"RHENT_5")) != NULL)
  {
