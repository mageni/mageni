...
#
# Fedora Update for samba FEDORA-2008-4797
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg01082.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306119");
  ...
  script_name( "Fedora Update for samba FEDORA-2008-4797");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~3.0.28a~1.fc7", rls:"FC7")) != NULL)
  {
