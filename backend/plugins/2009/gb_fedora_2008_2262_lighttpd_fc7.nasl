...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00162.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312135");
  ...
  script_name( "Fedora Update for lighttpd FEDORA-2008-2262");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"lighttpd", rpm:"lighttpd~1.4.18~3.fc7", rls:"FC7")) != NULL)
  {
