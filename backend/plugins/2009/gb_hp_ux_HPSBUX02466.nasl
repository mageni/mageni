...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c01908935-1");
  script_oid("1.3.6.1.4.1.25623.1.0.304926");
...
if(release == "HPUX11.31")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"hpuxws22TOMCAT.TOMCAT", revision:"B.5.5.27.03", rls:"HPUX11.31")) != NULL)
  {
...
if(release == "HPUX11.23")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"hpuxws22TOMCAT.TOMCAT", revision:"B.5.5.27.03", rls:"HPUX11.23")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"hpuxwsTOMCAT.TOMCAT", revision:"B.5.5.27.03", rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
