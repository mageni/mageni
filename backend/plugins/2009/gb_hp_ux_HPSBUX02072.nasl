...
tag_affected = "Trusted Mode remshd on
  HP-UX B.11.00, B.11.11, and B.11.23.";
tag_insight = "A potential vulnerability hs been identified with HP-UX systems running in 
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.305306");
...
if(release == "HPUX11.00")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"InternetSrvcs.INETSVCS-RUN", patch_list:['PHNE_33790'], rls:"HPUX11.00")) != NULL)
  {
...
if(release == "HPUX11.23")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"InternetSrvcs.INETSVCS2-RUN", patch_list:['PHNE_33792'], rls:"HPUX11.23")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"InternetSrvcs.INETSVCS-RUN", patch_list:['PHNE_33791'], rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
