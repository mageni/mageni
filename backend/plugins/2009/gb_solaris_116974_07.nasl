...
#
# Solaris Update for Apache 116974-07
#
# Authors:
...
tag_affected = "Apache on solaris_5.8_x86";
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.305179");
  ...
  script_name( "Solaris Update for Apache 116974-07");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-116974-07-1");
...
if(solaris_check_patch(release:"5.8", arch:"i386", patch:"116974-07", package:"SUNWapchS SUNWapchr SUNWapchd SUNWapchu") < 0)
{
  security_message(0);
  exit(0);
}
