...
# $Id: fcore_2009_10445.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to drupal-service_links
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311434");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=528200");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"drupal-service_links", rpm:"drupal-service_links~6.x.1.0~5.fc10", rls:"FC10")) != NULL) {
    report += res;
}
