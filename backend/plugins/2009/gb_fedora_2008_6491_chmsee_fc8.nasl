...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00684.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305589");
  ...
  script_name( "Fedora Update for chmsee FEDORA-2008-6491");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.0~3.31.fc8", rls:"FC8")) != NULL)
  {
