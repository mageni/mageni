...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00587.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309828");
  ...
  script_name( "Fedora Update for kernel FEDORA-2008-5308");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~2.6.25.6~55.fc9", rls:"FC9")) != NULL)
  {
