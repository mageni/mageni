...
tag_insight = "Multiple errors in LittleCMS allow for attacks including the remote
    execution of arbitrary code.";
tag_solution = "All LittleCMS users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309728");
 ...
 script_name("Gentoo Security Advisory GLSA 200904-19 (littlecms)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-libs/lcms", unaffected: make_list("ge 1.18-r1"), vulnerable: make_list("lt 1.18-r1"))) != NULL) {
    report += res;
}
