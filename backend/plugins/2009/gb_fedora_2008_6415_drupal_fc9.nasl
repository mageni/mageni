...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00527.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305820");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.3~1.fc9", rls:"FC9")) != NULL)
  {
