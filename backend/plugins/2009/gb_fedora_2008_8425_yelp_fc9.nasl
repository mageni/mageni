...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01354.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306899");
  ...
  script_name( "Fedora Update for yelp FEDORA-2008-8425");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"yelp", rpm:"yelp~2.22.1~5.fc9", rls:"FC9")) != NULL)
  {
