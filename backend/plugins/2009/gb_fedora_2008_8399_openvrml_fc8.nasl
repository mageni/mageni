...
#
# Fedora Update for openvrml FEDORA-2008-8399
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01376.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309511");
  ...
  script_name( "Fedora Update for openvrml FEDORA-2008-8399");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"openvrml", rpm:"openvrml~0.17.8~2.0.fc8", rls:"FC8")) != NULL)
  {
