...
tag_affected = "drupal on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00806.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309273");
  ...
  script_name( "Fedora Update for drupal FEDORA-2008-11237");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.7~1.fc10", rls:"FC10")) != NULL)
  {
