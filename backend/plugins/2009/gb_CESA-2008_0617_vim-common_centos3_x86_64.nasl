...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-November/015439.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310840");
  ...
  script_name( "CentOS Update for vim-common CESA-2008:0617 centos3 x86_64");
