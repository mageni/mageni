...
#
# CentOS Update for cups CESA-2008:1028 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-December/015484.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311052");
  ...
  script_name( "CentOS Update for cups CESA-2008:1028 centos3 i386");
