...
# $Id: fcore_2009_10981.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308980");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"blam", rpm:"blam~1.8.5~15.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"blam-debuginfo", rpm:"blam-debuginfo~1.8.5~15.fc10", rls:"FC10")) != NULL) {
    report += res;
}
