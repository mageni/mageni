...
# $Id: fcore_2009_12663.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306053");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=538459");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"dstat", rpm:"dstat~0.6.9~5.fc11", rls:"FC11")) != NULL) {
    report += res;
}
