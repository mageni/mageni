...
#
# Fedora Update for chmsee FEDORA-2007-2679
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-October/msg00432.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310594");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-27 16:01:32 +0100 (Fri, 27 Feb 2009)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2007-2679");
  script_name( "Fedora Update for chmsee FEDORA-2007-2679");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.0~1.25.fc7", rls:"FC7")) != NULL)
  {
  ...
  if ((res = isrpmvuln(pkg:"chmsee-debuginfo", rpm:"chmsee-debuginfo~1.0.0~1.25.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
