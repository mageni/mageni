...
#
# Fedora Update for openldap FEDORA-2008-1307
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00105.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310260");
  ...
  script_name( "Fedora Update for openldap FEDORA-2008-1307");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.3.34~6.fc7", rls:"FC7")) != NULL)
  {
