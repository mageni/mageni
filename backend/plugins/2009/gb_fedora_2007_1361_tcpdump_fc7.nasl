...
#
# Fedora Update for tcpdump FEDORA-2007-1361
#
# Authors:
...
tag_affected = "tcpdump on Fedora 7";
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.305151");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"tcpdump", rpm:"tcpdump~3.9.7~1.fc7", rls:"FC7")) != NULL)
  {
  ...
  if ((res = isrpmvuln(pkg:"tcpdump-debuginfo", rpm:"tcpdump-debuginfo~3.9.7~1.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
