...
tag_affected = "adminutil on Fedora 8";
tag_insight = "adminutil is libraries of functions used to administer directory
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00218.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307549");
  ...
  script_name( "Fedora Update for adminutil FEDORA-2008-7642");

  script_tag(name:"summary", value:"Check for the Version of adminutil");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"adminutil", rpm:"adminutil~1.1.7~1.fc8", rls:"FC8")) != NULL)
  {
