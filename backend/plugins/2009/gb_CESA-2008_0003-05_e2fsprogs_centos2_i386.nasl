...
#
# CentOS Update for e2fsprogs CESA-2008:0003-05 centos2 i386
#
# Authors:
...
tag_affected = "e2fsprogs on CentOS 2";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-January/014583.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307270");
  ...
  script_name( "CentOS Update for e2fsprogs CESA-2008:0003-05 centos2 i386");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"e2fsprogs", rpm:"e2fsprogs~1.26~1.73", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"e2fsprogs-devel", rpm:"e2fsprogs-devel~1.26~1.73", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
