...
#
# CentOS Update for rdesktop CESA-2008:0576 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-July/015163.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305876");
  ...
  script_name( "CentOS Update for rdesktop CESA-2008:0576 centos3 i386");
