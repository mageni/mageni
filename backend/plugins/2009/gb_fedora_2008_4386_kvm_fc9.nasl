...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg00706.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309844");
  ...
  script_name( "Fedora Update for kvm FEDORA-2008-4386");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"kvm", rpm:"kvm~65~7.fc9", rls:"FC9")) != NULL)
  {
