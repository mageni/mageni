...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309086");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ethereal", rpm:"ethereal~0.10.14~16.40.1", rls:"SLES10.0")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ethereal-devel", rpm:"ethereal-devel~0.10.14~16.40.1", rls:"SLES10.0")) != NULL) {
    report += res;
}
