...
# $Id: fcore_2009_1914.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_insight = "Crypt::OpenSSL::DSA - Digital Signature Algorithm using OpenSSL
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310556");
 ...
 script_name("Fedora Core 9 FEDORA-2009-1914 (perl-Crypt-OpenSSL-DSA)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"perl-Crypt-OpenSSL", rpm:"perl-Crypt-OpenSSL~DSA~0.13", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"perl-Crypt-OpenSSL", rpm:"perl-Crypt-OpenSSL~DSA~debuginfo", rls:"FC9")) != NULL) {
    report += res;
}
