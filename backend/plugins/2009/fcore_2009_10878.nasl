...
# $Id: fcore_2009_10878.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_summary = "The remote host is missing an update to chmsee
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305083");
 script_version("$Revision: 6624 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:11:55 +0200 (Mon, 10 Jul 2017) $");
 script_tag(name:"creation_date", value:"2009-11-11 15:56:44 +0100 (Wed, 11 Nov 2009)");
 script_cve_id("CVE-2009-0689", "CVE-2009-3380", "CVE-2009-3370", "CVE-2009-3274", "CVE-2009-3373", "CVE-2009-3372", "CVE-2009-3375", "CVE-2009-3374", "CVE-2009-3376");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.1~12.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"chmsee-debuginfo", rpm:"chmsee-debuginfo~1.0.1~12.fc11", rls:"FC11")) != NULL) {
    report += res;
}
