...
#
# Fedora Update for evolution-rss FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01057.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305328");
  ...
  script_name( "Fedora Update for evolution-rss FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"evolution-rss", rpm:"evolution-rss~0.1.0~5.fc9", rls:"FC9")) != NULL)
  {
