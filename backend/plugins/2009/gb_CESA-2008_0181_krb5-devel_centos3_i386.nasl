...
#
# CentOS Update for krb5-devel CESA-2008:0181 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-March/014754.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305224");
  ...
  script_name( "CentOS Update for krb5-devel CESA-2008:0181 centos3 i386");
