...
# $Id: deb_1725_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "Bas van Schaik discovered that WebSVN, a tool to view Subversion
...
tag_summary = "The remote host is missing an update to websvn
announced via advisory DSA 1725-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201725-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307416");
 ...
 script_name("Debian Security Advisory DSA 1725-1 (websvn)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"websvn", ver:"2.0-4+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
