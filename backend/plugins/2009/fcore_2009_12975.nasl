...
# $Id: fcore_2009_12975.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309437");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=542394");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"trac", rpm:"trac~0.11.6~1.fc12", rls:"FC12")) != NULL) {
    report += res;
}
