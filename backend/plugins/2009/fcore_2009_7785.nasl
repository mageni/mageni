...
# $Id: fcore_2009_7785.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-7785 (mediawiki)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-7785";
tag_summary = "The remote host is missing an update to mediawiki
announced via advisory FEDORA-2009-7785.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308326");
 script_version("$Revision: 6624 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:11:55 +0200 (Mon, 10 Jul 2017) $");
 script_tag(name:"creation_date", value:"2009-07-29 19:28:37 +0200 (Wed, 29 Jul 2009)");
 script_tag(name:"cvss_base", value:"4.3");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
 script_name("Fedora Core 11 FEDORA-2009-7785 (mediawiki)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mediawiki", rpm:"mediawiki~1.15.1~48.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mediawiki-math", rpm:"mediawiki-math~1.15.1~48.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mediawiki-nomath", rpm:"mediawiki-nomath~1.15.1~48.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"mediawiki-debuginfo", rpm:"mediawiki-debuginfo~1.15.1~48.fc11", rls:"FC11")) != NULL) {
    report += res;
}
