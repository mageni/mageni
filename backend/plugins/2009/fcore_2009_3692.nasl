...
# $Id: fcore_2009_3692.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305167");
 ...
 script_name("Fedora Core 9 FEDORA-2009-3692 (phpMyAdmin)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.1.3.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
