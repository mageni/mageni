...
tag_affected = "asterisk on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg01298.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307198");
  ...
  script_name( "Fedora Update for asterisk FEDORA-2008-6853");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.6.0~0.19.beta9.fc9", rls:"FC9")) != NULL)
  {
