...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00445.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308763");
  ...
  script_name( "Fedora Update for yelp FEDORA-2008-3249");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"yelp", rpm:"yelp~2.18.1~11.fc7", rls:"FC7")) != NULL)
  {
