...
#
# Fedora Update for evolution-rss FEDORA-2008-11511
#
# Authors:
...
tag_affected = "evolution-rss on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01002.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308284");
  ...
  script_name( "Fedora Update for evolution-rss FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"evolution-rss", rpm:"evolution-rss~0.1.2~3.fc10", rls:"FC10")) != NULL)
  {
