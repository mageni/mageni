...
tag_affected = "python-paramiko on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-January/msg00594.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306797");
  ...
  script_name( "Fedora Update for python-paramiko FEDORA-2008-0722");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"python-paramiko", rpm:"python-paramiko~1.7.1~3.fc7", rls:"FC7")) != NULL)
  {
