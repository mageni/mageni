...
# $Id: fcore_2009_10595.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-10595 (ocaml-postgresql)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-10595";
tag_summary = "The remote host is missing an update to ocaml-postgresql
announced via advisory FEDORA-2009-10595.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307233");
 ...
 script_name("Fedora Core 10 FEDORA-2009-10595 (ocaml-postgresql)");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=529325");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ocaml-postgresql", rpm:"ocaml-postgresql~1.12.3~1.fc10.2", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ocaml-postgresql-devel", rpm:"ocaml-postgresql-devel~1.12.3~1.fc10.2", rls:"FC10")) != NULL) {
    report += res;
}
