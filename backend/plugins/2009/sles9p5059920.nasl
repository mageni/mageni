...
# $Id: sles9p5059920.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
5059920 within the SuSE Enterprise Server 9 patch
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305846");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mozilla", rpm:"mozilla~1.8_seamonkey_1.1.17~0.6", rls:"SLES9.0")) != NULL) {
    report += res;
}
