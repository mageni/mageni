...
# $Id: bugzilla_36373.nasl 14031 2019-03-07 10:47:29Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Bugzilla 2.23.4 through 3.0.8 Bugzilla 3.1.1 through 3.2.4 Bugzilla 3.3.1 through 3.4.1");
