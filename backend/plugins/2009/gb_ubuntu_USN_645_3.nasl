...
# $Id: gb_ubuntu_USN_645_3.nasl 7969 2017-12-01 09:23:16Z santu $
#
...
if(description)
{
  script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-645-3/");
  script_oid("1.3.6.1.4.1.25623.1.0.307379");
