...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-April/014843.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310806");
  ...
  script_name( "CentOS Update for speex CESA-2008:0235 centos4 i386");
