...
#
# CentOS Update for cups CESA-2008:0498 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/014961.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305012");
  ...
  script_name( "CentOS Update for cups CESA-2008:0498 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"cups", rpm:"cups~1.1.17~13.3.53", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-devel", rpm:"cups-devel~1.1.17~13.3.53", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.1.17~13.3.53", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
