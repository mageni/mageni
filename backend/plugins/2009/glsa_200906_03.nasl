...
tag_insight = "Multiple errors in phpMyAdmin might allow the remote execution of arbitrary
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200906-03
http://bugs.gentoo.org/show_bug.cgi?id=263711";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311775");
