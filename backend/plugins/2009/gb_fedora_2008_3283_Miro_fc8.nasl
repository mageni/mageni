...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00493.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309205");
  ...
  script_name( "Fedora Update for Miro FEDORA-2008-3283");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"Miro", rpm:"Miro~1.2~2.fc8", rls:"FC8")) != NULL)
  {
