...
tag_affected = "uw-imap on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00058.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310824");
 ...
 script_version("$Revision: 6623 $");
  ...
  script_name( "Fedora Update for uw-imap FEDORA-2008-9383");

  script_tag(name:"summary", value:"Check for the Version of uw-imap");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"uw-imap", rpm:"uw-imap~2007d~1.fc8", rls:"FC8")) != NULL)
  {
