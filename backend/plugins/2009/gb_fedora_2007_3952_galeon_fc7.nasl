...
#
# Fedora Update for galeon FEDORA-2007-3952
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-November/msg01007.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305412");
  ...
  script_name( "Fedora Update for galeon FEDORA-2007-3952");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.3~14.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"galeon-debuginfo", rpm:"galeon-debuginfo~2.0.3~14.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
