...
tag_affected = "pdns-recursor on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg01353.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307738");
  ...
  script_name( "Fedora Update for pdns-recursor FEDORA-2008-6893");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"pdns-recursor", rpm:"pdns-recursor~3.1.7~2.fc9", rls:"FC9")) != NULL)
  {
