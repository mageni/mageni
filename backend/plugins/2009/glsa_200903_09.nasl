...
tag_insight = "Multiple buffer overflows in OpenTTD might allow for the execution of
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-09
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310252");
