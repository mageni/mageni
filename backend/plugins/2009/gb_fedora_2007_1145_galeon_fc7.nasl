...
#
# Fedora Update for galeon FEDORA-2007-1145
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-July/msg00351.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305126");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-27 15:48:41 +0100 (Fri, 27 Feb 2009)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2007-1145");
  script_name( "Fedora Update for galeon FEDORA-2007-1145");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.3~10.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"galeon-debuginfo", rpm:"galeon-debuginfo~2.0.3~10.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
