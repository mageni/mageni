...
# $Id: sles9p5055024.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
5055024 within the SuSE Enterprise Server 9 patch
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310191");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"jakarta-tomcat-examples", rpm:"jakarta-tomcat-examples~5.0.19~29.23", rls:"SLES9.0")) != NULL) {
    report += res;
}
