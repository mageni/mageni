...
#
# Fedora Update for drupal-cck FEDORA-2008-10000
#
# Authors:
...
tag_affected = "drupal-cck on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00765.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305618");
  ...
  script_name( "Fedora Update for drupal-cck FEDORA-2008-10000");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-cck", rpm:"drupal-cck~6.x.2.0~3.fc10", rls:"FC10")) != NULL)
  {
