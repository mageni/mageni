...
tag_affected = "pam_mount on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00730.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307124");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"pam_mount", rpm:"pam_mount~0.47~1.fc8", rls:"FC8")) != NULL)
  {
