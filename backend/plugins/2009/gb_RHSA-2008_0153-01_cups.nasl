...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-February/msg00014.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310353");
  ...
  script_name( "RedHat Update for cups RHSA-2008:0153-01");
...
if(release == "RHENT_3")
{
  ...
  if ((res = isrpmvuln(pkg:"cups", rpm:"cups~1.1.17~13.3.51", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-debuginfo", rpm:"cups-debuginfo~1.1.17~13.3.51", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-devel", rpm:"cups-devel~1.1.17~13.3.51", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.1.17~13.3.51", rls:"RHENT_3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
