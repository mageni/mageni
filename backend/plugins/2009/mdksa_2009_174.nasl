...
# $Id: mdksa_2009_174.nasl 6587 2017-07-07 06:35:35Z cfischer $
# Description: Auto-generated from advisory MDVSA-2009:174 (perl-Compress-Raw-Zlib)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:174";
tag_summary = "The remote host is missing an update to perl-Compress-Raw-Zlib
announced via advisory MDVSA-2009:174.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306799");
 ...
 script_name("Mandrake Security Advisory MDVSA-2009:174 (perl-Compress-Raw-Zlib)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"perl-Compress-Raw-Zlib", rpm:"perl-Compress-Raw-Zlib~2.015~1.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
