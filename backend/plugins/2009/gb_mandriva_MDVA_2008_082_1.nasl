...
#
# Mandriva Update for timezone MDVA-2008:082-1 (timezone)
#
# Authors:
...
tag_affected = "timezone on Mandriva Linux 2008.1,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-06/msg00010.php");
  script_oid("1.3.6.1.4.1.25623.1.0.310859");
  script_version("$Revision: 6568 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-06 15:04:21 +0200 (Thu, 06 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-04-09 14:05:19 +0200 (Thu, 09 Apr 2009)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_xref(name: "MDVA", value: "2008:082-1");
  script_name( "Mandriva Update for timezone MDVA-2008:082-1 (timezone)");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"timezone-2008c", rpm:"timezone-2008c~1.5mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"timezone-java-2008c", rpm:"timezone-java-2008c~1.5mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
