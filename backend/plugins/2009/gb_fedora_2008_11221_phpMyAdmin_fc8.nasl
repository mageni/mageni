...
#
# Fedora Update for phpMyAdmin FEDORA-2008-11221
#
# Authors:
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.305300");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-11221");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.1.1~1.fc8", rls:"FC8")) != NULL)
  {
