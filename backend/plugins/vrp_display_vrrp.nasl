...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150289");
  script_version("2020-10-06T07:31:27+0000");
  script_tag(name:"last_modification", value:"2020-10-07 09:36:44 +0000 (Wed, 07 Oct 2020)");
  script_tag(name:"creation_date", value:"2020-07-13 13:28:12 +0000 (Mon, 13 Jul 2020)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");

  script_name("Huawei Data Communication: Read display vrrp");
  ...
  script_tag(name:"summary", value:"Get the current VRRP configuration of the VRP device.
...
if(!ret){
  set_kb_item(name:"Policy/vrp/vrrp/ERROR", value:TRUE);
  exit(0);
}

set_kb_item(name:"Policy/vrp/vrrp", value:ret);
