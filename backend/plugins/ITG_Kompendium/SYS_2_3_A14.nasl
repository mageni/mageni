...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150602");
  ...
  script_tag(name:"summary", value:"Peripheriegeraete SOLLTEN nur nutzbar sein, wenn sie auf einer
zentral verwalteten Whitelist gefuehrt sind. Kernelmodule fuer Peripheriegeraete SOLLTEN nur geladen
und aktiviert werden, wenn das Geraet auf der Whitelist steht.");
...
title = "Absicherung gegen Nutzung unbefugter Peripheriegeraete";

if (host_runs("linux") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.3.A14");
  exit(0);
}
