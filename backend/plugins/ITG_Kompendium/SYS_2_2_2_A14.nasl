...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150000");
...
Die Kern-Anforderung 'A14: Anwendungssteuerung mit Software Restriction Policies und AppLocker' beschreibt,
dass SRP oder AppLocker aktiviert und konfiguriert sein sollten.");
...
title = "Anwendungssteuerung mit Software Restriction Policies und AppLocker";

if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A14");
  exit(0);
}
