...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109989");
...
"gsf/Policy/WindowsDefenderAV/defav_turn_off_defender.nasl");
...
Die Basis-Anforderung 'A3: Einsatz von Viren-Schutzprogrammen' beschreibt, dass ein Viren-Schutzprogramm
aktiv sein muss.

NOTE: Dieser Test prueft den Einsatz von Microsoft Windows Defender Antivirus.");
...
title = "Einsatz von Viren-Schutzprogrammen";
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109170");


if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A3");
  exit(0);
}
