...
set_kb_item(name:"GSHB/SYS.2.2.3.A8/title", value:title);
...
set_kb_item(name:"GSHB/SYS.2.2.3.A8/result", value:result);
set_kb_item(name:"GSHB/SYS.2.2.3.A8/desc", value:desc);
