...
if(description)
{
  script_version("2021-03-12T14:41:38+0000");
  script_oid("1.3.6.1.4.1.25623.1.0.150591");
  script_tag(name:"last_modification", value:"2021-03-12 14:41:38 +0000 (Fri, 12 Mar 2021)");
  ...
  script_tag(name:"summary", value:"Es SOLLTEN speziell gehaertete Kernels (z. B. grsecurity, PaX)
und geeignete Schutzmassnahmen wie Speicherschutz oder Dateisystemabsicherung umgesetzt werden, die
eine Ausnutzung von Schwachstellen und die Ausbreitung im Betriebssystem verhindern.");
...
if (host_runs("linux") != "yes"){
  ...
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.1.3.A17");
  exit(0);
}
