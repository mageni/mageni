...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150014");
...
"Policy/WindowsGeneral/SCM/win_lsa_protection.nasl");
...
Die Standard-Anforderung 'A6: Sichere Authentisierung und Autorisierung in Windows Server 2012'
beschreibt, wie die Authentisierung und Autorisierung konfiguriert sein sollte.");
...
title = "Sichere Authentisierung und Autorisierung in Windows Server 2012";
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109604",
"1.3.6.1.4.1.25623.1.0.109605");

if (host_runs("windows_server_2012") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.1.2.2.A6");
  exit(0);
}
