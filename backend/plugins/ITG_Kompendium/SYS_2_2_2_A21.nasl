...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150007");
...
Die Kern-Anforderung 'A21: Einsatz von File und Registry Virtualization' beschreibt, dass der Betrieb
von Altanwendungen konfiguriert sein muss.");
...
title = "Einsatz von File und Registry Virtualization";
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109249");

if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A21");
  exit(0);
}
