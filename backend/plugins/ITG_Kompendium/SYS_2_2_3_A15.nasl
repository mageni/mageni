...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109977");
...
"gsf/Policy/Windows10/Network/win_autoconnect_allowed_oem.nasl");
...
Die Standard-Anforderung 'A15: Einsatz der Synchronisationsmechanismen in Windows 10' beschreibt,
dass Nutzerdaten nicht mit Microsoft Cloud-Diensten synchronisiert und WLAN-Passwoerter nicht
...
title = "Einsatz der Synchronisationsmechanismen in Windows 10";
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109339");
...
itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.3.A15");
