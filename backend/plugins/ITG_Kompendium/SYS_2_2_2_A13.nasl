...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109999");
...
Die Standard-Anforderung 'A13: Anbindung von Windows 8.1 an AppStores' beschreibt, dass der Microsoft
AppStore deaktiviert werden sollte.");
...
title = "Anbindung von Windows 8.1 an AppStores";
...
oid_list = make_list("1.3.6.1.4.1.25623.1.0.109484");

if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A13");
  exit(0);
}
