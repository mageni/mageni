...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.107552");
  script_version("$Revision: 13691 $");
  script_tag(name:"last_modification", value:"$Date: 2019-02-15 11:59:06 +0100 (Fri, 15 Feb 2019) $");
  script_tag(name:"creation_date", value:"2019-02-12 12:04:49 +0100 (Tue, 12 Feb 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("Unified Automation UaExpert Version Detection (Windows)");
  ...
  of Unified Automation UaExpert for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "UaExpert") continue;
    ...
    set_kb_item(name:"unifiedautomation/uaexpert/win/detected", value:TRUE);

    register_and_report_cpe(app:"Unified Automation " + appName, ver:version, concluded:concluded,
                          base:"cpe:/a:unfiedautomation:uaexpert:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0);
    exit(0);
  }
}
