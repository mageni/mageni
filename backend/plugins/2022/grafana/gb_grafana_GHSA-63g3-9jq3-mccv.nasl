...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147616");
  script_version("2022-02-10T03:12:06+0000");
  script_tag(name:"last_modification", value:"2022-02-10 11:02:19 +0000 (Thu, 10 Feb 2022)");
  script_tag(name:"creation_date", value:"2022-02-10 03:00:50 +0000 (Thu, 10 Feb 2022)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:N/A:N");

  script_cve_id("CVE-2022-21713");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Grafana IDOR Vulnerability (GHSA-63g3-9jq3-mccv)");
  ...
  script_tag(name:"summary", value:"Grafana is prone to an insecure direct object reference (IDOR)
  vulnerability on Grafana Teams APIs.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"This vulnerability only impacts the following API endpoints:
  ...
  script_tag(name:"affected", value:"Grafana version 5.0.0-beta1 through 7.5.14 and 8.x through
  8.3.4.");

  script_tag(name:"solution", value:"Update to version 7.5.15, 8.3.5 or later.");

  script_xref(name:"URL", value:"https://github.com/grafana/grafana/security/advisories/GHSA-63g3-9jq3-mccv");
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.0.0", test_version_up: "7.5.15")) {
