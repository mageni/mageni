...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147727");
  script_version("2022-03-01T08:05:07+0000");
  script_tag(name:"last_modification", value:"2022-03-01 11:00:30 +0000 (Tue, 01 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-01 07:03:47 +0000 (Tue, 01 Mar 2022)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");

  script_cve_id("CVE-2022-0193");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Complianz - GDPR/CCPA Cookie Consent Plugin < 6.0.0 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not escape the 's' parameter before outputting
  it back in an attribute in an admin page, leading to a reflected XSS.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/30d1d328-9f19-4c4c-b90a-04937d617864");
