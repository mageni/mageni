...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147664");
  script_version("2022-02-21T14:09:09+0000");
  script_tag(name:"last_modification", value:"2022-02-22 11:21:00 +0000 (Tue, 22 Feb 2022)");
  script_tag(name:"creation_date", value:"2022-02-21 04:13:10 +0000 (Mon, 21 Feb 2022)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"severity_vector", value:"CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2019-08-21 18:54:00 +0000 (Wed, 21 Aug 2019)");

  script_cve_id("CVE-2018-20978");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Import any XML or CSV File to WordPress Plugin < 3.6.3 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not escape the Import's Title and Unique
  Identifier fields before outputting them in admin pages, which could allow high privilege users
  ...
  version 3.6.2 and prior.");

  script_tag(name:"solution", value:"Update to version 3.6.3 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/a8d314b9-26ac-4b56-a85c-a2528e55e73a");
