...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147462");
  script_version("2022-01-18T09:22:40+0000");
  script_tag(name:"last_modification", value:"2022-01-19 11:07:58 +0000 (Wed, 19 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-18 09:21:04 +0000 (Tue, 18 Jan 2022)");
  script_tag(name:"cvss_base", value:"3.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:N");

  script_cve_id("CVE-2021-25065");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Smash Balloon Social Post Feed Plugin < 4.1.1 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin is affected by a reflected XSS in
  custom-facebook-feed in cff-top admin page.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/ae1aab4e-b00a-458b-a176-85761655bdcc");
