...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147733");
  script_version("2022-03-01T08:05:07+0000");
  script_tag(name:"last_modification", value:"2022-03-01 11:00:30 +0000 (Tue, 01 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-01 08:01:59 +0000 (Tue, 01 Mar 2022)");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");

  script_cve_id("CVE-2022-0255");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Database Backup for WordPress Plugin < 2.5.1 SQLi Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin does not properly sanitise and escape the fragment
  parameter before using it in a SQL statement in the admin dashboard, leading to a SQL injection
  issue.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/684bb06d-864f-4cba-ab0d-f83974d026fa");
