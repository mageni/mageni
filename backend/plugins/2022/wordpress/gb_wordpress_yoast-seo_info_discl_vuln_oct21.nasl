...
if (description)
{
  ...
  script_name("WordPress Yoast SEO Plugin < 17.3 Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin Yoast SEO is prone to an information
  disclosure vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"WordPress Yoast SEO plugin version 17.2 and prior.");
...
if (version_is_less(version: version, test_version: "17.3")) {
