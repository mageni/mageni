...
if(description)
{
  ...
  script_version("2022-02-27T02:00:06+0000");
  ...
  script_name("Debian LTS: Security Advisory for htmldoc (DLA-2928-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/02/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2928-1");
  script_xref(name:"Advisory-ID", value:"DLA-2928-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'htmldoc'
  package(s) announced via the DLA-2928-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several issues have been found in htmldoc, an HTML processor that
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.8.27-8+deb9u2", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"htmldoc-common", ver:"1.8.27-8+deb9u2", rls:"DEB9"))) {
  report += res;
}
