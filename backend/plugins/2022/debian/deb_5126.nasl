...
if(description)
{
  ...
  script_version("2022-05-03T01:00:04+0000");
  ...
  script_name("Debian: Security Advisory for ffmpeg (DSA-5126-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5126.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5126-1");
  script_xref(name:"Advisory-ID", value:"DSA-5126-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ffmpeg'
  package(s) announced via the DSA-5126-1 advisory.");
