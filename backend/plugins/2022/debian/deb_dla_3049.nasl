...
if(description)
{
  ...
  script_version("2022-06-10T08:50:07+0000");
  ...
  script_name("Debian LTS: Security Advisory for mailman (DLA-3049-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/06/msg00011.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3049-1");
  script_xref(name:"Advisory-ID", value:"DLA-3049-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1000367");
  script_xref(name:"URL", value:"https://bugs.debian.org/1001685");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman'
  package(s) announced via the DLA-3049-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in Mailman, a web-based
