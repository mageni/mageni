...
if(description)
{
  ...
  script_name("Debian: Security Advisory for wpewebkit (DSA-5061-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5061.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5061-1");
  script_xref(name:"Advisory-ID", value:"DSA-5061-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wpewebkit'
  package(s) announced via the DSA-5061-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libwpewebkit-1.0-3", ver:"2.34.4-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libwpewebkit-1.0-dev", ver:"2.34.4-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libwpewebkit-1.0-doc", ver:"2.34.4-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"wpewebkit-driver", ver:"2.34.4-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
