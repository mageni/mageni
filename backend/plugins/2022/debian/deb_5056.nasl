...
if(description)
{
  ...
  script_version("2022-01-26T02:00:34+0000");
  script_cve_id("CVE-2021-45079");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-01-26 02:00:34 +0000 (Wed, 26 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-26 02:00:34 +0000 (Wed, 26 Jan 2022)");
  script_name("Debian: Security Advisory for strongswan (DSA-5056-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5056.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5056-1");
  ...
  package(s) announced via the DSA-5056-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Zhuowei Zhang discovered a bug in the EAP authentication client code of
...
upstream advisory at [link moved to references]");
