...
if(description)
{
  ...
  script_version("2022-01-18T02:00:05+0000");
  ...
  script_name("Debian LTS: Security Advisory for uriparser (DLA-2883-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00010.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2883-1");
  script_xref(name:"Advisory-ID", value:"DLA-2883-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'uriparser'
  package(s) announced via the DLA-2883-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there were two 'invalid free' issues in
uriparser, a C library for parsing URLs according to RFC 3986.");
