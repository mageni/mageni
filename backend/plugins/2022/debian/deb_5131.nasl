...
if(description)
{
  ...
  script_version("2022-05-06T01:00:17+0000");
  ...
  script_name("Debian: Security Advisory for openjdk-11 (DSA-5131-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5131.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5131-1");
  ...
  package(s) announced via the DSA-5131-1 advisory.");
