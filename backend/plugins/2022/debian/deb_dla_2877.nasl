...
if(description)
{
  ...
  script_version("2022-01-13T02:00:06+0000");
  ...
  script_name("Debian LTS: Security Advisory for gdal (DLA-2877-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00004.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2877-1");
  ...
  package(s) announced via the DLA-2877-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two issues were found in GDAL, a geospatial library, that could lead to
