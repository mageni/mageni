...
if(description)
{
  ...
  script_version("2022-03-10T02:01:05+0000");
  ...
  script_name("Debian: Security Advisory for linux (DSA-5096-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5096.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5096-1");
  script_xref(name:"Advisory-ID", value:"DSA-5096-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux'
  package(s) announced via the DSA-5096-1 advisory.");
...
if(!isnull(res = isdpkgvuln(pkg:"liblockdep-dev", ver:"4.19.232-1", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"liblockdep4.19", ver:"4.19.232-1", rls:"DEB10"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"lockdep", ver:"4.19.232-1", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"usbip", ver:"4.19.232-1", rls:"DEB10"))) {
  report += res;
}
