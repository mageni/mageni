...
if(description)
{
  ...
  script_version("2022-01-25T02:00:05+0000");
  ...
  script_name("Debian LTS: Security Advisory for qt4-x11 (DLA-2895-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2895-1");
  ...
  package(s) announced via the DLA-2895-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple out-of-bounds errors were discovered in qt4-x11.
