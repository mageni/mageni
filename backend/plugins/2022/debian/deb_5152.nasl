...
if(description)
{
  ...
  script_version("2022-05-31T08:35:24+0000");
  ...
  script_name("Debian: Security Advisory for spip (DSA-5152-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5152.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5152-1");
  script_xref(name:"Advisory-ID", value:"DSA-5152-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spip'
  package(s) announced via the DSA-5152-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"3.2.11-3+deb11u4", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"3.2.4-1+deb10u8", rls:"DEB10"))) {
  report += res;
}
