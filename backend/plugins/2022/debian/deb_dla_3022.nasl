...
if(description)
{
  ...
  script_version("2022-05-26T01:00:06+0000");
  script_cve_id("CVE-2022-1664");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-05-26 01:00:06 +0000 (Thu, 26 May 2022)");
  script_tag(name:"creation_date", value:"2022-05-26 01:00:06 +0000 (Thu, 26 May 2022)");
  script_name("Debian LTS: Security Advisory for dpkg (DLA-3022-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00033.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3022-1");
  ...
  package(s) announced via the DLA-3022-1 advisory.");
