...
if(description)
{
  ...
  script_version("2022-04-11T01:00:12+0000");
  ...
  script_name("Debian LTS: Security Advisory for gzip (DLA-2976-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/04/msg00007.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2976-1");
  script_xref(name:"Advisory-ID", value:"DLA-2976-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1009168");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gzip'
  package(s) announced via the DLA-2976-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An arbitrary-file-write vulnerability was discovered in gzip, which
