...
if(description)
{
  ...
  script_version("2022-04-15T01:00:09+0000");
  script_cve_id("CVE-2022-25308", "CVE-2022-25309", "CVE-2022-25310");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-04-15 01:00:09 +0000 (Fri, 15 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-15 01:00:09 +0000 (Fri, 15 Apr 2022)");
  script_name("Debian LTS: Security Advisory for fribidi (DLA-2974-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/04/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2974-1");
  ...
  package(s) announced via the DLA-2974-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several issues have been found in fribidi, a free Implementation of the
