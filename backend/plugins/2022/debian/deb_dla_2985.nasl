...
if(description)
{
  ...
  script_version("2022-04-29T01:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for golang-1.7 (DLA-2985-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/04/msg00017.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2985-1");
  script_xref(name:"Advisory-ID", value:"DLA-2985-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-1.7'
  package(s) announced via the DLA-2985-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"golang-1.7", ver:"1.7.4-2+deb9u5", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"golang-1.7-doc", ver:"1.7.4-2+deb9u5", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"golang-1.7-go", ver:"1.7.4-2+deb9u5", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"golang-1.7-src", ver:"1.7.4-2+deb9u5", rls:"DEB9"))) {
  report += res;
}
