...
if(description)
{
  ...
  script_version("2022-02-04T02:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for strongswan (DLA-2909-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/02/msg00003.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2909-1");
  ...
  package(s) announced via the DLA-2909-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Zhuowei Zhang discovered a bug in the EAP authentication client code
