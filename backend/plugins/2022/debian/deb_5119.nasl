...
if(description)
{
  ...
  script_version("2022-04-14T01:00:13+0000");
  ...
  script_name("Debian: Security Advisory for subversion (DSA-5119-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5119.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5119-1");
  ...
  package(s) announced via the DSA-5119-1 advisory.");
...
CVE-2021-28544Evgeny Kotkov reported that Subversion servers reveal copyfrom
