...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for php-horde-mime-viewer (DLA-3045-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/06/msg00007.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3045-1");
  script_xref(name:"Advisory-ID", value:"DLA-3045-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-horde-mime-viewer'
  package(s) announced via the DLA-3045-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"php-horde-mime-viewer", ver:"2.2.1-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
