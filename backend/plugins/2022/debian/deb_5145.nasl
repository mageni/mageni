...
if(description)
{
  ...
  script_version("2022-05-25T01:00:14+0000");
  ...
  script_name("Debian: Security Advisory for lrzip (DSA-5145-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5145.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5145-1");
  script_xref(name:"Advisory-ID", value:"DSA-5145-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lrzip'
  package(s) announced via the DSA-5145-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in the lrzip compression
