...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819949");
  ...
  script_tag(name:"creation_date", value:"2022-01-14 14:34:35 +0530 (Fri, 14 Jan 2022)");
  script_name("Mozilla Thunderbird Security Update(mfsa_2022-01_2022-03)-Windows");
...
if(version_is_less(version:tbVer, test_version:"91.5"))
{
  report = report_fixed_ver(installed_version:tbVer, fixed_version:"91.5", install_path:tbPath);
