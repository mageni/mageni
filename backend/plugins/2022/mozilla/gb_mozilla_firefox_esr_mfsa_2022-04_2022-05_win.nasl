...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819995");
  script_version("2022-02-22T06:48:08+0000");
  script_cve_id("CVE-2022-22753", "CVE-2022-22754", "CVE-2022-22756", "CVE-2022-22759",
  ...
  script_tag(name:"creation_date", value:"2022-02-10 10:57:26 +0530 (Thu, 10 Feb 2022)");
  script_name("Mozilla Firefox ESR Security Update(mfsa_2022-04_2022-05)-Windows");
  ...
  to escalate privileges, run arbitrary code and bypass security restrictions.");
