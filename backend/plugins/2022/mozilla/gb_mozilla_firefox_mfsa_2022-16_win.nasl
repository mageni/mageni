...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821163");
  ...
  script_tag(name:"creation_date", value:"2022-07-07 23:23:54 +0530 (Thu, 07 Jul 2022)");
  script_name("Mozilla Firefox Security Updates(mfsa2022-16) - Windows");
