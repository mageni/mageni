...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147570");
  script_version("2022-02-02T05:33:50+0000");
  script_tag(name:"last_modification", value:"2022-02-02 11:01:49 +0000 (Wed, 02 Feb 2022)");
  script_tag(name:"creation_date", value:"2022-02-02 04:56:53 +0000 (Wed, 02 Feb 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");

  script_cve_id("CVE-2021-46663");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"NoneAvailable");

  script_name("MariaDB DoS Vulnerability (MDEV-26351) - Windows");
  ...
  script_tag(name:"insight", value:"MariaDB allows a ha_maria::extra application crash via certain
  SELECT statements.");
  ...
  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-26351");
