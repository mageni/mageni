...
if (description)
{
  ...
  script_name("MariaDB Multiple Vulnerabilities (Feb 2022) - Linux");
  ...
  script_tag(name:"affected", value:"MariaDB version 10.2.x through 10.8.x.");
...
if (version_in_range(version: version, test_version: "10.2.0", test_version2: "10.2.41")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "10.2.42");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "10.3.0", test_version2: "10.3.32")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "10.3.33");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "10.4.0", test_version2: "10.4.22")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "10.4.23");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "10.5.0", test_version2: "10.5.13")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "10.5.14");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "10.6.0", test_version2: "10.6.5")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "10.6.6");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "10.7.0", test_version2: "10.7.1")) {
