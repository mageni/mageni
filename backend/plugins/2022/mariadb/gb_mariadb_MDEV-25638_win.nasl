...
if (description)
{
  ...
  script_name("MariaDB DoS Vulnerability (MDEV-25638) - Windows");
  ...
  script_tag(name:"insight", value:"MariaDB allows attackers to trigger a convert_const_to_int
  use-after-free when the BIGINT data type is used.");

  # nb: It's not clear if this is fixed and in which versions
  ...
  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-25638");
