...
if (description)
{
  ...
  script_name("MariaDB DoS Vulnerability (MDEV-26431) - Windows");
...
if (version_in_range(version: version, test_version: "10.2.0", test_version2: "10.6.8")) {
