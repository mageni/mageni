...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1429");
  ...
  script_version("2022-04-20T10:28:58+0000");
  script_tag(name:"last_modification", value:"2022-04-20 10:28:58 +0000 (Wed, 20 Apr 2022)");
  ...
  script_name("Huawei EulerOS: Security Advisory for kernel (EulerOS-SA-2022-1429)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1429");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1429");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2022-1429 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel", rpm:"kernel~4.19.90~vhulk2103.1.0.h693.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~4.19.90~vhulk2103.1.0.h693.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-tools-libs", rpm:"kernel-tools-libs~4.19.90~vhulk2103.1.0.h693.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-perf", rpm:"python3-perf~4.19.90~vhulk2103.1.0.h693.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
