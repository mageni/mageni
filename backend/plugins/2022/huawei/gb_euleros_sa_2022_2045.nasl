...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2045");
  ...
  script_name("Huawei EulerOS: Security Advisory for libvirt (EulerOS-SA-2022-2045)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2045");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2045");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libvirt' package(s) announced via the EulerOS-SA-2022-2045 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt", rpm:"libvirt~6.2.0~2.10.0.5.342", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
