...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1692");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdisk (EulerOS-SA-2022-1692)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1692");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1692");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdisk' package(s) announced via the EulerOS-SA-2022-1692 advisory.");
...
In ReadLogicalParts of basicmbr.cc, there is a possible out of bounds write due to a missing bounds check. This could lead to local escalation of privilege with no additional execution privileges needed. User interaction is not needed for exploitation. Product: Android, Versions: Android-8.1, Android-9, Android-10, Android-11, Android-8.0, Android ID: A-158063095.(CVE-2021-0308)");
  ...
  script_tag(name:"affected", value:"'gdisk' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdisk", rpm:"gdisk~0.8.6~5.h1", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
