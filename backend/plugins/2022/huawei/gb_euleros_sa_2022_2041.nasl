...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2041");
  ...
  script_name("Huawei EulerOS: Security Advisory for util-linux (EulerOS-SA-2022-2041)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2041");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2041");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'util-linux' package(s) announced via the EulerOS-SA-2022-2041 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"util-linux", rpm:"util-linux~2.35.2~2.h24.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
