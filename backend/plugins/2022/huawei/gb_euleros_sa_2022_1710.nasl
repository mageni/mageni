...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1710");
  script_cve_id("CVE-2022-0562", "CVE-2022-0865", "CVE-2022-0891", "CVE-2022-0924");
  ...
  script_name("Huawei EulerOS: Security Advisory for compat-libtiff3 (EulerOS-SA-2022-1710)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1710");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1710");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'compat-libtiff3' package(s) announced via the EulerOS-SA-2022-1710 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Null source pointer passed as an argument to memcpy() function within TIFFReadDirectory() in tif_dirread.c in libtiff versions from 4.0 to 4.3.0 could lead to Denial of Service via crafted TIFF file. For users that compile libtiff from sources, a fix is available with commit 561599c.(CVE-2022-0562)
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"compat-libtiff3", rpm:"compat-libtiff3~3.9.4~11.h27", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
