...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1113");
  ...
  script_name("Huawei EulerOS: Security Advisory for cifs-utils (EulerOS-SA-2022-1113)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1113");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1113");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cifs-utils' package(s) announced via the EulerOS-SA-2022-1113 advisory.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cifs-utils", rpm:"cifs-utils~6.2~10.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
