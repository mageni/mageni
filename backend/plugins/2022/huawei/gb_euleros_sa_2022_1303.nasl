...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1303");
  ...
  script_tag(name:"severity_date", value:"2021-11-17 00:40:00 +0000 (Wed, 17 Nov 2021)");

  script_name("Huawei EulerOS: Security Advisory for busybox (EulerOS-SA-2022-1303)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1303");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1303");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'busybox' package(s) announced via the EulerOS-SA-2022-1303 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox", rpm:"busybox~1.31.1~6.h3.r2.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
