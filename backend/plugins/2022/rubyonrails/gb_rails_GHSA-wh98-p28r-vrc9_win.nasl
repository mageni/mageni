...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147672");
  script_version("2022-02-21T07:26:39+0000");
  script_tag(name:"last_modification", value:"2022-02-22 11:21:00 +0000 (Tue, 22 Feb 2022)");
  script_tag(name:"creation_date", value:"2022-02-21 07:23:14 +0000 (Mon, 21 Feb 2022)");
  script_tag(name:"cvss_base", value:"7.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:C/I:C/A:N");

  script_cve_id("CVE-2022-23633");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Ruby on Rails Information Disclosure Vulnerability (GHSA-wh98-p28r-vrc9) - Windows");
  ...
  script_tag(name:"insight", value:"Under certain circumstances response bodies will not be closed,
  for example a bug in a webserver or a bug in a Rack middleware. In the event a response is not
  notified of a close, ActionDispatch::Executor will not know to reset thread local state for the
  next request. This can lead to data being leaked to subsequent requests, especially when
  interacting with ActiveSupport::CurrentAttributes.");
  ...
  script_xref(name:"URL", value:"https://github.com/rails/rails/security/advisories/GHSA-wh98-p28r-vrc9");
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.0", test_version_up: "5.2.6.2")) {
