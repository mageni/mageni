...
if(description)
{
  ...
  script_cve_id("CVE-2022-29909", "CVE-2022-29911", "CVE-2022-29912", "CVE-2022-29913", "CVE-2022-29914", "CVE-2022-29916", "CVE-2022-29917", "CVE-2022-1520", "CVE-2022-1529", "CVE-2022-1802", "CVE-2022-19916");
  ...
  script_name("Ubuntu: Security Advisory for thunderbird (USN-5435-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006578.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the USN-5435-1 advisory.");
...
JavaScript in a privileged context. (CVE-2022-1529, CVE-2022-1802)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
