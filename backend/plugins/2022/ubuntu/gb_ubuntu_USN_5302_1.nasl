...
if(description)
{
  ...
  script_cve_id("CVE-2022-0492", "CVE-2021-43976", "CVE-2021-44879", "CVE-2022-0435", "CVE-2022-24448", "CVE-2022-24959");
  ...
  script_name("Ubuntu: Security Advisory for linux-oem-5.14 (USN-5302-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006419.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.14'
  package(s) announced via the USN-5302-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Yiqi Sun and Kevin Wang discovered that the cgroups implementation
