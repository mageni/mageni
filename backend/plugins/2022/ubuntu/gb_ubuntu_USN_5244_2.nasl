...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dbus (USN-5244-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006546.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dbus'
  package(s) announced via the USN-5244-2 advisory.");
...
 in a denial of service.");
  ...
  script_tag(name:"affected", value:"'dbus' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
