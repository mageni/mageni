...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for docker.io (USN-5032-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-August/006134.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker.io'
  package(s) announced via the USN-5032-2 advisory.");
