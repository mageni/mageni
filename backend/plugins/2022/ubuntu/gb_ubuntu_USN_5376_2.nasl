...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for git (USN-5376-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006517.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'git'
  package(s) announced via the USN-5376-2 advisory.");
...
this issue to run arbitrary commands.");
  ...
  script_tag(name:"affected", value:"'git' package(s) on Ubuntu 22.04 LTS.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.34.1-1ubuntu1.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
