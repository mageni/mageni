...
if(description)
{
  ...
  script_cve_id("CVE-2021-44142", "CVE-2021-43566", "CVE-2022-0336");
  ...
  script_name("Ubuntu: Security Advisory for samba (USN-5260-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006379.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the USN-5260-1 advisory.");
...
services. (CVE-2022-0336)");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.13.17~dfsg-0ubuntu0.21.10.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.13.17~dfsg-0ubuntu0.21.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
