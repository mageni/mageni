...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for snapd (USN-5292-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006404.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snapd'
  package(s) announced via the USN-5292-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"snap did not properly manage the permissions for
...
execute arbitrary code. (CVE-2021-44731)");
  ...
  script_tag(name:"affected", value:"'snapd' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
