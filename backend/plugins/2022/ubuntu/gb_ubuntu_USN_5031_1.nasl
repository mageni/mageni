...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for opencryptoki (USN-5031-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-August/006132.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opencryptoki'
  package(s) announced via the USN-5031-1 advisory.");
