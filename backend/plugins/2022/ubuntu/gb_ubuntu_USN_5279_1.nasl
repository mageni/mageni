...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for util-linux (USN-5279-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006398.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'util-linux'
  package(s) announced via the USN-5279-1 advisory.");
...
FUSE filesystems belonging to other users.");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS.");
