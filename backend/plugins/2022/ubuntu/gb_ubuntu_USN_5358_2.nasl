...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-azure (USN-5358-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006488.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure'
  package(s) announced via the USN-5358-2 advisory.");
...
or possibly execute arbitrary code. (CVE-2022-27666)");
  ...
  script_tag(name:"affected", value:"'linux-azure' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
