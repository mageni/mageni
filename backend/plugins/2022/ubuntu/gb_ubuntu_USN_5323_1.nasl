...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for nbd (USN-5323-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006442.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nbd'
  package(s) announced via the USN-5323-1 advisory.");
...
of service, or possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'nbd' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nbd-server", ver:"1:3.21-1ubuntu0.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nbd-server", ver:"1:3.16.2-1ubuntu0.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nbd-server", ver:"1:3.20-1ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
