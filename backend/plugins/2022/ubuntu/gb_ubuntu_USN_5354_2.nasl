...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for twisted (USN-5354-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006541.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'twisted'
  package(s) announced via the USN-5354-2 advisory.");
...
 Twisted to crash, resulting in a denial of service. (CVE-2022-21716)");
  ...
  script_tag(name:"affected", value:"'twisted' package(s) on Ubuntu 22.04 LTS.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-twisted", ver:"22.1.0-2ubuntu2.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
