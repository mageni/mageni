...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libarchive (USN-5374-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006500.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive'
  package(s) announced via the USN-5374-1 advisory.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libarchive13", ver:"3.4.3-2ubuntu0.2", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libarchive13", ver:"3.4.0-2ubuntu1.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
