...
if(description)
{
  ...
  script_cve_id("CVE-2016-10228", "CVE-2019-25013", "CVE-2020-27618", "CVE-2020-29562", "CVE-2021-3326", "CVE-2020-6096", "CVE-2021-27645", "CVE-2021-35942", "CVE-2021-3998", "CVE-2021-3999", "CVE-2022-23218", "CVE-2022-23219");
  ...
  script_name("Ubuntu: Security Advisory for glibc (USN-5310-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006427.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc'
  package(s) announced via the USN-5310-1 advisory.");
...
CVE-2022-23219)");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc6", ver:"2.34-0ubuntu3.2", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc6", ver:"2.27-3ubuntu1.5", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc6", ver:"2.31-0ubuntu9.7", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
