...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libxml-security-java (USN-5525-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-July/006686.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml-security-java'
  package(s) announced via the USN-5525-1 advisory.");
...
attacker to abuse an XPath Transform to extract sensitive information.");
  ...
  script_tag(name:"affected", value:"'libxml-security-java' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml-security-java", ver:"2.0.10-2~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml-security-java", ver:"2.0.10-2+deb11u1build0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
