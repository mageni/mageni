...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for qemu (USN-5307-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006424.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu'
  package(s) announced via the USN-5307-1 advisory.");
...
(CVE-2022-0358)");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
