...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-gke (USN-5297-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006412.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke'
  package(s) announced via the USN-5297-1 advisory.");
...
(CVE-2022-22942)");
  ...
  script_tag(name:"affected", value:"'linux-gke' package(s) on Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1063-gke", ver:"5.4.0-1063.66", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"5.4.0.1063.73", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-5.4", ver:"5.4.0.1063.73", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
