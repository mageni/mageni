...
if(description)
{
  ...
  script_cve_id("CVE-2021-4002", "CVE-2021-20317", "CVE-2021-20321", "CVE-2021-3760", "CVE-2021-41864", "CVE-2021-43389");
  ...
  script_tag(name:"severity_date", value:"2021-10-05 19:46:00 +0000 (Tue, 05 Oct 2021)");
  script_tag(name:"creation_date", value:"2022-01-07 13:03:02 +0000 (Fri, 07 Jan 2022)");
  script_name("Ubuntu: Security Advisory for linux (USN-5209-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-January/006332.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux'
  package(s) announced via the USN-5209-1 advisory.");
