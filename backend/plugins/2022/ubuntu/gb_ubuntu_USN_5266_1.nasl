...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-gke (USN-5266-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006383.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke'
  package(s) announced via the USN-5266-1 advisory.");
...
possibly execute arbitrary code. (CVE-2021-42739)");
  ...
  script_tag(name:"affected", value:"'linux-gke' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
