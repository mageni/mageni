...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libsepol (USN-5391-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006523.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsepol'
  package(s) announced via the USN-5391-1 advisory.");
...
arbitrary code. (CVE-2021-36087)");
  ...
  script_tag(name:"affected", value:"'libsepol' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
