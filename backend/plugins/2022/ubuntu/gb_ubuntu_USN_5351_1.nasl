...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for paramiko (USN-5351-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006473.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'paramiko'
  package(s) announced via the USN-5351-1 advisory.");
...
to gain access to private keys.");
  ...
  script_tag(name:"affected", value:"'paramiko' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
