...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124006");
  ...
  script_cve_id("CVE-2021-45329");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Gitea < 1.5.1 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"A XSS vulnerability exists via the repository settings inside 
  the external wiki/issue tracker URL field.");

  script_tag(name:"affected", value:"Gitea prior to version 1.5.1.");

  script_tag(name:"solution", value:"Update to version 1.5.1 or later.");

  script_xref(name:"URL", value:"https://github.com/go-gitea/gitea/releases/tag/v1.5.1");
  script_xref(name:"URL", value:"https://blog.gitea.io/2018/09/gitea-1.5.1-is-released/");
