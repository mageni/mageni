...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820148");
  ...
  script_name("Fedora: Security Advisory for unrealircd (FEDORA-2022-0bff4ccd3b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-0bff4ccd3b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NCWBK3NC2KCNP5UPOYUAKJVLK24YWF7O");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'unrealircd'
  package(s) announced via the FEDORA-2022-0bff4ccd3b advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"unrealircd", rpm:"unrealircd~6.0.2~1.fc36", rls:"FC36"))) {
    report += res;
  }
