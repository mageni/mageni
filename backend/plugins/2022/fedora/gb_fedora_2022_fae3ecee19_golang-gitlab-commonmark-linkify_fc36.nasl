...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820962");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:30:19 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-gitlab-commonmark-linkify (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/R2CS4RSTTABBBFTFFUADASVJXXFSTXA7");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-gitlab-commonmark-linkify-0", rpm:"golang-gitlab-commonmark-linkify-0~0.9.20200805git64bca66.fc36", rls:"FC36"))) {
    report += res;
  }
