...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821585");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:16:37 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for dnscrypt-proxy (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5L5NYXHREDH5DGQIKYGFDDV272YIVXWZ");
...
Features:
 ...
 search results on Google, Yahoo and Bing.
  ...
  script_tag(name:"affected", value:"'dnscrypt-proxy' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnscrypt-proxy", rpm:"dnscrypt-proxy~2.1.1~4.fc35", rls:"FC35"))) {
    report += res;
  }
