...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820956");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:38:31 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for htmltest (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WXCCTUQ4E23VMMHGTPQUKFN7TB4NUBWA");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"htmltest", rpm:"htmltest~0.15.0~3.fc36", rls:"FC36"))) {
    report += res;
  }
