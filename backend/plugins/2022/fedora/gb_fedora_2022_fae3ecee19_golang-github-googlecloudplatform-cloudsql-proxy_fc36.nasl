...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820836");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:26:51 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-googlecloudplatform-cloudsql-proxy (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/D6ZCYIN2IYCB4CHF2WRPGSMY3CGMCYYE");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-googlecloudplatform-cloudsql-proxy", rpm:"golang-github-googlecloudplatform-cloudsql-proxy~1.19.1~6.fc36", rls:"FC36"))) {
    report += res;
  }
