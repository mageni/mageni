...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820887");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:23:24 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-google-protobuf (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UOU6HQINQPZMKR3XVNU7TWBLQZL5MZ5A");
  ...
  script_tag(name:"affected", value:"'golang-google-protobuf' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-google-protobuf", rpm:"golang-google-protobuf~1.27.1~5.fc36", rls:"FC36"))) {
    report += res;
  }
