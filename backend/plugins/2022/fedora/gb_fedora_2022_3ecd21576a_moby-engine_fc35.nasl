...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820779");
  ...
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2022-3ecd21576a)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/55AZMGOLCBBNQM7WZ3YHBFSV2YS7TUVW");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~20.10.17~2.fc35", rls:"FC35"))) {
    report += res;
  }
