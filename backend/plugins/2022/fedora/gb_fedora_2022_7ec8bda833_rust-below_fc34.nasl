...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819667");
  ...
  script_tag(name:"creation_date", value:"2022-02-04 02:03:21 +0000 (Fri, 04 Feb 2022)");
  script_name("Fedora: Security Advisory for rust-below (FEDORA-2022-7ec8bda833)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/V6VU6EB4DG3KOLYTUFTASM2P5BSHDNHH");
...
atop&#39, s design and style decisions.");
  ...
  script_tag(name:"affected", value:"'rust-below' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-below", rpm:"rust-below~0.4.1~3.fc34", rls:"FC34"))) {
    report += res;
  }
