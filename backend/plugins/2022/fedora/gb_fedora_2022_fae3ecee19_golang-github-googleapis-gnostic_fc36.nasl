...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820848");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:44:23 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-googleapis-gnostic (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2ML62KFDQXWQSZY3UYAKLO6HLVVJ3YKT");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-googleapis-gnostic", rpm:"golang-github-googleapis-gnostic~0.5.3~6.fc36", rls:"FC36"))) {
    report += res;
  }
