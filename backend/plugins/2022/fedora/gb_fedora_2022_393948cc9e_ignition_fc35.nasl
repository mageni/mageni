...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820657");
  ...
  script_tag(name:"creation_date", value:"2022-05-27 01:07:53 +0000 (Fri, 27 May 2022)");
  script_name("Fedora: Security Advisory for ignition (FEDORA-2022-393948cc9e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-393948cc9e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NP765L7TJI7CD4XVOHUWZVRYRH3FYBOR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ignition'
  package(s) announced via the FEDORA-2022-393948cc9e advisory.");
...
the configuration.");
  ...
  script_tag(name:"affected", value:"'ignition' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ignition", rpm:"ignition~2.14.0~1.fc35", rls:"FC35"))) {
    report += res;
  }
