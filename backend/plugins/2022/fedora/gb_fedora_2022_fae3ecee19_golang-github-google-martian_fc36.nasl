...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820830");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:25:52 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-google-martian (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SA3PXYVVR4USWT6K7YVZK7IEAFRAUE7G");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-google-martian", rpm:"golang-github-google-martian~3.1.0~9.fc36", rls:"FC36"))) {
    report += res;
  }
