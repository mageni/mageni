...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821033");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:31:44 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-hashicorp-serf (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/U5EMCTTKBXB66FJE4WYA67SJISLQBVGW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-hashicorp-serf'
  package(s) announced via the FEDORA-2022-fae3ecee19 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Serf is a decentralized solution for service discovery and orchestration that is
...
letting you use Serf&#39, s gossip protocol to propagate events such as deploys,
...
Here are some example use cases of Serf, though there are many others:
  ...
  script_tag(name:"affected", value:"'golang-github-hashicorp-serf' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-hashicorp-serf", rpm:"golang-github-hashicorp-serf~0.9.5~5.fc36", rls:"FC36"))) {
    report += res;
  }
