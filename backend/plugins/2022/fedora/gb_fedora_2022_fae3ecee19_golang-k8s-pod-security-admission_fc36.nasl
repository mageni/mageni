...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820982");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:39:54 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-k8s-pod-security-admission (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZXPUPEJPNNED5SH3EEO6JRCNWA72SSXF");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-k8s-pod-security-admission", rpm:"golang-k8s-pod-security-admission~1.22.0~3.fc36", rls:"FC36"))) {
    report += res;
  }
