...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821629");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:16:11 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-hashicorp-serf (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QZGGVQTLALD3VTDJCEZ5IO53P267EJII");
...
Here are some example use cases of Serf, though there are many others:
  ...
  script_tag(name:"affected", value:"'golang-github-hashicorp-serf' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-hashicorp-serf", rpm:"golang-github-hashicorp-serf~0.9.5~5.fc35", rls:"FC35"))) {
    report += res;
  }
