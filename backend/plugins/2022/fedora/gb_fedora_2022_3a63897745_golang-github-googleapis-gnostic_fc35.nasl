...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820279");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 01:09:05 +0000 (Fri, 29 Apr 2022)");
  script_name("Fedora: Security Advisory for golang-github-googleapis-gnostic (FEDORA-2022-3a63897745)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NCNBS65VVKKYFOEGDY6P4KE735ECXS2X");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-googleapis-gnostic", rpm:"golang-github-googleapis-gnostic~0.5.3~5.fc35", rls:"FC35"))) {
    report += res;
  }
