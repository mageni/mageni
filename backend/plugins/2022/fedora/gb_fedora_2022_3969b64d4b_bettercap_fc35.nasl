...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821454");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:37:52 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for bettercap (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZD5CAZKXDPHQIVPP65LXE3YXZCMUT3WS");
...
MITM attacks.");
  ...
  script_tag(name:"affected", value:"'bettercap' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bettercap", rpm:"bettercap~2.32.0~4.fc35", rls:"FC35"))) {
    report += res;
  }
