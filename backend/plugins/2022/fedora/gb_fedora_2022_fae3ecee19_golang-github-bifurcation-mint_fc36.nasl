...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820902");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:30:13 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-bifurcation-mint (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2H7NCB5HQPZLEPTAVJUQWZAYFTOGGRTE");
  ...
  script_tag(name:"affected", value:"'golang-github-bifurcation-mint' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-bifurcation-mint-0", rpm:"golang-github-bifurcation-mint-0~0.9.20200724git93c820e.fc36", rls:"FC36"))) {
    report += res;
  }
