...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821649");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:29:27 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for ignition (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VF5YWU2PUJVJDROEAQKTBLVVUWLYPBBM");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ignition", rpm:"ignition~2.14.0~3.fc35", rls:"FC35"))) {
    report += res;
  }
