...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820392");
  ...
  script_name("Fedora: Security Advisory for golang-github-prometheus-tsdb (FEDORA-2022-5cbd6de569)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RW6XM62XDGWNKGTCI4XCF6352JJCGFUX");
  ...
  script_tag(name:"affected", value:"'golang-github-prometheus-tsdb' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-tsdb", rpm:"golang-github-prometheus-tsdb~0.10.0~6.fc34", rls:"FC34"))) {
    report += res;
  }
