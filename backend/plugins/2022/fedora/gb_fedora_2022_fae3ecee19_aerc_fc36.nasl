...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820852");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:45:28 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for aerc (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DXZJ5JZ6P4VSNCTDQHKZCP6PZXR35LO5");
...
efficient and extensible, perfect for the discerning hacker.");
  ...
  script_tag(name:"affected", value:"'aerc' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aerc", rpm:"aerc~0.10.0~3.fc36", rls:"FC36"))) {
    report += res;
  }
