...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820898");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:40:39 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-ulikunitz-xz (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AIJ4IOKFBTL43S5HZEXZQIRX445R7OLJ");
...
code.");
  ...
  script_tag(name:"affected", value:"'golang-github-ulikunitz-xz' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-ulikunitz-xz", rpm:"golang-github-ulikunitz-xz~0.5.10~4.fc36", rls:"FC36"))) {
    report += res;
  }
