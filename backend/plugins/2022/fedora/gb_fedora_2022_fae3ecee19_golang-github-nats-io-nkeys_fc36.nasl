...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820955");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:40:00 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-nats-io-nkeys (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WPKWV2T5XSTIP5ZZFATRAV7G4EMLII47");
  ...
  script_tag(name:"affected", value:"'golang-github-nats-io-nkeys' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-nats-io-nkeys", rpm:"golang-github-nats-io-nkeys~0.2.0~5.fc36", rls:"FC36"))) {
    report += res;
  }
