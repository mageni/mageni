...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820746");
  ...
  script_name("Fedora: Security Advisory for python3.10 (FEDORA-2022-9da5703d22)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/W5664BGZVTA46LQDNTYX5THG6CN4FYJX");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.10", rpm:"python3.10~3.10.5~2.fc36", rls:"FC36"))) {
    report += res;
  }
