...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820797");
  ...
  script_tag(name:"creation_date", value:"2022-06-22 01:10:01 +0000 (Wed, 22 Jun 2022)");
  script_name("Fedora: Security Advisory for xen (FEDORA-2022-0142d562ca)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DS57GSJSNPJYK6OV5FPVS5DV22HN5MAJ");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.16.1~2.fc36", rls:"FC36"))) {
    report += res;
  }
