...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819789");
  ...
  script_name("Fedora: Security Advisory for python2.7 (FEDORA-2022-ef99a016f6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-ef99a016f6");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UDBDBAU6HUPZHISBOARTXZ5GKHF2VH5U");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7'
  package(s) announced via the FEDORA-2022-ef99a016f6 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2.7", rpm:"python2.7~2.7.18~20.fc34", rls:"FC34"))) {
    report += res;
  }
