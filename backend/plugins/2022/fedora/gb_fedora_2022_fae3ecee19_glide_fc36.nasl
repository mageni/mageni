...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821316");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:34:37 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for glide (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P3CMTVD35HDQBPJICTF7U6G2MP6KAPIQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glide'
  package(s) announced via the FEDORA-2022-fae3ecee19 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Glide is a tool for managing the vendor directory within a Go package. This
...
vendored and distributed with the package.");
  ...
  script_tag(name:"affected", value:"'glide' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glide", rpm:"glide~0.13.2~10.fc36", rls:"FC36"))) {
    report += res;
  }
