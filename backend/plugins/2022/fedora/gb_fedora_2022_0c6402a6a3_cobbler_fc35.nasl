...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819864");
  ...
  script_tag(name:"creation_date", value:"2022-03-23 08:35:27 +0000 (Wed, 23 Mar 2022)");
  script_name("Fedora: Security Advisory for cobbler (FEDORA-2022-0c6402a6a3)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-0c6402a6a3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Z5CSXQE7Q4TVDQJKFYBO4XDH3BZ7BLAR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2022-0c6402a6a3 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~3.2.2~10.fc35", rls:"FC35"))) {
    report += res;
  }
