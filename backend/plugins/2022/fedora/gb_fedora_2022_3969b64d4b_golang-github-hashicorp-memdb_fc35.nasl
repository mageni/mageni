...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821670");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:34:51 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-hashicorp-memdb (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/26JQFZUYUPWU2WU4YTRB4KAHJP6MICQ2");
...
The database provides the following:
  ...
  script_tag(name:"affected", value:"'golang-github-hashicorp-memdb' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-hashicorp-memdb", rpm:"golang-github-hashicorp-memdb~1.3.0~5.fc35", rls:"FC35"))) {
    report += res;
  }
