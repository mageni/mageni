...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821722");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:20:51 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-jaytaylor-html2text (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IXFG33IW3IU74EACED4DKOWGBGE4OJEX");
  ...
  script_tag(name:"affected", value:"'golang-jaytaylor-html2text' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-jaytaylor-html2text-0", rpm:"golang-jaytaylor-html2text-0~0.2.20220509gitbc68cce.fc35", rls:"FC35"))) {
    report += res;
  }
