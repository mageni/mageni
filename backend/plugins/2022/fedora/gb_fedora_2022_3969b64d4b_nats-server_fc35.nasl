...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821652");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:35:14 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for nats-server (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6YBLE2CXN7XCZ4YHGXLWEOBQJUYRTPKA");
...
Computing Foundation (CNCF).");
  ...
  script_tag(name:"affected", value:"'nats-server' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nats-server", rpm:"nats-server~2.1.9~6.fc35", rls:"FC35"))) {
    report += res;
  }
