...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819824");
  script_version("2022-03-23T08:34:10+0000");
  # TODO: No CVE assigned yet.
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-03-23 08:34:10 +0000 (Wed, 23 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-23 08:34:10 +0000 (Wed, 23 Mar 2022)");
  script_name("Fedora: Security Advisory for cabal-rpm (FEDORA-2022-78559f99a9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-78559f99a9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IW23IY7ZR43HIOJBARDQ7T7IMQSMTKLM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cabal-rpm'
  package(s) announced via the FEDORA-2022-78559f99a9 advisory.");
...
Standalone packages can also be made, built with cabal-install.");
  ...
  script_tag(name:"affected", value:"'cabal-rpm' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cabal-rpm", rpm:"cabal-rpm~2.0.11~1.fc34", rls:"FC34"))) {
    report += res;
  }
