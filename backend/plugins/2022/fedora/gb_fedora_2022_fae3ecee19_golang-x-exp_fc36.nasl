...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820868");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:24:06 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-x-exp (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5QXMDG7I5XWBTT7OEMJXD5ZNHECNLZBT");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-x-exp-0", rpm:"golang-x-exp-0~0.43.20220330git053ad81.fc36", rls:"FC36"))) {
    report += res;
  }
