...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820193");
  ...
  script_tag(name:"creation_date", value:"2022-03-27 01:06:26 +0000 (Sun, 27 Mar 2022)");
  script_name("Fedora: Security Advisory for zabbix (FEDORA-2022-19a9053f17)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-19a9053f17");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QWP6UBFA5T6MOQPY2VDUG5YAJBFPYRFF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zabbix'
  package(s) announced via the FEDORA-2022-19a9053f17 advisory.");
...
multitude of servers.");
  ...
  script_tag(name:"affected", value:"'zabbix' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~5.0.21~1.fc36", rls:"FC36"))) {
    report += res;
  }
