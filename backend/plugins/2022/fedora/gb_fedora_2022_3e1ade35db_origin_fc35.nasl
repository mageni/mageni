...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821797");
  ...
  script_tag(name:"creation_date", value:"2022-07-21 01:11:53 +0000 (Thu, 21 Jul 2022)");
  script_name("Fedora: Security Advisory for origin (FEDORA-2022-3e1ade35db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A2N35GG66ZW7WGMX5XFVMBSM7P3N5ZQP");
...
on a unified cluster.");
  ...
  script_tag(name:"affected", value:"'origin' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"origin", rpm:"origin~3.11.2~6.fc35", rls:"FC35"))) {
    report += res;
  }
