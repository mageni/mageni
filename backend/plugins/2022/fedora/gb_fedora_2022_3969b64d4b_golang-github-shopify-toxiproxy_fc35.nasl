...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821723");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:23:16 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-shopify-toxiproxy (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZFMTCTS5ZALJYQEIBRAWEMBBJCGSDICG");
...
up your project.");
  ...
  script_tag(name:"affected", value:"'golang-github-shopify-toxiproxy' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-shopify-toxiproxy", rpm:"golang-github-shopify-toxiproxy~2.1.4~10.fc35", rls:"FC35"))) {
    report += res;
  }
