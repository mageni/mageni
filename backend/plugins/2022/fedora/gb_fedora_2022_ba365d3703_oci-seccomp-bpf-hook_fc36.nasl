...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821484");
  ...
  script_tag(name:"creation_date", value:"2022-07-14 01:16:23 +0000 (Thu, 14 Jul 2022)");
  script_name("Fedora: Security Advisory for oci-seccomp-bpf-hook (FEDORA-2022-ba365d3703)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OYVO2O4HWFT6OH3LHPFA2VFOSXD6ZENG");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"oci-seccomp-bpf-hook", rpm:"oci-seccomp-bpf-hook~1.2.5~3.fc36", rls:"FC36"))) {
    report += res;
  }
