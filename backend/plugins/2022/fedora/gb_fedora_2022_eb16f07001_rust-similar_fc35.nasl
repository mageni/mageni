...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819609");
  ...
  script_name("Fedora: Security Advisory for rust-similar (FEDORA-2022-eb16f07001)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6XFV2W7O7OUVO3U6OX4VAIYFMTQECGED");
  ...
  script_tag(name:"affected", value:"'rust-similar' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-similar", rpm:"rust-similar~2.1.0~1.fc35", rls:"FC35"))) {
    report += res;
  }
