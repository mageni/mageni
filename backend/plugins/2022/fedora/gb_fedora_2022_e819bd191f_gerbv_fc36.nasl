...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820566");
  ...
  script_name("Fedora: Security Advisory for gerbv (FEDORA-2022-e819bd191f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-e819bd191f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PTGBC37N2FV7NKOWFVCFMPAFYEPHSB7C");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gerbv'
  package(s) announced via the FEDORA-2022-e819bd191f advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gerbv", rpm:"gerbv~2.8.2~1.fc36", rls:"FC36"))) {
    report += res;
  }
