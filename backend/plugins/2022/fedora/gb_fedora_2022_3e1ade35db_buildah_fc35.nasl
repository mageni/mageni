...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821662");
  ...
  script_tag(name:"creation_date", value:"2022-07-21 01:11:20 +0000 (Thu, 21 Jul 2022)");
  script_name("Fedora: Security Advisory for buildah (FEDORA-2022-3e1ade35db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YVFVTRFJ4XFJ2WSOW4QHI7S66YZPI46E");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.23.4~2.fc35", rls:"FC35"))) {
    report += res;
  }
