...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821883");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:24:27 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-prometheus-tsdb (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZQQGTIJKFNLETSZASLYYCNZSQR6EQHWU");
  ...
  script_tag(name:"affected", value:"'golang-github-prometheus-tsdb' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-tsdb", rpm:"golang-github-prometheus-tsdb~0.10.0~8.fc35", rls:"FC35"))) {
    report += res;
  }
