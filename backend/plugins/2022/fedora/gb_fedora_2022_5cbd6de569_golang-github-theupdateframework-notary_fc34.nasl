...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820344");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 01:10:01 +0000 (Fri, 29 Apr 2022)");
  script_name("Fedora: Security Advisory for golang-github-theupdateframework-notary (FEDORA-2022-5cbd6de569)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WF3J7M7MDQLGXD46KCGIBOGUKVEOPI2Z");
...
content.");
  ...
  script_tag(name:"affected", value:"'golang-github-theupdateframework-notary' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-theupdateframework-notary", rpm:"golang-github-theupdateframework-notary~0.7.0~4.fc34", rls:"FC34"))) {
    report += res;
  }
