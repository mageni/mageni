...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820527");
  ...
  script_name("Fedora: Security Advisory for java-11-openjdk (FEDORA-2022-5a2e1ad72b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JAC3GDMHRZ45QVXGL2TMDFZFIGJTVOXF");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk", rpm:"java-11-openjdk~11.0.15.0.10~1.fc35", rls:"FC35"))) {
    report += res;
  }
