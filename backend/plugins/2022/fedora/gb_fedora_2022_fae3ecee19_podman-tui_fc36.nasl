...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821014");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:33:46 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for podman-tui (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AJMRE7VUWYOYJ6QXHAMTL5GYPDCRJPHV");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman-tui", rpm:"podman-tui~0.4.0~2.fc36", rls:"FC36"))) {
    report += res;
  }
