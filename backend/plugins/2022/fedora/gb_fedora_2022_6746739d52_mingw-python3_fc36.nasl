...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820174");
  ...
  script_name("Fedora: Security Advisory for mingw-python3 (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XRK6JECD65OTFRIJULMZ6QKRXFH7YQVS");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-python3", rpm:"mingw-python3~3.10.2~12.fc36", rls:"FC36"))) {
    report += res;
  }
