...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820304");
  ...
  script_name("Fedora: Security Advisory for golang-github-googleapis-gnostic (FEDORA-2022-5cbd6de569)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7UJE2KMDJI5ATC4QK6KO5NNHY6URBIBT");
...
generate-gnostic directory.");
  ...
  script_tag(name:"affected", value:"'golang-github-googleapis-gnostic' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-googleapis-gnostic", rpm:"golang-github-googleapis-gnostic~0.5.3~5.fc34", rls:"FC34"))) {
    report += res;
  }
