...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820258");
  ...
  script_tag(name:"creation_date", value:"2022-04-11 01:04:41 +0000 (Mon, 11 Apr 2022)");
  script_name("Fedora: Security Advisory for unrealircd (FEDORA-2022-f6d46280da)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-f6d46280da");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JQGTHKFVSEL6OPYVIRS5CBEJSOKVWYYY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'unrealircd'
  package(s) announced via the FEDORA-2022-f6d46280da advisory.");
...
flood and anti-spam systems, swear filtering and module support.");
  ...
  script_tag(name:"affected", value:"'unrealircd' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"unrealircd", rpm:"unrealircd~6.0.3~1.fc35", rls:"FC35"))) {
    report += res;
  }
