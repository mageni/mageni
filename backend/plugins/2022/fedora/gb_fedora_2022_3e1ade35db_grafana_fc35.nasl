...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821661");
  ...
  script_name("Fedora: Security Advisory for grafana (FEDORA-2022-3e1ade35db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/O54UQ5F7TDQVQXLOYK5WYI4R3OBG36RI");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grafana", rpm:"grafana~7.5.15~3.fc35", rls:"FC35"))) {
    report += res;
  }
