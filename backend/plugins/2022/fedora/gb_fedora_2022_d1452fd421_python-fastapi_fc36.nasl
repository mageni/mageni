...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820496");
  ...
  script_tag(name:"creation_date", value:"2022-05-08 01:09:19 +0000 (Sun, 08 May 2022)");
  script_name("Fedora: Security Advisory for python-fastapi (FEDORA-2022-d1452fd421)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-d1452fd421");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/O6JUWQTJLA2CMG4CJN7DCUVSOXLZIIXL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-fastapi'
  package(s) announced via the FEDORA-2022-d1452fd421 advisory.");
...
The key features are:
  ...
  * estimation based on tests on an internal development team, building production
  ...
  script_tag(name:"affected", value:"'python-fastapi' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-fastapi", rpm:"python-fastapi~0.75.2~1.fc36", rls:"FC36"))) {
    report += res;
  }
