...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819758");
  ...
  script_tag(name:"creation_date", value:"2022-02-10 02:02:09 +0000 (Thu, 10 Feb 2022)");
  script_name("Fedora: Security Advisory for phoronix-test-suite (FEDORA-2022-8f968eea82)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-8f968eea82");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/57V2CSFU5MKWKL6RJUKMXSD4PCRFTMMQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phoronix-test-suite'
  package(s) announced via the FEDORA-2022-8f968eea82 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phoronix-test-suite", rpm:"phoronix-test-suite~10.8.1~1.fc35", rls:"FC35"))) {
    report += res;
  }
