...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820540");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2022-bbee226200)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-bbee226200");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/N5JF7EWP4DXVLP4UGYAML653OBILDQOE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2022-bbee226200 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.12~1.fc36", rls:"FC36"))) {
    report += res;
  }
