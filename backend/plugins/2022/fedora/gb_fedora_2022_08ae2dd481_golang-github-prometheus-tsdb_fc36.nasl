...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820447");
  ...
  script_name("Fedora: Security Advisory for golang-github-prometheus-tsdb (FEDORA-2022-08ae2dd481)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6NTKA6MZB7MFKZN2M6ZEBTYXRZCXD5WU");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-tsdb", rpm:"golang-github-prometheus-tsdb~0.10.0~6.fc36", rls:"FC36"))) {
    report += res;
  }
