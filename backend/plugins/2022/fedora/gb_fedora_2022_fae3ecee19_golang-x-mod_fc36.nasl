...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820921");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:31:16 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-x-mod (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TD7BYDIA4PB67IYLJRPTE5MCMNZEJBBE");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-x-mod-0.6.0-dev", rpm:"golang-x-mod-0.6.0-dev~3.20220330git9b9b3d8.fc36", rls:"FC36"))) {
    report += res;
  }
