...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821094");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:21:50 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for source-to-image (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Q7V7THP7HQHX3MMJM7TCZMGE6MTDTQSP");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"source-to-image", rpm:"source-to-image~1.3.1~4.fc36", rls:"FC36"))) {
    report += res;
  }
