...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821020");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:42:36 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-jaytaylor-html2text (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/INCNKW3QO76SU7CBEW2FYXU6TSZ7VYJ6");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-jaytaylor-html2text-0", rpm:"golang-jaytaylor-html2text-0~0.2.20220509gitbc68cce.fc36", rls:"FC36"))) {
    report += res;
  }
