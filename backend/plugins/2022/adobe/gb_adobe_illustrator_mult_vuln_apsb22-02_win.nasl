...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819930");
  ...
  script_name("Adobe Illustrator Multiple Privilege Escalation Vulnerabilities (APSB22-02) - Windows");
  ...
  2022 26.x prior to 26.0.2 versions on Windows.");
