...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818887");
  ...
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB21-29) - Windows");
  ...
  2020.001.30025 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Acrobat Classic 2020 version
  2020.001.30025 or later. Please see the references for more information.");
