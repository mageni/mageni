...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819939");
  ...
  script_cve_id("CVE-2021-44701", "CVE-2021-44702", "CVE-2021-44703", "CVE-2021-44704",
                ...
                "CVE-2021-45067", "CVE-2021-45068");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2022-01-14 11:23:55 +0000 (Fri, 14 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-13 18:47:50 +0530 (Thu, 13 Jan 2022)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB22-01) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat DC (Continuous) version prior to
  2021.011.20039 on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Acrobat DC (Continuous)
  to version 2021.011.20039 or later.");
...
if(version_is_less(version:vers, test_version:"21.011.20039"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2021.011.20039", install_path:path);
