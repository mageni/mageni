...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818890");
  ...
  script_name("Adobe Reader DC Continuous Security Update (APSB21-29) - Windows");
  ...
  2021.001.20150 and earlier versions on Windows.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"21.001.20150"))
{
