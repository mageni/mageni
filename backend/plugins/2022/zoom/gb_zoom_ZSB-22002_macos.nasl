...
if(description)
{
  ...
  script_name("Zoom Client < 5.7.3 DoS Vulnerability (ZSB-22002) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Zoom Client prior to version 5.7.3.");
