...
if (description)
{
  ...
  script_name("Cobbler < 3.3.1 Multiple Vulnerabilities");
  ...
  - CVE-2021-45082: Incomplete template sanitation

  - CVE-2021-45083: Make configuration files only readable by root");

  script_tag(name:"affected", value:"Cobbler version 3.3.0 and prior.");

  script_tag(name:"solution", value:"Update to version 3.3.1 or later.");

  script_xref(name:"URL", value:"https://github.com/cobbler/cobbler/releases/tag/v3.3.1");
