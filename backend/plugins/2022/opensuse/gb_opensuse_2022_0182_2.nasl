...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854498");
  ...
  script_tag(name:"creation_date", value:"2022-02-22 02:01:35 +0000 (Tue, 22 Feb 2022)");
  script_name("openSUSE: Security Advisory for webkit2gtk3 (openSUSE-SU-2022:0182-2)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:0182-2");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/IILRBHE4XKYN4SZKE6UX55V3HK54NAIK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk3'
  package(s) announced via the openSUSE-SU-2022:0182-2 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libwebkit2gtk3-lang", rpm:"libwebkit2gtk3-lang~2.34.3~23.3", rls:"openSUSELeap15.4"))) {
    report += res;
  }
