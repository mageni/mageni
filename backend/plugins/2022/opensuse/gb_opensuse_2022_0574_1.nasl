...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854513");
  ...
  script_tag(name:"creation_date", value:"2022-02-26 02:02:11 +0000 (Sat, 26 Feb 2022)");
  script_name("openSUSE: Security Advisory for ucode-intel (openSUSE-SU-2022:0574-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:0574-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/W7QEMHXA4R2RUIQPQL2RSCQ7TBADKDOH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2022:0574-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-20220207", rpm:"ucode-intel-20220207~10.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-20220207", rpm:"ucode-intel-20220207~10.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
