...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854754");
  ...
  script_tag(name:"creation_date", value:"2022-06-21 01:01:40 +0000 (Tue, 21 Jun 2022)");
  script_name("openSUSE: Security Advisory for golang-github-prometheus-alertmanager (SUSE-SU-2022:2139-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:2139-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/YA4SMGUGLFYXDPSQ7OLMV2I45MQ4SXEM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-prometheus-alertmanager'
  ...
  * Fix test not waiting for cluster member to be ready
  ...
  script_tag(name:"affected", value:"'golang-github-prometheus-alertmanager' package(s) on openSUSE Leap 15.3, openSUSE Leap 15.4.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-alertmanager", rpm:"golang-github-prometheus-alertmanager~0.23.0~150100.4.7.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-alertmanager", rpm:"golang-github-prometheus-alertmanager~0.23.0~150100.4.7.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
