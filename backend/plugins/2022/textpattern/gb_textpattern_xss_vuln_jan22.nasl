...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147894");
  script_version("2022-04-01T02:58:59+0000");
  script_tag(name:"last_modification", value:"2022-04-01 10:07:02 +0000 (Fri, 01 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-01 02:39:37 +0000 (Fri, 01 Apr 2022)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");

  script_cve_id("CVE-2021-44082");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Textpattern CMS < 4.8.8 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Textpattern is vulnerable to an XSS via /textpattern/index.php.
  A remote and unauthenticated attacker can use XSS to trigger remote code execution by uploading
  a webshell. To do so they must first steal the CSRF token before submitting a file upload
  request.");
  ...
  script_xref(name:"URL", value:"https://pentest.co.uk/labs/leveraging-xss-to-get-rce-in-textpattern/");
