...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124107");
  ...
  script_cve_id("CVE-2022-2227");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab < 14.10.5, 15.0.x < 15.0.4, 15.1.x < 15.1.1 Access Control Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a access control vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"GitLab allows a previous maintainer of a project with a
  specific runner to access job and project meta data under certain conditions.");

  script_tag(name:"affected", value:"GitLab prior to version 14.10.5, version 15.0.x through 15.0.3
  and 15.1.0.");

  script_tag(name:"solution", value:"Update to version 14.10.5, 15.0.4, 15.1.1 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2227.json");
...
if (version_is_less(version: version, test_version: "14.10.5")) {
