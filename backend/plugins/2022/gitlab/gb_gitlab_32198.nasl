...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170076");
  ...
  script_cve_id("CVE-2017-0926");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 8.8.x - 9.5.10, 10.x - 10.1.5, 10.2.x - 10.2.5, 10.3.x - 10.3.3 Improper Authorization Vulnerability");
  ...
  script_tag(name:"insight", value:"GitHub Integration Allows GitHub login even if OAuth sign-in
  source is disabled.");

  script_tag(name:"affected", value:"GitLab version 8.8.x through 9.5.10, 10.x through 10.1.5,
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/32198");
...
if ( version_in_range( version:version, test_version:"8.8.0", test_version2:"9.5.10" ) ) {
