...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126010");
  ...
  script_tag(name:"severity_date", value:"2022-05-18 18:19:00 +0000 (Wed, 18 May 2022)");

  script_cve_id("CVE-2022-1433");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 14.4 < 14.8.6, 14.9.x < 14.9.4, 14.10.x < 14.10.1 XSS Vulnerability.");
  ...
  script_tag(name:"impact", value:"Missing invalidation of Markdown caching causes potential
  payloads from a previously exploitable XSS vulnerability to persist and execute.");

  script_tag(name:"affected", value:"GitLab version 14.4.0 through 14.8.5, 14.9.x through 14.9.3
  and version 14.10.0.");
...
if ( version_in_range( version:version, test_version:"14.4.0", test_version2:"14.8.5" ) ) {
