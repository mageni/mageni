...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147907");
  script_version("2022-04-05T03:09:53+0000");
  script_tag(name:"last_modification", value:"2022-04-05 10:21:53 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"creation_date", value:"2022-04-05 02:15:26 +0000 (Tue, 05 Apr 2022)");
  script_tag(name:"cvss_base", value:"8.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:N");

  script_cve_id("CVE-2022-1175");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 14.4.x < 14.7.7, 14.8.x < 14.8.5, 14.9.x < 14.9.2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Improper neutralization of user input allowed an attacker to
  exploit XSS by injecting HTML in notes.");

  script_tag(name:"affected", value:"GitLab version 14.4.x prior to 14.7.7, 14.8.x prior to 14.8.5
...
if (version_in_range_exclusive(version: version, test_version_lo: "14.4.0", test_version_up: "14.7.7")) {
