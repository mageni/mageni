...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170077");
  ...
  script_cve_id("CVE-2017-0925");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 8.x - 9.5.10, 10.x - 10.1.5, 10.2.x - 10.2.5, 10.3.x - 10.3.3 Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a cleartext transmission of sensitive
  information vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"API exposes plain text password for service integrations.");

  script_tag(name:"affected", value:"GitLab version 8.x through 9.5.10, 10.x through 10.1.5,
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab/-/issues/3847");
...
if ( version_in_range( version:version, test_version:"8.0.0", test_version2:"9.5.10" ) ) {
