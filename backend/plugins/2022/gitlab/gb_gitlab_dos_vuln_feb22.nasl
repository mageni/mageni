...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147959");
  script_version("2022-05-11T07:54:51+0000");
  script_tag(name:"last_modification", value:"2022-05-11 10:22:31 +0000 (Wed, 11 May 2022)");
  script_tag(name:"creation_date", value:"2022-04-11 06:29:15 +0000 (Mon, 11 Apr 2022)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:H/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-05-05 19:57:00 +0000 (Thu, 05 May 2022)");

  script_cve_id("CVE-2022-0477");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 11.9.x < 14.5.4, 14.6.x < 14.6.4, 14.7.x < 14.7.1 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"GitLab was not correctly handling bulk requests to delete
  existing packages from the package registries which could result in a DoS under specific
  conditions.");

  script_tag(name:"affected", value:"GitLab version 11.9.x through 14.5.3, 14.6.x through 14.6.3 and
  14.7.0.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "11.9", test_version_up: "14.5.4")) {
