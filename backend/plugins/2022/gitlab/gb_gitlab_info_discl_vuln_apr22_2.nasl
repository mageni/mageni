...
if (description)
{
  ...
  script_name("GitLab 12.7.x < 14.5.4, 14.6.x < 14.6.4, 14.7.x < 14.7.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"Improper access control allowed for project non-members to
  retrieve issue details when it was linked to an item form the vulnerability dashboard in GitLab
  CE/EE.");

  script_tag(name:"affected", value:"GitLab version 12.7.x through 14.5.3, 14.6.x through 14.6.3 and
  14.7.0.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "12.7", test_version_up: "14.5.4")) {
