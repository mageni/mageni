...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-eventlet, python-eventlet' package(s) announced via the MGASA-2021-0266 advisory.");
...
workaround to protect Eventlet process (CVE-2021-21419).");
  ...
  script_tag(name:"affected", value:"'python-eventlet, python-eventlet' package(s) on Mageia 7, Mageia 8.");
