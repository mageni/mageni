...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript, ghostscript' package(s) announced via the MGASA-2019-0271 advisory.");
