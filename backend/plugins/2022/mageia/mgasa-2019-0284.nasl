...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ibus, ibus' package(s) announced via the MGASA-2019-0284 advisory.");
...
input related configurations through DBus method calls (CVE-2019-14822).");
  ...
  script_tag(name:"affected", value:"'ibus, ibus' package(s) on Mageia 6, Mageia 7.");
