...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnome-autoar, gnome-autoar' package(s) announced via the MGASA-2021-0111 advisory.");
