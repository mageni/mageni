...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'quagga, quagga' package(s) announced via the MGASA-2013-0310 advisory.");
...
and ospfclient features, which did not provide useful functionality.");
  ...
  script_tag(name:"affected", value:"'quagga, quagga' package(s) on Mageia 2, Mageia 3.");
