...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-05-05 05:26:00 +0000 (Mon, 05 May 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'varnish, varnish' package(s) announced via the MGASA-2014-0065 advisory.");
...
native services, which should allow for more consistent behavior.");
  ...
  script_tag(name:"affected", value:"'varnish, varnish' package(s) on Mageia 3, Mageia 4.");
