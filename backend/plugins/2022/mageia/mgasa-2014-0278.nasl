...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxfont, libxfont' package(s) announced via the MGASA-2014-0278 advisory.");
...
code (CVE-2014-0210, CVE-2014-0211).");
  ...
  script_tag(name:"affected", value:"'libxfont, libxfont' package(s) on Mageia 3, Mageia 4.");
