...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0238");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0238)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0238");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0238.html");
  ...
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=13401");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-vserver' package(s) announced via the MGASA-2014-0238 advisory.");
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-3.10.40-0.vs2.3.6.8.1.mga3", rpm:"kernel-vserver-3.10.40-0.vs2.3.6.8.1.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver", rpm:"kernel-vserver~3.10.40~0.vs2.3.6.8.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-devel-3.10.40-0.vs2.3.6.8.1.mga3", rpm:"kernel-vserver-devel-3.10.40-0.vs2.3.6.8.1.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-devel-latest", rpm:"kernel-vserver-devel-latest~3.10.40~0.vs2.3.6.8.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-doc", rpm:"kernel-vserver-doc~3.10.40~0.vs2.3.6.8.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-latest", rpm:"kernel-vserver-latest~3.10.40~0.vs2.3.6.8.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-source-3.10.40-0.vs2.3.6.8.1.mga3", rpm:"kernel-vserver-source-3.10.40-0.vs2.3.6.8.1.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-source-latest", rpm:"kernel-vserver-source-latest~3.10.40~0.vs2.3.6.8.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
