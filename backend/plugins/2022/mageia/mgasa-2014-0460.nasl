...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'boinc-client, boinc-client' package(s) announced via the MGASA-2014-0460 advisory.");
...
installation have been fixed as well.");
  ...
  script_tag(name:"affected", value:"'boinc-client, boinc-client' package(s) on Mageia 3, Mageia 4.");
