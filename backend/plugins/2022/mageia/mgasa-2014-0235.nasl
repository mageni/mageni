...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0235");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0235)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0235");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0235.html");
  ...
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=13398");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-linus' package(s) announced via the MGASA-2014-0235 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Updated kernel-linus provides upstream 3.10.40 kernel and fixes the
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-3.10.40-1.mga3", rpm:"kernel-linus-3.10.40-1.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus", rpm:"kernel-linus~3.10.40~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-3.10.40-1.mga3", rpm:"kernel-linus-devel-3.10.40-1.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-latest", rpm:"kernel-linus-devel-latest~3.10.40~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-doc", rpm:"kernel-linus-doc~3.10.40~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-latest", rpm:"kernel-linus-latest~3.10.40~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-3.10.40-1.mga3", rpm:"kernel-linus-source-3.10.40-1.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-latest", rpm:"kernel-linus-source-latest~3.10.40~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
