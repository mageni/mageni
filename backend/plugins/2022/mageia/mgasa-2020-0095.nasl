...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql11, postgresql9.6' package(s) announced via the MGASA-2020-0095 advisory.");
