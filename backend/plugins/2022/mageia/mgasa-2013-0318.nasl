...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dropbear, dropbear' package(s) announced via the MGASA-2013-0318 advisory.");
...
2013.59 (CVE-2013-4434).");
  ...
  script_tag(name:"affected", value:"'dropbear, dropbear' package(s) on Mageia 2, Mageia 3.");
