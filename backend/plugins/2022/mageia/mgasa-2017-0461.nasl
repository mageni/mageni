...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb, mariadb' package(s) announced via the MGASA-2017-0461 advisory.");
...
(complete DOS) of MariaDB Server (CVE-2017-10378).");
  ...
  script_tag(name:"affected", value:"'mariadb, mariadb' package(s) on Mageia 5, Mageia 6.");
