...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'jasper, jasper' package(s) announced via the MGASA-2018-0281 advisory.");
...
libjasper/jpc/jpc_math.c could lead to denial of service (CVE-2018-9055).");
  ...
  script_tag(name:"affected", value:"'jasper, jasper' package(s) on Mageia 5, Mageia 6.");
