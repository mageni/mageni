...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xpdf, xpdf' package(s) announced via the MGASA-2013-0261 advisory.");
...
(CVE-2012-2142).");
  ...
  script_tag(name:"affected", value:"'xpdf, xpdf' package(s) on Mageia 2, Mageia 3.");
