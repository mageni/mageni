...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libebml, vlc, vlc, vlc, vlc' package(s) announced via the MGASA-2019-0233 advisory.");
...
1.3.7, which is needed for Matroska support.");
  ...
  script_tag(name:"affected", value:"'libebml, vlc, vlc, vlc, vlc' package(s) on Mageia 6, Mageia 7.");
