...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2013-10-29 20:53:00 +0000 (Tue, 29 Oct 2013)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'aircrack-ng, aircrack-ng' package(s) announced via the MGASA-2013-0307 advisory.");
...
privileges of the process or a Denial of Service condition (CVE-2010-1159).");
  ...
  script_tag(name:"affected", value:"'aircrack-ng, aircrack-ng' package(s) on Mageia 2, Mageia 3.");
