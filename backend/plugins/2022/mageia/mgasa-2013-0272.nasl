...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-pear-Auth_OpenID, php-pear-Auth_OpenID' package(s) announced via the MGASA-2013-0272 advisory.");
...
(CVE-2013-4701).");
  ...
  script_tag(name:"affected", value:"'php-pear-Auth_OpenID, php-pear-Auth_OpenID' package(s) on Mageia 2, Mageia 3.");
