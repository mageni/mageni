...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libextractor, libextractor' package(s) announced via the MGASA-2018-0043 advisory.");
...
in plugins/xm_extractor.c (CVE-2017-17440).");
  ...
  script_tag(name:"affected", value:"'libextractor, libextractor' package(s) on Mageia 5, Mageia 6.");
