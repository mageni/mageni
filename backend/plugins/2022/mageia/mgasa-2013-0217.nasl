...
if(description)
{
  ...
  script_name("Mageia: Security Advisory (MGASA-2013-0217)");
  ...
  script_xref(name:"URL", value:"https://moodle.org/mod/forum/discuss.php?d=232500");
  ...
  script_tag(name:"insight", value:"Flash files distributed with the YUI library in Moodle before 2.4.5 may have
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moodle", rpm:"moodle~2.4.5~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
