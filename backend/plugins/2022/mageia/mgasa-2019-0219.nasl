...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cyrus-imapd, cyrus-imapd' package(s) announced via the MGASA-2019-0219 advisory.");
...
handling triggered by a long iCalendar property name (CVE-2019-11356).");
  ...
  script_tag(name:"affected", value:"'cyrus-imapd, cyrus-imapd' package(s) on Mageia 6, Mageia 7.");
