...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'apr-util, apr-util' package(s) announced via the MGASA-2017-0427 advisory.");
...
(CVE-2017-12618).");
  ...
  script_tag(name:"affected", value:"'apr-util, apr-util' package(s) on Mageia 5, Mageia 6.");
