...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer0.10-plugins-ugly, gstreamer0.10-plugins-ugly, gstreamer1.0-plugins-ugly, gstreamer1.0-plugins-ugly' package(s) announced via the MGASA-2018-0014 advisory.");
...
opened (CVE-2017-5846, CVE-2017-5847).");
  ...
  script_tag(name:"affected", value:"'gstreamer0.10-plugins-ugly, gstreamer0.10-plugins-ugly, gstreamer1.0-plugins-ugly, gstreamer1.0-plugins-ugly' package(s) on Mageia 5.");
