...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'oath-toolkit, oath-toolkit' package(s) announced via the MGASA-2014-0101 advisory.");
...
vulnerable to replay attacks (CVE-2013-7322).");
  ...
  script_tag(name:"affected", value:"'oath-toolkit, oath-toolkit' package(s) on Mageia 3, Mageia 4.");
