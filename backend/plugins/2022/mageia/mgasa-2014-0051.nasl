...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0051");
  ...
  script_tag(name:"severity_date", value:"2015-01-03 02:19:00 +0000 (Sat, 03 Jan 2015)");

  script_name("Mageia: Security Advisory (MGASA-2014-0051)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0051");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0051.html");
  script_xref(name:"URL", value:"http://www.debian.org/security/2014/dsa-2846");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=12235");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the MGASA-2014-0051 advisory.");
