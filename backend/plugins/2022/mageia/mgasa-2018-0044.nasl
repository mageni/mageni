...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'wayland, wayland' package(s) announced via the MGASA-2018-0044 advisory.");
...
(rhbz#1522638).");
  ...
  script_tag(name:"affected", value:"'wayland, wayland' package(s) on Mageia 5, Mageia 6.");
