...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'bip, bip' package(s) announced via the MGASA-2013-0351 advisory.");
...
out of resources, resulting in a denial of service (CVE-2013-4550).");
  ...
  script_tag(name:"affected", value:"'bip, bip' package(s) on Mageia 2, Mageia 3.");
