...
if(description)
{
  ...
  script_tag(name:"insight", value:"Updated php-smarty packages to version 4 for php 8 compatibility and to
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-smarty", rpm:"php-smarty~4.0.4~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
