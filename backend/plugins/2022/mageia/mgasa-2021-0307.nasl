...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dhcp, dhcp' package(s) announced via the MGASA-2021-0307 advisory.");
...
availability (CVE-2021-25217).");
  ...
  script_tag(name:"affected", value:"'dhcp, dhcp' package(s) on Mageia 7, Mageia 8.");
