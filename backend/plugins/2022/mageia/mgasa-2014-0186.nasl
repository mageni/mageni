...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nagios, nagios' package(s) announced via the MGASA-2014-0186 advisory.");
...
(CVE-2014-1878).");
  ...
  script_tag(name:"affected", value:"'nagios, nagios' package(s) on Mageia 3, Mageia 4.");
