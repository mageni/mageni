...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'irssi, irssi' package(s) announced via the MGASA-2021-0255 advisory.");
...
* null pointer dereference when receiving broken JOIN record.");
  ...
  script_tag(name:"affected", value:"'irssi, irssi' package(s) on Mageia 7, Mageia 8.");
