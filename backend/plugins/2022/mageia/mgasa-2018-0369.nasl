...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2018.0369");
  ...
  script_name("Mageia: Security Advisory (MGASA-2018-0369)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2018-0369");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2018-0369.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=23506");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/thread/377JCLG64STYRNYZZ4B5QKGX2MAW6JUX/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxkbcommon' package(s) announced via the MGASA-2018-0369 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Updated libxkbcommon packages fix security vulnerabilities:
...
xkbcommon before 0.8.2 could be used by local attackers to crash (NULL
pointer dereference) the xkbcommon parser by supplying a crafted ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'libxkbcommon' package(s) on Mageia 6.");
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64xkbcommon-devel", rpm:"lib64xkbcommon-devel~0.8.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64xkbcommon0", rpm:"lib64xkbcommon0~0.8.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxkbcommon", rpm:"libxkbcommon~0.8.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxkbcommon-devel", rpm:"libxkbcommon-devel~0.8.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxkbcommon-doc", rpm:"libxkbcommon-doc~0.8.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxkbcommon0", rpm:"libxkbcommon0~0.8.2~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
