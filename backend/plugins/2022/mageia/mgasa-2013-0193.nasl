...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xml-security-c, xml-security-c' package(s) announced via the MGASA-2013-0193 advisory.");
...
processing code (CVE-2013-2210).");
  ...
  script_tag(name:"affected", value:"'xml-security-c, xml-security-c' package(s) on Mageia 2, Mageia 3.");
