...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'icecream, icecream' package(s) announced via the MGASA-2014-0357 advisory.");
...
part of liblzo containing the vulnerable code.");
  ...
  script_tag(name:"affected", value:"'icecream, icecream' package(s) on Mageia 3, Mageia 4.");
