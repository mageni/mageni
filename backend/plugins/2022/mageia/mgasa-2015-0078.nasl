...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2015.0078");
  ...
  script_name("Mageia: Security Advisory (MGASA-2015-0078)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2015-0078");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0078.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=15225");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-vserver' package(s) announced via the MGASA-2015-0078 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This kernel-vserver update is based on upstream -longterm 3.14.32 and fixes the
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-3.14.32-0.vs2.3.6.14.1.mga4", rpm:"kernel-vserver-3.14.32-0.vs2.3.6.14.1.mga4~1~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver", rpm:"kernel-vserver~3.14.32~0.vs2.3.6.14.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-devel-3.14.32-0.vs2.3.6.14.1.mga4", rpm:"kernel-vserver-devel-3.14.32-0.vs2.3.6.14.1.mga4~1~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-devel-latest", rpm:"kernel-vserver-devel-latest~3.14.32~0.vs2.3.6.14.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-doc", rpm:"kernel-vserver-doc~3.14.32~0.vs2.3.6.14.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-latest", rpm:"kernel-vserver-latest~3.14.32~0.vs2.3.6.14.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-source-3.14.32-0.vs2.3.6.14.1.mga4", rpm:"kernel-vserver-source-3.14.32-0.vs2.3.6.14.1.mga4~1~1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-vserver-source-latest", rpm:"kernel-vserver-source-latest~3.14.32~0.vs2.3.6.14.1.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
