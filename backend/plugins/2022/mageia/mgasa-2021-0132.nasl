...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2021.0132");
  script_cve_id("CVE-2021-20178", "CVE-2021-20180", "CVE-2021-20191", "CVE-2021-20228");
  ...
  script_name("Mageia: Security Advisory (MGASA-2021-0132)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2021-0132");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2021-0132.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=28436");
  script_xref(name:"URL", value:"https://github.com/ansible/ansible/blob/stable-2.9/changelogs/CHANGELOG-v2.9.rst#id64");
  script_xref(name:"URL", value:"https://access.redhat.com/errata/RHSA-2021:0664");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible' package(s) announced via the MGASA-2021-0132 advisory.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ansible", rpm:"ansible~2.9.18~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
