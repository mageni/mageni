...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnupg, gnupg, libgcrypt, libgcrypt' package(s) announced via the MGASA-2013-0239 advisory.");
...
key information from another user on the system (CVE-2013-4242).");
  ...
  script_tag(name:"affected", value:"'gnupg, gnupg, libgcrypt, libgcrypt' package(s) on Mageia 2, Mageia 3.");
