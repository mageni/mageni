...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby, ruby, ruby-linecache19, ruby-ruby-debug-base19' package(s) announced via the MGASA-2013-0229 advisory.");
...
certification authority (CVE-2013-4073).");
  ...
  script_tag(name:"affected", value:"'ruby, ruby, ruby-linecache19, ruby-ruby-debug-base19' package(s) on Mageia 2, Mageia 3.");
