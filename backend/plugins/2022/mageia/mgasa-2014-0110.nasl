...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat, tomcat' package(s) announced via the MGASA-2014-0110 advisory.");
...
and was affected as well.");
  ...
  script_tag(name:"affected", value:"'tomcat, tomcat' package(s) on Mageia 3, Mageia 4.");
