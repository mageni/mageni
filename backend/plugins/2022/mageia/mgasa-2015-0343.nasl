...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pcre, pcre' package(s) announced via the MGASA-2015-0343 advisory.");
...
integer overflows.");
  ...
  script_tag(name:"affected", value:"'pcre, pcre' package(s) on Mageia 4, Mageia 5.");
