...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php, php, php-apc, php-apc, php-gd-bundled' package(s) announced via the MGASA-2014-0367 advisory.");
