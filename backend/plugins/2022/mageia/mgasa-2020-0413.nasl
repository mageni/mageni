...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2020.0413");
  ...
  script_name("Mageia: Security Advisory (MGASA-2020-0413)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2020-0413");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2020-0413.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=26648");
  script_xref(name:"URL", value:"https://chromereleases.googleblog.com/2020/11/stable-channel-update-for-desktop_11.html");
  ...
  script_xref(name:"URL", value:"https://chromereleases.googleblog.com/2020/09/stable-channel-update-for-desktop.html");
  script_xref(name:"URL", value:"https://chromereleases.googleblog.com/2020/08/stable-channel-update-for-desktop_25.html");
  script_xref(name:"URL", value:"https://chromereleases.googleblog.com/2020/08/stable-channel-update-for-desktop_18.html");
  ...
  script_xref(name:"URL", value:"https://chromereleases.googleblog.com/2020/06/stable-channel-update-for-desktop_22.htm");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium-browser-stable' package(s) announced via the MGASA-2020-0413 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The chromium-browser-stable package has been updated to 86.0.4240.198
version that fixes multiples security vulnerabilities.

From 81.0.4044.138 (released on May 9th, 2020) to 86.0.4240.198 version,
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium-browser", rpm:"chromium-browser~86.0.4240.198~1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-browser-stable", rpm:"chromium-browser-stable~86.0.4240.198~1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }
