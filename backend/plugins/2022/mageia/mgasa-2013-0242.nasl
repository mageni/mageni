...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'filezilla, filezilla, putty, putty' package(s) announced via the MGASA-2013-0242 advisory.");
...
in memory after being used by PuTTY tools (CVE-2013-4208).");
  ...
  script_tag(name:"affected", value:"'filezilla, filezilla, putty, putty' package(s) on Mageia 2, Mageia 3.");
