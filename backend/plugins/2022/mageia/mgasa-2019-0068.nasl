...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2019.0068");
  ...
  script_name("Mageia: Security Advisory (MGASA-2019-0068)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2019-0068");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2019-0068.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=24253");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/thread/SMFQ54VEZPJT4H2C2TBILCPDX2VMAIZ2/");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2019/02/11/2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opencontainers-runc' package(s) announced via the MGASA-2019-0068 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Not using pivot_root(2) leaves the host /proc around in the mount namespace
...
to /proc/self/exe (CVE-2019-5736).");
  ...
  script_tag(name:"affected", value:"'opencontainers-runc' package(s) on Mageia 6.");
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opencontainers-runc", rpm:"opencontainers-runc~1.0.0rc5~3.2.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
