...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind, bind' package(s) announced via the MGASA-2013-0237 advisory.");
...
(CVE-2013-4854).");
  ...
  script_tag(name:"affected", value:"'bind, bind' package(s) on Mageia 2, Mageia 3.");
