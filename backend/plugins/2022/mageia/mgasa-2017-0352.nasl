...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat, tomcat' package(s) announced via the MGASA-2017-0352 advisory.");
...
Note that CVE-2017-12616 only affected tomcat 7 in Mageia 5.");
  ...
  script_tag(name:"affected", value:"'tomcat, tomcat' package(s) on Mageia 5, Mageia 6.");
