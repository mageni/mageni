...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'virtuoso-opensource, virtuoso-opensource' package(s) announced via the MGASA-2015-0269 advisory.");
...
fixes for unspecified security issues have been added.");
  ...
  script_tag(name:"affected", value:"'virtuoso-opensource, virtuoso-opensource' package(s) on Mageia 4, Mageia 5.");
