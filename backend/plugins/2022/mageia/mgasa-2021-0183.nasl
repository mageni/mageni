...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'velocity, velocity' package(s) announced via the MGASA-2021-0183 advisory.");
...
Engine versions up to 2.2 (CVE-2020-13936).");
  ...
  script_tag(name:"affected", value:"'velocity, velocity' package(s) on Mageia 7, Mageia 8.");
