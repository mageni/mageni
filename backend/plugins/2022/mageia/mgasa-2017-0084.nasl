...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libquicktime, libquicktime' package(s) announced via the MGASA-2017-0084 advisory.");
...
(CVE-2016-2399)");
  ...
  script_tag(name:"affected", value:"'libquicktime, libquicktime' package(s) on Mageia 5.");
