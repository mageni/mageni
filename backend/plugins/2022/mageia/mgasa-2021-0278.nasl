...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xscreensaver, xscreensaver' package(s) announced via the MGASA-2021-0278 advisory.");
  ...
  script_tag(name:"affected", value:"'xscreensaver, xscreensaver' package(s) on Mageia 8.");
