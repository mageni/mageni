...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2019.0051");
  script_cve_id("CVE-2019-3806", "CVE-2019-3807");
  ...
  script_name("Mageia: Security Advisory (MGASA-2019-0051)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2019-0051");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2019-0051.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=24218");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pdns-recursor' package(s) announced via the MGASA-2019-0051 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue has been found in PowerDNS Recursor where Lua hooks are not
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pdns-recursor", rpm:"pdns-recursor~4.1.9~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
