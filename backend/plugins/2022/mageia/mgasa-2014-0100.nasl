...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kxml, xstream, xstream' package(s) announced via the MGASA-2014-0100 advisory.");
...
application (CVE-2013-7285).");
  ...
  script_tag(name:"affected", value:"'kxml, xstream, xstream' package(s) on Mageia 3, Mageia 4.");
