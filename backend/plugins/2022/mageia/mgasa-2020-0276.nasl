...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2020.0276");
  ...
  script_name("Mageia: Security Advisory (MGASA-2020-0276)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2020-0276");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2020-0276.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=26253");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2020/02/24/2");
  script_xref(name:"URL", value:"https://mail.python.org/pipermail/mailman-announce/2020-April/000250.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman' package(s) announced via the MGASA-2020-0276 advisory.");
...
and other issues. See the release announcement for details.");
  ...
  script_tag(name:"affected", value:"'mailman' package(s) on Mageia 7.");
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mailman", rpm:"mailman~2.1.33~1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }
