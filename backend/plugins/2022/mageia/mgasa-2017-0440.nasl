...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'git, git' package(s) announced via the MGASA-2017-0440 advisory.");
...
(CVE-2017-15298).");
  ...
  script_tag(name:"affected", value:"'git, git' package(s) on Mageia 5, Mageia 6.");
