...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libcaca, libcaca' package(s) announced via the MGASA-2021-0128 advisory.");
...
lead to local execution of arbitrary code in the user context (CVE-2021-3410).");
  ...
  script_tag(name:"affected", value:"'libcaca, libcaca' package(s) on Mageia 7, Mageia 8.");
