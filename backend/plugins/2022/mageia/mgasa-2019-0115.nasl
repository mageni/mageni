...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphicsmagick, imagemagick, transcode, xine-lib1.2, xine-lib1.2' package(s) announced via the MGASA-2019-0115 advisory.");
...
memory leaks exist in WritePDFImage in coders/pdf.c. (CVE-2019-7397)");
  ...
  script_tag(name:"affected", value:"'graphicsmagick, imagemagick, transcode, xine-lib1.2, xine-lib1.2' package(s) on Mageia 6.");
