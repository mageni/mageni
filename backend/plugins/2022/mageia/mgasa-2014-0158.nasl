...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0158");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0158)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0158");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0158.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-imaging' package(s) announced via the MGASA-2014-0158 advisory.");
...
application that uses the Python Imaging Library (CVE-2014-1933).");
  ...
  script_tag(name:"affected", value:"'python-imaging' package(s) on Mageia 3.");
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-imaging", rpm:"python-imaging~1.1.7~7.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-imaging-devel", rpm:"python-imaging-devel~1.1.7~7.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
