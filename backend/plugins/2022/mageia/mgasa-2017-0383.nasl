...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2017.0383");
  ...
  script_name("Mageia: Security Advisory (MGASA-2017-0383)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2017-0383");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2017-0383.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=21850");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-linus' package(s) announced via the MGASA-2017-0383 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This kernel-linus update is based on upstream 4.9.56 and fixes at least the
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-4.9.56-1.mga6", rpm:"kernel-linus-4.9.56-1.mga6~1~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus", rpm:"kernel-linus~4.9.56~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-4.9.56-1.mga6", rpm:"kernel-linus-devel-4.9.56-1.mga6~1~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-latest", rpm:"kernel-linus-devel-latest~4.9.56~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-doc", rpm:"kernel-linus-doc~4.9.56~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-latest", rpm:"kernel-linus-latest~4.9.56~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-4.9.56-1.mga6", rpm:"kernel-linus-source-4.9.56-1.mga6~1~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source-latest", rpm:"kernel-linus-source-latest~4.9.56~1.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
