...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2021.0256");
  script_cve_id("CVE-2020-24489", "CVE-2020-24511", "CVE-2020-24513");
  ...
  script_name("Mageia: Security Advisory (MGASA-2021-0256)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2021-0256");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2021-0256.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=29095");
  script_xref(name:"URL", value:"https://github.com/intel/Intel-Linux-Processor-Microcode-Data-Files/releases/tag/microcode-20210608");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode, microcode' package(s) announced via the MGASA-2021-0256 advisory.");
...
For more info about this update, see the refenced links.");
  ...
  script_tag(name:"affected", value:"'microcode, microcode' package(s) on Mageia 7, Mageia 8.");
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode", rpm:"microcode~0.20210608~1.mga7.nonfree", rls:"MAGEIA7"))) {
    report += res;
  }
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode", rpm:"microcode~0.20210608~1.mga8.nonfree", rls:"MAGEIA8"))) {
    report += res;
  }
