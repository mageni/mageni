...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2013-09-25 18:21:00 +0000 (Wed, 25 Sep 2013)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmodplug, libmodplug' package(s) announced via the MGASA-2013-0271 advisory.");
...
specially crafted ABC file (CVE-2013-4234).");
  ...
  script_tag(name:"affected", value:"'libmodplug, libmodplug' package(s) on Mageia 2, Mageia 3.");
