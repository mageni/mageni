...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-09-13 05:25:00 +0000 (Sat, 13 Sep 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'net-snmp, net-snmp' package(s) announced via the MGASA-2014-0122 advisory.");
