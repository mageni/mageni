...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'connman, connman' package(s) announced via the MGASA-2018-0036 advisory.");
...
(CVE-2017-12865)");
  ...
  script_tag(name:"affected", value:"'connman, connman' package(s) on Mageia 5, Mageia 6.");
