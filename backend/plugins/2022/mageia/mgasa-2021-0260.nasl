...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-bleach, python-bleach' package(s) announced via the MGASA-2021-0260 advisory.");
...
in allowed tags and 'strip_comments=False' is set (CVE-2021-23980).");
  ...
  script_tag(name:"affected", value:"'python-bleach, python-bleach' package(s) on Mageia 7, Mageia 8.");
