...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2013.0345");
  ...
  script_name("Mageia: Security Advisory (MGASA-2013-0345)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2013-0345");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2013-0345.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-rt' package(s) announced via the MGASA-2013-0345 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This kernel-rt update provides the upstream 3.4.69 kernel and fixes the
...
if(release == "MAGEIA2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-3.4.69-0.rt83.1.mga2", rpm:"kernel-rt-3.4.69-0.rt83.1.mga2~1~1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt", rpm:"kernel-rt~3.4.69~0.rt83.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-devel-3.4.69-0.rt83.1.mga2", rpm:"kernel-rt-devel-3.4.69-0.rt83.1.mga2~1~1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-devel-latest", rpm:"kernel-rt-devel-latest~3.4.69~0.rt83.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-doc", rpm:"kernel-rt-doc~3.4.69~0.rt83.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-latest", rpm:"kernel-rt-latest~3.4.69~0.rt83.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-source-3.4.69-0.rt83.1.mga2", rpm:"kernel-rt-source-3.4.69-0.rt83.1.mga2~1~1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-source-latest", rpm:"kernel-rt-source-latest~3.4.69~0.rt83.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }
