...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-06-21 04:38:00 +0000 (Sat, 21 Jun 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'flash-player-plugin, flash-player-plugin' package(s) announced via the MGASA-2014-0220 advisory.");
