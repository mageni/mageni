...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-02-10 19:16:00 +0000 (Wed, 10 Feb 2021)");
  ...
  script_tag(name:"insight", value:"Multiple security issues found in ezXML, bundled in netcdf");

  script_tag(name:"affected", value:"'netcdf' package(s) on Mageia 8.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64netcdf-devel", rpm:"lib64netcdf-devel~4.7.4~3.1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64netcdf18", rpm:"lib64netcdf18~4.7.4~3.1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libnetcdf-devel", rpm:"libnetcdf-devel~4.7.4~3.1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libnetcdf18", rpm:"libnetcdf18~4.7.4~3.1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"netcdf", rpm:"netcdf~4.7.4~3.1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
