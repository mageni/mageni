...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive, libarchive' package(s) announced via the MGASA-2017-0337 advisory.");
...
archive_read_support_format_xar.c (CVE-2017-14166).");
  ...
  script_tag(name:"affected", value:"'libarchive, libarchive' package(s) on Mageia 5, Mageia 6.");
