...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript, ghostscript' package(s) announced via the MGASA-2019-0236 advisory.");
...
klatexformula (mga#24866).");
  ...
  script_tag(name:"affected", value:"'ghostscript, ghostscript' package(s) on Mageia 6, Mageia 7.");
