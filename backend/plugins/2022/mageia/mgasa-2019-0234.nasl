...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible, ansible, python-jmespath' package(s) announced via the MGASA-2019-0234 advisory.");
...
Also, python-jmespath was added as a new dependency in Mageia 6.");
  ...
  script_tag(name:"affected", value:"'ansible, ansible, python-jmespath' package(s) on Mageia 6, Mageia 7.");
