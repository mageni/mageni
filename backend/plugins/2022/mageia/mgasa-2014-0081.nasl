...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rawtherapee, rawtherapee' package(s) announced via the MGASA-2014-0081 advisory.");
...
dereference (CVE-2013-1438).");
  ...
  script_tag(name:"affected", value:"'rawtherapee, rawtherapee' package(s) on Mageia 3, Mageia 4.");
