...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'polkit, polkit' package(s) announced via the MGASA-2021-0244 advisory.");
  ...
  script_tag(name:"affected", value:"'polkit, polkit' package(s) on Mageia 7, Mageia 8.");
