...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-13 15:38:00 +0000 (Thu, 13 Dec 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'flash-player-plugin, flash-player-plugin' package(s) announced via the MGASA-2013-0328 advisory.");
