...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'broadcom-wl, btrfs-progs, drakxtools, fglrx, kernel, kernel-firmware, kernel-firmware-nonfree, kernel-userspace-headers, kmod-broadcom-wl, kmod-fglrx, kmod-nvidia-current, kmod-nvidia173, kmod-nvidia304, kmod-vboxadditions, kmod-virtualbox, kmod-xtables-addons, ldetect-lst, libdrm, mesa, mesa, nvidia-current, nvidia173, nvidia304, radeon-firmware, x11-driver-video-ati, x11-driver-video-intel, x11-driver-video-nouveau, xtables-addons' package(s) announced via the MGASA-2013-0371 advisory.");
...
service (heap-based out-of-bounds write) via a crafted ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'broadcom-wl, btrfs-progs, drakxtools, fglrx, kernel, kernel-firmware, kernel-firmware-nonfree, kernel-userspace-headers, kmod-broadcom-wl, kmod-fglrx, kmod-nvidia-current, kmod-nvidia173, kmod-nvidia304, kmod-vboxadditions, kmod-virtualbox, kmod-xtables-addons, ldetect-lst, libdrm, mesa, mesa, nvidia-current, nvidia173, nvidia304, radeon-firmware, x11-driver-video-ati, x11-driver-video-intel, x11-driver-video-nouveau, xtables-addons' package(s) on Mageia 3.");
