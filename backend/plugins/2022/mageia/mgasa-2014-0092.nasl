...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-11-19 03:00:00 +0000 (Wed, 19 Nov 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'file, file' package(s) announced via the MGASA-2014-0092 advisory.");
