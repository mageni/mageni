...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxfont, libxfont, libxfont2' package(s) announced via the MGASA-2017-0373 advisory.");
...
(CVE-2017-13722)");
  ...
  script_tag(name:"affected", value:"'libxfont, libxfont, libxfont2' package(s) on Mageia 5, Mageia 6.");
