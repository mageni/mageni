...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-11-14 03:06:00 +0000 (Fri, 14 Nov 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'transmission, transmission' package(s) announced via the MGASA-2014-0298 advisory.");
...
service, or possibly execute arbitrary code (CVE-2014-4909).");
  ...
  script_tag(name:"affected", value:"'transmission, transmission' package(s) on Mageia 3, Mageia 4.");
