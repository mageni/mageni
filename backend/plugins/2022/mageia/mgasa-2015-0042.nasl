...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2015.0042");
  ...
  script_name("Mageia: Security Advisory (MGASA-2015-0042)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2015-0042");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0042.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=15135");
  script_xref(name:"URL", value:"http://openwall.com/lists/oss-security/2015/01/26/4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'privoxy' package(s) announced via the MGASA-2015-0042 advisory.");
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"privoxy", rpm:"privoxy~3.0.21~2.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
