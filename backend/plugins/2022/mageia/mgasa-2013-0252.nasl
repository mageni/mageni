...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-06-09 01:59:00 +0000 (Thu, 09 Jun 2016)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'bzr, bzr, python-pip, python-requests, python-tornado, python-tornado, python-virtualenv, python3, python3' package(s) announced via the MGASA-2013-0252 advisory.");
...
python-pip, and python-virtualenv, and those have been updated as well.");
  ...
  script_tag(name:"affected", value:"'bzr, bzr, python-pip, python-requests, python-tornado, python-tornado, python-virtualenv, python3, python3' package(s) on Mageia 2, Mageia 3.");
