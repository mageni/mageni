...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2021.0248");
  ...
  script_name("Mageia: Security Advisory (MGASA-2021-0248)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2021-0248");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2021-0248.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=29003");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/thread/KUE2Z2ZUWBHRU36ZGBD2YSJCYB6ELPXE/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker-containerd, docker-containerd' package(s) announced via the MGASA-2021-0248 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In containerd (an industry-standard container runtime) before versions 1.3.10
...
containerd 1.4.4. (CVE-2021-21334).");
  ...
  script_tag(name:"affected", value:"'docker-containerd, docker-containerd' package(s) on Mageia 7, Mageia 8.");
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-containerd", rpm:"docker-containerd~1.4.4~1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-containerd", rpm:"docker-containerd~1.4.4~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
