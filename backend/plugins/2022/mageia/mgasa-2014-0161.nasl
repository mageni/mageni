...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'a2ps, a2ps' package(s) announced via the MGASA-2014-0161 advisory.");
...
executed with the privileges of the user running fixps (CVE-2014-0466).");
  ...
  script_tag(name:"affected", value:"'a2ps, a2ps' package(s) on Mageia 3, Mageia 4.");
