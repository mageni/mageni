...
if(description)
{
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5010419)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5010419");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5010419");
...
if(version_is_less(version:fileVer, test_version:"6.3.9600.20269"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"Less than 6.3.9600.20269");
