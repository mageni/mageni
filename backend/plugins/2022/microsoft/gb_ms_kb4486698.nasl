...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820046");
  script_version("2022-03-31T07:10:52+0000");
  script_cve_id("CVE-2020-17122");
  ...
  script_name("Microsoft Office 2010 Remote Code Execution Vulnerability (KB4486698)");

  script_tag(name:"summary", value:"Microsoft Office 2010 is prone to
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4486698");
