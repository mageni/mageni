...
if(description)
{
  ...
  update according to Microsoft KB5011552");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5011552");
...
if(version_is_less(version:fileVer, test_version:"6.1.7601.25895"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"Less than 6.1.7601.25895");
