...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820066");
  ...
  script_name("Microsoft .NET Framework DoS Vulnerability (KB5012331)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5012331");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5012331");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.8961"))
            {
              vulnerable_range = "2.0.50727 - 2.0.50727.8961";
              break;
            }

            if(version_in_range(version:dllVer, test_version:"4.0.30319.30000", test_version2:"4.0.30319.36729"))
            {
              vulnerable_range = "4.0.30319.30000 - 4.0.30319.36729";
              break;
            }
            else if(version_in_range(version:dllVer, test_version:"4.6", test_version2:"4.7.3929"))
            {
              vulnerable_range = "4.6 - 4.7.3929";
              break;
            }
