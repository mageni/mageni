...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818946");
  ...
  script_name("Microsoft .NET Framework DoS Vulnerability (KB5008879)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5008879");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5 and 4.8 for Microsoft Windows 10 version 1909.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5008879");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9159"))
              {
                vulnerable_range = "2.0.50727 - 2.0.50727.9159";
                break;
              }
