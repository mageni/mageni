...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819913");
  ...
  script_name("Microsoft Office 2013 Remote Code Execution Vulnerability (KB5002119)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002119");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002119");
