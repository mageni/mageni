...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821231");
  ...
  script_name("Microsoft .NET Framework DoS Vulnerability (KB5013624)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5013624");
  ...
  - Microsoft .NET Framework 4.8 for Microsoft Windows 10 Version 21H2/21H2 32-bit/x64-based Systems");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5013624");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if("19042" >< build && version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9163"))
              {
                vulnerable_range = "2.0.50727 - 2.0.50727.9163";
                break;
              }
              else if(("19042" >< build || "19043" >< build || "19044" >< build) && version_in_range(version:dllVer, test_version:"4.8", test_version2:"4.8.4509"))
              {
