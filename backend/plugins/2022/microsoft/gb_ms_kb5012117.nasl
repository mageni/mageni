...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820067");
  ...
  script_name("Microsoft .NET Framework DoS Vulnerability (KB5012117)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5012117");
  ...
  script_tag(name:"affected", value:"- Microsoft .NET Framework 3.5 and 4.8 for Microsoft Windows 10 Version 20H2 32-bit/x64-based Systems

  - Microsoft .NET Framework 4.8 for Microsoft Windows 10 Version 21H2/21H1 32-bit/x64-based Systems");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5012117");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if("19042" >< build && version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9160"))
              {
    ...
    if((!vulnerable_range) && "ASP.NET" >< key)
    {
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(dotPath && "\Microsoft.NET\Framework" >< dotPath)
        {
          ...
          if(dllVer)
          {
            if(edgeVer =~ "^11\.0\.19042" && version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9160"))
            {
              vulnerable_range = "2.0.50727 - 2.0.50727.9160";
              break;
            }
            else if(edgeVer =~ "^11\.0\.1904[234]" && version_in_range(version:dllVer, test_version:"4.8", test_version2:"4.8.4493"))
            {
              vulnerable_range = "4.8 - 4.8.4493" ;
              break;
            }
