...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821136");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_21-2022-06) - MAC OS X");
  ...
  prior to 103.0.5060.53 on MAC OS X.");
