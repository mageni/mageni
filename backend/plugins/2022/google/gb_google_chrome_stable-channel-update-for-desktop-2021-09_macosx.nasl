...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821216");
  ...
  script_tag(name:"creation_date", value:"2022-05-09 11:01:06 +0530 (Mon, 09 May 2022)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2021-09) - Mac OS X");
