...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821245");
  ...
  script_tag(name:"creation_date", value:"2022-05-13 18:14:46 +0530 (Fri, 13 May 2022)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_10-2022-05) - Mac OS X");
