...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2017.026.01");
  ...
  script_name("Slackware: Security Advisory (SSA:2017-026-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2017-026-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2017&m=slackware-security.448861");
  script_xref(name:"URL", value:"https://www.mozilla.org/security/known-vulnerabilities/thunderbird.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-thunderbird' package(s) announced via the SSA:2017-026-01 advisory.");
...
if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"45.7.0-i486-1_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"45.7.0-x86_64-1_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"45.7.0-i586-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"45.7.0-x86_64-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
