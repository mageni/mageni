...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2020.091.01");
  ...
  script_name("Slackware: Security Advisory (SSA:2020-091-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2020-091-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2020&m=slackware-security.349813");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls' package(s) announced via the SSA:2020-091-01 advisory.");
...
+--------------------------+
patches/packages/gnutls-3.6.13-i586-1_slack14.2.txz: Upgraded.
...
if(!isnull(res = isslkpkgvuln(pkg:"gnutls", ver:"3.6.13-i586-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"gnutls", ver:"3.6.13-x86_64-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
