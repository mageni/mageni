...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2014.175.04");
  ...
  script_name("Slackware: Security Advisory (SSA:2014-175-04)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2014-175-04");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2014&m=slackware-security.435311");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the SSA:2014-175-04 advisory.");
...
if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.6.24-i486-1_slack14.0", rls:"SLK14.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.6.24-x86_64-1_slack14.0", rls:"SLK14.0"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"4.1.9-i486-1_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"4.1.9-x86_64-1_slack14.1", rls:"SLK14.1"))) {
  report += res;
}
