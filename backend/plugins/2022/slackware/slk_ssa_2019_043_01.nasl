...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2019.043.01");
  ...
  script_name("Slackware: Security Advisory (SSA:2019-043-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2019-043-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2019&m=slackware-security.394423");
  script_xref(name:"URL", value:"https://seclists.org/oss-sec/2019/q1/119");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lxc' package(s) announced via the SSA:2019-043-01 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"New lxc packages are available for Slackware 14.2 and -current to
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'lxc' package(s) on Slackware 14.2, Slackware current.");
...
if(!isnull(res = isslkpkgvuln(pkg:"lxc", ver:"2.0.9_d3a03247-i586-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
if(!isnull(res = isslkpkgvuln(pkg:"lxc", ver:"2.0.9_d3a03247-x86_64-1_slack14.2", rls:"SLK14.2"))) {
  report += res;
}
