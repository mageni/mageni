...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.14937.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:14937-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:14937-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-202214937-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openvpn-openssl1' package(s) announced via the SUSE-SU-2022:14937-1 advisory.");
...
if(release == "SLES11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openvpn-openssl1", rpm:"openvpn-openssl1~2.3.2~0.10.12.1", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvpn-openssl1-down-root-plugin", rpm:"openvpn-openssl1-down-root-plugin~2.3.2~0.10.12.1", rls:"SLES11.0"))) {
    report += res;
  }
