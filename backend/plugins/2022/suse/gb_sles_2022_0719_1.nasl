...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.0719.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:0719-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:0719-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220719-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd' package(s) announced via the SUSE-SU-2022:0719-1 advisory.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"containerd", rpm:"containerd~1.4.13~16.54.1", rls:"SLES12.0"))) {
    report += res;
  }
