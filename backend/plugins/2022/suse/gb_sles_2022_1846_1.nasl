...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.1846.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:1846-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:1846-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221846-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-firmware' package(s) announced via the SUSE-SU-2022:1846-1 advisory.");
...
if(release == "SLES12.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware", rpm:"kernel-firmware~20190618~5.25.2", rls:"SLES12.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-amd", rpm:"ucode-amd~20190618~5.25.2", rls:"SLES12.0SP4"))) {
    report += res;
  }
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware", rpm:"kernel-firmware~20190618~5.25.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-amd", rpm:"ucode-amd~20190618~5.25.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
