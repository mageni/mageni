...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.1840.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:1840-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221840-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-firmware' package(s) announced via the SUSE-SU-2022:1840-1 advisory.");
...
(CVE-2021-26339, CVE-2021-26373, CVE-2021-26347, CVE-2021-26376,
 ...
 bsc#1199459, bsc#1199470)");
  ...
  script_tag(name:"affected", value:"'kernel-firmware' package(s) on SUSE Linux Enterprise Micro 5.1, SUSE Linux Enterprise Micro 5.2, SUSE Linux Enterprise Module for Basesystem 15-SP3.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware", rpm:"kernel-firmware~20210208~150300.4.10.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware-brcm", rpm:"kernel-firmware-brcm~20210208~150300.4.10.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-amd", rpm:"ucode-amd~20210208~150300.4.10.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
