...
if(description)
{
  ...
  script_tag(name:"affected", value:"QNAP QuTScloud version c5.x prior to c5.0.0.1998 build 20220408.");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"c5.0.0", test_version_up:"c5.0.0_20220408" ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"c5.0.0_20220408" );
