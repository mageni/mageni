...
if(description)
{
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h4.5.4, h5.0.x prior to h5.0.0
  build 20220428.");

  script_tag(name:"solution", value:"Update to version h5.0.0 build 20220428 or later.");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"h4.5.4", test_version_up:"h5.0.0_20220428" ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"h5.0.0_20220428" );
