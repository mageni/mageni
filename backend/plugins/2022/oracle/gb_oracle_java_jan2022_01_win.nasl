...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819964");
  ...
  script_name("Oracle Java SE Security Update (jan2022) 01 - Windows");
  ...
  and earlier, 7u321 (1.7.0.321) and earlier on Windows.");
