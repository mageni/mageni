...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819970");
  script_version("2022-01-20T06:32:54+0000");
  script_cve_id("CVE-2022-21349");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2022-01-20 06:32:54 +0000 (Thu, 20 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-19 23:53:51 +0530 (Wed, 19 Jan 2022)");
  script_name("Oracle Java SE Security Update (jan2022) 01 - Linux");
  ...
  script_tag(name:"insight", value:"The flaw is due to an error in '2D'
  component.");
  ...
  and earlier, 7u321 (1.7.0.321) and earlier on Linux.");
