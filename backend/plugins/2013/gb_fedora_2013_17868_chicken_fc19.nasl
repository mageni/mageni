...
#
# Fedora Update for chicken FEDORA-2013-17868
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for chicken FEDORA-2013-17868");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"chicken", rpm:"chicken~4.8.0.4~4.fc19", rls:"FC19")) != NULL)
  {
