...
# $Id: gb_ubuntu_USN_1970_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-10-03 10:20:27 +0530 (Thu, 03 Oct 2013)");
  script_cve_id("CVE-2013-4254", "CVE-2013-1819", "CVE-2013-2237");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-lts-quantal USN-1970-1");
...
(CVE-2013-2237)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1970-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-41-generic", ver:"3.5.0-41.64~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
