...
#
# Fedora Update for python-pip FEDORA-2013-13213
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for python-pip FEDORA-2013-13213");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"python-pip", rpm:"python-pip~1.3.1~4.fc17", rls:"FC17")) != NULL)
  {
