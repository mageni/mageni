...
# $Id: gb_suse_2012_1460_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
# SuSE Update for update openSUSE-SU-2012:1460-1 (update)
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2012-11/msg00003.html");
  script_oid("1.3.6.1.4.1.25623.1.0.850424");
  script_version("$Revision: 12497 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-23 09:28:21 +0100 (Fri, 23 Nov 2018) $");
  script_tag(name:"creation_date", value:"2013-03-11 18:29:27 +0530 (Mon, 11 Mar 2013)");
  script_cve_id("CVE-2012-4548");
  script_tag(name:"cvss_base", value:"6.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:P/I:P/A:P");
  script_name("SuSE Update for update openSUSE-SU-2012:1460-1 (update)");
