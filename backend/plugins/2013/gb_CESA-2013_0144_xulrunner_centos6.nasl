...
#
# CentOS Update for xulrunner CESA-2013:0144 centos6
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2013-January/019048.html");
  script_oid("1.3.6.1.4.1.25623.1.0.881555");
  script_version("$Revision: 14222 $");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-01-11 16:46:19 +0530 (Fri, 11 Jan 2013)");
  ...
  script_name("CentOS Update for xulrunner CESA-2013:0144 centos6");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~10.0.12~1.el6.centos", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~10.0.12~1.el6.centos", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
