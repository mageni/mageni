...
# $Id: gb_suse_2012_1643_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This version upgrade of flash-player fixed multiple
...
if(release == "openSUSE12.1")
{
  ...
  if ((res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.258~38.1", rls:"openSUSE12.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.258~38.1", rls:"openSUSE12.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.258~38.1", rls:"openSUSE12.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
