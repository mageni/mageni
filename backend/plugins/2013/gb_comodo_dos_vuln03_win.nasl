...
# $Id: gb_comodo_dos_vuln03_win.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Comodo Internet Security versions before 3.8.65951.477");
  ...
  script_tag(name:"solution", value:"Upgrade to Comodo Internet Security version 3.8.65951.477 or later.");
