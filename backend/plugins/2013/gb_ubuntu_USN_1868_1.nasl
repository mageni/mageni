...
# $Id: gb_ubuntu_USN_1868_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_tag(name:"affected", value:"libxvmc on Ubuntu 13.04,
  Ubuntu 12.10,
  Ubuntu 12.04 LTS");
  ...
  script_name("Ubuntu Update for libxvmc USN-1868-1");

  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1868-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libxvmc1", ver:"2:1.0.6-1ubuntu2", rls:"UBUNTU12.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libxvmc1", ver:"2:1.0.7-1ubuntu1", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU13.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"libxvmc1", ver:"2:1.0.7-1ubuntu1", rls:"UBUNTU13.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
