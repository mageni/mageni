...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866871");
  ...
  script_name("Fedora Update for lighttpd FEDORA-2013-15344");


  script_tag(name:"affected", value:"lighttpd on Fedora 18");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"lighttpd", rpm:"lighttpd~1.4.32~1.fc18", rls:"FC18")) != NULL)
  {
