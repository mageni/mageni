...
#
# CentOS Update for firefox CESA-2013:0271 centos5
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.881614");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-02-22 10:08:22 +0530 (Fri, 22 Feb 2013)");
  script_cve_id("CVE-2013-0775", "CVE-2013-0776", "CVE-2013-0780", "CVE-2013-0782", "CVE-2013-0783");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("CentOS Update for firefox CESA-2013:0271 centos5");

  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2013-February/019245.html");
  ...
  described in the linked article may be required when using Firefox 17.0.3 ESR with the
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~17.0.3~1.el5.centos", rls:"CentOS5")) != NULL)
  {
