...
# $Id: alas-2013-245.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-245");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"gc-devel", rpm:"gc-devel~7.1~12.6.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"gc", rpm:"gc~7.1~12.6.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"gc-debuginfo", rpm:"gc-debuginfo~7.1~12.6.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
