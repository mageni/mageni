...
#
# Fedora Update for v8 FEDORA-2013-23401
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867194");
  ...
  script_name("Fedora Update for v8 FEDORA-2013-23401");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"v8", rpm:"v8~3.14.5.10~3.fc18", rls:"FC18")) != NULL)
  {
