...
#
# Fedora Update for kernel FEDORA-2013-15151
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866832");
  ...
  script_name("Fedora Update for kernel FEDORA-2013-15151");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.10.9~100.fc18", rls:"FC18")) != NULL)
  {
