...
# $Id: gb_ubuntu_USN_1839_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"A flaw was discovered in the Linux kernel's perf_events interface. A local
