...
# $Id: deb_2623.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"openconnect on Debian Linux");
  script_tag(name:"solution", value:"For the stable distribution (squeeze), this problem has been fixed in
version 2.25-0.1+squeeze2.

We recommend that you upgrade your openconnect packages.");
  script_tag(name:"summary", value:"Kevin Cernekee discovered that a malicious VPN gateway can send
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"openconnect", ver:"2.25-0.1+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
