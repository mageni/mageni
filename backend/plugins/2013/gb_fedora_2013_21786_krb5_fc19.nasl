...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867099");
  ...
  script_name("Fedora Update for krb5 FEDORA-2013-21786");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.11.3~13.fc19", rls:"FC19")) != NULL)
  {
