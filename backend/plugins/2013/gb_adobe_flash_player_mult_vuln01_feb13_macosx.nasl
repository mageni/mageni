...
# $Id: gb_adobe_flash_player_mult_vuln01_feb13_macosx.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(playerVer =~ "^[0-9]+\.")
{
  ...
  {
    report = report_fixed_ver(installed_version:playerVer, vulnerable_range:"< 10.3.183.51, 11.0 - 11.5.502.148");
