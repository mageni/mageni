...
#
# CentOS Update for xulrunner CESA-2013:0271 centos6
#
# Authors:
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~17.0.3~1.el6.centos", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~17.0.3~1.el6.centos", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
