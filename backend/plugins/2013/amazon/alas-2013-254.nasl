...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-254)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"mod24_nss-debuginfo", rpm:"mod24_nss-debuginfo~1.0.8~24.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mod24_nss", rpm:"mod24_nss~1.0.8~24.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }
