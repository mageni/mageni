...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867090");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-11-26 10:46:52 +0530 (Tue, 26 Nov 2013)");
  script_cve_id("CVE-2013-4238");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_name("Fedora Update for python3 FEDORA-2013-21418");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"python3", rpm:"python3~3.3.2~8.fc19", rls:"FC19")) != NULL)
  {
