...
# $Id: gb_suse_2013_1370_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"puppet on openSUSE 12.3");
  script_tag(name:"insight", value:"A potential remote code execution via YAML was fixed in
