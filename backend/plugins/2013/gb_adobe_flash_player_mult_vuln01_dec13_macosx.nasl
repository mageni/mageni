...
# $Id: gb_adobe_flash_player_mult_vuln01_dec13_macosx.nasl 12832 2018-12-19 07:49:53Z asteins $
#
# Adobe Flash Player Multiple Vulnerabilities-01 Dec13 (Mac OS X)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.804168");
  ...
  script_tag(name:"creation_date", value:"2013-12-18 16:15:12 +0530 (Wed, 18 Dec 2013)");
  script_name("Adobe Flash Player Multiple Vulnerabilities-01 Dec13 (Mac OS X)");
