...
# $Id: deb_2755.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
We recommend that you upgrade your python-django packages.");
  script_tag(name:"summary", value:"Rainer Koirikivi discovered a directory traversal vulnerability with
ssi
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-django", ver:"1.2.3-3+squeeze7", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-django-doc", ver:"1.2.3-3+squeeze7", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-django", ver:"1.4.5-1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-django-doc", ver:"1.4.5-1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
