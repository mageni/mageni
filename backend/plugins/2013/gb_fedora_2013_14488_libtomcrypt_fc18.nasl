...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866467");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-08-20 12:42:32 +0530 (Tue, 20 Aug 2013)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("Fedora Update for libtomcrypt FEDORA-2013-14488");


  script_tag(name:"affected", value:"libtomcrypt on Fedora 18");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"libtomcrypt", rpm:"libtomcrypt~1.17~20.fc18", rls:"FC18")) != NULL)
  {
