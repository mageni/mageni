...
# $Id: gb_comodo_dos_vuln04_win.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Upgrade to Comodo Internet Security version 3.11.108364.552 or later.");
