...
# $Id: deb_2629.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
We recommend that you upgrade your openjpeg packages.");
  script_tag(name:"summary", value:"CVE-2009-5030
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libopenjpeg-dev", ver:"1.3+dfsg-4+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libopenjpeg2", ver:"1.3+dfsg-4+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libopenjpeg2-dbg", ver:"1.3+dfsg-4+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjpeg-tools", ver:"1.3+dfsg-4+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libopenjpeg-dev", ver:"1.3+dfsg-4.6", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libopenjpeg2", ver:"1.3+dfsg-4.6", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libopenjpeg2-dbg", ver:"1.3+dfsg-4.6", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"openjpeg-tools", ver:"1.3+dfsg-4.6", rls:"DEB7")) != NULL) {
  report += res;
}
