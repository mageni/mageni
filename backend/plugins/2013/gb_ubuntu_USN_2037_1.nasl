...
# $Id: gb_ubuntu_USN_2037_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-ec2 USN-2037-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-12-04 10:27:49 +0530 (Wed, 04 Dec 2013)");
  script_cve_id("CVE-2012-2121", "CVE-2013-4511");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-ec2 USN-2037-1");
...
exploit this flaw to gain administrative privileges. (CVE-2013-4511)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2037-1/");
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-2.6.32-359-ec2", ver:"2.6.32-359.72", rls:"UBUNTU10.04 LTS")) != NULL)
  {
