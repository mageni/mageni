...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867169");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-12-17 11:49:58 +0530 (Tue, 17 Dec 2013)");
  script_cve_id("CVE-2013-4553", "CVE-2013-4554", "CVE-2013-6375", "CVE-2013-4551",
                ...
                "CVE-2013-2196", "CVE-2013-2076", "CVE-2013-2077", "CVE-2013-2078",
                "CVE-2013-2072", "CVE-2013-1952", "CVE-2013-1922", "CVE-2013-1919",
  ...
  script_name("Fedora Update for xen FEDORA-2013-22312");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123213.html");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"xen", rpm:"xen~4.2.3~10.fc18", rls:"FC18")) != NULL)
  {
