...
if(description)
{
  ...
  script_name("Oracle MySQL 5.5 <= 5.5.30 / 5.6 <= 5.6.10 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5 versions 5.5.30 and prior, 5.6.10 and prior.");
