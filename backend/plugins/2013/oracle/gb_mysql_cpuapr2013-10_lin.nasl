...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117214");
  ...
  script_name("Oracle MySQL 5.5 <= 5.5.29 Security Update (cpuapr2013) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5 versions 5.5.29 and prior.");
