...
# $Id: gb_openssl_dhe_ecdhe_key_exchange_dos_vuln_win.nasl 13898 2019-02-27 08:37:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"OpenSSL 1.1.0 before 1.1.0d on Windows");
