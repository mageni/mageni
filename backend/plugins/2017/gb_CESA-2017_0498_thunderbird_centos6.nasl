...
#
# CentOS Update for thunderbird CESA-2017:0498 centos6
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882679");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2017-03-16 09:11:00 +0100 (Thu, 16 Mar 2017)");
  ...
  script_name("CentOS Update for thunderbird CESA-2017:0498 centos6");
...
the original reporters.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2017-March/022339.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~45.8.0~1.el6.centos", rls:"CentOS6")) != NULL)
  {
