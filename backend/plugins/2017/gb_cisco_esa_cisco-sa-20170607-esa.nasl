...
# $Id: gb_cisco_esa_cisco-sa-20170607-esa.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
Security Appliance (ESA) could allow an unauthenticated, remote attacker to conduct a cross-site scripting (XSS)
