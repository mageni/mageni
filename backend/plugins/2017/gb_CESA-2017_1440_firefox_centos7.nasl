...
#
# CentOS Update for firefox CESA-2017:1440 centos7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882734");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2017-06-16 06:58:54 +0200 (Fri, 16 Jun 2017)");
  ...
  script_name("CentOS Update for firefox CESA-2017:1440 centos7");
...
Smith, Abhishek Arya, and F. Alonso (revskills) as the original reporters.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2017-June/022460.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~52.2.0~1.el7.centos", rls:"CentOS7")) != NULL)
  {
