...
# $Id: deb_3924.nasl 14280 2019-03-18 14:50:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libvarnishapi-dev", ver:"5.0.0-7+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libvarnishapi1", ver:"5.0.0-7+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish", ver:"5.0.0-7+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish-doc", ver:"5.0.0-7+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libvarnishapi-dev", ver:"4.0.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libvarnishapi1", ver:"4.0.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish", ver:"4.0.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish-dbg", ver:"4.0.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish-doc", ver:"4.0.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
