...
if (description)
{
  ...
  script_tag(name:"impact", value:"An attacker may be able to disrupt service on the BIG-IP system by sending crafted websocket traffic to the virtual server.");
