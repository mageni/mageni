...
# $Id: deb_3988.nasl 14280 2019-03-18 14:50:45Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"idn2", ver:"0.16-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0", ver:"0.16-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dbg", ver:"0.16-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dev", ver:"0.16-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"idn2", ver:"0.10-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0", ver:"0.10-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dbg", ver:"0.10-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dev", ver:"0.10-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"idn2", ver:"2.0.2-4", rls:"DEB10")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0", ver:"2.0.2-4", rls:"DEB10")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dev", ver:"2.0.2-4", rls:"DEB10")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-dev", ver:"2.0.2-4", rls:"DEB10")) != NULL) {
  report += res;
}
