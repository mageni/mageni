...
#
# RedHat Update for firefox RHSA-2017:0461-01
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871770");
  script_version("$Revision: 12497 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-23 09:28:21 +0100 (Fri, 23 Nov 2018) $");
  script_tag(name:"creation_date", value:"2017-03-09 05:00:23 +0100 (Thu, 09 Mar 2017)");
  ...
  script_name("RedHat Update for firefox RHSA-2017:0461-01");
...
the original reporters.");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2017-March/msg00021.html");
...
if(release == "RHENT_7")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~52.0~4.el7_3", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"firefox-debuginfo", rpm:"firefox-debuginfo~52.0~4.el7_3", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
