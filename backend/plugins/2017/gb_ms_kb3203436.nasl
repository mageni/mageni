...
if(description)
{
  ...
  update according to Microsoft KB3203436");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/3203436");
...
if(officeVer =~ "^(12\.)")
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"12.0", test_version2:"12.0.6770.4999"))
  {
