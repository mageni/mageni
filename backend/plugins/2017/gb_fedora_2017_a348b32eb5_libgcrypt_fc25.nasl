...
#
# Fedora Update for libgcrypt FEDORA-2017-a348b32eb5
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XBH2YFHL7DVECJ5FL7MSNYYJ25NA2OH5");
...
if(release == "FC25")
{
  ...
  if ((res = isrpmvuln(pkg:"libgcrypt", rpm:"libgcrypt~1.7.8~1.fc25", rls:"FC25")) != NULL)
  {
