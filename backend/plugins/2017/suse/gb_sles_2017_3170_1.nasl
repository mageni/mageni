...
if(description)
{
  ...
  script_cve_id("CVE-2014-9939","CVE-2017-12448","CVE-2017-12450");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:3170-1)");
  ...
  package(s) announced via the SUSE-SU-2017:3170-1 advisory.");
