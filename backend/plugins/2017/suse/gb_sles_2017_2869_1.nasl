...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000252","CVE-2017-10810","CVE-2017-11472");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2869-1)");
  ...
  package(s) announced via the SUSE-SU-2017:2869-1 advisory.");
