...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0003-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-January/002540.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'zlib'
  package(s) announced via the SUSE-SU-2017:0003-1 advisory.");
