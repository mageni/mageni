...
if(description)
{
  ...
  script_cve_id("CVE-2017-13738","CVE-2017-13739","CVE-2017-13740");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2570-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-September/003260.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'liblouis'
  package(s) announced via the SUSE-SU-2017:2570-1 advisory.");
