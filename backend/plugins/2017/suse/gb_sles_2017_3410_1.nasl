...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000410","CVE-2017-11600","CVE-2017-12193");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:3410-1)");
  ...
  package(s) announced via the SUSE-SU-2017:3410-1 advisory.");
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-default-base-debuginfo", rpm:"kernel-default-base-debuginfo~4.4.103~92.53.1", rls:"SLES12.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-debuginfo", rpm:"kernel-default-debuginfo~4.4.103~92.53.1", rls:"SLES12.0SP2"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-debugsource", rpm:"kernel-default-debugsource~4.4.103~92.53.1", rls:"SLES12.0SP2"))){
    report += res;
  }
