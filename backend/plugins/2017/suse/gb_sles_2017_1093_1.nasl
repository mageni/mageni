...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1093-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-April/002824.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tigervnc'
  package(s) announced via the SUSE-SU-2017:1093-1 advisory.");
