...
if(description)
{
  ...
  script_cve_id("CVE-2015-8709","CVE-2016-7117","CVE-2016-9806");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0575-1)");
  ...
  package(s) announced via the SUSE-SU-2017:0575-1 advisory.");
