...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000111","CVE-2017-1000112","CVE-2017-10810");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2286-1)");
  ...
  package(s) announced via the SUSE-SU-2017:2286-1 advisory.");
