...
if(description)
{
  ...
  script_cve_id("CVE-2016-6354","CVE-2016-7175","CVE-2016-7176");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1442-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-May/002925.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2017:1442-1 advisory.");
