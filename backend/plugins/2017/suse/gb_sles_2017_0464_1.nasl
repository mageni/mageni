...
if(description)
{
  ...
  script_cve_id("CVE-2015-8962","CVE-2015-8963","CVE-2015-8964");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0464-1)");
  ...
  package(s) announced via the SUSE-SU-2017:0464-1 advisory.");
