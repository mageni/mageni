...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2526-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-September/003249.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'gcc48'
  package(s) announced via the SUSE-SU-2017:2526-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'gcc48' package(s) on SUSE Linux Enterprise Server 12");
...
if(release == "SLES12.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc48", rpm:"gcc48~c", rls:"SLES12.0SP3"))){
    report += res;
  }
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc48", rpm:"gcc48~c", rls:"SLES12.0SP2"))){
    report += res;
  }
...
if(release == "SLES12.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc48", rpm:"gcc48~c", rls:"SLES12.0SP1"))){
    report += res;
  }
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"cpp48", rpm:"cpp48~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cpp48-debuginfo", rpm:"cpp48-debuginfo~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48", rpm:"gcc48~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48", rpm:"gcc48~c", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48-debuginfo", rpm:"gcc48-debuginfo~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48-debugsource", rpm:"gcc48-debugsource~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48-locale", rpm:"gcc48-locale~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libstdc", rpm:"libstdc~", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48-32bit", rpm:"gcc48-32bit~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libasan0-32bit", rpm:"libasan0-32bit~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libasan0-32bit-debuginfo", rpm:"libasan0-32bit-debuginfo~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libasan0", rpm:"libasan0~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libasan0-debuginfo", rpm:"libasan0-debuginfo~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc48-info", rpm:"gcc48-info~4.8.5~31.3.1", rls:"SLES12.0LTSS"))){
    report += res;
  }
