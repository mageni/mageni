...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1944-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-July/003065.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'Linux Kernel Live  Patch 14 for SLE 12 SP1'
  package(s) announced via the SUSE-SU-2017:1944-1 advisory.");
