...
if(description)
{
  ...
  script_cve_id("CVE-2017-7392","CVE-2017-7393","CVE-2017-7394");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1094-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-April/002825.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tigervnc'
  package(s) announced via the SUSE-SU-2017:1094-1 advisory.");
