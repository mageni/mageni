...
if(description)
{
  ...
  script_cve_id("CVE-2016-10166","CVE-2016-10167","CVE-2016-10168");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0468-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-February/002645.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'gd'
  package(s) announced via the SUSE-SU-2017:0468-1 advisory.");
