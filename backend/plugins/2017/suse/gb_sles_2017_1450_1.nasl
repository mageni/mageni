...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1450-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-May/002930.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'sudo'
  package(s) announced via the SUSE-SU-2017:1450-1 advisory.");
