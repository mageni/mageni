...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1898-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-July/003039.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'systemd, dracut'
  package(s) announced via the SUSE-SU-2017:1898-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'systemd, dracut' package(s) on SUSE Linux Enterprise Server 12");
