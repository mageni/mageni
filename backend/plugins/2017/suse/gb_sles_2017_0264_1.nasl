...
if(description)
{
  ...
  script_cve_id("CVE-2016-10009","CVE-2016-10010","CVE-2016-10011");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0264-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-January/002592.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openssh'
  package(s) announced via the SUSE-SU-2017:0264-1 advisory.");
