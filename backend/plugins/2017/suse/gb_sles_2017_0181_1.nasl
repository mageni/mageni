...
if(description)
{
  ...
  script_cve_id("CVE-2015-1350","CVE-2015-8964","CVE-2016-7039");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0181-1)");
  ...
  package(s) announced via the SUSE-SU-2017:0181-1 advisory.");
