...
# $Id: gb_mozilla_thunderbird_mfsa_2017-09_2017-09_macosx.nasl 11977 2018-10-19 07:28:56Z mmartin $
#
# Mozilla Thunderbird Security Updates( mfsa_2017-09_2017-09 )-MAC OS X
#
# Authors:
...
if(description)
{
  ...
  script_name("Mozilla Thunderbird Security Updates( mfsa_2017-09_2017-09 )-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Thunderbird version before 52.0 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Thunderbird version 52.0.");
