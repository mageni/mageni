...
# $Id: gb_mantis_92522_lin.nasl 12818 2018-12-18 09:55:03Z ckuersteiner $
#
# MantisBT 'view_type' Cross Site Scripting Vulnerability (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108049");
