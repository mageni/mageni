...
# $Id: gb_mysql_oct2017-3236626_01_win.nasl 11989 2018-10-19 11:25:26Z cfischer $
#
...
if(description)
{
  ...
  script_name("Oracle Mysql Security Updates (oct2017-3236626) 01 - Windows");

  script_tag(name:"summary", value:"This host is running Oracle MySQL and is
  prone to multiple uspecified vulnerabilities.");
  ...
  script_tag(name:"affected", value:"Oracle MySQL version 5.7.18 and earlier on Windows.");
...
if(version_in_range(version:mysqlVer, test_version:"5.7", test_version2:"5.7.18"))
{
