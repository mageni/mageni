...
# $Id: gb_mysql_unspecified_vuln03_feb16_lin.nasl 2016-01-28 13:07:06 +0530 feb$
#
# Oracle MySQL Unspecified Vulnerability-03 Feb16 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812186");
  script_version("$Revision: 11989 $");
  script_cve_id("CVE-2016-0502");
  script_bugtraq_id(81136);
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"$Date: 2018-10-19 13:25:26 +0200 (Fri, 19 Oct 2018) $");
  script_tag(name:"creation_date", value:"2017-11-22 15:31:41 +0530 (Wed, 22 Nov 2017)");
  script_tag(name:"qod_type", value:"remote_banner_unreliable");
  script_name("Oracle MySQL Unspecified Vulnerability-03 Feb16 (Linux)");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server 5.5.31 and earlier
  and 5.6.11 and earlier on windows");
...
if(mysqlVer =~ "^(5\.6)")
{
  if(version_is_less(version:mysqlVer, test_version:"5.6.12"))
  {
   VULN = TRUE;
  }
}

else if(mysqlVer =~ "^(5\.5)")
{
  if(version_is_less(version:mysqlVer, test_version:"5.5.32"))
  {
    VULN = TRUE;
  }
}
