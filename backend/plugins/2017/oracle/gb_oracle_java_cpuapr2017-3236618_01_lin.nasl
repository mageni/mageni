...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108382");
  ...
  script_name("Oracle Java SE Security Updates (cpuapr2017-3236618) 01 - Linux");
  ...
  earlier, 1.7.0.131 and earlier, 1.8.0.121 and earlier on Linux");
