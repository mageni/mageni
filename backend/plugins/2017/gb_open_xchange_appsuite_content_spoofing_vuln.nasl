...
# $Id: gb_open_xchange_appsuite_content_spoofing_vuln.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
# Open-Xchange (OX) AppSuite Content Spoofing Vulnerability
#
# Authors:
...
if(oxRev)
{
  ...
  if(oxVer =~ "^(7\.8\.0)" && version_is_less( version:oxVer, test_version:"7.8.0.23"))
  {
    fix = "7.8.0-rev23";
    VULN = TRUE;
  }
