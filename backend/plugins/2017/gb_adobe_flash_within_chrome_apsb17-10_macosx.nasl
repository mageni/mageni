...
# $Id: gb_adobe_flash_within_chrome_apsb17-10_macosx.nasl 11874 2018-10-12 11:28:04Z mmartin $
#
# Adobe Flash Player Within Google Chrome Security Update (apsb17-10) - Mac OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810844");
  ...
  script_tag(name:"creation_date", value:"2017-04-12 10:06:04 +0530 (Wed, 12 Apr 2017)");
  ...
  script_tag(name:"affected", value:"Adobe Flash Player version for chrome versions
  before 25.0.0.148 on Mac OS X.");
