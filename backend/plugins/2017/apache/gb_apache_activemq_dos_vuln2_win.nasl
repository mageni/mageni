...
# $Id: gb_apache_activemq_dos_vuln2_win.nasl 11983 2018-10-19 10:04:45Z mmartin $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108288");
  ...
  script_name("Apache ActiveMQ 'CVE-2014-3576' Denial of Service Vulnerability (Windows)");
