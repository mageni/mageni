...
# $Id: gb_ibm_inotes_xss_vuln_aug17.nasl 11977 2018-10-19 07:28:56Z mmartin $
#
...
if(description)
{
  ...
  prior to 8.5.3 Fix Pack 6 Interim Fix 5, 9.0 and 9.0.1 prior to 9.0.1 Feature Pack
  8 Interim Fix 3");
