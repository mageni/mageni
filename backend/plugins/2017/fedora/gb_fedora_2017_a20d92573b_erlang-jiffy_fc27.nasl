...
# $Id: gb_fedora_2017_a20d92573b_erlang-jiffy_fc27.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'erlang-jiffy'
