...
#
# Microsoft SQL Server 2014 Information Disclosure Vulnerability KB4019093 (Remote)
#
# Authors:
...
if(description)
{
  ...
  script_name("Microsoft SQL Server 2014 Information Disclosure Vulnerability KB4019093 (Remote)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4019093");
...
## security update for SQL Server 2014 Service Pack 2 GDR
if(mssqlVer =~ "^12\.0")
{
  if(version_in_range(version:mssqlVer, test_version:"12.0.5000.0", test_version2:"12.0.5206.0"))
  {
    report  = 'Vulnerable range: ' + "12.0.5000.0 - 12.0.5206.0" + '\n' ;
