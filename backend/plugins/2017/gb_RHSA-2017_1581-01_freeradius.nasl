...
#
# RedHat Update for freeradius RHSA-2017:1581-01
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871837");
  script_version("$Revision: 12497 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-23 09:28:21 +0100 (Fri, 23 Nov 2018) $");
  script_tag(name:"creation_date", value:"2017-06-29 05:09:44 +0200 (Thu, 29 Jun 2017)");
  script_cve_id("CVE-2017-9148");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("RedHat Update for freeradius RHSA-2017:1581-01");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2017-June/msg00056.html");
...
if(release == "RHENT_7")
{
  ...
  if ((res = isrpmvuln(pkg:"freeradius", rpm:"freeradius~3.0.4~8.el7_3", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"freeradius-debuginfo", rpm:"freeradius-debuginfo~3.0.4~8.el7_3", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
