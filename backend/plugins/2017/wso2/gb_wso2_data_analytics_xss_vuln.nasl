...
# $Id: gb_wso2_data_analytics_xss_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.140390");
  ...
  script_name("WSO2 Data Analytics Server Multiple XSS Vulnerabilities");
  ...
  script_mandatory_keys("wso2_carbon_data_analytics_server/installed");

  script_tag(name:"summary", value:"WSO2 Data Analytics Server is prone to multiple
...
otherwise.");
  ...
  script_tag(name:"affected", value:"WSO2 Data Analytics Server 3.1.0 and probably prior.");
