...
# $Id: gb_wso2_business_process_server_xss_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
# WSO2 Business Process Server Multiple XSS Vulnerabilities
#
# Authors:
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.140395");
  ...
  script_name("WSO2 Business Process Server Multiple XSS Vulnerabilities");
  ...
  script_mandatory_keys("wso2_carbon_business_process_server/installed");

  script_tag(name:"summary", value:"WSO2 Business Process Server is prone to
...
otherwise.");
  ...
  script_tag(name:"affected", value:"WSO2 Business Process Server 3.6.0 and probably prior.");
