...
# $Id: gb_wso2_identity_server_xss_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
# WSO2 Identity Server XSS Vulnerability
#
# Authors:
...
if (description)
{
  ...
  script_tag(name:"summary", value:"WSO2 Identity Server is prone to a cross-site scripting
vulnerability.");
