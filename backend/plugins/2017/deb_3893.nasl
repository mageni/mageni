...
# $Id: deb_3893.nasl 14280 2019-03-18 14:50:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"jython", ver:"2.5.3-16+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"jython-doc", ver:"2.5.3-16+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"jython", ver:"2.5.3-3+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"jython-doc", ver:"2.5.3-3+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
