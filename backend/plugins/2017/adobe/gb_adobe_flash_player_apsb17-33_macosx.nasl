...
#
# Adobe Flash Player Security Updates( apsb17-33 )-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812141");
  ...
  script_tag(name:"creation_date", value:"2017-11-15 13:50:30 +0530 (Wed, 15 Nov 2017)");
  script_name("Adobe Flash Player Security Updates( apsb17-33 )-MAC OS X");
