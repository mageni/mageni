...
#
# Ubuntu Update for firefox USN-3216-1
#
# Authors:
...
if(description)
{
  ...
  attacker could potentially exploit these to bypass same origin restrictions,
  obtain sensitive information, spoof the addressbar, spoof the print dialog,
  cause a denial of service via application crash or hang, or execute arbitrary
  code. (CVE-2017-5398, CVE-2017-5399, CVE-2017-5400, CVE-2017-5401,
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3216-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"52.0+build2-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU16.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"52.0+build2-0ubuntu0.16.10.1", rls:"UBUNTU16.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"52.0+build2-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"52.0+build2-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
