...
if(description)
{
  ...
  script_name("RedHat Update for ghostscript RHSA-2017:2180-01");
  ...
  to common bitmap formats so that the code can be displayed or printed. Security
  Fix(es): * A NULL pointer dereference flaw was found in ghostscript's
...
if(release == "RHENT_7")
{
  ...
  if ((res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~9.07~28.el7", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ghostscript-cups", rpm:"ghostscript-cups~9.07~28.el7", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ghostscript-debuginfo", rpm:"ghostscript-debuginfo~9.07~28.el7", rls:"RHENT_7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
