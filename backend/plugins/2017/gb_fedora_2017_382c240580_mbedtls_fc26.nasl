...
# $Id: gb_fedora_2017_382c240580_mbedtls_fc26.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BIDCXCILJ7BZS2GBSR75NMKRUNLQD3R5");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"mbedtls", rpm:"mbedtls~2.6.0~1.fc26", rls:"FC26")) != NULL)
  {
