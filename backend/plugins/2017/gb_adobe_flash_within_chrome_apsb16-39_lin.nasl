...
# $Id: gb_adobe_flash_within_chrome_apsb16-39_lin.nasl 11874 2018-10-12 11:28:04Z mmartin $
#
# Adobe Flash Player Within Google Chrome Security Update (apsb16-39) - Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810629");
  ...
  script_tag(name:"creation_date", value:"2017-03-17 15:52:00 +0530 (Fri, 17 Mar 2017)");
  script_name("Adobe Flash Player Within Google Chrome Security Update (apsb16-39) - Linux");
