...
# $Id: gb_powerdns_auth_server_label_decompression_dos_vuln_lin.nasl 11888 2018-10-12 15:27:49Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809859");
  ...
  script_tag(name:"creation_date", value:"2017-01-04 15:20:12 +0530 (Wed, 04 Jan 2017)");
  script_name("PowerDNS Authoritative (Auth) Server Denial of Service Vulnerability (Linux)");
  ...
  3.3.x before 3.3.3, and 3.4.x before 3.4.5 on Linux");
  ...
  script_mandatory_keys("powerdns/authoritative_server/installed", "Host/runs_unixoide");
  exit(0);
}
