...
# $Id: gb_phpmyadmin_mult_vuln_jul11-02_lin.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
# phpMyAdmin 3.x < 3.3.10.3; 3.4.x < 3.4.3.2 Multiple Vulnerabilities (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("phpMyAdmin 3.x < 3.3.10.3; 3.4.x < 3.4.3.2 Multiple Vulnerabilities (Linux)");
