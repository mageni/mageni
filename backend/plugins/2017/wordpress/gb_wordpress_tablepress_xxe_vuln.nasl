...
# $Id: gb_wordpress_tablepress_xxe_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
res = http_get_cache(port: port, item: dir + "/wp-content/plugins/tablepress/readme.txt");

if ("TablePress" >< res && "Changelog" >< res) {
  vers = eregmatch(pattern: "Stable tag: ([0-9.]+)", string: res);
  if (!isnull(vers[1])) {
    if (version_is_less(version: vers[1], test_version: "1.8.1")) {
      report = report_fixed_ver(installed_version: vers[1], fixed_version: "1.8.1");
