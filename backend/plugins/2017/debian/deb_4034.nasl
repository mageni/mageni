...
# $Id: deb_4034.nasl 14284 2019-03-18 15:02:15Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libvarnishapi-dev", ver:"5.0.0-7+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libvarnishapi1", ver:"5.0.0-7+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish", ver:"5.0.0-7+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"varnish-doc", ver:"5.0.0-7+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
