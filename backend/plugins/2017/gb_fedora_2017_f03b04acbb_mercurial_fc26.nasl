...
if(description)
{
  ...
  script_tag(name:"affected", value:"mercurial on Fedora 26");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2JNWSQUDHZPCFPWAL5EVBK4RMA7WWVWZ");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"mercurial", rpm:"mercurial~4.2.3~1.fc26", rls:"FC26")) != NULL)
  {
