...
if(description)
{
  ...
  script_version("2022-05-24T07:39:31+0000");
...
#
if (!recv || ("Zookeeper version" >!< recv && recv != 'stat is not executed because it is not in the whitelist.\n'))
  exit(0);
...
log_message(data: build_detection_report(app: "Apache ZooKeeper", version: version, install: install, cpe: cpe,
