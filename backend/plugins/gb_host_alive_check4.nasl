...
# $Id: gb_host_alive_check4.nasl 13775 2019-02-20 07:45:12Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108218");
  ...
  script_name("Mark host as dead if going offline (failed ICMP ping) during scan - Phase 4");
  script_category(ACT_ATTACK);
  script_copyright("Copyright (C) 2017 Greenbone Networks GmbH");
  script_family("Service detection");
  script_dependencies("gb_host_alive_check3.nasl", "toolcheck.nasl");
  script_mandatory_keys("global_settings/mark_host_dead_failed_icmp", "Tools/Present/ping");

  script_tag(name:"summary", value:"This plugin checks the target host in the phase 4 of a scan
