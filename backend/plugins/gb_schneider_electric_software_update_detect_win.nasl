...
# $Id: gb_schneider_electric_software_update_detect_win.nasl 12753 2018-12-11 08:48:01Z mmartin $
#
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    base:"cpe:/a:schneider_electric:software_update:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0);
