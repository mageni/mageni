...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the installed TCExam version and saves
  the result in KB.");
...
foreach dir( make_list_unique( "/", "/tcexam", "/TCExam", cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "HTTP/1.. 200" && ">TCExam<" >< rcvRes ) {
