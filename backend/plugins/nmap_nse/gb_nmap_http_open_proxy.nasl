...
# $Id: gb_nmap_http_open_proxy.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script attempts to check if an HTTP proxy is open.

  This is a wrapper on the Nmap Security Scanner's http-open-proxy.nse.");
