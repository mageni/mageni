...
# $Id: gb_nmap6_finger.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803550");
  ...
  script_tag(name:"creation_date", value:"2013-02-28 19:00:39 +0530 (Thu, 28 Feb 2013)");
  script_name("Nmap NSE 6.01: finger");
