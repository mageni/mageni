...
# $Id: gb_nmap_db2_info.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
# Wrapper for Nmap DB2 Info NSE script.
#
# Authors:
# NSE-Script: Tom Sellers
...
if(description)
{
  ...
  This is a wrapper on the Nmap Security Scanner's db2-info.nse.");
...
argv = make_list("nmap", "--script=db2-info.nse", "-p", port, get_host_ip());
...
if(res)
{
  ...
  if("db2-info" >< result) {
    msg = string('Result found by Nmap Security Scanner (db2-info.nse) ',
                'http://nmap.org:\n\n', result);
