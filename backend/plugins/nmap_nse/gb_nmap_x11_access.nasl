...
# $Id: gb_nmap_x11_access.nasl 11966 2018-10-18 13:56:21Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801698");
  ...
  script_tag(name:"summary", value:"This script attempts to check if you are allowed to connect to
  the X server.

  This is a wrapper on the Nmap Security Scanner's x11-access.nse.");
