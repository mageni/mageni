#
#VID b168ddea-105a-11db-ac96-000c6ec775d9
...
http://www.vuxml.org/freebsd/b168ddea-105a-11db-ac96-000c6ec775d9.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303854");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.0.1,1")>=0 && revcomp(a:bver, b:"3.0.23,1")<0) {
