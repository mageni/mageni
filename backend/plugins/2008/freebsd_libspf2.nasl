#
#VID 2ddbfd29-a455-11dd-a55e-00163e000016
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID 2ddbfd29-a455-11dd-a55e-00163e000016
#
# Authors:
...
tag_insight = "The following package is affected: libspf2
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302197");
 ...
 script_name("FreeBSD Ports: libspf2");
...
txt = "";
vuln = 0;
bver = portver(pkg:"libspf2");
if(!isnull(bver) && revcomp(a:bver, b:"1.2.8")<0) {
    txt += 'Package libspf2 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
