...
tag_insight = "Multiple security issues have been discovered in Midnight Commander
including several buffer overflows and string format vulnerabilities.";
tag_solution = "All Midnight Commander users should upgrade to the latest stable version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200405-21
http://bugs.gentoo.org/show_bug.cgi?id=49990";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302532");
