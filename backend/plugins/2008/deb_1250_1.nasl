...
# $Id: deb_1250_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1250-1
#
# Authors:
...
We recommend that you upgrade your cacti package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201250-1";
tag_summary = "The remote host is missing an update to cacti
announced via advisory DSA 1250-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301234");
 ...
 script_name("Debian Security Advisory DSA 1250-1 (cacti)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.6c-7sarge4", rls:"DEB3.1")) != NULL) {
    report += res;
}
