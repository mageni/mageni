...
# $Id: deb_1688_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The update of courier-authlib in DSA 1688-1 caused a regression with
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201688-2";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302962");
 ...
 script_name("Debian Security Advisory DSA 1688-2 (courier-authlib)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"courier-authlib-dev", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authdaemon", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authlib-pipe", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authlib", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authlib-ldap", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authlib-postgresql", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authlib-mysql", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"courier-authlib-userdb", ver:"0.58-4+etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
