...
tag_insight = "The code for parsing ELF headers in file contains a flaw which may allow an
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-07
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303049");
