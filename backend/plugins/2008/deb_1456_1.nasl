...
# $Id: deb_1456_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1456-1 (fail2ban)
#
# Authors:
...
tag_insight = "Daniel B. Cid discovered that fail2ban, a tool to block IP addresses
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201456-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303036");
 ...
 script_name("Debian Security Advisory DSA 1456-1 (fail2ban)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"fail2ban", ver:"0.7.5-2etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
