...
# $Id: deb_529_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 529-1
#
# Authors:
...
tag_insight = "b0f discovered a format string vulnerability in netkit-telnet-ssl
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20529-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301755");
