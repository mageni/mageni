...
# $Id: deb_979_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 979-1
#
# Authors:
...
We recommend that you upgrade your pdfkit.framework package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20979-1";
tag_summary = "The remote host is missing an update to pdfkit.framework
announced via advisory DSA 979-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304349");
 ...
 script_name("Debian Security Advisory DSA 979-1 (pdfkit.framework)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"pdfkit.framework", ver:"0.8-2sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
