...
tag_insight = "ImageMagick is vulnerable to a heap overflow when decoding Photoshop
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-26
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302638");
