...
# $Id: deb_1214_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1214-1
#
# Authors:
...
We recommend that you upgrade your gv package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201214-1";
tag_summary = "The remote host is missing an update to gv
announced via advisory DSA 1214-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303465");
 ...
 script_name("Debian Security Advisory DSA 1214-1 (gv)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gv", ver:"3.6.1-10sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
