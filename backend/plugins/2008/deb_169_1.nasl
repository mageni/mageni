...
# $Id: deb_169_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 169-1
#
# Authors:
...
tag_insight = "A security vulnerability has been found in all Tomcat 4.x releases.
...
announced via advisory DSA 169-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20169-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300213");
 ...
 script_name("Debian Security Advisory DSA 169-1 (tomcat4)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtomcat4-java", ver:"4.0.3-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tomcat4-webapps", ver:"4.0.3-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tomcat4", ver:"4.0.3-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
