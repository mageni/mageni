...
tag_insight = "cpio contains a flaw which may allow a specially crafted cpio archive to
extract files to an arbitrary directory.";
tag_solution = "All cpio users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301403");
