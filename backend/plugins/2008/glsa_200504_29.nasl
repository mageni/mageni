...
tag_insight = "Pound is vulnerable to a buffer overflow that could lead to the remote
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200504-29
http://bugs.gentoo.org/show_bug.cgi?id=90851
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302002");
