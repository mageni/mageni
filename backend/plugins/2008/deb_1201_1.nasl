...
# $Id: deb_1201_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301645");
 ...
 script_name("Debian Security Advisory DSA 1201-1 (ethereal)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ethereal", ver:"0.10.10-2sarge9", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ethereal-common", ver:"0.10.10-2sarge9", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ethereal-dev", ver:"0.10.10-2sarge9", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tethereal", ver:"0.10.10-2sarge9", rls:"DEB3.1")) != NULL) {
    report += res;
}
