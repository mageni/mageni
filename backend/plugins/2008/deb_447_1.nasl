...
# $Id: deb_447_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 447-1
#
# Authors:
...
tag_insight = "During an audit, Ulf Harnhammar discovered a format string
...
tag_summary = "The remote host is missing an update to hsftp
announced via advisory DSA 447-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20447-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303014");
 ...
 script_name("Debian Security Advisory DSA 447-1 (hsftp)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hsftp", ver:"1.11-1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
