...
# $Id: deb_159_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Zack Weinberg discovered an insecure use of a temporary file in
...
announced via advisory DSA 159-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20159-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301877");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"python-base", ver:"1.5.2-10potato12", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python1.5", ver:"1.5.2-23.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python2.1", ver:"2.1.3-3.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"python2.2", ver:"2.2.1-4.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
