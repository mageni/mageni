...
tag_insight = "A heap-based buffer overflow vulnerability has been discovered in
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-24
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301018");
