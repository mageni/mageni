...
tag_insight = "Several vulnerabilities in the Mozilla Suite and Firefox allow an attacker
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200505-11
http://bugs.gentoo.org/show_bug.cgi?id=91859
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302032");
