...
tag_insight = "Fail2ban is vulnerable to a Denial of Service attack.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200707-13
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302161");
