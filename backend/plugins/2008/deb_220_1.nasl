...
# $Id: deb_220_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 220-1
#
# Authors:
...
tag_insight = "A cross site scripting vulnerability has been discovered in
...
announced via advisory DSA 220-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20220-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302673");
 ...
 script_name("Debian Security Advisory DSA 220-1 (squirrelmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squirrelmail", ver:"1.2.6-1.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
