...
tag_insight = "Multiple vulnerabilities including one buffer overflow exist in Ethereal,
which may allow an attacker to run arbitrary code or crash the program.";
tag_solution = "All Ethereal users should upgrade to the latest stable version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-08
http://bugs.gentoo.org/show_bug.cgi?id=56423
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302667");
