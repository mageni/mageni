#
#VID 597e2bee-68ea-11d9-a9e7-0001020eed82
...
CVE-2005-0005
Heap-based buffer overflow in psd.c for ImageMagick 6.1.0, 6.1.7, and
possibly earlier versions allows remote attackers to execute arbitrary
code via a .PSD image file with a large number of layers.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.idefense.com/application/poi/display?id=184&type=vulnerabilities
http://www.vuxml.org/freebsd/597e2bee-68ea-11d9-a9e7-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300342");
