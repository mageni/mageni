#
#VID fb672330-02db-11dd-bd06-0017319806e7
...
tag_insight = "The following package is affected: suphp";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303225");
 ...
 script_name("FreeBSD Ports: suphp");
...
txt = "";
vuln = 0;
bver = portver(pkg:"suphp");
if(!isnull(bver) && revcomp(a:bver, b:"0.6.3")<0) {
    txt += 'Package suphp version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
