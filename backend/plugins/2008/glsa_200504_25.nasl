...
tag_insight = "Rootkit Hunter is vulnerable to symlink attacks, potentially allowing a
local user to overwrite arbitrary files.";
tag_solution = "All Rootkit Hunter users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-forensics/rkhunter-1.2.3-r1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200504-25
http://bugs.gentoo.org/show_bug.cgi?id=90007";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303742");
