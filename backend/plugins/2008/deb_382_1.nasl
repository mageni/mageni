...
# $Id: deb_382_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "A bug has been found in OpenSSH's buffer handling where a buffer could
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20382-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300275");
 ...
 script_name("Debian Security Advisory DSA 382-1 (ssh)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ssh", ver:"3.4p1-1.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ssh-askpass-gnome", ver:"3.4p1-1.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
