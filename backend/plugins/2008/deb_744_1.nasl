...
# $Id: deb_744_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 744-1
#
# Authors:
...
We recommend that you upgrade your fuse package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20744-1";
tag_summary = "The remote host is missing an update to fuse
announced via advisory DSA 744-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303376");
 ...
 script_name("Debian Security Advisory DSA 744-1 (fuse)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"fuse-source", ver:"2.2.1-4sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
