...
tag_insight = "HylaFAX is subject to a vulnerability in its username matching code,
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-21
http://bugs.gentoo.org/show_bug.cgi?id=75941
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300223");
