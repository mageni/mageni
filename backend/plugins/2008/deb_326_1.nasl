...
# $Id: deb_326_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Orville Write, a replacement for the standard write(1) command,
...
tag_summary = "The remote host is missing an update to orville-write
announced via advisory DSA 326-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20326-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301405");
 ...
 script_name("Debian Security Advisory DSA 326-1 (orville-write)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"orville-write", ver:"2.53-4woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
