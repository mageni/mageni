#
#VID e546c7ce-ce46-11db-bc24-0016179b2dd5
...
http://www.vuxml.org/freebsd/e546c7ce-ce46-11db-bc24-0016179b2dd5.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302391");
 script_version("$Revision: 4203 $");
 script_cve_id("CVE-2007-1405");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.10.3_1")<0) {
