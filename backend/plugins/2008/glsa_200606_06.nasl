...
tag_insight = "AWStats contains a bug in the sanitization of the input parameters which
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302095");
 ...
 script_name("Gentoo Security Advisory GLSA 200606-06 (awstats)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-www/awstats", unaffected: make_list("ge 6.5-r1"), vulnerable: make_list("lt 6.5-r1"))) != NULL) {
    report += res;
}
