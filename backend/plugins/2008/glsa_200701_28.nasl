...
tag_insight = "The default configuration of the Gentoo thttpd package potentially allows
unauthenticated access to system files when used with newer versions of
baselayout.";
tag_solution = "All thttpd users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-servers/thttpd-2.25b-r5'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200701-28
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301495");
