...
# $Id: deb_1288_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "A regression in the handling of out-of-order sequence numbers of some
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201288-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303757");
 ...
 script_name("Debian Security Advisory DSA 1288-2 (pptpd)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bcrelay", ver:"1.3.0-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"pptpd", ver:"1.3.0-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
