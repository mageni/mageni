...
# $Id: deb_338_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "x-face-el, a decoder for images included inline in X-Face email
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20338-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300079");
 ...
 script_name("Debian Security Advisory DSA 338-1 (x-face-el)");
