...
# $Id: gb_wireshark_mult_vuln_oct08_win.nasl 12623 2018-12-03 13:11:38Z cfischer $
#
...
if(description)
{
  ...
  Request Block (URB) dissector. Versions 0.99.7 through 1.0.3 are affected by this vulnerabiliy.");
