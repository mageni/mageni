...
tag_insight = "Multiple vulnerabilities have been discovered in Ruby that allow for
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-17
http://bugs.gentoo.org/show_bug.cgi?id=225465
http://bugs.gentoo.org/show_bug.cgi?id=236060";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301441");
