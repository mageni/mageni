...
# $Id: deb_844_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302235");
 ...
 script_name("Debian Security Advisory DSA 844-1 (mod-auth-shadow)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libapache-mod-auth-shadow", ver:"1.3-3.1woody.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libapache-mod-auth-shadow", ver:"1.4-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
