...
tag_insight = "A vulnerability in TunePimp has been reported which could lead to the
execution of arbitrary code.";
tag_solution = "TunePimp has been masked in Portage pending the resolution of these issues.
TunePimp users are advised to uninstall the package until further notice:

    # emerge --ask --unmerge 'media-libs/tunepimp'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200607-11
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301703");
