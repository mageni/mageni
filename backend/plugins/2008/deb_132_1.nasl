...
# $Id: deb_132_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 132-1
#
# Authors:
...
announced via advisory DSA 132-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20132-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301219");
 ...
 script_name("Debian Security Advisory DSA 132-1 (apache-ssl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"apache-ssl", ver:"1.3.9.13-4.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
