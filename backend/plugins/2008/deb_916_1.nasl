...
# $Id: deb_916_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to inkscape
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301959");
 ...
 script_name("Debian Security Advisory DSA 916-1 (inkscape)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"inkscape", ver:"0.41-4.99.sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
