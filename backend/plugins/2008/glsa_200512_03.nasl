...
tag_insight = "Multiple flaws in phpMyAdmin may lead to several XSS issues and local and
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200512-03
http://bugs.gentoo.org/show_bug.cgi?id=114662
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301072");
