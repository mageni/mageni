...
# $Id: deb_547_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Marcus Meissner from SUSE has discovered several buffer overflows in
...
tag_summary = "The remote host is missing an update to imagemagic
announced via advisory DSA 547-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20547-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302819");
