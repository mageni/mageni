...
# $Id: deb_121_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several security related problems have been found in the xtell
...
tag_summary = "The remote host is missing an update to xtell
announced via advisory DSA 121-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20121-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300627");
 ...
 script_name("Debian Security Advisory DSA 121-1 (xtell)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xtell", ver:"1.91.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
