...
# $Id: deb_494_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Jack <jack@rapturesecurity.org> discovered a buffer overflow in
...
tag_summary = "The remote host is missing an update to ident2
announced via advisory DSA 494-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20494-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302683");
 ...
 script_name("Debian Security Advisory DSA 494-1 (ident2)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ident2", ver:"1.03-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
