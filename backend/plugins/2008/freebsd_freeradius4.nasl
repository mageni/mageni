...
http://www.vuxml.org/freebsd/c110eda2-e995-11db-a944-0012f06707f0.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300120");
 ...
 script_cve_id("CVE-2005-1455", "CVE-2005-1454", "CVE-2007-2028", "CVE-2005-4745");
 script_bugtraq_id(23466);
 script_tag(name:"cvss_base", value:"7.5");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
 script_name("FreeBSD Ports: freeradius, freeradius-mysql");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.1.5")<=0) {
    txt += 'Package freeradius-mysql version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
