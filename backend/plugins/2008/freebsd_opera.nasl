#
#VID 20c9bb14-81e6-11d9-a9e7-0001020eed82
...
CVE-2005-0456
Opera 7.54 and earlier does not properly validate base64 encoded
binary data in a data: (RFC 2397) URL, which causes the URL to be
obscured in a download dialog, which may allow remote attackers to
...
http://www.vuxml.org/freebsd/20c9bb14-81e6-11d9-a9e7-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302021");
