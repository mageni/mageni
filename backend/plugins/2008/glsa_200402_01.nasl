...
tag_insight = "If the server configuration ' php.ini ' file has ' register_globals = on '
...
tag_solution = "All users are recommended to upgrade their PHP installation to 4.3.4-r4:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301368");
