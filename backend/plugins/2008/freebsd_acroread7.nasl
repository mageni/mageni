#
#VID 02bc9b7c-e019-11d9-a8bd-000cf18bbe54
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300773");
 ...
 script_name("FreeBSD Ports: acroread7, ja-acroread");
...
if(!isnull(bver) && revcomp(a:bver, b:"7.0.0")>=0 && revcomp(a:bver, b:"7.0.2")<0) {
    txt += 'Package acroread7 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"ja-acroread");
if(!isnull(bver) && revcomp(a:bver, b:"7.0.0")>=0 && revcomp(a:bver, b:"7.0.2")<0) {
    txt += 'Package ja-acroread version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
