...
# $Id: deb_1465_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
announced via advisory DSA 1465-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201465-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301922");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"apt-listchanges", ver:"2.72.5etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
