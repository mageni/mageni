...
tag_insight = "A buffer overflow in the XRender extension potentially allows any X.Org
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200605-02
http://bugs.gentoo.org/show_bug.cgi?id=130979";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302904");
