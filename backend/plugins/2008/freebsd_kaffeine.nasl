#
#VID 4bfcd857-c628-11da-b2fb-000e0c2e438a
...
tag_insight = "The following package is affected: kaffeine
...
http://www.vuxml.org/freebsd/4bfcd857-c628-11da-b2fb-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301803");
 ...
 script_name("FreeBSD Ports: kaffeine");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.4.2")>=0 && revcomp(a:bver, b:"0.8.0")<0) {
    txt += 'Package kaffeine version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
