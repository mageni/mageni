...
# $Id: deb_1207_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302906");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"2.6.2-3sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
