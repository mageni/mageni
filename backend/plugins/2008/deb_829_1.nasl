...
# $Id: deb_829_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 829-1
#
# Authors:
...
announced via advisory DSA 829-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20829-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302915");
 ...
 script_name("Debian Security Advisory DSA 829-1 (mysql)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mysql-common", ver:"3.23.49-8.14", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mysql-doc", ver:"3.23.49-8.5", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmysqlclient10", ver:"3.23.49-8.14", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmysqlclient10-dev", ver:"3.23.49-8.14", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mysql-client", ver:"3.23.49-8.14", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mysql-server", ver:"3.23.49-8.14", rls:"DEB3.0")) != NULL) {
    report += res;
}
