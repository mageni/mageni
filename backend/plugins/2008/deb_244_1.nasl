...
# $Id: deb_244_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Dan Jacobson noticed a problem in noffle, an offline news server, that
...
tag_summary = "The remote host is missing an update to noffle
announced via advisory DSA 244-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20244-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303941");
 ...
 script_name("Debian Security Advisory DSA 244-1 (noffle)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"noffle", ver:"1.0.1-1.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
