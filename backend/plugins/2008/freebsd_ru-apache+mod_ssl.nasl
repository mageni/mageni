#
#VID 4238151d-207a-11d9-bfe2-0090962cff2a
...
'SSLCipherSuite' directive in directory or location context, allows
remote clients to bypass intended restrictions by using any cipher
suite that is allowed by the virtual host configuration.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://issues.apache.org/bugzilla/show_bug.cgi?id=31505
http://marc.theaimsgroup.com/?l=apache-modssl&m=109724918128044
http://www.vuxml.org/freebsd/4238151d-207a-11d9-bfe2-0090962cff2a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302483");
 ...
 script_name("FreeBSD Ports: ru-apache+mod_ssl");
...
bver = portver(pkg:"apache2");
if(!isnull(bver) && revcomp(a:bver, b:"2.0.52_1")<=0) {
    txt += 'Package apache2 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
