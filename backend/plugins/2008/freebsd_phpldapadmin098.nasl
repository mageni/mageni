#
#VID 6d78202e-e2f9-11da-8674-00123ffe8333
...
tag_insight = "The following package is affected: phpldapadmin098
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304026");
 ...
 script_name("FreeBSD Ports: phpldapadmin098");
...
txt = "";
vuln = 0;
bver = portver(pkg:"phpldapadmin098");
if(!isnull(bver) && revcomp(a:bver, b:"0.9.8.3")<0) {
    txt += 'Package phpldapadmin098 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
