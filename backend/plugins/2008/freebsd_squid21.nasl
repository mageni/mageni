#
#VID 6eb580d7-a29c-11dc-8919-001c2514716c
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300399");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.0")>=0 && revcomp(a:bver, b:"2.6.16_1")<0) {
    txt += 'Package squid version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"3")>=0 && revcomp(a:bver, b:"3.0.r1.20071001_1")<0) {
    txt += 'Package squid version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
