...
tag_insight = "Trac is vulnerable to a cross-site scripting attack that could allow
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200601-12
http://bugs.gentoo.org/show_bug.cgi?id=118302
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301396");
 script_version("$Revision: 6596 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 11:21:37 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-09-24 21:14:03 +0200 (Wed, 24 Sep 2008)");
 script_bugtraq_id(16386);
