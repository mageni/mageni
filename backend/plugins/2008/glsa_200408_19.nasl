...
tag_insight = "There is a format string vulnerability in non-standard configurations of
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200408-19
http://bugs.gentoo.org/show_bug.cgi?id=60865
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304103");
