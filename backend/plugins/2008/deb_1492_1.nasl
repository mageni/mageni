...
# $Id: deb_1492_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Frank Lichtenheld and Nico Golde discovered that WML, an off-line HTML
...
tag_summary = "The remote host is missing an update to wml
announced via advisory DSA 1492-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201492-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301708");
 ...
 script_name("Debian Security Advisory DSA 1492-1 (wml)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"wml", ver:"2.0.11-1etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
