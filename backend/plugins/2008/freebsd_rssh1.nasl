...
a chroot jail, which allows remote authenticated users to determine
the existence of files in a directory outside the jail.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302467");
 ...
 script_xref(name : "URL" , value : "http://marc.theaimsgroup.com/?l=bugtraq&m=108787373022844");
 script_xref(name : "URL" , value : "http://www.vuxml.org/freebsd/a4815970-c5cc-11d8-8898-000d6111a684.html");
 exit(0);
}
