...
# $Id: deb_062_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Samuel Dralet reported on bugtraq that version 2.6.2 of rxvt (a
...
tag_summary = "The remote host is missing an update to rxvt
announced via advisory DSA 062-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20062-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300933");
