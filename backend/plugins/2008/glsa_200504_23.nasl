...
tag_insight = "Kommander executes remote scripts without confirmation, potentially
resulting in the execution of arbitrary code.";
tag_solution = "All kdewebdev users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=kde-base/kdewebdev-3.3.2-r2'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200504-23
http://bugs.gentoo.org/show_bug.cgi?id=89092
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301401");
