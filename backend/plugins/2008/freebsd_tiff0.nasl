#
#VID 8f86d8b5-6025-11d9-a9e7-0001020eed82
...
CVE-2004-1183
Integer overflow in the tiffdump utility for libtiff 3.7.1 and earlier
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303525");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.7.1_2")<0) {
