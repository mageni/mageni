...
tag_insight = "ipfw(8) is a system facility which allows IP packet filtering,
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303596");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-05:13.ipfw.asc)";
 script_name(name);
