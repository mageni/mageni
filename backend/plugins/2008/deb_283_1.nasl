...
# $Id: deb_283_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Ethan Benson discovered a problem in xfsdump, that contains
...
tag_summary = "The remote host is missing an update to xfsdump
announced via advisory DSA 283-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20283-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303378");
 ...
 script_name("Debian Security Advisory DSA 283-1 (xfsdump)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xfsdump", ver:"2.0.1-2", rls:"DEB3.0")) != NULL) {
    report += res;
}
