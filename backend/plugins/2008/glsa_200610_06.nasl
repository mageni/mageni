...
tag_insight = "NSS fails to properly validate PKCS #1 v1.5 signatures.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200610-06
http://bugs.gentoo.org/show_bug.cgi?id=148283";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303183");
