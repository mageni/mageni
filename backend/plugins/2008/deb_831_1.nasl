...
# $Id: deb_831_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20831-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303358");
 ...
 script_name("Debian Security Advisory DSA 831-1 (mysql-dfsg)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mysql-common", ver:"4.0.24-10sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmysqlclient12", ver:"4.0.24-10sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmysqlclient12-dev", ver:"4.0.24-10sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mysql-client", ver:"4.0.24-10sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mysql-server", ver:"4.0.24-10sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
