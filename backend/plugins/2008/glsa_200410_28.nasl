...
tag_insight = "rssh is vulnerable to a format string vulnerability that allows arbitrary
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-28
http://bugs.gentoo.org/show_bug.cgi?id=66988
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301736");
