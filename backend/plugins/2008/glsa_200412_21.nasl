...
tag_insight = "Multiple overflow vulnerabilities have been found in MPlayer, potentially
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-21
http://bugs.gentoo.org/show_bug.cgi?id=74473
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300889");
