#
#VID 59ada6e5-676a-11da-99f6-00123ffe8333
...
http://www.vuxml.org/freebsd/59ada6e5-676a-11da-99f6-00123ffe8333.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.7.0.55968");
 ...
 script_bugtraq_id(15735);
 script_cve_id("CVE-2005-3665");
