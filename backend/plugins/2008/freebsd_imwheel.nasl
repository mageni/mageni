#
#VID e31d44a2-21e3-11d9-9289-000c41e2cdad
...
tag_insight = "The following package is affected: imwheel";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300619");
 ...
 script_name("FreeBSD Ports: imwheel");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.0.p12")<0) {
    txt += 'Package imwheel version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
