...
tag_insight = "The AMD64 x86 emulation Qt library makes use of an insecure version of the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-06
http://bugs.gentoo.org/show_bug.cgi?id=153704
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300852");
