...
# $Id: deb_1569_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "It was discovered that Cacti, a systems and services monitoring frontend,
...
announced via advisory DSA 1569-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201569-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300366");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cacti", ver:"0.8.6i-3.3", rls:"DEB4.0")) != NULL) {
    report += res;
}
