...
tag_insight = "Exploitation of a buffer overflow in the XFree86 Project Inc.'s XFree86 X
Window System allows local attackers to gain root privileges.";
tag_solution = "All users are recommended to upgrade their XFree86 installation:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303417");
