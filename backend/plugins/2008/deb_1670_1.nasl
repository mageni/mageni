...
# $Id: deb_1670_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several vulnerabilities have been discovered in Enscript, a converter
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201670-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300811");
 ...
 script_name("Debian Security Advisory DSA 1670-1 (enscript)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"enscript", ver:"1.6.4-11.1", rls:"DEB4.0")) != NULL) {
    report += res;
}
