...
# $Id: deb_756_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304297");
 ...
 script_name("Debian Security Advisory DSA 756-1 (squirrelmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squirrelmail", ver:"1.2.6-4", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"squirrelmail", ver:"1.4.4-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
