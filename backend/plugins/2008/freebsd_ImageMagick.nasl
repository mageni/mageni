#
#VID 713c3913-8c2b-11d9-b58c-0001020eed82
...
CVE-2005-0397
Format string vulnerability in the SetImageInfo function in image.c
for ImageMagick before 6.0.2.5 may allow remote attackers to cause a
denial of service (application crash) and possibly execute arbitrary
code via format string specifiers in a filename argument to convert,
which may be called by other web applications.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.ubuntulinux.org/support/documentation/usn/usn-90-1
http://www.vuxml.org/freebsd/713c3913-8c2b-11d9-b58c-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303074");
