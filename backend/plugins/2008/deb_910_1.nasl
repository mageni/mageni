...
# $Id: deb_910_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 910-1
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300382");
 ...
 script_name("Debian Security Advisory DSA 910-1 (zope2.7)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"zope2.7", ver:"2.7.5-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
