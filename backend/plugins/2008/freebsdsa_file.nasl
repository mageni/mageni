...
tag_insight = "The file(1) utility attempts to classify file system objects based on
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:04.file.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300760");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-07:04.file.asc)";
 script_name(name);
...
vuln = 0;
if(patchlevelcmp(rel:"6.2", patchlevel:"5")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"6.1", patchlevel:"17")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"5.5", patchlevel:"13")<0) {
    vuln = 1;
}
