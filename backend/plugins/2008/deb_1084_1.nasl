...
# $Id: deb_1084_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1084-1
#
# Authors:
...
announced via advisory DSA 1084-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303711");
 ...
 script_name("Debian Security Advisory DSA 1084-1 (typespeed)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"typespeed", ver:"0.4.1-2.4", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"typespeed", ver:"0.4.4-8sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
