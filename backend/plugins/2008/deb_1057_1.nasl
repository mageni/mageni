...
# $Id: deb_1057_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1057-1
#
# Authors:
...
announced via advisory DSA 1057-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303945");
 ...
 script_name("Debian Security Advisory DSA 1057-1 (phpldapadmin)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpldapadmin", ver:"0.9.5-3sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
