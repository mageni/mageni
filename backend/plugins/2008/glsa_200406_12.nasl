...
tag_insight = "Webmin contains two security vulnerabilities which could lead to a Denial
of Service attack and information disclosure.";
tag_solution = "All Webmin users should upgrade to the latest stable version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300682");
 ...
 script_name("Gentoo Security Advisory GLSA 200406-12 (webmin)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-admin/webmin", unaffected: make_list("ge 1.150"), vulnerable: make_list("le 1.140-r1"))) != NULL) {
    report += res;
}
