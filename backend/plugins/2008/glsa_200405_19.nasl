...
tag_insight = "A vulnerability exists in Opera's telnet URI handler that may allow a
remote attacker to overwrite arbitrary files.";
tag_solution = "All Opera users are encouraged to upgrade to the latest version of the
program:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200405-19
http://bugs.gentoo.org/show_bug.cgi?id=50857
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302509");
