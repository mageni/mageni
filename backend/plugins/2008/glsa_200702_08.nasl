...
tag_solution = "All AMD64 x86 emulation Sun's J2SE Development Kit users should upgrade to
the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-emulation/emul-linux-x86-java-1.5.0.10'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200702-08
http://bugs.gentoo.org/show_bug.cgi?id=159547";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303938");
