...
# $Id: deb_263_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Al Viro and Alan Cox discovered several maths overflow errors in
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20263-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303077");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 22:28:10 +0100 (Thu, 17 Jan 2008)");
 script_bugtraq_id(6979);
