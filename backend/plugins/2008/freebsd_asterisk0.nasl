#
#VID 1c0def84-5fb1-11db-b2e9-0008c79fa3d2
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304136");
 ...
 script_name("FreeBSD Ports: asterisk, asterisk-bristuff");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.2.13")<0) {
    txt += 'Package asterisk-bristuff version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
