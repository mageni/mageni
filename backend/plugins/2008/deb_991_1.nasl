...
# $Id: deb_991_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 991-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to zoo
announced via advisory DSA 991-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303434");
 ...
 script_name("Debian Security Advisory DSA 991-1 (zoo)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"zoo", ver:"2.10-9woody0", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"zoo", ver:"2.10-11sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
