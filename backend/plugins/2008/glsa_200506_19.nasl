...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200506-19
http://bugs.gentoo.org/show_bug.cgi?id=95937
http://www.squirrelmail.org/security/issue/2005-06-15";
tag_summary = "The remote host is missing updates announced in
advisory GLSA 200506-19.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301934");
 ...
 script_name("Gentoo Security Advisory GLSA 200506-19 (SquirrelMail)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"mail-client/squirrelmail", unaffected: make_list("ge 1.4.4", "lt 1.4.0"), vulnerable: make_list("lt 1.4.4"))) != NULL) {
    report += res;
}
