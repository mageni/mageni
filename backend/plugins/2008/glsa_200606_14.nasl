...
tag_insight = "An authentication error in GDM could allow users to gain elevated
privileges.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303524");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"gnome-base/gdm", unaffected: make_list("ge 2.8.0.8"), vulnerable: make_list("lt 2.8.0.8"))) != NULL) {
    report += res;
}
