...
tag_insight = "A bug in mod_ssl may allow a remote attacker to execute arbitrary code when
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-18
http://bugs.gentoo.org/show_bug.cgi?id=57379
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300334");
