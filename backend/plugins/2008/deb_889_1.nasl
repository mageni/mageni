...
# $Id: deb_889_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 889-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to enigmail
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301882");
 ...
 script_name("Debian Security Advisory DSA 889-1 (enigmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mozilla-enigmail", ver:"0.91-4sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mozilla-thunderbird-enigmail", ver:"0.91-4sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
