...
tag_insight = "A flaw in the multibyte character handling allows execution of arbitrary
SQL statements.";
tag_solution = "All PostgreSQL users should upgrade to the latest version in the respective
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200607-04
http://bugs.gentoo.org/show_bug.cgi?id=134168
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304120");
