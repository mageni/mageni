#
#VID e50b04e8-9c55-11d8-9366-0020ed76ef5a
...
libxine suffers from an arbitrary file update
vulnerability that allows an attacker, via a malicious
MRL in any xine-lib based media player, to write
arbitrary content into any file.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.xinehq.de/index.php/security/XSA-2004-1
http://www.vuxml.org/freebsd/e50b04e8-9c55-11d8-9366-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301817");
