...
# $Id: deb_1598_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201598-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303522");
 ...
 script_name("Debian Security Advisory DSA 1598-1 (libtk-img)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtk-img", ver:"1.3-15etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
