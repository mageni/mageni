...
# $Id: deb_1537_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1537-1 (xpdf)
#
# Authors:
...
tag_insight = "Alin Rad Pop (Secunia) discovered a number of vulnerabilities in xpdf, a set
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201537-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304111");
 ...
 script_name("Debian Security Advisory DSA 1537-1 (xpdf)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xpdf-common", ver:"3.01-9.1+etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xpdf", ver:"3.01-9.1+etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xpdf-utils", ver:"3.01-9.1+etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xpdf-reader", ver:"3.01-9.1+etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
