...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-04
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303464");
 ...
 script_name("Gentoo Security Advisory GLSA 200812-04 (lighttpd)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"www-servers/lighttpd", unaffected: make_list("ge 1.4.20"), vulnerable: make_list("lt 1.4.20"))) != NULL) {
    report += res;
}
