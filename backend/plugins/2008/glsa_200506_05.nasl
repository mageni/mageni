...
tag_insight = "Executable files with insecure permissions can be modified causing an
unsuspecting user to run arbitrary code.";
tag_solution = "All SilverCity users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-text/silvercity-0.9.5-r1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200506-05
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303429");
