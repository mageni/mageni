...
# $Id: deb_100_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "GOBBLES found a buffer overflow in gzip that occurs when compressing
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20100-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303832");
 ...
 script_name("Debian Security Advisory DSA 100-1 (gzip)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gzip", ver:"1.2.4-33.1", rls:"DEB2.2")) != NULL) {
    report += res;
}
