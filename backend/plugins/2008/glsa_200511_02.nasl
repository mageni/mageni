...
tag_solution = "All QDBM users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200511-02
http://bugs.gentoo.org/show_bug.cgi?id=105717
http://bugs.gentoo.org/show_bug.cgi?id=105760
http://bugs.gentoo.org/show_bug.cgi?id=108534";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300758");
