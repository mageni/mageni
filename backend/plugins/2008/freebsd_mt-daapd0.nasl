#
#VID 86a4d810-1884-11dd-a914-0016179b2dd5
...
tag_insight = "The following package is affected: mt-daapd
...
http://www.vuxml.org/freebsd/86a4d810-1884-11dd-a914-0016179b2dd5.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301639");
 ...
 script_name("FreeBSD Ports: mt-daapd");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.2.4.2")<0) {
    txt += 'Package mt-daapd version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
