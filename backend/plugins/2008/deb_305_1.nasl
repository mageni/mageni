...
# $Id: deb_305_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Paul Szabo discovered bugs in three scripts included in the sendmail
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20305-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303136");
