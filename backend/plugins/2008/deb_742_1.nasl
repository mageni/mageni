...
# $Id: deb_742_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 742-1
#
# Authors:
...
announced via advisory DSA 742-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303216");
 ...
 script_name("Debian Security Advisory DSA 742-1 (cvs)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cvs", ver:"1.11.1p1debian-12", rls:"DEB3.0")) != NULL) {
    report += res;
}
