...
tag_insight = "The following package is affected: linux_base-suse

CVE-2005-1849
inftrees.h in zlib 1.2.2 allows remote attackers to cause a denial of
service (application crash) via an invalid file that causes a large
dynamic tree to be produced.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303892");
 ...
 script_name("FreeBSD Ports: linux_base-suse");
...
if(!isnull(bver) && revcomp(a:bver, b:"9.3_1")<0) {
    txt += 'Package linux_base-suse version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
