...
# $Id: deb_428_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 428-1
#
# Authors:
...
tag_insight = "A vulnerability was discovered in slocate, a program to index and
...
announced via advisory DSA 428-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20428-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302394");
 ...
 script_name("Debian Security Advisory DSA 428-1 (slocate)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"slocate", ver:"2.6-1.3.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
