...
# $Id: deb_1000_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
We recommend that you upgrade your libapreq2, libapache2-mod-apreq2
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201000-1";
tag_summary = "The remote host is missing an update to libapreq2-perl
announced via advisory DSA 1000-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302312");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libapache2-request-perl", ver:"2.04-dev-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
