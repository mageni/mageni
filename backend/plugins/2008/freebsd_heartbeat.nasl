#
#VID f6447303-9ec9-11da-b410-000e0c2e438a
...
tag_insight = "The following package is affected: heartbeat
...
http://www.vuxml.org/freebsd/f6447303-9ec9-11da-b410-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303767");
 ...
 script_name("FreeBSD Ports: heartbeat");
...
if(!isnull(bver) && revcomp(a:bver, b:"0")>=0) {
    txt += 'Package heartbeat version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
