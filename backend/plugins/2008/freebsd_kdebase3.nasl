#
#VID 14ad2a28-66d2-11dc-b25f-02e0185f8d72
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301777");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.5.7_2")<0) {
    txt += 'Package kdelibs3 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
