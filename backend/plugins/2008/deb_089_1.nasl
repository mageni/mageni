...
# $Id: deb_089_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The icecast-server (a streaming music server) package as distributed
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20089-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303374");
 script_cve_id("CVE-2001-0784","CVE-2001-1083","CVE-2001-1230");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 14:24:38 +0100 (Thu, 17 Jan 2008)");
 script_tag(name:"cvss_base", value:"7.5");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
 script_name("Debian Security Advisory DSA 089-1 (icecast-server)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"icecast-server", ver:"1.3.10-1", rls:"DEB2.2")) != NULL) {
    report += res;
}
