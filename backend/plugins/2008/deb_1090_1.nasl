...
# $Id: deb_1090_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1090-1
#
# Authors:
...
We recommend that you upgrade your spamd package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201090-1";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302053");
 ...
 script_name("Debian Security Advisory DSA 1090-1 (spamassassin)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"spamassassin", ver:"3.0.3-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"spamc", ver:"3.0.3-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
