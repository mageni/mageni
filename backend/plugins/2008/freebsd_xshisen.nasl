#
#VID 56971fa6-641c-11d9-a097-000854d03344
...
tag_insight = "The following package is affected: xshisen
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304166");
 ...
 script_cve_id("CVE-2003-1053", "CVE-2005-0117");
 script_tag(name:"cvss_base", value:"4.6");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
 script_name("FreeBSD Ports: xshisen");
...
txt = "";
vuln = 0;
bver = portver(pkg:"xshisen");
if(!isnull(bver) && revcomp(a:bver, b:"1.36_1")<0) {
    txt += 'Package xshisen version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
