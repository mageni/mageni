...
# $Id: deb_374_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "libpam-smb is a PAM authentication module which makes it possible to
...
tag_summary = "The remote host is missing an update to libpam-smb
announced via advisory DSA 374-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20374-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301035");
 ...
 script_name("Debian Security Advisory DSA 374-1 (libpam-smb)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpam-smb", ver:"1.1.6-1.1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
