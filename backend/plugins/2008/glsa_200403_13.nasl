...
tag_insight = "MPlayer contains a remotely exploitable buffer overflow in the HTTP parser
that may allow attackers to run arbitrary code on a user's computer.";
tag_solution = "MPlayer may be upgraded as follows:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200403-13
http://bugs.gentoo.org/show_bug.cgi?id=46246
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302111");
