#
#VID 12b1a62d-6056-4d90-9e21-45fcde6abae4
...
CVE-2004-2124
The register_globals simulation capability in Gallery 1.3.1 through
1.4.1 allows remote attackers to modify the HTTP_POST_VARS variable
and conduct a PHP remote code injection attack via the GALLERY_BASEDIR
parameter, a different vulnerability than CVE-2002-1412.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://marc.theaimsgroup.com/?l=bugtraq&m=107524414317693
http://www.vuxml.org/freebsd/12b1a62d-6056-4d90-9e21-45fcde6abae4.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303217");
