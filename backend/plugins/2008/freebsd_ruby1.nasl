...
tag_insight = "The following packages are affected: ruby ruby_static";
...
http://www.vuxml.org/freebsd/594eb447-e398-11d9-a8bd-000cf18bbe54.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304010");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.8.2_3")<=0) {
