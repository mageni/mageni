...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200502-10
http://bugs.gentoo.org/show_bug.cgi?id=78629
http://www.gentoo.org/security/en/glsa/glsa-200501-28.xml";
tag_summary = "The remote host is missing updates announced in
advisory GLSA 200502-10.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301482");
 ...
 script_name("Gentoo Security Advisory GLSA 200502-10 (pdftohtml)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-text/pdftohtml", unaffected: make_list("ge 0.36-r3"), vulnerable: make_list("lt 0.36-r3"))) != NULL) {
    report += res;
}
