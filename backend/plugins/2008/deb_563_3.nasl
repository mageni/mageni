...
# $Id: deb_563_3.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 563-3
#
# Authors:
...
tag_insight = "This advisory is an addition to DSA 563-1 and 563-2 which weren't able
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20563-3";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301169");
 ...
 script_name("Debian Security Advisory DSA 563-3 (cyrus-sasl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libsasl-dev", ver:"1.5.27-3.1woody5", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsasl-digestmd5-plain", ver:"1.5.27-3.1woody5", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsasl-modules-plain", ver:"1.5.27-3.1woody5", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libsasl7", ver:"1.5.27-3.1woody5", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sasl-bin", ver:"1.5.27-3.1woody5", rls:"DEB3.0")) != NULL) {
    report += res;
}
