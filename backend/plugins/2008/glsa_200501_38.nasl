...
tag_insight = "The Perl DBI library and File::Path::rmtree function are vulnerable to
symlink attacks.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-38
http://bugs.gentoo.org/show_bug.cgi?id=75696
http://bugs.gentoo.org/show_bug.cgi?id=78634
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300915");
