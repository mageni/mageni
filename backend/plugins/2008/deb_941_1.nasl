...
# $Id: deb_941_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to tuxpaint
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300792");
 ...
 script_name("Debian Security Advisory DSA 941-1 (tuxpaint)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tuxpaint-data", ver:"0.9.14-2sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tuxpaint", ver:"0.9.14-2sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
