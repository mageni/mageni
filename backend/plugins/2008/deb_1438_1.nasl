...
# $Id: deb_1438_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several vulnerabilities have been discovered in GNU Tar. The Common
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201438-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302890");
 ...
 script_name("Debian Security Advisory DSA 1438-1 (tar)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tar", ver:"1.14-2.4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tar", ver:"1.16-2etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
