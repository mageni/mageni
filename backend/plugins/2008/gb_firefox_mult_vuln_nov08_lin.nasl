...
# $Id: gb_firefox_mult_vuln_nov08_lin.nasl 12623 2018-12-03 13:11:38Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Firefox version prior to 2.0.0.18 and 3.x to 3.0.3 on Linux.");
