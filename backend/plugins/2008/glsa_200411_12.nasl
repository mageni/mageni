...
tag_insight = "zgv contains multiple buffer overflows that can potentially lead to the
execution of arbitrary code.";
tag_solution = "All zgv users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301846");
 ...
 script_name("Gentoo Security Advisory GLSA 200411-12 (zgv)");
