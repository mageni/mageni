#
#ADV FreeBSD-SA-06:13.sendmail.asc
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:13.sendmail.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-06:13.sendmail.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302752");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-06:13.sendmail.asc)";
 script_name(name);
