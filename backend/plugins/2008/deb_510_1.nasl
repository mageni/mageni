...
# $Id: deb_510_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "jaguar@felinemenace.org discovered a vulnerability in jftpgw, an FTP
...
tag_summary = "The remote host is missing an update to jftpgw
announced via advisory DSA 510-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20510-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300982");
 ...
 script_name("Debian Security Advisory DSA 510-1 (jftpgw)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"jftpgw", ver:"0.13.1-1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
