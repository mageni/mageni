...
# $Id: deb_1065_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302396");
 ...
 script_name("Debian Security Advisory DSA 1065-1 (hostapd)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"hostapd", ver:"0.3.7-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
