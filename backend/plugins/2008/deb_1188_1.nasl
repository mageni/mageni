...
# $Id: deb_1188_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300226");
 ...
 script_name("Debian Security Advisory DSA 1188-1 (mailman)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-8sarge5", rls:"DEB3.1")) != NULL) {
    report += res;
}
