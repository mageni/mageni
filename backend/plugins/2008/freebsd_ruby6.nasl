#
#VID 53802164-3f7e-11dd-90ea-0019666436c2
...
http://www.vuxml.org/freebsd/53802164-3f7e-11dd-90ea-0019666436c2.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302439");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.8.*,1")>=0 && revcomp(a:bver, b:"1.8.6.111_3,1")<0) {
