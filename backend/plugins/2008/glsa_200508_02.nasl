...
tag_insight = "Under specific circumstances, ProFTPD is vulnerable to format string
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200508-02
http://bugs.gentoo.org/show_bug.cgi?id=100364";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301007");
