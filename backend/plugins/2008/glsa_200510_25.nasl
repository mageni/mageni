...
'>=net-analyzer/ethereal-0.10.13-r1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200510-25
http://bugs.gentoo.org/show_bug.cgi?id=109348
http://www.ethereal.com/appnotes/enpa-sa-00021.html";
tag_summary = "The remote host is missing updates announced in
advisory GLSA 200510-25.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303367");
 ...
 script_name("Gentoo Security Advisory GLSA 200510-25 (Ethereal)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-analyzer/ethereal", unaffected: make_list("ge 0.10.13-r1"), vulnerable: make_list("lt 0.10.13-r1"))) != NULL) {
    report += res;
}
