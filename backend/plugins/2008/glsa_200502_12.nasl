...
tag_insight = "Portage-built Webmin binary packages accidentally include a file containing
the local encrypted root password.";
tag_solution = "Webmin users should delete any old shared Webmin binary package as soon as
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200502-12
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303905");
