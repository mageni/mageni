...
tag_insight = "XnView is vulnerable to a stack-based buffer overflow and possible remote
code execution when handling XPM image files.";
tag_solution = "No update appears to be forthcoming from the XnView developer and XnView is
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200707-06
http://bugs.gentoo.org/show_bug.cgi?id=175670";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302513");
