...
tag_insight = "Opera contain several vulnerabilities, some of which may allow the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200708-17
http://bugs.gentoo.org/show_bug.cgi?id=185497
http://bugs.gentoo.org/show_bug.cgi?id=188987
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302722");
