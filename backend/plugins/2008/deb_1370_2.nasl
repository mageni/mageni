...
# $Id: deb_1370_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1370-2
#
# Authors:
...
tag_insight = "The update for the oldstable distribution was incorrectly installed into
...
announced via advisory DSA 1370-2.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201370-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303826");
 ...
 script_name("Debian Security Advisory DSA 1370-2 (phpmyadmin)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"2.6.2-3sarge5", rls:"DEB3.1")) != NULL) {
    report += res;
}
