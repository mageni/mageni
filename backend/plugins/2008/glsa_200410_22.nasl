...
tag_insight = "Several vulnerabilities including privilege abuse, Denial of Service, and
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-22
http://bugs.gentoo.org/show_bug.cgi?id=67062
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301297");
