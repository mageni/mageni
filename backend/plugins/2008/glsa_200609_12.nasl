...
tag_insight = "Mailman has multiple vulnerable that can result in Denial of Service, log
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302291");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-mail/mailman", unaffected: make_list("ge 2.1.9_rc1"), vulnerable: make_list("lt 2.1.9_rc1"))) != NULL) {
    report += res;
}
