...
# $Id: deb_734_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 734-1
#
# Authors:
...
We recommend that you upgrade your gaim package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20734-1";
tag_summary = "The remote host is missing an update to gaim
announced via advisory DSA 734-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301542");
 ...
 script_name("Debian Security Advisory DSA 734-1 (gaim)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gaim-data", ver:"1.2.1-1.3", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gaim", ver:"1.2.1-1.3", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gaim-dev", ver:"1.2.1-1.3", rls:"DEB3.1")) != NULL) {
    report += res;
}
