...
# $Id: deb_1365_3.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201365-3";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301830");
 ...
 script_name("Debian Security Advisory DSA 1365-3 (id3lib3.8.3)");
...
if ((res = isdpkgvuln(pkg:"libid3-3.8.3-dev", ver:"3.8.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libid3-3.8.3c2a", ver:"3.8.3-6etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
