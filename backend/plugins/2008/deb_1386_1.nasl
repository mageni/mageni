...
# $Id: deb_1386_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201386-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300712");
 ...
 script_name("Debian Security Advisory DSA 1386-1 (wesnoth)");
...
if ((res = isdpkgvuln(pkg:"wesnoth-data", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-ei", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-httt", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-music", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-sotbe", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-tdh", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-trow", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-editor", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"wesnoth-server", ver:"0.9.0-6", rls:"DEB4.0")) != NULL) {
    report += res;
}
