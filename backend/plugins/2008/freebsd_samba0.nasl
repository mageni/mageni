#
#VID f3d3f621-38d8-11d9-8fff-000c6e8f12ef
...
CVE-2004-0882
Buffer overflow in the QFILEPATHINFO request handler in Samba 3.0.x
through 3.0.7 may allow remote attackers to execute arbitrary code via
a TRANSACT2_QFILEPATHINFO request with a small 'maximum data bytes'
value.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://marc.theaimsgroup.com/?l=bugtraq&m=110055646329581
http://www.vuxml.org/freebsd/f3d3f621-38d8-11d9-8fff-000c6e8f12ef.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301064");
