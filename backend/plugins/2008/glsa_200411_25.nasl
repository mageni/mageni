...
'>=mail-client/squirrelmail-1.4.3a-r2'
...
advisory GLSA 200411-25.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301084");
 ...
 script_name("Gentoo Security Advisory GLSA 200411-25 (SquirrelMail)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"mail-client/squirrelmail", unaffected: make_list("ge 1.4.3a-r2"), vulnerable: make_list("lt 1.4.3a-r2"))) != NULL) {
    report += res;
}
