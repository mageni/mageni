...
# $Id: deb_827_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 827-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to backupninja
announced via advisory DSA 827-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301765");
 ...
 script_name("Debian Security Advisory DSA 827-1 (backupninja)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"backupninja", ver:"0.5-3sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
