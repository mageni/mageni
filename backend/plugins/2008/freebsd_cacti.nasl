#
#VID ca543e06-207a-11d9-814e-0001020eed82
...
Cacti is a frontend to RRDTool.  It suffers from
a path disclosure as well as a SQL injection vulnerability.
By default, FreeBSD systems are not vulnerable to the
SQL injection vulnerability unless 'magic_quotes_gpc' is
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300782");
