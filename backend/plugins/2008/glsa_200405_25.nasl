...
tag_insight = "tla includes a vulnerable version of the neon library.";
tag_solution = "All users of tla should upgrade to the latest stable version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300047");
