...
tag_insight = "The following package is affected: bogofilter

CVE-2005-4592
Heap-based buffer overflow in bogofilter and bogolexer 0.96.2 allows
remote attackers to cause a denial of service (crash) and possibly
execute arbitrary code via words that are longer than the input buffer
used by flex.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bogofilter.sourceforge.net/security/bogofilter-SA-2005-02
http://www.vuxml.org/freebsd/b747b2a9-7be0-11da-8ec4-0002b3b60e4c.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304023");
