...
tag_insight = "Local users can exploit an scponly flaw to gain root privileges, and
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200512-17
http://bugs.gentoo.org/show_bug.cgi?id=116526
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300530");
