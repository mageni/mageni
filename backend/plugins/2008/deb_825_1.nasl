...
# $Id: deb_825_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 825-1
#
# Authors:
...
announced via advisory DSA 825-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301398");
 ...
 script_name("Debian Security Advisory DSA 825-1 (loop-aes-utils)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"loop-aes-utils", ver:"2.12p-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
