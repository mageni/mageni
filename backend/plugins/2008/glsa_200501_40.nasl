...
tag_insight = "ngIRCd is vulnerable to a buffer overflow that can be used to crash the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-40
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302802");
