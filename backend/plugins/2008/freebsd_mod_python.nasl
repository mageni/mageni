#
#VID 5192e7ca-7d4f-11d9-a9e7-0001020eed82
...
tag_insight = "The following package is affected: mod_python

CVE-2005-0088
The publisher handler for mod_python 2.7.8 and earlier allows remote
attackers to obtain access to restricted objects via a crafted URL.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301853");
