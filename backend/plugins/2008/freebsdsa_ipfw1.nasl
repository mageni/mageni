...
tag_insight = "ipfw(8) is a system facility which provides IP packet filtering,
...
as announced in the referenced advisory FreeBSD-SA-06:04.ipfw.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303681");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-06:04.ipfw.asc)";
 script_name(name);
