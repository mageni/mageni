...
# $Id: deb_659_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Two problems have been discovered in the libpam-radius-auth package,
...
tag_summary = "The remote host is missing an update to libpam-radius-auth
announced via advisory DSA 659-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20659-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302822");
 ...
 script_name("Debian Security Advisory DSA 659-1 (libpam-radius-auth)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpam-radius-auth", ver:"1.3.14-1.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
