...
# $Id: deb_1278_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1278-1
#
# Authors:
...
We recommend that you upgrade your man-db package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201278-1";
tag_summary = "The remote host is missing an update to man-db
announced via advisory DSA 1278-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300409");
 ...
 script_name("Debian Security Advisory DSA 1278-1 (man-db)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"man-db", ver:"2.4.2-21sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
