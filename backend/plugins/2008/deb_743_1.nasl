...
# $Id: deb_743_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 743-1
#
# Authors:
...
We recommend that you upgrade your ht package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20743-1";
tag_summary = "The remote host is missing an update to ht
announced via advisory DSA 743-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300124");
 ...
 script_name("Debian Security Advisory DSA 743-1 (ht)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ht", ver:"0.5.0-1woody4", rls:"DEB3.0")) != NULL) {
    report += res;
}
