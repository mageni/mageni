...
tag_insight = "The hpssd daemon might allow local attackers to execute arbitrary commands
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-26
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302570");
