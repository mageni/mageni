...
# $Id: deb_930_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 930-2
#
# Authors:
...
We recommend that you upgrade your smstools package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20930-2";
tag_summary = "The remote host is missing an update to smstools
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301752");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 23:07:13 +0100 (Thu, 17 Jan 2008)");
 script_bugtraq_id(16188);
 script_cve_id("CVE-2006-0083");
 script_tag(name:"cvss_base", value:"4.6");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
 script_name("Debian Security Advisory DSA 930-2 (smstools)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"smstools", ver:"1.5.0-2woody0", rls:"DEB3.0")) != NULL) {
    report += res;
}
