...
# $Id: deb_342_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "mozart, a development platform based on the Oz language, includes MIME
...
tag_summary = "The remote host is missing an update to mozart
announced via advisory DSA 342-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20342-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304249");
 ...
 script_name("Debian Security Advisory DSA 342-1 (mozart)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mozart-doc-html", ver:"1.2.3.20011204-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mozart", ver:"1.2.3.20011204-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mozart-contrib", ver:"1.2.3.20011204-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
