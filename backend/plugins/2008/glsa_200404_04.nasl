...
tag_insight = "Multiple vulnerabilities in the way sysstat handles symlinks may allow an
attacker to execute arbitrary code or overwrite arbitrary files";
tag_solution = "Systat users should upgrade to version 4.2 or later:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200404-04
http://bugs.gentoo.org/show_bug.cgi?id=45159";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301098");
