...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300198");
 ...
 script_name("FreeBSD Ports: cups-lpr, fr-cups-lpr");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.1.23")<0) {
    txt += 'Package cups-lpr version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"fr-cups-lpr");
if(!isnull(bver) && revcomp(a:bver, b:"1.1.23")<0) {
    txt += 'Package fr-cups-lpr version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
