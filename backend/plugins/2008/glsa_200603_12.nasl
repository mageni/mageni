...
tag_insight = "A buffer overflow in zoo may be exploited to execute arbitrary when
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-12
http://bugs.gentoo.org/show_bug.cgi?id=125622
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303488");
