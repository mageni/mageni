...
# $Id: deb_399_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Jeremy Nelson discovered a remotely exploitable buffer overflow in
...
tag_summary = "The remote host is missing an update to epic4
announced via advisory DSA 399-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20399-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303749");
 ...
 script_name("Debian Security Advisory DSA 399-1 (epic4)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"epic4", ver:"1.1.2.20020219-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
