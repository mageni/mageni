...
tag_insight = "phpMyAdmin contains multiple vulnerabilities that could lead to command
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200503-07
http://bugs.gentoo.org/show_bug.cgi?id=83190
...
advisory GLSA 200503-07.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304354");
 ...
 script_name("Gentoo Security Advisory GLSA 200503-07 (phpMyAdmin)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-db/phpmyadmin", unaffected: make_list("ge 2.6.1_p2-r1"), vulnerable: make_list("lt 2.6.1_p2-r1"))) != NULL) {
    report += res;
}
