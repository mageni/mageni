...
tag_insight = "Version 1.2.9 of ProFTPD introduced a vulnerability that causes CIDR-based
...
tag_solution = "ProFTPD users are encouraged to upgrade to the latest version of the
package:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200405-09
http://bugs.gentoo.org/show_bug.cgi?id=49496";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300596");
