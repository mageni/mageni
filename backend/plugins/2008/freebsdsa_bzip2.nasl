#
#ADV FreeBSD-SA-05:14.bzip2.asc
...
tag_insight = "bzip2 is a block-sorting file compression utility.
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:14.bzip2.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300598");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-05:14.bzip2.asc)";
 script_name(name);
