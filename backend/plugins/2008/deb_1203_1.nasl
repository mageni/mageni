...
# $Id: deb_1203_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300525");
 ...
 script_name("Debian Security Advisory DSA 1203-1 (libpam-ldap)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpam-ldap", ver:"178-1sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
