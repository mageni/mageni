...
advisory GLSA 200411-30.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302434");
 ...
 script_name("Gentoo Security Advisory GLSA 200411-30 (pdftohtml)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-text/pdftohtml", unaffected: make_list("ge 0.36-r1"), vulnerable: make_list("le 0.36"))) != NULL) {
    report += res;
}
