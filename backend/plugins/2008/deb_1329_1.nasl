...
# $Id: deb_1329_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1329-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to gfax
announced via advisory DSA 1329-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201329-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304076");
 ...
 script_name("Debian Security Advisory DSA 1329-1 (gfax)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gfax", ver:"0.4.2-11sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
