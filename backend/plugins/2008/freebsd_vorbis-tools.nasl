#
#VID 633716fa-1f8f-11dd-b143-0211d880e350
...
tag_insight = "The following package is affected: vorbis-tools
...
http://www.vuxml.org/freebsd/633716fa-1f8f-11dd-b143-0211d880e350.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302550");
 ...
 script_name("FreeBSD Ports: vorbis-tools");
...
txt = "";
vuln = 0;
bver = portver(pkg:"vorbis-tools");
if(!isnull(bver) && revcomp(a:bver, b:"1.2.0_2,3")<0) {
    txt += 'Package vorbis-tools version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
