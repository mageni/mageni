...
tag_insight = "Wireshark (formerly known as Ethereal) is vulnerable to several security
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301016");
 ...
 script_name("Gentoo Security Advisory GLSA 200607-09 (wireshark ethereal)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"net-analyzer/wireshark", unaffected: make_list("ge 0.99.2"), vulnerable: make_list("lt 0.99.2"))) != NULL) {
    report += res;
}
if ((res = ispkgvuln(pkg:"net-analyzer/ethereal", unaffected: make_list(), vulnerable: make_list("le 0.99.0-r1"))) != NULL) {
    report += res;
}
