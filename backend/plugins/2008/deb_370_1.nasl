...
# $Id: deb_370_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Florian Zumbiehl reported a vulnerability in pam-pgsql whereby the
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20370-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300721");
 ...
 script_name("Debian Security Advisory DSA 370-1 (pam-pgsql)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpam-pgsql", ver:"0.5.2-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
