#
#VID 2701611f-df5c-11d9-b875-0001020eed82
...
(application crash) via a Yahoo! message with non-ASCII characters in
a file name.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://gaim.sourceforge.net/security/index.php?id=18
http://www.vuxml.org/freebsd/2701611f-df5c-11d9-b875-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300979");
