...
tag_insight = "The jail(2) system call allows a system administrator to lock up a
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:03.jail.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301640");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-04:03.jail.asc)";
 script_name(name);
