...
tag_insight = "An attacker can trick lighttpd into revealing the source of scripts that
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200502-21
http://bugs.gentoo.org/show_bug.cgi?id=81776
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300674");
