...
# $Id: deb_392_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Jens Steube reported two vulnerabilities in webfs, a lightweight HTTP
...
tag_summary = "The remote host is missing an update to webfs
announced via advisory DSA 392-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20392-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301791");
 ...
 script_name("Debian Security Advisory DSA 392-1 (webfs)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"webfs", ver:"1.17.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
