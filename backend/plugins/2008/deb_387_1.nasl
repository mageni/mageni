...
# $Id: deb_387_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "gopherd, a gopher server from the University of Minnesota, contains a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20387-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301996");
 ...
 script_name("Debian Security Advisory DSA 387-1 (gopher)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gopher", ver:"3.0.3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gopherd", ver:"3.0.3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
