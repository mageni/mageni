...
tag_insight = "The following package is affected: smbftpd
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300769");
 ...
 script_name("FreeBSD Ports: smbftpd");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.96")<0) {
    txt += 'Package smbftpd version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
