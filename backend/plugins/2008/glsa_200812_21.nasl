...
tag_insight = "Two vulnerabilities in ClamAV may allow for the remote execution of
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-21
http://bugs.gentoo.org/show_bug.cgi?id=245450
http://bugs.gentoo.org/show_bug.cgi?id=249833";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303872");
