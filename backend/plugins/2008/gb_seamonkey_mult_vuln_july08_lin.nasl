...
# $Id: gb_seamonkey_mult_vuln_july08_lin.nasl 12670 2018-12-05 14:14:20Z cfischer $
#
...
if(description)
{
  ...
  script_name("Mozilla Seamonkey Multiple Vulnerability July-08 (Linux)");
  ...
  script_tag(name:"summary", value:"The host is installed with Mozilla Seamonkey, that is prone
