...
# $Id: deb_801_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303684");
 ...
 script_name("Debian Security Advisory DSA 801-1 (ntp)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ntp-doc", ver:"4.2.0a+stable-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ntp", ver:"4.2.0a+stable-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ntp-refclock", ver:"4.2.0a+stable-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ntp-server", ver:"4.2.0a+stable-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ntp-simple", ver:"4.2.0a+stable-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ntpdate", ver:"4.2.0a+stable-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
