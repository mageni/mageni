#
#VID 673aec6f-1cae-11da-bc01-000e0c2e438a
...
tag_insight = "The following package is affected: htdig
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300158");
 ...
 script_name("FreeBSD Ports: htdig");
...
if(!isnull(bver) && revcomp(a:bver, b:"0")>0) {
    txt += 'Package htdig version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
