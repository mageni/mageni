...
# $Id: deb_730_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Imran Ghory discovered a race condition in bzip2, a high-quality
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20730-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304087");
 ...
 script_name("Debian Security Advisory DSA 730-1 (bzip2)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bzip2", ver:"1.0.2-1.woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libbz2-1.0", ver:"1.0.2-1.woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libbz2-dev", ver:"1.0.2-1.woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
