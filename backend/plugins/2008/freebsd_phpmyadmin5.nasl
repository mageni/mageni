#
#VID c55f9ed0-56a7-11da-a3f0-00123ffe8333
...
http://www.vuxml.org/freebsd/c55f9ed0-56a7-11da-a3f0-00123ffe8333.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.7.0.55884");
 script_version("$Revision: 4148 $");
 script_cve_id("CVE-2005-3621");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.6.4.4")<0) {
