...
# $Id: deb_1027_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1027-1
#
# Authors:
...
We recommend that you upgrade your mailman package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201027-1";
tag_summary = "The remote host is missing an update to mailman
announced via advisory DSA 1027-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302797");
 script_version("$Revision: 6616 $");
 script_tag(name:"last_modification", value:"$Date: 2017-07-07 14:10:49 +0200 (Fri, 07 Jul 2017) $");
 script_tag(name:"creation_date", value:"2008-01-17 23:09:45 +0100 (Thu, 17 Jan 2008)");
 script_bugtraq_id(17311);
 script_cve_id("CVE-2006-0052");
 script_tag(name:"cvss_base", value:"5.0");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
 script_name("Debian Security Advisory DSA 1027-1 (mailman)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-8sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
