...
# $Id: deb_1072_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303530");
 ...
 script_name("Debian Security Advisory DSA 1072-1 (nagios)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"nagios-common", ver:"1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios-mysql", ver:"1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios-pgsql", ver:"1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"nagios-text", ver:"1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1")) != NULL) {
    report += res;
}
