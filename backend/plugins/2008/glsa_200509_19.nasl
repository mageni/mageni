...
tag_insight = "PHP makes use of an affected PCRE library and ships with an affected
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200509-19
http://bugs.gentoo.org/show_bug.cgi?id=102373
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302457");
