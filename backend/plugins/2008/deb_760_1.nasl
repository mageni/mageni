...
# $Id: deb_760_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 760-1
#
# Authors:
...
We recommend that you upgrade your ekg package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20760-1";
tag_summary = "The remote host is missing an update to ekg
announced via advisory DSA 760-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302383");
 ...
 script_name("Debian Security Advisory DSA 760-1 (ekg)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ekg", ver:"1.5+20050411-4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgadu-dev", ver:"1.5+20050411-4", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libgadu3", ver:"1.5+20050411-4", rls:"DEB3.1")) != NULL) {
    report += res;
}
