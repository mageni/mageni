...
# $Id: deb_508_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Jaguar discovered a vulnerability in one component of xpcd, a PhotoCD
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20508-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300984");
 ...
 script_name("Debian Security Advisory DSA 508-1 (xpcd)");
