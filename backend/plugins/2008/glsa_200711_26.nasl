...
tag_insight = "Multiple vulnerabilities have been discovered in teTeX, possibly allowing
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200711-26
...
advisory GLSA 200711-26.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303362");
 ...
 script_name("Gentoo Security Advisory GLSA 200711-26 (tetex)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-text/tetex", unaffected: make_list("ge 3.0_p1-r6"), vulnerable: make_list("lt 3.0_p1-r6"))) != NULL) {
    report += res;
}
