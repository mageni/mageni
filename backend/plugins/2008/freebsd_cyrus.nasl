...
tag_insight = "The following package is affected: cyrus
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301143");
 ...
 script_name("FreeBSD Ports: cyrus");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.0.17")<0) {
    txt += 'Package cyrus version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
