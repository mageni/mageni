...
# $Id: deb_1113_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1113-1
#
# Authors:
...
We recommend that you upgrade your zope2.7 package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201113-1";
tag_summary = "The remote host is missing an update to zope2.7
announced via advisory DSA 1113-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302465");
 ...
 script_name("Debian Security Advisory DSA 1113-1 (zope2.7)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"zope2.7", ver:"2.7.5-2sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
