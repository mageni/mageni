...
# $Id: deb_1411_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1411-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to libopenssl-ruby
announced via advisory DSA 1411-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201411-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304256");
 ...
 script_name("Debian Security Advisory DSA 1411-1 (libopenssl-ruby)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libopenssl-ruby1.6", ver:"0.1.4a-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
