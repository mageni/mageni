...
# $Id: deb_1287_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Two vulnerabilities have been identified in the version of
...
tag_summary = "The remote host is missing an update to ldap-account-manager (0.4.9-2sarge1)
announced via advisory DSA 1287-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201287-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300288");
 ...
 script_name("Debian Security Advisory DSA 1287-1 (ldap-account-manager (0.4.9-2sarge1))");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ldap-account-manager", ver:"0.4.9-2sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
