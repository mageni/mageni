...
# $Id: deb_1039_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1039-1
#
# Authors:
...
We recommend that you upgrade your blender package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201039-1";
tag_summary = "The remote host is missing an update to blender
announced via advisory DSA 1039-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303526");
 ...
 script_name("Debian Security Advisory DSA 1039-1 (blender)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"blender", ver:"2.36-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
