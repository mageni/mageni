...
tag_insight = "The resolver is the part of libc that resolves hostnames (example.com) to
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:02.libc.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301635");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-08:02.libc.asc)";
 script_name(name);
