...
tag_insight = "Multiple Denial of Service vulnerabilities have been reported in OpenLDAP.";
tag_solution = "All OpenLDAP users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=net-nds/openldap-2.3.41'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-28
http://bugs.gentoo.org/show_bug.cgi?id=197446
http://bugs.gentoo.org/show_bug.cgi?id=209677";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303864");
