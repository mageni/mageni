...
tag_insight = "A format string error has been discovered in Sylpheed and Claws Mail,
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-29
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300265");
