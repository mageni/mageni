...
# $Id: deb_389_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "ipmasq is a package which simplifies configuration of Linux IP
...
tag_summary = "The remote host is missing an update to ipmasq
announced via advisory DSA 389-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20389-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300661");
 ...
 script_name("Debian Security Advisory DSA 389-1 (ipmasq)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ipmasq", ver:"3.5.10c", rls:"DEB3.0")) != NULL) {
    report += res;
}
