#
#VID c4b7badf-24ca-11d8-82e5-0020ed76ef5a
...
tag_insight = "The following package is affected: libmcrypt
...
http://www.vuxml.org/freebsd/c4b7badf-24ca-11d8-82e5-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301573");
 ...
 script_name("FreeBSD Ports: libmcrypt");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.5.6")<0) {
    txt += 'Package libmcrypt version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
