#
#VID fba75b43-c588-11da-9110-00123ffe8333
...
http://www.vuxml.org/freebsd/fba75b43-c588-11da-9110-00123ffe8333.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.7.0.56513");
 script_version("$Revision: 4148 $");
 script_cve_id("CVE-2006-1678");
 script_bugtraq_id(17390);
...
if(!isnull(bver) && revcomp(a:bver, b:"2.8.0.3")<0) {
