...
# $Id: deb_944_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300853");
 ...
 script_name("Debian Security Advisory DSA 944-1 (mantis)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mantis", ver:"0.19.2-5sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
