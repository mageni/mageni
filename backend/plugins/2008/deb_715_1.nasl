...
# $Id: deb_715_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several problems have been discovered in the CVS server, which serves
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20715-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301442");
 ...
 script_name("Debian Security Advisory DSA 715-1 (cvs)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cvs", ver:"1.11.1p1debian-10", rls:"DEB3.0")) != NULL) {
    report += res;
}
