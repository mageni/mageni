#
#VID 8950ac62-1d30-11dd-9388-0211060005df
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302503");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.9.1_6")<0) {
    txt += 'Package qemu version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"0.9.1s.20070101*")>=0 && revcomp(a:bver, b:"0.9.1s.20080302_6")<0) {
    txt += 'Package qemu version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
