...
# $Id: deb_522_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Max Vozeler discovered a format string vulnerability in super, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20522-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304191");
 ...
 script_name("Debian Security Advisory DSA 522-1 (super)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"super", ver:"3.16.1-1.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
