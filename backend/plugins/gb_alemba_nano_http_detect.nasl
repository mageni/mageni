...
foreach dir (make_list_unique("/", cgi_dirs(port: port))) {
  ...
  if ("Nano" >< res && 'id="NanoDevelopment"' >< res) {
    version = "unknown";

    # <span id="Version">9.10.4.0</span>
    ...
    log_message(data: build_detection_report(app: "Alemba Nano", version: version, install: install, cpe: cpe,
                                             concluded:vers[0]),
                port: port);
    exit(0);
  }
