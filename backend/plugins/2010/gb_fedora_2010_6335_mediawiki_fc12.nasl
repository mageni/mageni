...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/043799.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313933");
  ...
  script_name("Fedora Update for mediawiki FEDORA-2010-6335");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"mediawiki", rpm:"mediawiki~1.15.3~53.fc12", rls:"FC12")) != NULL)
  {
