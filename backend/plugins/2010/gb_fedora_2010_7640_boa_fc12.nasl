...
tag_affected = "boa on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041271.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312738");
  ...
  script_name("Fedora Update for boa FEDORA-2010-7640");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"boa", rpm:"boa~0.94.14~0.15.rc21.fc12", rls:"FC12")) != NULL)
  {
