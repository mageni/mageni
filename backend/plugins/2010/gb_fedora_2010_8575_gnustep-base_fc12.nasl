...
tag_affected = "gnustep-base on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041702.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313272");
  script_version("$Revision: 8338 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-09 09:00:38 +0100 (Tue, 09 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-05-28 10:00:59 +0200 (Fri, 28 May 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-8575");
  script_cve_id("CVE-2010-1457", "CVE-2010-1602", "CVE-2010-1620");
  script_name("Fedora Update for gnustep-base FEDORA-2010-8575");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"gnustep-base", rpm:"gnustep-base~1.18.0~9.fc12", rls:"FC12")) != NULL)
  {
