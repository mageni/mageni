...
tag_affected = "blam on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035424.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314385");
  ...
  script_name("Fedora Update for blam FEDORA-2010-1727");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"blam", rpm:"blam~1.8.5~22.fc12", rls:"FC12")) != NULL)
  {
