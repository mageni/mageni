...
#
# Fedora Update for drupal-cck FEDORA-2010-15665
#
# Authors:
...
tag_affected = "drupal-cck on Fedora 14";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049231.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314142");
  script_version("$Revision: 8266 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-01 08:28:32 +0100 (Mon, 01 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-15665");
  script_name("Fedora Update for drupal-cck FEDORA-2010-15665");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-cck", rpm:"drupal-cck~6.x.2.8~1.fc14", rls:"FC14")) != NULL)
  {
