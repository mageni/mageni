...
#
# Fedora Update for w3m FEDORA-2010-10369
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044401.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313733");
  ...
  script_name("Fedora Update for w3m FEDORA-2010-10369");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"w3m", rpm:"w3m~0.5.2~17.fc12", rls:"FC12")) != NULL)
  {
