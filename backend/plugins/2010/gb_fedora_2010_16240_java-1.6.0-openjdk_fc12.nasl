...
tag_affected = "java-1.6.0-openjdk on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049702.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314099");
  ...
  script_name("Fedora Update for java-1.6.0-openjdk FEDORA-2010-16240");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.0~41.1.8.2.fc12", rls:"FC12")) != NULL)
  {
