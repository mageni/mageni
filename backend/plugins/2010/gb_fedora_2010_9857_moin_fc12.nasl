...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/042786.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313665");
  script_version("$Revision: 8485 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-22 08:57:57 +0100 (Mon, 22 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-06-18 17:26:33 +0200 (Fri, 18 Jun 2010)");
  script_tag(name:"cvss_base", value:"3.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-9857");
  script_cve_id("CVE-2010-0828");
  script_name("Fedora Update for moin FEDORA-2010-9857");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"moin", rpm:"moin~1.8.8~1.fc12", rls:"FC12")) != NULL)
  {
