...
#
# Fedora Update for znc FEDORA-2010-10082
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043044.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314299");
  ...
  script_name("Fedora Update for znc FEDORA-2010-10082");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"znc", rpm:"znc~0.090~2.fc11", rls:"FC11")) != NULL)
  {
