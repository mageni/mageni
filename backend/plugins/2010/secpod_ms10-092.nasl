...
if(description)
{
  ...
  script_tag(name:"impact", value:"Successful exploition will allows elevation of privilege.");
  script_tag(name:"affected", value:"Microsoft Windows 7

  Microsoft Windows Vista Service Pack 2 and prior.

  Microsoft Windows Server 2008 Service Pack 2 and prior.");
  script_tag(name:"insight", value:"The flaw is caused by an error in task scheduler when performing integrity
