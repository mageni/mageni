...
#
# Fedora Update for NetworkManager FEDORA-2010-12911
#
# Authors:
...
tag_affected = "NetworkManager on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046010.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314689");
  ...
  script_name("Fedora Update for NetworkManager FEDORA-2010-12911");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"NetworkManager", rpm:"NetworkManager~0.8.1~3.git20100813.fc12", rls:"FC12")) != NULL)
  {
