...
#
# Fedora Update for znc FEDORA-2010-10042
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043000.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314501");
  ...
  script_name("Fedora Update for znc FEDORA-2010-10042");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"znc", rpm:"znc~0.090~2.fc13", rls:"FC13")) != NULL)
  {
