...
# $Id: gb_gallo_39890.nasl 14326 2019-03-19 13:40:32Z jschulte $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Gallo is prone to a remote file-include vulnerability because it fails
