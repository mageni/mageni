...
#
# Fedora Update for ardour FEDORA-2010-15499
#
# Authors:
...
tag_affected = "ardour on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049373.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313952");
  script_version("$Revision: 8528 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-25 08:57:36 +0100 (Thu, 25 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-10-19 15:54:15 +0200 (Tue, 19 Oct 2010)");
  script_xref(name: "FEDORA", value: "2010-15499");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_cve_id("CVE-2010-3349");
  script_name("Fedora Update for ardour FEDORA-2010-15499");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"ardour", rpm:"ardour~2.8.11~5.fc12", rls:"FC12")) != NULL)
  {
