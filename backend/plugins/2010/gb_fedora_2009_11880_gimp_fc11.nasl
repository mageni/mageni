...
tag_affected = "gimp on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2010-January/msg00184.html");
  script_oid("1.3.6.1.4.1.25623.1.0.315026");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"gimp", rpm:"gimp~2.6.8~1.fc11", rls:"FC11")) != NULL)
  {
