...
tag_affected = "kde-l10n on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041919.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314284");
  ...
  script_name("Fedora Update for kde-l10n FEDORA-2010-8544");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kde-l10n", rpm:"kde-l10n~4.4.3~1.fc12", rls:"FC12")) != NULL)
  {
