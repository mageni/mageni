...
tag_affected = "dracut on Fedora 14";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/051417.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314294");
  ...
  script_name("Fedora Update for dracut FEDORA-2010-17930");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"dracut", rpm:"dracut~006~5.fc14", rls:"FC14")) != NULL)
  {
