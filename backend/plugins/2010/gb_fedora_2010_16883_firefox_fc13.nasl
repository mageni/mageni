...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/050061.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314323");
  ...
  script_name("Fedora Update for firefox FEDORA-2010-16883");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~3.6.12~1.fc13", rls:"FC13")) != NULL)
  {
