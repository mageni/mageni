...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052025.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314648");
  ...
  script_name("Fedora Update for perl-Gtk2-MozEmbed FEDORA-2010-18775");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-Gtk2-MozEmbed", rpm:"perl-Gtk2-MozEmbed~0.08~6.fc13.20", rls:"FC13")) != NULL)
  {
