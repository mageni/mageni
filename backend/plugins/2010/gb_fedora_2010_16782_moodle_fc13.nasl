...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050803.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313471");
  ...
  script_name("Fedora Update for moodle FEDORA-2010-16782");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"moodle", rpm:"moodle~1.9.10~1.fc13", rls:"FC13")) != NULL)
  {
