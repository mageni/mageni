...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/037100.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313077");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"cups", rpm:"cups~1.4.2~20.fc12", rls:"FC12")) != NULL)
  {
