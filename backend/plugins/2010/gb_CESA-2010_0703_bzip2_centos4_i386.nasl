...
#
# CentOS Update for bzip2 CESA-2010:0703 centos4 i386
#
# Authors:
...
tag_affected = "bzip2 on CentOS 4";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-September/017016.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312812");
  ...
  script_name("CentOS Update for bzip2 CESA-2010:0703 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"bzip2", rpm:"bzip2~1.0.2~16.el4_8", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"bzip2-devel", rpm:"bzip2-devel~1.0.2~16.el4_8", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"bzip2-libs", rpm:"bzip2-libs~1.0.2~16.el4_8", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
