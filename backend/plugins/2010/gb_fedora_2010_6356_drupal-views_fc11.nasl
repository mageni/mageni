...
#
# Fedora Update for drupal-views FEDORA-2010-6356
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039118.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314858");
  script_version("$Revision: 8246 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-26 08:29:20 +0100 (Tue, 26 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-04-16 17:02:11 +0200 (Fri, 16 Apr 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-6356");
  script_name("Fedora Update for drupal-views FEDORA-2010-6356");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-views", rpm:"drupal-views~6.x.2.9~1.fc11", rls:"FC11")) != NULL)
  {
