...
#
# Fedora Update for gnome-web-photo FEDORA-2010-11375
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044481.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312836");
  ...
  script_name("Fedora Update for gnome-web-photo FEDORA-2010-11375");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.9~8.fc12", rls:"FC12")) != NULL)
  {
