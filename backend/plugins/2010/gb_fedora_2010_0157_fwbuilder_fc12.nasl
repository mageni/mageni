...
#
# Fedora Update for fwbuilder FEDORA-2010-0157
#
# Authors:
...
tag_affected = "fwbuilder on Fedora 12";
tag_insight = "Firewall Builder consists of a GUI and set of policy compilers for
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.314425");
 ...
 script_version("$Revision: 8469 $");
  ...
  script_name("Fedora Update for fwbuilder FEDORA-2010-0157");

  script_tag(name: "summary" , value: "Check for the Version of fwbuilder");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"fwbuilder", rpm:"fwbuilder~3.0.7~1.fc12", rls:"FC12")) != NULL)
  {
