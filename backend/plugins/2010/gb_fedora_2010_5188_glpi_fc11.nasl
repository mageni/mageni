...
#
# Fedora Update for glpi FEDORA-2010-5188
#
# Authors:
...
tag_affected = "glpi on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/037946.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312908");
  script_version("$Revision: 8207 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-21 08:30:12 +0100 (Thu, 21 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-31 14:20:46 +0200 (Wed, 31 Mar 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-5188");
  script_name("Fedora Update for glpi FEDORA-2010-5188");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"glpi", rpm:"glpi~0.72.4~2.svn11035.fc11", rls:"FC11")) != NULL)
  {
