...
tag_affected = "openldap on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046039.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314282");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.4.21~10.fc13", rls:"FC13")) != NULL)
  {
