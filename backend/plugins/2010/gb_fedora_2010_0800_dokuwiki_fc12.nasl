...
tag_affected = "dokuwiki on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/034831.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313052");
 ...
 script_version("$Revision: 8274 $");
  ...
  script_name("Fedora Update for dokuwiki FEDORA-2010-0800");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"dokuwiki", rpm:"dokuwiki~0~0.4.20091225.c.fc12", rls:"FC12")) != NULL)
  {
