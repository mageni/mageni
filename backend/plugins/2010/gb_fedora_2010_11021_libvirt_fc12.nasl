...
tag_affected = "libvirt on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044579.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314172");
  ...
  script_name("Fedora Update for libvirt FEDORA-2010-11021");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"libvirt", rpm:"libvirt~0.8.2~1.fc12", rls:"FC12")) != NULL)
  {
