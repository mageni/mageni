...
tag_affected = "udev on Fedora 14";
tag_insight = "udev is a collection of tools and a daemon to manage events received
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/051418.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314541");
  ...
  script_name("Fedora Update for udev FEDORA-2010-17930");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"udev", rpm:"udev~161~7.fc14", rls:"FC14")) != NULL)
  {
