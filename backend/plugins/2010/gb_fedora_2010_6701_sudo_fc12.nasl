...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/040578.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313785");
  script_version("$Revision: 8250 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-27 08:29:15 +0100 (Wed, 27 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-05-07 15:42:01 +0200 (Fri, 07 May 2010)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2010-6701");
  script_cve_id("CVE-2010-0426");
  script_name("Fedora Update for sudo FEDORA-2010-6701");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.7.2p6~1.fc12", rls:"FC12")) != NULL)
  {
