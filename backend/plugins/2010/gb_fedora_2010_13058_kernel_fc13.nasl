...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046051.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314977");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~2.6.33.8~149.fc13", rls:"FC13")) != NULL)
  {
