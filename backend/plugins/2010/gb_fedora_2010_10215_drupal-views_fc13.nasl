...
tag_affected = "drupal-views on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043202.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312745");
  ...
  script_name("Fedora Update for drupal-views FEDORA-2010-10215");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-views", rpm:"drupal-views~6.x.2.11~1.fc13", rls:"FC13")) != NULL)
  {
