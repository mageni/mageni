...
tag_affected = "mantis on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/048639.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313870");
  ...
  script_name("Fedora Update for mantis FEDORA-2010-15080");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"mantis", rpm:"mantis~1.1.8~4.fc12", rls:"FC12")) != NULL)
  {
