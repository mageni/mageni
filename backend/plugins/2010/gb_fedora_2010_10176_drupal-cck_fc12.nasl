...
#
# Fedora Update for drupal-cck FEDORA-2010-10176
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043172.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313056");
  script_version("$Revision: 8228 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-22 08:29:52 +0100 (Fri, 22 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-06-25 12:25:26 +0200 (Fri, 25 Jun 2010)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-10176");
  script_name("Fedora Update for drupal-cck FEDORA-2010-10176");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-cck", rpm:"drupal-cck~6.x.2.7~1.fc12", rls:"FC12")) != NULL)
  {
