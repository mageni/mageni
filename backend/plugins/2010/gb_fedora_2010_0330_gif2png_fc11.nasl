...
tag_insight = "The gif2png program converts files from the obsolescent Graphic Interchange
...
tag_affected = "gif2png on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/033890.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314274");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"gif2png", rpm:"gif2png~2.5.1~1102.fc11", rls:"FC11")) != NULL)
  {
