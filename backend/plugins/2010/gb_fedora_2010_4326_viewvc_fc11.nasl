...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/037289.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314024");
  script_version("$Revision: 8258 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-29 08:28:57 +0100 (Fri, 29 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-22 11:34:53 +0100 (Mon, 22 Mar 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-4326");
  script_name("Fedora Update for viewvc FEDORA-2010-4326");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"viewvc", rpm:"viewvc~1.1.4~1.fc11", rls:"FC11")) != NULL)
  {
