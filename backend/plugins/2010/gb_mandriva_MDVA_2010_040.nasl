...
tag_insight = "A dependency problem was discovered with roundcube. The
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-01/msg00071.php");
  script_oid("1.3.6.1.4.1.25623.1.0.314448");
  script_version("$Revision: 8510 $");
  script_cve_id("CVE-2010-0414", "CVE-2009-4641");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"mmc-wizard", rpm:"mmc-wizard~1.0~13.2mdvmes5", rls:"MNDK_mes5")) != NULL)
  {
