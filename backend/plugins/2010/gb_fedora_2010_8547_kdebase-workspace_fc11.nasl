...
#
# Fedora Update for kdebase-workspace FEDORA-2010-8547
#
# Authors:
...
tag_affected = "kdebase-workspace on Fedora 11";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041975.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314645");
  ...
  script_cve_id("CVE-2010-1000", "CVE-2010-1511", "CVE-2010-0436");
  script_name("Fedora Update for kdebase-workspace FEDORA-2010-8547");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"kdebase-workspace", rpm:"kdebase-workspace~4.4.3~1.fc11.1", rls:"FC11")) != NULL)
  {
