...
tag_affected = "mailgraph on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "in /etc/sysconfig/mailgraph, MAILGRAPH_MAIL_LOG should be
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.313585");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"mailgraph", rpm:"mailgraph~1.14~5.1mdvmes5.1", rls:"MNDK_mes5")) != NULL)
  {
