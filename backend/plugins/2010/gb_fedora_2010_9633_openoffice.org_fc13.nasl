...
#
# Fedora Update for openoffice.org FEDORA-2010-9633
#
# Authors:
...
tag_affected = "openoffice.org on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/042534.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313884");
  script_version("$Revision: 8485 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-22 08:57:57 +0100 (Mon, 22 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-06-11 13:46:51 +0200 (Fri, 11 Jun 2010)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2010-9633");
  script_cve_id("CVE-2010-0395");
  script_name("Fedora Update for openoffice.org FEDORA-2010-9633");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"openoffice.org", rpm:"openoffice.org~3.2.0~12.24.fc13", rls:"FC13")) != NULL)
  {
