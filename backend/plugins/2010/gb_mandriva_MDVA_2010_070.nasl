...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-02/msg00031.php");
  script_oid("1.3.6.1.4.1.25623.1.0.314934");
  ...
  script_xref(name: "MDVA", value: "2010:070");
  script_name("Mandriva Update for blogtk MDVA-2010:070 (blogtk)");
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"blogtk", rpm:"blogtk~2.0~3.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"python-gdata", rpm:"python-gdata~2.0.2~1.1mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
