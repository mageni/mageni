...
#
# Fedora Update for lib3ds FEDORA-2010-14730
#
# Authors:
...
tag_affected = "lib3ds on Fedora 14";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/048083.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314632");
  ...
  script_name("Fedora Update for lib3ds FEDORA-2010-14730");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"lib3ds", rpm:"lib3ds~1.3.0~9.fc14", rls:"FC14")) != NULL)
  {
