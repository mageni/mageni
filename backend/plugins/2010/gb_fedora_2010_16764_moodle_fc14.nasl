...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050797.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314947");
  script_version("$Revision: 8469 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-19 08:58:21 +0100 (Fri, 19 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-16764");
  script_cve_id("CVE-2010-4207", "CVE-2010-4208", "CVE-2010-4209");
  script_name("Fedora Update for moodle FEDORA-2010-16764");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"moodle", rpm:"moodle~1.9.10~1.fc14", rls:"FC14")) != NULL)
  {
