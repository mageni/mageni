...
tag_insight = "MMC-Wizard create an insecure sqlite.db file for roundcubemail. This
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.314548");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"mmc-wizard", rpm:"mmc-wizard~1.0~13.12mdvmes5.1", rls:"MNDK_mes5")) != NULL)
  {
