...
#
# Fedora Update for kdebase-workspace FEDORA-2010-6077
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039587.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314697");
  ...
  script_name("Fedora Update for kdebase-workspace FEDORA-2010-6077");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"kdebase-workspace", rpm:"kdebase-workspace~4.4.2~5.fc11", rls:"FC11")) != NULL)
  {
