...
#
# Fedora Update for kdesdk FEDORA-2010-6096
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039472.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314194");
  ...
  script_name("Fedora Update for kdesdk FEDORA-2010-6096");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdesdk", rpm:"kdesdk~4.4.2~1.fc12", rls:"FC12")) != NULL)
  {
