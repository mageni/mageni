...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046044.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312852");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"ruby", rpm:"ruby~1.8.6.399~6.fc13", rls:"FC13")) != NULL)
  {
