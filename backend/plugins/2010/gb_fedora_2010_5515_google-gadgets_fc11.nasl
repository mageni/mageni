...
#
# Fedora Update for google-gadgets FEDORA-2010-5515
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038335.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314382");
  ...
  script_name("Fedora Update for google-gadgets FEDORA-2010-5515");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"google-gadgets", rpm:"google-gadgets~0.11.1~6.fc11", rls:"FC11")) != NULL)
  {
