...
#
# Fedora Update for sunbird FEDORA-2010-14352
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047242.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313719");
  ...
  script_name("Fedora Update for sunbird FEDORA-2010-14352");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"sunbird", rpm:"sunbird~1.0~0.24.20090916hg.fc12", rls:"FC12")) != NULL)
  {
