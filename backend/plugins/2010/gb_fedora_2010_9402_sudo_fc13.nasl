...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/042838.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312935");
  script_version("$Revision: 8469 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-19 08:58:21 +0100 (Fri, 19 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-06-18 17:26:33 +0200 (Fri, 18 Jun 2010)");
  script_tag(name:"cvss_base", value:"6.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2010-9402");
  script_cve_id("CVE-2010-1646");
  script_name("Fedora Update for sudo FEDORA-2010-9402");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.7.2p6~2.fc13", rls:"FC13")) != NULL)
  {
