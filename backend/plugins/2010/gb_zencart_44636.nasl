...
# $Id: gb_zencart_44636.nasl 14323 2019-03-19 13:19:09Z jschulte $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Zen Cart is prone to a local file-include vulnerability because it
