...
tag_affected = "zabbix on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/034425.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313602");
  script_version("$Revision: 8228 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-22 08:29:52 +0100 (Fri, 22 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-02 08:38:02 +0100 (Tue, 02 Mar 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-0278");
  script_cve_id("CVE-2009-4499", "CVE-2009-4501");
  script_name("Fedora Update for zabbix FEDORA-2010-0278");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~1.6.8~1.fc11", rls:"FC11")) != NULL)
  {
