...
tag_affected = "mod_auth_shadow on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041340.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313717");
  script_version("$Revision: 8314 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-08 09:01:01 +0100 (Mon, 08 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-05-17 16:00:10 +0200 (Mon, 17 May 2010)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-6359");
  script_cve_id("CVE-2010-1151");
  script_name("Fedora Update for mod_auth_shadow FEDORA-2010-6359");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"mod_auth_shadow", rpm:"mod_auth_shadow~2.2~8.fc12", rls:"FC12")) != NULL)
  {
