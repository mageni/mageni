...
tag_affected = "mingw32-libltdl on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035850.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313642");
  ...
  script_name("Fedora Update for mingw32-libltdl FEDORA-2010-2341");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"mingw32-libltdl", rpm:"mingw32-libltdl~1.5.26~20.fc12", rls:"FC12")) != NULL)
  {
