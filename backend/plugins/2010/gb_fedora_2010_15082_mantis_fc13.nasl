...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/048659.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314998");
  script_version("$Revision: 8246 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-26 08:29:20 +0100 (Tue, 26 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-10-01 16:10:21 +0200 (Fri, 01 Oct 2010)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-15082");
  script_cve_id("CVE-2010-3070", "CVE-2010-2574", "CVE-2010-3303");
  script_name("Fedora Update for mantis FEDORA-2010-15082");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"mantis", rpm:"mantis~1.1.8~4.fc13", rls:"FC13")) != NULL)
  {
