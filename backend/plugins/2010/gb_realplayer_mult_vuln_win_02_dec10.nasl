...
# $Id: gb_realplayer_mult_vuln_win_02_dec10.nasl 12653 2018-12-04 15:31:25Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801673");
  script_version("$Revision: 12653 $");
  script_tag(name:"last_modification", value:"$Date: 2018-12-04 16:31:25 +0100 (Tue, 04 Dec 2018) $");
  script_tag(name:"creation_date", value:"2010-12-29 07:31:27 +0100 (Wed, 29 Dec 2010)");
  script_bugtraq_id(45411);
  script_cve_id("CVE-2010-4376", "CVE-2010-4397");
  ...
  script_tag(name:"affected", value:"RealPlayer SP 1.0 to 1.1.1 (12.x)
...
if(version_in_range(version:rpVer, test_version:"11.0.0", test_version2:"11.0.0.674") ||
   version_in_range(version:rpVer, test_version:"12.0.0", test_version2:"12.0.0.614")){
