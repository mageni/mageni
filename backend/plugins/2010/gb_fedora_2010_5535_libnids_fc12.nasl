...
#
# Fedora Update for libnids FEDORA-2010-5535
#
# Authors:
...
tag_insight = "Libnids is an implementation of an E-component of Network Intrusion
...
tag_affected = "libnids on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038374.html");
  script_oid("1.3.6.1.4.1.25623.1.0.315085");
 ...
 script_version("$Revision: 8287 $");
  ...
  script_tag(name: "summary" , value: "Check for the Version of libnids");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"libnids", rpm:"libnids~1.24~1.fc12", rls:"FC12")) != NULL)
  {
