...
#
# Fedora Update for konq-plugins FEDORA-2010-6077
#
# Authors:
...
tag_affected = "konq-plugins on Fedora 11";
tag_insight = "Some additional plugins that interact with konqueror
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039584.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314475");
  ...
  script_name("Fedora Update for konq-plugins FEDORA-2010-6077");

  script_tag(name: "summary" , value: "Check for the Version of konq-plugins");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"konq-plugins", rpm:"konq-plugins~4.4.0~3.fc11", rls:"FC11")) != NULL)
  {
