...
tag_affected = "drupal on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/045464.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314515");
  ...
  script_name("Fedora Update for drupal FEDORA-2010-12753");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.19~1.fc13", rls:"FC13")) != NULL)
  {
