...
tag_affected = "kdeutils on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039581.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313112");
  ...
  script_name("Fedora Update for kdeutils FEDORA-2010-6077");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"kdeutils", rpm:"kdeutils~4.4.2~1.fc11.1", rls:"FC11")) != NULL)
  {
