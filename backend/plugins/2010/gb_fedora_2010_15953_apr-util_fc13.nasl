...
tag_affected = "apr-util on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/049885.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314183");
  ...
  script_name("Fedora Update for apr-util FEDORA-2010-15953");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"apr-util", rpm:"apr-util~1.3.10~1.fc13", rls:"FC13")) != NULL)
  {
