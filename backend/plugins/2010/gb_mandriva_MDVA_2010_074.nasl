...
#
# Mandriva Update for xdg-utils MDVA-2010:074 (xdg-utils)
#
# Authors:
...
tag_insight = "This update enables files to be properly attached when xdg-email is
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.313432");
...
if(release == "MNDK_2010.0")
{
  ...
  if ((res = isrpmvuln(pkg:"xdg-utils", rpm:"xdg-utils~1.0.2~14.5mdv2010.0", rls:"MNDK_2010.0")) != NULL)
  {
