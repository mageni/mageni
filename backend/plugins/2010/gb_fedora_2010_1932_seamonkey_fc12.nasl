...
#
# Fedora Update for seamonkey FEDORA-2010-1932
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035346.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314242");
  ...
  script_name("Fedora Update for seamonkey FEDORA-2010-1932");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.0.3~1.fc12", rls:"FC12")) != NULL)
  {
