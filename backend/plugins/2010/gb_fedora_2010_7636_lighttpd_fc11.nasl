...
tag_affected = "lighttpd on Fedora 11";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041264.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314872");
  script_version("$Revision: 8447 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-17 17:12:19 +0100 (Wed, 17 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-05-17 16:00:10 +0200 (Mon, 17 May 2010)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_xref(name: "FEDORA", value: "2010-7636");
  script_cve_id("CVE-2010-0295");
  script_name("Fedora Update for lighttpd FEDORA-2010-7636");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"lighttpd", rpm:"lighttpd~1.4.26~2.fc11", rls:"FC11")) != NULL)
  {
