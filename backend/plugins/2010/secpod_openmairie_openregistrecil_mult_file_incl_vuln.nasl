...
if(description)
{
  ...
  script_name("openMairie openRegistreCIL Multiple File Inclusion Vulnerabilities");
  script_xref(name:"URL", value:"http://secunia.com/advisories/39534");
  script_xref(name:"URL", value:"http://www.exploit-db.com/exploits/12313");
  ...
  script_tag(name:"summary", value:"This host is running openMairie openRegistreCIL and is prone to
  ...
  script_tag(name:"affected", value:"OpenMairie openRegistreCIL version 1.02 and prior.");
...
openVer = get_kb_item("www/"+ openPort + "/OpenMairie/Open_Registre_CIL");
if(!openVer)
  exit(0);
