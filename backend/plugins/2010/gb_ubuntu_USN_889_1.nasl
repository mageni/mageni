...
# $Id: gb_ubuntu_USN_889_1.nasl 8528 2018-01-25 07:57:36Z teissa $
#
...
tag_insight = "It was discovered that gzip incorrectly handled certain malformed
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-889-1";
tag_affected = "gzip vulnerabilities on Ubuntu 6.06 LTS ,
  Ubuntu 8.04 LTS ,
  Ubuntu 8.10 ,
  Ubuntu 9.04 ,
  Ubuntu 9.10";
...
if(description)
{
  script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-889-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.313450");
...
if(release == "UBUNTU9.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.12-6ubuntu2.9.04.1", rls:"UBUNTU9.04")) != NULL)
  {
...
if(release == "UBUNTU6.06 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.5-12ubuntu0.3", rls:"UBUNTU6.06 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU8.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.12-6ubuntu2.8.10.1", rls:"UBUNTU8.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU8.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.12-3.2ubuntu0.1", rls:"UBUNTU8.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU9.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.12-8ubuntu1.1", rls:"UBUNTU9.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
