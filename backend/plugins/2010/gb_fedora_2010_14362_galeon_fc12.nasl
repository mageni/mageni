...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047282.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313094");
  ...
  script_name("Fedora Update for galeon FEDORA-2010-14362");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.7~25.fc12", rls:"FC12")) != NULL)
  {
