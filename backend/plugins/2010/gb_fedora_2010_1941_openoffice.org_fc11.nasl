...
#
# Fedora Update for openoffice.org FEDORA-2010-1941
#
# Authors:
...
tag_affected = "openoffice.org on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035181.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314808");
  ...
  script_name("Fedora Update for openoffice.org FEDORA-2010-1941");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"openoffice.org", rpm:"openoffice.org~3.1.1~19.12.fc11", rls:"FC11")) != NULL)
  {
