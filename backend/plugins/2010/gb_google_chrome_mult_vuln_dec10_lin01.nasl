...
# $Id: gb_google_chrome_mult_vuln_dec10_lin01.nasl 12670 2018-12-05 14:14:20Z cfischer $
#
...
if(description)
{
  ...
  service.");
  script_tag(name:"affected", value:"Google Chrome version prior to 8.0.552.215 on Linux.");
