...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/033915.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313751");
  ...
  script_cve_id("CVE-2009-4212", "CVE-2009-3295");
  script_name("Fedora Update for krb5 FEDORA-2010-0503");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.7~18.fc12", rls:"FC12")) != NULL)
  {
