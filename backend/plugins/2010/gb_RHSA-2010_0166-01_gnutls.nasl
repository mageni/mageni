...
tag_insight = "The GnuTLS library provides support for cryptographic algorithms and for
  ...
  the CVE-2009-3555 flaw: href= &qt http://kbase.redhat.com/faq/docs/DOC-20491
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2010-March/msg00024.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313423");
  script_version("$Revision: 8528 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-25 08:57:36 +0100 (Thu, 25 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-03-31 14:20:46 +0200 (Wed, 31 Mar 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
  script_xref(name: "RHSA", value: "2010:0166-01");
  script_cve_id("CVE-2009-2409", "CVE-2009-3555");
  script_name("RedHat Update for gnutls RHSA-2010:0166-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~1.4.1~3.el5_4.8", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gnutls-debuginfo", rpm:"gnutls-debuginfo~1.4.1~3.el5_4.8", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gnutls-devel", rpm:"gnutls-devel~1.4.1~3.el5_4.8", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gnutls-utils", rpm:"gnutls-utils~1.4.1~3.el5_4.8", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
