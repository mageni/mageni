...
tag_affected = "gdm on Red Hat Enterprise Linux AS version 4,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2010-August/msg00031.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313537");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"gdm", rpm:"gdm~2.6.0.5~7.rhel4.19.el4_8.2", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gdm-debuginfo", rpm:"gdm-debuginfo~2.6.0.5~7.rhel4.19.el4_8.2", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
