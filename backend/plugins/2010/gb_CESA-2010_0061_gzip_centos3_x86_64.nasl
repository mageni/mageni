...
#
# CentOS Update for gzip CESA-2010:0061 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-January/016468.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313597");
  ...
  script_name("CentOS Update for gzip CESA-2010:0061 centos3 x86_64");
