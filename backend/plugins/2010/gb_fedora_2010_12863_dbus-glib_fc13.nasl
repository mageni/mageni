...
tag_affected = "dbus-glib on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/045979.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314045");
  ...
  script_name("Fedora Update for dbus-glib FEDORA-2010-12863");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"dbus-glib", rpm:"dbus-glib~0.86~4.fc13", rls:"FC13")) != NULL)
  {
