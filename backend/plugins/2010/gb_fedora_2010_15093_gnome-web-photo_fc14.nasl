...
#
# Fedora Update for gnome-web-photo FEDORA-2010-15093
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/048386.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312838");
  ...
  script_name("Fedora Update for gnome-web-photo FEDORA-2010-15093");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.9~13.fc14", rls:"FC14")) != NULL)
  {
