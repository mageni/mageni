...
tag_affected = "banshee on Fedora 14";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050756.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313806");
  script_version("$Revision: 8510 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-24 08:57:42 +0100 (Wed, 24 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2010-17021");
  script_cve_id("CVE-2010-3998");
  script_name("Fedora Update for banshee FEDORA-2010-17021");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"banshee", rpm:"banshee~1.8.0~10.fc14", rls:"FC14")) != NULL)
  {
