...
#
# Fedora Update for w3m FEDORA-2010-10250
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/043956.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313025");
  script_version("$Revision: 8447 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-17 17:12:19 +0100 (Wed, 17 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-07-12 11:56:20 +0200 (Mon, 12 Jul 2010)");
  script_xref(name: "FEDORA", value: "2010-10250");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_cve_id("CVE-2010-2074");
  script_name("Fedora Update for w3m FEDORA-2010-10250");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"w3m", rpm:"w3m~0.5.2~18.fc13", rls:"FC13")) != NULL)
  {
