...
#
# Fedora Update for kernel FEDORA-2015-6294
#
# Authors:
...
if(description)
{
  ...
  script_cve_id("CVE-2015-2150", "CVE-2015-2672", "CVE-2015-2666", "CVE-2014-8159",
                ...
                "CVE-2014-8160", "CVE-2014-9585", "CVE-2014-9529", "CVE-2014-9419",
                ...
                "CVE-2013-6368", "CVE-2013-6367", "CVE-2015-2922");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Fedora Update for kernel FEDORA-2015-6294");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"kernel on Fedora 20");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155804.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.19.4~100.fc20", rls:"FC20")) != NULL)
  {
