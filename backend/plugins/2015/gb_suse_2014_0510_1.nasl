...
# $Id: gb_suse_2014_0510_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for puppet SUSE-SU-2014:0510-1 (puppet)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for puppet SUSE-SU-2014:0510-1 (puppet)");
...
if(release == "SLES11.0SP3")
{
  ...
  if ((res = isrpmvuln(pkg:"puppet", rpm:"puppet~2.6.18~0.14.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"puppet-server", rpm:"puppet-server~2.6.18~0.14.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
