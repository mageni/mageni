...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.869052");
  ...
  script_name("Fedora Update for v8 FEDORA-2015-2313");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-February/150528.html");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"v8", rpm:"v8~3.14.5.10~17.fc21", rls:"FC21")) != NULL)
  {
