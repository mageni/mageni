...
# $Id: gb_sam_multi_sql_inj_vuln.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
# SolarWinds Server and Application Monitor Multiple SQL Injection Vulnerabilities
#
# Authors:
...
if (description)
{
  ...
  script_dependencies("gb_orion_sam_detect.nasl");
