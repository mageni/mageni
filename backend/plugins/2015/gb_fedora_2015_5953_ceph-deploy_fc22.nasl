...
if(description)
{
  ...
  script_name("Fedora Update for ceph-deploy FEDORA-2015-5953");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ceph-deploy'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"ceph-deploy on Fedora 22");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"ceph-deploy", rpm:"ceph-deploy~1.5.23~1.fc22", rls:"FC22")) != NULL)
  {
