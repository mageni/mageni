...
# $Id: alas-2015-600.nasl 6575 2017-07-06 13:42:08Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2015-600");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"libunwind-devel", rpm:"libunwind-devel~1.1~10.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libunwind", rpm:"libunwind~1.1~10.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libunwind-debuginfo", rpm:"libunwind-debuginfo~1.1~10.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
