...
#
# Ubuntu Update for linux USN-2688-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-07-30 05:13:17 +0200 (Thu, 30 Jul 2015)");
  script_cve_id("CVE-2015-3290", "CVE-2015-1333", "CVE-2015-3291", "CVE-2015-5157");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux USN-2688-1");
...
or potentially escalate privileges on the system. (CVE-2015-5157)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2688-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-generic", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-generic-lpae", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-lowlatency", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-powerpc-e500", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-powerpc-e500mc", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-powerpc-smp", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-powerpc64-emb", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-59-powerpc64-smp", ver:"3.13.0-59.98", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
