...
#
# Fedora Update for mingw-libjpeg-turbo FEDORA-2014-17561
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147315.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"mingw-libjpeg-turbo", rpm:"mingw-libjpeg-turbo~1.3.1~4.fc20", rls:"FC20")) != NULL)
  {
