...
#
# Fedora Update for mbedtls FEDORA-2015-9607
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.869711");
  ...
  script_name("Fedora Update for mbedtls FEDORA-2015-9607");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"mbedtls", rpm:"mbedtls~1.3.11~1.fc22", rls:"FC22")) != NULL)
  {
