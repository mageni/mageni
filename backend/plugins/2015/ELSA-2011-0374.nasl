...
# $Id: ELSA-2011-0374.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2011-0374 - thunderbird security and bug fix update. Please see the references for more insight.");
...
{
  if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~3.1.9~3.0.1.el6_0", rls:"OracleLinux6")) != NULL) {
