...
#
# Ubuntu Update for linux-ti-omap4 USN-2612-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-06-09 11:09:27 +0200 (Tue, 09 Jun 2015)");
  script_cve_id("CVE-2015-3339", "CVE-2014-9715");
  script_tag(name:"cvss_base", value:"6.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-ti-omap4 USN-2612-1");
...
a denial of service (system crash of targeted system). (CVE-2014-9715)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2612-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-1464-omap4", ver:"3.2.0-1464.84", rls:"UBUNTU12.04 LTS")) != NULL)
  {
