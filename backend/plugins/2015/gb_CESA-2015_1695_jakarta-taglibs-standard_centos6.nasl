...
if(description)
{
  ...
  script_name("CentOS Update for jakarta-taglibs-standard CESA-2015:1695 centos6");
...
noarc ...
  ...
  script_tag(name:"affected", value:"jakarta-taglibs-standard on CentOS 6");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"jakarta-taglibs-standard", rpm:"jakarta-taglibs-standard~1.1.1~11.7.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"jakarta-taglibs-standard-javadoc", rpm:"jakarta-taglibs-standard-javadoc~1.1.1~11.7.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
