...
#
# Fedora Update for kernel FEDORA-2014-17244
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868851");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-01-05 14:59:15 +0100 (Mon, 05 Jan 2015)");
  script_cve_id("CVE-2014-8134", "CVE-2014-9090", "CVE-2014-7842", "CVE-2014-7841",
                "CVE-2014-7826", "CVE-2014-7825", "CVE-2014-3610", "CVE-2014-3611",
                "CVE-2014-3646", "CVE-2014-8369", "CVE-2014-3688", "CVE-2014-3687",
                "CVE-2014-3673", "CVE-2014-3690", "CVE-2014-7975", "CVE-2014-7970",
                ...
                "CVE-2014-1737", "CVE-2014-3122", "CVE-2014-2851", "CVE-2014-0155",
                ...
                "CVE-2013-2234", "CVE-2010-5313");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Fedora Update for kernel FEDORA-2014-17244");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"kernel on Fedora 19");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147478.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.14.27~100.fc19", rls:"FC19")) != NULL)
  {
