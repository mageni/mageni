...
if(description)
{
  ...
  script_cve_id("CVE-2014-9293","CVE-2014-9294","CVE-2014-9297");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0274-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-February/001220.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ntp'
  package(s) announced via the SUSE-SU-2015:0274-1 advisory.");
