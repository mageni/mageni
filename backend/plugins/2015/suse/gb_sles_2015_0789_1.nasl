...
if(description)
{
  ...
  script_cve_id("CVE-2015-0458","CVE-2015-0459","CVE-2015-0460");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0789-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-April/001363.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_0-openjdk,  java-1_7_0-openjdk-bootstrap'
  package(s) announced via the SUSE-SU-2015:0789-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'java-1_7_0-openjdk,  java-1_7_0-openjdk-bootstrap' package(s) on SUSE Linux Enterprise Server 12 (ppc64le s390x x86_64)");
