...
if(description)
{
  ...
  script_cve_id("CVE-2015-5307","CVE-2015-7311","CVE-2015-7504");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:2328-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-December/001747.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2015:2328-1 advisory.");
