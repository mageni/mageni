...
if(description)
{
  ...
  script_cve_id("CVE-2015-0272","CVE-2015-2925","CVE-2015-5156");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:2292-1)");
  ...
  package(s) announced via the SUSE-SU-2015:2292-1 advisory.");
