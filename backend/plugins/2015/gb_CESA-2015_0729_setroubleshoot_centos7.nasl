...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882141");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-04-01 07:23:01 +0200 (Wed, 01 Apr 2015)");
  script_cve_id("CVE-2015-1815");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("CentOS Update for setroubleshoot CESA-2015:0729 centos7");
...
which contain a backported patch to correct this issue.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-April/021037.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"setroubleshoot", rpm:"setroubleshoot~3.2.17~4.1.el7_1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"setroubleshoot-server", rpm:"setroubleshoot-server~3.2.17~4.1.el7_1", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
