...
# $Id: ELSA-2011-0885.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2011-0885 -  firefox security and bug fix update. Please see the references for more insight.");
