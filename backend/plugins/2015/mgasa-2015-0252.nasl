...
# $Id: mgasa-2015-0252.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-15 10:43:00 +0300 (Thu, 15 Oct 2015)");
  script_tag(name:"last_modification", value:"$Date: 2018-09-28 18:55:19 +0200 (Fri, 28 Sep 2018) $");
  script_name("Mageia Linux Local Check: mgasa-2015-0252");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0252");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"p7zip", rpm:"p7zip~9.20.1~6.1.mga5", rls:"MAGEIA5")) != NULL) {
