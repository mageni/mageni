...
#
# Fedora Update for community-mysql FEDORA-2015-1162
#
# Authors:
...
if(description)
{
  ...
  script_cve_id("CVE-2015-0411", "CVE-2015-0382", "CVE-2015-0381", "CVE-2015-0432",
                ...
                "CVE-2014-2432", "CVE-2014-2431", "CVE-2014-2430", "CVE-2014-2436",
                "CVE-2014-2438", "CVE-2014-2419", "CVE-2014-0001");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("Fedora Update for community-mysql FEDORA-2015-1162");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~5.5.41~1.fc20", rls:"FC20")) != NULL)
  {
