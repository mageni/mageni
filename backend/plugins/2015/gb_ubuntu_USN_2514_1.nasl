...
#
# Ubuntu Update for linux-ti-omap4 USN-2514-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for linux-ti-omap4 USN-2514-1");
...
gain administrative privileges. (CVE-2014-9644)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2514-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-1460-omap4", ver:"3.2.0-1460.80", rls:"UBUNTU12.04 LTS")) != NULL)
  {
