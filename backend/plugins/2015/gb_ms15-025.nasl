...
if(description)
{
  ...
  update according to Microsoft Bulletin MS15-025.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaws are exists,

  - In the way that Windows Registry Virtualization improperly allows a user
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/kb/3038680");
  script_xref(name:"URL", value:"https://technet.microsoft.com/library/security/MS15-025");
...
##Elevation of Privilege KB3033395
if(hotfix_check_sp(win2003x64:3,win2003:3) > 0)
{
  dllVer = fetch_file_version(sysPath:sysPath, file_name:"system32\drivers\Fltmgr.sys");
  if(!dllVer){
    exit(0);
  }
  if(version_is_less(version:dllVer, test_version:"5.2.3790.5107"))
  {
...
##Elevation of Privilege KB3035131
...
{
  if(version_is_less(version:dllVer, test_version:"6.0.6002.19327") ||
...
{
  if(version_is_less(version:dllVer, test_version:"6.1.7601.18738") ||
     version_in_range(version:dllVer, test_version:"6.1.7601.22000", test_version2:"6.1.7601.22942")){
    security_message( port: 0, data: "The target host was found to be vulnerable" );
  }
  exit(0);
}
...
if(hotfix_check_sp(win8:1, win8x64:1, win2012:1) > 0)
{
  if(version_is_less(version:dllVer, test_version:"6.2.9200.17251") ||
     version_in_range(version:dllVer, test_version:"6.2.9200.20000", test_version2:"6.2.9200.21367")){
    security_message( port: 0, data: "The target host was found to be vulnerable" );
  }
  exit(0);
}
