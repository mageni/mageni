...
# $Id: ELSA-2014-0026.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2014-0026 - java-1.7.0-openjdk security update. Please see the references for more insight.");
