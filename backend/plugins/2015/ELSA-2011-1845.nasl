...
# $Id: ELSA-2011-1845.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(release == "OracleLinux5")
{
  ...
  if ((res = isrpmvuln(pkg:"tomcat5-jsp", rpm:"tomcat5-jsp~2.0~api~5.5.23~0jpp.22.el5_7", rls:"OracleLinux5")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"tomcat5-jsp", rpm:"tomcat5-jsp~2.0~api~javadoc~5.5.23~0jpp.22.el5_7", rls:"OracleLinux5")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"tomcat5-servlet", rpm:"tomcat5-servlet~2.4~api~5.5.23~0jpp.22.el5_7", rls:"OracleLinux5")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"tomcat5-servlet", rpm:"tomcat5-servlet~2.4~api~javadoc~5.5.23~0jpp.22.el5_7", rls:"OracleLinux5")) != NULL) {
    security_message(data:res);
    exit(0);
  }
