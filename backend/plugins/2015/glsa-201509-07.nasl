...
# $Id: glsa-201509-07.nasl 12128 2018-10-26 13:35:25Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.121413");
  script_version("$Revision: 12128 $");
  script_tag(name:"creation_date", value:"2015-09-29 11:29:04 +0300 (Tue, 29 Sep 2015)");
  script_tag(name:"last_modification", value:"$Date: 2018-10-26 15:35:25 +0200 (Fri, 26 Oct 2018) $");
  script_name("Gentoo Security Advisory GLSA 201509-07");
  ...
  script_xref(name:"URL", value:"https://security.gentoo.org/glsa/201509-07");
  ...
  script_tag(name:"summary", value:"Gentoo Linux Local Security Checks GLSA 201509-07");
...
if((res=ispkgvuln(pkg:"www-plugins/adobe-flash", unaffected: make_list("ge 11.2.202.521"), vulnerable: make_list("lt 11.2.202.521"))) != NULL) {
  report += res;
}
