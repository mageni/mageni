...
#
# Fedora Update for wpa_supplicant FEDORA-2015-6860
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for wpa_supplicant FEDORA-2015-6860");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~2.0~13.fc21", rls:"FC21")) != NULL)
  {
