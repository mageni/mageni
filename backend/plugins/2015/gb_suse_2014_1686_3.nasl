...
# $Id: gb_suse_2014_1686_3.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for ntp SUSE-SU-2014:1686-3 (ntp)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850884");
  script_version("$Revision: 12381 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-16 12:16:30 +0100 (Fri, 16 Nov 2018) $");
  script_tag(name:"creation_date", value:"2015-10-16 13:34:14 +0200 (Fri, 16 Oct 2015)");
  script_cve_id("CVE-2014-9295");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("SuSE Update for ntp SUSE-SU-2014:1686-3 (ntp)");
...
if(release == "SLES11.0SP1")
{
  ...
  if ((res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.4p8~1.28.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.4p8~1.28.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
