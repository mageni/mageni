...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868840");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-01-05 14:57:30 +0100 (Mon, 05 Jan 2015)");
  script_cve_id("CVE-2014-8964");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_name("Fedora Update for pcre FEDORA-2014-15573");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"pcre", rpm:"pcre~8.35~8.fc21", rls:"FC21")) != NULL)
  {
