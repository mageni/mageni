...
# $Id: deb_3200.nasl 14278 2019-03-18 14:47:26Z cfischer $
...
found the Drupal content management framework.");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"drupal7", ver:"7.14-2+deb7u9", rls:"DEB7")) != NULL) {
  report += res;
}
