...
#
# Ubuntu Update for linux USN-2843-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for linux USN-2843-1");
...
if(release == "UBUNTU15.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-generic", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-generic-lpae", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-lowlatency", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-powerpc-e500mc", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-powerpc-smp", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-powerpc64-emb", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.2.0-21-powerpc64-smp", ver:"4.2.0-21.25", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
