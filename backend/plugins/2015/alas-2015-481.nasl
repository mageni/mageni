...
# $Id: alas-2015-481.nasl 6575 2017-07-06 13:42:08Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2015-481");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"libyaml-devel", rpm:"libyaml-devel~0.1.6~6.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libyaml-debuginfo", rpm:"libyaml-debuginfo~0.1.6~6.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libyaml", rpm:"libyaml~0.1.6~6.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
