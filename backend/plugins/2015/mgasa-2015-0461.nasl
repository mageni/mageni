...
# $Id: mgasa-2015-0461.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0461.html");
  script_cve_id("CVE-2015-8316");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"lightdm", rpm:"lightdm~1.14.4~1.mga5", rls:"MAGEIA5")) != NULL) {
