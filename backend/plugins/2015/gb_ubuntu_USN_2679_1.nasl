...
#
# Ubuntu Update for linux-ti-omap4 USN-2679-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-07-24 06:34:54 +0200 (Fri, 24 Jul 2015)");
  script_cve_id("CVE-2015-1805", "CVE-2015-4700");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-ti-omap4 USN-2679-1");
...
denial of service (system crash). (CVE-2015-4700)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2679-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-1468-omap4", ver:"3.2.0-1468.89", rls:"UBUNTU12.04 LTS")) != NULL)
  {
