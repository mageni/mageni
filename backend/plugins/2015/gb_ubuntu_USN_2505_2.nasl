...
#
# Ubuntu Update for firefox USN-2505-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-03-10 06:33:44 +0100 (Tue, 10 Mar 2015)");
  ...
  script_name("Ubuntu Update for firefox USN-2505-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"USN-2505-1 fixed vulnerabilities in Firefox.
This update removed the deprecated '-remote' command-line switch that some older
software still depends on. This update fixes the problem.
...
SVG conte ...
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2505-2/");
...
if(release == "UBUNTU14.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"36.0.1+build2-0ubuntu0.14.10.1", rls:"UBUNTU14.10")) != NULL)
  {
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"36.0.1+build2-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"36.0.1+build2-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
