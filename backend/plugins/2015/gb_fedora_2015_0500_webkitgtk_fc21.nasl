...
#
# Fedora Update for webkitgtk FEDORA-2015-0500
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for webkitgtk FEDORA-2015-0500");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"webkitgtk", rpm:"webkitgtk~2.4.8~1.fc21", rls:"FC21")) != NULL)
  {
