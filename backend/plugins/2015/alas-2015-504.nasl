...
# $Id: alas-2015-504.nasl 6575 2017-07-06 13:42:08Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2015-504");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"unzip-debuginfo", rpm:"unzip-debuginfo~6.0~2.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"unzip", rpm:"unzip~6.0~2.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
