...
#
# Ubuntu Update for openjdk-7 USN-2696-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-07-31 07:22:57 +0200 (Fri, 31 Jul 2015)");
  script_cve_id("CVE-2015-2590", "CVE-2015-2628", "CVE-2015-4731", "CVE-2015-4732", "CVE-2015-4733", "CVE-2015-4760", "CVE-2015-4748", "CVE-2015-2601", "CVE-2015-2808", "CVE-2015-4000", "CVE-2015-2625", "CVE-2015-2613", "CVE-2015-2621", "CVE-2015-2632", "CVE-2015-4749");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for openjdk-7 USN-2696-1");
...
this to cause a denial of service. (CVE-2015-4749)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2696-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"icedtea-7-jre-jamvm", ver:"7u79-2.5.6-0ubuntu1.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"openjdk-7-jdk", ver:"7u79-2.5.6-0ubuntu1.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"openjdk-7-jre", ver:"7u79-2.5.6-0ubuntu1.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-headless", ver:"7u79-2.5.6-0ubuntu1.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-lib", ver:"7u79-2.5.6-0ubuntu1.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"openjdk-7-jre-zero", ver:"7u79-2.5.6-0ubuntu1.14.04.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
