...
# $Id: deb_3305.nasl 14278 2019-03-18 14:47:26Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-django", ver:"1.4.5-1+deb7u12", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-django-doc", ver:"1.4.5-1+deb7u12", rls:"DEB7")) != NULL) {
  report += res;
}
