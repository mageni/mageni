...
# $Id: glsa-201512-09.nasl 12128 2018-10-26 13:35:25Z cfischer $
#
...
if(description)
{
  ...
  script_name("Gentoo Security Advisory GLSA 201512-09");
  ...
  script_tag(name:"summary", value:"Gentoo Linux Local Security Checks GLSA 201512-09");
...
if((res=ispkgvuln(pkg:"sys-fs/encfs", unaffected: make_list("ge 1.7.5"), vulnerable: make_list("lt 1.7.5"))) != NULL) {
  report += res;
}
