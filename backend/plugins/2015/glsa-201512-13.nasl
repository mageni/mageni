...
# $Id: glsa-201512-13.nasl 12128 2018-10-26 13:35:25Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security.gentoo.org/glsa/201512-13");
  ...
  script_tag(name:"summary", value:"Gentoo Linux Local Security Checks GLSA 201512-13");
...
if((res=ispkgvuln(pkg:"net-irc/inspircd", unaffected: make_list("ge 2.0.20"), vulnerable: make_list("lt 2.0.20"))) != NULL) {
  report += res;
}
