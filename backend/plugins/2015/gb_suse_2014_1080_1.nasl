...
# $Id: gb_suse_2014_1080_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for apache2 SUSE-SU-2014:1080-1 (apache2)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for apache2 SUSE-SU-2014:1080-1 (apache2)");
...
if(release == "SLES11.0SP2")
{
  ...
  if ((res = isrpmvuln(pkg:"apache2", rpm:"apache2~2.2.12~1.48.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"apache2-doc", rpm:"apache2-doc~2.2.12~1.48.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"apache2-example-pages", rpm:"apache2-example-pages~2.2.12~1.48.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"apache2-prefork", rpm:"apache2-prefork~2.2.12~1.48.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"apache2-utils", rpm:"apache2-utils~2.2.12~1.48.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"apache2-worker", rpm:"apache2-worker~2.2.12~1.48.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
