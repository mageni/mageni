...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-201)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"openvpn", rpm:"openvpn~2.3.1~1.7.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvpn-debuginfo", rpm:"openvpn-debuginfo~2.3.1~1.7.amzn1", rls:"AMAZON"))) {
    report += res;
  }
