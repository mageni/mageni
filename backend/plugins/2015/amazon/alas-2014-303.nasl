...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-303)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"openswan", rpm:"openswan~2.6.37~3.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openswan-debuginfo", rpm:"openswan-debuginfo~2.6.37~3.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openswan-doc", rpm:"openswan-doc~2.6.37~3.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }
