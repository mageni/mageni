...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-181)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"puppet-debuginfo", rpm:"puppet-debuginfo~2.7.21~2.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"puppet-server", rpm:"puppet-server~2.7.21~2.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"puppet", rpm:"puppet~2.7.21~2.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }
