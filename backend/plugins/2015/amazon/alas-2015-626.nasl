...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2015-626)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"autofs", rpm:"autofs~5.0.7~54.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"autofs-debuginfo", rpm:"autofs-debuginfo~5.0.7~54.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }
