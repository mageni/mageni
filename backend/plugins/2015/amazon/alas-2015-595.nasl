...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2015-595)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"jakarta-taglibs-standard", rpm:"jakarta-taglibs-standard~1.1.1~11.7.9.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"jakarta-taglibs-standard-javadoc", rpm:"jakarta-taglibs-standard-javadoc~1.1.1~11.7.9.amzn1", rls:"AMAZON"))) {
    report += res;
  }
