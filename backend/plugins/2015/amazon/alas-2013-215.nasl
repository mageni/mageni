...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 13:26:13 +0200 (Tue, 08 Sep 2015)");
  ...
  script_tag(name:"solution", value:"Run yum update haproxy to update your system.");
