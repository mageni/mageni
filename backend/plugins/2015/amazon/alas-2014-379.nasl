...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-379)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"gnupg2", rpm:"gnupg2~2.0.24~1.25.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnupg2-debuginfo", rpm:"gnupg2-debuginfo~2.0.24~1.25.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnupg2-smime", rpm:"gnupg2-smime~2.0.24~1.25.amzn1", rls:"AMAZON"))) {
    report += res;
  }
