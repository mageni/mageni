...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-407)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.38.0~1.46.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl-devel", rpm:"libcurl-devel~7.38.0~1.46.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"curl-debuginfo", rpm:"curl-debuginfo~7.38.0~1.46.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.38.0~1.46.amzn1", rls:"AMAZON"))) {
    report += res;
  }
