...
if(description)
{
  ...
  script_name("Fedora Update for mingw-libtasn1 FEDORA-2015-5390");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-libtasn1'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"mingw-libtasn1 on Fedora 20");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"mingw-libtasn1", rpm:"mingw-libtasn1~3.8~2.fc20", rls:"FC20")) != NULL)
  {
