...
# $Id: gb_citrix_netscaler_CTX202482.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.105454");
...
if( enhanced )
{
  if( version_in_range( version:vers, test_version:"10.5", test_version2:"10.5.54.9009" ) )
  {
    fix = '10.5.e Build 56.1505.e';
  }
  if( version_in_range( version:vers, test_version:'10.1', test_version2:'10.1.132.8' ) )
  {
...
{
  if( version_in_range( version:vers, test_version:'10.5', test_version2:'10.5.57.7' ) )
  {
