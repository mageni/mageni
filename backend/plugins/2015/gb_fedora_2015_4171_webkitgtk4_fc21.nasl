...
#
# Fedora Update for webkitgtk4 FEDORA-2015-4171
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"webkitgtk4 on Fedora 21");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-March/153553.html");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"webkitgtk4", rpm:"webkitgtk4~2.6.5~3.fc21", rls:"FC21")) != NULL)
  {
