...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882311");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-11-05 06:15:52 +0100 (Thu, 05 Nov 2015)");
  ...
  script_name("CentOS Update for firefox CESA-2015:1982 centos5");
...
the update, Firefox must be restarted for the changes to take effect.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-November/021474.html");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.4.0~1.el5.centos", rls:"CentOS5")) != NULL)
  {
