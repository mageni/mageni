...
if(description)
{
  ...
  script_name("Fedora Update for moodle FEDORA-2015-14996");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-September/166397.html");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"moodle", rpm:"moodle~2.7.9~1.fc21", rls:"FC21")) != NULL)
  {
