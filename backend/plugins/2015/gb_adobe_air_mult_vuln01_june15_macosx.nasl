...
# $Id: gb_adobe_air_mult_vuln01_june15_macosx.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
# Adobe Air Multiple Vulnerabilities - 01 June15 (Mac OS X)
#
# Authors:
...
if(description)
{
  ...
  script_name("Adobe Air Multiple Vulnerabilities - 01 June15 (Mac OS X)");
...
if(version_is_less(version:airVer, test_version:"18.0.0.143"))
{
