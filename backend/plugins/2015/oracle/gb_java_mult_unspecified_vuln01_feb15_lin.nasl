...
# $Id: gb_java_mult_unspecified_vuln01_feb15_lin.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
...
if(jreVer =~ "^(1\.8)")
{
  if(version_in_range(version:jreVer, test_version:"1.8.0", test_version2:"1.8.0.25"))
  {
