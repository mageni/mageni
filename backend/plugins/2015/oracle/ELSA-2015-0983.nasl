...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2015-0983 - tomcat security update. Please see the references for more insight.");
...
if(release == "OracleLinux7")
{
  ...
  if ((res = isrpmvuln(pkg:"tomcat-el-2.2-api", rpm:"tomcat-el-2.2-api~7.0.54~2.el7_1", rls:"OracleLinux7")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"tomcat-jsp-2.2-api", rpm:"tomcat-jsp-2.2-api~7.0.54~2.el7_1", rls:"OracleLinux7")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"tomcat-servlet-3.0-api", rpm:"tomcat-servlet-3.0-api~7.0.54~2.el7_1", rls:"OracleLinux7")) != NULL) {
    security_message(data:res);
    exit(0);
  }
