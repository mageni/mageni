...
#
# Ubuntu Update for linux USN-2666-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-07-08 06:33:04 +0200 (Wed, 08 Jul 2015)");
  ...
  script_name("Ubuntu Update for linux USN-2666-1");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"A race condition was discovered in the Linux
kernel's file_handle size verification. A local user could exploit this flaw to
read potentially sensitive memory locations. (CVE-2015-1420)
...
denial of service (system crash). (CVE-2015-4700)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2666-1/");
...
if(release == "UBUNTU14.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-generic", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-generic-lpae", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-lowlatency", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-powerpc-e500mc", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-powerpc-smp", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-powerpc64-emb", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.16.0-43-powerpc64-smp", ver:"3.16.0-43.58", rls:"UBUNTU14.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
