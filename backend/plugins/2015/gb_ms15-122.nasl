...
if(hotfix_check_sp(winVista:3, win2008:3) > 0)
{
  if(version_is_less(version:dllVer, test_version:"6.0.6002.19525")||
     version_in_range(version:dllVer, test_version:"6.0.6002.23000", test_version2:"6.0.6002.23834")){
    VULN = TRUE ;
  }
}
...
{
  if(version_is_less(version:dllVer, test_version:"6.1.7601.19043") ||
     version_in_range(version:dllVer, test_version:"6.1.7601.23000", test_version2:"6.1.7601.23248")){
    VULN = TRUE ;
  }
}
...
{
  if(version_is_less(version:dllVer, test_version:"6.2.9200.17557") ||
     version_in_range(version:dllVer, test_version:"6.2.9200.21000", test_version2:"6.2.9200.21673")){
     VULN = TRUE ;
  }
}
