...
# $Id: gb_mediawiki_hovercards_xss_vuln.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Hovercards extension
  ...
  text parameter to the 'Extension:Popups'. script is
  ...
  script_tag(name:"solution", value:"Upgrade to Hovercards extension version 1.24
  or later.");
  ...
  script_xref(name:"URL", value:"http://www.mediawiki.org/wiki/Special:ExtensionDistributor/Popups");
  exit(0);
}
...
if (reswiki =~">Popups<") {
   ...
   url =dir+"/index.php?title=Extension:Popups&action=submit";
   ...
   url = dir+"/index.php/Extension:Popups";
