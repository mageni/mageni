...
# $Id: gb_suse_2014_0605_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for flash-player SUSE-SU-2014:0605-1 (flash-player)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for flash-player SUSE-SU-2014:0605-1 (flash-player)");
...
if(release == "SLED11.0SP3")
{
  ...
  if ((res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.356~0.3.1", rls:"SLED11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.356~0.3.1", rls:"SLED11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.356~0.3.1", rls:"SLED11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
