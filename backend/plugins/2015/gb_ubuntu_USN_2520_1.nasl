...
#
# Ubuntu Update for cups USN-2520-1
#
# Authors:
...
if(release == "UBUNTU14.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.7.5-3ubuntu3.1", rls:"UBUNTU14.10")) != NULL)
  {
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.7.2-0ubuntu1.5", rls:"UBUNTU14.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.5.3-0ubuntu8.6", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"cups", ver:"1.4.3-1ubuntu1.14", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
