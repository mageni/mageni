...
if(description)
{
  ...
  script_name("Delta Electronics CNCSoft MLCEditor Version Detection (Windows)");
  ...
  of Delta Electronics CNCSoft MLCEditor for Windows.");
...
set_kb_item( name:"delta_electronics/cncsoft/mlceditor/detected", value:TRUE );

register_and_report_cpe( app:"Delta Electronics CNCSoft MLCEditor", ver:version, concluded:concluded,
                         base:"cpe:/a:delta_electronics:cncsoft_mlceditor:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0 );
