...
# $Id: gb_owncloud_mult_xss_vuln02_may14.nasl 11867 2018-10-12 10:48:11Z cfischer $
#
...
if (description)
{
  ...
  script_name("ownCloud Multiple Cross Site Scripting Vulnerabilities -02 May14");
...
before version 5.0.7");
  script_tag(name:"solution", value:"Upgrade to ownCloud version 4.0.16 or 4.5.12 or 5.0.7 or later.");
...
if(version_is_less(version:ownVer, test_version:"4.0.16")||
   version_in_range(version:ownVer, test_version:"4.5.0", test_version2:"4.5.11")||
