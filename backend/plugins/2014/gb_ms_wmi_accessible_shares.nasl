...
# $Id: gb_ms_wmi_accessible_shares.nasl 9055 2018-03-08 12:53:10Z cfischer $
#
...
if(description)
{
  ...
  script_version("$Revision: 9055 $");
  script_tag(name:"last_modification", value:"$Date: 2018-03-08 13:53:10 +0100 (Thu, 08 Mar 2018) $");
