...
# $Id: gb_ubuntu_USN_2269_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for linux-lts-quantal USN-2269-1
#
# Authors:
...
privileges.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2269-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-52-generic", ver:"3.5.0-52.79~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
