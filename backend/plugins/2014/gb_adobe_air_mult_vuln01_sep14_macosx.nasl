...
# $Id: gb_adobe_air_mult_vuln01_sep14_macosx.nasl 11867 2018-10-12 10:48:11Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.804844");
  ...
  script_tag(name:"creation_date", value:"2014-09-12 11:55:41 +0530 (Fri, 12 Sep 2014)");

  script_name("Adobe AIR Multiple Vulnerabilities-01 Sep14 (Mac OS X)");
