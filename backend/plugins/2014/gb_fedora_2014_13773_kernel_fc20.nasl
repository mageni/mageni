...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868434");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-10-29 05:49:57 +0100 (Wed, 29 Oct 2014)");
  script_cve_id("CVE-2014-3610", "CVE-2014-3611", "CVE-2014-3646", "CVE-2014-8369",
                "CVE-2014-3688", "CVE-2014-3687", "CVE-2014-3673", "CVE-2014-3690",
  ...
  script_name("Fedora Update for kernel FEDORA-2014-13773");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141478.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.16.6~203.fc20", rls:"FC20")) != NULL)
  {
