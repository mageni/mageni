...
# $Id: alas-2014-405.nasl 6724 2017-07-14 09:57:17Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-405");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"libxcb-debuginfo", rpm:"libxcb-debuginfo~1.8.1~1.15.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libxcb-devel", rpm:"libxcb-devel~1.8.1~1.15.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libxcb-python", rpm:"libxcb-python~1.8.1~1.15.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"libxcb-doc", rpm:"libxcb-doc~1.8.1~1.15.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
