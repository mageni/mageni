...
# $Id: gb_ubuntu_USN_2357_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-09-24 06:03:14 +0200 (Wed, 24 Sep 2014)");
  ...
  script_name("Ubuntu Update for linux-ti-omap4 USN-2357-1");
...
process). (CVE-2014-5472)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2357-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.2.0-1453-omap4", ver:"3.2.0-1453.73", rls:"UBUNTU12.04 LTS")) != NULL)
  {
