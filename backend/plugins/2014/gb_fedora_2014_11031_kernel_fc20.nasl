...
if(description)
{
  ...
  script_cve_id("CVE-2014-3186", "CVE-2014-3181", "CVE-2014-3631", "CVE-2014-5077",
                ...
                "CVE-2013-6376", "CVE-2013-6368", "CVE-2013-6367", "CVE-2014-6410");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Fedora Update for kernel FEDORA-2014-11031");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.16.2~201.fc20", rls:"FC20")) != NULL)
  {
