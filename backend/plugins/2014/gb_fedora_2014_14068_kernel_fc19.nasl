...
#
# Fedora Update for kernel FEDORA-2014-14068
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868489");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-11-17 07:11:47 +0100 (Mon, 17 Nov 2014)");
  ...
  script_name("Fedora Update for kernel FEDORA-2014-14068");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144040.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.14.23~100.fc19", rls:"FC19")) != NULL)
  {
