...
# $Id: gb_ubuntu_USN_2241_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-06-09 14:37:24 +0530 (Mon, 09 Jun 2014)");
  script_cve_id("CVE-2014-3153", "CVE-2014-0155", "CVE-2014-2568", "CVE-2014-3122");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux USN-2241-1");
...
denial of service (system crash). (CVE-2014-3122)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2241-1/");
...
if(release == "UBUNTU13.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.11.0-23-generic", ver:"3.11.0-23.40", rls:"UBUNTU13.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.11.0-23-generic-lpae", ver:"3.11.0-23.40", rls:"UBUNTU13.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
