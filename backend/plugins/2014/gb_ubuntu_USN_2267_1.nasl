...
# $Id: gb_ubuntu_USN_2267_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for linux-ec2 USN-2267-1
#
# Authors:
...
privileges.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2267-1/");
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-2.6.32-366-ec2", ver:"2.6.32-366.81", rls:"UBUNTU10.04 LTS")) != NULL)
  {
