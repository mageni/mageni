...
# $Id: gb_wordpress_contact_form_plugin_xss_vuln.nasl 11402 2018-09-15 09:13:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with WordPress Contact Form Plugin and is prone to
cross-site scripting vulnerability.");
  script_tag(name:"vuldetect", value:"Send a crafted data via HTTP GET request and check whether it is able to read
cookie or not.");
  script_tag(name:"insight", value:"Input passed via the 'width' parameter to the xd_resize.php script is not
...
browser and the server.");
  script_tag(name:"affected", value:"WordPress Contact Form Plugin version 2.3 and prior.");
