...
if(description)
{
  ...
  script_name("Fedora Update for ReviewBoard FEDORA-2014-8771");
  script_tag(name:"affected", value:"ReviewBoard on Fedora 19");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137812.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"ReviewBoard", rpm:"ReviewBoard~1.7.27~1.fc19", rls:"FC19")) != NULL)
  {
