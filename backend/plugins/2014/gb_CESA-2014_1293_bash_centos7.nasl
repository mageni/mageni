...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882030");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-09-25 05:58:37 +0200 (Thu, 25 Sep 2014)");
  script_cve_id("CVE-2014-6271");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("CentOS Update for bash CESA-2014:1293 centos7");
  script_tag(name:"insight", value:"The GNU Bourne Again shell (Bash) is a shell
...
contain a backported patch to correct this issue.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2014-September/020583.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"bash", rpm:"bash~4.2.45~5.el7_0.2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"bash-doc", rpm:"bash-doc~4.2.45~5.el7_0.2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
