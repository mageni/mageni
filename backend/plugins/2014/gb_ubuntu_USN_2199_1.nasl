...
# $Id: gb_ubuntu_USN_2199_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-05-12 09:13:08 +0530 (Mon, 12 May 2014)");
  script_cve_id("CVE-2014-0196");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-lts-quantal USN-2199-1");
...
service (system crash) or potentially gain administrator privileges.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2199-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-49-generic", ver:"3.5.0-49.74~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
