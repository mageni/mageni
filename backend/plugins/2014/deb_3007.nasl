...
# $Id: deb_3007.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
We recommend that you upgrade your cacti packages.");
  script_tag(name:"summary", value:"Multiple security issues (cross-site scripting, missing input sanitising
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
