...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867621");
  ...
  script_tag(name:"affected", value:"perltidy on Fedora 20");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"perltidy", rpm:"perltidy~20130922~1.fc20", rls:"FC20")) != NULL)
  {
