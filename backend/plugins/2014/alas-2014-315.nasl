...
# $Id: alas-2014-315.nasl 6769 2017-07-20 09:56:33Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-315");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"yum-cron-security", rpm:"yum-cron-security~3.4.3~137.49.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"yum-cron-hourly", rpm:"yum-cron-hourly~3.4.3~137.49.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"yum", rpm:"yum~3.4.3~137.49.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"yum-cron", rpm:"yum-cron~3.4.3~137.49.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"yum-cron-daily", rpm:"yum-cron-daily~3.4.3~137.49.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"yum", rpm:"yum~3.4.3~137.49.amzn1", rls:"AMAZON")) != NULL) {
