...
# $Id: gb_ubuntu_USN_2369_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for file USN-2369-1
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for file USN-2369-1");
...
in a denial of service.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2369-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"file", ver:"1:5.14-2ubuntu3.2", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"file", ver:"5.09-2ubuntu0.5", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"file", ver:"5.03-5ubuntu1.4", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
