...
# $Id: deb_2897.nasl 14277 2019-03-18 14:45:38Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libservlet3.0-java", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libservlet3.0-java-doc", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtomcat7-java", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-admin", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-common", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-docs", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-examples", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-user", ver:"7.0.28-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
