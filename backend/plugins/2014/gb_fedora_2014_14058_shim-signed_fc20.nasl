...
if(description)
{
  ...
  script_name("Fedora Update for shim-signed FEDORA-2014-14058");
  script_tag(name:"summary", value:"Check the version of shim-signed");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"shim-signed on Fedora 20");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"shim-signed", rpm:"shim-signed~0.8~3", rls:"FC20")) != NULL)
  {
