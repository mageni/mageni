...
# $Id: deb_2997.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"reportbug on Debian Linux");
...
We recommend that you upgrade your reportbug packages.");
  script_tag(name:"summary", value:"Jakub Wilk discovered a remote command execution flaw in reportbug, a
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-reportbug", ver:"6.4.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"reportbug", ver:"6.4.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
