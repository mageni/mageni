...
# $Id: gb_ubuntu_USN_2336_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for linux-lts-trusty USN-2336-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-09-03 05:55:32 +0200 (Wed, 03 Sep 2014)");
  ...
  script_name("Ubuntu Update for linux-lts-trusty USN-2336-1");
...
(kvm) validation of interrupt requests (irq). A guest OS user could exploit
this flaw to cause a denial of service (host OS crash). (CVE-2014-0155)
...
An integer overflow flaw was  ...

  Description truncated, please see the referenced URL(s) for more information.");
  script_tag(name:"solution", value:"Please Install the Updated Packages.");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2336-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-35-generic", ver:"3.13.0-35.62~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-35-generic-lpae", ver:"3.13.0-35.62~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
