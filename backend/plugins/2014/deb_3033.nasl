...
# $Id: deb_3033.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libnss3", ver:"2:3.14.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-1d", ver:"2:3.14.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-dbg", ver:"2:3.14.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-dev", ver:"2:3.14.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-tools", ver:"2:3.14.5-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
