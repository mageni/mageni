...
# $Id: deb_3013.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"s3ql on Debian Linux");
  script_tag(name:"solution", value:"For the stable distribution (wheezy), this problem has been fixed in
version 1.11.1-3+deb7u1.

We recommend that you upgrade your s3ql packages.");
  script_tag(name:"summary", value:"Nikolaus Rath discovered that s3ql, a file system for online data
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"s3ql", ver:"1.11.1-3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"s3ql-dbg", ver:"1.11.1-3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
