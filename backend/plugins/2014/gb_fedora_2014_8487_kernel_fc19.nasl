...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868019");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-07-28 16:14:20 +0530 (Mon, 28 Jul 2014)");
  script_cve_id("CVE-2014-4943", "CVE-2014-4715", "CVE-2014-4699", "CVE-2014-0206",
                ...
                "CVE-2013-2234", "CVE-2014-4667", "CVE-2014-4608", "CVE-2014-4611");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Fedora Update for kernel FEDORA-2014-8487");
  script_tag(name:"affected", value:"kernel on Fedora 19");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135779.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.14.13~100.fc19", rls:"FC19")) != NULL)
  {
