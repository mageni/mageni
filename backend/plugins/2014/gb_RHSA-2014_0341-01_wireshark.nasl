...
#
# RedHat Update for wireshark RHSA-2014:0341-01
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871151");
  ...
  script_name("RedHat Update for wireshark RHSA-2014:0341-01");
...
of Wireshark must be restarted for the update to take effect.");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2014-March/msg00038.html");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~1.0.15~6.el5_10", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wireshark-debuginfo", rpm:"wireshark-debuginfo~1.0.15~6.el5_10", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"wireshark-gnome", rpm:"wireshark-gnome~1.0.15~6.el5_10", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
