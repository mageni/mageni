...
if(description)
{
  ...
  script_cve_id("CVE-2014-9296", "CVE-2014-9294", "CVE-2014-9295", "CVE-2014-9293");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"ntp-perl", rpm:"ntp-perl~4.2.6p5~2.22.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"ntp-debuginfo", rpm:"ntp-debuginfo~4.2.6p5~2.22.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.6p5~2.22.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.6p5~2.22.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
