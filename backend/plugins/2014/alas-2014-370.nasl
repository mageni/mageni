...
# $Id: alas-2014-370.nasl 6769 2017-07-20 09:56:33Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-370");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"chkrootkit-debuginfo", rpm:"chkrootkit-debuginfo~0.49~9.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"chkrootkit", rpm:"chkrootkit~0.49~9.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
