...
#
# Fedora Update for kernel FEDORA-2014-9959
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868149");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-08-31 05:52:28 +0200 (Sun, 31 Aug 2014)");
  script_cve_id("CVE-2014-5471", "CVE-2014-5472", "CVE-2014-5077", "CVE-2014-4171",
  ...
  script_name("Fedora Update for kernel FEDORA-2014-9959");
  script_tag(name:"affected", value:"kernel on Fedora 20");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-August/137179.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.15.10~201.fc20", rls:"FC20")) != NULL)
  {
