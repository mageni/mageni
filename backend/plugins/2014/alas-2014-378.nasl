...
# $Id: alas-2014-378.nasl 6663 2017-07-11 09:58:05Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-378");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"gnupg", rpm:"gnupg~1.4.18~1.25.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"gnupg-debuginfo", rpm:"gnupg-debuginfo~1.4.18~1.25.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
