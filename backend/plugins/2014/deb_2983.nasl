...
# $Id: deb_2983.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
We recommend that you upgrade your drupal7 packages.");
  script_tag(name:"summary", value:"Multiple security issues have been discovered in the Drupal content
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"drupal7", ver:"7.14-2+deb7u5", rls:"DEB7")) != NULL) {
  report += res;
}
