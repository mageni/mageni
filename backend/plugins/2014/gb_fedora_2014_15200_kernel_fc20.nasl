...
#
# Fedora Update for kernel FEDORA-2014-15200
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868501");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-11-21 06:38:04 +0100 (Fri, 21 Nov 2014)");
  script_cve_id("CVE-2014-7843", "CVE-2014-7842", "CVE-2014-7841", "CVE-2014-7826",
  ...
  script_name("Fedora Update for kernel FEDORA-2014-15200");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144691.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.17.3~200.fc20", rls:"FC20")) != NULL)
  {
