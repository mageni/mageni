...
# $Id: gb_google_chrome_mult_vuln01_aug14_lin.nasl 11867 2018-10-12 10:48:11Z cfischer $
#
...
execute arbitrary code or possibly have other impact via unknown vectors.");
  script_tag(name:"affected", value:"Google Chrome version prior to 36.0.1985.143 on Linux.");
