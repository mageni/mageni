...
# $Id: gb_panda_products_bof_vuln.nasl 14117 2019-03-12 14:02:42Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Panda Antivirus
...
if(version_is_equal(version:version, test_version:"13.01.01"))
{
