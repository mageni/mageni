...
# $Id: gb_antiweb_detect.nasl 10922 2018-08-10 19:21:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Anti-Web Server Detection");
...
log_message(data: build_detection_report(app: "Anti-Web", version: version, install: "/", cpe: cpe,
                                         concluded: vers[0]),
            port: port);
