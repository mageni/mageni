...
# $Id: gb_zimbra_zcs_xss_vuln_mar18.nasl 9261 2018-03-29 11:26:07Z asteins $
#
# Zimbra ZCS < 8.7 Patch 1 XSS Vulnerability
#
# Authors:
...
if( description )
{
  ...
  script_version("$Revision: 9261 $");
  script_tag(name:"last_modification", value:"$Date: 2018-03-29 13:26:07 +0200 (Thu, 29 Mar 2018) $");
  ...
  script_cve_id("CVE-2017-6882");

  script_name("Zimbra ZCS < 8.7 Patch 1 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"XSS Vulnerability in Zimbra Collaboration Suite (ZCS) before 8.7 Patch 1 and 8.8.x before 8.8.7.");
  ...
  script_tag(name:"affected", value:"ZCS before 8.7 Patch 1 and 8.8.x before 8.8.7.");
  script_tag(name:"solution", value:"Update to ZCS 8.7 Patch 1 or 8.8.7.");
...
if( version_is_less_equal( version: version, test_version: "8.7" ) ) {
  vuln = TRUE;
  fix = "8.7 Patch 1";
}
