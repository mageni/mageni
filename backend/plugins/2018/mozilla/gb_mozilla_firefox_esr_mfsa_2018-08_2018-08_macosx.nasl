...
# $Id: gb_mozilla_firefox_esr_mfsa_2018-08_2018-08_macosx.nasl 12068 2018-10-25 07:21:15Z mmartin $
#
# Mozilla Firefox ESR Security Updates(mfsa_2018-08_2018-08)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813048");
  ...
  script_tag(name:"creation_date", value:"2018-03-22 11:02:28 +0530 (Thu, 22 Mar 2018)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2018-08_2018-08)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 52.7.2 on MAC OS X.");
