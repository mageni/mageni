...
# Id$
#
# Mozilla Firefox Security Updates(mfsa_2018-24_2018-24)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814062");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-12386", "CVE-2018-12387");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-10-03 17:02:23 +0530 (Wed, 03 Oct 2018)");
  script_name("Mozilla Firefox Security Updates(mfsa_2018-24_2018-24)-MAC OS X");
...
if(version_is_less(version:ffVer, test_version:"62.0.3"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"62.0.3", install_path:ffPath);
