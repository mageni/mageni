...
# $Id: deb_dla_1039.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1039-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1039-1] rkhunter security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2017/07/msg00032.html");
  ...
  script_tag(name:"affected", value:"rkhunter on Debian Linux");
  script_tag(name:"solution", value:"For Debian 7 'Wheezy', these problems have been fixed in version
1.4.0-1+deb7u1.

We recommend that you upgrade your rkhunter packages.");
  script_tag(name:"summary", value:"CVE-2017-7480
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"rkhunter", ver:"1.4.0-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
