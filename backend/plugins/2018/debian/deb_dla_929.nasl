...
# $Id: deb_dla_929.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 929-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 929-1] libpodofo security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libpodofo-dev", ver:"0.9.0-1.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpodofo-utils", ver:"0.9.0-1.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpodofo0.9.0", ver:"0.9.0-1.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
