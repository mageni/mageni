...
# $Id: deb_dla_1011.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"sudo", ver:"1.8.5p2-1+nmu3+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"sudo-ldap", ver:"1.8.5p2-1+nmu3+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
