...
# $Id: deb_dla_1419.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1419-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1419-1] ruby-sprockets security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"ruby-sprockets", ver:"2.12.3-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
