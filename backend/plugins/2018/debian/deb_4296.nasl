...
# $Id: deb_4296.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libmbedcrypto0", ver:"2.4.2-1+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmbedtls-dev", ver:"2.4.2-1+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmbedtls-doc", ver:"2.4.2-1+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmbedtls10", ver:"2.4.2-1+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmbedx509-0", ver:"2.4.2-1+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
