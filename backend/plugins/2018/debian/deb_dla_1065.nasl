...
# $Id: deb_dla_1065.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1065-1] fontforge security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"fontforge", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"fontforge-dbg", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"fontforge-nox", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfontforge-dev", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfontforge1", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgdraw4", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-fontforge", ver:"0.0.20120101+git-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
