...
# $Id: deb_dla_1459.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1459-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA-1459-1] cgit security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"cgit", ver:"0.10.2.git2.0.1-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
