...
# $Id: deb_4207.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"gir1.2-packagekitglib-1.0", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gstreamer1.0-packagekit", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpackagekit-glib2-18", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpackagekit-glib2-dev", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"packagekit", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"packagekit-command-not-found", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"packagekit-docs", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"packagekit-gtk3-module", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"packagekit-tools", ver:"1.1.5-2+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
