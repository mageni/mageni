...
# $Id: deb_dla_1302.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1302-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1302-1] leptonlib security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"leptonica-progs", ver:"1.69-3.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"liblept3", ver:"1.69-3.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libleptonica-dev", ver:"1.69-3.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
