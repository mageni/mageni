...
# $Id: deb_dla_998.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libc-ares-dev", ver:"1.9.1-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libc-ares2", ver:"1.9.1-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
