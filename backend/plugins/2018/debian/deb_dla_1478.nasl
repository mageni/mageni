...
# $Id: deb_dla_1478.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1478-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA-1478-1] libextractor security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"extract", ver:"1:1.3-2+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libextractor-dbg", ver:"1:1.3-2+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libextractor-dev", ver:"1:1.3-2+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libextractor3", ver:"1:1.3-2+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
