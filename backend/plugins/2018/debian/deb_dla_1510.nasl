...
# $Id: deb_dla_1510.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"glusterfs-client", ver:"3.5.2-2+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"glusterfs-common", ver:"3.5.2-2+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"glusterfs-dbg", ver:"3.5.2-2+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"glusterfs-server", ver:"3.5.2-2+deb8u4", rls:"DEB8")) != NULL) {
  report += res;
}
