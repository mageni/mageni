...
# $Id: deb_dla_1125.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1125-1] botan1.10 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"botan1.10-dbg", ver:"1.10.5-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libbotan-1.10-0", ver:"1.10.5-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libbotan1.10-dev", ver:"1.10.5-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
