...
# $Id: deb_dla_838.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 838-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 838-1] shadow security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"login", ver:"4.1.5.1-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"passwd", ver:"4.1.5.1-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
