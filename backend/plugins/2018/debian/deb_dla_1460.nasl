...
# $Id: deb_dla_1460.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1460-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA-1460-1] libmspack security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libmspack-dbg", ver:"0.5-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmspack-dev", ver:"0.5-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmspack-doc", ver:"0.5-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmspack0", ver:"0.5-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
