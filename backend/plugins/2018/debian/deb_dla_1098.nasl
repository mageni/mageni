...
# $Id: deb_dla_1098.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1098-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1098-1] freexl security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libfreexl-dev", ver:"1.0.0b-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfreexl1", ver:"1.0.0b-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfreexl1-dbg", ver:"1.0.0b-1+deb7u4", rls:"DEB7")) != NULL) {
  report += res;
}
