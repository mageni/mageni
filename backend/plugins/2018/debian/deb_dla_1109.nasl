...
# $Id: deb_dla_1109.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libraw-bin", ver:"0.14.6-2+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libraw-dev", ver:"0.14.6-2+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libraw-doc", ver:"0.14.6-2+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libraw5", ver:"0.14.6-2+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
