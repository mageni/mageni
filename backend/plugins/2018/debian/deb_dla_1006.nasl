...
# $Id: deb_dla_1006.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"bsdcpio", ver:"3.0.4-3+wheezy6", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"bsdtar", ver:"3.0.4-3+wheezy6", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libarchive-dev", ver:"3.0.4-3+wheezy6", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libarchive12", ver:"3.0.4-3+wheezy6", rls:"DEB7")) != NULL) {
  report += res;
}
