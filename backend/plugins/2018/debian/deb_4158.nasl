...
# $Id: deb_4158.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libssl1.0-dev", ver:"1.0.2l-2+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libssl1.0.2", ver:"1.0.2l-2+deb9u3", rls:"DEB9")) != NULL) {
  report += res;
}
