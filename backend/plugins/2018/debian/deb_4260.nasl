...
# $Id: deb_4260.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libmspack-dbg", ver:"0.5-1+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmspack-dev", ver:"0.5-1+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmspack-doc", ver:"0.5-1+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmspack0", ver:"0.5-1+deb9u2", rls:"DEB9")) != NULL) {
  report += res;
}
