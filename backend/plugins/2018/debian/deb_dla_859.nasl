...
# $Id: deb_dla_859.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 859-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 859-1] calibre security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"calibre", ver:"0.8.51+dfsg1-0.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"calibre-bin", ver:"0.8.51+dfsg1-0.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
