...
# $Id: deb_dla_1036.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1036-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1036-1] gsoap security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"gsoap", ver:"2.8.7-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gsoap-dbg", ver:"2.8.7-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gsoap-doc", ver:"2.8.7-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libgsoap2", ver:"2.8.7-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
