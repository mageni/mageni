...
# $Id: deb_4175.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"freeplane", ver:"1.3.12-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjortho-freeplane-java", ver:"1.3.12-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"freeplane", ver:"1.5.18-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"freeplane-scripting-api", ver:"1.5.18-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
