...
# $Id: deb_dla_963.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"exiv2", ver:"0.23-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libexiv2-12", ver:"0.23-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libexiv2-dbg", ver:"0.23-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libexiv2-dev", ver:"0.23-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libexiv2-doc", ver:"0.23-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
