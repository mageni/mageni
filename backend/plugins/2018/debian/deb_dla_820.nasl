...
# $Id: deb_dla_820.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 820-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 820-1] viewvc security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"viewvc", ver:"1.1.5-1.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"viewvc-query", ver:"1.1.5-1.4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
