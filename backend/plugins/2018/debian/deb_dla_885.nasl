...
# $Id: deb_dla_885.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-django", ver:"1.4.22-1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-django-doc", ver:"1.4.22-1+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
