...
# $Id: deb_dla_1241.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libkohana2-modules-php", ver:"2.3.4-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libkohana2-php", ver:"2.3.4-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
