...
# $Id: deb_dla_876.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 876-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 876-1] eject security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"eject", ver:"2.1.5+deb1+cvs20081104-13+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
