...
# $Id: deb_dla_886.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"tzdata", ver:"2017b-0+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tzdata-java", ver:"2017b-0+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
