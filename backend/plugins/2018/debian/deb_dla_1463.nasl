...
# $Id: deb_dla_1463.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1463-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1463-1] sam2p security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"sam2p", ver:"0.49.2-3+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
