...
# $Id: deb_dla_873.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 873-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 873-1] apt-cacher security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"apt-cacher", ver:"1.7.6+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
