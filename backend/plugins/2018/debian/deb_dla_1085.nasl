...
# $Id: deb_dla_1085.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1085-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1085-1] libidn2-0 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"idn2", ver:"0.8-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0", ver:"0.8-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dbg", ver:"0.8-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libidn2-0-dev", ver:"0.8-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
