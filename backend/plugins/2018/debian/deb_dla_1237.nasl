...
# $Id: deb_dla_1237.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1237-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1237-1] plexus-utils2 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libplexus-utils2-java", ver:"2.0.5-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libplexus-utils2-java-doc", ver:"2.0.5-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
