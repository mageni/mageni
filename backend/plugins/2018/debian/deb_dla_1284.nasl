...
# $Id: deb_dla_1284.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"leptonica-progs", ver:"1.69-3.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"liblept3", ver:"1.69-3.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libleptonica-dev", ver:"1.69-3.1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
