...
# $Id: deb_dla_935.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 935-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 935-1] lxterminal security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"lxterminal", ver:"0.1.11-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"lxterminal-dbg", ver:"0.1.11-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
