...
# $Id: deb_dla_1602.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"nsis", ver:"2.46-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"nsis-common", ver:"2.46-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"nsis-doc", ver:"2.46-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"nsis-pluginapi", ver:"2.46-10+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
