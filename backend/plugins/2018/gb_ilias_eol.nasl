...
# $Id: gb_ilias_eol.nasl 9082 2018-03-12 09:20:49Z cfischer $
#
...
if(description)
{
  ...
  tag_summary = "The ILIAS version on the remote host has reached the end of life and should
  not be used anymore.";

  tag_impact = "An end of life version of ILIAS is not receiving any security updates from the vendor. Unfixed security vulnerabilities
  might be leveraged by an attacker to compromise the security of this host.";

  tag_solution = "Update the ILIAS version on the remote host to a still supported version.";
