...
if(description)
{
  ...
  script_cve_id("CVE-2017-5715","CVE-2018-1064","CVE-2018-3639");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2082-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-July/004324.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libvirt'
  package(s) announced via the SUSE-SU-2018:2082-1 advisory.");
