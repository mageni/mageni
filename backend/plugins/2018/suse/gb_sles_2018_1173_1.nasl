...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.1173.1");
  script_cve_id("CVE-2017-18257","CVE-2018-10087","CVE-2018-10124");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1173-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-May/003979.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2018:1173-1 advisory.");
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-default-man", rpm:"kernel-default-man~4.4.121~92.73.1", rls:"SLES12.0SP2"))){
    report += res;
  }
