...
if(description)
{
  ...
  script_cve_id("CVE-2017-13884","CVE-2017-13885","CVE-2017-7153");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3387-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004781.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2018:3387-1 advisory.");
