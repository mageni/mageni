...
if(description)
{
  ...
  script_cve_id("CVE-2017-18344","CVE-2018-14734","CVE-2018-3620");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2374-1)");
  ...
  package(s) announced via the SUSE-SU-2018:2374-1 advisory.");
