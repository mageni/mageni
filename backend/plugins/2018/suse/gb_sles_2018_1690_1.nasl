...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1690-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004188.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_8_0-openjdk'
  package(s) announced via the SUSE-SU-2018:1690-1 advisory.");
