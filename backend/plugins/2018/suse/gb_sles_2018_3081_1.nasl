...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3081-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004657.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libxml2'
  package(s) announced via the SUSE-SU-2018:3081-1 advisory.");
