...
if(description)
{
  ...
  script_cve_id("CVE-2017-18248","CVE-2018-4180","CVE-2018-4181");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2162-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004364.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'cups'
  package(s) announced via the SUSE-SU-2018:2162-1 advisory.");
