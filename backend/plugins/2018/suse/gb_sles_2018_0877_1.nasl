...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0877-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-April/003873.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'spice-gtk'
  package(s) announced via the SUSE-SU-2018:0877-1 advisory.");
