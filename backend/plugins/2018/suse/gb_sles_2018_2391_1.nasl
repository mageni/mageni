...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2391-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004459.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel  (Live Patch 19 for SLE 12 SP2)'
  package(s) announced via the SUSE-SU-2018:2391-1 advisory.");
