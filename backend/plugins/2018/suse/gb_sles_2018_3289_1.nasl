...
if(description)
{
  ...
  script_cve_id("CVE-2017-11613","CVE-2017-9935","CVE-2018-16335");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3289-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004759.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tiff'
  package(s) announced via the SUSE-SU-2018:3289-1 advisory.");
