...
if(description)
{
  ...
  script_cve_id("CVE-2016-4692","CVE-2016-4743","CVE-2016-7586");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0219-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003633.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2018:0219-1 advisory.");
