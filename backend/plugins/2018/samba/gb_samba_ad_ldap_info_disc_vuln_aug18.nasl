...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exists due to a missing access control
  checks.");
  ...
  script_tag(name:"solution", value:"Upgrade to Samba 4.8.4 or 4.7.9 or 4.6.16
...
if(version_in_range(version:vers, test_version:"4.0.0", test_version2:"4.6.15")){
  fix = "4.6.16";
}
