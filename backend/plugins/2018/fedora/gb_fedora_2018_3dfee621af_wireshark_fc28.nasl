...
# $Id: gb_fedora_2018_3dfee621af_wireshark_fc28.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
on the target host.");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IZPDRUOAYITN6VBAAICJJ4KSGAKGGCHH");
...
if(release == "FC28")
{
  ...
  if ((res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~2.6.1~1.fc28", rls:"FC28")) != NULL)
  {
