...
# $Id: gb_suse_2018_2479_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-08/msg00071.html");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"d-nbd-debuginfo", rpm:"d-nbd-debuginfo~12.2.5+git.1524775272.5e7ea8cf03~9.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
