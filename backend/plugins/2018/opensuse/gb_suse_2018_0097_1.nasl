...
# $Id: gb_suse_2018_0097_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This update for tiff to version 4.0.9 fixes the following issues:
