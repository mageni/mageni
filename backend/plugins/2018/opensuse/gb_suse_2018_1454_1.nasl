...
# $Id: gb_suse_2018_1454_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
on the target host.");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-05/msg00111.html");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"enigmail", rpm:"enigmail~2.0.6~18.1", rls:"openSUSELeap42.3")) != NULL)
  {
