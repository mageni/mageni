...
# $Id: gb_suse_2018_3701_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
# SuSE Update for opensc openSUSE-SU-2018:3701-1 (opensc)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for opensc openSUSE-SU-2018:3701-1 (opensc)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-11/msg00010.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc'
  package(s) announced via the openSUSE-SU-2018:3701_1 advisory.");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.13.0~9.3.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"opensc-debuginfo", rpm:"opensc-debuginfo~0.13.0~9.3.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"opensc-debugsource", rpm:"opensc-debugsource~0.13.0~9.3.1", rls:"openSUSELeap42.3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
