...
# $Id: gb_drupal_core_mult_vuln_SA-CORE-2018-006_win.nasl 12041 2018-10-23 13:56:19Z cfischer $
#
# Drupal Core Multiple Security Vulnerabilities (SA-CORE-2018-006) (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Drupal core versions 7.x before 7.60, 8.5.x before 8.5.8 and 8.6.x before 8.6.2 on Windows.");
