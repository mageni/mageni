...
if(description)
{
  ...
  5.6.x through 5.6.41, 5.7.x through 5.7.23 and 8.0.x through 8.0.12 on Linux");
...
if(version_in_range(version:mysqlVer, test_version:"5.5", test_version2:"5.5.61")||
   version_in_range(version:mysqlVer, test_version:"5.6", test_version2:"5.6.41")||
