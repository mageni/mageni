...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813680");
  ...
  script_name("Oracle Java SE Security Updates-01 (jul2018-4258247) Windows");
  ...
  earlier, 1.7.0.181 and earlier, 1.6.0.191 and earlier on Windows");
