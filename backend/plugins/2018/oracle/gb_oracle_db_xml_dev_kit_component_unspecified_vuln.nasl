...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813002");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2011-2232");
  script_tag(name:"cvss_base", value:"6.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-03-07 15:14:30 +0530 (Wed, 07 Mar 2018)");
  script_name("Oracle Database Server XML Developer Kit Component Unspecified Vulnerability");
  ...
  component 'XML Developer Kit'.");

  script_tag(name:"impact", value:"Successfully exploitation will allow remote
  attackers to affect confidentiality and integrity via unknown vectors.");

  script_tag(name:"affected", value:"Oracle Database Server version 10.1.0.5, 10.2.0.3,
  10.2.0.4, 11.1.0.7, and 11.2.0.1");
...
affected = make_list('10.1.0.5', '10.2.0.3', '10.2.0.4', '11.1.0.7', '11.2.0.1');
