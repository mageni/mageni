...
# $Id: gb_jenkins_20171214_1_win.nasl 12761 2018-12-11 14:32:20Z cfischer $
#
# Jenkins Random Startup Failure Vulnerability (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112195");
  ...
  script_name("Jenkins Random Startup Failure Vulnerability (Windows)");
