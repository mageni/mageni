...
# $Id: gb_adobe_flash_player_eol_lin.nasl 11624 2018-09-26 12:00:34Z santu $
#
# Adobe Flash Player End Of Life Detection (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("Adobe Flash Player End Of Life Detection (Linux)");
