...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813855");
  ...
  script_name("Adobe Acrobat Reader DC (Continuous Track) Multiple Arbitrary Code Execution Vulnerabilities-apsb18-29 (Mac OS X)");

  script_tag(name:"summary", value:"This host is installed with Adobe Acrobat Reader
  DC (Continuous Track) and is prone to multiple arbitrary code execution vulnerabilities.");
  ...
  2018.011.20055 and earlier versions on Mac OS X.");
