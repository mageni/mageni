...
# $Id: gb_moodle_mult_vuln_jul18_01_win.nasl 12120 2018-10-26 11:13:20Z mmartin $
#
...
if( description )
{
  script_oid("1.3.6.1.4.1.25623.1.0.113229");
  ...
  script_name("Moodle CMS <= 3.1.12, 3.2.x, 3.3.x <= 3.3.6, 3.4.x <= 3.4.3, 3.5.0 Multiple Vulnerabilities (Windows)");
