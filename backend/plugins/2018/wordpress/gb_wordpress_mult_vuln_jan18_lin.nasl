...
# $Id: gb_wordpress_mult_vuln_jan18_lin.nasl 12116 2018-10-26 10:01:35Z mmartin $
#
# WordPress Multiple Vulnerabilities-Jan 2018 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812508");
  script_version("$Revision: 12116 $");
  script_cve_id("CVE-2018-5776");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"$Date: 2018-10-26 12:01:35 +0200 (Fri, 26 Oct 2018) $");
  script_tag(name:"creation_date", value:"2018-01-22 14:20:20 +0530 (Mon, 22 Jan 2018)");
  script_name("WordPress Multiple Vulnerabilities-Jan 2018 (Linux)");
  ...
  script_tag(name:"affected", value:"WordPress versions prior to 4.9.2 on Linux");
