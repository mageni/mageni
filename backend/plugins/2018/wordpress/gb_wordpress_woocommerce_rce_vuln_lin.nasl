...
# $Id: gb_wordpress_woocommerce_rce_vuln_lin.nasl 13455 2019-02-05 07:38:02Z mmartin $
#
...
if (description)
{
  ...
  script_tag(name:"affected", value:"WooCommerce plugin for Wordpress prior to version 3.4.6 on Linux.");
