...
if(description)
{
  ...
  update according to Microsoft KB4461577");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4461577");
...
if(excelVer =~ "^14\." && version_is_less(version:excelVer, test_version:"14.0.7225.5000"))
{
  report = report_fixed_ver(file_checked:excelPath + "Excel.exe",
                            file_version:excelVer, vulnerable_range:"14.0 - 14.0.7225.4999");
