...
if(description)
{
  ...
  update according to Microsoft KB4022205");
...
if(version_in_range(version:outlookVer, test_version:"14.0", test_version2:"14.0.7210.4999"))
{
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"14.0 - 14.0.7210.4999");
