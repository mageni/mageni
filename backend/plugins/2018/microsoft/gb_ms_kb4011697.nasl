...
#
# Microsoft Outlook 2013 Service Pack 1 Multiple Vulnerabilities (KB4011697)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812903");
  ...
  script_tag(name:"creation_date", value:"2018-02-14 09:22:48 +0530 (Wed, 14 Feb 2018)");
  script_name("Microsoft Outlook 2013 Service Pack 1 Multiple Vulnerabilities (KB4011697)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4011697");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4011697");
...
if(version_is_less(version:outlookVer, test_version:"15.0.5007.1000"))
{
  report = report_fixed_ver(file_checked:outlookFile + "outlook.exe",
           file_version:outlookVer, vulnerable_range:"15.0 - 15.0.5007.0999");
