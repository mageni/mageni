...
if(description)
{
  ...
  update according to Microsoft KB4018399");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4018399");
...
if(excelVer =~ "^(15\.)" && version_is_less(version:excelVer, test_version:"15.0.5031.1000"))
{
  report = report_fixed_ver(file_checked:excelPath + "\Excel.exe",
                            file_version:excelVer, vulnerable_range:"15.0 - 15.0.5031.0999");
