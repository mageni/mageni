...
#
# Microsoft Yammer Desktop Remote Code Execution Vulnerability (Mac OS X)
#
# Authors:
...
if(description)
{
  ...
  script_name("Microsoft Yammer Desktop Remote Code Execution Vulnerability (Mac OS X");
