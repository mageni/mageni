...
if(description)
{
  ...
  4.7.1, and 4.7.2 for Windows 7 SP1 and Server 2008 R2 SP1

  Microsoft .NET Framework 4.6 for Server 2008 SP2");
...
foreach key(key_list)
{
  ...
  if(VULN)
  {
    report = report_fixed_ver(file_checked:dotPath + "system.web.extensions.dll",
                              file_version:sysdllVer, vulnerable_range:"4.6 - 4.7.3281");
