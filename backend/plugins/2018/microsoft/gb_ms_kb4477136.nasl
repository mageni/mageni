...
#
# MS Windows Latest Servicing Stack Updates-Defense in Depth (KB4477136)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814634");
  script_version("2019-05-03T08:55:39+0000");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-03 08:55:39 +0000 (Fri, 03 May 2019)");
  script_tag(name:"creation_date", value:"2018-12-20 14:48:24 +0530 (Thu, 20 Dec 2018)");
  script_name("MS Windows Latest Servicing Stack Updates-Defense in Depth (KB4477136)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4477136");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4477136");
...
if(max_version && version_in_range(version:max_version, test_version:"10.0.16299.0", test_version2:"10.0.16299.842"))
{
  report = report_fixed_ver(file_checked: path,
                            file_version:max_version, vulnerable_range:"10.0.16299.0 - 10.0.16299.842");
