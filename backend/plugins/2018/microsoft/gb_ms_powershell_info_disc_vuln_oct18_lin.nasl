...
#
# Microsoft PowerShell Core Information Disclosure Vulnerability Oct18 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814092");
  script_version("2019-05-03T08:55:39+0000");
  script_cve_id("CVE-2018-8292");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-05-03 08:55:39 +0000 (Fri, 03 May 2019)");
  script_tag(name:"creation_date", value:"2018-10-11 12:17:23 +0530 (Thu, 11 Oct 2018)");
  script_name("Microsoft PowerShell Core Information Disclosure Vulnerability Oct18 (Linux)");
