...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4461556");
...
if(version_in_range(version:outlookVer, test_version:"15.0", test_version2:"15.0.5093.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "\outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 15.0.5093.0999");
