...
# $Id: gb_ubuntu_USN_3579_2.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for libreoffice USN-3579-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-03-01 08:14:47 +0100 (Thu, 01 Mar 2018)");
  script_cve_id("CVE-2018-6871");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for libreoffice USN-3579-2");
...
information. (CVE-2018-6871)");
  ...
  script_xref(name:"URL", value:"https://usn.ubuntu.com/usn/usn-3579-2/");
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libreoffice-common", ver:"1:5.4.5-0ubuntu0.17.10.4", rls:"UBUNTU17.10")) != NULL)
  {
