...
# $Id: gb_ubuntu_USN_3677_2.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
# Ubuntu Update for linux-gcp USN-3677-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-06-12 05:55:36 +0200 (Tue, 12 Jun 2018)");
  script_cve_id("CVE-2018-1068", "CVE-2018-1092", "CVE-2018-7492", "CVE-2018-8087",
                "CVE-2018-8781");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-gcp USN-3677-2");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
on the target host.");
  script_tag(name:"insight", value:"USN-3677-1 fixed vulnerabilities in the Linux
kernel for Ubuntu 17.10. This update provides the corresponding updates for the
Linux Hardware Enablement (HWE) kernel from Ubuntu 17.10 for Ubuntu 16.04 LTS.
...
memory) or possibly execute arbitrary code. (CVE-2018-8781)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3677-2/");
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-4.13.0-1019-gcp", ver:"4.13.0-1019.23", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.13.0-1030-oem", ver:"4.13.0-1030.33", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.13.0-45-generic", ver:"4.13.0-45.50~16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.13.0-45-generic-lpae", ver:"4.13.0-45.50~16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-4.13.0-45-lowlatency", ver:"4.13.0-45.50~16.04.1", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-gcp", ver:"4.13.0.1019.21", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-gke", ver:"4.13.0.1019.21", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-oem", ver:"4.13.0.1030.35", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
