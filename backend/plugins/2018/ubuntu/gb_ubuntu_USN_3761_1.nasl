...
# $Id: gb_ubuntu_USN_3761_1.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
...
if(description)
{
  ...
  script_name("Ubuntu Update for firefox USN-3761-1");
...
attacker could potentially exploit these to cause a denial of service, or execute
...
sensitive information. (CVE-2018-12383)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3761-1/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"62.0+build2-0ubuntu0.14.04.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU18.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"62.0+build2-0ubuntu0.18.04.3", rls:"UBUNTU18.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"62.0+build2-0ubuntu0.16.04.3", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
