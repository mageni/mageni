...
#
# Burp Suite 'Collaborator server certificat' Security Bypass Vulnerability (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813809");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-10377");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-08-02 12:58:40 +0530 (Thu, 02 Aug 2018)");
  script_name("Burp Suite 'Collaborator server certificat' Security Bypass Vulnerability (Windows)");
  ...
  script_tag(name:"affected", value:"Burp Suite before 1.7.34 on Windows.");
