...
# $Id: gb_postgresql_sql_inj_vuln_oct18_lin.nasl 12858 2018-12-21 08:05:36Z ckuersteiner $
#
# PostgreSQL < 10.6, 11.x < 11.1 SQL Injection Vulnerability (Linux)
#
# Authors:
...
if( description )
{
  script_oid("1.3.6.1.4.1.25623.1.0.112429");
  ...
  script_name("PostgreSQL < 10.6, 11.x < 11.1 SQL Injection Vulnerability (Linux)");
