...
# $Id: gb_axdcms_45735.nasl 12018 2018-10-22 13:31:29Z mmartin $
#
...
if (description)
{
  ...
  script_tag(name:"summary", value:"Ax Developer CMS is prone to a local file-include vulnerability
...
foreach dir( make_list_unique( "/axdcms", "/cms", cgi_dirs( port:port ) ) ) {
