...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-April/017291.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880520");
  ...
  script_name("CentOS Update for postfix CESA-2011:0422 centos5 i386");
