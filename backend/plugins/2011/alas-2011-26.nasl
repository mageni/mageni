...
# $Id: alas-2011-26.nasl 11711 2018-10-01 12:30:57Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple flaws were found in Linux kernel. Please see the references for more information.");
