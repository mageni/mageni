...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-July/062658.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863352");
  ...
  script_name("Fedora Update for asterisk FEDORA-2011-8983");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.8.4.4~2.fc15", rls:"FC15")) != NULL)
  {
