...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-February/015633.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880784");
  ...
  script_name("CentOS Update for vnc CESA-2009:0261 centos4 i386");
  ...
  script_tag(name:"affected", value:"vnc on CentOS 4");
