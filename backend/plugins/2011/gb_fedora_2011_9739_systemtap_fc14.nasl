...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-July/063230.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863385");
  ...
  script_name("Fedora Update for systemtap FEDORA-2011-9739");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"systemtap", rpm:"systemtap~1.5~8.fc14", rls:"FC14")) != NULL)
  {
