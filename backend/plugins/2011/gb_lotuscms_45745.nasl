...
# $Id: gb_lotuscms_45745.nasl 12018 2018-10-22 13:31:29Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"LotusCMS is prone to a local file-include vulnerability because it
