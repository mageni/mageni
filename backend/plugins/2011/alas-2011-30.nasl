...
# $Id: alas-2011-30.nasl 11703 2018-10-01 08:05:31Z cfischer $
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2011-30");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"nginx-debuginfo", rpm:"nginx-debuginfo~0.8.54~1.4.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"nginx", rpm:"nginx~0.8.54~1.4.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
