...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-January/052796.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862768");
  ...
  script_name("Fedora Update for opensc FEDORA-2010-19192");
  ...
  script_tag(name:"affected", value:"opensc on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.11.13~6.fc14", rls:"FC14")) != NULL)
  {
