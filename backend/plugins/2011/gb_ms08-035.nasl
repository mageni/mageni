...
if(description)
{
  ...
  script_tag(name:"impact", value:"Successful exploitation will allow attacker to send specially crafted LDAP
  ...
  script_tag(name:"insight", value:"The issue is due to an input validation error in the processing of
