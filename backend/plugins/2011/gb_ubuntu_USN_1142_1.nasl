...
# $Id: gb_ubuntu_USN_1142_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1142-1/");
  ...
  script_name("Ubuntu Update for gdm USN-1142-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1142-1");
  script_tag(name:"affected", value:"gdm on Ubuntu 11.04");
...
if(release == "UBUNTU11.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"gdm", ver:"2.32.1-0ubuntu3.2", rls:"UBUNTU11.04")) != NULL)
  {
