...
# $Id: gb_feng_office_47049.nasl 12014 2018-10-22 10:01:47Z mmartin $
#
...
if( file >< recv ) {
  ...
  if( "<pre>OpenVAS-Upload-Test</pre>" >< buf ) {
    ...
    report += '\n\n';
    report += "It was possible to upload the file " + report_vuln_url( port:port, url:url2, url_only:TRUE );
