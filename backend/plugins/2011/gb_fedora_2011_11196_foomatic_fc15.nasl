...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066208.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863536");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"foomatic", rpm:"foomatic~4.0.8~3.fc15", rls:"FC15")) != NULL)
  {
