...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-July/062628.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863354");
  ...
  script_name("Fedora Update for asterisk FEDORA-2011-8914");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.6.2.19~1.fc14", rls:"FC14")) != NULL)
  {
