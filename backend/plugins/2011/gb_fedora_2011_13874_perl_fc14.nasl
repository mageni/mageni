...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-November/068753.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863605");
  ...
  script_tag(name:"affected", value:"perl on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"perl", rpm:"perl~5.12.4~147.fc14", rls:"FC14")) != NULL)
  {
