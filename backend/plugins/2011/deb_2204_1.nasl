...
# $Id: deb_2204_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202204-1");
  script_tag(name:"insight", value:"Moritz Naumann discovered that imp4, a webmail component for the horde
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"imp4", ver:"4.2-4lenny3", rls:"DEB5")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"imp4", ver:"4.3.7+debian0-2.1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"imp4", ver:"4.3.7+debian0-2.1", rls:"DEB7")) != NULL) {
  report += res;
}
