...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065810.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863513");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"mozvoikko", rpm:"mozvoikko~1.0~24.fc14.1", rls:"FC14")) != NULL)
  {
