...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/055896.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862931");
  ...
  script_tag(name:"affected", value:"cgit on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"cgit", rpm:"cgit~0.9~1.fc14", rls:"FC14")) != NULL)
  {
