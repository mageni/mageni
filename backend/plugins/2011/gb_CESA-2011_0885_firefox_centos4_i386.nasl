...
#
# CentOS Update for firefox CESA-2011:0885 centos4 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-August/017679.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880954");
  ...
  script_name("CentOS Update for firefox CESA-2011:0885 centos4 i386");
