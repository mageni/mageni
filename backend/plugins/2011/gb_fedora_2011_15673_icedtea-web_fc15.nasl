...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-November/069058.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863612");
  ...
  script_tag(name:"affected", value:"icedtea-web on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"icedtea-web", rpm:"icedtea-web~1.0.6~1.fc15", rls:"FC15")) != NULL)
  {
