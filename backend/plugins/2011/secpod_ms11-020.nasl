...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.900280");
  ...
  script_name("Microsoft Windows SMB Server Remote Code Execution Vulnerability (2508429)");
  script_xref(name:"URL", value:"http://support.microsoft.com/kb/2508429");
  script_xref(name:"URL", value:"http://www.microsoft.com/technet/security/Bulletin/MS11-020.mspx");
...
## MS11-020 Hotfix (2508429)
if(hotfix_missing(name:"2508429") == 0){
  exit(0);
}
...
else if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  {
    if(version_is_less(version:sysVer, test_version:"5.2.3790.4832")){
      security_message( port: 0, data: "The target host was found to be vulnerable" );
    }
    exit(0);
  }
...
else if(hotfix_check_sp(winVista:3, win2008:3) > 0)
{
  ...
  {
    if(version_in_range(version:sysVer, test_version:"6.0.6001.18000", test_version2:"6.0.6001.18601")||
       version_in_range(version:sysVer, test_version:"6.0.6001.22000", test_version2:"6.0.6001.22856")){
      security_message( port: 0, data: "The target host was found to be vulnerable" );
    }
    exit(0);
  }
  if("Service Pack 2" >< SP)
  {
    if(version_in_range(version:sysVer, test_version:"6.0.6002.18000", test_version2:"6.0.6002.18406")||
       version_in_range(version:sysVer, test_version:"6.0.6002.22000", test_version2:"6.0.6002.22591")){
      security_message( port: 0, data: "The target host was found to be vulnerable" );
    }
    exit(0);
  }
