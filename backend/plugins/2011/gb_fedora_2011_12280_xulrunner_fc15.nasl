...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065700.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863500");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~6.0.2~1.fc15", rls:"FC15")) != NULL)
  {
