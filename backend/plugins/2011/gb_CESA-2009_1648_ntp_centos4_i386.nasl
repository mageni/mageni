...
#
# CentOS Update for ntp CESA-2009:1648 centos4 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-December/016356.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880846");
  ...
  script_name("CentOS Update for ntp CESA-2009:1648 centos4 i386");
  ...
  script_tag(name:"affected", value:"ntp on CentOS 4");
