...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066070.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863525");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"bcfg2", rpm:"bcfg2~1.1.2~2.fc14", rls:"FC14")) != NULL)
  {
