...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066333.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863547");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.4.5~1.fc15", rls:"FC15")) != NULL)
  {
