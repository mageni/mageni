...
# $Id: gb_betsy_46124.nasl 12018 2018-10-22 13:31:29Z mmartin $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.103063");
  ...
  script_tag(name:"summary", value:"Betsy is prone to a local file-include vulnerability because it fails
