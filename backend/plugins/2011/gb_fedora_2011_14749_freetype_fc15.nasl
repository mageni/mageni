...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-November/069100.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863611");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"freetype", rpm:"freetype~2.4.4~6.fc15", rls:"FC15")) != NULL)
  {
