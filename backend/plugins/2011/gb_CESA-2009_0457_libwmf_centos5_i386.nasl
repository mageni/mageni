...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015871.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880836");
  ...
  script_name("CentOS Update for libwmf CESA-2009:0457 centos5 i386");
  ...
  script_tag(name:"affected", value:"libwmf on CentOS 5");
