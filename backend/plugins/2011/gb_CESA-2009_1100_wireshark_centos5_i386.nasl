...
#
# CentOS Update for wireshark CESA-2009:1100 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-June/015987.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880862");
  ...
  script_name("CentOS Update for wireshark CESA-2009:1100 centos5 i386");
