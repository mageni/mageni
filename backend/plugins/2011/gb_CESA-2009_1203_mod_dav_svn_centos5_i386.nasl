...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-August/016070.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880681");
  ...
  script_name("CentOS Update for mod_dav_svn CESA-2009:1203 centos5 i386");
