...
# $Id: gb_joomla_com_resman_xss_vuln.nasl 11552 2018-09-22 13:45:08Z cfischer $
#
...
url = dir + '/index.php?option=com_resman&task=list&city=<script>alert("OpenVAS-XSS")</script>';

if (http_vuln_check(port: port, url: url, pattern: ';<script>alert("OpenVAS-XSS")</script>', check_header: TRUE)) {
