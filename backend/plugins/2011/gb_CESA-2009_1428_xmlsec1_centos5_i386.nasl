...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-September/016161.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880823");
  ...
  script_name("CentOS Update for xmlsec1 CESA-2009:1428 centos5 i386");
