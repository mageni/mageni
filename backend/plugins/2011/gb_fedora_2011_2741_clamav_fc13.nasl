...
#
# Fedora Update for clamav FEDORA-2011-2741
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"clamav on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"clamav", rpm:"clamav~0.97~1300.fc13", rls:"FC13")) != NULL)
  {
