...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-April/058885.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863050");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-Mojolicious", rpm:"perl-Mojolicious~0.999929~2.fc14", rls:"FC14")) != NULL)
  {
