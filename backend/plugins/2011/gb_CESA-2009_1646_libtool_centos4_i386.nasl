...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-December/016358.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880753");
  ...
  script_name("CentOS Update for libtool CESA-2009:1646 centos4 i386");
  ...
  script_tag(name:"affected", value:"libtool on CentOS 4");
