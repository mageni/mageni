...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066389.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863551");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"Django", rpm:"Django~1.3.1~2.fc14", rls:"FC14")) != NULL)
  {
