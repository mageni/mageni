...
# $Id: esoft_slk_ssa_2005_251_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-251-01 kcheckpass in kdebase");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-251-01");
...
if((res = isslkpkgvuln(pkg:"kdebase", ver:"3.2.3-i486-3", rls:"SLK10.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"kdebase", ver:"3.3.2-i486-2", rls:"SLK10.1")) != NULL) {
  report += res;
}
