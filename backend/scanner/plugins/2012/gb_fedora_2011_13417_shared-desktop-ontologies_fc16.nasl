...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.863933");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'shared-desktop-ontologies'
  ...
  script_tag(name:"affected", value:"shared-desktop-ontologies on Fedora 16");
