...
# $Id: gb_adobe_prdts_mult_vuln_aug12_macosx.nasl 11905 2018-10-15 12:43:50Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Adobe Reader versions 9.x through 9.5.1 and 10.x through 10.1.3 on Mac OS X");
