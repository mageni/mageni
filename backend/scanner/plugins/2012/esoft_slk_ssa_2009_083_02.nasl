...
# $Id: esoft_slk_ssa_2009_083_02.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2009-083-02 seamonkey");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2009-083-02");
...
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.15-i486-1_slack11.0", rls:"SLK11.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.15-i486-1_slack12.0", rls:"SLK12.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.15-i486-1_slack12.1", rls:"SLK12.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.15-i486-1_slack12.2", rls:"SLK12.2")) != NULL) {
  report += res;
}
