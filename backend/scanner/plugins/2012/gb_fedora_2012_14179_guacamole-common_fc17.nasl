...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864738");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'guacamole-common'
  ...
  script_tag(name:"affected", value:"guacamole-common on Fedora 17");
