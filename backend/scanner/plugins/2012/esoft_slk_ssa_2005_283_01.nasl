...
# $Id: esoft_slk_ssa_2005_283_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2005-283-01 xine-lib");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-283-01");
...
if((res = isslkpkgvuln(pkg:"xine-lib", ver:"1rc4-i686-2", rls:"SLK9.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"xine-lib", ver:"1.0.3a-i686-1", rls:"SLK10.0")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"xine-lib", ver:"1.0.3a-i686-1", rls:"SLK10.1")) != NULL) {
  report += res;
}
if((res = isslkpkgvuln(pkg:"xine-lib", ver:"1.0.3a-i686-1", rls:"SLK10.2")) != NULL) {
  report += res;
}
