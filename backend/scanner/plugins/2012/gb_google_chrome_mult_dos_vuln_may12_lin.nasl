...
# $Id: gb_google_chrome_mult_dos_vuln_may12_lin.nasl 11857 2018-10-12 08:25:16Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 18.0.1025.168 on Linux");
