...
# $Id: esoft_slk_ssa_2009_118_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63942");
  ...
  script_name("Slackware Advisory SSA:2009-118-01 mozilla-firefox");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2009-118-01");
...
if((res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.0.10-i686-1", rls:"SLK12.2")) != NULL) {
  report += res;
}
