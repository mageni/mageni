...
# $Id: deb_2474_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202474-1");
  script_tag(name:"insight", value:"R Benencia discovered that ikiwiki, a wiki compiler, does not
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"ikiwiki", ver:"3.20100815.9", rls:"DEB6")) != NULL) {
  report += res;
}
