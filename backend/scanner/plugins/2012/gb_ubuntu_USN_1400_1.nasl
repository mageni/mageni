...
# $Id: gb_ubuntu_USN_1400_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(release == "UBUNTU10.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"11.0+build1-0ubuntu0.10.10.2", rls:"UBUNTU10.10")) != NULL)
  {
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"11.0+build1-0ubuntu0.10.04.2", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU11.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"11.0+build1-0ubuntu0.11.10.1", rls:"UBUNTU11.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU11.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"firefox", ver:"11.0+build1-0ubuntu0.11.04.1", rls:"UBUNTU11.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
