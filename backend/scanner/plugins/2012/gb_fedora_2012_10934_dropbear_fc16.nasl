...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2012-July/084354.html");
  script_oid("1.3.6.1.4.1.25623.1.0.864567");
  ...
  script_tag(name:"affected", value:"dropbear on Fedora 16");
