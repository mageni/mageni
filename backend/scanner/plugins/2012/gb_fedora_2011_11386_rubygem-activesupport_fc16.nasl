...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065210.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863883");
  ...
  script_name("Fedora Update for rubygem-activesupport FEDORA-2011-11386");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-activesupport", rpm:"rubygem-activesupport~3.0.10~1.fc16", rls:"FC16")) != NULL)
  {
