...
#
# CentOS Update for postgresql84 CESA-2011:0198 centos5 x86_64
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.881376");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-07-30 17:37:35 +0530 (Mon, 30 Jul 2012)");
  script_cve_id("CVE-2010-4015");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_name("CentOS Update for postgresql84 CESA-2011:0198 centos5 x86_64");

  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-April/017384.html");
