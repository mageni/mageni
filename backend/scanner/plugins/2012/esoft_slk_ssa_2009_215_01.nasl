...
# $Id: esoft_slk_ssa_2009_215_01.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2009-215-01 mozilla-firefox");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2009-215-01");
...
if((res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.0.13-i686-1", rls:"SLK12.2")) != NULL) {
  report += res;
}
