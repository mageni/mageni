...
# $Id: gb_ubuntu_USN_1673_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1673-1/");
  script_oid("1.3.6.1.4.1.25623.1.0.841261");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2012-12-26 12:08:21 +0530 (Wed, 26 Dec 2012)");
  script_cve_id("CVE-2012-5517");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:N/C:N/I:N/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-1673-1");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1673-1");
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-216-omap4", ver:"3.5.0-216.23", rls:"UBUNTU12.10")) != NULL)
  {
