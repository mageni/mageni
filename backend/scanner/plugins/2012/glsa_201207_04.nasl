...
# $Id: glsa_201207_04.nasl 11859 2018-10-12 08:53:01Z cfischer $
#
...
res = "";
report = "";
if((res = ispkgvuln(pkg:"x11-base/xorg-server", unaffected: make_list("ge 1.11.4-r1", "rge 1.10.6-r1", "rle 1.9.5-r1"), vulnerable: make_list("lt 1.11.4-r1"))) != NULL ) {
    report += res;
}
