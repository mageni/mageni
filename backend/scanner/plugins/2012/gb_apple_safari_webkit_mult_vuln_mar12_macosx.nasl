...
# $Id: gb_apple_safari_webkit_mult_vuln_mar12_macosx.nasl 11857 2018-10-12 08:25:16Z cfischer $
#
...
if(description)
{
  ...
  script_bugtraq_id(52421, 52364, 50360, 52367, 52367, 52367, 52367, 50360,
...
if(version_is_less(version:safVer, test_version:"5.1.4")){
