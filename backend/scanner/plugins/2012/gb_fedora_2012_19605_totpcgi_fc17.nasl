...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864940");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'totpcgi'
  ...
  script_tag(name:"affected", value:"totpcgi on Fedora 17");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"totpcgi", rpm:"totpcgi~0.5.4~1.fc17", rls:"FC17")) != NULL)
  {
