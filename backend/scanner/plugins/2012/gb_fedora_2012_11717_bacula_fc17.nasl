...
#
# Fedora Update for bacula FEDORA-2012-11717
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"bacula on Fedora 17");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"bacula", rpm:"bacula~5.2.10~5.fc17", rls:"FC17")) != NULL)
  {
