...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864107");
  ...
  script_tag(name:"affected", value:"gnutls on Fedora 16");
...
if(release == "FC16")
{
  ...
  if ((res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~2.12.14~2.fc16", rls:"FC16")) != NULL)
  {
