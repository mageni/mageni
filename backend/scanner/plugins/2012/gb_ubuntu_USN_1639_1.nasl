...
# $Id: gb_ubuntu_USN_1639_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1639-1/");
  ...
  script_tag(name:"summary", value:"Ubuntu Update for Linux kernel vulnerabilities USN-1639-1");
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"xul-ext-unity", ver:"2.4.1-0ubuntu1.1", rls:"UBUNTU12.10")) != NULL)
  {
