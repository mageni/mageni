...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.864697");
  ...
  script_tag(name:"affected", value:"trousers on Fedora 17");
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"trousers", rpm:"trousers~0.3.9~1.fc17", rls:"FC17")) != NULL)
  {
