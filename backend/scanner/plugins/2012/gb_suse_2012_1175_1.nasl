...
# $Id: gb_suse_2012_1175_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850325");
  ...
  script_tag(name:"insight", value:"The icedtea-web Java plugin was updated to 1.11.4 to fix
