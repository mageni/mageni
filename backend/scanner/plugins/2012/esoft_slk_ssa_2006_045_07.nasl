...
# $Id: esoft_slk_ssa_2006_045_07.nasl 14202 2019-03-15 09:16:15Z cfischer $
...
if(description)
{
  ...
  script_name("Slackware Advisory SSA:2006-045-07 php");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2006-045-07");
...
if((res = isslkpkgvuln(pkg:"php", ver:"4.4.2-i486-3", rls:"SLK10.2")) != NULL) {
  report += res;
}
