...
# $Id: deb_2538_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202538-1");
  script_tag(name:"insight", value:"It was discovered that Moin, a Python clone of WikiWiki, incorrectly
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-moinmoin", ver:"1.9.3-1+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
