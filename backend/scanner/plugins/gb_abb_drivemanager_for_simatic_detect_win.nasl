...
# $Id: gb_abb_drivemanager_for_simatic_detect_win.nasl 13445 2019-02-04 15:55:03Z mmartin $
#
# ABB DriveManager for SIMATIC Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-04 16:35:13 +0100 (Mon, 04 Feb 2019)");
  ...
  of ABB DriveManager for SIMATIC on Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    register_and_report_cpe(app:appName, ver:version, concluded:concluded,
                          base:"cpe:/a:abb:drivemanager_for_simatic:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0);
    exit(0);
  }
}
