...
# $Id: gb_trendmicro_maximum_security_detect_win.nasl 11279 2018-09-07 09:08:31Z cfischer $
#
# Trend Micro Maximum Security Version Detection (Windows)
#
# Authors:
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if("Trend Micro Maximum Security" >< AppName)
  {
