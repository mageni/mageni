...
# $Id: gb_host_alive_check1.nasl 13775 2019-02-20 07:45:12Z cfischer $
#
...
if(description)
{
  ...
  script_name("Mark host as dead if going offline (failed ICMP ping) during scan - Phase 1");
  script_category(ACT_SETTINGS);
  script_copyright("Copyright (C) 2017 Greenbone Networks GmbH");
  script_family("Service detection");
  script_dependencies("global_settings.nasl", "toolcheck.nasl");
