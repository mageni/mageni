...
# $Id: gb_nmap_smb_enum_users.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  ...
  script_name("Nmap NSE: SMB Enum Users");
  ...
  This is a wrapper on the Nmap Security Scanner's smb-enum-users.nse.");
...
if( "yes" == script_get_preference("lsaonly :")){
  args[i++] = "lsaonly=1";
}
