...
# $Id: gb_nmap_dns_recursion.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801690");
  ...
  script_tag(name:"summary", value:"This script attempts to check if a DNS server allows queries for
  third-party names.

  This is a wrapper on the Nmap Security Scanner's dns-recursion.nse.");
...
argv = make_list("nmap", "-sU", "--script=dns-recursion.nse", "-p", port, get_host_ip());
