...
# $Id: gb_nmap_smb_system_info.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801262");
  ...
  script_tag(name:"summary", value:"This script attempts to get the information about the remote system
  from the registry.

  This is a wrapper on the Nmap Security Scanner's smb-system-info.nse");
