...
# $Id: gb_nmap_auth_spoof.nasl 12115 2018-10-26 09:30:41Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.801652");
  ...
  script_tag(name:"summary", value:"This script attempts to checks for an identd (auth)server which is
  spoofing its replies.

  This is a wrapper on the Nmap Security Scanner's auth-spoof.nse.");
