...
# $Id: gb_ibm_guardium_detect.nasl 10911 2018-08-10 15:16:34Z cfischer $
#
# IBM Security Guardium Big Data Intelligence Detection
#
# Authors:
...
if(description)
{
  ...
  script_name("IBM Security Guardium Big Data Intelligence Detection");

  script_tag(name:"summary", value:"Detection of IBM Security Guardium Big Data Intelligence.

The script sends a connection request to the server and attempts to detect IBM Security Guardium Big Data
Intelligence and to extract its version.");
...
if ("IBM Security - Login - Guardium Big Data Intelligence - Login" >< res && "login.xhtml" >< res) {
  ...
  set_kb_item(name: "ibm_guardium/installed", value: TRUE);
