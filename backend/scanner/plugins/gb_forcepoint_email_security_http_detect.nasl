...
if(description)
{
  ...
  script_version("2019-11-08T15:18:00+0000");
  script_tag(name:"last_modification", value:"2019-11-08 15:18:00 +0000 (Fri, 08 Nov 2019)");
...
foreach dir( make_list_unique( "/", cgi_dirs( port: port ) ) ) {
  ...
  if( buf =~ "HTTP/[0-9]\.[0-9] 200" && buf =~ '<title>Forcepoint Email Security' ) {
