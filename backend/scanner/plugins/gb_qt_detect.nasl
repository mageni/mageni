...
# $Id: gb_qt_detect.nasl 11015 2018-08-17 06:31:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the installed Qt version and saves the version
  in KB.");
  exit(0);
}
