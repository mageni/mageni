...
if(description)
{
  ...
  script_tag(name:"summary", value:"Detection of DrayTek Vigor Routers via PPTP.

  The script checks the vendor string of the device previously gathered via the PPTP Protocol and attempts to
  detect the presence of a DrayTek Vigor Router.");
...
set_kb_item( name:"draytek/vigor/router/pptp/detected", value:TRUE );
set_kb_item( name:"draytek/vigor/router/pptp/port", value:port );
set_kb_item( name:"draytek/vigor/router/pptp/" + port + "/concluded", value:concluded );
set_kb_item( name:"draytek/vigor/router/pptp/" + port + "/version", value:version );
