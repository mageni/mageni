...
# $Id: nopsec_php_5_2_3.nasl 10460 2018-07-09 07:50:03Z cfischer $
#
...
if( version_is_less( version:vers, test_version:"5.2.3" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"5.2.3" );
