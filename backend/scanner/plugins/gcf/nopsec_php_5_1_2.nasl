...
# $Id: nopsec_php_5_1_2.nasl 10460 2018-07-09 07:50:03Z cfischer $
#
# PHP Version < 5.1.2 Multiple Vulnerabilities
#
# Authors:
...
if( version_is_less( version:vers, test_version:"5.1.2" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"5.1.2" );
