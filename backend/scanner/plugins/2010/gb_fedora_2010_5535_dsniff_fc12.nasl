...
tag_affected = "dsniff on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038375.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314690");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"dsniff", rpm:"dsniff~2.4~0.9.b1.fc12", rls:"FC12")) != NULL)
  {
