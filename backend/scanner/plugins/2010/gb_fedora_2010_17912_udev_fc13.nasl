...
tag_affected = "udev on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/051755.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314359");
  ...
  script_name("Fedora Update for udev FEDORA-2010-17912");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"udev", rpm:"udev~153~5.fc13", rls:"FC13")) != NULL)
  {
