...
#
# Fedora Update for ikiwiki FEDORA-2010-4884
#
# Authors:
...
tag_affected = "ikiwiki on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038327.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314738");
  script_version("$Revision: 8228 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-22 08:29:52 +0100 (Fri, 22 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-04-06 08:56:44 +0200 (Tue, 06 Apr 2010)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-4884");
  script_name("Fedora Update for ikiwiki FEDORA-2010-4884");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"ikiwiki", rpm:"ikiwiki~3.20100312~1.fc12", rls:"FC12")) != NULL)
  {
