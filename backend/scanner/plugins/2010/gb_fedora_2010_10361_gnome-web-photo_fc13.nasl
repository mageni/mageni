...
#
# Fedora Update for gnome-web-photo FEDORA-2010-10361
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043401.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313080");
  ...
  script_name("Fedora Update for gnome-web-photo FEDORA-2010-10361");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.9~9.fc13", rls:"FC13")) != NULL)
  {
