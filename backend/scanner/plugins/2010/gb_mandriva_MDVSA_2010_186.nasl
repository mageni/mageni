...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2010-09/msg00027.php");
  script_oid("1.3.6.1.4.1.25623.1.0.314863");
  script_version("$Revision: 8207 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-21 08:30:12 +0100 (Thu, 21 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-09-27 08:14:44 +0200 (Mon, 27 Sep 2010)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "MDVSA", value: "2010:186");
  script_cve_id("CVE-2010-3263");
  script_name("Mandriva Update for phpmyadmin MDVSA-2010:186 (phpmyadmin)");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"phpmyadmin", rpm:"phpmyadmin~3.3.7~0.1mdvmes5.1", rls:"MNDK_mes5")) != NULL)
  {
