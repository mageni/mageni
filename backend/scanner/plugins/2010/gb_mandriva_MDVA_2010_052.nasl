...
tag_affected = "microcode_ctl on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "microcode_ctl is now providing a script to allow updates to retrieve
...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.313496");
...
if(release == "MNDK_mes5")
{
  ...
  if ((res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~1.17~12.1mdvmes5", rls:"MNDK_mes5")) != NULL)
  {
