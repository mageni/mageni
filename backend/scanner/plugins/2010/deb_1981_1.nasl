...
tag_insight = "Christoph Anton Mitterer discovered that maildrop, a mail delivery agent
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201981-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.314230");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"maildrop", ver:"2.0.2-11+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"maildrop", ver:"2.0.4-3+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
