...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/048389.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313989");
  ...
  script_name("Fedora Update for perl-Gtk2-MozEmbed FEDORA-2010-15093");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-Gtk2-MozEmbed", rpm:"perl-Gtk2-MozEmbed~0.08~6.fc14.18", rls:"FC14")) != NULL)
  {
