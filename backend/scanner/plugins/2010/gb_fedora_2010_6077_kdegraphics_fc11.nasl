...
#
# Fedora Update for kdegraphics FEDORA-2010-6077
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/039586.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314426");
  ...
  script_name("Fedora Update for kdegraphics FEDORA-2010-6077");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"kdegraphics", rpm:"kdegraphics~4.4.2~3.fc11", rls:"FC11")) != NULL)
  {
