...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043191.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313494");
  ...
  script_name("Fedora Update for drupal-cck FEDORA-2010-10200");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-cck", rpm:"drupal-cck~6.x.2.7~1.fc13", rls:"FC13")) != NULL)
  {
