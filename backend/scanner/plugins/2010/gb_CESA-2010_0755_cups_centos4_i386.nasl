...
#
# CentOS Update for cups CESA-2010:0755 centos4 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2010-October/017051.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314514");
  ...
  script_name("CentOS Update for cups CESA-2010:0755 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"cups", rpm:"cups~1.1.22~0.rc1.9.32.el4.10", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-devel", rpm:"cups-devel~1.1.22~0.rc1.9.32.el4.10", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.1.22~0.rc1.9.32.el4.10", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
