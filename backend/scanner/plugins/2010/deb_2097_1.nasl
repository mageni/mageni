...
# $Id: deb_2097_1.nasl 8528 2018-01-25 07:57:36Z teissa $
# Description: Auto-generated from advisory DSA 2097-1 (phpmyadmin)
#
# Authors:
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202097-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.314578");
 ...
 script_name("Debian Security Advisory DSA 2097-1 (phpmyadmin)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpmyadmin", ver:"2.11.8.1-5+lenny5", rls:"DEB5.0")) != NULL) {
    report += res;
}
