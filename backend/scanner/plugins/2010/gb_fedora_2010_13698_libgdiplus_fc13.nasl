...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047268.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313069");
  script_version("$Revision: 8314 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-08 09:01:01 +0100 (Mon, 08 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-09-10 14:21:00 +0200 (Fri, 10 Sep 2010)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-13698");
  script_cve_id("CVE-2010-1526");
  script_name("Fedora Update for libgdiplus FEDORA-2010-13698");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"libgdiplus", rpm:"libgdiplus~2.6.7~2.fc13", rls:"FC13")) != NULL)
  {
