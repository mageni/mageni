...
# $Id: deb_1974_1.nasl 8266 2018-01-01 07:28:32Z teissa $
...
tag_insight = "Several vulnerabilities have been found in gzip, the GNU compression
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201974-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.313236");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.5-15+etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gzip-win32", ver:"1.3.12-6+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gzip", ver:"1.3.12-6+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
