...
#
# Fedora Update for Miro FEDORA-2010-1936
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035363.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314857");
  ...
  script_name("Fedora Update for Miro FEDORA-2010-1936");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"Miro", rpm:"Miro~2.5.4~2.fc11", rls:"FC11")) != NULL)
  {
