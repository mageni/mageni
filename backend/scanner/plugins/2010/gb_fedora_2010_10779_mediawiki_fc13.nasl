...
#
# Fedora Update for mediawiki FEDORA-2010-10779
#
# Authors:
...
tag_affected = "mediawiki on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/043803.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313243");
  script_version("$Revision: 8228 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-22 08:29:52 +0100 (Fri, 22 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-07-12 11:56:20 +0200 (Mon, 12 Jul 2010)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-10779");
  script_cve_id("CVE-2010-1647", "CVE-2010-1648");
  script_name("Fedora Update for mediawiki FEDORA-2010-10779");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"mediawiki", rpm:"mediawiki~1.15.4~54.fc13", rls:"FC13")) != NULL)
  {
