...
#
# Fedora Update for glpi FEDORA-2010-16912
#
# Authors:
...
tag_affected = "glpi on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050428.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314123");
  ...
  script_name("Fedora Update for glpi FEDORA-2010-16912");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"glpi", rpm:"glpi~0.72.4~3.svn11497.fc13", rls:"FC13")) != NULL)
  {
