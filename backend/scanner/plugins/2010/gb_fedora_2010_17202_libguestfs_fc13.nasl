...
#
# Fedora Update for libguestfs FEDORA-2010-17202
#
# Authors:
...
tag_affected = "libguestfs on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050742.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314679");
  script_version("$Revision: 8246 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-26 08:29:20 +0100 (Tue, 26 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-11-16 14:49:48 +0100 (Tue, 16 Nov 2010)");
  script_tag(name:"cvss_base", value:"4.7");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:N/A:N");
  script_xref(name: "FEDORA", value: "2010-17202");
  script_cve_id("CVE-2010-3851");
  script_name("Fedora Update for libguestfs FEDORA-2010-17202");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"libguestfs", rpm:"libguestfs~1.6.0~1.fc13.1", rls:"FC13")) != NULL)
  {
