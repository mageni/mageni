...
#
# Fedora Update for glpi FEDORA-2010-5106
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-March/037866.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313979");
  ...
  script_name("Fedora Update for glpi FEDORA-2010-5106");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"glpi", rpm:"glpi~0.72.4~2.svn11035.fc12", rls:"FC12")) != NULL)
  {
