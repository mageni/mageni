...
#
# Fedora Update for sunbird FEDORA-2010-14396
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047355.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313503");
  ...
  script_name("Fedora Update for sunbird FEDORA-2010-14396");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"sunbird", rpm:"sunbird~1.0~0.28.b2pre.fc14", rls:"FC14")) != NULL)
  {
