...
tag_affected = "httpd on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/045455.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313158");
  ...
  script_name("Fedora Update for httpd FEDORA-2010-12478");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.2.16~1.fc13", rls:"FC13")) != NULL)
  {
