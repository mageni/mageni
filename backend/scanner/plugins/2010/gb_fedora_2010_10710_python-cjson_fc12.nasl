...
#
# Fedora Update for python-cjson FEDORA-2010-10710
#
# Authors:
...
tag_affected = "python-cjson on Fedora 12";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/044312.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314341");
  script_version("$Revision: 8457 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-18 08:58:32 +0100 (Thu, 18 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-07-23 16:10:25 +0200 (Fri, 23 Jul 2010)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-10710");
  script_cve_id("CVE-2010-1666");
  script_name("Fedora Update for python-cjson FEDORA-2010-10710");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"python-cjson", rpm:"python-cjson~1.0.5~5.fc12", rls:"FC12")) != NULL)
  {
