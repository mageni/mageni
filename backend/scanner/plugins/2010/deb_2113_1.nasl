...
# $Id: deb_2113_1.nasl 8495 2018-01-23 07:57:49Z teissa $
# Description: Auto-generated from advisory DSA 2113-1 (drupal6)
#
# Authors:
...
tag_insight = "Several vulnerabilities have been discovered in drupal6 a fully-featured
...
announced via advisory DSA 2113-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202113-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.313521");
 script_version("$Revision: 8495 $");
 script_tag(name:"last_modification", value:"$Date: 2018-01-23 08:57:49 +0100 (Tue, 23 Jan 2018) $");
 script_tag(name:"creation_date", value:"2010-10-10 19:35:00 +0200 (Sun, 10 Oct 2010)");
 script_tag(name:"cvss_base", value:"5.5");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:N");
 script_cve_id("CVE-2010-3091", "CVE-2010-3092", "CVE-2010-3093", "CVE-2010-3094");
 script_name("Debian Security Advisory DSA 2113-1 (drupal6)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal6", ver:"6.6-3lenny6", rls:"DEB5.0")) != NULL) {
    report += res;
}
