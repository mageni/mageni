...
#
# Fedora Update for bltk FEDORA-2010-1327
#
# Authors:
...
tag_affected = "bltk on Fedora 11";
tag_insight = "This tool kit is used to measure battery life and performance under
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035245.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314813");
  script_version("$Revision: 8244 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-25 08:29:28 +0100 (Mon, 25 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-02 08:38:02 +0100 (Tue, 02 Mar 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-1327");
  script_name("Fedora Update for bltk FEDORA-2010-1327");

  script_tag(name: "summary" , value: "Check for the Version of bltk");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"bltk", rpm:"bltk~1.0.8~3.fc11", rls:"FC11")) != NULL)
  {
