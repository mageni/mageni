...
tag_affected = "kdeutils on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-May/041927.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314725");
  ...
  script_name("Fedora Update for kdeutils FEDORA-2010-8544");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"kdeutils", rpm:"kdeutils~4.4.3~1.fc12.1", rls:"FC12")) != NULL)
  {
