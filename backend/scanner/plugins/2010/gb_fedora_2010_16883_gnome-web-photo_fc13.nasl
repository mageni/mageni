...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-October/050063.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313698");
  ...
  script_name("Fedora Update for gnome-web-photo FEDORA-2010-16883");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.9~14.fc13", rls:"FC13")) != NULL)
  {
