...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-April/038379.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314155");
  ...
  script_name("Fedora Update for sunbird FEDORA-2010-5539");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"sunbird", rpm:"sunbird~1.0~0.21.20090916hg.fc12", rls:"FC12")) != NULL)
  {
