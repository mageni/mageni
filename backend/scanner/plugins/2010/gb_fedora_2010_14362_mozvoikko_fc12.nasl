...
#
# Fedora Update for mozvoikko FEDORA-2010-14362
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047285.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313026");
  ...
  script_name("Fedora Update for mozvoikko FEDORA-2010-14362");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"mozvoikko", rpm:"mozvoikko~1.0~12.fc12", rls:"FC12")) != NULL)
  {
