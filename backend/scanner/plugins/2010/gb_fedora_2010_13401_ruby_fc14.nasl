...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046296.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314856");
  ...
  script_name("Fedora Update for ruby FEDORA-2010-13401");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"ruby", rpm:"ruby~1.8.7.302~1.fc14", rls:"FC14")) != NULL)
  {
