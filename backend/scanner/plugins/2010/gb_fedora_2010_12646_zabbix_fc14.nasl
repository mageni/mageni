...
#
# Fedora Update for zabbix FEDORA-2010-12646
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-August/046409.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313971");
  script_version("$Revision: 8287 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-04 08:28:11 +0100 (Thu, 04 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-02 08:39:14 +0100 (Thu, 02 Dec 2010)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-12646");
  script_cve_id("CVE-2010-2790");
  script_name("Fedora Update for zabbix FEDORA-2010-12646");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"zabbix", rpm:"zabbix~1.8.2~3.fc14", rls:"FC14")) != NULL)
  {
