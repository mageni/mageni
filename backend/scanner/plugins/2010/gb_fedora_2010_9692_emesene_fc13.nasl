...
tag_affected = "emesene on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/042699.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313289");
  script_version("$Revision: 8440 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-17 08:58:46 +0100 (Wed, 17 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-06-11 13:46:51 +0200 (Fri, 11 Jun 2010)");
  script_tag(name:"cvss_base", value:"3.3");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:N/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-9692");
  script_cve_id("CVE-2010-2053");
  script_name("Fedora Update for emesene FEDORA-2010-9692");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"emesene", rpm:"emesene~1.6.2~1.fc13", rls:"FC13")) != NULL)
  {
