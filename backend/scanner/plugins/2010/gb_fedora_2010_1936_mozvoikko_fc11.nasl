...
#
# Fedora Update for mozvoikko FEDORA-2010-1936
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035359.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313383");
  ...
  script_name("Fedora Update for mozvoikko FEDORA-2010-1936");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"mozvoikko", rpm:"mozvoikko~0.9.7~0.11.rc1.fc11", rls:"FC11")) != NULL)
  {
