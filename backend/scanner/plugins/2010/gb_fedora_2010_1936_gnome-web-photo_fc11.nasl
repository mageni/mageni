...
#
# Fedora Update for gnome-web-photo FEDORA-2010-1936
#
# Authors:
...
tag_affected = "gnome-web-photo on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035366.html");
  script_oid("1.3.6.1.4.1.25623.1.0.315041");
  ...
  script_name("Fedora Update for gnome-web-photo FEDORA-2010-1936");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.7~10.fc11", rls:"FC11")) != NULL)
  {
