...
# $Id: OpenX_37913.nasl 14127 2019-03-13 07:37:35Z ckuersteiner $
#
...
if (description)
{
  ...
  script_name("OpenX SQL Injection Vulnerability");
  ...
  script_tag(name:"summary", value:"OpenX is prone to an SQL-injection vulnerability because it fails
