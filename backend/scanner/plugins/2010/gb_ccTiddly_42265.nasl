...
# $Id: gb_ccTiddly_42265.nasl 14233 2019-03-16 13:32:43Z mmartin $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.100769");
  ...
  script_tag(name:"summary", value:"ccTiddly is prone to multiple remote file-include vulnerabilities
