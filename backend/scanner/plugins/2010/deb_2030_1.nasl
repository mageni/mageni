...
# $Id: deb_2030_1.nasl 8266 2018-01-01 07:28:32Z teissa $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202030-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.314555");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mahara-apache2", ver:"1.0.4-4+lenny5", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mahara", ver:"1.0.4-4+lenny5", rls:"DEB5.0")) != NULL) {
    report += res;
}
