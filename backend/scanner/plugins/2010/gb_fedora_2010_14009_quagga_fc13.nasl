...
tag_affected = "quagga on Fedora 13";


if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/047486.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312931");
  ...
  script_name("Fedora Update for quagga FEDORA-2010-14009");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"quagga", rpm:"quagga~0.99.17~1.fc13", rls:"FC13")) != NULL)
  {
