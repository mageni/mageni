...
#
# Fedora Update for gnome-python2-extras FEDORA-2010-10361
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-June/043402.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314743");
  ...
  script_name("Fedora Update for gnome-python2-extras FEDORA-2010-10361");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.25.3~19.fc13", rls:"FC13")) != NULL)
  {
