...
tag_affected = "gnash on Fedora 11";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035093.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313699");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"gnash", rpm:"gnash~0.8.6~13.fc11", rls:"FC11")) != NULL)
  {
