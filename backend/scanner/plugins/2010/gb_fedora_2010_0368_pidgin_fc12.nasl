...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/033771.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314434");
  script_version("$Revision: 8187 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-20 08:30:09 +0100 (Wed, 20 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-02 08:38:02 +0100 (Tue, 02 Mar 2010)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_xref(name: "FEDORA", value: "2010-0368");
  script_cve_id("CVE-2010-0013");
  script_name("Fedora Update for pidgin FEDORA-2010-0368");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"pidgin", rpm:"pidgin~2.6.5~1.fc12", rls:"FC12")) != NULL)
  {
