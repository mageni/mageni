...
tag_affected = "avahi on Fedora 13";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-July/043820.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314647");
  ...
  script_name("Fedora Update for avahi FEDORA-2010-10581");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"avahi", rpm:"avahi~0.6.25~7.fc13", rls:"FC13")) != NULL)
  {
