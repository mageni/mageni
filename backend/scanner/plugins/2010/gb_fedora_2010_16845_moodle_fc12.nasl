...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-November/050800.html");
  script_oid("1.3.6.1.4.1.25623.1.0.314472");
  ...
  script_name("Fedora Update for moodle FEDORA-2010-16845");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"moodle", rpm:"moodle~1.9.10~1.fc12", rls:"FC12")) != NULL)
  {
