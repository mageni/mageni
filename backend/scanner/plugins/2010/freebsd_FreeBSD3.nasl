#
#VID 768cfe70-ca40-11df-aade-0050568f000c
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID 768cfe70-ca40-11df-aade-0050568f000c
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.314303");
...
if(!isnull(bver) && revcomp(a:bver, b:"6.4")>0 && revcomp(a:bver, b:"6.4_10")<0) {
    txt += 'Package FreeBSD version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"7.1")>0 && revcomp(a:bver, b:"7.1_12")<0) {
    txt += 'Package FreeBSD version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
