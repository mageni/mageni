...
#
# Fedora Update for galeon FEDORA-2010-15093
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-September/048387.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313502");
  ...
  script_name("Fedora Update for galeon FEDORA-2010-15093");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.7~33.fc14", rls:"FC14")) != NULL)
  {
