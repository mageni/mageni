...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.800781");
  ...
  script_tag(name:"summary", value:"This host is running openMairie openCourrier and is prone to
  multiple file inclusion vulnerabilities.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to obtain
  sensitive information or compromise a vulnerable system.");

  script_tag(name:"affected", value:"OpenMairie Opencourrier version 2.03beta and prior.");
