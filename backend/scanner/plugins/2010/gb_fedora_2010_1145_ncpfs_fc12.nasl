...
#
# Fedora Update for ncpfs FEDORA-2010-1145
#
# Authors:
...
tag_insight = "Ncpfs is a filesystem which understands the Novell NetWare(TM) NCP
...
tag_affected = "ncpfs on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/034403.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313182");
  ...
  script_xref(name: "FEDORA", value: "2010-1145");
  script_cve_id("CVE-2009-3297");
  script_name("Fedora Update for ncpfs FEDORA-2010-1145");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"ncpfs", rpm:"ncpfs~2.2.6~13.fc12", rls:"FC12")) != NULL)
  {
