...
tag_insight = "The following package is affected: mahara
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.314344");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.1.8")<0) {
    txt += 'Package mahara version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
