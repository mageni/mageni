...
tag_affected = "trac on Fedora 11";
tag_insight = "Trac is an integrated system for managing software projects, an
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-January/033777.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313323");
  script_version("$Revision: 8244 $");
  script_tag(name:"last_modification", value:"$Date: 2017-12-25 08:29:28 +0100 (Mon, 25 Dec 2017) $");
  script_tag(name:"creation_date", value:"2010-03-02 08:38:02 +0100 (Tue, 02 Mar 2010)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2010-0007");
  script_name("Fedora Update for trac FEDORA-2010-0007");

  script_tag(name: "summary" , value: "Check for the Version of trac");
...
if(release == "FC11")
{
  ...
  if ((res = isrpmvuln(pkg:"trac", rpm:"trac~0.11.6~1.fc11", rls:"FC11")) != NULL)
  {
