...
tag_affected = "maildrop on Fedora 12";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035127.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313513");
  ...
  script_name("Fedora Update for maildrop FEDORA-2010-1863");
...
if(release == "FC12")
{
  ...
  if ((res = isrpmvuln(pkg:"maildrop", rpm:"maildrop~2.4.0~12.fc12", rls:"FC12")) != NULL)
  {
