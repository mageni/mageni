...
#
# Fedora Update for mailman FEDORA-2010-14834
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.fedoraproject.org/pipermail/package-announce/2010-December/052312.html");
  script_oid("1.3.6.1.4.1.25623.1.0.313813");
  script_version("$Revision: 8457 $");
  script_tag(name:"last_modification", value:"$Date: 2018-01-18 08:58:32 +0100 (Thu, 18 Jan 2018) $");
  script_tag(name:"creation_date", value:"2010-12-28 07:11:56 +0100 (Tue, 28 Dec 2010)");
  script_tag(name:"cvss_base", value:"3.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_xref(name: "FEDORA", value: "2010-14834");
  script_cve_id("CVE-2010-3089");
  script_name("Fedora Update for mailman FEDORA-2010-14834");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"mailman", rpm:"mailman~2.1.13~6.fc14.1", rls:"FC14")) != NULL)
  {
