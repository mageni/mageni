...
if(description)
{
  ...
  script_version("2019-10-09T11:18:34+0000");
  script_tag(name:"last_modification", value:"2019-10-09 11:18:34 +0000 (Wed, 09 Oct 2019)");
  ...
  script_tag(name:"affected", value:"OpenEMR through version 5.0.2.");
  script_tag(name:"solution", value:"No known solution is available as of 09th October, 2019.
