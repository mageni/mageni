...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.142623");
  script_version("2019-07-18T08:02:21+0000");
  script_tag(name:"last_modification", value:"2019-07-18 08:02:21 +0000 (Thu, 18 Jul 2019)");
  script_tag(name:"creation_date", value:"2019-07-18 08:01:35 +0000 (Thu, 18 Jul 2019)");
  ...
  script_name("Drupal Access Bypass Vulnerability (SA-CORE-2019-008) (Windows)");
...
if (version_is_equal(version: version, test_version: "8.7.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.7.5", install_path: path);
