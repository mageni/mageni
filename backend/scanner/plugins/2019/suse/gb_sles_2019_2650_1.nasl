...
if(description)
{
  ...
  script_cve_id("CVE-2018-1000876","CVE-2018-17358","CVE-2018-17359");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2650-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-October/006007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'binutils'
  package(s) announced via the SUSE-SU-2019:2650-1 advisory.");
