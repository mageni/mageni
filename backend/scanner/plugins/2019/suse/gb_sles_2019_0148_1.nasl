...
if(description)
{
  ...
  script_cve_id("CVE-2017-16939","CVE-2018-1120","CVE-2018-16862");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0148-1)");
  ...
  package(s) announced via the SUSE-SU-2019:0148-1 advisory.");
