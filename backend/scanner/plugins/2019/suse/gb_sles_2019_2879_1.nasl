...
if(description)
{
  ...
  script_cve_id("CVE-2017-18595","CVE-2019-14821","CVE-2019-15291");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2879-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-October/006083.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2019:2879-1 advisory.");
