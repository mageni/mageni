...
if(description)
{
  ...
  script_cve_id("CVE-2016-9843","CVE-2018-3143","CVE-2018-3156");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0119-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-January/005041.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mariadb'
  package(s) announced via the SUSE-SU-2019:0119-1 advisory.");
