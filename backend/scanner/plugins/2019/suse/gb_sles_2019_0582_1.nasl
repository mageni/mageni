...
if(description)
{
  ...
  script_cve_id("CVE-2017-13672","CVE-2017-13673","CVE-2018-16872");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0582-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-March/005184.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qemu'
  package(s) announced via the SUSE-SU-2019:0582-1 advisory.");
