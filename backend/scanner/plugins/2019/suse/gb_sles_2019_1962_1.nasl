...
if(description)
{
  ...
  script_cve_id("CVE-2017-9111","CVE-2017-9112","CVE-2017-9113");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1962-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005747.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openexr'
  package(s) announced via the SUSE-SU-2019:1962-1 advisory.");
