...
if(description)
{
  ...
  script_cve_id("CVE-2016-9396","CVE-2018-19539","CVE-2018-19540");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2513-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-October/005977.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'jasper'
  package(s) announced via the SUSE-SU-2019:2513-1 advisory.");
