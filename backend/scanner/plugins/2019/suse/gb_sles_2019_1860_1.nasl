...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2019.1860.1");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1860-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005721.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xrdp'
  package(s) announced via the SUSE-SU-2019:1860-1 advisory.");
