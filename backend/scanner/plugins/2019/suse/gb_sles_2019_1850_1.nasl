...
if(description)
{
  ...
  script_cve_id("CVE-2019-6237","CVE-2019-8571","CVE-2019-8583");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:1850-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-July/005709.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2019:1850-1 advisory.");
