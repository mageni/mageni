...
if(description)
{
  ...
  script_cve_id("CVE-2018-14613","CVE-2018-14617","CVE-2018-14633");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:0095-1)");
  ...
  package(s) announced via the SUSE-SU-2019:0095-1 advisory.");
