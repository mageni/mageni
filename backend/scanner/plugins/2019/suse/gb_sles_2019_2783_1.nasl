...
if(description)
{
  ...
  script_cve_id("CVE-2019-12068","CVE-2019-14378","CVE-2019-15890");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2783-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-October/006058.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2019:2783-1 advisory.");
