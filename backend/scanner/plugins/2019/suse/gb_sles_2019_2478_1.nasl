...
if(description)
{
  ...
  script_cve_id("CVE-2019-12973","CVE-2019-14811","CVE-2019-14812");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:2478-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-September/005970.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ghostscript'
  package(s) announced via the SUSE-SU-2019:2478-1 advisory.");
