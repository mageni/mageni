...
if(description)
{
  ...
  script_cve_id("CVE-2019-14901","CVE-2019-15213","CVE-2019-16746");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2019:3389-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-December/006292.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2019:3389-1 advisory.");
