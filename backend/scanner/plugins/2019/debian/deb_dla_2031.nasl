...
if(description)
{
  ...
  script_version("2019-12-11T03:00:40+0000");
  script_cve_id("CVE-2019-12211", "CVE-2019-12213");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-12-11 03:00:40 +0000 (Wed, 11 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-11 03:00:40 +0000 (Wed, 11 Dec 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2031-1] freeimage security update)");
  ...
  package(s) announced via the DSA-2031-1 advisory.");
