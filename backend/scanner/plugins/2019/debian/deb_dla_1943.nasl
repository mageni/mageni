...
if(description)
{
  ...
  script_version("2019-10-03T02:00:14+0000");
  script_cve_id("CVE-2019-14540", "CVE-2019-16335", "CVE-2019-16942", "CVE-2019-16943");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-10-03 02:00:14 +0000 (Thu, 03 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-03 02:00:14 +0000 (Thu, 03 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1943-1] jackson-databind security update)");
  ...
  package(s) announced via the DSA-1943-1 advisory.");
