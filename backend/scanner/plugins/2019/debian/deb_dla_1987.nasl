...
if(description)
{
  ...
  script_version("2019-11-11T03:00:11+0000");
  ...
  script_tag(name:"last_modification", value:"2019-11-11 03:00:11 +0000 (Mon, 11 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-11 03:00:11 +0000 (Mon, 11 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1987-1] firefox-esr security update)");
  ...
  package(s) announced via the DSA-1987-1 advisory.");
