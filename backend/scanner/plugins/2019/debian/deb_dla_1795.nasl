...
if(description)
{
  ...
  script_version("2019-05-21T02:00:14+0000");
  script_cve_id("CVE-2019-11473", "CVE-2019-11474", "CVE-2019-11505", "CVE-2019-11506");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-21 02:00:14 +0000 (Tue, 21 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-21 02:00:14 +0000 (Tue, 21 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1795-1] graphicsmagick security update)");
  ...
  package(s) announced via the DSA-1795-1 advisory.");
