...
if(description)
{
  ...
  script_version("2019-11-09T03:00:09+0000");
  script_cve_id("CVE-2019-18804");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-09 03:00:09 +0000 (Sat, 09 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-09 03:00:09 +0000 (Sat, 09 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1985-1] djvulibre security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00004.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1985-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the DSA-1985-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a NULL pointer dereference issue
...
technologies for high-resolution ssues.");
  ...
  script_tag(name:"solution", value:"For Debian 8 'Jessie', this issue has been fixed in djvulibre version
3.5.25.4-4+deb8u2.
