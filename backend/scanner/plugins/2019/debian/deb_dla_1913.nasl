...
if(description)
{
  ...
  script_version("2019-09-08T02:00:07+0000");
  script_cve_id("CVE-2019-15026");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-09-08 02:00:07 +0000 (Sun, 08 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-08 02:00:07 +0000 (Sun, 08 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1913-1] memcached security update)");
  ...
  package(s) announced via the DSA-1913-1 advisory.");
