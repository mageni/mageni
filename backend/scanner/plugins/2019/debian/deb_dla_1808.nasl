...
if(description)
{
  ...
  script_version("2019-05-29T02:00:09+0000");
  script_cve_id("CVE-2019-8354", "CVE-2019-8355", "CVE-2019-8356", "CVE-2019-8357");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-29 02:00:09 +0000 (Wed, 29 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-29 02:00:09 +0000 (Wed, 29 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1808-1] sox security update)");
  ...
  package(s) announced via the DSA-1808-1 advisory.");
