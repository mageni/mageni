...
if(description)
{
  ...
  script_version("2019-07-23T02:00:10+0000");
  script_cve_id("CVE-2016-4609", "CVE-2016-4610", "CVE-2019-13117", "CVE-2019-13118");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-07-23 02:00:10 +0000 (Tue, 23 Jul 2019)");
  script_tag(name:"creation_date", value:"2019-07-23 02:00:10 +0000 (Tue, 23 Jul 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1860-1] libxslt security update)");
  ...
  package(s) announced via the DSA-1860-1 advisory.");
