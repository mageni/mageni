...
if(description)
{
  ...
  script_version("2019-05-21T02:00:23+0000");
  ...
  script_tag(name:"last_modification", value:"2019-05-21 02:00:23 +0000 (Tue, 21 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-21 02:00:23 +0000 (Tue, 21 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1796-1] jruby security update)");
  ...
  package(s) announced via the DSA-1796-1 advisory.");
