...
if(description)
{
  ...
  script_version("2019-09-13T02:00:06+0000");
  script_cve_id("CVE-2019-16163");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-09-13 02:00:06 +0000 (Fri, 13 Sep 2019)");
  script_tag(name:"creation_date", value:"2019-09-13 02:00:06 +0000 (Fri, 13 Sep 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1918-1] libonig security update)");
  ...
  package(s) announced via the DSA-1918-1 advisory.");
