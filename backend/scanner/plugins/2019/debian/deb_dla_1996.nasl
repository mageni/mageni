...
if(description)
{
  ...
  script_version("2019-11-26T12:49:51+0000");
  script_cve_id("CVE-2019-14857");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-26 12:49:51 +0000 (Tue, 26 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-26 12:49:51 +0000 (Tue, 26 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1996-1] libapache2-mod-auth-openidc security update)");
  ...
  package(s) announced via the DSA-1996-1 advisory.");
