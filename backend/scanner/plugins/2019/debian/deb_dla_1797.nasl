...
if(description)
{
  ...
  script_version("2019-05-21T02:00:26+0000");
  script_cve_id("CVE-2019-11358", "CVE-2019-11831");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-05-21 02:00:26 +0000 (Tue, 21 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-21 02:00:26 +0000 (Tue, 21 May 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1797-1] drupal7 security update)");
  ...
  package(s) announced via the DSA-1797-1 advisory.");
