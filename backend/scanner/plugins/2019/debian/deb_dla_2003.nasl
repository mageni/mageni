...
if(description)
{
  ...
  script_version("2019-11-26T12:50:18+0000");
  script_cve_id("CVE-2016-2774");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-26 12:50:18 +0000 (Tue, 26 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-26 12:50:18 +0000 (Tue, 26 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2003-1] isc-dhcp security update)");
  ...
  package(s) announced via the DSA-2003-1 advisory.");
