...
if(description)
{
  ...
  script_version("2019-07-20T02:00:06+0000");
  script_cve_id("CVE-2019-13504");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-07-20 02:00:06 +0000 (Sat, 20 Jul 2019)");
  script_tag(name:"creation_date", value:"2019-07-20 02:00:06 +0000 (Sat, 20 Jul 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1855-1] exiv2 security update)");
  ...
  package(s) announced via the DSA-1855-1 advisory.");
