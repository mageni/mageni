...
if(description)
{
  ...
  script_version("2019-06-01T09:22:32+0000");
  script_cve_id("CVE-2018-15822", "CVE-2019-11338");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-06-01 09:22:32 +0000 (Sat, 01 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-01 09:22:32 +0000 (Sat, 01 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1809-1] libav security update)");
  ...
  package(s) announced via the DSA-1809-1 advisory.");
