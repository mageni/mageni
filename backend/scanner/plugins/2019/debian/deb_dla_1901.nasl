...
if(description)
{
  ...
  script_version("2019-08-30T02:00:07+0000");
  script_cve_id("CVE-2019-11500");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-08-30 02:00:07 +0000 (Fri, 30 Aug 2019)");
  script_tag(name:"creation_date", value:"2019-08-30 02:00:07 +0000 (Fri, 30 Aug 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1901-1] dovecot security update)");
  ...
  package(s) announced via the DSA-1901-1 advisory.");
