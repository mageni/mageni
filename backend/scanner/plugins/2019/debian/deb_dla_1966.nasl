...
if(description)
{
  ...
  script_version("2019-10-20T02:00:09+0000");
  script_cve_id("CVE-2019-17544");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-10-20 02:00:09 +0000 (Sun, 20 Oct 2019)");
  script_tag(name:"creation_date", value:"2019-10-20 02:00:09 +0000 (Sun, 20 Oct 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1966-1] aspell security update)");
  ...
  package(s) announced via the DSA-1966-1 advisory.");
