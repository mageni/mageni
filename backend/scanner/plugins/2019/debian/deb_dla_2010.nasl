...
if(description)
{
  ...
  script_version("2019-11-27T03:00:13+0000");
  script_cve_id("CVE-2014-9862");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-27 03:00:13 +0000 (Wed, 27 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-27 03:00:13 +0000 (Wed, 27 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2010-1] bsdiff security update)");
  ...
  package(s) announced via the DSA-2010-1 advisory.");
