...
if(description)
{
  ...
  script_version("2019-06-01T09:22:42+0000");
  script_cve_id("CVE-2016-10245");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-06-01 09:22:42 +0000 (Sat, 01 Jun 2019)");
  script_tag(name:"creation_date", value:"2019-06-01 09:22:42 +0000 (Sat, 01 Jun 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1812-1] doxygen security update)");
  ...
  package(s) announced via the DSA-1812-1 advisory.");
