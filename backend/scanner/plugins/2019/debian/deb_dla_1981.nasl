...
if(description)
{
  ...
  script_version("2019-11-06T03:00:20+0000");
  script_cve_id("CVE-2019-14866");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-11-06 03:00:20 +0000 (Wed, 06 Nov 2019)");
  script_tag(name:"creation_date", value:"2019-11-06 03:00:20 +0000 (Wed, 06 Nov 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1981-1] cpio security update)");
  ...
  package(s) announced via the DSA-1981-1 advisory.");
