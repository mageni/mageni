...
if(description)
{
  ...
  script_version("2019-03-29T15:44:25+0000");
  script_cve_id("CVE-2016-10743");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-03-29 15:44:25 +0000 (Fri, 29 Mar 2019)");
  script_tag(name:"creation_date", value:"2019-03-27 23:00:00 +0100 (Wed, 27 Mar 2019)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1733-1] wpa security update)");
  ...
  package(s) announced via the DSA-1733-1 advisory.");
