...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libnss3", ver:"2:3.26-1+debu8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-1d", ver:"2:3.26-1+debu8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-dbg", ver:"2:3.26-1+debu8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-dev", ver:"2:3.26-1+debu8u4", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libnss3-tools", ver:"2:3.26-1+debu8u4", rls:"DEB8")) != NULL) {
  report += res;
}
