...
if(description)
{
  ...
  script_version("2019-09-26T05:55:57+0000");
  script_tag(name:"last_modification", value:"2019-09-26 05:55:57 +0000 (Thu, 26 Sep 2019)");
  ...
  script_name("vBulletin 5.x <= 5.5.4 RCE Vulnerability");
  ...
  script_tag(name:"affected", value:"vBulletin versions 5.x.x.");

  script_tag(name:"solution", value:"No known solution is available as of 25th September, 2019.
...
foreach pattern(keys(final_checks)) {
  ...
  if (egrep(pattern:pattern, string:res)) {
    ...
    info['2. URL'] = report_vuln_url( port:port, url:url, url_only:TRUE );
