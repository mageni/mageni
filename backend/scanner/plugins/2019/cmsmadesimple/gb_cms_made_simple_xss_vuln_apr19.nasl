...
if(description)
{
  ...
  script_version("2019-04-29T12:25:46+0000");
  script_tag(name:"last_modification", value:"2019-04-29 12:25:46 +0000 (Mon, 29 Apr 2019)");
  ...
  script_cve_id("CVE-2019-11513");

  script_name("CMS Made Simple <= 2.2.10 Reflected Cross-Site Scripting (XSS) Vulnerability");
  ...
  script_tag(name:"insight", value:"The File Manager is prone to reflected XSS via the 'New Name' field in a Rename action.");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 29th April, 2019.
