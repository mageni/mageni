...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815623");
  ...
  script_name("Microsoft Windows Scripting Engine Memory Corruption Vulnerability (KB4522014)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4522014");
  ...
  script_tag(name:"affected", value:"Internet Explorer 11 on Windows 10 Version 1803 x32/x64");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4522014");
...
if(version_in_range(version:fileVer, test_version:"11.0.17134.0", test_version2:"11.0.17134.1006"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Edgehtml.dll",
                            file_version:fileVer, vulnerable_range:"11.0.17134.0 - 11.0.17134.1006");
