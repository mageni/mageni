...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple flaws exists when the Excel software
...
if(offVer =~ "^1[56]\.")
{
  if(version_is_less_equal(version:offVer, test_version:"16.16.14")||
     version_in_range(version:offVer, test_version:"16.17.0", test_version2:"16.29.1"))
  {
