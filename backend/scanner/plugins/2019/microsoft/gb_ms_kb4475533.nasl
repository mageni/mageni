...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815525");
  ...
  script_tag(name:"creation_date", value:"2019-08-14 10:51:03 +0530 (Wed, 14 Aug 2019)");
  script_name("Microsoft Word 2010 Service Pack 2 Remote Code Execution Vulnerability (KB4475533)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4475533");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475533");
...
if(exeVer =~ "^14\." && version_is_less(version:exeVer, test_version:"14.0.7236.5000"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"14.0 - 14.0.7236.4999");
