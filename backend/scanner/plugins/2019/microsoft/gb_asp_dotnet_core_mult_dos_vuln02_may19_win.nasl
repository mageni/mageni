...
if(description)
{
  ...
  script_tag(name:"affected", value:"ASP.NET Core 2.1.x prior to version 2.1.11
  and 2.2.x prior to version 2.2.5");

  script_tag(name:"solution", value:"Upgrade to ASP.NET Core 2.1.11 or 2.2.5 or
...
if(coreVers =~ "^2\.2" && version_is_less(version:coreVers, test_version:"2.2.5")){
  fix = "2.2.5";
}

else if (coreVers =~ "^2\.1" && version_is_less(version:coreVers, test_version:"2.1.11")){
  fix = "2.1.11";
}
