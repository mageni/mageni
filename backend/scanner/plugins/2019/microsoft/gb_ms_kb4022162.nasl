...
if(description)
{
  ...
  update according to Microsoft KB4022162");
  ...
  script_tag(name:"impact", value:"Successful exploitation will allow an attacke
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4022162");
