...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815677");
  ...
  script_name("Microsoft PowerPoint 2013 Service Pack 1 RCE Vulnerability (KB4461590)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4461590");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to errors in Microsoft
  PowerPoint software when the software fails to properly handle objects in
  memory.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4461590");
...
foreach key(key_list)
{
  ...
  if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5197.1000"))
  {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll",
                            file_version:exeVer, vulnerable_range:"15.0 - 15.0.5197.0999");
