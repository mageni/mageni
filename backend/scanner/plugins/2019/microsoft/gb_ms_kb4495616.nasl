...
if(description)
{
  ...
  update according to Microsoft KB4495616");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4495616");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ## https://support.microsoft.com/en-us/help/4495616
