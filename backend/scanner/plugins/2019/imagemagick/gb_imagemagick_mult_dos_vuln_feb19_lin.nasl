...
if( description )
{
  script_oid("1.3.6.1.4.1.25623.1.0.107609");
  script_version("$Revision: 14068 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-09 19:17:11 +0100 (Sat, 09 Mar 2019) $");
  script_tag(name:"creation_date", value:"2019-03-09 19:01:00 +0100 (Sat, 09 Mar 2019)");
  ...
  script_name("ImageMagick < 7.0.8-25 Multiple Vulnerabilities (Linux)");
