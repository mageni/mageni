...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815445");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_26-2019-08)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 76.0.3809.132 on Linux");
...
if(version_is_less(version:chr_ver, test_version:"76.0.3809.132"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"76.0.3809.132", install_path:chr_path);
