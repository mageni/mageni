...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815846");
  ...
  script_tag(name:"creation_date", value:"2019-11-15 15:54:20 +0530 (Fri, 15 Nov 2019)");
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_2019-11)-Mac OS X");
...
if(version_is_less(version:chr_ver, test_version:"78.0.3904.97"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"78.0.3904.97", install_path:chr_path);
