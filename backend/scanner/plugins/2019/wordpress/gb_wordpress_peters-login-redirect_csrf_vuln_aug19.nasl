...
if(description)
{
  ...
  script_version("2019-09-02T11:25:31+0000");
  script_tag(name:"last_modification", value:"2019-09-02 11:25:31 +0000 (Mon, 02 Sep 2019)");
...
url = dir + "/wp-content/plugins/peters-login-redirect/readme.txt";
res = http_get_cache( port: port, item: url );

if( "Defining redirect rules per role" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.9.2" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.9.2", file_checked: url );
