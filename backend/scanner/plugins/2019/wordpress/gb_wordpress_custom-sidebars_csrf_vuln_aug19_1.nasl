...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.113477");
  ...
  script_cve_id("CVE-2017-18511");

  script_name("Wordpress Custom Sidebars Plugin < 3.0.8.1 CSRF Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress Custom Sidebars plugin through version 3.0.8.");
...
if( "=== Custom Sidebars" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: vers[1], test_version: "3.0.8.1" ) ) {
    report = report_fixed_ver( installed_version: vers[1], fixed_version: "3.0.8.1", file_checked: url );
