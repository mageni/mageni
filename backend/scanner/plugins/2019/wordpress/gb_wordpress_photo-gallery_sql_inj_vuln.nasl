...
if (description)
{
  ...
  script_version("2019-08-01T09:34:27+0000");
  script_tag(name:"last_modification", value:"2019-08-01 09:34:27 +0000 (Thu, 01 Aug 2019)");
...
if ((res =~ "Photo Gallery by (WD|10Web) - Responsive (Photo|Image) Gallery" || "=== Gallery ===" >< res ||
  ...
  if (!isnull(vers[1])) {
    if (version_is_less(version: vers[1], test_version: "1.5.31")) {
      report = report_fixed_ver(installed_version: vers[1], fixed_version: "1.5.31", file_checked: url);
