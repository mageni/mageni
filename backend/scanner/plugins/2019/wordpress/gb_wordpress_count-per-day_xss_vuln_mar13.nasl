...
if (description)
{
  ...
  script_version("2019-06-17T11:01:05+0000");
  script_tag(name:"last_modification", value:"2019-06-17 11:01:05 +0000 (Mon, 17 Jun 2019)");
...
url = dir + "/wp-content/plugins/count-per-day/readme.txt";
...
if("=== Count per Day ===" >< res && "Changelog" >< res) {
  ...
  if(vers[1] && version_is_less(version: vers[1], test_version: "3.2.6")) {
    report = report_fixed_ver(installed_version: vers[1], fixed_version: "3.2.6", file_checked: url);
