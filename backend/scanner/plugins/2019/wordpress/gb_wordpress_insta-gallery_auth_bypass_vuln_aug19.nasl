...
if(description)
{
  ...
  script_version("2019-09-11T10:30:52+0000");
  script_tag(name:"last_modification", value:"2019-09-11 10:30:52 +0000 (Wed, 11 Sep 2019)");
...
url = dir + "/wp-content/plugins/insta-gallery/readme.txt";
res = http_get_cache( port: port, item: url );

if( ( "Instagram Gallery" >< res || "=== WP Social Feed Gallery" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "2.4.8" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "2.4.8", file_checked: url );
