...
if(description)
{
  ...
  script_version("2019-08-27T12:37:10+0000");
  script_tag(name:"last_modification", value:"2019-08-27 12:37:10 +0000 (Tue, 27 Aug 2019)");
...
url = dir + "/wp-content/plugins/wp-editor/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== WP Editor" >< res && "Changelog" >< res ) {

  vers = eregmatch( pattern: "Stable tag: ([0-9.]+)", string: res );

  if( vers[1] && version_is_less( version: vers[1], test_version: "1.2.6" ) ) {
    report = report_fixed_ver( installed_version: vers[1], fixed_version: "1.2.6", file_checked: url );
