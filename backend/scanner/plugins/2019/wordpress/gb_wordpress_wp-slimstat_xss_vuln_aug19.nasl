...
if(description)
{
  ...
  script_version("2019-09-16T13:21:10+0000");
  script_tag(name:"last_modification", value:"2019-09-16 13:21:10 +0000 (Mon, 16 Sep 2019)");
...
url = dir + "/wp-content/plugins/wp-slimstat/readme.txt";
res = http_get_cache( port: port, item: url );

if( ( "=== WP SlimStat" >< res || "=== WP Slimstat" >< res || "=== Slimstat Analytics" >< res )
    && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "4.8.1" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "4.8.1", file_checked: url );
