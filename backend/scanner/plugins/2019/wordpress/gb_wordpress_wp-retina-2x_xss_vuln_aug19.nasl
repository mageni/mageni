...
if(description)
{
  ...
  script_version("2019-09-16T12:34:02+0000");
  script_tag(name:"last_modification", value:"2019-09-16 12:34:02 +0000 (Mon, 16 Sep 2019)");
...
url = dir + "/wp-content/plugins/wp-retina-2x/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== WP Retina 2x" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "5.2.3" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "5.2.3", file_checked: url );
