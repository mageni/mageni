...
url = dir + "/wp-content/plugins/one-click-ssl/readme.txt";
res = http_get_cache( port: port, item: url );

if( "=== One Click SSL" >< res && "Changelog" >< res ) {
  ...
  if( version_is_less( version: version, test_version: "1.4.7" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "1.4.7", file_checked: url );
