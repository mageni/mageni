...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876436");
  ...
  script_name("Fedora Update for drupal7-entity FEDORA-2019-2d831039a3");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OXF462NMKEKT6OQISEBZLYE3AOL47V5P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal7-entity'
  package(s) announced via the FEDORA-2019-2d831039a3 advisory.");
...
This package provides the following Drupal modules:
  ...
  * entity_token");
  ...
  script_tag(name:"affected", value:"'drupal7-entity' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal7-entity", rpm:"drupal7-entity~1.9~1.fc30", rls:"FC30"))) {
    report += res;
  }
