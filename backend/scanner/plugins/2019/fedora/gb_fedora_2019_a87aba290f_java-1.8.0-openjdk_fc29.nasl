...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876935");
  ...
  script_name("Fedora Update for java-1.8.0-openjdk FEDORA-2019-a87aba290f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3DJOJHUU3RYCBFA62WWVXCIUNDM7CUY2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk'
  package(s) announced via the FEDORA-2019-a87aba290f advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~1.8.0.232.b09~0.fc29", rls:"FC29"))) {
    report += res;
  }
