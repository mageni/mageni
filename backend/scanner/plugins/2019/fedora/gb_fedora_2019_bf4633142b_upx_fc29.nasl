...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876659");
  ...
  script_name("Fedora Update for upx FEDORA-2019-bf4633142b");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T52JATXV6NTPTMGXCRGT37H6KXERYNZN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'upx'
  package(s) announced via the FEDORA-2019-bf4633142b advisory.");
...
executables suffer no memory overhead or other drawbacks.");
  ...
  script_tag(name:"affected", value:"'upx' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"upx", rpm:"upx~3.95~4.fc29", rls:"FC29"))) {
    report += res;
  }
