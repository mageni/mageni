...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876791");
  ...
  script_name("Fedora Update for wordpress FEDORA-2019-d9677f2b92");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ATD2FDPTN6NQOECFPHSWOHYF23THMXBU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2019-d9677f2b92 advisory.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.2.3~1.fc30", rls:"FC30"))) {
    report += res;
  }
