...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876850");
  ...
  script_name("Fedora Update for znc FEDORA-2019-154930f99b");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NHR6OD52FQAG5ZPZ42NJM2T765C3V2XC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'znc'
  package(s) announced via the FEDORA-2019-154930f99b advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"znc", rpm:"znc~1.7.4~4.fc29", rls:"FC29"))) {
    report += res;
  }
