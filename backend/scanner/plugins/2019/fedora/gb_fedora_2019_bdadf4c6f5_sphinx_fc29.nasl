...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876800");
  ...
  script_tag(name:"creation_date", value:"2019-09-15 02:22:11 +0000 (Sun, 15 Sep 2019)");
  script_name("Fedora Update for sphinx FEDORA-2019-bdadf4c6f5");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XD25JJJVM7FFXAO2L3ZG2KXQ6UMFBIA4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sphinx'
  package(s) announced via the FEDORA-2019-bdadf4c6f5 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Sphinx is a full-text search engine, distributed under GPL version 2.
Commercial licensing (e.g. for embedded use) is also available upon request.

Generally, it&#39, s a standalone search engine, meant to provide fast,
...
Phrase Index. Yes, I know about CMU&#39, s Sphinx project.");

  script_tag(name:"affected", value:"'sphinx' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sphinx", rpm:"sphinx~2.2.11~12.fc29", rls:"FC29"))) {
    report += res;
  }
