...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876902");
  ...
  script_tag(name:"creation_date", value:"2019-10-12 02:30:30 +0000 (Sat, 12 Oct 2019)");
  script_name("Fedora Update for opendmarc FEDORA-2019-e1f0417a24");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PEUBIHJLMPMB6KHOSGDMUQKSAW4HOCYM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opendmarc'
  package(s) announced via the FEDORA-2019-e1f0417a24 advisory.");
...
/usr/share/opendmarc/contrib/rddmarc.");
  ...
  script_tag(name:"affected", value:"'opendmarc' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opendmarc", rpm:"opendmarc~1.3.2~1.fc29", rls:"FC29"))) {
    report += res;
  }
