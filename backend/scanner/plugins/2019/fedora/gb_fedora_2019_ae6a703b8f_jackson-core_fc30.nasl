...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876828");
  ...
  script_tag(name:"creation_date", value:"2019-09-23 02:27:41 +0000 (Mon, 23 Sep 2019)");
  script_name("Fedora Update for jackson-core FEDORA-2019-ae6a703b8f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FYVAAYS5J3ZXEGAB5XZPN3DZJS7MMAR2");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jackson-core", rpm:"jackson-core~2.9.9~1.fc30", rls:"FC30"))) {
    report += res;
  }
