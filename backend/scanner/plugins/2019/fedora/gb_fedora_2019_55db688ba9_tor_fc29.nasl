...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876210");
  script_version("2019-05-14T05:04:40+0000");
  script_cve_id("CVE-2019-8955");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-05-14 05:04:40 +0000 (Tue, 14 May 2019)");
  script_tag(name:"creation_date", value:"2019-05-07 02:39:00 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for tor FEDORA-2019-55db688ba9");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VLVYJHBVLJQQUELVJBQDQ3A2NWDQZXGM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2019-55db688ba9 advisory.");
...
Tor network, or as a client to connect to the Tor network.");
  ...
  script_tag(name:"affected", value:"'tor' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.3.5.8~1.fc29", rls:"FC29"))) {
    report += res;
  }
