...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876552");
  ...
  script_name("Fedora Update for glpi FEDORA-2019-169f1eec7c");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MTBJ3ZKYPTNOTZISCKUQ7YCU5D2GGG65");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glpi'
  package(s) announced via the FEDORA-2019-169f1eec7c advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glpi", rpm:"glpi~9.3.4~2.fc29", rls:"FC29"))) {
    report += res;
  }
