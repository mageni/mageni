...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876583");
  ...
  script_tag(name:"creation_date", value:"2019-07-20 02:14:40 +0000 (Sat, 20 Jul 2019)");
  script_name("Fedora Update for kernel-headers FEDORA-2019-a95015e60f");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HAGNIT3C65FUF4X45DJQH6KQWMU5IRSC");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.1.18~200.fc29", rls:"FC29"))) {
    report += res;
  }
