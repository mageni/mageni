...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876655");
  ...
  script_name("Fedora Update for aubio FEDORA-2019-00ca0acb47");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IYIKPYXZIWYWWNNORSKWRCFFCP6AFMRZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'aubio'
  package(s) announced via the FEDORA-2019-00ca0acb47 advisory.");
...
virtual instruments.");
  ...
  script_tag(name:"affected", value:"'aubio' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aubio", rpm:"aubio~0.4.9~1.fc30", rls:"FC30"))) {
    report += res;
  }
