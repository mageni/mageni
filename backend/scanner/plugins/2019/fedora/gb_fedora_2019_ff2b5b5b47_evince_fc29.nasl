...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876533");
  ...
  script_tag(name:"creation_date", value:"2019-06-25 02:17:38 +0000 (Tue, 25 Jun 2019)");
  script_name("Fedora Update for evince FEDORA-2019-ff2b5b5b47");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YJ6R7NMY44IHIQIY24CV3WV2GLGJPQPZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the
  'evince' package(s) announced via the FEDORA-2019-ff2b5b5b47 advisory.");
...
installing additional backends.");
  ...
  script_tag(name:"affected", value:"'evince' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"evince", rpm:"evince~3.30.2~4.fc29", rls:"FC29"))) {
    report += res;
  }
