...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FP6BFQUPQRVRRFIYHFWWB6RHJNEB4LGQ");

  script_tag(name:"summary", value:"The remote host is missing an update
  for the 'gvfs' package(s) announced via the FEDORA-2019-e6b02af8b8 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version
  is present on the target host.");

  script_tag(name:"insight", value:"The gvfs package provides backend
  implementations for the gio framework in GLib. It includes ftp, sftp, cifs.");

  script_tag(name:"affected", value:"'gvfs' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gvfs", rpm:"gvfs~1.38.3~1.fc29", rls:"FC29"))) {
    report += res;
  }
