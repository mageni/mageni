...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875563");
  ...
  script_tag(name:"creation_date", value:"2019-04-17 02:11:38 +0000 (Wed, 17 Apr 2019)");
  script_name("Fedora Update for php FEDORA-2019-253da50ddd");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MDGIPABROE3CQSB3PNGEE6ARASTKLKKB");

  script_tag(name:"summary", value:"The remote host is missing an update for the
  'php' package(s) announced via the FEDORA-2019-253da50ddd advisory.");
...
if(release == "FC28") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php", rpm:"php~7.2.17~1.fc28", rls:"FC28"))) {
    report += res;
  }
