...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875811");
  ...
  script_name("Fedora Update for drupal8 FEDORA-2018-4381dd7d0b");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/X2WIO3KMAUWWC3PZWVLHKUEVC6W5KGVB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal8'
  package(s) announced via the FEDORA-2018-4381dd7d0b advisory.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal8", rpm:"drupal8~8.6.2~1.fc29", rls:"FC29"))) {
    report += res;
  }
