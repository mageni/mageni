...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876031");
  ...
  script_tag(name:"creation_date", value:"2019-05-07 02:32:19 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for podofo FEDORA-2019-023ea18e20");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5Z7UF3AC76HHLSAHVBUQWMYXHR33DR34");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podofo", rpm:"podofo~0.9.6~6.fc29", rls:"FC29"))) {
    report += res;
  }
