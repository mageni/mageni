...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.875860");
  ...
  script_tag(name:"creation_date", value:"2019-05-07 02:24:27 +0000 (Tue, 07 May 2019)");
  script_name("Fedora Update for hostapd FEDORA-2019-f409af9fbe");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TDOZGR3T7FVO5JSZWK2QPR7AOFIEJTIZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'hostapd'
  package(s) announced via the FEDORA-2019-f409af9fbe advisory.");
...
included with hostapd.");
  ...
  script_tag(name:"affected", value:"'hostapd' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"hostapd", rpm:"hostapd~2.7~2.fc29", rls:"FC29"))) {
    report += res;
  }
