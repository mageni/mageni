...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877018");
  ...
  script_tag(name:"creation_date", value:"2019-11-21 03:39:14 +0000 (Thu, 21 Nov 2019)");
  script_name("Fedora Update for libmp4v2 FEDORA-2019-6469ad8129");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GISUIWPKBWPXORUFNWBGFTKQS7UUVUC4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmp4v2'
  package(s) announced via the FEDORA-2019-6469ad8129 advisory.");
...
and is an exact copy of the library distributed in the mpeg4ip package.");
  ...
  script_tag(name:"affected", value:"'libmp4v2' package(s) on Fedora 29.");
...
if(release == "FC29") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmp4v2", rpm:"libmp4v2~2.1.0~0.19.trunkREV507.fc29", rls:"FC29"))) {
    report += res;
  }
