...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KDFQHFWQSTST6R3XQHNFGGVOO7ABSIPZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kea'
  package(s) announced via the FEDORA-2019-0811a88d77 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"DHCP implementation from Internet Systems Consortium, Inc. that features fully
...
servers support DNS Update mechanism, using stand-alone DDNS daemon.");
  ...
  script_tag(name:"affected", value:"'kea' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kea", rpm:"kea~1.5.0~9.fc30", rls:"FC30"))) {
    report += res;
  }
