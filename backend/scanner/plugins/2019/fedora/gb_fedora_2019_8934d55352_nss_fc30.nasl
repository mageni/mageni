...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.876961");
  ...
  script_name("Fedora Update for nss FEDORA-2019-8934d55352");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NVN4GML7DGTEWR34OKQZA5O7Y6ZVCZYX");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss", rpm:"nss~3.47.0~2.fc30", rls:"FC30"))) {
    report += res;
  }
