...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815256");
  ...
  script_name("VLC Media Player Heap Overflow Vulnerability Jul19 (Mac OS X)");
  ...
  script_tag(name:"affected", value:"VideoLAN VLC media player version 3.0.7.1 on Mac OS X.");
