...
# $Id: gb_open_xchange_appsuite_58226.nasl 13455 2019-02-05 07:38:02Z mmartin $
#
# Open-Xchange (OX) AppSuite Multiple Vulnerabilities (58226, 58096)
#
# Authors:
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.141834");
  script_version("$Revision: 13455 $");
  script_tag(name:"last_modification", value:"$Date: 2019-02-05 08:38:02 +0100 (Tue, 05 Feb 2019) $");
  script_tag(name:"creation_date", value:"2019-01-07 16:07:01 +0700 (Mon, 07 Jan 2019)");
  ...
  script_name("Open-Xchange (OX) AppSuite Multiple Vulnerabilities (58226, 58096)");
  ...
  - Cross-Site Scripting (BugID: 58096, 58226)");

  script_tag(name:"affected", value:"OX AppSuite version 7.8.4 and prior.");

  script_tag(name:"solution", value:"Update to version 7.8.4-rev34, 7.8.3-rev43, 7.6.3-rev33 or later.");
...
if (version_is_less(version: version, test_version: "7.6.3.33")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.6.3.33");
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "7.6.4", test_version2: "7.8.3.42")) {
