...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.142679");
  script_version("2019-07-31T02:28:41+0000");
  script_tag(name:"last_modification", value:"2019-07-31 02:28:41 +0000 (Wed, 31 Jul 2019)");
  script_tag(name:"creation_date", value:"2019-07-31 02:10:42 +0000 (Wed, 31 Jul 2019)");
  ...
  script_name("Jenkins < 2.186 and < 2.176.2 LTS Multiple Vulnerabilities (Linux)");
