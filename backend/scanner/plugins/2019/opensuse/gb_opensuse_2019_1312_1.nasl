...
if(description)
{
  ...
  script_name("openSUSE Update for dovecot23 openSUSE-SU-2019:1312-1 (dovecot23)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00000.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot23'
  package(s) announced via the openSUSE-SU-2019:1312_1 advisory.");
