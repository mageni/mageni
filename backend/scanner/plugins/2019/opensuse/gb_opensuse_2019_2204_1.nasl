...
if(description)
{
  ...
  script_name("openSUSE Update for expat openSUSE-SU-2019:2204-1 (expat)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00080.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the openSUSE-SU-2019:2204_1 advisory.");
