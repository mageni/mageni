...
if(description)
{
  ...
  script_name("openSUSE Update for polkit openSUSE-SU-2019:1914-1 (polkit)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00049.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'polkit'
  package(s) announced via the openSUSE-SU-2019:1914_1 advisory.");
