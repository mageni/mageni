...
if(description)
{
  ...
  script_name("openSUSE Update for libtasn1 openSUSE-SU-2019:1510-1 (libtasn1)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00018.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libtasn1'
  package(s) announced via the openSUSE-SU-2019:1510_1 advisory.");
