...
if(description)
{
  ...
  script_name("openSUSE Update for java-1_7_0-openjdk openSUSE-SU-2019:1500-1 (java-1_7_0-openjdk)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00013.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1_7_0-openjdk'
  package(s) announced via the openSUSE-SU-2019:1500_1 advisory.");
