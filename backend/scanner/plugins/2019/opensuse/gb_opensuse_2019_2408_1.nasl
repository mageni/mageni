...
if(description)
{
  ...
  script_name("openSUSE Update for nfs-utils openSUSE-SU-2019:2408-1 (nfs-utils)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00071.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nfs-utils'
  package(s) announced via the openSUSE-SU-2019:2408_1 advisory.");
