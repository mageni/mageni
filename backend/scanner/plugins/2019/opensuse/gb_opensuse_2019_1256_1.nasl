...
if(description)
{
  ...
  script_name("openSUSE Update for php5 openSUSE-SU-2019:1256-1 (php5)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00083.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php5'
  package(s) announced via the openSUSE-SU-2019:1256_1 advisory.");
