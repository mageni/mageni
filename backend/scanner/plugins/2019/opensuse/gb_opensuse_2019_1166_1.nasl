...
if(description)
{
  ...
  script_version("2019-04-06T02:01:20+0000");
  script_cve_id("CVE-2019-9917");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2019-04-06 02:01:20 +0000 (Sat, 06 Apr 2019)");
  script_tag(name:"creation_date", value:"2019-04-06 02:01:20 +0000 (Sat, 06 Apr 2019)");
  script_name("openSUSE Update for znc openSUSE-SU-2019:1166-1 (znc)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00037.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'znc'
  package(s) announced via the openSUSE-SU-2019:1166_1 advisory.");
