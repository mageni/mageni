...
if(description)
{
  ...
  script_name("openSUSE Update for python-urllib3 openSUSE-SU-2019:2131-1 (python-urllib3)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00039.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-urllib3'
  package(s) announced via the openSUSE-SU-2019:2131_1 advisory.");
