...
if(description)
{
  ...
  script_name("openSUSE Update for LibreOffice openSUSE-SU-2019:1929-1 (LibreOffice)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00059.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'LibreOffice'
  package(s) announced via the openSUSE-SU-2019:1929_1 advisory.");
