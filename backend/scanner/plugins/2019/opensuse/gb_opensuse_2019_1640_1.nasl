...
if(description)
{
  ...
  script_name("openSUSE Update for libssh2_org openSUSE-SU-2019:1640-1 (libssh2_org)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00072.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh2_org'
  package(s) announced via the openSUSE-SU-2019:1640_1 advisory.");
