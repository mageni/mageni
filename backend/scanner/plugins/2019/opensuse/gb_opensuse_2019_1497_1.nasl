...
if(description)
{
  ...
  script_name("openSUSE Update for axis openSUSE-SU-2019:1497-1 (axis)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'axis'
  package(s) announced via the openSUSE-SU-2019:1497_1 advisory.");
