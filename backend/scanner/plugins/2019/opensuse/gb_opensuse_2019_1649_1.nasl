...
if(description)
{
  ...
  script_name("openSUSE Update for exempi openSUSE-SU-2019:1649-1 (exempi)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00075.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'exempi'
  package(s) announced via the openSUSE-SU-2019:1649_1 advisory.");
