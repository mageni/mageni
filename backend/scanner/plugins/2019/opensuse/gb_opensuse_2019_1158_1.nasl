...
if(description)
{
  ...
  script_name("openSUSE Update for ntp openSUSE-SU-2019:1158-1 (ntp)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00036.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp'
  package(s) announced via the openSUSE-SU-2019:1158_1 advisory.");
