...
if(description)
{
  ...
  script_name("openSUSE Update for ImageMagick openSUSE-SU-2019:1331-1 (ImageMagick)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00010.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ImageMagick'
  package(s) announced via the openSUSE-SU-2019:1331_1 advisory.");
