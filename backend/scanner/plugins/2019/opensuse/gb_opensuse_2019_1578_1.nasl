...
if(description)
{
  ...
  script_name("openSUSE Update for postgresql10 openSUSE-SU-2019:1578-1 (postgresql10)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql10'
  package(s) announced via the openSUSE-SU-2019:1578_1 advisory.");
