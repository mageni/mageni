...
if(description)
{
  ...
  script_name("openSUSE Update for sqlite3 openSUSE-SU-2019:1372-1 (sqlite3)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00026.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sqlite3'
  package(s) announced via the openSUSE-SU-2019:1372_1 advisory.");
