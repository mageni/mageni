...
if(description)
{
  ...
  script_name("openSUSE Update for gnutls openSUSE-SU-2019:1477-1 (gnutls)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00068.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls'
  package(s) announced via the openSUSE-SU-2019:1477_1 advisory.");
