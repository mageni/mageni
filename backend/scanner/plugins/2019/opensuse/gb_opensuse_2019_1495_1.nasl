...
if(description)
{
  ...
  script_name("openSUSE Update for Recommended openSUSE-SU-2019:1495-1 (Recommended)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00004.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Recommended'
  package(s) announced via the openSUSE-SU-2019:1495_1 advisory.");
