...
if(description)
{
  ...
  script_name("openSUSE Update for libqt5-qtbase openSUSE-SU-2019:1239-1 (libqt5-qtbase)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00080.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libqt5-qtbase'
  package(s) announced via the openSUSE-SU-2019:1239_1 advisory.");
