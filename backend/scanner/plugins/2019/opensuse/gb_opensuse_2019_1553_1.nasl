...
if(description)
{
  ...
  script_name("openSUSE Update for rubygem-rack openSUSE-SU-2019:1553-1 (rubygem-rack)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00032.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-rack'
  package(s) announced via the openSUSE-SU-2019:1553_1 advisory.");
