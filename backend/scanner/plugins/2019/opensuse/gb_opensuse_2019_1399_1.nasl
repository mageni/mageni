...
if(description)
{
  ...
  script_name("openSUSE Update for jakarta-commons-fileupload openSUSE-SU-2019:1399-1 (jakarta-commons-fileupload)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00036.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jakarta-commons-fileupload'
  package(s) announced via the openSUSE-SU-2019:1399_1 advisory.");
