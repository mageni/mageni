...
if(description)
{
  ...
  script_name("openSUSE Update for aubio openSUSE-SU-2019:1834-1 (aubio)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00003.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'aubio'
  package(s) announced via the openSUSE-SU-2019:1834_1 advisory.");
