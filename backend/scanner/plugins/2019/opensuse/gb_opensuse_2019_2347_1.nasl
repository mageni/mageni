...
if(description)
{
  ...
  script_name("openSUSE Update for lighttpd openSUSE-SU-2019:2347-1 (lighttpd)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00054.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lighttpd'
  package(s) announced via the openSUSE-SU-2019:2347_1 advisory.");
