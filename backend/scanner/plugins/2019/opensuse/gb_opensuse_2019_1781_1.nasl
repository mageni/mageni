...
if(description)
{
  ...
  script_name("openSUSE Update for bzip2 openSUSE-SU-2019:1781-1 (bzip2)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00040.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bzip2'
  package(s) announced via the openSUSE-SU-2019:1781_1 advisory.");
