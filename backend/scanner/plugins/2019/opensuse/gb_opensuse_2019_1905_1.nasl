...
if(description)
{
  ...
  script_name("openSUSE Update for dosbox openSUSE-SU-2019:1905-1 (dosbox)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00047.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dosbox'
  package(s) announced via the openSUSE-SU-2019:1905_1 advisory.");
