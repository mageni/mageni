...
if(description)
{
  ...
  script_name("openSUSE Update for gstreamer-0_10-plugins-base openSUSE-SU-2019:1638-1 (gstreamer-0_10-plugins-base)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00082.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer-0_10-plugins-base'
  package(s) announced via the openSUSE-SU-2019:1638_1 advisory.");
