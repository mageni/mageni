...
if(description)
{
  ...
  script_name("openSUSE Update for xen openSUSE-SU-2019:1403-1 (xen)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-05/msg00038.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen'
  package(s) announced via the openSUSE-SU-2019:1403_1 advisory.");
