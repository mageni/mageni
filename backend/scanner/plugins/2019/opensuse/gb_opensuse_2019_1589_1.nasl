...
if(description)
{
  ...
  script_name("openSUSE Update for sssd openSUSE-SU-2019:1589-1 (sssd)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-06/msg00051.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sssd'
  package(s) announced via the openSUSE-SU-2019:1589_1 advisory.");
