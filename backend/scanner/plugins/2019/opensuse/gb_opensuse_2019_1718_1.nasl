...
if(description)
{
  ...
  script_name("openSUSE Update for libqb openSUSE-SU-2019:1718-1 (libqb)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-07/msg00017.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libqb'
  package(s) announced via the openSUSE-SU-2019:1718_1 advisory.");
