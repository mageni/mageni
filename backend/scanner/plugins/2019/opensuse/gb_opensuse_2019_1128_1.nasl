...
if(description)
{
  ...
  script_version("2019-04-04T02:03:47+0000");
  script_cve_id("CVE-2019-3871");
  script_tag(name:"cvss_base", value:"6.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2019-04-04 02:03:47 +0000 (Thu, 04 Apr 2019)");
  script_tag(name:"creation_date", value:"2019-04-04 02:03:47 +0000 (Thu, 04 Apr 2019)");
  script_name("openSUSE Update for pdns openSUSE-SU-2019:1128-1 (pdns)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-04/msg00024.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pdns'
  package(s) announced via the openSUSE-SU-2019:1128_1 advisory.");
