...
if(description)
{
  ...
  script_name("openSUSE Update for containerd, openSUSE-SU-2019:2021-1 (containerd, )");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00084.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd, '
  package(s) announced via the openSUSE-SU-2019:2021_1 advisory.");
