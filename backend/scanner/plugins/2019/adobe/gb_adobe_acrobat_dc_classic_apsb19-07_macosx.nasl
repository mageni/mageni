...
if(version_is_less(version:readerVer, test_version:"15.006.30475"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"15.006.30475", install_path:InstallPath);
