...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815099");
  ...
  script_tag(name:"creation_date", value:"2019-06-12 11:58:07 +0530 (Wed, 12 Jun 2019)");
  script_name("Adobe Flash Player Within Google Chrome Security Update(apsb19-30)- MAC OS X");
