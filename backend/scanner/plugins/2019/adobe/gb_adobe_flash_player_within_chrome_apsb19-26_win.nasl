...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815056");
  ...
  script_tag(name:"creation_date", value:"2019-05-15 12:43:13 +0530 (Wed, 15 May 2019)");
  script_name("Adobe Flash Player Within Google Chrome Security Update(apsb19-26)- Windows");
