...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815690");
  ...
  script_name("Adobe Acrobat DC (Continuous) Security Updates(apsb19-55)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat DC 2019 (Continuous Track)
  prior to version 2019.021.20058 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade Adobe Acrobat DC 2019 (Continuous)
...
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"19.021.20057 (2019.021.20058)", install_path:InstallPath);
