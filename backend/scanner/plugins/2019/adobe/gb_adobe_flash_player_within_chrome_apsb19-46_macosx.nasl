...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815469");
  ...
  script_tag(name:"creation_date", value:"2019-09-11 12:21:08 +0530 (Wed, 11 Sep 2019)");
  script_name("Adobe Flash Player Within Google Chrome Security Update(apsb19-46)- MAC OS X");
