...
if(description)
{
  ...
  script_name("Mozilla Firefox Security Updates( mfsa_2019-33_2019-34 )-Windows");
  ...
  execute arbitrary code, bypass security restrictions and conduct
  cross-site scripting attacks.");

  script_tag(name:"affected", value:"Mozilla Firefox version before 70 on Windows.");
