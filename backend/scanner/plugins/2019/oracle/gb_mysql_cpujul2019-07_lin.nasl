...
if (description)
{
  ...
  script_name("Oracle MySQL Server 8.0 <= 8.0.12 Security Update (cpujul2019) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 8.0 through 8.0.12.");
