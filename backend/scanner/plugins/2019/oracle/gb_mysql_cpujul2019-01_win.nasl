...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.142643");
  script_version("2021-02-12T10:44:24+0000");
  script_tag(name:"last_modification", value:"2021-02-15 11:14:46 +0000 (Mon, 15 Feb 2021)");
  script_tag(name:"creation_date", value:"2019-07-23 09:59:11 +0000 (Tue, 23 Jul 2019)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:P/A:N");

  script_cve_id("CVE-2019-2730");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server <= 5.6.44 / 5.7 <= 5.7.18 Security Update (cpujul2019) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.6.44 and prior and 5.7 through 5.7.18.");

  script_tag(name:"solution", value:"Update to version 5.6.45, 5.7.19 or later.");
...
if (version_in_range(version: version, test_version: "5.7", test_version2: "5.7.18")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.7.19", install_path: path);
  security_message(port: port, data: report);
  exit(0);
}
