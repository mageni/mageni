...
if(description)
{
  ...
  script_name("Ubuntu Update for libreoffice USN-4102-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-August/005073.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice'
  package(s) announced via the USN-4102-1 advisory.");
