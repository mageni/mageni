...
if(description)
{
  ...
  script_name("Ubuntu Update for graphicsmagick USN-4207-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-December/005232.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphicsmagick'
  package(s) announced via the USN-4207-1 advisory.");
...
unspecified impact.");
  ...
  script_tag(name:"affected", value:"'graphicsmagick' package(s) on Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"-q16-12", ver:"1.3.28-2ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
