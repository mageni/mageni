...
if(description)
{
  ...
  script_cve_id("CVE-2019-14744", "CVE-2016-6232");
  ...
  script_name("Ubuntu Update for kconfig USN-4100-1");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2019-August/005072.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kconfig'
  package(s) announced via the USN-4100-1 advisory.");
...
arbitrary files via a ../ in a filename in an archive file. (CVE-2016-6232)");
  ...
  script_tag(name:"affected", value:"'kconfig' package(s) on Ubuntu 19.04, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
