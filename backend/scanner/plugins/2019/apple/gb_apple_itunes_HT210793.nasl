...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://support.apple.com/en-in/HT210793");
  script_xref(name:"URL", value:"https://www.apple.com/itunes/");
...
if(version_is_less(version:ituneVer, test_version:"12.10.3"))
{
  report = report_fixed_ver(installed_version: ituneVer, fixed_version:"12.10.3", install_path: itunePath);
