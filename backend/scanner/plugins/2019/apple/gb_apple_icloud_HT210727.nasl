...
if(description)
{
  ...
  script_tag(name:"affected", value:"Apple iCloud version 10.x before 11.0 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Apple iCloud 11.0 or later.
  Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://support.apple.com/en-in/HT210727");
...
if(hotfix_check_sp(win10:1, win10x64:1) <= 0)  exit(0);
...
# iCloud for Window 10 works with the May 2019 Update version of Microsoft Windows 10 and later versions of Microsoft Windows 10
# https://support.microsoft.com/en-in/help/4028685/windows-10-get-the-update
if(version_is_less(version:edgeVer, test_version:"11.0.18362.0")){
  exit(0);
}
...
if(icVer =~ "^10\.")
{
  report = report_fixed_ver(installed_version:icVer, fixed_version:"11.0", install_path:icPath);
