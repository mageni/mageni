...
# $Id: gb_paypal_merchant-sdk-php_detect.nasl 5449 2017-03-01 07:07:26Z cfi $
#
...
if(description)
{
  ...
  script_version("$Revision: 5449 $");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"$Date: 2017-03-01 08:07:26 +0100 (Wed, 01 Mar 2017) $");
  ...
  PayPal PHP Merchant SDK and sets the result in KB.");
...
foreach dir( make_list_unique( "/merchant-sdk-php" , "/paypal", cgi_dirs( port:port ) ) ) {
  ...
  if( res =~ "HTTP/1\.. 200" && ( '"name": "paypal/merchant-sdk-php",' >< res ||
    ...
    if( res =~ "HTTP/1\.. 200" && ! isnull( vers[1] ) ) {
      version = vers[1];
