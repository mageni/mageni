...
# $Id: gb_logix_designer_compare_tool_detect_win.nasl 13196 2019-01-21 13:47:03Z mmartin $
#
# Rockwell Automation Logix Designer Compare Tool Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 13196 $");
  script_tag(name:"last_modification", value:"$Date: 2019-01-21 14:47:03 +0100 (Mon, 21 Jan 2019) $");
  script_tag(name:"creation_date", value:"2019-01-21 14:46:26 +0100 (Mon, 21 Jan 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("Rockwell Automation Logix Designer Compare Tool Version Detection (Windows)");
  ...
  of Rockwell Automation Logix Designer Compare Tool for Windows.");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "Logix Designer Compare Tool") continue;
