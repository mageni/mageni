...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-7329";
tag_summary = "The remote host is missing an update to phpMyAdmin
announced via advisory FEDORA-2009-7329.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306087");
 ...
 script_name("Fedora Core 11 FEDORA-2009-7329 (phpMyAdmin)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.2.0.1~1.fc11", rls:"FC11")) != NULL) {
    report += res;
}
