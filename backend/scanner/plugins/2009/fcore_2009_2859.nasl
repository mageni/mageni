...
# $Id: fcore_2009_2859.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311635");
 ...
 script_name("Fedora Core 10 FEDORA-2009-2859 (weechat)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"weechat", rpm:"weechat~0.2.6.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"weechat-debuginfo", rpm:"weechat-debuginfo~0.2.6.1~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
