...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-July/msg00036.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309343");
  script_version("$Revision: 6683 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-12 11:41:57 +0200 (Wed, 12 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-03-06 07:30:35 +0100 (Fri, 06 Mar 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "RHSA", value: "2008:0486-01");
  script_cve_id("CVE-2008-1376");
  script_name( "RedHat Update for nfs-utils RHSA-2008:0486-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"nfs-utils", rpm:"nfs-utils~1.0.9~35z.el5_2", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"nfs-utils-debuginfo", rpm:"nfs-utils-debuginfo~1.0.9~35z.el5_2", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
