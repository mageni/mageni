...
#
# CentOS Update for tcltk CESA-2008:0134-01 centos2 i386
#
# Authors:
...
tag_affected = "tcltk on CentOS 2";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-February/014697.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307905");
  ...
  script_name( "CentOS Update for tcltk CESA-2008:0134-01 centos2 i386");

  script_tag(name:"summary", value:"Check for the Version of tcltk");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"expect", rpm:"expect~5.38.0~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"itcl", rpm:"itcl~3.2~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tcl", rpm:"tcl~8.3.3~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tcllib", rpm:"tcllib~1.0~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tclx", rpm:"tclx~8.3~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tix", rpm:"tix~8.2.0b1~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tk", rpm:"tk~8.3.3~75", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
