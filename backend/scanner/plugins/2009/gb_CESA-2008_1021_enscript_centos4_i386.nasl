...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-December/015510.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308832");
  ...
  script_name( "CentOS Update for enscript CESA-2008:1021 centos4 i386");
