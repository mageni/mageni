...
tag_affected = "rubygem-rails on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01320.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305345");
  ...
  script_name( "Fedora Update for rubygem-rails FEDORA-2008-8322");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-rails", rpm:"rubygem-rails~2.1.1~2.fc9", rls:"FC9")) != NULL)
  {
