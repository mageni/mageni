...
# $Id: fcore_2009_10718.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309543");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"sahana", rpm:"sahana~0.6.2.2~6.fc11", rls:"FC11")) != NULL) {
    report += res;
}
