...
# $Id: fcore_2009_1366.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-1366 (gpsdrive)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-1366";
tag_summary = "The remote host is missing an update to gpsdrive
announced via advisory FEDORA-2009-1366.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309317");
 ...
 script_name("Fedora Core 9 FEDORA-2009-1366 (gpsdrive)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"gpsdrive", rpm:"gpsdrive~2.09~7.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gpsdrive-debuginfo", rpm:"gpsdrive-debuginfo~2.09~7.fc9", rls:"FC9")) != NULL) {
    report += res;
}
