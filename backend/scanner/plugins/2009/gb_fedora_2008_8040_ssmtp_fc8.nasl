...
tag_affected = "ssmtp on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00757.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307668");
  ...
  script_name( "Fedora Update for ssmtp FEDORA-2008-8040");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"ssmtp", rpm:"ssmtp~2.61~11.6.fc8.1", rls:"FC8")) != NULL)
  {
