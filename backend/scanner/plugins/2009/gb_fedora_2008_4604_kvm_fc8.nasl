...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg00935.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304406");
  ...
  script_name( "Fedora Update for kvm FEDORA-2008-4604");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"kvm", rpm:"kvm~60~6.fc8", rls:"FC8")) != NULL)
  {
