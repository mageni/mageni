...
tag_insight = "The libXfont package contains the X.Org X11 libXfont runtime library.
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-January/msg00012.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311359");
  ...
  script_name( "RedHat Update for libXfont RHSA-2008:0064-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"libXfont", rpm:"libXfont~1.2.2~1.0.3.el5_1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libXfont-debuginfo", rpm:"libXfont-debuginfo~1.2.2~1.0.3.el5_1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libXfont-devel", rpm:"libXfont-devel~1.2.2~1.0.3.el5_1", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
