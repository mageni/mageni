...
#
# CentOS Update for perl CESA-2008:0522 centos4 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/015043.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306987");
  ...
  script_name( "CentOS Update for perl CESA-2008:0522 centos4 i386");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"perl", rpm:"perl~5.8.5~36.el4_6.3", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"perl-suidperl", rpm:"perl-suidperl~5.8.5~36.el4_6.3", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
