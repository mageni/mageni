...
# $Id: fcore_2009_2984.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-2984 (phpMyAdmin)
#
# Authors:
...
announced via advisory FEDORA-2009-2984.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305810");
 script_version("$Revision: 6624 $");
 script_cve_id("CVE-2009-1148", "CVE-2009-1149", "CVE-2009-1150", "CVE-2009-1151");
 script_bugtraq_id(34253, 34251, 34236);
 script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:11:55 +0200 (Mon, 10 Jul 2017) $");
 script_tag(name:"creation_date", value:"2009-03-31 19:20:21 +0200 (Tue, 31 Mar 2009)");
 script_tag(name:"cvss_base", value:"7.5");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
 script_name("Fedora Core 9 FEDORA-2009-2984 (phpMyAdmin)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.1.3.1~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
