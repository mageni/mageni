...
tag_affected = "ImageMagick on solaris_5.9_x86";
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.304399");
  ...
  script_name( "Solaris Update for ImageMagick 137039-01");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-137039-01-1");
...
if(solaris_check_patch(release:"5.9", arch:"i386", patch:"137039-01", package:"SUNWimagick SUNWimagickS") < 0)
{
  security_message(0);
  exit(0);
}