...
tag_insight = "Multiple errors in F-PROT Antivirus may lead to a Denial of Service.";
tag_solution = "All F-PROT Antivirus users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307073");
