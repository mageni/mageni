...
tag_affected = "nss_ldap on Mandriva Linux 2007.1,
  Mandriva Linux 2007.1/X86_64";
tag_insight = "This update corrects an issue in nss_ldap when handling SIGPIPE,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-12/msg00025.php");
  script_oid("1.3.6.1.4.1.25623.1.0.308519");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"nss_ldap-257", rpm:"nss_ldap-257~1.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
