...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg00247.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307785");
  ...
  script_name( "Fedora Update for libvorbis FEDORA-2008-3898");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"libvorbis", rpm:"libvorbis~1.1.2~4.fc7", rls:"FC7")) != NULL)
  {
