...
# $Id: fcore_2009_0653.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-0653 (drupal)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-0653";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311111");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"drupal", rpm:"drupal~6.9~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
