...
#
# Fedora Update for phpMyAdmin FEDORA-2008-6810
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg01239.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310337");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-6810");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.8.1~1.fc8", rls:"FC8")) != NULL)
  {
