...
#
# Fedora Update for kazehakase FEDORA-2008-6127
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00199.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310803");
  ...
  script_name( "Fedora Update for kazehakase FEDORA-2008-6127");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"kazehakase", rpm:"kazehakase~0.5.4~2.fc8.2", rls:"FC8")) != NULL)
  {
