...
tag_insight = "Raphael Marichez discovered a denial of service bug in how vixie-cron
...
tag_affected = "vixie-cron on Mandriva Linux 2007.0,
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"vixie-cron", rpm:"vixie-cron~4.1~9.1mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
...
if(release == "MNDK_2007.0")
{
  ...
  if ((res = isrpmvuln(pkg:"vixie-cron", rpm:"vixie-cron~4.1~9.1mdv2007.0", rls:"MNDK_2007.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"vixie-cron", rpm:"vixie-cron~4.1~9.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
