...
# $Id: fcore_2009_13196.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304718");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"merkaartor", rpm:"merkaartor~0.14~2.fc12", rls:"FC12")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"merkaartor-debuginfo", rpm:"merkaartor-debuginfo~0.14~2.fc12", rls:"FC12")) != NULL) {
    report += res;
}
