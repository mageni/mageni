...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-November/msg01053.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311665");
  ...
  script_name( "Fedora Update for gnome-web-photo FEDORA-2007-3962");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.3~7.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gnome-web-photo-debuginfo", rpm:"gnome-web-photo-debuginfo~0.3~7.fc8", rls:"FC8")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
