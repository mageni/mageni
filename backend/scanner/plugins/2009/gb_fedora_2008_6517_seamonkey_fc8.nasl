...
#
# Fedora Update for seamonkey FEDORA-2008-6517
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00667.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307989");
  ...
  script_name( "Fedora Update for seamonkey FEDORA-2008-6517");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~1.1.11~1.fc8", rls:"FC8")) != NULL)
  {
