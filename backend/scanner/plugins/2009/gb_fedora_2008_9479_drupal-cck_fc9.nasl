...
#
# Fedora Update for drupal-cck FEDORA-2008-9479
#
# Authors:
...
tag_affected = "drupal-cck on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-November/msg00178.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309392");
  script_cve_id("CVE-2008-6229");
 script_tag(name:"cvss_base", value:"3.5");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:N");
 script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 17:07:33 +0100 (Tue, 17 Feb 2009)");
  script_xref(name: "FEDORA", value: "2008-9479");
  script_name( "Fedora Update for drupal-cck FEDORA-2008-9479");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-cck", rpm:"drupal-cck~6.x.2.0~3.fc9", rls:"FC9")) != NULL)
  {
