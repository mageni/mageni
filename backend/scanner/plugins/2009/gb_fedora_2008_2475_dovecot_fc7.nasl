...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00381.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307548");
  ...
  script_name( "Fedora Update for dovecot FEDORA-2008-2475");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"dovecot", rpm:"dovecot~1.0.13~18.fc7", rls:"FC7")) != NULL)
  {
