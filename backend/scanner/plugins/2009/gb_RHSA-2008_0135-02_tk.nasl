...
tag_affected = "tk on Red Hat Enterprise Linux AS version 4,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-February/msg00012.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309744");
  ...
  script_name( "RedHat Update for tk RHSA-2008:0135-02");
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"tk", rpm:"tk~8.4.7~3.el4_6.1", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tk-debuginfo", rpm:"tk-debuginfo~8.4.7~3.el4_6.1", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"tk-devel", rpm:"tk-devel~8.4.7~3.el4_6.1", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
