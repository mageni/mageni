...
# $Id: RHSA_2009_1337.nasl 6683 2017-07-12 09:41:57Z cfischer $
# Description: Auto-generated from advisory RHSA-2009:1337 ()
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311086");
 ...
 script_name("RedHat Security Advisory RHSA-2009:1337");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-1337.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"gfs2-utils", rpm:"gfs2-utils~0.1.62~1.el5", rls:"RHENT_5")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"gfs2-utils-debuginfo", rpm:"gfs2-utils-debuginfo~0.1.62~1.el5", rls:"RHENT_5")) != NULL) {
    report += res;
}
