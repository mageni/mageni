...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00434.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311729");
  ...
  script_name( "Fedora Update for kazehakase FEDORA-2008-3249");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"kazehakase", rpm:"kazehakase~0.5.4~2.fc7.2", rls:"FC7")) != NULL)
  {
