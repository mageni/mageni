...
tag_insight = "This update fixes a crash when reading packages with an empty backport
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-02/msg00016.php");
  script_oid("1.3.6.1.4.1.25623.1.0.310685");
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"park-rpmdrake", rpm:"park-rpmdrake~3.117.3~1.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"rpmdrake", rpm:"rpmdrake~3.117.3~1.1mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
