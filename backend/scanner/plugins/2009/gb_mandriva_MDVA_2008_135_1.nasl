...
tag_affected = "draksnapshot on Mandriva Linux 2009.0,
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-10/msg00011.php");
  script_oid("1.3.6.1.4.1.25623.1.0.309784");
  ...
  script_name( "Mandriva Update for draksnapshot MDVA-2008:135-1 (draksnapshot)");
...
if(release == "MNDK_2009.0")
{
  ...
  if ((res = isrpmvuln(pkg:"draksnapshot", rpm:"draksnapshot~0.19~2mdv2009.0", rls:"MNDK_2009.0")) != NULL)
  {
