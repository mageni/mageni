...
#
# CentOS Update for enscript CESA-2008:1021 centos4 x86_64
#
# Authors:
...
tag_affected = "enscript on CentOS 4";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-December/015511.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306740");
  ...
  script_name( "CentOS Update for enscript CESA-2008:1021 centos4 x86_64");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"enscript", rpm:"enscript~1.6.1~33.el4_7.1", rls:"CentOS4")) != NULL)
  {
