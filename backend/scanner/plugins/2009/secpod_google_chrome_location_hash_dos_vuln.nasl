...
# $Id: secpod_google_chrome_location_hash_dos_vuln.nasl 12629 2018-12-03 15:19:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Error exists when application fails to handle JavaScript code with a long
