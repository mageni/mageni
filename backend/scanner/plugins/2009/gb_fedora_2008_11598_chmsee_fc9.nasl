...
#
# Fedora Update for chmsee FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01053.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306134");
  ...
  script_name( "Fedora Update for chmsee FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"chmsee", rpm:"chmsee~1.0.1~7.fc9", rls:"FC9")) != NULL)
  {
