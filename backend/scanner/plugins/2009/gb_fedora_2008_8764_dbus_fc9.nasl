...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00298.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310996");
  ...
  script_name( "Fedora Update for dbus FEDORA-2008-8764");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"dbus", rpm:"dbus~1.2.4~1.fc9", rls:"FC9")) != NULL)
  {
