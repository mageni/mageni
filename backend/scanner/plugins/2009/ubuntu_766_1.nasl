...
# $Id: ubuntu_766_1.nasl 7969 2017-12-01 09:23:16Z santu $
# $Id: ubuntu_766_1.nasl 7969 2017-12-01 09:23:16Z santu $
# Description: Auto-generated from advisory USN-766-1 (acpid)
#
# Authors:
...
tag_insight = "It was discovered that acpid did not properly handle a large number of
...
announced via advisory USN-766-1.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305172");
 ...
 script_name("Ubuntu USN-766-1 (acpid)");



 script_category(ACT_GATHER_INFO);
 script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-766-1/");
