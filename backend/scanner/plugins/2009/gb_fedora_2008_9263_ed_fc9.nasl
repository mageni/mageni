...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00873.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308334");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"ed", rpm:"ed~1.1~1.fc9", rls:"FC9")) != NULL)
  {
