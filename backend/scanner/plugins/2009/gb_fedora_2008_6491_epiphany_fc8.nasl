...
#
# Fedora Update for epiphany FEDORA-2008-6491
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00682.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310761");
  ...
  script_name( "Fedora Update for epiphany FEDORA-2008-6491");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"epiphany", rpm:"epiphany~2.20.3~6.fc8", rls:"FC8")) != NULL)
  {
