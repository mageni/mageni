...
tag_affected = "mc on Mandriva Linux 2007.1,
  Mandriva Linux 2007.1/X86_64";
tag_insight = "This update fixes two separate problems in mc. Firstly, translations
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2007-10/msg00004.php");
  script_oid("1.3.6.1.4.1.25623.1.0.306475");
  ...
  script_tag(name:"summary", value:"Check for the Version of mc");
...
if(release == "MNDK_2007.1")
{
  ...
  if ((res = isrpmvuln(pkg:"mc", rpm:"mc~4.6.1~6.3mdv2007.1", rls:"MNDK_2007.1")) != NULL)
  {
