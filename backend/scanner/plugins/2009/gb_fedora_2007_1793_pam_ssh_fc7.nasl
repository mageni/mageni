...
tag_affected = "pam_ssh on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-August/msg00378.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311814");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-27 15:48:41 +0100 (Fri, 27 Feb 2009)");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_xref(name: "FEDORA", value: "2007-1793");
  script_cve_id("CVE-2007-0844");
  script_name( "Fedora Update for pam_ssh FEDORA-2007-1793");

  script_tag(name:"summary", value:"Check for the Version of pam_ssh");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"pam_ssh", rpm:"pam_ssh~1.92~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pam_ssh-debuginfo", rpm:"pam_ssh-debuginfo~1.92~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
