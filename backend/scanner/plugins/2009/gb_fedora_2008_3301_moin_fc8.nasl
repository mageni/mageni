...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00510.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305653");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"moin", rpm:"moin~1.5.9~1.fc8", rls:"FC8")) != NULL)
  {
