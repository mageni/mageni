...
#
# Fedora Update for devhelp FEDORA-2008-11511
#
# Authors:
...
tag_affected = "devhelp on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01001.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305782");
  ...
  script_name( "Fedora Update for devhelp FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"devhelp", rpm:"devhelp~0.22~2.fc10", rls:"FC10")) != NULL)
  {
