...
#
# Fedora Update for gnome-python2-extras FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01058.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310239");
  ...
  script_name( "Fedora Update for gnome-python2-extras FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.19.1~22.fc9", rls:"FC9")) != NULL)
  {
