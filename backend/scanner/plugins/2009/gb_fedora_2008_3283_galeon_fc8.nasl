...
#
# Fedora Update for galeon FEDORA-2008-3283
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00491.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309262");
  ...
  script_name( "Fedora Update for galeon FEDORA-2008-3283");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.4~2.fc8.3", rls:"FC8")) != NULL)
  {
