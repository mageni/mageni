...
tag_affected = "squid on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00507.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307832");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~2.6.STABLE16~2.fc7", rls:"FC7")) != NULL)
  {
  ...
  if ((res = isrpmvuln(pkg:"squid-debuginfo", rpm:"squid-debuginfo~2.6.STABLE16~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
