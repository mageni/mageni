...
#
# Solaris Update for perl 122092-01
#
# Authors:
...
tag_affected = "perl on solaris_5.8_x86";
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.306889");
  ...
  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-122092-01-1");
...
if(solaris_check_patch(release:"5.8", arch:"i386", patch:"122092-01", package:"SUNWpl5u") < 0)
{
  security_message(0);
  exit(0);
}
