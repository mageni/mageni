...
tag_insight = "Speex is a patent-free compression format designed especially for speech.
...
tag_affected = "speex on CentOS 4";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-April/014842.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308417");
  ...
  script_name( "CentOS Update for speex CESA-2008:0235 centos4 x86_64");
...
if(release == "CentOS4")
{
  ...
  if ((res = isrpmvuln(pkg:"speex", rpm:"speex~1.0.4~4.el4_6.1", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"speex-devel", rpm:"speex-devel~1.0.4~4.el4_6.1", rls:"CentOS4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
