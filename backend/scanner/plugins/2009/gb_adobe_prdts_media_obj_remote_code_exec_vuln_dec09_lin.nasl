...
# $Id: gb_adobe_prdts_media_obj_remote_code_exec_vuln_dec09_lin.nasl 12632 2018-12-03 17:55:22Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Adobe Reader and is prone to Doc.media.newPlayer
