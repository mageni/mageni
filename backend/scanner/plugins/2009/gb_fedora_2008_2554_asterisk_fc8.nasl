...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00438.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308569");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.4.18.1~1.fc8", rls:"FC8")) != NULL)
  {
