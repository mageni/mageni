...
# $Id: mdksa_2009_189.nasl 6573 2017-07-06 13:10:50Z cfischer $
# Description: Auto-generated from advisory MDVSA-2009:189 (apache-mod_auth_mysql)
#
# Authors:
...
tag_insight = "A vulnerability has been found and corrected in mod_auth_mysql:
...
https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:189";
tag_summary = "The remote host is missing an update to apache-mod_auth_mysql
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306075");
