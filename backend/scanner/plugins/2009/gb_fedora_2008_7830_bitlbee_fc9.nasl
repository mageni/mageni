...
#
# Fedora Update for bitlbee FEDORA-2008-7830
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00692.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311559");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"bitlbee", rpm:"bitlbee~1.2.3~1.fc9", rls:"FC9")) != NULL)
  {
