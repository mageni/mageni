...
#
# Fedora Update for wordpress FEDORA-2008-1559
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00416.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306362");
  ...
  script_name( "Fedora Update for wordpress FEDORA-2008-1559");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.3.3~0.fc8", rls:"FC8")) != NULL)
  {
