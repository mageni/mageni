...
# $Id: fcore_2009_2583.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-2583 (roundup)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2583";
tag_summary = "The remote host is missing an update to roundup
announced via advisory FEDORA-2009-2583.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306593");
 ...
 script_name("Fedora Core 10 FEDORA-2009-2583 (roundup)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"roundup", rpm:"roundup~1.4.6~4.fc10", rls:"FC10")) != NULL) {
    report += res;
}
