...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-June/015002.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308413");
  ...
  script_name( "CentOS Update for sblim-cmpi-base CESA-2008:0497 centos4 x86_64");
