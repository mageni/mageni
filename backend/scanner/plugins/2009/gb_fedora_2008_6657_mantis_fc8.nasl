...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00813.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305535");
  ...
  script_name( "Fedora Update for mantis FEDORA-2008-6657");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"mantis", rpm:"mantis~1.1.2~1.fc8", rls:"FC8")) != NULL)
  {
