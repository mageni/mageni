...
tag_affected = "ghostscript on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-March/msg00085.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306750");
  ...
  script_name( "Fedora Update for ghostscript FEDORA-2008-1998");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~8.61~8.fc8", rls:"FC8")) != NULL)
  {
