...
#
# Fedora Update for xine-lib FEDORA-2008-3326
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00536.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308483");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 16:43:56 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-3326");
  script_cve_id("CVE-2008-1878");
  script_name( "Fedora Update for xine-lib FEDORA-2008-3326");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"xine-lib", rpm:"xine-lib~1.1.11.1~1.fc7.2", rls:"FC7")) != NULL)
  {
