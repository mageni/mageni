...
# $Id: fcore_2009_11034.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_insight = "Data files (audio, maps, etc) for Alien Arena 2009.
...
tag_summary = "The remote host is missing an update to alienarena-data
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308701");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"alienarena-data", rpm:"alienarena-data~20091102~1.fc11", rls:"FC11")) != NULL) {
    report += res;
}
