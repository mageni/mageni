...
#
# Fedora Update for gnome-web-photo FEDORA-2008-11511
#
# Authors:
...
tag_affected = "gnome-web-photo on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01007.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309815");
  ...
  script_name( "Fedora Update for gnome-web-photo FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-web-photo", rpm:"gnome-web-photo~0.3~13.fc10", rls:"FC10")) != NULL)
  {
