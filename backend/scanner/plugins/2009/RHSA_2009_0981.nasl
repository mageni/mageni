...
# $Id: RHSA_2009_0981.nasl 6683 2017-07-12 09:41:57Z cfischer $
...
tag_summary = "The remote host is missing updates to util-linux announced in
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308926");
 ...
 script_name("RedHat Security Advisory RHSA-2009:0981");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-0981.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"util-linux", rpm:"util-linux~2.12a~24.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"util-linux-debuginfo", rpm:"util-linux-debuginfo~2.12a~24.el4", rls:"RHENT_4")) != NULL) {
    report += res;
}
