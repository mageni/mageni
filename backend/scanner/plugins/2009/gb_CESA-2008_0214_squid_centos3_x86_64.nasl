...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-April/014819.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311812");
  ...
  script_name( "CentOS Update for squid CESA-2008:0214 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~2.5.STABLE3~9.3E", rls:"CentOS3")) != NULL)
  {
