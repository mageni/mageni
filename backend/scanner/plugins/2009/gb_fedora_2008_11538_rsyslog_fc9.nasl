...
tag_affected = "rsyslog on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01077.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306628");
  ...
  script_xref(name: "FEDORA", value: "2008-11538");
  script_cve_id("CVE-2008-5617", "CVE-2008-5618");
  script_name( "Fedora Update for rsyslog FEDORA-2008-11538");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"rsyslog", rpm:"rsyslog~3.20.2~2.fc9", rls:"FC9")) != NULL)
  {
