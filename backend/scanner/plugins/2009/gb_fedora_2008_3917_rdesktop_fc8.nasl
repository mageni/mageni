...
tag_affected = "rdesktop on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-May/msg00270.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307361");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 16:43:56 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_xref(name: "FEDORA", value: "2008-3917");
  script_cve_id("CVE-2008-1803", "CVE-2008-1801", "CVE-2008-1802");
  script_name( "Fedora Update for rdesktop FEDORA-2008-3917");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"rdesktop", rpm:"rdesktop~1.6.0~1.fc8", rls:"FC8")) != NULL)
  {
