...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg01316.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309058");
 ...
 script_version("$Revision: 6623 $");
  ...
  script_name( "Fedora Update for phpMyAdmin FEDORA-2008-6868");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.8.1~1.fc9", rls:"FC9")) != NULL)
  {
