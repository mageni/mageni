...
# $Id: fcore_2009_5190.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_insight = "A one-byte overflow bug allows a carefully crafted exploit
...
tag_summary = "The remote host is missing an update to nsd
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"nsd", rpm:"nsd~3.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"nsd-debuginfo", rpm:"nsd-debuginfo~3.2.2~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
