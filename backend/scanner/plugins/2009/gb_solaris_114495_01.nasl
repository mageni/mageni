...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.309837");
  script_version("$Revision: 5359 $");
  script_cve_id("CVE-2003-0840");
  ...
  script_name( "Solaris Update for CDE 1.5 114495-01");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-114495-01-1");
...
if(solaris_check_patch(release:"5.9", arch:"sparc", patch:"114495-01", package:"SUNWdtdst") < 0)
{
  security_message(0);
  exit(0);
}
