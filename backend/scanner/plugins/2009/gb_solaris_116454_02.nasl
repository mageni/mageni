...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.304758");
  ...
  script_name( "Solaris Update for Obsoleted by 116454-02");

  script_xref(name : "URL" , value : "http://sunsolve.sun.com/search/document.do?assetkey=1-21-116454-02-1");
...
if(solaris_check_patch(release:"5.9", arch:"i386", patch:"116454-02", package:"SUNWadmfw") < 0)
{
  security_message(0);
  exit(0);
}
