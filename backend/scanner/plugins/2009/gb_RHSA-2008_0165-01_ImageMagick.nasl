...
tag_affected = "ImageMagick on Red Hat Enterprise Linux AS (Advanced Server) version 2.1,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/rhsa-announce/2008-April/msg00014.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304753");
  ...
  script_name( "RedHat Update for ImageMagick RHSA-2008:0165-01");
...
if(release == "RHENT_2.1")
{
  ...
  if ((res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~5.3.8~21", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-c++", rpm:"ImageMagick-c++~5.3.8~21", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-c++-devel", rpm:"ImageMagick-c++-devel~5.3.8~21", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-devel", rpm:"ImageMagick-devel~5.3.8~21", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-perl", rpm:"ImageMagick-perl~5.3.8~21", rls:"RHENT_2.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
