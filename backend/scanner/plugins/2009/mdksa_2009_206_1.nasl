...
# $Id: mdksa_2009_206_1.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311155");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wget", rpm:"wget~1.10.2~6.1mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
