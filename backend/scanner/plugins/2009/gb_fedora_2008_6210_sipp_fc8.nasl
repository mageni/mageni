...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-July/msg00311.html");
  script_oid("1.3.6.1.4.1.25623.1.0.306417");
  ...
  script_name( "Fedora Update for sipp FEDORA-2008-6210");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"sipp", rpm:"sipp~3.1~2.fc8", rls:"FC8")) != NULL)
  {
