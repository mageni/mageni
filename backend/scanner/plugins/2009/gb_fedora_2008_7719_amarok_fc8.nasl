...
tag_affected = "amarok on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg00097.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310227");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"amarok", rpm:"amarok~1.4.10~1.fc8", rls:"FC8")) != NULL)
  {
