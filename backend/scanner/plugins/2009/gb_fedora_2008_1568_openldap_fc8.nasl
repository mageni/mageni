...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00430.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308136");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-16 14:16:57 +0100 (Mon, 16 Feb 2009)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_xref(name: "FEDORA", value: "2008-1568");
  script_cve_id("CVE-2008-0658");
  script_name( "Fedora Update for openldap FEDORA-2008-1568");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.3.39~3.fc8", rls:"FC8")) != NULL)
  {
