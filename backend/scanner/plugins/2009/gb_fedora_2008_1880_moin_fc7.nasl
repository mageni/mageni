...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00726.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307716");
  ...
  script_name( "Fedora Update for moin FEDORA-2008-1880");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"moin", rpm:"moin~1.5.8~4.fc7", rls:"FC7")) != NULL)
  {
