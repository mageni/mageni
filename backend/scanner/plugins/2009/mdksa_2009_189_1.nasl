...
# $Id: mdksa_2009_189_1.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307387");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"apache-mod_auth_mysql", rpm:"apache-mod_auth_mysql~3.0.0~13.1mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
