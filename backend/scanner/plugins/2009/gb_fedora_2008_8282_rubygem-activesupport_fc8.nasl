...
tag_affected = "rubygem-activesupport on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00323.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305181");
  ...
  script_name( "Fedora Update for rubygem-activesupport FEDORA-2008-8282");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-activesupport", rpm:"rubygem-activesupport~2.1.1~1.fc8", rls:"FC8")) != NULL)
  {
