...
tag_affected = "deluge on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00069.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304599");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"deluge", rpm:"deluge~0.5.8.3~1.fc7", rls:"FC7")) != NULL)
  {
