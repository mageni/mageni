...
if(description)
{
  ...
  script_tag(name:"summary", value:"WEBJump! is prone to multiple SQL-injection vulnerabilities because
...
foreach dir( make_list_unique( "/", cgi_dirs( port:port ) ) ) {
  ...
  if( dir == "/" ) dir = "";
  url = string(dir, "/portfolio_genre.php?id=-67%20union%20select%201,2,0x53514c2d496e6a656374696f6e2d54657374--");
