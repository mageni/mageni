...
# $Id: fcore_2009_10743.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309152");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"squidGuard", rpm:"squidGuard~1.4~8.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"squidGuard-debuginfo", rpm:"squidGuard-debuginfo~1.4~8.fc10", rls:"FC10")) != NULL) {
    report += res;
}
