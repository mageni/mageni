...
# $Id: deb_1963_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "It was discovered that Unbound, a DNS resolver, does not properly
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201963-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307115");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libunbound-dev", ver:"1.0.2-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"unbound-host", ver:"1.0.2-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libunbound0", ver:"1.0.2-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"unbound", ver:"1.0.2-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
