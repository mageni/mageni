...
# $Id: fcore_2009_1675.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311772");
 ...
 script_name("Fedora Core 9 FEDORA-2009-1675 (trickle)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"trickle", rpm:"trickle~1.07~7.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"trickle-debuginfo", rpm:"trickle-debuginfo~1.07~7.fc9", rls:"FC9")) != NULL) {
    report += res;
}
