...
# $Id: fcore_2009_10780.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309963");
 ...
 script_xref(name : "URL" , value : "https://bugzilla.redhat.com/show_bug.cgi?id=530862");
 exit(0);
}
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"squidGuard", rpm:"squidGuard~1.4~8.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"squidGuard-debuginfo", rpm:"squidGuard-debuginfo~1.4~8.fc11", rls:"FC11")) != NULL) {
    report += res;
}
