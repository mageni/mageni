...
#
# CentOS Update for ImageMagick CESA-2008:0145 centos3 x86_64
#
# Authors:
...
tag_affected = "ImageMagick on CentOS 3";
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-April/014821.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310058");
  ...
  script_name( "CentOS Update for ImageMagick CESA-2008:0145 centos3 x86_64");
...
if(release == "CentOS3")
{
  ...
  if ((res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~5.5.6~28", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-c++", rpm:"ImageMagick-c++~5.5.6~28", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-c++-devel", rpm:"ImageMagick-c++-devel~5.5.6~28", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-devel", rpm:"ImageMagick-devel~5.5.6~28", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"ImageMagick-perl", rpm:"ImageMagick-perl~5.5.6~28", rls:"CentOS3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
