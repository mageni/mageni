...
# $Id: mdksa_2009_274.nasl 6587 2017-07-07 06:35:35Z cfischer $
...
tag_insight = "This is a security release for XSS and SQL injection problems.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307916");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~2.11.9.6~0.1.20060mlcs4", rls:"MNDK_4.0")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"phpmyadmin", rpm:"phpmyadmin~3.2.2.1~0.1mdvmes5", rls:"MNDK_mes5")) != NULL) {
    report += res;
}
