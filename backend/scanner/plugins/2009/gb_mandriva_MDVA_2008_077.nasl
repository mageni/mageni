...
tag_affected = "gnome-settings-daemon on Mandriva Linux 2008.1,
  Mandriva Linux 2008.1/X86_64";
tag_insight = "Gnome-settings-daemon was not respecting correctly user settings
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-05/msg00038.php");
  script_oid("1.3.6.1.4.1.25623.1.0.306436");
  ...
  script_tag(name:"summary", value:"Check for the Version of gnome-settings-daemon");
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-settings-daemon", rpm:"gnome-settings-daemon~2.22.1~2mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"gnome-settings-daemon-devel", rpm:"gnome-settings-daemon-devel~2.22.1~2mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
