...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-June/msg00836.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312062");
  script_version("$Revision: 6623 $");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-17 16:50:22 +0100 (Tue, 17 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-5576");
  script_cve_id("CVE-2008-2720", "CVE-2008-2721", "CVE-2008-2722", "CVE-2008-2723", "CVE-2008-2724");
  script_name( "Fedora Update for gallery2 FEDORA-2008-5576");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"gallery2", rpm:"gallery2~2.2.5~1.fc9", rls:"FC9")) != NULL)
  {
