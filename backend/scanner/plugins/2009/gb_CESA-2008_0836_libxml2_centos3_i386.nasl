...
#
# CentOS Update for libxml2 CESA-2008:0836 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-August/015209.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310042");
  ...
  script_name( "CentOS Update for libxml2 CESA-2008:0836 centos3 i386");
