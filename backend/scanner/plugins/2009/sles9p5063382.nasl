...
# $Id: sles9p5063382.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311130");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ethereal", rpm:"ethereal~0.10.13~2.45", rls:"SLES9.0")) != NULL) {
    report += res;
}
