#
#VID 399f4cd7-4d59-11de-8811-0030843d3802
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID 399f4cd7-4d59-11de-8811-0030843d3802
#
# Authors:
...
tag_insight = "The following package is affected: eggdrop
...
http://www.vuxml.org/freebsd/399f4cd7-4d59-11de-8811-0030843d3802.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309263");
 ...
 script_name("FreeBSD Ports: eggdrop");
...
txt = "";
vuln = 0;
bver = portver(pkg:"eggdrop");
if(!isnull(bver) && revcomp(a:bver, b:"1.6.19_2")<0) {
    txt += 'Package eggdrop version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
