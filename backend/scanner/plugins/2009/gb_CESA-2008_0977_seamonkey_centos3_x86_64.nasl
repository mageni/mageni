...
#
# CentOS Update for seamonkey CESA-2008:0977 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-November/015403.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308023");
  ...
  script_name( "CentOS Update for seamonkey CESA-2008:0977 centos3 x86_64");
