...
tag_affected = "Thunar on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2007-December/msg00531.html");
  script_oid("1.3.6.1.4.1.25623.1.0.310439");
  ...
  script_tag(name:"summary", value:"Check for the Version of Thunar");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"Thunar", rpm:"Thunar~0.9.0~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"Thunar-debuginfo", rpm:"Thunar-debuginfo~0.9.0~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
  ...
  if ((res = isrpmvuln(pkg:"Thunar-devel", rpm:"Thunar-devel~0.9.0~2.fc7", rls:"FC7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
