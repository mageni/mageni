...
#
# CentOS Update for samba CESA-2007:1114 centos3 x86_64
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2007-December/014495.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309046");
  ...
  script_name( "CentOS Update for samba CESA-2007:1114 centos3 x86_64");
