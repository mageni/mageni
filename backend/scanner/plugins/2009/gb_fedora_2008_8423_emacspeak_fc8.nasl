...
tag_affected = "emacspeak on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00012.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307142");
  ...
  script_name( "Fedora Update for emacspeak FEDORA-2008-8423");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"emacspeak", rpm:"emacspeak~28.0~3.fc8", rls:"FC8")) != NULL)
  {
