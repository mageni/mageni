...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.mandriva.com/security-announce/2008-04/msg00018.php");
  script_oid("1.3.6.1.4.1.25623.1.0.306316");
  ...
  script_name( "Mandriva Update for vorbis-tools MDVSA-2008:093 (vorbis-tools)");
...
if(release == "MNDK_2008.0")
{
  ...
  if ((res = isrpmvuln(pkg:"vorbis-tools", rpm:"vorbis-tools~1.1.1~5.3mdv2008.0", rls:"MNDK_2008.0")) != NULL)
  {
...
if(release == "MNDK_2008.1")
{
  ...
  if ((res = isrpmvuln(pkg:"vorbis-tools", rpm:"vorbis-tools~1.2.0~1.1mdv2008.1", rls:"MNDK_2008.1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
