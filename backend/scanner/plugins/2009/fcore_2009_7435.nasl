...
# $Id: fcore_2009_7435.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307020");
 ...
 script_name("Fedora Core 11 FEDORA-2009-7435 (perl-IO-Socket-SSL)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"perl-IO-Socket", rpm:"perl-IO-Socket~SSL~1.26", rls:"FC11")) != NULL) {
    report += res;
}
