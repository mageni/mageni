...
# $Id: fcore_2009_1776.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-1776 (jhead)
#
# Authors:
...
tag_insight = "* fixes CVE-2008-4640 jhead: arbitrary file deletion (#468056)    * fixes
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310310");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"jhead", rpm:"jhead~2.86~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"jhead-debuginfo", rpm:"jhead-debuginfo~2.86~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
