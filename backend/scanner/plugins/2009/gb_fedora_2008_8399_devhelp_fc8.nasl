...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-September/msg01366.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304846");
  ...
  script_name( "Fedora Update for devhelp FEDORA-2008-8399");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"devhelp", rpm:"devhelp~0.16.1~10.fc8", rls:"FC8")) != NULL)
  {
