...
# $Id: fcore_2009_7724.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309012");
 ...
 script_name("Fedora Core 10 FEDORA-2009-7724 (libtiff)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.8.2~14.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.8.2~14.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libtiff-static", rpm:"libtiff-static~3.8.2~14.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libtiff-debuginfo", rpm:"libtiff-debuginfo~3.8.2~14.fc10", rls:"FC10")) != NULL) {
    report += res;
}
