...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01351.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311670");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"kvm", rpm:"kvm~74~10.fc10", rls:"FC10")) != NULL)
  {
