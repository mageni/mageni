...
tag_affected = "comix on Fedora 7";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-April/msg00183.html");
  script_oid("1.3.6.1.4.1.25623.1.0.308694");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"comix", rpm:"comix~3.6.4~6.fc7", rls:"FC7")) != NULL)
  {
