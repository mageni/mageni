...
# $Id: fcore_2009_8101.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-8101 (sssd)
#
# Authors:
...
tag_summary = "The remote host is missing an update to sssd
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305386");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"sssd", rpm:"sssd~0.4.1~3.fc11", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"sssd-debuginfo", rpm:"sssd-debuginfo~0.4.1~3.fc11", rls:"FC11")) != NULL) {
    report += res;
}
