...
#
# Fedora Update for drupal-views FEDORA-2008-11519
#
# Authors:
...
tag_affected = "drupal-views on Fedora 9";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01024.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312027");
  script_version("$Revision: 6623 $");
  script_cve_id("CVE-2008-6020");
  script_tag(name:"last_modification", value:"$Date: 2017-07-10 08:10:20 +0200 (Mon, 10 Jul 2017) $");
  script_tag(name:"creation_date", value:"2009-02-13 10:35:30 +0100 (Fri, 13 Feb 2009)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_xref(name: "FEDORA", value: "2008-11519");
  script_name( "Fedora Update for drupal-views FEDORA-2008-11519");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"drupal-views", rpm:"drupal-views~6.x.2.2~1.fc9", rls:"FC9")) != NULL)
  {
