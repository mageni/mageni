...
# $Id: deb_1727_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "Two SQL injection vulnerabilities have been found in proftpd, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201727-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307998");
 ...
 script_name("Debian Security Advisory DSA 1727-1 (proftpd-dfsg)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"proftpd-doc", ver:"1.3.1-17lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"proftpd", ver:"1.3.1-17lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"proftpd-basic", ver:"1.3.1-17lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"proftpd-mod-ldap", ver:"1.3.1-17lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"proftpd-mod-mysql", ver:"1.3.1-17lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"proftpd-mod-pgsql", ver:"1.3.1-17lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
