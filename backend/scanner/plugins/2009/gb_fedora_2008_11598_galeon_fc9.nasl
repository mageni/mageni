...
#
# Fedora Update for galeon FEDORA-2008-11598
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01056.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307469");
  ...
  script_name( "Fedora Update for galeon FEDORA-2008-11598");
...
if(release == "FC9")
{
  ...
  if ((res = isrpmvuln(pkg:"galeon", rpm:"galeon~2.0.7~4.fc9", rls:"FC9")) != NULL)
  {
