...
# $Id: RHSA_2009_1651.nasl 6683 2017-07-12 09:41:57Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310264");
 ...
 script_xref(name : "URL" , value : "http://rhn.redhat.com/errata/RHSA-2009-1651.html");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.1.2~6.el3", rls:"RHENT_3")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ntp-debuginfo", rpm:"ntp-debuginfo~4.1.2~6.el3", rls:"RHENT_3")) != NULL) {
    report += res;
}
