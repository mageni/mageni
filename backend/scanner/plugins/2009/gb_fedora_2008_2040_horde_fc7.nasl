...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00887.html");
  script_oid("1.3.6.1.4.1.25623.1.0.312071");
  ...
  script_name( "Fedora Update for horde FEDORA-2008-2040");
...
if(release == "FC7")
{
  ...
  if ((res = isrpmvuln(pkg:"horde", rpm:"horde~3.1.6~1.fc7", rls:"FC7")) != NULL)
  {
