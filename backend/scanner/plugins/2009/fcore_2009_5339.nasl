...
# $Id: fcore_2009_5339.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-5339 (wireshark)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-5339";
tag_summary = "The remote host is missing an update to wireshark
announced via advisory FEDORA-2009-5339.";



if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309381");
 ...
 script_name("Fedora Core 9 FEDORA-2009-5339 (wireshark)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~1.0.8~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"wireshark-gnome", rpm:"wireshark-gnome~1.0.8~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"wireshark-debuginfo", rpm:"wireshark-debuginfo~1.0.8~1.fc9", rls:"FC9")) != NULL) {
    report += res;
}
