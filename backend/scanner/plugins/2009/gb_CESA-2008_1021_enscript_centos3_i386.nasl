...
#
# CentOS Update for enscript CESA-2008:1021 centos3 i386
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-December/015482.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305983");
  ...
  script_name( "CentOS Update for enscript CESA-2008:1021 centos3 i386");
