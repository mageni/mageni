...
#
# Fedora Update for deluge FEDORA-2008-1287
#
# Authors:
...
tag_affected = "deluge on Fedora 8";
tag_insight = "Deluge is a new BitTorrent client, created using Python and GTK+. It is
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00079.html");
  script_oid("1.3.6.1.4.1.25623.1.0.307183");
  ...
  script_tag(name:"summary", value:"Check for the Version of deluge");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"deluge", rpm:"deluge~0.5.8.3~1.fc8", rls:"FC8")) != NULL)
  {
