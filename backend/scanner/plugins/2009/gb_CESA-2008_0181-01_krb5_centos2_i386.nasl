...
if(description)
{
  script_xref(name : "URL" , value : "http://lists.centos.org/pipermail/centos-announce/2008-March/014759.html");
  script_oid("1.3.6.1.4.1.25623.1.0.305837");
  ...
  script_name( "CentOS Update for krb5 CESA-2008:0181-01 centos2 i386");
...
if(release == "CentOS2")
{
  ...
  if ((res = isrpmvuln(pkg:"krb5-devel", rpm:"krb5-devel~1.2.2~48", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"krb5-libs", rpm:"krb5-libs~1.2.2~48", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"krb5-server", rpm:"krb5-server~1.2.2~48", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"krb5-workstation", rpm:"krb5-workstation~1.2.2~48", rls:"CentOS2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
