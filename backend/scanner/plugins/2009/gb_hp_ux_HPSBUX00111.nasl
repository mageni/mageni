...
if(description)
{
  script_xref(name : "URL" , value : "http://www11.itrc.hp.com/service/cki/docDisplay.do?docId=emr_na-c00899026-1");
  script_oid("1.3.6.1.4.1.25623.1.0.311966");
  ...
  script_name( "HP-UX Update for Ignite-UX HPSBUX00111");
...
if(release == "HPUX11.00")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"Ignite-UX.MGMT-TOOLS", revision:"B.2.4.307", rls:"HPUX11.00")) != NULL)
  {
...
if(release == "HPUX11.11")
{
  ...
  if ((res = ishpuxpkgvuln(pkg:"Ignite-UX.MGMT-TOOLS", revision:"B.2.4.307", rls:"HPUX11.11")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
