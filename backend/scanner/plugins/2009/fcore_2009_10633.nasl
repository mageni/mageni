...
# $Id: fcore_2009_10633.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309368");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"ocaml-postgresql", rpm:"ocaml-postgresql~1.12.3~1.fc11.2", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"ocaml-postgresql-devel", rpm:"ocaml-postgresql-devel~1.12.3~1.fc11.2", rls:"FC11")) != NULL) {
    report += res;
}
