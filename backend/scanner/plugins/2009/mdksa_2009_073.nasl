...
# $Id: mdksa_2009_073.nasl 6573 2017-07-06 13:10:50Z cfischer $
# Description: Auto-generated from advisory MDVSA-2009:073 (sarg)
#
# Authors:
...
tag_insight = "Various stack buffer overflows were discovered and corrected in sarg:
...
https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:073";
tag_summary = "The remote host is missing an update to sarg
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309932");
