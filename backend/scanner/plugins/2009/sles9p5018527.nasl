...
5018527 within the SuSE Enterprise Server 9 patch
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311210");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"mozilla-deat", rpm:"mozilla-deat~1.8_seamonkey_1.0.4~0.7", rls:"SLES9.0")) != NULL) {
    report += res;
}
