...
# $Id: deb_1735_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
...
tag_insight = "It was discovered that znc, an IRC proxy/bouncer, does not properly
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201735-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304642");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"znc", ver:"0.045-3+etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"znc", ver:"0.058-2+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
