...
#
# Fedora Update for xine-lib FEDORA-2008-1043
#
# Authors:
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-January/msg00956.html");
  script_oid("1.3.6.1.4.1.25623.1.0.304567");
  ...
  script_xref(name: "FEDORA", value: "2008-1043");
  script_name( "Fedora Update for xine-lib FEDORA-2008-1043");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"xine-lib", rpm:"xine-lib~1.1.10~1.fc8", rls:"FC8")) != NULL)
  {
