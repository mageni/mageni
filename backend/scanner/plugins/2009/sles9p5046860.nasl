...
# $Id: sles9p5046860.nasl 6666 2017-07-11 13:13:36Z cfischer $
...
5046860 within the SuSE Enterprise Server 9 patch
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.307937");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"IBMJava2-JRE", rpm:"IBMJava2-JRE~1.4.2~0.133", rls:"SLES9.0")) != NULL) {
    report += res;
}
