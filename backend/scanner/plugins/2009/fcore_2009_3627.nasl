...
# $Id: fcore_2009_3627.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.310596");
 ...
 script_name("Fedora Core 9 FEDORA-2009-3627 (pam_ssh)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"pam_ssh", rpm:"pam_ssh~1.92~10.fc9", rls:"FC9")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"pam_ssh-debuginfo", rpm:"pam_ssh-debuginfo~1.92~10.fc9", rls:"FC9")) != NULL) {
    report += res;
}
