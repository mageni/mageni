#
#VID 3ebd4cb5-657f-11de-883a-00e0815b8da8
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID 3ebd4cb5-657f-11de-883a-00e0815b8da8
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305060");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.12_3")<=0) {
    txt += 'Package nagios2 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"nagios-devel");
if(!isnull(bver) && revcomp(a:bver, b:"3.1.0_1")<=0) {
    txt += 'Package nagios-devel version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
