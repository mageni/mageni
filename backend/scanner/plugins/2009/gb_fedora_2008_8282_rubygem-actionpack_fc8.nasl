...
tag_affected = "rubygem-actionpack on Fedora 8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-October/msg00404.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309996");
  ...
  script_name( "Fedora Update for rubygem-actionpack FEDORA-2008-8282");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"rubygem-actionpack", rpm:"rubygem-actionpack~2.1.1~1.fc8", rls:"FC8")) != NULL)
  {
