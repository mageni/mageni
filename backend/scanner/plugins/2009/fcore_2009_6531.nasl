...
# $Id: fcore_2009_6531.nasl 6624 2017-07-10 06:11:55Z cfischer $
...
tag_insight = "Libpng should be installed if you need to manipulate PNG format image
files.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.306675");
 ...
 script_name("Fedora Core 10 FEDORA-2009-6531 (libpng)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.2.37~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libpng-devel", rpm:"libpng-devel~1.2.37~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libpng-static", rpm:"libpng-static~1.2.37~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"libpng-debuginfo", rpm:"libpng-debuginfo~1.2.37~1.fc10", rls:"FC10")) != NULL) {
    report += res;
}
