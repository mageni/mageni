...
tag_affected = "rsyslog on Fedora 10";
tag_insight = "Rsyslog is an enhanced multi-threaded syslogd supporting, among others, MySQL,
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg01135.html");
  script_oid("1.3.6.1.4.1.25623.1.0.309568");
  ...
  script_xref(name: "FEDORA", value: "2008-11476");
  script_cve_id("CVE-2008-5617", "CVE-2008-5618");
  script_name( "Fedora Update for rsyslog FEDORA-2008-11476");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"rsyslog", rpm:"rsyslog~3.21.9~1.fc10", rls:"FC10")) != NULL)
  {
