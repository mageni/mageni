...
# $Id: fcore_2009_8868.nasl 6624 2017-07-10 06:11:55Z cfischer $
# Description: Auto-generated from advisory FEDORA-2009-8868 (perl-Compress-Raw-Bzip2)
#
# Authors:
...
https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-8868";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.311892");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"perl-Compress-Raw", rpm:"perl-Compress-Raw~Bzip2~2.020", rls:"FC11")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"perl-Compress-Raw", rpm:"perl-Compress-Raw~Bzip2~debuginfo", rls:"FC11")) != NULL) {
    report += res;
}
