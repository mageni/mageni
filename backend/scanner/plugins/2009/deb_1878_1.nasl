...
# $Id: deb_1878_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
# Description: Auto-generated from advisory DSA 1878-1 (devscripts)
#
# Authors:
...
tag_insight = "Raphael Geissert discovered that uscan, a program to check for
...
announced via advisory DSA 1878-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201878-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.309028");
 ...
 script_name("Debian Security Advisory DSA 1878-1 (devscripts)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"devscripts", ver:"2.9.26etch4", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"devscripts", ver:"2.10.35lenny6", rls:"DEB5.0")) != NULL) {
    report += res;
}
