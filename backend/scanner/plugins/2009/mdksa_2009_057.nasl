...
# $Id: mdksa_2009_057.nasl 6573 2017-07-06 13:10:50Z cfischer $
...
tag_insight = "A vulnerability has been identified and corrected in valgrind:
...
tag_summary = "The remote host is missing an update to valgrind
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.308044");
 ...
 script_name("Mandrake Security Advisory MDVSA-2009:057 (valgrind)");
...
res = "";
report = "";
if ((res = isrpmvuln(pkg:"valgrind", rpm:"valgrind~3.2.3~2.2mdv2008.0", rls:"MNDK_2008.0")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"valgrind", rpm:"valgrind~3.3.0~3.1mdv2008.1", rls:"MNDK_2008.1")) != NULL) {
    report += res;
}
if ((res = isrpmvuln(pkg:"valgrind", rpm:"valgrind~3.3.1~2.1mdv2009.0", rls:"MNDK_2009.0")) != NULL) {
    report += res;
}
