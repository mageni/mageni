...
# $Id: deb_1806_1.nasl 6615 2017-07-07 12:09:52Z cfischer $
# Description: Auto-generated from advisory DSA 1806-1 (cscope)
#
# Authors:
...
tag_insight = "Matt Murphy discovered that cscope, a source code browsing tool, does not
...
announced via advisory DSA 1806-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201806-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.305590");
 ...
 script_name("Debian Security Advisory DSA 1806-1 (cscope)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cscope", ver:"15.6-6+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
