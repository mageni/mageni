...
#
# Fedora Update for xulrunner FEDORA-2008-11511
#
# Authors:
...
tag_affected = "xulrunner on Fedora 10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-December/msg00997.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311148");
  ...
  script_name( "Fedora Update for xulrunner FEDORA-2008-11511");
...
if(release == "FC10")
{
  ...
  if ((res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~1.9.0.5~1.fc10", rls:"FC10")) != NULL)
  {
