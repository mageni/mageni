...
if(description)
{
  script_xref(name : "URL" , value : "https://www.redhat.com/archives/fedora-package-announce/2008-February/msg00926.html");
  script_oid("1.3.6.1.4.1.25623.1.0.311586");
  ...
  script_name( "Fedora Update for imp FEDORA-2008-2087");
...
if(release == "FC8")
{
  ...
  if ((res = isrpmvuln(pkg:"imp", rpm:"imp~4.1.6~1.fc8", rls:"FC8")) != NULL)
  {
