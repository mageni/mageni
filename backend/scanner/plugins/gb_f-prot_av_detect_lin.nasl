...
# $Id: gb_f-prot_av_detect_lin.nasl 11015 2018-08-17 06:31:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The script finds the installed F-PROT Antivirus Version and saves
  the result in KB.");
  exit(0);
}
