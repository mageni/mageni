...
# $Id: gb_phpmyadmin_mult_vuln_apr13_win.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108213");
  ...
  script_name("phpMyAdmin Multiple Security Vulnerabilities Apr13 (Windows)");
