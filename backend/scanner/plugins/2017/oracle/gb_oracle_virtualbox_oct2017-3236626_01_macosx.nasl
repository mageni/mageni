...
# $Id: gb_oracle_virtualbox_oct2017-3236626_01_macosx.nasl 11982 2018-10-19 08:49:21Z mmartin $
#
# Oracle VirtualBox Security Updates (oct2017-3236626) 01 - MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811982");
  ...
  script_tag(name:"creation_date", value:"2017-10-18 12:48:50 +0530 (Wed, 18 Oct 2017)");
  script_name("Oracle VirtualBox Security Updates (oct2017-3236626) 01 - MAC OS X");
  ...
  script_tag(name:"affected", value:"VirtualBox versions Prior to 5.1.30 on MAC OS X.");
