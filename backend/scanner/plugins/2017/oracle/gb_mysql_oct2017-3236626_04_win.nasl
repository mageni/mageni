...
# $Id: gb_mysql_oct2017-3236626_04_win.nasl 12983 2019-01-08 15:30:19Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811991");
  ...
  script_name("Oracle Mysql Security Updates (oct2017-3236626) 04 - Windows");
