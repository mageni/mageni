...
# $Id: gb_mysql_unspecified_vuln02_feb16_lin.nasl 2016-01-28 13:07:06 +0530 feb$
#
# Oracle MySQL Unspecified Vulnerability-02 Feb16 (Linux)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812197");
  script_version("$Revision: 11989 $");
  script_cve_id("CVE-2016-0605");
  script_bugtraq_id(81253);
  ...
  script_tag(name:"creation_date", value:"2017-11-22 15:29:00 +0530 (Wed, 22 Nov 2017)");
  script_tag(name:"qod_type", value:"remote_banner_unreliable");
  script_name("Oracle MySQL Unspecified Vulnerability-02 Feb16 (Linux)");
...
if(mysqlVer =~ "^(5\.6)")
{
  if(version_is_less(version:mysqlVer, test_version:"5.6.27"))
  {
