...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108383");
  ...
  script_name("Oracle Java SE Security Updates (cpuapr2017-3236618) 02 - Linux");
  ...
  and earlier, 1.8.0.121 and earlier on Linux");
