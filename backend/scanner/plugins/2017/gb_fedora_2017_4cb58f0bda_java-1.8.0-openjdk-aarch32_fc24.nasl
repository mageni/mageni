...
#
# Fedora Update for java-1.8.0-openjdk-aarch32 FEDORA-2017-4cb58f0bda
#
# Authors:
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~aarch32~1.8.0.112~3.161109.fc24", rls:"FC24")) != NULL)
  {
