...
# $Id: gb_wireshark_modbus_dissector_dos_vuln_win.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811598");
  ...
  script_name("Wireshark 'Modbus' Dissector DoS Vulnerability (Windows)");
  ...
  script_tag(name:"affected", value:"Wireshark version 2.4.0 on Windows.");
