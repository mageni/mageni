...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HFNNTZZCP4BF5G5NLUFULJK4HXHPBPF6");
...
if(release == "FC25")
{
  ...
  if ((res = isrpmvuln(pkg:"chromium-native_client", rpm:"chromium-native_client~59.0.3071.86~1.20170607gitaac1de2.fc25", rls:"FC25")) != NULL)
  {
