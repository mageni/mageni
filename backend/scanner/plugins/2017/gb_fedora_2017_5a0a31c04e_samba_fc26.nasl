...
# $Id: gb_fedora_2017_5a0a31c04e_samba_fc26.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CESOLC3ZYYRLEXGNAQIXLN7ONPCHXFCO");
...
if(release == "FC26")
{
  ...
  if ((res = isrpmvuln(pkg:"samba", rpm:"samba~4.6.8~0.fc26", rls:"FC26")) != NULL)
  {
