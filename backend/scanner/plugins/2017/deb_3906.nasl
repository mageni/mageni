...
# $Id: deb_3906.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libundertow-java", ver:"1.4.18-1", rls:"DEB10")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libundertow-java-doc", ver:"1.4.18-1", rls:"DEB10")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libundertow-java", ver:"1.4.8-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libundertow-java-doc", ver:"1.4.8-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
