...
# $Id: gb_cisco_cucm_cisco-sa-20170215-cucm1.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.106598");
  script_cve_id("CVE-2017-3828");
  ...
  script_xref(name:"URL", value:"https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20170215-cucm1");
...
code in the context of the interface or allow the attacker to access sensitive browser-based information.");
  ...
  script_tag(name:"creation_date", value:"2017-02-16 13:26:24 +0700 (Thu, 16 Feb 2017)");
