...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZLF6D5S7KH2MNTSSYIKF2WVZWP7TX335");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"jasper", rpm:"jasper~1.900.13~4.fc24", rls:"FC24")) != NULL)
  {
