...
# $Id: deb_3769.nasl 14280 2019-03-18 14:50:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libphp-swiftmailer", ver:"5.2.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"php-swiftmailer", ver:"5.2.2-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libphp-swiftmailer", ver:"5.4.2-1.1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"php-swiftmailer", ver:"5.4.2-1.1", rls:"DEB9")) != NULL) {
  report += res;
}
