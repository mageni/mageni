...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810689");
  ...
  script_name("Microsoft Office Suite Remote Code Execution Vulnerability (KB3178702)");

  script_tag(name:"summary", value:"This host is missing a critical update for
  Microsoft Office Suite according to Microsoft security update KB3178702.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/3178702");
...
if(officeVer =~ "^16\.")
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"16.0", test_version2:"16.0.4522.1001"))
  {
    report = 'File checked:     ' + offPath + "\Mso.dll" + '\n' +
             'File version:     ' + offexeVer  + '\n' +
             'Vulnerable range: ' + "16.0 - 16.0.4522.1001" + '\n' ;
