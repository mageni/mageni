...
# $Id: gb_adobe_flash_player_apsb17-10_macosx.nasl 11923 2018-10-16 10:38:56Z mmartin $
#
# Adobe Flash Player Security Updates( apsb17-10 )-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810841");
  ...
  script_tag(name:"creation_date", value:"2017-04-12 08:48:17 +0530 (Wed, 12 Apr 2017)");
  script_name("Adobe Flash Player Security Updates( apsb17-10 )-MAC OS X");
