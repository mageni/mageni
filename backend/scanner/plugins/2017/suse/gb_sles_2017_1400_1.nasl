...
if(description)
{
  ...
  script_cve_id("CVE-2017-3289","CVE-2017-3509","CVE-2017-3511");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1400-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-May/002920.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_0-openjdk'
  package(s) announced via the SUSE-SU-2017:1400-1 advisory.");
