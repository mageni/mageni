...
if(description)
{
  ...
  script_cve_id("CVE-2017-10684","CVE-2017-10685","CVE-2017-11112");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:2075-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-August/003105.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ncurses'
  package(s) announced via the SUSE-SU-2017:2075-1 advisory.");
