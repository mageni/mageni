...
if(description)
{
  ...
  script_cve_id("CVE-2017-11188","CVE-2017-11478","CVE-2017-11523");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:3388-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-December/003544.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ImageMagick'
  package(s) announced via the SUSE-SU-2017:3388-1 advisory.");
