...
if(description)
{
  ...
  script_cve_id("CVE-2017-6502","CVE-2017-7606","CVE-2017-7941");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1489-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-June/002937.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ImageMagick'
  package(s) announced via the SUSE-SU-2017:1489-1 advisory.");
