...
if(description)
{
  ...
  script_cve_id("CVE-2017-12176","CVE-2017-12177","CVE-2017-12178");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:3047-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-November/003402.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xorg-x11-server'
  package(s) announced via the SUSE-SU-2017:3047-1 advisory.");
