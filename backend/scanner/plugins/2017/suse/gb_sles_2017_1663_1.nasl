...
if(description)
{
  ...
  script_cve_id("CVE-2017-9343","CVE-2017-9344","CVE-2017-9345");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:1663-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-June/002974.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2017:1663-1 advisory.");
