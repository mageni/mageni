...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0610-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-March/002681.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libquicktime'
  package(s) announced via the SUSE-SU-2017:0610-1 advisory.");
