...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2017:0951-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-April/002788.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'dracut'
  package(s) announced via the SUSE-SU-2017:0951-1 advisory.");
