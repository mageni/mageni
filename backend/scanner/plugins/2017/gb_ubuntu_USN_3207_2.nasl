...
#
# Ubuntu Update for linux-lts-trusty USN-3207-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-02-22 15:15:06 +0100 (Wed, 22 Feb 2017)");
  script_cve_id("CVE-2016-7910", "CVE-2016-7911", "CVE-2017-6074");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-lts-trusty USN-3207-2");
...
privileges. (CVE-2017-6074)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3207-2/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-110-generic", ver:"3.13.0-110.157~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-110-generic-lpae", ver:"3.13.0-110.157~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-generic-lpae-lts-trusty", ver:"3.13.0.110.101", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-generic-lts-trusty", ver:"3.13.0.110.101", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
