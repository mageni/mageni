...
# $Id: gb_vmware_workstation_dnd_function_oob_mem_access_vuln_win.nasl 11935 2018-10-17 08:47:01Z mmartin $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810534");
  ...
  script_tag(name:"creation_date", value:"2017-02-03 13:26:12 +0530 (Fri, 03 Feb 2017)");
  script_name("VMware Workstation DnD Function Out-of-Bounds Access Vulnerability (Windows)");
