...
# $Id: gb_cisco_esa_cisco-sa-20170816-csa.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.140308");
  script_cve_id("CVE-2017-6783");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_version("$Revision: 12106 $");

  script_name("Cisco Email Security Appliance SNMP Polling Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"A vulnerability in SNMP polling for the Cisco Email Security Appliance (ESA)
...
attacker must know the configured SNMP community string to exploit this vulnerability.");
  ...
  script_tag(name:"creation_date", value:"2017-08-17 10:25:21 +0700 (Thu, 17 Aug 2017)");
