...
if (version =~ "^10\.05\.") {
  if (version_is_less(version: version, test_version: "10.05.3")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "10.05.3");
...
if (version =~ "^10\.01\.") {
  if (version_is_less_equal(version: version, test_version: "10.01.3")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "10.01.4");
    security_message(port: port, data: report, proto: proto);
    exit(0);
  }
}
