...
# $Id: gb_vlc_media_player_transcode_module_bof_vuln_win.nasl 11863 2018-10-12 09:42:02Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"VideoLAN VLC media player before 2.1.5 on Windows.");
