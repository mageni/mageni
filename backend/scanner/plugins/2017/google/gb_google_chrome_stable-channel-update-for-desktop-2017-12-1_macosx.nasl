...
#
# Google Chrome Security Updates(stable-channel-update-for-desktop-2017-12-1)-Mac OS X
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 63.0.3239.108 on Mac OS X.");
