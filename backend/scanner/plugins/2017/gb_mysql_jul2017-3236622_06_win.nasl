...
# $Id: gb_mysql_jul2017-3236622_06_win.nasl 11989 2018-10-19 11:25:26Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.811440");
  ...
  script_name("Oracle Mysql Security Updates (jul2017-3236622) 06 - Windows");
...
if(version_in_range(version:mysqlVer, test_version:"5.6.0", test_version2:"5.6.35") ||
   version_in_range(version:mysqlVer, test_version:"5.7.0", test_version2:"5.7.17"))
{
