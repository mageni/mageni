...
# $Id: gb_apache_http_server_null_point_deref_dos_vuln_lin.nasl 11874 2018-10-12 11:28:04Z mmartin $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Apache HTTP Server version 2.4.25 on Linux.");
