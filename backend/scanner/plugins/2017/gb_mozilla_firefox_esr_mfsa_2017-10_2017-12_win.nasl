...
# $Id: gb_mozilla_firefox_esr_mfsa_2017-10_2017-12_win.nasl 11888 2018-10-12 15:27:49Z cfischer $
#
# Mozilla Firefox ESR Security Updates(mfsa_2017-10_2017-12)-Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810756");
  ...
  script_tag(name:"creation_date", value:"2017-04-20 11:46:40 +0530 (Thu, 20 Apr 2017)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2017-10_2017-12)-Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 52.1 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR 52.1 or later.");
