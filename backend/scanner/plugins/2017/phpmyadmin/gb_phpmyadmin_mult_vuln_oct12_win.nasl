...
# $Id: gb_phpmyadmin_mult_vuln_oct12_win.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
# phpMyAdmin 3.5.x < 3.5.3 Multiple Vulnerabilities (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108237");
  ...
  script_name("phpMyAdmin 3.5.x < 3.5.3 Multiple Vulnerabilities (Windows)");
