...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812025");
  ...
  script_tag(name:"creation_date", value:"2017-10-11 10:40:50 +0530 (Wed, 11 Oct 2017)");
  script_name("Microsoft Word 2010 Service Pack 2 Remote Code Execution Vulnerability (KB3213630)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB3213630");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/3213630");
...
if(exeVer =~ "^(14\.)" && version_is_less(version:exeVer, test_version:"14.0.7189.5001"))
{
