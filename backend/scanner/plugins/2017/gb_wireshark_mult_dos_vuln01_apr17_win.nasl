...
# $Id: gb_wireshark_mult_dos_vuln01_apr17_win.nasl 11900 2018-10-15 07:44:31Z mmartin $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810699");
  ...
  script_tag(name:"creation_date", value:"2017-04-19 14:43:27 +0530 (Wed, 19 Apr 2017)");
  script_name("Wireshark Multiple DoS Vulnerabilities-01 Apr17 (Windows)");
  ...
  script_tag(name:"affected", value:"Wireshark version 2.2.0 on Windows");
