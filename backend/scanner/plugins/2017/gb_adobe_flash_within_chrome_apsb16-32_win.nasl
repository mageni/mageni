...
# $Id: gb_adobe_flash_within_chrome_apsb16-32_win.nasl 11977 2018-10-19 07:28:56Z mmartin $
#
# Adobe Flash Player Within Google Chrome Security Update (apsb16-32) - Windows
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.810639");
  ...
  script_tag(name:"creation_date", value:"2017-03-17 18:34:40 +0530 (Fri, 17 Mar 2017)");
  script_name("Adobe Flash Player Within Google Chrome Security Update (apsb16-32) - Windows");
