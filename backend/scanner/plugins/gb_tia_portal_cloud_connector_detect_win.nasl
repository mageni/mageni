...
if(description)
{
  ...
  script_version("$Revision: 13709 $");
  script_tag(name:"last_modification", value:"$Date: 2019-02-16 13:00:51 +0100 (Sat, 16 Feb 2019) $");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "TIA Portal Cloud Connector V[0-9A-Z.+]+") continue;
