...
# $Id: gb_host_alive_check5.nasl 13775 2019-02-20 07:45:12Z cfischer $
#
...
if(description)
{
  ...
  script_dependencies("toolcheck.nasl", "default_http_auth_credentials.nasl", "default_ssh_credentials.nasl", "gb_host_alive_check4.nasl"); # Trying to enforce that this NVT is running late in its category
