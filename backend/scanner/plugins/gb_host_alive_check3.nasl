...
# $Id: gb_host_alive_check3.nasl 13775 2019-02-20 07:45:12Z cfischer $
#
...
if(description)
{
  ...
  script_dependencies("gb_host_alive_check2.nasl", "toolcheck.nasl", "os_detection.nasl"); # To avoid launching it directly at the beginning of the ACT_GATHER_INFO phase
