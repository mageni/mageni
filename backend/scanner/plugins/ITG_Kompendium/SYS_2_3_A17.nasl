...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150604");
...
exponierte Dienste und Anwendungen auf die unbedingt notwendige Anzahl beschraenkt werden (z. B.
durch seccomp). Die vorhandenen Standardprofile bzw. -regeln von SELinux, AppArmor sowie alternativen
Erweiterungen SOLLTEN manuell ueberprueft und gegebenenfalls an die eigene Sicherheitsrichtlinie
...
if (host_runs("linux") != "yes"){
  ...
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.3.A17");
  exit(0);
}
