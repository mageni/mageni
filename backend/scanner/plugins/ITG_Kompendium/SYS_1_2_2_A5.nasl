...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150013");
...
Die Standard-Anforderung 'A5: Schutz vor Schadsoftware' beschreibt, dass ein Antiviren-Schutzprogramm
...
if (host_runs("windows_server_2012") != "yes"){
  ...
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.1.2.2.A5");
  exit(0);
}
