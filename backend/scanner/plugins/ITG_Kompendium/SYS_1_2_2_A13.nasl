...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150021");
  script_version("2019-12-16T11:21:42+0000");
  script_tag(name:"last_modification", value:"2019-12-16 11:21:42 +0000 (Mon, 16 Dec 2019)");
  script_tag(name:"creation_date", value:"2019-12-13 10:19:13 +0100 (Fri, 13 Dec 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name("SYS.1.2.2.A13");
...
Die Kern-Anforderung 'A13: Starke Authentifizierung bei Windows Server 2012' beschreibt, dass ein
rollenbasiertes Administrations-Modell fuer Administratoren entworfen und umgesetzt werden sollte.");
...
title = "Starke Authentifizierung bei Windows Server 2012";

if (host_runs("windows_server_2012") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.1.2.2.A13");
  exit(0);
}
