...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109990");
...
Die Standard-Anforderung 'A4: Beschaffung von Windows 8.1' beschreibt, welche Anforderungen an die
Hardware bei der Beschaffung von Windows 8.1 beruecksichtift werden sollten.");
...
title = "Beschaffung von Windows 8.1";

if (host_runs("windows_8.1") != "yes"){
  result = itg_result_wrong_target();
  desc = itg_desc_wrong_target();
  itg_set_kb_entries(result:result, desc:desc, title:title, id:"SYS.2.2.2.A4");
  exit(0);
}
