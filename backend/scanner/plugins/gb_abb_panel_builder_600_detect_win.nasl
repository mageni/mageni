...
# $Id: gb_abb_panel_builder_600_detect_win.nasl 13445 2019-02-04 15:55:03Z mmartin $
#
# ABB Panel Builder 600 Version Detection (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-04 16:12:25 +0100 (Mon, 04 Feb 2019)");
...
foreach key (key_list) {
  foreach item (registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "Panel Builder 600") continue;
    ...
    set_kb_item(name:"abb/panel_builder_600/win/detected", value:TRUE);

    register_and_report_cpe(app:"ABB " + appName, ver:version, concluded:concluded,
                          base:"cpe:/a:abb:panel_builder_600:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0);
    exit(0);
  }
}
