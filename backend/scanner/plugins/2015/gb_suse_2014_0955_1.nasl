...
# $Id: gb_suse_2014_0955_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for lzo SUSE-SU-2014:0955-1 (lzo)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for lzo SUSE-SU-2014:0955-1 (lzo)");
...
if(release == "SLES11.0SP2")
{
  ...
  if ((res = isrpmvuln(pkg:"liblzo2-2", rpm:"liblzo2-2~2.03~12.3.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"liblzo2-2-32bit", rpm:"liblzo2-2-32bit~2.03~12.3.1", rls:"SLES11.0SP2")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "SLES11.0SP1")
{
  ...
  if ((res = isrpmvuln(pkg:"liblzo2-2", rpm:"liblzo2-2~2.03~12.3.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"liblzo2-2-32bit", rpm:"liblzo2-2-32bit~2.03~12.3.1", rls:"SLES11.0SP1")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
