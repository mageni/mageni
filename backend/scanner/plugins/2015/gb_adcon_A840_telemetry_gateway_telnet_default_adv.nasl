...
# $Id: gb_adcon_A840_telemetry_gateway_telnet_default_adv.nasl 11536 2018-09-21 19:44:30Z cfischer $
#
# Adcon A840 Telemetry Gateway Default adv Telnet Credentials
#
# Authors:
...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.105493");
  script_version("$Revision: 11536 $");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("Adcon A840 Telemetry Gateway Default adv Telnet Credential");
  ...
  script_tag(name:"insight", value:'It was possible to login with default credentials of adv:addvantage');
...
send( socket:soc, data: 'addvantage\r\n' );
sleep(3);
recv = recv( socket:soc, length:1024 );

if( ( recv && "Adcon Telemetry emu3ap" >< recv ) && "Login incorrect" >!< recv )
{
  send( socket:soc, data: 'TYPE\r\n' );
  recv = recv( socket:soc, length:128 );

  if( "A840" >< recv && "OK" >< recv )
  {
