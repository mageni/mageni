...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882103");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2015-01-24 05:49:05 +0100 (Sat, 24 Jan 2015)");
  script_cve_id("CVE-2014-8157", "CVE-2014-8158");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("CentOS Update for jasper CESA-2015:0074 centos7");
...
the JasPer libraries must be restarted for the update to take effect.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-January/020894.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"jasper", rpm:"jasper~1.900.1~26.el7_0.3", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"jasper-devel", rpm:"jasper-devel~1.900.1~26.el7_0.3", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"jasper-libs", rpm:"jasper-libs~1.900.1~26.el7_0.3", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"jasper-utils", rpm:"jasper-utils~1.900.1~26.el7_0.3", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
