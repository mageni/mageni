...
# $Id: deb_3425.nasl 14278 2019-03-18 14:47:26Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"tryton-server", ver:"3.4.0-3+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tryton-server-doc", ver:"3.4.0-3+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
