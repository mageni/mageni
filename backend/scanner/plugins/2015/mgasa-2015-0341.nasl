...
# $Id: mgasa-2015-0341.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.130045");
  script_version("$Revision: 11692 $");
  script_tag(name:"creation_date", value:"2015-10-15 10:41:59 +0300 (Thu, 15 Oct 2015)");
  script_tag(name:"last_modification", value:"$Date: 2018-09-28 18:55:19 +0200 (Fri, 28 Sep 2018) $");
  script_name("Mageia Linux Local Check: mgasa-2015-0341");
  ...
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0341.html");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0341");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"bind", rpm:"bind~9.10.2.P4~1.mga5", rls:"MAGEIA5")) != NULL) {
