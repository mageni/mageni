...
# $Id: gb_suse_2014_1366_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for wget SUSE-SU-2014:1366-1 (wget)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for wget SUSE-SU-2014:1366-1 (wget)");
...
if(release == "SLES11.0SP3")
{
  ...
  if ((res = isrpmvuln(pkg:"wget", rpm:"wget~1.11.4~1.19.1", rls:"SLES11.0SP3")) != NULL)
  {
