...
#
# CentOS Update for java CESA-2015:1526 centos5
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882236");
  ...
  script_name("CentOS Update for java CESA-2015:1526 centos5");
...
certificate ident ...
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2015-July/021272.html");
...
if(release == "CentOS5")
{
  ...
  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk", rpm:"java-1.6.0-openjdk~1.6.0.36~1.13.8.1.el5_11", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-demo", rpm:"java-1.6.0-openjdk-demo~1.6.0.36~1.13.8.1.el5_11", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-devel", rpm:"java-1.6.0-openjdk-devel~1.6.0.36~1.13.8.1.el5_11", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-javadoc", rpm:"java-1.6.0-openjdk-javadoc~1.6.0.36~1.13.8.1.el5_11", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java-1.6.0-openjdk-src", rpm:"java-1.6.0-openjdk-src~1.6.0.36~1.13.8.1.el5_11", rls:"CentOS5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
