...
if(description)
{
  ...
  script_tag(name:"affected", value:"util-linux on Fedora 21");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146229.html");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"util-linux", rpm:"util-linux~2.25.2~2.fc21", rls:"FC21")) != NULL)
  {
