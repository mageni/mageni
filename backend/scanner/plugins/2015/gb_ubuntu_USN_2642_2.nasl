...
#
# Ubuntu Update for linux-lts-trusty USN-2642-2
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-06-24 06:18:00 +0200 (Wed, 24 Jun 2015)");
  script_cve_id("CVE-2015-1328");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"qod_type", value:"package");
  script_name("Ubuntu Update for linux-lts-trusty USN-2642-2");
...
gain administrative privileges on the system.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2642-2/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-55-generic", ver:"3.13.0-55.94~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.13.0-55-generic-lpae", ver:"3.13.0-55.94~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
