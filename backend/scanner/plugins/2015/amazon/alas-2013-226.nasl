...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-226)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"libgcrypt-debuginfo", rpm:"libgcrypt-debuginfo~1.4.5~9.12.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libgcrypt-devel", rpm:"libgcrypt-devel~1.4.5~9.12.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libgcrypt", rpm:"libgcrypt~1.4.5~9.12.amzn1", rls:"AMAZON"))) {
    report += res;
  }
