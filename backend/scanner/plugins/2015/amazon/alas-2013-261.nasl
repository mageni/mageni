...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-261)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"coreutils-libs", rpm:"coreutils-libs~8.4~31.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"coreutils", rpm:"coreutils~8.4~31.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"coreutils-debuginfo", rpm:"coreutils-debuginfo~8.4~31.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }
