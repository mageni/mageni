...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152800.html");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"patch", rpm:"patch~2.7.5~1.fc21", rls:"FC21")) != NULL)
  {
