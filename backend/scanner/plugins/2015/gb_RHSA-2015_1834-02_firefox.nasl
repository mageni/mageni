...
#
# RedHat Update for firefox RHSA-2015:1834-02
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.871455");
  script_version("$Revision: 12497 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-23 09:28:21 +0100 (Fri, 23 Nov 2018) $");
  script_tag(name:"creation_date", value:"2015-09-25 07:18:26 +0200 (Fri, 25 Sep 2015)");
  ...
  script_name("RedHat Update for firefox RHSA-2015:1834-02");
...
the update, Firefox must be restarted for the changes to take effect.");
  ...
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2015-September/msg00032.html");
