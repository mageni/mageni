...
if (description)
{
  ...
  script_xref(name:"URL", value:"https://support.f5.com/kb/en-us/solutions/public/16000/700/sol16728.html");
...
check_f5['LTM'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;11.0.0-11.2.1;10.0.0-10.2.4;');

check_f5['AAM'] = make_array( 'affected',   '11.4.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;');

check_f5['AFM'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;');

check_f5['AVR'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;11.0.0-11.2.1;');

check_f5['APM'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;11.0.0-11.2.1;10.1.0-10.2.4;');

check_f5['ASM'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;11.0.0-11.2.1;10.0.0-10.2.4;');

check_f5['GTM'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;11.0.0-11.2.1;10.0.0-10.2.4;');

check_f5['LC'] = make_array( 'affected',   '11.3.0-11.6.0;',
                              'unaffected', '12.0.0;11.6.0_HF6;11.5.3_HF2;11.4.1_HF10;11.0.0-11.2.1;10.0.0-10.2.4;');
