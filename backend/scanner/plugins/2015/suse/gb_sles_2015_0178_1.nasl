...
if(description)
{
  ...
  script_cve_id("CVE-2014-3687","CVE-2014-3690","CVE-2014-8559");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0178-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-January/001198.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2015:0178-1 advisory.");
