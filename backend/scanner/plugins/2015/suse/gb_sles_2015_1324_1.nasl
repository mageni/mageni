...
if(description)
{
  ...
  script_cve_id("CVE-2014-9728","CVE-2014-9729","CVE-2014-9730");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:1324-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for 'the SUSE Linux  Enterprise 12 kernel'
  package(s) announced via the SUSE-SU-2015:1324-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'the SUSE Linux  Enterprise 12 kernel' package(s) on SUSE Linux Enterprise Server 12 (ppc64le s390x x86_64), SUSE Linux Enterprise Server 12 (x86_64), SUSE Linux Enterprise Server 12 (noarch), SUSE Linux Enterprise Server 12 (s390x)");
