...
if(description)
{
  ...
  script_cve_id("CVE-2015-0801","CVE-2015-0807","CVE-2015-0813");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0704-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-April/001344.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'MozillaFirefox'
  package(s) announced via the SUSE-SU-2015:0704-1 advisory.");
