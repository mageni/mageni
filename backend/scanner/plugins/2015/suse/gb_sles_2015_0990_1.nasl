...
if(description)
{
  ...
  script_cve_id("CVE-2015-3143","CVE-2015-3144","CVE-2015-3145");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0990-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-June/001421.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'curl'
  package(s) announced via the SUSE-SU-2015:0990-1 advisory.");
