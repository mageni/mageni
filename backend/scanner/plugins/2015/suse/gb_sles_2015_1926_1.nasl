...
if(description)
{
  ...
  script_cve_id("CVE-2015-4513","CVE-2015-7181","CVE-2015-7182");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:1926-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-November/001671.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'MozillaFirefox,  mozilla-nspr, mozilla-nss'
  package(s) announced via the SUSE-SU-2015:1926-1 advisory.");
