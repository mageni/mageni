...
if(description)
{
  ...
  script_cve_id("CVE-2014-3673","CVE-2014-3687","CVE-2014-7822");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0529-1)");
  ...
  package(s) announced via the SUSE-SU-2015:0529-1 advisory.");
