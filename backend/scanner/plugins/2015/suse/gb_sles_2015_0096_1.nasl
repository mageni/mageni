...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2015:0096-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-January/001167.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'bind'
  package(s) announced via the SUSE-SU-2015:0096-1 advisory.");
