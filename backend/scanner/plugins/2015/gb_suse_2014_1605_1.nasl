...
# $Id: gb_suse_2014_1605_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for OpenVPN SUSE-SU-2014:1605-1 (OpenVPN)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for OpenVPN SUSE-SU-2014:1605-1 (OpenVPN)");
...
if(release == "SLES11.0SP3")
{
  ...
  if ((res = isrpmvuln(pkg:"openvpn", rpm:"openvpn~2.0.9~143.44.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openvpn-auth-pam-plugin", rpm:"openvpn-auth-pam-plugin~2.0.9~143.44.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
