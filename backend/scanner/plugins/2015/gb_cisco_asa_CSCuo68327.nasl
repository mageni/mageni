...
# $Id: gb_cisco_asa_CSCuo68327.nasl 12106 2018-10-26 06:33:36Z cfischer $
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3388");
  script_bugtraq_id(70305);

  script_name("Cisco ASA DNS Inspection Engine DoS Vulnerability");
...
if ((revcomp(a:compver, b:"9.0.4.13") < 0) &&
    (revcomp(a:compver, b:"9.0.4.8") >= 0)) {
...
if ((revcomp(a:compver, b:"9.1.5.7") < 0) &&
    (revcomp(a:compver, b:"9.1.5.2") >= 0)) {
  report = 'Installed Version: ' + version + '\n' +
           'Fixed Version:     9.1(5.7)\n';
  security_message(port: 0, data:report);
  exit(0);
}
