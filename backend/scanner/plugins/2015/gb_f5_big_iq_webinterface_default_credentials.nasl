...
# $Id: gb_f5_big_iq_webinterface_default_credentials.nasl 11872 2018-10-12 11:22:41Z cfischer $
#
...
if (description)
{
  ...
  script_dependencies("gb_f5_big_iq_web_detect.nasl");
...
access to sensitive information or modify system configuration.');
  ...
  script_mandatory_keys("f5/big_iq/web_management/installed");
...
port = get_kb_item("f5/big_iq/web_management/port");
if( ! port ) exit( 0 );
