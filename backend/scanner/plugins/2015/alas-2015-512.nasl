...
# $Id: alas-2015-512.nasl 6575 2017-07-06 13:42:08Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2015-512");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"python26-botocore", rpm:"python26-botocore~0.103.0~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python27-botocore", rpm:"python27-botocore~0.103.0~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python-botocore", rpm:"python-botocore~0.103.0~1.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
