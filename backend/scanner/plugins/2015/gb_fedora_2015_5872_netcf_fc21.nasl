...
#
# Fedora Update for netcf FEDORA-2015-5872
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"netcf on Fedora 21");
...
if(release == "FC21")
{
  ...
  if ((res = isrpmvuln(pkg:"netcf", rpm:"netcf~0.2.8~1.fc21", rls:"FC21")) != NULL)
  {
