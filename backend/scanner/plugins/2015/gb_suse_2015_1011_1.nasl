...
# $Id: gb_suse_2015_1011_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
# SuSE Update for cups SUSE-SU-2015:1011-1 (cups)
#
# Authors:
...
if(release == "SLES11.0SP3")
{
  ...
  if ((res = isrpmvuln(pkg:"cups", rpm:"cups~1.3.9~8.46.56.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-client", rpm:"cups-client~1.3.9~8.46.56.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.3.9~8.46.56.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs-32bit", rpm:"cups-libs-32bit~1.3.9~8.46.56.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"cups-libs-x86", rpm:"cups-libs-x86~1.3.9~8.46.56.1", rls:"SLES11.0SP3")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
