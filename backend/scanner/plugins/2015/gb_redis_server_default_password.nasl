...
# $Id: gb_redis_server_default_password.nasl 10074 2018-06-05 08:01:45Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"vuldetect", value:"Evaluate if the remote Redis server is protected by a default password.");
