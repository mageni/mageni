...
# $Id: mgasa-2015-0380.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0380");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"shutter", rpm:"shutter~0.93~4.1.mga5", rls:"MAGEIA5")) != NULL) {
