...
# $Id: mgasa-2015-0462.nasl 11692 2018-09-28 16:55:19Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.131142");
  script_version("$Revision: 11692 $");
  script_tag(name:"creation_date", value:"2015-12-02 11:02:36 +0200 (Wed, 02 Dec 2015)");
  script_tag(name:"last_modification", value:"$Date: 2018-09-28 18:55:19 +0200 (Fri, 28 Sep 2018) $");
  script_name("Mageia Linux Local Check: mgasa-2015-0462");
  ...
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2015-0462.html");
  ...
  script_tag(name:"summary", value:"Mageia Linux Local Security Checks mgasa-2015-0462");
...
if(release == "MAGEIA5")
{
if ((res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~38.4.0~1.mga5", rls:"MAGEIA5")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"thunderbird-l10n", rpm:"thunderbird-l10n~38.4.0~1.mga5", rls:"MAGEIA5")) != NULL) {
  security_message(data:res);
  exit(0);
}
