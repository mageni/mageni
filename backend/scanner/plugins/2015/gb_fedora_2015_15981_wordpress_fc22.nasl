...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.869965");
  ...
  script_name("Fedora Update for wordpress FEDORA-2015-15981");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2015-September/167701.html");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~4.3.1~1.fc22", rls:"FC22")) != NULL)
  {
