...
# $Id: ELSA-2015-2369.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2015-2369 - openhpi security, bug fix, and enhancement update. Please see the references for more insight.");
