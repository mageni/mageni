...
# $Id: deb_3233.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"hostapd", ver:"1.0-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"wpagui", ver:"1.0-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"wpasupplicant", ver:"1.0-3+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
