...
# $Id: ELSA-2013-1866.nasl 11688 2018-09-28 13:36:28Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"ELSA-2013-1866 - ca-certificates security update. Please see the references for more insight.");
...
{
  if ((res = isrpmvuln(pkg:"ca-certificates", rpm:"ca-certificates~2013.1.95~65.1.el6_5", rls:"OracleLinux6")) != NULL) {
