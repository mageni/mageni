...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0693-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-March/008428.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openldap2'
  package(s) announced via the SUSE-SU-2021:0693-1 advisory.");
