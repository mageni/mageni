...
if(description)
{
  ...
  script_cve_id("CVE-2020-0465","CVE-2020-0466","CVE-2020-29569");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0408-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-February/008299.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel (Live Patch 32 for SLE 12 SP3)'
  package(s) announced via the SUSE-SU-2021:0408-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'the Linux Kernel (Live Patch 32 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12");
