...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2021.2766.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:2766-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:2766-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212766-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spice-vdagent' package(s) announced via the SUSE-SU-2021:2766-1 advisory.");
...
CVE-2020-25653: UNIX domain socket peer PID retrieved via `SO_PEERCRED`
 is subject to race condition (bsc#1177783)");
  ...
  script_tag(name:"affected", value:"'spice-vdagent' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"spice-vdagent", rpm:"spice-vdagent~0.16.0~8.8.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"spice-vdagent-debuginfo", rpm:"spice-vdagent-debuginfo~0.16.0~8.8.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"spice-vdagent-debugsource", rpm:"spice-vdagent-debugsource~0.16.0~8.8.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
