...
Long brackets with a huge number of '=' overflow some internal buffer
 arithmetic.");
  ...
  script_tag(name:"affected", value:"'lua53' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
