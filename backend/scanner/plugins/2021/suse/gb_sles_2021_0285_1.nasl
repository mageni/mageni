...
CVE-2019-8842: Fixed an out-of-bounds read in an extension field
 (bsc#1170671).");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on SUSE Linux Enterprise Module for Development Tools 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2");
