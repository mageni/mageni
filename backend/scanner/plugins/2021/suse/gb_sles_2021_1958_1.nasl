...
CVE-2020-17541: Fixed a stack-based buffer overflow in the 'transform'
 component (bsc#1186764).");
  ...
  script_tag(name:"affected", value:"'libjpeg-turbo' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP3, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2, SUSE Linux Enterprise Module for Desktop Applications 15-SP3, SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
