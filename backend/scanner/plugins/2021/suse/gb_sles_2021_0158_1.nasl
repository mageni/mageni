...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:0158-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for 'tcmu-runner'
  package(s) announced via the SUSE-SU-2021:0158-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'tcmu-runner' package(s) on SUSE Linux Enterprise Server 15");
...
if(release == "SLES15.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"libtcmu2", rpm:"libtcmu2~1.4.0~3.9.1", rls:"SLES15.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtcmu2-debuginfo", rpm:"libtcmu2-debuginfo~1.4.0~3.9.1", rls:"SLES15.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcmu-runner", rpm:"tcmu-runner~1.4.0~3.9.1", rls:"SLES15.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcmu-runner-debuginfo", rpm:"tcmu-runner-debuginfo~1.4.0~3.9.1", rls:"SLES15.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcmu-runner-debugsource", rpm:"tcmu-runner-debugsource~1.4.0~3.9.1", rls:"SLES15.0LTSS"))){
    report += res;
  }
