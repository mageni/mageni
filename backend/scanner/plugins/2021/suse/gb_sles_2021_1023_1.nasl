...
if(description)
{
  ...
  script_cve_id("CVE-2020-28368","CVE-2021-20257","CVE-2021-28687");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2021:1023-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-April/008585.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2021:1023-1 advisory.");
