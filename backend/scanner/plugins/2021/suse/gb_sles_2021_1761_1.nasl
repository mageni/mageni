...
CVE-2021-3504: hivex: missing bounds check within hivex_open()
 (bsc#1185013)");
  ...
  script_tag(name:"affected", value:"'hivex' package(s) on SUSE MicroOS 5.0, SUSE Linux Enterprise Module for Development Tools 15-SP3, SUSE Linux Enterprise Module for Development Tools 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Basesystem 15-SP2");
