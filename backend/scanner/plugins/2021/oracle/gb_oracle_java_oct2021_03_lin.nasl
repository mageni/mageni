...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818834");
  script_version("2021-10-28T14:17:20+0000");
  script_cve_id("CVE-2021-35550", "CVE-2021-35565");
  ...
  script_tag(name:"creation_date", value:"2021-10-25 16:21:37 +0530 (Mon, 25 Oct 2021)");
  script_name("Oracle Java SE Security Update (oct2021) 03 - Linux");
  ...
  and earlier, 7u311 (1.7.0.311) and earlier, 11.0.12 and earlier on Linux.");
