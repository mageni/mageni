...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.145234");
  script_version("2021-02-10T15:21:20+0000");
  script_tag(name:"last_modification", value:"2021-02-11 11:09:43 +0000 (Thu, 11 Feb 2021)");
  script_tag(name:"creation_date", value:"2021-01-22 07:17:18 +0000 (Fri, 22 Jan 2021)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");

  script_cve_id("CVE-2021-2028", "CVE-2021-2030", "CVE-2021-2055", "CVE-2021-2042");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL 8.0 <= 8.0.21 Security Update (cpujan2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL versions 8.0 through 8.0.21.");
