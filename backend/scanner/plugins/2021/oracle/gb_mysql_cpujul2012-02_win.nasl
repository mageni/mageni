...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117265");
  ...
  # nb: From the vendor advisory: CVE-2012-1734 and CVE-2012-2749 are equivalent.
  script_cve_id("CVE-2012-0540", "CVE-2012-1734", "CVE-2012-2749");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server <= 5.1.62 / 5.4.x <= 5.5.23 Security Update (cpujul2012) - Windows");
  ...
  availability via unknown vectors related to the 'Server Optimizer' and 'GIS Extension'
  package / privilege.");

  script_tag(name:"affected", value:"Oracle MySQL Server 5.1.62 and prior and 5.4.x
  through 5.5.23.");

  script_tag(name:"solution", value:"Update to version 5.1.63, 5.5.24 or later.");
...
else if (version_in_range(version: version, test_version: "5.4", test_version2: "5.5.23")) {
