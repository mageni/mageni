...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146357");
  script_version("2021-07-22T08:06:30+0000");
  script_tag(name:"last_modification", value:"2021-07-22 11:15:29 +0000 (Thu, 22 Jul 2021)");
  script_tag(name:"creation_date", value:"2021-07-22 07:56:00 +0000 (Thu, 22 Jul 2021)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:M/C:N/I:N/A:C");

  script_cve_id("CVE-2021-2412");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0 <= 8.0.21 Security Update (cpujul2021) - Windows");
  ...
  vulnerability in the Optimizer component.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Oracle MySQL Server version 8.0 through 8.0.21.");
...
if (version_in_range(version: version, test_version: "8.0", test_version2: "8.0.21")) {
