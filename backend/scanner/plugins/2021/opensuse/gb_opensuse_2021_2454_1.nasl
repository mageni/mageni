...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854018");
  ...
  script_tag(name:"creation_date", value:"2021-07-23 03:01:50 +0000 (Fri, 23 Jul 2021)");
  script_name("openSUSE: Security Advisory for transfig (openSUSE-SU-2021:2454-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:2454-1");
  ...
  package(s) announced via the openSUSE-SU-2021:2454-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"transfig", rpm:"transfig~3.2.8a~4.12.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"transfig-debuginfo", rpm:"transfig-debuginfo~3.2.8a~4.12.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"transfig-debugsource", rpm:"transfig-debugsource~3.2.8a~4.12.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }
