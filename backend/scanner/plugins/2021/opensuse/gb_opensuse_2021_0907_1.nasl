...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853884");
  ...
  script_tag(name:"creation_date", value:"2021-06-25 03:01:50 +0000 (Fri, 25 Jun 2021)");
  script_name("openSUSE: Security Advisory for cryptctl (openSUSE-SU-2021:0907-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:0907-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/DGYSYGNUS4QKFOUUYGCDWJ7IFEVXEUO2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cryptctl'
  package(s) announced via the openSUSE-SU-2021:0907-1 advisory.");
  ...
  script_tag(name:"affected", value:"'cryptctl' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cryptctl", rpm:"cryptctl~2.4~lp152.5.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cryptctl-debuginfo", rpm:"cryptctl-debuginfo~2.4~lp152.5.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
