...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854053");
  ...
  script_tag(name:"creation_date", value:"2021-08-11 03:02:23 +0000 (Wed, 11 Aug 2021)");
  script_name("openSUSE: Security Advisory for mysql-connector-java (openSUSE-SU-2021:1126-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1126-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/WS25DT4QDBVK3PBC74G4JTBWADK62LTQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-connector-java'
  package(s) announced via the openSUSE-SU-2021:1126-1 advisory.");
  ...
  script_tag(name:"affected", value:"'mysql-connector-java' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mysql-connector-java", rpm:"mysql-connector-java~5.1.47~lp152.2.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
