...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854217");
  ...
  script_tag(name:"creation_date", value:"2021-10-13 01:02:25 +0000 (Wed, 13 Oct 2021)");
  script_name("openSUSE: Security Advisory for systemd (openSUSE-SU-2021:3348-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:3348-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/MCSKB4ZMNVGFIMLLPPNFDQMFKY7DLL4L");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the openSUSE-SU-2021:3348-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"systemd-bash-completion-234", rpm:"systemd-bash-completion-234~24.93.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
