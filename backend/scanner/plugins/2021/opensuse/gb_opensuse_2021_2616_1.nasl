...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854040");
  ...
  script_tag(name:"creation_date", value:"2021-08-07 03:01:43 +0000 (Sat, 07 Aug 2021)");
  script_name("openSUSE: Security Advisory for mariadb (openSUSE-SU-2021:2616-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:2616-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CIBQJA52DDSVBOYKKQO4M2QLZ3Q6SVJ2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb'
  package(s) announced via the openSUSE-SU-2021:2616-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb-galera", rpm:"mariadb-galera~10.4.20~3.9.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
