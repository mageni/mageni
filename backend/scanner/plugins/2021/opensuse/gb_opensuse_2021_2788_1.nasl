...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854090");
  ...
  script_tag(name:"creation_date", value:"2021-08-21 03:01:55 +0000 (Sat, 21 Aug 2021)");
  script_name("openSUSE: Security Advisory for go1.16 (openSUSE-SU-2021:2788-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:2788-1");
  ...
  package(s) announced via the openSUSE-SU-2021:2788-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.16", rpm:"go1.16~1.16.7~1.23.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.16-doc", rpm:"go1.16-doc~1.16.7~1.23.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.16-race", rpm:"go1.16-race~1.16.7~1.23.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
