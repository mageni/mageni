...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118204");
  ...
  script_name("Python 2.7.x < 2.7.17, 3.5.x < 3.5.8, 3.6.x < 3.6.9, 3.7.x < 3.7.4 Information Disclosure Vulnerability (bpo-36742) - Mac OS X");
  ...
  script_tag(name:"insight", value:"'urlsplit' is affected by a NFKD normalization vulnerability
  in 'user:password@'.
  ...
  script_tag(name:"affected", value:"Python 2.7.x prior to version 2.7.17, versions 3.5.x prior to 3.5.8,
  3.6.x prior to 3.6.9 and 3.7.x prior to 3.7.4.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for
  more information.");

  script_xref(name:"URL", value:"https://python-security.readthedocs.io/vuln/urlsplit-nfkc-normalization2.html");
  script_xref(name:"Advisory-ID", value:"bpo-36742");
