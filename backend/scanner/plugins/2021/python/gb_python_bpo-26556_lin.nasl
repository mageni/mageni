...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.118256");
  ...
  script_name("Python < 2.7.12, 3.3.x < 3.3.7, 3.4.x < 3.4.5, 3.5.x < 3.5.2 Expat 2.1.1 (bpo-26556) - Linux");
  ...
  script_tag(name:"summary", value:"Python is prone to multiple integer overflows in Expat.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple integer overflows in the XML_GetBuffer function in Expat
  through 2.1.0 allow remote attackers to cause a denial of service (heap-based buffer overflow) or
  possibly have unspecified other impact via crafted XML data, a related issue to CVE-2015-2716.");

  script_tag(name:"affected", value:"Python prior to version 2.7.12, versions 3.3.x prior to 3.3.7,
  3.4.x prior to 3.4.5 and 3.5.x prior to 3.5.2.");

  script_tag(name:"solution", value:"Update to version 2.7.12, 3.3.7, 3.4.5, 3.5.2 or later.");

  script_xref(name:"URL", value:"https://python-security.readthedocs.io/vuln/expat-2.1.1.html");
  script_xref(name:"Advisory-ID", value:"bpo-26556");
