...
if(description)
{
  ...
  script_version("2021-11-01T15:55:16+0000");
  script_tag(name:"last_modification", value:"2021-11-01 15:55:16 +0000 (Mon, 01 Nov 2021)");
  ...
  script_name("Python < 2.7.8 Integer Overflow Vulnerability (Oct14) - Linux");
