...
if (description)
{
  ...
  script_version("2021-03-08T04:10:26+0000");
  ...
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:M/C:C/I:P/A:P");

  script_cve_id("CVE-2020-8296");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Nextcloud Server Stored Cleartext Passwords Vulnerability (NC-SA-2021-006)");
  ...
  script_tag(name:"summary", value:"Nextcloud Server is prone to a vulnerability where cleartext passwords are
  stored in cleartext.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"A missing condition causes the external storage app to always store the
  users password in a recoverable format.");
