...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883315");
  ...
  script_tag(name:"creation_date", value:"2021-01-16 04:00:36 +0000 (Sat, 16 Jan 2021)");
  script_name("CentOS: Security Advisory for firefox (CESA-2021:0053)");
  ...
  script_xref(name:"CESA", value:"2021:0053");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2021-January/048243.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2021:0053 advisory.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~78.6.1~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
