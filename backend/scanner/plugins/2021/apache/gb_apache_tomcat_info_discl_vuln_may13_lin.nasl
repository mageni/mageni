...
if (description)
{
  ...
  script_name("Apache Tomcat Information Disclosure Vulnerability (May 2013) - Linux");
  ...
  script_tag(name:"affected", value:"Apache Tomcat 7.x through 7.0.39.");
...
if (version_in_range(version: version, test_version: "7.0.0", test_version2: "7.0.39")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.0.40", install_path: location);
