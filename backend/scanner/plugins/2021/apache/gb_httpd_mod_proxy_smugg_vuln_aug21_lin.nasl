...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117615");
  script_version("2021-08-09T08:14:10+0000");
  ...
  script_name("Apache HTTP Server <= 2.4.48 'mod_proxy' HTTP/2 Request Smuggling Vulnerability - Linux");
  ...
  script_tag(name:"affected", value:"Apache HTTP Server version through 2.4.48 running the mod_proxy
  module together with an enabled HTTP/2 protocol.");

  script_tag(name:"solution", value:"No known solution is available as of 09th August, 2021.
  Information regarding this issue will be updated once solution details are available.

  As a workaround disable the HTTP/2 protocol.");
...
if( version_is_less_equal( version:version, test_version:"2.4.48" ) ) {
