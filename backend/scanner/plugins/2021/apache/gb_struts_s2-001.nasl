...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117659");
  script_version("2021-09-14T13:16:43+0000");
  ...
  script_name("Apache Struts Security Update (S2-001)");
  ...
  script_xref(name:"URL", value:"https://cwiki.apache.org/confluence/display/WW/S2-001");
  script_xref(name:"Advisory-ID", value:"S2-001");
  ...
  script_tag(name:"affected", value:"Apache Struts 2.0.0 through 2.0.8.");
...
if (version_in_range(version: version, test_version: "2.0.0", test_version2: "2.0.8")) {
