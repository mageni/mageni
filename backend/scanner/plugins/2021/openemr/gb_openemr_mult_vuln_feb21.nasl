...
if(description)
{
  ...
  script_version("2021-02-16T14:54:37+0000");
  ...
  script_cve_id("CVE-2020-29139", "CVE-2020-29140", "CVE-2020-29142", "CVE-2020-29143");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("OpenEMR < 5.0.2-5 Multiple SQL Injection Vulnerabilities");
  ...
  script_tag(name:"summary", value:"OpenEMR is prone to multiple SQL injection vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The following files are vulnerable to SQL injection:

  - interface/main/finder/patient_select.php from library/patient.inc (CVE-2020-29139)

  - interface/reports/immunization_report.php (CVE-2020-29140)

  - interface/usergroup/usergroup_admin.php (CVE-2020-29142)

  - interface/reports/non_reported.php (CVE-2020-29143)");
