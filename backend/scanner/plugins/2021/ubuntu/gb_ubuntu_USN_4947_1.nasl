...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-oem-5.6 (USN-4947-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-May/006015.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.6'
  package(s) announced via the USN-4947-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Kiyin () discovered that the x25 implementation in the Linux kernel
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.6.0-1056-oem", ver:"5.6.0-1056.60", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-20.04", ver:"5.6.0.1056.52", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
