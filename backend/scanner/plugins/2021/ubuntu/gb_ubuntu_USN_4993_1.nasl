...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dovecot (USN-4993-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006078.html");
...
STARTTLS negotiation. (CVE-2021-33515)");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Ubuntu 20.10, Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.3.7.2-1ubuntu3.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dovecot-core", ver:"1:2.3.11.3+dfsg1-2ubuntu0.2", rls:"UBUNTU20.10"))) {
    report += res;
  }
