...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for apache-log4j2 (USN-5197-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-December/006318.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-log4j2'
  package(s) announced via the USN-5197-1 advisory.");
