...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-oem-5.10 (USN-5115-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-October/006244.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-5.10'
  package(s) announced via the USN-5115-1 advisory.");
...
memory usage of certain IPC objects. A local attacker co ...
