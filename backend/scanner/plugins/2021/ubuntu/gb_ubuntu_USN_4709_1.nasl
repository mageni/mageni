...
if(description)
{
  ...
  script_cve_id("CVE-2020-28374", "CVE-2018-13093", "CVE-2019-19813", "CVE-2019-19816", "CVE-2020-25669");
  ...
  script_name("Ubuntu: Security Advisory for linux-kvm (USN-4709-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-January/005858.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm'
  package(s) announced via the USN-4709-1 advisory.");
...
(CVE-2020-25669)");
  ...
  script_tag(name:"affected", value:"'linux-kvm' package(s) on Ubuntu 16.04 LTS.");
