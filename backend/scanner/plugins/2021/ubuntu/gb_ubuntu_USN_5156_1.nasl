...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for icu (USN-5156-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-November/006289.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icu'
  package(s) announced via the USN-5156-1 advisory.");
...
possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'icu' package(s) on Ubuntu 20.04 LTS.");
