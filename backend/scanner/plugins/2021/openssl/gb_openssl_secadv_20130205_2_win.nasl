...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112970");
  ...
  script_name("OpenSSL: OCSP Invalid Key DoS Issue (20130205) (Windows)");
  ...
  script_tag(name:"insight", value:"OpenSSL does not properly perform signature verification for
  ...
  script_tag(name:"solution", value:"Update to version 0.9.8y, 1.0.0k, 1.0.1d or later.");
