...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112977");
  ...
  script_name("OpenSSL: Alternative Chains Certificate Forgery (20150709) (Linux)");
  ...
  script_tag(name:"summary", value:"OpenSSL is prone certificate forgery.");
