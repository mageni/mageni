...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819119");
  ...
  script_name("Fedora: Security Advisory for WindowMaker (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4USFBEJ7RNC2C5NFMCCMV5EUBYFXSQOY");
  ...
  script_tag(name:"insight", value:"Window Maker is an X11 window manager designed to give additional
...
most useful and universal window managers available.");
  ...
  script_tag(name:"affected", value:"'WindowMaker' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"WindowMaker", rpm:"WindowMaker~0.95.9~7.fc35", rls:"FC35"))) {
    report += res;
  }
