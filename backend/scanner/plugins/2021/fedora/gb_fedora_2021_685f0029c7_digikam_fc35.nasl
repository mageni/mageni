...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819140");
  ...
  script_name("Fedora: Security Advisory for digikam (FEDORA-2021-685f0029c7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-685f0029c7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GKYJRANVLSXWQ2434LXEAG7WUO6AD34C");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'digikam'
  package(s) announced via the FEDORA-2021-685f0029c7 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"digikam", rpm:"digikam~7.3.0~4.fc35", rls:"FC35"))) {
    report += res;
  }
