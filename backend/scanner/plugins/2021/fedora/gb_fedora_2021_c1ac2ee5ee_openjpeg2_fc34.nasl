...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879748");
  ...
  script_name("Fedora: Security Advisory for openjpeg2 (FEDORA-2021-c1ac2ee5ee)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BCRXAQJZ7774QPW344OO7IBQX5PPDZ7O");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.4.0~3.fc34", rls:"FC34"))) {
    report += res;
  }
