...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879379");
  script_version("2021-04-21T07:29:02+0000");
  script_cve_id("CVE-2020-25670", "CVE-2020-25671", "CVE-2020-25672", "CVE-2020-25673");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2021-04-21 10:10:24 +0000 (Wed, 21 Apr 2021)");
  script_tag(name:"creation_date", value:"2021-04-17 03:05:14 +0000 (Sat, 17 Apr 2021)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2021-21360476b6)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PW3OASG7OEMHANDWBM5US5WKTOC76KMH");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.11.14~100.fc32", rls:"FC32"))) {
    report += res;
  }
