...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819368");
  ...
  script_name("Fedora: Security Advisory for guacamole-server (FEDORA-2021-ac23d9e47f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KBJ5L26GHLKCXDHME7ND7BEO2AAGONFY");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"guacamole-server", rpm:"guacamole-server~1.3.0~9.fc33", rls:"FC33"))) {
    report += res;
  }
