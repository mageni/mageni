...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879799");
  ...
  script_name("Fedora: Security Advisory for ansible (FEDORA-2021-4ad7c70d71)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-4ad7c70d71");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZZWULBQYTOURAJ3ITFOK3YWMXGHLW7QB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible'
  package(s) announced via the FEDORA-2021-4ad7c70d71 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ansible", rpm:"ansible~2.9.23~1.fc33", rls:"FC33"))) {
    report += res;
  }
