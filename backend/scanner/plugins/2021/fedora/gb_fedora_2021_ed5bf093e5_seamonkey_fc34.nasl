...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819350");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:03 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2021-ed5bf093e5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-ed5bf093e5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IWSFDDQJJ73RPHLDNO46MLI4BTVVNXW4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2021-ed5bf093e5 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.10~2.fc34", rls:"FC34"))) {
    report += res;
  }
