...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879382");
  script_version("2021-04-21T07:29:02+0000");
  script_cve_id("CVE-2021-30184");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2021-04-21 10:10:24 +0000 (Wed, 21 Apr 2021)");
  script_tag(name:"creation_date", value:"2021-04-17 03:05:19 +0000 (Sat, 17 Apr 2021)");
  script_name("Fedora: Security Advisory for gnuchess (FEDORA-2021-2c714d311f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-2c714d311f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QC74RWMDLSQGV6Z3ZABNTPABB33S4YNF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnuchess'
  package(s) announced via the FEDORA-2021-2c714d311f advisory.");
...
you&#39, ll also need to install the xboard package and the X Window System.");
  ...
  script_tag(name:"affected", value:"'gnuchess' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnuchess", rpm:"gnuchess~6.2.7~5.fc33", rls:"FC33"))) {
    report += res;
  }
