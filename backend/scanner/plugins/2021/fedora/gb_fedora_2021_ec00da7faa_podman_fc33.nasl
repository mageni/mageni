...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879451");
  ...
  script_name("Fedora: Security Advisory for podman (FEDORA-2021-ec00da7faa)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IKOQ2O3CAYO75ZV2PUCTL6G72K7JVGCT");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~3.1.2~1.fc33", rls:"FC33"))) {
    report += res;
  }
