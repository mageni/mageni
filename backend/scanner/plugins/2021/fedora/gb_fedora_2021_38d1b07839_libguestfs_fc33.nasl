...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818443");
  ...
  script_name("Fedora: Security Advisory for libguestfs (FEDORA-2021-38d1b07839)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XKZ4NNI4W74LOQLGAH4ZJSCC3UW2PMPD");
...
Language bindings:
 ...
 libguestfs-gobject-devel  GObject bindings and GObject Introspection
  ...
  script_tag(name:"affected", value:"'libguestfs' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libguestfs", rpm:"libguestfs~1.44.1~2.fc33", rls:"FC33"))) {
    report += res;
  }
