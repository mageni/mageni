...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819069");
  ...
  script_name("Fedora: Security Advisory for xstream (FEDORA-2021-5e376c0ed9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-5e376c0ed9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PVPHZA7VW2RRSDCOIPP2W6O5ND254TU7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xstream'
  package(s) announced via the FEDORA-2021-5e376c0ed9 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xstream", rpm:"xstream~1.4.18~2.fc35", rls:"FC35"))) {
    report += res;
  }
