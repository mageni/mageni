...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819100");
  ...
  script_name("Fedora: Security Advisory for rpki-client (FEDORA-2021-6a91085462)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-6a91085462");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XJ7XN5EYMRQB7JZW6PU732SLJEGYMERY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client'
  package(s) announced via the FEDORA-2021-6a91085462 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~7.4~1.fc35", rls:"FC35"))) {
    report += res;
  }
