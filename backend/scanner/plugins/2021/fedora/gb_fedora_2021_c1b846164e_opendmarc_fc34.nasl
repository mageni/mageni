...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879548");
  ...
  script_tag(name:"creation_date", value:"2021-05-08 03:06:44 +0000 (Sat, 08 May 2021)");
  script_name("Fedora: Security Advisory for opendmarc (FEDORA-2021-c1b846164e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-c1b846164e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JHDKMCZGE3W4XBP76NLI2Q7IOZHXLD4A");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opendmarc'
  package(s) announced via the FEDORA-2021-c1b846164e advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opendmarc", rpm:"opendmarc~1.4.0~1.fc34", rls:"FC34"))) {
    report += res;
  }
