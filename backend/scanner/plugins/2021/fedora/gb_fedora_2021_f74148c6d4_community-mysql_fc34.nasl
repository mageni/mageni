...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819097");
  ...
  script_tag(name:"creation_date", value:"2021-11-14 02:26:12 +0000 (Sun, 14 Nov 2021)");
  script_name("Fedora: Security Advisory for community-mysql (FEDORA-2021-f74148c6d4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-f74148c6d4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PRCU3RTIPVKPC3GMC76YW7DJEXUEY6FG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'community-mysql'
  package(s) announced via the FEDORA-2021-f74148c6d4 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"community-mysql", rpm:"community-mysql~8.0.27~1.fc34", rls:"FC34"))) {
    report += res;
  }
