...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879778");
  ...
  script_tag(name:"creation_date", value:"2021-06-24 05:39:16 +0000 (Thu, 24 Jun 2021)");
  script_name("Fedora: Security Advisory for iaito (FEDORA-2021-ca59eb65a9)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/W3LPB5VGCIA7WA55FSB3YZQFUGZKWD7O");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"iaito", rpm:"iaito~5.2.2~3.fc33", rls:"FC33"))) {
    report += res;
  }
