...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878978");
  ...
  script_name("Fedora: Security Advisory for python3.8 (FEDORA-2021-7d3a9004e2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-7d3a9004e2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MNUN5SOMFL2BBKP6ZAICIIUPQKZDMGYO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.8'
  package(s) announced via the FEDORA-2021-7d3a9004e2 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.8", rpm:"python3.8~3.8.8~1.fc33", rls:"FC33"))) {
    report += res;
  }
