...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819327");
  ...
  script_tag(name:"creation_date", value:"2021-12-05 02:19:20 +0000 (Sun, 05 Dec 2021)");
  script_name("Fedora: Security Advisory for synfig (FEDORA-2021-b58af96f33)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MXKK2KM7T7PPLJKIKNLTQUJAJVC6DKQ4");
  ...
  script_tag(name:"insight", value:"Synfig is a powerful, industrial-strength vector-based 2D animation
...
Install synfigstudio package for GUI-based animation studio.");
  ...
  script_tag(name:"affected", value:"'synfig' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"synfig", rpm:"synfig~1.4.0~1.fc34.1", rls:"FC34"))) {
    report += res;
  }
