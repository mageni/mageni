...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819046");
  ...
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2021-7cc30bb3dd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-7cc30bb3dd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PWDPLAWBCCANMT4V5RXJ7GEU4R7PXNFH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2021-7cc30bb3dd advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenmpt", rpm:"libopenmpt~0.5.12~1.fc34", rls:"FC34"))) {
    report += res;
  }
