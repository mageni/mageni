...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879049");
  ...
  script_name("Fedora: Security Advisory for libebml (FEDORA-2021-aa78f97893)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-aa78f97893");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JNHQI6MDOECJ2HT5GCLEX2DMJFEOWPW7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libebml'
  package(s) announced via the FEDORA-2021-aa78f97893 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libebml", rpm:"libebml~1.4.2~1.fc33", rls:"FC33"))) {
    report += res;
  }
