...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819131");
  ...
  script_name("Fedora: Security Advisory for vips (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/76HU6MNRRPVQXGEIS6YNBBMZDLDIYLXO");
...
against VIPS.");
  ...
  script_tag(name:"affected", value:"'vips' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vips", rpm:"vips~8.11.3~6.fc35", rls:"FC35"))) {
    report += res;
  }
