...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819351");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:23:44 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for gnome-remote-desktop (FEDORA-2021-5d227916bc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A52J4QZXXA4U5XGSJW5DDSRYD7LBLLMW");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-remote-desktop", rpm:"gnome-remote-desktop~40.2~2.fc34", rls:"FC34"))) {
    report += res;
  }
