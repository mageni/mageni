...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879143");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-90083c9c0f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IP7KCKEZXNJTW32YZIEIWWA72O6ERVMI");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.11.7~300.fc34", rls:"FC34"))) {
    report += res;
  }
