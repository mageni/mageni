...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818751");
  ...
  script_name("Fedora: Security Advisory for radare2 (FEDORA-2021-55198e6804)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/N22IVMSXWVQT5LMAJHOVAGQM2EDSRV5W");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"radare2", rpm:"radare2~5.4.0~1.fc33", rls:"FC33"))) {
    report += res;
  }
