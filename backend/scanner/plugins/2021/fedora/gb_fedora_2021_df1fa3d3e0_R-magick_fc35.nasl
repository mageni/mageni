...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819175");
  ...
  script_tag(name:"creation_date", value:"2021-11-14 02:25:51 +0000 (Sun, 14 Nov 2021)");
  script_name("Fedora: Security Advisory for R-magick (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EX3CDHCQLXOUCQKEK4SHF37GJ42RUPDT");
...
coordinates.");
  ...
  script_tag(name:"affected", value:"'R-magick' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"R-magick", rpm:"R-magick~2.7.3~2.fc35", rls:"FC35"))) {
    report += res;
  }
