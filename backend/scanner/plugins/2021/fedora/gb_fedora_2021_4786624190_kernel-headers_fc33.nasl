...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879877");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-4786624190)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TS7SZNLYGNMFA44VTDFUZ2VKOR2KEEOM");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.13.3~100.fc33", rls:"FC33"))) {
    report += res;
  }
