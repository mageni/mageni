...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878872");
  ...
  script_name("Fedora: Security Advisory for jasper (FEDORA-2021-2b151590d9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-2b151590d9");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UPOVZTSIQPW2H4AFLMI3LHJEZGBVEQET");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jasper'
  package(s) announced via the FEDORA-2021-2b151590d9 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jasper", rpm:"jasper~2.0.24~1.fc33", rls:"FC33"))) {
    report += res;
  }
