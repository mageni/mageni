...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819311");
  ...
  script_name("Fedora: Security Advisory for skopeo (FEDORA-2021-aacef7fa15)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-aacef7fa15");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RZTO6N55WHKHIZI4IMLY2QFBPMVTAERM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'skopeo'
  package(s) announced via the FEDORA-2021-aacef7fa15 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"skopeo", rpm:"skopeo~1.5.2~1.fc34", rls:"FC34"))) {
    report += res;
  }
