...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819078");
  ...
  script_name("Fedora: Security Advisory for synfig (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IC5UFYMHXIS5TY3N2CMPCP5C3MYPZJH4");
...
Install synfigstudio package for GUI-based animation studio.");
  ...
  script_tag(name:"affected", value:"'synfig' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"synfig", rpm:"synfig~1.4.0~4.fc35", rls:"FC35"))) {
    report += res;
  }
