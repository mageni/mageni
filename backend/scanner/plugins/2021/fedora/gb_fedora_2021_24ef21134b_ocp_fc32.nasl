...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878798");
  ...
  script_tag(name:"creation_date", value:"2021-01-14 09:50:53 +0000 (Thu, 14 Jan 2021)");
  script_name("Fedora: Security Advisory for ocp (FEDORA-2021-24ef21134b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2AU74C3ZCJPQX5GYKSF7363GWILLAQ2E");
...
visualizations.");
  ...
  script_tag(name:"affected", value:"'ocp' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ocp", rpm:"ocp~0.1.22~0.28.git849cc42.fc32", rls:"FC32"))) {
    report += res;
  }
