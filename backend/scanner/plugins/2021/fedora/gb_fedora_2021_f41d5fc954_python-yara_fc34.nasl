...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879518");
  ...
  script_tag(name:"creation_date", value:"2021-05-05 03:17:01 +0000 (Wed, 05 May 2021)");
  script_name("Fedora: Security Advisory for python-yara (FEDORA-2021-f41d5fc954)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5I23HF4ZWWML76HMU356UHAWE6FHVBGD");
...
and a Boolean expression which determine its logic.");
  ...
  script_tag(name:"affected", value:"'python-yara' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-yara", rpm:"python-yara~4.1.0~1.fc34", rls:"FC34"))) {
    report += res;
  }
