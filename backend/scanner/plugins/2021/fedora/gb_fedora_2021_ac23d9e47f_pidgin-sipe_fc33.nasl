...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819325");
  ...
  script_name("Fedora: Security Advisory for pidgin-sipe (FEDORA-2021-ac23d9e47f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MXJXW4LTOUPAXKIF6ECERROKRUIS44H3");
...
This package provides the icon set for Pidgin.");
  ...
  script_tag(name:"affected", value:"'pidgin-sipe' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pidgin-sipe", rpm:"pidgin-sipe~1.25.0~7.fc33", rls:"FC33"))) {
    report += res;
  }
