...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879391");
  ...
  script_name("Fedora: Security Advisory for leptonica (FEDORA-2021-977ebc82da)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RD5AIWHWE334HGYZJR2U3I3JYKSSO2LW");
...
Fundamental image processing and image analysis operations
  ...
  * Pixelwise masking, blending, enhancement, arithmetic ops,
  ...
  script_tag(name:"affected", value:"'leptonica' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"leptonica", rpm:"leptonica~1.80.0~3.fc32", rls:"FC32"))) {
    report += res;
  }
