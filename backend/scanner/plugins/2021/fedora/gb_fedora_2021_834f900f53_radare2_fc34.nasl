...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879785");
  ...
  script_tag(name:"creation_date", value:"2021-06-24 05:39:27 +0000 (Thu, 24 Jun 2021)");
  script_name("Fedora: Security Advisory for radare2 (FEDORA-2021-834f900f53)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/V2UL4V4XKSFJVNNUMFV443UJXGDBYGS4");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"radare2", rpm:"radare2~5.3.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
