...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819330");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:24:58 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for freerdp (FEDORA-2021-ac23d9e47f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WIZUPVRGCWUDAPDOQVUGUIYUO7UWKMXX");
...
machines, xrdp and VirtualBox.");
  ...
  script_tag(name:"affected", value:"'freerdp' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freerdp", rpm:"freerdp~2.4.1~1.fc33", rls:"FC33"))) {
    report += res;
  }
