...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819185");
  ...
  script_name("Fedora: Security Advisory for cacti-spine (FEDORA-2021-cfc1913b5f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YWFYS5JEKGTIKUHORXI2BPBUUYVX3QY4");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cacti-spine", rpm:"cacti-spine~1.2.19~1.fc33", rls:"FC33"))) {
    report += res;
  }
