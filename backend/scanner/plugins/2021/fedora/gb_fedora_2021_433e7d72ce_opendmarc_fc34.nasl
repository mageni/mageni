...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879689");
  ...
  script_tag(name:"creation_date", value:"2021-06-03 06:24:33 +0000 (Thu, 03 Jun 2021)");
  script_name("Fedora: Security Advisory for opendmarc (FEDORA-2021-433e7d72ce)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-433e7d72ce");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KBOGOQOK3TIWWJV66MW5YWNRJAFFYGR5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opendmarc'
  package(s) announced via the FEDORA-2021-433e7d72ce advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opendmarc", rpm:"opendmarc~1.4.1~1.fc34", rls:"FC34"))) {
    report += res;
  }
