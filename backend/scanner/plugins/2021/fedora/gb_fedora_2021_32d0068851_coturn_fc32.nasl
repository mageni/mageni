...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878830");
  ...
  script_tag(name:"creation_date", value:"2021-01-20 04:01:58 +0000 (Wed, 20 Jan 2021)");
  script_name("Fedora: Security Advisory for coturn (FEDORA-2021-32d0068851)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M4CJOPAQT43MYAFU3UROGLEXN3Z6RS4H");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"coturn", rpm:"coturn~4.5.2~1.fc32", rls:"FC32"))) {
    report += res;
  }
