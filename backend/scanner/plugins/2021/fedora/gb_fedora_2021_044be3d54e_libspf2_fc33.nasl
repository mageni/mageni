...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818714");
  ...
  script_tag(name:"creation_date", value:"2021-10-02 01:22:25 +0000 (Sat, 02 Oct 2021)");
  script_name("Fedora: Security Advisory for libspf2 (FEDORA-2021-044be3d54e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-044be3d54e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Y6T4HYXXSUQCGJB2ES6X7Q74YYF7V7XU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libspf2'
  package(s) announced via the FEDORA-2021-044be3d54e advisory.");
...
great deal of effort has been put into the regression tests.");
  ...
  script_tag(name:"affected", value:"'libspf2' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libspf2", rpm:"libspf2~1.2.11~1.20210922git4915c308.fc33", rls:"FC33"))) {
    report += res;
  }
