...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879914");
  ...
  script_tag(name:"creation_date", value:"2021-08-02 03:18:38 +0000 (Mon, 02 Aug 2021)");
  script_name("Fedora: Security Advisory for mingw-python-pillow (FEDORA-2021-bf01a738f3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7V6LCG525ARIX6LX5QRYNAWVDD2MD2SV");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-python-pillow", rpm:"mingw-python-pillow~7.2.0~7.fc33", rls:"FC33"))) {
    report += res;
  }
