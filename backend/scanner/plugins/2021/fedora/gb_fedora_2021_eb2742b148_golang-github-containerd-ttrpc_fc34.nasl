...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819354");
  ...
  script_tag(name:"creation_date", value:"2021-12-04 02:25:08 +0000 (Sat, 04 Dec 2021)");
  script_name("Fedora: Security Advisory for golang-github-containerd-ttrpc (FEDORA-2021-eb2742b148)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-eb2742b148");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EAH2SCWC4MRLDQSHISVW6YBYLUQ4WTSQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-containerd-ttrpc'
  package(s) announced via the FEDORA-2021-eb2742b148 advisory.");
...
use as GRPC.");
  ...
  script_tag(name:"affected", value:"'golang-github-containerd-ttrpc' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-containerd-ttrpc", rpm:"golang-github-containerd-ttrpc~1.1.0~1.fc34", rls:"FC34"))) {
    report += res;
  }
