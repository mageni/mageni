...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878861");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2021-d4f4c994cc)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-d4f4c994cc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GX33MEETAIA2D73MR66RSFXVZZ26ZE5K");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2021-d4f4c994cc advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.6~1.fc32", rls:"FC32"))) {
    report += res;
  }
