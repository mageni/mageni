...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818561");
  ...
  script_tag(name:"creation_date", value:"2021-10-02 01:22:16 +0000 (Sat, 02 Oct 2021)");
  script_name("Fedora: Security Advisory for iaito (FEDORA-2021-d206891379)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MVENTCRIOVE7FTAM2GUVFOBU3A2GEE6O");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"iaito", rpm:"iaito~5.3.1~3.fc34", rls:"FC34"))) {
    report += res;
  }
