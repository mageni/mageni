...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819118");
  ...
  script_name("Fedora: Security Advisory for synfigstudio (FEDORA-2021-df1fa3d3e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NXJOBKM3IKQI7CQ37D52VZS64RXXPWTO");
...
This package contains the GUI-based animation studio.");
  ...
  script_tag(name:"affected", value:"'synfigstudio' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"synfigstudio", rpm:"synfigstudio~1.4.0~3.fc35", rls:"FC35"))) {
    report += res;
  }
