...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818451");
  ...
  script_name("Fedora: Security Advisory for wimlib (FEDORA-2021-c0235d9d79)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IFHFQHPLPXKPUPM2WCEW5XVDXKUXTWIJ");
...
WIMGAPI, ImageX, and DISM.");
  ...
  script_tag(name:"affected", value:"'wimlib' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wimlib", rpm:"wimlib~1.13.4~2.fc34", rls:"FC34"))) {
    report += res;
  }
