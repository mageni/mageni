...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879735");
  ...
  script_name("Fedora: Security Advisory for isync (FEDORA-2021-754af4d52b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-754af4d52b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RPIDLIJKNRJHUVBCL7QGAPAAVPIHQGXK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'isync'
  package(s) announced via the FEDORA-2021-754af4d52b advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"isync", rpm:"isync~1.4.2~1.fc33", rls:"FC33"))) {
    report += res;
  }
