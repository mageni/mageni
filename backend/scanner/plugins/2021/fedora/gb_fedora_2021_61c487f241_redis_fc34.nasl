...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819048");
  ...
  script_tag(name:"creation_date", value:"2021-10-21 01:25:09 +0000 (Thu, 21 Oct 2021)");
  script_name("Fedora: Security Advisory for redis (FEDORA-2021-61c487f241)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2021-61c487f241");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HTYQ5ZF37HNGTZWVNJD3VXP7I6MEEF42");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis'
  package(s) announced via the FEDORA-2021-61c487f241 advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.2.6~1.fc34", rls:"FC34"))) {
    report += res;
  }
