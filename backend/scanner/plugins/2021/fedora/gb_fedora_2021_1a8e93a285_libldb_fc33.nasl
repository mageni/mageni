...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818234");
  ...
  script_name("Fedora: Security Advisory for libldb (FEDORA-2021-1a8e93a285)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZXP3ONIY6MB4C5LDZV4YL5KJCES3UX24");
...
servers, or use local tdb databases.");
  ...
  script_tag(name:"affected", value:"'libldb' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libldb", rpm:"libldb~2.2.1~1.fc33", rls:"FC33"))) {
    report += res;
  }
