...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.145869");
  script_version("2021-04-30T05:00:51+0000");
  script_tag(name:"last_modification", value:"2021-04-30 10:37:53 +0000 (Fri, 30 Apr 2021)");
  script_tag(name:"creation_date", value:"2021-04-30 04:52:23 +0000 (Fri, 30 Apr 2021)");
  ...
  script_name("PHP < 7.3.28 IMAP Header Injection Vulnerability (Apr 2021) - Linux");
  ...
  script_tag(name:"affected", value:"PHP versions prior to 7.3.28.");

  script_tag(name:"solution", value:"Update to version 7.3.28 or later.");
