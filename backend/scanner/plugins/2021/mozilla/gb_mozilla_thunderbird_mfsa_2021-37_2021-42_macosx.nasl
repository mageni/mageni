...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818521");
  ...
  script_tag(name:"creation_date", value:"2021-09-09 00:25:17 +0530 (Thu, 09 Sep 2021)");
  script_name("Mozilla Thunderbird Security Update(mfsa_2021-37_2021-42) - Mac OS X");
