...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2014.22");
  script_cve_id("CVE-2014-1502");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2014-22) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2014-22");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2014-22/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=972622");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"WebGL content injection from one domain to rendering in another
Mozilla developer Jeff Gilbert discovered a mechanism where
