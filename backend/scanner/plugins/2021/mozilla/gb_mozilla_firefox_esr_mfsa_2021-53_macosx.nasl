...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818879");
  ...
  script_tag(name:"creation_date", value:"2021-12-12 23:52:33 +0530 (Sun, 12 Dec 2021)");
  script_name("Mozilla Firefox ESR Security Update (mfsa2021-53) - Mac OS X");
