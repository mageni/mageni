...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2016.11");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2016-11) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2016-11");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2016-11/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1237103");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Application Reputation service disabled in Firefox 43
Mozilla developer Francois Marier reported that the Firefox was unable to reach the Application Reputation service due to a bug introduced in Firefox 43, disabling the ability to warn against potentially malicious downloads. Other parts of the Safe Browsing feature, for example the warnings about phishing and
malicious sites, continued to function.");
