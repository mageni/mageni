...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2021.20");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2021-20) - Linux");
  ...
  script_tag(name:"insight", value:"CVE-2021-29953: Universal Cross-Site Scripting
