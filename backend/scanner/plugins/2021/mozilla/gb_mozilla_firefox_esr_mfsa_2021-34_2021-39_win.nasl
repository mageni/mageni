...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818514");
  ...
  script_name("Mozilla Firefox ESR Security Update(mfsa_2021-34_2021-39) - Windows");
  ...
  78.14 or later. Please see the references for more information.");
