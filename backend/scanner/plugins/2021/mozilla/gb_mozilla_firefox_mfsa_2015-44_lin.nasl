...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2015.44");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2015-44) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2015-44");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2015-44/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1148328");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Certificate verification bypass through the HTTP/2 Alt-Svc header
...
certificate with their own.");
  ...
  script_tag(name:"affected", value:"Firefox version(s) below 37.0.1.");
...
if (version_is_less(version: version, test_version: "37.0.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "37.0.1", install_path: location);
