...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2013.57");
  script_cve_id("CVE-2013-1695");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2013-57) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2013-57");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2013-57/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=849791");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Sandbox restrictions not applied to nested frame elements
