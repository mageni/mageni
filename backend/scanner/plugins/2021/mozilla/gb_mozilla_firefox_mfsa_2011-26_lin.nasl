...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.2.1.2011.26");
  script_cve_id("CVE-2011-2367", "CVE-2011-2368");
  ...
  script_name("Mozilla Firefox Security Advisory (MFSA2011-26) - Linux");
  ...
  script_xref(name:"Advisory-ID", value:"MFSA2011-26");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-26/");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=656752");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=657201");

  script_tag(name:"summary", value:"This host is missing a security update for Mozilla Firefox.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple WebGL crashes
...
determined to be critical.");
  ...
  script_tag(name:"affected", value:"Firefox version(s) below 5.");
...
if (version_is_less(version: version, test_version: "5")) {
