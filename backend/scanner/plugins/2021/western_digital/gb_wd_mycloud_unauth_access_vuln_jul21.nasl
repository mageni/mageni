...
if(description)
{
  ...
  script_version("2021-07-16T06:07:29+0000");
  ...
  script_tag(name:"insight", value:"Addressed a vulnerability in My Cloud SSH configuration that
  could allow unauthorized access via SSH. The vulnerability was addressed by removing the use of
  DSA keys and hardening the SSH configuration.");
  ...
  script_xref(name:"URL", value:"https://os5releasenotes.mycloud.com/#/");
