...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.879315");
  ...
  script_tag(name:"creation_date", value:"2021-04-02 03:05:27 +0000 (Fri, 02 Apr 2021)");
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2021-2306e89112)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JVCQC3OKL7HRLFCBEYIMMG3VNKSYLZHF");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.11.11~200.fc33", rls:"FC33"))) {
    report += res;
  }
