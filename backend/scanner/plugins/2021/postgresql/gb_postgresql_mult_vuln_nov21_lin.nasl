...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147148");
  script_version("2021-11-15T03:28:41+0000");
  script_tag(name:"last_modification", value:"2021-11-15 10:55:03 +0000 (Mon, 15 Nov 2021)");
  script_tag(name:"creation_date", value:"2021-11-15 03:17:12 +0000 (Mon, 15 Nov 2021)");
  ...
  script_name("PostgreSQL < 9.6.24, 10.x < 10.19, 11.x < 11.14, 12.x < 12.9, 13.x < 13.5, 14.x < 14.1 Multiple Vulnerabilities - Linux");
