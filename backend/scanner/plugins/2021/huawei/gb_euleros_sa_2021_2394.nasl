...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2394");
  ...
  script_name("Huawei EulerOS: Security Advisory for libexif (EulerOS-SA-2021-2394)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2394");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2394");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libexif' package(s) announced via the EulerOS-SA-2021-2394 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libexif", rpm:"libexif~0.6.21~6.h7", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
