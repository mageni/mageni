...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1871");
  ...
  script_tag(name:"creation_date", value:"2021-05-19 06:21:16 +0000 (Wed, 19 May 2021)");
  script_name("Huawei EulerOS: Security Advisory for glib2 (EulerOS-SA-2021-1871)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1871");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1871");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'glib2' package(s) announced via the EulerOS-SA-2021-1871 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.58.1~1.h9.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"glib2-devel", rpm:"glib2-devel~2.58.1~1.h9.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"glib2-fam", rpm:"glib2-fam~2.58.1~1.h9.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
