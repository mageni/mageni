...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2120");
  ...
  script_tag(name:"creation_date", value:"2021-07-07 08:42:08 +0000 (Wed, 07 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for cups (EulerOS-SA-2021-2120)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2120");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2120");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'cups' package(s) announced via the EulerOS-SA-2021-2120 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"In macOS High Sierra before 10.13.5, an issue existed in CUPS. This issue was addressed with improved access restrictions.(CVE-2018-4181)
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.6.3~35.h9", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
