...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2601");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg (EulerOS-SA-2021-2601)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2601");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2601");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg' package(s) announced via the EulerOS-SA-2021-2601 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg-libs", rpm:"openjpeg-libs~1.5.1~16.h6", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
