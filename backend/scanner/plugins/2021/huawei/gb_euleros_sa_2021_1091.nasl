...
if(description)
{
  ...
  script_version("2021-01-19T10:11:01+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1091");
  ...
  'libvncserver' package(s) announced via the EulerOS-SA-2021-1091 advisory.");
