...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2840");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-jinja2 (EulerOS-SA-2021-2840)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2840");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2840");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-jinja2' package(s) announced via the EulerOS-SA-2021-2840 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-jinja2", rpm:"python-jinja2~2.7.2~2.h3", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
