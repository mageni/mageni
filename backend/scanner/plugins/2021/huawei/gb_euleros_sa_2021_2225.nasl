...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2225");
  script_version("2021-07-19T05:22:35+0000");
  ...
  script_tag(name:"creation_date", value:"2021-07-19 05:22:35 +0000 (Mon, 19 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for openssl1.1.1d (EulerOS-SA-2021-2225)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2225");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2225");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openssl1.1.1d' package(s) announced via the EulerOS-SA-2021-2225 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was found in openssl. A sA flaw was found in openssl. A server crash and denial of service attack could occur if a client sends a TLSv1.2 renegotiation ClientHello and omits the signature_algorithms extension but includes a signature_algorithms_cert extension. The highest threat from this vulnerability is to system availability. crash and denial of service attack could occur if a client sends a TLSv1.2 renegotiation ClientHello and omits the signature_algorithms extension but includes a signature_algorithms_cert extension. The highest threat from this vulnerability is to system availability.(CVE-2021-3449)");

  script_tag(name:"affected", value:"'openssl1.1.1d' package(s) on Huawei EulerOS V2.0SP5.");
