...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2210");
  script_version("2021-07-13T12:59:54+0000");
  ...
  script_tag(name:"creation_date", value:"2021-07-13 12:59:54 +0000 (Tue, 13 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for unbound (EulerOS-SA-2021-2210)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2210");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2210");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'unbound' package(s) announced via the EulerOS-SA-2021-2210 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-unbound", rpm:"python3-unbound~1.7.3~18.h6.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound-libs", rpm:"unbound-libs~1.7.3~18.h6.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
