...
if(description)
{
  ...
  'PyYAML' package(s) announced via the EulerOS-SA-2021-2165 advisory.");
...
if(release == "EULEROSVIRT-3.0.2.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"PyYAML", rpm:"PyYAML~3.10~11.h5.eulerosv2r7.x86_64", rls:"EULEROSVIRT-3.0.2.2"))) {
    report += res;
  }
