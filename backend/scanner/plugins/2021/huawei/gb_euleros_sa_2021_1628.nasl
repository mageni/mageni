...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1628");
  script_version("2021-03-12T07:24:07+0000");
  ...
  script_tag(name:"creation_date", value:"2021-03-12 07:24:07 +0000 (Fri, 12 Mar 2021)");
  script_name("Huawei EulerOS: Security Advisory for trousers (EulerOS-SA-2021-1628)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1628");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1628");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'trousers' package(s) announced via the EulerOS-SA-2021-1628 advisory.");
...
An issue was discovered in TrouSerS through 0.3.14. If the tcsd daemon is started with root privileges, the tss user still has read and write access to the /etc/tcsd.conf file (which contains various settings related to this daemon).(CVE-2020-24331)");
  ...
  script_tag(name:"affected", value:"'trousers' package(s) on Huawei EulerOS Virtualization release 2.9.1.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trousers", rpm:"trousers~0.3.14~3.h3.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
