...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.145192");
  script_version("2021-01-19T02:29:41+0000");
  script_tag(name:"last_modification", value:"2021-01-22 11:28:48 +0000 (Fri, 22 Jan 2021)");
  script_tag(name:"creation_date", value:"2021-01-19 02:00:22 +0000 (Tue, 19 Jan 2021)");
  script_tag(name:"cvss_base", value:"3.3");
  script_tag(name:"cvss_base_vector", value:"AV:A/AC:L/Au:N/C:N/I:N/A:P");

  script_cve_id("CVE-2020-9201");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Huawei Data Communication: Out of Bounds Read Vulnerability in Several Products");
  ...
  DHCP messages including crafted parameter. Successful exploit could cause certain service abnormal.");
  ...
  USG9500 versions V500R001C30SPC200 V500R001C30SPC600 V500R001C60SPC500 V500R005C00");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_xref(name:"URL", value:"http://www.huawei.com/en/psirt/security-advisories/huawei-sa-20200122-04-eudemon-en");
