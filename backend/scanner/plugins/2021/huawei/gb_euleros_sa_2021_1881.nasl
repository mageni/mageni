...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1881");
  ...
  script_tag(name:"creation_date", value:"2021-05-19 06:21:42 +0000 (Wed, 19 May 2021)");
  script_name("Huawei EulerOS: Security Advisory for openldap (EulerOS-SA-2021-1881)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1881");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1881");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'openldap' package(s) announced via the EulerOS-SA-2021-1881 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openldap", rpm:"openldap~2.4.46~8.h12.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-clients", rpm:"openldap-clients~2.4.46~8.h12.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-devel", rpm:"openldap-devel~2.4.46~8.h12.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openldap-servers", rpm:"openldap-servers~2.4.46~8.h12.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
