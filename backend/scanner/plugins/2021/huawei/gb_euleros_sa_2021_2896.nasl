...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2896");
  ...
  script_name("Huawei EulerOS: Security Advisory for libldb (EulerOS-SA-2021-2896)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2896");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2896");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libldb' package(s) announced via the EulerOS-SA-2021-2896 advisory.");
...
A flaw was found in samba. Spaces used in a string around a domain name (DN), while supposed to be ignored, can cause invalid DN strings with spaces to instead write a zero-byte into out-of-bounds memory, resulting in a crash. The highest threat from this vulnerability is to system availability.(CVE-2020-27840)");
  ...
  script_tag(name:"affected", value:"'libldb' package(s) on Huawei EulerOS Virtualization 3.0.2.6.");
...
if(release == "EULEROSVIRT-3.0.2.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libldb", rpm:"libldb~1.2.2~1.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.2.6"))) {
    report += res;
  }
