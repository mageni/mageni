...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2391");
  ...
  script_name("Huawei EulerOS: Security Advisory for junit (EulerOS-SA-2021-2391)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2391");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2391");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'junit' package(s) announced via the EulerOS-SA-2021-2391 advisory.");
  ...
  script_tag(name:"affected", value:"'junit' package(s) on Huawei EulerOS V2.0SP2.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"junit", rpm:"junit~4.11~8.h4", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
