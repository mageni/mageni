...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2334");
  ...
  script_name("Huawei EulerOS: Security Advisory for ImageMagick (EulerOS-SA-2021-2334)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2334");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2334");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ImageMagick' package(s) announced via the EulerOS-SA-2021-2334 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ImageMagick", rpm:"ImageMagick~6.9.10.67~1.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-c++", rpm:"ImageMagick-c++~6.9.10.67~1.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-libs", rpm:"ImageMagick-libs~6.9.10.67~1.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-perl", rpm:"ImageMagick-perl~6.9.10.67~1.h6.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
