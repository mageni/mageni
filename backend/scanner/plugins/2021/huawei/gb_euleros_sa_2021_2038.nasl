...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2038");
  script_version("2021-07-01T07:39:30+0000");
  ...
  script_tag(name:"creation_date", value:"2021-07-01 07:39:30 +0000 (Thu, 01 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for libldb (EulerOS-SA-2021-2038)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2038");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2038");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libldb' package(s) announced via the EulerOS-SA-2021-2038 advisory.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libldb", rpm:"libldb~1.2.2~1.h3.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
