...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.2186");
  script_version("2021-07-13T12:58:36+0000");
  ...
  script_tag(name:"creation_date", value:"2021-07-13 12:58:36 +0000 (Tue, 13 Jul 2021)");
  script_name("Huawei EulerOS: Security Advisory for rpm (EulerOS-SA-2021-2186)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-2186");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2186");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'rpm' package(s) announced via the EulerOS-SA-2021-2186 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-rpm", rpm:"python3-rpm~4.15.1~12.h18.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpm", rpm:"rpm~4.15.1~12.h18.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpm-libs", rpm:"rpm-libs~4.15.1~12.h18.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
