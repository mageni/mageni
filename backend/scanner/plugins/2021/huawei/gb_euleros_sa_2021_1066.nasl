...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1066");
  script_version("2021-01-19T10:09:03+0000");
  ...
  script_tag(name:"creation_date", value:"2021-01-19 10:09:03 +0000 (Tue, 19 Jan 2021)");
  script_name("Huawei EulerOS: Security Advisory for freerdp (EulerOS-SA-2021-1066)");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1066");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1066");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'freerdp' package(s) announced via the EulerOS-SA-2021-1066 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"freerdp", rpm:"freerdp~1.0.2~6.1.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"freerdp-libs", rpm:"freerdp-libs~1.0.2~6.1.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"freerdp-plugins", rpm:"freerdp-plugins~1.0.2~6.1.h10", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
