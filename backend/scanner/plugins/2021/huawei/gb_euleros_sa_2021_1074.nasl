...
if(description)
{
  ...
  script_version("2021-01-19T10:09:37+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2021-1074");
  ...
  'ImageMagick' package(s) announced via the EulerOS-SA-2021-1074 advisory.");
