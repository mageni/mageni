...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1374");
  script_version("2021-02-22T08:41:29+0000");
  ...
  script_tag(name:"creation_date", value:"2021-02-22 08:41:29 +0000 (Mon, 22 Feb 2021)");
  script_name("Huawei EulerOS: Security Advisory for dnsmasq (EulerOS-SA-2021-1374)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1374");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1374");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'dnsmasq' package(s) announced via the EulerOS-SA-2021-1374 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.76~2.2.h3", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dnsmasq-utils", rpm:"dnsmasq-utils~2.76~2.2.h3", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
