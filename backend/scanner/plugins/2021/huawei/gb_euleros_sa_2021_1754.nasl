...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1754");
  script_version("2021-04-13T06:16:26+0000");
  ...
  script_tag(name:"creation_date", value:"2021-04-13 06:16:26 +0000 (Tue, 13 Apr 2021)");
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2021-1754)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1754");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1754");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libtiff' package(s) announced via the EulerOS-SA-2021-1754 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.1.0~1.h1.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
