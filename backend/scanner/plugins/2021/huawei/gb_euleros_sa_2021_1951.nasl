...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2021.1951");
  script_version("2021-06-07T09:14:48+0000");
  ...
  script_tag(name:"creation_date", value:"2021-06-07 09:14:48 +0000 (Mon, 07 Jun 2021)");
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2021-1951)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2021-1951");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1951");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libtiff' package(s) announced via the EulerOS-SA-2021-1951 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.1.0~1.h1.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
