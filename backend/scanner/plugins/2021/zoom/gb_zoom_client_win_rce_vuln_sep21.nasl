...
if(description)
{
  ...
  script_name("Zoom Client for Meetings for Windows < 5.3.0 Remote Code Execution Vulnerability");

  script_tag(name:"summary", value:"Zoom Client for Meetings for Windows is prone to a remote code
  execution vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The application fails to properly validate the certificate
  information used to sign .msi files when performing an update of the client. This could lead
  to remote code execution in an elevated privileged context.");
