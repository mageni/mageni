...
if(description)
{
  ...
  script_cve_id("CVE-2021-32626", "CVE-2021-32627", "CVE-2021-32628", "CVE-2021-32672", "CVE-2021-32675", "CVE-2021-32687", "CVE-2021-32761", "CVE-2021-32762", "CVE-2021-41099");
  ...
  script_name("Debian: Security Advisory for redis (DSA-5001-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5001.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5001-1");
  ...
  package(s) announced via the DSA-5001-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in Redis, a persistent key-value
