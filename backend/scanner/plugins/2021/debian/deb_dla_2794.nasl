...
if(description)
{
  ...
  script_version("2021-10-28T01:00:07+0000");
  script_cve_id("CVE-2021-21703");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2021-10-28 01:00:07 +0000 (Thu, 28 Oct 2021)");
  script_tag(name:"creation_date", value:"2021-10-28 01:00:07 +0000 (Thu, 28 Oct 2021)");
  script_name("Debian LTS: Security Advisory for php7.0 (DLA-2794-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/10/msg00021.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2794-1");
  script_xref(name:"Advisory-ID", value:"DLA-2794-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/997003");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.0'
  package(s) announced via the DLA-2794-1 advisory.");
