...
if(description)
{
  ...
  script_version("2021-04-03T03:00:07+0000");
  ...
  script_name("Debian: Security Advisory for ldb (DSA-4884-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4884.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4884-1");
  ...
  package(s) announced via the DSA-4884-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in ldb, a LDAP-like
embedded database built on top of TDB.

CVE-2020-10730Andrew Bartlett discovered a NULL pointer dereference and
use-after-free flaw when handling ASQ and VLV
LDAP controls and
