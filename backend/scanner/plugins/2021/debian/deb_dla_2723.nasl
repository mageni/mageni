...
if(description)
{
  ...
  script_version("2021-07-31T03:00:07+0000");
  ...
  script_name("Debian LTS: Security Advisory for linuxptp (DLA-2723-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/07/msg00025.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2723-1");
  script_xref(name:"Advisory-ID", value:"DLA-2723-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linuxptp'
  package(s) announced via the DLA-2723-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"linuxptp", ver:"1.8-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
