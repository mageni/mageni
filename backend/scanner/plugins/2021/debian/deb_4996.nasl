...
if(description)
{
  ...
  script_name("Debian: Security Advisory for wpewebkit (DSA-4996-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4996.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4996-1");
  ...
  package(s) announced via the DSA-4996-1 advisory.");
