...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for amd64-microcode (DLA-2743-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/08/msg00019.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2743-1");
  script_xref(name:"Advisory-ID", value:"DLA-2743-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/886382");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'amd64-microcode'
  package(s) announced via the DLA-2743-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that systems with microprocessors utilizing
...
et al. This fix adds amd-microcode-based IBPB support.");
  ...
  script_tag(name:"affected", value:"'amd64-microcode' package(s) on Debian Linux.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"amd64-microcode", ver:"3.20181128.1~deb9u1", rls:"DEB9"))) {
  report += res;
}
