...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for opencv (DLA-2799-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/10/msg00028.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2799-1");
  script_xref(name:"Advisory-ID", value:"DLA-2799-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/886282");
  script_xref(name:"URL", value:"https://bugs.debian.org/885843");
  script_xref(name:"URL", value:"https://bugs.debian.org/875342");
  script_xref(name:"URL", value:"https://bugs.debian.org/872044");
  script_xref(name:"URL", value:"https://bugs.debian.org/872043");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opencv'
  package(s) announced via the DLA-2799-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities have been discovered in OpenCV, the Open
...
unspecified impact.");
  ...
  script_tag(name:"affected", value:"'opencv' package(s) on Debian Linux.");
