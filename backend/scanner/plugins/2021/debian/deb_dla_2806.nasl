...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for glusterfs (DLA-2806-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2021/11/msg00000.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2806-1");
  script_xref(name:"Advisory-ID", value:"DLA-2806-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/909215");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glusterfs'
  package(s) announced via the DLA-2806-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple security vulnerabilities were discovered in GlusterFS, a
...
arbitrary code.");
  ...
  script_tag(name:"affected", value:"'glusterfs' package(s) on Debian Linux.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"glusterfs-client", ver:"3.8.8-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"glusterfs-common", ver:"3.8.8-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"glusterfs-dbg", ver:"3.8.8-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"glusterfs-server", ver:"3.8.8-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
