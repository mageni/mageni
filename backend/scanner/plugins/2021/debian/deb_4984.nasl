...
if(description)
{
  ...
  script_version("2021-10-15T01:00:10+0000");
  ...
  script_name("Debian: Security Advisory for flatpak (DSA-4984-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4984.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4984-1");
  ...
  package(s) announced via the DSA-4984-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that sandbox restrictions in Flatpak, an application
