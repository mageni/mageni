...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818198");
  ...
  script_tag(name:"creation_date", value:"2021-08-13 00:04:53 +0530 (Fri, 13 Aug 2021)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB21-51) - Mac OS X");
