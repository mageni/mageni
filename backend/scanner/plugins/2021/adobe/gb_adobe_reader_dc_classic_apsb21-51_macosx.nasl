...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818501");
  ...
  script_tag(name:"creation_date", value:"2021-08-13 00:05:25 +0530 (Fri, 13 Aug 2021)");
  script_name("Adobe Reader Classic 2020 Security Update (APSB21-51) - Mac OS X");
  ...
  2020.004.30006 on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Reader Classic 2020 to
  version 2020.004.30006 or later. Please see the references for more information.");
