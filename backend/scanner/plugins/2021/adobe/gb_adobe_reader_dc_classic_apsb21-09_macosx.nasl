...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817933");
  ...
  script_tag(name:"creation_date", value:"2021-02-11 18:09:29 +0530 (Thu, 11 Feb 2021)");
  script_name("Adobe Reader Classic 2020 Security Update (APSB21-09) - Mac OS X");
