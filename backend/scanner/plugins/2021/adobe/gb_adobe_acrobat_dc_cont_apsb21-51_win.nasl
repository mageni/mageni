...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818192");
  ...
  script_name("Adobe Acrobat DC Continuous Security Update (APSB21-51) - Windows");
  ...
  2021.005.20054andearlierversionson Windows.");
