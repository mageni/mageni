...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818500");
  ...
  script_tag(name:"creation_date", value:"2021-08-13 00:05:15 +0530 (Fri, 13 Aug 2021)");
  script_name("Adobe Reader 2017 Security Update (APSB21-51) - Mac OS X");
