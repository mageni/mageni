...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818199");
  ...
  script_tag(name:"creation_date", value:"2021-08-13 00:05:04 +0530 (Fri, 13 Aug 2021)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB21-51) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat DC (Continuous Track) 2021.005.20054
 andearlierversions on Mac OS X.");
