...
if(description)
{
  ...
  script_version("2021-01-28T04:50:27+0000");
  ...
  script_name("CKEditor 4.0 < 4.16 Multiple ReDoS Vulnerabilities");
  ...
  script_tag(name:"summary", value:"CKEditor is prone to multiple regular expression denial of service (ReDoS) vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The following vulnerabilities exist:

  - ReDoS in the Advanced Tab for Dialogs plugin (CVE-2021-26271)

  - ReDoS in the Autolink plugin (CVE-2021-26272)");

  script_tag(name:"affected", value:"CKEditor versions 4.0 - 4.15.1.");
