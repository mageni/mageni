...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.146590");
  script_version("2021-08-30T07:40:10+0000");
  script_tag(name:"last_modification", value:"2021-09-03 12:13:43 +0000 (Fri, 03 Sep 2021)");
  script_tag(name:"creation_date", value:"2021-08-30 07:39:31 +0000 (Mon, 30 Aug 2021)");
  ...
  script_name("Cacti < 1.2.13 XSS Vulnerability - Windows");
