...
if (description)
{
  ...
  script_version("2021-02-10T06:10:51+0000");
  ...
  script_cve_id("CVE-2021-21435");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("OTRS 6.0 < 7.0.24, 8.0 < 8.0.11 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"Article Bcc fields and agent personal information are shown when a customer
