...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817592");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_4-2021-02)-Linux");
  ...
  prior to 88.0.4324.150 on Linux");
