...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817939");
  ...
  script_tag(name:"creation_date", value:"2021-02-23 11:45:52 +0530 (Tue, 23 Feb 2021)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_16-2021-02) - Mac OS X");
