...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117222");
  ...
  script_name("'/.jsp/WEB-INF/' Information Disclosure Vulnerability (HTTP)");
  ...
  http://example.com/.jsp/WEB-INF/web.xml

  http://example.com/.jsp/web-inf/web.xml

  (note the '.jsp/' before 'WEB-INF').");
