...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818921");
  ...
  script_cve_id("CVE-2021-40441", "CVE-2021-41333", "CVE-2021-43207", "CVE-2021-43215",
                ...
                "CVE-2021-43233", "CVE-2021-43234", "CVE-2021-43236", "CVE-2021-43238",
                "CVE-2021-43245", "CVE-2021-43883", "CVE-2021-43893");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5008244)");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5008244");
...
if(version_is_less(version:fileVer, test_version:"6.1.7601.25792"))
{
  report = report_fixed_ver(file_checked:dllPath + "\advapi32.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.1.7601.25792");
