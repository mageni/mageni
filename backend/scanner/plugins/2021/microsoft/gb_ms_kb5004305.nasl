...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817726");
  ...
  script_tag(name:"creation_date", value:"2021-07-14 14:03:55 +0530 (Wed, 14 Jul 2021)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5004305)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5004305");
  ...
  - A privilege escalation error in Windows GPSVC.

  - An privilege escalation error in Windows Print Spooler.

  For more information about the vulnerabilities refer to Reference links.");

  script_tag(name:"impact", value:"Successful exploitation will allow an attacker
  to elevate privileges, bypass security restrictions.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5004305");
...
if(version_is_less(version:fileVer, test_version:"6.0.6002.24564"))
{
  report = report_fixed_ver(file_checked:dllPath + "\kerberos.dll",
                            file_version:fileVer, vulnerable_range:"Less than 6.0.6002.24564");
