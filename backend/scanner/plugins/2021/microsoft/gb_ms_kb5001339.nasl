...
if(description)
{
  ...
  script_cve_id("CVE-2021-26413", "CVE-2021-26415", "CVE-2021-27072", "CVE-2021-27079",
                ...
                "CVE-2021-28439", "CVE-2021-28440", "CVE-2021-28442", "CVE-2021-28443",
                "CVE-2021-28444", "CVE-2021-28447");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5001339)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5001339");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001339");
...
if(version_in_range(version:fileVer, test_version:"10.0.17134.0", test_version2:"10.0.17134.2144"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.17134.0 - 10.0.17134.2144");
