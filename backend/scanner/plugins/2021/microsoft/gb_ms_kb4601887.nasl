...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817664");
  ...
  script_name("Microsoft .NET Framework Denial of Service Vulnerability (KB4601887)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4601887");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 4.7.2 and 4.8 on Microsoft Windows 10 version 1809 and Microsoft Windows Server 2019.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4601887");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.3769"))
              {
                vulnerable_range = "4.7 - 4.7.3769" ;
                break;
              }
