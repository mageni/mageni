...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817667");
  ...
  script_name("Microsoft .NET Framework Denial of Service Vulnerability (KB4603004)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4603004");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 4.6, 4.6.1, 4.6.2, 4.7, 4.7.1, 4.7.2, 4.8 for Microsoft Windows 8.1 and Microsoft Windows Server 2012 R2.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4603004");
