...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818910");
  ...
  script_name("Microsoft Word 2013 Service Pack 1 RCE Vulnerability (KB5001960)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5001960");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5001960");
...
if(exeVer =~ "^15\." && version_is_less(version:exeVer, test_version:"15.0.5389.1000"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"15.0 - 15.0.5389.0999");
