...
if(description)
{
  ...
  script_version("2022-06-03T08:08:36+0000");
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  if (log)desc = string("Beim Testen des Systems trat ein Fehler auf:\n" + log);
}else if(OSVER == '5.1' || (OSVER == '5.2' && 'Microsoft(R) Windows(R) XP Professional x64 Edition' >< OSNAME ) || (OSVER == '6.0' && OSTYPE == 1 ) || (OSVER == '6.1' && OSTYPE == 1 )){
  result = string("nicht zutreffend");
