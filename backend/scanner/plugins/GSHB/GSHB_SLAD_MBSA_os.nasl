...
# $Id: GSHB_SLAD_MBSA_os.nasl 10620 2018-07-25 14:15:31Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.96064");
  ...
  script_name("SLAD Microsoft Baseline Security Analyzer OS run");
