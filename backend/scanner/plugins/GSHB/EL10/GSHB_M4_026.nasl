...
# $Id: GSHB_M4_026.nasl 11531 2018-09-21 18:50:24Z cfischer $
#
# IT-Grundschutz, 10. EL, Maßnahme 4.026
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94026");
  ...
  script_name("IT-Grundschutz M4.026: Regelmäßiger Sicherheitscheck des Unix-Systems");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.026: Regelmäßiger Sicherheitscheck des Unix-Systems.

  ACHTUNG: Dieser Test wird nicht mehr unterstützt. Er wurde ersetzt durch
  den entsprechenden Test der nun permanent and die aktuelle EL angepasst
  wird: OID 1.3.6.1.4.1.25623.1.0.94198
