...
# $Id: GSHB_M4_288.nasl 10611 2018-07-25 11:49:26Z cfischer $
#
# IT-Grundschutz, 14. EL, Maßnahme 4.288
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94228");
  ...
  script_name("IT-Grundschutz M4.288: Sichere Administration von VoIP-Endgeräten");
...
name = 'IT-Grundschutz M4.288: Sichere Administration von VoIP-Endgeräten\n';
...
set_kb_item(name:"GSHB/M4_288/result", value:result);
set_kb_item(name:"GSHB/M4_288/desc", value:desc);
set_kb_item(name:"GSHB/M4_288/name", value:name);

silence = get_kb_item("GSHB/silence");
if (!silence) itg_send_details (itg_id: 'GSHB/M4_288');
