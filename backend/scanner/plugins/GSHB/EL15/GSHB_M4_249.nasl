...
# $Id: GSHB_M4_249.nasl 10611 2018-07-25 11:49:26Z cfischer $
#
# IT-Grundschutz, 14. EL, Maßnahme 4.249
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94222");
...
set_kb_item(name:"GSHB/M4_249/result", value:result);
set_kb_item(name:"GSHB/M4_249/desc", value:desc);
set_kb_item(name:"GSHB/M4_249/name", value:name);

silence = get_kb_item("GSHB/silence");
if (!silence) itg_send_details (itg_id: 'GSHB/M4_249');
