...
# $Id: GSHB_M4_238.nasl 10646 2018-07-27 07:00:22Z cfischer $
#
# IT-Grundschutz, 14. EL, Maßnahme 4.238
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.94220");
  ...
  script_name("IT-Grundschutz M4.238: Einsatz eines lokalen Paketfilters");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.238: Einsatz eines lokalen Paketfilters.
...
name = 'IT-Grundschutz M4.238: Einsatz eines lokalen Paketfilters\n';
...
set_kb_item(name:"GSHB/M4_238/result", value:result);
set_kb_item(name:"GSHB/M4_238/desc", value:desc);
set_kb_item(name:"GSHB/M4_238/name", value:name);

silence = get_kb_item("GSHB/silence");
if (!silence) itg_send_details (itg_id: 'GSHB/M4_238');
