...
# $Id: alas-2016-690.nasl 6574 2017-07-06 13:41:26Z cfischer$
#
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"foomatic-debuginfo", rpm:"foomatic-debuginfo~4.0.4~5.11.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"foomatic", rpm:"foomatic~4.0.4~5.11.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
