...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.809383");
  ...
  script_name("Oracle MySQL <= 5.7.14 Security Update (cpuoct2016) - Linux");
...
if(version_is_less_equal(version:vers, test_version:"5.7.14")) {
