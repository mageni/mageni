...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.808594");
  script_version("2021-01-29T09:52:54+0000");
  ...
  script_tag(name:"creation_date", value:"2016-07-21 12:47:01 +0530 (Thu, 21 Jul 2016)");
  script_tag(name:"qod_type", value:"remote_banner");
  script_name("Oracle MySQL <= 5.5.48 / 5.6 <= 5.6.29 / 5.7 <= 5.7.10 Security Update (cpujul2016) - Windows");
  ...
  unknown vectors related to the 'Security Encryption' sub-component.");

  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to affect
  confidentiality via unknown vectors.");

  script_tag(name:"affected", value:"Oracle MySQL 5.5.48 and earlier, 5.6.29 and earlier, 5.7.10 and earlier.");

  script_tag(name:"solution", value:"Updates are available. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"https://www.oracle.com/security-alerts/cpujul2016.html");
