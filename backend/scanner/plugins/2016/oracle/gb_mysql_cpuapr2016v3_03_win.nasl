...
if(description)
{
  ...
  script_cve_id("CVE-2016-0667", "CVE-2016-0662", "CVE-2016-0659", "CVE-2016-0657", "CVE-2016-3440");
  ...
  script_name("Oracle MySQL <= 5.7.11 Security Update (cpuapr2016v3, cpujul2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.11 and earlier.");
...
if(version_is_less_equal(version:vers, test_version:"5.7.11")) {
