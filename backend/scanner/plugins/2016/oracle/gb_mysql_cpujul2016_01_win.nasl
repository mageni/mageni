...
if(description)
{
  ...
  script_name("Oracle MySQL <= 5.5.49 / 5.6 <= 5.6.30 / 5.7 <= 5.7.12 Security Update (cpujul2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5.49 and earlier, 5.6.30 and earlier, 5.7.12 and earlier.");
