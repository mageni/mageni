...
if(description)
{
  ...
  script_name("Oracle MySQL 5.7.9 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.7.9.");
...
if(version_is_equal(version:vers, test_version:"5.7.9")) {
