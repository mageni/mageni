...
# $Id: gb_mysql_unspecified_vuln10_jun16_lin.nasl 12983 2019-01-08 15:30:19Z cfischer $
#
# Oracle MySQL Unspecified Vulnerability-10 Jun16 (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("Oracle MySQL Unspecified Vulnerability-04 Jun16 (Linux)");
...
if(mysqlVer =~ "^5\.[56]\.")
{
  if(version_in_range(version:mysqlVer, test_version:"5.6", test_version2:"5.6.23")||
     version_in_range(version:mysqlVer, test_version:"5.5", test_version2:"5.5.42"))
  {
