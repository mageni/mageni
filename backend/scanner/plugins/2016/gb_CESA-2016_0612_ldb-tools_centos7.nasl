...
#
# CentOS Update for ldb-tools CESA-2016:0612 centos7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882459");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-04-14 05:19:07 +0200 (Thu, 14 Apr 2016)");
  ...
  script_name("CentOS Update for ldb-tools CESA-2016:0612 centos7");
...
protection for LDAP connections. A man-in-the-middle attacker could u ...
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-April/021827.html");
...
if(release == "CentOS7")
{
  ...
  if ((res = isrpmvuln(pkg:"ldb-tools", rpm:"ldb-tools~1.1.25~1.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libldb", rpm:"libldb~1.1.25~1.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libldb-devel", rpm:"libldb-devel~1.1.25~1.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pyldb", rpm:"pyldb~1.1.25~1.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pyldb-devel", rpm:"pyldb-devel~1.1.25~1.el7_2", rls:"CentOS7")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
