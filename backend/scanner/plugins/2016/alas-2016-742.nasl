...
# $Id: alas-2016-742.nasl 11703 2018-10-01 08:05:31Z cfischer $
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2016-742");
...
if(release == "AMAZON")
{
  if ((res = isrpmvuln(pkg:"libcurl-devel", rpm:"libcurl-devel~7.47.1~8.65.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"curl", rpm:"curl~7.47.1~8.65.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.47.1~8.65.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"curl-debuginfo", rpm:"curl-debuginfo~7.47.1~8.65.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
