...
# $Id: alas-2016-735.nasl 11703 2018-10-01 08:05:31Z cfischer $
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: alas-2016-735");
...
if(release == "AMAZON")
{
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.1.23~16.22.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
  if ((res = isrpmvuln(pkg:"squid-debuginfo", rpm:"squid-debuginfo~3.1.23~16.22.amzn1", rls:"AMAZON")) != NULL) {
    security_message(data:res);
    exit(0);
  }
