...
#
# Fedora Update for perl-CGI-Emulate-PSGI FEDORA-2016-683d0b257b
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for perl-CGI-Emulate-PSGI FEDORA-2016-683d0b257b");
  ...
  script_tag(name:"affected", value:"perl-CGI-Emulate-PSGI on Fedora 24");
...
if(release == "FC24")
{
  ...
  if ((res = isrpmvuln(pkg:"perl-CGI-Emulate-PSGI", rpm:"perl-CGI-Emulate-PSGI~0.22~1.fc24", rls:"FC24")) != NULL)
  {
