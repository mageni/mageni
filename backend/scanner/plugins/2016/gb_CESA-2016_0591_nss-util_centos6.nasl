...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.882447");
  script_version("$Revision: 14058 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-08 14:25:52 +0100 (Fri, 08 Mar 2019) $");
  script_tag(name:"creation_date", value:"2016-04-11 12:47:13 +0530 (Mon, 11 Apr 2016)");
  script_cve_id("CVE-2016-1978", "CVE-2016-1979");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"qod_type", value:"package");
  script_name("CentOS Update for nss-util CESA-2016:0591 centos6");
...
CVE-2016-1978 and Tim Taubert as the original reporter of CVE-2016-1979.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2016-April/021808.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.21.0~0.3.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"nss-util-devel", rpm:"nss-util-devel~3.21.0~0.3.el6_7", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
