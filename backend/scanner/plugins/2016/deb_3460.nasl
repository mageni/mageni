...
# $Id: deb_3460.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"privoxy", ver:"3.0.21-7+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"privoxy", ver:"3.0.24-1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"privoxy", ver:"3.0.19-2+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
