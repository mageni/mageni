...
#
# Ubuntu Update for linux-raspi2 USN-3152-2
#
# Authors:
...
if(description)
{
  ...
  script_name("Ubuntu Update for linux-raspi2 USN-3152-2");
...
administrative privileges.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-3152-2/");
...
if(release == "UBUNTU16.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-4.8.0-1020-raspi2", ver:"4.8.0-1020.23", rls:"UBUNTU16.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-raspi2", ver:"4.8.0.1020.23", rls:"UBUNTU16.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
