...
# $Id: alas-2016-644.nasl 6574 2017-07-06 13:41:26Z cfischer$
#
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"python26-rsa", rpm:"python26-rsa~3.3~2.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python27-rsa", rpm:"python27-rsa~3.3~2.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"python-rsa", rpm:"python-rsa~3.3~2.7.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
