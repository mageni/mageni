...
# $Id: gb_typo3_mult_vuln02_may16.nasl 12455 2018-11-21 09:17:27Z cfischer $
#
# TYPO3 Multiple Vulnerabilities-02 May16
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://typo3.org/teams/security/security-bulletins/typo3-core/typo3-core-sa-2016-005");
  script_xref(name:"URL", value:"https://typo3.org/teams/security/security-bulletins/typo3-core/typo3-core-sa-2016-007");
  script_xref(name:"URL", value:"https://typo3.org/teams/security/security-bulletins/typo3-core/typo3-core-sa-2016-008");
