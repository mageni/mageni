...
#
# Fedora Update for php-adodb FEDORA-2016-7d6ca385a4
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for php-adodb FEDORA-2016-7d6ca385a4");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"php-adodb", rpm:"php-adodb~5.15~10.fc23", rls:"FC23")) != NULL)
  {
