...
#
# MS SharePoint Server Excel Services Remote Code Execution Vulnerability (3199168)
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-in/kb/3118381");
