...
if(hotfix_check_sp(win7:2, win7x64:2, win2008r2:2) > 0)
{
  ...
  else if(version_in_range(version:sysVer, test_version:"6.1.7601.23000", test_version2:"6.1.7601.23345"))
  {
    Vulnerable_range = "6.1.7601.23000 - 6.1.7601.23345";
    VULN = TRUE ;
  }
}
...
else if(hotfix_check_sp(winVista:3, win2008:3) > 0)
{
  ...
  else if(version_in_range(version:sysVer, test_version:"6.0.6002.23000", test_version2:"6.0.6002.23907"))
  {
    Vulnerable_range = "6.0.6002.23000 - 6.0.6002.23907";
    VULN = TRUE ;
  }
}
...
else if(hotfix_check_sp(win2012:1) > 0)
{
  ...
  else if(version_in_range(version:sysVer, test_version:"6.2.9200.21000", test_version2:"6.2.9200.21765"))
  {
