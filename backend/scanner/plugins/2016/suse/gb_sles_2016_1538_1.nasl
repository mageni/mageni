...
if(description)
{
  ...
  script_cve_id("CVE-2015-8806","CVE-2016-1762","CVE-2016-1833");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1538-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-June/002104.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libxml2'
  package(s) announced via the SUSE-SU-2016:1538-1 advisory.");
