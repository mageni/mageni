...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2942-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002429.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'vim'
  package(s) announced via the SUSE-SU-2016:2942-1 advisory.");
