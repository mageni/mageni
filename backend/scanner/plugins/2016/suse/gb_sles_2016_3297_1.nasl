...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:3297-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002533.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libgstegl, libgstegl-debuginfo, gstreamer-plugins-bad, gstreamer-plugins-bad-debuginfo, gstreamer-plugins-bad-debugsource, libgstbasecamerabinsrc, libgstbasecamerabinsrc-debuginfo, libgstcodecparsers, libgstcodecparsers-debuginfo, libgstmpegts, libgstmpegts-debuginfo, libgstphotography, libgstphotography-debuginfo, gstreamer-plugins-bad-lang'
  package(s) announced via the SUSE-SU-2016:3297-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'libgstegl, libgstegl-debuginfo, gstreamer-plugins-bad, gstreamer-plugins-bad-debuginfo, gstreamer-plugins-bad-debugsource, libgstbasecamerabinsrc, libgstbasecamerabinsrc-debuginfo, libgstcodecparsers, libgstcodecparsers-debuginfo, libgstmpegts, libgstmpegts-debuginfo, libgstphotography, libgstphotography-debuginfo, gstreamer-plugins-bad-lang' package(s) on SUSE Linux Enterprise Server 12");
