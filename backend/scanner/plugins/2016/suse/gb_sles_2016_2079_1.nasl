...
if(description)
{
  ...
  script_cve_id("CVE-2015-2059","CVE-2015-8948","CVE-2016-6261");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2079-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-August/002210.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libidn'
  package(s) announced via the SUSE-SU-2016:2079-1 advisory.");
