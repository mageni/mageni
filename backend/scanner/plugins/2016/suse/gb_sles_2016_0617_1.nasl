...
if(description)
{
  ...
  script_cve_id("CVE-2015-3197","CVE-2016-0702","CVE-2016-0703");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0617-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-March/001900.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openssl'
  package(s) announced via the SUSE-SU-2016:0617-1 advisory.");
