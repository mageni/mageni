...
if(description)
{
  ...
  script_cve_id("CVE-2016-3622","CVE-2016-3623","CVE-2016-3945");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2508-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-October/002326.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'tiff'
  package(s) announced via the SUSE-SU-2016:2508-1 advisory.");
