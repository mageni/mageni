...
if(description)
{
  ...
  script_cve_id("CVE-2015-4792","CVE-2015-4802","CVE-2015-4807");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0121-1)");
  ...
  package(s) announced via the SUSE-SU-2016:0121-1 advisory.");
