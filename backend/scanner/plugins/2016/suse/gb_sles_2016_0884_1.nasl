...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0884-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-March/001968.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'ghostscript'
  package(s) announced via the SUSE-SU-2016:0884-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12 (ppc64le s390x x86_64)");
