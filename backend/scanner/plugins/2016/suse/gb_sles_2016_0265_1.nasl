...
if(description)
{
  ...
  script_cve_id("CVE-2015-4871","CVE-2015-7575","CVE-2015-8126");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:0265-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-January/001832.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_0-openjdk'
  package(s) announced via the SUSE-SU-2016:0265-1 advisory.");
