...
if(description)
{
  ...
  script_cve_id("CVE-2016-6258","CVE-2016-6259","CVE-2016-6833");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2473-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-October/002317.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2016:2473-1 advisory.");
