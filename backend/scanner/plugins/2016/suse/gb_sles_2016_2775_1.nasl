...
if(description)
{
  ...
  script_cve_id("CVE-2008-3522","CVE-2014-8158","CVE-2015-5203");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:2775-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002398.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'jasper'
  package(s) announced via the SUSE-SU-2016:2775-1 advisory.");
