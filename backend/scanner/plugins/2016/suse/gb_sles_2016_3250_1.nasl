...
if(description)
{
  ...
  script_cve_id("CVE-2016-9957","CVE-2016-9958","CVE-2016-9959");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:3250-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002517.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libgme'
  package(s) announced via the SUSE-SU-2016:3250-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'libgme' package(s) on SUSE Linux Enterprise Server 12");
