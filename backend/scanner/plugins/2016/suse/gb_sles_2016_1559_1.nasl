...
if(description)
{
  ...
  script_cve_id("CVE-2015-5260","CVE-2015-5261","CVE-2016-0749");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2016:1559-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-June/002108.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'spice'
  package(s) announced via the SUSE-SU-2016:1559-1 advisory.");
