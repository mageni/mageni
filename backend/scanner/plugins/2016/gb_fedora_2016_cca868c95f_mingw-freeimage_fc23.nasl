...
#
# Fedora Update for mingw-freeimage FEDORA-2016-cca868c95f
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for mingw-freeimage FEDORA-2016-cca868c95f");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-freeimage'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"affected", value:"mingw-freeimage on Fedora 23");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"mingw-freeimage", rpm:"mingw-freeimage~3.17.0~4.fc23", rls:"FC23")) != NULL)
  {
