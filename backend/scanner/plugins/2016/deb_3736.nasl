...
# $Id: deb_3736.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libupnp-dev", ver:"1:1.6.19+git20141001-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6", ver:"1:1.6.19+git20141001-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6-dbg", ver:"1:1.6.19+git20141001-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6-dev", ver:"1:1.6.19+git20141001-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6-doc", ver:"1:1.6.19+git20141001-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp-dev", ver:"1:1.6.19+git20160116-1.2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6", ver:"1:1.6.19+git20160116-1.2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6-dbg", ver:"1:1.6.19+git20160116-1.2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6-dev", ver:"1:1.6.19+git20160116-1.2", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libupnp6-doc", ver:"1:1.6.19+git20160116-1.2", rls:"DEB9")) != NULL) {
  report += res;
}
