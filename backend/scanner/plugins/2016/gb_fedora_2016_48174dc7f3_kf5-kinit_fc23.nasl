...
#
# Fedora Update for kf5-kinit FEDORA-2016-48174dc7f3
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for kf5-kinit FEDORA-2016-48174dc7f3");
...
if(release == "FC23")
{
  ...
  if ((res = isrpmvuln(pkg:"kf5-kinit", rpm:"kf5-kinit~5.22.0~3.fc23", rls:"FC23")) != NULL)
  {
