...
# $Id: gb_mysql_mult_unspecified_vuln05_may16_lin.nasl 58702 2016-05-05 10:35:58 +0530 May$
#
# Oracle MySQL Multiple Unspecified Vulnerabilities-05 May16 (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server 5.6.29 and earlier,
  5.7.11 and earlier on Linux");
...
if(mysqlVer =~ "^(5\.(6|7))")
{
  if(version_in_range(version:mysqlVer, test_version:"5.6.0", test_version2:"5.6.29") ||
