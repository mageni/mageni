...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"nss", rpm:"nss~1.0.12~4.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-debuginfo", rpm:"nss-debuginfo~1.0.12~4.22.amzn1", rls:"AMAZON"))) {
    report += res;
  }
