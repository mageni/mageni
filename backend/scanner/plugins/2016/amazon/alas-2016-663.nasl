...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2016-663)");
  ...
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-663.html");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"privoxy", rpm:"privoxy~3.0.23~2.7.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"privoxy-debuginfo", rpm:"privoxy-debuginfo~3.0.23~2.7.amzn1", rls:"AMAZON"))) {
    report += res;
  }
