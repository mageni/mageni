...
# $Id: gb_cloudbees_jenkins_mult_vuln02_may16_win.nasl 12761 2018-12-11 14:32:20Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"CloudBees Jenkins LTS before 1.642.2 on Windows");
