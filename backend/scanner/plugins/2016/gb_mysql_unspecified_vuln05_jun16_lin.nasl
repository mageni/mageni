...
# $Id: gb_mysql_unspecified_vuln05_jun16_lin.nasl 34604 2014-01-21 18:24:50Z Jan$
#
...
if(mysqlVer =~ "^(5\.(5|6))")
{
  if(version_in_range(version:mysqlVer, test_version:"5.5", test_version2:"5.5.34") ||
