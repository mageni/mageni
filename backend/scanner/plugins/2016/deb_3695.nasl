...
# $Id: deb_3695.nasl 14279 2019-03-18 14:48:34Z cfischer $
...
We recommend that you upgrade your quagga packages.");
  script_tag(name:"summary", value:"It was discovered that the zebra daemon in the Quagga routing suite
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"quagga", ver:"0.99.23.1-1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"quagga-dbg", ver:"0.99.23.1-1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"quagga-doc", ver:"0.99.23.1-1+deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
