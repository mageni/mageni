...
#
# Ubuntu Update for samba USN-2950-5
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-05-26 05:22:14 +0200 (Thu, 26 May 2016)");
  ...
  script_name("Ubuntu Update for samba USN-2950-5");
  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the referenced advisory.");
  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");
  script_tag(name:"insight", value:"USN-2950-1 fixed vulnerabilities in Samba.
  USN-2950-3 updated Samba to version 4.3.9, which introduced a regression when
  using the ntlm_auth tool. This update fixes the problem.
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2950-5/");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"samba", ver:"2:4.3.9+dfsg-0ubuntu0.14.04.3", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"samba", ver:"2:4.3.9+dfsg-0ubuntu0.16.04.2", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU15.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"samba", ver:"2:4.3.9+dfsg-0ubuntu0.15.10.2", rls:"UBUNTU15.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
