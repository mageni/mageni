...
# $Id: gb_avast_free_antivirus_sanbox_escape_sec_bypass_vuln.nasl 11569 2018-09-24 10:29:54Z asteins $
#
# Avast Free Antivirus Sandbox Escape Security Bypass Vulnerability
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"affected", value:"Avast Free Antivirus 11.x through
  11.1.2262");
