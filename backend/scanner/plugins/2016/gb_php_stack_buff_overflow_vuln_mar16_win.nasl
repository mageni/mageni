...
# $Id: gb_php_stack_buff_overflow_vuln_mar16_win.nasl 2016-03-01 16:56:54Z March$
#
# PHP 'phar_fix_filepath' Function Stack Buffer Overflow Vulnerability - Mar16 (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("PHP 'phar_fix_filepath' Function Stack Buffer Overflow Vulnerability - Mar16 (Windows)");
