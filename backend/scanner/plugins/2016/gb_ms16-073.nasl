...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://technet.microsoft.com/library/security/MS16-073");
  exit(0);
}
...
else if(hotfix_check_sp(winVista:3, win2008:3) > 0)
{
  ...
  else if(version_in_range(version:sysVer, test_version:"6.0.6002.23000", test_version2:"6.0.6002.23971"))
  {
