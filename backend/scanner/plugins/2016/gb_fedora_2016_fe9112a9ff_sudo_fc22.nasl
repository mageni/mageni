...
#
# Fedora Update for sudo FEDORA-2016-fe9112a9ff
#
# Authors:
...
if(description)
{
  ...
  script_name("Fedora Update for sudo FEDORA-2016-fe9112a9ff");
...
if(release == "FC22")
{
  ...
  if ((res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.8.15~2.fc22", rls:"FC22")) != NULL)
  {
