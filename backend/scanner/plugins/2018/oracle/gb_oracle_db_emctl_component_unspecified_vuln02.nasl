...
#
# Oracle Database Server EMCTL Component Unspecified Vulnerability-02
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812799");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2011-0881");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-03-07 15:14:30 +0530 (Wed, 07 Mar 2018)");
  script_name("Oracle Database Server EMCTL Component Unspecified Vulnerability-02");
...
affected = make_list('11.1.0.7', '10.2.0.3', '10.2.0.4');
