...
#
# Oracle Java SE Security Updates-03 (jul2018-4258247) Linux
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813685");
  ...
  script_name("Oracle Java SE Security Updates-03 (jul2018-4258247) Linux");
