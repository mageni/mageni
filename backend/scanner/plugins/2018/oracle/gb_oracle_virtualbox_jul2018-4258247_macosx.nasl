...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.813582");
  ...
  script_tag(name:"creation_date", value:"2018-07-18 10:56:12 +0530 (Wed, 18 Jul 2018)");
  script_name("Oracle VirtualBox Security Updates (jul2018-4258247) (MAC OS X)");
