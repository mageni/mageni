...
#
# Oracle Mysql Security Updates-01 (oct2018-4428296) Linux
#
# Authors:
...
if(description)
{
  ...
  script_name("Oracle Mysql Security Updates-01 (oct2018-4428296) Linux");
  ...
  5.7.x through 5.7.23, 8.0.x through 8.0.12 on Linux");
