...
# $Id: gb_fedora_2018_6e759af8fb_python-prometheus_client_fc28.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-prometheus_client'
