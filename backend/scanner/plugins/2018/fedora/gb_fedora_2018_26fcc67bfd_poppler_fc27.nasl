...
# $Id: gb_fedora_2018_26fcc67bfd_poppler_fc27.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
on the target host.");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/L55T5FH6FBU2WLBJQ7KYCCCBDZWXYYPV");
...
if(release == "FC27")
{
  ...
  if ((res = isrpmvuln(pkg:"poppler", rpm:"poppler~0.57.0~9.fc27", rls:"FC27")) != NULL)
  {
