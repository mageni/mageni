...
# $Id: gb_fedora_2018_7c2e288c5f_timidity++_fc28.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"timidity++ on Fedora 28");
  script_tag(name:"solution", value:"Please install the updated packages.");

  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AYEUMI7QRKEK6U76UT7GXM5NIOQ7ZPLZ");
...
if(release == "FC28")
{
  ...
  if ((res = isrpmvuln(pkg:"timidity++", rpm:"timidity++~2.14.0~16.fc28", rls:"FC28")) != NULL)
  {
