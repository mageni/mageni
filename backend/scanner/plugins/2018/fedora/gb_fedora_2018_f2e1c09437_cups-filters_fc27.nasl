...
# $Id: gb_fedora_2018_f2e1c09437_cups-filters_fc27.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"cups-filters on Fedora 27");
  script_tag(name:"solution", value:"Please install the updated package(s).");

  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AIBMMYQBDJLW4DOW75H564CIDKX3PAKK");
...
if(release == "FC27")
{
  ...
  if ((res = isrpmvuln(pkg:"cups-filters", rpm:"cups-filters~1.16.1~5.fc27", rls:"FC27")) != NULL)
  {
