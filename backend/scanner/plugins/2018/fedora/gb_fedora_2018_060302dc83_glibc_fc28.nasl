...
# $Id: gb_fedora_2018_060302dc83_glibc_fc28.nasl 14223 2019-03-15 13:49:35Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M52KE4YR3GNMHQUOS3DKAGZD5TQ5D5UH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc'
  package(s) announced via the FEDORA-2018-060302dc83 advisory.");
...
if(release == "FC28")
{
  ...
  if ((res = isrpmvuln(pkg:"glibc", rpm:"glibc~2.27~35.fc28", rls:"FC28")) != NULL)
  {
