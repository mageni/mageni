...
#
# Apache HTTPD HTTP/2 'SETTINGS' Data Processing DoS Vulnerability (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("Apache HTTPD HTTP/2 'SETTINGS' Data Processing DoS Vulnerability (Windows)");
