...
# $Id: deb_dla_1499.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"discount", ver:"2.1.7-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmarkdown2", ver:"2.1.7-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmarkdown2-dbg", ver:"2.1.7-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmarkdown2-dev", ver:"2.1.7-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
