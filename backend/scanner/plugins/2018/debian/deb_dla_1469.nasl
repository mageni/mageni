...
# $Id: deb_dla_1469.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxcursor-dev", ver:"1:1.1.14-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxcursor1", ver:"1:1.1.14-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxcursor1-dbg", ver:"1:1.1.14-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
