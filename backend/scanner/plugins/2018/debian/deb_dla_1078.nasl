...
# $Id: deb_dla_1078.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1078-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1078-1] connman security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"connman", ver:"1.0-1.1+wheezy2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"connman-dev", ver:"1.0-1.1+wheezy2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"connman-doc", ver:"1.0-1.1+wheezy2", rls:"DEB7")) != NULL) {
  report += res;
}
