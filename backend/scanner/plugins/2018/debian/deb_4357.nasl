...
# $Id: deb_4357.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libapache-mod-jk-doc", ver:"1:1.2.46-0+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libapache2-mod-jk", ver:"1:1.2.46-0+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
