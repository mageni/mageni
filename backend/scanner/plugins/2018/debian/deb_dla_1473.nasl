...
# $Id: deb_dla_1473.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"otrs", ver:"3.3.18-1+deb8u5", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"otrs2", ver:"3.3.18-1+deb8u5", rls:"DEB8")) != NULL) {
  report += res;
}
