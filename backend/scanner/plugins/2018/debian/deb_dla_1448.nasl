...
# $Id: deb_dla_1448.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"gir1.2-polkit-1.0", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpolkit-agent-1-0", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpolkit-agent-1-dev", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpolkit-backend-1-0", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpolkit-backend-1-dev", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpolkit-gobject-1-0", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpolkit-gobject-1-dev", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"policykit-1", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"policykit-1-doc", ver:"0.105-15~deb8u3", rls:"DEB8")) != NULL) {
  report += res;
}
