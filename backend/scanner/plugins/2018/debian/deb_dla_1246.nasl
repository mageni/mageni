...
# $Id: deb_dla_1246.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"transmission", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"transmission-cli", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"transmission-common", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"transmission-daemon", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"transmission-dbg", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"transmission-gtk", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"transmission-qt", ver:"2.52-3+nmu3", rls:"DEB7")) != NULL) {
  report += res;
}
