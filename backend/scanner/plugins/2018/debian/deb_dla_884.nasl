...
# $Id: deb_dla_884.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 884-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 884-1] collectd security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"collectd", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"collectd-core", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"collectd-dbg", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"collectd-dev", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"collectd-utils", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libcollectdclient-dev", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libcollectdclient0", ver:"5.1.0-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
