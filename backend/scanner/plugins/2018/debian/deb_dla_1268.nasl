...
# $Id: deb_dla_1268.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1268-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1268-1] p7zip security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"p7zip", ver:"9.20.1~dfsg.1-4+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"p7zip-full", ver:"9.20.1~dfsg.1-4+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
