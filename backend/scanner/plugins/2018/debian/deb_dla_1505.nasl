...
# $Id: deb_dla_1505.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"zutils", ver:"1.3-4+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"zutils-dbg", ver:"1.3-4+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
