...
# $Id: deb_dla_872.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 872-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 872-1] xrdp security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"xrdp", ver:"0.5.0-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
