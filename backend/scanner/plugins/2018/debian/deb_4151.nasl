...
# $Id: deb_4151.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"librelp-dev", ver:"1.2.7-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"librelp0", ver:"1.2.7-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"librelp-dev", ver:"1.2.12-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"librelp0", ver:"1.2.12-1+deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
