...
# $Id: deb_4329.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"teeworlds", ver:"0.6.5+dfsg-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"teeworlds-data", ver:"0.6.5+dfsg-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"teeworlds-server", ver:"0.6.5+dfsg-1~deb9u1", rls:"DEB9")) != NULL) {
  report += res;
}
