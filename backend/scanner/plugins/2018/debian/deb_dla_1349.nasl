...
# $Id: deb_dla_1349.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1349-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"linux-kbuild-3.2", ver:"3.2.101-1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"linux-tools-3.2", ver:"3.2.101-1", rls:"DEB7")) != NULL) {
  report += res;
}
...
if((res = isdpkgvuln(pkg:"usbip", ver:"1.1.1+3.2.101-1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libusbip-dev", ver:"1.1.1+3.2.101-1", rls:"DEB7")) != NULL) {
  report += res;
}
