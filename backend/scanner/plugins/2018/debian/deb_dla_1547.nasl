...
# $Id: deb_dla_1547.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libfontbox-java", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfontbox-java-doc", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjempbox-java", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjempbox-java-doc", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpdfbox-java", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpdfbox-java-doc", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
