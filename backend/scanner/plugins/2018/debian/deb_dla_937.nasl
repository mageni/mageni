...
# $Id: deb_dla_937.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 937-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 937-1] rpcbind security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"rpcbind", ver:"0.2.0-8+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
