...
# $Id: deb_dla_1086.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1086-1] enigmail security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"enigmail", ver:"2:1.9.8.1-1~deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
