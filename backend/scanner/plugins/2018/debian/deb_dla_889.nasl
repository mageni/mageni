...
# $Id: deb_dla_889.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 889-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 889-1] potrace security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libpotrace-dev", ver:"1.10-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libpotrace0", ver:"1.10-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"potrace", ver:"1.10-1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
