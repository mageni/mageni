...
# $Id: deb_dla_1594.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxml-security-c-dev", ver:"1.7.2-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libxml-security-c17", ver:"1.7.2-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"xml-security-c-utils", ver:"1.7.2-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
