...
# $Id: deb_dla_1348.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1348-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1348-1] patch security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"patch", ver:"2.6.1-3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
