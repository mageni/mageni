...
# $Id: deb_dla_1016.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1016-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1016-1] radare2 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libradare2-0.9", ver:"0.9-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libradare2-0.9-dbg", ver:"0.9-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libradare2-dev", ver:"0.9-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"radare2", ver:"0.9-3+deb7u3", rls:"DEB7")) != NULL) {
  report += res;
}
