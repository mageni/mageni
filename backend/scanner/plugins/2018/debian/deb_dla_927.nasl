...
# $Id: deb_dla_927.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"fop", ver:"1:1.0.dfsg2-6+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"fop-doc", ver:"1:1.0.dfsg2-6+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libfop-java", ver:"1:1.0.dfsg2-6+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
