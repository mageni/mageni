...
# $Id: deb_dla_1311.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1311-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1311-1] adminer security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"adminer", ver:"3.3.3-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
