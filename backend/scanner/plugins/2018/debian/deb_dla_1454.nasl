...
# $Id: deb_dla_1454.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"network-manager-vpnc", ver:"0.9.10.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"network-manager-vpnc-gnome", ver:"0.9.10.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
