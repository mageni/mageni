...
# $Id: deb_dla_1287.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1287-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1287-1] zziplib security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libzzip-0-13", ver:"0.13.56-1.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libzzip-dev", ver:"0.13.56-1.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"zziplib-bin", ver:"0.13.56-1.1+deb7u2", rls:"DEB7")) != NULL) {
  report += res;
}
