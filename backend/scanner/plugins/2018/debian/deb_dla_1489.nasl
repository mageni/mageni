...
# $Id: deb_dla_1489.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1489-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1489-1] spice-gtk security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"gir1.2-spice-client-glib-2.0", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gir1.2-spice-client-gtk-2.0", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"gir1.2-spice-client-gtk-3.0", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-client-glib-2.0-8", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-client-glib-2.0-dev", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-client-gtk-2.0-4", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-client-gtk-2.0-dev", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-client-gtk-3.0-4", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libspice-client-gtk-3.0-dev", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-spice-client-gtk", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"spice-client-glib-usb-acl-helper", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"spice-client-gtk", ver:"0.25-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
