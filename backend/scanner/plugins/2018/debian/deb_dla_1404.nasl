...
# $Id: deb_dla_1404.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1404-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1404-1] lava-server security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"lava", ver:"2014.09.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"lava-dev", ver:"2014.09.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"lava-server", ver:"2014.09.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"lava-server-doc", ver:"2014.09.1-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
