...
# $Id: deb_dla_1312.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1312-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1312-1] libvorbisidec security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libvorbisidec-dev", ver:"1.0.2+svn18153-0.2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libvorbisidec1", ver:"1.0.2+svn18153-0.2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
