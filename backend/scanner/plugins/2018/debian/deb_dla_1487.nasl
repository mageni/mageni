...
# $Id: deb_dla_1487.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 1487-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1487-1] libtirpc security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libtirpc-dev", ver:"0.2.5-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtirpc1", ver:"0.2.5-1+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
