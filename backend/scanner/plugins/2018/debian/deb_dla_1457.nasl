...
# $Id: deb_dla_1457.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"ant", ver:"1.9.4-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ant-doc", ver:"1.9.4-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ant-gcj", ver:"1.9.4-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ant-optional", ver:"1.9.4-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"ant-optional-gcj", ver:"1.9.4-3+deb8u2", rls:"DEB8")) != NULL) {
  report += res;
}
