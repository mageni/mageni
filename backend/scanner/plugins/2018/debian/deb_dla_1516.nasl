...
# $Id: deb_dla_1516.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libokularcore5", ver:"4:4.14.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"okular", ver:"4:4.14.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"okular-dbg", ver:"4:4.14.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"okular-dev", ver:"4:4.14.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"okular-extra-backends", ver:"4:4.14.2-2+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
