...
# $Id: deb_dla_959.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 959-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 959-1] libical security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libical-dbg", ver:"0.48-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libical-dev", ver:"0.48-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libical0", ver:"0.48-2+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
