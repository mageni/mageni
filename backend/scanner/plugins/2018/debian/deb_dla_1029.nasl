...
# $Id: deb_dla_1029.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libmtp-common", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmtp-dbg", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmtp-dev", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmtp-doc", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmtp-runtime", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libmtp9", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"mtp-tools", ver:"1.1.3-35-g0ece104-5+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
