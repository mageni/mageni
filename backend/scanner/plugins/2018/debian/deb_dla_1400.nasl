...
# $Id: deb_dla_1400.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libservlet3.0-java", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libservlet3.0-java-doc", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtomcat7-java", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-admin", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-common", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-docs", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-examples", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"tomcat7-user", ver:"7.0.56-3+really7.0.88-2", rls:"DEB8")) != NULL) {
  report += res;
}
