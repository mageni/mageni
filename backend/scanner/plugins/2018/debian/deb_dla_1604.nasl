...
# $Id: deb_dla_1604.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"python-lxml", ver:"3.4.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-lxml-dbg", ver:"3.4.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python-lxml-doc", ver:"3.4.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python3-lxml", ver:"3.4.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"python3-lxml-dbg", ver:"3.4.0-1+deb8u1", rls:"DEB8")) != NULL) {
  report += res;
}
