...
# $Id: deb_dla_898.nasl 14270 2019-03-18 14:24:29Z cfischer $
#
# Auto-generated from advisory DLA 898-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 898-1] libosip2 security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libosip2-7", ver:"3.6.0-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libosip2-dev", ver:"3.6.0-4+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
