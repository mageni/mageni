...
# $Id: deb_dla_1020.nasl 14281 2019-03-18 14:53:48Z cfischer $
#
# Auto-generated from advisory DLA 1020-1 using nvtgen 1.0
# Script version: 1.0
#
# Author:
# Greenbone Networks
...
if(description)
{
  ...
  script_name("Debian LTS Advisory ([SECURITY] [DLA 1020-1] jetty security update)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"jetty", ver:"6.1.26-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjetty-extra", ver:"6.1.26-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjetty-extra-java", ver:"6.1.26-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjetty-java", ver:"6.1.26-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libjetty-java-doc", ver:"6.1.26-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
