...
# $Id: gb_CESA-2018_1270_java_centos6.nasl 14058 2019-03-08 13:25:52Z cfischer $
#
# CentOS Update for java CESA-2018:1270 centos6
#
# Authors:
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~1.7.0.181~2.6.14.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~demo~1.7.0.181~2.6.14.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~devel~1.7.0.181~2.6.14.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~javadoc~1.7.0.181~2.6.14.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"java", rpm:"java~1.7.0~openjdk~src~1.7.0.181~2.6.14.1.el6_9", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
