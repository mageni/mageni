...
# $Id: gb_suse_2018_2130_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-07/msg00047.html");
...
if(release == "openSUSELeap42.3")
{
  ...
  if ((res = isrpmvuln(pkg:"qutebrowser", rpm:"qutebrowser~0.11.1~2.3.1", rls:"openSUSELeap42.3")) != NULL)
  {
