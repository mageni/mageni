...
# $Id: gb_suse_2018_0737_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"This update for Mozilla Firefox to version 52.7.2esr fixes security issues
  and bugs.
