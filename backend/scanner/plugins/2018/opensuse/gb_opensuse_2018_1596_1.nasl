...
# $Id: gb_suse_2018_1596_1.nasl 12497 2018-11-23 08:28:21Z cfischer $
#
# SuSE Update for xdg-utils openSUSE-SU-2018:1596-1 (xdg-utils)
#
# Authors:
...
if(description)
{
  ...
  script_name("SuSE Update for xdg-utils openSUSE-SU-2018:1596-1 (xdg-utils)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2018-06/msg00009.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xdg-utils'
  package(s) announced via the openSUSE-SU-2018:1596_1 advisory.");
...
if(release == "openSUSELeap15.0")
{
  ...
  if ((res = isrpmvuln(pkg:"xdg-utils", rpm:"xdg-utils~20170508~lp150.3.3.2", rls:"openSUSELeap15.0")) != NULL)
  {
