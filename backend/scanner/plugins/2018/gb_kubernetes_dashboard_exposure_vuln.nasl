...
# $Id: gb_kubernetes_dashboard_exposure_vuln.nasl 10838 2018-08-08 12:05:36Z cfischer $
#
...
if(description)
{
  ...
  script_mandatory_keys("KubernetesDashboard/installed");
...
if(get_kb_item("KubernetesDashboard/" + port + "/installed") ) {
