...
if(description)
{
  ...
  This script has been merged into the NVT 'Elastic Logstash 'CVE-2015-5378' Man in the Middle Security Bypass Vulnerability'
  ...
  script_mandatory_keys("elastic/logstash/detected", "Host/runs_unixoide");
