...
# $Id: gb_matomo_mult_xss_nov18.nasl 12445 2018-11-20 16:27:13Z cfischer $
#
# Matomo Analytics < 3.7.0 Multiple XSS Vulnerabilities
#
# Authors:
...
if(description)
{
  ...
  script_version("$Revision: 12445 $");
  script_tag(name:"last_modification", value:"$Date: 2018-11-20 17:27:13 +0100 (Tue, 20 Nov 2018) $");
