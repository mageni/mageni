...
#
# Scripting Engine Memory Corruption Vulnerability (KB4483230)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814626");
  ...
  script_tag(name:"creation_date", value:"2018-12-20 12:54:55 +0530 (Thu, 20 Dec 2018)");
  script_name("Scripting Engine Memory Corruption Vulnerability (KB4483230)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4483230");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4483230");
...
if(version_in_range(version:iedllVer, test_version:"10.0.15063.0", test_version2:"10.0.15063.1507"))
{
  report = report_fixed_ver(file_checked:iePath + "\Pcadm.dll",
                            file_version:iedllVer, vulnerable_range:"10.0.15063.0 - 10.0.15063.1507");
