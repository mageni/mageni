...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4032229");
...
if(excelVer =~ "^(16\.)" && version_is_less(version:excelVer, test_version:"16.0.4732.1000"))
{
  report = report_fixed_ver(file_checked:excelPath + "Excel.exe",
                            file_version:excelVer, vulnerable_range:"16.0 - 16.0.4732.0999");
