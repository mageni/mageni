...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814706");
  ...
  script_tag(name:"creation_date", value:"2018-12-12 12:37:33 +0530 (Wed, 12 Dec 2018)");
  script_name("Microsoft .NET Framework 4.5.2 Multiple Vulnerabilities (KB4470623)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4470623");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 4.5.2 for Windows Server 2012");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4470623");
...
foreach key(key_list)
{
  ...
  if(VULN)
  {
    report = report_fixed_ver(file_checked:dotPath + "workflowservicehostperformancecounters.dll",
