...
#
# Adobe Flash Player Within Google Chrome Security Update(apsb18-31)-MAC OS X
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814009");
  script_version("2019-05-17T10:45:27+0000");
  script_cve_id("CVE-2018-15967");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2019-05-17 10:45:27 +0000 (Fri, 17 May 2019)");
  script_tag(name:"creation_date", value:"2018-09-12 10:44:45 +0530 (Wed, 12 Sep 2018)");
  script_name("Adobe Flash Player Within Google Chrome Security Update( apsb18-31 )- MAC OS X");
  ...
  script_tag(name:"affected", value:"Adobe Flash Player prior to 31.0.0.108
  within Google Chrome on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade to Adobe Flash Player for
  Google Chrome 31.0.0.108, or later. Please see the references for more information.");
