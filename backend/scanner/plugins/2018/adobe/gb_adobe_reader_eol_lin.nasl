...
# $Id: gb_adobe_reader_eol_lin.nasl 11624 2018-09-26 12:00:34Z santu $
#
# Adobe Reader End Of Life Detection (Linux)
#
# Authors:
...
if(description)
{
  ...
  script_name("Adobe Reader End Of Life Detection (Linux)");
