...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814186");
  ...
  script_name("Adobe Acrobat 2017 Information Disclosure Vulnerability(apsb18-40)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat 2017 version 2017.x before 2017.011.30106 on MAC OS X.");
