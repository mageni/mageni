...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.812552");
  ...
  script_name("Adobe Acrobat Reader DC (Continuous Track) Security Updates(apsb17-24)-Windows");
  ...
  2017.009.20058 and earlier versions on Windows.");
