...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://developer.joomla.org/security-centre/734-20180506-core-filter-field-in-com-fields-allows-remote-code-execution.html");
...
if(version_in_range(version:jVer, test_version:"3.7.0", test_version2:"3.8.7")) {
