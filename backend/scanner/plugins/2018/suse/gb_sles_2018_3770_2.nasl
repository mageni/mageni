...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3770-2)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-December/004954.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'postgresql10'
  package(s) announced via the SUSE-SU-2018:3770-2 advisory.");
