...
if(description)
{
  ...
  script_cve_id("CVE-2016-7837","CVE-2016-9800","CVE-2016-9804");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1778-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004212.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'bluez'
  package(s) announced via the SUSE-SU-2018:1778-1 advisory.");
