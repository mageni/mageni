...
if(description)
{
  ...
  script_cve_id("CVE-2017-16227","CVE-2018-5378","CVE-2018-5379");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0456-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003734.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'quagga'
  package(s) announced via the SUSE-SU-2018:0456-1 advisory.");
