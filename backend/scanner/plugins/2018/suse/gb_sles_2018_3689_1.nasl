...
if(description)
{
  ...
  script_cve_id("CVE-2018-14633","CVE-2018-18281","CVE-2018-18386");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3689-1)");
  ...
  package(s) announced via the SUSE-SU-2018:3689-1 advisory.");
