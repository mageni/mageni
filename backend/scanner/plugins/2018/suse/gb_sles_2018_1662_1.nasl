...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000456","CVE-2017-14517","CVE-2017-14518");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1662-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004186.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'poppler'
  package(s) announced via the SUSE-SU-2018:1662-1 advisory.");
