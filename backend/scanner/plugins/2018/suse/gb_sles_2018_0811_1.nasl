...
if(description)
{
  ...
  script_cve_id("CVE-2017-17997","CVE-2018-7320","CVE-2018-7321");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0811-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-March/003842.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'wireshark'
  package(s) announced via the SUSE-SU-2018:0811-1 advisory.");
