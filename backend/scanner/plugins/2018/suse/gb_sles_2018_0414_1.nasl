...
if(description)
{
  ...
  script_cve_id("CVE-2016-10244","CVE-2017-7864","CVE-2017-8105");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0414-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003720.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'freetype2'
  package(s) announced via the SUSE-SU-2018:0414-1 advisory.");
