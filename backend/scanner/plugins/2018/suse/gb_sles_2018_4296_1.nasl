...
if(description)
{
  ...
  script_cve_id("CVE-2015-2775","CVE-2016-6893","CVE-2018-0618");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:4296-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-December/005005.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'mailman'
  package(s) announced via the SUSE-SU-2018:4296-1 advisory.");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"mailman", rpm:"mailman~2.1.17~3.3.3", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mailman-debuginfo", rpm:"mailman-debuginfo~2.1.17~3.3.3", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mailman-debugsource", rpm:"mailman-debugsource~2.1.17~3.3.3", rls:"SLES12.0LTSS"))){
    report += res;
  }
