...
if(description)
{
  ...
  script_cve_id("CVE-2017-14970","CVE-2017-9214","CVE-2017-9263");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0311-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003692.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openvswitch'
  package(s) announced via the SUSE-SU-2018:0311-1 advisory.");
