...
if(description)
{
  ...
  script_cve_id("CVE-2017-17805","CVE-2017-17806","CVE-2017-5715");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:0012-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003566.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2018:0012-1 advisory.");
