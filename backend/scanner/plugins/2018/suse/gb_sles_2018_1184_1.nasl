...
if(description)
{
  ...
  script_cve_id("CVE-2018-10471","CVE-2018-10472","CVE-2018-7540");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:1184-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-May/003988.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'xen'
  package(s) announced via the SUSE-SU-2018:1184-1 advisory.");
