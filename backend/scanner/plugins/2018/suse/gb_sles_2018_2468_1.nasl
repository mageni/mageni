...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:2468-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004482.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'libcgroup'
  package(s) announced via the SUSE-SU-2018:2468-1 advisory.");
