...
if(description)
{
  ...
  script_cve_id("CVE-2017-11624","CVE-2017-11625","CVE-2017-11626");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2018:3066-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004650.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'qpdf'
  package(s) announced via the SUSE-SU-2018:3066-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Please see the references for more information on the vulnerabilities.");

  script_tag(name:"affected", value:"'qpdf' package(s) on SUSE Linux Enterprise Server 12");
...
if(release == "SLES12.0LTSS") {
  if(!isnull(res = isrpmvuln(pkg:"cups-filters", rpm:"cups-filters~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-cups-browsed", rpm:"cups-filters-cups-browsed~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-cups-browsed-debuginfo", rpm:"cups-filters-cups-browsed-debuginfo~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-debuginfo", rpm:"cups-filters-debuginfo~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-debugsource", rpm:"cups-filters-debugsource~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-foomatic-rip", rpm:"cups-filters-foomatic-rip~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-foomatic-rip-debuginfo", rpm:"cups-filters-foomatic-rip-debuginfo~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-ghostscript", rpm:"cups-filters-ghostscript~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cups-filters-ghostscript-debuginfo", rpm:"cups-filters-ghostscript-debuginfo~1.0.58~15.2.1", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libqpdf18", rpm:"libqpdf18~7.1.1~3.3.4", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libqpdf18-debuginfo", rpm:"libqpdf18-debuginfo~7.1.1~3.3.4", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qpdf", rpm:"qpdf~7.1.1~3.3.4", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qpdf-debuginfo", rpm:"qpdf-debuginfo~7.1.1~3.3.4", rls:"SLES12.0LTSS"))){
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qpdf-debugsource", rpm:"qpdf-debugsource~7.1.1~3.3.4", rls:"SLES12.0LTSS"))){
    report += res;
  }
