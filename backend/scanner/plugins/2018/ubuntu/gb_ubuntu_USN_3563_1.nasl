...
# $Id: gb_ubuntu_USN_3563_1.nasl 14288 2019-03-18 16:34:17Z cfischer $
#
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"mailman", ver:"1:2.1.16-2ubuntu0.5", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU17.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"mailman", ver:"1:2.1.23-1ubuntu0.2", rls:"UBUNTU17.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU16.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"mailman", ver:"1:2.1.20-1ubuntu0.3", rls:"UBUNTU16.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
