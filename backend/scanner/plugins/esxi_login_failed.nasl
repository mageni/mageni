...
# $Id: esxi_login_failed.nasl 13248 2019-01-23 15:35:02Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"solution", value:"Recheck the VMware ESXi credentials and configuration for authenticated checks
  as well as the output of the VT 'VMware ESXi scan initialization' (OID: 1.3.6.1.4.1.25623.1.0.103447).");
