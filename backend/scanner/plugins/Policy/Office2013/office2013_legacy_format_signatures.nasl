...
# $Id: office2013_legacy_format_signatures.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Legacy format signatures
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312323");
  ...
  script_name('Microsoft Office 2013: Legacy format signatures');
  ...
  script_tag(name: "summary", value: 'Check Setting "Legacy format signatures" (Microsoft Office 2013).');
  exit(0);
}
...
item = 'EnableCreationOfWeakXPSignatures';
