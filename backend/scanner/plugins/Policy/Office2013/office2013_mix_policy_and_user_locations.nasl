...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312346");
  ...
  script_name('Microsoft Office 2013: Mix of Policy and User Locations');
  ...
  script_tag(name: "summary", value: 'Check Setting "Allow mix of policy and user locations" (Microsoft Office 2013).');
  exit(0);
}
