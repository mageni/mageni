...
# $Id: office2013_png_output_format.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Allow PNG as an output format
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312341");
  ...
  script_name('Microsoft Office 2013: Allow PNG as an output format');
  ...
  script_tag(name: "summary", value: 'Check Setting "Allow PNG as an output format" (Microsoft Office 2013).');
  exit(0);
}
