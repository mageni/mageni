...
# $Id: office2013_data_uploading_office_telemetry_agent.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Turn on data uploading for Office Telemetry Agent
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312328");
  ...
  script_name('Microsoft Office 2013: Turn on data uploading for Office Telemetry Agent');
  ...
  script_tag(name: "summary", value: 'Check Setting "Turn on data uploading for Office Telemetry Agent" (Microsoft Office 2013).');
  exit(0);
}
