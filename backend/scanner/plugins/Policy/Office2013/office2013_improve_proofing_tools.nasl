...
# $Id: office2013_improve_proofing_tools.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Improve Proofing Tools"
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312334");
  ...
  script_name('Microsoft Office 2013: Improve Proofing Tools"');
  ...
  script_tag(name: "summary", value: 'Check Setting "Improve Proofing Tools"" (Microsoft Office 2013).');
  exit(0);
}
...
type = 'HKCU';
key = 'Software\\Policies\\Microsoft\\Office\\15.0\\common\\ptwatson';
item = 'PTWOptIn';
