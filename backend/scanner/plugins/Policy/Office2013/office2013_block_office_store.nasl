...
# $Id: office2013_block_office_store.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Block the Office Store
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312326");
  ...
  script_name('Microsoft Office 2013: Block the Office Store');
  ...
  script_tag(name: "summary", value: 'Check Setting "Block the Office Store" (Microsoft Office 2013).');
  exit(0);
}
