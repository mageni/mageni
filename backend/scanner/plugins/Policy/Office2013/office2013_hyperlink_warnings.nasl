...
# $Id: office2013_hyperlink_warnings.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Suppress hyperlink warnings
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312318");
  ...
  script_name('Microsoft Office 2013: Suppress hyperlink warnings');
  ...
  script_tag(name: "summary", value: 'Check Setting "Suppress hyperlink warnings" (Microsoft Office 2013).');
  exit(0);
}
