...
# $Id: office2013_protect_rights_managed_files_metadata.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Protect document metadata for rights managed Office Open XML Files
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312329");
  ...
  script_name('Microsoft Office 2013: Protect document metadata for rights managed Office Open XML Files');
  ...
  script_tag(name: "summary", value: 'Check Setting "Protect document metadata for rights managed Office Open XML Files" (Microsoft Office 2013).');
  exit(0);
}
