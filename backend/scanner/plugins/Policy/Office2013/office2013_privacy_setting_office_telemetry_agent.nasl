...
# $Id: office2013_privacy_setting_office_telemetry_agent.nasl 9659 2018-04-27 11:55:11Z emoss $
#
# Check value for Turn on privacy setting in Office Telemetry Agent
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312333");
  ...
  script_name('Microsoft Office 2013: Turn on privacy setting in Office Telemetry Agent');
  ...
  script_tag(name: "summary", value: 'Check Setting "Turn on privacy setting in Office Telemetry Agent" (Microsoft Office 2013).');
  exit(0);
}
