...
if(description)
{
  ...
  script_tag(name:"summary", value:"The sticky bit prevents user other then the owner to delete the
directory.

This scripts checks for world-writable directories without the sticky bit.
...
if(!get_kb_item("login/SSH/success") || !sock = ssh_login_or_reuse_connection()){
  ...
  compliant = "yes";
  files = ssh_cmd_without_errors(cmd:cmd, socket:sock);
  if(files){
    compliant = "no";
