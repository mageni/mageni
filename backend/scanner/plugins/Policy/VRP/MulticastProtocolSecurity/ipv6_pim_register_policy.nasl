...
if(description)
{
  ...
  script_dependencies("vrp_current_configuration_interface.nasl", "vrp_current_configuration_section_include_multicast_ipv6.nasl", "vrp_current_configuration_pim.nasl");
