...
# $Id: win10_rename_admin_account.nasl 10649 2018-07-27 07:16:55Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312195");
  ...
  script_name('Microsoft Windows 10: Accounts: Rename administrator account');
