...
# $Id: win_xbox_live_auth_manager.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Xbox Live Auth Manager (XblAuthManager)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312299");
  script_version("$Revision: 10714 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-01 16:49:06 +0200 (Wed, 01 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-13 15:46:27 +0200 (Wed, 13 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows 10: Service: Xbox Live Auth Manager');
...
'Xbox Live Auth Manager (XblAuthManager)' on Windows hosts (Windows 10).

The service provides authentication and authorization services for interacting
with Xbox Live.");
  exit(0);
}
