...
# $Id: win_geolocation_service.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Geolocation Service (lfsvc)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312295");
  ...
  script_name('Microsoft Windows 10: Service: Geolocation Service');
...
'Geolocation Service (lfsvc)' on Windows hosts (Windows 10).

The service monitors the current location of the system and manages geofences.
If turned off, apps are unable to use or receive notifications for geolocations
or geofences.");
  exit(0);
}
