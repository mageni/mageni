...
# $Id: win_dignostic_data_experience.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Do not use diagnostic data for tailored experiences
# (users listed in HKU)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312241");
...
'Do not use diagnostic data for tailored experiences' on Windows hosts (at
least Windows 10).

The setting determines if Windows can use diagnostic data to provide tailored
