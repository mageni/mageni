...
# $Id: win10_generate_security_audits.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Generate security audits (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312279");
  ...
  script_name('Microsoft Windows 10: Generate security audits');
...
accounts can be used by a process to generate audit records in the security 
event log. The Local Security Authority Subsystem Service (LSASS) writes events 
to the log. You can use the information in the security event log to trace 
