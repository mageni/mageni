...
# $Id: win10_allow_logon_locally.nasl 10649 2018-07-27 07:16:55Z emoss $
#
# Check value for Allow log on locally (WMI)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312251");
...
can start an interactive session on the device. Users must have this user right 
to log on over a Remote Desktop Services session that is running on a 
Windows-based member device or domain controller.");
  exit(0);
}
