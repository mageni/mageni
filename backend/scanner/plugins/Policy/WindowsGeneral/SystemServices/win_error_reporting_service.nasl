...
# $Id: win_error_reporting_service.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Windows Error Reporting Service (WerSvc)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312654");
...
'Windows Error Reporting Service (WerSvc)' on Windows hosts (at least Windows 7).

The service allows errors to be reported when programs stop working or responding
