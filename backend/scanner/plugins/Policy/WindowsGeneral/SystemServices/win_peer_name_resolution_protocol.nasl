...
# $Id: win_peer_name_resolution_protocol.nasl 10714 2018-08-01 14:49:06Z emoss $
#
# Check value for Peer Name Resolution Protocol (PNRPsvc)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312682");
...
'Peer Name Resolution Protocol' on Windows hosts (at least
Windows 7).

The service enables serverless peer name resolution over the internet using the
