...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312599");
  ...
  script_name('Microsoft Windows: Allow standby states (S1-S3) when sleeping (on battery)');
...
title = 'Allow standby states (S1-S3) when sleeping (on battery)';
