...
# $Id: win_advertising_id.nasl 10819 2018-08-07 14:11:07Z emoss $
#
# Check value for Turn off the advertising ID
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312616");
...
'Turn off the advertising ID' on Windows hosts (at least Windows 8.1).

The setting turns off the advertising ID, preventing apps from using the ID for experiences across
apps.");
  exit(0);
}
