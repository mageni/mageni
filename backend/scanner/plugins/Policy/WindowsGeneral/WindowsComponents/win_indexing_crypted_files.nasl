...
# $Id: win_indexing_crypted_files.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Allow indexing of encrypted files
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312472");
...
'Allow indexing of encrypted files' on Windows hosts (at least Windows 7).

The setting allows encrypted items to be indexed");
  exit(0);
}
