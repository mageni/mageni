...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312385");
  ...
  script_name('Microsoft Windows: Hardware-based encryption: Restrict crypto algorithms');
...
The option allows to restrict the encryption algorithms that BitLocker can use
...
item = 'FDVAllowedHardwareEncryptionAlgorithms';
