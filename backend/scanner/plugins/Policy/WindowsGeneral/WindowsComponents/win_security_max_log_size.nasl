...
# $Id: win_security_max_log_size.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Specify the maximum log file size (Security)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312379");
  script_version("$Revision: 10989 $");
  script_tag(name:"last_modification", value:"$Date: 2018-08-15 16:57:51 +0200 (Wed, 15 Aug 2018) $");
  script_tag(name:"creation_date", value:"2018-06-26 15:32:55 +0200 (Tue, 26 Jun 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");
  script_name('Microsoft Windows: Specify the maximum log file size (Security)');
...
'Security: Specify the maximum log file size' on Windows hosts (at least
Windows 7).
...
Event Log Service/Security/' + title;
type = 'HKLM';
