...
# $Id: win_rdhost_disconnect_limit.nasl 10989 2018-08-15 14:57:51Z emoss $
#
# Check value for Set time limit for disconnected sessions
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312478");
...
'Set time limit for disconnected sessions' on Windows hosts (at least Windows 7).

The setting specifies the maximum amount of time that a disconnected session
remains active on the server.");
  exit(0);
}
