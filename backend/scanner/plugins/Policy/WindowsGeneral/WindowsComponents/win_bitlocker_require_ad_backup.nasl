...
# $Id: win_bitlocker_require_ad_backup.nasl 10842 2018-08-08 14:01:21Z emoss $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.312397");
...
'Choose how BitLocker-protected fixed drives can be recovered: Do not enable
BitLocker until recovery information is stored to AD DS for fixed data drives'
