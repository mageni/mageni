...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109574");
  ...
  script_name("Microsoft Windows Firewall: Public: Logging: Log dropped packets");
...
Advanced Security discards an inbound packet for any reason.");
...
win_min_ver = "6.1";
title = "Public Profile: Logging: Log dropped packets";
