...
# $Id: deb_278_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 278-1
#
# Authors:
...
announced via advisory DSA 278-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20278-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302541");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sendmail", ver:"8.9.3-26", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sendmail-doc", ver:"8.12.3-6.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmilter-dev", ver:"8.12.3-6.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"sendmail", ver:"8.12.3-6.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
