...
# $Id: deb_980_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to tutos
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301094");
 ...
 script_name("Debian Security Advisory DSA 980-1 (tutos)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tutos", ver:"1.1.20031017-2+1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
