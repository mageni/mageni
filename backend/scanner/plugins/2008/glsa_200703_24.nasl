...
tag_insight = "mgv improperly handles user-supplied data possibly allowing for the
execution of arbitrary code.";
tag_solution = "mgv is currently unmaintained, and the mgv website no longer exists. As
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302569");
