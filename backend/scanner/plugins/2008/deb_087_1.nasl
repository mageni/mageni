...
# $Id: deb_087_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 087-1
#
# Authors:
...
tag_insight = "CORE ST reports that an exploit has been found for a bug in the wu-ftpd
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20087-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303613");
