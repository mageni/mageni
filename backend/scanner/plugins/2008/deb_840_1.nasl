...
# $Id: deb_840_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 840-1
#
# Authors:
...
We recommend that you upgrade your drupal package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20840-1";
tag_summary = "The remote host is missing an update to drupal
announced via advisory DSA 840-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301114");
 ...
 script_name("Debian Security Advisory DSA 840-1 (drupal)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"drupal", ver:"4.5.3-4", rls:"DEB3.1")) != NULL) {
    report += res;
}
