...
# $Id: deb_146_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
announced via advisory DSA 146-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20146-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302567");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"dietlibc-doc", ver:"0.12-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"dietlibc-dev", ver:"0.12-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
