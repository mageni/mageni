#
#VID 97c3a452-6e36-11d9-8324-000a95bc6fae
...
CVE-2004-1061
Cross-site scripting (XSS) vulnerability in unknown versions of
Bugzilla allows remote attackers to inject arbitrary HTML and web
script via unknown attack vectors.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.bugzilla.org/security/2.16.7-nr/
https://bugzilla.mozilla.org/show_bug.cgi?id=272620
http://www.vuxml.org/freebsd/97c3a452-6e36-11d9-8324-000a95bc6fae.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304073");
