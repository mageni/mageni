#
#VID 63347ee7-6841-11dc-82b6-02e0185f8d72
...
http://www.vuxml.org/freebsd/63347ee7-6841-11dc-82b6-02e0185f8d72.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300119");
 ...
 script_name("FreeBSD Ports: wordpress, de-wordpress, zh-wordpress");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.2.3,1")<0) {
...
if(!isnull(bver) && revcomp(a:bver, b:"1.2.4,2")<0) {
