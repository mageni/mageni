...
# $Id: deb_1627_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The previous security update for opensc had a too strict check for
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201627-2";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301032");
 ...
 script_name("Debian Security Advisory DSA 1627-2 (opensc)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"opensc", ver:"0.11.1-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mozilla-opensc", ver:"0.11.1-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libopensc2-dbg", ver:"0.11.1-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libopensc2-dev", ver:"0.11.1-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libopensc2", ver:"0.11.1-2etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
