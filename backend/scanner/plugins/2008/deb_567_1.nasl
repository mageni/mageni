...
# $Id: deb_567_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several problems have been discovered in libtiff, the Tag Image File
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20567-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301186");
 ...
 script_name("Debian Security Advisory DSA 567-1 (tiff)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libtiff-tools", ver:"3.5.5-6woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiff3g", ver:"3.5.5-6woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libtiff3g-dev", ver:"3.5.5-6woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
