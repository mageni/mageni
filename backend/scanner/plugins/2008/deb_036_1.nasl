...
# $Id: deb_036_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "It has been reported that a local user could tweak Midnight Commander
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20036-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300094");
