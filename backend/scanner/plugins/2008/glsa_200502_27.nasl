...
tag_insight = "gFTP is vulnerable to directory traversal attacks, possibly leading to the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200502-27
http://bugs.gentoo.org/show_bug.cgi?id=81994
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301211");
