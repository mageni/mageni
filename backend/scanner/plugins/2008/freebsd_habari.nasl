#
#VID 578f6322-c450-11dd-a721-0030843d3802
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID 578f6322-c450-11dd-a721-0030843d3802
#
# Authors:
...
tag_insight = "The following package is affected: habari
...
http://www.vuxml.org/freebsd/578f6322-c450-11dd-a721-0030843d3802.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300134");
 ...
 script_cve_id("CVE-2008-4601");
 script_tag(name:"cvss_base", value:"4.3");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
 script_name("FreeBSD Ports: habari");
...
txt = "";
vuln = 0;
bver = portver(pkg:"habari");
if(!isnull(bver) && revcomp(a:bver, b:"0.5.2")<0) {
    txt += 'Package habari version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
