#
#VID e4c62abd-5065-11db-a5ae-00508d6a62df
...
tag_insight = "The following package is affected: tikiwiki";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304091");
 ...
 script_name("FreeBSD Ports: tikiwiki");
...
txt = "";
vuln = 0;
bver = portver(pkg:"tikiwiki");
if(!isnull(bver) && revcomp(a:bver, b:"1.9.5")<0) {
    txt += 'Package tikiwiki version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
