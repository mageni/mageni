#
#VID 0832ee18-cf77-11dc-8c6a-00304881ac9a 
...
tag_insight = "The following package is affected: jetty
...
http://www.vuxml.org/freebsd/0832ee18-cf77-11dc-8c6a-00304881ac9a .html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304181");
 ...
 script_name("FreeBSD Ports: jetty");
...
if(!isnull(bver) && revcomp(a:bver, b:"6.1.7")<0) {
    txt += 'Package jetty version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
