...
# $Id: deb_1040_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1040-1
#
# Authors:
...
tag_summary = "The remote host is missing an update to gdm
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300861");
 ...
 script_name("Debian Security Advisory DSA 1040-1 (gdm)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gdm", ver:"2.6.0.8-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
