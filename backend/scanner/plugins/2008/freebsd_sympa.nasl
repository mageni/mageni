#
#VID 0d9ba03b-0dbb-42b4-ae0f-60e27af78e22
...
tag_insight = "The following package is affected: sympa

CVE-2005-0073
Buffer overflow in queue.c in a support script for sympa 3.3.3, when
running setuid, allows local users to execute arbitrary code.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.debian.org/security/2005/dsa-677
http://www.vuxml.org/freebsd/0d9ba03b-0dbb-42b4-ae0f-60e27af78e22.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300497");
...
if(!isnull(bver) && revcomp(a:bver, b:"4.1.2_1")<0) {
