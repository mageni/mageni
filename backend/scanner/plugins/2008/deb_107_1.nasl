...
# $Id: deb_107_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Basically, this is the same Security Advisory as DSA 072-1, but for
...
arbitrary code.";
tag_summary = "The remote host is missing an update to jgroff
announced via advisory DSA 107-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20107-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302059");
 ...
 script_name("Debian Security Advisory DSA 107-1 (jgroff)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"jgroff", ver:"1.15+ja-3.4", rls:"DEB2.2")) != NULL) {
    report += res;
}
