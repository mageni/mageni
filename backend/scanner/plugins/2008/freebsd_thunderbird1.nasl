#
#VID a7e0d783-131b-11d9-bc4a-000c41e2cdad
...
allow remote web sites to install arbitrary extensions by using
interactive events to manipulate the XPInstall Security dialog box.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugzilla.mozilla.org/show_bug.cgi?id=162020
http://www.vuxml.org/freebsd/a7e0d783-131b-11d9-bc4a-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301623");
