#
#VID 322d4ff6-85c3-11d8-a41f-0020ed76ef5a
...
CVE-2003-1023
Stack-based buffer overflow in vfs_s_resolve_symlink of vfs/direntry.c
for Midnight Commander (mc) 4.6.0 and earlier, and possibly later
versions, allows remote attackers to execute arbitrary code during
symlink conversion.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://marc.theaimsgroup.com/?l=bugtraq&m=106399528518704
http://www.vuxml.org/freebsd/322d4ff6-85c3-11d8-a41f-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300622");
