#
#ADV FreeBSD-SA-07:06.tcpdump.asc
...
tag_insight = "Tcpdump is a commonly used network diagnostic utility which decodes packets
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:06.tcpdump.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-07:06.tcpdump.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300950");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-07:06.tcpdump.asc)";
 script_name(name);
