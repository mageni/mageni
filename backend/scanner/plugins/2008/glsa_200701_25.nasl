...
tag_insight = "Sean Larsson from iDefense Labs has found multiple vulnerabilities in the
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302571");
 ...
 script_name("Gentoo Security Advisory GLSA 200701-25 (X.Org)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"x11-base/xorg-server", unaffected: make_list("ge 1.1.1-r4"), vulnerable: make_list("lt 1.1.1-r4"))) != NULL) {
    report += res;
}
