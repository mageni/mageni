...
tag_insight = "The following package is affected: newsgrab
...
http://www.vuxml.org/freebsd/cd7e260a-6bff-11d9-a5df-00065be4b5b6.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303168");
 ...
 script_cve_id("CVE-2005-0154");
 script_tag(name:"cvss_base", value:"5.0"); 
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P"); 
 script_name("FreeBSD Ports: newsgrab");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.4.0")<=0) {
    txt += 'Package newsgrab version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
