...
# $Id: deb_017_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "With older versions of jazip a user could gain root access for members
...
tag_summary = "The remote host is missing an update to jazip
announced via advisory DSA 017-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20017-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303093");
