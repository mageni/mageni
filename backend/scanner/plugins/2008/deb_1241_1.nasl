...
# $Id: deb_1241_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300759");
 ...
 script_name("Debian Security Advisory DSA 1241-1 (squirrelmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"squirrelmail", ver:"1.4.4-10", rls:"DEB3.1")) != NULL) {
    report += res;
}
