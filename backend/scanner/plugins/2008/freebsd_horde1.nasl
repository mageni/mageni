#
#VID ed1d404d-2784-11d9-b954-000bdb1444a4
...
http://www.vuxml.org/freebsd/ed1d404d-2784-11d9-b954-000bdb1444a4.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300269");
 ...
 script_name("FreeBSD Ports: horde, horde-devel");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.2.7")<0) {
    txt += 'Package horde-devel version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
