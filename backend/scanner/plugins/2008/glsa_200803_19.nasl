...
tag_insight = "Multiple vulnerabilities have been discovered in Apache.";
tag_solution = "All Apache users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-servers/apache-2.2.8'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-19
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302227");
 ...
 script_name("Gentoo Security Advisory GLSA 200803-19 (apache)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"www-servers/apache", unaffected: make_list("ge 2.2.8"), vulnerable: make_list("lt 2.2.8"))) != NULL) {
    report += res;
}
