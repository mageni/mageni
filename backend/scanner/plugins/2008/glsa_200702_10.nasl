...
tag_insight = "Multiple vulnerabilities have been found in the network components of
UFO2000 that could result in the remote execution of arbitrary code.";
tag_solution = "UFO2000 currently depends on the dumb-0.9.2 library, which has been removed
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200702-10
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301851");
