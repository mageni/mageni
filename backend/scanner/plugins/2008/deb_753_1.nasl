...
# $Id: deb_753_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 753-1
#
# Authors:
...
We recommend that you upgrade your gedit package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20753-1";
tag_summary = "The remote host is missing an update to gedit
announced via advisory DSA 753-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300303");
 ...
 script_name("Debian Security Advisory DSA 753-1 (gedit)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gedit-common", ver:"2.8.3-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gedit-dev", ver:"2.8.3-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
