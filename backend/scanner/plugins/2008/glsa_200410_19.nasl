...
tag_insight = "The catchsegv script in the glibc package is vulnerable to symlink attacks,
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200410-19
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303779");
