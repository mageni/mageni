#
#VID a2ffb627-9c53-11d8-9366-0020ed76ef5a
...
arbitrary code via long directory or file names in an LHA archive,
which triggers the overflow when testing or extracting the archive.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303194");
