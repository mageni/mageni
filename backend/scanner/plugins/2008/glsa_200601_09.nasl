...
tag_insight = "There is a flaw in Wine in the handling of Windows Metafiles (WMF) files,
which could possibly result in the execution of arbitrary code.";
tag_solution = "All Wine users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-emulation/wine-0.9.0'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200601-09
http://bugs.gentoo.org/show_bug.cgi?id=118101";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302276");
