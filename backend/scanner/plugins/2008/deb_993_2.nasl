...
# $Id: deb_993_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 993-2
#
# Authors:
...
We recommend that you upgrade your gnupg package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20993-2";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303984");
 ...
 script_name("Debian Security Advisory DSA 993-2 (gnupg)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gnupg", ver:"1.0.6-4woody5", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gnupg", ver:"1.4.1-1.sarge3", rls:"DEB3.1")) != NULL) {
    report += res;
}
