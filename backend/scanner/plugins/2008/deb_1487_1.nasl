...
# $Id: deb_1487_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several vulnerabilities have been discovered in the EXIF parsing code
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201487-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302524");
...
if ((res = isdpkgvuln(pkg:"libexif12", ver:"0.6.13-5etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libexif-dev", ver:"0.6.13-5etch2", rls:"DEB4.0")) != NULL) {
    report += res;
}
