#
#VID 3b260179-e464-460d-bf9f-d5cda6204020
...
CVE-2005-0398
The KAME racoon daemon in ipsec-tools before 0.5 allows remote
attackers to cause a denial of service (crash) via malformed ISAKMP
packets.";
...
http://www.vuxml.org/freebsd/3b260179-e464-460d-bf9f-d5cda6204020.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300232");
...
if(!isnull(bver) && revcomp(a:bver, b:"20050510a")<0) {
