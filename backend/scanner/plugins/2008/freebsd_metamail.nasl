#
#VID a20082c3-6255-11d8-80e3-0020ed76ef5a
...
tag_insight = "The following package is affected: metamail
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302346");
 ...
 script_name("FreeBSD Ports: metamail");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.7_2")<0) {
    txt += 'Package metamail version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
