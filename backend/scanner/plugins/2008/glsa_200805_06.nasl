...
tag_insight = "Firebird allows remote connections to the administrative account without
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200805-06
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302001");
