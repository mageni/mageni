...
tag_insight = "A vulnerability in the webmail function of Usermin could be used by an
...
tag_solution = "All Usermin users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-15
http://bugs.gentoo.org/show_bug.cgi?id=63167
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300707");
