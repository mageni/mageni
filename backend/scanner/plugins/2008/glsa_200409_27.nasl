...
tag_insight = "glFTPd is vulnerable to a local buffer overflow which may allow arbitrary
code execution.";
tag_solution = "All glFTPd users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303562");
