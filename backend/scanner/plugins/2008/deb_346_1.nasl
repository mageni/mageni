...
# $Id: deb_346_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Albert Puigsech Galicia <ripe@7a69ezine.org> reported that phpsysinfo,
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20346-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303582");
 ...
 script_name("Debian Security Advisory DSA 346-1 (phpsysinfo)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpsysinfo", ver:"2.0-3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
