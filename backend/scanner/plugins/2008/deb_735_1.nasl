...
# $Id: deb_735_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "A local user who has been granted permission to run commands via sudo
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20735-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300490");
 ...
 script_name("Debian Security Advisory DSA 735-1 (sudo)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"sudo", ver:"1.6.6-1.3woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
