...
tag_insight = "Clam AntiVirus is vulnerable to integer overflows when handling several
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303030");
 ...
 script_name("Gentoo Security Advisory GLSA 200507-25 (clamav)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"app-antivirus/clamav", unaffected: make_list("ge 0.86.2"), vulnerable: make_list("lt 0.86.2"))) != NULL) {
    report += res;
}
