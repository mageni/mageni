#
#VID e16293f0-26b7-11d9-9289-000c41e2cdad
...
CVE-2004-0754
Integer overflow in Gaim before 0.82 allows remote attackers to cause
a denial of service and possibly execute arbitrary code via the size
variable in Groupware server messages.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://gaim.sourceforge.net/security/?id=2
http://www.vuxml.org/freebsd/e16293f0-26b7-11d9-9289-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300835");
