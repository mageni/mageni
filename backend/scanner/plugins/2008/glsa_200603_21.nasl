...
tag_insight = "Sendmail is vulnerable to a race condition which could lead to the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-21
http://bugs.gentoo.org/show_bug.cgi?id=125623
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301663");
