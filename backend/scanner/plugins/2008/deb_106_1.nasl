...
# $Id: deb_106_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 106-1
#
# Authors:
...
tag_insight = "Sebastian Krahmer found several places in rsync (a popular tool to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20106-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303258");
 ...
 script_name("Debian Security Advisory DSA 106-1 (rsync)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rsync", ver:"2.3.2-1.3", rls:"DEB2.2")) != NULL) {
    report += res;
}
