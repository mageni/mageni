#
#VID 5ad3e437-e527-4514-b9ed-280b2ca1a8c9
...
http://www.vuxml.org/freebsd/5ad3e437-e527-4514-b9ed-280b2ca1a8c9.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301693");
 ...
 script_bugtraq_id(14610);
 script_cve_id("CVE-2005-2534");
