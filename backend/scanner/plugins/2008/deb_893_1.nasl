...
# $Id: deb_893_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to acidlab
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303330");
 ...
 script_name("Debian Security Advisory DSA 893-1 (acidlab)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"acidlab", ver:"0.9.6b20-2.1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"acidlab-doc", ver:"0.9.6b20-10.1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"acidlab-mysql", ver:"0.9.6b20-10.1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"acidlab-pgsql", ver:"0.9.6b20-10.1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"acidlab", ver:"0.9.6b20-10.1", rls:"DEB3.1")) != NULL) {
    report += res;
}
