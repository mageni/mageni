#
#VID 610bc692-a2ad-11dc-900c-000bcdc1757a
...
tag_insight = "The following package is affected: gnu-finger
...
http://www.gnu.org/software/finger/
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301247");
 ...
 script_cve_id("CVE-1999-1165");
 script_tag(name:"cvss_base", value:"7.2");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
 script_name("FreeBSD Ports: gnu-finger");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.37_1")<=0) {
    txt += 'Package gnu-finger version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
