#
#VID 0d4c31ac-cb91-11d8-8898-000d6111a684
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.7.0.52439");
 ...
 script_cve_id("CVE-2004-2632", "CVE-2004-2631");
 script_bugtraq_id(10629);
...
if(!isnull(bver) && revcomp(a:bver, b:"2.5.7.1")<0) {
