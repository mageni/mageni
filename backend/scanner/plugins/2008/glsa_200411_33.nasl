...
tag_insight = "A bug in the TWiki search function allows an attacker to execute arbitrary
commands with the permissions of the user running TWiki.";
tag_solution = "All TWiki users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-apps/twiki-20040902'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-33
http://bugs.gentoo.org/show_bug.cgi?id=71035
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302684");
