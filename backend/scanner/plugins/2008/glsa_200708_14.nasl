...
tag_insight = "A vulnerability has been discovered in the NVIDIA graphic drivers, allowing
for a Denial of Service.";
tag_solution = "All NVIDIA drivers users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose 'x11-drivers/nvidia-drivers'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200708-14
http://bugs.gentoo.org/show_bug.cgi?id=183567";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301082");
