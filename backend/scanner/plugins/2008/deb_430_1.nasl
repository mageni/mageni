...
# $Id: deb_430_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Steve Kemp discovered a problem in trr19, a type trainer application
...
tag_summary = "The remote host is missing an update to trr19
announced via advisory DSA 430-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20430-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302871");
 ...
 script_name("Debian Security Advisory DSA 430-1 (trr19)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"trr19", ver:"1.0beta5-15woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
