...
# $Id: deb_1633_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "It has been discovered that Slash, the Slashdot Like Automated
...
tag_summary = "The remote host is missing an update to slash
announced via advisory DSA 1633-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201633-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301478");
 ...
 script_name("Debian Security Advisory DSA 1633-1 (slash)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"slash", ver:"2.2.6-8etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
