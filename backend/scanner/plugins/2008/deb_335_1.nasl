...
# $Id: deb_335_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "mantis, a PHP/MySQL web based bug tracking system, stores the password
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20335-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303219");
 ...
 script_name("Debian Security Advisory DSA 335-1 (mantis)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mantis", ver:"0.17.1-3", rls:"DEB3.0")) != NULL) {
    report += res;
}
