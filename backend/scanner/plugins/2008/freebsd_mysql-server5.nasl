#
#VID 77420ebb-0cf4-11d9-8a8a-000c41e2cdad
...
There is a buffer overflow in libmysqlclient that
...
http://www.vuxml.org/freebsd/77420ebb-0cf4-11d9-8a8a-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301974");
 ...
 script_name("FreeBSD Ports: mysql-server, mysql-client");
