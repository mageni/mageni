...
# $Id: deb_702_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several vulnerabilities have been discovered in ImageMagick, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20702-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302614");
 ...
 script_name("Debian Security Advisory DSA 702-1 (imagemagick)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"imagemagick", ver:"5.4.4.5-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmagick++5", ver:"5.4.4.5-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmagick++5-dev", ver:"5.4.4.5-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmagick5", ver:"5.4.4.5-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libmagick5-dev", ver:"5.4.4.5-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"perlmagick", ver:"5.4.4.5-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
