...
tag_insight = "The PNG image decoding routines in the GD library contain an integer
overflow that may allow execution of arbitrary code with the rights of the
program decoding a malicious PNG image.";
tag_solution = "All GD users should upgrade to the latest version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301430");
 ...
 script_name("Gentoo Security Advisory GLSA 200411-08 (GD)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-libs/gd", unaffected: make_list("ge 2.0.32"), vulnerable: make_list("lt 2.0.32"))) != NULL) {
    report += res;
}
