...
# $Id: deb_1064_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1064-1
#
# Authors:
...
We recommend that you upgrade your cscope package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201064-1";
tag_summary = "The remote host is missing an update to cscope
announced via advisory DSA 1064-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302613");
 ...
 script_name("Debian Security Advisory DSA 1064-1 (cscope)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"cscope", ver:"15.3-1woody3", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"cscope", ver:"15.5-1.1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
