...
tag_insight = "PHP contains several vulnerabilities including a heap buffer overflow,
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-21
http://bugs.gentoo.org/show_bug.cgi?id=153911
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301642");
