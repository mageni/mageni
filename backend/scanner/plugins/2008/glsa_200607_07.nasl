...
tag_insight = "A buffer overflow has been found in the libmms library shipped with
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301146");
 ...
 script_name("Gentoo Security Advisory GLSA 200607-07 (xine-lib)");
