...
# $Id: deb_407_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several vulnerabilities were discovered upstream in ethereal, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20407-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303493");
 ...
 script_name("Debian Security Advisory DSA 407-1 (ethereal)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ethereal", ver:"0.9.4-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ethereal-common", ver:"0.9.4-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ethereal-dev", ver:"0.9.4-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tethereal", ver:"0.9.4-1woody6", rls:"DEB3.0")) != NULL) {
    report += res;
}
