...
# $Id: deb_499_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 499-1
#
# Authors:
...
tag_insight = "A vulnerability was discovered in rsync, a file transfer program,
...
announced via advisory DSA 499-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20499-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301902");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"rsync", ver:"2.5.5-0.4", rls:"DEB3.0")) != NULL) {
    report += res;
}
