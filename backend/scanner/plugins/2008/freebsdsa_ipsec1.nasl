#
#ADV FreeBSD-SA-06:11.ipsec.asc
...
tag_insight = "IPsec is a set of protocols, including ESP (Encapsulating Security Payload)
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301568");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-06:11.ipsec.asc)";
 script_name(name);
