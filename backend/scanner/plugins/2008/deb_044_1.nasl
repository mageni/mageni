...
# $Id: deb_044_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The mail program (a simple tool to read and send email) as
...
tag_summary = "The remote host is missing an update to mailx
announced via advisory DSA 044-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20044-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301826");
