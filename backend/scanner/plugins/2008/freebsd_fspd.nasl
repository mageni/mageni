#
#VID 20be2982-4aae-11d8-96f2-0020ed76ef5a
...
tag_insight = "The following package is affected: fspd
...
http://www.vuxml.org/freebsd/20be2982-4aae-11d8-96f2-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301360");
 ...
 script_name("FreeBSD Ports: fspd");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.8.1.19")<0) {
    txt += 'Package fspd version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
