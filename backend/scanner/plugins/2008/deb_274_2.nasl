...
# $Id: deb_274_2.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20274-2";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300377");
 ...
 script_name("Debian Security Advisory DSA 274-2 (mutt)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mutt", ver:"1.2.5-5.2", rls:"DEB2.2")) != NULL) {
    report += res;
}
