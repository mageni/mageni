...
# $Id: deb_670_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to emacs20
announced via advisory DSA 670-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20670-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300696");
 ...
 script_name("Debian Security Advisory DSA 670-1 (emacs20)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"emacs20-el", ver:"20.7-13.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"emacs20", ver:"20.7-13.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
