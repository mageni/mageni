#
#VID 44ee8160-c453-11dd-a721-0030843d3802
# OpenVAS Vulnerability Test
# $
# Description: Auto generated from VID 44ee8160-c453-11dd-a721-0030843d3802
#
# Authors:
...
tag_insight = "The following package is affected: mgetty+sendfax
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302771");
 ...
 script_name("FreeBSD Ports: mgetty+sendfax");
...
txt = "";
vuln = 0;
bver = portver(pkg:"mgetty+sendfax");
if(!isnull(bver) && revcomp(a:bver, b:"1.1.35_2")<0) {
    txt += 'Package mgetty+sendfax version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
