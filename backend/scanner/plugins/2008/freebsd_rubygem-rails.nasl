#
#VID 90064567-28b1-11db-844d-000c6ec775d9
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301249");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.1.0")>=0 && revcomp(a:bver, b:"1.1.3")<0) {
    txt += 'Package rubygem-rails version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"1.1.4")>=0 && revcomp(a:bver, b:"1.1.6")<0) {
    txt += 'Package rubygem-rails version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
