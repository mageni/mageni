...
# $Id: deb_1158_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1158-1
#
# Authors:
...
We recommend that you upgrade your streamripper package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201158-1";
tag_summary = "The remote host is missing an update to streamripper
announced via advisory DSA 1158-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302450");
 ...
 script_name("Debian Security Advisory DSA 1158-1 (streamripper)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"streamripper", ver:"1.61.7-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
