#
#VID a4fd8f53-05eb-11d9-b45d-000c41e2cdad
...
CVE-2004-0722
Integer overflow in the SOAPParameter object constructor in (1)
Netscape version 7.0 and 7.1 and (2) Mozilla 1.6, and possibly earlier
versions, allows remote attackers to execute arbitrary code.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugzilla.mozilla.org/show_bug.cgi?id=236618
http://www.vuxml.org/freebsd/a4fd8f53-05eb-11d9-b45d-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303637");
