...
# $Id: deb_885_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 885-1
#
# Authors:
...
We recommend that you upgrade your openvpn package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20885-1";
tag_summary = "The remote host is missing an update to openvpn
announced via advisory DSA 885-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300834");
 ...
 script_name("Debian Security Advisory DSA 885-1 (openvpn)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"openvpn", ver:"2.0-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
