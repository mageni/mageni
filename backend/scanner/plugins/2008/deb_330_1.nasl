...
# $Id: deb_330_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "tcptraceroute is a setuid-root program which drops root privileges
...
tag_summary = "The remote host is missing an update to tcptraceroute
announced via advisory DSA 330-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20330-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303256");
 ...
 script_name("Debian Security Advisory DSA 330-1 (tcptraceroute)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tcptraceroute", ver:"1.2-2", rls:"DEB3.0")) != NULL) {
    report += res;
}
