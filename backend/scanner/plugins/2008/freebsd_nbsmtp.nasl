...
tag_insight = "The following package is affected: nbsmtp";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300466");
 ...
 script_name("FreeBSD Ports: nbsmtp");
...
if(!isnull(bver) && revcomp(a:bver, b:"0.99_1")<0) {
    txt += 'Package nbsmtp version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
