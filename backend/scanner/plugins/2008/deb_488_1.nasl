...
# $Id: deb_488_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Christian Jaeger reported a bug in logcheck which could potentially be
...
tag_summary = "The remote host is missing an update to logcheck
announced via advisory DSA 488-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20488-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301735");
 ...
 script_name("Debian Security Advisory DSA 488-1 (logcheck)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"logcheck-database", ver:"1.1.1-13.1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"logcheck", ver:"1.1.1-13.1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"logtail", ver:"1.1.1-13.1woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
