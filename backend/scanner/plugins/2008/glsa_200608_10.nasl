...
tag_insight = "A flaw in the input handling could lead to the execution of arbitrary SQL
statements in the underlying PostgreSQL database.";
tag_solution = "All pike users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=dev-lang/pike-7.6.86'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200608-10
http://bugs.gentoo.org/show_bug.cgi?id=136065
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302841");
