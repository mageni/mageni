...
# $Id: deb_1371_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Several vulnerabilities have been discovered in phpWiki, a wiki engine
...
tag_summary = "The remote host is missing an update to phpwiki
announced via advisory DSA 1371-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201371-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302709");
 ...
 script_name("Debian Security Advisory DSA 1371-1 (phpwiki)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpwiki", ver:"1.3.12p3-5etch1", rls:"DEB4.0")) != NULL) {
    report += res;
}
