...
tag_insight = "AWStats fails to validate certain log input, which could lead to the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200508-07
http://bugs.gentoo.org/show_bug.cgi?id=102145
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300904");
