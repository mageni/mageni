#
#VID 6596bb80-d026-11d9-9aed-000e0c2e438a
...
tag_insight = "The following package is affected: shtool";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300897");
 ...
 script_name("FreeBSD Ports: shtool");
...
txt = "";
vuln = 0;
bver = portver(pkg:"shtool");
if(!isnull(bver) && revcomp(a:bver, b:"2.0.1")<=0) {
    txt += 'Package shtool version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
