...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303567");
 ...
 script_name("Debian Security Advisory DSA 848-1 (masqmail)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"masqmail", ver:"0.1.16-2.2", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"masqmail", ver:"0.2.20-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
