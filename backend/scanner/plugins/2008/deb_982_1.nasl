...
# $Id: deb_982_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 982-1
#
# Authors:
...
We recommend that you upgrade your gpdf package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20982-1";
tag_summary = "The remote host is missing an update to gpdf
announced via advisory DSA 982-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300221");
 ...
 script_name("Debian Security Advisory DSA 982-1 (gpdf)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gpdf", ver:"2.8.2-1.2sarge4", rls:"DEB3.1")) != NULL) {
    report += res;
}
