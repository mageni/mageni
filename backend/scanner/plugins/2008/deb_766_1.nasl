...
# $Id: deb_766_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 766-1
#
# Authors:
...
announced via advisory DSA 766-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300944");
 ...
 script_name("Debian Security Advisory DSA 766-1 (webcalendar)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"webcalendar", ver:"0.9.45-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
