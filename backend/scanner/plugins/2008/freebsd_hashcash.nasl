#
#VID 5ebfe901-a3cb-11d9-b248-000854d03344
...
tag_insight = "The following package is affected: hashcash

CVE-2005-0687
Format string vulnerability in Hashcash 1.16 allows remote attackers
...
http://www.vuxml.org/freebsd/5ebfe901-a3cb-11d9-b248-000854d03344.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302109");
 ...
 script_name("FreeBSD Ports: hashcash");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.17")<0) {
    txt += 'Package hashcash version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
