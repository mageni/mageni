...
tag_insight = "TikiWiki is vulnerable to cross-site scripting attacks.";
...
advisory GLSA 200510-23.";

                                                                                

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303904");
 ...
 script_name("Gentoo Security Advisory GLSA 200510-23 (tikiwiki)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"www-apps/tikiwiki", unaffected: make_list("ge 1.9.1.1"), vulnerable: make_list("lt 1.9.1.1"))) != NULL) {
    report += res;
}
