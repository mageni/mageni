...
tag_insight = "The following package is affected: elm";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://archives.neohapsis.com/archives/fulldisclosure/2005-08/0688.html
http://www.vuxml.org/freebsd/f66e011d-13ff-11da-af41-0004614cc33d.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301509");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.5.8")<0) {
    txt += 'Package elm version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
