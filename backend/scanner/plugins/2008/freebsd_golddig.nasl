...
tag_insight = "The following package is affected: golddig
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300710");
 ...
 script_name("FreeBSD Ports: golddig");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.0")<=0) {
    txt += 'Package golddig version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
