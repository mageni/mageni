#
#VID 1f826757-26be-11d9-ad2d-0050fc56d258
...
The installed version of rssh is vulnerable to a
format string attack that allows an attacker to
execute arbitrary code on the remote system.
Specific to FreeBSD, only the account running rssh
can be compromised (as opposed to root).";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://www.pizzashack.org/rssh/security.shtml
http://marc.theaimsgroup.com/?l=bugtraq&m=109855982425122
http://www.vuxml.org/freebsd/1f826757-26be-11d9-ad2d-0050fc56d258.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301215");
