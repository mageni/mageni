...
# $Id: deb_1272_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1272-1
#
# Authors:
...
We recommend that you upgrade your tcpdump package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201272-1";
tag_summary = "The remote host is missing an update to tcpdump
announced via advisory DSA 1272-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302837");
 ...
 script_name("Debian Security Advisory DSA 1272-1 (tcpdump)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tcpdump", ver:"3.8.3-5sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
