...
tag_insight = "Multiple vulnerabilities in phpMyAdmin may allow a remote attacker with a
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300641");
 ...
 script_name("Gentoo Security Advisory GLSA 200407-22 (dev-db/phpmyadmin)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-db/phpmyadmin", unaffected: make_list("ge 2.5.7_p1"), vulnerable: make_list("le 2.5.7"))) != NULL) {
    report += res;
}
