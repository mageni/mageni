#
#VID ae9fb0d7-c4dc-11da-b2fb-000e0c2e438a
...
tag_insight = "The following package is affected: netpbm

CVE-2005-2978
pnmtopng in netpbm before 10.25, when using the -trans option, uses
...
http://www.vuxml.org/freebsd/ae9fb0d7-c4dc-11da-b2fb-000e0c2e438a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302792");
 ...
 script_name("FreeBSD Ports: netpbm");
...
if(!isnull(bver) && revcomp(a:bver, b:"10.26")<0) {
    txt += 'Package netpbm version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
