#
#VID aed343b4-5480-11da-b579-001125afbed7
...
http://www.vuxml.org/freebsd/aed343b4-5480-11da-b579-001125afbed7.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304130");
 ...
 script_name("FreeBSD Ports: linux-flashplugin6");
...
if(!isnull(bver) && revcomp(a:bver, b:"6.0r79_3")<=0) {
    txt += 'Package linux-flashplugin6 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"linux-flashplugin7");
if(!isnull(bver) && revcomp(a:bver, b:"7.0r61")<0) {
    txt += 'Package linux-flashplugin7 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
