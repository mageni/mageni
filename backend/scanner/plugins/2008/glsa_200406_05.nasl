...
tag_insight = "A bug in mod_ssl may allow a remote attacker to execute remote code when
Apache is configured a certain way.";
tag_solution = "Apache 1.x users should upgrade to the latest version of mod_ssl:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-05
http://bugs.gentoo.org/show_bug.cgi?id=51368";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302521");
