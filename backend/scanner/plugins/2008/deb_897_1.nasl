...
# $Id: deb_897_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301414");
 ...
 script_name("Debian Security Advisory DSA 897-1 (phpsysinfo)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"phpsysinfo", ver:"2.0-3woody3", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"phpsysinfo", ver:"2.3-4sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
