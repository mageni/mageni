...
# $Id: deb_372_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Shaun Colley discovered a buffer overflow vulnerability in netris, a
...
tag_summary = "The remote host is missing an update to netris
announced via advisory DSA 372-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20372-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303290");
 ...
 script_name("Debian Security Advisory DSA 372-1 (netris)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"netris", ver:"0.5-4woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
