#
#VID 5ef12755-1c6c-11dd-851d-0016d325a0ed
...
tag_insight = "The following package is affected: swfdec
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303597");
 ...
 script_cve_id("CVE-2008-1834");
 script_tag(name:"cvss_base", value:"4.3");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
 script_name("FreeBSD Ports: swfdec");
...
txt = "";
vuln = 0;
bver = portver(pkg:"swfdec");
if(!isnull(bver) && revcomp(a:bver, b:"0.6.4")<0) {
    txt += 'Package swfdec version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
