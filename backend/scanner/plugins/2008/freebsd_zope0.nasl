#
#VID 65a8f773-4a37-11db-a4cc-000a48049292
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303563");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.7.0")>=0 && revcomp(a:bver, b:"2.7.9_1")<0) {
    txt += 'Package zope version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"2.8.0")>=0 && revcomp(a:bver, b:"2.8.8_1")<0) {
    txt += 'Package zope version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
