...
# $Id: deb_314_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Rick Patel discovered that atftpd is vulnerable to a buffer overflow
...
tag_summary = "The remote host is missing an update to atftp
announced via advisory DSA 314-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20314-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300058");
