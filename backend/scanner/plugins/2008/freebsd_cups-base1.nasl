#
#VID 30cea6be-1d0c-11d9-814e-0001020eed82
...
CVE-2004-0923
CUPS 1.1.20 and earlier records authentication information for a
device URI in the error_log file, which allows local users to obtain
...
http://www.vuxml.org/freebsd/30cea6be-1d0c-11d9-814e-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301268");
