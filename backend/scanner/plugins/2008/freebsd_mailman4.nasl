#
#VID b3cd00f7-c0c5-452d-87bc-086c5635333e
...
CVE-2004-1143
The password generation in mailman before 2.1.5 generates only 5
million unique passwords, which makes it easier for remote attackers
to guess passwords via a brute force attack.";
...
http://www.vuxml.org/freebsd/b3cd00f7-c0c5-452d-87bc-086c5635333e.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302493");
