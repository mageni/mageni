#
#VID 70ae62b0-16b0-11dc-b803-0016179b2dd5
...
tag_insight = "The following package is affected: c-ares
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304252");
 ...
 script_name("FreeBSD Ports: c-ares");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.4.0")<0) {
    txt += 'Package c-ares version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
