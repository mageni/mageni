#
#VID d8fbf13a-6215-11db-a59e-0211d85f11fb
...
http://www.vuxml.org/freebsd/d8fbf13a-6215-11db-a59e-0211d85f11fb.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300584");
 ...
 script_name("FreeBSD Ports: kdelibs, kdelibs-nocups");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.3.6_3")<0) {
    txt += 'Package qt-copy version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
