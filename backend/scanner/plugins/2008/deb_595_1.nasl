...
# $Id: deb_595_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Leon Juranic discovered that BNC, an IRC session bouncing proxy, does
...
tag_summary = "The remote host is missing an update to bnc
announced via advisory DSA 595-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20595-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301668");
 ...
 script_name("Debian Security Advisory DSA 595-1 (bnc)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bnc", ver:"2.6.4-3.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
