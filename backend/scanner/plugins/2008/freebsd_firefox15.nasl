...
in other domains by using an IFRAME and causing the browser to
navigate to a previous javascript: URL, which can lead to arbitrary
code execution when combined with CVE-2005-1477.
...
http://www.vuxml.org/freebsd/eca6195a-c233-11d9-804c-02061b08fc24.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301984");
