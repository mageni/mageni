...
tag_insight = "MySQL contains several vulnerabilities potentially leading to the
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301402");
 ...
 script_name("Gentoo Security Advisory GLSA 200503-19 (mysql)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"dev-db/mysql", unaffected: make_list("ge 4.0.24"), vulnerable: make_list("lt 4.0.24"))) != NULL) {
    report += res;
}
