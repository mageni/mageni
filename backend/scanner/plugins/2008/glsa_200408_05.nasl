...
tag_insight = "Several new vulnerabilities were found and fixed in Opera, including one
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200408-05
http://bugs.gentoo.org/show_bug.cgi?id=59503
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300031");
