...
# $Id: deb_378_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Nicolas Boullis discovered two vulnerabilities in mah-jong, a
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20378-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301320");
 ...
 script_name("Debian Security Advisory DSA 378-1 (mah-jong)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mah-jong", ver:"1.4-2", rls:"DEB3.0")) != NULL) {
    report += res;
}
