#
#VID 9a035a56-eff0-11d9-8310-0001020eed82
...
tag_insight = "The following package is affected: pl-ekg";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugs.gentoo.org/show_bug.cgi?id=94172
http://marc.theaimsgroup.com/?l=bugtraq&m=112060146011122
http://www.vuxml.org/freebsd/9a035a56-eff0-11d9-8310-0001020eed82.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304078");
 ...
 script_cve_id("CVE-2005-1916");
 script_bugtraq_id(14146);
 script_tag(name:"cvss_base", value:"2.1");
 script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:P/A:N");
 script_name("FreeBSD Ports: pl-ekg");
