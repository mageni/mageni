...
# $Id: deb_886_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304322");
 ...
 script_name("Debian Security Advisory DSA 886-1 (chmlib)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"chmlib", ver:"0.35-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chmlib-bin", ver:"0.35-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chmlib-dev", ver:"0.35-6sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
