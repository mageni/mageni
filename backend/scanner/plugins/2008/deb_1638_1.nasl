...
# $Id: deb_1638_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "It has been discovered that the signal handler implementing the login
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201638-1";


if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303910");
 ...
 script_name("Debian Security Advisory DSA 1638-1 (openssh)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ssh-krb5", ver:"4.3p2-9etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ssh", ver:"4.3p2-9etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openssh-client", ver:"4.3p2-9etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ssh-askpass-gnome", ver:"4.3p2-9etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"openssh-server", ver:"4.3p2-9etch3", rls:"DEB4.0")) != NULL) {
    report += res;
}
