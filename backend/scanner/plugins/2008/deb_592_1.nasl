...
# $Id: deb_592_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_summary = "The remote host is missing an update to ez-ipupdate
announced via advisory DSA 592-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20592-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300912");
 ...
 script_name("Debian Security Advisory DSA 592-1 (ez-ipupdate)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ez-ipupdate", ver:"3.0.11b5-1woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
