...
tag_insight = "A bug in the aspell utility word-list-compress can allow an attacker to
execute arbitrary code.";
tag_solution = "All users should upgrade to the latest available version of aspell.
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-14
http://bugs.gentoo.org/show_bug.cgi?id=53389
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300513");
