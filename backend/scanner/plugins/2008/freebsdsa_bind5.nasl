...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:06.bind.asc";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303018");
 ...
 name = "FreeBSD Security Advisory (FreeBSD-SA-08:06.bind.asc)";
 script_name(name);
