...
tag_insight = "The Java sandbox environment in Konqueror can be bypassed to access
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-16
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300523");
