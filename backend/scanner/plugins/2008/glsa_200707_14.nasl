...
tag_insight = "A vulnerability has been discovered in tcpdump, allowing for the execution
of arbitrary code, possibly with root privileges.";
tag_solution = "All tcpdump users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=net-analyzer/tcpdump-3.9.5-r3'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200707-14
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301576");
