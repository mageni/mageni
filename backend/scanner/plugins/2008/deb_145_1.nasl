...
# $Id: deb_145_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "The authors of tinyproxy, a lightweight HTTP proxy, discovered a bug
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20145-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302102");
 ...
 script_name("Debian Security Advisory DSA 145-1 (tinyproxy)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tinyproxy", ver:"1.4.3-2woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
