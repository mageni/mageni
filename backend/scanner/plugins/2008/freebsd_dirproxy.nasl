#
#VID a1ef3fc0-8ad0-11dc-9490-0016179b2dd5
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301987");
 ...
 script_cve_id("CVE-2007-5226");
 script_tag(name:"cvss_base", value:"5.0");
 script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
 script_name("FreeBSD Ports: dirproxy");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.0.5_1")<0) {
    txt += 'Package dirproxy version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
bver = portver(pkg:"dirproxy-devel");
if(!isnull(bver) && revcomp(a:bver, b:"1.2.0.b2_1")<0) {
    txt += 'Package dirproxy-devel version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
