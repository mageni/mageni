...
# $Id: ubuntu_699_1.nasl 7969 2017-12-01 09:23:16Z santu $
# Description: Auto-generated from advisory USN-699-1 (blender)
#
# Authors:
...
tag_insight = "It was discovered that Blender did not correctly handle certain malformed
...
announced via advisory USN-699-1.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301667");
 ...
 script_name("Ubuntu USN-699-1 (blender)");



 script_category(ACT_GATHER_INFO);
 script_xref(name: "URL" , value: "http://www.ubuntu.com/usn/usn-699-1/");
