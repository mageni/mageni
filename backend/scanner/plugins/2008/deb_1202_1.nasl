...
# $Id: deb_1202_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1202-1
#
# Authors:
...
We recommend that you upgrade your screen package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201202-1";
tag_summary = "The remote host is missing an update to screen
announced via advisory DSA 1202-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304141");
 ...
 script_name("Debian Security Advisory DSA 1202-1 (screen)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"screen", ver:"4.0.2-4.1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
