...
# $Id: deb_304_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Leonard Stiles discovered that lv, a multilingual file viewer, would
...
tag_summary = "The remote host is missing an update to lv
announced via advisory DSA 304-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20304-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301553");
 ...
 script_name("Debian Security Advisory DSA 304-1 (lv)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"lv", ver:"4.49.3-4potato2", rls:"DEB2.2")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lv", ver:"4.49.4-7woody2", rls:"DEB3.0")) != NULL) {
    report += res;
}
