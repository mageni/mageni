...
# $Id: deb_997_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303965");
 ...
 script_name("Debian Security Advisory DSA 997-1 (bomberclone)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"bomberclone-data", ver:"0.11.5-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"bomberclone", ver:"0.11.5-1sarge1", rls:"DEB3.1")) != NULL) {
    report += res;
}
