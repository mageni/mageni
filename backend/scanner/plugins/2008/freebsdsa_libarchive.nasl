#
#ADV FreeBSD-SA-07:05.libarchive.asc
...
tag_insight = "The libarchive library provides a flexible interface for reading and
...
https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:05.libarchive.asc";
tag_summary = "The remote host is missing an update to the system
as announced in the referenced advisory FreeBSD-SA-07:05.libarchive.asc";

                                                                                
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304179");
 script_version("$Revision: 8023 $");
 script_tag(name:"last_modification", value:"$Date: 2017-12-07 09:36:26 +0100 (Thu, 07 Dec 2017) $");
 script_tag(name:"creation_date", value:"2008-09-04 20:41:11 +0200 (Thu, 04 Sep 2008)");
 script_cve_id("CVE-2007-3641");
...
vuln = 0;
if(patchlevelcmp(rel:"6.2", patchlevel:"6")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"6.1", patchlevel:"18")<0) {
    vuln = 1;
}
if(patchlevelcmp(rel:"5.5", patchlevel:"14")<0) {
    vuln = 1;
}
