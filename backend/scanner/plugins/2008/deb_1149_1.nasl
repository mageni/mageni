...
# $Id: deb_1149_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1149-1
#
# Authors:
...
We recommend that you upgrade your ncompress package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%201149-1";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.300728");
 ...
 script_name("Debian Security Advisory DSA 1149-1 (ncompress)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ncompress", ver:"4.2.4-15sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
