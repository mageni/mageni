#
#VID e936d612-253f-11da-bc01-000e0c2e438a
...
remote attackers to cause a denial of service (child process crash)
via a CRL that causes a buffer overflow of one null byte.";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303880");
