...
# $Id: deb_532_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20532-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304238");
 ...
 script_name("Debian Security Advisory DSA 532-1 (libapache-mod-ssl)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libapache-mod-ssl-doc", ver:"2.8.9-2.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libapache-mod-ssl", ver:"2.8.9-2.3", rls:"DEB3.0")) != NULL) {
    report += res;
}
