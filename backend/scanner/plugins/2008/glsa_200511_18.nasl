...
tag_insight = "phpSysInfo is vulnerable to multiple issues, including a local file
inclusion leading to information disclosure and the potential execution of
arbitrary code.";
tag_solution = "All phpSysInfo users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-apps/phpsysinfo-2.4.1'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200511-18
http://bugs.gentoo.org/show_bug.cgi?id=112482
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301565");
