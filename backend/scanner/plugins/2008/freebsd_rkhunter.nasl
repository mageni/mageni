...
tag_insight = "The following package is affected: rkhunter
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301265");
 ...
 script_name("FreeBSD Ports: rkhunter");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.2.5")<0) {
    txt += 'Package rkhunter version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
