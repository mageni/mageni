#
#VID b58ff497-6977-11d9-ae49-000c41e2cdad
...
CVE-2004-0804
Vulnerability in in tif_dirread.c for libtiff allows remote attackers
to cause a denial of service (application crash) via a TIFF image that
causes a divide-by-zero error when the number of row bytes is zero.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugzilla.remotesensing.org/show_bug.cgi?id=111
http://www.vuxml.org/freebsd/b58ff497-6977-11d9-ae49-000c41e2cdad.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301437");
 ...
 script_name("FreeBSD Ports: tiff, linux-tiff");
...
if(!isnull(bver) && revcomp(a:bver, b:"3.6.0")<0) {
