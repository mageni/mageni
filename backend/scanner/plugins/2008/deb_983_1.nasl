...
# $Id: deb_983_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 983-1
#
# Authors:
...
We recommend that you upgrade your gpdf package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20983-1";
tag_summary = "The remote host is missing an update to pdftohtml
announced via advisory DSA 983-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301519");
 ...
 script_name("Debian Security Advisory DSA 983-1 (pdftohtml)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"pdftohtml", ver:"0.36-11sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
