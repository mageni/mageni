...
tag_insight = "AlsaPlayer is vulnerable to multiple buffer overflows which could lead to
the execution of arbitrary code.";
tag_solution = "AlsaPlayer has been masked in Portage pending the resolution of these
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301774");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"media-sound/alsaplayer", unaffected: make_list(), vulnerable: make_list("le 0.99.76-r3"))) != NULL) {
    report += res;
}
