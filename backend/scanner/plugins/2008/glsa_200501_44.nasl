...
tag_insight = "The ncpfs utilities contain multiple flaws, potentially resulting in the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-44
http://bugs.gentoo.org/show_bug.cgi?id=77414
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303443");
