...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302454");
 ...
 script_name("FreeBSD Ports: openoffice.org-2, openoffice.org-2-RC, openoffice.org-2-devel");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.4")>=0 && revcomp(a:bver, b:"2.4.2")<0) {
    txt += 'Package openoffice.org-2 version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
...
if(!isnull(bver) && revcomp(a:bver, b:"2.4")>=0 && revcomp(a:bver, b:"2.4.2")<0) {
    txt += 'Package openoffice.org-2-RC version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"2.4.20040402")>=0) {
    txt += 'Package openoffice.org-2-RC version ' + bver + ' is installed which is known to be vulnerable.\n';
...
if(!isnull(bver) && revcomp(a:bver, b:"2.4")>=0 && revcomp(a:bver, b:"2.4.2")<0) {
    txt += 'Package openoffice.org-2-devel version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
if(!isnull(bver) && revcomp(a:bver, b:"2.4.20040402")>=0) {
    txt += 'Package openoffice.org-2-devel version ' + bver + ' is installed which is known to be vulnerable.\n';
