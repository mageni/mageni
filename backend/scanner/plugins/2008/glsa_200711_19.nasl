...
tag_insight = "Multiple vulnerabilities have been discovered in TikiWiki, possibly
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301343");
 ...
 script_name("Gentoo Security Advisory GLSA 200711-19 (tikiwiki)");
...
res = "";
report = "";
if ((res = ispkgvuln(pkg:"www-apps/tikiwiki", unaffected: make_list("ge 1.9.8.3"), vulnerable: make_list("lt 1.9.8.3"))) != NULL) {
    report += res;
}
