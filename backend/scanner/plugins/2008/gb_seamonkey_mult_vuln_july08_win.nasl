...
# $Id: gb_seamonkey_mult_vuln_july08_win.nasl 12670 2018-12-05 14:14:20Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The host is installed with Mozilla Seamonkey, that is prone to
