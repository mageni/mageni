#
#VID 863f95d3-3df1-11dc-b3d3-0016179b2dd5
...
http://www.vuxml.org/freebsd/863f95d3-3df1-11dc-b3d3-0016179b2dd5.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304114");
 ...
 script_name("FreeBSD Ports: mutt, mutt-lite, ja-mutt, zh-mutt");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.4.2.3")<0) {
    txt += 'Package zh-mutt version ' + bver + ' is installed which is known to be vulnerable.\n';
    vuln = 1;
}
