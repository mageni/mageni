...
# $Id: deb_695_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 695-1
#
# Authors:
...
tag_insight = "Several vulnerabilities have been discovered in xli, an image viewer
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20695-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302627");
 ...
 script_name("Debian Security Advisory DSA 695-1 (xli)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xli", ver:"1.17.0-11woody1", rls:"DEB3.0")) != NULL) {
    report += res;
}
