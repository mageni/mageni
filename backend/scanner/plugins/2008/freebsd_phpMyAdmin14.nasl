#
#VID 51b51d4a-7c0f-11dc-9e47-0011d861d5e2
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303601");
 ...
 script_cve_id("CVE-2007-5386");
 script_bugtraq_id(26020);
...
if(!isnull(bver) && revcomp(a:bver, b:"2.11.1.1")<0) {
