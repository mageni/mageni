...
tag_solution = "Note that this GLSA addresses the same issue as GLSA 200707-03, but for the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200711-04
http://bugs.gentoo.org/show_bug.cgi?id=190861
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301050");
