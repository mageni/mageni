...
tag_insight = "racoon provided as part of IPsec-Tools fails do proper authentication.";
tag_solution = "All IPsec-Tools users should upgrade to the latest stable version:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303250");
