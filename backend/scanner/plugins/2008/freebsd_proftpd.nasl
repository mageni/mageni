#
#VID cb6c6c29-9c4f-11d8-9366-0020ed76ef5a
...
entries as if they were AllowAll, which could allow FTP clients to
bypass intended access restrictions.";
tag_solution = "Update your system with the appropriate patches or
software upgrades.

http://bugs.proftpd.org/show_bug.cgi?id=2267
http://www.vuxml.org/freebsd/cb6c6c29-9c4f-11d8-9366-0020ed76ef5a.html";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304243");
...
if(!isnull(bver) && revcomp(a:bver, b:"1.2.9")>=0 && revcomp(a:bver, b:"1.2.10.r1")<0) {
