...
# $Id: deb_971_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304345");
 ...
 script_name("Debian Security Advisory DSA 971-1 (xpdf)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"xpdf-common", ver:"3.00-13.5", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xpdf", ver:"3.00-13.5", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xpdf-reader", ver:"3.00-13.5", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"xpdf-utils", ver:"3.00-13.5", rls:"DEB3.1")) != NULL) {
    report += res;
}
