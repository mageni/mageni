...
tag_insight = "A bug in KDM can allow privilege escalation with certain configurations of
PAM modules.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200311-01
http://bugs.gentoo.org/show_bug.cgi?id=29406
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.304317");
