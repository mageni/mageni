...
# $Id: deb_763_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
tag_insight = "Markus Oberhumer discovered a flaw in the way zlib, a library used for
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20763-1";

if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.302097");
 ...
 script_name("Debian Security Advisory DSA 763-1 (zlib)");
...
if ((res = isdpkgvuln(pkg:"lib64z1", ver:"1.2.2-4.sarge.2", rls:"DEB3.1")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"lib64z1-dev", ver:"1.2.2-4.sarge.2", rls:"DEB3.1")) != NULL) {
    report += res;
}
