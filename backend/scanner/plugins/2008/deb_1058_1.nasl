...
# $Id: deb_1058_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
# Description: Auto-generated from advisory DSA 1058-1
#
# Authors:
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303726");
 ...
 script_name("Debian Security Advisory DSA 1058-1 (awstats)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"awstats", ver:"6.4-1sarge2", rls:"DEB3.1")) != NULL) {
    report += res;
}
