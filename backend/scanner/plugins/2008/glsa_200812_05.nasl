...
tag_insight = "A buffer overflow vulnerability in libsamplerate might lead to the
execution of arbitrary code.";
tag_solution = "All libsamplerate users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=media-libs/libsamplerate-0.1.4'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-05
http://bugs.gentoo.org/show_bug.cgi?id=237037";
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.303032");
