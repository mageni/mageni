...
# $Id: deb_927_1.nasl 6616 2017-07-07 12:10:49Z cfischer $
...
We recommend that you upgrade your tkdiff package.
 ...
 https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20927-1";
tag_summary = "The remote host is missing an update to tkdiff
announced via advisory DSA 927-1.
...
if(description)
{
 script_oid("1.3.6.1.4.1.25623.1.0.301127");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"tkdiff", ver:"3.08-3woody0", rls:"DEB3.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"tkdiff", ver:"4.0.2-1sarge0", rls:"DEB3.1")) != NULL) {
    report += res;
}
