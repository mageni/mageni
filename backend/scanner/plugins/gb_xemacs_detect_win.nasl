...
# $Id: gb_xemacs_detect_win.nasl 11015 2018-08-17 06:31:19Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detects the installed version of XEmacs and sets
  the result in KB.");
  exit(0);
}
