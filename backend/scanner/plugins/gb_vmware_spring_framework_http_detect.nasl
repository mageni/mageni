...
if (description)
{
  ...
  script_version("2022-03-31T11:54:40+0000");
  ...
  script_name("VMware Spring Framework Detection (HTTP)");
  ...
  script_tag(name:"summary", value:"HTTP based detection of the VMware Spring Framework.");
...
if( found ) {
  ...
  log_message( data:build_detection_report( app:"VMware Spring Framework",
                                            version:version,
                                            install:install,
                                            cpe:cpe,
                                            concluded:concluded,
