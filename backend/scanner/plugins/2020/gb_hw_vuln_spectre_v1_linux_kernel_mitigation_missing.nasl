...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108843");
  script_version("2020-08-13T08:33:13+0000");
  script_cve_id("CVE-2017-5753", "CVE-2019-1125");
  ...
  script_name("Missing Linux Kernel mitigations for 'Spectre variant 1' hardware vulnerabilities");
  ...
  side for the referenced 'Spectre variant 1' hardware vulnerabilities.");
