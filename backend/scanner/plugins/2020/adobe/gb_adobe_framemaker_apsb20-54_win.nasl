...
if (description)
{
  ...
  script_tag(name:"affected", value:"Adobe Framemaker 2019.0.6 and earlier versions on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Framemaker 2019.0.7 or later. Please
