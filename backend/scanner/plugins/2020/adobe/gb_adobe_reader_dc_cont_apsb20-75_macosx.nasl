...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817863");
  ...
  script_tag(name:"creation_date", value:"2020-12-10 11:51:52 +0530 (Thu, 10 Dec 2020)");
  script_name("Adobe Reader DC Continuous Security Update(apsb20-75) - Mac OS X");

  script_tag(name:"summary", value:"This host is installed with Adobe Reader DC
  Continuous and is prone to an information disclosure vulnerability.");
  ...
  versions before 2020.013.20074on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC (Continuous)
  to version 2020.013.20074or later. Please see the references for more information.");
