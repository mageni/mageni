...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816814");
  ...
  script_name("Adobe Acrobat DC 2015 Security Updates(apsb20-13)-MAC OS X");
  ...
  to version 2015.006.30518 on MAC OS X.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC 2015 (Classic) to
  version 2015.006.30518 or later. Please see the references for more information.");
...
if(version_in_range(version:readerVer, test_version:"15.0", test_version2:"15.006.30517"))
{
  report = report_fixed_ver(installed_version:readerVer, fixed_version:"15.006.30518(2015.006.30518)", install_path:InstallPath);
