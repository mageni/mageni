...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817155");
  ...
  script_name("Adobe Flash Player Microsoft Edge and Internet Explorer Security Update (apsb20-30) - Windows");
  ...
  script_tag(name:"solution", value:"Upgrade to Adobe Flash Player 32.0.0.387 or later.
...
if(version_is_less(version:vers, test_version:"32.0.0.387")) {
  report = report_fixed_ver(file_checked:path, file_version:vers, vulnerable_range:"Less than 32.0.0.387");
