...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817801");
  ...
  script_tag(name:"creation_date", value:"2020-10-14 18:00:18 +0530 (Wed, 14 Oct 2020)");
  script_name("Adobe Flash Player Security Updates(apsb20-58)-Mac OS X");
