...
if(description)
{
  ...
  and Adobe Photoshop 2020 21.2 and earlier versions on Windows.");

  script_tag(name:"solution", value:"Upgrade to Adobe Photoshop CC 2019 20.0.10
  or Photoshop CC 2020 21.2.1 or later. Please see the references for more information.");
