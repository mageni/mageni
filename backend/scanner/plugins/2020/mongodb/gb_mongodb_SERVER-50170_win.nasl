...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.144952");
  script_version("2020-12-02T07:09:35+0000");
  script_tag(name:"last_modification", value:"2020-12-02 11:21:40 +0000 (Wed, 02 Dec 2020)");
  script_tag(name:"creation_date", value:"2020-12-02 06:04:20 +0000 (Wed, 02 Dec 2020)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");

  script_cve_id("CVE-2020-7926");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MongoDB 4.4.0 DoS Vulnerability - Windows");
  ...
  issuing a specially crafted query which violates an invariant in the server selection subsystem.");

  script_tag(name:"affected", value:"MongoDB version 4.4.0.");

  script_tag(name:"solution", value:"Update to version 4.4.1 or later.");

  script_xref(name:"URL", value:"https://jira.mongodb.org/browse/SERVER-50170");
