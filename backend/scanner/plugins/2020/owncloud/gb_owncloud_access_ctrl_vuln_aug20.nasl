...
if(description)
{
  ...
  script_tag(name:"impact", value:"It was possible to access the preview-image of a password-protected
  ...
  script_xref(name:"URL", value:"https://owncloud.com/security/public-link-password-bypass-via-image-previews/");
