...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816603");
  script_version("2020-01-17T10:38:45+0000");
  script_cve_id("CVE-2020-2604", "CVE-2020-2601", "CVE-2020-2593", "CVE-2020-2654",
                "CVE-2020-2590", "CVE-2020-2583");
  ...
  script_name("Oracle Java SE Security Updates(jan2020) 01 - Linux");
  ...
  and earlier, 8u231 (1.8.0.231) and earlier, 11.0.5 and earlier, 13.0.1 on Linux");
...
if(version_in_range(version:jreVer, test_version:"1.8.0", test_version2:"1.8.0.231") ||
   ...
   version_in_range(version:jreVer, test_version:"11.0", test_version2:"11.0.5") ||
   version_in_range(version:jreVer, test_version:"13.0", test_version2:"13.0.1"))
{
