...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108965");
  ...
  script_cve_id("CVE-2020-14799");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL < 8.0.21 Security Update (cpuoct2020) - Windows");
  ...
  script_tag(name:"summary", value:"Oracle MySQL is prone to a Denial of Service vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Oracle MySQL 8.0.20 and prior.");
...
if (version_is_less(version: version, test_version: "8.0.21")) {
