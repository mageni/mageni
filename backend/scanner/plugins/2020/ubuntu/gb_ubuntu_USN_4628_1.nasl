...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for intel-microcode (USN-4628-1)");
  ...
  script_xref(name:"USN", value:"4628-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-November/005753.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'intel-microcode'
  package(s) announced via the USN-4628-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20201110.0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20201110.0ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20201110.0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20201110.0ubuntu0.20.10.1", rls:"UBUNTU20.10"))) {
    report += res;
  }
