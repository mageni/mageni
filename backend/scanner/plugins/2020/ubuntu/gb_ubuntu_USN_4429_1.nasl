...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for evolution-data-server (USN-4429-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-July/005520.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'evolution-data-server'
  package(s) announced via the USN-4429-1 advisory.");
...
to perform a response injection attack.");
  ...
  script_tag(name:"affected", value:"'evolution-data-server' package(s) on Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
