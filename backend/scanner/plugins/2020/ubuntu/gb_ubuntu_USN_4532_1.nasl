...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for netty-3.9 (USN-4532-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-September/005642.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netty-3.9'
  package(s) announced via the USN-4532-1 advisory.");
...
smuggling attack. (CVE-2019-20445)");
  ...
  script_tag(name:"affected", value:"'netty-3.9' package(s) on Ubuntu 18.04 LTS.");
