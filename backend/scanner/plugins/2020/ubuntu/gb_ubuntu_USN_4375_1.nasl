...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for php7.4 (USN-4375-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-May/005451.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.4'
  package(s) announced via the USN-4375-1 advisory.");
...
An attacker could possibly use this issue to cause a denial of service.");
  ...
  script_tag(name:"affected", value:"'php7.4' package(s) on Ubuntu 20.04 LTS, Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
