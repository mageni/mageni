...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for squid3 (USN-4446-1)");
  ...
  script_xref(name:"USN", value:"4446-1");
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-August/005540.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid3'
  package(s) announced via the USN-4446-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"3.5.27-1ubuntu1.7", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"3.5.12-1ubuntu7.12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
