...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for systemd (USN-4269-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2020-February/005316.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the USN-4269-1 advisory.");
...
escalate privileges. (CVE-2020-1712)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on Ubuntu 19.10, Ubuntu 18.04 LTS, Ubuntu 16.04 LTS.");
