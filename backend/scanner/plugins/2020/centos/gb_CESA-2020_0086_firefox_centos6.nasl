...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883161");
  ...
  script_tag(name:"creation_date", value:"2020-01-15 04:00:46 +0000 (Wed, 15 Jan 2020)");
  script_name("CentOS Update for firefox CESA-2020:0086 centos6");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-January/035597.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox'
  package(s) announced via the CESA-2020:0086 advisory.");
...
if(release == "CentOS6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~68.4.1~1.el6.centos", rls:"CentOS6"))) {
    report += res;
  }
