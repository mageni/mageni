...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883232");
  ...
  script_tag(name:"creation_date", value:"2020-05-01 03:01:42 +0000 (Fri, 01 May 2020)");
  script_name("CentOS: Security Advisory for python-twisted-web (CESA-2020:1561)");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-April/035709.html");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-twisted-web", rpm:"python-twisted-web~12.1.0~7.el7_8", rls:"CentOS7"))) {
    report += res;
  }
