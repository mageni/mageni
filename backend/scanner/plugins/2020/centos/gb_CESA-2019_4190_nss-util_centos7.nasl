...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883152");
  script_version("2020-01-13T11:49:13+0000");
  script_cve_id("CVE-2019-11729", "CVE-2019-11745");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-13 11:49:13 +0000 (Mon, 13 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-08 11:14:58 +0000 (Wed, 08 Jan 2020)");
  script_name("CentOS Update for nss-util CESA-2019:4190 centos7 ");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2019-December/035587.html");
...
page(s) listed in the References section.");
  ...
  script_tag(name:"affected", value:"'nss-util' package(s) on CentOS 7.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.44.0~4.el7_7", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-util-devel", rpm:"nss-util-devel~3.44.0~4.el7_7", rls:"CentOS7"))) {
    report += res;
  }
