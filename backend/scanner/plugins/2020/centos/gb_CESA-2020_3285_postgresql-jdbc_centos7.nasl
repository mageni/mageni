...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.883273");
  ...
  script_tag(name:"creation_date", value:"2020-08-08 03:01:07 +0000 (Sat, 08 Aug 2020)");
  script_name("CentOS: Security Advisory for postgresql-jdbc (CESA-2020:3285)");
  ...
  script_xref(name:"CESA", value:"2020:3285");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2020-August/035788.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-jdbc'
  package(s) announced via the CESA-2020:3285 advisory.");
...
page(s) listed in the References section.");
  ...
  script_tag(name:"affected", value:"'postgresql-jdbc' package(s) on CentOS 7.");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"postgresql-jdbc", rpm:"postgresql-jdbc~9.2.1002~8.el7_8", rls:"CentOS7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql-jdbc-javadoc", rpm:"postgresql-jdbc-javadoc~9.2.1002~8.el7_8", rls:"CentOS7"))) {
    report += res;
  }
