...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108845");
  ...
  script_name("Missing Linux Kernel mitigations for 'SRBDS - Special Register Buffer Data Sampling' hardware vulnerabilities");
  ...
  script_xref(name:"URL", value:"https://www.kernel.org/doc/html/latest/admin-guide/hw-vuln/special-register-buffer-data-sampling.html");

  script_tag(name:"summary", value:"The remote host is missing one or more known mitigation(s) on Linux Kernel
  side for the referenced 'SRBDS - Special Register Buffer Data Sampling' hardware vulnerabilities.");
