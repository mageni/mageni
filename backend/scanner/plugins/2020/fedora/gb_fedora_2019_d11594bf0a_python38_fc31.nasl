...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877256");
  ...
  script_name("Fedora Update for python38 FEDORA-2019-d11594bf0a");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EFXQS57HDHLVGEOE5VTVM6Q7SQCG7NCB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python38'
  package(s) announced via the FEDORA-2019-d11594bf0a advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python38", rpm:"python38~3.8.0~b4~1.fc31", rls:"FC31"))) {
    report += res;
  }
