...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878658");
  ...
  script_tag(name:"creation_date", value:"2020-11-27 04:12:01 +0000 (Fri, 27 Nov 2020)");
  script_name("Fedora: Security Advisory for slurm (FEDORA-2020-98a5098030)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Q7PLOQLZ5WLGXZXWZJODBYAXJXRMBQHM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'slurm'
  package(s) announced via the FEDORA-2020-98a5098030 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"slurm", rpm:"slurm~19.05.8~1.fc32", rls:"FC32"))) {
    report += res;
  }
