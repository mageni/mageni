...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877451");
  ...
  script_name("Fedora: Security Advisory for libasr (FEDORA-2020-270ef80e9e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VUQH5UQC6GGZIZ2LXICV2TL5EZ33FCJP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libasr'
  package(s) announced via the FEDORA-2020-270ef80e9e advisory.");
...
OpenSMTPD daemon, but it can be used in any other contexts.");
  ...
  script_tag(name:"affected", value:"'libasr' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libasr", rpm:"libasr~1.0.4~1.fc30", rls:"FC30"))) {
    report += res;
  }
