...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877609");
  ...
  script_tag(name:"creation_date", value:"2020-03-25 04:17:13 +0000 (Wed, 25 Mar 2020)");
  script_name("Fedora: Security Advisory for timeshift (FEDORA-2020-1050d60507)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AAOFXT64CEUMJE3723JDJWTEQWQUCYMD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'timeshift'
  package(s) announced via the FEDORA-2020-1050d60507 advisory.");
...
Ubuntu-type subvolume layout (with @ and @home subvolumes).");
  ...
  script_tag(name:"affected", value:"'timeshift' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"timeshift", rpm:"timeshift~20.03~1.fc30", rls:"FC30"))) {
    report += res;
  }
