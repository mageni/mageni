...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878104");
  ...
  script_tag(name:"creation_date", value:"2020-07-17 05:34:47 +0000 (Fri, 17 Jul 2020)");
  script_name("Fedora: Security Advisory for python39 (FEDORA-2020-705c6ea5be)");
  ...
  script_xref(name:"FEDORA", value:"2020-705c6ea5be");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FCCZTAYZATTNSNEAXWA7U3HCO2OVQKT5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python39'
  package(s) announced via the FEDORA-2020-705c6ea5be advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python39-3.9.0", rpm:"python39-3.9.0~b4~1.fc32", rls:"FC32"))) {
    report += res;
  }
