...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877750");
  ...
  script_tag(name:"creation_date", value:"2020-04-30 03:15:26 +0000 (Thu, 30 Apr 2020)");
  script_name("Fedora: Security Advisory for ansible (FEDORA-2020-f80154b5b4)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MRRYUU5ZBLPBXCYG6CFP35D64NP2UB2S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible'
  package(s) announced via the FEDORA-2020-f80154b5b4 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ansible", rpm:"ansible~2.9.7~1.fc31", rls:"FC31"))) {
    report += res;
  }
