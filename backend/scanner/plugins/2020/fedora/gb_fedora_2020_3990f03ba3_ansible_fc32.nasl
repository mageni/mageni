...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877763");
  ...
  script_tag(name:"creation_date", value:"2020-04-30 03:15:44 +0000 (Thu, 30 Apr 2020)");
  script_name("Fedora: Security Advisory for ansible (FEDORA-2020-3990f03ba3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DKPA4KC3OJSUFASUYMG66HKJE7ADNGFW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible'
  package(s) announced via the FEDORA-2020-3990f03ba3 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ansible", rpm:"ansible~2.9.7~1.fc32", rls:"FC32"))) {
    report += res;
  }
