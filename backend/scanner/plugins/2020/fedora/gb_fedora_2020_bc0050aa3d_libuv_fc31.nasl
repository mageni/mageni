...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878431");
  ...
  script_name("Fedora: Security Advisory for libuv (FEDORA-2020-bc0050aa3d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XJSTU3OUIBRMCKYFIO7OIPNIENANG3RM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libuv'
  package(s) announced via the FEDORA-2020-bc0050aa3d advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libuv", rpm:"libuv~1.40.0~1.fc31", rls:"FC31"))) {
    report += res;
  }
