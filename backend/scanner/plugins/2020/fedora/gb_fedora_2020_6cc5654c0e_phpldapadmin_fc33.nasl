...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878753");
  ...
  script_tag(name:"creation_date", value:"2020-12-21 04:11:01 +0000 (Mon, 21 Dec 2020)");
  script_name("Fedora: Security Advisory for phpldapadmin (FEDORA-2020-6cc5654c0e)");
  ...
  script_xref(name:"FEDORA", value:"2020-6cc5654c0e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6XA42XDSUPCOXL5ZCP5RGD3FD4JQQWNX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpldapadmin'
  package(s) announced via the FEDORA-2020-6cc5654c0e advisory.");
...
access by remote web-clients.");
  ...
  script_tag(name:"affected", value:"'phpldapadmin' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phpldapadmin", rpm:"phpldapadmin~1.2.6.2~1.fc33", rls:"FC33"))) {
    report += res;
  }
