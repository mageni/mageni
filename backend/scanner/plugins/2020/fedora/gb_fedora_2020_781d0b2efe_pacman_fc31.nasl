...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877679");
  ...
  script_tag(name:"creation_date", value:"2020-04-12 03:15:46 +0000 (Sun, 12 Apr 2020)");
  script_name("Fedora: Security Advisory for pacman (FEDORA-2020-781d0b2efe)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2TTUXXUW5OCOASIRMJK4RHEPLEA33Y6C");
...
packages.");
  ...
  script_tag(name:"affected", value:"'pacman' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pacman", rpm:"pacman~5.2.1~2.fc31", rls:"FC31"))) {
    report += res;
  }
