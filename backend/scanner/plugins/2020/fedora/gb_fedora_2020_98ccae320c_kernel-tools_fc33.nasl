...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878622");
  ...
  script_tag(name:"creation_date", value:"2020-11-16 04:21:13 +0000 (Mon, 16 Nov 2020)");
  script_name("Fedora: Security Advisory for kernel-tools (FEDORA-2020-98ccae320c)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IND2IAI2SEXPMVCE62PNGQQBZ25WQ6TN");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.9.7~200.fc33", rls:"FC33"))) {
    report += res;
  }
