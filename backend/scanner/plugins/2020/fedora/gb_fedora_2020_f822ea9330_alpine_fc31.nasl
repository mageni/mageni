...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817078");
  ...
  script_tag(name:"creation_date", value:"2020-07-03 03:20:20 +0000 (Fri, 03 Jul 2020)");
  script_name("Fedora: Security Advisory for alpine (FEDORA-2020-f822ea9330)");
  ...
  script_xref(name:"FEDORA", value:"2020-f822ea9330");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YFXQGKZZMP3VSTLZVO5Z7Z6USYIW37A6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'alpine'
  package(s) announced via the FEDORA-2020-f822ea9330 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Alpine -- an Alternatively Licensed Program for Internet
...
GNU Build System&#39, s autotools.");

  script_tag(name:"affected", value:"'alpine' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"alpine", rpm:"alpine~2.23~2.fc31", rls:"FC31"))) {
    report += res;
  }
