...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877916");
  ...
  script_name("Fedora: Security Advisory for perl-Email-MIME-ContentType (FEDORA-2020-39d40d9ae9)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NEOBVYVR4UC6X4KNWFAVXUAIVQCNC24D");
...
respectively.");
  ...
  script_tag(name:"affected", value:"'perl-Email-MIME-ContentType' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Email-MIME-ContentType", rpm:"perl-Email-MIME-ContentType~1.024~1.fc31", rls:"FC31"))) {
    report += res;
  }
