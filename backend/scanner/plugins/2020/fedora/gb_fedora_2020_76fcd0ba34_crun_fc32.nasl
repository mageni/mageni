...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878394");
  ...
  script_name("Fedora: Security Advisory for crun (FEDORA-2020-76fcd0ba34)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4MGKVD3AXWJ7BXIXFQJXUBXLTHDPR3CE");
  ...
  script_tag(name:"affected", value:"'crun' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"crun", rpm:"crun~0.15~5.fc32", rls:"FC32"))) {
    report += res;
  }
