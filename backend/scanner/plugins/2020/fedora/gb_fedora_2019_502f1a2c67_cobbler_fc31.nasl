...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877299");
  script_version("2020-01-13T11:49:13+0000");
  script_cve_id("CVE-2018-10931");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-13 11:49:13 +0000 (Mon, 13 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-09 07:36:42 +0000 (Thu, 09 Jan 2020)");
  script_name("Fedora Update for cobbler FEDORA-2019-502f1a2c67");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5NBFYRFY77OMU5I3KSQFGHT3DVTTJME5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cobbler'
  package(s) announced via the FEDORA-2019-502f1a2c67 advisory.");
...
other applications.");
  ...
  script_tag(name:"affected", value:"'cobbler' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cobbler", rpm:"cobbler~3.0.1~1.fc31", rls:"FC31"))) {
    report += res;
  }
