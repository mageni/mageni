...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878438");
  ...
  script_tag(name:"creation_date", value:"2020-10-07 03:09:27 +0000 (Wed, 07 Oct 2020)");
  script_name("Fedora: Security Advisory for pandoc-citeproc (FEDORA-2020-fe299b3fa3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/G7ZDYHCSAM3ETZIJBOBFHWKLWAPZPJEP");
...
pandoc-citeproc originated as a fork of Andrea Rossato&#39, s citeproc-hs.");
  ...
  script_tag(name:"affected", value:"'pandoc-citeproc' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pandoc-citeproc", rpm:"pandoc-citeproc~0.15.0.1~2.fc31", rls:"FC31"))) {
    report += res;
  }
