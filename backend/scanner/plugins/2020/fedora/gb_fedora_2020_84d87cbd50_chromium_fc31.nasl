...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878155");
  ...
  script_tag(name:"creation_date", value:"2020-08-02 03:07:33 +0000 (Sun, 02 Aug 2020)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2020-84d87cbd50)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MYIDWCHG24ZTFD4P42D4A4WWPPA74BCG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2020-84d87cbd50 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~84.0.4147.89~1.fc31", rls:"FC31"))) {
    report += res;
  }
