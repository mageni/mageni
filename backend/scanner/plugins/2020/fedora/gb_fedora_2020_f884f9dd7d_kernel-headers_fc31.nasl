...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877477");
  ...
  script_name("Fedora: Security Advisory for kernel-headers (FEDORA-2020-f884f9dd7d)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/K3V4MBU66MQIJEBPG7URBPPSBI5IILIS");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-headers", rpm:"kernel-headers~5.4.18~200.fc31", rls:"FC31"))) {
    report += res;
  }
