...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877519");
  ...
  script_name("Fedora: Security Advisory for etcd (FEDORA-2020-279c61dd70)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3E5X67WNICF5HDDJJYLOJ2XIOFLWFERA");
  ...
  script_tag(name:"affected", value:"'etcd' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"etcd", rpm:"etcd~3.3.12~5.20190413gitf29b1ad.fc30", rls:"FC30"))) {
    report += res;
  }
