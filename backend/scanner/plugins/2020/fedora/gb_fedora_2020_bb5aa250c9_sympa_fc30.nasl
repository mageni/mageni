...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877569");
  ...
  script_name("Fedora: Security Advisory for sympa (FEDORA-2020-bb5aa250c9)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6TMVZ5LVYCCIHGEC7RQUMGUE7DJWUXN7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sympa'
  package(s) announced via the FEDORA-2020-bb5aa250c9 advisory.");
...
and encryption.");
  ...
  script_tag(name:"affected", value:"'sympa' package(s) on Fedora 30.");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sympa", rpm:"sympa~6.2.54~1.fc30", rls:"FC30"))) {
    report += res;
  }
