...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878321");
  ...
  script_tag(name:"creation_date", value:"2020-09-21 03:13:13 +0000 (Mon, 21 Sep 2020)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2020-3813e1317b)");
  ...
  script_xref(name:"FEDORA", value:"2020-3813e1317b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OKR6IQRJTC4AAI2BQQAASV6ZHTRSDRSQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2020-3813e1317b advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.4~1.fc31", rls:"FC31"))) {
    report += res;
  }
