...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878507");
  ...
  script_tag(name:"creation_date", value:"2020-10-24 03:10:36 +0000 (Sat, 24 Oct 2020)");
  script_name("Fedora: Security Advisory for kde-partitionmanager (FEDORA-2020-73471e6414)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HVLKYIMDG53VYLWRTWJ2SI3B2VWTQJXW");
...
manipulate filesystems.");
  ...
  script_tag(name:"affected", value:"'kde-partitionmanager' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kde-partitionmanager", rpm:"kde-partitionmanager~4.2.0~1.fc33", rls:"FC33"))) {
    report += res;
  }
