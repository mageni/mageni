...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877457");
  ...
  script_tag(name:"creation_date", value:"2020-02-09 04:03:18 +0000 (Sun, 09 Feb 2020)");
  script_name("Fedora: Security Advisory for opensmtpd (FEDORA-2020-270ef80e9e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6IF6PULYIJOCKONNI4HXSJKICTHQNJB4");
...
if(release == "FC30") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opensmtpd", rpm:"opensmtpd~6.6.2p1~1.fc30", rls:"FC30"))) {
    report += res;
  }
