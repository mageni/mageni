...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878091");
  ...
  script_name("Fedora: Security Advisory for libslirp (FEDORA-2020-8c0b966c16)");
  ...
  script_xref(name:"FEDORA", value:"2020-8c0b966c16");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JYTZ32P67PZER6P7TW6FQK3SZRKQLVEI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libslirp'
  package(s) announced via the FEDORA-2020-8c0b966c16 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libslirp", rpm:"libslirp~4.3.1~1.fc32", rls:"FC32"))) {
    report += res;
  }
