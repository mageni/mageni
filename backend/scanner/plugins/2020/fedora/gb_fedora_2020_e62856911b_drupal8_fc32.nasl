...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877656");
  ...
  script_name("Fedora: Security Advisory for drupal8 (FEDORA-2020-e62856911b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ISNCFKDNLXNZPIB4GFGHBRMTIK3N3Z2K");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'drupal8'
  package(s) announced via the FEDORA-2020-e62856911b advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"drupal8", rpm:"drupal8~8.8.4~1.fc32", rls:"FC32"))) {
    report += res;
  }
