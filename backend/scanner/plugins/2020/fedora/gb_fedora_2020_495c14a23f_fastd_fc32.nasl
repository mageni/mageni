...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878552");
  ...
  script_tag(name:"creation_date", value:"2020-11-03 04:23:58 +0000 (Tue, 03 Nov 2020)");
  script_name("Fedora: Security Advisory for fastd (FEDORA-2020-495c14a23f)");
  ...
  script_xref(name:"FEDORA", value:"2020-495c14a23f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GUZ3AGTAXH7OOP45F5WXBVRQ3IDWUR7M");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fastd'
  package(s) announced via the FEDORA-2020-495c14a23f advisory.");
  ...
  script_tag(name:"affected", value:"'fastd' package(s) on Fedora 32.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fastd", rpm:"fastd~21~1.fc32", rls:"FC32"))) {
    report += res;
  }
