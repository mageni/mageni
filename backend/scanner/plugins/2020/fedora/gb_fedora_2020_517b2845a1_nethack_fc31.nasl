...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877441");
  ...
  script_name("Fedora: Security Advisory for nethack (FEDORA-2020-517b2845a1)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IDJHUQ4IWD4WBRUNL4JTM6YZ5XKADXVX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nethack'
  package(s) announced via the FEDORA-2020-517b2845a1 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nethack", rpm:"nethack~3.6.5~1.fc31", rls:"FC31"))) {
    report += res;
  }
