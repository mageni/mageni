...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878522");
  ...
  script_tag(name:"creation_date", value:"2020-10-26 04:10:52 +0000 (Mon, 26 Oct 2020)");
  script_name("Fedora: Security Advisory for java-11-openjdk (FEDORA-2020-845860fd4f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Z7XEONOP6JB7SD7AMUWZTLZF2L4QD546");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openjdk'
  package(s) announced via the FEDORA-2020-845860fd4f advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openjdk", rpm:"java-11-openjdk~11.0.9.11~0.fc33", rls:"FC33"))) {
    report += res;
  }
