...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878439");
  ...
  script_name("Fedora: Security Advisory for ghc-hakyll (FEDORA-2020-fe299b3fa3)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P6HCDBKZSJKSUOP7OEHJE5QDQ5I4DOG4");
...
as markdown or RST.");
  ...
  script_tag(name:"affected", value:"'ghc-hakyll' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghc-hakyll", rpm:"ghc-hakyll~4.12.5.2~2.fc31", rls:"FC31"))) {
    report += res;
  }
