...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877443");
  ...
  script_name("Fedora: Security Advisory for runc (FEDORA-2020-46ecc60897)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GGFCQYULYHRBI72RFEQLK3YXYA4RCR62");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc'
  package(s) announced via the FEDORA-2020-46ecc60897 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.0.0~102.dev.gitdc9208a.fc31", rls:"FC31"))) {
    report += res;
  }
