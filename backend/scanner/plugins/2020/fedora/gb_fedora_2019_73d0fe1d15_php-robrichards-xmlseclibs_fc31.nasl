...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877112");
  ...
  script_name("Fedora Update for php-robrichards-xmlseclibs FEDORA-2019-73d0fe1d15");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7KID7C4AZPYYIZQIPSLANP4R2RQR6YK3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-robrichards-xmlseclibs'
  package(s) announced via the FEDORA-2019-73d0fe1d15 advisory.");
...
Autoloader: /usr/share/php/RobRichards/XMLSecLibs/autoload.php");
  ...
  script_tag(name:"affected", value:"'php-robrichards-xmlseclibs' package(s) on Fedora 31.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-robrichards-xmlseclibs", rpm:"php-robrichards-xmlseclibs~2.1.1~1.fc31", rls:"FC31"))) {
    report += res;
  }
