...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878604");
  ...
  script_name("Fedora: Security Advisory for cifs-utils (FEDORA-2020-ea0b9caac3)");
  ...
  script_xref(name:"FEDORA", value:"2020-ea0b9caac3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DUMRICFXJVCBBOSKZSKT3HFVQM6VPJU3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cifs-utils'
  package(s) announced via the FEDORA-2020-ea0b9caac3 advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cifs-utils", rpm:"cifs-utils~6.11~1.fc33", rls:"FC33"))) {
    report += res;
  }
