...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878691");
  ...
  script_name("Fedora: Security Advisory for pdfresurrect (FEDORA-2020-e9f9bb77a0)");
  ...
  script_xref(name:"FEDORA", value:"2020-e9f9bb77a0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JMEEEPBBGER5LPABBRVZLMCC6Z24RBXW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pdfresurrect'
  package(s) announced via the FEDORA-2020-e9f9bb77a0 advisory.");
...
from previous versions that might not be intended for anyone else to read.");
  ...
  script_tag(name:"affected", value:"'pdfresurrect' package(s) on Fedora 33.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pdfresurrect", rpm:"pdfresurrect~0.21~1.fc33", rls:"FC33"))) {
    report += res;
  }
