...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878642");
  ...
  script_name("Fedora: Security Advisory for pngcheck (FEDORA-2020-23432b7b72)");
  ...
  script_xref(name:"FEDORA", value:"2020-23432b7b72");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/STGE7VHLLURUUC5R2RRNJOAPKW7KRH7E");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pngcheck'
  package(s) announced via the FEDORA-2020-23432b7b72 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pngcheck", rpm:"pngcheck~2.3.0~4.fc32", rls:"FC32"))) {
    report += res;
  }
