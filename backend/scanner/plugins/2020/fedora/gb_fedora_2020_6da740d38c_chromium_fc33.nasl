...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878340");
  ...
  script_tag(name:"creation_date", value:"2020-09-26 03:12:55 +0000 (Sat, 26 Sep 2020)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2020-6da740d38c)");
  ...
  script_xref(name:"FEDORA", value:"2020-6da740d38c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EE7XWIZBME7JAY7N6CGPET4CLNHHEIVT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2020-6da740d38c advisory.");
...
if(release == "FC33") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~85.0.4183.83~1.fc33", rls:"FC33"))) {
    report += res;
  }
