...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877760");
  ...
  script_name("Fedora: Security Advisory for cacti-spine (FEDORA-2020-788dd52289)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZIHZW7SKKLXYTN7EDY6CUGZQCFR4F26E");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cacti-spine", rpm:"cacti-spine~1.2.11~1.fc32", rls:"FC32"))) {
    report += res;
  }
