...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.878651");
  ...
  script_tag(name:"creation_date", value:"2020-11-26 04:16:43 +0000 (Thu, 26 Nov 2020)");
  script_name("Fedora: Security Advisory for chromium (FEDORA-2020-3e005ce2e0)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/S4XYJ7B6OXHZNYSA5J3DBUOFEC6WCAGW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the FEDORA-2020-3e005ce2e0 advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~87.0.4280.66~1.fc32", rls:"FC32"))) {
    report += res;
  }
