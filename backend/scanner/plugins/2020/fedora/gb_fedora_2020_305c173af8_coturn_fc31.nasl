...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877660");
  ...
  script_tag(name:"creation_date", value:"2020-04-03 03:17:53 +0000 (Fri, 03 Apr 2020)");
  script_name("Fedora: Security Advisory for coturn (FEDORA-2020-305c173af8)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XN2NK6FT7AMW5UIZNXDNHKEAYWAUMGSF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'coturn'
  package(s) announced via the FEDORA-2020-305c173af8 advisory.");
...
if(release == "FC31") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"coturn", rpm:"coturn~4.5.1.1~3.fc31", rls:"FC31"))) {
    report += res;
  }
