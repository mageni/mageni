...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.877820");
  ...
  script_name("Fedora: Security Advisory for wordpress (FEDORA-2020-a0d6d5ccac)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5CKVHPQZFMXBX7LP34TO73Y36T6FM55K");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2020-a0d6d5ccac advisory.");
...
if(release == "FC32") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~5.4.1~1.fc32", rls:"FC32"))) {
    report += res;
  }
