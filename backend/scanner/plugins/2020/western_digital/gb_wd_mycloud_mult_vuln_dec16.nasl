...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108921");
  ...
  script_name("Western Digital My Cloud Multiple Products < 2.11.157 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Western Digital My Cloud with firmware versions prior to 2.11.157.");

  script_tag(name:"solution", value:"Update to firmware version 2.11.157 or later.
...
if (version_is_less(version: version, test_version: "2.11.157")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.11.157");
