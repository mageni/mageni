...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817521");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-11)-Windows");
  ...
  prior to 86.0.4240.183 on Windows");
...
if(version_is_less(version:chr_ver, test_version:"86.0.4240.183"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"86.0.4240.183", install_path:chr_path);
