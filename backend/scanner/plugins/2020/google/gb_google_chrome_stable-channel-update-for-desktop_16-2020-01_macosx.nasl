...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815750");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_16-2020-01)-MAC OS X");
  ...
  prior to 79.0.3945.130 on MAC OS X");
