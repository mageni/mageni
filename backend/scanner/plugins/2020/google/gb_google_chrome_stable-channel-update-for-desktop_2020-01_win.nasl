...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815889");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_2020-01)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 79.0.3945.117 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version
  79.0.3945.117 or later. Please see the references for more information.");
...
if(version_is_less(version:chr_ver, test_version:"79.0.3945.117"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"79.0.3945.117", install_path:chr_path);
