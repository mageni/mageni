...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817286");
  ...
  script_tag(name:"creation_date", value:"2020-09-02 11:51:30 +0530 (Wed, 02 Sep 2020)");
  script_name("Google Chrome WebGL Code Execution Vulnerability(Aug-2020)-MacOSX");
  ...
  script_tag(name:"affected", value:"Google Chrome version 81.0.4044.138, 84.0.4136.5 and 84.0.4143.7 on MacOSX");
