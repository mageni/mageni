...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817299");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_21-2020-09)-MAC OS X");
  ...
  prior to 85.0.4183.121 on MAC OS X");
