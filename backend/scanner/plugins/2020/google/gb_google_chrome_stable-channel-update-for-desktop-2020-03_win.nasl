...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815785");
  ...
  script_tag(name:"creation_date", value:"2020-03-04 14:58:04 +0530 (Wed, 04 Mar 2020)");
  script_name("Google Chrome Security Updates (stable-channel-update-for-desktop-2020-03)-Windows");
