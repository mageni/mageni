...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817025");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_19-2020-05)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 83.0.4103.61 on Windows");
