...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817421");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2020-08)-Linux");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 84.0.4147.125 on Linux");
