...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817426");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop_27-2020-07)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 84.0.4147.105 on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version 84.0.4147.105 or later.
...
if(version_is_less(version:chr_ver, test_version:"84.0.4147.105"))
{
  report = report_fixed_ver(installed_version:chr_ver, fixed_version:"84.0.4147.105", install_path:chr_path);
