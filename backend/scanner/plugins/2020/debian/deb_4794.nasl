...
if(description)
{
  ...
  script_version("2020-11-22T04:00:16+0000");
  ...
  script_name("Debian: Security Advisory for mupdf (DSA-4794-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4794.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4794-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mupdf'
  package(s) announced via the DSA-4794-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libmupdf-dev", ver:"1.14.0+ds1-4+deb10u2", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"mupdf", ver:"1.14.0+ds1-4+deb10u2", rls:"DEB10"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"mupdf-tools", ver:"1.14.0+ds1-4+deb10u2", rls:"DEB10"))) {
  report += res;
}
