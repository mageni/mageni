...
if(description)
{
  ...
  script_version("2020-04-22T03:00:07+0000");
  ...
  script_name("Debian: Security Advisory for awl (DSA-4660-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4660.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4660-1");
  ...
  script_tag(name:"insight", value:"Andrew Bartlett discovered that awl, DAViCal Andrew's Web Libraries,
