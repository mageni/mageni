...
if(description)
{
  ...
  script_version("2020-11-23T04:00:11+0000");
  ...
  script_name("Debian: Security Advisory for thunderbird (DSA-4796-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4796.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4796-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the DSA-4796-1 advisory.");
