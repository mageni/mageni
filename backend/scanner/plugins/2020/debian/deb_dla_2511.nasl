...
if(description)
{
  ...
  script_version("2020-12-31T04:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for highlight.js (DLA-2511-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/12/msg00041.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2511-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'highlight.js'
  package(s) announced via the DLA-2511-1 advisory.");
...
properties.");
  ...
  script_tag(name:"affected", value:"'highlight.js' package(s) on Debian Linux.");
