...
if(description)
{
  ...
  script_version("2020-01-13T04:00:11+0000");
  script_cve_id("CVE-2019-17571");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-13 04:00:11 +0000 (Mon, 13 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-13 04:00:11 +0000 (Mon, 13 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2065-1] apache-log4j1.2 security update)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/01/msg00008.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2065-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/947124");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-log4j1.2'
  package(s) announced via the DSA-2065-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Included in Log4j 1.2, a logging library for Java, is a SocketServer
