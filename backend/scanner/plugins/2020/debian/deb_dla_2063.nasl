...
if(description)
{
  ...
  script_version("2020-01-16T04:00:06+0000");
  script_cve_id("CVE-2019-3467");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-16 04:00:06 +0000 (Thu, 16 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-16 04:00:06 +0000 (Thu, 16 Jan 2020)");
  script_name("Debian LTS Advisory ([SECURITY] [DLA 2063-1] debian-lan-config security update)");
  ...
  package(s) announced via the DSA-2063-1 advisory.");
