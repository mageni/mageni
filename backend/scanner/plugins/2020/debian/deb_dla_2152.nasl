...
if(description)
{
  ...
  script_version("2020-03-22T04:00:05+0000");
  ...
  script_name("Debian LTS: Security Advisory for graphicsmagick (DLA-2152-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/03/msg00026.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2152-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphicsmagick'
  package(s) announced via the DLA-2152-1 advisory.");
