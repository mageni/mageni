...
if(description)
{
  ...
  script_version("2020-08-04T03:00:14+0000");
  ...
  script_name("Debian LTS: Security Advisory for zabbix (DLA-2311-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00007.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2311-1");
  ...
  package(s) announced via the DLA-2311-1 advisory.");
