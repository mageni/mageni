...
if(description)
{
  ...
  script_version("2020-08-29T03:00:15+0000");
  ...
  script_name("Debian LTS: Security Advisory for libvncserver (DLA-2347-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00045.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2347-1");
  ...
  script_tag(name:"insight", value:"Several minor vulnerabilities have been discovered in libvncserver, a
