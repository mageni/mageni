...
if (description)
{
  ...
  script_version("2020-01-07T12:22:46+0000");
  script_tag(name:"last_modification", value:"2020-01-07 12:22:46 +0000 (Tue, 07 Jan 2020)");
  ...
  script_name("Pure-FTPd <= 1.0.49 DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"Pure-FTPd is prone to a stack exhaustion issue in the listdir function in ls.c.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Pure-FTPd version 1.0.49 and probably prior.");

  script_tag(name:"solution", value:"No known solution is available as of 07th January, 2020.
