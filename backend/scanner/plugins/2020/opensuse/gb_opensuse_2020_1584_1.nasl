...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853472");
  ...
  script_tag(name:"creation_date", value:"2020-10-02 03:00:58 +0000 (Fri, 02 Oct 2020)");
  script_name("openSUSE: Security Advisory for go1.14 (openSUSE-SU-2020:1584-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1584-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-10/msg00000.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.14'
  package(s) announced via the openSUSE-SU-2020:1584-1 advisory.");
...
if(release == "openSUSELeap15.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.14", rpm:"go1.14~1.14.9~lp151.16.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.14-doc", rpm:"go1.14-doc~1.14.9~lp151.16.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.14-race", rpm:"go1.14-race~1.14.9~lp151.16.1", rls:"openSUSELeap15.1"))) {
    report += res;
  }
