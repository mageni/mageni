...
if(description)
{
  ...
  script_name("openSUSE Update for bird openSUSE-SU-2019:2178-1 (bird)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00063.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bird'
  package(s) announced via the openSUSE-SU-2019:2178_1 advisory.");
