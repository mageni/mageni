...
if(description)
{
  ...
  script_name("openSUSE Update for procps openSUSE-SU-2019:2376-1 (procps)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00058.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'procps'
  package(s) announced via the openSUSE-SU-2019:2376_1 advisory.");
