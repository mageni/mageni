...
if(description)
{
  ...
  script_name("openSUSE Update for apache2-mod_auth_openidc openSUSE-SU-2019:2499-1 (apache2-mod_auth_openidc)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00030.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2-mod_auth_openidc'
  package(s) announced via the openSUSE-SU-2019:2499_1 advisory.");
