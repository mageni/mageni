...
if(description)
{
  ...
  script_name("openSUSE Update for go1.12 openSUSE-SU-2019:2000-1 (go1.12)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00076.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.12'
  package(s) announced via the openSUSE-SU-2019:2000_1 advisory.");
