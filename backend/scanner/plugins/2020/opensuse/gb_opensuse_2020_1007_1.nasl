...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853290");
  ...
  script_tag(name:"creation_date", value:"2020-07-20 03:00:49 +0000 (Mon, 20 Jul 2020)");
  script_name("openSUSE: Security Advisory for ntp (openSUSE-SU-2020:1007-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1007-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-07/msg00044.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp'
  package(s) announced via the openSUSE-SU-2020:1007-1 advisory.");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.8p15~lp152.3.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-debuginfo", rpm:"ntp-debuginfo~4.2.8p15~lp152.3.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-debugsource", rpm:"ntp-debugsource~4.2.8p15~lp152.3.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.8p15~lp152.3.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
