...
if(description)
{
  ...
  script_name("openSUSE Update for gdal openSUSE-SU-2019:2466-1 (gdal)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-11/msg00022.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdal'
  package(s) announced via the openSUSE-SU-2019:2466_1 advisory.");
