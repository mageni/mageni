...
if(description)
{
  ...
  script_name("openSUSE Update for qemu openSUSE-SU-2019:2041-1 (qemu)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-09/msg00000.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu'
  package(s) announced via the openSUSE-SU-2019:2041_1 advisory.");
