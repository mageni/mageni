...
if(description)
{
  ...
  script_name("openSUSE Update for mariadb, openSUSE-SU-2019:1913-1 (mariadb, )");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-08/msg00035.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb, '
  package(s) announced via the openSUSE-SU-2019:1913_1 advisory.");
