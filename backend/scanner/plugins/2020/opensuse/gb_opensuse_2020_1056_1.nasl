...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853309");
  ...
  script_tag(name:"creation_date", value:"2020-07-25 03:00:42 +0000 (Sat, 25 Jul 2020)");
  script_name("openSUSE: Security Advisory for LibVNCServer (openSUSE-SU-2020:1056-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1056-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-07/msg00066.html");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"LibVNCServer-debugsource", rpm:"LibVNCServer-debugsource~0.9.10~lp152.9.4.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"LibVNCServer-devel", rpm:"LibVNCServer-devel~0.9.10~lp152.9.4.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncclient0", rpm:"libvncclient0~0.9.10~lp152.9.4.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncclient0-debuginfo", rpm:"libvncclient0-debuginfo~0.9.10~lp152.9.4.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncserver0", rpm:"libvncserver0~0.9.10~lp152.9.4.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncserver0-debuginfo", rpm:"libvncserver0-debuginfo~0.9.10~lp152.9.4.2", rls:"openSUSELeap15.2"))) {
    report += res;
  }
