...
if(description)
{
  ...
  script_name("openSUSE Update for MozillaThunderbird openSUSE-SU-2019:2249-1 (MozillaThunderbird)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-10/msg00009.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaThunderbird'
  package(s) announced via the openSUSE-SU-2019:2249_1 advisory.");
