...
if(description)
{
  ...
  script_name("openSUSE Update for cloud-init openSUSE-SU-2019:2633-1 (cloud-init)");
  ...
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2019-12/msg00018.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cloud-init'
  package(s) announced via the openSUSE-SU-2019:2633_1 advisory.");
