...
if (description)
{
  ...
  script_name("OCS Inventory NG <= 2.7 RCE Vulnerability");
  ...
  script_tag(name:"summary", value:"OCS Inventory NG is prone to an authenticated remote code execution vulnerability.");
  ...
  script_tag(name:"affected", value:"OCS Inventory NG version 2.7 and probably prior.");

  script_tag(name:"solution", value:"No known solution is available as of 03rd July, 2020.
...
if (version_is_less_equal(version: vers, test_version: "2.7")) {
  report = report_fixed_ver(installed_version: vers, fixed_version: "None", install_path: location);
