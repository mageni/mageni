...
if(description)
{
  ...
  script_version("2020-01-23T10:41:14+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 10:41:14 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-el", rpm:"tomcat-el~2.2~api~7.0.69~10", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat-jsp", rpm:"tomcat-jsp~2.2~api~7.0.69~10", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-servlet", rpm:"tomcat-servlet~3.0~api~7.0.69~10", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
