...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1587");
  script_version("2020-05-26T05:45:57+0000");
  ...
  script_tag(name:"creation_date", value:"2020-05-26 05:45:57 +0000 (Tue, 26 May 2020)");
  script_name("Huawei EulerOS: Security Advisory for php (EulerOS-SA-2020-1587)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1587");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'php' package(s) announced via the EulerOS-SA-2020-1587 advisory.");
