...
if(description)
{
  ...
  script_version("2020-01-23T12:32:24+0000");
  script_cve_id("CVE-2018-11784", "CVE-2019-0221");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 12:32:24 +0000 (Thu, 23 Jan 2020)");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-el", rpm:"tomcat-el~2.2~api~7.0.76~8.h4", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat-jsp", rpm:"tomcat-jsp~2.2~api~7.0.76~8.h4", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-servlet", rpm:"tomcat-servlet~3.0~api~7.0.76~8.h4", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
