...
if(description)
{
  ...
  script_version("2020-11-05T08:49:49+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2472");
  ...
  'python-ipaddress' package(s) announced via the EulerOS-SA-2020-2472 advisory.");
