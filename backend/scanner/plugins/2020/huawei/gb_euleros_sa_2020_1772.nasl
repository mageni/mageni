...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1772");
  script_version("2020-07-03T06:23:00+0000");
  ...
  script_tag(name:"creation_date", value:"2020-07-03 06:23:00 +0000 (Fri, 03 Jul 2020)");
  script_name("Huawei EulerOS: Security Advisory for libvorbis (EulerOS-SA-2020-1772)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1772");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1772");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libvorbis' package(s) announced via the EulerOS-SA-2020-1772 advisory.");
...
An out-of-bounds read flaw was found in the way libvorbis handled processing of Ogg Vorbis format files. This flaw could potentially be used to crash an application using libvorbis by tricking the application into processing specially crafted files.(CVE-2017-14633)");
  ...
  script_tag(name:"affected", value:"'libvorbis' package(s) on Huawei EulerOS Virtualization 3.0.6.0.");
...
if(release == "EULEROSVIRT-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvorbis", rpm:"libvorbis~1.3.3~8.h5.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.0"))) {
    report += res;
  }
