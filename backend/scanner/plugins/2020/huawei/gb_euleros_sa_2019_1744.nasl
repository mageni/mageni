...
if(description)
{
  ...
  script_version("2020-01-23T12:21:29+0000");
  script_cve_id("CVE-2019-3880");
  script_tag(name:"cvss_base", value:"5.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 12:21:29 +0000 (Thu, 23 Jan 2020)");
  ...
  'samba' package(s) announced via the EulerOS-SA-2019-1744 advisory.");
