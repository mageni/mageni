...
if(description)
{
  ...
  script_version("2020-01-23T10:53:03+0000");
  script_cve_id("CVE-2017-3142", "CVE-2017-3143");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 10:53:03 +0000 (Thu, 23 Jan 2020)");
  ...
  'bind' package(s) announced via the EulerOS-SA-2017-1140 advisory.");
