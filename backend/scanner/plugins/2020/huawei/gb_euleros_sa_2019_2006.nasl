...
if(description)
{
  ...
  script_version("2020-01-23T12:30:37+0000");
  script_cve_id("CVE-2014-5270", "CVE-2017-7526");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-01-23 12:30:37 +0000 (Thu, 23 Jan 2020)");
  ...
  'libgcrypt' package(s) announced via the EulerOS-SA-2019-2006 advisory.");
