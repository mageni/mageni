...
if(description)
{
  ...
  script_version("2020-10-30T10:44:37+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2249");
  ...
  'java-1.8.0-openjdk' package(s) announced via the EulerOS-SA-2020-2249 advisory.");
...
Vulnerability in the Java SE, Java SE Embedded product of Oracle Java SE (component: JAXP). Supported versions that are affected are Java SE: 7u261, 8u251, 11.0.7 and 14.0.1, Java SE Embedded: 8u251. Easily exploitable vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise Java SE, Java SE Embedded. Successful attacks of this vulnerability can result in unauthorized update, insert or delete access to some of Java SE, Java SE Embedded acc ...
