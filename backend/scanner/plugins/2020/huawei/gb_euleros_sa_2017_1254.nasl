...
if(description)
{
  ...
  script_version("2020-01-23T11:01:29+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:01:29 +0000 (Thu, 23 Jan 2020)");
  ...
  'java-1.8.0-openjdk' package(s) announced via the EulerOS-SA-2017-1254 advisory.");
...
if(release == "EULEROS-2.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~1.8.0.151~1.b12", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~devel~1.8.0.151~1.b12", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java", rpm:"java~1.8.0~openjdk~headless~1.8.0.151~1.b12", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
