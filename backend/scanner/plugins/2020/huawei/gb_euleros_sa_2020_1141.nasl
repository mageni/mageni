...
if(description)
{
  ...
  script_version("2020-02-25T13:56:45+0000");
  script_cve_id("CVE-2019-6467", "CVE-2019-6477");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-02-25 13:56:45 +0000 (Tue, 25 Feb 2020)");
  ...
  'bind' package(s) announced via the EulerOS-SA-2020-1141 advisory.");
