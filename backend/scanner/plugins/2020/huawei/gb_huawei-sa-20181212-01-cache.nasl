...
if(description)
{
  ...
  script_tag(name:"summary", value:"Some Huawei devices are prone to a cache timing side channel attack.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The OpenSSL RSA Key generation algorithm has been shown to be vulnerable 
  to a cache timing side channel attack.");

  script_tag(name:"impact", value:"An attacker could exploit this vulnerability to recover the private key.");

  script_tag(name:"affected", value:"Huawei TE30, TE40, TE50 and TE60.");
