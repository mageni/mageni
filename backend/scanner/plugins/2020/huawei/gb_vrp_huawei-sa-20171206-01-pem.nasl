...
if(description)
{
  ...
  script_name("Huawei VRP Data Communication: PEM Module Multiple Vulnerabilities (huawei-sa-20171206-01-pem)");
  ...
  script_tag(name:"summary", value:"Multiple Huawei products are prone to multiple vulnerabilities in the PEM
  module.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple Huawei products are prone to multiple vulnerabilities in the PEM
  module:

  - Null pointer reference vulnerability (CVE-2017-17135)

  - Heap overflow vulnerabilityy (CVE-2017-17136)

  - Out-of-Bounds memory access vulnerability (CVE-2017-17137)

  - DoS vulnerability (CVE-2017-17138)");

  script_tag(name:"impact", value:"The attacker can exploit these vulnerabilities to cause a denial of service.");

  script_tag(name:"affected", value:"Huawei DP300, IPS Module, NGFW Module, NIP6300, NIP6600, RP200, S12700,
  S1700, S2700, S5700, S6700, S7700, S9700, Secospace USG6300, Secospace USG6500, Secospace USG6600, TE30,
  TE40, TE50, TE60, TP3106, TP3206, USG9500 and ViewPoint 9030.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"http://www.huawei.com/en/psirt/security-advisories/huawei-sa-20171206-01-pem-en");
...
if (cpe == "cpe:/o:huawei:s12700_firmware") {
  if (version == "V200R007C00" || version == "V200R007C01" || version == "V200R008C00" ||
    ...
    report = report_fixed_ver(installed_version: version, fixed_version: "V200R011C10");
...
if (cpe =~ "^cpe:/o:huawei:usg6[35]00_firmware") {
  if (version == "V500R001C00" || version == "V500R001C30") {
...
if (cpe == "cpe:/o:huawei:usg6600_firmware") {
  if (version == "V500R001C00" || version == "V500R001C30S") {
    report = report_fixed_ver(installed_version: version, installed_patch: patch,
                              fixed_version: "V500R001C60SPC500", fixed_patch: "V500R001SPH015");
    security_message(port: 0, data: report);
    exit(0);
