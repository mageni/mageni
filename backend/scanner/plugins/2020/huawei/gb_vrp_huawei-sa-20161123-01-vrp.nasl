...
if(description)
{
  ...
  script_version("2020-05-19T10:10:45+0000");
  ...
  script_name("Huawei VRP Data Communication: Integer Overflow Vulnerability (huawei-sa-20161123-01-vrp)");
  ...
  script_tag(name:"summary", value:"Multiple Huawei products are prone to an integer overflow vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Some Huawei devices have an integer overflow vulnerability. Due to the lack of
  validation in some field of the packet, a remote, unauthenticated attacker may craft specific IPFPM packets,
  probably causing the device to reset.");
  ...
  CloudEngine 8800 and Secospace USG6600.");
