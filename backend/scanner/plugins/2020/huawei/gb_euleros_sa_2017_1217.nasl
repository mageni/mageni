...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2017.1217");
  script_version("2020-01-23T10:59:38+0000");
  script_cve_id("CVE-2017-1000115", "CVE-2017-1000116");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 10:59:38 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 10:59:38 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for mercurial (EulerOS-SA-2017-1217)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1217");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'mercurial' package(s) announced via the EulerOS-SA-2017-1217 advisory.");
...
if(release == "EULEROS-2.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mercurial", rpm:"mercurial~2.6.2~8", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
