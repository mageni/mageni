...
if(description)
{
  ...
  script_version("2020-07-03T06:18:31+0000");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1715");
  ...
  'util-linux' package(s) announced via the EulerOS-SA-2020-1715 advisory.");
