...
if(description)
{
  ...
  script_version("2020-04-30T12:13:26+0000");
  script_cve_id("CVE-2018-10689");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-04-30 12:13:26 +0000 (Thu, 30 Apr 2020)");
  ...
  'blktrace' package(s) announced via the EulerOS-SA-2020-1550 advisory.");
