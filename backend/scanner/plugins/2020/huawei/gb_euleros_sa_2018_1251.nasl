...
if(description)
{
  ...
  script_version("2020-01-23T11:19:00+0000");
  script_cve_id("CVE-2018-2562");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:P/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 11:19:00 +0000 (Thu, 23 Jan 2020)");
  ...
  'mariadb' package(s) announced via the EulerOS-SA-2018-1251 advisory.");
