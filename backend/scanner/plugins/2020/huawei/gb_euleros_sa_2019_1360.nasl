...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1360");
  script_version("2020-01-23T11:40:22+0000");
  script_cve_id("CVE-2019-3858", "CVE-2019-3859", "CVE-2019-3860", "CVE-2019-3861", "CVE-2019-3862");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:40:22 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 11:40:22 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for libssh2 (EulerOS-SA-2019-1360)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1360");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libssh2' package(s) announced via the EulerOS-SA-2019-1360 advisory.");
...
if(release == "EULEROSVIRT-2.5.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh2", rpm:"libssh2~1.4.3~10.1.h2", rls:"EULEROSVIRT-2.5.3"))) {
    report += res;
  }
