...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1763");
  script_version("2020-07-03T06:22:49+0000");
  ...
  script_tag(name:"creation_date", value:"2020-07-03 06:22:49 +0000 (Fri, 03 Jul 2020)");
  script_name("Huawei EulerOS: Security Advisory for wpa_supplicant (EulerOS-SA-2020-1763)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1763");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1763");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'wpa_supplicant' package(s) announced via the EulerOS-SA-2020-1763 advisory.");
...
An invalid authentication sequence could result in the hostapd process terminating due to missing state validation steps when processing the SAE confirm message when in hostapd/AP mode. All version of hostapd with SAE support are vulnerable. An attacker may force the hostapd process to terminate, performing a denial of service attack. Both hostapd with SAE support and wpa_supplicant with SAE support prior to and including version 2.7 are affected.(CVE-2019-9496)");
  ...
  script_tag(name:"affected", value:"'wpa_supplicant' package(s) on Huawei EulerOS Virtualization 3.0.6.0.");
...
if(release == "EULEROSVIRT-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~2.6~9.h6.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.0"))) {
    report += res;
  }
