...
if(description)
{
  ...
  script_name("Huawei VRP Data Communication: Multiple H323 Protocol Vulnerabilities (huawei-sa-20171129-01-h323)");
  ...
  - Out-of-bounds vulnerability in the H323 protocol (CVE-2017-15331)

  - Memory leak vulnerability in the H323 protocol (CVE-2017-15332)");

  script_tag(name:"impact", value:"By exploiting this vulnerability, an attacker can cause process reboot or
  cause a memory leak and eventual denial of service (DoS) condition.");

  script_tag(name:"affected", value:"Huawei AR120-S, AR1200, AR1200-S, AR150, AR150-S, AR160, AR200, AR200-S,
  AR2200, AR2200-S, AR3200, AR510, DP300, IPS Module, MAX PRESENCE, NGFW Module, NIP6300, NIP6600, NIP6800,
  NetEngine16EX, RP200, RSE6500, SMC2.0, SRG1300, SRG2300, SRG3300, SVN5600, SVN5800, SVN5800-C,
  Secospace USG6300, Secospace USG6500, TE30, TE40, TE50, TE60, TP3106, TP3206, USG9500, USG9520, USG9560,
  USG9580 and ViewPoint 9030.");
...
if (cpe == "cpe:/o:huawei:ar2200_firmware") {
  if (version == "V200R006C10" || version == "V200R006C13" || version == "V200R006C16PWE" ||
