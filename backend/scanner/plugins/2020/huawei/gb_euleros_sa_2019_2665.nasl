...
if(description)
{
  ...
  script_version("2020-01-23T13:13:10+0000");
  script_cve_id("CVE-2015-4645", "CVE-2015-4646");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 13:13:10 +0000 (Thu, 23 Jan 2020)");
  ...
  'squashfs-tools' package(s) announced via the EulerOS-SA-2019-2665 advisory.");
