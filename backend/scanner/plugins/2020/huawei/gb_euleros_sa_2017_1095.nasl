...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2017.1095");
  script_version("2020-01-23T10:50:24+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 10:50:24 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 10:50:24 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for jasper (EulerOS-SA-2017-1095)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1095");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'jasper' package(s) announced via the EulerOS-SA-2017-1095 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jasper-libs", rpm:"jasper-libs~1.900.1~30", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
