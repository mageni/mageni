...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2017.1198");
  script_version("2020-01-23T10:57:52+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 10:57:52 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 10:57:52 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for firefox (EulerOS-SA-2017-1198)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1198");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'firefox' package(s) announced via the EulerOS-SA-2017-1198 advisory.");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~52.3.0~2.h1", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
