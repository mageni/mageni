...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2019.1413");
  script_version("2020-01-23T15:42:05+0000");
  script_cve_id("CVE-2017-13089", "CVE-2017-13090", "CVE-2018-0494");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 15:42:05 +0000 (Thu, 23 Jan 2020)");
  script_tag(name:"creation_date", value:"2020-01-23 11:43:05 +0000 (Thu, 23 Jan 2020)");
  script_name("Huawei EulerOS: Security Advisory for wget (EulerOS-SA-2019-1413)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1413");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'wget' package(s) announced via the EulerOS-SA-2019-1413 advisory.");
...
A heap-based buffer overflow, when processing chunked encoded HTTP responses, was found in wget. By tricking an unsuspecting user into connecting to a malicious HTTP server, an attacker could exploit this flaw to potentially execute arbitrary code.(CVE-2017-13090)");
  ...
  script_tag(name:"affected", value:"'wget' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.1.0.");
...
if(release == "EULEROSVIRTARM64-3.0.1.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wget", rpm:"wget~1.14~15.1.h5", rls:"EULEROSVIRTARM64-3.0.1.0"))) {
    report += res;
  }
