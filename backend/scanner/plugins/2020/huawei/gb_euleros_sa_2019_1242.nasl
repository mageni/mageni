...
if(description)
{
  ...
  script_version("2020-01-23T11:36:12+0000");
  script_cve_id("CVE-2018-16864");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:36:12 +0000 (Thu, 23 Jan 2020)");
  ...
  'systemd' package(s) announced via the EulerOS-SA-2019-1242 advisory.");
