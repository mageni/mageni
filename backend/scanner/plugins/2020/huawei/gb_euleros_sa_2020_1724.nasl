...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1724");
  script_version("2020-07-03T06:18:55+0000");
  ...
  script_tag(name:"creation_date", value:"2020-07-03 06:18:55 +0000 (Fri, 03 Jul 2020)");
  script_name("Huawei EulerOS: Security Advisory for libsndfile (EulerOS-SA-2020-1724)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-1724");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1724");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libsndfile' package(s) announced via the EulerOS-SA-2020-1724 advisory.");
...
An issue was discovered in libsndfile 1.0.28. There is a NULL pointer dereference in the function sf_write_int in sndfile.c, which will lead to a denial of service.(CVE-2018-19432)");
  ...
  script_tag(name:"affected", value:"'libsndfile' package(s) on Huawei EulerOS Virtualization 3.0.6.0.");
...
if(release == "EULEROSVIRT-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsndfile", rpm:"libsndfile~1.0.25~10.h10.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.0"))) {
    report += res;
  }
