...
if(description)
{
  ...
  script_version("2020-01-23T10:55:31+0000");
  script_cve_id("CVE-2015-2806", "CVE-2015-3622");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2020-01-23 10:55:31 +0000 (Thu, 23 Jan 2020)");
  ...
  'libtasn1' package(s) announced via the EulerOS-SA-2017-1172 advisory.");
