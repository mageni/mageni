...
if(description)
{
  ...
  script_version("2020-01-23T11:08:23+0000");
  ...
  script_tag(name:"last_modification", value:"2020-01-23 11:08:23 +0000 (Thu, 23 Jan 2020)");
  ...
  'gimp' package(s) announced via the EulerOS-SA-2018-1022 advisory.");
