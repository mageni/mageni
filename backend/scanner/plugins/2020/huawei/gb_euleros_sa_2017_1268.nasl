...
if(description)
{
  ...
  script_version("2020-01-23T11:02:37+0000");
  script_cve_id("CVE-2017-15670", "CVE-2017-15804");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 11:02:37 +0000 (Thu, 23 Jan 2020)");
  ...
  'glibc' package(s) announced via the EulerOS-SA-2017-1268 advisory.");
