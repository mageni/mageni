...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.1241");
  script_version("2020-03-13T07:17:42+0000");
  ...
  script_tag(name:"creation_date", value:"2020-03-13 07:17:42 +0000 (Fri, 13 Mar 2020)");
  script_name("Huawei EulerOS: Security Advisory for libXfont (EulerOS-SA-2020-1241)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1241");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'libXfont' package(s) announced via the EulerOS-SA-2020-1241 advisory.");
...
In the PatternMatch function in fontfile/fontdir.c in libXfont through 1.5.2 and 2.x before 2.0.2, an attacker with access to an X connection can cause a buffer over-read during pattern matching of fonts, leading to information disclosure or a crash (denial of service). This occurs because '\\0' characters are incorrectly skipped in situations involving ? characters.(CVE-2017-13720)");
  ...
  script_tag(name:"affected", value:"'libXfont' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libXfont", rpm:"libXfont~1.5.2~1.h2", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
