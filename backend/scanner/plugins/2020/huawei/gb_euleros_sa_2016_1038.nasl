...
if(description)
{
  ...
  script_version("2020-01-23T10:40:02+0000");
  script_cve_id("CVE-2015-0247", "CVE-2015-1572");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2020-01-23 10:40:02 +0000 (Thu, 23 Jan 2020)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1038");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'e2fsprogs' package(s) announced via the EulerOS-SA-2016-1038 advisory.");
