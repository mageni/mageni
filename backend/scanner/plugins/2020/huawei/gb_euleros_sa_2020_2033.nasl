...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2020.2033");
  ...
  script_tag(name:"creation_date", value:"2020-09-29 13:41:24 +0000 (Tue, 29 Sep 2020)");
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2020-2033)");
  ...
  script_xref(name:"EulerOS-SA", value:"2020-2033");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2033");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS
  'sqlite' package(s) announced via the EulerOS-SA-2020-2033 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.24.0~2.h19.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"sqlite-libs", rpm:"sqlite-libs~3.24.0~2.h19.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
