...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.143913");
  script_version("2020-05-15T13:04:15+0000");
  script_tag(name:"last_modification", value:"2020-05-18 10:22:57 +0000 (Mon, 18 May 2020)");
  script_tag(name:"creation_date", value:"2020-05-15 02:46:26 +0000 (Fri, 15 May 2020)");
  ...
  script_name("PHP < 7.2.31, 7.3 < 7.3.18, 7.4 < 7.4.6 Multiple DoS Vulnerabilities - May20 (Linux)");
