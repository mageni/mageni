...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.108863");
  ...
  script_name("PHP < 5.2.2 'CVE-2007-1649' Vulnerability");
  ...
  script_tag(name:"summary", value:"PHP is prone to a security vulnerability.");

  script_tag(name:"affected", value:"PHP before version 5.2.2.");
