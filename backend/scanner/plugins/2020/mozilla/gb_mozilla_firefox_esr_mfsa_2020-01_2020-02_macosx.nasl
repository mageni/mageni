...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815884");
  ...
  script_tag(name:"creation_date", value:"2020-01-08 13:10:58 +0530 (Wed, 08 Jan 2020)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-01_2020-02)-MAC OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 68.4 on MAC OS X.");
