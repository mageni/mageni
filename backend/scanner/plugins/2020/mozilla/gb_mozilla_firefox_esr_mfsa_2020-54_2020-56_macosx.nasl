...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817557");
  ...
  script_tag(name:"creation_date", value:"2020-12-16 11:17:36 +0530 (Wed, 16 Dec 2020)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-54_2020-56)-MAC OS X");
