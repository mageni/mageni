...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-03_2020-03)-MAC OS X");

  script_tag(name:"summary", value:"This host is installed with
  Mozilla Firefox ESR and is prone to type confusion vulnerability.");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 68.4.1
...
if(version_is_less(version:ffVer, test_version:"68.4.1"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"68.4.1", install_path:ffPath);
