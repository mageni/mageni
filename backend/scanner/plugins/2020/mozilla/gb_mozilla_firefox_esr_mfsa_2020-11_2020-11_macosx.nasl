...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.816736");
  ...
  script_tag(name:"creation_date", value:"2020-04-07 17:22:41 +0530 (Tue, 07 Apr 2020)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-11_2020-11)-MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 68.6.1
...
if(version_is_less(version:ffVer, test_version:"68.6.1"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"68.6.1", install_path:ffPath);
