...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817037");
  ...
  script_tag(name:"creation_date", value:"2020-06-03 13:33:28 +0530 (Wed, 03 Jun 2020)");
  script_name("Mozilla Firefox ESR Security Updates(mfsa_2020-20_2020-21)-Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR version before 68.9 on Windows.");

  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox ESR version 68.9
...
if(version_is_less(version:ffVer, test_version:"68.9"))
{
  report = report_fixed_ver(installed_version:ffVer, fixed_version:"68.9", install_path:ffPath);
