...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112800");
  ...
  script_name("WordPress Elegant Themes Divi Theme 3.0 <= 4.5.2 Authenticated Arbitrary File Upload Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress theme Divi by Elegant Themes is prone to an authenticated arbitrary file upload vulnerability.");
  ...
  script_tag(name:"affected", value:"WordPress Divi theme by Elegant Themes versions 3.0 through 4.5.2.");
...
if( version_in_range( version: version, test_version: "3.0", test_version2: "4.5.2" ) ) {
