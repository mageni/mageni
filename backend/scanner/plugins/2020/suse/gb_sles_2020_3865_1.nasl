...
if(description)
{
  ...
  script_cve_id("CVE-2019-18348","CVE-2019-20916","CVE-2020-27619");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:3865-1)");
  ...
  package(s) announced via the SUSE-SU-2020:3865-1 advisory.");
