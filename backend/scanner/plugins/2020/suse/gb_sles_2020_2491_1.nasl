...
if(description)
{
  ...
  script_cve_id("CVE-2019-0155","CVE-2019-14814","CVE-2019-14815");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2491-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-September/007367.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel (Live Patch 32 for SLE 12 SP2)'
  package(s) announced via the SUSE-SU-2020:2491-1 advisory.");
