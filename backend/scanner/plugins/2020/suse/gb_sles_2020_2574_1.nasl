...
if(description)
{
  ...
  script_cve_id("CVE-2020-14314","CVE-2020-14331","CVE-2020-14356");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2574-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-September/007382.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2020:2574-1 advisory.");
