...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:0474-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-February/006529.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'openssl'
  package(s) announced via the SUSE-SU-2020:0474-1 advisory.");
