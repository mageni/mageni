...
if(description)
{
  ...
  script_cve_id("CVE-2017-18922","CVE-2018-21247","CVE-2019-20839");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2020:2167-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-August/007241.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'LibVNCServer'
  package(s) announced via the SUSE-SU-2020:2167-1 advisory.");
