...
if(description)
{
  ...
  script_version("2020-04-07T06:08:49+0000");
  ...
  script_name("Zoom Client Multiple Vulnerabilities - Apr20 (Mac OS X)");
  ...
  script_tag(name:"insight", value:"The Zoom Client is prone to multiple vulnerabilities where a
  malicious party with local access could:

  - tamper with the Zoom installer to gain additional privileges to the computer (CVE-2020-11469)

  - gain access to a user's webcam and microphone (CVE-2020-11470)");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Zoom Client before version 4.6.9 (19273.0402) on Mac OS X.");

  script_tag(name:"solution", value:"Update to Zoom Client 4.6.9 (19273.0402) or later. Please see the references for more information.");
