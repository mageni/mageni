...
if(description)
{
  ...
  script_version("2020-07-29T06:45:04+0000");
  ...
  script_tag(name:"affected", value:"Cherokee Web Server through versions 0.4.27 to 1.2.10.");

  script_tag(name:"solution", value:"No known solution is available as of 29th July, 2020.
