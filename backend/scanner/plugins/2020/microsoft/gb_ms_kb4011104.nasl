...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.815596");
  ...
  script_tag(name:"creation_date", value:"2020-04-15 12:03:52 +0530 (Wed, 15 Apr 2020)");
  script_name("Microsoft Office 2013 Remote Code Execution Vulnerability (KB4011104)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4011104");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4011104");
...
if(offVer =~ "^15.*")
{
  ...
  if(dllPath)
  {
    ...
    if(version_in_range(version:vbVer, test_version:"7.0", test_version2:"7.01.1095"))
    {
      report = report_fixed_ver(file_checked: dllPath + "Microsoft Shared\VBA\VBA7\VBE7.DLL",
                            file_version:vbVer, vulnerable_range:"7.0 - 7.01.1095");
