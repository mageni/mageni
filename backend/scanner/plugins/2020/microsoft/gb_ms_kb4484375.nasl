...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817417");
  ...
  script_tag(name:"creation_date", value:"2020-08-12 12:35:17 +0530 (Wed, 12 Aug 2020)");
  script_name("Microsoft Office 2010 Service Pack 2 RCE and Information Disclosure Vulnerabilities (KB4484375)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484375");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484375");
...
foreach key(key_list)
{
  ...
  if(offexeVer && version_in_range(version:offexeVer, test_version:"14.0", test_version2:"14.0.7256.4999"))
  {
    report = report_fixed_ver(file_checked:offPath + "\graph.exe",
                              file_version:offexeVer, vulnerable_range:"14.0 - 14.0.7256.4999");
