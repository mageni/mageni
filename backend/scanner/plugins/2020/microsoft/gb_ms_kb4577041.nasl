...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817359");
  ...
  script_cve_id("CVE-2020-0648", "CVE-2020-0766", "CVE-2020-0782", "CVE-2020-0790",
                ...
                "CVE-2020-0878", "CVE-2020-0886", "CVE-2020-0904", "CVE-2020-0908",
                "CVE-2020-0911", "CVE-2020-0912", "CVE-2020-0914", "CVE-2020-0921",
                "CVE-2020-0922", "CVE-2020-0941", "CVE-2020-0951", "CVE-2020-0989",
                ...
                "CVE-2020-1133", "CVE-2020-1146", "CVE-2020-1152", "CVE-2020-1169",
                ...
                "CVE-2020-1508", "CVE-2020-1559", "CVE-2020-1589", "CVE-2020-1593",
                "CVE-2020-1596", "CVE-2020-1598", "CVE-2020-16854");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4577041)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4577041");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4577041");
...
if(version_in_range(version:fileVer, test_version:"10.0.16299.0", test_version2:"10.0.16299.2106"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.16299.0 - 10.0.16299.2106");
