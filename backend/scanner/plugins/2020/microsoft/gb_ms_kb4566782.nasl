...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817260");
  ...
  script_tag(name:"creation_date", value:"2020-08-12 08:59:44 +0530 (Wed, 12 Aug 2020)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB4566782)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB4566782");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4566782");
...
if(version_in_range(version:fileVer, test_version:"10.0.19041.0", test_version2:"10.0.19041.449"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Gdiplus.dll",
                            file_version:fileVer, vulnerable_range:"10.0.19041.0 - 10.0.19041.449");
