...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817451");
  ...
  script_tag(name:"creation_date", value:"2020-09-09 12:32:12 +0530 (Wed, 09 Sep 2020)");
  script_name("Microsoft Word 2013 Service Pack 1 Remote Code Execution Vulnerability (KB4484522)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484522");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484522");
...
if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"15.0.5275.1000"))
{
  report = report_fixed_ver(file_checked:exePath + "winword.exe",
                            file_version:exeVer, vulnerable_range:"16.0 - 15.0.5275.0999");
