...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817627");
  ...
  script_name("Microsoft Office Access Connectivity Engine Remote Code Execution Vulnerability (KB4484520)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484520");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present
  on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an error in Microsoft
  Office Access Connectivity Engine while opening a crafted modified file.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484520");
    ...
    if(msdllVer && msdllVer =~ "^15\.")
    {
      if(version_is_less(version:msdllVer, test_version:"15.0.5293.1000"))
      {
        report = report_fixed_ver( file_checked:offPath + "\acecore.dll",
                                   file_version:msdllVer, vulnerable_range:"15.0 - 15.0.5293.0999");
