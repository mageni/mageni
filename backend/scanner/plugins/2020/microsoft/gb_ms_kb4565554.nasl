...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817242");
  ...
  script_tag(name:"creation_date", value:"2020-07-16 15:28:12 +0530 (Thu, 16 Jul 2020)");
  script_name("Windows Modules Installer Elevation of Privilege Vulnerability (KB4565554)");

  script_tag(name:"summary", value:"This host is missing a important security
  update according to Microsoft KB4565554");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4565554");
...
if(version_in_range(version:fileVer, test_version:"10.0.18362.0", test_version2:"10.0.18362.951"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Updateagent.dll",
                            file_version:fileVer, vulnerable_range:"10.0.18362.0 - 10.0.18362.951");
