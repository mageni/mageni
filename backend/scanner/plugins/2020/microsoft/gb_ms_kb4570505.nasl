...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817325");
  ...
  script_name("Microsoft .NET Framework Multiple Vulnerabilities (KB4570505)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4570505");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4570505");
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              ...
              else if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.3649"))
              {
                vulnerable_range = "4.7 - 4.7.3649" ;
                break;
              }
