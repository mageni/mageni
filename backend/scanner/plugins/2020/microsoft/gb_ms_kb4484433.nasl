...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817080");
  ...
  script_tag(name:"creation_date", value:"2020-07-15 17:17:48 +0530 (Wed, 15 Jul 2020)");
  script_name("Microsoft Outlook 2016 Remote Code Execution Vulnerability (KB4484433)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4484433");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4484433");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.5017.0999")){
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.5017.0999");
