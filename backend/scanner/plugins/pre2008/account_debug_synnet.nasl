...
# $Id: account_debug_synnet.nasl 9567 2018-04-23 13:22:46Z cfischer $
#
# Default password 'synnet' for account 'debug'
#
# Authors:
# Michel Arboi
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.17289");
  ...
  script_name("Default password 'synnet' for account 'debug'");
  ...
  script_tag(name:"summary", value:"The account 'debug' has the password 'synnet'.");
