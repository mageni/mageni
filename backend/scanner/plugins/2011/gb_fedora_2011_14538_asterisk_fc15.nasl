...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-November/069054.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863610");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.8.7.1~1.fc15", rls:"FC15")) != NULL)
  {
