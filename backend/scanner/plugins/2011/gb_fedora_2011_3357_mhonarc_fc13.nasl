...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/056523.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862947");
  ...
  script_name("Fedora Update for mhonarc FEDORA-2011-3357");
  ...
  script_tag(name:"affected", value:"mhonarc on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"mhonarc", rpm:"mhonarc~2.6.18~3.fc13", rls:"FC13")) != NULL)
  {
