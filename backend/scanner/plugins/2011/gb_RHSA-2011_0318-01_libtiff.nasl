...
if(description)
{
  script_xref(name:"URL", value:"https://www.redhat.com/archives/rhsa-announce/2011-March/msg00010.html");
  script_oid("1.3.6.1.4.1.25623.1.0.870400");
  ...
  script_name("RedHat Update for libtiff RHSA-2011:0318-01");
...
if(release == "RHENT_5")
{
  ...
  if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.8.2~7.el5_6.6", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-debuginfo", rpm:"libtiff-debuginfo~3.8.2~7.el5_6.6", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.8.2~7.el5_6.6", rls:"RHENT_5")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "RHENT_4")
{
  ...
  if ((res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~3.6.1~17.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-debuginfo", rpm:"libtiff-debuginfo~3.6.1~17.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~3.6.1~17.el4", rls:"RHENT_4")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
