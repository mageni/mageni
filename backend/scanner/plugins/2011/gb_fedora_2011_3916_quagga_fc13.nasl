...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-April/057831.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862983");
  ...
  script_name("Fedora Update for quagga FEDORA-2011-3916");
  ...
  script_tag(name:"affected", value:"quagga on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"quagga", rpm:"quagga~0.99.18~1.fc13", rls:"FC13")) != NULL)
  {
