...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065703.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863495");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.25.3~34.fc15", rls:"FC15")) != NULL)
  {
