...
# $Id: gb_joomla_lyftenbloggie_mult_xss_vuln.nasl 11552 2018-09-22 13:45:08Z cfischer $
#
...
url = dir + '/index.php?option=com_lyftenbloggie&tag=<script>alert("OpenVAS-XSS-Testing")</script>';

if (http_vuln_check(port: port, url: url, pattern: '><script>alert("OpenVAS-XSS-Testing")</script><',
                    check_header: TRUE)) {
