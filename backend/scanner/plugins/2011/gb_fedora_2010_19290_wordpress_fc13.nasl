...
#
# Fedora Update for wordpress FEDORA-2010-19290
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-January/052892.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862763");
  ...
  script_name("Fedora Update for wordpress FEDORA-2010-19290");
  ...
  script_tag(name:"affected", value:"wordpress on Fedora 13");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~2.8.6~3.fc13", rls:"FC13")) != NULL)
  {
