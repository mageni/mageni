...
#
# Fedora Update for asterisk FEDORA-2011-3945
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/057156.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862962");
  ...
  script_name("Fedora Update for asterisk FEDORA-2011-3945");
...
if(release == "FC13")
{
  ...
  if ((res = isrpmvuln(pkg:"asterisk", rpm:"asterisk~1.6.2.17.2~1.fc13", rls:"FC13")) != NULL)
  {
