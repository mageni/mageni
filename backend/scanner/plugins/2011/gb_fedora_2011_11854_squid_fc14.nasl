...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065534.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863476");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"squid", rpm:"squid~3.1.15~1.fc14", rls:"FC14")) != NULL)
  {
