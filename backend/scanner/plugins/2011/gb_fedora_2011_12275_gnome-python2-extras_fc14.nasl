...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065808.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863509");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"gnome-python2-extras", rpm:"gnome-python2-extras~2.25.3~33.fc14.1", rls:"FC14")) != NULL)
  {
