...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.831304");
  ...
  script_tag(name:"affected", value:"evince on Mandriva Linux 2010.0,
  Mandriva Linux 2010.0/X86_64,
  Mandriva Linux 2010.1,
  Mandriva Linux 2010.1/X86_64,
  Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64");
  script_tag(name:"insight", value:"Multiple vulnerabilities has been found and corrected in evince:
