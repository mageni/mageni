...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066335.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863556");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~3.4.5~1.fc14", rls:"FC14")) != NULL)
  {
