...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/066319.html");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"qt", rpm:"qt~4.7.4~2.fc15", rls:"FC15")) != NULL)
  {
