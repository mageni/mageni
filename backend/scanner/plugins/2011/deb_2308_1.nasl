...
# $Id: deb_2308_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202308-1");
  script_tag(name:"insight", value:"Several vulnerabilities were found in Mantis, a  web-based bug
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"mantis", ver:"1.1.6+dfsg-2lenny6", rls:"DEB5")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"mantis", ver:"1.1.8+dfsg-10squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
