...
#
# CentOS Update for thunderbird CESA-2011:0887 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-June/017623.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880523");
  ...
  script_name("CentOS Update for thunderbird CESA-2011:0887 centos5 i386");
