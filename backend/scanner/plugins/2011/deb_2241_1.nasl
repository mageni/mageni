...
# $Id: deb_2241_1.nasl 14275 2019-03-18 14:39:45Z cfischer $
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202241-1");
  script_tag(name:"insight", value:"Nelson Elhage discovered that incorrect memory handling during the
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"kvm", ver:"0.12.5+dfsg-5+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"qemu-kvm", ver:"0.12.5+dfsg-5+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"qemu-kvm-dbg", ver:"0.12.5+dfsg-5+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
