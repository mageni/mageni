...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-February/054208.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862858");
  ...
  script_name("Fedora Update for Django FEDORA-2011-1235");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"Django", rpm:"Django~1.2.5~1.fc14", rls:"FC14")) != NULL)
  {
