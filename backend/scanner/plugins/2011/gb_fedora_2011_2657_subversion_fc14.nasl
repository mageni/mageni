...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-March/056071.html");
  script_oid("1.3.6.1.4.1.25623.1.0.862918");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"subversion", rpm:"subversion~1.6.16~1.fc14", rls:"FC14")) != NULL)
  {
