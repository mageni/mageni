...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065686.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863496");
  ...
  script_tag(name:"affected", value:"avahi on Fedora 14");
...
if(release == "FC14")
{
  ...
  if ((res = isrpmvuln(pkg:"avahi", rpm:"avahi~0.6.27~8.fc14", rls:"FC14")) != NULL)
  {
