...
#
# CentOS Update for openssl CESA-2009:0004 centos5 i386
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2009-January/015537.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880789");
  ...
  script_name("CentOS Update for openssl CESA-2009:0004 centos5 i386");
