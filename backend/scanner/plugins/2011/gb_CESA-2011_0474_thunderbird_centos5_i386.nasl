...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2011-April/017462.html");
  script_oid("1.3.6.1.4.1.25623.1.0.880539");
  ...
  script_name("CentOS Update for thunderbird CESA-2011:0474 centos5 i386");
