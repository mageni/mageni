...
if(description)
{
  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2011-September/065730.html");
  script_oid("1.3.6.1.4.1.25623.1.0.863498");
  ...
  script_tag(name:"affected", value:"librsvg2 on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"librsvg2", rpm:"librsvg2~2.34.0~2.fc15", rls:"FC15")) != NULL)
  {
