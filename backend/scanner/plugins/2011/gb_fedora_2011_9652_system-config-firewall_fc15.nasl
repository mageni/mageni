...
if(description)
{
  ...
  script_tag(name:"affected", value:"system-config-firewall on Fedora 15");
...
if(release == "FC15")
{
  ...
  if ((res = isrpmvuln(pkg:"system-config-firewall", rpm:"system-config-firewall~1.2.29~4.fc15", rls:"FC15")) != NULL)
  {
