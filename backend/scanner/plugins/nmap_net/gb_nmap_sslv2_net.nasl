...
# $Id: gb_nmap_sslv2_net.nasl 11527 2018-09-21 15:59:27Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104059");
  ...
  script_name("Nmap NSE net: sslv2");
...
if (phase == 1) {
  argv = make_array();
  nmap_nse_register(script:"sslv2", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"sslv2");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (sslv2.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
