...
# $Id: gb_nmap_oracle_sid_brute_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if (phase == 1) {
    ...
    if (!isnull(pref) && pref != "") {
        argv["oraclesids"] = string('"', pref, '"');
    }
    nmap_nse_register(script:"oracle-sid-brute", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"oracle-sid-brute");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (oracle-sid-brute.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
