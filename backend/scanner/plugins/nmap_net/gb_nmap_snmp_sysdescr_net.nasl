...
# $Id: gb_nmap_snmp_sysdescr_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"snmp-sysdescr", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"snmp-sysdescr");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (snmp-sysdescr.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
