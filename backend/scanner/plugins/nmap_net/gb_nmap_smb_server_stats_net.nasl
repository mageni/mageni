...
# $Id: gb_nmap_smb_server_stats_net.nasl 12117 2018-10-26 10:50:36Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104058");
  ...
  script_name("Nmap NSE net: smb-server-stats");
...
if (phase == 1) {
    ...
    nmap_nse_register(script:"smb-server-stats", args:argv);
} else if (phase == 2) {
    res = nmap_nse_get_results(script:"smb-server-stats");
    foreach portspec (keys(res)) {
        output_banner = 'Result found by Nmap Security Scanner (smb-server-stats.nse) http://nmap.org:\n\n';
        if (portspec == "0") {
