...
# $Id: gb_ubuntu_USN_2124_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  Ubuntu 10.04 LTS");
  script_tag(name:"insight", value:"A vulnerability was discovered in the OpenJDK JRE related to
