...
# $Id: gb_ubuntu_USN_2370_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_name("Ubuntu Update for apt USN-2370-1");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"apt", ver:"1.0.1ubuntu2.5", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"apt", ver:"0.8.16~exp12ubuntu10.21", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
