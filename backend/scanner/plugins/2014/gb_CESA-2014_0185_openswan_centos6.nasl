...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.881884");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-02-20 15:09:14 +0530 (Thu, 20 Feb 2014)");
  script_cve_id("CVE-2013-6466");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_name("CentOS Update for openswan CESA-2014:0185 centos6");
...
contain a backported patch to correct this issue.");
  ...
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2014-February/020161.html");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"openswan", rpm:"openswan~2.6.32~27.2.el6_5", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"openswan-doc", rpm:"openswan-doc~2.6.32~27.2.el6_5", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
