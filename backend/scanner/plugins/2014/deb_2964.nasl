...
# $Id: deb_2964.nasl 14302 2019-03-19 08:28:48Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"iodine on Debian Linux");
...
We recommend that you upgrade your iodine packages.");
  script_tag(name:"summary", value:"Oscar Reparaz discovered an authentication bypass vulnerability in
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"iodine", ver:"0.6.0~rc1-12+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
