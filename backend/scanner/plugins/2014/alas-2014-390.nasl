...
# $Id: alas-2014-390.nasl 6663 2017-07-11 09:58:05Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-390");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"transmission-cli", rpm:"transmission-cli~2.84~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"transmission-daemon", rpm:"transmission-daemon~2.84~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"transmission-common", rpm:"transmission-common~2.84~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"transmission-debuginfo", rpm:"transmission-debuginfo~2.84~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"transmission", rpm:"transmission~2.84~1.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
