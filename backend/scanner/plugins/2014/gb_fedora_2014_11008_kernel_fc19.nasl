...
#
# Fedora Update for kernel FEDORA-2014-11008
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868351");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-10-01 17:00:23 +0530 (Wed, 01 Oct 2014)");
  script_cve_id("CVE-2014-6410", "CVE-2014-3186", "CVE-2014-3181", "CVE-2014-3631",
                ...
                "CVE-2013-2234", "CVE-2014-5471", "CVE-2014-5472");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_name("Fedora Update for kernel FEDORA-2014-11008");
  script_tag(name:"affected", value:"kernel on Fedora 19");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-September/139573.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.14.19~100.fc19", rls:"FC19")) != NULL)
  {
