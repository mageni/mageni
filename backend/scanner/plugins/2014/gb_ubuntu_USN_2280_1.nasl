...
# $Id: gb_ubuntu_USN_2280_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"affected", value:"miniupnpc on Ubuntu 14.04 LTS,
  Ubuntu 13.10,
  Ubuntu 12.04 LTS");
  script_tag(name:"insight", value:"It was discovered that MiniUPnPc incorrectly handled certain
...
applications using MiniUPnPc to crash, resulting in a denial of service.");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2280-1/");
