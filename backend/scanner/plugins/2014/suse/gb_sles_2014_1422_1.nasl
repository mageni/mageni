...
if(description)
{
  ...
  script_cve_id("CVE-2014-6457","CVE-2014-6502","CVE-2014-6504");
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2014:1422-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2014-November/001062.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'java-1_7_0-openjdk'
  package(s) announced via the SUSE-SU-2014:1422-1 advisory.");
