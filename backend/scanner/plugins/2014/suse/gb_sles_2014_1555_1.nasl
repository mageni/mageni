...
if(description)
{
  ...
  script_name("SUSE Linux Enterprise Server: Security Advisory (SUSE-SU-2014:1555-1)");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2014-December/001092.html");

  script_tag(name:"summary", value:"The remote host is missing an update for 'file'
  package(s) announced via the SUSE-SU-2014:1555-1 advisory.");
