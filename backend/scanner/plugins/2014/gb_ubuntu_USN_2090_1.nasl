...
# $Id: gb_ubuntu_USN_2090_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"munin", ver:"1.4.6-3ubuntu3.4", rls:"UBUNTU12.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU13.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"munin", ver:"2.0.17-2ubuntu1.1", rls:"UBUNTU13.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"munin", ver:"2.0.2-1ubuntu2.3", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
