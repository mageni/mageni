...
# $Id: gb_wordpress_bib2html_xss_vuln.nasl 11402 2018-09-15 09:13:36Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Wordpress bib2html Plugin and is prone to
