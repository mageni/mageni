...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867536");
  ...
  script_name("Fedora Update for file FEDORA-2014-2739");
  script_tag(name:"affected", value:"file on Fedora 20");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128994.html");
...
if(release == "FC20")
{
  ...
  if ((res = isrpmvuln(pkg:"file", rpm:"file~5.14~15.fc20", rls:"FC20")) != NULL)
  {
