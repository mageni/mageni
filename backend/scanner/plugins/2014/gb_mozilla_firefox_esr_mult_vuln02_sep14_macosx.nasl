...
# $Id: gb_mozilla_firefox_esr_mult_vuln02_sep14_macosx.nasl 11974 2018-10-19 06:22:46Z cfischer $
#
# Mozilla Firefox ESR Multiple Vulnerabilities-02 September14 (Mac OS X)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.804832");
  ...
  script_tag(name:"creation_date", value:"2014-09-05 19:30:31 +0530 (Fri, 05 Sep 2014)");

  script_name("Mozilla Firefox ESR Multiple Vulnerabilities-02 September14 (Mac OS X)");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR 31.x before 31.1 on Mac OS X");
