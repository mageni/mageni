...
#
# Fedora Update for kernel FEDORA-2014-9142
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.868076");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2014-08-09 05:49:21 +0200 (Sat, 09 Aug 2014)");
  ...
  script_name("Fedora Update for kernel FEDORA-2014-9142");
  script_tag(name:"affected", value:"kernel on Fedora 19");
  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_tag(name:"qod_type", value:"package");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2014-August/136444.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.14.15~100.fc19", rls:"FC19")) != NULL)
  {
