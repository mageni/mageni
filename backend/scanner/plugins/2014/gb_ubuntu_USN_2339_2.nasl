...
# $Id: gb_ubuntu_USN_2339_2.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
...
if(description)
{
  ...
  script_name("Ubuntu Update for libgcrypt11 USN-2339-2");
  script_tag(name:"insight", value:"Daniel Genkin, Adi Shamir, and Eran Tromer
discovered that Libgcrypt was susceptible to an adaptive chosen ciphertext attack
via physical side channels. A local attacker could use this attack to possibly
recover private keys.");
  script_tag(name:"affected", value:"libgcrypt11 on Ubuntu 14.04 LTS,
  Ubuntu 12.04 LTS,
  Ubuntu 10.04 LTS");
...
if(release == "UBUNTU14.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt11", ver:"1.5.3-2ubuntu4.1", rls:"UBUNTU14.04 LTS")) != NULL)
  {
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt11", ver:"1.5.0-3ubuntu0.3", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU10.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"libgcrypt11", ver:"1.4.4-5ubuntu2.3", rls:"UBUNTU10.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
