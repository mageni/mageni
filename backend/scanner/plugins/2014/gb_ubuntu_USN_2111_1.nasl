...
# $Id: gb_ubuntu_USN_2111_1.nasl 14140 2019-03-13 12:26:09Z cfischer $
#
# Ubuntu Update for linux-lts-quantal USN-2111-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-02-20 15:16:37 +0530 (Thu, 20 Feb 2014)");
  script_cve_id("CVE-2013-2929", "CVE-2013-4592", "CVE-2013-6378", "CVE-2013-6380");
  script_tag(name:"cvss_base", value:"4.7");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:N/I:N/A:C");
  script_name("Ubuntu Update for linux-lts-quantal USN-2111-1");
...
(CVE-2013-6380)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2111-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-46-generic", ver:"3.5.0-46.70~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
