...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2014-282)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"libXfont-devel", rpm:"libXfont-devel~1.4.5~3.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libXfont", rpm:"libXfont~1.4.5~3.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libXfont-debuginfo", rpm:"libXfont-debuginfo~1.4.5~3.8.amzn1", rls:"AMAZON"))) {
    report += res;
  }
