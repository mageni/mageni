...
# $Id: alas-2014-324.nasl 6759 2017-07-19 09:56:33Z teissa$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-324");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"perl-YAML-LibYAML-debuginfo", rpm:"perl-YAML-LibYAML-debuginfo~0.41~4.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"perl-YAML-LibYAML", rpm:"perl-YAML-LibYAML~0.41~4.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
