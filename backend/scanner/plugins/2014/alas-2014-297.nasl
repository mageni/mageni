...
# $Id: alas-2014-297.nasl 6913 2017-08-14 05:35:04Z asteins$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2014-297");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"graphviz-php", rpm:"graphviz-php~2.30.1~12.37.amzn1", rls:"AMAZON")) != NULL) {
