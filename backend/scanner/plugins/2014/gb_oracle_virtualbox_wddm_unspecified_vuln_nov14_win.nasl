...
# $Id: gb_oracle_virtualbox_wddm_unspecified_vuln_nov14_win.nasl 11867 2018-10-12 10:48:11Z cfischer $
#
# Oracle Virtualbox WDDM Unspecified Vulnerability Nov14 (Windows)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.804948");
  ...
  script_tag(name:"creation_date", value:"2014-11-03 11:32:04 +0530 (Mon, 03 Nov 2014)");
  script_name("Oracle Virtualbox WDDM Unspecified Vulnerability Nov14 (Windows)");
  ...
  before 4.2.26, and 4.3.x before 4.3.14 on Windows");
