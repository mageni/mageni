...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.107571");
  script_version("$Revision: 13691 $");
  script_tag(name:"last_modification", value:"$Date: 2019-02-15 11:59:06 +0100 (Fri, 15 Feb 2019) $");
  script_tag(name:"creation_date", value:"2019-02-15 10:54:53 +0100 (Fri, 15 Feb 2019)");
  ...
  of CAS CommServer UA for Windows.");
  script_xref(name:"URL", value:"http://www.commsvr.com/");
