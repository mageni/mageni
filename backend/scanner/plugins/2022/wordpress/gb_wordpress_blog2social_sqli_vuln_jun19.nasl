...
CPE = "cpe:/a:blog2social:blog2social";

if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127113");
  script_version("2022-07-30T07:26:17+0000");
  script_tag(name:"last_modification", value:"2022-07-30 07:26:17 +0000 (Sat, 30 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-30 07:04:08 +0000 (Sat, 30 Jul 2022)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_cve_id("CVE-2019-13572");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Blog2Social Plugin <= 5.5.0 SQLi Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress Blog2Social plugin version 5.5.0 and prior.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/9476");
...
if( version_is_less_equal(version: version, test_version: "5.5.0" ) ) {
