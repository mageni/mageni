...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127112");
  script_version("2022-07-30T07:26:17+0000");
  script_tag(name:"last_modification", value:"2022-07-30 07:26:17 +0000 (Sat, 30 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-30 06:59:08 +0000 (Sat, 30 Jul 2022)");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:N/I:P/A:P");

  script_cve_id("CVE-2019-14683");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Import users from CSV with meta Plugin < 1.14.2.2 CSRF Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin allows CSRF in
  wp-admin/admin-ajax.php?action=acui_delete_attachment.");

  script_tag(name:"affected", value:"WordPress Import users from CSV with meta plugin prior to
  version 1.14.2.2.");

  script_tag(name:"solution", value:"Update to version 1.14.2.2 or later.");
