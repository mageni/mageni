...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libreoffice (USN-5330-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006448.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice'
  package(s) announced via the USN-5330-1 advisory.");
...
expectations.");
  ...
  script_tag(name:"affected", value:"'libreoffice' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:7.2.5-0ubuntu0.21.10.3", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:6.0.7-0ubuntu0.18.04.11", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:6.4.7-0ubuntu0.20.04.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
