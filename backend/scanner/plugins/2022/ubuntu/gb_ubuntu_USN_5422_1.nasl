...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for libxml2 (USN-5422-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006563.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2'
  package(s) announced via the USN-5422-1 advisory.");
...
arbitrary code. (CVE-2022-29824)");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
