...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-kvm (USN-4997-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-June/006094.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm'
  package(s) announced via the USN-4997-2 advisory.");
...
(system crash) or possibly execute arbit ...

  Description truncated. Please see the references for more information.");

  script_tag(name:"affected", value:"'linux-kvm' package(s) on Ubuntu 21.04.");
...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.11.0-1009-kvm", ver:"5.11.0-1009.9", rls:"UBUNTU21.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.11.0.1009.9", rls:"UBUNTU21.04"))) {
    report += res;
  }
