...
if(description)
{
  ...
  script_cve_id("CVE-2022-28346", "CVE-2022-28347", "CVE-2021-32052");
  ...
  script_name("Ubuntu: Security Advisory for python-django (USN-5373-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-April/006498.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django'
  package(s) announced via the USN-5373-1 advisory.");
