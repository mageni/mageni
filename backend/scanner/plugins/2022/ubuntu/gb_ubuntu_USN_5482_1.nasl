...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for spip (USN-5482-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006633.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spip'
  package(s) announced via the USN-5482-1 advisory.");
...
sensitive information. (CVE-2022-26846, CVE-2022-26847)");
  ...
  script_tag(name:"affected", value:"'spip' package(s) on Ubuntu 21.10, Ubuntu 18.04 LTS.");
