...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for curl (USN-5412-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006553.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl'
  package(s) announced via the USN-5412-1 advisory.");
