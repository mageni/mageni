...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for zsh (USN-5325-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006444.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zsh'
  package(s) announced via the USN-5325-1 advisory.");
...
(CVE-2021-45444)");
  ...
  script_tag(name:"affected", value:"'zsh' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
