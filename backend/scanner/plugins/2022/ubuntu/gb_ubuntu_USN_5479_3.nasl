...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for php7.2 (USN-5479-3)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-July/006661.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.2'
  package(s) announced via the USN-5479-3 advisory.");
...
denial of service, or possibly execute arbitrary code. (CVE-2022-31626)");
  ...
  script_tag(name:"affected", value:"'php7.2' package(s) on Ubuntu 18.04 LTS.");
