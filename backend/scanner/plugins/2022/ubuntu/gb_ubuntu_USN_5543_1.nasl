...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for net-snmp (USN-5543-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-August/006703.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'net-snmp'
  package(s) announced via the USN-5543-1 advisory.");
...
service, or possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'net-snmp' package(s) on Ubuntu 22.04 LTS, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
