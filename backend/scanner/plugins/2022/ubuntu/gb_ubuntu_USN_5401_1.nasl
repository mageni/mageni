...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for dpdk (USN-5401-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006539.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dpdk'
  package(s) announced via the USN-5401-1 advisory.");
...
leading to a denial of service. (CVE-2022-0669)");
  ...
  script_tag(name:"affected", value:"'dpdk' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dpdk", ver:"20.11.5-0ubuntu1", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dpdk", ver:"21.11.1-0ubuntu0.3", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dpdk", ver:"19.11.12-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
