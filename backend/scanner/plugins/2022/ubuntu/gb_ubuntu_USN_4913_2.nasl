...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for underscore (USN-4913-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2021-April/005992.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'underscore'
  package(s) announced via the USN-4913-2 advisory.");
