...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for linux-raspi (USN-5390-2)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006536.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi'
  package(s) announced via the USN-5390-2 advisory.");
...
(system crash) or possibly execute arbitrary code. (CVE-2022-26490)");
  ...
  script_tag(name:"affected", value:"'linux-raspi' package(s) on Ubuntu 22.04 LTS.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1006-raspi", ver:"5.15.0-1006.6", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1006-raspi-nolpae", ver:"5.15.0-1006.6", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.15.0.1006.6", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-nolpae", ver:"5.15.0.1006.6", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
