...
if(description)
{
  ...
  script_cve_id("CVE-2021-3667", "CVE-2021-3975", "CVE-2021-4147", "CVE-2022-0897", "CVE-2020-25637", "CVE-2021-3631");
  ...
  script_name("Ubuntu: Security Advisory for libvirt (USN-5399-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-May/006534.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt'
  package(s) announced via the USN-5399-1 advisory.");
...
LTS. (CVE-2021-3631)");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
