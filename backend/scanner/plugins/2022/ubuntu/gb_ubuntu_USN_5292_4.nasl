...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for snapd (USN-5292-4)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-February/006420.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snapd'
  package(s) announced via the USN-5292-4 advisory.");
...
James discovered that snap did not properly manage the permissions for
