...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for apache-log4j2 (USN-5222-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-January/006343.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-log4j2'
  package(s) announced via the USN-5222-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblog4j2-java", ver:"2.12.4-0ubuntu0.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblog4j2-java", ver:"2.17.1-0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
