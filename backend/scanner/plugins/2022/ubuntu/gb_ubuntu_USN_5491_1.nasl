...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for squid (USN-5491-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006640.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid'
  package(s) announced via the USN-5491-1 advisory.");
...
crash, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on Ubuntu 22.04 LTS, Ubuntu 21.10, Ubuntu 20.04 LTS, Ubuntu 18.04 LTS.");
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"4.13-10ubuntu5.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"3.5.27-1ubuntu1.13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"5.2-1ubuntu4.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"4.10-1ubuntu1.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
