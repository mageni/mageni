...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for expat (USN-5320-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-March/006439.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the USN-5320-1 advisory.");
