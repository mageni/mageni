...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory for curl (USN-5495-1)");
  ...
  script_xref(name:"URL", value:"https://lists.ubuntu.com/archives/ubuntu-security-announce/2022-June/006646.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl'
  package(s) announced via the USN-5495-1 advisory.");
