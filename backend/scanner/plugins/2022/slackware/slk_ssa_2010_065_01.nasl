...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2010.065.01");
  ...
  script_name("Slackware: Security Advisory (SSA:2010-065-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2010-065-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2010&m=slackware-security.332913");
  script_xref(name:"URL", value:"http://www.mozilla.org/security/known-vulnerabilities/firefox30.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-firefox' package(s) announced via the SSA:2010-065-01 advisory.");
...
if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.0.18-i686-1", rls:"SLK12.2"))) {
  report += res;
}
