...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820138");
  ...
  script_name("Fedora: Security Advisory for cabal-rpm (FEDORA-2022-0b216519ff)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-0b216519ff");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T2NL2ULUQUHDLDPE7FTZM2BOGW3JVKLV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cabal-rpm'
  package(s) announced via the FEDORA-2022-0b216519ff advisory.");
...
Standalone packages can also be made, built with cabal-install.");
  ...
  script_tag(name:"affected", value:"'cabal-rpm' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cabal-rpm", rpm:"cabal-rpm~2.0.11~1.fc36", rls:"FC36"))) {
    report += res;
  }
