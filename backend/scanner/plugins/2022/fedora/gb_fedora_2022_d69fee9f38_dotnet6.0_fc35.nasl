...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820626");
  ...
  script_tag(name:"creation_date", value:"2022-05-22 01:07:10 +0000 (Sun, 22 May 2022)");
  script_name("Fedora: Security Advisory for dotnet6.0 (FEDORA-2022-d69fee9f38)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-d69fee9f38");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IBYSBUDJYQ76HK4TULXVIIPCKK2U6WDB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dotnet6.0'
  package(s) announced via the FEDORA-2022-d69fee9f38 advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dotnet6.0", rpm:"dotnet6.0~6.0.105~1.fc35", rls:"FC35"))) {
    report += res;
  }
