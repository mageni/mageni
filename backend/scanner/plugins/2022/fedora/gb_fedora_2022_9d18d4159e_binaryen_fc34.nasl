...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819579");
  ...
  script_tag(name:"creation_date", value:"2022-01-25 02:01:55 +0000 (Tue, 25 Jan 2022)");
  script_name("Fedora: Security Advisory for binaryen (FEDORA-2022-9d18d4159e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-9d18d4159e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UKGCHPS7UAIOOBGSXDJAUFE5CROTTF6J");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'binaryen'
  package(s) announced via the FEDORA-2022-9d18d4159e advisory.");
...
effective:
  ...
  * Effective: Binaryen&#39, s optimizer has many passes that can improve code very
  ...
  script_tag(name:"affected", value:"'binaryen' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binaryen", rpm:"binaryen~105~1.fc34", rls:"FC34"))) {
    report += res;
  }
