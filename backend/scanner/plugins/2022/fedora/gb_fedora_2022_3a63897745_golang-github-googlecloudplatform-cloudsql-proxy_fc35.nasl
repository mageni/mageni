...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820287");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 01:09:22 +0000 (Fri, 29 Apr 2022)");
  script_name("Fedora: Security Advisory for golang-github-googlecloudplatform-cloudsql-proxy (FEDORA-2022-3a63897745)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3WS5N4QY3IGJYBGBNXOXEARQISM4FKLF");
...
Cloud SQL instances when the sockets are used.");
  ...
  script_tag(name:"affected", value:"'golang-github-googlecloudplatform-cloudsql-proxy' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-googlecloudplatform-cloudsql-proxy", rpm:"golang-github-googlecloudplatform-cloudsql-proxy~1.19.1~5.fc35", rls:"FC35"))) {
    report += res;
  }
