...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820219");
  ...
  script_tag(name:"creation_date", value:"2022-04-05 01:04:48 +0000 (Tue, 05 Apr 2022)");
  script_name("Fedora: Security Advisory for phoronix-test-suite (FEDORA-2022-29c30bc7ef)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-29c30bc7ef");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PQ2PBBODEOE3BUCYHL5CV47M72ST4I7S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phoronix-test-suite'
  package(s) announced via the FEDORA-2022-29c30bc7ef advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phoronix-test-suite", rpm:"phoronix-test-suite~10.8.2~1.fc34", rls:"FC34"))) {
    report += res;
  }
