...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822136");
  ...
  script_name("Fedora: Security Advisory for buildah (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/W57MITP4F2GRLTOUDY4NS2VNLHASDXG7");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.26.2~2.fc36", rls:"FC36"))) {
    report += res;
  }
