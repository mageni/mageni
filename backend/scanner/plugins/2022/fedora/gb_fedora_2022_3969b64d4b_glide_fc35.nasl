...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821568");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:30:45 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for glide (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SMXDQVIVSX3VBDQB3RRBIWXIWO7434KB");
...
vendored and distributed with the package.");
  ...
  script_tag(name:"affected", value:"'glide' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glide", rpm:"glide~0.13.2~10.fc35", rls:"FC35"))) {
    report += res;
  }
