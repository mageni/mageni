...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819668");
  ...
  script_tag(name:"creation_date", value:"2022-02-04 02:03:25 +0000 (Fri, 04 Feb 2022)");
  script_name("Fedora: Security Advisory for trojita (FEDORA-2022-46fefaadfd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-46fefaadfd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SSCSDYWJ45IP5FPTTPRDC5HVJUMMI3YM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trojita'
  package(s) announced via the FEDORA-2022-46fefaadfd advisory.");
...
This application is heavily based on Qt and uses WebKit.");
  ...
  script_tag(name:"affected", value:"'trojita' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trojita", rpm:"trojita~0.7.0.1~0.13.20220117git266c757.fc34", rls:"FC34"))) {
    report += res;
  }
