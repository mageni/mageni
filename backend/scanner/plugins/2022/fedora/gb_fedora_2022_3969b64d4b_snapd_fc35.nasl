...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821700");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:38:34 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for snapd (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EZB2GIMB6K5YZ3J6JPK2GLUTCZ7NEPDB");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"snapd", rpm:"snapd~2.56.2~2.fc35", rls:"FC35"))) {
    report += res;
  }
