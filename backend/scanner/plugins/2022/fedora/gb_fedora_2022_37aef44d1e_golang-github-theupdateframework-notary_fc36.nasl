...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822042");
  ...
  script_name("Fedora: Security Advisory for golang-github-theupdateframework-notary (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MW5LK435XLW3V6IBR3DCOUOV42VYT5JV");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-theupdateframework-notary", rpm:"golang-github-theupdateframework-notary~0.7.0~7.fc36", rls:"FC36"))) {
    report += res;
  }
