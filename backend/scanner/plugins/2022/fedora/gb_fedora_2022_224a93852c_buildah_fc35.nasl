...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820220");
  ...
  script_tag(name:"creation_date", value:"2022-04-08 01:05:25 +0000 (Fri, 08 Apr 2022)");
  script_name("Fedora: Security Advisory for buildah (FEDORA-2022-224a93852c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-224a93852c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2VWH6X6HOFPO6HTESF42HIJZEPXSWVIO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah'
  package(s) announced via the FEDORA-2022-224a93852c advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.23.3~2.fc35", rls:"FC35"))) {
    report += res;
  }
