...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821672");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:24:18 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for vgrep (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ZSL2A3MI7M7A43FCLWP2TIGWDJJALOCL");
...
directory trees or showing the context lines before and after the matches.");
  ...
  script_tag(name:"affected", value:"'vgrep' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vgrep", rpm:"vgrep~2.5.6~2.fc35", rls:"FC35"))) {
    report += res;
  }
