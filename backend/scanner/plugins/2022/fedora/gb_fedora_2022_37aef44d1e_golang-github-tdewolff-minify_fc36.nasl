...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821999");
  ...
  script_name("Fedora: Security Advisory for golang-github-tdewolff-minify (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GOLH3CQLOPEUUKC5AKMCVFOJB4KHSJOF");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-tdewolff-minify", rpm:"golang-github-tdewolff-minify~2.11.10~4.fc36", rls:"FC36"))) {
    report += res;
  }
