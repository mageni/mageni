...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820126");
  ...
  script_name("Fedora: Security Advisory for python-fastapi (FEDORA-2022-dbf6e00ba8)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CN7W3GOXALINKFUUE7ICQIC2EF5HNKUQ");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-fastapi", rpm:"python-fastapi~0.75.0~3.fc36", rls:"FC36"))) {
    report += res;
  }
