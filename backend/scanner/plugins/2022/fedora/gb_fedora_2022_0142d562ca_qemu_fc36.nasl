...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820788");
  ...
  script_name("Fedora: Security Advisory for qemu (FEDORA-2022-0142d562ca)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OH65U6FTTB5MLH5A6Q3TW7KVCGOG4MYI");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu", rpm:"qemu~6.2.0~12.fc36", rls:"FC36"))) {
    report += res;
  }
