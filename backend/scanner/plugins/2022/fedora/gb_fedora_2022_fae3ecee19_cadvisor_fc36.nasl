...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821008");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:24:01 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for cadvisor (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EO5PCR4VQYG7CQKB4KD5LUQIYO6LWJIV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cadvisor'
  package(s) announced via the FEDORA-2022-fae3ecee19 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"cAdvisor (Container Advisor) provides container users an understanding of the
...
so feel free to open an issue if that is not the case. cAdvisor&#39, s container
abstraction is based on lmctfy&#39, s so containers are inherently nested
hierarchically.");

  script_tag(name:"affected", value:"'cadvisor' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cadvisor", rpm:"cadvisor~0.44.1~3.fc36", rls:"FC36"))) {
    report += res;
  }
