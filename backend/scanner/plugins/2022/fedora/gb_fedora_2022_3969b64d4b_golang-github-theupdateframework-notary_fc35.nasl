...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821622");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:32:57 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-theupdateframework-notary (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/OVOLFNIATTRU4YK3O3M43WD2XKUTSIK2");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-theupdateframework-notary", rpm:"golang-github-theupdateframework-notary~0.7.0~6.fc35", rls:"FC35"))) {
    report += res;
  }
