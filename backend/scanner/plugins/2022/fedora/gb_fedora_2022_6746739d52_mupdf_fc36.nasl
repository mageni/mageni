...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820169");
  ...
  script_name("Fedora: Security Advisory for mupdf (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BYH37KZZRJCVI5LCENWTTVWZDLBETBAJ");
...
searchable text, and rendering pages to image files is provided.");
  ...
  script_tag(name:"affected", value:"'mupdf' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mupdf", rpm:"mupdf~1.19.0~7.fc36", rls:"FC36"))) {
    report += res;
  }
