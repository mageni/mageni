...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821540");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:28:05 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for micro (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IPEVRHA4FYYXJZW5JYLFZ7ITXOXINUD7");
...
it (like me), or because you need to (over ssh).");
  ...
  script_tag(name:"affected", value:"'micro' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"micro", rpm:"micro~2.0.8~5.fc35", rls:"FC35"))) {
    report += res;
  }
