...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820759");
  ...
  script_name("Fedora: Security Advisory for python3.8 (FEDORA-2022-2e1d1205cf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-2e1d1205cf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FIRUTX47BJD2HYJDLMI7JJBVCYFAPKAQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.8'
  package(s) announced via the FEDORA-2022-2e1d1205cf advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.8", rpm:"python3.8~3.8.13~3.fc35", rls:"FC35"))) {
    report += res;
  }
