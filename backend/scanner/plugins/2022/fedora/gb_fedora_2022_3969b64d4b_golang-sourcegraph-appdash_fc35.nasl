...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821731");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:20:46 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-sourcegraph-appdash (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A5QCMHB7Z5NXGK32PM23IUYHMSVL6IIY");
...
for HTTP (client and server) and SQL are provided, and you can write your own.");
  ...
  script_tag(name:"affected", value:"'golang-sourcegraph-appdash' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-sourcegraph-appdash-0", rpm:"golang-sourcegraph-appdash-0~0.9.20210113gitebfcffb.fc35", rls:"FC35"))) {
    report += res;
  }
