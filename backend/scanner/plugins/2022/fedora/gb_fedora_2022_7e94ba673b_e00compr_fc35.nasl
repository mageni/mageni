...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819531");
  ...
  script_name("Fedora: Security Advisory for e00compr (FEDORA-2022-7e94ba673b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-7e94ba673b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LBTDKJYP6QVE5HN2PGFM45MJEEVZMIJ2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'e00compr'
  package(s) announced via the FEDORA-2022-7e94ba673b advisory.");
...
(e00compr-tools) and the libraries (e00compr-libs).");
  ...
  script_tag(name:"affected", value:"'e00compr' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"e00compr", rpm:"e00compr~1.0.1~28.fc35", rls:"FC35"))) {
    report += res;
  }
