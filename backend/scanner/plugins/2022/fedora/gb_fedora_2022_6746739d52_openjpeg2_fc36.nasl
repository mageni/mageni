...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820114");
  ...
  script_name("Fedora: Security Advisory for openjpeg2 (FEDORA-2022-6746739d52)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SEULZGC2CZW3EY4AEGSIRH5KAP7VLDHB");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.4.0~7.fc36", rls:"FC36"))) {
    report += res;
  }
