...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820774");
  ...
  script_name("Fedora: Security Advisory for python3.7 (FEDORA-2022-4c788bdc40)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-4c788bdc40");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XO2H6CKWLRGTTZCGUQVELW6LUH437Q3O");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.7'
  package(s) announced via the FEDORA-2022-4c788bdc40 advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.7", rpm:"python3.7~3.7.13~2.fc36", rls:"FC36"))) {
    report += res;
  }
