...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819591");
  ...
  script_name("Fedora: Security Advisory for rust-ron0.6 (FEDORA-2022-f3b8d958e8)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/5AWAI7I6NNCIURWTX7UX2MIE3KYMNPNE");
  ...
  script_tag(name:"affected", value:"'rust-ron0.6' package(s) on Fedora 34.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-ron0.6", rpm:"rust-ron0.6~0.6.6~1.fc34", rls:"FC34"))) {
    report += res;
  }
