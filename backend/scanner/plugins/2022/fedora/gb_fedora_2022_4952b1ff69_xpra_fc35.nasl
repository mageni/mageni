...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819788");
  ...
  script_name("Fedora: Security Advisory for xpra (FEDORA-2022-4952b1ff69)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-4952b1ff69");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Y7PNOMOW4V6H5IPOTK2KJRTKRRMQWBNV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xpra'
  package(s) announced via the FEDORA-2022-4952b1ff69 advisory.");
...
network bandwidth constraints.");
  ...
  script_tag(name:"affected", value:"'xpra' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xpra", rpm:"xpra~4.3.2~1.fc35", rls:"FC35"))) {
    report += res;
  }
