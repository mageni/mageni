...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820859");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:33:41 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-etcd-bbolt (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WHOMQ5NDU5FLWNXAVVRHWUZPYVFGG4XW");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-etcd-bbolt", rpm:"golang-etcd-bbolt~1.3.6~4.fc36", rls:"FC36"))) {
    report += res;
  }
