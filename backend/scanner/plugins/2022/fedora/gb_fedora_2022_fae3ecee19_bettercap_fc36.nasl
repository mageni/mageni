...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820947");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:24:47 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for bettercap (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BRJEYID246ZCU7BM76AHEFSM44UR7LZK");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bettercap", rpm:"bettercap~2.32.0~4.fc36", rls:"FC36"))) {
    report += res;
  }
