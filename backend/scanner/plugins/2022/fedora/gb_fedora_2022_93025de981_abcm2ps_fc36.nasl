...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820105");
  ...
  script_tag(name:"creation_date", value:"2022-03-27 01:05:46 +0000 (Sun, 27 Mar 2022)");
  script_name("Fedora: Security Advisory for abcm2ps (FEDORA-2022-93025de981)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-93025de981");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EVGJH4HMXI3TWMHQJQCG3M7KSXJWJM7R");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'abcm2ps'
  package(s) announced via the FEDORA-2022-93025de981 advisory.");
...
music.");
  ...
  script_tag(name:"affected", value:"'abcm2ps' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"abcm2ps", rpm:"abcm2ps~8.14.13~1.fc36", rls:"FC36"))) {
    report += res;
  }
