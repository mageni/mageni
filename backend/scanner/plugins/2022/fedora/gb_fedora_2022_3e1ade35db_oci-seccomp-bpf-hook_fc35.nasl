...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821573");
  ...
  script_name("Fedora: Security Advisory for oci-seccomp-bpf-hook (FEDORA-2022-3e1ade35db)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6CIRWA6JNTPLF2UTMK7GJNTQRIM7HPT3");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"oci-seccomp-bpf-hook", rpm:"oci-seccomp-bpf-hook~1.2.5~3.fc35", rls:"FC35"))) {
    report += res;
  }
