...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820950");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:33:30 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-tdewolff-minify (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DXUDRUZSMLSOSNLZGOYAANDKXI2EKPUK");
...
UglifyCSS, ...).");
  ...
  script_tag(name:"affected", value:"'golang-github-tdewolff-minify' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-tdewolff-minify", rpm:"golang-github-tdewolff-minify~2.11.10~3.fc36", rls:"FC36"))) {
    report += res;
  }
