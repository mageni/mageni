...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821542");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:37:46 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-x-mod (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6IFYSEEPLPQX3PXLN46ND6Z6ICU25CGM");
...
mechanics. That is, it is for direct manipulation of Go modules themselves.");
  ...
  script_tag(name:"affected", value:"'golang-x-mod' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-x-mod-0.6.0-dev", rpm:"golang-x-mod-0.6.0-dev~3.20220330git9b9b3d8.fc35", rls:"FC35"))) {
    report += res;
  }
