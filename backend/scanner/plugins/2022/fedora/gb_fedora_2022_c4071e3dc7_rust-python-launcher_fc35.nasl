...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819614");
  ...
  script_name("Fedora: Security Advisory for rust-python-launcher (FEDORA-2022-c4071e3dc7)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WPZL73LV2N7N5GKJYZVEIR677FQPAXQS");
...
The Python Launcher should be viewed as a tool of convenience, not necessity.");
  ...
  script_tag(name:"affected", value:"'rust-python-launcher' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-python-launcher", rpm:"rust-python-launcher~1.0.0~4.fc35", rls:"FC35"))) {
    report += res;
  }
