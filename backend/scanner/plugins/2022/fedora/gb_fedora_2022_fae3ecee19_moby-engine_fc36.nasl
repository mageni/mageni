...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820920");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:32:23 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for moby-engine (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EVINETANORK4VAUN6BGZNWFDNECFYAD2");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"moby-engine", rpm:"moby-engine~20.10.17~3.fc36", rls:"FC36"))) {
    report += res;
  }
