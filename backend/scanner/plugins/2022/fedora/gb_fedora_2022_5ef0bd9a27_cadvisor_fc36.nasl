...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821971");
  ...
  script_name("Fedora: Security Advisory for cadvisor (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M5BZCVHEZG6UY75MM7WW36S47JUL4FJR");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cadvisor", rpm:"cadvisor~0.44.1~4.fc36", rls:"FC36"))) {
    report += res;
  }
