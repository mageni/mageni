...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820542");
  ...
  script_name("Fedora: Security Advisory for unrealircd (FEDORA-2022-c51b3a7f19)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-c51b3a7f19");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VWCPVWUKULAL74EBOEIGTL6ZEGSNZP7N");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'unrealircd'
  package(s) announced via the FEDORA-2022-c51b3a7f19 advisory.");
...
flood and anti-spam systems, swear filtering and module support.");
  ...
  script_tag(name:"affected", value:"'unrealircd' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"unrealircd", rpm:"unrealircd~6.0.3~1.fc36", rls:"FC36"))) {
    report += res;
  }
