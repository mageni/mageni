...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821483");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:22:59 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-burntsushi-toml-test (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/H6BNNJAB5ABWRIGSVVJ422JJ7PA7HSK6");
...
format as the JSON that a TOML decoder should output.");
  ...
  script_tag(name:"affected", value:"'golang-github-burntsushi-toml-test' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-burntsushi-toml-test", rpm:"golang-github-burntsushi-toml-test~0.2.0~11.20210108git9767d20.fc35", rls:"FC35"))) {
    report += res;
  }
