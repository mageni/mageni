...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820137");
  ...
  script_tag(name:"creation_date", value:"2022-03-31 01:04:48 +0000 (Thu, 31 Mar 2022)");
  script_name("Fedora: Security Advisory for phoronix-test-suite (FEDORA-2022-e790a2739f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-e790a2739f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KSQH5OWXAMWSM7H6VSBRDGTOE7UIOZHZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phoronix-test-suite'
  package(s) announced via the FEDORA-2022-e790a2739f advisory.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phoronix-test-suite", rpm:"phoronix-test-suite~10.8.2~1.fc36", rls:"FC36"))) {
    report += res;
  }
