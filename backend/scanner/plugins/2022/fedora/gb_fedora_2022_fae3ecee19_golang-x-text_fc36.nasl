...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820885");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:30:42 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-x-text (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YIGFUJUGMFHE2EW763ZPMKSD5SKMZUQU");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-x-text", rpm:"golang-x-text~0.3.7~2.fc36", rls:"FC36"))) {
    report += res;
  }
