...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822122");
  ...
  script_name("Fedora: Security Advisory for golang-google-protobuf (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/35QVLJDO2MKIXEVFNW445ZFPMU5NS36Q");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-google-protobuf", rpm:"golang-google-protobuf~1.27.1~6.fc36", rls:"FC36"))) {
    report += res;
  }
