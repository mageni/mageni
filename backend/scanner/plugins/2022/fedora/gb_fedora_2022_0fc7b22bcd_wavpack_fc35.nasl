...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820328");
  ...
  script_name("Fedora: Security Advisory for wavpack (FEDORA-2022-0fc7b22bcd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-0fc7b22bcd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CRZWZKEEABCLVXZEXQZBIT3ZKLIXVFF5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wavpack'
  package(s) announced via the FEDORA-2022-0fc7b22bcd advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wavpack", rpm:"wavpack~5.4.0~5.fc35", rls:"FC35"))) {
    report += res;
  }
