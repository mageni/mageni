...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821595");
  ...
  script_tag(name:"creation_date", value:"2022-07-18 01:21:12 +0000 (Mon, 18 Jul 2022)");
  script_name("Fedora: Security Advisory for cadvisor (FEDORA-2022-3969b64d4b)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A52OLIQOGA7RUX6AK2RCJVDXTR2KB7GS");
...
hierarchically.");
  ...
  script_tag(name:"affected", value:"'cadvisor' package(s) on Fedora 35.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cadvisor", rpm:"cadvisor~0.44.1~3.fc35", rls:"FC35"))) {
    report += res;
  }
