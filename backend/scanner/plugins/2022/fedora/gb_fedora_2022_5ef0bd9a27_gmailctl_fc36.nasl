...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.822200");
  ...
  script_name("Fedora: Security Advisory for gmailctl (FEDORA-2022-5ef0bd9a27)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ARYSMNCHBVHALCPCAWP7R7SVUJZJXARR");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gmailctl", rpm:"gmailctl~0.10.4~4.fc36", rls:"FC36"))) {
    report += res;
  }
