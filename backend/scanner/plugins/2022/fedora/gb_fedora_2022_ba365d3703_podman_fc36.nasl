...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821750");
  ...
  script_tag(name:"creation_date", value:"2022-07-14 01:14:58 +0000 (Thu, 14 Jul 2022)");
  script_name("Fedora: Security Advisory for podman (FEDORA-2022-ba365d3703)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VIJZWIJZ5DA2DOH2MWXH3LFGRVVDHPDP");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~4.1.1~2.fc36", rls:"FC36"))) {
    report += res;
  }
