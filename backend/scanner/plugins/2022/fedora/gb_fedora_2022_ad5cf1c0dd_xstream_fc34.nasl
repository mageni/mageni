...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819751");
  ...
  script_tag(name:"creation_date", value:"2022-02-12 02:03:02 +0000 (Sat, 12 Feb 2022)");
  script_name("Fedora: Security Advisory for xstream (FEDORA-2022-ad5cf1c0dd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-ad5cf1c0dd");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XODFRE2ZL64FICBJDOPWOLPTSSAI4U7X");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xstream'
  package(s) announced via the FEDORA-2022-ad5cf1c0dd advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xstream", rpm:"xstream~1.4.19~1.fc34", rls:"FC34"))) {
    report += res;
  }
