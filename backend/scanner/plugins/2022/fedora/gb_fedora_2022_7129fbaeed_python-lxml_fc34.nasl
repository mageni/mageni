...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819575");
  ...
  script_tag(name:"creation_date", value:"2022-01-23 02:09:51 +0000 (Sun, 23 Jan 2022)");
  script_name("Fedora: Security Advisory for python-lxml (FEDORA-2022-7129fbaeed)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-7129fbaeed");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/V2XMOM5PFT6U5AAXY6EFNT5JZCKKHK2V");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-lxml'
  package(s) announced via the FEDORA-2022-7129fbaeed advisory.");
...
if(release == "FC34") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-lxml", rpm:"python-lxml~4.6.5~1.fc34", rls:"FC34"))) {
    report += res;
  }
