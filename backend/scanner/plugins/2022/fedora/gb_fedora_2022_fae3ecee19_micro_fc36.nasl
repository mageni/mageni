...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820880");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:38:25 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for micro (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RBQ5U4XRWKYNW2DNIZ7TNOIC5HZ6JXVA");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"micro", rpm:"micro~2.0.8~5.fc36", rls:"FC36"))) {
    report += res;
  }
