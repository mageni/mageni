...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821050");
  ...
  script_tag(name:"creation_date", value:"2022-07-06 01:37:07 +0000 (Wed, 06 Jul 2022)");
  script_name("Fedora: Security Advisory for golang-github-pkg-diff (FEDORA-2022-fae3ecee19)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ROOLLSNK7PHXSVELXC3CLT5SSUZOWV4T");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-pkg-diff'
  package(s) announced via the FEDORA-2022-fae3ecee19 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Module can be used to create, modify, and print diffs.
...
The subpackages provide very fine-grained control over every aspect:
  ...
  script_tag(name:"affected", value:"'golang-github-pkg-diff' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-pkg-diff-0", rpm:"golang-github-pkg-diff-0~0.4.20210406git20ebb0f.fc36", rls:"FC36"))) {
    report += res;
  }
