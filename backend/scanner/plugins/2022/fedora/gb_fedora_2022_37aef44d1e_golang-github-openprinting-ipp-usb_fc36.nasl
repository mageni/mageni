...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821942");
  ...
  script_name("Fedora: Security Advisory for golang-github-openprinting-ipp-usb (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MNLTBBHF2NU6Z2PYY54ZTDV32B4TIAQN");
 ...
 driverless support for USB devices capable of using IPP-over-USB protocol.");
  ...
  script_tag(name:"affected", value:"'golang-github-openprinting-ipp-usb' package(s) on Fedora 36.");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-openprinting-ipp-usb", rpm:"golang-github-openprinting-ipp-usb~0.9.22~2.fc36", rls:"FC36"))) {
    report += res;
  }
