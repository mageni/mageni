...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821968");
  ...
  script_name("Fedora: Security Advisory for golang-github-ulikunitz-xz (FEDORA-2022-37aef44d1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WRUQE3OY75IBUBIEUT67ZASSOT7B7A7C");
...
if(release == "FC36") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-ulikunitz-xz", rpm:"golang-github-ulikunitz-xz~0.5.10~5.fc36", rls:"FC36"))) {
    report += res;
  }
