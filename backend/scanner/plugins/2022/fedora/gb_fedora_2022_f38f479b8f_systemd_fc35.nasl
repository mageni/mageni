...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819545");
  ...
  script_name("Fedora: Security Advisory for systemd (FEDORA-2022-f38f479b8f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2022-f38f479b8f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VB6N3BUJM4QNTUFDHJ7GEUDM3DCRYM4I");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the FEDORA-2022-f38f479b8f advisory.");
...
if(release == "FC35") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"systemd", rpm:"systemd~249.9~1.fc35", rls:"FC35"))) {
    report += res;
  }
