...
if(description)
{
  ...
  script_name("VMware Spring Boot RCE Vulnerability (Spring4Shell, SpringShell) - Version Check");
  ...
  script_tag(name:"affected", value:"VMware Spring Boot version 2.5.11 and prior and version
  2.6.x through 2.6.5.
...
if( version_in_range( version:version, test_version:"2.6.0", test_version2:"2.6.5" ) ) {
