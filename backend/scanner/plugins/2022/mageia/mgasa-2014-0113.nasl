...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mediawiki, mediawiki, mediawiki-ldapauthentication, mediawiki-ldapauthentication, mediawiki-math, mediawiki-math' package(s) announced via the MGASA-2014-0113 advisory.");
...
will need to maintain separate wiki instances manually.");
  ...
  script_tag(name:"affected", value:"'mediawiki, mediawiki, mediawiki-ldapauthentication, mediawiki-ldapauthentication, mediawiki-math, mediawiki-math' package(s) on Mageia 3, Mageia 4.");
