...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2021.0549");
  ...
  script_name("Mageia: Security Advisory (MGASA-2021-0549)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2021-0549");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2021-0549.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=29622");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/thread/3TDGZFLBOP27LZKLH45WQLSNPSPP7S7Z/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curaengine' package(s) announced via the MGASA-2021-0549 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Buffer overflow vulnerability in function stbi__extend_receive in
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curaengine", rpm:"curaengine~4.8.0~1.1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
