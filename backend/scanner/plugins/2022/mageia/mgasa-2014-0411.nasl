...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsyslog, rsyslog' package(s) announced via the MGASA-2014-0411 advisory.");
...
sources, and trigger a denial of service attack (CVE-2014-3634).");
  ...
  script_tag(name:"affected", value:"'rsyslog, rsyslog' package(s) on Mageia 3, Mageia 4.");
