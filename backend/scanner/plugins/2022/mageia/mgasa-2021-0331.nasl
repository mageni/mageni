...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'connman, connman' package(s) announced via the MGASA-2021-0331 advisory.");
...
(for A or AAAA) (CVE-2021-33833).");
  ...
  script_tag(name:"affected", value:"'connman, connman' package(s) on Mageia 7, Mageia 8.");
