...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dbus, dbus' package(s) announced via the MGASA-2013-0173 advisory.");
...
but we advise that all systems should be updated.");
  ...
  script_tag(name:"affected", value:"'dbus, dbus' package(s) on Mageia 2, Mageia 3.");
