...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'fail2ban, fail2ban' package(s) announced via the MGASA-2014-0176 advisory.");
...
(CVE-2013-7176).");
  ...
  script_tag(name:"affected", value:"'fail2ban, fail2ban' package(s) on Mageia 3, Mageia 4.");
