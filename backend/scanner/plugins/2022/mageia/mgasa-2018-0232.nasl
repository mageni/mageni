...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'qpdf, qpdf' package(s) announced via the MGASA-2018-0232 advisory.");
...
(CVE-2018-9918).");
  ...
  script_tag(name:"affected", value:"'qpdf, qpdf' package(s) on Mageia 5, Mageia 6.");
