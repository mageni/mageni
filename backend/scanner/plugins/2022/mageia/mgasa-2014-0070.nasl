...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'socat, socat' package(s) announced via the MGASA-2014-0070 advisory.");
...
scripts that receive data from untrusted sources (CVE-2014-0019).");
  ...
  script_tag(name:"affected", value:"'socat, socat' package(s) on Mageia 3, Mageia 4.");
