...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2017-0359");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2017-0359.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=21755");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rawtherapee, rawtherapee' package(s) announced via the MGASA-2017-0359 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that rawtherapee had a floating point exception in the
...
service and code execution attack (CVE-2017-14265).");
  ...
  script_tag(name:"affected", value:"'rawtherapee, rawtherapee' package(s) on Mageia 5, Mageia 6.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rawtherapee", rpm:"rawtherapee~4.1~4.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rawtherapee", rpm:"rawtherapee~5.1~1.2.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
