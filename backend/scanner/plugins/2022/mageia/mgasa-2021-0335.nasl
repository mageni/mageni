...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-smarty, php-smarty' package(s) announced via the MGASA-2021-0335 advisory.");
...
after a {function name= substring (CVE-2021-26120).");
  ...
  script_tag(name:"affected", value:"'php-smarty, php-smarty' package(s) on Mageia 7, Mageia 8.");
