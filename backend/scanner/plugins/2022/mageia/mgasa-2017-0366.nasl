...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'x11-server, x11-server' package(s) announced via the MGASA-2017-0366 advisory.");
...
longer than anticipated (CVE-2017-13723).");
  ...
  script_tag(name:"affected", value:"'x11-server, x11-server' package(s) on Mageia 5, Mageia 6.");
