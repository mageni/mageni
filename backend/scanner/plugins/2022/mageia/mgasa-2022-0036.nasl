...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2022.0036");
  script_cve_id("CVE-2022-23807", "CVE-2022-23808");
  ...
  script_name("Mageia: Security Advisory (MGASA-2022-0036)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2022-0036");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2022-0036.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=29931");
  script_xref(name:"URL", value:"https://www.phpmyadmin.net/news/2022/1/22/phpmyadmin-498-512-and-520-rc1-are-released/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpmyadmin' package(s) announced via the MGASA-2022-0036 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was identified in how phpMyAdmin processes two factor
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phpmyadmin", rpm:"phpmyadmin~5.1.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
