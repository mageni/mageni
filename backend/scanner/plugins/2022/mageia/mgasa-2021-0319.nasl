...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libupnp, libupnp' package(s) announced via the MGASA-2021-0319 advisory.");
...
(CVE-2021-29462).");
  ...
  script_tag(name:"affected", value:"'libupnp, libupnp' package(s) on Mageia 7, Mageia 8.");
