...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rxvt-unicode, rxvt-unicode' package(s) announced via the MGASA-2014-0202 advisory.");
...
(CVE-2014-3121).");
  ...
  script_tag(name:"affected", value:"'rxvt-unicode, rxvt-unicode' package(s) on Mageia 3, Mageia 4.");
