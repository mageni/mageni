...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'polarssl, polarssl' package(s) announced via the MGASA-2014-0481 advisory.");
...
tool and fixed in PolarSSL 1.3.9 (CVE-2014-8628).");
  ...
  script_tag(name:"affected", value:"'polarssl, polarssl' package(s) on Mageia 3, Mageia 4.");
