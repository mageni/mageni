...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xpdf, xpdf' package(s) announced via the MGASA-2021-0112 advisory.");
...
(CVE-2020-35376).");
  ...
  script_tag(name:"affected", value:"'xpdf, xpdf' package(s) on Mageia 7, Mageia 8.");
