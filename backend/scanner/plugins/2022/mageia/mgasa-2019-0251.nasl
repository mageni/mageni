...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang, golang' package(s) announced via the MGASA-2019-0251 advisory.");
...
(CVE-2019-14809)");
  ...
  script_tag(name:"affected", value:"'golang, golang' package(s) on Mageia 6, Mageia 7.");
