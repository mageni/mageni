...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-29 14:24:00 +0000 (Mon, 29 Jul 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openswan, openswan' package(s) announced via the MGASA-2014-0097 advisory.");
...
dropped (CVE-2013-6466).");
  ...
  script_tag(name:"affected", value:"'openswan, openswan' package(s) on Mageia 3, Mageia 4.");
