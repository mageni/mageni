...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'italc, italc' package(s) announced via the MGASA-2014-0359 advisory.");
...
part of liblzo containing the vulnerable code.");
  ...
  script_tag(name:"affected", value:"'italc, italc' package(s) on Mageia 3, Mageia 4.");
