...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox, firefox-l10n, firefox-l10n, libpng, libvpx, libvpx, nss, nss, sqlite3, sqlite3, thunderbird, thunderbird, thunderbird-l10n, thunderbird-l10n, thunderbird-lightning, thunderbird-lightning' package(s) announced via the MGASA-2014-0421 advisory.");
...
being sent in plain text unexpectedly (CVE-2014-5369).");
  ...
  script_tag(name:"affected", value:"'firefox, firefox, firefox-l10n, firefox-l10n, libpng, libvpx, libvpx, nss, nss, sqlite3, sqlite3, thunderbird, thunderbird, thunderbird-l10n, thunderbird-l10n, thunderbird-lightning, thunderbird-lightning' package(s) on Mageia 3, Mageia 4.");
