...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdk-pixbuf2.0, gdk-pixbuf2.0' package(s) announced via the MGASA-2018-0016 advisory.");
...
affected Mageia 5.");
  ...
  script_tag(name:"affected", value:"'gdk-pixbuf2.0, gdk-pixbuf2.0' package(s) on Mageia 5, Mageia 6.");
