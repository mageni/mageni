...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2017.0051");
  ...
  script_name("Mageia: Security Advisory (MGASA-2017-0051)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2017-0051");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2017-0051.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=20038");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2016-12/msg00095.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjpeg2' package(s) announced via the MGASA-2017-0051 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Floating Point Exception (aka FPE or divide by zero) in opj_pi_next_cprl
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64openjp2_7", rpm:"lib64openjp2_7~2.1.2~1.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64openjpeg2-devel", rpm:"lib64openjpeg2-devel~2.1.2~1.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenjp2_7", rpm:"libopenjp2_7~2.1.2~1.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenjpeg2-devel", rpm:"libopenjpeg2-devel~2.1.2~1.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.1.2~1.2.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
