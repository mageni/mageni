...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-phpmailer, php-phpmailer' package(s) announced via the MGASA-2021-0345 advisory.");
...
See upstream release notes.");
  ...
  script_tag(name:"affected", value:"'php-phpmailer, php-phpmailer' package(s) on Mageia 7, Mageia 8.");
