...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'quassel, quassel' package(s) announced via the MGASA-2018-0243 advisory.");
...
other fixes and improvements.");
  ...
  script_tag(name:"affected", value:"'quassel, quassel' package(s) on Mageia 5, Mageia 6.");
