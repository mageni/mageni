...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq, dnsmasq' package(s) announced via the MGASA-2021-0231 advisory.");
...
This kind of configuration is the default when network-manager uses dnsmasq.");
  ...
  script_tag(name:"affected", value:"'dnsmasq, dnsmasq' package(s) on Mageia 7, Mageia 8.");
