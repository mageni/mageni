...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'lighttpd, lighttpd' package(s) announced via the MGASA-2014-0133 advisory.");
...
validation of hostnames in HTTP requests (CVE-2014-2324).");
  ...
  script_tag(name:"affected", value:"'lighttpd, lighttpd' package(s) on Mageia 3, Mageia 4.");
