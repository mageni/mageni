...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kmod-virtualbox, kmod-virtualbox, virtualbox, virtualbox' package(s) announced via the MGASA-2021-0197 advisory.");
...
Successful attacks of this vulnerability can result in ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'kmod-virtualbox, kmod-virtualbox, virtualbox, virtualbox' package(s) on Mageia 7, Mageia 8.");
