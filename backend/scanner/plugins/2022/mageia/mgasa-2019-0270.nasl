...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'links, links' package(s) announced via the MGASA-2019-0270 advisory.");
...
link rel='dns-prefetch' code");
  ...
  script_tag(name:"affected", value:"'links, links' package(s) on Mageia 6, Mageia 7.");
