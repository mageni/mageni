...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2021.0104");
  ...
  script_name("Mageia: Security Advisory (MGASA-2021-0104)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2021-0104");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2021-0104.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=28500");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-firmware-nonfree' package(s) announced via the MGASA-2021-0104 advisory.");
...
* rtlwifi-firmware:
 - rtw89: 8852a: add firmware v0.9.12.2");
  ...
  script_tag(name:"affected", value:"'kernel-firmware-nonfree' package(s) on Mageia 8.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"iwlwifi-firmware", rpm:"iwlwifi-firmware~20210223~1.mga8.nonfree", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware-nonfree", rpm:"kernel-firmware-nonfree~20210223~1.mga8.nonfree", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ralink-firmware", rpm:"ralink-firmware~20210223~1.mga8.nonfree", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rtlwifi-firmware", rpm:"rtlwifi-firmware~20210223~1.mga8.nonfree", rls:"MAGEIA8"))) {
    report += res;
  }
