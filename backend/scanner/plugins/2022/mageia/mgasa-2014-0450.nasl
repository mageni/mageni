...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-12-19 19:14:00 +0000 (Fri, 19 Dec 2014)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'getmail, getmail' package(s) announced via the MGASA-2014-0450 advisory.");
...
crafted certificate (CVE-2014-7275).");
  ...
  script_tag(name:"affected", value:"'getmail, getmail' package(s) on Mageia 3, Mageia 4.");
