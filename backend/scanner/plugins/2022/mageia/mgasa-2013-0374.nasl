...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2013.0374");
  ...
  script_name("Mageia: Security Advisory (MGASA-2013-0374)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2013-0374");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2013-0374.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=11466");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-rt' package(s) announced via the MGASA-2013-0374 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This kernel-rt update provides an update to the 3.10 longterm branch,
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-3.10.24-0.rt20.2.mga3", rpm:"kernel-rt-3.10.24-0.rt20.2.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt", rpm:"kernel-rt~3.10.24~0.rt20.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-devel-3.10.24-0.rt20.2.mga3", rpm:"kernel-rt-devel-3.10.24-0.rt20.2.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-devel-latest", rpm:"kernel-rt-devel-latest~3.10.24~0.rt20.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-doc", rpm:"kernel-rt-doc~3.10.24~0.rt20.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-latest", rpm:"kernel-rt-latest~3.10.24~0.rt20.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-source-3.10.24-0.rt20.2.mga3", rpm:"kernel-rt-source-3.10.24-0.rt20.2.mga3~1~1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-rt-source-latest", rpm:"kernel-rt-source-latest~3.10.24~0.rt20.2.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
