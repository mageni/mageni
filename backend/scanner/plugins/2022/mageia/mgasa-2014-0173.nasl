...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tigervnc, tigervnc' package(s) announced via the MGASA-2014-0173 advisory.");
...
RLE decoding (CVE-2014-0011).");
  ...
  script_tag(name:"affected", value:"'tigervnc, tigervnc' package(s) on Mageia 3, Mageia 4.");
