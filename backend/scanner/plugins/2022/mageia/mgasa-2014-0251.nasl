...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libcap-ng, libcap-ng' package(s) announced via the MGASA-2014-0251 advisory.");
...
(CVE-2014-3215).");
  ...
  script_tag(name:"affected", value:"'libcap-ng, libcap-ng' package(s) on Mageia 3, Mageia 4.");
