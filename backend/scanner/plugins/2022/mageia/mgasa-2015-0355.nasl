...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pure-ftpd, pure-ftpd' package(s) announced via the MGASA-2015-0355 advisory.");
...
trying to match a file pattern longer than the maximum length for a path.");
  ...
  script_tag(name:"affected", value:"'pure-ftpd, pure-ftpd' package(s) on Mageia 4, Mageia 5.");
