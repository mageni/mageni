...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssh, openssh' package(s) announced via the MGASA-2015-0321 advisory.");
...
for remote code execution (rhbz#1252852).");
  ...
  script_tag(name:"affected", value:"'openssh, openssh' package(s) on Mageia 4, Mageia 5.");
