...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2019.0334");
  ...
  script_name("Mageia: Security Advisory (MGASA-2019-0334)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2019-0334");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2019-0334.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode' package(s) announced via the MGASA-2019-0334 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update provides the Intel 20191112 microcode release that adds the
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode", rpm:"microcode~0.20191112~1.mga7.nonfree", rls:"MAGEIA7"))) {
    report += res;
  }
