...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql9.4, postgresql9.4, postgresql9.6' package(s) announced via the MGASA-2018-0137 advisory.");
...
of the postgresql9.3 package should migrate to 9.4.");
  ...
  script_tag(name:"affected", value:"'postgresql9.4, postgresql9.4, postgresql9.6' package(s) on Mageia 5, Mageia 6.");
