...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'elfutils, elfutils' package(s) announced via the MGASA-2014-0177 advisory.");
...
the application (CVE-2014-0172).");
  ...
  script_tag(name:"affected", value:"'elfutils, elfutils' package(s) on Mageia 3, Mageia 4.");
