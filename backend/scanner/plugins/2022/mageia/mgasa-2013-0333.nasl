...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libjpeg, libjpeg' package(s) announced via the MGASA-2013-0333 advisory.");
...
(CVE-2013-6630).");
  ...
  script_tag(name:"affected", value:"'libjpeg, libjpeg' package(s) on Mageia 2, Mageia 3.");
