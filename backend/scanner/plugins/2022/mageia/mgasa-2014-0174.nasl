...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'jbigkit, jbigkit' package(s) announced via the MGASA-2014-0174 advisory.");
...
force the jbig85 decoder into an end-less loop.");
  ...
  script_tag(name:"affected", value:"'jbigkit, jbigkit' package(s) on Mageia 3, Mageia 4.");
