...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2013.0178");
  ...
  script_name("Mageia: Security Advisory (MGASA-2013-0178)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2013-0178");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2013-0178.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=10528");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-updates/2013-06/msg00146.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nfs-utils, nfs-utils' package(s) announced via the MGASA-2013-0178 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was reported that rpc.gssd in nfs-utils is vulnerable to DNS spoofing due
...
is talking to the 'correct' server (CVE-2013-1923).");
  ...
  script_tag(name:"affected", value:"'nfs-utils, nfs-utils' package(s) on Mageia 2, Mageia 3.");
...
if(release == "MAGEIA2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nfs-utils", rpm:"nfs-utils~1.2.5~1.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nfs-utils-clients", rpm:"nfs-utils-clients~1.2.5~1.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nfs-utils", rpm:"nfs-utils~1.2.7~3.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
