...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2013.0185");
  ...
  script_name("Mageia: Security Advisory (MGASA-2013-0185)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2013-0185");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2013-0185.html");
  script_xref(name:"URL", value:"http://www.oracle.com/technetwork/topics/security/javacpujun2013-1899847.html");
  script_xref(name:"URL", value:"https://rhn.redhat.com/errata/RHSA-2013-0957.html");
  script_xref(name:"URL", value:"https://rhn.redhat.com/errata/RHBA-2013-0959.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=10564");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icedtea-web, java-1.7.0-openjdk, java-1.7.0-openjdk' package(s) announced via the MGASA-2013-0185 advisory.");
...
phishing attack by providing frame content that spoofed a login ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'icedtea-web, java-1.7.0-openjdk, java-1.7.0-openjdk' package(s) on Mageia 2, Mageia 3.");
...
if(release == "MAGEIA2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk", rpm:"java-1.7.0-openjdk~1.7.0.25~2.3.10.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-demo", rpm:"java-1.7.0-openjdk-demo~1.7.0.25~2.3.10.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.25~2.3.10.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-javadoc", rpm:"java-1.7.0-openjdk-javadoc~1.7.0.25~2.3.10.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-src", rpm:"java-1.7.0-openjdk-src~1.7.0.25~2.3.10.1.mga2", rls:"MAGEIA2"))) {
    report += res;
  }
...
if(release == "MAGEIA3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"icedtea-web", rpm:"icedtea-web~1.3.2~1.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icedtea-web-javadoc", rpm:"icedtea-web-javadoc~1.3.2~1.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk", rpm:"java-1.7.0-openjdk~1.7.0.25~2.3.10.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-demo", rpm:"java-1.7.0-openjdk-demo~1.7.0.25~2.3.10.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-devel", rpm:"java-1.7.0-openjdk-devel~1.7.0.25~2.3.10.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-javadoc", rpm:"java-1.7.0-openjdk-javadoc~1.7.0.25~2.3.10.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1.7.0-openjdk-src", rpm:"java-1.7.0-openjdk-src~1.7.0.25~2.3.10.1.mga3", rls:"MAGEIA3"))) {
    report += res;
  }
