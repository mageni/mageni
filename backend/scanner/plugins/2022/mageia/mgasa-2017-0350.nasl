...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'bluez, bluez' package(s) announced via the MGASA-2017-0350 advisory.");
...
keys (CVE-2017-1000250).");
  ...
  script_tag(name:"affected", value:"'bluez, bluez' package(s) on Mageia 5, Mageia 6.");
