...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'discover, discover' package(s) announced via the MGASA-2021-0146 advisory.");
...
sense to do that verification (CVE-2021-28117).");
  ...
  script_tag(name:"affected", value:"'discover, discover' package(s) on Mageia 7, Mageia 8.");
