...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ipython, ipython' package(s) announced via the MGASA-2014-0320 advisory.");
...
visits a crafted malicious page (CVE-2014-3429).");
  ...
  script_tag(name:"affected", value:"'ipython, ipython' package(s) on Mageia 3, Mageia 4.");
