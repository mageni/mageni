...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nas, nas' package(s) announced via the MGASA-2013-0298 advisory.");
...
Race when opening a TCP device (nas#289).");
  ...
  script_tag(name:"affected", value:"'nas, nas' package(s) on Mageia 2, Mageia 3.");
