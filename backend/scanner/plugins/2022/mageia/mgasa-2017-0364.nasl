...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2017.0364");
  ...
  script_name("Mageia: Security Advisory (MGASA-2017-0364)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2017-0364");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2017-0364.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq' package(s) announced via the MGASA-2017-0364 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2017-13704: Dnsmasq could be made to crash on a large DNS query. A
...
if(release == "MAGEIA6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.77~1.2.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dnsmasq-base", rpm:"dnsmasq-base~2.77~1.2.mga6", rls:"MAGEIA6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dnsmasq-utils", rpm:"dnsmasq-utils~2.77~1.2.mga6", rls:"MAGEIA6"))) {
    report += res;
  }
