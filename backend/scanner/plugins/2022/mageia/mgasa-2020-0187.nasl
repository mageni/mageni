...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2020.0187");
  ...
  script_name("Mageia: Security Advisory (MGASA-2020-0187)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2020-0187");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2020-0187.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=26532");
  script_xref(name:"URL", value:"http://www.squid-cache.org/Advisories/SQUID-2020_4.txt");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the MGASA-2020-0187 advisory.");
...
if(release == "MAGEIA7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~4.11~1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~4.11~1.mga7", rls:"MAGEIA7"))) {
    report += res;
  }
