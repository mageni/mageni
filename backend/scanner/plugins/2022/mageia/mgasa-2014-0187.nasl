...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-10-10 20:09:00 +0000 (Wed, 10 Oct 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl, openssl' package(s) announced via the MGASA-2014-0187 advisory.");
