...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox, firefox-l10n, firefox-l10n, nspr, nspr, nss, nss, rootcerts, rootcerts' package(s) announced via the MGASA-2021-0236 advisory.");
...
- Neither audio nor video with BigBlueButton and other WebRTC services
 with our packaged version of Firefox ESR (Bug 27374).");
  ...
  script_tag(name:"affected", value:"'firefox, firefox, firefox-l10n, firefox-l10n, nspr, nspr, nss, nss, rootcerts, rootcerts' package(s) on Mageia 7, Mageia 8.");
