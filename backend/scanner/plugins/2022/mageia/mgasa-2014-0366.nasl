...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django, python-django, python-django14' package(s) announced via the MGASA-2014-0366 advisory.");
