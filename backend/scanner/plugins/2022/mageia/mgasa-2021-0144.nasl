...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xmlgraphics-commons, xmlgraphics-commons' package(s) announced via the MGASA-2021-0144 advisory.");
...
requests (CVE-2020-11988).");
  ...
  script_tag(name:"affected", value:"'xmlgraphics-commons, xmlgraphics-commons' package(s) on Mageia 7, Mageia 8.");
