...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-21 18:29:00 +0000 (Fri, 21 Dec 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xerces-j2, xerces-j2' package(s) announced via the MGASA-2014-0398 advisory.");
...
application to use an excessive amount of CPU (CVE-2013-4002).");
  ...
  script_tag(name:"affected", value:"'xerces-j2, xerces-j2' package(s) on Mageia 3, Mageia 4.");
