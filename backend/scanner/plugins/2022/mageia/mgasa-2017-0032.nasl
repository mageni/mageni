...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-pycrypto' package(s) announced via the MGASA-2017-0032 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This is a security fix for a possible Buffer overflow.
...
There was a bug in pycrypto which could be exploited to get a shell.");
  ...
  script_tag(name:"affected", value:"'python-pycrypto' package(s) on Mageia 5.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-pycrypto", rpm:"python-pycrypto~2.6.1~6.1.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-pycrypto", rpm:"python3-pycrypto~2.6.1~6.1.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
