...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2014.0385");
  ...
  script_name("Mageia: Security Advisory (MGASA-2014-0385)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2014-0385");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2014-0385.html");
  ...
  script_xref(name:"URL", value:"http://curl.haxx.se/docs/adv_20140910B.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the MGASA-2014-0385 advisory.");
...
if(release == "MAGEIA4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.34.0~1.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"curl-examples", rpm:"curl-examples~7.34.0~1.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64curl-devel", rpm:"lib64curl-devel~7.34.0~1.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64curl4", rpm:"lib64curl4~7.34.0~1.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl-devel", rpm:"libcurl-devel~7.34.0~1.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl4", rpm:"libcurl4~7.34.0~1.3.mga4", rls:"MAGEIA4"))) {
    report += res;
  }
