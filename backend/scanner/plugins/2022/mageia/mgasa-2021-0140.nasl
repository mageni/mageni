...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-02 15:52:00 +0000 (Fri, 02 Jul 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode, microcode' package(s) announced via the MGASA-2021-0140 advisory.");
