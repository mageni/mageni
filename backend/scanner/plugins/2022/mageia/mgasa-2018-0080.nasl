...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ldetect-lst, ldetect-lst, nvidia-current, nvidia-current' package(s) announced via the MGASA-2018-0080 advisory.");
...
It also adds support for newer GPUs and fixes some bugs.");
  ...
  script_tag(name:"affected", value:"'ldetect-lst, ldetect-lst, nvidia-current, nvidia-current' package(s) on Mageia 5, Mageia 6.");
