...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'upx, upx' package(s) announced via the MGASA-2021-0241 advisory.");
...
availability. (CVE-2021-20285)");
  ...
  script_tag(name:"affected", value:"'upx, upx' package(s) on Mageia 7, Mageia 8.");
