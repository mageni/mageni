...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'hivex, hivex' package(s) announced via the MGASA-2021-0320 advisory.");
...
from this vulnerability is to system availability (CVE-2021-3504).");
  ...
  script_tag(name:"affected", value:"'hivex, hivex' package(s) on Mageia 7, Mageia 8.");
