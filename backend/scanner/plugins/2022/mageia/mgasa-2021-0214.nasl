...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel, kernel, kmod-virtualbox, kmod-virtualbox, kmod-xtables-addons, kmod-xtables-addons' package(s) announced via the MGASA-2021-0214 advisory.");
