...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox, firefox-l10n, firefox-l10n, nss, nss, rootcerts, rootcerts, thunderbird, thunderbird, thunderbird-l10n, thunderbird-l10n' package(s) announced via the MGASA-2014-0293 advisory.");
...
these issues.");
  ...
  script_tag(name:"affected", value:"'firefox, firefox, firefox-l10n, firefox-l10n, nss, nss, rootcerts, rootcerts, thunderbird, thunderbird, thunderbird-l10n, thunderbird-l10n' package(s) on Mageia 3, Mageia 4.");
