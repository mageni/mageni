...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mpg123, mpg123' package(s) announced via the MGASA-2014-0067 advisory.");
...
several others.");
  ...
  script_tag(name:"affected", value:"'mpg123, mpg123' package(s) on Mageia 3, Mageia 4.");
