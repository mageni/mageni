...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147544");
  script_version("2022-01-31T04:35:24+0000");
  script_tag(name:"last_modification", value:"2022-01-31 10:37:41 +0000 (Mon, 31 Jan 2022)");
  script_tag(name:"creation_date", value:"2022-01-31 04:34:51 +0000 (Mon, 31 Jan 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");

  script_cve_id("CVE-2021-46658");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-25630) - Windows");
  ...
  script_tag(name:"insight", value:"save_window_function_values in MariaDB allows an application
  crash because of incorrect handling of with_window_func=true for a subquery.");

  script_tag(name:"affected", value:"MariaDB versions 10.2.x through 10.6.x.");

  script_tag(name:"solution", value:"Update to version 10.2.40, 10.3.31, 10.4.21, 10.5.12, 10.6.3
  or later.");

  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-25630");
