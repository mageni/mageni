...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148372");
  script_version("2022-07-05T03:13:38+0000");
  script_tag(name:"last_modification", value:"2022-07-05 03:13:38 +0000 (Tue, 05 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-05 03:13:02 +0000 (Tue, 05 Jul 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");

  script_cve_id("CVE-2022-32086");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-26412) - Windows");
  ...
  script_tag(name:"affected", value:"MariaDB version 10.4.x through 10.8.x.");

  script_tag(name:"solution", value:"Update to version 10.4.25, 10.5.16, 10.6.8, 10.7.4, 10.8.3 or
  later.");

  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-26412");
