...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.147578");
  script_version("2022-02-02T05:33:50+0000");
  script_tag(name:"last_modification", value:"2022-02-02 11:01:49 +0000 (Wed, 02 Feb 2022)");
  script_tag(name:"creation_date", value:"2022-02-02 05:21:41 +0000 (Wed, 02 Feb 2022)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");

  script_cve_id("CVE-2021-46667");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-26350) - Windows");
  ...
  script_tag(name:"insight", value:"MariaDB has a sql_lex.cc integer overflow, leading to an
  application crash.");

  script_tag(name:"affected", value:"MariaDB version 10.2.x through 10.6.x.");

  script_tag(name:"solution", value:"Update to version 10.2.41, 10.3.32, 10.4.22, 10.5.13, 10.6.5
  or later.");

  script_xref(name:"URL", value:"https://jira.mariadb.org/browse/MDEV-26350");
...
if (version_in_range(version: version, test_version: "10.2.0", test_version2: "10.2.40")) {
