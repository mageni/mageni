...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126003");
  script_version("2022-06-23T12:48:43+0000");
  script_tag(name:"last_modification", value:"2022-06-23 12:48:43 +0000 (Thu, 23 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-02-14 04:53:48 +0000 (Mon, 14 Feb 2022)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-04-21 17:03:00 +0000 (Thu, 21 Apr 2022)");

  script_cve_id("CVE-2022-27448");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-28095) - Linux");
  ...
  script_tag(name:"insight", value:"There is an assertion failure in MariaDB Server via
  'node->pcur->rel_pos == BTR_PCUR_ON' at /row/row0mysql.cc.");

  script_tag(name:"affected", value:"MariaDB version 10.3.x through 10.3.34, 10.4.x through
  10.4.24, 10.5.x through 10.5.15, 10.6.x through 10.6.7, 10.7.x through 10.7.3.");
...
if (version_in_range(version: version, test_version: "10.3.0", test_version2: "10.3.34")) {
