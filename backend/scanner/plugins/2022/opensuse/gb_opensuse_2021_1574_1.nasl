...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854437");
  ...
  script_tag(name:"creation_date", value:"2022-02-08 08:15:39 +0000 (Tue, 08 Feb 2022)");
  script_name("openSUSE: Security Advisory for nodejs12 (openSUSE-SU-2021:1574-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:1574-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/OZ6MU5ASKOGKZBGVKFFXVB64PMZRVEPX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs12'
  package(s) announced via the openSUSE-SU-2021:1574-1 advisory.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs12", rpm:"nodejs12~12.22.7~lp152.3.21.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-debuginfo", rpm:"nodejs12-debuginfo~12.22.7~lp152.3.21.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-debugsource", rpm:"nodejs12-debugsource~12.22.7~lp152.3.21.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-devel", rpm:"nodejs12-devel~12.22.7~lp152.3.21.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm12", rpm:"npm12~12.22.7~lp152.3.21.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs12-docs", rpm:"nodejs12-docs~12.22.7~lp152.3.21.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
