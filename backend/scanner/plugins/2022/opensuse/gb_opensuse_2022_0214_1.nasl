...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854426");
  ...
  script_tag(name:"creation_date", value:"2022-02-08 08:15:21 +0000 (Tue, 08 Feb 2022)");
  script_name("openSUSE: Security Advisory for log4j (openSUSE-SU-2022:0214-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:0214-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/E4IIJDMYKSUHPR6X6ARBPWWQRNNXT4HI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'log4j'
  package(s) announced via the openSUSE-SU-2022:0214-1 advisory.");
  ...
  script_tag(name:"affected", value:"'log4j' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.3.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"log4j-manual", rpm:"log4j-manual~1.2.17~5.9.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"log4j-manual", rpm:"log4j-manual~1.2.17~5.9.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
