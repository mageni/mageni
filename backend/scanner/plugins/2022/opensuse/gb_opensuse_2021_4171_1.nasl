...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854404");
  ...
  script_tag(name:"creation_date", value:"2022-02-01 06:35:59 +0000 (Tue, 01 Feb 2022)");
  script_name("openSUSE: Security Advisory for runc (openSUSE-SU-2021:4171-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:4171-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/6DD7LA7CG2OYZJT2SOA3MHVO7GOW3ANO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc'
  package(s) announced via the openSUSE-SU-2021:4171-1 advisory.");
  ...
  * Fixed returning error from GetStats when hugetlb is unsupported (which
  ...
  script_tag(name:"affected", value:"'runc' package(s) on openSUSE Leap 15.3.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.0.3~27.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"runc-debuginfo", rpm:"runc-debuginfo~1.0.3~27.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
