...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854537");
  ...
  script_tag(name:"creation_date", value:"2022-03-05 02:01:56 +0000 (Sat, 05 Mar 2022)");
  script_name("openSUSE: Security Advisory for mariadb (openSUSE-SU-2022:0726-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:0726-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/AHNAIZXQ7HT4J5VE4Z2HNIR2M675NUXE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb'
  package(s) announced via the openSUSE-SU-2022:0726-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mariadb-galera", rpm:"mariadb-galera~10.4.24~3.25.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
