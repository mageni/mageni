...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.854706");
  ...
  script_tag(name:"creation_date", value:"2022-05-26 01:01:59 +0000 (Thu, 26 May 2022)");
  script_name("openSUSE: Security Advisory for redis (SUSE-SU-2022:1842-1)");
  ...
  package(s) announced via the SUSE-SU-2022:1842-1 advisory.");
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.0.14~150200.6.11.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"redis-debuginfo", rpm:"redis-debuginfo~6.0.14~150200.6.11.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"redis-debugsource", rpm:"redis-debugsource~6.0.14~150200.6.11.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
