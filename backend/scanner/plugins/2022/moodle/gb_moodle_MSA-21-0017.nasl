...
if(description)
{
  ...
  script_name("Moodle 3.10.x < 3.10.4 Information Disclosure Vulnerability (MSA-21-0017)");
  ...
  script_tag(name:"affected", value:"Moodle version 3.10.x through 3.10.3.");
