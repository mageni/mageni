...
if(description)
{
  ...
  script_cve_id("CVE-2022-21341", "CVE-2022-21365", "CVE-2022-21282", "CVE-2022-21305",
                "CVE-2022-21299", "CVE-2022-21296", "CVE-2022-21283", "CVE-2022-21340",
                "CVE-2022-21293", "CVE-2022-21294", "CVE-2022-21360", "CVE-2022-21248");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle OpenJDK Multiple Vulnerabilities (Jan 2022 - 01)");
  ...
  script_tag(name:"affected", value:"Oracle OpenJDK versions 7, 8, 11, 13, 15 and 17.");
...
if (vers =~ "^1\.7" && version_is_less(version: vers, test_version: "1.7.0.331")) {
  report = report_fixed_ver(installed_version: vers, fixed_version: "1.7.0.331", install_path: path);
  security_message(port: port, data: report);
  exit(0);
}

if (vers =~ "^1\.8" && version_is_less(version: vers, test_version: "1.8.0.322")) {
  report = report_fixed_ver(installed_version: vers, fixed_version: "1.8.0.322", install_path: path);
  security_message(port: port, data: report);
  exit(0);
}
