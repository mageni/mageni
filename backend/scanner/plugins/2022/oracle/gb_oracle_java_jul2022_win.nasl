...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821189");
  ...
  script_name("Oracle Java SE Security Update (jul2022) - Windows");
  ...
  17.x through 17.0.3.1, 18.x through 18.0.1.1 on Windows.");
