...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821190");
  ...
  script_name("Oracle VirtualBox Security Update(jul2022) - Linux");
  ...
  script_tag(name:"affected", value:"VirtualBox versions 6.1.x prior to 6.1.36
  on Linux.");

  script_tag(name:"solution", value:"Upgrade to Oracle VirtualBox version 6.1.36
