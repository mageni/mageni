...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821127");
  ...
  script_name("Adobe Illustrator Multiple Vulnerabilities (APSB22-26) - Mac OS X");
  ...
  25.4.5 and earlier versions on Mac OS X.");
