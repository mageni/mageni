...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820059");
  ...
  script_name("Adobe Reader DC Continuous Security Update (APSB21-29) - Mac OS X");

  script_tag(name:"summary", value:"Adobe Reader DC Continuous is prone to multiple vulnerabilities.");
  ...
  2021.001.20150 and earlier versions on Mac OS X.");

  script_tag(name:"solution", value:"Upgrade Adobe Reader DC (Continuous)
  to version 2021.001.20155 or later. Please see the references for more information.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"21.001.20149"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"2021.001.20155", install_path:path);
