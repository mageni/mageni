...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820056");
  ...
  script_name("Adobe Acrobat DC (Continuous) Security Update (APSB21-29) - Mac OS X");
  ...
  to version 2021.001.20155 on Mac OS X.");
