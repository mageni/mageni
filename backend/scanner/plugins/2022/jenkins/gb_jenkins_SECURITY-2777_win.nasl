...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148330");
  script_version("2022-06-24T06:49:39+0000");
  script_tag(name:"last_modification", value:"2022-06-24 06:49:39 +0000 (Fri, 24 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-06-24 06:48:40 +0000 (Fri, 24 Jun 2022)");
  ...
  script_name("Jenkins 2.335 < 2.356 Information Disclosure Vulnerability (SECURITY-2777) - Windows");
