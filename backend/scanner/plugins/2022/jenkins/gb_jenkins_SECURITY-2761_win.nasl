...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148326");
  script_version("2022-06-24T05:53:52+0000");
  script_tag(name:"last_modification", value:"2022-06-24 05:53:52 +0000 (Fri, 24 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-06-24 05:52:56 +0000 (Fri, 24 Jun 2022)");
  ...
  script_name("Jenkins 2.321 < 2.356, 2.332.1 LTS < 2.332.4 LTS XSS Vulnerability (SECURITY-2761) - Windows");
