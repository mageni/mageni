...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821151");
  ...
  script_tag(name:"creation_date", value:"2022-07-07 22:23:03 +0530 (Thu, 07 Jul 2022)");
  script_name("Mozilla Thunderbird Security Updates(mfsa2022-18) - Windows");
