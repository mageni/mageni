...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821162");
  script_version("2022-07-14T06:41:19+0000");
  script_cve_id("CVE-2022-1097", "CVE-2022-28281", "CVE-2022-28282", "CVE-2022-28283",
  ...
  script_tag(name:"creation_date", value:"2022-07-07 23:23:32 +0530 (Thu, 07 Jul 2022)");
  script_name("Mozilla Firefox Security Updates(mfsa2022-13) - MAC OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to Mozilla Firefox version 99
...
if(version_is_less(version:vers, test_version:"99"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"99", install_path:path);
