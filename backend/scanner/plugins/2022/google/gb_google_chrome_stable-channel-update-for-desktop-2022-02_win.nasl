...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819978");
  ...
  script_name("Google Chrome Security Updates(stable-channel-update-for-desktop-2022-02)-Windows");
  ...
  script_tag(name:"affected", value:"Google Chrome version prior to 98.0.4758.80/81/82
  on Windows");

  script_tag(name:"solution", value:"Upgrade to Google Chrome version 98.0.4758.80/81/82
...
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"98.0.4758.80/81/82", install_path:path);
