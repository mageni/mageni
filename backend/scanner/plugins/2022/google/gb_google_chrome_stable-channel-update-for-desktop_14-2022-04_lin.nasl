...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820081");
  ...
  script_tag(name:"creation_date", value:"2022-04-19 11:47:36 +0530 (Tue, 19 Apr 2022)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_14-2022-04) - Linux");
