...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821213");
  ...
  script_tag(name:"creation_date", value:"2022-05-06 17:26:52 +0530 (Fri, 06 May 2022)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2022-04) - Mac OS X");
