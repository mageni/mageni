...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.14914.1");
  script_cve_id("CVE-2020-25097", "CVE-2021-28651");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:14914-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:14914-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-202214914-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid3' package(s) announced via the SUSE-SU-2022:14914-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid3", rpm:"squid3~3.1.23~8.16.37.18.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
