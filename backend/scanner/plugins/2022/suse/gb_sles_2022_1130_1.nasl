...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221130-1/");
...
Don't prevent less restrictive umasks (bsc#1195999)");
  ...
  script_tag(name:"affected", value:"'libsolv, libzypp, zypper' package(s) on SUSE Linux Enterprise High Performance Computing 15, SUSE Linux Enterprise Installer 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP 15.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsolv-debuginfo", rpm:"libsolv-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsolv-debugsource", rpm:"libsolv-debugsource~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsolv-devel-debuginfo", rpm:"libsolv-devel-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsolv-tools-debuginfo", rpm:"libsolv-tools-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libzypp-debuginfo", rpm:"libzypp-debuginfo~17.30.0~150000.3.95.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libzypp-debugsource", rpm:"libzypp-debugsource~17.30.0~150000.3.95.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-solv-debuginfo", rpm:"perl-solv-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-solv-debuginfo", rpm:"python-solv-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-solv-debuginfo", rpm:"python3-solv-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby-solv-debuginfo", rpm:"ruby-solv-debuginfo~0.7.22~150000.3.51.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"zypper-debuginfo", rpm:"zypper-debuginfo~1.14.52~150000.3.69.2", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zypper-debugsource", rpm:"zypper-debugsource~1.14.52~150000.3.69.2", rls:"SLES15.0"))) {
    report += res;
  }
