...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.14896.1");
  ...
  script_tag(name:"creation_date", value:"2022-02-24 11:38:54 +0000 (Thu, 24 Feb 2022)");
  script_version("2022-02-24T11:38:54+0000");
  script_tag(name:"last_modification", value:"2022-02-24 11:38:54 +0000 (Thu, 24 Feb 2022)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_tag(name:"severity_origin", value:"Greenbone");
  script_tag(name:"severity_date", value:"2022-02-24 11:38:54 +0000 (Thu, 24 Feb 2022)");

  script_name("SUSE: Security Advisory (SUSE-SU-2022:14896-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:14896-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-202214896-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2022:14896-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~91.6.0~78.162.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~91.6.0~78.162.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-other", rpm:"MozillaFirefox-translations-other~91.6.0~78.162.2", rls:"SLES11.0SP4"))) {
    report += res;
  }
