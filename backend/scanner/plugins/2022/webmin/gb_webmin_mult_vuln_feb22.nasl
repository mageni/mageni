...
if(description)
{
  ...
  script_version("2022-03-03T04:44:25+0000");
  ...
  # nb: When reviewing the solution check the commits below (Seems to target a 1.990 release)
  script_tag(name:"solution", value:"No known solution is available as of 03th March, 2022.
