...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820004");
  ...
  script_name("Apple MacOSX Security Update (HT213092)");
  ...
  12.2.1 or later. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/HT213092");
...
if(version_in_range(version:osVer, test_version:"12.0", test_version2:"12.2"))
{
  report = report_fixed_ver(installed_version:osVer, fixed_version:"12.2.1");
