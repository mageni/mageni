...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148270");
  script_version("2022-06-15T04:39:05+0000");
  script_tag(name:"last_modification", value:"2022-06-15 10:13:29 +0000 (Wed, 15 Jun 2022)");
  script_tag(name:"creation_date", value:"2022-06-15 04:04:22 +0000 (Wed, 15 Jun 2022)");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:S/C:C/I:N/A:N");

  script_cve_id("CVE-2022-31047");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("TYPO3 Information Disclosure Vulnerability (TYPO3-CORE-SA-2022-002)");
  ...
  script_tag(name:"insight", value:"It has been discovered that system internal credentials or keys
  (e.g. database credentials) have been logged as plaintext in exception handlers, when logging the
  ...
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-002");
