...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820063");
  ...
  script_name("Microsoft .NET Framework DoS Vulnerability (KB5012328)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5012328");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.7.2 and 4.8 on Microsoft Windows 10 version 1809 32-bit/x64-based Systems.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5012328");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer)
            {
              if(version_in_range(version:dllVer, test_version:"2.0.50727", test_version2:"2.0.50727.9050"))
              {
                vulnerable_range = "2.0.50727 - 2.0.50727.9050";
                break;
              }
              else if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.3929"))
              {
                vulnerable_range = "4.7 - 4.7.3929" ;
                break;
              }
