...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818958");
  ...
  script_name("Microsoft Excel 2016 RCE Vulnerability (KB5002114)");

  script_tag(name:"summary", value:"This host is missing a critical security
  update according to Microsoft KB5002114");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002114");
...
if(version_in_range(version:vers, test_version:"16.0", test_version2:"16.0.5266.0999"))
{
  report = report_fixed_ver(file_checked:path + "Excel.exe",
                            file_version:vers, vulnerable_range:"16.0 - 16.0.5266.0999");
