...
if(description)
{
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5014748)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5014748");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5014748");
...
if(version_in_range(version:fileVer, test_version:"6.1.7601.0", test_version2:"6.1.7601.25982"))
{
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"6.1.7601.0 - 6.1.7601.25982");
