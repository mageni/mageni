...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170118");
  ...
  script_name("QNAP QuTS hero XSS Vulnerability (QSA-21-63)");
  ...
  reported to affect TFTP Server in QuTS hero.");

  script_tag(name:"impact", value:"If exploited, this vulnerability allows remote attackers to
  inject malicious code.");

  script_tag(name:"solution", value:"Update to version h4.5.4.1771 build 20210825 or later.");
...
if ( version_is_less( version:version, test_version:"h4.5.4_20210825" ) ) {
  report = report_fixed_ver( installed_version:version, fixed_version:"h4.5.4_20210825" );
