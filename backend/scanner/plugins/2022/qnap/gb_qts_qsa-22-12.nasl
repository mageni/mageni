...
if(description)
{
  ...
  script_tag(name:"affected", value:"QNAP QTS version 4.2.6 prior to 4.5.4 build 20220419,
  5.0.x prior to 5.0.1 build 20220515.");

  script_tag(name:"solution", value:"Update to version 4.5.4 build 20220419, 5.0.1 build 20220515
  or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "4.2.6", test_version_up: "4.5.4_20220419")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.5.4_20220419");
