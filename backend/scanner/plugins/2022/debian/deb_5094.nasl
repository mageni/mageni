...
if(description)
{
  ...
  script_version("2022-03-10T02:01:14+0000");
  ...
  script_name("Debian: Security Advisory for thunderbird (DSA-5094-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5094.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5094-1");
  script_xref(name:"Advisory-ID", value:"DSA-5094-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird'
  package(s) announced via the DSA-5094-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"calendar-google-provider", ver:"1:91.6.2-1~deb10u1", rls:"DEB10"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"lightning", ver:"1:91.6.2-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
...
if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-si", ver:"1:91.6.2-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
