...
if(description)
{
  ...
  script_version("2022-02-02T02:00:06+0000");
  ...
  script_name("Debian: Security Advisory for python-nbxmpp (DSA-5064-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5064.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5064-1");
  script_xref(name:"Advisory-ID", value:"DSA-5064-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-nbxmpp'
  package(s) announced via the DSA-5064-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that missing input sanitising in python-nbxmpp, a
...
The oldstable distribution (buster) is not affected.");
  ...
  script_tag(name:"affected", value:"'python-nbxmpp' package(s) on Debian Linux.");
