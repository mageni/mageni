...
if(description)
{
  ...
  script_version("2022-05-05T14:03:47+0000");
  ...
  script_name("Debian: Security Advisory for openjdk-17 (DSA-5128-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5128.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5128-1");
  ...
  package(s) announced via the DSA-5128-1 advisory.");
