...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for vim (DLA-3053-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/06/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3053-1");
  ...
  package(s) announced via the DLA-3053-1 advisory.");
