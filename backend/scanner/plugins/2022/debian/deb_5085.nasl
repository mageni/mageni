...
if(description)
{
  ...
  script_version("2022-02-23T02:00:07+0000");
  ...
  script_name("Debian: Security Advisory for expat (DSA-5085-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5085.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5085-1");
  script_xref(name:"Advisory-ID", value:"DSA-5085-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat'
  package(s) announced via the DSA-5085-1 advisory.");
