...
if(description)
{
  ...
  script_name("Debian: Security Advisory for openjdk-17 (DSA-5058-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5058.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5058-1");
  ...
  package(s) announced via the DSA-5058-1 advisory.");
