...
if(description)
{
  ...
  script_version("2022-01-07T02:00:05+0000");
  ...
  script_name("Debian: Security Advisory for sphinxsearch (DSA-5036-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5036.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5036-1");
  script_xref(name:"Advisory-ID", value:"DSA-5036-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sphinxsearch'
  package(s) announced via the DSA-5036-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"sphinxsearch", ver:"2.2.11-2+deb10u1", rls:"DEB10"))) {
  report += res;
}
