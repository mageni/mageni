...
if(description)
{
  ...
  script_version("2022-03-08T02:00:31+0000");
  ...
  script_name("Debian: Security Advisory for chromium (DSA-5089-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5089.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5089-1");
  script_xref(name:"Advisory-ID", value:"DSA-5089-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the DSA-5089-1 advisory.");
