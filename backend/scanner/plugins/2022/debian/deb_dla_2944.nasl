...
if(description)
{
  ...
  script_version("2022-03-11T02:00:13+0000");
  ...
  script_name("Debian LTS: Security Advisory for nbd (DLA-2944-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/03/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2944-1");
  script_xref(name:"Advisory-ID", value:"DLA-2944-1");
  script_xref(name:"URL", value:"https://bugs.debian.org/1003863");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nbd'
  package(s) announced via the DLA-2944-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An integer overflow (with a resultant heap-based buffer overflow)
...
dangling pointer.");
  ...
  script_tag(name:"affected", value:"'nbd' package(s) on Debian Linux.");
