...
if(description)
{
  ...
  script_version("2022-03-22T02:00:05+0000");
  ...
  script_name("Debian LTS: Security Advisory for paramiko (DLA-2959-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/03/msg00032.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2959-1");
  ...
  package(s) announced via the DLA-2959-1 advisory.");
