...
if(description)
{
  ...
  script_version("2022-01-22T02:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for golang-1.8 (DLA-2891-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/01/msg00016.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2891-1");
  script_xref(name:"Advisory-ID", value:"DLA-2891-1");
  ...
  package(s) announced via the DLA-2891-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"golang-1.8", ver:"1.8.1-1+deb9u4", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"golang-1.8-doc", ver:"1.8.1-1+deb9u4", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"golang-1.8-go", ver:"1.8.1-1+deb9u4", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"golang-1.8-src", ver:"1.8.1-1+deb9u4", rls:"DEB9"))) {
  report += res;
}
