...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for maven-shared-utils (DLA-3059-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/06/msg00022.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3059-1");
  script_xref(name:"Advisory-ID", value:"DLA-3059-1");
  ...
  package(s) announced via the DLA-3059-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libmaven-shared-utils-java", ver:"3.0.0-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libmaven-shared-utils-java-doc", ver:"3.0.0-1+deb9u1", rls:"DEB9"))) {
  report += res;
}
