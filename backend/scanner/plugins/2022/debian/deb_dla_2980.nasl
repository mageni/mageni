...
if(description)
{
  ...
  script_version("2022-04-13T01:00:08+0000");
  ...
  script_name("Debian LTS: Security Advisory for zabbix (DLA-2980-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/04/msg00011.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-2980-1");
  ...
  package(s) announced via the DLA-2980-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities have been discovered in zabbix, a network
