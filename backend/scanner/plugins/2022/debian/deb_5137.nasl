...
if(description)
{
  ...
  script_version("2022-05-18T01:00:04+0000");
  ...
  script_name("Debian: Security Advisory for needrestart (DSA-5137-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5137.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5137-1");
  script_xref(name:"Advisory-ID", value:"DSA-5137-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'needrestart'
  package(s) announced via the DSA-5137-1 advisory.");
