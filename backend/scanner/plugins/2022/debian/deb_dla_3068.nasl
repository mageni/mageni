...
if(description)
{
  ...
  script_version("2022-08-08T08:50:57+0000");
  script_cve_id("CVE-2022-2319", "CVE-2022-2320");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-08-08 08:50:57 +0000 (Mon, 08 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-05 01:00:08 +0000 (Fri, 05 Aug 2022)");
  script_name("Debian LTS: Security Advisory for xorg-server (DLA-3068-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/08/msg00000.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3068-1");
  script_xref(name:"Advisory-ID", value:"DLA-3068-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server'
  package(s) announced via the DLA-3068-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jan-Niklas Sohn discovered two out of bound memory writes in X.Org Server's
