...
if(description)
{
  ...
  script_name("Debian: Security Advisory for python-bottle (DSA-5159-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5159.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5159-1");
  script_xref(name:"Advisory-ID", value:"DSA-5159-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-bottle'
  package(s) announced via the DSA-5159-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Elton Nokaj discovered that incorrect error handling in Bottle, a WSGI
