...
if(description)
{
  ...
  script_version("2022-05-14T01:00:11+0000");
  ...
  script_name("Debian LTS: Security Advisory for htmldoc (DLA-3004-1)");
  ...
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2022/05/msg00014.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-3004-1");
  ...
  package(s) announced via the DLA-3004-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an integer overflow vulnerabiliity
