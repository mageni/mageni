...
if(description)
{
  ...
  script_name("Debian: Security Advisory for jetty9 (DSA-5198-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5198.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5198-1");
  script_xref(name:"Advisory-ID", value:"DSA-5198-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jetty9'
  package(s) announced via the DSA-5198-1 advisory.");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"jetty9", ver:"9.4.39-3+deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjetty9-extra-java", ver:"9.4.39-3+deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjetty9-java", ver:"9.4.39-3+deb11u1", rls:"DEB11"))) {
  report += res;
}
