...
if(description)
{
  ...
  script_version("2022-08-08T01:00:18+0000");
  ...
  script_tag(name:"last_modification", value:"2022-08-08 01:00:18 +0000 (Mon, 08 Aug 2022)");
  script_tag(name:"creation_date", value:"2022-08-08 01:00:18 +0000 (Mon, 08 Aug 2022)");
  script_name("Debian: Security Advisory for chromium (DSA-5201-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5201.html");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5201-1");
  script_xref(name:"Advisory-ID", value:"DSA-5201-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the DSA-5201-1 advisory.");
...
if(!isnull(res = isdpkgvuln(pkg:"chromium-driver", ver:"104.0.5112.79-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"chromium-l10n", ver:"104.0.5112.79-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"chromium-sandbox", ver:"104.0.5112.79-1~deb11u1", rls:"DEB11"))) {
  report += res;
}
