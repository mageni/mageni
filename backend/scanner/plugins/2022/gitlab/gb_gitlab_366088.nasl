...
if (description)
{
  ...
  script_cve_id("CVE-2022-2185");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 14.0.x < 14.10.5, 15.0.x < 15.0.4, 15.1.x < 15.1.1 Command Injection Vulnerability");
  ...
  script_tag(name:"summary", value:"GitLab is prone to a command injection vulnerability.");
  ...
  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/cves/-/blob/master/2022/CVE-2022-2185.json");
...
if (version_in_range_exclusive(version: version, test_version_lo: "14.0", test_version_up: "14.10.5")) {
