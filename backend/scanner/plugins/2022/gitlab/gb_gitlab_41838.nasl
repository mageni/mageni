...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170071");
  ...
  script_tag(name:"severity_date", value:"2019-02-27 19:42:00 +0000 (Wed, 27 Feb 2019)");

  script_cve_id("CVE-2018-9244");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 9.2.x - 10.4.6, 10.5.x - 10.5.6, 10.6.x - 10.6.2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The milestone_select.js located in
   app/assets/javascripts/milestone_select.js suffers from a stored XSS issue in the
   renderRow-function.");

  script_tag(name:"affected", value:"GitLab version 9.2.x through 10.4.6, 10.5.x through 10.5.6 and
  10.6.x through 10.6.2.");

  script_tag(name:"solution", value:"Update to version 10.4.7, 10.5.7, 10.6.3 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/41838");
...
if ( version_in_range( version:version, test_version:"9.2.0", test_version2:"10.4.6" ) ) {
