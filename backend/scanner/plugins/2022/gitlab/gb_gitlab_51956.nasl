...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170062");
  ...
  script_tag(name:"severity_date", value:"2019-02-05 15:31:00 +0000 (Tue, 05 Feb 2019)");

  script_cve_id("CVE-2018-17939");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 11.1.x - 11.1.7, 11.2.x - 11.2.4, 11.3.x - 11.3.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"Merge request discussion JSON endpoint exposes all User
  attributes/columns including secrets, some encrypted, some not.");

  script_tag(name:"affected", value:"GitLab version 11.1.x through 11.1.7, 11.2.x through 11.2.4 and
  11.3.x through 11.3.1.");

  script_tag(name:"solution", value:"Update to version 11.1.8, 11.2.5, 11.3.2 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/51956");
...
if ( version_in_range( version:version, test_version:"11.1.0", test_version2:"11.1.7" ) ) {
