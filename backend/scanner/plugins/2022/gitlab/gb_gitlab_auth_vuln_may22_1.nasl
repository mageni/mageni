...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148268");
  ...
  script_tag(name:"severity_date", value:"2022-05-19 20:41:00 +0000 (Thu, 19 May 2022)");

  script_cve_id("CVE-2022-1352");

  script_tag(name:"qod_type", value:"executable_version_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 11.0.0 < 14.8.6, 14.9.x < 14.9.4, 14.10.x < 14.10.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"impact", value:"An endpoint may reveal the issue title to a user who crafted an
  API call with the ID of the issue from a public project that restricts access to issue only to
  project members.");

  script_tag(name:"affected", value:"GitLab version 11.0 through 14.8.5, 14.9.x through 14.9.3 and
  version 14.10.0.");
...
if ( version_in_range( version:version, test_version:"11.0.0", test_version2:"14.8.5" ) ) {
