...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126014");
  ...
  script_name("GitLab 12.4.x < 14.5.4, 14.6.x < 14.6.4, 14.7.x < 14.7.1 Improper Access Vulnerability.");
  ...
  script_tag(name:"impact", value:"The vulnerability allows project non-members to retrieve the
  service desk email address.");

  script_tag(name:"affected", value:"GitLab version 12.4.x through 14.5.3, 14.6.x through 14.6.3
  and version 14.7.0.");
...
if ( version_in_range( version:version, test_version:"12.4.0", test_version2:"14.5.3" ) ) {
