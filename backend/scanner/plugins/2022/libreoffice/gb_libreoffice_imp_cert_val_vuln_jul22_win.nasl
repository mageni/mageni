...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126087");
  script_version("2022-07-29T09:37:29+0000");
  script_tag(name:"last_modification", value:"2022-07-29 09:37:29 +0000 (Fri, 29 Jul 2022)");
  script_tag(name:"creation_date", value:"2022-07-28 19:39:30 +0000 (Thu, 28 Jul 2022)");
  ...
  script_name("Libre Office 7.2.x < 7.2.7, 7.3.x < 7.3.2 Improper Certificate Validation Vulnerability (Jul 22) - Windows");
