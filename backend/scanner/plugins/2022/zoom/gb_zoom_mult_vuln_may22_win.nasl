...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.148144");
  script_version("2022-05-19T04:38:16+0000");
  script_tag(name:"last_modification", value:"2022-05-20 09:52:18 +0000 (Fri, 20 May 2022)");
  script_tag(name:"creation_date", value:"2022-05-19 04:34:34 +0000 (Thu, 19 May 2022)");
  script_tag(name:"cvss_base", value:"8.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:C/I:C/A:N");

  script_cve_id("CVE-2022-22784", "CVE-2022-22785", "CVE-2022-22786", "CVE-2022-22787");

  script_tag(name:"qod_type", value:"executable_version");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Zoom Client < 5.10.0 Multiple Vulnerabilities (ZSB-22006, ZSB-22007, ZSB-22008, ZSB-22009) - Windows");
