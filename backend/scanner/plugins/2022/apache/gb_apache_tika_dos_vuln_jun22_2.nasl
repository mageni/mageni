...
if(description)
{
  ...
  script_version("2022-06-29T04:34:57+0000");
  script_tag(name:"last_modification", value:"2022-06-29 04:34:57 +0000 (Wed, 29 Jun 2022)");
  ...
  script_name("Apache Tika Server < 1.28.4, 2.4.x < 2.4.1 DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"Apache Tika Server is prone to a denial of service (DoS)
  vulnerability.");
...
if (version_is_less(version: version, test_version: "1.28.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.28.4", install_path: location);
