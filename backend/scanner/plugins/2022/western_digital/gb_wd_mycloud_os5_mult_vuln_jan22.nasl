...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-21 16:33:00 +0000 (Fri, 21 Jan 2022)");
  ...
  script_name("Western Digital My Cloud Multiple Products 5.0 < 5.19.117 Multiple Vulnerabilities (WDC-22002)");
