...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1945");
  ...
  script_name("Huawei EulerOS: Security Advisory for pcre2 (EulerOS-SA-2022-1945)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1945");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1945");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pcre2' package(s) announced via the EulerOS-SA-2022-1945 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pcre2", rpm:"pcre2~10.32~3.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pcre2-devel", rpm:"pcre2-devel~10.32~3.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pcre2-utf16", rpm:"pcre2-utf16~10.32~3.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pcre2-utf32", rpm:"pcre2-utf32~10.32~3.h3.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
