...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1583");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-pillow (EulerOS-SA-2022-1583)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1583");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1583");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-pillow' package(s) announced via the EulerOS-SA-2022-1583 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-pillow", rpm:"python2-pillow~5.3.0~1.h14.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-pillow", rpm:"python3-pillow~5.3.0~1.h14.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
