...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.2129");
  ...
  script_name("Huawei EulerOS: Security Advisory for docker-engine (EulerOS-SA-2022-2129)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-2129");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2129");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'docker-engine' package(s) announced via the EulerOS-SA-2022-2129 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-engine", rpm:"docker-engine~18.09.0.200~200.h48.28.15.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
