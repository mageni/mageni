...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1147");
  ...
  script_name("Huawei EulerOS: Security Advisory for squashfs-tools (EulerOS-SA-2022-1147)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1147");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1147");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'squashfs-tools' package(s) announced via the EulerOS-SA-2022-1147 advisory.");
...
squashfs_opendir in unsquash-2.c in Squashfs-Tools 4.5 allows Directory Traversal, a different vulnerability than CVE-2021-40153. A squashfs filesystem that has been crafted to include a symbolic link and then contents under the same filename in a filesystem can cause unsquashfs to first create the symbolic link pointing outside the expected directory, and then the subsequent write operation will cause the unsquashfs process to write through the symbolic link elsewhere in the filesystem.(CVE-2021-41072)");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Huawei EulerOS Virtualization 3.0.6.6.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squashfs-tools", rpm:"squashfs-tools~4.3~0.21.gitaae0aff4.h2.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
