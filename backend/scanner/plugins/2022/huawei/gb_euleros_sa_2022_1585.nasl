...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1585");
  ...
  script_name("Huawei EulerOS: Security Advisory for docker-engine (EulerOS-SA-2022-1585)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1585");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1585");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'docker-engine' package(s) announced via the EulerOS-SA-2022-1585 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-engine-selinux", rpm:"docker-engine-selinux~18.09.0.101~1.h49.19.9.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
