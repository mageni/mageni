...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1235");
  ...
  script_name("Huawei EulerOS: Security Advisory for squashfs-tools (EulerOS-SA-2022-1235)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1235");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1235");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'squashfs-tools' package(s) announced via the EulerOS-SA-2022-1235 advisory.");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Huawei EulerOS V2.0SP10(x86_64).");
...
if(release == "EULEROS-2.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squashfs-tools", rpm:"squashfs-tools~4.4~1.h3.eulerosv2r10", rls:"EULEROS-2.0SP1"))) {
    report += res;
  }
