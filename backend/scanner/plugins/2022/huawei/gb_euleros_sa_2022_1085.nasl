...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1085");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg (EulerOS-SA-2022-1085)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1085");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1085");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg' package(s) announced via the EulerOS-SA-2022-1085 advisory.");
...
A flaw was found in OpenJPEG's encoder in the opj_dwt_calc_explicit_stepsizes() function. This flaw allows an attacker who can supply crafted input to decomposition levels to cause a buffer overflow. The highest threat from this vulnerability is to system availability.(CVE-2020-27824)");
  ...
  script_tag(name:"affected", value:"'openjpeg' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.6.0.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg-libs", rpm:"openjpeg-libs~1.5.1~22.h3.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
