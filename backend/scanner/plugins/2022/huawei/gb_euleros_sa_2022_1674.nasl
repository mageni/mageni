...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1674");
  ...
  script_name("Huawei EulerOS: Security Advisory for squashfs-tools (EulerOS-SA-2022-1674)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1674");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1674");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'squashfs-tools' package(s) announced via the EulerOS-SA-2022-1674 advisory.");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Huawei EulerOS Virtualization for ARM 64 3.0.2.0.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squashfs-tools", rpm:"squashfs-tools~4.3~0.21.gitaae0aff4.h2", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
