...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1321");
  ...
  script_name("Huawei EulerOS: Security Advisory for gegl (EulerOS-SA-2022-1321)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1321");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1321");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gegl' package(s) announced via the EulerOS-SA-2022-1321 advisory.");
...
if(release == "EULEROS-2.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gegl", rpm:"gegl~0.2.0~19.h3.eulerosv2r7", rls:"EULEROS-2.0SP5"))) {
    report += res;
  }
