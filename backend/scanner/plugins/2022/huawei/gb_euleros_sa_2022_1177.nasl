...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2022.1177");
  script_cve_id("CVE-2016-6893", "CVE-2021-42096", "CVE-2021-42097");
  ...
  script_name("Huawei EulerOS: Security Advisory for mailman (EulerOS-SA-2022-1177)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2022-1177");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1177");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mailman' package(s) announced via the EulerOS-SA-2022-1177 advisory.");
...
if(release == "EULEROS-2.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mailman", rpm:"mailman~2.1.15~26.1.h3", rls:"EULEROS-2.0SP3"))) {
    report += res;
  }
