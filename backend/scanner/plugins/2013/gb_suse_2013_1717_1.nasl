...
# $Id: gb_suse_2013_1717_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850544");
  ...
  script_tag(name:"insight", value:"Adobe Flash Player was updated to 11.2.202.327: (bnc#850220)
