...
# $Id: gb_ubuntu_USN_1859_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  script_tag(name:"affected", value:"libxi on Ubuntu 13.04,
  Ubuntu 12.10,
  Ubuntu 12.04 LTS,
  Ubuntu 10.04 LTS");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1859-1/");
