...
# $Id: gb_adobe_air_mult_vuln01_feb13_lin.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_mandatory_keys("Adobe/Air/Linux/Ver");
  ...
  script_tag(name:"affected", value:"Adobe AIR Version prior to 3.6.0.597 on Linux");
