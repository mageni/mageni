...
# $Id: gb_ubuntu_USN_2042_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-lts-saucy USN-2042-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-12-04 10:16:26 +0530 (Wed, 04 Dec 2013)");
  script_cve_id("CVE-2013-4299", "CVE-2013-4470");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-lts-saucy USN-2042-1");
...
administrative privileges. (CVE-2013-4470)");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2042-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.11.0-14-generic", ver:"3.11.0-14.21~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isdpkgvuln(pkg:"linux-image-3.11.0-14-generic-lpae", ver:"3.11.0-14.21~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
