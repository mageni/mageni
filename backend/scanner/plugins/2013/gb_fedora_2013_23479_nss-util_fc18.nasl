...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.867184");
  ...
  script_name("Fedora Update for nss-util FEDORA-2013-23479");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"nss-util", rpm:"nss-util~3.15.3~1.fc18", rls:"FC18")) != NULL)
  {
