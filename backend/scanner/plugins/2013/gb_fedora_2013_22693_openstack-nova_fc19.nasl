...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123433.html");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"openstack-nova", rpm:"openstack-nova~2013.1.4~3.fc19", rls:"FC19")) != NULL)
  {
