...
#
# Fedora Update for ansible FEDORA-2013-12394
#
# Authors:
...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111637.html");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"ansible", rpm:"ansible~1.2.2~1.fc18", rls:"FC18")) != NULL)
  {
