...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117205");
  ...
  script_cve_id("CVE-2012-5612", "CVE-2013-0386", "CVE-2013-0368", "CVE-2013-0371", "CVE-2012-0578",
                "CVE-2013-0367", "CVE-2012-5096");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL 5.5 <= 5.5.28 Security Update (cpujan2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5 versions 5.5.28 and prior.");

  script_tag(name:"solution", value:"Update to version 5.5.29 or later.");
