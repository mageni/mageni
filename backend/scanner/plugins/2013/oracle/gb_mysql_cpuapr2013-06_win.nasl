...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117210");
  ...
  script_name("Oracle MySQL <= 5.1.63 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.1.63 and prior.");
