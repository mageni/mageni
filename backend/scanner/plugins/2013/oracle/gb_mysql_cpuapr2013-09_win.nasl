...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117213");
  ...
  script_cve_id("CVE-2013-1523");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL 5.5 <= 5.5.29 / 5.6 <= 5.6.11 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL 5.5 versions 5.5.29 and prior, 5.6.10 and prior.");

  script_tag(name:"solution", value:"Update to version 5.5.30, 5.6.11 or later.");
