...
# $Id: gb_suse_2013_1870_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  ...
  script_name("SuSE Update for ca-certificates-mozilla openSUSE-SU-2013:1870-1 (ca-certificates-mozilla)");
...
if(release == "openSUSE11.4")
{
  ...
  if ((res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~1.95~17.1", rls:"openSUSE11.4")) != NULL)
  {
