...
# $Id: deb_2726.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"php-radius on Debian Linux");
...
We recommend that you upgrade your php-radius packages.");
  script_tag(name:"summary", value:"A buffer overflow has been discovered in the Radius extension for PHP.
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"php-radius-legacy", ver:"1.2.5-2+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"php5-radius", ver:"1.2.5-2+squeeze1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"php-radius-legacy", ver:"1.2.5-2.3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"php5-radius", ver:"1.2.5-2.3+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
