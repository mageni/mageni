...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-189)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"nginx-debuginfo", rpm:"nginx-debuginfo~1.2.9~1.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nginx", rpm:"nginx~1.2.9~1.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }
