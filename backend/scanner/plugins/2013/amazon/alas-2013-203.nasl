...
if(description)
{
  ...
  script_name("Amazon Linux: Security Advisory (ALAS-2013-203)");
...
if(release == "AMAZON") {
  if(!isnull(res = isrpmvuln(pkg:"nagios-plugins-nrpe", rpm:"nagios-plugins-nrpe~2.14~3.5.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nrpe", rpm:"nrpe~2.14~3.5.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nrpe-debuginfo", rpm:"nrpe-debuginfo~2.14~3.5.amzn1", rls:"AMAZON"))) {
    report += res;
  }
