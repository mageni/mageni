...
# $Id: gb_mysql_server_optimizer_unspecified_vuln.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"insight", value:"Unspecified error in MySQL Server component related to Server Optimizer.");
