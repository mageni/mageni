...
# $Id: deb_2708.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
if(description)
{
  ...
  script_tag(name:"affected", value:"fail2ban on Debian Linux");
...
We recommend that you upgrade your fail2ban packages.");
  script_tag(name:"summary", value:"Krzysztof Katowicz-Kowalewski discovered a vulnerability in Fail2ban, a
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"fail2ban", ver:"0.8.4-3+squeeze2", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"fail2ban", ver:"0.8.6-3wheezy2", rls:"DEB7")) != NULL) {
  report += res;
}
