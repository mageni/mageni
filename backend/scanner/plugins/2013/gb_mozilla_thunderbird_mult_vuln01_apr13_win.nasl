...
# $Id: gb_mozilla_thunderbird_mult_vuln01_apr13_win.nasl 11865 2018-10-12 10:03:43Z cfischer $
#
...
if(description)
{
  ...
  script_name("Mozilla Thunderbird Multiple Vulnerabilities -01 Apr13 (Windows)");
