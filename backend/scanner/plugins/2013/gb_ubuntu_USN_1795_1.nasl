...
# $Id: gb_ubuntu_USN_1795_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-04-15 10:18:43 +0530 (Mon, 15 Apr 2013)");
  ...
  script_name("Ubuntu Update for linux-lts-quantal USN-1795-1");

  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1795-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-27-generic", ver:"3.5.0-27.46~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
