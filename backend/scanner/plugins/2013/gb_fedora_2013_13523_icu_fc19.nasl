...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866805");
  ...
  script_name("Fedora Update for icu FEDORA-2013-13523");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"icu", rpm:"icu~50.1.2~7.fc19", rls:"FC19")) != NULL)
  {
