...
#
# Fedora Update for 389-ds-base FEDORA-2013-15518
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866856");
  ...
  script_name("Fedora Update for 389-ds-base FEDORA-2013-15518");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"389-ds-base", rpm:"389-ds-base~1.3.0.8~1.fc18", rls:"FC18")) != NULL)
  {
