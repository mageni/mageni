...
#
# CentOS Update for libibumad CESA-2013:0509 centos6
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://lists.centos.org/pipermail/centos-announce/2013-March/019374.html");
  script_oid("1.3.6.1.4.1.25623.1.0.881668");
  script_version("$Revision: 14222 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 13:50:48 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-03-12 10:01:47 +0530 (Tue, 12 Mar 2013)");
  script_cve_id("CVE-2012-4517", "CVE-2012-4518");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_name("CentOS Update for libibumad CESA-2013:0509 centos6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libibumad'
  ...
  script_tag(name:"affected", value:"libibumad on CentOS 6");
...
if(release == "CentOS6")
{
  ...
  if ((res = isrpmvuln(pkg:"libibumad", rpm:"libibumad~1.3.8~1.el6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libibumad-devel", rpm:"libibumad-devel~1.3.8~1.el6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"libibumad-static", rpm:"libibumad-static~1.3.8~1.el6", rls:"CentOS6")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
