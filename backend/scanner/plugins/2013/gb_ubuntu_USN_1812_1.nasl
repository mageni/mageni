...
# $Id: gb_ubuntu_USN_1812_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-lts-quantal USN-1812-1
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-06-14 12:53:04 +0530 (Fri, 14 Jun 2013)");
  ...
  script_name("Ubuntu Update for linux-lts-quantal USN-1812-1");

  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1812-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-28-generic", ver:"3.5.0-28.48~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
