...
#
# Fedora Update for kernel FEDORA-2013-17942
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866934");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-10-03 10:11:33 +0530 (Thu, 03 Oct 2013)");
  script_cve_id("CVE-2013-4345", "CVE-2013-4350", "CVE-2013-4343", "CVE-2013-2888",
  ...
  script_name("Fedora Update for kernel FEDORA-2013-17942");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2013-October/117906.html");
...
if(release == "FC18")
{
  ...
  if ((res = isrpmvuln(pkg:"kernel", rpm:"kernel~3.10.13~101.fc18", rls:"FC18")) != NULL)
  {
