...
# $Id: gb_ubuntu_USN_1845_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-05-31 09:57:53 +0530 (Fri, 31 May 2013)");
  script_cve_id("CVE-2013-2850");
  script_tag(name:"cvss_base", value:"7.9");
  script_tag(name:"cvss_base_vector", value:"AV:A/AC:M/Au:N/C:C/I:C/A:C");
  script_name("Ubuntu Update for linux-lts-quantal USN-1845-1");

  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1845-1/");
...
if(release == "UBUNTU12.04 LTS")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-32-generic", ver:"3.5.0-32.53~precise1", rls:"UBUNTU12.04 LTS")) != NULL)
  {
