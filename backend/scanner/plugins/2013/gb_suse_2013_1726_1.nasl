...
# $Id: gb_suse_2013_1726_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850553");
  ...
  script_tag(name:"insight", value:"openssh was updated to fix a memory corruption when AES-GCM
