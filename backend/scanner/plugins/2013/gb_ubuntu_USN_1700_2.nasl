...
# $Id: gb_ubuntu_USN_1700_2.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
# Ubuntu Update for linux-ti-omap4 USN-1700-2
#
# Authors:
...
if(description)
{
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1700-2/");
  script_oid("1.3.6.1.4.1.25623.1.0.841305");
  script_version("$Revision: 14132 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-13 10:25:59 +0100 (Wed, 13 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-02-04 09:58:01 +0530 (Mon, 04 Feb 2013)");
  script_cve_id("CVE-2012-4530", "CVE-2012-5532");
  script_tag(name:"cvss_base", value:"4.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:N/A:C");
  script_name("Ubuntu Update for linux-ti-omap4 USN-1700-2");
...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"linux-image-3.5.0-218-omap4", ver:"3.5.0-218.26", rls:"UBUNTU12.10")) != NULL)
  {
