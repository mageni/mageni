...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866631");
  ...
  script_name("Fedora Update for spice FEDORA-2013-14110");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"spice", rpm:"spice~0.12.4~1.fc19", rls:"FC19")) != NULL)
  {
