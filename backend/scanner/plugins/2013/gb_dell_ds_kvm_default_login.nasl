...
# $Id: gb_dell_ds_kvm_default_login.nasl 13659 2019-02-14 08:34:21Z cfischer $
#
...
if(description)
{
 ...
 sensitive information or modify system configuration without requiring authentication.');
  ...
  script_tag(name:"summary", value:'The remote Dell KVM is prone to a default account
