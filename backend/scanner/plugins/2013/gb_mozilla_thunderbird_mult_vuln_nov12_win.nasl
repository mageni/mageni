...
# $Id: gb_mozilla_thunderbird_mult_vuln_nov12_win.nasl 11883 2018-10-12 13:31:09Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.803628");
  ...
  script_name("Mozilla Thunderbird Multiple Vulnerabilities - November12 (Windows)");
  ...
  script_tag(name:"affected", value:"Thunderbird version before 16.0.2 on Windows");
