...
#
# Fedora Update for gnupg FEDORA-2013-0459
#
# Authors:
...
if(release == "FC17")
{
  ...
  if ((res = isrpmvuln(pkg:"gnupg", rpm:"gnupg~1.4.13~2.fc17", rls:"FC17")) != NULL)
  {
