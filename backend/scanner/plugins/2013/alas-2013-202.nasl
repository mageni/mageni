...
# $Id: alas-2013-202.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-202");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"socat-debuginfo", rpm:"socat-debuginfo~1.7.2.2~1.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"socat", rpm:"socat~1.7.2.2~1.8.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
