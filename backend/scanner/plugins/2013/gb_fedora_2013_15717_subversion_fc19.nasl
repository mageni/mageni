...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.866878");
  script_version("$Revision: 14223 $");
  script_tag(name:"last_modification", value:"$Date: 2019-03-15 14:49:35 +0100 (Fri, 15 Mar 2019) $");
  script_tag(name:"creation_date", value:"2013-09-12 11:34:36 +0530 (Thu, 12 Sep 2013)");
  script_cve_id("CVE-2013-4277");
  script_tag(name:"cvss_base", value:"3.3");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:N/I:P/A:P");
  script_name("Fedora Update for subversion FEDORA-2013-15717");
...
if(release == "FC19")
{
  ...
  if ((res = isrpmvuln(pkg:"subversion", rpm:"subversion~1.7.13~1.fc19", rls:"FC19")) != NULL)
  {
