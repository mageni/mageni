...
# $Id: alas-2013-232.nasl 6577 2017-07-06 13:43:46Z cfischer$
#
...
if(description)
{
  ...
  script_name("Amazon Linux Local Check: ALAS-2013-232");
...
if(release == "AMAZON")
{
if ((res = isrpmvuln(pkg:"xinetd", rpm:"xinetd~2.3.14~39.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
if ((res = isrpmvuln(pkg:"xinetd-debuginfo", rpm:"xinetd-debuginfo~2.3.14~39.9.amzn1", rls:"AMAZON")) != NULL) {
  security_message(data:res);
  exit(0);
}
