...
# $Id: deb_2817.nasl 14276 2019-03-18 14:43:56Z cfischer $
...
We recommend that you upgrade your libtar packages.");
  script_tag(name:"summary", value:"Timo Warns reported multiple integer overflow vulnerabilities in libtar,
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libtar", ver:"1.2.11-6+deb6u1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtar-dev", ver:"1.2.11-6+deb6u1", rls:"DEB6")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtar-dev", ver:"1.2.16-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
if((res = isdpkgvuln(pkg:"libtar0", ver:"1.2.16-1+deb7u1", rls:"DEB7")) != NULL) {
  report += res;
}
