...
# $Id: gb_ubuntu_USN_1856_1.nasl 14132 2019-03-13 09:25:59Z cfischer $
#
...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-1856-1/");
  ...
  script_tag(name:"affected", value:"libxcursor on Ubuntu 13.04,
  Ubuntu 12.10,
  Ubuntu 12.04 LTS");
