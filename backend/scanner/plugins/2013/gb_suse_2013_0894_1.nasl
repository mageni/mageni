...
# $Id: gb_suse_2013_0894_1.nasl 12381 2018-11-16 11:16:30Z cfischer $
#
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.850550");
  ...
  script_tag(name:"affected", value:"MozillaThunderbird on openSUSE 12.3");
